...
; <label>:8:                                      ; preds = %2
  ...
  br i1 %10, label %11, label %53, !dbg !276
...
; <label>:24:                                     ; preds = %15, %45
  ...
  %29 = icmp eq i64 %28, -1, !dbg !297
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !299
  br i1 %29, label %48, label %30, !dbg !299

; <label>:30:                                     ; preds = %24
  %31 = icmp eq i64 %28, -2, !dbg !300
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !302
  br i1 %31, label %45, label %32, !dbg !302

; <label>:32:                                     ; preds = %30
  %33 = icmp eq i64 %28, 0, !dbg !303
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !305
  %34 = load i8*, i8** %14, align 8, !dbg !306, !tbaa !285
  br i1 %33, label %35, label %39, !dbg !305

; <label>:35:                                     ; preds = %32
  %36 = getelementptr inbounds i8, i8* %34, i64 1, !dbg !308
  store i8* %36, i8** %14, align 8, !dbg !308, !tbaa !285
  %37 = load i32, i32* %5, align 8, !dbg !310, !tbaa !263
  %38 = add nsw i32 %37, -1, !dbg !310
  store i32 %38, i32* %5, align 8, !dbg !310, !tbaa !263
  br label %53, !dbg !311

; <label>:39:                                     ; preds = %32
  %40 = getelementptr inbounds i8, i8* %34, i64 %28, !dbg !312
  store i8* %40, i8** %14, align 8, !dbg !312, !tbaa !285
  %41 = load i32, i32* %5, align 8, !dbg !313, !tbaa !263
  %42 = trunc i64 %28 to i32, !dbg !313
  %43 = sub i32 %41, %42, !dbg !313
  store i32 %43, i32* %5, align 8, !dbg !313, !tbaa !263
  %44 = load i32, i32* %3, align 4, !dbg !314, !tbaa !290
  br label %53, !dbg !315

; <label>:45:                                     ; preds = %30
  %46 = call i32 @__srefill_r(%struct._reent* %0, %struct.__sFILE* nonnull %1) #5, !dbg !316
  %47 = icmp eq i32 %46, 0, !dbg !317
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !318
  br i1 %47, label %24, label %48, !dbg !318, !llvm.loop !319

; <label>:48:                                     ; preds = %24, %45
  %49 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %1, i64 0, i32 3, !dbg !322
  %50 = load i16, i16* %49, align 8, !dbg !323, !tbaa !324
  %51 = or i16 %50, 64, !dbg !323
  store i16 %51, i16* %49, align 8, !dbg !323, !tbaa !324
  %52 = call i32* @__errno() #5, !dbg !325
  store i32 138, i32* %52, align 4, !dbg !326, !tbaa !290
  br label %53, !dbg !327

; <label>:53:                                     ; preds = %8, %48, %39, %35, %17
  %54 = phi i32 [ %21, %17 ], [ -1, %48 ], [ 0, %35 ], [ %44, %39 ], [ -1, %8 ], !dbg !306
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !328
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %4) #4, !dbg !329
...
; Function Attrs: noredzone nounwind
define dso_local i32 @_fgetwc_r(%struct._reent*, %struct.__sFILE*) local_unnamed_addr #0 !dbg !330 {
  %3 = alloca i32, align 4
  %4 = bitcast i32* %3 to i8*, !dbg !338
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %4) #4, !dbg !338
  %5 = call i32 @pthread_setcancelstate(i32 1, i32* nonnull %3) #5, !dbg !338
  %6 = call i32 @__fgetwc(%struct._reent* %0, %struct.__sFILE* %1) #6, !dbg !339
  %7 = load i32, i32* %3, align 4, !dbg !341, !tbaa !290
  %8 = call i32 @pthread_setcancelstate(i32 %7, i32* nonnull %3) #5, !dbg !341
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %4) #4, !dbg !342
...
; Function Attrs: noredzone nounwind
define dso_local i32 @fgetwc(%struct.__sFILE*) local_unnamed_addr #0 !dbg !344 {
  %2 = alloca i32, align 4
  %3 = tail call %struct._reent* @__getreent() #5, !dbg !353
  %4 = icmp eq %struct._reent* %3, null, !dbg !356
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !356
  br i1 %4, label %10, label %5, !dbg !356

; <label>:5:                                      ; preds = %1
  %6 = getelementptr inbounds %struct._reent, %struct._reent* %3, i64 0, i32 8, !dbg !356
  %7 = load i32, i32* %6, align 8, !dbg !356, !tbaa !358
  %8 = icmp eq i32 %7, 0, !dbg !356
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !355
  br i1 %8, label %9, label %10, !dbg !355

; <label>:9:                                      ; preds = %5
  tail call void @__sinit(%struct._reent* nonnull %3) #5, !dbg !356
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !356
  br label %10, !dbg !356

; <label>:10:                                     ; preds = %5, %1, %9
  %11 = bitcast i32* %2 to i8*, !dbg !365
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %11) #4, !dbg !365
  %12 = call i32 @pthread_setcancelstate(i32 1, i32* nonnull %2) #5, !dbg !365
  %13 = call i32 @__fgetwc(%struct._reent* %3, %struct.__sFILE* %0) #5, !dbg !366
  %14 = load i32, i32* %2, align 4, !dbg !368, !tbaa !290
  %15 = call i32 @pthread_setcancelstate(i32 %14, i32* nonnull %2) #5, !dbg !368
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %11) #4, !dbg !369
...
!297 = !DILocation(line: 194, column: 17, scope: !298)
!298 = distinct !DILexicalBlock(scope: !282, file: !1, line: 194, column: 11)
!299 = !DILocation(line: 194, column: 11, scope: !282)
!300 = !DILocation(line: 196, column: 22, scope: !301)
!301 = distinct !DILexicalBlock(scope: !298, file: !1, line: 196, column: 16)
!302 = !DILocation(line: 196, column: 16, scope: !298)
!303 = !DILocation(line: 198, column: 22, scope: !304)
!304 = distinct !DILexicalBlock(scope: !301, file: !1, line: 198, column: 16)
!305 = !DILocation(line: 198, column: 16, scope: !301)
!306 = !DILocation(line: 0, scope: !307)
!307 = distinct !DILexicalBlock(scope: !304, file: !1, line: 209, column: 9)
!308 = !DILocation(line: 204, column: 10, scope: !309)
!309 = distinct !DILexicalBlock(scope: !304, file: !1, line: 199, column: 2)
!310 = !DILocation(line: 205, column: 10, scope: !309)
!311 = !DILocation(line: 206, column: 4, scope: !309)
!312 = !DILocation(line: 210, column: 11, scope: !307)
!313 = !DILocation(line: 211, column: 11, scope: !307)
!314 = !DILocation(line: 212, column: 12, scope: !307)
!315 = !DILocation(line: 212, column: 4, scope: !307)
!316 = !DILocation(line: 215, column: 10, scope: !33)
!317 = !DILocation(line: 215, column: 31, scope: !33)
!318 = !DILocation(line: 214, column: 5, scope: !282)
!319 = distinct !{!319, !320, !321}
!320 = !DILocation(line: 191, column: 3, scope: !33)
!321 = !DILocation(line: 215, column: 35, scope: !33)
!322 = !DILocation(line: 216, column: 7, scope: !33)
!323 = !DILocation(line: 216, column: 14, scope: !33)
!324 = !{!264, !269, i64 16}
!325 = !DILocation(line: 217, column: 3, scope: !33)
!326 = !DILocation(line: 217, column: 9, scope: !33)
!327 = !DILocation(line: 218, column: 3, scope: !33)
!328 = !DILocation(line: 0, scope: !262)
!329 = !DILocation(line: 219, column: 1, scope: !33)
!330 = distinct !DISubprogram(name: "_fgetwc_r", scope: !1, file: !1, line: 222, type: !34, isLocal: false, isDefinition: true, scopeLine: 225, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !331)
!331 = !{!332, !333, !334, !335}
!332 = !DILocalVariable(name: "ptr", arg: 1, scope: !330, file: !1, line: 222, type: !36)
!333 = !DILocalVariable(name: "fp", arg: 2, scope: !330, file: !1, line: 222, type: !250)
!334 = !DILocalVariable(name: "r", scope: !330, file: !1, line: 226, type: !22)
!335 = !DILocalVariable(name: "__oldfpcancel", scope: !336, file: !1, line: 228, type: !5)
!336 = distinct !DILexicalBlock(scope: !330, file: !1, line: 228, column: 3)
!337 = !DILocation(line: 222, column: 1, scope: !330)
!338 = !DILocation(line: 228, column: 3, scope: !336)
!339 = !DILocation(line: 230, column: 7, scope: !336)
!340 = !DILocation(line: 226, column: 10, scope: !330)
!341 = !DILocation(line: 231, column: 3, scope: !336)
!342 = !DILocation(line: 231, column: 3, scope: !330)
!343 = !DILocation(line: 232, column: 3, scope: !330)
!344 = distinct !DISubprogram(name: "fgetwc", scope: !1, file: !1, line: 236, type: !345, isLocal: false, isDefinition: true, scopeLine: 238, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !347)
!345 = !DISubroutineType(types: !346)
!346 = !{!22, !250}
!347 = !{!348, !349, !350}
!348 = !DILocalVariable(name: "fp", arg: 1, scope: !344, file: !1, line: 236, type: !250)
!349 = !DILocalVariable(name: "reent", scope: !344, file: !1, line: 239, type: !36)
!350 = !DILocalVariable(name: "_check_init_ptr", scope: !351, file: !1, line: 241, type: !36)
!351 = distinct !DILexicalBlock(scope: !344, file: !1, line: 241, column: 3)
!352 = !DILocation(line: 236, column: 1, scope: !344)
!353 = !DILocation(line: 239, column: 26, scope: !344)
!354 = !DILocation(line: 239, column: 18, scope: !344)
!355 = !DILocation(line: 241, column: 3, scope: !351)
!356 = !DILocation(line: 241, column: 3, scope: !357)
!357 = distinct !DILexicalBlock(scope: !351, file: !1, line: 241, column: 3)
!358 = !{!359, !268, i64 80}
!359 = !{!"_reent", !268, i64 0, !265, i64 8, !265, i64 16, !265, i64 24, !268, i64 32, !266, i64 36, !268, i64 64, !265, i64 72, !268, i64 80, !265, i64 88, !265, i64 96, !268, i64 104, !265, i64 112, !265, i64 120, !268, i64 128, !265, i64 136, !266, i64 144, !265, i64 504, !360, i64 512, !265, i64 1304, !362, i64 1312, !266, i64 1336}
!360 = !{!"_atexit", !265, i64 0, !268, i64 8, !266, i64 16, !361, i64 272}
!361 = !{!"_on_exit_args", !266, i64 0, !266, i64 256, !268, i64 512, !268, i64 516}
!362 = !{!"_glue", !265, i64 0, !268, i64 8, !265, i64 16}
!363 = !DILocation(line: 222, column: 1, scope: !330, inlinedAt: !364)
!364 = distinct !DILocation(line: 242, column: 10, scope: !344)
!365 = !DILocation(line: 228, column: 3, scope: !336, inlinedAt: !364)
!366 = !DILocation(line: 230, column: 7, scope: !336, inlinedAt: !364)
!367 = !DILocation(line: 226, column: 10, scope: !330, inlinedAt: !364)
!368 = !DILocation(line: 231, column: 3, scope: !336, inlinedAt: !364)
!369 = !DILocation(line: 231, column: 3, scope: !330, inlinedAt: !364)
!370 = !DILocation(line: 232, column: 3, scope: !330, inlinedAt: !364)
!371 = !DILocation(line: 242, column: 3, scope: !344)
