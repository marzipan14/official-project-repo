...
; Function Attrs: noredzone nounwind
define dso_local i8* @itoa(i32, i8*, i32) local_unnamed_addr #0 !dbg !47 {
  %4 = add i32 %2, -2, !dbg !56
  %5 = icmp ugt i32 %4, 34, !dbg !56
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !56
  br i1 %5, label %6, label %7, !dbg !56

; <label>:6:                                      ; preds = %3
  store i8 0, i8* %1, align 1, !dbg !57, !tbaa !27
  br label %18, !dbg !58

; <label>:7:                                      ; preds = %3
  %8 = icmp eq i32 %2, 10, !dbg !59
  %9 = icmp slt i32 %0, 0, !dbg !60
  %10 = and i1 %9, %8, !dbg !61
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !61
  br i1 %10, label %11, label %13, !dbg !61

; <label>:11:                                     ; preds = %7
  store i8 45, i8* %1, align 1, !dbg !62, !tbaa !27
  %12 = sub nsw i32 0, %0, !dbg !63
  br label %13, !dbg !65

; <label>:13:                                     ; preds = %7, %11
  %14 = phi i32 [ %12, %11 ], [ %0, %7 ], !dbg !66
  %15 = phi i64 [ 1, %11 ], [ 0, %7 ]
  store volatile i32 42, i32* @__A_VARIABLE, align 4
  %16 = getelementptr inbounds i8, i8* %1, i64 %15, !dbg !67
  %17 = tail call i8* @__utoa(i32 %14, i8* %16, i32 %2) #3, !dbg !68
  br label %18, !dbg !69

; <label>:18:                                     ; preds = %6, %13
  %19 = phi i8* [ null, %6 ], [ %1, %13 ], !dbg !70
...
!46 = !DILocation(line: 60, column: 1, scope: !9)
!47 = distinct !DISubprogram(name: "itoa", scope: !1, file: !1, line: 63, type: !10, isLocal: false, isDefinition: true, scopeLine: 67, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !48)
!48 = !{!49, !50, !51}
!49 = !DILocalVariable(name: "value", arg: 1, scope: !47, file: !1, line: 63, type: !14)
!50 = !DILocalVariable(name: "str", arg: 2, scope: !47, file: !1, line: 63, type: !12)
!51 = !DILocalVariable(name: "base", arg: 3, scope: !47, file: !1, line: 63, type: !14)
!52 = !DILocation(line: 63, column: 1, scope: !47)
!53 = !DILocation(line: 33, column: 1, scope: !9, inlinedAt: !54)
!54 = distinct !DILocation(line: 68, column: 10, scope: !47)
!55 = !DILocation(line: 39, column: 7, scope: !9, inlinedAt: !54)
!56 = !DILocation(line: 42, column: 18, scope: !24, inlinedAt: !54)
!57 = !DILocation(line: 44, column: 14, scope: !26, inlinedAt: !54)
!58 = !DILocation(line: 45, column: 7, scope: !26, inlinedAt: !54)
!59 = !DILocation(line: 50, column: 13, scope: !32, inlinedAt: !54)
!60 = !DILocation(line: 50, column: 30, scope: !32, inlinedAt: !54)
!61 = !DILocation(line: 50, column: 20, scope: !32, inlinedAt: !54)
!62 = !DILocation(line: 52, column: 16, scope: !36, inlinedAt: !54)
!63 = !DILocation(line: 53, column: 26, scope: !36, inlinedAt: !54)
!64 = !DILocation(line: 38, column: 12, scope: !9, inlinedAt: !54)
!65 = !DILocation(line: 54, column: 5, scope: !36, inlinedAt: !54)
!66 = !DILocation(line: 0, scope: !32, inlinedAt: !54)
!67 = !DILocation(line: 58, column: 20, scope: !9, inlinedAt: !54)
!68 = !DILocation(line: 58, column: 3, scope: !9, inlinedAt: !54)
!69 = !DILocation(line: 59, column: 3, scope: !9, inlinedAt: !54)
!70 = !DILocation(line: 0, scope: !9, inlinedAt: !54)
!71 = !DILocation(line: 0, scope: !47)
!72 = !DILocation(line: 60, column: 1, scope: !9, inlinedAt: !54)
!73 = !DILocation(line: 68, column: 3, scope: !47)
