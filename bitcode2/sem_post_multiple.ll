...
define dso_local i32 @sem_post_multiple(%struct.sem_t_** nocapture readonly, i32) local_unnamed_addr #0 !dbg !16 {
  ...
  br i1 %6, label %7, label %8, !dbg !512
...
; <label>:8:                                      ; preds = %2
  %9 = getelementptr inbounds %struct.sem_t_, %struct.sem_t_* %3, i64 0, i32 1, !dbg !515
  %10 = tail call i32 @pthread_mutex_lock(%struct.pthread_mutex_t_** nonnull %9) #3, !dbg !517
  %11 = icmp eq i32 %10, 0, !dbg !518
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !519
  br i1 %11, label %12, label %32, !dbg !519

; <label>:12:                                     ; preds = %8
  %13 = load %struct.sem_t_*, %struct.sem_t_** %0, align 8, !dbg !520, !tbaa !504
  %14 = icmp eq %struct.sem_t_* %13, null, !dbg !523
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !524
  br i1 %14, label %15, label %17, !dbg !524

; <label>:15:                                     ; preds = %12
  %16 = tail call i32 @pthread_mutex_unlock(%struct.pthread_mutex_t_** nonnull %9) #3, !dbg !525
  br label %43, !dbg !527

; <label>:17:                                     ; preds = %12
  %18 = getelementptr inbounds %struct.sem_t_, %struct.sem_t_* %3, i64 0, i32 0, !dbg !528
  %19 = load i32, i32* %18, align 8, !dbg !528, !tbaa !530
  %20 = sub nsw i32 2147483647, %1, !dbg !533
  %21 = icmp sgt i32 %19, %20, !dbg !534
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !535
  br i1 %21, label %34, label %22, !dbg !535

; <label>:22:                                     ; preds = %17
  %23 = sub nsw i32 0, %19, !dbg !536
  %24 = add nsw i32 %19, %1, !dbg !538
  store i32 %24, i32* %18, align 8, !dbg !538, !tbaa !530
  %25 = icmp slt i32 %19, 0, !dbg !539
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !541
  br i1 %25, label %26, label %36, !dbg !541

; <label>:26:                                     ; preds = %22
  %27 = getelementptr inbounds %struct.sem_t_, %struct.sem_t_* %3, i64 0, i32 2, !dbg !542
  %28 = load %struct.uk_semaphore*, %struct.uk_semaphore** %27, align 8, !dbg !542, !tbaa !544
  %29 = icmp sgt i32 %23, %1, !dbg !545
  %30 = select i1 %29, i32 %1, i32 %23, !dbg !546
  %31 = tail call i32 @pte_osSemaphorePost(%struct.uk_semaphore* %28, i32 %30) #3, !dbg !547
  br label %34, !dbg !548

; <label>:32:                                     ; preds = %7, %8
  %33 = phi i32 [ %10, %8 ], [ 22, %7 ]
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !549
  br label %40, !dbg !549

; <label>:34:                                     ; preds = %17, %26
  %35 = phi i32 [ 0, %26 ], [ 34, %17 ]
  store volatile i32 42, i32* @__A_VARIABLE, align 4
  br label %36, !dbg !550

; <label>:36:                                     ; preds = %34, %22
  %37 = phi i32 [ 0, %22 ], [ %35, %34 ], !dbg !551
  %38 = tail call i32 @pthread_mutex_unlock(%struct.pthread_mutex_t_** nonnull %9) #3, !dbg !550
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !553
  %39 = icmp eq i32 %37, 0, !dbg !554
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !549
  br i1 %39, label %43, label %40, !dbg !549

; <label>:40:                                     ; preds = %32, %36
  %41 = phi i32 [ %33, %32 ], [ %37, %36 ]
  %42 = tail call i32* @__errno() #3, !dbg !556
  store i32 %41, i32* %42, align 4, !dbg !558, !tbaa !559
  br label %43, !dbg !560

; <label>:43:                                     ; preds = %36, %40, %15
  %44 = phi i32 [ -1, %40 ], [ -1, %15 ], [ 0, %36 ], !dbg !561
...
!513 = !DILocation(line: 95, column: 5, scope: !514)
!514 = distinct !DILexicalBlock(scope: !510, file: !1, line: 93, column: 5)
!515 = !DILocation(line: 96, column: 46, scope: !516)
!516 = distinct !DILexicalBlock(scope: !510, file: !1, line: 96, column: 12)
!517 = !DILocation(line: 96, column: 22, scope: !516)
!518 = !DILocation(line: 96, column: 53, scope: !516)
!519 = !DILocation(line: 96, column: 12, scope: !510)
!520 = !DILocation(line: 100, column: 11, scope: !521)
!521 = distinct !DILexicalBlock(scope: !522, file: !1, line: 100, column: 11)
!522 = distinct !DILexicalBlock(scope: !516, file: !1, line: 97, column: 5)
!523 = !DILocation(line: 100, column: 16, scope: !521)
!524 = !DILocation(line: 100, column: 11, scope: !522)
!525 = !DILocation(line: 102, column: 18, scope: !526)
!526 = distinct !DILexicalBlock(scope: !521, file: !1, line: 101, column: 9)
!527 = !DILocation(line: 104, column: 11, scope: !526)
!528 = !DILocation(line: 107, column: 14, scope: !529)
!529 = distinct !DILexicalBlock(scope: !522, file: !1, line: 107, column: 11)
!530 = !{!531, !532, i64 0}
!531 = !{!"sem_t_", !532, i64 0, !505, i64 8, !505, i64 16}
!532 = !{!"int", !506, i64 0}
!533 = !DILocation(line: 107, column: 38, scope: !529)
!534 = !DILocation(line: 107, column: 20, scope: !529)
!535 = !DILocation(line: 107, column: 11, scope: !522)
!536 = !DILocation(line: 109, column: 21, scope: !537)
!537 = distinct !DILexicalBlock(scope: !529, file: !1, line: 108, column: 9)
!538 = !DILocation(line: 110, column: 20, scope: !537)
!539 = !DILocation(line: 111, column: 23, scope: !540)
!540 = distinct !DILexicalBlock(scope: !537, file: !1, line: 111, column: 15)
!541 = !DILocation(line: 111, column: 15, scope: !537)
!542 = !DILocation(line: 114, column: 38, scope: !543)
!543 = distinct !DILexicalBlock(scope: !540, file: !1, line: 112, column: 13)
!544 = !{!531, !505, i64 16}
!545 = !DILocation(line: 114, column: 51, scope: !543)
!546 = !DILocation(line: 114, column: 43, scope: !543)
!547 = !DILocation(line: 114, column: 15, scope: !543)
!548 = !DILocation(line: 116, column: 13, scope: !543)
!549 = !DILocation(line: 133, column: 7, scope: !16)
!550 = !DILocation(line: 130, column: 14, scope: !522)
!551 = !DILocation(line: 0, scope: !552)
!552 = distinct !DILexicalBlock(scope: !529, file: !1, line: 126, column: 9)
!553 = !DILocation(line: 131, column: 5, scope: !522)
!554 = !DILocation(line: 133, column: 14, scope: !555)
!555 = distinct !DILexicalBlock(scope: !16, file: !1, line: 133, column: 7)
!556 = !DILocation(line: 135, column: 7, scope: !557)
!557 = distinct !DILexicalBlock(scope: !555, file: !1, line: 134, column: 5)
!558 = !DILocation(line: 135, column: 13, scope: !557)
!559 = !{!532, !532, i64 0}
!560 = !DILocation(line: 136, column: 7, scope: !557)
!561 = !DILocation(line: 0, scope: !526)
!562 = !DILocation(line: 141, column: 1, scope: !16)
