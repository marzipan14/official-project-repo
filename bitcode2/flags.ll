; ModuleID = '/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/stdio/flags.c'
source_filename = "/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/stdio/flags.c"
...
define dso_local i32 @__sflags(%struct._reent* nocapture, i8* nocapture readonly, i32* nocapture) local_unnamed_addr #0 !dbg !7 {
  %4 = load i8, i8* %1, align 1, !dbg !239, !tbaa !240
  %5 = sext i8 %4 to i32, !dbg !239
...
; <label>:8:                                      ; preds = %3
  %9 = getelementptr inbounds %struct._reent, %struct._reent* %0, i64 0, i32 0, !dbg !250
  store i32 22, i32* %9, align 8, !dbg !251, !tbaa !252
  br label %43, !dbg !259

; <label>:10:                                     ; preds = %3, %7, %6
  %11 = phi i32 [ 264, %7 ], [ 8, %6 ], [ 4, %3 ], !dbg !260
  %12 = phi i32 [ 1, %7 ], [ 1, %6 ], [ 0, %3 ], !dbg !260
  %13 = phi i32 [ 520, %7 ], [ 1536, %6 ], [ 0, %3 ], !dbg !260
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !260
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !261
  %14 = getelementptr inbounds i8, i8* %1, i64 1, !dbg !262
  %15 = load i8, i8* %14, align 1, !dbg !263, !tbaa !240
  %16 = icmp eq i8 %15, 0, !dbg !261
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !261
  br i1 %16, label %39, label %17, !dbg !261

; <label>:17:                                     ; preds = %10, %33
  %18 = phi i8 [ %37, %33 ], [ %15, %10 ]
  %19 = phi i8* [ %36, %33 ], [ %14, %10 ]
  %20 = phi i32 [ %35, %33 ], [ %12, %10 ]
  %21 = phi i32 [ %34, %33 ], [ %11, %10 ]
  %22 = sext i8 %18 to i32, !dbg !264
...
; <label>:23:                                     ; preds = %17
  %24 = and i32 %21, -29, !dbg !267
  %25 = or i32 %24, 16, !dbg !269
  %26 = and i32 %20, -4, !dbg !270
  %27 = or i32 %26, 2, !dbg !271
  br label %30, !dbg !272

; <label>:28:                                     ; preds = %17
  %29 = or i32 %20, 2048, !dbg !273
  br label %30, !dbg !274

; <label>:30:                                     ; preds = %23, %28
  %31 = phi i32 [ %25, %23 ], [ %21, %28 ]
  %32 = phi i32 [ %27, %23 ], [ %29, %28 ]
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !275
  br label %33, !dbg !261

; <label>:33:                                     ; preds = %30, %17
  %34 = phi i32 [ %21, %17 ], [ %31, %30 ], !dbg !275
  %35 = phi i32 [ %20, %17 ], [ %32, %30 ], !dbg !275
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !261
  %36 = getelementptr inbounds i8, i8* %19, i64 1, !dbg !262
  %37 = load i8, i8* %36, align 1, !dbg !263, !tbaa !240
  %38 = icmp eq i8 %37, 0, !dbg !261
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !261
  br i1 %38, label %39, label %17, !dbg !261, !llvm.loop !276

; <label>:39:                                     ; preds = %33, %10
  %40 = phi i32 [ %11, %10 ], [ %34, %33 ], !dbg !278
  %41 = phi i32 [ %12, %10 ], [ %35, %33 ], !dbg !279
  %42 = or i32 %41, %13, !dbg !280
  store i32 %42, i32* %2, align 4, !dbg !281, !tbaa !282
  br label %43, !dbg !283

; <label>:43:                                     ; preds = %39, %8
  %44 = phi i32 [ 0, %8 ], [ %40, %39 ], !dbg !284
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !260
...
!1 = !DIFile(filename: "/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/stdio/flags.c", directory: "/root/.unikraft/apps/redis/build")
!2 = !{}
!3 = !{i32 2, !"Dwarf Version", i32 4}
!4 = !{i32 2, !"Debug Info Version", i32 3}
!5 = !{i32 1, !"wchar_size", i32 4}
!6 = !{!"clang version 7.0.1-8+deb10u2 (tags/RELEASE_701/final)"}
!7 = distinct !DISubprogram(name: "__sflags", scope: !1, file: !1, line: 33, type: !8, isLocal: false, isDefinition: true, scopeLine: 37, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !231)
...
!230 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !10, size: 64)
!231 = !{!232, !233, !234, !235, !236, !237}
!232 = !DILocalVariable(name: "ptr", arg: 1, scope: !7, file: !1, line: 33, type: !11)
!233 = !DILocalVariable(name: "mode", arg: 2, scope: !7, file: !1, line: 33, type: !44)
!234 = !DILocalVariable(name: "optr", arg: 3, scope: !7, file: !1, line: 33, type: !230)
!235 = !DILocalVariable(name: "ret", scope: !7, file: !1, line: 38, type: !10)
!236 = !DILocalVariable(name: "m", scope: !7, file: !1, line: 38, type: !10)
!237 = !DILocalVariable(name: "o", scope: !7, file: !1, line: 38, type: !10)
!238 = !DILocation(line: 33, column: 1, scope: !7)
!239 = !DILocation(line: 40, column: 11, scope: !7)
!240 = !{!241, !241, i64 0}
!241 = !{!"omnipotent char", !242, i64 0}
!242 = !{!"Simple C/C++ TBAA"}
!243 = !DILocation(line: 40, column: 3, scope: !7)
!244 = !DILocation(line: 38, column: 16, scope: !7)
!245 = !DILocation(line: 38, column: 21, scope: !7)
!246 = !DILocation(line: 38, column: 24, scope: !7)
!247 = !DILocation(line: 52, column: 7, scope: !248)
!248 = distinct !DILexicalBlock(scope: !7, file: !1, line: 41, column: 5)
!249 = !DILocation(line: 58, column: 7, scope: !248)
!250 = !DILocation(line: 60, column: 12, scope: !248)
!251 = !DILocation(line: 60, column: 19, scope: !248)
!252 = !{!253, !254, i64 0}
!253 = !{!"_reent", !254, i64 0, !255, i64 8, !255, i64 16, !255, i64 24, !254, i64 32, !241, i64 36, !254, i64 64, !255, i64 72, !254, i64 80, !255, i64 88, !255, i64 96, !254, i64 104, !255, i64 112, !255, i64 120, !254, i64 128, !255, i64 136, !241, i64 144, !255, i64 504, !256, i64 512, !255, i64 1304, !258, i64 1312, !241, i64 1336}
!254 = !{!"int", !241, i64 0}
!255 = !{!"any pointer", !241, i64 0}
!256 = !{!"_atexit", !255, i64 0, !254, i64 8, !241, i64 16, !257, i64 272}
!257 = !{!"_on_exit_args", !241, i64 0, !241, i64 256, !254, i64 512, !254, i64 516}
!258 = !{!"_glue", !255, i64 0, !254, i64 8, !255, i64 16}
!259 = !DILocation(line: 61, column: 7, scope: !248)
!260 = !DILocation(line: 0, scope: !248)
!261 = !DILocation(line: 63, column: 3, scope: !7)
!262 = !DILocation(line: 63, column: 11, scope: !7)
!263 = !DILocation(line: 63, column: 10, scope: !7)
!264 = !DILocation(line: 65, column: 15, scope: !265)
!265 = distinct !DILexicalBlock(scope: !7, file: !1, line: 64, column: 5)
!266 = !DILocation(line: 65, column: 7, scope: !265)
!267 = !DILocation(line: 68, column: 15, scope: !268)
!268 = distinct !DILexicalBlock(scope: !265, file: !1, line: 66, column: 2)
!269 = !DILocation(line: 68, column: 35, scope: !268)
!270 = !DILocation(line: 69, column: 11, scope: !268)
!271 = !DILocation(line: 69, column: 25, scope: !268)
!272 = !DILocation(line: 70, column: 4, scope: !268)
!273 = !DILocation(line: 87, column: 6, scope: !268)
!274 = !DILocation(line: 88, column: 4, scope: !268)
!275 = !DILocation(line: 0, scope: !268)
!276 = distinct !{!276, !261, !277}
!277 = !DILocation(line: 92, column: 5, scope: !7)
!278 = !DILocation(line: 55, column: 11, scope: !248)
!279 = !DILocation(line: 56, column: 9, scope: !248)
!280 = !DILocation(line: 97, column: 13, scope: !7)
!281 = !DILocation(line: 97, column: 9, scope: !7)
!282 = !{!254, !254, i64 0}
!283 = !DILocation(line: 98, column: 3, scope: !7)
!284 = !DILocation(line: 0, scope: !7)
!285 = !DILocation(line: 99, column: 1, scope: !7)
