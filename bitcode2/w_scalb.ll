...
; <label>:44:                                     ; preds = %14, %8, %11
  ...
  br i1 %45, label %46, label %74, !dbg !102

; <label>:46:                                     ; preds = %44
  %47 = fcmp une double %5, %0, !dbg !103
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !104
  br i1 %47, label %48, label %74, !dbg !104

; <label>:48:                                     ; preds = %46
  %49 = getelementptr inbounds %struct.exception, %struct.exception* %3, i64 0, i32 0, !dbg !105
  store i32 4, i32* %49, align 8, !dbg !107, !tbaa !56
  %50 = getelementptr inbounds %struct.exception, %struct.exception* %3, i64 0, i32 1, !dbg !108
  store i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i64 0, i64 0), i8** %50, align 8, !dbg !109, !tbaa !63
  %51 = getelementptr inbounds %struct.exception, %struct.exception* %3, i64 0, i32 5, !dbg !110
  store i32 0, i32* %51, align 8, !dbg !111, !tbaa !66
  %52 = getelementptr inbounds %struct.exception, %struct.exception* %3, i64 0, i32 2, !dbg !112
  store double %0, double* %52, align 8, !dbg !113, !tbaa !69
  %53 = getelementptr inbounds %struct.exception, %struct.exception* %3, i64 0, i32 3, !dbg !114
  store double %1, double* %53, align 8, !dbg !115, !tbaa !72
  %54 = tail call double @copysign(double 0.000000e+00, double %0) #5, !dbg !116
  %55 = getelementptr inbounds %struct.exception, %struct.exception* %3, i64 0, i32 4, !dbg !117
  store double %54, double* %55, align 8, !dbg !118, !tbaa !77
  %56 = load i32, i32* @__fdlib_version, align 4, !dbg !119, !tbaa !41
  %57 = icmp eq i32 %56, 2, !dbg !121
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !122
  br i1 %57, label %58, label %60, !dbg !122

; <label>:58:                                     ; preds = %48
  %59 = tail call i32* @__errno() #5, !dbg !123
  br label %65, !dbg !123

; <label>:60:                                     ; preds = %48
  %61 = call i32 @matherr(%struct.exception* nonnull %3) #5, !dbg !124
  %62 = icmp eq i32 %61, 0, !dbg !124
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !126
  br i1 %62, label %63, label %67, !dbg !126

; <label>:63:                                     ; preds = %60
  %64 = call i32* @__errno() #5, !dbg !127
  br label %65, !dbg !129

; <label>:65:                                     ; preds = %58, %63
  %66 = phi i32* [ %64, %63 ], [ %59, %58 ]
  store i32 34, i32* %66, align 4, !dbg !130, !tbaa !91
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !130
  br label %67, !dbg !131

; <label>:67:                                     ; preds = %65, %60
  %68 = load i32, i32* %51, align 8, !dbg !131, !tbaa !66
  %69 = icmp eq i32 %68, 0, !dbg !133
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !134
  br i1 %69, label %72, label %70, !dbg !134

; <label>:70:                                     ; preds = %67
  %71 = call i32* @__errno() #5, !dbg !135
  store i32 %68, i32* %71, align 4, !dbg !136, !tbaa !91
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !135
  br label %72, !dbg !135

; <label>:72:                                     ; preds = %67, %70
  %73 = load double, double* %55, align 8, !dbg !137, !tbaa !77
  br label %79, !dbg !138

; <label>:74:                                     ; preds = %46, %44
  %75 = tail call i32 @finite(double %1) #5, !dbg !139
  %76 = icmp eq i32 %75, 0, !dbg !139
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !141
  br i1 %76, label %77, label %79, !dbg !141

; <label>:77:                                     ; preds = %74
  %78 = tail call i32* @__errno() #5, !dbg !142
  store i32 34, i32* %78, align 4, !dbg !143, !tbaa !91
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !142
  br label %79, !dbg !142

; <label>:79:                                     ; preds = %77, %74, %2, %72, %42
  %80 = phi double [ %73, %72 ], [ %43, %42 ], [ %5, %2 ], [ %5, %74 ], [ %5, %77 ], !dbg !144
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !145
  call void @llvm.lifetime.end.p0i8(i64 48, i8* nonnull %4) #4, !dbg !146
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !146
  ret double %80, !dbg !146
}
...
!102 = !DILocation(line: 70, column: 11, scope: !101)
!103 = !DILocation(line: 70, column: 14, scope: !101)
!104 = !DILocation(line: 70, column: 5, scope: !15)
!105 = !DILocation(line: 72, column: 10, scope: !106)
!106 = distinct !DILexicalBlock(scope: !101, file: !1, line: 70, column: 19)
...
!113 = !DILocation(line: 75, column: 15, scope: !106)
!114 = !DILocation(line: 76, column: 10, scope: !106)
!115 = !DILocation(line: 76, column: 15, scope: !106)
!116 = !DILocation(line: 77, column: 19, scope: !106)
!117 = !DILocation(line: 77, column: 10, scope: !106)
!118 = !DILocation(line: 77, column: 17, scope: !106)
!119 = !DILocation(line: 78, column: 10, scope: !120)
!120 = distinct !DILexicalBlock(scope: !106, file: !1, line: 78, column: 10)
!121 = !DILocation(line: 78, column: 23, scope: !120)
!122 = !DILocation(line: 78, column: 10, scope: !106)
...
!132 = distinct !DILexicalBlock(scope: !106, file: !1, line: 83, column: 10)
!133 = !DILocation(line: 83, column: 18, scope: !132)
!134 = !DILocation(line: 83, column: 10, scope: !106)
!135 = !DILocation(line: 84, column: 9, scope: !132)
!136 = !DILocation(line: 84, column: 15, scope: !132)
!137 = !DILocation(line: 85, column: 24, scope: !106)
!138 = !DILocation(line: 85, column: 13, scope: !106)
!139 = !DILocation(line: 88, column: 6, scope: !140)
!140 = distinct !DILexicalBlock(scope: !15, file: !1, line: 88, column: 5)
!141 = !DILocation(line: 88, column: 5, scope: !15)
!142 = !DILocation(line: 88, column: 18, scope: !140)
!143 = !DILocation(line: 88, column: 24, scope: !140)
!144 = !DILocation(line: 0, scope: !54)
!145 = !DILocation(line: 0, scope: !40)
!146 = !DILocation(line: 92, column: 1, scope: !15)
