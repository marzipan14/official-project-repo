...
; <label>:59:                                     ; preds = %10, %1, %7, %55
  ...
  call void @llvm.lifetime.end.p0i8(i64 48, i8* nonnull %3) #4, !dbg !135
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !135
  ret float %60, !dbg !135
}
...
!134 = !DILocation(line: 0, scope: !41)
!135 = !DILocation(line: 69, column: 1, scope: !18)
