; ModuleID = '/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/stdlib/drand48.c'
source_filename = "/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/stdlib/drand48.c"
...
define dso_local double @_drand48_r(%struct._reent*) local_unnamed_addr #0 !dbg !7 {
  %2 = getelementptr inbounds %struct._reent, %struct._reent* %0, i64 0, i32 16, i32 0, i32 0, i64 12, !dbg !234
  %3 = bitcast i8** %2 to i16*, !dbg !234
  %4 = tail call double @_erand48_r(%struct._reent* %0, i16* nonnull %3) #3, !dbg !235
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !236
  ret double %4, !dbg !236
}

; Function Attrs: noredzone
declare dso_local double @_erand48_r(%struct._reent*, i16*) local_unnamed_addr #1

; Function Attrs: noredzone nounwind
define dso_local double @drand48() local_unnamed_addr #0 !dbg !237 {
  %1 = tail call %struct._reent* @__getreent() #3, !dbg !240
  %2 = getelementptr inbounds %struct._reent, %struct._reent* %1, i64 0, i32 16, i32 0, i32 0, i64 12, !dbg !243
  %3 = bitcast i8** %2 to i16*, !dbg !243
  %4 = tail call double @_erand48_r(%struct._reent* %1, i16* nonnull %3) #3, !dbg !244
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !245
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !246
  ret double %4, !dbg !246
}
...
!1 = !DIFile(filename: "/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/stdlib/drand48.c", directory: "/root/.unikraft/apps/redis/build")
!2 = !{}
!3 = !{i32 2, !"Dwarf Version", i32 4}
!4 = !{i32 2, !"Debug Info Version", i32 3}
!5 = !{i32 1, !"wchar_size", i32 4}
!6 = !{!"clang version 7.0.1-8+deb10u2 (tags/RELEASE_701/final)"}
!7 = distinct !DISubprogram(name: "_drand48_r", scope: !1, file: !1, line: 17, type: !8, isLocal: false, isDefinition: true, scopeLine: 19, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !231)
...
!231 = !{!232}
!232 = !DILocalVariable(name: "r", arg: 1, scope: !7, file: !1, line: 17, type: !11)
!233 = !DILocation(line: 17, column: 1, scope: !7)
!234 = !DILocation(line: 21, column: 24, scope: !7)
!235 = !DILocation(line: 21, column: 10, scope: !7)
!236 = !DILocation(line: 21, column: 3, scope: !7)
!237 = distinct !DISubprogram(name: "drand48", scope: !1, file: !1, line: 26, type: !238, isLocal: false, isDefinition: true, scopeLine: 27, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !2)
!238 = !DISubroutineType(types: !239)
!239 = !{!10}
!240 = !DILocation(line: 28, column: 22, scope: !237)
!241 = !DILocation(line: 17, column: 1, scope: !7, inlinedAt: !242)
!242 = distinct !DILocation(line: 28, column: 10, scope: !237)
!243 = !DILocation(line: 21, column: 24, scope: !7, inlinedAt: !242)
!244 = !DILocation(line: 21, column: 10, scope: !7, inlinedAt: !242)
!245 = !DILocation(line: 21, column: 3, scope: !7, inlinedAt: !242)
!246 = !DILocation(line: 28, column: 3, scope: !237)
