; ModuleID = '/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/stdio/clearerr_u.c'
source_filename = "/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/stdio/clearerr_u.c"
...
define dso_local void @clearerr_unlocked(%struct.__sFILE* nocapture) local_unnamed_addr #0 !dbg !7 {
  %2 = tail call %struct._reent* @__getreent() #3, !dbg !238
  %3 = icmp eq %struct._reent* %2, null, !dbg !239
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !239
  br i1 %3, label %9, label %4, !dbg !239

; <label>:4:                                      ; preds = %1
  %5 = getelementptr inbounds %struct._reent, %struct._reent* %2, i64 0, i32 8, !dbg !239
...
; <label>:8:                                      ; preds = %4
  tail call void @__sinit(%struct._reent* nonnull %2) #3, !dbg !239
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !239
  br label %9, !dbg !239

; <label>:9:                                      ; preds = %4, %1, %8
  %10 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %0, i64 0, i32 3, !dbg !250
  %11 = load i16, i16* %10, align 8, !dbg !250, !tbaa !251
  %12 = and i16 %11, -97, !dbg !250
  store i16 %12, i16* %10, align 8, !dbg !250, !tbaa !251
...
!1 = !DIFile(filename: "/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/stdio/clearerr_u.c", directory: "/root/.unikraft/apps/redis/build")
!2 = !{}
!3 = !{i32 2, !"Dwarf Version", i32 4}
!4 = !{i32 2, !"Debug Info Version", i32 3}
!5 = !{i32 1, !"wchar_size", i32 4}
!6 = !{!"clang version 7.0.1-8+deb10u2 (tags/RELEASE_701/final)"}
!7 = distinct !DISubprogram(name: "clearerr_unlocked", scope: !1, file: !1, line: 36, type: !8, isLocal: false, isDefinition: true, scopeLine: 38, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !233)
...
!233 = !{!234, !235}
!234 = !DILocalVariable(name: "fp", arg: 1, scope: !7, file: !1, line: 36, type: !10)
!235 = !DILocalVariable(name: "_check_init_ptr", scope: !236, file: !1, line: 39, type: !41)
!236 = distinct !DILexicalBlock(scope: !7, file: !1, line: 39, column: 3)
!237 = !DILocation(line: 36, column: 1, scope: !7)
!238 = !DILocation(line: 39, column: 3, scope: !236)
!239 = !DILocation(line: 39, column: 3, scope: !240)
!240 = distinct !DILexicalBlock(scope: !236, file: !1, line: 39, column: 3)
!241 = !{!242, !243, i64 80}
!242 = !{!"_reent", !243, i64 0, !246, i64 8, !246, i64 16, !246, i64 24, !243, i64 32, !244, i64 36, !243, i64 64, !246, i64 72, !243, i64 80, !246, i64 88, !246, i64 96, !243, i64 104, !246, i64 112, !246, i64 120, !243, i64 128, !246, i64 136, !244, i64 144, !246, i64 504, !247, i64 512, !246, i64 1304, !249, i64 1312, !244, i64 1336}
!243 = !{!"int", !244, i64 0}
!244 = !{!"omnipotent char", !245, i64 0}
!245 = !{!"Simple C/C++ TBAA"}
!246 = !{!"any pointer", !244, i64 0}
!247 = !{!"_atexit", !246, i64 0, !243, i64 8, !244, i64 16, !248, i64 272}
!248 = !{!"_on_exit_args", !244, i64 0, !244, i64 256, !243, i64 512, !243, i64 516}
!249 = !{!"_glue", !246, i64 0, !243, i64 8, !246, i64 16}
!250 = !DILocation(line: 40, column: 3, scope: !7)
!251 = !{!252, !253, i64 16}
!252 = !{!"__sFILE", !246, i64 0, !243, i64 8, !243, i64 12, !253, i64 16, !253, i64 18, !254, i64 24, !243, i64 40, !246, i64 48, !246, i64 56, !246, i64 64, !246, i64 72, !246, i64 80, !254, i64 88, !246, i64 104, !243, i64 112, !244, i64 116, !244, i64 119, !254, i64 120, !243, i64 136, !255, i64 144, !246, i64 152, !243, i64 160, !256, i64 164, !243, i64 172}
!253 = !{!"short", !244, i64 0}
!254 = !{!"__sbuf", !246, i64 0, !243, i64 8}
!255 = !{!"long", !244, i64 0}
!256 = !{!"", !243, i64 0, !244, i64 4}
!257 = !DILocation(line: 41, column: 1, scope: !7)
