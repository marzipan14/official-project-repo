...
.LBB0_4:
	movl	$42, __A_VARIABLE(%rip)
	movq	-24(%rbp), %xmm3        # 8-byte Folded Reload
                                        # xmm3 = mem[0],zero
	jmp	.LBB0_15
.LBB0_7:
...
# %bb.1:
	...
	mulsd	%xmm0, %xmm1
	addsd	%xmm0, %xmm1
	movsd	.LCPI2_12(%rip), %xmm2  # xmm2 = mem[0],zero
	divsd	%xmm1, %xmm2
	jmp	.LBB2_23
.LBB2_2:
	orl	%ebx, %ecx
...
# %bb.7:
	...
	movsd	-16(%rbp), %xmm0        # 8-byte Reload
                                        # xmm0 = mem[0],zero
	callq	cos
	movapd	.LCPI2_15(%rip), %xmm1  # xmm1 = [-0.0E+0,-0.0E+0]
	xorpd	-32(%rbp), %xmm1        # 16-byte Folded Reload
	subsd	%xmm0, %xmm1
	movl	$42, __A_VARIABLE(%rip)
	cmpl	$2145386496, %ebx       # imm = 0x7FE00000
	jae	.LBB2_8
...
.LBB2_20:
	...
	ja	.LBB2_22
# %bb.21:
	movsd	.LCPI2_14(%rip), %xmm2  # xmm2 = mem[0],zero
	divsd	%xmm0, %xmm2
	jmp	.LBB2_23
.LBB2_8:
	movl	$42, __A_VARIABLE(%rip)
...
.LBB2_23:
	...
	retq
.Lfunc_end2:
	.size	__ieee754_y1, .Lfunc_end2-__ieee754_y1
                                        # -- End function
	.type	pr8,@object             # @pr8
