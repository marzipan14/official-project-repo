...
define dso_local i32 @wmemcmp(i32* nocapture readonly, i32* nocapture readonly, i64) local_unnamed_addr #0 !dbg !7 {
  ...
  br i1 %4, label %20, label %5, !dbg !28

; <label>:5:                                      ; preds = %3, %15
  %6 = phi i64 [ %18, %15 ], [ 0, %3 ]
  %7 = phi i32* [ %17, %15 ], [ %1, %3 ]
  %8 = phi i32* [ %16, %15 ], [ %0, %3 ]
  %9 = load i32, i32* %8, align 4, !dbg !29, !tbaa !32
  %10 = load i32, i32* %7, align 4, !dbg !36, !tbaa !32
  %11 = icmp eq i32 %9, %10, !dbg !37
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !38
  br i1 %11, label %15, label %12, !dbg !38

; <label>:12:                                     ; preds = %5
  %13 = icmp sgt i32 %9, %10, !dbg !39
  %14 = select i1 %13, i32 1, i32 -1, !dbg !41
  br label %20, !dbg !42

; <label>:15:                                     ; preds = %5
  %16 = getelementptr inbounds i32, i32* %8, i64 1, !dbg !43
  %17 = getelementptr inbounds i32, i32* %7, i64 1, !dbg !44
  %18 = add nuw i64 %6, 1, !dbg !45
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !46
  %19 = icmp ult i64 %18, %2, !dbg !26
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !28
  br i1 %19, label %5, label %20, !dbg !28, !llvm.loop !47

; <label>:20:                                     ; preds = %15, %3, %12
  %21 = phi i32 [ %14, %12 ], [ 0, %3 ], [ 0, %15 ], !dbg !49
...
!24 = !DILocation(line: 78, column: 8, scope: !25)
!25 = distinct !DILexicalBlock(scope: !7, file: !1, line: 78, column: 3)
!26 = !DILocation(line: 78, column: 17, scope: !27)
!27 = distinct !DILexicalBlock(scope: !25, file: !1, line: 78, column: 3)
!28 = !DILocation(line: 78, column: 3, scope: !25)
!29 = !DILocation(line: 80, column: 11, scope: !30)
!30 = distinct !DILexicalBlock(scope: !31, file: !1, line: 80, column: 11)
!31 = distinct !DILexicalBlock(scope: !27, file: !1, line: 79, column: 5)
!32 = !{!33, !33, i64 0}
!33 = !{!"int", !34, i64 0}
!34 = !{!"omnipotent char", !35, i64 0}
!35 = !{!"Simple C/C++ TBAA"}
!36 = !DILocation(line: 80, column: 18, scope: !30)
!37 = !DILocation(line: 80, column: 15, scope: !30)
!38 = !DILocation(line: 80, column: 11, scope: !31)
!39 = !DILocation(line: 83, column: 15, scope: !40)
!40 = distinct !DILexicalBlock(scope: !30, file: !1, line: 81, column: 2)
!41 = !DILocation(line: 83, column: 11, scope: !40)
!42 = !DILocation(line: 83, column: 4, scope: !40)
!43 = !DILocation(line: 85, column: 9, scope: !31)
!44 = !DILocation(line: 86, column: 9, scope: !31)
!45 = !DILocation(line: 78, column: 23, scope: !27)
!46 = !DILocation(line: 78, column: 3, scope: !27)
!47 = distinct !{!47, !28, !48}
!48 = !DILocation(line: 87, column: 5, scope: !25)
!49 = !DILocation(line: 0, scope: !7)
!50 = !DILocation(line: 0, scope: !40)
!51 = !DILocation(line: 89, column: 1, scope: !7)
