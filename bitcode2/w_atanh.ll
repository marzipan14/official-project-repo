...
; <label>:56:                                     ; preds = %10, %1, %7, %53
  ...
  call void @llvm.lifetime.end.p0i8(i64 48, i8* nonnull %3) #4, !dbg !130
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !130
  ret double %57, !dbg !130
}
...
!129 = !DILocation(line: 0, scope: !39)
!130 = !DILocation(line: 134, column: 1, scope: !15)
