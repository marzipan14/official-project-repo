...
; <label>:52:                                     ; preds = %46
  ...
  %54 = icmp eq i32 %12, 2146435072, !dbg !121
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !123
  br i1 %53, label %55, label %65, !dbg !120

; <label>:55:                                     ; preds = %52
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !124
  %56 = trunc i32 %38 to i2, !dbg !124
  %57 = xor i2 %56, -2, !dbg !124
  %58 = zext i2 %57 to i64, !dbg !124
  br i1 %54, label %59, label %62, !dbg !128

; <label>:59:                                     ; preds = %55
  %60 = getelementptr inbounds [4 x double], [4 x double]* @switch.table.__ieee754_atan2, i64 0, i64 %58, !dbg !129
  %61 = load double, double* %60, align 8, !dbg !129
  br label %93, !dbg !129

; <label>:62:                                     ; preds = %55
  %63 = getelementptr inbounds [4 x double], [4 x double]* @switch.table.__ieee754_atan2.1, i64 0, i64 %58, !dbg !131
  %64 = load double, double* %63, align 8, !dbg !131
  br label %93, !dbg !131

; <label>:65:                                     ; preds = %52
  br i1 %54, label %66, label %69, !dbg !132

; <label>:66:                                     ; preds = %65
  %67 = icmp slt i32 %10, 0, !dbg !133
  %68 = select i1 %67, double 0xBFF921FB54442D18, double 0x3FF921FB54442D18, !dbg !134
  br label %93, !dbg !135

; <label>:69:                                     ; preds = %65
  %70 = sub nsw i32 %12, %7, !dbg !136
  %71 = icmp sgt i32 %70, 63963135, !dbg !137
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !139
  br i1 %71, label %80, label %72, !dbg !139

; <label>:72:                                     ; preds = %69
  %73 = icmp slt i32 %5, 0, !dbg !141
  %74 = icmp slt i32 %70, -62914560, !dbg !143
  %75 = and i1 %73, %74, !dbg !144
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !144
  br i1 %75, label %80, label %76, !dbg !144

; <label>:76:                                     ; preds = %72
  %77 = fdiv double %0, %1, !dbg !145
  %78 = tail call double @fabs(double %77) #3, !dbg !146
  %79 = tail call double @atan(double %78) #3, !dbg !147
  br label %80

; <label>:80:                                     ; preds = %72, %69, %76
  %81 = phi double [ %79, %76 ], [ 0x3FF921FB54442D18, %69 ], [ 0.000000e+00, %72 ], !dbg !149
  store volatile i32 42, i32* @__A_VARIABLE, align 4
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !150
  %82 = trunc i32 %38 to i2, !dbg !150
...
; <label>:83:                                     ; preds = %80
  %84 = bitcast double %81 to i64, !dbg !151
  %85 = xor i64 %84, -9223372036854775808, !dbg !152
  %86 = bitcast i64 %85 to double, !dbg !152
  br label %93, !dbg !153

; <label>:87:                                     ; preds = %80
  %88 = fadd double %81, 0xBCA1A62633145C07, !dbg !154
  %89 = fsub double 0x400921FB54442D18, %88, !dbg !155
  br label %93, !dbg !156

; <label>:90:                                     ; preds = %80
  %91 = fadd double %81, 0xBCA1A62633145C07, !dbg !157
  %92 = fadd double %91, 0xC00921FB54442D18, !dbg !158
  br label %93, !dbg !159

; <label>:93:                                     ; preds = %80, %62, %59, %41, %41, %90, %87, %83, %66, %49, %44, %43, %30, %24
  %94 = phi double [ %25, %24 ], [ %31, %30 ], [ %51, %49 ], [ %68, %66 ], [ %92, %90 ], [ %89, %87 ], [ %86, %83 ], [ 0xC00921FB54442D18, %44 ], [ 0x400921FB54442D18, %43 ], [ %0, %41 ], [ %0, %41 ], [ %61, %59 ], [ %64, %62 ], [ %81, %80 ], !dbg !160
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !161
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !162
  ret double %94, !dbg !162
}
...
!120 = !DILocation(line: 92, column: 5, scope: !22)
!121 = !DILocation(line: 0, scope: !122)
!122 = distinct !DILexicalBlock(scope: !22, file: !1, line: 110, column: 5)
!123 = !DILocation(line: 0, scope: !22)
!124 = !DILocation(line: 0, scope: !125)
!125 = distinct !DILexicalBlock(scope: !126, file: !1, line: 100, column: 13)
!126 = distinct !DILexicalBlock(scope: !127, file: !1, line: 93, column: 9)
!127 = distinct !DILexicalBlock(scope: !119, file: !1, line: 92, column: 21)
!128 = !DILocation(line: 93, column: 9, scope: !127)
!129 = !DILocation(line: 94, column: 3, scope: !130)
!130 = distinct !DILexicalBlock(scope: !126, file: !1, line: 93, column: 25)
!131 = !DILocation(line: 101, column: 3, scope: !125)
!132 = !DILocation(line: 110, column: 5, scope: !22)
!133 = !DILocation(line: 110, column: 31, scope: !122)
!134 = !DILocation(line: 110, column: 28, scope: !122)
!135 = !DILocation(line: 110, column: 21, scope: !122)
!136 = !DILocation(line: 113, column: 9, scope: !22)
!137 = !DILocation(line: 114, column: 7, scope: !138)
!138 = distinct !DILexicalBlock(scope: !22, file: !1, line: 114, column: 5)
!139 = !DILocation(line: 114, column: 5, scope: !22)
!140 = !DILocation(line: 66, column: 12, scope: !22)
!141 = !DILocation(line: 115, column: 12, scope: !142)
!142 = distinct !DILexicalBlock(scope: !138, file: !1, line: 115, column: 10)
!143 = !DILocation(line: 115, column: 17, scope: !142)
!144 = !DILocation(line: 115, column: 14, scope: !142)
!145 = !DILocation(line: 116, column: 20, scope: !142)
!146 = !DILocation(line: 116, column: 14, scope: !142)
!147 = !DILocation(line: 116, column: 9, scope: !142)
!148 = !DILocation(line: 65, column: 9, scope: !22)
!149 = !DILocation(line: 0, scope: !142)
!150 = !DILocation(line: 117, column: 2, scope: !22)
!151 = !DILocation(line: 121, column: 9, scope: !60)
!152 = !DILocation(line: 122, column: 9, scope: !62)
!153 = !DILocation(line: 124, column: 7, scope: !58)
!154 = !DILocation(line: 125, column: 27, scope: !58)
!155 = !DILocation(line: 125, column: 24, scope: !58)
!156 = !DILocation(line: 125, column: 14, scope: !58)
!157 = !DILocation(line: 127, column: 21, scope: !58)
!158 = !DILocation(line: 127, column: 28, scope: !58)
!159 = !DILocation(line: 127, column: 11, scope: !58)
!160 = !DILocation(line: 0, scope: !109)
!161 = !DILocation(line: 0, scope: !76)
!162 = !DILocation(line: 129, column: 1, scope: !22)
