...
; <label>:6:                                      ; preds = %2
  %7 = fptosi float %0 to i32, !dbg !64
  %8 = icmp eq i32 %7, 0, !dbg !67
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !68
  br i1 %8, label %43, label %9, !dbg !68

; <label>:9:                                      ; preds = %6, %2
  %10 = fmul float %0, %0, !dbg !69
  %11 = fmul float %10, 0x3DA8FAE9C0000000, !dbg !71
  %12 = fsub float 0x3E21EE9EC0000000, %11, !dbg !71
  %13 = fmul float %10, %12, !dbg !72
  %14 = fadd float %13, 0xBE927E4F80000000, !dbg !73
  %15 = fmul float %10, %14, !dbg !74
  %16 = fadd float %15, 0x3EFA01A020000000, !dbg !75
  %17 = fmul float %10, %16, !dbg !76
  %18 = fadd float %17, 0xBF56C16C20000000, !dbg !77
  %19 = fmul float %10, %18, !dbg !78
  %20 = fadd float %19, 0x3FA5555560000000, !dbg !79
  %21 = fmul float %10, %20, !dbg !80
  %22 = icmp ult i32 %4, 1050253722, !dbg !82
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !83
  br i1 %22, label %23, label %30, !dbg !83

; <label>:23:                                     ; preds = %9
  %24 = fmul float %10, 5.000000e-01, !dbg !84
  %25 = fmul float %10, %21, !dbg !85
  %26 = fmul float %0, %1, !dbg !86
  %27 = fsub float %25, %26, !dbg !87
  %28 = fsub float %27, %24, !dbg !88
  %29 = fadd float %28, 1.000000e+00, !dbg !88
  br label %43, !dbg !89

; <label>:30:                                     ; preds = %9
  %31 = icmp ugt i32 %4, 1061683200, !dbg !90
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !91
  %32 = add nsw i32 %4, -16777216, !dbg !93
  %33 = bitcast i32 %32 to float, !dbg !93
  %34 = select i1 %31, float 2.812500e-01, float %33, !dbg !91
  store volatile i32 42, i32* @__A_VARIABLE, align 4
  %35 = fmul float %10, 5.000000e-01, !dbg !94
  %36 = fsub float %35, %34, !dbg !95
  %37 = fsub float 1.000000e+00, %34, !dbg !97
  %38 = fmul float %10, %21, !dbg !99
  %39 = fmul float %0, %1, !dbg !100
  %40 = fsub float %38, %39, !dbg !101
  %41 = fsub float %36, %40, !dbg !102
  %42 = fsub float %37, %41, !dbg !103
  br label %43, !dbg !104

; <label>:43:                                     ; preds = %6, %30, %23
  %44 = phi float [ %29, %23 ], [ %42, %30 ], [ 1.000000e+00, %6 ], !dbg !105
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !106
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !107
  ret float %44, !dbg !107
}
...
!63 = !DILocation(line: 42, column: 5, scope: !26)
!64 = !DILocation(line: 43, column: 10, scope: !65)
!65 = distinct !DILexicalBlock(scope: !66, file: !1, line: 43, column: 9)
!66 = distinct !DILexicalBlock(scope: !62, file: !1, line: 42, column: 20)
!67 = !DILocation(line: 43, column: 17, scope: !65)
!68 = !DILocation(line: 43, column: 9, scope: !66)
!69 = !DILocation(line: 45, column: 8, scope: !26)
!70 = !DILocation(line: 38, column: 13, scope: !26)
!71 = !DILocation(line: 46, column: 38, scope: !26)
!72 = !DILocation(line: 46, column: 32, scope: !26)
!73 = !DILocation(line: 46, column: 30, scope: !26)
!74 = !DILocation(line: 46, column: 26, scope: !26)
!75 = !DILocation(line: 46, column: 24, scope: !26)
!76 = !DILocation(line: 46, column: 20, scope: !26)
!77 = !DILocation(line: 46, column: 18, scope: !26)
!78 = !DILocation(line: 46, column: 14, scope: !26)
!79 = !DILocation(line: 46, column: 12, scope: !26)
!80 = !DILocation(line: 46, column: 8, scope: !26)
!81 = !DILocation(line: 38, column: 15, scope: !26)
!82 = !DILocation(line: 47, column: 8, scope: !55)
!83 = !DILocation(line: 47, column: 5, scope: !26)
!84 = !DILocation(line: 48, column: 30, scope: !55)
!85 = !DILocation(line: 48, column: 37, scope: !55)
!86 = !DILocation(line: 48, column: 43, scope: !55)
!87 = !DILocation(line: 48, column: 40, scope: !55)
!88 = !DILocation(line: 48, column: 17, scope: !55)
!89 = !DILocation(line: 48, column: 6, scope: !55)
!90 = !DILocation(line: 50, column: 12, scope: !53)
!91 = !DILocation(line: 50, column: 9, scope: !54)
!92 = !DILocation(line: 38, column: 17, scope: !26)
!93 = !DILocation(line: 53, column: 10, scope: !51)
!94 = !DILocation(line: 55, column: 21, scope: !54)
!95 = !DILocation(line: 55, column: 23, scope: !54)
!96 = !DILocation(line: 38, column: 10, scope: !26)
!97 = !DILocation(line: 56, column: 14, scope: !54)
!98 = !DILocation(line: 38, column: 8, scope: !26)
!99 = !DILocation(line: 57, column: 25, scope: !54)
!100 = !DILocation(line: 57, column: 29, scope: !54)
!101 = !DILocation(line: 57, column: 27, scope: !54)
!102 = !DILocation(line: 57, column: 21, scope: !54)
!103 = !DILocation(line: 57, column: 15, scope: !54)
!104 = !DILocation(line: 57, column: 6, scope: !54)
!105 = !DILocation(line: 0, scope: !54)
!106 = !DILocation(line: 0, scope: !65)
!107 = !DILocation(line: 59, column: 1, scope: !26)
