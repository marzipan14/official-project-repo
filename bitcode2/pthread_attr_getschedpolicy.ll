...
define dso_local i32 @pthread_attr_getschedpolicy(%struct.pthread_attr_t_**, i32*) local_unnamed_addr #0 !dbg !20 {
  ...
  %4 = icmp ne i32 %3, 0, !dbg !52
  %5 = icmp eq i32* %1, null, !dbg !53
  %6 = or i1 %5, %4, !dbg !54
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !54
  br i1 %6, label %10, label %7, !dbg !54

; <label>:7:                                      ; preds = %2
  %8 = icmp ugt i32* %1, inttoptr (i64 2 to i32*), !dbg !55
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !57
  br i1 %8, label %9, label %10, !dbg !57

; <label>:9:                                      ; preds = %7
  store i32 0, i32* %1, align 4, !dbg !58, !tbaa !59
  br label %10, !dbg !63

; <label>:10:                                     ; preds = %7, %2, %9
  %11 = phi i32 [ 0, %9 ], [ 22, %2 ], [ 22, %7 ], !dbg !64
...
!53 = !DILocation(line: 50, column: 41, scope: !51)
!54 = !DILocation(line: 50, column: 31, scope: !51)
!55 = !DILocation(line: 59, column: 14, scope: !56)
!56 = distinct !DILexicalBlock(scope: !20, file: !1, line: 59, column: 7)
!57 = !DILocation(line: 59, column: 7, scope: !20)
!58 = !DILocation(line: 64, column: 11, scope: !20)
!59 = !{!60, !60, i64 0}
!60 = !{!"int", !61, i64 0}
!61 = !{!"omnipotent char", !62, i64 0}
!62 = !{!"Simple C/C++ TBAA"}
!63 = !DILocation(line: 66, column: 3, scope: !20)
!64 = !DILocation(line: 0, scope: !20)
!65 = !DILocation(line: 0, scope: !66)
!66 = distinct !DILexicalBlock(scope: !51, file: !1, line: 51, column: 5)
!67 = !DILocation(line: 67, column: 1, scope: !20)
