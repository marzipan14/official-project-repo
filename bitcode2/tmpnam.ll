...
define dso_local i8* @_tmpnam_r(%struct._reent*, i8*) local_unnamed_addr #0 !dbg !11 {
  ...
  %4 = getelementptr inbounds %struct._reent, %struct._reent* %0, i64 0, i32 5, i64 0, !dbg !240
  %5 = select i1 %3, i8* %4, i8* %1, !dbg !239
...
; <label>:8:                                      ; preds = %19, %2
  ...
  br i1 %14, label %15, label %19, !dbg !274
...
; <label>:15:                                     ; preds = %8
  ...
  br i1 %18, label %24, label %21, !dbg !285

; <label>:19:                                     ; preds = %8
  %20 = tail call i32 @_close_r(%struct._reent* nonnull %0, i32 %13) #3, !dbg !286
...
; <label>:21:                                     ; preds = %15
  ...
  %22 = load i32, i32* %7, align 8, !dbg !292, !tbaa !294
  %23 = add nsw i32 %22, 1, !dbg !292
  store i32 %23, i32* %7, align 8, !dbg !292, !tbaa !294
  br label %25, !dbg !295

; <label>:24:                                     ; preds = %15
  store i8 0, i8* %5, align 1, !dbg !296, !tbaa !298
...
; <label>:25:                                     ; preds = %24, %21
  %26 = phi i8* [ %5, %21 ], [ null, %24 ], !dbg !301
...
; Function Attrs: noredzone nounwind
define dso_local i8* @_tempnam_r(%struct._reent*, i8*, i8*) local_unnamed_addr #0 !dbg !304 {
  %4 = icmp eq i8* %2, null, !dbg !315
  %5 = select i1 %4, i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str.2, i64 0, i64 0), i8* %2, !dbg !315
  %6 = icmp eq i8* %1, null, !dbg !317
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !319
  br i1 %6, label %7, label %11, !dbg !319

; <label>:7:                                      ; preds = %3
  %8 = tail call i8* @getenv(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.3, i64 0, i64 0)) #3, !dbg !320
  %9 = icmp eq i8* %8, null, !dbg !321
  %10 = select i1 %9, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i8* %8, !dbg !322
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !322
  br label %11, !dbg !322

; <label>:11:                                     ; preds = %7, %3
  %12 = phi i8* [ %10, %7 ], [ %1, %3 ]
  %13 = tail call i64 @strlen(i8* %12) #3, !dbg !323
  %14 = tail call i64 @strlen(i8* %5) #3, !dbg !324
  %15 = add i64 %14, %13, !dbg !325
  %16 = shl i64 %15, 32, !dbg !326
  %17 = add i64 %16, 81604378624, !dbg !326
  %18 = ashr exact i64 %17, 32, !dbg !326
  %19 = tail call i8* @malloc(i64 %18) #3, !dbg !326
  %20 = icmp eq i8* %19, null, !dbg !328
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !330
  br i1 %20, label %44, label %21, !dbg !330

; <label>:21:                                     ; preds = %11
  %22 = tail call i32 @_getpid_r(%struct._reent* %0) #3, !dbg !331
  %23 = ptrtoint %struct._reent* %0 to i64, !dbg !334
  %24 = trunc i64 %23 to i32, !dbg !335
  %25 = xor i32 %22, %24, !dbg !336
  %26 = getelementptr inbounds %struct._reent, %struct._reent* %0, i64 0, i32 4, !dbg !337
  br label %27, !dbg !340

; <label>:27:                                     ; preds = %38, %21
  store volatile i32 42, i32* @__A_VARIABLE, align 4
  %28 = load i32, i32* %26, align 4, !dbg !341, !tbaa !264
  %29 = tail call i32 (%struct._reent*, i8*, i8*, ...) @_sprintf_r(%struct._reent* %0, i8* nonnull %19, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.4, i64 0, i64 0), i8* %12, i8* %5, i32 %25, i32 %28) #3, !dbg !342
  %30 = load i32, i32* %26, align 4, !dbg !343, !tbaa !264
  %31 = add nsw i32 %30, 1, !dbg !343
  store i32 %31, i32* %26, align 4, !dbg !343, !tbaa !264
  %32 = tail call i32 @_open_r(%struct._reent* %0, i8* nonnull %19, i32 0, i32 0) #3, !dbg !344
  %33 = icmp eq i32 %32, -1, !dbg !346
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !347
  br i1 %33, label %34, label %38, !dbg !347

; <label>:34:                                     ; preds = %27
  %35 = getelementptr inbounds %struct._reent, %struct._reent* %0, i64 0, i32 0, !dbg !348
  %36 = load i32, i32* %35, align 8, !dbg !348, !tbaa !278
  %37 = icmp eq i32 %36, 88, !dbg !349
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !350
  br i1 %37, label %41, label %40, !dbg !350

; <label>:38:                                     ; preds = %27
  %39 = tail call i32 @_close_r(%struct._reent* nonnull %0, i32 %32) #3, !dbg !351
...
; <label>:41:                                     ; preds = %34
  store i8 0, i8* %19, align 1, !dbg !355, !tbaa !298
  br label %42, !dbg !356

; <label>:42:                                     ; preds = %41, %40
  %43 = phi i8* [ %19, %40 ], [ null, %41 ]
  store volatile i32 42, i32* @__A_VARIABLE, align 4
  store volatile i32 42, i32* @__A_VARIABLE, align 4
...
; Function Attrs: noredzone nounwind
define dso_local i8* @tempnam(i8*, i8*) local_unnamed_addr #0 !dbg !360 {
  %3 = tail call %struct._reent* @__getreent() #3, !dbg !367
  %4 = tail call i8* @_tempnam_r(%struct._reent* %3, i8* %0, i8* %1) #5, !dbg !368
...
; Function Attrs: noredzone nounwind
define dso_local i8* @tmpnam(i8*) local_unnamed_addr #0 !dbg !370 {
  %2 = tail call %struct._reent* @__getreent() #3, !dbg !376
  %3 = tail call i8* @_tmpnam_r(%struct._reent* %2, i8* %0) #5, !dbg !377
...
!239 = !DILocation(line: 146, column: 7, scope: !11)
!240 = !DILocation(line: 150, column: 16, scope: !241)
!241 = distinct !DILexicalBlock(scope: !238, file: !1, line: 147, column: 5)
!242 = !DILocation(line: 143, column: 9, scope: !11)
...
!286 = !DILocation(line: 133, column: 7, scope: !259, inlinedAt: !261)
!287 = !DILocation(line: 134, column: 5, scope: !248, inlinedAt: !261)
!288 = !DILocation(line: 131, column: 4, scope: !277, inlinedAt: !261)
!289 = !DILocation(line: 135, column: 3, scope: !248, inlinedAt: !261)
!290 = !DILocation(line: 136, column: 1, scope: !248, inlinedAt: !261)
!291 = !DILocation(line: 158, column: 7, scope: !11)
!292 = !DILocation(line: 160, column: 14, scope: !293)
!293 = distinct !DILexicalBlock(scope: !246, file: !1, line: 159, column: 5)
!294 = !{!279, !265, i64 32}
!295 = !DILocation(line: 161, column: 7, scope: !293)
!296 = !DILocation(line: 128, column: 18, scope: !297, inlinedAt: !261)
!297 = distinct !DILexicalBlock(scope: !276, file: !1, line: 127, column: 6)
!298 = !{!266, !266, i64 0}
!299 = !DILocation(line: 129, column: 8, scope: !297, inlinedAt: !261)
!300 = !DILocation(line: 164, column: 3, scope: !11)
!301 = !DILocation(line: 0, scope: !11)
!302 = !DILocation(line: 0, scope: !293)
!303 = !DILocation(line: 165, column: 1, scope: !11)
!304 = distinct !DISubprogram(name: "_tempnam_r", scope: !1, file: !1, line: 168, type: !305, isLocal: false, isDefinition: true, scopeLine: 172, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !307)
!305 = !DISubroutineType(types: !306)
!306 = !{!14, !16, !51, !51}
!307 = !{!308, !309, !310, !311, !312, !313}
!308 = !DILocalVariable(name: "p", arg: 1, scope: !304, file: !1, line: 168, type: !16)
!309 = !DILocalVariable(name: "dir", arg: 2, scope: !304, file: !1, line: 168, type: !51)
!310 = !DILocalVariable(name: "pfx", arg: 3, scope: !304, file: !1, line: 168, type: !51)
!311 = !DILocalVariable(name: "filename", scope: !304, file: !1, line: 173, type: !14)
!312 = !DILocalVariable(name: "length", scope: !304, file: !1, line: 174, type: !5)
!313 = !DILocalVariable(name: "prefix", scope: !304, file: !1, line: 175, type: !51)
!314 = !DILocation(line: 168, column: 1, scope: !304)
!315 = !DILocation(line: 175, column: 25, scope: !304)
!316 = !DILocation(line: 175, column: 16, scope: !304)
!317 = !DILocation(line: 176, column: 11, scope: !318)
!318 = distinct !DILexicalBlock(scope: !304, file: !1, line: 176, column: 7)
!319 = !DILocation(line: 176, column: 19, scope: !318)
!320 = !DILocation(line: 176, column: 29, scope: !318)
!321 = !DILocation(line: 176, column: 48, scope: !318)
!322 = !DILocation(line: 176, column: 7, scope: !304)
!323 = !DILocation(line: 180, column: 12, scope: !304)
!324 = !DILocation(line: 180, column: 27, scope: !304)
!325 = !DILocation(line: 180, column: 25, scope: !304)
!326 = !DILocation(line: 182, column: 14, scope: !304)
!327 = !DILocation(line: 173, column: 9, scope: !304)
!328 = !DILocation(line: 183, column: 7, scope: !329)
!329 = distinct !DILexicalBlock(scope: !304, file: !1, line: 183, column: 7)
!330 = !DILocation(line: 183, column: 7, scope: !304)
!331 = !DILocation(line: 186, column: 7, scope: !332)
!332 = distinct !DILexicalBlock(scope: !333, file: !1, line: 185, column: 11)
!333 = distinct !DILexicalBlock(scope: !329, file: !1, line: 184, column: 5)
!334 = !DILocation(line: 186, column: 29, scope: !332)
!335 = !DILocation(line: 186, column: 23, scope: !332)
!336 = !DILocation(line: 186, column: 21, scope: !332)
!337 = !DILocation(line: 186, column: 51, scope: !332)
!338 = !DILocation(line: 107, column: 1, scope: !248, inlinedAt: !339)
!339 = distinct !DILocation(line: 185, column: 13, scope: !332)
!340 = !DILocation(line: 118, column: 3, scope: !248, inlinedAt: !339)
!341 = !DILocation(line: 121, column: 67, scope: !259, inlinedAt: !339)
!342 = !DILocation(line: 121, column: 7, scope: !259, inlinedAt: !339)
!343 = !DILocation(line: 122, column: 15, scope: !259, inlinedAt: !339)
!344 = !DILocation(line: 123, column: 11, scope: !259, inlinedAt: !339)
!345 = !DILocation(line: 120, column: 11, scope: !259, inlinedAt: !339)
!346 = !DILocation(line: 124, column: 13, scope: !273, inlinedAt: !339)
!347 = !DILocation(line: 124, column: 11, scope: !259, inlinedAt: !339)
!348 = !DILocation(line: 126, column: 13, scope: !276, inlinedAt: !339)
!349 = !DILocation(line: 126, column: 20, scope: !276, inlinedAt: !339)
!350 = !DILocation(line: 126, column: 8, scope: !277, inlinedAt: !339)
!351 = !DILocation(line: 133, column: 7, scope: !259, inlinedAt: !339)
!352 = !DILocation(line: 134, column: 5, scope: !248, inlinedAt: !339)
!353 = !DILocation(line: 131, column: 4, scope: !277, inlinedAt: !339)
!354 = !DILocation(line: 185, column: 11, scope: !333)
!355 = !DILocation(line: 128, column: 18, scope: !297, inlinedAt: !339)
!356 = !DILocation(line: 187, column: 2, scope: !332)
!357 = !DILocation(line: 136, column: 1, scope: !248, inlinedAt: !339)
!358 = !DILocation(line: 0, scope: !332)
!359 = !DILocation(line: 190, column: 1, scope: !304)
!360 = distinct !DISubprogram(name: "tempnam", scope: !1, file: !1, line: 195, type: !361, isLocal: false, isDefinition: true, scopeLine: 198, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !363)
!361 = !DISubroutineType(types: !362)
!362 = !{!14, !51, !51}
!363 = !{!364, !365}
!364 = !DILocalVariable(name: "dir", arg: 1, scope: !360, file: !1, line: 195, type: !51)
!365 = !DILocalVariable(name: "pfx", arg: 2, scope: !360, file: !1, line: 195, type: !51)
!366 = !DILocation(line: 195, column: 1, scope: !360)
!367 = !DILocation(line: 199, column: 22, scope: !360)
!368 = !DILocation(line: 199, column: 10, scope: !360)
!369 = !DILocation(line: 199, column: 3, scope: !360)
!370 = distinct !DISubprogram(name: "tmpnam", scope: !1, file: !1, line: 203, type: !371, isLocal: false, isDefinition: true, scopeLine: 205, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !373)
!371 = !DISubroutineType(types: !372)
!372 = !{!14, !14}
!373 = !{!374}
!374 = !DILocalVariable(name: "s", arg: 1, scope: !370, file: !1, line: 203, type: !14)
!375 = !DILocation(line: 203, column: 1, scope: !370)
!376 = !DILocation(line: 206, column: 21, scope: !370)
!377 = !DILocation(line: 206, column: 10, scope: !370)
!378 = !DILocation(line: 206, column: 3, scope: !370)
