; ModuleID = '/root/.unikraft/apps/redis/build/libpthread-embedded/origin/pthread-embedded-44b41d760a433915d70a7be9809651b0a65e001d/pthread_setcancelstate.c'
source_filename = "/root/.unikraft/apps/redis/build/libpthread-embedded/origin/pthread-embedded-44b41d760a433915d70a7be9809651b0a65e001d/pthread_setcancelstate.c"
...
define dso_local i32 @pthread_setcancelstate(i32, i32*) local_unnamed_addr #0 !dbg !545 {
  %3 = tail call { i8*, i32 } @pthread_self() #3, !dbg !557
  %4 = extractvalue { i8*, i32 } %3, 0, !dbg !557
  %5 = icmp eq i8* %4, null, !dbg !560
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !562
  br i1 %5, label %35, label %6, !dbg !562

; <label>:6:                                      ; preds = %2
  %7 = icmp ugt i32 %0, 1, !dbg !563
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !563
  br i1 %7, label %35, label %8, !dbg !563

; <label>:8:                                      ; preds = %6
  %9 = getelementptr inbounds i8, i8* %4, i64 80, !dbg !564
  %10 = bitcast i8* %9 to %struct.pthread_mutex_t_**, !dbg !564
  %11 = tail call i32 @pthread_mutex_lock(%struct.pthread_mutex_t_** nonnull %10) #3, !dbg !565
  %12 = icmp eq i32* %1, null, !dbg !566
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !568
  %13 = getelementptr inbounds i8, i8* %4, i64 88, !dbg !569
  %14 = bitcast i8* %13 to i32*, !dbg !569
  br i1 %12, label %17, label %15, !dbg !568

; <label>:15:                                     ; preds = %8
  %16 = load i32, i32* %14, align 8, !dbg !571, !tbaa !572
  store i32 %16, i32* %1, align 4, !dbg !579, !tbaa !580
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !581
  br label %17, !dbg !581

; <label>:17:                                     ; preds = %8, %15
  store i32 %0, i32* %14, align 8, !dbg !582, !tbaa !572
  %18 = icmp eq i32 %0, 0, !dbg !583
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !585
  br i1 %18, label %19, label %33, !dbg !585

; <label>:19:                                     ; preds = %17
  %20 = getelementptr inbounds i8, i8* %4, i64 92, !dbg !586
  %21 = bitcast i8* %20 to i32*, !dbg !586
  %22 = load i32, i32* %21, align 4, !dbg !586, !tbaa !587
  %23 = icmp eq i32 %22, 0, !dbg !588
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !589
  br i1 %23, label %24, label %33, !dbg !589

; <label>:24:                                     ; preds = %19
  %25 = bitcast i8* %4 to %struct.uk_thread**, !dbg !590
  %26 = load %struct.uk_thread*, %struct.uk_thread** %25, align 8, !dbg !590, !tbaa !591
  %27 = tail call i32 @pte_osThreadCheckCancel(%struct.uk_thread* %26) #3, !dbg !592
  %28 = icmp eq i32 %27, 4, !dbg !593
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !594
  br i1 %28, label %29, label %33, !dbg !594

; <label>:29:                                     ; preds = %24
  %30 = getelementptr inbounds i8, i8* %4, i64 32, !dbg !595
  %31 = bitcast i8* %30 to i32*, !dbg !595
  store volatile i32 4, i32* %31, align 8, !dbg !597, !tbaa !598
  store i32 1, i32* %14, align 8, !dbg !599, !tbaa !572
  %32 = tail call i32 @pthread_mutex_unlock(%struct.pthread_mutex_t_** nonnull %10) #3, !dbg !600
  tail call void @pte_throw(i32 2) #3, !dbg !601
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !602
  br label %33, !dbg !602

; <label>:33:                                     ; preds = %29, %24, %19, %17
  %34 = tail call i32 @pthread_mutex_unlock(%struct.pthread_mutex_t_** nonnull %10) #3, !dbg !603
  br label %35, !dbg !604

; <label>:35:                                     ; preds = %2, %6, %33
  %36 = phi i32 [ 0, %33 ], [ 22, %6 ], [ 22, %2 ], !dbg !605
...
; Function Attrs: noredzone
declare dso_local i32 @pte_osThreadCheckCancel(%struct.uk_thread*) local_unnamed_addr #1
...
!1 = !DIFile(filename: "/root/.unikraft/apps/redis/build/libpthread-embedded/origin/pthread-embedded-44b41d760a433915d70a7be9809651b0a65e001d/pthread_setcancelstate.c", directory: "/root/.unikraft/apps/redis/build")
!2 = !{!3, !10, !20, !38}
...
!545 = distinct !DISubprogram(name: "pthread_setcancelstate", scope: !1, file: !1, line: 48, type: !546, isLocal: false, isDefinition: true, scopeLine: 87, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !548)
!546 = !DISubroutineType(types: !547)
!547 = !{!22, !22, !162}
!548 = !{!549, !550, !551, !552, !553}
!549 = !DILocalVariable(name: "state", arg: 1, scope: !545, file: !1, line: 48, type: !22)
!550 = !DILocalVariable(name: "oldstate", arg: 2, scope: !545, file: !1, line: 48, type: !162)
!551 = !DILocalVariable(name: "result", scope: !545, file: !1, line: 88, type: !22)
!552 = !DILocalVariable(name: "self", scope: !545, file: !1, line: 89, type: !497)
!553 = !DILocalVariable(name: "sp", scope: !545, file: !1, line: 90, type: !48)
!554 = !DILocation(line: 48, column: 29, scope: !545)
!555 = !DILocation(line: 48, column: 41, scope: !545)
!556 = !DILocation(line: 88, column: 7, scope: !545)
!557 = !DILocation(line: 89, column: 20, scope: !545)
!558 = !DILocation(line: 89, column: 13, scope: !545)
!559 = !DILocation(line: 90, column: 18, scope: !545)
!560 = !DILocation(line: 92, column: 10, scope: !561)
!561 = distinct !DILexicalBlock(scope: !545, file: !1, line: 92, column: 7)
!562 = !DILocation(line: 93, column: 7, scope: !561)
!563 = !DILocation(line: 93, column: 42, scope: !561)
!564 = !DILocation(line: 101, column: 35, scope: !545)
!565 = !DILocation(line: 101, column: 10, scope: !545)
!566 = !DILocation(line: 103, column: 16, scope: !567)
!567 = distinct !DILexicalBlock(scope: !545, file: !1, line: 103, column: 7)
!568 = !DILocation(line: 103, column: 7, scope: !545)
!569 = !DILocation(line: 0, scope: !570)
!570 = distinct !DILexicalBlock(scope: !567, file: !1, line: 104, column: 5)
!571 = !DILocation(line: 105, column: 23, scope: !570)
!572 = !{!573, !578, i64 88}
...
!578 = !{!"int", !575, i64 0}
!579 = !DILocation(line: 105, column: 17, scope: !570)
!580 = !{!578, !578, i64 0}
!581 = !DILocation(line: 106, column: 5, scope: !570)
!582 = !DILocation(line: 108, column: 19, scope: !545)
!583 = !DILocation(line: 113, column: 13, scope: !584)
!584 = distinct !DILexicalBlock(scope: !545, file: !1, line: 113, column: 7)
!585 = !DILocation(line: 114, column: 7, scope: !584)
!586 = !DILocation(line: 114, column: 15, scope: !584)
!587 = !{!573, !578, i64 92}
!588 = !DILocation(line: 114, column: 26, scope: !584)
!589 = !DILocation(line: 115, column: 7, scope: !584)
!590 = !DILocation(line: 115, column: 39, scope: !584)
!591 = !{!573, !574, i64 0}
!592 = !DILocation(line: 115, column: 11, scope: !584)
!593 = !DILocation(line: 115, column: 49, scope: !584)
!594 = !DILocation(line: 113, column: 7, scope: !545)
!595 = !DILocation(line: 117, column: 11, scope: !596)
!596 = distinct !DILexicalBlock(scope: !584, file: !1, line: 116, column: 5)
!597 = !DILocation(line: 117, column: 17, scope: !596)
!598 = !{!573, !575, i64 32}
!599 = !DILocation(line: 118, column: 23, scope: !596)
!600 = !DILocation(line: 119, column: 14, scope: !596)
!601 = !DILocation(line: 120, column: 7, scope: !596)
!602 = !DILocation(line: 123, column: 5, scope: !596)
!603 = !DILocation(line: 125, column: 10, scope: !545)
!604 = !DILocation(line: 127, column: 3, scope: !545)
!605 = !DILocation(line: 0, scope: !545)
!606 = !DILocation(line: 0, scope: !607)
!607 = distinct !DILexicalBlock(scope: !561, file: !1, line: 94, column: 5)
!608 = !DILocation(line: 129, column: 1, scope: !545)
