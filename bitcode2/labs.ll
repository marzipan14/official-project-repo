...
define dso_local i64 @labs(i64) local_unnamed_addr #0 !dbg !7 {
  ...
  br i1 %2, label %3, label %5, !dbg !16

; <label>:3:                                      ; preds = %1
  %4 = sub nsw i64 0, %0, !dbg !17
...
!16 = !DILocation(line: 44, column: 7, scope: !7)
!17 = !DILocation(line: 46, column: 11, scope: !18)
!18 = distinct !DILexicalBlock(scope: !15, file: !1, line: 45, column: 5)
!19 = !DILocation(line: 47, column: 5, scope: !18)
!20 = !DILocation(line: 48, column: 3, scope: !7)
