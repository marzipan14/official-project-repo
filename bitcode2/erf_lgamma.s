...
# %bb.36:
	...
	jbe	.LBB0_39
# %bb.37:
	movss	.LCPI0_7(%rip), %xmm7   # xmm7 = mem[0],zero,zero,zero
...
# %bb.50:
	...
	mulss	%xmm5, %xmm3
	addss	.LCPI0_19(%rip), %xmm3
	mulss	%xmm5, %xmm3
	addss	.LCPI0_20(%rip), %xmm3
	mulss	%xmm5, %xmm3
	addss	.LCPI0_21(%rip), %xmm3
	mulss	%xmm5, %xmm3
	addss	.LCPI0_22(%rip), %xmm3
	mulss	%xmm5, %xmm3
	addss	.LCPI0_23(%rip), %xmm3
	mulss	%xmm5, %xmm3
	addss	.LCPI0_24(%rip), %xmm3
...
# %bb.42:
	xorps	%xmm0, %xmm0
	movss	.LCPI0_34(%rip), %xmm7  # xmm7 = mem[0],zero,zero,zero
.LBB0_38:
	movl	$42, __A_VARIABLE(%rip)
	subss	%xmm5, %xmm7
	movl	$42, __A_VARIABLE(%rip)
...
.LBB0_39:
	...
	jbe	.LBB0_40
# %bb.45:
	movss	.LCPI0_36(%rip), %xmm1  # xmm1 = mem[0],zero,zero,zero
	movaps	-48(%rbp), %xmm5        # 16-byte Reload
	jmp	.LBB0_46
.LBB0_43:
	movl	$42, __A_VARIABLE(%rip)
	cmpl	$1067296287, %ebx       # imm = 0x3F9DA61F
	jbe	.LBB0_47
# %bb.44:
	xorps	%xmm0, %xmm0
	movss	.LCPI0_35(%rip), %xmm1  # xmm1 = mem[0],zero,zero,zero
.LBB0_46:
	addss	%xmm1, %xmm5
	movl	$42, __A_VARIABLE(%rip)
	movl	$42, __A_VARIABLE(%rip)
	...
	movaps	%xmm5, %xmm1
	mulss	%xmm2, %xmm1
	movss	.LCPI0_47(%rip), %xmm7  # xmm7 = mem[0],zero,zero,zero
	mulss	%xmm1, %xmm7
	addss	.LCPI0_48(%rip), %xmm7
	mulss	%xmm1, %xmm7
	addss	.LCPI0_49(%rip), %xmm7
	mulss	%xmm1, %xmm7
	addss	.LCPI0_50(%rip), %xmm7
	mulss	%xmm1, %xmm7
	addss	.LCPI0_51(%rip), %xmm7
	...
	subss	%xmm4, %xmm1
	subss	%xmm1, %xmm7
	addss	.LCPI0_63(%rip), %xmm7
	addss	%xmm0, %xmm7
	jmp	.LBB0_61
.LBB0_59:
	addss	.LCPI0_10(%rip), %xmm7
	mulss	-48(%rbp), %xmm7        # 16-byte Folded Reload
.LBB0_60:
	movss	-64(%rbp), %xmm6        # 4-byte Reload
                                        # xmm6 = mem[0],zero,zero,zero
	jmp	.LBB0_61
