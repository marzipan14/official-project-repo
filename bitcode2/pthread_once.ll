...
define dso_local i32 @pthread_once(%struct.pthread_once_t_*, void ()*) local_unnamed_addr #0 !dbg !477 {
  ...
  br i1 %8, label %68, label %9, !dbg !516

; <label>:9:                                      ; preds = %2
  %10 = getelementptr inbounds %struct.pthread_once_t_, %struct.pthread_once_t_* %0, i64 0, i32 0
  %11 = bitcast %struct.pte_cleanup_t* %4 to i8*
  %12 = bitcast %struct.pthread_once_t_* %0 to i8*
  %13 = getelementptr inbounds %struct.pthread_once_t_, %struct.pthread_once_t_* %0, i64 0, i32 1
  %14 = bitcast i8** %13 to i64*
  %15 = getelementptr inbounds %struct.pthread_once_t_, %struct.pthread_once_t_* %0, i64 0, i32 2
  %16 = bitcast i8** %13 to %struct.uk_semaphore**
  %17 = bitcast %struct.uk_semaphore** %3 to i64*
  br label %18, !dbg !518

; <label>:18:                                     ; preds = %9, %67
  %19 = load i32, i32* %10, align 8, !dbg !518, !tbaa !519
  %20 = cmpxchg i32* %10, i32 0, i32 1 seq_cst seq_cst, !dbg !525
  %21 = extractvalue { i32, i1 } %20, 1, !dbg !525
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !525
  br i1 %21, label %23, label %22, !dbg !525
...
; <label>:23:                                     ; preds = %22, %18
  %24 = icmp eq i32 %19, 2, !dbg !527
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !528
  br i1 %24, label %68, label %25, !dbg !528

; <label>:25:                                     ; preds = %23
  %26 = icmp eq i32 %19, 0, !dbg !529
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !530
  br i1 %26, label %27, label %36, !dbg !530

; <label>:27:                                     ; preds = %25
  call void @llvm.lifetime.start.p0i8(i64 24, i8* nonnull %11) #4, !dbg !531
  call void @pte_push_cleanup(%struct.pte_cleanup_t* nonnull %4, void (i8*)* nonnull @pte_once_init_routine_cleanup, i8* nonnull %12) #5, !dbg !531
  call void %1() #5, !dbg !532
  %28 = call %struct.pte_cleanup_t* @pte_pop_cleanup(i32 0) #5, !dbg !533
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %11) #4, !dbg !534
  %29 = atomicrmw xchg i32* %10, i32 2 seq_cst, !dbg !535
  %30 = atomicrmw add i64* %14, i64 0 seq_cst, !dbg !536
  %31 = icmp eq i64 %30, 0, !dbg !536
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !538
  br i1 %31, label %67, label %32, !dbg !538

; <label>:32:                                     ; preds = %27
  %33 = load %struct.uk_semaphore*, %struct.uk_semaphore** %16, align 8, !dbg !539, !tbaa !541
  %34 = load i32, i32* %15, align 8, !dbg !542, !tbaa !543
  %35 = call i32 @pte_osSemaphorePost(%struct.uk_semaphore* %33, i32 %34) #5, !dbg !544
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !545
  br label %67, !dbg !545

; <label>:36:                                     ; preds = %25
  %37 = atomicrmw add i32* %15, i32 1 seq_cst, !dbg !546
  %38 = atomicrmw add i64* %14, i64 0 seq_cst, !dbg !547
  %39 = icmp eq i64 %38, 0, !dbg !547
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !548
  br i1 %39, label %40, label %52, !dbg !548

; <label>:40:                                     ; preds = %36
  %41 = call i32 @pte_osSemaphoreCreate(i32 0, %struct.uk_semaphore** nonnull %3) #5, !dbg !550
  %42 = load i64, i64* %14, align 8, !dbg !551, !tbaa !552
  %43 = load i64, i64* %17, align 8, !dbg !554, !tbaa !555
  %44 = cmpxchg i64* %14, i64 0, i64 %43 seq_cst seq_cst, !dbg !554
  %45 = extractvalue { i64, i1 } %44, 1, !dbg !554
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !554
  br i1 %45, label %47, label %46, !dbg !554
...
; <label>:47:                                     ; preds = %46, %40
  %48 = load %struct.uk_semaphore*, %struct.uk_semaphore** %3, align 8, !dbg !554
  %49 = icmp eq i64 %42, 0, !dbg !556
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !557
  br i1 %49, label %52, label %50, !dbg !557

; <label>:50:                                     ; preds = %47
  %51 = call i32 @pte_osSemaphoreDelete(%struct.uk_semaphore* %48) #5, !dbg !558
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !560
  br label %52, !dbg !560

; <label>:52:                                     ; preds = %47, %36, %50
  %53 = atomicrmw add i32* %10, i32 0 seq_cst, !dbg !561
  %54 = icmp eq i32 %53, 1, !dbg !563
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !564
  br i1 %54, label %55, label %58, !dbg !564

; <label>:55:                                     ; preds = %52
  %56 = load %struct.uk_semaphore*, %struct.uk_semaphore** %16, align 8, !dbg !565, !tbaa !541
  %57 = call i32 @pte_osSemaphorePend(%struct.uk_semaphore* %56, i32* null) #5, !dbg !567
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !568
  br label %58, !dbg !568

; <label>:58:                                     ; preds = %55, %52
  %59 = atomicrmw add i32* %15, i32 -1 seq_cst, !dbg !569
  %60 = icmp eq i32 %59, 1, !dbg !571
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !572
  br i1 %60, label %61, label %67, !dbg !572

; <label>:61:                                     ; preds = %58
  %62 = atomicrmw xchg i64* %14, i64 0 seq_cst, !dbg !573
  %63 = inttoptr i64 %62 to %struct.uk_semaphore*, !dbg !576
  store %struct.uk_semaphore* %63, %struct.uk_semaphore** %3, align 8, !dbg !577, !tbaa !555
  %64 = icmp eq i64 %62, 0, !dbg !577
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !578
  br i1 %64, label %67, label %65, !dbg !578

; <label>:65:                                     ; preds = %61
  %66 = call i32 @pte_osSemaphoreDelete(%struct.uk_semaphore* %63) #5, !dbg !579
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !581
  br label %67, !dbg !581

; <label>:67:                                     ; preds = %27, %61, %58, %65, %32
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !528
  br label %18, !dbg !528, !llvm.loop !582

; <label>:68:                                     ; preds = %23, %2
  %69 = phi i32 [ 22, %2 ], [ 0, %23 ], !dbg !584
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %5) #4, !dbg !587
...
; Function Attrs: noredzone nounwind
define internal void @pte_once_init_routine_cleanup(i8* nocapture) #0 !dbg !589 {
  %2 = bitcast i8* %0 to i32*, !dbg !595
  %3 = atomicrmw xchg i32* %2, i32 0 seq_cst, !dbg !595
  %4 = getelementptr inbounds i8, i8* %0, i64 8, !dbg !596
  %5 = bitcast i8* %4 to i64*, !dbg !596
  %6 = atomicrmw add i64* %5, i64 0 seq_cst, !dbg !596
  %7 = icmp eq i64 %6, 0, !dbg !596
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !598
  br i1 %7, label %12, label %8, !dbg !598

; <label>:8:                                      ; preds = %1
  %9 = bitcast i8* %4 to %struct.uk_semaphore**, !dbg !599
  %10 = load %struct.uk_semaphore*, %struct.uk_semaphore** %9, align 8, !dbg !599, !tbaa !541
  %11 = tail call i32 @pte_osSemaphorePost(%struct.uk_semaphore* %10, i32 1) #5, !dbg !601
...
!517 = !DILocation(line: 0, scope: !477)
!518 = !DILocation(line: 118, column: 13, scope: !487)
!519 = !{!520, !521, i64 0}
!520 = !{!"pthread_once_t_", !521, i64 0, !524, i64 8, !521, i64 16, !521, i64 20}
!521 = !{!"int", !522, i64 0}
!522 = !{!"omnipotent char", !523, i64 0}
!523 = !{!"Simple C/C++ TBAA"}
!524 = !{!"any pointer", !522, i64 0}
!525 = !DILocation(line: 118, column: 13, scope: !489)
!526 = !DILocation(line: 104, column: 7, scope: !477)
!527 = !DILocation(line: 121, column: 10, scope: !477)
!528 = !DILocation(line: 117, column: 3, scope: !477)
!529 = !DILocation(line: 123, column: 25, scope: !493)
!530 = !DILocation(line: 123, column: 11, scope: !494)
!531 = !DILocation(line: 127, column: 11, scope: !491)
!532 = !DILocation(line: 128, column: 11, scope: !491)
!533 = !DILocation(line: 129, column: 11, scope: !491)
!534 = !DILocation(line: 129, column: 11, scope: !492)
!535 = !DILocation(line: 131, column: 18, scope: !492)
!536 = !DILocation(line: 137, column: 15, scope: !537)
!537 = distinct !DILexicalBlock(scope: !492, file: !1, line: 137, column: 15)
!538 = !DILocation(line: 137, column: 15, scope: !492)
!539 = !DILocation(line: 139, column: 73, scope: !540)
!540 = distinct !DILexicalBlock(scope: !537, file: !1, line: 138, column: 13)
!541 = !{!520, !524, i64 8}
!542 = !DILocation(line: 139, column: 97, scope: !540)
!543 = !{!520, !521, i64 16}
!544 = !DILocation(line: 139, column: 15, scope: !540)
!545 = !DILocation(line: 140, column: 13, scope: !540)
!546 = !DILocation(line: 144, column: 11, scope: !507)
!547 = !DILocation(line: 146, column: 16, scope: !506)
!548 = !DILocation(line: 146, column: 15, scope: !507)
!549 = !DILocation(line: 105, column: 25, scope: !477)
!550 = !DILocation(line: 148, column: 15, scope: !505)
!551 = !DILocation(line: 150, column: 19, scope: !503)
!552 = !{!553, !553, i64 0}
!553 = !{!"long", !522, i64 0}
!554 = !DILocation(line: 150, column: 19, scope: !509)
!555 = !{!524, !524, i64 0}
!556 = !DILocation(line: 150, column: 19, scope: !504)
!557 = !DILocation(line: 150, column: 19, scope: !505)
!558 = !DILocation(line: 154, column: 19, scope: !559)
!559 = distinct !DILexicalBlock(scope: !504, file: !1, line: 153, column: 17)
!560 = !DILocation(line: 155, column: 17, scope: !559)
!561 = !DILocation(line: 162, column: 15, scope: !562)
!562 = distinct !DILexicalBlock(scope: !507, file: !1, line: 162, column: 15)
!563 = !DILocation(line: 162, column: 65, scope: !562)
!564 = !DILocation(line: 162, column: 15, scope: !507)
!565 = !DILocation(line: 164, column: 73, scope: !566)
!566 = distinct !DILexicalBlock(scope: !562, file: !1, line: 163, column: 13)
!567 = !DILocation(line: 164, column: 15, scope: !566)
!568 = !DILocation(line: 165, column: 13, scope: !566)
!569 = !DILocation(line: 167, column: 20, scope: !570)
!570 = distinct !DILexicalBlock(scope: !507, file: !1, line: 167, column: 15)
!571 = !DILocation(line: 167, column: 17, scope: !570)
!572 = !DILocation(line: 167, column: 15, scope: !507)
!573 = !DILocation(line: 171, column: 46, scope: !574)
!574 = distinct !DILexicalBlock(scope: !575, file: !1, line: 170, column: 19)
!575 = distinct !DILexicalBlock(scope: !570, file: !1, line: 168, column: 13)
!576 = !DILocation(line: 171, column: 22, scope: !574)
!577 = !DILocation(line: 170, column: 25, scope: !574)
!578 = !DILocation(line: 170, column: 19, scope: !575)
!579 = !DILocation(line: 173, column: 19, scope: !580)
!580 = distinct !DILexicalBlock(scope: !574, file: !1, line: 172, column: 17)
!581 = !DILocation(line: 174, column: 17, scope: !580)
!582 = distinct !{!582, !528, !583}
!583 = !DILocation(line: 177, column: 5, scope: !477)
!584 = !DILocation(line: 0, scope: !585)
!585 = distinct !DILexicalBlock(scope: !514, file: !1, line: 113, column: 5)
!586 = !DILocation(line: 103, column: 7, scope: !477)
!587 = !DILocation(line: 186, column: 1, scope: !477)
!588 = !DILocation(line: 185, column: 3, scope: !477)
!589 = distinct !DISubprogram(name: "pte_once_init_routine_cleanup", scope: !1, file: !1, line: 52, type: !15, isLocal: true, isDefinition: true, scopeLine: 53, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !590)
!590 = !{!591, !592}
!591 = !DILocalVariable(name: "arg", arg: 1, scope: !589, file: !1, line: 52, type: !11)
!592 = !DILocalVariable(name: "once_control", scope: !589, file: !1, line: 54, type: !465)
!593 = !DILocation(line: 52, column: 38, scope: !589)
!594 = !DILocation(line: 54, column: 20, scope: !589)
!595 = !DILocation(line: 56, column: 10, scope: !589)
!596 = !DILocation(line: 58, column: 7, scope: !597)
!597 = distinct !DILexicalBlock(scope: !589, file: !1, line: 58, column: 7)
!598 = !DILocation(line: 58, column: 7, scope: !589)
!599 = !DILocation(line: 60, column: 65, scope: !600)
!600 = distinct !DILexicalBlock(scope: !597, file: !1, line: 59, column: 5)
!601 = !DILocation(line: 60, column: 7, scope: !600)
!602 = !DILocation(line: 61, column: 5, scope: !600)
!603 = !DILocation(line: 62, column: 1, scope: !589)
