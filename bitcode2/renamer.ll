; ModuleID = '/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/reent/renamer.c'
source_filename = "/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/reent/renamer.c"
...
define dso_local i32 @_rename_r(%struct._reent*, i8*, i8*) local_unnamed_addr #0 !dbg !7 {
  %4 = tail call i32 @_link_r(%struct._reent* %0, i8* %1, i8* %2) #3, !dbg !237
...
; <label>:7:                                      ; preds = %3
  %8 = tail call i32 @_unlink_r(%struct._reent* %0, i8* %1) #3, !dbg !242
  %9 = icmp eq i32 %8, -1, !dbg !244
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !245
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !246
  %10 = sext i1 %9 to i32, !dbg !247
  br label %11, !dbg !247

; <label>:11:                                     ; preds = %7, %6
  %12 = phi i32 [ -1, %6 ], [ %10, %7 ], !dbg !246
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !249
  ret i32 %12, !dbg !249
}

; Function Attrs: noredzone
declare dso_local i32 @_link_r(%struct._reent*, i8*, i8*) local_unnamed_addr #1
...
!1 = !DIFile(filename: "/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/reent/renamer.c", directory: "/root/.unikraft/apps/redis/build")
!2 = !{}
!3 = !{i32 2, !"Dwarf Version", i32 4}
!4 = !{i32 2, !"Debug Info Version", i32 3}
!5 = !{i32 1, !"wchar_size", i32 4}
!6 = !{!"clang version 7.0.1-8+deb10u2 (tags/RELEASE_701/final)"}
!7 = distinct !DISubprogram(name: "_rename_r", scope: !1, file: !1, line: 50, type: !8, isLocal: false, isDefinition: true, scopeLine: 54, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !230)
...
!230 = !{!231, !232, !233, !234}
!231 = !DILocalVariable(name: "ptr", arg: 1, scope: !7, file: !1, line: 50, type: !11)
!232 = !DILocalVariable(name: "old", arg: 2, scope: !7, file: !1, line: 50, type: !50)
!233 = !DILocalVariable(name: "new", arg: 3, scope: !7, file: !1, line: 50, type: !50)
!234 = !DILocalVariable(name: "ret", scope: !7, file: !1, line: 55, type: !10)
!235 = !DILocation(line: 50, column: 1, scope: !7)
!236 = !DILocation(line: 55, column: 7, scope: !7)
!237 = !DILocation(line: 62, column: 7, scope: !238)
!238 = distinct !DILexicalBlock(scope: !7, file: !1, line: 62, column: 7)
!239 = !DILocation(line: 62, column: 31, scope: !238)
!240 = !DILocation(line: 62, column: 7, scope: !7)
!241 = !DILocation(line: 63, column: 5, scope: !238)
!242 = !DILocation(line: 65, column: 7, scope: !243)
!243 = distinct !DILexicalBlock(scope: !7, file: !1, line: 65, column: 7)
!244 = !DILocation(line: 65, column: 28, scope: !243)
!245 = !DILocation(line: 65, column: 7, scope: !7)
!246 = !DILocation(line: 0, scope: !7)
!247 = !DILocation(line: 68, column: 7, scope: !248)
!248 = distinct !DILexicalBlock(scope: !243, file: !1, line: 66, column: 5)
!249 = !DILocation(line: 72, column: 1, scope: !7)
