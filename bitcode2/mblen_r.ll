...
define dso_local i32 @_mblen_r(%struct._reent* nocapture readnone, i8* readonly, i64, %struct._mbstate_t* nocapture readnone) local_unnamed_addr #0 !dbg !9 {
  ...
  br i1 %5, label %9, label %6, !dbg !299
...
!306 = !DILocation(line: 71, column: 5, scope: !298)
!307 = !DILocation(line: 72, column: 9, scope: !308)
!308 = distinct !DILexicalBlock(scope: !9, file: !1, line: 72, column: 7)
!309 = !DILocation(line: 72, column: 7, scope: !9)
!310 = !DILocation(line: 0, scope: !9)
!311 = !DILocation(line: 73, column: 5, scope: !308)
!312 = !DILocation(line: 76, column: 1, scope: !9)
