...
; Function Attrs: noredzone nounwind
define dso_local i32 @__srget(%struct.__sFILE*) local_unnamed_addr #0 !dbg !273 {
  %2 = tail call %struct._reent* @__getreent() #3, !dbg !279
  %3 = icmp eq %struct._reent* %2, null, !dbg !283
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !283
  br i1 %3, label %9, label %4, !dbg !283

; <label>:4:                                      ; preds = %1
  %5 = getelementptr inbounds %struct._reent, %struct._reent* %2, i64 0, i32 8, !dbg !283
  %6 = load i32, i32* %5, align 8, !dbg !283, !tbaa !242
  %7 = icmp eq i32 %6, 0, !dbg !283
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !282
  br i1 %7, label %8, label %9, !dbg !282

; <label>:8:                                      ; preds = %4
  tail call void @__sinit(%struct._reent* nonnull %2) #3, !dbg !283
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !283
  br label %9, !dbg !283

; <label>:9:                                      ; preds = %8, %4, %1
  %10 = tail call i32 @__srefill_r(%struct._reent* %2, %struct.__sFILE* %0) #3, !dbg !284
  %11 = icmp eq i32 %10, 0, !dbg !285
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !286
  br i1 %11, label %12, label %21, !dbg !286

; <label>:12:                                     ; preds = %9
  %13 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %0, i64 0, i32 1, !dbg !287
  %14 = load i32, i32* %13, align 8, !dbg !288, !tbaa !258
  %15 = add nsw i32 %14, -1, !dbg !288
  store i32 %15, i32* %13, align 8, !dbg !288, !tbaa !258
  %16 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %0, i64 0, i32 0, !dbg !289
  %17 = load i8*, i8** %16, align 8, !dbg !290, !tbaa !266
  %18 = getelementptr inbounds i8, i8* %17, i64 1, !dbg !290
  store i8* %18, i8** %16, align 8, !dbg !290, !tbaa !266
  %19 = load i8, i8* %17, align 1, !dbg !291, !tbaa !268
  %20 = zext i8 %19 to i32, !dbg !291
  br label %21, !dbg !292

; <label>:21:                                     ; preds = %9, %12
  %22 = phi i32 [ %20, %12 ], [ -1, %9 ], !dbg !293
...
!272 = !DILocation(line: 49, column: 1, scope: !7)
!273 = distinct !DISubprogram(name: "__srget", scope: !1, file: !1, line: 55, type: !274, isLocal: false, isDefinition: true, scopeLine: 57, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !276)
!274 = !DISubroutineType(types: !275)
!275 = !{!10, !230}
!276 = !{!277}
!277 = !DILocalVariable(name: "fp", arg: 1, scope: !273, file: !1, line: 55, type: !230)
!278 = !DILocation(line: 55, column: 1, scope: !273)
!279 = !DILocation(line: 58, column: 21, scope: !273)
!280 = !DILocation(line: 35, column: 1, scope: !7, inlinedAt: !281)
!281 = distinct !DILocation(line: 58, column: 10, scope: !273)
!282 = !DILocation(line: 41, column: 3, scope: !237, inlinedAt: !281)
!283 = !DILocation(line: 41, column: 3, scope: !241, inlinedAt: !281)
!284 = !DILocation(line: 43, column: 7, scope: !252, inlinedAt: !281)
!285 = !DILocation(line: 43, column: 29, scope: !252, inlinedAt: !281)
!286 = !DILocation(line: 43, column: 7, scope: !7, inlinedAt: !281)
!287 = !DILocation(line: 45, column: 11, scope: !256, inlinedAt: !281)
!288 = !DILocation(line: 45, column: 13, scope: !256, inlinedAt: !281)
!289 = !DILocation(line: 46, column: 19, scope: !256, inlinedAt: !281)
!290 = !DILocation(line: 46, column: 21, scope: !256, inlinedAt: !281)
!291 = !DILocation(line: 46, column: 14, scope: !256, inlinedAt: !281)
!292 = !DILocation(line: 46, column: 7, scope: !256, inlinedAt: !281)
!293 = !DILocation(line: 0, scope: !7, inlinedAt: !281)
!294 = !DILocation(line: 0, scope: !273)
!295 = !DILocation(line: 49, column: 1, scope: !7, inlinedAt: !281)
!296 = !DILocation(line: 58, column: 3, scope: !273)
