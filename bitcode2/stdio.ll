...
define dso_local i64 @__swrite(%struct._reent*, i8* nocapture, i8*, i32) local_unnamed_addr #0 !dbg !277 {
  ...
  %10 = getelementptr inbounds i8, i8* %1, i64 18, !dbg !290
  %11 = bitcast i8* %10 to i16*, !dbg !290
  br i1 %9, label %17, label %12, !dbg !289
...
!289 = !DILocation(line: 88, column: 7, scope: !277)
!290 = !DILocation(line: 0, scope: !287)
