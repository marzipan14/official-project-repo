...
; <label>:7:                                      ; preds = %5
  ...
  %9 = icmp sgt i32 %8, 0, !dbg !43
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !45
  br i1 %9, label %10, label %21, !dbg !45

; <label>:10:                                     ; preds = %7, %10
  %11 = phi i32 [ %13, %10 ], [ -126, %7 ]
  %12 = phi i32 [ %14, %10 ], [ %8, %7 ]
  %13 = add nsw i32 %11, -1, !dbg !46
  %14 = shl i32 %12, 1, !dbg !47
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !48
  %15 = icmp sgt i32 %14, 0, !dbg !43
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !45
  br i1 %15, label %10, label %21, !dbg !45, !llvm.loop !49

; <label>:16:                                     ; preds = %5
  %17 = icmp ult i32 %3, 2139095040, !dbg !51
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !53
  br i1 %17, label %18, label %21, !dbg !53

; <label>:18:                                     ; preds = %16
  %19 = lshr i32 %3, 23, !dbg !54
  %20 = add nsw i32 %19, -127, !dbg !55
  br label %21, !dbg !56

; <label>:21:                                     ; preds = %10, %16, %7, %1, %18
  %22 = phi i32 [ %20, %18 ], [ -2147483647, %1 ], [ -126, %7 ], [ 2147483647, %16 ], [ %13, %10 ], !dbg !57
...
!42 = !DILocation(line: 33, column: 11, scope: !40)
!43 = !DILocation(line: 33, column: 31, scope: !44)
!44 = distinct !DILexicalBlock(scope: !40, file: !1, line: 33, column: 6)
!45 = !DILocation(line: 33, column: 6, scope: !40)
!46 = !DILocation(line: 33, column: 46, scope: !44)
!47 = !DILocation(line: 33, column: 37, scope: !44)
!48 = !DILocation(line: 33, column: 6, scope: !44)
!49 = distinct !{!49, !45, !50}
!50 = !DILocation(line: 33, column: 48, scope: !40)
!51 = !DILocation(line: 39, column: 12, scope: !52)
!52 = distinct !DILexicalBlock(scope: !36, file: !1, line: 39, column: 11)
!53 = !DILocation(line: 39, column: 11, scope: !36)
!54 = !DILocation(line: 40, column: 17, scope: !52)
!55 = !DILocation(line: 40, column: 22, scope: !52)
!56 = !DILocation(line: 40, column: 7, scope: !52)
!57 = !DILocation(line: 0, scope: !52)
!58 = !DILocation(line: 0, scope: !33)
