...
; <label>:6:                                      ; preds = %3
  ...
  br i1 %9, label %10, label %44, !dbg !567
...
; <label>:23:                                     ; preds = %16
  store %struct.sem_t_* null, %struct.sem_t_** %0, align 8, !dbg !588, !tbaa !558
  store i32 2147483647, i32* %11, align 8, !dbg !590, !tbaa !569
  %24 = tail call i32 @pthread_mutex_unlock(%struct.pthread_mutex_t_** nonnull %7) #7, !dbg !591
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !592
  br label %25, !dbg !592

; <label>:25:                                     ; preds = %37, %23
  %26 = tail call i64 asm sideeffect "mov %rsp, $0", "=r,~{dirflag},~{fpsr},~{flags}"() #6, !dbg !593, !srcloc !617
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !619
  %27 = and i64 %26, -65536, !dbg !621
  %28 = inttoptr i64 %27 to %struct.uk_thread**, !dbg !622
  %29 = load %struct.uk_thread*, %struct.uk_thread** %28, align 65536, !dbg !624, !tbaa !558
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !625
  %30 = icmp eq %struct.uk_thread* %29, null, !dbg !627
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !630
  br i1 %30, label %31, label %32, !dbg !630, !prof !631

; <label>:31:                                     ; preds = %25
  tail call void (i8*, ...) @uk_pr_crit(i8* undef, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.1, i64 0, i64 0)) #7, !dbg !632
  tail call void @ukplat_terminate(i32 3) #8, !dbg !632
  unreachable

; <label>:32:                                     ; preds = %25
  %33 = getelementptr inbounds %struct.uk_thread, %struct.uk_thread* %29, i64 0, i32 9, !dbg !634
  %34 = load %struct.uk_sched*, %struct.uk_sched** %33, align 8, !dbg !634, !tbaa !635
  %35 = icmp eq %struct.uk_sched* %34, null, !dbg !642
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !645
  br i1 %35, label %36, label %37, !dbg !645, !prof !631

; <label>:36:                                     ; preds = %32
  tail call void (i8*, ...) @uk_pr_crit(i8* undef, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i64 0, i64 0)) #7, !dbg !646
  tail call void @ukplat_terminate(i32 3) #8, !dbg !646
  unreachable

; <label>:37:                                     ; preds = %32
  %38 = getelementptr inbounds %struct.uk_sched, %struct.uk_sched* %34, i64 0, i32 0, !dbg !648
  %39 = load void (%struct.uk_sched*)*, void (%struct.uk_sched*)** %38, align 8, !dbg !648, !tbaa !649
  tail call void %39(%struct.uk_sched* nonnull %34) #7, !dbg !653
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !654
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !655
  %40 = tail call i32 @pthread_mutex_destroy(%struct.pthread_mutex_t_** nonnull %7) #7, !dbg !656
  %41 = icmp eq i32 %40, 16, !dbg !657
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !658
  br i1 %41, label %25, label %47, !dbg !658, !llvm.loop !659

; <label>:42:                                     ; preds = %14, %3, %1, %21
  %43 = phi i32 [ 22, %21 ], [ 16, %14 ], [ 22, %3 ], [ 22, %1 ]
  store volatile i32 42, i32* @__A_VARIABLE, align 4
  br label %44, !dbg !587

; <label>:44:                                     ; preds = %42, %6
  %45 = phi i32 [ %8, %6 ], [ %43, %42 ]
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !587
  %46 = tail call i32* @__errno() #7, !dbg !661
  store i32 %45, i32* %46, align 4, !dbg !664, !tbaa !665
  br label %49, !dbg !666

; <label>:47:                                     ; preds = %37
  store volatile i32 42, i32* @__A_VARIABLE, align 4
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !587
  %48 = bitcast %struct.sem_t_* %4 to i8*, !dbg !667
  tail call void @free(i8* %48) #7, !dbg !668
  br label %49, !dbg !669

; <label>:49:                                     ; preds = %47, %44
  %50 = phi i32 [ -1, %44 ], [ 0, %47 ], !dbg !670
...
define internal void @uk_pr_crit(i8* nocapture readnone, ...) unnamed_addr #4 !dbg !2 {
  ...
  %3 = bitcast [1 x %struct.__va_list_tag]* %2 to i8*, !dbg !673
  call void @llvm.lifetime.start.p0i8(i64 24, i8* nonnull %3) #6, !dbg !673
  %4 = getelementptr inbounds [1 x %struct.__va_list_tag], [1 x %struct.__va_list_tag]* %2, i64 0, i64 0, !dbg !675
  call void @llvm.va_start(i8* nonnull %3), !dbg !675
  call void @_uk_vprintk(i32 0, i8* getelementptr inbounds ([20 x i8], [20 x i8]* @uk_pr_crit.__str, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8], [14 x i8]* @uk_pr_crit.__str.3, i64 0, i64 0), i32 198, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str, i64 0, i64 0), %struct.__va_list_tag* nonnull %4) #7, !dbg !676
  call void @llvm.va_end(i8* nonnull %3), !dbg !679
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %3) #6, !dbg !680
...
!587 = !DILocation(line: 146, column: 7, scope: !503)
!588 = !DILocation(line: 124, column: 24, scope: !589)
!589 = distinct !DILexicalBlock(scope: !582, file: !10, line: 115, column: 17)
!590 = !DILocation(line: 128, column: 28, scope: !589)
!591 = !DILocation(line: 130, column: 26, scope: !589)
!592 = !DILocation(line: 132, column: 19, scope: !589)
!593 = !DILocation(line: 120, column: 2, scope: !594, inlinedAt: !600)
!594 = distinct !DISubprogram(name: "ukarch_read_sp", scope: !595, file: !595, line: 116, type: !596, isLocal: true, isDefinition: true, scopeLine: 117, flags: DIFlagPrototyped, isOptimized: true, unit: !9, retainedNodes: !598)
!595 = !DIFile(filename: "/root/.unikraft/unikraft/arch/x86/x86_64/include/uk/asm/lcpu.h", directory: "/root/.unikraft/apps/redis/build")
!596 = !DISubroutineType(types: !597)
!597 = !{!108}
!598 = !{!599}
!599 = !DILocalVariable(name: "sp", scope: !594, file: !595, line: 118, type: !108)
!600 = distinct !DILocation(line: 154, column: 21, scope: !601, inlinedAt: !607)
!601 = distinct !DISubprogram(name: "uk_thread_current", scope: !40, file: !40, line: 151, type: !602, isLocal: true, isDefinition: true, scopeLine: 152, flags: DIFlagPrototyped, isOptimized: true, unit: !9, retainedNodes: !604)
!602 = !DISubroutineType(types: !603)
!603 = !{!38}
!604 = !{!605, !606}
!605 = !DILocalVariable(name: "current", scope: !601, file: !40, line: 153, type: !37)
!606 = !DILocalVariable(name: "sp", scope: !601, file: !40, line: 154, type: !108)
!607 = distinct !DILocation(line: 117, column: 30, scope: !608, inlinedAt: !612)
!608 = distinct !DISubprogram(name: "uk_sched_yield", scope: !84, file: !84, line: 114, type: !418, isLocal: true, isDefinition: true, scopeLine: 115, flags: DIFlagPrototyped, isOptimized: true, unit: !9, retainedNodes: !609)
!609 = !{!610, !611}
!610 = !DILocalVariable(name: "s", scope: !608, file: !84, line: 116, type: !82)
!611 = !DILocalVariable(name: "current", scope: !608, file: !84, line: 117, type: !38)
!612 = distinct !DILocation(line: 244, column: 2, scope: !613, inlinedAt: !615)
!613 = distinct !DISubprogram(name: "pte_osYield", scope: !20, file: !20, line: 242, type: !418, isLocal: true, isDefinition: true, scopeLine: 243, flags: DIFlagPrototyped, isOptimized: true, unit: !9, retainedNodes: !614)
!614 = !{}
!615 = distinct !DILocation(line: 138, column: 23, scope: !616)
!616 = distinct !DILexicalBlock(scope: !589, file: !10, line: 133, column: 21)
!617 = !{i32 528255}
!618 = !DILocation(line: 118, column: 16, scope: !594, inlinedAt: !600)
!619 = !DILocation(line: 121, column: 2, scope: !594, inlinedAt: !600)
!620 = !DILocation(line: 154, column: 16, scope: !601, inlinedAt: !607)
!621 = !DILocation(line: 156, column: 38, scope: !601, inlinedAt: !607)
!622 = !DILocation(line: 156, column: 12, scope: !601, inlinedAt: !607)
!623 = !DILocation(line: 153, column: 21, scope: !601, inlinedAt: !607)
!624 = !DILocation(line: 158, column: 9, scope: !601, inlinedAt: !607)
!625 = !DILocation(line: 158, column: 2, scope: !601, inlinedAt: !607)
!626 = !DILocation(line: 117, column: 20, scope: !608, inlinedAt: !612)
!627 = !DILocation(line: 119, column: 2, scope: !628, inlinedAt: !612)
!628 = distinct !DILexicalBlock(scope: !629, file: !84, line: 119, column: 2)
!629 = distinct !DILexicalBlock(scope: !608, file: !84, line: 119, column: 2)
!630 = !DILocation(line: 119, column: 2, scope: !629, inlinedAt: !612)
!631 = !{!"branch_weights", i32 1, i32 2000}
!632 = !DILocation(line: 119, column: 2, scope: !633, inlinedAt: !612)
!633 = distinct !DILexicalBlock(scope: !628, file: !84, line: 119, column: 2)
!634 = !DILocation(line: 121, column: 15, scope: !608, inlinedAt: !612)
!635 = !{!636, !559, i64 88}
!636 = !{!"uk_thread", !559, i64 0, !559, i64 8, !559, i64 16, !559, i64 24, !637, i64 32, !571, i64 48, !638, i64 56, !639, i64 64, !640, i64 72, !559, i64 88, !559, i64 96, !571, i64 104, !559, i64 112, !559, i64 120}
!637 = !{!"", !559, i64 0, !559, i64 8}
!638 = !{!"long", !560, i64 0}
!639 = !{!"_Bool", !560, i64 0}
!640 = !{!"uk_waitq", !559, i64 0, !559, i64 8}
!641 = !DILocation(line: 116, column: 19, scope: !608, inlinedAt: !612)
!642 = !DILocation(line: 122, column: 2, scope: !643, inlinedAt: !612)
!643 = distinct !DILexicalBlock(scope: !644, file: !84, line: 122, column: 2)
!644 = distinct !DILexicalBlock(scope: !608, file: !84, line: 122, column: 2)
!645 = !DILocation(line: 122, column: 2, scope: !644, inlinedAt: !612)
!646 = !DILocation(line: 122, column: 2, scope: !647, inlinedAt: !612)
!647 = distinct !DILexicalBlock(scope: !643, file: !84, line: 122, column: 2)
!648 = !DILocation(line: 123, column: 5, scope: !608, inlinedAt: !612)
!649 = !{!650, !559, i64 0}
!650 = !{!"uk_sched", !559, i64 0, !559, i64 8, !559, i64 16, !559, i64 24, !559, i64 32, !559, i64 40, !559, i64 48, !559, i64 56, !559, i64 64, !639, i64 72, !636, i64 80, !651, i64 208, !652, i64 224, !559, i64 248, !559, i64 256, !559, i64 264}
!651 = !{!"uk_thread_list", !559, i64 0, !559, i64 8}
!652 = !{!"ukplat_ctx_callbacks", !559, i64 0, !559, i64 8, !559, i64 16}
!653 = !DILocation(line: 123, column: 2, scope: !608, inlinedAt: !612)
!654 = !DILocation(line: 124, column: 1, scope: !608, inlinedAt: !612)
!655 = !DILocation(line: 245, column: 1, scope: !613, inlinedAt: !615)
!656 = !DILocation(line: 140, column: 26, scope: !589)
!657 = !DILocation(line: 140, column: 59, scope: !589)
!658 = !DILocation(line: 139, column: 21, scope: !616)
!659 = distinct !{!659, !592, !660}
!660 = !DILocation(line: 140, column: 67, scope: !589)
!661 = !DILocation(line: 148, column: 7, scope: !662)
!662 = distinct !DILexicalBlock(scope: !663, file: !10, line: 147, column: 5)
!663 = distinct !DILexicalBlock(scope: !503, file: !10, line: 146, column: 7)
!664 = !DILocation(line: 148, column: 13, scope: !662)
!665 = !{!571, !571, i64 0}
!666 = !DILocation(line: 149, column: 7, scope: !662)
!667 = !DILocation(line: 152, column: 9, scope: !503)
!668 = !DILocation(line: 152, column: 3, scope: !503)
!669 = !DILocation(line: 154, column: 3, scope: !503)
!670 = !DILocation(line: 0, scope: !503)
!671 = !DILocation(line: 0, scope: !662)
!672 = !DILocation(line: 156, column: 1, scope: !503)
!673 = !DILocation(line: 196, column: 2, scope: !2)
!674 = !DILocation(line: 196, column: 10, scope: !2)
!675 = !DILocation(line: 197, column: 2, scope: !2)
!676 = !DILocation(line: 198, column: 2, scope: !677)
!677 = distinct !DILexicalBlock(scope: !678, file: !3, line: 198, column: 2)
!678 = distinct !DILexicalBlock(scope: !2, file: !3, line: 198, column: 2)
!679 = !DILocation(line: 199, column: 2, scope: !2)
!680 = !DILocation(line: 200, column: 1, scope: !2)
