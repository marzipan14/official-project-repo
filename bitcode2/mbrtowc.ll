...
; Function Attrs: noredzone nounwind
define dso_local i64 @mbrtowc(i32* noalias, i8* noalias, i64, %struct._mbstate_t* noalias) local_unnamed_addr #0 !dbg !347 {
  %5 = tail call %struct._reent* @__getreent() #3, !dbg !362
  %6 = icmp eq i8* %1, null, !dbg !364
  %7 = tail call %struct._reent* @__getreent() #3, !dbg !366
  %8 = getelementptr inbounds %struct._reent, %struct._reent* %7, i64 0, i32 7, !dbg !368
  %9 = load %struct.__locale_t*, %struct.__locale_t** %8, align 8, !dbg !368, !tbaa !309
  %10 = icmp eq %struct.__locale_t* %9, null, !dbg !366
...
; <label>:12:                                     ; preds = %4, %11
  %13 = phi %struct.__locale_t* [ @__global_locale, %11 ], [ %9, %4 ], !dbg !366
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !371
  %14 = getelementptr inbounds %struct.__locale_t, %struct.__locale_t* %13, i64 0, i32 2, !dbg !372
  %15 = load i32 (%struct._reent*, i32*, i8*, i64, %struct._mbstate_t*)*, i32 (%struct._reent*, i32*, i8*, i64, %struct._mbstate_t*)** %14, align 8, !dbg !372, !tbaa !323
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !373
  br i1 %6, label %16, label %18, !dbg !373

; <label>:16:                                     ; preds = %12
  %17 = tail call i32 %15(%struct._reent* %5, i32* null, i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str, i64 0, i64 0), i64 1, %struct._mbstate_t* %3) #3, !dbg !374
  br label %20, !dbg !375

; <label>:18:                                     ; preds = %12
  %19 = tail call i32 %15(%struct._reent* %5, i32* %0, i8* nonnull %1, i64 %2, %struct._mbstate_t* %3) #3, !dbg !376
  br label %20

; <label>:20:                                     ; preds = %18, %16
  %21 = phi i32 [ %17, %16 ], [ %19, %18 ], !dbg !372
  store volatile i32 42, i32* @__A_VARIABLE, align 4
  %22 = icmp eq i32 %21, -1, !dbg !377
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !379
  br i1 %22, label %23, label %26, !dbg !379

; <label>:23:                                     ; preds = %20
  %24 = getelementptr inbounds %struct._mbstate_t, %struct._mbstate_t* %3, i64 0, i32 0, !dbg !380
  store i32 0, i32* %24, align 4, !dbg !382, !tbaa !336
  %25 = getelementptr inbounds %struct._reent, %struct._reent* %5, i64 0, i32 0, !dbg !383
  store i32 138, i32* %25, align 8, !dbg !384, !tbaa !340
  br label %28, !dbg !385

; <label>:26:                                     ; preds = %20
  %27 = sext i32 %21 to i64, !dbg !386
  br label %28, !dbg !387

; <label>:28:                                     ; preds = %26, %23
  %29 = phi i64 [ -1, %23 ], [ %27, %26 ], !dbg !388
...
!346 = !DILocation(line: 41, column: 1, scope: !14)
!347 = distinct !DISubprogram(name: "mbrtowc", scope: !1, file: !1, line: 45, type: !348, isLocal: false, isDefinition: true, scopeLine: 50, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !353)
!348 = !DISubroutineType(types: !349)
!349 = !{!17, !350, !351, !5, !352}
!350 = !DIDerivedType(tag: DW_TAG_restrict_type, baseType: !134)
!351 = !DIDerivedType(tag: DW_TAG_restrict_type, baseType: !57)
!352 = !DIDerivedType(tag: DW_TAG_restrict_type, baseType: !127)
!353 = !{!354, !355, !356, !357, !358, !359}
!354 = !DILocalVariable(name: "pwc", arg: 1, scope: !347, file: !1, line: 45, type: !350)
!355 = !DILocalVariable(name: "s", arg: 2, scope: !347, file: !1, line: 45, type: !351)
!356 = !DILocalVariable(name: "n", arg: 3, scope: !347, file: !1, line: 45, type: !5)
!357 = !DILocalVariable(name: "ps", arg: 4, scope: !347, file: !1, line: 45, type: !352)
!358 = !DILocalVariable(name: "retval", scope: !347, file: !1, line: 54, type: !24)
!359 = !DILocalVariable(name: "reent", scope: !347, file: !1, line: 55, type: !19)
!360 = !DILocation(line: 45, column: 1, scope: !347)
!361 = !DILocation(line: 54, column: 7, scope: !347)
!362 = !DILocation(line: 55, column: 26, scope: !347)
!363 = !DILocation(line: 55, column: 18, scope: !347)
!364 = !DILocation(line: 65, column: 9, scope: !365)
!365 = distinct !DILexicalBlock(scope: !347, file: !1, line: 65, column: 7)
!366 = !DILocation(line: 230, column: 10, scope: !304, inlinedAt: !367)
!367 = distinct !DILocation(line: 0, scope: !365)
!368 = !DILocation(line: 230, column: 18, scope: !304, inlinedAt: !367)
!369 = !DILocation(line: 213, column: 3, scope: !319, inlinedAt: !370)
!370 = distinct !DILocation(line: 230, column: 29, scope: !304, inlinedAt: !367)
!371 = !DILocation(line: 230, column: 3, scope: !304, inlinedAt: !367)
!372 = !DILocation(line: 0, scope: !365)
!373 = !DILocation(line: 65, column: 7, scope: !347)
!374 = !DILocation(line: 66, column: 14, scope: !365)
!375 = !DILocation(line: 66, column: 5, scope: !365)
!376 = !DILocation(line: 68, column: 14, scope: !365)
!377 = !DILocation(line: 70, column: 14, scope: !378)
!378 = distinct !DILexicalBlock(scope: !347, file: !1, line: 70, column: 7)
!379 = !DILocation(line: 70, column: 7, scope: !347)
!380 = !DILocation(line: 72, column: 11, scope: !381)
!381 = distinct !DILexicalBlock(scope: !378, file: !1, line: 71, column: 5)
!382 = !DILocation(line: 72, column: 19, scope: !381)
!383 = !DILocation(line: 73, column: 14, scope: !381)
!384 = !DILocation(line: 73, column: 21, scope: !381)
!385 = !DILocation(line: 74, column: 7, scope: !381)
!386 = !DILocation(line: 77, column: 12, scope: !378)
!387 = !DILocation(line: 77, column: 5, scope: !378)
!388 = !DILocation(line: 0, scope: !378)
!389 = !DILocation(line: 0, scope: !381)
!390 = !DILocation(line: 79, column: 1, scope: !347)
