...
; <label>:3:                                      ; preds = %1
  ...
  %7 = getelementptr inbounds %struct.pthread_key_t_, %struct.pthread_key_t_* %0, i64 0, i32 1, !dbg !601
  br i1 %6, label %33, label %8, !dbg !600
...
; <label>:15:                                     ; preds = %11
  ...
  %16 = bitcast i8** %4 to %struct.ThreadKeyAssoc**, !dbg !611
  %17 = load %struct.ThreadKeyAssoc*, %struct.ThreadKeyAssoc** %16, align 8, !dbg !611, !tbaa !593
  %18 = icmp eq %struct.ThreadKeyAssoc* %17, null, !dbg !613
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !610
  br i1 %18, label %31, label %19, !dbg !610
...
; <label>:19:                                     ; preds = %15, %28
  ...
  %23 = getelementptr inbounds %struct.pte_thread_t_, %struct.pte_thread_t_* %22, i64 0, i32 8, !dbg !619
  %24 = tail call i32 @pthread_mutex_lock(%struct.pthread_mutex_t_** nonnull %23) #7, !dbg !621
  %25 = icmp eq i32 %24, 0, !dbg !622
  tail call void @pte_tkAssocDestroy(%struct.ThreadKeyAssoc* nonnull %20) #7, !dbg !623
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !625
  br i1 %25, label %26, label %28, !dbg !625

; <label>:26:                                     ; preds = %19
  %27 = tail call i32 @pthread_mutex_unlock(%struct.pthread_mutex_t_** nonnull %23) #7, !dbg !626
...
; <label>:28:                                     ; preds = %19, %26
  ...
  %29 = load %struct.ThreadKeyAssoc*, %struct.ThreadKeyAssoc** %16, align 8, !dbg !611, !tbaa !593
  %30 = icmp eq %struct.ThreadKeyAssoc* %29, null, !dbg !613
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !610
  br i1 %30, label %31, label %19, !dbg !610

; <label>:31:                                     ; preds = %28, %15
  %32 = tail call i32 @pthread_mutex_unlock(%struct.pthread_mutex_t_** nonnull %12) #7, !dbg !630
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !631
  br label %33, !dbg !631

; <label>:33:                                     ; preds = %3, %8, %31, %11
  %34 = getelementptr inbounds %struct.pthread_key_t_, %struct.pthread_key_t_* %0, i64 0, i32 0, !dbg !632
  %35 = load i32, i32* %34, align 8, !dbg !632, !tbaa !633
  %36 = tail call i32 @pte_osTlsFree(i32 %35) #7, !dbg !634
  %37 = load void (i8*)*, void (i8*)** %7, align 8, !dbg !635, !tbaa !603
  %38 = icmp eq void (i8*)* %37, null, !dbg !637
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !638
  br i1 %38, label %60, label %39, !dbg !638

; <label>:39:                                     ; preds = %33
  %40 = getelementptr inbounds %struct.pthread_key_t_, %struct.pthread_key_t_* %0, i64 0, i32 2, !dbg !639
  %41 = tail call i32 @pthread_mutex_destroy(%struct.pthread_mutex_t_** nonnull %40) #7, !dbg !641
  %42 = icmp eq i32 %41, 16, !dbg !642
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !643
  br i1 %42, label %43, label %60, !dbg !643

; <label>:43:                                     ; preds = %39, %55
  %44 = tail call i64 asm sideeffect "mov %rsp, $0", "=r,~{dirflag},~{fpsr},~{flags}"() #6, !dbg !644, !srcloc !669
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !671
  %45 = and i64 %44, -65536, !dbg !673
  %46 = inttoptr i64 %45 to %struct.uk_thread**, !dbg !674
  %47 = load %struct.uk_thread*, %struct.uk_thread** %46, align 65536, !dbg !676, !tbaa !677
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !678
  %48 = icmp eq %struct.uk_thread* %47, null, !dbg !680
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !683
  br i1 %48, label %49, label %50, !dbg !683, !prof !684

; <label>:49:                                     ; preds = %43
  tail call void (i8*, ...) @uk_pr_crit(i8* undef, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.1, i64 0, i64 0)) #7, !dbg !685
  tail call void @ukplat_terminate(i32 3) #8, !dbg !685
  unreachable

; <label>:50:                                     ; preds = %43
  %51 = getelementptr inbounds %struct.uk_thread, %struct.uk_thread* %47, i64 0, i32 9, !dbg !687
  %52 = load %struct.uk_sched*, %struct.uk_sched** %51, align 8, !dbg !687, !tbaa !688
  %53 = icmp eq %struct.uk_sched* %52, null, !dbg !695
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !698
  br i1 %53, label %54, label %55, !dbg !698, !prof !684

; <label>:54:                                     ; preds = %50
  tail call void (i8*, ...) @uk_pr_crit(i8* undef, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i64 0, i64 0)) #7, !dbg !699
  tail call void @ukplat_terminate(i32 3) #8, !dbg !699
  unreachable

; <label>:55:                                     ; preds = %50
  %56 = getelementptr inbounds %struct.uk_sched, %struct.uk_sched* %52, i64 0, i32 0, !dbg !701
  %57 = load void (%struct.uk_sched*)*, void (%struct.uk_sched*)** %56, align 8, !dbg !701, !tbaa !702
  tail call void %57(%struct.uk_sched* nonnull %52) #7, !dbg !706
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !707
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !708
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !643
  %58 = tail call i32 @pthread_mutex_destroy(%struct.pthread_mutex_t_** nonnull %40) #7, !dbg !641
  %59 = icmp eq i32 %58, 16, !dbg !642
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !643
  br i1 %59, label %43, label %60, !dbg !643, !llvm.loop !709

; <label>:60:                                     ; preds = %55, %39, %33
  %61 = phi i32 [ 0, %33 ], [ %41, %39 ], [ %58, %55 ], !dbg !711
  %62 = bitcast %struct.pthread_key_t_* %0 to i8*, !dbg !712
  tail call void @free(i8* %62) #7, !dbg !713
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !714
  br label %63, !dbg !714

; <label>:63:                                     ; preds = %1, %60
  %64 = phi i32 [ %61, %60 ], [ 0, %1 ], !dbg !711
...
define internal void @uk_pr_crit(i8* nocapture readnone, ...) unnamed_addr #4 !dbg !2 {
  ...
  %3 = bitcast [1 x %struct.__va_list_tag]* %2 to i8*, !dbg !716
  call void @llvm.lifetime.start.p0i8(i64 24, i8* nonnull %3) #6, !dbg !716
  %4 = getelementptr inbounds [1 x %struct.__va_list_tag], [1 x %struct.__va_list_tag]* %2, i64 0, i64 0, !dbg !718
  call void @llvm.va_start(i8* nonnull %3), !dbg !718
  call void @_uk_vprintk(i32 0, i8* getelementptr inbounds ([20 x i8], [20 x i8]* @uk_pr_crit.__str, i64 0, i64 0), i8* getelementptr inbounds ([21 x i8], [21 x i8]* @uk_pr_crit.__str.3, i64 0, i64 0), i32 198, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str, i64 0, i64 0), %struct.__va_list_tag* nonnull %4) #7, !dbg !719
  call void @llvm.va_end(i8* nonnull %3), !dbg !722
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %3) #6, !dbg !723
...
!600 = !DILocation(line: 83, column: 32, scope: !583)
!601 = !DILocation(line: 0, scope: !583)
...
!610 = !DILocation(line: 96, column: 11, scope: !582)
!611 = !DILocation(line: 96, column: 51, scope: !582)
!612 = !DILocation(line: 87, column: 27, scope: !582)
!613 = !DILocation(line: 96, column: 60, scope: !582)
...
!618 = !DILocation(line: 100, column: 19, scope: !587)
!619 = !DILocation(line: 106, column: 49, scope: !620)
!620 = distinct !DILexicalBlock(scope: !587, file: !10, line: 106, column: 19)
!621 = !DILocation(line: 106, column: 19, scope: !620)
!622 = !DILocation(line: 106, column: 62, scope: !620)
!623 = !DILocation(line: 0, scope: !624)
!624 = distinct !DILexicalBlock(scope: !620, file: !10, line: 118, column: 17)
!625 = !DILocation(line: 106, column: 19, scope: !587)
!626 = !DILocation(line: 115, column: 26, scope: !627)
!627 = distinct !DILexicalBlock(scope: !620, file: !10, line: 107, column: 17)
!628 = !DILocation(line: 116, column: 17, scope: !627)
!629 = !DILocation(line: 122, column: 13, scope: !582)
!630 = !DILocation(line: 123, column: 11, scope: !582)
!631 = !DILocation(line: 124, column: 9, scope: !582)
!632 = !DILocation(line: 126, column: 27, scope: !584)
!633 = !{!594, !595, i64 0}
!634 = !DILocation(line: 126, column: 7, scope: !584)
!635 = !DILocation(line: 127, column: 16, scope: !636)
!636 = distinct !DILexicalBlock(scope: !584, file: !10, line: 127, column: 11)
!637 = !DILocation(line: 127, column: 27, scope: !636)
!638 = !DILocation(line: 127, column: 11, scope: !584)
!639 = !DILocation(line: 130, column: 67, scope: !640)
!640 = distinct !DILexicalBlock(scope: !636, file: !10, line: 128, column: 9)
!641 = !DILocation(line: 130, column: 37, scope: !640)
!642 = !DILocation(line: 130, column: 24, scope: !640)
!643 = !DILocation(line: 130, column: 11, scope: !640)
!644 = !DILocation(line: 120, column: 2, scope: !645, inlinedAt: !651)
!645 = distinct !DISubprogram(name: "ukarch_read_sp", scope: !646, file: !646, line: 116, type: !647, isLocal: true, isDefinition: true, scopeLine: 117, flags: DIFlagPrototyped, isOptimized: true, unit: !9, retainedNodes: !649)
!646 = !DIFile(filename: "/root/.unikraft/unikraft/arch/x86/x86_64/include/uk/asm/lcpu.h", directory: "/root/.unikraft/apps/redis/build")
!647 = !DISubroutineType(types: !648)
!648 = !{!121}
!649 = !{!650}
!650 = !DILocalVariable(name: "sp", scope: !645, file: !646, line: 118, type: !121)
!651 = distinct !DILocation(line: 154, column: 21, scope: !652, inlinedAt: !658)
!652 = distinct !DISubprogram(name: "uk_thread_current", scope: !52, file: !52, line: 151, type: !653, isLocal: true, isDefinition: true, scopeLine: 152, flags: DIFlagPrototyped, isOptimized: true, unit: !9, retainedNodes: !655)
!653 = !DISubroutineType(types: !654)
!654 = !{!50}
!655 = !{!656, !657}
!656 = !DILocalVariable(name: "current", scope: !652, file: !52, line: 153, type: !63)
!657 = !DILocalVariable(name: "sp", scope: !652, file: !52, line: 154, type: !121)
!658 = distinct !DILocation(line: 117, column: 30, scope: !659, inlinedAt: !663)
!659 = distinct !DISubprogram(name: "uk_sched_yield", scope: !97, file: !97, line: 114, type: !431, isLocal: true, isDefinition: true, scopeLine: 115, flags: DIFlagPrototyped, isOptimized: true, unit: !9, retainedNodes: !660)
!660 = !{!661, !662}
!661 = !DILocalVariable(name: "s", scope: !659, file: !97, line: 116, type: !95)
!662 = !DILocalVariable(name: "current", scope: !659, file: !97, line: 117, type: !50)
!663 = distinct !DILocation(line: 244, column: 2, scope: !664, inlinedAt: !667)
!664 = distinct !DISubprogram(name: "pte_osYield", scope: !665, file: !665, line: 242, type: !431, isLocal: true, isDefinition: true, scopeLine: 243, flags: DIFlagPrototyped, isOptimized: true, unit: !9, retainedNodes: !666)
!665 = !DIFile(filename: "/root/.unikraft/apps/redis/build/libpthread-embedded/origin/pthread-embedded-44b41d760a433915d70a7be9809651b0a65e001d/pte_generic_osal.h", directory: "/root/.unikraft/apps/redis/build")
!666 = !{}
!667 = distinct !DILocation(line: 132, column: 15, scope: !668)
!668 = distinct !DILexicalBlock(scope: !640, file: !10, line: 131, column: 13)
!669 = !{i32 544200}
!670 = !DILocation(line: 118, column: 16, scope: !645, inlinedAt: !651)
!671 = !DILocation(line: 121, column: 2, scope: !645, inlinedAt: !651)
!672 = !DILocation(line: 154, column: 16, scope: !652, inlinedAt: !658)
!673 = !DILocation(line: 156, column: 38, scope: !652, inlinedAt: !658)
!674 = !DILocation(line: 156, column: 12, scope: !652, inlinedAt: !658)
!675 = !DILocation(line: 153, column: 21, scope: !652, inlinedAt: !658)
!676 = !DILocation(line: 158, column: 9, scope: !652, inlinedAt: !658)
!677 = !{!598, !598, i64 0}
!678 = !DILocation(line: 158, column: 2, scope: !652, inlinedAt: !658)
!679 = !DILocation(line: 117, column: 20, scope: !659, inlinedAt: !663)
!680 = !DILocation(line: 119, column: 2, scope: !681, inlinedAt: !663)
!681 = distinct !DILexicalBlock(scope: !682, file: !97, line: 119, column: 2)
!682 = distinct !DILexicalBlock(scope: !659, file: !97, line: 119, column: 2)
!683 = !DILocation(line: 119, column: 2, scope: !682, inlinedAt: !663)
!684 = !{!"branch_weights", i32 1, i32 2000}
!685 = !DILocation(line: 119, column: 2, scope: !686, inlinedAt: !663)
!686 = distinct !DILexicalBlock(scope: !681, file: !97, line: 119, column: 2)
!687 = !DILocation(line: 121, column: 15, scope: !659, inlinedAt: !663)
!688 = !{!689, !598, i64 88}
!689 = !{!"uk_thread", !598, i64 0, !598, i64 8, !598, i64 16, !598, i64 24, !690, i64 32, !595, i64 48, !691, i64 56, !692, i64 64, !693, i64 72, !598, i64 88, !598, i64 96, !595, i64 104, !598, i64 112, !598, i64 120}
!690 = !{!"", !598, i64 0, !598, i64 8}
!691 = !{!"long", !596, i64 0}
!692 = !{!"_Bool", !596, i64 0}
!693 = !{!"uk_waitq", !598, i64 0, !598, i64 8}
!694 = !DILocation(line: 116, column: 19, scope: !659, inlinedAt: !663)
!695 = !DILocation(line: 122, column: 2, scope: !696, inlinedAt: !663)
!696 = distinct !DILexicalBlock(scope: !697, file: !97, line: 122, column: 2)
!697 = distinct !DILexicalBlock(scope: !659, file: !97, line: 122, column: 2)
!698 = !DILocation(line: 122, column: 2, scope: !697, inlinedAt: !663)
!699 = !DILocation(line: 122, column: 2, scope: !700, inlinedAt: !663)
!700 = distinct !DILexicalBlock(scope: !696, file: !97, line: 122, column: 2)
!701 = !DILocation(line: 123, column: 5, scope: !659, inlinedAt: !663)
!702 = !{!703, !598, i64 0}
!703 = !{!"uk_sched", !598, i64 0, !598, i64 8, !598, i64 16, !598, i64 24, !598, i64 32, !598, i64 40, !598, i64 48, !598, i64 56, !598, i64 64, !692, i64 72, !689, i64 80, !704, i64 208, !705, i64 224, !598, i64 248, !598, i64 256, !598, i64 264}
!704 = !{!"uk_thread_list", !598, i64 0, !598, i64 8}
!705 = !{!"ukplat_ctx_callbacks", !598, i64 0, !598, i64 8, !598, i64 16}
!706 = !DILocation(line: 123, column: 2, scope: !659, inlinedAt: !663)
!707 = !DILocation(line: 124, column: 1, scope: !659, inlinedAt: !663)
!708 = !DILocation(line: 245, column: 1, scope: !664, inlinedAt: !667)
!709 = distinct !{!709, !643, !710}
!710 = !DILocation(line: 133, column: 13, scope: !640)
!711 = !DILocation(line: 0, scope: !575)
!712 = !DILocation(line: 136, column: 13, scope: !584)
!713 = !DILocation(line: 136, column: 7, scope: !584)
!714 = !DILocation(line: 137, column: 5, scope: !584)
!715 = !DILocation(line: 139, column: 3, scope: !575)
!716 = !DILocation(line: 196, column: 2, scope: !2)
!717 = !DILocation(line: 196, column: 10, scope: !2)
!718 = !DILocation(line: 197, column: 2, scope: !2)
!719 = !DILocation(line: 198, column: 2, scope: !720)
!720 = distinct !DILexicalBlock(scope: !721, file: !3, line: 198, column: 2)
!721 = distinct !DILexicalBlock(scope: !2, file: !3, line: 198, column: 2)
!722 = !DILocation(line: 199, column: 2, scope: !2)
!723 = !DILocation(line: 200, column: 1, scope: !2)
