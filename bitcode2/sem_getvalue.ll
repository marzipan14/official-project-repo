; ModuleID = '/root/.unikraft/apps/redis/build/libpthread-embedded/origin/pthread-embedded-44b41d760a433915d70a7be9809651b0a65e001d/sem_getvalue.c'
source_filename = "/root/.unikraft/apps/redis/build/libpthread-embedded/origin/pthread-embedded-44b41d760a433915d70a7be9809651b0a65e001d/sem_getvalue.c"
...
define dso_local i32 @sem_getvalue(%struct.sem_t_** readonly, i32*) local_unnamed_addr #0 !dbg !16 {
  %3 = icmp eq %struct.sem_t_** %0, null, !dbg !504
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !505
  br i1 %3, label %9, label %4, !dbg !505

; <label>:4:                                      ; preds = %2
  %5 = load %struct.sem_t_*, %struct.sem_t_** %0, align 8, !dbg !506, !tbaa !507
  %6 = icmp eq %struct.sem_t_* %5, null, !dbg !511
  %7 = icmp eq i32* %1, null, !dbg !512
  %8 = or i1 %7, %6, !dbg !513
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !513
  br i1 %8, label %9, label %11, !dbg !513

; <label>:9:                                      ; preds = %4, %2
  %10 = tail call i32* @__errno() #3, !dbg !514
  store i32 22, i32* %10, align 4, !dbg !516, !tbaa !517
  br label %27, !dbg !519

; <label>:11:                                     ; preds = %4
  %12 = getelementptr inbounds %struct.sem_t_, %struct.sem_t_* %5, i64 0, i32 1, !dbg !522
  %13 = tail call i32 @pthread_mutex_lock(%struct.pthread_mutex_t_** nonnull %12) #3, !dbg !524
  %14 = icmp eq i32 %13, 0, !dbg !525
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !526
  br i1 %14, label %15, label %25, !dbg !526

; <label>:15:                                     ; preds = %11
  %16 = load %struct.sem_t_*, %struct.sem_t_** %0, align 8, !dbg !527, !tbaa !507
  %17 = icmp eq %struct.sem_t_* %16, null, !dbg !530
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !531
  br i1 %17, label %18, label %21, !dbg !531

; <label>:18:                                     ; preds = %15
  %19 = tail call i32 @pthread_mutex_unlock(%struct.pthread_mutex_t_** nonnull %12) #3, !dbg !532
  %20 = tail call i32* @__errno() #3, !dbg !534
  store i32 22, i32* %20, align 4, !dbg !535, !tbaa !517
  br label %25, !dbg !536

; <label>:21:                                     ; preds = %15
  %22 = getelementptr inbounds %struct.sem_t_, %struct.sem_t_* %5, i64 0, i32 0, !dbg !537
  %23 = load i32, i32* %22, align 8, !dbg !537, !tbaa !538
  %24 = tail call i32 @pthread_mutex_unlock(%struct.pthread_mutex_t_** nonnull %12) #3, !dbg !540
  store i32 %23, i32* %1, align 4, !dbg !541, !tbaa !517
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !542
  br label %25, !dbg !542

; <label>:25:                                     ; preds = %11, %21, %18
  %26 = phi i32 [ -1, %18 ], [ %13, %21 ], [ %13, %11 ], !dbg !543
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !544
  br label %27

; <label>:27:                                     ; preds = %25, %9
  %28 = phi i32 [ -1, %9 ], [ %26, %25 ], !dbg !544
...
!1 = !DIFile(filename: "/root/.unikraft/apps/redis/build/libpthread-embedded/origin/pthread-embedded-44b41d760a433915d70a7be9809651b0a65e001d/sem_getvalue.c", directory: "/root/.unikraft/apps/redis/build")
!2 = !{!3}
...
!16 = distinct !DISubprogram(name: "sem_getvalue", scope: !1, file: !1, line: 56, type: !17, isLocal: false, isDefinition: true, scopeLine: 85, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !494)
...
!495 = !DILocalVariable(name: "sem", arg: 1, scope: !16, file: !1, line: 56, type: !20)
!496 = !DILocalVariable(name: "sval", arg: 2, scope: !16, file: !1, line: 56, type: !143)
!497 = !DILocalVariable(name: "value", scope: !498, file: !1, line: 93, type: !42)
!498 = distinct !DILexicalBlock(scope: !499, file: !1, line: 92, column: 5)
!499 = distinct !DILexicalBlock(scope: !16, file: !1, line: 86, column: 7)
!500 = !DILocalVariable(name: "s", scope: !498, file: !1, line: 94, type: !21)
!501 = !DILocalVariable(name: "result", scope: !498, file: !1, line: 95, type: !19)
!502 = !DILocation(line: 56, column: 23, scope: !16)
!503 = !DILocation(line: 56, column: 33, scope: !16)
!504 = !DILocation(line: 86, column: 11, scope: !499)
!505 = !DILocation(line: 86, column: 19, scope: !499)
!506 = !DILocation(line: 86, column: 22, scope: !499)
!507 = !{!508, !508, i64 0}
!508 = !{!"any pointer", !509, i64 0}
!509 = !{!"omnipotent char", !510, i64 0}
!510 = !{!"Simple C/C++ TBAA"}
!511 = !DILocation(line: 86, column: 27, scope: !499)
!512 = !DILocation(line: 86, column: 43, scope: !499)
!513 = !DILocation(line: 86, column: 35, scope: !499)
!514 = !DILocation(line: 88, column: 7, scope: !515)
!515 = distinct !DILexicalBlock(scope: !499, file: !1, line: 87, column: 5)
!516 = !DILocation(line: 88, column: 13, scope: !515)
!517 = !{!518, !518, i64 0}
!518 = !{!"int", !509, i64 0}
!519 = !DILocation(line: 89, column: 7, scope: !515)
!520 = !DILocation(line: 94, column: 22, scope: !498)
!521 = !DILocation(line: 95, column: 11, scope: !498)
!522 = !DILocation(line: 97, column: 44, scope: !523)
!523 = distinct !DILexicalBlock(scope: !498, file: !1, line: 97, column: 11)
!524 = !DILocation(line: 97, column: 21, scope: !523)
!525 = !DILocation(line: 97, column: 51, scope: !523)
!526 = !DILocation(line: 97, column: 11, scope: !498)
!527 = !DILocation(line: 101, column: 15, scope: !528)
!528 = distinct !DILexicalBlock(scope: !529, file: !1, line: 101, column: 15)
!529 = distinct !DILexicalBlock(scope: !523, file: !1, line: 98, column: 9)
!530 = !DILocation(line: 101, column: 20, scope: !528)
!531 = !DILocation(line: 101, column: 15, scope: !529)
!532 = !DILocation(line: 103, column: 22, scope: !533)
!533 = distinct !DILexicalBlock(scope: !528, file: !1, line: 102, column: 13)
!534 = !DILocation(line: 104, column: 15, scope: !533)
!535 = !DILocation(line: 104, column: 21, scope: !533)
!536 = !DILocation(line: 105, column: 15, scope: !533)
!537 = !DILocation(line: 108, column: 22, scope: !529)
!538 = !{!539, !518, i64 0}
!539 = !{!"sem_t_", !518, i64 0, !508, i64 8, !508, i64 16}
!540 = !DILocation(line: 109, column: 18, scope: !529)
!541 = !DILocation(line: 110, column: 17, scope: !529)
!542 = !DILocation(line: 111, column: 9, scope: !529)
!543 = !DILocation(line: 0, scope: !498)
!544 = !DILocation(line: 0, scope: !533)
!545 = !DILocation(line: 116, column: 1, scope: !16)
