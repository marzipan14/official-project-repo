...
define dso_local i32 @__ascii_mbtowc(%struct._reent* nocapture readnone, i32*, i8* readonly, i64, %struct._mbstate_t* nocapture readnone) local_unnamed_addr #0 !dbg !324 {
  ...
  br i1 %8, label %9, label %10, !dbg !338
...
; <label>:10:                                     ; preds = %9, %5
  %11 = phi i32* [ %6, %9 ], [ %1, %5 ]
  %12 = icmp eq i8* %2, null, !dbg !340
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !342
  br i1 %12, label %13, label %14, !dbg !342
...
; <label>:14:                                     ; preds = %10
  %15 = icmp eq i64 %3, 0, !dbg !344
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !346
  br i1 %15, label %16, label %17, !dbg !346
...
; <label>:17:                                     ; preds = %14
  %18 = load i8, i8* %2, align 1, !dbg !348, !tbaa !349
  %19 = zext i8 %18 to i32, !dbg !350
  store i32 %19, i32* %11, align 4, !dbg !351, !tbaa !352
  %20 = load i8, i8* %2, align 1, !dbg !353, !tbaa !349
  %21 = icmp ne i8 %20, 0, !dbg !355
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !356
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !357
  %22 = zext i1 %21 to i32, !dbg !358
  br label %23, !dbg !358

; <label>:23:                                     ; preds = %17, %16, %13
  %24 = phi i32 [ 0, %13 ], [ -2, %16 ], [ %22, %17 ], !dbg !357
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %7), !dbg !359
...
!339 = !DILocation(line: 33, column: 5, scope: !337)
!340 = !DILocation(line: 35, column: 9, scope: !341)
!341 = distinct !DILexicalBlock(scope: !324, file: !1, line: 35, column: 7)
!342 = !DILocation(line: 35, column: 7, scope: !324)
!343 = !DILocation(line: 36, column: 5, scope: !341)
!344 = !DILocation(line: 38, column: 9, scope: !345)
!345 = distinct !DILexicalBlock(scope: !324, file: !1, line: 38, column: 7)
!346 = !DILocation(line: 38, column: 7, scope: !324)
!347 = !DILocation(line: 39, column: 5, scope: !345)
!348 = !DILocation(line: 49, column: 19, scope: !324)
!349 = !{!309, !309, i64 0}
!350 = !DILocation(line: 49, column: 10, scope: !324)
!351 = !DILocation(line: 49, column: 8, scope: !324)
!352 = !{!308, !308, i64 0}
!353 = !DILocation(line: 51, column: 7, scope: !354)
!354 = distinct !DILexicalBlock(scope: !324, file: !1, line: 51, column: 7)
!355 = !DILocation(line: 51, column: 10, scope: !354)
!356 = !DILocation(line: 51, column: 7, scope: !324)
!357 = !DILocation(line: 0, scope: !324)
!358 = !DILocation(line: 52, column: 5, scope: !354)
!359 = !DILocation(line: 55, column: 1, scope: !324)
