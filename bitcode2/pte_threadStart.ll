...
define dso_local i32 @pte_threadStart(i8* nocapture readonly) local_unnamed_addr #0 !dbg !530 {
  ...
  %17 = icmp eq i32 %16, 0, !dbg !581
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !583
  br i1 %17, label %18, label %20, !dbg !583

; <label>:18:                                     ; preds = %1
  %19 = tail call i8* %6(i8* %9) #4, !dbg !585
  br label %22, !dbg !587

; <label>:20:                                     ; preds = %1
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !588
  %21 = icmp eq i32 %16, 1, !dbg !588
  br i1 %21, label %26, label %22, !dbg !588

; <label>:22:                                     ; preds = %20, %18
  %23 = phi i8* [ %19, %18 ], [ inttoptr (i64 -1 to i8*), %20 ]
  %24 = getelementptr inbounds i8, i8* %3, i64 40, !dbg !590
  %25 = bitcast i8* %24 to i8**, !dbg !590
  store i8* %23, i8** %25, align 8, !dbg !590, !tbaa !591
  br label %26, !dbg !590

; <label>:26:                                     ; preds = %20, %22
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !590
  %27 = tail call i32 (...) @pte_thread_detach_and_exit_np() #4, !dbg !592
...
!581 = !DILocation(line: 113, column: 9, scope: !582)
!582 = distinct !DILexicalBlock(scope: !530, file: !1, line: 113, column: 7)
!583 = !DILocation(line: 113, column: 7, scope: !530)
!584 = !DILocation(line: 85, column: 18, scope: !530)
!585 = !DILocation(line: 119, column: 33, scope: !586)
!586 = distinct !DILexicalBlock(scope: !582, file: !1, line: 114, column: 5)
!587 = !DILocation(line: 120, column: 5, scope: !586)
!588 = !DILocation(line: 123, column: 7, scope: !589)
!589 = distinct !DILexicalBlock(scope: !582, file: !1, line: 122, column: 5)
!590 = !DILocation(line: 0, scope: !586)
!591 = !{!576, !562, i64 40}
!592 = !DILocation(line: 240, column: 10, scope: !530)
!593 = !DILocation(line: 249, column: 3, scope: !530)
