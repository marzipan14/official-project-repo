...
; <label>:55:                                     ; preds = %50
  ...
  %57 = select i1 %56, i32 -2147483648, i32 0, !dbg !118
  %58 = xor i32 %51, -1, !dbg !119
  %59 = and i32 %58, %6, !dbg !120
  %60 = lshr i32 262144, %12, !dbg !121
  %61 = or i32 %59, %60, !dbg !122
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !123
  br label %82, !dbg !123

; <label>:62:                                     ; preds = %1
  %63 = icmp ugt i32 %11, 1074, !dbg !124
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !126
  br i1 %63, label %64, label %68, !dbg !126

; <label>:64:                                     ; preds = %62
  %65 = icmp eq i32 %12, 1024, !dbg !127
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !130
  %66 = fadd double %0, %0, !dbg !131
  %67 = select i1 %65, double %66, double %0, !dbg !130
  br label %95, !dbg !130

; <label>:68:                                     ; preds = %62
  %69 = add nsw i32 %11, -1043, !dbg !132
  %70 = lshr i32 -1, %69, !dbg !134
  %71 = and i32 %70, %7, !dbg !135
  %72 = icmp eq i32 %71, 0, !dbg !137
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !138
  br i1 %72, label %95, label %73, !dbg !138

; <label>:73:                                     ; preds = %68
  %74 = lshr i32 %70, 1, !dbg !139
  %75 = and i32 %74, %7, !dbg !140
  %76 = icmp eq i32 %75, 0, !dbg !142
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !143
  br i1 %76, label %82, label %77, !dbg !143

; <label>:77:                                     ; preds = %73
  %78 = xor i32 %74, -1, !dbg !144
  %79 = and i32 %78, %7, !dbg !145
  %80 = lshr i32 1073741824, %69, !dbg !146
  %81 = or i32 %79, %80, !dbg !147
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !148
  br label %82, !dbg !148

; <label>:82:                                     ; preds = %50, %73, %55, %77
  %83 = phi i32 [ %57, %55 ], [ %7, %50 ], [ %81, %77 ], [ %7, %73 ], !dbg !149
  %84 = phi i32 [ %61, %55 ], [ %6, %50 ], [ %6, %77 ], [ %6, %73 ], !dbg !149
  %85 = zext i32 %84 to i64, !dbg !150
  %86 = shl nuw i64 %85, 32, !dbg !150
  %87 = zext i32 %83 to i64, !dbg !150
  %88 = or i64 %86, %87, !dbg !150
  %89 = bitcast i64 %88 to double, !dbg !150
  %90 = getelementptr inbounds [2 x double], [2 x double]* @TWO52, i64 0, i64 %8, !dbg !151
  %91 = load double, double* %90, align 8, !dbg !151, !tbaa !88
  %92 = fadd double %91, %89, !dbg !152
  store volatile double %92, double* %2, align 8, !dbg !153, !tbaa !88
  %93 = load volatile double, double* %2, align 8, !dbg !154, !tbaa !88
  %94 = fsub double %93, %91, !dbg !155
  br label %95, !dbg !156

; <label>:95:                                     ; preds = %64, %68, %45, %16, %82, %20
  %96 = phi double [ %44, %20 ], [ %94, %82 ], [ %0, %16 ], [ %0, %45 ], [ %0, %68 ], [ %67, %64 ], !dbg !157
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !158
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %3), !dbg !159
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !159
  ret double %96, !dbg !159
}
...
!117 = !DILocation(line: 114, column: 10, scope: !116)
!118 = !DILocation(line: 114, column: 18, scope: !115)
!119 = !DILocation(line: 115, column: 17, scope: !116)
!120 = !DILocation(line: 115, column: 15, scope: !116)
!121 = !DILocation(line: 115, column: 32, scope: !116)
!122 = !DILocation(line: 115, column: 21, scope: !116)
!123 = !DILocation(line: 116, column: 3, scope: !116)
!124 = !DILocation(line: 118, column: 15, scope: !125)
!125 = distinct !DILexicalBlock(scope: !51, file: !3, line: 118, column: 13)
!126 = !DILocation(line: 118, column: 13, scope: !51)
!127 = !DILocation(line: 119, column: 11, scope: !128)
!128 = distinct !DILexicalBlock(scope: !129, file: !3, line: 119, column: 9)
!129 = distinct !DILexicalBlock(scope: !125, file: !3, line: 118, column: 20)
!130 = !DILocation(line: 119, column: 9, scope: !129)
!131 = !DILocation(line: 119, column: 28, scope: !128)
!132 = !DILocation(line: 122, column: 41, scope: !133)
!133 = distinct !DILexicalBlock(scope: !125, file: !3, line: 121, column: 9)
!134 = !DILocation(line: 122, column: 36, scope: !133)
!135 = !DILocation(line: 123, column: 12, scope: !136)
!136 = distinct !DILexicalBlock(scope: !133, file: !3, line: 123, column: 9)
!137 = !DILocation(line: 123, column: 15, scope: !136)
!138 = !DILocation(line: 123, column: 9, scope: !133)
!139 = !DILocation(line: 124, column: 7, scope: !133)
!140 = !DILocation(line: 125, column: 12, scope: !141)
!141 = distinct !DILexicalBlock(scope: !133, file: !3, line: 125, column: 9)
!142 = !DILocation(line: 125, column: 15, scope: !141)
!143 = !DILocation(line: 125, column: 9, scope: !133)
!144 = !DILocation(line: 125, column: 30, scope: !141)
!145 = !DILocation(line: 125, column: 28, scope: !141)
!146 = !DILocation(line: 125, column: 48, scope: !141)
!147 = !DILocation(line: 125, column: 34, scope: !141)
!148 = !DILocation(line: 125, column: 20, scope: !141)
!149 = !DILocation(line: 0, scope: !35)
!150 = !DILocation(line: 127, column: 2, scope: !57)
!151 = !DILocation(line: 128, column: 6, scope: !19)
!152 = !DILocation(line: 128, column: 15, scope: !19)
!153 = !DILocation(line: 128, column: 4, scope: !19)
!154 = !DILocation(line: 129, column: 9, scope: !19)
!155 = !DILocation(line: 129, column: 10, scope: !19)
!156 = !DILocation(line: 129, column: 2, scope: !19)
!157 = !DILocation(line: 0, scope: !136)
!158 = !DILocation(line: 0, scope: !74)
!159 = !DILocation(line: 130, column: 1, scope: !19)
