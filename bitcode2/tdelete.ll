...
define dso_local i8* @tdelete(i8* noalias, i8** noalias, i32 (i8*, i8*)* nocapture) local_unnamed_addr #0 !dbg !21 {
  ...
  br i1 %5, label %83, label %6, !dbg !47
...
; <label>:6:                                      ; preds = %3
  ...
  br i1 %8, label %83, label %9, !dbg !55
...
; <label>:21:                                     ; preds = %9, %15
  ...
  br i1 %29, label %83, label %15, !dbg !74, !llvm.loop !64
...
; <label>:46:                                     ; preds = %41
  ...
  %47 = getelementptr inbounds %struct.node, %struct.node* %43, i64 0, i32 1, !dbg !99
  %48 = load %struct.node*, %struct.node** %47, align 8, !dbg !99, !tbaa !81
  %49 = icmp eq %struct.node* %48, null, !dbg !101
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !102
  br i1 %49, label %59, label %50, !dbg !102

; <label>:50:                                     ; preds = %46, %50
  %51 = phi %struct.node* [ %54, %50 ], [ %48, %46 ]
  %52 = phi %struct.node* [ %51, %50 ], [ %43, %46 ]
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !103
  %53 = getelementptr inbounds %struct.node, %struct.node* %51, i64 0, i32 1, !dbg !99
  %54 = load %struct.node*, %struct.node** %53, align 8, !dbg !99, !tbaa !81
  %55 = icmp eq %struct.node* %54, null, !dbg !101
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !102
  br i1 %55, label %56, label %50, !dbg !102, !llvm.loop !104

; <label>:56:                                     ; preds = %50
  %57 = getelementptr inbounds %struct.node, %struct.node* %51, i64 0, i32 1, !dbg !99
  %58 = getelementptr inbounds %struct.node, %struct.node* %52, i64 0, i32 1, !dbg !106
  br label %59, !dbg !102

; <label>:59:                                     ; preds = %56, %46
  %60 = phi %struct.node** [ %58, %56 ], [ %42, %46 ], !dbg !106
  %61 = phi %struct.node* [ %51, %56 ], [ %43, %46 ], !dbg !107
  %62 = phi %struct.node** [ %57, %56 ], [ %47, %46 ], !dbg !99
  %63 = getelementptr inbounds %struct.node, %struct.node* %61, i64 0, i32 2, !dbg !108
  %64 = bitcast %struct.node** %63 to i64*, !dbg !108
  %65 = load i64, i64* %64, align 8, !dbg !108, !tbaa !77
  %66 = bitcast %struct.node** %60 to i64*, !dbg !109
  store i64 %65, i64* %66, align 8, !dbg !109, !tbaa !81
  %67 = load %struct.node*, %struct.node** %31, align 8, !dbg !110, !tbaa !49
  %68 = getelementptr inbounds %struct.node, %struct.node* %67, i64 0, i32 1, !dbg !111
  %69 = bitcast %struct.node** %68 to i64*, !dbg !111
  %70 = load i64, i64* %69, align 8, !dbg !111, !tbaa !81
  %71 = bitcast %struct.node** %62 to i64*, !dbg !112
  store i64 %70, i64* %71, align 8, !dbg !112, !tbaa !81
  %72 = load %struct.node*, %struct.node** %31, align 8, !dbg !113, !tbaa !49
  %73 = getelementptr inbounds %struct.node, %struct.node* %72, i64 0, i32 2, !dbg !114
  %74 = bitcast %struct.node** %73 to i64*, !dbg !114
  %75 = load i64, i64* %74, align 8, !dbg !114, !tbaa !77
  store i64 %75, i64* %64, align 8, !dbg !115, !tbaa !77
  br label %76

; <label>:76:                                     ; preds = %30, %45, %59
  %77 = phi %struct.node* [ %61, %59 ], [ %35, %45 ], [ %35, %30 ]
  store volatile i32 42, i32* @__A_VARIABLE, align 4
  br label %78, !dbg !116

; <label>:78:                                     ; preds = %76, %39
  %79 = phi %struct.node* [ %37, %39 ], [ %77, %76 ], !dbg !117
  %80 = bitcast %struct.node** %31 to i8**, !dbg !116
  %81 = load i8*, i8** %80, align 8, !dbg !116, !tbaa !49
  tail call void @free(i8* %81) #3, !dbg !118
  store %struct.node* %79, %struct.node** %31, align 8, !dbg !119, !tbaa !49
  %82 = bitcast %struct.node* %32 to i8*, !dbg !120
  br label %83, !dbg !121

; <label>:83:                                     ; preds = %21, %3, %6, %78
  %84 = phi i8* [ %82, %78 ], [ null, %6 ], [ null, %3 ], [ null, %21 ], !dbg !62
...
!98 = distinct !DILexicalBlock(scope: !89, file: !1, line: 56, column: 10)
!99 = !DILocation(line: 57, column: 26, scope: !100)
!100 = distinct !DILexicalBlock(scope: !97, file: !1, line: 57, column: 4)
!101 = !DILocation(line: 57, column: 32, scope: !100)
!102 = !DILocation(line: 57, column: 4, scope: !97)
!103 = !DILocation(line: 57, column: 4, scope: !100)
!104 = distinct !{!104, !102, !105}
!105 = !DILocation(line: 58, column: 9, scope: !97)
!106 = !DILocation(line: 59, column: 7, scope: !98)
!107 = !DILocation(line: 0, scope: !100)
!108 = !DILocation(line: 59, column: 18, scope: !98)
!109 = !DILocation(line: 59, column: 13, scope: !98)
!110 = !DILocation(line: 60, column: 16, scope: !98)
!111 = !DILocation(line: 60, column: 25, scope: !98)
!112 = !DILocation(line: 60, column: 13, scope: !98)
!113 = !DILocation(line: 61, column: 16, scope: !98)
!114 = !DILocation(line: 61, column: 25, scope: !98)
!115 = !DILocation(line: 61, column: 13, scope: !98)
!116 = !DILocation(line: 64, column: 7, scope: !21)
!117 = !DILocation(line: 0, scope: !80)
!118 = !DILocation(line: 64, column: 2, scope: !21)
!119 = !DILocation(line: 65, column: 9, scope: !21)
!120 = !DILocation(line: 66, column: 9, scope: !21)
!121 = !DILocation(line: 66, column: 2, scope: !21)
!122 = !DILocation(line: 0, scope: !46)
!123 = !DILocation(line: 67, column: 1, scope: !21)
