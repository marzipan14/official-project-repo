; ModuleID = '/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/stdio/diprintf.c'
source_filename = "/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/stdio/diprintf.c"
...
define dso_local i32 @_diprintf_r(%struct._reent*, i32, i8*, ...) local_unnamed_addr #0 !dbg !7 {
  %4 = alloca [1 x %struct.__va_list_tag], align 16
  %5 = bitcast [1 x %struct.__va_list_tag]* %4 to i8*, !dbg !249
  call void @llvm.lifetime.start.p0i8(i64 24, i8* nonnull %5) #3, !dbg !249
  %6 = getelementptr inbounds [1 x %struct.__va_list_tag], [1 x %struct.__va_list_tag]* %4, i64 0, i64 0, !dbg !251
  call void @llvm.va_start(i8* nonnull %5), !dbg !251
  %7 = call i32 @_vdiprintf_r(%struct._reent* %0, i32 %1, i8* %2, %struct.__va_list_tag* nonnull %6) #5, !dbg !252
  call void @llvm.va_end(i8* nonnull %5), !dbg !254
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %5) #3, !dbg !255
...
declare dso_local i32 @_vdiprintf_r(%struct._reent*, i32, i8*, %struct.__va_list_tag*) local_unnamed_addr #4
...
; Function Attrs: noredzone nounwind
define dso_local i32 @diprintf(i32, i8*, ...) local_unnamed_addr #0 !dbg !257 {
  %3 = alloca [1 x %struct.__va_list_tag], align 16
  %4 = bitcast [1 x %struct.__va_list_tag]* %3 to i8*, !dbg !266
  call void @llvm.lifetime.start.p0i8(i64 24, i8* nonnull %4) #3, !dbg !266
  %5 = getelementptr inbounds [1 x %struct.__va_list_tag], [1 x %struct.__va_list_tag]* %3, i64 0, i64 0, !dbg !268
  call void @llvm.va_start(i8* nonnull %4), !dbg !268
  %6 = call %struct._reent* @__getreent() #5, !dbg !269
  %7 = call i32 @_vdiprintf_r(%struct._reent* %6, i32 %0, i8* %1, %struct.__va_list_tag* nonnull %5) #5, !dbg !270
  call void @llvm.va_end(i8* nonnull %4), !dbg !272
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %4) #3, !dbg !273
...
!1 = !DIFile(filename: "/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/stdio/diprintf.c", directory: "/root/.unikraft/apps/redis/build")
!2 = !{}
!3 = !{i32 2, !"Dwarf Version", i32 4}
!4 = !{i32 2, !"Debug Info Version", i32 3}
!5 = !{i32 1, !"wchar_size", i32 4}
!6 = !{!"clang version 7.0.1-8+deb10u2 (tags/RELEASE_701/final)"}
!7 = distinct !DISubprogram(name: "_diprintf_r", scope: !1, file: !1, line: 52, type: !8, isLocal: false, isDefinition: true, scopeLine: 56, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !230)
...
!230 = !{!231, !232, !233, !234, !247}
!231 = !DILocalVariable(name: "ptr", arg: 1, scope: !7, file: !1, line: 52, type: !11)
!232 = !DILocalVariable(name: "fd", arg: 2, scope: !7, file: !1, line: 52, type: !10)
!233 = !DILocalVariable(name: "format", arg: 3, scope: !7, file: !1, line: 52, type: !50)
!234 = !DILocalVariable(name: "ap", scope: !7, file: !1, line: 57, type: !235)
!235 = !DIDerivedType(tag: DW_TAG_typedef, name: "va_list", file: !236, line: 46, baseType: !237)
...
!237 = !DIDerivedType(tag: DW_TAG_typedef, name: "__gnuc_va_list", file: !238, line: 51, baseType: !239)
!238 = !DIFile(filename: "/root/.unikraft/libs/newlib/include/stdarg.h", directory: "/root/.unikraft/apps/redis/build")
!239 = !DIDerivedType(tag: DW_TAG_typedef, name: "__builtin_va_list", file: !1, line: 57, baseType: !240)
!240 = !DICompositeType(tag: DW_TAG_array_type, baseType: !241, size: 192, elements: !70)
!241 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "__va_list_tag", file: !1, line: 57, size: 192, elements: !242)
!242 = !{!243, !244, !245, !246}
!243 = !DIDerivedType(tag: DW_TAG_member, name: "gp_offset", scope: !241, file: !1, line: 57, baseType: !92, size: 32)
!244 = !DIDerivedType(tag: DW_TAG_member, name: "fp_offset", scope: !241, file: !1, line: 57, baseType: !92, size: 32, offset: 32)
!245 = !DIDerivedType(tag: DW_TAG_member, name: "overflow_arg_area", scope: !241, file: !1, line: 57, baseType: !36, size: 64, offset: 64)
!246 = !DIDerivedType(tag: DW_TAG_member, name: "reg_save_area", scope: !241, file: !1, line: 57, baseType: !36, size: 64, offset: 128)
!247 = !DILocalVariable(name: "n", scope: !7, file: !1, line: 58, type: !10)
!248 = !DILocation(line: 52, column: 1, scope: !7)
!249 = !DILocation(line: 57, column: 3, scope: !7)
!250 = !DILocation(line: 57, column: 11, scope: !7)
!251 = !DILocation(line: 60, column: 3, scope: !7)
!252 = !DILocation(line: 61, column: 7, scope: !7)
!253 = !DILocation(line: 58, column: 7, scope: !7)
!254 = !DILocation(line: 62, column: 3, scope: !7)
!255 = !DILocation(line: 64, column: 1, scope: !7)
!256 = !DILocation(line: 63, column: 3, scope: !7)
!257 = distinct !DISubprogram(name: "diprintf", scope: !1, file: !1, line: 69, type: !258, isLocal: false, isDefinition: true, scopeLine: 72, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !260)
!258 = !DISubroutineType(types: !259)
!259 = !{!10, !10, !50, null}
!260 = !{!261, !262, !263, !264}
!261 = !DILocalVariable(name: "fd", arg: 1, scope: !257, file: !1, line: 69, type: !10)
!262 = !DILocalVariable(name: "format", arg: 2, scope: !257, file: !1, line: 69, type: !50)
!263 = !DILocalVariable(name: "ap", scope: !257, file: !1, line: 73, type: !235)
!264 = !DILocalVariable(name: "n", scope: !257, file: !1, line: 74, type: !10)
!265 = !DILocation(line: 69, column: 1, scope: !257)
!266 = !DILocation(line: 73, column: 3, scope: !257)
!267 = !DILocation(line: 73, column: 11, scope: !257)
!268 = !DILocation(line: 76, column: 3, scope: !257)
!269 = !DILocation(line: 77, column: 21, scope: !257)
!270 = !DILocation(line: 77, column: 7, scope: !257)
!271 = !DILocation(line: 74, column: 7, scope: !257)
!272 = !DILocation(line: 78, column: 3, scope: !257)
!273 = !DILocation(line: 80, column: 1, scope: !257)
!274 = !DILocation(line: 79, column: 3, scope: !257)
