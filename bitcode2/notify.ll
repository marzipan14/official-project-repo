...
define dso_local i32 @keyspaceEventsStringToFlags(i8* nocapture readonly) local_unnamed_addr #0 !dbg !7 {
  ...
  %2 = load i8, i8* %0, align 1, !dbg !22, !tbaa !23
  %3 = icmp eq i8 %2, 0, !dbg !26
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !21
  br i1 %3, label %26, label %4, !dbg !21
...
; <label>:21:                                     ; preds = %4, %20, %19, %18, %17, %16, %15, %14, %13, %12, %11, %10
  ...
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !21
  %24 = load i8, i8* %8, align 1, !dbg !22, !tbaa !23
  %25 = icmp eq i8 %24, 0, !dbg !26
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !21
  br i1 %25, label %26, label %4, !dbg !21, !llvm.loop !44

; <label>:26:                                     ; preds = %21, %4, %1
...
; <label>:54:                                     ; preds = %48, %52
  ...
  br i1 %57, label %62, label %58, !dbg !117
...
; <label>:62:                                     ; preds = %60, %54
  %63 = phi i8* [ %55, %54 ], [ %61, %60 ], !dbg !123
  %64 = and i32 %0, 1, !dbg !121
  %65 = icmp eq i32 %64, 0, !dbg !121
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !124
  br i1 %65, label %68, label %66, !dbg !124

; <label>:66:                                     ; preds = %62
  %67 = tail call i8* @sdscatlen(i8* %63, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.10, i64 0, i64 0), i64 1) #4, !dbg !125
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !126
  br label %68, !dbg !126

; <label>:68:                                     ; preds = %62, %66
  %69 = phi i8* [ %67, %66 ], [ %63, %62 ], !dbg !120
  %70 = and i32 %0, 2, !dbg !127
  %71 = icmp eq i32 %70, 0, !dbg !127
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !129
  br i1 %71, label %74, label %72, !dbg !129

; <label>:72:                                     ; preds = %68
  %73 = tail call i8* @sdscatlen(i8* %69, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.11, i64 0, i64 0), i64 1) #4, !dbg !130
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !131
  br label %74, !dbg !131

; <label>:74:                                     ; preds = %68, %72
  %75 = phi i8* [ %73, %72 ], [ %69, %68 ], !dbg !132
...
; <label>:16:                                     ; preds = %10
  ...
  %28 = load i32, i32* getelementptr inbounds (%struct.redisServer, %struct.redisServer* @server, i64 0, i32 257), align 8, !dbg !208, !tbaa !172
  br label %29, !dbg !207

; <label>:29:                                     ; preds = %10, %16
  %30 = phi i32 [ %28, %16 ], [ %13, %10 ], !dbg !208
...
!21 = !DILocation(line: 44, column: 5, scope: !7)
!22 = !DILocation(line: 44, column: 16, scope: !7)
!23 = !{!24, !24, i64 0}
!24 = !{!"omnipotent char", !25, i64 0}
!25 = !{!"Simple C/C++ TBAA"}
!26 = !DILocation(line: 44, column: 22, scope: !7)
...
!120 = !DILocation(line: 0, scope: !64)
...
!124 = !DILocation(line: 85, column: 9, scope: !48)
!125 = !DILocation(line: 85, column: 40, scope: !122)
!126 = !DILocation(line: 85, column: 34, scope: !122)
...
!207 = !DILocation(line: 124, column: 5, scope: !192)
!208 = !DILocation(line: 127, column: 16, scope: !209)
!209 = distinct !DILexicalBlock(scope: !134, file: !1, line: 127, column: 9)
!210 = !DILocation(line: 0, scope: !134)
!211 = !DILocation(line: 127, column: 39, scope: !209)
!212 = !DILocation(line: 127, column: 9, scope: !134)
!213 = !DILocation(line: 128, column: 16, scope: !214)
!214 = distinct !DILexicalBlock(scope: !209, file: !1, line: 127, column: 58)
...
!233 = !DILocation(line: 0, scope: !171)
