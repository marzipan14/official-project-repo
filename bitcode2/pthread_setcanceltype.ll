; ModuleID = '/root/.unikraft/apps/redis/build/libpthread-embedded/origin/pthread-embedded-44b41d760a433915d70a7be9809651b0a65e001d/pthread_setcanceltype.c'
source_filename = "/root/.unikraft/apps/redis/build/libpthread-embedded/origin/pthread-embedded-44b41d760a433915d70a7be9809651b0a65e001d/pthread_setcanceltype.c"
...
define dso_local i32 @pthread_setcanceltype(i32, i32*) local_unnamed_addr #0 !dbg !545 {
  %3 = tail call { i8*, i32 } @pthread_self() #3, !dbg !557
  %4 = extractvalue { i8*, i32 } %3, 0, !dbg !557
  %5 = icmp eq i32 %0, 0, !dbg !560
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !562
  br i1 %5, label %21, label %6, !dbg !562

; <label>:6:                                      ; preds = %2
  %7 = icmp eq i8* %4, null, !dbg !563
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !565
  br i1 %7, label %21, label %8, !dbg !565

; <label>:8:                                      ; preds = %6
  %9 = icmp ugt i32 %0, 1, !dbg !566
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !566
  br i1 %9, label %21, label %10, !dbg !566

; <label>:10:                                     ; preds = %8
  %11 = getelementptr inbounds i8, i8* %4, i64 80, !dbg !567
  %12 = bitcast i8* %11 to %struct.pthread_mutex_t_**, !dbg !567
  %13 = tail call i32 @pthread_mutex_lock(%struct.pthread_mutex_t_** nonnull %12) #3, !dbg !568
  %14 = icmp eq i32* %1, null, !dbg !569
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !571
  %15 = getelementptr inbounds i8, i8* %4, i64 92, !dbg !572
  %16 = bitcast i8* %15 to i32*, !dbg !572
  br i1 %14, label %19, label %17, !dbg !571

; <label>:17:                                     ; preds = %10
  %18 = load i32, i32* %16, align 4, !dbg !574, !tbaa !575
  store i32 %18, i32* %1, align 4, !dbg !582, !tbaa !583
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !584
  br label %19, !dbg !584

; <label>:19:                                     ; preds = %10, %17
  store i32 %0, i32* %16, align 4, !dbg !585, !tbaa !575
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !586
  %20 = tail call i32 @pthread_mutex_unlock(%struct.pthread_mutex_t_** nonnull %12) #3, !dbg !588
  br label %21, !dbg !589

; <label>:21:                                     ; preds = %6, %8, %2, %19
  %22 = phi i32 [ 0, %19 ], [ 1, %2 ], [ 22, %8 ], [ 22, %6 ], !dbg !590
...
!1 = !DIFile(filename: "/root/.unikraft/apps/redis/build/libpthread-embedded/origin/pthread-embedded-44b41d760a433915d70a7be9809651b0a65e001d/pthread_setcanceltype.c", directory: "/root/.unikraft/apps/redis/build")
!2 = !{!3, !10, !20, !38}
...
!545 = distinct !DISubprogram(name: "pthread_setcanceltype", scope: !1, file: !1, line: 48, type: !546, isLocal: false, isDefinition: true, scopeLine: 88, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !548)
!546 = !DISubroutineType(types: !547)
!547 = !{!22, !22, !162}
!548 = !{!549, !550, !551, !552, !553}
!549 = !DILocalVariable(name: "type", arg: 1, scope: !545, file: !1, line: 48, type: !22)
!550 = !DILocalVariable(name: "oldtype", arg: 2, scope: !545, file: !1, line: 48, type: !162)
!551 = !DILocalVariable(name: "result", scope: !545, file: !1, line: 89, type: !22)
!552 = !DILocalVariable(name: "self", scope: !545, file: !1, line: 90, type: !497)
!553 = !DILocalVariable(name: "sp", scope: !545, file: !1, line: 91, type: !48)
!554 = !DILocation(line: 48, column: 28, scope: !545)
!555 = !DILocation(line: 48, column: 39, scope: !545)
!556 = !DILocation(line: 89, column: 7, scope: !545)
!557 = !DILocation(line: 90, column: 20, scope: !545)
!558 = !DILocation(line: 90, column: 13, scope: !545)
!559 = !DILocation(line: 91, column: 18, scope: !545)
!560 = !DILocation(line: 94, column: 12, scope: !561)
!561 = distinct !DILexicalBlock(scope: !545, file: !1, line: 94, column: 7)
!562 = !DILocation(line: 94, column: 7, scope: !545)
!563 = !DILocation(line: 103, column: 10, scope: !564)
!564 = distinct !DILexicalBlock(scope: !545, file: !1, line: 103, column: 7)
!565 = !DILocation(line: 104, column: 7, scope: !564)
!566 = !DILocation(line: 105, column: 11, scope: !564)
!567 = !DILocation(line: 113, column: 35, scope: !545)
!568 = !DILocation(line: 113, column: 10, scope: !545)
!569 = !DILocation(line: 115, column: 15, scope: !570)
!570 = distinct !DILexicalBlock(scope: !545, file: !1, line: 115, column: 7)
!571 = !DILocation(line: 115, column: 7, scope: !545)
!572 = !DILocation(line: 0, scope: !573)
!573 = distinct !DILexicalBlock(scope: !570, file: !1, line: 116, column: 5)
!574 = !DILocation(line: 117, column: 22, scope: !573)
!575 = !{!576, !581, i64 92}
!576 = !{!"pte_thread_t_", !577, i64 0, !580, i64 8, !577, i64 24, !578, i64 32, !577, i64 40, !577, i64 48, !581, i64 56, !581, i64 60, !577, i64 64, !581, i64 72, !577, i64 80, !581, i64 88, !581, i64 92, !581, i64 96, !578, i64 104, !581, i64 168, !577, i64 176, !577, i64 184}
!577 = !{!"any pointer", !578, i64 0}
!578 = !{!"omnipotent char", !579, i64 0}
!579 = !{!"Simple C/C++ TBAA"}
!580 = !{!"", !577, i64 0, !581, i64 8}
!581 = !{!"int", !578, i64 0}
!582 = !DILocation(line: 117, column: 16, scope: !573)
!583 = !{!581, !581, i64 0}
!584 = !DILocation(line: 118, column: 5, scope: !573)
!585 = !DILocation(line: 120, column: 18, scope: !545)
!586 = !DILocation(line: 127, column: 7, scope: !587)
!587 = distinct !DILexicalBlock(scope: !545, file: !1, line: 126, column: 7)
!588 = !DILocation(line: 138, column: 10, scope: !545)
!589 = !DILocation(line: 140, column: 3, scope: !545)
!590 = !DILocation(line: 0, scope: !545)
!591 = !DILocation(line: 0, scope: !592)
!592 = distinct !DILexicalBlock(scope: !561, file: !1, line: 95, column: 5)
!593 = !DILocation(line: 142, column: 1, scope: !545)
