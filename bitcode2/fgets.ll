...
define dso_local i8* @_fgets_r(%struct._reent*, i8* noalias, i32, %struct.__sFILE* noalias) local_unnamed_addr #0 !dbg !29 {
  ...
  br i1 %6, label %72, label %7, !dbg !273
...
; <label>:20:                                     ; preds = %57, %14
  %21 = phi i8* [ %1, %14 ], [ %63, %57 ], !dbg !290
  %22 = phi i32 [ %17, %14 ], [ %64, %57 ], !dbg !292
...
; <label>:28:                                     ; preds = %25
  ...
  br i1 %29, label %30, label %68, !dbg !310
...
; <label>:35:                                     ; preds = %33, %20
  ...
  br i1 %38, label %39, label %40, !dbg !322
...
; <label>:40:                                     ; preds = %39, %35
  %41 = phi i32 [ %22, %39 ], [ %36, %35 ]
  %42 = sext i32 %41 to i64, !dbg !324
  %43 = call i8* @memchr(i8* %37, i32 10, i64 %42) #4, !dbg !326
  %44 = icmp eq i8* %43, null, !dbg !328
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !330
  br i1 %44, label %57, label %45, !dbg !330

; <label>:45:                                     ; preds = %40
  %46 = getelementptr inbounds i8, i8* %43, i64 1, !dbg !331
  %47 = ptrtoint i8* %46 to i64, !dbg !333
  %48 = ptrtoint i8* %37 to i64, !dbg !333
  %49 = sub i64 %47, %48, !dbg !333
  %50 = load i32, i32* %18, align 8, !dbg !334, !tbaa !295
  %51 = trunc i64 %49 to i32, !dbg !334
  %52 = sub i32 %50, %51, !dbg !334
  store i32 %52, i32* %18, align 8, !dbg !334, !tbaa !295
  store i8* %46, i8** %19, align 8, !dbg !335, !tbaa !318
  %53 = call i8* @memcpy(i8* %21, i8* %37, i64 %49) #4, !dbg !336
  %54 = getelementptr inbounds i8, i8* %21, i64 %49, !dbg !337
  store i8 0, i8* %54, align 1, !dbg !338, !tbaa !339
  %55 = load i32, i32* %5, align 4, !dbg !340, !tbaa !313
  %56 = call i32 @pthread_setcancelstate(i32 %55, i32* nonnull %5) #4, !dbg !340
  br label %66, !dbg !341

; <label>:57:                                     ; preds = %40
  %58 = load i32, i32* %18, align 8, !dbg !342, !tbaa !295
  %59 = sub i32 %58, %41, !dbg !342
  store i32 %59, i32* %18, align 8, !dbg !342, !tbaa !295
  %60 = load i8*, i8** %19, align 8, !dbg !343, !tbaa !318
  %61 = getelementptr inbounds i8, i8* %60, i64 %42, !dbg !343
  store i8* %61, i8** %19, align 8, !dbg !343, !tbaa !318
  %62 = call i8* @memcpy(i8* %21, i8* %37, i64 %42) #4, !dbg !344
  %63 = getelementptr inbounds i8, i8* %21, i64 %42, !dbg !345
  %64 = sub i32 %22, %41, !dbg !346
  %65 = icmp eq i32 %64, 0, !dbg !347
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !348
  br i1 %65, label %68, label %20, !dbg !348, !llvm.loop !349

; <label>:66:                                     ; preds = %30, %45
  %67 = phi i8* [ %1, %45 ], [ null, %30 ]
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !351
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %15) #5, !dbg !352
  br label %72

; <label>:68:                                     ; preds = %57, %28
  %69 = phi i8* [ %21, %28 ], [ %63, %57 ], !dbg !290
  store i8 0, i8* %69, align 1, !dbg !353, !tbaa !339
  %70 = load i32, i32* %5, align 4, !dbg !354, !tbaa !313
  %71 = call i32 @pthread_setcancelstate(i32 %70, i32* nonnull %5) #4, !dbg !354
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !352
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %15) #5, !dbg !352
  store volatile i32 42, i32* @__A_VARIABLE, align 4
  br label %72, !dbg !355

; <label>:72:                                     ; preds = %4, %66, %68
  %73 = phi i8* [ %1, %68 ], [ %67, %66 ], [ null, %4 ], !dbg !356
  store volatile i32 42, i32* @__A_VARIABLE, align 4
...
; Function Attrs: noredzone nounwind
define dso_local i8* @fgets(i8* noalias, i32, %struct.__sFILE* noalias) local_unnamed_addr #0 !dbg !358 {
  %4 = tail call %struct._reent* @__getreent() #4, !dbg !366
  %5 = tail call i8* @_fgets_r(%struct._reent* %4, i8* %0, i32 %1, %struct.__sFILE* %2) #6, !dbg !367
...
!323 = !DILocation(line: 194, column: 2, scope: !321)
!324 = !DILocation(line: 0, scope: !305)
!325 = !DILocation(line: 131, column: 10, scope: !29)
!326 = !DILocation(line: 195, column: 29, scope: !291)
!327 = !DILocation(line: 133, column: 22, scope: !29)
!328 = !DILocation(line: 196, column: 13, scope: !329)
!329 = distinct !DILexicalBlock(scope: !291, file: !1, line: 196, column: 11)
!330 = !DILocation(line: 196, column: 11, scope: !291)
!331 = !DILocation(line: 198, column: 10, scope: !332)
!332 = distinct !DILexicalBlock(scope: !329, file: !1, line: 197, column: 2)
!333 = !DILocation(line: 198, column: 14, scope: !332)
!334 = !DILocation(line: 199, column: 11, scope: !332)
!335 = !DILocation(line: 200, column: 11, scope: !332)
!336 = !DILocation(line: 201, column: 15, scope: !332)
!337 = !DILocation(line: 202, column: 4, scope: !332)
!338 = !DILocation(line: 202, column: 11, scope: !332)
!339 = !{!281, !281, i64 0}
!340 = !DILocation(line: 203, column: 11, scope: !332)
!341 = !DILocation(line: 204, column: 4, scope: !332)
!342 = !DILocation(line: 206, column: 14, scope: !291)
!343 = !DILocation(line: 207, column: 14, scope: !291)
!344 = !DILocation(line: 208, column: 18, scope: !291)
!345 = !DILocation(line: 209, column: 9, scope: !291)
!346 = !DILocation(line: 211, column: 13, scope: !269)
!347 = !DILocation(line: 211, column: 21, scope: !269)
!348 = !DILocation(line: 210, column: 5, scope: !291)
!349 = distinct !{!349, !289, !350}
!350 = !DILocation(line: 211, column: 25, scope: !269)
!351 = !DILocation(line: 0, scope: !332)
!352 = !DILocation(line: 213, column: 3, scope: !29)
!353 = !DILocation(line: 212, column: 6, scope: !269)
!354 = !DILocation(line: 213, column: 3, scope: !269)
!355 = !DILocation(line: 214, column: 3, scope: !29)
!356 = !DILocation(line: 0, scope: !312)
!357 = !DILocation(line: 215, column: 1, scope: !29)
!358 = distinct !DISubprogram(name: "fgets", scope: !1, file: !1, line: 220, type: !359, isLocal: false, isDefinition: true, scopeLine: 224, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !361)
!359 = !DISubroutineType(types: !360)
!360 = !{!32, !248, !5, !249}
!361 = !{!362, !363, !364}
!362 = !DILocalVariable(name: "buf", arg: 1, scope: !358, file: !1, line: 220, type: !248)
!363 = !DILocalVariable(name: "n", arg: 2, scope: !358, file: !1, line: 220, type: !5)
!364 = !DILocalVariable(name: "fp", arg: 3, scope: !358, file: !1, line: 220, type: !249)
!365 = !DILocation(line: 220, column: 1, scope: !358)
!366 = !DILocation(line: 225, column: 20, scope: !358)
!367 = !DILocation(line: 225, column: 10, scope: !358)
!368 = !DILocation(line: 225, column: 3, scope: !358)
