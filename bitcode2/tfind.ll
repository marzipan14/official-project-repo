...
; <label>:19:                                     ; preds = %9
  ...
  %21 = load %struct.node*, %struct.node** %11, align 8, !dbg !62, !tbaa !45
...
; <label>:27:                                     ; preds = %19, %6, %3, %16
  %28 = phi i8* [ %18, %16 ], [ null, %3 ], [ null, %6 ], [ null, %19 ], !dbg !67
  store volatile i32 42, i32* @__A_VARIABLE, align 4
...
!61 = !DILocation(line: 43, column: 14, scope: !37)
!62 = !DILocation(line: 0, scope: !37)
!63 = !DILocation(line: 44, column: 18, scope: !37)
!64 = !DILocation(line: 45, column: 18, scope: !37)
!65 = !DILocation(line: 43, column: 11, scope: !37)
!66 = !DILocation(line: 46, column: 2, scope: !21)
!67 = !DILocation(line: 0, scope: !21)
!68 = !DILocation(line: 48, column: 1, scope: !21)
