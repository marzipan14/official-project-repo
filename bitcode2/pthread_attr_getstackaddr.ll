; ModuleID = '/root/.unikraft/apps/redis/build/libpthread-embedded/origin/pthread-embedded-44b41d760a433915d70a7be9809651b0a65e001d/pthread_attr_getstackaddr.c'
source_filename = "/root/.unikraft/apps/redis/build/libpthread-embedded/origin/pthread-embedded-44b41d760a433915d70a7be9809651b0a65e001d/pthread_attr_getstackaddr.c"
...
define dso_local i32 @pthread_attr_getstackaddr(%struct.pthread_attr_t_**, i8** nocapture) local_unnamed_addr #0 !dbg !7 {
  ...
  br i1 %4, label %5, label %11, !dbg !45

; <label>:5:                                      ; preds = %2
  %6 = load %struct.pthread_attr_t_*, %struct.pthread_attr_t_** %0, align 8, !dbg !46, !tbaa !47
  %7 = getelementptr inbounds %struct.pthread_attr_t_, %struct.pthread_attr_t_* %6, i64 0, i32 1, !dbg !51
  %8 = bitcast i8** %7 to i64*, !dbg !51
  %9 = load i64, i64* %8, align 8, !dbg !51, !tbaa !52
  %10 = bitcast i8** %1 to i64*, !dbg !57
  store i64 %9, i64* %10, align 8, !dbg !57, !tbaa !47
  br label %11, !dbg !58

; <label>:11:                                     ; preds = %2, %5
  %12 = phi i32 [ 0, %5 ], [ 22, %2 ], !dbg !59
...
!1 = !DIFile(filename: "/root/.unikraft/apps/redis/build/libpthread-embedded/origin/pthread-embedded-44b41d760a433915d70a7be9809651b0a65e001d/pthread_attr_getstackaddr.c", directory: "/root/.unikraft/apps/redis/build")
!2 = !{}
!3 = !{i32 2, !"Dwarf Version", i32 4}
!4 = !{i32 2, !"Debug Info Version", i32 3}
!5 = !{i32 1, !"wchar_size", i32 4}
!6 = !{!"clang version 7.0.1-8+deb10u2 (tags/RELEASE_701/final)"}
!7 = distinct !DISubprogram(name: "pthread_attr_getstackaddr", scope: !1, file: !1, line: 48, type: !8, isLocal: false, isDefinition: true, scopeLine: 83, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !37)
...
!39 = !DILocalVariable(name: "stackaddr", arg: 2, scope: !7, file: !1, line: 48, type: !36)
!40 = !DILocation(line: 48, column: 51, scope: !7)
!41 = !DILocation(line: 48, column: 64, scope: !7)
!42 = !DILocation(line: 86, column: 7, scope: !43)
!43 = distinct !DILexicalBlock(scope: !7, file: !1, line: 86, column: 7)
!44 = !DILocation(line: 86, column: 26, scope: !43)
!45 = !DILocation(line: 86, column: 7, scope: !7)
...
!57 = !DILocation(line: 91, column: 14, scope: !7)
!58 = !DILocation(line: 92, column: 3, scope: !7)
!59 = !DILocation(line: 0, scope: !7)
!60 = !DILocation(line: 0, scope: !61)
!61 = distinct !DILexicalBlock(scope: !43, file: !1, line: 87, column: 5)
!62 = !DILocation(line: 99, column: 1, scope: !7)
