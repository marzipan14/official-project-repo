...
; <label>:31:                                     ; preds = %28, %29, %10
  ...
  call void @llvm.lifetime.end.p0i8(i64 176, i8* nonnull %8) #3, !dbg !322
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %7) #3, !dbg !322
...
; Function Attrs: noredzone nounwind
define dso_local i32 @snprintf(i8* noalias, i64, i8* noalias, ...) local_unnamed_addr #0 !dbg !323 {
  %4 = alloca [1 x %struct.__va_list_tag], align 16
  %5 = alloca %struct.__sFILE, align 8
  %6 = bitcast [1 x %struct.__va_list_tag]* %4 to i8*, !dbg !335
  call void @llvm.lifetime.start.p0i8(i64 24, i8* nonnull %6) #3, !dbg !335
  %7 = bitcast %struct.__sFILE* %5 to i8*, !dbg !337
  call void @llvm.lifetime.start.p0i8(i64 176, i8* nonnull %7) #3, !dbg !337
  %8 = tail call %struct._reent* @__getreent() #5, !dbg !338
  %9 = icmp ugt i64 %1, 2147483647, !dbg !340
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !342
  br i1 %9, label %10, label %12, !dbg !342

; <label>:10:                                     ; preds = %3
  %11 = getelementptr inbounds %struct._reent, %struct._reent* %8, i64 0, i32 0, !dbg !343
  store i32 139, i32* %11, align 8, !dbg !345, !tbaa !266
  br label %31, !dbg !346

; <label>:12:                                     ; preds = %3
  %13 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %5, i64 0, i32 3, !dbg !347
  store i16 520, i16* %13, align 8, !dbg !348, !tbaa !278
  %14 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %5, i64 0, i32 0, !dbg !349
  store i8* %0, i8** %14, align 8, !dbg !350, !tbaa !286
  %15 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %5, i64 0, i32 5, i32 0, !dbg !351
  store i8* %0, i8** %15, align 8, !dbg !352, !tbaa !289
  %16 = icmp ne i64 %1, 0, !dbg !353
  %17 = add i64 %1, 4294967295, !dbg !354
  %18 = select i1 %16, i64 %17, i64 0, !dbg !355
  %19 = trunc i64 %18 to i32, !dbg !356
  %20 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %5, i64 0, i32 2, !dbg !357
  store i32 %19, i32* %20, align 4, !dbg !358, !tbaa !296
  %21 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %5, i64 0, i32 5, i32 1, !dbg !359
  store i32 %19, i32* %21, align 8, !dbg !360, !tbaa !299
  %22 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %5, i64 0, i32 4, !dbg !361
  store i16 -1, i16* %22, align 2, !dbg !362, !tbaa !302
  %23 = getelementptr inbounds [1 x %struct.__va_list_tag], [1 x %struct.__va_list_tag]* %4, i64 0, i64 0, !dbg !363
  call void @llvm.va_start(i8* nonnull %6), !dbg !363
  %24 = call i32 @_svfprintf_r(%struct._reent* %8, %struct.__sFILE* nonnull %5, i8* %2, %struct.__va_list_tag* nonnull %23) #5, !dbg !365
  call void @llvm.va_end(i8* nonnull %6), !dbg !367
  %25 = icmp slt i32 %24, -1, !dbg !368
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !370
  br i1 %25, label %26, label %28, !dbg !370

; <label>:26:                                     ; preds = %12
  %27 = getelementptr inbounds %struct._reent, %struct._reent* %8, i64 0, i32 0, !dbg !371
  store i32 139, i32* %27, align 8, !dbg !372, !tbaa !266
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !373
  br label %28, !dbg !373

; <label>:28:                                     ; preds = %26, %12
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !374
  br i1 %16, label %29, label %31, !dbg !374

; <label>:29:                                     ; preds = %28
  %30 = load i8*, i8** %14, align 8, !dbg !375, !tbaa !286
  store i8 0, i8* %30, align 1, !dbg !377, !tbaa !318
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !378
  br label %31, !dbg !378

; <label>:31:                                     ; preds = %28, %29, %10
  %32 = phi i32 [ -1, %10 ], [ %24, %29 ], [ %24, %28 ], !dbg !379
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !380
  call void @llvm.lifetime.end.p0i8(i64 176, i8* nonnull %7) #3, !dbg !381
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %6) #3, !dbg !381
...
!321 = !DILocation(line: 0, scope: !264)
!322 = !DILocation(line: 73, column: 1, scope: !10)
!323 = distinct !DISubprogram(name: "snprintf", scope: !1, file: !1, line: 85, type: !324, isLocal: false, isDefinition: true, scopeLine: 96, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !326)
!324 = !DISubroutineType(types: !325)
!325 = !{!13, !231, !232, !234, null}
!326 = !{!327, !328, !329, !330, !331, !332, !333}
!327 = !DILocalVariable(name: "str", arg: 1, scope: !323, file: !1, line: 85, type: !231)
!328 = !DILocalVariable(name: "size", arg: 2, scope: !323, file: !1, line: 85, type: !232)
!329 = !DILocalVariable(name: "fmt", arg: 3, scope: !323, file: !1, line: 85, type: !234)
!330 = !DILocalVariable(name: "ret", scope: !323, file: !1, line: 97, type: !13)
!331 = !DILocalVariable(name: "ap", scope: !323, file: !1, line: 98, type: !242)
!332 = !DILocalVariable(name: "f", scope: !323, file: !1, line: 99, type: !255)
!333 = !DILocalVariable(name: "ptr", scope: !323, file: !1, line: 100, type: !14)
!334 = !DILocation(line: 85, column: 1, scope: !323)
!335 = !DILocation(line: 98, column: 3, scope: !323)
!336 = !DILocation(line: 98, column: 11, scope: !323)
!337 = !DILocation(line: 99, column: 3, scope: !323)
!338 = !DILocation(line: 100, column: 24, scope: !323)
!339 = !DILocation(line: 100, column: 18, scope: !323)
!340 = !DILocation(line: 102, column: 12, scope: !341)
!341 = distinct !DILexicalBlock(scope: !323, file: !1, line: 102, column: 7)
!342 = !DILocation(line: 102, column: 7, scope: !323)
!343 = !DILocation(line: 104, column: 12, scope: !344)
!344 = distinct !DILexicalBlock(scope: !341, file: !1, line: 103, column: 5)
!345 = !DILocation(line: 104, column: 19, scope: !344)
!346 = !DILocation(line: 105, column: 7, scope: !344)
!347 = !DILocation(line: 107, column: 5, scope: !323)
!348 = !DILocation(line: 107, column: 12, scope: !323)
!349 = !DILocation(line: 108, column: 19, scope: !323)
!350 = !DILocation(line: 108, column: 22, scope: !323)
!351 = !DILocation(line: 108, column: 9, scope: !323)
!352 = !DILocation(line: 108, column: 15, scope: !323)
!353 = !DILocation(line: 109, column: 30, scope: !323)
!354 = !DILocation(line: 109, column: 41, scope: !323)
!355 = !DILocation(line: 109, column: 25, scope: !323)
!356 = !DILocation(line: 109, column: 24, scope: !323)
!357 = !DILocation(line: 109, column: 19, scope: !323)
!358 = !DILocation(line: 109, column: 22, scope: !323)
!359 = !DILocation(line: 109, column: 9, scope: !323)
!360 = !DILocation(line: 109, column: 15, scope: !323)
!361 = !DILocation(line: 110, column: 5, scope: !323)
!362 = !DILocation(line: 110, column: 11, scope: !323)
!363 = !DILocation(line: 112, column: 3, scope: !323)
!364 = !DILocation(line: 99, column: 8, scope: !323)
!365 = !DILocation(line: 116, column: 9, scope: !323)
!366 = !DILocation(line: 97, column: 7, scope: !323)
!367 = !DILocation(line: 117, column: 3, scope: !323)
!368 = !DILocation(line: 118, column: 11, scope: !369)
!369 = distinct !DILexicalBlock(scope: !323, file: !1, line: 118, column: 7)
!370 = !DILocation(line: 118, column: 7, scope: !323)
!371 = !DILocation(line: 119, column: 10, scope: !369)
!372 = !DILocation(line: 119, column: 17, scope: !369)
!373 = !DILocation(line: 119, column: 5, scope: !369)
!374 = !DILocation(line: 120, column: 7, scope: !323)
!375 = !DILocation(line: 121, column: 8, scope: !376)
!376 = distinct !DILexicalBlock(scope: !323, file: !1, line: 120, column: 7)
!377 = !DILocation(line: 121, column: 11, scope: !376)
!378 = !DILocation(line: 121, column: 5, scope: !376)
!379 = !DILocation(line: 0, scope: !323)
!380 = !DILocation(line: 0, scope: !344)
!381 = !DILocation(line: 123, column: 1, scope: !323)
