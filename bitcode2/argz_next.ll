...
; <label>:10:                                     ; preds = %5
  ...
  %13 = select i1 %12, i8* %9, i8* null, !dbg !43
  br label %17, !dbg !43

; <label>:14:                                     ; preds = %3
  %15 = icmp eq i64 %1, 0, !dbg !44
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !47
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !48
  %16 = select i1 %15, i8* null, i8* %0, !dbg !49
  br label %17, !dbg !49

; <label>:17:                                     ; preds = %14, %10
  %18 = phi i8* [ %13, %10 ], [ %16, %14 ], !dbg !48
...
!41 = !DILocation(line: 25, column: 11, scope: !29)
!42 = !DILocation(line: 0, scope: !39)
!43 = !DILocation(line: 28, column: 9, scope: !39)
!44 = !DILocation(line: 32, column: 20, scope: !45)
!45 = distinct !DILexicalBlock(scope: !46, file: !1, line: 32, column: 11)
!46 = distinct !DILexicalBlock(scope: !26, file: !1, line: 31, column: 5)
!47 = !DILocation(line: 32, column: 11, scope: !46)
!48 = !DILocation(line: 0, scope: !45)
!49 = !DILocation(line: 35, column: 9, scope: !45)
!50 = !DILocation(line: 37, column: 1, scope: !10)
