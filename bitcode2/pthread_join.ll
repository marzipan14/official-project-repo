...
define dso_local i32 @pthread_join(i8*, i32, i8**) local_unnamed_addr #0 !dbg !545 {
  ...
  br i1 %6, label %12, label %7, !dbg !565
...
; <label>:7:                                      ; preds = %3
  ...
  br i1 %11, label %13, label %12, !dbg !572
...
; <label>:13:                                     ; preds = %7
  %14 = getelementptr inbounds i8, i8* %0, i64 60, !dbg !576
  %15 = bitcast i8* %14 to i32*, !dbg !576
  %16 = load i32, i32* %15, align 4, !dbg !576, !tbaa !578
  %17 = icmp eq i32 %16, 1, !dbg !579
...
; <label>:19:                                     ; preds = %13, %12
  %20 = phi i32 [ 3, %12 ], [ %18, %13 ], !dbg !581
  %21 = load %struct.uk_mutex*, %struct.uk_mutex** @pte_thread_reuse_lock, align 8, !dbg !583, !tbaa !558
  %22 = tail call i32 @pte_osMutexUnlock(%struct.uk_mutex* %21) #3, !dbg !584
  %23 = icmp eq i32 %20, 0, !dbg !585
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !587
  br i1 %23, label %24, label %51, !dbg !587

; <label>:24:                                     ; preds = %19
  %25 = tail call { i8*, i32 } @pthread_self() #3, !dbg !588
  %26 = extractvalue { i8*, i32 } %25, 0, !dbg !588
  %27 = icmp eq i8* %26, null, !dbg !591
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !593
  br i1 %27, label %28, label %29, !dbg !593
...
; <label>:29:                                     ; preds = %24
  %30 = extractvalue { i8*, i32 } %25, 1, !dbg !588
  %31 = tail call i32 @pthread_equal(i8* nonnull %26, i32 %30, i8* %0, i32 %1) #3, !dbg !596
  %32 = icmp eq i32 %31, 0, !dbg !596
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !598
  br i1 %32, label %34, label %33, !dbg !598
...
; <label>:34:                                     ; preds = %29
  %35 = bitcast i8* %0 to %struct.uk_thread**, !dbg !601
  %36 = load %struct.uk_thread*, %struct.uk_thread** %35, align 8, !dbg !601, !tbaa !603
  %37 = tail call i32 @pte_osThreadWaitForEnd(%struct.uk_thread* %36) #3, !dbg !604
  %38 = icmp eq i32 %37, 0, !dbg !605
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !607
  br i1 %38, label %39, label %48, !dbg !607

; <label>:39:                                     ; preds = %34
  %40 = icmp eq i8** %2, null, !dbg !608
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !611
  br i1 %40, label %46, label %41, !dbg !611

; <label>:41:                                     ; preds = %39
  %42 = getelementptr inbounds i8, i8* %0, i64 40, !dbg !612
  %43 = bitcast i8* %42 to i64*, !dbg !612
  %44 = load i64, i64* %43, align 8, !dbg !612, !tbaa !614
  %45 = bitcast i8** %2 to i64*, !dbg !615
  store i64 %44, i64* %45, align 8, !dbg !615, !tbaa !558
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !616
  br label %46, !dbg !616

; <label>:46:                                     ; preds = %39, %41
  %47 = tail call i32 @pthread_detach(i8* nonnull %0, i32 %1) #3, !dbg !617
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !618
  br label %51, !dbg !618

; <label>:48:                                     ; preds = %34
  %49 = icmp eq i32 %37, 4, !dbg !619
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !621
  store volatile i32 42, i32* @__A_VARIABLE, align 4
  %50 = select i1 %49, i32 0, i32 3, !dbg !622
  br label %51, !dbg !622

; <label>:51:                                     ; preds = %48, %28, %46, %33, %19
  %52 = phi i32 [ 2, %28 ], [ 45, %33 ], [ %47, %46 ], [ %20, %19 ], [ %50, %48 ], !dbg !624
...
!573 = !DILocation(line: 86, column: 7, scope: !545)
!574 = !DILocation(line: 97, column: 5, scope: !575)
!575 = distinct !DILexicalBlock(scope: !564, file: !1, line: 95, column: 5)
!576 = !DILocation(line: 98, column: 43, scope: !577)
!577 = distinct !DILexicalBlock(scope: !564, file: !1, line: 98, column: 12)
!578 = !{!568, !570, i64 60}
!579 = !DILocation(line: 98, column: 36, scope: !577)
!580 = !DILocation(line: 98, column: 12, scope: !564)
!581 = !DILocation(line: 0, scope: !582)
!582 = distinct !DILexicalBlock(scope: !577, file: !1, line: 103, column: 5)
!583 = !DILocation(line: 107, column: 21, scope: !545)
!584 = !DILocation(line: 107, column: 3, scope: !545)
!585 = !DILocation(line: 109, column: 14, scope: !586)
!586 = distinct !DILexicalBlock(scope: !545, file: !1, line: 109, column: 7)
!587 = !DILocation(line: 109, column: 7, scope: !545)
!588 = !DILocation(line: 114, column: 14, scope: !589)
!589 = distinct !DILexicalBlock(scope: !586, file: !1, line: 110, column: 5)
!590 = !DILocation(line: 87, column: 13, scope: !545)
!591 = !DILocation(line: 116, column: 16, scope: !592)
!592 = distinct !DILexicalBlock(scope: !589, file: !1, line: 116, column: 11)
!593 = !DILocation(line: 116, column: 11, scope: !589)
!594 = !DILocation(line: 119, column: 9, scope: !595)
!595 = distinct !DILexicalBlock(scope: !592, file: !1, line: 117, column: 9)
!596 = !DILocation(line: 120, column: 16, scope: !597)
!597 = distinct !DILexicalBlock(scope: !592, file: !1, line: 120, column: 16)
!598 = !DILocation(line: 120, column: 16, scope: !592)
!599 = !DILocation(line: 123, column: 9, scope: !600)
!600 = distinct !DILexicalBlock(scope: !597, file: !1, line: 121, column: 9)
!601 = !DILocation(line: 134, column: 47, scope: !602)
!602 = distinct !DILexicalBlock(scope: !597, file: !1, line: 125, column: 9)
!603 = !{!568, !559, i64 0}
!604 = !DILocation(line: 134, column: 20, scope: !602)
!605 = !DILocation(line: 136, column: 25, scope: !606)
!606 = distinct !DILexicalBlock(scope: !602, file: !1, line: 136, column: 15)
!607 = !DILocation(line: 136, column: 15, scope: !602)
!608 = !DILocation(line: 138, column: 29, scope: !609)
!609 = distinct !DILexicalBlock(scope: !610, file: !1, line: 138, column: 19)
!610 = distinct !DILexicalBlock(scope: !606, file: !1, line: 137, column: 13)
!611 = !DILocation(line: 138, column: 19, scope: !610)
!612 = !DILocation(line: 140, column: 36, scope: !613)
!613 = distinct !DILexicalBlock(scope: !609, file: !1, line: 139, column: 17)
!614 = !{!568, !559, i64 40}
!615 = !DILocation(line: 140, column: 30, scope: !613)
!616 = !DILocation(line: 141, column: 17, scope: !613)
!617 = !DILocation(line: 148, column: 24, scope: !610)
!618 = !DILocation(line: 149, column: 13, scope: !610)
!619 = !DILocation(line: 150, column: 20, scope: !620)
!620 = distinct !DILexicalBlock(scope: !606, file: !1, line: 150, column: 13)
!621 = !DILocation(line: 150, column: 13, scope: !606)
!622 = !DILocation(line: 154, column: 6, scope: !623)
!623 = distinct !DILexicalBlock(scope: !620, file: !1, line: 151, column: 6)
!624 = !DILocation(line: 0, scope: !575)
!625 = !DILocation(line: 162, column: 3, scope: !545)
