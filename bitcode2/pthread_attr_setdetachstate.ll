; ModuleID = '/root/.unikraft/apps/redis/build/libpthread-embedded/origin/pthread-embedded-44b41d760a433915d70a7be9809651b0a65e001d/pthread_attr_setdetachstate.c'
source_filename = "/root/.unikraft/apps/redis/build/libpthread-embedded/origin/pthread-embedded-44b41d760a433915d70a7be9809651b0a65e001d/pthread_attr_setdetachstate.c"
...
define dso_local i32 @pthread_attr_setdetachstate(%struct.pthread_attr_t_**, i32) local_unnamed_addr #0 !dbg !25 {
  ...
  br i1 %4, label %5, label %10, !dbg !59

; <label>:5:                                      ; preds = %2
  %6 = icmp ugt i32 %1, 1, !dbg !60
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !60
  br i1 %6, label %10, label %7, !dbg !60

; <label>:7:                                      ; preds = %5
  %8 = load %struct.pthread_attr_t_*, %struct.pthread_attr_t_** %0, align 8, !dbg !62, !tbaa !63
  %9 = getelementptr inbounds %struct.pthread_attr_t_, %struct.pthread_attr_t_* %8, i64 0, i32 3, !dbg !67
  store i32 %1, i32* %9, align 8, !dbg !68, !tbaa !69
  br label %10, !dbg !74

; <label>:10:                                     ; preds = %5, %2, %7
  %11 = phi i32 [ 0, %7 ], [ 22, %2 ], [ 22, %5 ], !dbg !75
...
!1 = !DIFile(filename: "/root/.unikraft/apps/redis/build/libpthread-embedded/origin/pthread-embedded-44b41d760a433915d70a7be9809651b0a65e001d/pthread_attr_setdetachstate.c", directory: "/root/.unikraft/apps/redis/build")
!2 = !{!3}
...
!25 = distinct !DISubprogram(name: "pthread_attr_setdetachstate", scope: !1, file: !1, line: 48, type: !26, isLocal: false, isDefinition: true, scopeLine: 83, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !51)
...
!53 = !DILocalVariable(name: "detachstate", arg: 2, scope: !25, file: !1, line: 48, type: !5)
!54 = !DILocation(line: 48, column: 47, scope: !25)
!55 = !DILocation(line: 48, column: 57, scope: !25)
!56 = !DILocation(line: 84, column: 7, scope: !57)
!57 = distinct !DILexicalBlock(scope: !25, file: !1, line: 84, column: 7)
!58 = !DILocation(line: 84, column: 26, scope: !57)
!59 = !DILocation(line: 84, column: 7, scope: !25)
!60 = !DILocation(line: 89, column: 46, scope: !61)
!61 = distinct !DILexicalBlock(scope: !25, file: !1, line: 89, column: 7)
!62 = !DILocation(line: 95, column: 4, scope: !25)
!63 = !{!64, !64, i64 0}
!64 = !{!"any pointer", !65, i64 0}
!65 = !{!"omnipotent char", !66, i64 0}
!66 = !{!"Simple C/C++ TBAA"}
!67 = !DILocation(line: 95, column: 12, scope: !25)
!68 = !DILocation(line: 95, column: 24, scope: !25)
!69 = !{!70, !72, i64 24}
!70 = !{!"pthread_attr_t_", !71, i64 0, !64, i64 8, !71, i64 16, !72, i64 24, !73, i64 28, !72, i64 32, !72, i64 36}
!71 = !{!"long", !65, i64 0}
!72 = !{!"int", !65, i64 0}
!73 = !{!"sched_param", !72, i64 0}
!74 = !DILocation(line: 96, column: 3, scope: !25)
!75 = !DILocation(line: 0, scope: !25)
!76 = !DILocation(line: 0, scope: !77)
!77 = distinct !DILexicalBlock(scope: !57, file: !1, line: 85, column: 5)
!78 = !DILocation(line: 97, column: 1, scope: !25)
