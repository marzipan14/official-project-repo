; ModuleID = '/root/.unikraft/apps/redis/build/libpthread-embedded/origin/pthread-embedded-44b41d760a433915d70a7be9809651b0a65e001d/pthread_mutex_lock.c'
source_filename = "/root/.unikraft/apps/redis/build/libpthread-embedded/origin/pthread-embedded-44b41d760a433915d70a7be9809651b0a65e001d/pthread_mutex_lock.c"
...
define dso_local i32 @pthread_mutex_lock(%struct.pthread_mutex_t_**) local_unnamed_addr #0 !dbg !502 {
  %2 = load %struct.pthread_mutex_t_*, %struct.pthread_mutex_t_** %0, align 8, !dbg !520, !tbaa !522
  %3 = icmp eq %struct.pthread_mutex_t_* %2, null, !dbg !526
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !527
  br i1 %3, label %73, label %4, !dbg !527

; <label>:4:                                      ; preds = %1
  %5 = icmp ult %struct.pthread_mutex_t_* %2, inttoptr (i64 -3 to %struct.pthread_mutex_t_*), !dbg !528
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !530
  br i1 %5, label %11, label %6, !dbg !530

; <label>:6:                                      ; preds = %4
  %7 = tail call i32 @pte_mutex_check_need_init(%struct.pthread_mutex_t_** nonnull %0) #3, !dbg !531
  %8 = icmp eq i32 %7, 0, !dbg !534
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !535
  br i1 %8, label %9, label %73, !dbg !535

; <label>:9:                                      ; preds = %6
  %10 = load %struct.pthread_mutex_t_*, %struct.pthread_mutex_t_** %0, align 8, !dbg !536, !tbaa !522
  br label %11, !dbg !535

; <label>:11:                                     ; preds = %9, %4
  %12 = phi %struct.pthread_mutex_t_* [ %10, %9 ], [ %2, %4 ], !dbg !536
  %13 = getelementptr inbounds %struct.pthread_mutex_t_, %struct.pthread_mutex_t_* %12, i64 0, i32 3, !dbg !538
  %14 = load i32, i32* %13, align 8, !dbg !538, !tbaa !539
  %15 = icmp eq i32 %14, 0, !dbg !543
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !544
  br i1 %15, label %16, label %30, !dbg !544

; <label>:16:                                     ; preds = %11
  %17 = getelementptr inbounds %struct.pthread_mutex_t_, %struct.pthread_mutex_t_* %12, i64 0, i32 1, !dbg !545
  %18 = atomicrmw xchg i32* %17, i32 1 seq_cst, !dbg !545
  %19 = icmp eq i32 %18, 0, !dbg !548
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !549
  br i1 %19, label %73, label %20, !dbg !549

; <label>:20:                                     ; preds = %16
  %21 = getelementptr inbounds %struct.pthread_mutex_t_, %struct.pthread_mutex_t_* %12, i64 0, i32 0
  br label %22, !dbg !550

; <label>:22:                                     ; preds = %20, %25
  %23 = atomicrmw xchg i32* %17, i32 -1 seq_cst, !dbg !550
  %24 = icmp eq i32 %23, 0, !dbg !552
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !553
  br i1 %24, label %73, label %25, !dbg !553

; <label>:25:                                     ; preds = %22
  %26 = load %struct.uk_semaphore*, %struct.uk_semaphore** %21, align 8, !dbg !554, !tbaa !557
  %27 = tail call i32 @pte_osSemaphorePend(%struct.uk_semaphore* %26, i32* null) #3, !dbg !558
  %28 = icmp eq i32 %27, 0, !dbg !559
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !560
  br i1 %28, label %22, label %29, !dbg !560, !llvm.loop !561
...
; <label>:30:                                     ; preds = %11
  %31 = tail call { i8*, i32 } @pthread_self() #3, !dbg !565
  %32 = extractvalue { i8*, i32 } %31, 0, !dbg !565
  %33 = extractvalue { i8*, i32 } %31, 1, !dbg !565
  %34 = getelementptr inbounds %struct.pthread_mutex_t_, %struct.pthread_mutex_t_* %12, i64 0, i32 1, !dbg !567
  %35 = load i32, i32* %34, align 8, !dbg !567, !tbaa !568
  %36 = cmpxchg i32* %34, i32 0, i32 1 seq_cst seq_cst, !dbg !569
  %37 = extractvalue { i32, i1 } %36, 1, !dbg !569
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !569
  br i1 %37, label %39, label %38, !dbg !569
...
; <label>:39:                                     ; preds = %38, %30
  %40 = icmp eq i32 %35, 0, !dbg !570
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !571
  br i1 %40, label %41, label %45, !dbg !571

; <label>:41:                                     ; preds = %39
  %42 = getelementptr inbounds %struct.pthread_mutex_t_, %struct.pthread_mutex_t_* %12, i64 0, i32 2, !dbg !572
  store i32 1, i32* %42, align 4, !dbg !574, !tbaa !575
  %43 = getelementptr inbounds %struct.pthread_mutex_t_, %struct.pthread_mutex_t_* %12, i64 0, i32 4, i32 0, !dbg !576
  store i8* %32, i8** %43, align 8, !dbg !576
  %44 = getelementptr inbounds %struct.pthread_mutex_t_, %struct.pthread_mutex_t_* %12, i64 0, i32 4, i32 1, !dbg !576
  store i32 %33, i32* %44, align 8, !dbg !576
  br label %71, !dbg !577

; <label>:45:                                     ; preds = %39
  %46 = getelementptr inbounds %struct.pthread_mutex_t_, %struct.pthread_mutex_t_* %12, i64 0, i32 4, i32 0, !dbg !578
  %47 = load i8*, i8** %46, align 8, !dbg !578
  %48 = getelementptr inbounds %struct.pthread_mutex_t_, %struct.pthread_mutex_t_* %12, i64 0, i32 4, i32 1, !dbg !578
  %49 = load i32, i32* %48, align 8, !dbg !578
  %50 = tail call i32 @pthread_equal(i8* %47, i32 %49, i8* %32, i32 %33) #3, !dbg !578
  %51 = icmp eq i32 %50, 0, !dbg !578
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !581
  br i1 %51, label %52, label %54, !dbg !581

; <label>:52:                                     ; preds = %45
  %53 = getelementptr inbounds %struct.pthread_mutex_t_, %struct.pthread_mutex_t_* %12, i64 0, i32 0
  br label %61, !dbg !582

; <label>:54:                                     ; preds = %45
  %55 = load i32, i32* %13, align 8, !dbg !584, !tbaa !539
  %56 = icmp eq i32 %55, 1, !dbg !587
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !588
  br i1 %56, label %57, label %71, !dbg !588

; <label>:57:                                     ; preds = %54
  %58 = getelementptr inbounds %struct.pthread_mutex_t_, %struct.pthread_mutex_t_* %12, i64 0, i32 2, !dbg !589
  %59 = load i32, i32* %58, align 4, !dbg !591, !tbaa !575
  %60 = add nsw i32 %59, 1, !dbg !591
  store i32 %60, i32* %58, align 4, !dbg !591, !tbaa !575
  br label %71, !dbg !592

; <label>:61:                                     ; preds = %52, %64
  %62 = atomicrmw xchg i32* %34, i32 -1 seq_cst, !dbg !582
  %63 = icmp eq i32 %62, 0, !dbg !593
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !594
  br i1 %63, label %69, label %64, !dbg !594

; <label>:64:                                     ; preds = %61
  %65 = load %struct.uk_semaphore*, %struct.uk_semaphore** %53, align 8, !dbg !595, !tbaa !557
  %66 = tail call i32 @pte_osSemaphorePend(%struct.uk_semaphore* %65, i32* null) #3, !dbg !598
  %67 = icmp eq i32 %66, 0, !dbg !599
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !600
  br i1 %67, label %61, label %68, !dbg !600, !llvm.loop !601
...
; <label>:69:                                     ; preds = %61
  ...
  %70 = getelementptr inbounds %struct.pthread_mutex_t_, %struct.pthread_mutex_t_* %12, i64 0, i32 2, !dbg !606
  store i32 1, i32* %70, align 4, !dbg !609, !tbaa !575
  store i8* %32, i8** %46, align 8, !dbg !610
  store i32 %33, i32* %48, align 8, !dbg !610
  br label %71, !dbg !611

; <label>:71:                                     ; preds = %54, %68, %57, %69, %41
  %72 = phi i32 [ 0, %41 ], [ 0, %57 ], [ 0, %69 ], [ 22, %68 ], [ 45, %54 ], !dbg !612
  store volatile i32 42, i32* @__A_VARIABLE, align 4
  store volatile i32 42, i32* @__A_VARIABLE, align 4
  br label %73

; <label>:73:                                     ; preds = %22, %71, %29, %16, %6, %1
  %74 = phi i32 [ 22, %1 ], [ %7, %6 ], [ 22, %29 ], [ 0, %16 ], [ %72, %71 ], [ 0, %22 ], !dbg !613
...
; Function Attrs: noredzone
declare dso_local i32 @pte_osSemaphorePend(%struct.uk_semaphore*, i32*) local_unnamed_addr #1
...
!1 = !DIFile(filename: "/root/.unikraft/apps/redis/build/libpthread-embedded/origin/pthread-embedded-44b41d760a433915d70a7be9809651b0a65e001d/pthread_mutex_lock.c", directory: "/root/.unikraft/apps/redis/build")
!2 = !{!3, !10, !22}
...
!33 = !DIDerivedType(tag: DW_TAG_typedef, name: "pthread_mutex_t", file: !11, line: 417, baseType: !34)
!34 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !35, size: 64)
!35 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "pthread_mutex_t_", file: !36, line: 146, size: 320, elements: !37)
!36 = !DIFile(filename: "/root/.unikraft/apps/redis/build/libpthread-embedded/origin/pthread-embedded-44b41d760a433915d70a7be9809651b0a65e001d/implement.h", directory: "/root/.unikraft/apps/redis/build")
!37 = !{!38, !488, !489, !490, !491}
!38 = !DIDerivedType(tag: DW_TAG_member, name: "handle", scope: !35, file: !36, line: 148, baseType: !39, size: 64)
!39 = !DIDerivedType(tag: DW_TAG_typedef, name: "pte_osSemaphoreHandle", file: !40, line: 12, baseType: !41)
!40 = !DIFile(filename: "/root/.unikraft/libs/pthread-embedded/include/pte_osal.h", directory: "/root/.unikraft/apps/redis/build")
!41 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !42, size: 64)
!42 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "uk_semaphore", file: !43, line: 51, size: 192, elements: !44)
!43 = !DIFile(filename: "/root/.unikraft/unikraft/lib/uklock/include/uk/semaphore.h", directory: "/root/.unikraft/apps/redis/build")
!44 = !{!45, !47}
!45 = !DIDerivedType(tag: DW_TAG_member, name: "count", scope: !42, file: !43, line: 52, baseType: !46, size: 64)
!46 = !DIBasicType(name: "long int", size: 64, encoding: DW_ATE_signed)
!47 = !DIDerivedType(tag: DW_TAG_member, name: "wait", scope: !42, file: !43, line: 53, baseType: !48, size: 128, offset: 64)
...
!54 = !{!55, !57, !482}
!55 = !DIDerivedType(tag: DW_TAG_member, name: "waiting", scope: !53, file: !49, line: 36, baseType: !56, size: 32)
!56 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!57 = !DIDerivedType(tag: DW_TAG_member, name: "thread", scope: !53, file: !49, line: 37, baseType: !58, size: 64, offset: 64)
...
!61 = !{!62, !66, !67, !68, !69, !75, !80, !85, !87, !88, !237, !238, !239, !452}
...
!66 = !DIDerivedType(tag: DW_TAG_member, name: "stack", scope: !59, file: !60, line: 61, baseType: !32, size: 64, offset: 64)
!67 = !DIDerivedType(tag: DW_TAG_member, name: "tls", scope: !59, file: !60, line: 62, baseType: !32, size: 64, offset: 128)
!68 = !DIDerivedType(tag: DW_TAG_member, name: "ctx", scope: !59, file: !60, line: 63, baseType: !32, size: 64, offset: 192)
...
!83 = !DIDerivedType(tag: DW_TAG_typedef, name: "__s64", file: !84, line: 128, baseType: !46)
...
!87 = !DIDerivedType(tag: DW_TAG_member, name: "waiting_threads", scope: !59, file: !60, line: 68, baseType: !48, size: 128, offset: 576)
...
!111 = !DIDerivedType(tag: DW_TAG_typedef, name: "prio_t", file: !106, line: 53, baseType: !56)
...
!147 = !{!56, !89, !135, !148}
!148 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !56, size: 64)
...
!190 = !{!56, !165, !191, !174, !174}
!191 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !32, size: 64)
...
!236 = !DIDerivedType(tag: DW_TAG_member, name: "prv", scope: !90, file: !91, line: 110, baseType: !32, size: 64, offset: 2112)
!237 = !DIDerivedType(tag: DW_TAG_member, name: "prv", scope: !59, file: !60, line: 70, baseType: !32, size: 64, offset: 768)
!238 = !DIDerivedType(tag: DW_TAG_member, name: "tid", scope: !59, file: !60, line: 72, baseType: !56, size: 32, offset: 832)
!239 = !DIDerivedType(tag: DW_TAG_member, name: "reent", scope: !59, file: !60, line: 82, baseType: !240, size: 64, offset: 896)
...
!244 = !DIDerivedType(tag: DW_TAG_member, name: "_errno", scope: !241, file: !242, line: 571, baseType: !56, size: 32)
...
!253 = !DIDerivedType(tag: DW_TAG_member, name: "_r", scope: !248, file: !242, line: 183, baseType: !56, size: 32, offset: 64)
!254 = !DIDerivedType(tag: DW_TAG_member, name: "_w", scope: !248, file: !242, line: 184, baseType: !56, size: 32, offset: 96)
...
!262 = !DIDerivedType(tag: DW_TAG_member, name: "_size", scope: !259, file: !242, line: 119, baseType: !56, size: 32, offset: 64)
!263 = !DIDerivedType(tag: DW_TAG_member, name: "_lbfsize", scope: !248, file: !242, line: 188, baseType: !56, size: 32, offset: 320)
!264 = !DIDerivedType(tag: DW_TAG_member, name: "_cookie", scope: !248, file: !242, line: 195, baseType: !32, size: 64, offset: 384)
...
!268 = !{!269, !240, !32, !271, !56}
!269 = !DIDerivedType(tag: DW_TAG_typedef, name: "_ssize_t", file: !270, line: 145, baseType: !46)
...
!279 = !{!280, !240, !32, !280, !56}
!280 = !DIDerivedType(tag: DW_TAG_typedef, name: "_fpos_t", file: !270, line: 114, baseType: !46)
...
!287 = !DIDerivedType(tag: DW_TAG_member, name: "_ur", scope: !248, file: !242, line: 208, baseType: !56, size: 32, offset: 896)
...
!297 = !DIDerivedType(tag: DW_TAG_member, name: "_blksize", scope: !248, file: !242, line: 218, baseType: !56, size: 32, offset: 1088)
!298 = !DIDerivedType(tag: DW_TAG_member, name: "_offset", scope: !248, file: !242, line: 219, baseType: !299, size: 64, offset: 1152)
!299 = !DIDerivedType(tag: DW_TAG_typedef, name: "_off_t", file: !270, line: 44, baseType: !46)
...
!303 = !DIDerivedType(tag: DW_TAG_typedef, name: "_LOCK_RECURSIVE_T", file: !304, line: 12, baseType: !56)
...
!308 = !{!309, !310}
!309 = !DIDerivedType(tag: DW_TAG_member, name: "__count", scope: !307, file: !270, line: 165, baseType: !56, size: 32)
...
!319 = !DIDerivedType(tag: DW_TAG_member, name: "_flags2", scope: !248, file: !242, line: 229, baseType: !56, size: 32, offset: 1376)
...
!322 = !DIDerivedType(tag: DW_TAG_member, name: "_inc", scope: !241, file: !242, line: 578, baseType: !56, size: 32, offset: 256)
!323 = !DIDerivedType(tag: DW_TAG_member, name: "_emergency", scope: !241, file: !242, line: 579, baseType: !324, size: 200, offset: 288)
!324 = !DICompositeType(tag: DW_TAG_array_type, baseType: !65, size: 200, elements: !325)
!325 = !{!326}
!326 = !DISubrange(count: 25)
!327 = !DIDerivedType(tag: DW_TAG_member, name: "_unspecified_locale_info", scope: !241, file: !242, line: 582, baseType: !56, size: 32, offset: 512)
...
!331 = !DIDerivedType(tag: DW_TAG_member, name: "__sdidinit", scope: !241, file: !242, line: 585, baseType: !56, size: 32, offset: 640)
...
!341 = !DIDerivedType(tag: DW_TAG_member, name: "_k", scope: !338, file: !242, line: 50, baseType: !56, size: 32, offset: 64)
!342 = !DIDerivedType(tag: DW_TAG_member, name: "_maxwds", scope: !338, file: !242, line: 50, baseType: !56, size: 32, offset: 96)
!343 = !DIDerivedType(tag: DW_TAG_member, name: "_sign", scope: !338, file: !242, line: 50, baseType: !56, size: 32, offset: 128)
!344 = !DIDerivedType(tag: DW_TAG_member, name: "_wds", scope: !338, file: !242, line: 50, baseType: !56, size: 32, offset: 160)
...
!348 = !DIDerivedType(tag: DW_TAG_member, name: "_result_k", scope: !241, file: !242, line: 591, baseType: !56, size: 32, offset: 832)
...
!352 = !DIDerivedType(tag: DW_TAG_member, name: "_cvtlen", scope: !241, file: !242, line: 596, baseType: !56, size: 32, offset: 1024)
...
!363 = !DICompositeType(tag: DW_TAG_array_type, baseType: !65, size: 208, elements: !364)
!364 = !{!365}
...
!369 = !DIDerivedType(tag: DW_TAG_member, name: "__tm_sec", scope: !367, file: !242, line: 57, baseType: !56, size: 32)
!370 = !DIDerivedType(tag: DW_TAG_member, name: "__tm_min", scope: !367, file: !242, line: 58, baseType: !56, size: 32, offset: 32)
!371 = !DIDerivedType(tag: DW_TAG_member, name: "__tm_hour", scope: !367, file: !242, line: 59, baseType: !56, size: 32, offset: 64)
!372 = !DIDerivedType(tag: DW_TAG_member, name: "__tm_mday", scope: !367, file: !242, line: 60, baseType: !56, size: 32, offset: 96)
!373 = !DIDerivedType(tag: DW_TAG_member, name: "__tm_mon", scope: !367, file: !242, line: 61, baseType: !56, size: 32, offset: 128)
!374 = !DIDerivedType(tag: DW_TAG_member, name: "__tm_year", scope: !367, file: !242, line: 62, baseType: !56, size: 32, offset: 160)
!375 = !DIDerivedType(tag: DW_TAG_member, name: "__tm_wday", scope: !367, file: !242, line: 63, baseType: !56, size: 32, offset: 192)
!376 = !DIDerivedType(tag: DW_TAG_member, name: "__tm_yday", scope: !367, file: !242, line: 64, baseType: !56, size: 32, offset: 224)
!377 = !DIDerivedType(tag: DW_TAG_member, name: "__tm_isdst", scope: !367, file: !242, line: 65, baseType: !56, size: 32, offset: 256)
!378 = !DIDerivedType(tag: DW_TAG_member, name: "_gamma_signgam", scope: !358, file: !242, line: 607, baseType: !56, size: 32, offset: 640)
...
!393 = !DICompositeType(tag: DW_TAG_array_type, baseType: !65, size: 64, elements: !394)
!394 = !{!395}
...
!397 = !DICompositeType(tag: DW_TAG_array_type, baseType: !65, size: 192, elements: !398)
!398 = !{!399}
!399 = !DISubrange(count: 24)
!400 = !DIDerivedType(tag: DW_TAG_member, name: "_getdate_err", scope: !358, file: !242, line: 615, baseType: !56, size: 32, offset: 1344)
...
!406 = !DIDerivedType(tag: DW_TAG_member, name: "_h_errno", scope: !358, file: !242, line: 621, baseType: !56, size: 32, offset: 1696)
...
!421 = !DIDerivedType(tag: DW_TAG_member, name: "_ind", scope: !418, file: !242, line: 95, baseType: !56, size: 32, offset: 64)
...
!433 = !DICompositeType(tag: DW_TAG_array_type, baseType: !32, size: 2048, elements: !427)
...
!448 = !DIDerivedType(tag: DW_TAG_member, name: "_niobs", scope: !444, file: !242, line: 294, baseType: !56, size: 32, offset: 64)
...
!452 = !DIDerivedType(tag: DW_TAG_member, name: "signals_container", scope: !59, file: !60, line: 85, baseType: !453, size: 64, offset: 960)
...
!476 = !{!477, !478, !479}
!477 = !DIDerivedType(tag: DW_TAG_member, name: "si_signo", scope: !475, file: !458, line: 69, baseType: !56, size: 32)
!478 = !DIDerivedType(tag: DW_TAG_member, name: "si_code", scope: !475, file: !458, line: 70, baseType: !56, size: 32, offset: 32)
!479 = !DIDerivedType(tag: DW_TAG_member, name: "si_pid", scope: !475, file: !458, line: 71, baseType: !480, size: 32, offset: 64)
!480 = !DIDerivedType(tag: DW_TAG_typedef, name: "pid_t", file: !458, line: 61, baseType: !56)
!481 = !DIDerivedType(tag: DW_TAG_member, name: "list_node", scope: !454, file: !4, line: 124, baseType: !462, size: 128, offset: 512)
!482 = !DIDerivedType(tag: DW_TAG_member, name: "thread_list", scope: !53, file: !49, line: 38, baseType: !483, size: 64, offset: 128)
!483 = distinct !DICompositeType(tag: DW_TAG_structure_type, scope: !53, file: !49, line: 38, size: 64, elements: !484)
!484 = !{!485}
!485 = !DIDerivedType(tag: DW_TAG_member, name: "stqe_next", scope: !483, file: !49, line: 38, baseType: !52, size: 64)
!486 = !DIDerivedType(tag: DW_TAG_member, name: "stqh_last", scope: !48, file: !49, line: 42, baseType: !487, size: 64, offset: 64)
!487 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !52, size: 64)
!488 = !DIDerivedType(tag: DW_TAG_member, name: "lock_idx", scope: !35, file: !36, line: 149, baseType: !56, size: 32, offset: 64)
!489 = !DIDerivedType(tag: DW_TAG_member, name: "recursive_count", scope: !35, file: !36, line: 156, baseType: !56, size: 32, offset: 96)
!490 = !DIDerivedType(tag: DW_TAG_member, name: "kind", scope: !35, file: !36, line: 159, baseType: !56, size: 32, offset: 128)
!491 = !DIDerivedType(tag: DW_TAG_member, name: "ownerThread", scope: !35, file: !36, line: 160, baseType: !492, size: 128, offset: 192)
...
!495 = !{!496, !497}
!496 = !DIDerivedType(tag: DW_TAG_member, name: "p", scope: !494, file: !11, line: 398, baseType: !32, size: 64)
...
!502 = distinct !DISubprogram(name: "pthread_mutex_lock", scope: !1, file: !1, line: 51, type: !503, isLocal: false, isDefinition: true, scopeLine: 52, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !506)
!503 = !DISubroutineType(types: !504)
!504 = !{!56, !505}
!505 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !33, size: 64)
!506 = !{!507, !508, !509, !510, !513, !516}
!507 = !DILocalVariable(name: "mutex", arg: 1, scope: !502, file: !1, line: 51, type: !505)
!508 = !DILocalVariable(name: "result", scope: !502, file: !1, line: 53, type: !56)
!509 = !DILocalVariable(name: "mx", scope: !502, file: !1, line: 54, type: !33)
!510 = !DILocalVariable(name: "self", scope: !511, file: !1, line: 98, type: !492)
!511 = distinct !DILexicalBlock(scope: !512, file: !1, line: 97, column: 5)
!512 = distinct !DILexicalBlock(scope: !502, file: !1, line: 80, column: 7)
!513 = !DILocalVariable(name: "__orig", scope: !514, file: !1, line: 100, type: !56)
!514 = distinct !DILexicalBlock(scope: !515, file: !1, line: 100, column: 11)
!515 = distinct !DILexicalBlock(scope: !511, file: !1, line: 100, column: 11)
!516 = !DILocalVariable(name: "stored", scope: !517, file: !1, line: 100, type: !56)
!517 = distinct !DILexicalBlock(scope: !514, file: !1, line: 100, column: 11)
!518 = !DILocation(line: 51, column: 39, scope: !502)
!519 = !DILocation(line: 53, column: 7, scope: !502)
!520 = !DILocation(line: 59, column: 7, scope: !521)
!521 = distinct !DILexicalBlock(scope: !502, file: !1, line: 59, column: 7)
!522 = !{!523, !523, i64 0}
!523 = !{!"any pointer", !524, i64 0}
!524 = !{!"omnipotent char", !525, i64 0}
!525 = !{!"Simple C/C++ TBAA"}
!526 = !DILocation(line: 59, column: 14, scope: !521)
!527 = !DILocation(line: 59, column: 7, scope: !502)
!528 = !DILocation(line: 70, column: 14, scope: !529)
!529 = distinct !DILexicalBlock(scope: !502, file: !1, line: 70, column: 7)
!530 = !DILocation(line: 70, column: 7, scope: !502)
!531 = !DILocation(line: 72, column: 21, scope: !532)
!532 = distinct !DILexicalBlock(scope: !533, file: !1, line: 72, column: 11)
!533 = distinct !DILexicalBlock(scope: !529, file: !1, line: 71, column: 5)
!534 = !DILocation(line: 72, column: 56, scope: !532)
!535 = !DILocation(line: 72, column: 11, scope: !533)
!536 = !DILocation(line: 78, column: 8, scope: !502)
!537 = !DILocation(line: 54, column: 19, scope: !502)
!538 = !DILocation(line: 80, column: 11, scope: !512)
!539 = !{!540, !541, i64 16}
!540 = !{!"pthread_mutex_t_", !523, i64 0, !541, i64 8, !541, i64 12, !541, i64 16, !542, i64 24}
!541 = !{!"int", !524, i64 0}
!542 = !{!"", !523, i64 0, !541, i64 8}
!543 = !DILocation(line: 80, column: 16, scope: !512)
!544 = !DILocation(line: 80, column: 7, scope: !502)
!545 = !DILocation(line: 82, column: 11, scope: !546)
!546 = distinct !DILexicalBlock(scope: !547, file: !1, line: 82, column: 11)
!547 = distinct !DILexicalBlock(scope: !512, file: !1, line: 81, column: 5)
!548 = !DILocation(line: 84, column: 16, scope: !546)
!549 = !DILocation(line: 82, column: 11, scope: !547)
!550 = !DILocation(line: 86, column: 18, scope: !551)
!551 = distinct !DILexicalBlock(scope: !546, file: !1, line: 85, column: 9)
!552 = !DILocation(line: 86, column: 56, scope: !551)
!553 = !DILocation(line: 86, column: 11, scope: !551)
!554 = !DILocation(line: 88, column: 43, scope: !555)
!555 = distinct !DILexicalBlock(scope: !556, file: !1, line: 88, column: 19)
!556 = distinct !DILexicalBlock(scope: !551, file: !1, line: 87, column: 13)
!557 = !{!540, !523, i64 0}
!558 = !DILocation(line: 88, column: 19, scope: !555)
!559 = !DILocation(line: 88, column: 56, scope: !555)
!560 = !DILocation(line: 88, column: 19, scope: !556)
!561 = distinct !{!561, !553, !562}
!562 = !DILocation(line: 93, column: 13, scope: !551)
!563 = !DILocation(line: 91, column: 19, scope: !564)
!564 = distinct !DILexicalBlock(scope: !555, file: !1, line: 89, column: 17)
!565 = !DILocation(line: 98, column: 24, scope: !511)
!566 = !DILocation(line: 98, column: 17, scope: !511)
!567 = !DILocation(line: 100, column: 11, scope: !514)
!568 = !{!540, !541, i64 8}
!569 = !DILocation(line: 100, column: 11, scope: !517)
!570 = !DILocation(line: 100, column: 58, scope: !515)
!571 = !DILocation(line: 100, column: 11, scope: !511)
!572 = !DILocation(line: 102, column: 15, scope: !573)
!573 = distinct !DILexicalBlock(scope: !515, file: !1, line: 101, column: 9)
!574 = !DILocation(line: 102, column: 31, scope: !573)
!575 = !{!540, !541, i64 12}
!576 = !DILocation(line: 103, column: 29, scope: !573)
!577 = !DILocation(line: 104, column: 9, scope: !573)
!578 = !DILocation(line: 107, column: 15, scope: !579)
!579 = distinct !DILexicalBlock(scope: !580, file: !1, line: 107, column: 15)
!580 = distinct !DILexicalBlock(scope: !515, file: !1, line: 106, column: 9)
!581 = !DILocation(line: 107, column: 15, scope: !580)
!582 = !DILocation(line: 120, column: 22, scope: !583)
!583 = distinct !DILexicalBlock(scope: !579, file: !1, line: 119, column: 13)
!584 = !DILocation(line: 109, column: 23, scope: !585)
!585 = distinct !DILexicalBlock(scope: !586, file: !1, line: 109, column: 19)
!586 = distinct !DILexicalBlock(scope: !579, file: !1, line: 108, column: 13)
!587 = !DILocation(line: 109, column: 28, scope: !585)
!588 = !DILocation(line: 109, column: 19, scope: !586)
!589 = !DILocation(line: 111, column: 23, scope: !590)
!590 = distinct !DILexicalBlock(scope: !585, file: !1, line: 110, column: 17)
!591 = !DILocation(line: 111, column: 38, scope: !590)
!592 = !DILocation(line: 112, column: 17, scope: !590)
!593 = !DILocation(line: 120, column: 60, scope: !583)
!594 = !DILocation(line: 120, column: 15, scope: !583)
!595 = !DILocation(line: 122, column: 47, scope: !596)
!596 = distinct !DILexicalBlock(scope: !597, file: !1, line: 122, column: 23)
!597 = distinct !DILexicalBlock(scope: !583, file: !1, line: 121, column: 17)
!598 = !DILocation(line: 122, column: 23, scope: !596)
!599 = !DILocation(line: 122, column: 60, scope: !596)
!600 = !DILocation(line: 122, column: 23, scope: !597)
!601 = distinct !{!601, !594, !602}
!602 = !DILocation(line: 127, column: 17, scope: !583)
!603 = !DILocation(line: 125, column: 23, scope: !604)
!604 = distinct !DILexicalBlock(scope: !596, file: !1, line: 123, column: 21)
!605 = !DILocation(line: 129, column: 19, scope: !583)
!606 = !DILocation(line: 131, column: 23, scope: !607)
!607 = distinct !DILexicalBlock(scope: !608, file: !1, line: 130, column: 17)
!608 = distinct !DILexicalBlock(scope: !583, file: !1, line: 129, column: 19)
!609 = !DILocation(line: 131, column: 39, scope: !607)
!610 = !DILocation(line: 132, column: 37, scope: !607)
!611 = !DILocation(line: 133, column: 17, scope: !607)
!612 = !DILocation(line: 0, scope: !604)
!613 = !DILocation(line: 0, scope: !502)
!614 = !DILocation(line: 0, scope: !615)
!615 = distinct !DILexicalBlock(scope: !521, file: !1, line: 60, column: 5)
!616 = !DILocation(line: 140, column: 1, scope: !502)
