...
; <label>:7:                                      ; preds = %5
  ...
  %9 = icmp sgt i32 %8, 0, !dbg !48
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !50
  br i1 %9, label %10, label %26, !dbg !50

; <label>:10:                                     ; preds = %7, %10
  %11 = phi i32 [ %14, %10 ], [ %8, %7 ]
  %12 = phi i32 [ %13, %10 ], [ -126, %7 ]
  %13 = add nsw i32 %12, -1, !dbg !51
  %14 = shl i32 %11, 1, !dbg !52
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !53
  %15 = icmp sgt i32 %14, 0, !dbg !48
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !50
  br i1 %15, label %10, label %16, !dbg !50, !llvm.loop !54

; <label>:16:                                     ; preds = %10
  %17 = sitofp i32 %13 to float, !dbg !56
  br label %26, !dbg !56

; <label>:18:                                     ; preds = %5
  %19 = icmp eq i32 %3, 2139095040, !dbg !57
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !59
  br i1 %19, label %26, label %20, !dbg !59

; <label>:20:                                     ; preds = %18
  %21 = icmp ugt i32 %3, 2139095040, !dbg !60
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !62
  br i1 %21, label %26, label %22, !dbg !62

; <label>:22:                                     ; preds = %20
  %23 = lshr i32 %3, 23, !dbg !63
  %24 = add nsw i32 %23, -127, !dbg !64
  %25 = sitofp i32 %24 to float, !dbg !65
  br label %26, !dbg !66

; <label>:26:                                     ; preds = %20, %18, %7, %16, %1, %22
  %27 = phi float [ %25, %22 ], [ 0xFFF0000000000000, %1 ], [ -1.260000e+02, %7 ], [ %17, %16 ], [ 0x7FF0000000000000, %18 ], [ %0, %20 ], !dbg !67
...
!47 = !DILocation(line: 42, column: 11, scope: !45)
!48 = !DILocation(line: 42, column: 31, scope: !49)
!49 = distinct !DILexicalBlock(scope: !45, file: !1, line: 42, column: 6)
!50 = !DILocation(line: 42, column: 6, scope: !45)
!51 = !DILocation(line: 42, column: 46, scope: !49)
!52 = !DILocation(line: 42, column: 37, scope: !49)
!53 = !DILocation(line: 42, column: 6, scope: !49)
!54 = distinct !{!54, !50, !55}
!55 = !DILocation(line: 42, column: 48, scope: !45)
!56 = !DILocation(line: 43, column: 13, scope: !46)
!57 = !DILocation(line: 45, column: 11, scope: !58)
!58 = distinct !DILexicalBlock(scope: !41, file: !1, line: 45, column: 11)
!59 = !DILocation(line: 45, column: 11, scope: !41)
!60 = !DILocation(line: 46, column: 11, scope: !61)
!61 = distinct !DILexicalBlock(scope: !58, file: !1, line: 46, column: 11)
!62 = !DILocation(line: 46, column: 11, scope: !58)
!63 = !DILocation(line: 47, column: 26, scope: !61)
!64 = !DILocation(line: 47, column: 31, scope: !61)
!65 = !DILocation(line: 47, column: 14, scope: !61)
!66 = !DILocation(line: 47, column: 7, scope: !61)
