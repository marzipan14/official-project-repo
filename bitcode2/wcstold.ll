...
; <label>:8:                                      ; preds = %2, %7
  %9 = phi %struct.__locale_t* [ @__global_locale, %7 ], [ %5, %2 ], !dbg !315
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !333
  %10 = tail call double @wcstod_l(i32* %0, i32** %1, %struct.__locale_t* nonnull %9) #3, !dbg !334
  %11 = fpext double %10 to x86_fp80, !dbg !334
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !335
  ret x86_fp80 %11, !dbg !335
}
...
!330 = !DILocation(line: 213, column: 3, scope: !331, inlinedAt: !332)
!331 = distinct !DISubprogram(name: "__get_global_locale", scope: !24, file: !24, line: 210, type: !317, isLocal: true, isDefinition: true, scopeLine: 211, isOptimized: true, unit: !0, retainedNodes: !2)
!332 = distinct !DILocation(line: 230, column: 29, scope: !316, inlinedAt: !319)
!333 = !DILocation(line: 230, column: 3, scope: !316, inlinedAt: !319)
!334 = !DILocation(line: 119, column: 10, scope: !307)
!335 = !DILocation(line: 119, column: 3, scope: !307)
