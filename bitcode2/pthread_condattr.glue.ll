...
; <label>:4:                                      ; preds = %2
  %5 = and i32 %1, -2, !dbg !56
  %6 = icmp eq i32 %5, 2, !dbg !56
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !57
  br i1 %6, label %13, label %7, !dbg !57

; <label>:7:                                      ; preds = %4
  %8 = load %struct.pthread_condattr_t_*, %struct.pthread_condattr_t_** %0, align 8, !dbg !58, !tbaa !32
  %9 = getelementptr inbounds %struct.pthread_condattr_t_, %struct.pthread_condattr_t_* %8, i64 0, i32 0, !dbg !59
  %10 = load i32, i32* %9, align 4, !dbg !60, !tbaa !37
  %11 = and i32 %10, -2147483648, !dbg !60
  %12 = or i32 %11, %1, !dbg !61
  store i32 %12, i32* %9, align 4, !dbg !61, !tbaa !37
  br label %13, !dbg !62

; <label>:13:                                     ; preds = %2, %4, %7
  %14 = phi i32 [ 0, %7 ], [ 22, %4 ], [ 22, %2 ], !dbg !63
...
!55 = !DILocation(line: 37, column: 19, scope: !54)
!56 = !DILocation(line: 37, column: 34, scope: !54)
!57 = !DILocation(line: 37, column: 6, scope: !44)
!58 = !DILocation(line: 39, column: 3, scope: !44)
!59 = !DILocation(line: 39, column: 11, scope: !44)
!60 = !DILocation(line: 39, column: 17, scope: !44)
!61 = !DILocation(line: 40, column: 17, scope: !44)
!62 = !DILocation(line: 41, column: 2, scope: !44)
!63 = !DILocation(line: 0, scope: !44)
!64 = !DILocation(line: 0, scope: !54)
!65 = !DILocation(line: 42, column: 1, scope: !44)
