...
; <label>:11:                                     ; preds = %8
  %12 = fcmp oeq float %1, 0.000000e+00, !dbg !50
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !52
  br i1 %12, label %13, label %42, !dbg !52

; <label>:13:                                     ; preds = %11
  %14 = getelementptr inbounds %struct.exception, %struct.exception* %3, i64 0, i32 0, !dbg !53
  store i32 1, i32* %14, align 8, !dbg !55, !tbaa !56
  %15 = getelementptr inbounds %struct.exception, %struct.exception* %3, i64 0, i32 1, !dbg !61
  store i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str, i64 0, i64 0), i8** %15, align 8, !dbg !62, !tbaa !63
  %16 = getelementptr inbounds %struct.exception, %struct.exception* %3, i64 0, i32 5, !dbg !64
  store i32 0, i32* %16, align 8, !dbg !65, !tbaa !66
  %17 = getelementptr inbounds %struct.exception, %struct.exception* %3, i64 0, i32 2, !dbg !67
  %18 = insertelement <2 x float> undef, float %0, i32 0, !dbg !68
  %19 = insertelement <2 x float> %18, float %1, i32 1, !dbg !68
  %20 = fpext <2 x float> %19 to <2 x double>, !dbg !68
  %21 = bitcast double* %17 to <2 x double>*, !dbg !69
  store <2 x double> %20, <2 x double>* %21, align 8, !dbg !69, !tbaa !70
  %22 = getelementptr inbounds %struct.exception, %struct.exception* %3, i64 0, i32 4, !dbg !71
  store double 0x7FF8000000000000, double* %22, align 8, !dbg !72, !tbaa !73
  %23 = load i32, i32* @__fdlib_version, align 4, !dbg !74, !tbaa !43
  %24 = icmp eq i32 %23, 2, !dbg !76
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !77
  br i1 %24, label %25, label %27, !dbg !77

; <label>:25:                                     ; preds = %13
  %26 = tail call i32* @__errno() #5, !dbg !78
  br label %32, !dbg !78

; <label>:27:                                     ; preds = %13
  %28 = call i32 @matherr(%struct.exception* nonnull %3) #5, !dbg !80
  %29 = icmp eq i32 %28, 0, !dbg !80
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !82
  br i1 %29, label %30, label %34, !dbg !82

; <label>:30:                                     ; preds = %27
  %31 = call i32* @__errno() #5, !dbg !83
  br label %32, !dbg !85

; <label>:32:                                     ; preds = %25, %30
  %33 = phi i32* [ %31, %30 ], [ %26, %25 ]
  store i32 33, i32* %33, align 4, !dbg !86, !tbaa !87
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !86
  br label %34, !dbg !88

; <label>:34:                                     ; preds = %32, %27
  %35 = load i32, i32* %16, align 8, !dbg !88, !tbaa !66
  %36 = icmp eq i32 %35, 0, !dbg !90
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !91
  br i1 %36, label %39, label %37, !dbg !91

; <label>:37:                                     ; preds = %34
  %38 = call i32* @__errno() #5, !dbg !92
  store i32 %35, i32* %38, align 4, !dbg !93, !tbaa !87
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !92
  br label %39, !dbg !92

; <label>:39:                                     ; preds = %34, %37
  %40 = load double, double* %22, align 8, !dbg !94, !tbaa !73
  %41 = fptrunc double %40 to float, !dbg !95
  br label %42, !dbg !96

; <label>:42:                                     ; preds = %11, %2, %8, %39
  %43 = phi float [ %41, %39 ], [ %5, %8 ], [ %5, %2 ], [ %5, %11 ], !dbg !97
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !98
  call void @llvm.lifetime.end.p0i8(i64 48, i8* nonnull %4) #4, !dbg !99
...
!50 = !DILocation(line: 37, column: 6, scope: !51)
...
!54 = distinct !DILexicalBlock(scope: !51, file: !1, line: 37, column: 20)
!55 = !DILocation(line: 39, column: 22, scope: !54)
!56 = !{!57, !58, i64 0}
!57 = !{!"exception", !58, i64 0, !59, i64 8, !60, i64 16, !60, i64 24, !60, i64 32, !58, i64 40}
!58 = !{!"int", !44, i64 0}
!59 = !{!"any pointer", !44, i64 0}
!60 = !{!"double", !44, i64 0}
!61 = !DILocation(line: 40, column: 17, scope: !54)
!62 = !DILocation(line: 40, column: 22, scope: !54)
!63 = !{!57, !59, i64 8}
!64 = !DILocation(line: 41, column: 10, scope: !54)
!65 = !DILocation(line: 41, column: 14, scope: !54)
!66 = !{!57, !58, i64 40}
!67 = !DILocation(line: 42, column: 10, scope: !54)
!68 = !DILocation(line: 42, column: 17, scope: !54)
!69 = !DILocation(line: 42, column: 15, scope: !54)
!70 = !{!60, !60, i64 0}
!71 = !DILocation(line: 44, column: 17, scope: !54)
!72 = !DILocation(line: 44, column: 24, scope: !54)
!73 = !{!57, !60, i64 32}
!74 = !DILocation(line: 45, column: 17, scope: !75)
!75 = distinct !DILexicalBlock(scope: !54, file: !1, line: 45, column: 17)
!76 = !DILocation(line: 45, column: 30, scope: !75)
!77 = !DILocation(line: 45, column: 17, scope: !54)
!78 = !DILocation(line: 46, column: 16, scope: !75)
!79 = !DILocation(line: 34, column: 19, scope: !18)
...
!89 = distinct !DILexicalBlock(scope: !54, file: !1, line: 50, column: 10)
!90 = !DILocation(line: 50, column: 18, scope: !89)
!91 = !DILocation(line: 50, column: 10, scope: !54)
!92 = !DILocation(line: 51, column: 9, scope: !89)
!93 = !DILocation(line: 51, column: 15, scope: !89)
!94 = !DILocation(line: 52, column: 31, scope: !54)
!95 = !DILocation(line: 52, column: 20, scope: !54)
!96 = !DILocation(line: 52, column: 13, scope: !54)
!97 = !DILocation(line: 0, scope: !51)
!98 = !DILocation(line: 0, scope: !42)
!99 = !DILocation(line: 56, column: 1, scope: !18)
