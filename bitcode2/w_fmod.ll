...
; <label>:11:                                     ; preds = %8
  ...
  br i1 %13, label %44, label %14, !dbg !49

; <label>:14:                                     ; preds = %11
  %15 = fcmp oeq double %1, 0.000000e+00, !dbg !50
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !52
  br i1 %15, label %16, label %44, !dbg !52

; <label>:16:                                     ; preds = %14
  %17 = getelementptr inbounds %struct.exception, %struct.exception* %3, i64 0, i32 0, !dbg !53
  store i32 1, i32* %17, align 8, !dbg !55, !tbaa !56
  %18 = getelementptr inbounds %struct.exception, %struct.exception* %3, i64 0, i32 1, !dbg !61
  store i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i8** %18, align 8, !dbg !62, !tbaa !63
  %19 = getelementptr inbounds %struct.exception, %struct.exception* %3, i64 0, i32 2, !dbg !64
  store double %0, double* %19, align 8, !dbg !65, !tbaa !66
  %20 = getelementptr inbounds %struct.exception, %struct.exception* %3, i64 0, i32 3, !dbg !67
  store double %1, double* %20, align 8, !dbg !68, !tbaa !69
  %21 = getelementptr inbounds %struct.exception, %struct.exception* %3, i64 0, i32 5, !dbg !70
  store i32 0, i32* %21, align 8, !dbg !71, !tbaa !72
  %22 = load i32, i32* @__fdlib_version, align 4, !dbg !73, !tbaa !41
  %23 = icmp eq i32 %22, 0, !dbg !75
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !76
  %24 = getelementptr inbounds %struct.exception, %struct.exception* %3, i64 0, i32 4, !dbg !77
  br i1 %23, label %25, label %26, !dbg !76

; <label>:25:                                     ; preds = %16
  store double %0, double* %24, align 8, !dbg !78, !tbaa !79
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !80
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !81
  br label %30, !dbg !81

; <label>:26:                                     ; preds = %16
  store double 0x7FF8000000000000, double* %24, align 8, !dbg !82, !tbaa !79
  store volatile i32 42, i32* @__A_VARIABLE, align 4
  %27 = icmp eq i32 %22, 2, !dbg !83
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !81
  br i1 %27, label %28, label %30, !dbg !81

; <label>:28:                                     ; preds = %26
  %29 = tail call i32* @__errno() #5, !dbg !85
  br label %35, !dbg !85

; <label>:30:                                     ; preds = %25, %26
  %31 = call i32 @matherr(%struct.exception* nonnull %3) #5, !dbg !87
  %32 = icmp eq i32 %31, 0, !dbg !87
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !89
  br i1 %32, label %33, label %37, !dbg !89
...
; <label>:35:                                     ; preds = %28, %33
  ...
  store i32 33, i32* %36, align 4, !dbg !93, !tbaa !94
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !93
  br label %37, !dbg !95

; <label>:37:                                     ; preds = %35, %30
  %38 = load i32, i32* %21, align 8, !dbg !95, !tbaa !72
  %39 = icmp eq i32 %38, 0, !dbg !97
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !98
  br i1 %39, label %42, label %40, !dbg !98

; <label>:40:                                     ; preds = %37
  %41 = call i32* @__errno() #5, !dbg !99
  store i32 %38, i32* %41, align 4, !dbg !100, !tbaa !94
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !99
  br label %42, !dbg !99

; <label>:42:                                     ; preds = %37, %40
  %43 = load double, double* %24, align 8, !dbg !101, !tbaa !79
  br label %44, !dbg !102

; <label>:44:                                     ; preds = %14, %2, %8, %11, %42
  %45 = phi double [ %43, %42 ], [ %5, %11 ], [ %5, %8 ], [ %5, %2 ], [ %5, %14 ], !dbg !103
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !104
  call void @llvm.lifetime.end.p0i8(i64 48, i8* nonnull %4) #4, !dbg !105
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !105
  ret double %45, !dbg !105
}
...
!49 = !DILocation(line: 82, column: 5, scope: !15)
!50 = !DILocation(line: 83, column: 6, scope: !51)
!51 = distinct !DILexicalBlock(scope: !15, file: !1, line: 83, column: 5)
!52 = !DILocation(line: 83, column: 5, scope: !15)
!53 = !DILocation(line: 85, column: 17, scope: !54)
!54 = distinct !DILexicalBlock(scope: !51, file: !1, line: 83, column: 13)
!55 = !DILocation(line: 85, column: 22, scope: !54)
!56 = !{!57, !58, i64 0}
!57 = !{!"exception", !58, i64 0, !59, i64 8, !60, i64 16, !60, i64 24, !60, i64 32, !58, i64 40}
!58 = !{!"int", !42, i64 0}
!59 = !{!"any pointer", !42, i64 0}
!60 = !{!"double", !42, i64 0}
!61 = !DILocation(line: 86, column: 17, scope: !54)
!62 = !DILocation(line: 86, column: 22, scope: !54)
!63 = !{!57, !59, i64 8}
!64 = !DILocation(line: 87, column: 10, scope: !54)
!65 = !DILocation(line: 87, column: 15, scope: !54)
!66 = !{!57, !60, i64 16}
!67 = !DILocation(line: 88, column: 10, scope: !54)
!68 = !DILocation(line: 88, column: 15, scope: !54)
!69 = !{!57, !60, i64 24}
!70 = !DILocation(line: 89, column: 10, scope: !54)
!71 = !DILocation(line: 89, column: 14, scope: !54)
!72 = !{!57, !58, i64 40}
!73 = !DILocation(line: 90, column: 17, scope: !74)
!74 = distinct !DILexicalBlock(scope: !54, file: !1, line: 90, column: 17)
!75 = !DILocation(line: 90, column: 30, scope: !74)
!76 = !DILocation(line: 90, column: 17, scope: !54)
!77 = !DILocation(line: 0, scope: !74)
!78 = !DILocation(line: 91, column: 27, scope: !74)
!79 = !{!57, !60, i64 32}
!80 = !DILocation(line: 91, column: 16, scope: !74)
!81 = !DILocation(line: 94, column: 17, scope: !54)
!82 = !DILocation(line: 93, column: 20, scope: !74)
!83 = !DILocation(line: 94, column: 30, scope: !84)
!84 = distinct !DILexicalBlock(scope: !54, file: !1, line: 94, column: 17)
!85 = !DILocation(line: 95, column: 16, scope: !84)
!86 = !DILocation(line: 80, column: 19, scope: !15)
!87 = !DILocation(line: 96, column: 23, scope: !88)
!88 = distinct !DILexicalBlock(scope: !84, file: !1, line: 96, column: 22)
!89 = !DILocation(line: 96, column: 22, scope: !84)
!90 = !DILocation(line: 97, column: 19, scope: !91)
!91 = distinct !DILexicalBlock(scope: !88, file: !1, line: 96, column: 38)
!92 = !DILocation(line: 98, column: 13, scope: !91)
!93 = !DILocation(line: 0, scope: !84)
!94 = !{!58, !58, i64 0}
!95 = !DILocation(line: 99, column: 14, scope: !96)
!96 = distinct !DILexicalBlock(scope: !54, file: !1, line: 99, column: 10)
!97 = !DILocation(line: 99, column: 18, scope: !96)
!98 = !DILocation(line: 99, column: 10, scope: !54)
!99 = !DILocation(line: 100, column: 9, scope: !96)
!100 = !DILocation(line: 100, column: 15, scope: !96)
!101 = !DILocation(line: 101, column: 24, scope: !54)
!102 = !DILocation(line: 101, column: 13, scope: !54)
!103 = !DILocation(line: 0, scope: !51)
!104 = !DILocation(line: 0, scope: !40)
!105 = !DILocation(line: 105, column: 1, scope: !15)
