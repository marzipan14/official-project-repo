; ModuleID = '/root/.unikraft/apps/redis/build/libpthread-embedded/origin/pthread-embedded-44b41d760a433915d70a7be9809651b0a65e001d/pte_rwlock_cancelwrwait.c'
source_filename = "/root/.unikraft/apps/redis/build/libpthread-embedded/origin/pthread-embedded-44b41d760a433915d70a7be9809651b0a65e001d/pte_rwlock_cancelwrwait.c"
...
define dso_local void @pte_rwlock_cancelwrwait(i8*) local_unnamed_addr #0 !dbg !513 {
  %2 = getelementptr inbounds i8, i8* %0, i64 32, !dbg !519
  %3 = bitcast i8* %2 to i32*, !dbg !519
  %4 = load i32, i32* %3, align 8, !dbg !519, !tbaa !520
  %5 = sub nsw i32 0, %4, !dbg !526
  %6 = getelementptr inbounds i8, i8* %0, i64 24, !dbg !527
  %7 = bitcast i8* %6 to i32*, !dbg !527
  store i32 %5, i32* %7, align 8, !dbg !528, !tbaa !529
  store i32 0, i32* %3, align 8, !dbg !530, !tbaa !520
  %8 = getelementptr inbounds i8, i8* %0, i64 8, !dbg !531
  %9 = bitcast i8* %8 to %struct.pthread_mutex_t_**, !dbg !531
  %10 = tail call i32 @pthread_mutex_unlock(%struct.pthread_mutex_t_** nonnull %9) #3, !dbg !532
  %11 = bitcast i8* %0 to %struct.pthread_mutex_t_**, !dbg !533
  %12 = tail call i32 @pthread_mutex_unlock(%struct.pthread_mutex_t_** %11) #3, !dbg !534
...
!1 = !DIFile(filename: "/root/.unikraft/apps/redis/build/libpthread-embedded/origin/pthread-embedded-44b41d760a433915d70a7be9809651b0a65e001d/pte_rwlock_cancelwrwait.c", directory: "/root/.unikraft/apps/redis/build")
!2 = !{!3}
...
!513 = distinct !DISubprogram(name: "pte_rwlock_cancelwrwait", scope: !1, file: !1, line: 47, type: !212, isLocal: false, isDefinition: true, scopeLine: 48, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !514)
!514 = !{!515, !516}
!515 = !DILocalVariable(name: "arg", arg: 1, scope: !513, file: !1, line: 47, type: !51)
!516 = !DILocalVariable(name: "rwl", scope: !513, file: !1, line: 49, type: !11)
!517 = !DILocation(line: 47, column: 32, scope: !513)
!518 = !DILocation(line: 49, column: 20, scope: !513)
!519 = !DILocation(line: 51, column: 35, scope: !513)
!520 = !{!521, !525, i64 32}
!521 = !{!"pthread_rwlock_t_", !522, i64 0, !522, i64 8, !522, i64 16, !525, i64 24, !525, i64 28, !525, i64 32, !525, i64 36}
!522 = !{!"any pointer", !523, i64 0}
!523 = !{!"omnipotent char", !524, i64 0}
!524 = !{!"Simple C/C++ TBAA"}
!525 = !{!"int", !523, i64 0}
!526 = !DILocation(line: 51, column: 29, scope: !513)
!527 = !DILocation(line: 51, column: 8, scope: !513)
!528 = !DILocation(line: 51, column: 27, scope: !513)
!529 = !{!521, !525, i64 24}
!530 = !DILocation(line: 52, column: 36, scope: !513)
!531 = !DILocation(line: 54, column: 39, scope: !513)
!532 = !DILocation(line: 54, column: 10, scope: !513)
!533 = !DILocation(line: 55, column: 39, scope: !513)
!534 = !DILocation(line: 55, column: 10, scope: !513)
!535 = !DILocation(line: 56, column: 1, scope: !513)
