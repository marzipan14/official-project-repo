...
define dso_local float @__ieee754_log10f(float) local_unnamed_addr #0 !dbg !24 {
  ...
  br i1 %4, label %39, label %5, !dbg !56
...
; <label>:14:                                     ; preds = %10
  ...
  br i1 %15, label %16, label %19, !dbg !69

; <label>:16:                                     ; preds = %14
  %17 = fmul float %0, 0x4180000000000000, !dbg !70
  %18 = bitcast float %17 to i32, !dbg !71
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !72
  br label %19, !dbg !72

; <label>:19:                                     ; preds = %16, %14
  %20 = phi i32 [ %18, %16 ], [ %2, %14 ], !dbg !73
  %21 = phi i32 [ -25, %16 ], [ 0, %14 ], !dbg !74
  %22 = ashr i32 %20, 23, !dbg !75
  %23 = add nsw i32 %22, -127, !dbg !76
  %24 = add nsw i32 %23, %21, !dbg !77
  %25 = lshr i32 %24, 31, !dbg !78
  %26 = and i32 %20, 8388607, !dbg !80
  %27 = shl nuw nsw i32 %25, 23, !dbg !81
  %28 = or i32 %27, %26, !dbg !82
  %29 = xor i32 %28, 1065353216, !dbg !82
  %30 = add nsw i32 %25, %24, !dbg !83
  %31 = sitofp i32 %30 to float, !dbg !84
  %32 = bitcast i32 %29 to float, !dbg !86
  %33 = fmul float %31, 0x3EAA84FB60000000, !dbg !87
  %34 = tail call float @__ieee754_logf(float %32) #3, !dbg !88
  %35 = fmul float %34, 0x3FDBCB7B20000000, !dbg !89
  %36 = fadd float %35, %33, !dbg !90
  %37 = fmul float %31, 0x3FD3441000000000, !dbg !92
  %38 = fadd float %37, %36, !dbg !93
  br label %39, !dbg !94

; <label>:39:                                     ; preds = %1, %19, %12, %7
  %40 = phi float [ %9, %7 ], [ %38, %19 ], [ %13, %12 ], [ 0xFFF0000000000000, %1 ], !dbg !95
...
!69 = !DILocation(line: 51, column: 13, scope: !24)
!70 = !DILocation(line: 52, column: 24, scope: !46)
!71 = !DILocation(line: 53, column: 6, scope: !45)
!72 = !DILocation(line: 54, column: 9, scope: !46)
!73 = !DILocation(line: 0, scope: !37)
!74 = !DILocation(line: 0, scope: !24)
!75 = !DILocation(line: 55, column: 10, scope: !24)
!76 = !DILocation(line: 55, column: 15, scope: !24)
!77 = !DILocation(line: 55, column: 4, scope: !24)
!78 = !DILocation(line: 56, column: 33, scope: !24)
!79 = !DILocation(line: 42, column: 12, scope: !24)
!80 = !DILocation(line: 57, column: 17, scope: !24)
!81 = !DILocation(line: 57, column: 39, scope: !24)
!82 = !DILocation(line: 57, column: 29, scope: !24)
!83 = !DILocation(line: 58, column: 23, scope: !24)
!84 = !DILocation(line: 58, column: 14, scope: !24)
!85 = !DILocation(line: 41, column: 8, scope: !24)
!86 = !DILocation(line: 59, column: 2, scope: !49)
!87 = !DILocation(line: 60, column: 8, scope: !24)
!88 = !DILocation(line: 60, column: 28, scope: !24)
!89 = !DILocation(line: 60, column: 27, scope: !24)
!90 = !DILocation(line: 60, column: 19, scope: !24)
!91 = !DILocation(line: 41, column: 10, scope: !24)
!92 = !DILocation(line: 61, column: 13, scope: !24)
!93 = !DILocation(line: 61, column: 11, scope: !24)
!94 = !DILocation(line: 61, column: 2, scope: !24)
!95 = !DILocation(line: 0, scope: !64)
!96 = !DILocation(line: 0, scope: !55)
!97 = !DILocation(line: 62, column: 1, scope: !24)
