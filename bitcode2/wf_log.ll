...
; <label>:7:                                      ; preds = %1
  ...
  br i1 %11, label %55, label %12, !dbg !48
...
; <label>:28:                                     ; preds = %24
  ...
  br i1 %30, label %31, label %47, !dbg !89
...
; <label>:47:                                     ; preds = %46, %28
  %48 = load i32, i32* %14, align 8, !dbg !108, !tbaa !58
  %49 = icmp eq i32 %48, 0, !dbg !110
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !111
  br i1 %49, label %52, label %50, !dbg !111

; <label>:50:                                     ; preds = %47
  %51 = call i32* @__errno() #5, !dbg !112
  store i32 %48, i32* %51, align 4, !dbg !113, !tbaa !85
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !112
  br label %52, !dbg !112

; <label>:52:                                     ; preds = %47, %50
  %53 = load double, double* %20, align 8, !dbg !114, !tbaa !71
  %54 = fptrunc double %53 to float, !dbg !115
  br label %55, !dbg !116

; <label>:55:                                     ; preds = %1, %7, %52
  %56 = phi float [ %54, %52 ], [ %4, %7 ], [ %4, %1 ], !dbg !117
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !118
  call void @llvm.lifetime.end.p0i8(i64 48, i8* nonnull %3) #4, !dbg !119
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !119
  ret float %56, !dbg !119
}
...
!70 = !DILocation(line: 46, column: 6, scope: !18)
!71 = !{!52, !55, i64 32}
...
!118 = !DILocation(line: 0, scope: !40)
!119 = !DILocation(line: 72, column: 1, scope: !18)
