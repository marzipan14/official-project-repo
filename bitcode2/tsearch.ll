...
; <label>:19:                                     ; preds = %9
  %20 = icmp slt i32 %14, 0, !dbg !62
  %21 = load %struct.node*, %struct.node** %11, align 8, !dbg !63, !tbaa !46
  %22 = getelementptr inbounds %struct.node, %struct.node* %21, i64 0, i32 1, !dbg !64
  %23 = getelementptr inbounds %struct.node, %struct.node* %21, i64 0, i32 2, !dbg !65
  %24 = select i1 %20, %struct.node** %22, %struct.node** %23, !dbg !66
...
; <label>:27:                                     ; preds = %19, %6
  ...
  %29 = tail call i8* @malloc(i64 24) #3, !dbg !68
  %30 = icmp eq i8* %29, null, !dbg !69
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !71
  br i1 %30, label %36, label %31, !dbg !71

; <label>:31:                                     ; preds = %27
  %32 = bitcast %struct.node** %28 to i8**, !dbg !73
  store i8* %29, i8** %32, align 8, !dbg !73, !tbaa !46
  %33 = bitcast i8* %29 to i8**, !dbg !75
  store i8* %0, i8** %33, align 8, !dbg !76, !tbaa !54
  %34 = getelementptr inbounds i8, i8* %29, i64 8, !dbg !77
  %35 = bitcast i8* %34 to <2 x %struct.node*>*, !dbg !78
  store <2 x %struct.node*> zeroinitializer, <2 x %struct.node*>* %35, align 8, !dbg !78, !tbaa !46
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !79
  br label %36, !dbg !79

; <label>:36:                                     ; preds = %31, %27, %3, %16
  %37 = phi i8* [ %18, %16 ], [ null, %3 ], [ %29, %27 ], [ %29, %31 ], !dbg !80
  store volatile i32 42, i32* @__A_VARIABLE, align 4
...
!61 = !DILocation(line: 43, column: 4, scope: !53)
!62 = !DILocation(line: 45, column: 14, scope: !38)
!63 = !DILocation(line: 0, scope: !38)
!64 = !DILocation(line: 46, column: 18, scope: !38)
!65 = !DILocation(line: 47, column: 18, scope: !38)
!66 = !DILocation(line: 45, column: 11, scope: !38)
!67 = !DILocation(line: 48, column: 2, scope: !21)
!68 = !DILocation(line: 50, column: 6, scope: !21)
!69 = !DILocation(line: 51, column: 8, scope: !70)
!70 = distinct !DILexicalBlock(scope: !21, file: !1, line: 51, column: 6)
!71 = !DILocation(line: 51, column: 6, scope: !21)
!72 = !DILocation(line: 33, column: 10, scope: !21)
!73 = !DILocation(line: 52, column: 10, scope: !74)
!74 = distinct !DILexicalBlock(scope: !70, file: !1, line: 51, column: 14)
!75 = !DILocation(line: 54, column: 6, scope: !74)
!76 = !DILocation(line: 54, column: 10, scope: !74)
!77 = !DILocation(line: 55, column: 6, scope: !74)
!78 = !DILocation(line: 55, column: 12, scope: !74)
!79 = !DILocation(line: 56, column: 2, scope: !74)
!80 = !DILocation(line: 0, scope: !21)
