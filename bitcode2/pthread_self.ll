; ModuleID = '/root/.unikraft/apps/redis/build/libpthread-embedded/origin/pthread-embedded-44b41d760a433915d70a7be9809651b0a65e001d/pthread_self.c'
source_filename = "/root/.unikraft/apps/redis/build/libpthread-embedded/origin/pthread-embedded-44b41d760a433915d70a7be9809651b0a65e001d/pthread_self.c"
...
define dso_local { i8*, i32 } @pthread_self() local_unnamed_addr #0 !dbg !536 {
  %1 = load %struct.pthread_key_t_*, %struct.pthread_key_t_** @pte_selfThreadKey, align 8, !dbg !542, !tbaa !543
  %2 = tail call i8* @pthread_getspecific(%struct.pthread_key_t_* %1) #3, !dbg !547
  %3 = icmp eq i8* %2, null, !dbg !548
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !550
  br i1 %3, label %11, label %4, !dbg !550

; <label>:4:                                      ; preds = %0
  %5 = getelementptr inbounds i8, i8* %2, i64 8, !dbg !552
  %6 = bitcast i8* %5 to i8**, !dbg !552
  %7 = load i8*, i8** %6, align 8, !dbg !552
  %8 = getelementptr inbounds i8, i8* %2, i64 16, !dbg !552
  %9 = bitcast i8* %8 to i32*, !dbg !552
  %10 = load i32, i32* %9, align 8, !dbg !552
  br label %28, !dbg !555

; <label>:11:                                     ; preds = %0
  %12 = tail call { i8*, i32 } @pte_new() #3, !dbg !556
  %13 = extractvalue { i8*, i32 } %12, 0, !dbg !556
  %14 = extractvalue { i8*, i32 } %12, 1, !dbg !556
  %15 = icmp eq i8* %13, null, !dbg !558
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !560
  br i1 %15, label %31, label %16, !dbg !560

; <label>:16:                                     ; preds = %11
  %17 = getelementptr inbounds i8, i8* %13, i64 168, !dbg !561
  %18 = load i8, i8* %17, align 8, !dbg !563
  %19 = or i8 %18, 1, !dbg !563
  store i8 %19, i8* %17, align 8, !dbg !563
  %20 = getelementptr inbounds i8, i8* %13, i64 60, !dbg !564
  %21 = bitcast i8* %20 to i32*, !dbg !564
  store i32 1, i32* %21, align 4, !dbg !565, !tbaa !566
  %22 = tail call %struct.uk_thread* @pte_osThreadGetHandle() #3, !dbg !570
  %23 = bitcast i8* %13 to %struct.uk_thread**, !dbg !571
  store %struct.uk_thread* %22, %struct.uk_thread** %23, align 8, !dbg !572, !tbaa !573
  %24 = getelementptr inbounds i8, i8* %13, i64 72, !dbg !574
  %25 = bitcast i8* %24 to i32*, !dbg !574
  store i32 0, i32* %25, align 8, !dbg !575, !tbaa !576
  %26 = load %struct.pthread_key_t_*, %struct.pthread_key_t_** @pte_selfThreadKey, align 8, !dbg !577, !tbaa !543
  %27 = tail call i32 @pthread_setspecific(%struct.pthread_key_t_* %26, i8* nonnull %13) #3, !dbg !578
  br label %28, !dbg !579

; <label>:28:                                     ; preds = %4, %16
  %29 = phi i8* [ %13, %16 ], [ %7, %4 ]
  %30 = phi i32 [ %14, %16 ], [ %10, %4 ]
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !580
  br label %31, !dbg !581

; <label>:31:                                     ; preds = %28, %11
  %32 = phi i8* [ null, %11 ], [ %29, %28 ], !dbg !582
  %33 = phi i32 [ %14, %11 ], [ %30, %28 ], !dbg !582
  %34 = insertvalue { i8*, i32 } undef, i8* %32, 0, !dbg !581
  %35 = insertvalue { i8*, i32 } %34, i32 %33, 1, !dbg !581
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !581
  ret { i8*, i32 } %35, !dbg !581
}
...
; Function Attrs: noredzone
declare dso_local %struct.uk_thread* @pte_osThreadGetHandle() local_unnamed_addr #1
...
!1 = !DIFile(filename: "/root/.unikraft/apps/redis/build/libpthread-embedded/origin/pthread-embedded-44b41d760a433915d70a7be9809651b0a65e001d/pthread_self.c", directory: "/root/.unikraft/apps/redis/build")
!2 = !{!3, !10, !20}
...
!536 = distinct !DISubprogram(name: "pthread_self", scope: !1, file: !1, line: 50, type: !537, isLocal: false, isDefinition: true, scopeLine: 70, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !539)
!537 = !DISubroutineType(types: !538)
!538 = !{!488}
!539 = !{!540, !541}
!540 = !DILocalVariable(name: "self", scope: !536, file: !1, line: 71, type: !488)
!541 = !DILocalVariable(name: "sp", scope: !536, file: !1, line: 72, type: !39)
!542 = !DILocation(line: 74, column: 46, scope: !536)
!543 = !{!544, !544, i64 0}
!544 = !{!"any pointer", !545, i64 0}
!545 = !{!"omnipotent char", !546, i64 0}
!546 = !{!"Simple C/C++ TBAA"}
!547 = !DILocation(line: 74, column: 25, scope: !536)
!548 = !DILocation(line: 76, column: 10, scope: !549)
!549 = distinct !DILexicalBlock(scope: !536, file: !1, line: 76, column: 7)
!550 = !DILocation(line: 76, column: 7, scope: !536)
!551 = !DILocation(line: 72, column: 18, scope: !536)
!552 = !DILocation(line: 78, column: 18, scope: !553)
!553 = distinct !DILexicalBlock(scope: !549, file: !1, line: 77, column: 5)
!554 = !DILocation(line: 71, column: 13, scope: !536)
!555 = !DILocation(line: 79, column: 5, scope: !553)
!556 = !DILocation(line: 90, column: 14, scope: !557)
!557 = distinct !DILexicalBlock(scope: !549, file: !1, line: 81, column: 5)
!558 = !DILocation(line: 93, column: 14, scope: !559)
!559 = distinct !DILexicalBlock(scope: !557, file: !1, line: 93, column: 11)
!560 = !DILocation(line: 93, column: 11, scope: !557)
!561 = !DILocation(line: 101, column: 15, scope: !562)
!562 = distinct !DILexicalBlock(scope: !559, file: !1, line: 94, column: 9)
!563 = !DILocation(line: 101, column: 24, scope: !562)
!564 = !DILocation(line: 102, column: 15, scope: !562)
!565 = !DILocation(line: 102, column: 27, scope: !562)
!566 = !{!567, !569, i64 60}
!567 = !{!"pte_thread_t_", !544, i64 0, !568, i64 8, !544, i64 24, !545, i64 32, !544, i64 40, !544, i64 48, !569, i64 56, !569, i64 60, !544, i64 64, !569, i64 72, !544, i64 80, !569, i64 88, !569, i64 92, !569, i64 96, !545, i64 104, !569, i64 168, !544, i64 176, !544, i64 184}
!568 = !{!"", !544, i64 0, !569, i64 8}
!569 = !{!"int", !545, i64 0}
!570 = !DILocation(line: 104, column: 26, scope: !562)
!571 = !DILocation(line: 104, column: 15, scope: !562)
!572 = !DILocation(line: 104, column: 24, scope: !562)
!573 = !{!567, !544, i64 0}
!574 = !DILocation(line: 109, column: 15, scope: !562)
!575 = !DILocation(line: 109, column: 30, scope: !562)
!576 = !{!567, !569, i64 72}
!577 = !DILocation(line: 111, column: 32, scope: !562)
!578 = !DILocation(line: 111, column: 11, scope: !562)
!579 = !DILocation(line: 112, column: 9, scope: !562)
!580 = !DILocation(line: 0, scope: !553)
!581 = !DILocation(line: 117, column: 1, scope: !536)
!582 = !DILocation(line: 0, scope: !557)
