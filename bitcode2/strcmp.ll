...
; <label>:8:                                      ; preds = %2
  ...
  %11 = load i64, i64* %9, align 8, !dbg !36, !tbaa !37
  %12 = load i64, i64* %10, align 8, !dbg !41, !tbaa !37
  %13 = icmp eq i64 %11, %12, !dbg !42
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !35
  br i1 %13, label %14, label %29, !dbg !35
...
; <label>:14:                                     ; preds = %8, %23
  ...
  br i1 %22, label %23, label %59, !dbg !46

; <label>:23:                                     ; preds = %14
  %24 = getelementptr inbounds i64, i64* %17, i64 1, !dbg !47
  %25 = getelementptr inbounds i64, i64* %16, i64 1, !dbg !48
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !35
  %26 = load i64, i64* %24, align 8, !dbg !36, !tbaa !37
  %27 = load i64, i64* %25, align 8, !dbg !41, !tbaa !37
  %28 = icmp eq i64 %26, %27, !dbg !42
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !35
  br i1 %28, label %14, label %29, !dbg !35, !llvm.loop !49
...
; <label>:34:                                     ; preds = %2, %29
  ...
  %37 = load i8, i8* %35, align 1, !dbg !56, !tbaa !57
  %38 = icmp eq i8 %37, 0, !dbg !58
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !59
  br i1 %38, label %50, label %39, !dbg !59

; <label>:39:                                     ; preds = %34, %45
  %40 = phi i8 [ %48, %45 ], [ %37, %34 ]
  %41 = phi i8* [ %47, %45 ], [ %36, %34 ]
  %42 = phi i8* [ %46, %45 ], [ %35, %34 ]
  %43 = load i8, i8* %41, align 1, !dbg !60, !tbaa !57
  %44 = icmp eq i8 %40, %43, !dbg !61
  store volatile i32 42, i32* @__A_VARIABLE, align 4
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !55
  br i1 %44, label %45, label %53, !dbg !55

; <label>:45:                                     ; preds = %39
  %46 = getelementptr inbounds i8, i8* %42, i64 1, !dbg !62
  %47 = getelementptr inbounds i8, i8* %41, i64 1, !dbg !64
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !55
  %48 = load i8, i8* %46, align 1, !dbg !56, !tbaa !57
  %49 = icmp eq i8 %48, 0, !dbg !58
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !59
  br i1 %49, label %50, label %39, !dbg !59, !llvm.loop !65

; <label>:50:                                     ; preds = %45, %34
  %51 = phi i8* [ %36, %34 ], [ %47, %45 ]
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !55
  %52 = load i8, i8* %51, align 1, !dbg !67, !tbaa !57
  br label %53

; <label>:53:                                     ; preds = %39, %50
  %54 = phi i8 [ %52, %50 ], [ %43, %39 ], !dbg !67
  %55 = phi i8 [ 0, %50 ], [ %40, %39 ]
  %56 = zext i8 %55 to i32, !dbg !68
  %57 = zext i8 %54 to i32, !dbg !69
  %58 = sub nsw i32 %56, %57, !dbg !70
  br label %59, !dbg !71

; <label>:59:                                     ; preds = %14, %53
  %60 = phi i32 [ %58, %53 ], [ 0, %14 ], !dbg !72
...
!35 = !DILocation(line: 83, column: 7, scope: !31)
!36 = !DILocation(line: 83, column: 14, scope: !31)
!37 = !{!38, !38, i64 0}
!38 = !{!"long", !39, i64 0}
!39 = !{!"omnipotent char", !40, i64 0}
!40 = !{!"Simple C/C++ TBAA"}
!41 = !DILocation(line: 83, column: 21, scope: !31)
!42 = !DILocation(line: 83, column: 18, scope: !31)
...
!56 = !DILocation(line: 99, column: 10, scope: !15)
!57 = !{!39, !39, i64 0}
!58 = !DILocation(line: 99, column: 14, scope: !15)
!59 = !DILocation(line: 99, column: 22, scope: !15)
!60 = !DILocation(line: 99, column: 32, scope: !15)
!61 = !DILocation(line: 99, column: 29, scope: !15)
...
!67 = !DILocation(line: 104, column: 37, scope: !15)
!68 = !DILocation(line: 104, column: 10, scope: !15)
