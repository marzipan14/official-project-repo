; ModuleID = '/root/.unikraft/apps/redis/build/libpthread-embedded/origin/pthread-embedded-44b41d760a433915d70a7be9809651b0a65e001d/pthread_rwlock_destroy.c'
source_filename = "/root/.unikraft/apps/redis/build/libpthread-embedded/origin/pthread-embedded-44b41d760a433915d70a7be9809651b0a65e001d/pthread_rwlock_destroy.c"
...
@pte_rwlock_test_init_lock = external dso_local local_unnamed_addr global %struct.uk_mutex*, align 8
@__A_VARIABLE = internal global i32 0

; Function Attrs: noredzone nounwind
define dso_local i32 @pthread_rwlock_destroy(%struct.pthread_rwlock_t_**) local_unnamed_addr #0 !dbg !513 {
  %2 = icmp eq %struct.pthread_rwlock_t_** %0, null, !dbg !527
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !529
  br i1 %2, label %65, label %3, !dbg !529

; <label>:3:                                      ; preds = %1
  %4 = load %struct.pthread_rwlock_t_*, %struct.pthread_rwlock_t_** %0, align 8, !dbg !530, !tbaa !531
  %5 = icmp eq %struct.pthread_rwlock_t_* %4, null, !dbg !535
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !536
  br i1 %5, label %65, label %6, !dbg !536

; <label>:6:                                      ; preds = %3
  %7 = icmp eq %struct.pthread_rwlock_t_* %4, inttoptr (i64 -1 to %struct.pthread_rwlock_t_*), !dbg !537
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !539
  br i1 %7, label %47, label %8, !dbg !539

; <label>:8:                                      ; preds = %6
  %9 = getelementptr inbounds %struct.pthread_rwlock_t_, %struct.pthread_rwlock_t_* %4, i64 0, i32 6, !dbg !541
  %10 = load i32, i32* %9, align 4, !dbg !541, !tbaa !544
  %11 = icmp eq i32 %10, 262974946, !dbg !547
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !548
  br i1 %11, label %12, label %65, !dbg !548

; <label>:12:                                     ; preds = %8
  %13 = getelementptr inbounds %struct.pthread_rwlock_t_, %struct.pthread_rwlock_t_* %4, i64 0, i32 0, !dbg !549
  %14 = tail call i32 @pthread_mutex_lock(%struct.pthread_mutex_t_** nonnull %13) #3, !dbg !551
  %15 = icmp eq i32 %14, 0, !dbg !552
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !553
  br i1 %15, label %16, label %65, !dbg !553

; <label>:16:                                     ; preds = %12
  %17 = getelementptr inbounds %struct.pthread_rwlock_t_, %struct.pthread_rwlock_t_* %4, i64 0, i32 1, !dbg !554
  %18 = tail call i32 @pthread_mutex_lock(%struct.pthread_mutex_t_** nonnull %17) #3, !dbg !556
  %19 = icmp eq i32 %18, 0, !dbg !557
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !558
  br i1 %19, label %22, label %20, !dbg !558

; <label>:20:                                     ; preds = %16
  %21 = tail call i32 @pthread_mutex_unlock(%struct.pthread_mutex_t_** nonnull %13) #3, !dbg !559
  br label %65, !dbg !561

; <label>:22:                                     ; preds = %16
  %23 = getelementptr inbounds %struct.pthread_rwlock_t_, %struct.pthread_rwlock_t_* %4, i64 0, i32 4, !dbg !562
  %24 = load i32, i32* %23, align 4, !dbg !562, !tbaa !564
  %25 = icmp sgt i32 %24, 0, !dbg !565
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !566
  br i1 %25, label %32, label %26, !dbg !566

; <label>:26:                                     ; preds = %22
  %27 = getelementptr inbounds %struct.pthread_rwlock_t_, %struct.pthread_rwlock_t_* %4, i64 0, i32 3, !dbg !567
  %28 = load i32, i32* %27, align 8, !dbg !567, !tbaa !568
  %29 = getelementptr inbounds %struct.pthread_rwlock_t_, %struct.pthread_rwlock_t_* %4, i64 0, i32 5, !dbg !569
  %30 = load i32, i32* %29, align 8, !dbg !569, !tbaa !570
  %31 = icmp sgt i32 %28, %30, !dbg !571
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !572
  br i1 %31, label %32, label %35, !dbg !572

; <label>:32:                                     ; preds = %26, %22
  %33 = tail call i32 @pthread_mutex_unlock(%struct.pthread_mutex_t_** nonnull %17) #3, !dbg !573
  %34 = tail call i32 @pthread_mutex_unlock(%struct.pthread_mutex_t_** nonnull %13) #3, !dbg !575
  br label %57, !dbg !576

; <label>:35:                                     ; preds = %26
  store i32 0, i32* %9, align 4, !dbg !577, !tbaa !544
  %36 = tail call i32 @pthread_mutex_unlock(%struct.pthread_mutex_t_** nonnull %17) #3, !dbg !579
  %37 = icmp eq i32 %36, 0, !dbg !581
  %38 = tail call i32 @pthread_mutex_unlock(%struct.pthread_mutex_t_** nonnull %13) #3, !dbg !582
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !584
  br i1 %37, label %39, label %65, !dbg !584

; <label>:39:                                     ; preds = %35
  %40 = icmp eq i32 %38, 0, !dbg !585
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !586
  br i1 %40, label %41, label %65, !dbg !586

; <label>:41:                                     ; preds = %39
  store %struct.pthread_rwlock_t_* null, %struct.pthread_rwlock_t_** %0, align 8, !dbg !587, !tbaa !531
  %42 = getelementptr inbounds %struct.pthread_rwlock_t_, %struct.pthread_rwlock_t_* %4, i64 0, i32 2, !dbg !588
  %43 = tail call i32 @pthread_cond_destroy(%struct.pthread_cond_t_** nonnull %42) #3, !dbg !589
  %44 = tail call i32 @pthread_mutex_destroy(%struct.pthread_mutex_t_** nonnull %17) #3, !dbg !590
  %45 = tail call i32 @pthread_mutex_destroy(%struct.pthread_mutex_t_** nonnull %13) #3, !dbg !591
  %46 = bitcast %struct.pthread_rwlock_t_* %4 to i8*, !dbg !592
  tail call void @free(i8* %46) #3, !dbg !593
  br label %57

; <label>:47:                                     ; preds = %6
  %48 = load %struct.uk_mutex*, %struct.uk_mutex** @pte_rwlock_test_init_lock, align 8, !dbg !594, !tbaa !531
  %49 = tail call i32 @pte_osMutexLock(%struct.uk_mutex* %48) #3, !dbg !596
  %50 = load %struct.pthread_rwlock_t_*, %struct.pthread_rwlock_t_** %0, align 8, !dbg !597, !tbaa !531
  %51 = icmp eq %struct.pthread_rwlock_t_* %50, inttoptr (i64 -1 to %struct.pthread_rwlock_t_*), !dbg !599
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !600
  br i1 %51, label %52, label %53, !dbg !600

; <label>:52:                                     ; preds = %47
  store %struct.pthread_rwlock_t_* null, %struct.pthread_rwlock_t_** %0, align 8, !dbg !601, !tbaa !531
  br label %53, !dbg !603

; <label>:53:                                     ; preds = %47, %52
  %54 = phi i32 [ 0, %52 ], [ 16, %47 ], !dbg !604
  store volatile i32 42, i32* @__A_VARIABLE, align 4
  %55 = load %struct.uk_mutex*, %struct.uk_mutex** @pte_rwlock_test_init_lock, align 8, !dbg !606, !tbaa !531
  %56 = tail call i32 @pte_osMutexUnlock(%struct.uk_mutex* %55) #3, !dbg !607
  br label %57

; <label>:57:                                     ; preds = %32, %41, %53
  %58 = phi i32 [ %33, %32 ], [ %43, %41 ], [ %54, %53 ], !dbg !608
  %59 = phi i32 [ %34, %32 ], [ %44, %41 ], [ 0, %53 ], !dbg !608
  %60 = phi i32 [ 16, %32 ], [ %45, %41 ], [ 0, %53 ], !dbg !608
  store volatile i32 42, i32* @__A_VARIABLE, align 4
  %61 = icmp eq i32 %58, 0, !dbg !609
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !610
  %62 = icmp eq i32 %59, 0, !dbg !611
  %63 = select i1 %62, i32 %60, i32 %59, !dbg !612
  %64 = select i1 %61, i32 %63, i32 %58, !dbg !610
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !608
  br label %65, !dbg !613

; <label>:65:                                     ; preds = %39, %35, %12, %8, %1, %3, %57, %20
  %66 = phi i32 [ %18, %20 ], [ %64, %57 ], [ 22, %3 ], [ 22, %1 ], [ 22, %8 ], [ %14, %12 ], [ %36, %35 ], [ %38, %39 ], !dbg !614
...
; Function Attrs: noredzone
declare dso_local i32 @pthread_cond_destroy(%struct.pthread_cond_t_**) local_unnamed_addr #1
...
!1 = !DIFile(filename: "/root/.unikraft/apps/redis/build/libpthread-embedded/origin/pthread-embedded-44b41d760a433915d70a7be9809651b0a65e001d/pthread_rwlock_destroy.c", directory: "/root/.unikraft/apps/redis/build")
!2 = !{!3}
...
!513 = distinct !DISubprogram(name: "pthread_rwlock_destroy", scope: !1, file: !1, line: 51, type: !514, isLocal: false, isDefinition: true, scopeLine: 52, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !517)
!514 = !DISubroutineType(types: !515)
!515 = !{!41, !516}
!516 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !12, size: 64)
!517 = !{!518, !519, !520, !521, !522}
!518 = !DILocalVariable(name: "rwlock", arg: 1, scope: !513, file: !1, line: 51, type: !516)
!519 = !DILocalVariable(name: "rwl", scope: !513, file: !1, line: 53, type: !12)
!520 = !DILocalVariable(name: "result", scope: !513, file: !1, line: 54, type: !41)
!521 = !DILocalVariable(name: "result1", scope: !513, file: !1, line: 54, type: !41)
!522 = !DILocalVariable(name: "result2", scope: !513, file: !1, line: 54, type: !41)
!523 = !DILocation(line: 51, column: 44, scope: !513)
!524 = !DILocation(line: 54, column: 7, scope: !513)
!525 = !DILocation(line: 54, column: 19, scope: !513)
!526 = !DILocation(line: 54, column: 32, scope: !513)
!527 = !DILocation(line: 56, column: 14, scope: !528)
!528 = distinct !DILexicalBlock(scope: !513, file: !1, line: 56, column: 7)
!529 = !DILocation(line: 56, column: 22, scope: !528)
!530 = !DILocation(line: 56, column: 25, scope: !528)
!531 = !{!532, !532, i64 0}
!532 = !{!"any pointer", !533, i64 0}
!533 = !{!"omnipotent char", !534, i64 0}
!534 = !{!"Simple C/C++ TBAA"}
!535 = !DILocation(line: 56, column: 33, scope: !528)
!536 = !DILocation(line: 56, column: 7, scope: !513)
!537 = !DILocation(line: 61, column: 15, scope: !538)
!538 = distinct !DILexicalBlock(scope: !513, file: !1, line: 61, column: 7)
!539 = !DILocation(line: 61, column: 7, scope: !513)
!540 = !DILocation(line: 53, column: 20, scope: !513)
!541 = !DILocation(line: 65, column: 16, scope: !542)
!542 = distinct !DILexicalBlock(scope: !543, file: !1, line: 65, column: 11)
!543 = distinct !DILexicalBlock(scope: !538, file: !1, line: 62, column: 5)
!544 = !{!545, !546, i64 36}
!545 = !{!"pthread_rwlock_t_", !532, i64 0, !532, i64 8, !532, i64 16, !546, i64 24, !546, i64 28, !546, i64 32, !546, i64 36}
!546 = !{!"int", !533, i64 0}
!547 = !DILocation(line: 65, column: 23, scope: !542)
!548 = !DILocation(line: 65, column: 11, scope: !543)
!549 = !DILocation(line: 70, column: 48, scope: !550)
!550 = distinct !DILexicalBlock(scope: !543, file: !1, line: 70, column: 11)
!551 = !DILocation(line: 70, column: 21, scope: !550)
!552 = !DILocation(line: 70, column: 70, scope: !550)
!553 = !DILocation(line: 70, column: 11, scope: !543)
!554 = !DILocation(line: 76, column: 41, scope: !555)
!555 = distinct !DILexicalBlock(scope: !543, file: !1, line: 75, column: 11)
!556 = !DILocation(line: 76, column: 14, scope: !555)
!557 = !DILocation(line: 76, column: 69, scope: !555)
!558 = !DILocation(line: 75, column: 11, scope: !543)
!559 = !DILocation(line: 78, column: 18, scope: !560)
!560 = distinct !DILexicalBlock(scope: !555, file: !1, line: 77, column: 9)
!561 = !DILocation(line: 79, column: 11, scope: !560)
!562 = !DILocation(line: 86, column: 16, scope: !563)
!563 = distinct !DILexicalBlock(scope: !543, file: !1, line: 86, column: 11)
!564 = !{!545, !546, i64 28}
!565 = !DILocation(line: 86, column: 38, scope: !563)
!566 = !DILocation(line: 87, column: 11, scope: !563)
!567 = !DILocation(line: 87, column: 19, scope: !563)
!568 = !{!545, !546, i64 24}
!569 = !DILocation(line: 87, column: 45, scope: !563)
!570 = !{!545, !546, i64 32}
!571 = !DILocation(line: 87, column: 38, scope: !563)
!572 = !DILocation(line: 86, column: 11, scope: !543)
!573 = !DILocation(line: 89, column: 20, scope: !574)
!574 = distinct !DILexicalBlock(scope: !563, file: !1, line: 88, column: 9)
!575 = !DILocation(line: 90, column: 21, scope: !574)
!576 = !DILocation(line: 92, column: 9, scope: !574)
!577 = !DILocation(line: 95, column: 23, scope: !578)
!578 = distinct !DILexicalBlock(scope: !563, file: !1, line: 94, column: 9)
!579 = !DILocation(line: 98, column: 18, scope: !580)
!580 = distinct !DILexicalBlock(scope: !578, file: !1, line: 97, column: 15)
!581 = !DILocation(line: 98, column: 75, scope: !580)
!582 = !DILocation(line: 0, scope: !583)
!583 = distinct !DILexicalBlock(scope: !578, file: !1, line: 104, column: 15)
!584 = !DILocation(line: 97, column: 15, scope: !578)
!585 = !DILocation(line: 105, column: 69, scope: !583)
!586 = !DILocation(line: 104, column: 15, scope: !578)
!587 = !DILocation(line: 110, column: 19, scope: !578)
!588 = !DILocation(line: 111, column: 49, scope: !578)
!589 = !DILocation(line: 111, column: 20, scope: !578)
!590 = !DILocation(line: 112, column: 21, scope: !578)
!591 = !DILocation(line: 113, column: 21, scope: !578)
!592 = !DILocation(line: 114, column: 24, scope: !578)
!593 = !DILocation(line: 114, column: 18, scope: !578)
!594 = !DILocation(line: 123, column: 24, scope: !595)
!595 = distinct !DILexicalBlock(scope: !538, file: !1, line: 118, column: 5)
!596 = !DILocation(line: 123, column: 7, scope: !595)
!597 = !DILocation(line: 128, column: 11, scope: !598)
!598 = distinct !DILexicalBlock(scope: !595, file: !1, line: 128, column: 11)
!599 = !DILocation(line: 128, column: 19, scope: !598)
!600 = !DILocation(line: 128, column: 11, scope: !595)
!601 = !DILocation(line: 136, column: 19, scope: !602)
!602 = distinct !DILexicalBlock(scope: !598, file: !1, line: 129, column: 9)
!603 = !DILocation(line: 137, column: 9, scope: !602)
!604 = !DILocation(line: 0, scope: !605)
!605 = distinct !DILexicalBlock(scope: !598, file: !1, line: 139, column: 9)
!606 = !DILocation(line: 147, column: 25, scope: !595)
!607 = !DILocation(line: 147, column: 7, scope: !595)
!608 = !DILocation(line: 0, scope: !513)
!609 = !DILocation(line: 151, column: 19, scope: !513)
!610 = !DILocation(line: 151, column: 11, scope: !513)
!611 = !DILocation(line: 151, column: 46, scope: !513)
!612 = !DILocation(line: 151, column: 37, scope: !513)
!613 = !DILocation(line: 151, column: 3, scope: !513)
!614 = !DILocation(line: 0, scope: !615)
!615 = distinct !DILexicalBlock(scope: !583, file: !1, line: 106, column: 13)
!616 = !DILocation(line: 0, scope: !617)
!617 = distinct !DILexicalBlock(scope: !528, file: !1, line: 57, column: 5)
!618 = !DILocation(line: 152, column: 1, scope: !513)
