...
; <label>:25:                                     ; preds = %16, %1
  ...
  call void @llvm.lifetime.end.p0i8(i64 1, i8* nonnull %4) #4, !dbg !341
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %6) #4, !dbg !341
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %5) #4, !dbg !341
...
!340 = !DILocation(line: 0, scope: !48)
!341 = !DILocation(line: 32, column: 1, scope: !15)
