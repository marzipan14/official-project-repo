...
; <label>:95:                                     ; preds = %33, %94, %36, %87
  %96 = phi i32 [ 12, %87 ], [ 12, %36 ], [ 0, %94 ], [ 0, %33 ], !dbg !143
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !143
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %14) #5, !dbg !144
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %10) #5, !dbg !144
...
!142 = !DILocation(line: 93, column: 3, scope: !10)
!143 = !DILocation(line: 0, scope: !85)
!144 = !DILocation(line: 94, column: 1, scope: !10)
