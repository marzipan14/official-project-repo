...
; <label>:4:                                      ; preds = %2
  ...
  %6 = icmp eq %struct.pthread_mutexattr_t_* %5, null, !dbg !52
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !53
  br i1 %6, label %11, label %7, !dbg !53

; <label>:7:                                      ; preds = %4
  %8 = icmp ult i32 %1, 2, !dbg !54
...
; <label>:11:                                     ; preds = %7, %2, %4, %9
  %12 = phi i32 [ 0, %9 ], [ 22, %4 ], [ 22, %2 ], [ 22, %7 ], !dbg !63
...
!53 = !DILocation(line: 92, column: 39, scope: !45)
!54 = !DILocation(line: 93, column: 44, scope: !45)
