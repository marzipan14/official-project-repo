...
; Function Attrs: noredzone nounwind
define dso_local i8* @mem_malloc(i64) local_unnamed_addr #1 !dbg !77 {
  %2 = tail call i8* @sys_malloc(i64 %0) #8, !dbg !88
  %3 = icmp eq i8* %2, null, !dbg !90
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !91
  br i1 %3, label %4, label %6, !dbg !91

; <label>:4:                                      ; preds = %1
  %5 = tail call i64 @ukplat_lcpu_save_irqf() #8, !dbg !92
  tail call void @ukplat_lcpu_restore_irqf(i64 %5) #8, !dbg !94
  br label %6, !dbg !95
...
declare dso_local i8* @sys_malloc(i64) local_unnamed_addr #4
...
define internal void @uk_pr_crit(i8*, ...) unnamed_addr #5 !dbg !2 {
  ...
  %3 = bitcast [1 x %struct.__va_list_tag]* %2 to i8*, !dbg !99
  call void @llvm.lifetime.start.p0i8(i64 24, i8* nonnull %3) #7, !dbg !99
  %4 = getelementptr inbounds [1 x %struct.__va_list_tag], [1 x %struct.__va_list_tag]* %2, i64 0, i64 0, !dbg !101
  call void @llvm.va_start(i8* nonnull %3), !dbg !101
  call void @_uk_vprintk(i32 0, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @uk_pr_crit.__str, i64 0, i64 0), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @uk_pr_crit.__str.5, i64 0, i64 0), i32 198, i8* %0, %struct.__va_list_tag* nonnull %4) #8, !dbg !102
  call void @llvm.va_end(i8* nonnull %3), !dbg !105
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %3) #7, !dbg !106
...
; Function Attrs: noredzone nounwind
define dso_local void @mem_free(i8*) local_unnamed_addr #1 !dbg !107 {
  %2 = icmp eq i8* %0, null, !dbg !113
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !116
  br i1 %2, label %3, label %4, !dbg !116

; <label>:3:                                      ; preds = %1
  tail call void (i8*, ...) @uk_pr_crit(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.3, i64 0, i64 0)) #9, !dbg !117
  tail call void (i8*, ...) @uk_pr_crit(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.1, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0)) #9, !dbg !120
  tail call void @ukplat_terminate(i32 3) #10, !dbg !120
  unreachable

; <label>:4:                                      ; preds = %1
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !124
  tail call void @sys_free(i8* nonnull %0) #8, !dbg !126
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !127
  ret void, !dbg !127
}

; Function Attrs: noredzone
declare dso_local void @sys_free(i8*) local_unnamed_addr #4

; Function Attrs: noredzone nounwind
define dso_local i8* @mem_calloc(i64, i64) local_unnamed_addr #1 !dbg !128 {
  %3 = trunc i64 %0 to i32, !dbg !136
  %4 = tail call i8* @sys_calloc(i32 %3, i64 %1) #8, !dbg !137
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !138
  ret i8* %4, !dbg !138
}

; Function Attrs: noredzone
declare dso_local i8* @sys_calloc(i32, i64) local_unnamed_addr #4
...
!97 = !DILocation(line: 220, column: 3, scope: !77)
!98 = !DILocation(line: 194, column: 43, scope: !2)
!99 = !DILocation(line: 196, column: 2, scope: !2)
!100 = !DILocation(line: 196, column: 10, scope: !2)
!101 = !DILocation(line: 197, column: 2, scope: !2)
!102 = !DILocation(line: 198, column: 2, scope: !103)
!103 = distinct !DILexicalBlock(scope: !104, file: !3, line: 198, column: 2)
!104 = distinct !DILexicalBlock(scope: !2, file: !3, line: 198, column: 2)
!105 = !DILocation(line: 199, column: 2, scope: !2)
!106 = !DILocation(line: 200, column: 1, scope: !2)
!107 = distinct !DISubprogram(name: "mem_free", scope: !10, file: !10, line: 228, type: !108, isLocal: false, isDefinition: true, scopeLine: 229, flags: DIFlagPrototyped, isOptimized: true, unit: !9, retainedNodes: !110)
!108 = !DISubroutineType(types: !109)
!109 = !{null, !21}
!110 = !{!111}
!111 = !DILocalVariable(name: "rmem", arg: 1, scope: !107, file: !10, line: 228, type: !21)
!112 = !DILocation(line: 228, column: 16, scope: !107)
!113 = !DILocation(line: 230, column: 3, scope: !114)
!114 = distinct !DILexicalBlock(scope: !115, file: !10, line: 230, column: 3)
!115 = distinct !DILexicalBlock(scope: !107, file: !10, line: 230, column: 3)
!116 = !DILocation(line: 230, column: 3, scope: !115)
!117 = !DILocation(line: 230, column: 3, scope: !118)
!118 = distinct !DILexicalBlock(scope: !119, file: !10, line: 230, column: 3)
!119 = distinct !DILexicalBlock(scope: !114, file: !10, line: 230, column: 3)
!120 = !DILocation(line: 230, column: 3, scope: !121)
!121 = distinct !DILexicalBlock(scope: !122, file: !10, line: 230, column: 3)
!122 = distinct !DILexicalBlock(scope: !123, file: !10, line: 230, column: 3)
!123 = distinct !DILexicalBlock(scope: !118, file: !10, line: 230, column: 3)
!124 = !DILocation(line: 231, column: 3, scope: !125)
!125 = distinct !DILexicalBlock(scope: !107, file: !10, line: 231, column: 3)
!126 = !DILocation(line: 236, column: 3, scope: !107)
!127 = !DILocation(line: 237, column: 1, scope: !107)
!128 = distinct !DISubprogram(name: "mem_calloc", scope: !10, file: !10, line: 982, type: !129, isLocal: false, isDefinition: true, scopeLine: 983, flags: DIFlagPrototyped, isOptimized: true, unit: !9, retainedNodes: !131)
!129 = !DISubroutineType(types: !130)
!130 = !{!21, !65, !65}
!131 = !{!132, !133}
!132 = !DILocalVariable(name: "count", arg: 1, scope: !128, file: !10, line: 982, type: !65)
!133 = !DILocalVariable(name: "size", arg: 2, scope: !128, file: !10, line: 982, type: !65)
!134 = !DILocation(line: 982, column: 23, scope: !128)
!135 = !DILocation(line: 982, column: 41, scope: !128)
!136 = !DILocation(line: 984, column: 26, scope: !128)
!137 = !DILocation(line: 984, column: 10, scope: !128)
!138 = !DILocation(line: 984, column: 3, scope: !128)
