; ModuleID = '/root/.unikraft/apps/redis/build/libpthread-embedded/origin/pthread-embedded-44b41d760a433915d70a7be9809651b0a65e001d/pte_cancellable_wait.c'
source_filename = "/root/.unikraft/apps/redis/build/libpthread-embedded/origin/pthread-embedded-44b41d760a433915d70a7be9809651b0a65e001d/pte_cancellable_wait.c"
...
define dso_local i32 @pte_cancellable_wait(%struct.uk_semaphore*, i32*) local_unnamed_addr #0 !dbg !545 {
  %3 = tail call { i8*, i32 } @pthread_self() #3, !dbg !562
  %4 = extractvalue { i8*, i32 } %3, 0, !dbg !562
  %5 = icmp ne i8* %4, null, !dbg !564
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !566
  br i1 %5, label %6, label %13, !dbg !566

; <label>:6:                                      ; preds = %2
  %7 = getelementptr inbounds i8, i8* %4, i64 88, !dbg !568
  %8 = bitcast i8* %7 to i32*, !dbg !568
  ...
  br i1 %10, label %11, label %13, !dbg !579

; <label>:11:                                     ; preds = %6
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !580
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !582
  %12 = tail call i32 @pte_osSemaphoreCancellablePend(%struct.uk_semaphore* %0, i32* %1) #3, !dbg !583
  br label %15, !dbg !587

; <label>:13:                                     ; preds = %6, %2
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !582
  %14 = tail call i32 @pte_osSemaphorePend(%struct.uk_semaphore* %0, i32* %1) #3, !dbg !588
  br label %15

; <label>:15:                                     ; preds = %13, %11
  %16 = phi i32 [ %12, %11 ], [ %14, %13 ], !dbg !590
...
; <label>:18:                                     ; preds = %15
  ...
  br i1 %5, label %19, label %36, !dbg !595

; <label>:19:                                     ; preds = %18
  %20 = getelementptr inbounds i8, i8* %4, i64 80, !dbg !597
  %21 = bitcast i8* %20 to %struct.pthread_mutex_t_**, !dbg !597
  %22 = tail call i32 @pthread_mutex_lock(%struct.pthread_mutex_t_** nonnull %21) #3, !dbg !600
  %23 = getelementptr inbounds i8, i8* %4, i64 32, !dbg !601
  %24 = bitcast i8* %23 to i32*, !dbg !601
  %25 = load volatile i32, i32* %24, align 8, !dbg !601, !tbaa !603
  %26 = icmp ult i32 %25, 4, !dbg !604
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !605
  br i1 %26, label %27, label %31, !dbg !605

; <label>:27:                                     ; preds = %19
  store volatile i32 4, i32* %24, align 8, !dbg !606, !tbaa !603
  %28 = getelementptr inbounds i8, i8* %4, i64 88, !dbg !608
  %29 = bitcast i8* %28 to i32*, !dbg !608
  store i32 1, i32* %29, align 8, !dbg !609, !tbaa !571
  %30 = tail call i32 @pthread_mutex_unlock(%struct.pthread_mutex_t_** nonnull %21) #3, !dbg !610
  tail call void @pte_throw(i32 2) #3, !dbg !611
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !612
  br label %31, !dbg !612

; <label>:31:                                     ; preds = %27, %19
  %32 = tail call i32 @pthread_mutex_unlock(%struct.pthread_mutex_t_** nonnull %21) #3, !dbg !613
  br label %34, !dbg !614

; <label>:33:                                     ; preds = %15
  br label %34, !dbg !615

; <label>:34:                                     ; preds = %15, %17, %33, %31
  %35 = phi i32 [ 116, %17 ], [ 22, %31 ], [ 22, %33 ], [ %16, %15 ]
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !616
  br label %36, !dbg !618

; <label>:36:                                     ; preds = %34, %18
  %37 = phi i32 [ 22, %18 ], [ %35, %34 ], !dbg !616
...
; Function Attrs: noredzone
declare dso_local i32 @pte_osSemaphoreCancellablePend(%struct.uk_semaphore*, i32*) local_unnamed_addr #1
...
!1 = !DIFile(filename: "/root/.unikraft/apps/redis/build/libpthread-embedded/origin/pthread-embedded-44b41d760a433915d70a7be9809651b0a65e001d/pte_cancellable_wait.c", directory: "/root/.unikraft/apps/redis/build")
!2 = !{!3, !10, !19, !29}
...
!19 = !DICompositeType(tag: DW_TAG_enumeration_type, file: !20, line: 61, baseType: !5, size: 32, elements: !21)
...
!49 = !DIDerivedType(tag: DW_TAG_typedef, name: "pte_thread_t", file: !20, line: 83, baseType: !50)
!50 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "pte_thread_t_", file: !20, line: 85, size: 1536, elements: !51)
!51 = !{!52, !496, !503, !504, !507, !508, !509, !510, !511, !528, !529, !530, !531, !532, !533, !538, !539, !540}
!52 = !DIDerivedType(tag: DW_TAG_member, name: "threadId", scope: !50, file: !20, line: 87, baseType: !53, size: 64)
...
!93 = !{!94, !95, !96}
!94 = !DIDerivedType(tag: DW_TAG_member, name: "waiting", scope: !92, file: !88, line: 36, baseType: !31, size: 32)
...
!125 = !DIDerivedType(tag: DW_TAG_typedef, name: "prio_t", file: !120, line: 53, baseType: !31)
...
!252 = !DIDerivedType(tag: DW_TAG_member, name: "tid", scope: !56, file: !57, line: 72, baseType: !31, size: 32, offset: 832)
...
!258 = !DIDerivedType(tag: DW_TAG_member, name: "_errno", scope: !255, file: !256, line: 571, baseType: !31, size: 32)
...
!267 = !DIDerivedType(tag: DW_TAG_member, name: "_r", scope: !262, file: !256, line: 183, baseType: !31, size: 32, offset: 64)
!268 = !DIDerivedType(tag: DW_TAG_member, name: "_w", scope: !262, file: !256, line: 184, baseType: !31, size: 32, offset: 96)
...
!276 = !DIDerivedType(tag: DW_TAG_member, name: "_size", scope: !273, file: !256, line: 119, baseType: !31, size: 32, offset: 64)
!277 = !DIDerivedType(tag: DW_TAG_member, name: "_lbfsize", scope: !262, file: !256, line: 188, baseType: !31, size: 32, offset: 320)
...
!301 = !DIDerivedType(tag: DW_TAG_member, name: "_ur", scope: !262, file: !256, line: 208, baseType: !31, size: 32, offset: 896)
...
!311 = !DIDerivedType(tag: DW_TAG_member, name: "_blksize", scope: !262, file: !256, line: 218, baseType: !31, size: 32, offset: 1088)
...
!317 = !DIDerivedType(tag: DW_TAG_typedef, name: "_LOCK_RECURSIVE_T", file: !318, line: 12, baseType: !31)
...
!322 = !{!323, !324}
!323 = !DIDerivedType(tag: DW_TAG_member, name: "__count", scope: !321, file: !284, line: 165, baseType: !31, size: 32)
...
!333 = !DIDerivedType(tag: DW_TAG_member, name: "_flags2", scope: !262, file: !256, line: 229, baseType: !31, size: 32, offset: 1376)
...
!336 = !DIDerivedType(tag: DW_TAG_member, name: "_inc", scope: !255, file: !256, line: 578, baseType: !31, size: 32, offset: 256)
...
!341 = !DIDerivedType(tag: DW_TAG_member, name: "_unspecified_locale_info", scope: !255, file: !256, line: 582, baseType: !31, size: 32, offset: 512)
...
!345 = !DIDerivedType(tag: DW_TAG_member, name: "__sdidinit", scope: !255, file: !256, line: 585, baseType: !31, size: 32, offset: 640)
...
!355 = !DIDerivedType(tag: DW_TAG_member, name: "_k", scope: !352, file: !256, line: 50, baseType: !31, size: 32, offset: 64)
!356 = !DIDerivedType(tag: DW_TAG_member, name: "_maxwds", scope: !352, file: !256, line: 50, baseType: !31, size: 32, offset: 96)
!357 = !DIDerivedType(tag: DW_TAG_member, name: "_sign", scope: !352, file: !256, line: 50, baseType: !31, size: 32, offset: 128)
!358 = !DIDerivedType(tag: DW_TAG_member, name: "_wds", scope: !352, file: !256, line: 50, baseType: !31, size: 32, offset: 160)
...
!362 = !DIDerivedType(tag: DW_TAG_member, name: "_result_k", scope: !255, file: !256, line: 591, baseType: !31, size: 32, offset: 832)
...
!366 = !DIDerivedType(tag: DW_TAG_member, name: "_cvtlen", scope: !255, file: !256, line: 596, baseType: !31, size: 32, offset: 1024)
...
!383 = !DIDerivedType(tag: DW_TAG_member, name: "__tm_sec", scope: !381, file: !256, line: 57, baseType: !31, size: 32)
!384 = !DIDerivedType(tag: DW_TAG_member, name: "__tm_min", scope: !381, file: !256, line: 58, baseType: !31, size: 32, offset: 32)
!385 = !DIDerivedType(tag: DW_TAG_member, name: "__tm_hour", scope: !381, file: !256, line: 59, baseType: !31, size: 32, offset: 64)
!386 = !DIDerivedType(tag: DW_TAG_member, name: "__tm_mday", scope: !381, file: !256, line: 60, baseType: !31, size: 32, offset: 96)
!387 = !DIDerivedType(tag: DW_TAG_member, name: "__tm_mon", scope: !381, file: !256, line: 61, baseType: !31, size: 32, offset: 128)
!388 = !DIDerivedType(tag: DW_TAG_member, name: "__tm_year", scope: !381, file: !256, line: 62, baseType: !31, size: 32, offset: 160)
!389 = !DIDerivedType(tag: DW_TAG_member, name: "__tm_wday", scope: !381, file: !256, line: 63, baseType: !31, size: 32, offset: 192)
!390 = !DIDerivedType(tag: DW_TAG_member, name: "__tm_yday", scope: !381, file: !256, line: 64, baseType: !31, size: 32, offset: 224)
!391 = !DIDerivedType(tag: DW_TAG_member, name: "__tm_isdst", scope: !381, file: !256, line: 65, baseType: !31, size: 32, offset: 256)
!392 = !DIDerivedType(tag: DW_TAG_member, name: "_gamma_signgam", scope: !372, file: !256, line: 607, baseType: !31, size: 32, offset: 640)
...
!414 = !DIDerivedType(tag: DW_TAG_member, name: "_getdate_err", scope: !372, file: !256, line: 615, baseType: !31, size: 32, offset: 1344)
...
!420 = !DIDerivedType(tag: DW_TAG_member, name: "_h_errno", scope: !372, file: !256, line: 621, baseType: !31, size: 32, offset: 1696)
...
!435 = !DIDerivedType(tag: DW_TAG_member, name: "_ind", scope: !432, file: !256, line: 95, baseType: !31, size: 32, offset: 64)
...
!462 = !DIDerivedType(tag: DW_TAG_member, name: "_niobs", scope: !458, file: !256, line: 294, baseType: !31, size: 32, offset: 64)
...
!490 = !{!491, !492, !493}
!491 = !DIDerivedType(tag: DW_TAG_member, name: "si_signo", scope: !489, file: !472, line: 69, baseType: !31, size: 32)
!492 = !DIDerivedType(tag: DW_TAG_member, name: "si_code", scope: !489, file: !472, line: 70, baseType: !31, size: 32, offset: 32)
!493 = !DIDerivedType(tag: DW_TAG_member, name: "si_pid", scope: !489, file: !472, line: 71, baseType: !494, size: 32, offset: 64)
!494 = !DIDerivedType(tag: DW_TAG_typedef, name: "pid_t", file: !472, line: 61, baseType: !31)
!495 = !DIDerivedType(tag: DW_TAG_member, name: "list_node", scope: !468, file: !4, line: 124, baseType: !476, size: 128, offset: 512)
!496 = !DIDerivedType(tag: DW_TAG_member, name: "ptHandle", scope: !50, file: !20, line: 88, baseType: !497, size: 128, offset: 64)
!497 = !DIDerivedType(tag: DW_TAG_typedef, name: "pthread_t", file: !30, line: 413, baseType: !498)
!498 = !DIDerivedType(tag: DW_TAG_typedef, name: "pte_handle_t", file: !30, line: 411, baseType: !499)
!499 = distinct !DICompositeType(tag: DW_TAG_structure_type, file: !30, line: 395, size: 128, elements: !500)
!500 = !{!501, !502}
!501 = !DIDerivedType(tag: DW_TAG_member, name: "p", scope: !499, file: !30, line: 398, baseType: !64, size: 64)
!502 = !DIDerivedType(tag: DW_TAG_member, name: "x", scope: !499, file: !30, line: 399, baseType: !5, size: 32, offset: 64)
!503 = !DIDerivedType(tag: DW_TAG_member, name: "prevReuse", scope: !50, file: !20, line: 89, baseType: !48, size: 64, offset: 192)
!504 = !DIDerivedType(tag: DW_TAG_member, name: "state", scope: !50, file: !20, line: 90, baseType: !505, size: 32, offset: 256)
!505 = !DIDerivedType(tag: DW_TAG_volatile_type, baseType: !506)
!506 = !DIDerivedType(tag: DW_TAG_typedef, name: "PThreadState", file: !20, line: 80, baseType: !19)
!507 = !DIDerivedType(tag: DW_TAG_member, name: "exitStatus", scope: !50, file: !20, line: 91, baseType: !64, size: 64, offset: 320)
!508 = !DIDerivedType(tag: DW_TAG_member, name: "parms", scope: !50, file: !20, line: 92, baseType: !64, size: 64, offset: 384)
!509 = !DIDerivedType(tag: DW_TAG_member, name: "ptErrno", scope: !50, file: !20, line: 93, baseType: !31, size: 32, offset: 448)
!510 = !DIDerivedType(tag: DW_TAG_member, name: "detachState", scope: !50, file: !20, line: 94, baseType: !31, size: 32, offset: 480)
!511 = !DIDerivedType(tag: DW_TAG_member, name: "threadLock", scope: !50, file: !20, line: 95, baseType: !512, size: 64, offset: 512)
!512 = !DIDerivedType(tag: DW_TAG_typedef, name: "pthread_mutex_t", file: !30, line: 417, baseType: !513)
!513 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !514, size: 64)
!514 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "pthread_mutex_t_", file: !20, line: 146, size: 320, elements: !515)
!515 = !{!516, !524, !525, !526, !527}
!516 = !DIDerivedType(tag: DW_TAG_member, name: "handle", scope: !514, file: !20, line: 148, baseType: !517, size: 64)
...
!524 = !DIDerivedType(tag: DW_TAG_member, name: "lock_idx", scope: !514, file: !20, line: 149, baseType: !31, size: 32, offset: 64)
!525 = !DIDerivedType(tag: DW_TAG_member, name: "recursive_count", scope: !514, file: !20, line: 156, baseType: !31, size: 32, offset: 96)
!526 = !DIDerivedType(tag: DW_TAG_member, name: "kind", scope: !514, file: !20, line: 159, baseType: !31, size: 32, offset: 128)
!527 = !DIDerivedType(tag: DW_TAG_member, name: "ownerThread", scope: !514, file: !20, line: 160, baseType: !497, size: 128, offset: 192)
!528 = !DIDerivedType(tag: DW_TAG_member, name: "sched_priority", scope: !50, file: !20, line: 96, baseType: !31, size: 32, offset: 576)
!529 = !DIDerivedType(tag: DW_TAG_member, name: "cancelLock", scope: !50, file: !20, line: 97, baseType: !512, size: 64, offset: 640)
!530 = !DIDerivedType(tag: DW_TAG_member, name: "cancelState", scope: !50, file: !20, line: 98, baseType: !31, size: 32, offset: 704)
!531 = !DIDerivedType(tag: DW_TAG_member, name: "cancelType", scope: !50, file: !20, line: 99, baseType: !31, size: 32, offset: 736)
!532 = !DIDerivedType(tag: DW_TAG_member, name: "cancelEvent", scope: !50, file: !20, line: 100, baseType: !31, size: 32, offset: 768)
!533 = !DIDerivedType(tag: DW_TAG_member, name: "start_mark", scope: !50, file: !20, line: 102, baseType: !534, size: 512, offset: 832)
...
!538 = !DIDerivedType(tag: DW_TAG_member, name: "implicit", scope: !50, file: !20, line: 104, baseType: !31, size: 1, offset: 1344, flags: DIFlagBitField, extraData: i64 1344)
!539 = !DIDerivedType(tag: DW_TAG_member, name: "keys", scope: !50, file: !20, line: 106, baseType: !64, size: 64, offset: 1408)
!540 = !DIDerivedType(tag: DW_TAG_member, name: "nextAssoc", scope: !50, file: !20, line: 107, baseType: !64, size: 64, offset: 1472)
...
!545 = distinct !DISubprogram(name: "pte_cancellable_wait", scope: !1, file: !1, line: 50, type: !546, isLocal: false, isDefinition: true, scopeLine: 51, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !549)
!546 = !DISubroutineType(types: !547)
!547 = !{!31, !517, !548}
!548 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !5, size: 64)
!549 = !{!550, !551, !552, !553, !555, !556, !557}
!550 = !DILocalVariable(name: "semHandle", arg: 1, scope: !545, file: !1, line: 50, type: !517)
!551 = !DILocalVariable(name: "timeout", arg: 2, scope: !545, file: !1, line: 50, type: !548)
!552 = !DILocalVariable(name: "result", scope: !545, file: !1, line: 52, type: !31)
!553 = !DILocalVariable(name: "osResult", scope: !545, file: !1, line: 53, type: !554)
!554 = !DIDerivedType(tag: DW_TAG_typedef, name: "pte_osResult", file: !11, line: 60, baseType: !10)
!555 = !DILocalVariable(name: "cancelEnabled", scope: !545, file: !1, line: 54, type: !31)
!556 = !DILocalVariable(name: "self", scope: !545, file: !1, line: 55, type: !497)
!557 = !DILocalVariable(name: "sp", scope: !545, file: !1, line: 56, type: !48)
!558 = !DILocation(line: 50, column: 49, scope: !545)
!559 = !DILocation(line: 50, column: 74, scope: !545)
!560 = !DILocation(line: 52, column: 7, scope: !545)
!561 = !DILocation(line: 54, column: 7, scope: !545)
!562 = !DILocation(line: 58, column: 10, scope: !545)
!563 = !DILocation(line: 55, column: 13, scope: !545)
!564 = !DILocation(line: 61, column: 10, scope: !565)
!565 = distinct !DILexicalBlock(scope: !545, file: !1, line: 61, column: 7)
!566 = !DILocation(line: 61, column: 7, scope: !545)
!567 = !DILocation(line: 56, column: 18, scope: !545)
!568 = !DILocation(line: 66, column: 15, scope: !569)
!569 = distinct !DILexicalBlock(scope: !570, file: !1, line: 66, column: 11)
!570 = distinct !DILexicalBlock(scope: !565, file: !1, line: 62, column: 5)
!571 = !{!572, !577, i64 88}
!572 = !{!"pte_thread_t_", !573, i64 0, !576, i64 8, !573, i64 24, !574, i64 32, !573, i64 40, !573, i64 48, !577, i64 56, !577, i64 60, !573, i64 64, !577, i64 72, !573, i64 80, !577, i64 88, !577, i64 92, !577, i64 96, !574, i64 104, !577, i64 168, !573, i64 176, !573, i64 184}
!573 = !{!"any pointer", !574, i64 0}
!574 = !{!"omnipotent char", !575, i64 0}
!575 = !{!"Simple C/C++ TBAA"}
!576 = !{!"", !573, i64 0, !577, i64 8}
!577 = !{!"int", !574, i64 0}
!578 = !DILocation(line: 66, column: 27, scope: !569)
!579 = !DILocation(line: 66, column: 11, scope: !570)
!580 = !DILocation(line: 69, column: 9, scope: !581)
!581 = distinct !DILexicalBlock(scope: !569, file: !1, line: 67, column: 9)
!582 = !DILocation(line: 73, column: 7, scope: !545)
!583 = !DILocation(line: 75, column: 18, scope: !584)
!584 = distinct !DILexicalBlock(scope: !585, file: !1, line: 74, column: 5)
!585 = distinct !DILexicalBlock(scope: !545, file: !1, line: 73, column: 7)
!586 = !DILocation(line: 53, column: 16, scope: !545)
!587 = !DILocation(line: 76, column: 5, scope: !584)
!588 = !DILocation(line: 79, column: 18, scope: !589)
!589 = distinct !DILexicalBlock(scope: !585, file: !1, line: 78, column: 5)
!590 = !DILocation(line: 0, scope: !589)
!591 = !DILocation(line: 82, column: 3, scope: !545)
!592 = !DILocation(line: 93, column: 7, scope: !593)
!593 = distinct !DILexicalBlock(scope: !594, file: !1, line: 91, column: 5)
!594 = distinct !DILexicalBlock(scope: !545, file: !1, line: 83, column: 5)
!595 = !DILocation(line: 98, column: 11, scope: !596)
!596 = distinct !DILexicalBlock(scope: !594, file: !1, line: 97, column: 5)
!597 = !DILocation(line: 104, column: 43, scope: !598)
!598 = distinct !DILexicalBlock(scope: !599, file: !1, line: 99, column: 9)
!599 = distinct !DILexicalBlock(scope: !596, file: !1, line: 98, column: 11)
!600 = !DILocation(line: 104, column: 18, scope: !598)
!601 = !DILocation(line: 105, column: 19, scope: !602)
!602 = distinct !DILexicalBlock(scope: !598, file: !1, line: 105, column: 15)
!603 = !{!572, !574, i64 32}
!604 = !DILocation(line: 105, column: 25, scope: !602)
!605 = !DILocation(line: 105, column: 15, scope: !598)
!606 = !DILocation(line: 107, column: 25, scope: !607)
!607 = distinct !DILexicalBlock(scope: !602, file: !1, line: 106, column: 13)
!608 = !DILocation(line: 108, column: 19, scope: !607)
!609 = !DILocation(line: 108, column: 31, scope: !607)
!610 = !DILocation(line: 109, column: 22, scope: !607)
!611 = !DILocation(line: 110, column: 15, scope: !607)
!612 = !DILocation(line: 113, column: 13, scope: !607)
!613 = !DILocation(line: 114, column: 18, scope: !598)
!614 = !DILocation(line: 115, column: 9, scope: !598)
!615 = !DILocation(line: 124, column: 5, scope: !594)
!616 = !DILocation(line: 0, scope: !617)
!617 = distinct !DILexicalBlock(scope: !594, file: !1, line: 85, column: 5)
!618 = !DILocation(line: 127, column: 3, scope: !545)
