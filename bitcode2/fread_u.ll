...
define dso_local i64 @_fread_unlocked_r(%struct._reent*, i8* noalias, i64, i64, %struct.__sFILE* noalias) local_unnamed_addr #0 !dbg !18 {
  ...
  br i1 %7, label %115, label %8, !dbg !267
...
; <label>:26:                                     ; preds = %20
  ...
  br i1 %29, label %84, label %104, !dbg !304
...
; <label>:57:                                     ; preds = %31
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !325
  %58 = icmp eq i64 %46, 0, !dbg !326
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !325
  br i1 %58, label %80, label %59, !dbg !325

; <label>:59:                                     ; preds = %56, %57
  %60 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %4, i64 0, i32 5
  %61 = getelementptr inbounds %struct.__sbuf, %struct.__sbuf* %60, i64 0, i32 0
  %62 = bitcast %struct.__sbuf* %60 to i64*
  %63 = bitcast %struct.__sFILE* %4 to i64*
  %64 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %4, i64 0, i32 5, i32 1
  %65 = load i64, i64* %62, align 8, !dbg !327, !tbaa !328
  %66 = load i64, i64* %63, align 8, !dbg !329, !tbaa !303
  %67 = load i32, i32* %64, align 8, !dbg !330, !tbaa !331
  br label %68, !dbg !325

; <label>:68:                                     ; preds = %59, %77
  %69 = phi i64 [ %46, %59 ], [ %75, %77 ]
  %70 = phi i8* [ %45, %59 ], [ %78, %77 ]
  store i8* %70, i8** %61, align 8, !dbg !336, !tbaa !328
  %71 = trunc i64 %69 to i32, !dbg !337
  store i32 %71, i32* %64, align 8, !dbg !338, !tbaa !331
  store i8* %70, i8** %36, align 8, !dbg !339, !tbaa !303
  %72 = tail call i32 @__srefill_r(%struct._reent* %0, %struct.__sFILE* nonnull %4) #3, !dbg !340
  store i64 %65, i64* %62, align 8, !dbg !341, !tbaa !328
  store i32 %67, i32* %64, align 8, !dbg !342, !tbaa !331
  store i64 %66, i64* %63, align 8, !dbg !343, !tbaa !303
  %73 = load i32, i32* %16, align 8, !dbg !344, !tbaa !282
  %74 = sext i32 %73 to i64, !dbg !345
  %75 = sub i64 %69, %74, !dbg !346
  store i32 0, i32* %16, align 8, !dbg !347, !tbaa !282
  %76 = icmp eq i32 %72, 0, !dbg !348
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !350
  br i1 %76, label %77, label %81, !dbg !350

; <label>:77:                                     ; preds = %68
  %78 = getelementptr inbounds i8, i8* %70, i64 %74, !dbg !351
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !352
  store volatile i32 42, i32* @__A_VARIABLE, align 4
  %79 = icmp eq i64 %75, 0, !dbg !326
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !325
  br i1 %79, label %80, label %68, !dbg !325

; <label>:80:                                     ; preds = %77, %57
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !353
  br label %114

; <label>:81:                                     ; preds = %68
  %82 = sub i64 %6, %75, !dbg !354
  %83 = udiv i64 %82, %2, !dbg !356
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !357
  store volatile i32 42, i32* @__A_VARIABLE, align 4
  br label %115

; <label>:84:                                     ; preds = %26, %95
  %85 = phi i8* [ %100, %95 ], [ %30, %26 ]
  %86 = phi i64 [ %98, %95 ], [ %28, %26 ]
  %87 = phi i64 [ %92, %95 ], [ %6, %26 ]
  %88 = phi i8* [ %96, %95 ], [ %1, %26 ]
  %89 = tail call i8* @memcpy(i8* %88, i8* %85, i64 %86) #3, !dbg !358
  %90 = load i8*, i8** %27, align 8, !dbg !360, !tbaa !303
  %91 = getelementptr inbounds i8, i8* %90, i64 %86, !dbg !360
  store i8* %91, i8** %27, align 8, !dbg !360, !tbaa !303
  %92 = sub i64 %87, %86, !dbg !361
  %93 = tail call i32 @__srefill_r(%struct._reent* %0, %struct.__sFILE* nonnull %4) #3, !dbg !362
  %94 = icmp eq i32 %93, 0, !dbg !362
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !364
  br i1 %94, label %95, label %101, !dbg !364, !llvm.loop !365

; <label>:95:                                     ; preds = %84
  %96 = getelementptr inbounds i8, i8* %88, i64 %86, !dbg !367
  %97 = load i32, i32* %16, align 8, !dbg !368, !tbaa !282
  %98 = sext i32 %97 to i64, !dbg !299
  %99 = icmp ugt i64 %92, %98, !dbg !301
  %100 = load i8*, i8** %27, align 8, !dbg !302, !tbaa !303
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !304
  br i1 %99, label %84, label %104, !dbg !304

; <label>:101:                                    ; preds = %84
  %102 = sub i64 %6, %92, !dbg !369
  %103 = udiv i64 %102, %2, !dbg !371
  br label %115, !dbg !372

; <label>:104:                                    ; preds = %95, %26
  %105 = phi i8* [ %1, %26 ], [ %96, %95 ], !dbg !373
  %106 = phi i64 [ %6, %26 ], [ %92, %95 ], !dbg !373
  %107 = phi i8* [ %30, %26 ], [ %100, %95 ], !dbg !302
  %108 = tail call i8* @memcpy(i8* %105, i8* %107, i64 %106) #3, !dbg !374
  %109 = load i32, i32* %16, align 8, !dbg !375, !tbaa !282
  %110 = trunc i64 %106 to i32, !dbg !375
  %111 = sub i32 %109, %110, !dbg !375
  store i32 %111, i32* %16, align 8, !dbg !375, !tbaa !282
  %112 = load i8*, i8** %27, align 8, !dbg !376, !tbaa !303
  %113 = getelementptr inbounds i8, i8* %112, i64 %106, !dbg !376
  store i8* %113, i8** %27, align 8, !dbg !376, !tbaa !303
  br label %114

; <label>:114:                                    ; preds = %80, %104
  store volatile i32 42, i32* @__A_VARIABLE, align 4
  br label %115, !dbg !377

; <label>:115:                                    ; preds = %5, %81, %114, %101
  %116 = phi i64 [ %3, %114 ], [ %83, %81 ], [ %103, %101 ], [ 0, %5 ], !dbg !378
  store volatile i32 42, i32* @__A_VARIABLE, align 4
...
; Function Attrs: noredzone nounwind
define dso_local i64 @fread_unlocked(i8* noalias, i64, i64, %struct.__sFILE* noalias) local_unnamed_addr #0 !dbg !380 {
  %5 = tail call %struct._reent* @__getreent() #3, !dbg !389
  %6 = tail call i64 @_fread_unlocked_r(%struct._reent* %5, i8* %0, i64 %1, i64 %2, %struct.__sFILE* %3) #4, !dbg !390
...
!326 = !DILocation(line: 219, column: 20, scope: !255)
!327 = !DILocation(line: 223, column: 29, scope: !258)
!328 = !{!283, !276, i64 24}
!329 = !DILocation(line: 224, column: 23, scope: !258)
!330 = !DILocation(line: 225, column: 27, scope: !258)
!331 = !{!283, !273, i64 32}
!332 = !DILocation(line: 221, column: 8, scope: !258)
!333 = !DILocation(line: 223, column: 10, scope: !258)
!334 = !DILocation(line: 224, column: 11, scope: !258)
!335 = !DILocation(line: 225, column: 8, scope: !258)
!336 = !DILocation(line: 227, column: 18, scope: !258)
!337 = !DILocation(line: 228, column: 20, scope: !258)
!338 = !DILocation(line: 228, column: 18, scope: !258)
!339 = !DILocation(line: 229, column: 11, scope: !258)
!340 = !DILocation(line: 230, column: 9, scope: !258)
!341 = !DILocation(line: 232, column: 18, scope: !258)
!342 = !DILocation(line: 233, column: 18, scope: !258)
!343 = !DILocation(line: 234, column: 11, scope: !258)
!344 = !DILocation(line: 235, column: 17, scope: !258)
!345 = !DILocation(line: 235, column: 13, scope: !258)
!346 = !DILocation(line: 235, column: 10, scope: !258)
!347 = !DILocation(line: 237, column: 11, scope: !258)
!348 = !DILocation(line: 238, column: 8, scope: !349)
!349 = distinct !DILexicalBlock(scope: !258, file: !19, line: 238, column: 8)
!350 = !DILocation(line: 238, column: 8, scope: !258)
!351 = !DILocation(line: 236, column: 6, scope: !258)
!352 = !DILocation(line: 250, column: 2, scope: !255)
!353 = !DILocation(line: 251, column: 5, scope: !256)
!354 = !DILocation(line: 248, column: 22, scope: !355)
!355 = distinct !DILexicalBlock(scope: !349, file: !19, line: 239, column: 6)
!356 = !DILocation(line: 248, column: 31, scope: !355)
!357 = !DILocation(line: 248, column: 8, scope: !355)
!358 = !DILocation(line: 257, column: 15, scope: !359)
!359 = distinct !DILexicalBlock(scope: !300, file: !19, line: 256, column: 2)
!360 = !DILocation(line: 258, column: 11, scope: !359)
!361 = !DILocation(line: 261, column: 10, scope: !359)
!362 = !DILocation(line: 262, column: 8, scope: !363)
!363 = distinct !DILexicalBlock(scope: !359, file: !19, line: 262, column: 8)
!364 = !DILocation(line: 262, column: 8, scope: !359)
!365 = distinct !{!365, !304, !366}
!366 = !DILocation(line: 275, column: 2, scope: !300)
!367 = !DILocation(line: 260, column: 6, scope: !359)
!368 = !DILocation(line: 255, column: 31, scope: !300)
!369 = !DILocation(line: 273, column: 22, scope: !370)
!370 = distinct !DILexicalBlock(scope: !363, file: !19, line: 263, column: 6)
!371 = !DILocation(line: 273, column: 31, scope: !370)
!372 = !DILocation(line: 273, column: 8, scope: !370)
!373 = !DILocation(line: 0, scope: !359)
!374 = !DILocation(line: 276, column: 18, scope: !300)
!375 = !DILocation(line: 277, column: 14, scope: !300)
!376 = !DILocation(line: 278, column: 14, scope: !300)
!377 = !DILocation(line: 290, column: 3, scope: !18)
!378 = !DILocation(line: 0, scope: !370)
!379 = !DILocation(line: 291, column: 1, scope: !18)
!380 = distinct !DISubprogram(name: "fread_unlocked", scope: !19, file: !19, line: 295, type: !381, isLocal: false, isDefinition: true, scopeLine: 300, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !383)
!381 = !DISubroutineType(types: !382)
!382 = !{!22, !237, !5, !5, !238}
!383 = !{!384, !385, !386, !387}
!384 = !DILocalVariable(name: "buf", arg: 1, scope: !380, file: !19, line: 295, type: !237)
!385 = !DILocalVariable(name: "size", arg: 2, scope: !380, file: !19, line: 295, type: !5)
!386 = !DILocalVariable(name: "count", arg: 3, scope: !380, file: !19, line: 295, type: !5)
!387 = !DILocalVariable(name: "fp", arg: 4, scope: !380, file: !19, line: 295, type: !238)
!388 = !DILocation(line: 295, column: 1, scope: !380)
!389 = !DILocation(line: 301, column: 21, scope: !380)
!390 = !DILocation(line: 301, column: 11, scope: !380)
!391 = !DILocation(line: 301, column: 4, scope: !380)
