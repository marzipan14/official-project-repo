...
; <label>:29:                                     ; preds = %26, %27, %9
  ...
  call void @llvm.lifetime.end.p0i8(i64 176, i8* nonnull %7) #5, !dbg !323
...
define dso_local i32 @_vsniprintf_r(%struct._reent*, i8*, i64, i8*, %struct.__va_list_tag*) local_unnamed_addr #0 !dbg !38 {
  ...
  %7 = bitcast %struct.__sFILE* %6 to i8*, !dbg !326
  call void @llvm.lifetime.start.p0i8(i64 176, i8* nonnull %7) #5, !dbg !326
  %8 = icmp ugt i64 %2, 2147483647, !dbg !327
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !328
  br i1 %8, label %9, label %11, !dbg !328

; <label>:9:                                      ; preds = %5
  %10 = getelementptr inbounds %struct._reent, %struct._reent* %0, i64 0, i32 0, !dbg !329
  store i32 139, i32* %10, align 8, !dbg !330, !tbaa !269
  br label %29, !dbg !331

; <label>:11:                                     ; preds = %5
  %12 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %6, i64 0, i32 3, !dbg !332
  store i16 520, i16* %12, align 8, !dbg !333, !tbaa !281
  %13 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %6, i64 0, i32 0, !dbg !334
  store i8* %1, i8** %13, align 8, !dbg !335, !tbaa !289
  %14 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %6, i64 0, i32 5, i32 0, !dbg !336
  store i8* %1, i8** %14, align 8, !dbg !337, !tbaa !292
  %15 = icmp ne i64 %2, 0, !dbg !338
  %16 = add i64 %2, 4294967295, !dbg !339
  %17 = select i1 %15, i64 %16, i64 0, !dbg !340
  %18 = trunc i64 %17 to i32, !dbg !341
  %19 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %6, i64 0, i32 2, !dbg !342
  store i32 %18, i32* %19, align 4, !dbg !343, !tbaa !299
  %20 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %6, i64 0, i32 5, i32 1, !dbg !344
  store i32 %18, i32* %20, align 8, !dbg !345, !tbaa !302
  %21 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %6, i64 0, i32 4, !dbg !346
  store i16 -1, i16* %21, align 2, !dbg !347, !tbaa !305
  %22 = call i32 @_svfiprintf_r(%struct._reent* %0, %struct.__sFILE* nonnull %6, i8* %3, %struct.__va_list_tag* %4) #4, !dbg !349
  %23 = icmp slt i32 %22, -1, !dbg !351
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !352
  br i1 %23, label %24, label %26, !dbg !352

; <label>:24:                                     ; preds = %11
  %25 = getelementptr inbounds %struct._reent, %struct._reent* %0, i64 0, i32 0, !dbg !353
  store i32 139, i32* %25, align 8, !dbg !354, !tbaa !269
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !355
  br label %26, !dbg !355

; <label>:26:                                     ; preds = %24, %11
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !356
  br i1 %15, label %27, label %29, !dbg !356

; <label>:27:                                     ; preds = %26
  %28 = load i8*, i8** %13, align 8, !dbg !357, !tbaa !289
  store i8 0, i8* %28, align 1, !dbg !358, !tbaa !319
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !359
  br label %29, !dbg !359

; <label>:29:                                     ; preds = %26, %27, %9
  %30 = phi i32 [ -1, %9 ], [ %22, %27 ], [ %22, %26 ], !dbg !360
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !361
  call void @llvm.lifetime.end.p0i8(i64 176, i8* nonnull %7) #5, !dbg !362
...
!323 = !DILocation(line: 72, column: 1, scope: !38, inlinedAt: !261)
!324 = !DILocation(line: 41, column: 3, scope: !10)
!325 = !DILocation(line: 47, column: 1, scope: !38)
!326 = !DILocation(line: 55, column: 3, scope: !38)
!327 = !DILocation(line: 57, column: 12, scope: !264)
!328 = !DILocation(line: 57, column: 7, scope: !38)
!329 = !DILocation(line: 59, column: 12, scope: !267)
!330 = !DILocation(line: 59, column: 19, scope: !267)
!331 = !DILocation(line: 60, column: 7, scope: !267)
!332 = !DILocation(line: 62, column: 5, scope: !38)
!333 = !DILocation(line: 62, column: 12, scope: !38)
!334 = !DILocation(line: 63, column: 19, scope: !38)
!335 = !DILocation(line: 63, column: 22, scope: !38)
!336 = !DILocation(line: 63, column: 9, scope: !38)
!337 = !DILocation(line: 63, column: 15, scope: !38)
!338 = !DILocation(line: 64, column: 30, scope: !38)
!339 = !DILocation(line: 64, column: 41, scope: !38)
!340 = !DILocation(line: 64, column: 25, scope: !38)
!341 = !DILocation(line: 64, column: 24, scope: !38)
!342 = !DILocation(line: 64, column: 19, scope: !38)
!343 = !DILocation(line: 64, column: 22, scope: !38)
!344 = !DILocation(line: 64, column: 9, scope: !38)
!345 = !DILocation(line: 64, column: 15, scope: !38)
!346 = !DILocation(line: 65, column: 5, scope: !38)
!347 = !DILocation(line: 65, column: 11, scope: !38)
!348 = !DILocation(line: 55, column: 8, scope: !38)
!349 = !DILocation(line: 66, column: 9, scope: !38)
!350 = !DILocation(line: 54, column: 7, scope: !38)
!351 = !DILocation(line: 67, column: 11, scope: !310)
!352 = !DILocation(line: 67, column: 7, scope: !38)
!353 = !DILocation(line: 68, column: 10, scope: !310)
!354 = !DILocation(line: 68, column: 17, scope: !310)
!355 = !DILocation(line: 68, column: 5, scope: !310)
!356 = !DILocation(line: 69, column: 7, scope: !38)
!357 = !DILocation(line: 70, column: 8, scope: !317)
!358 = !DILocation(line: 70, column: 11, scope: !317)
!359 = !DILocation(line: 70, column: 5, scope: !317)
!360 = !DILocation(line: 0, scope: !38)
!361 = !DILocation(line: 0, scope: !267)
!362 = !DILocation(line: 72, column: 1, scope: !38)
