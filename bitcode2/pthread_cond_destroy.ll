...
define dso_local i32 @pthread_cond_destroy(%struct.pthread_cond_t_**) local_unnamed_addr #0 !dbg !502 {
  ...
  br i1 %2, label %111, label %3, !dbg !518

; <label>:3:                                      ; preds = %1
  %4 = load %struct.pthread_cond_t_*, %struct.pthread_cond_t_** %0, align 8, !dbg !519, !tbaa !520
  %5 = icmp eq %struct.pthread_cond_t_* %4, null, !dbg !524
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !525
  br i1 %5, label %111, label %6, !dbg !525

; <label>:6:                                      ; preds = %3
  %7 = icmp eq %struct.pthread_cond_t_* %4, inttoptr (i64 -1 to %struct.pthread_cond_t_*), !dbg !526
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !528
  br i1 %7, label %93, label %8, !dbg !528

; <label>:8:                                      ; preds = %6
  %9 = load %struct.uk_mutex*, %struct.uk_mutex** @pte_cond_list_lock, align 8, !dbg !529, !tbaa !520
  %10 = tail call i32 @pte_osMutexLock(%struct.uk_mutex* %9) #3, !dbg !531
  %11 = load %struct.pthread_cond_t_*, %struct.pthread_cond_t_** %0, align 8, !dbg !532, !tbaa !520
  %12 = getelementptr inbounds %struct.pthread_cond_t_, %struct.pthread_cond_t_* %11, i64 0, i32 4, !dbg !534
  %13 = tail call i32 @sem_wait(%struct.sem_t_** nonnull %12) #3, !dbg !536
  %14 = icmp eq i32 %13, 0, !dbg !537
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !538
  br i1 %14, label %18, label %15, !dbg !538

; <label>:15:                                     ; preds = %8
  %16 = tail call i32* @__errno() #3, !dbg !539
  %17 = load i32, i32* %16, align 4, !dbg !539, !tbaa !541
  br label %111, !dbg !543

; <label>:18:                                     ; preds = %8
  %19 = getelementptr inbounds %struct.pthread_cond_t_, %struct.pthread_cond_t_* %11, i64 0, i32 5, !dbg !544
  %20 = tail call i32 @pthread_mutex_trylock(%struct.pthread_mutex_t_** nonnull %19) #3, !dbg !546
  %21 = icmp eq i32 %20, 0, !dbg !547
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !548
  br i1 %21, label %24, label %22, !dbg !548

; <label>:22:                                     ; preds = %18
  %23 = tail call i32 @sem_post(%struct.sem_t_** nonnull %12) #3, !dbg !549
  br label %111, !dbg !551

; <label>:24:                                     ; preds = %18
  %25 = getelementptr inbounds %struct.pthread_cond_t_, %struct.pthread_cond_t_* %11, i64 0, i32 0, !dbg !552
  %26 = load i64, i64* %25, align 8, !dbg !552, !tbaa !554
  %27 = getelementptr inbounds %struct.pthread_cond_t_, %struct.pthread_cond_t_* %11, i64 0, i32 1, !dbg !557
  %28 = load i64, i64* %27, align 8, !dbg !557, !tbaa !558
  %29 = icmp sgt i64 %26, %28, !dbg !559
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !560
  br i1 %29, label %30, label %39, !dbg !560

; <label>:30:                                     ; preds = %24
  %31 = tail call i32 @sem_post(%struct.sem_t_** nonnull %12) #3, !dbg !561
  %32 = icmp eq i32 %31, 0, !dbg !564
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !565
  br i1 %32, label %36, label %33, !dbg !565

; <label>:33:                                     ; preds = %30
  %34 = tail call i32* @__errno() #3, !dbg !566
  %35 = load i32, i32* %34, align 4, !dbg !566, !tbaa !541
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !568
  br label %36, !dbg !568

; <label>:36:                                     ; preds = %30, %33
  %37 = phi i32 [ %35, %33 ], [ 0, %30 ], !dbg !569
  %38 = tail call i32 @pthread_mutex_unlock(%struct.pthread_mutex_t_** nonnull %19) #3, !dbg !570
  br label %87, !dbg !571

; <label>:39:                                     ; preds = %24
  store %struct.pthread_cond_t_* null, %struct.pthread_cond_t_** %0, align 8, !dbg !572, !tbaa !520
  %40 = tail call i32 @sem_destroy(%struct.sem_t_** nonnull %12) #3, !dbg !574
  %41 = icmp eq i32 %40, 0, !dbg !576
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !577
  br i1 %41, label %45, label %42, !dbg !577

; <label>:42:                                     ; preds = %39
  %43 = tail call i32* @__errno() #3, !dbg !578
  %44 = load i32, i32* %43, align 4, !dbg !578, !tbaa !541
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !580
  br label %45, !dbg !580

; <label>:45:                                     ; preds = %39, %42
  %46 = phi i32 [ %44, %42 ], [ 0, %39 ], !dbg !569
  %47 = getelementptr inbounds %struct.pthread_cond_t_, %struct.pthread_cond_t_* %11, i64 0, i32 3, !dbg !581
  %48 = tail call i32 @sem_destroy(%struct.sem_t_** nonnull %47) #3, !dbg !583
  %49 = icmp eq i32 %48, 0, !dbg !584
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !585
  br i1 %49, label %53, label %50, !dbg !585

; <label>:50:                                     ; preds = %45
  %51 = tail call i32* @__errno() #3, !dbg !586
  %52 = load i32, i32* %51, align 4, !dbg !586, !tbaa !541
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !588
  br label %53, !dbg !588

; <label>:53:                                     ; preds = %45, %50
  %54 = phi i32 [ %52, %50 ], [ 0, %45 ], !dbg !589
  %55 = tail call i32 @pthread_mutex_unlock(%struct.pthread_mutex_t_** nonnull %19) #3, !dbg !590
  %56 = icmp eq i32 %55, 0, !dbg !592
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !593
  br i1 %56, label %57, label %59, !dbg !593

; <label>:57:                                     ; preds = %53
  %58 = tail call i32 @pthread_mutex_destroy(%struct.pthread_mutex_t_** nonnull %19) #3, !dbg !594
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !596
  br label %59, !dbg !596

; <label>:59:                                     ; preds = %57, %53
  %60 = phi i32 [ %58, %57 ], [ %55, %53 ], !dbg !597
  %61 = load %struct.pthread_cond_t_*, %struct.pthread_cond_t_** @pte_cond_list_head, align 8, !dbg !598, !tbaa !520
  %62 = icmp eq %struct.pthread_cond_t_* %61, %11, !dbg !600
  %63 = getelementptr inbounds %struct.pthread_cond_t_, %struct.pthread_cond_t_* %11, i64 0, i32 6, !dbg !601
  %64 = bitcast %struct.pthread_cond_t_** %63 to i64*, !dbg !601
  %65 = load i64, i64* %64, align 8, !dbg !601, !tbaa !603
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !604
  br i1 %62, label %66, label %70, !dbg !604

; <label>:66:                                     ; preds = %59
  store i64 %65, i64* bitcast (%struct.pthread_cond_t_** @pte_cond_list_head to i64*), align 8, !dbg !605, !tbaa !520
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !607
  %67 = getelementptr inbounds %struct.pthread_cond_t_, %struct.pthread_cond_t_* %11, i64 0, i32 7
  %68 = bitcast %struct.pthread_cond_t_** %67 to i64*
  %69 = load i64, i64* %68, align 8, !dbg !608, !tbaa !611
  br label %76, !dbg !607

; <label>:70:                                     ; preds = %59
  %71 = getelementptr inbounds %struct.pthread_cond_t_, %struct.pthread_cond_t_* %11, i64 0, i32 7, !dbg !612
  %72 = load %struct.pthread_cond_t_*, %struct.pthread_cond_t_** %71, align 8, !dbg !612, !tbaa !611
  %73 = getelementptr inbounds %struct.pthread_cond_t_, %struct.pthread_cond_t_* %72, i64 0, i32 6, !dbg !613
  %74 = bitcast %struct.pthread_cond_t_** %73 to i64*, !dbg !614
  store i64 %65, i64* %74, align 8, !dbg !614, !tbaa !603
  store volatile i32 42, i32* @__A_VARIABLE, align 4
  %75 = ptrtoint %struct.pthread_cond_t_* %72 to i64
  br label %76

; <label>:76:                                     ; preds = %70, %66
  %77 = phi i64 [ %75, %70 ], [ %69, %66 ], !dbg !608
  %78 = load %struct.pthread_cond_t_*, %struct.pthread_cond_t_** @pte_cond_list_tail, align 8, !dbg !615, !tbaa !520
  %79 = icmp eq %struct.pthread_cond_t_* %78, %11, !dbg !616
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !617
  br i1 %79, label %84, label %80, !dbg !617

; <label>:80:                                     ; preds = %76
  %81 = load %struct.pthread_cond_t_*, %struct.pthread_cond_t_** %63, align 8, !dbg !618, !tbaa !603
  %82 = getelementptr inbounds %struct.pthread_cond_t_, %struct.pthread_cond_t_* %81, i64 0, i32 7, !dbg !619
  %83 = bitcast %struct.pthread_cond_t_** %82 to i64*, !dbg !620
  br label %84

; <label>:84:                                     ; preds = %76, %80
  %85 = phi i64* [ %83, %80 ], [ bitcast (%struct.pthread_cond_t_** @pte_cond_list_tail to i64*), %76 ]
  store i64 %77, i64* %85, align 8, !dbg !621, !tbaa !520
  store volatile i32 42, i32* @__A_VARIABLE, align 4
  %86 = bitcast %struct.pthread_cond_t_* %11 to i8*, !dbg !623
  tail call void @free(i8* %86) #3, !dbg !624
  br label %87

; <label>:87:                                     ; preds = %84, %36
  %88 = phi i32 [ %37, %36 ], [ %46, %84 ], !dbg !625
  %89 = phi i32 [ %38, %36 ], [ %54, %84 ], !dbg !626
  %90 = phi i32 [ 16, %36 ], [ %60, %84 ], !dbg !627
  store volatile i32 42, i32* @__A_VARIABLE, align 4
  %91 = load %struct.uk_mutex*, %struct.uk_mutex** @pte_cond_list_lock, align 8, !dbg !628, !tbaa !520
  %92 = tail call i32 @pte_osMutexUnlock(%struct.uk_mutex* %91) #3, !dbg !629
  br label %103, !dbg !630

; <label>:93:                                     ; preds = %6
  %94 = load %struct.uk_mutex*, %struct.uk_mutex** @pte_cond_test_init_lock, align 8, !dbg !631, !tbaa !520
  %95 = tail call i32 @pte_osMutexLock(%struct.uk_mutex* %94) #3, !dbg !633
  %96 = load %struct.pthread_cond_t_*, %struct.pthread_cond_t_** %0, align 8, !dbg !634, !tbaa !520
  %97 = icmp eq %struct.pthread_cond_t_* %96, inttoptr (i64 -1 to %struct.pthread_cond_t_*), !dbg !636
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !637
  br i1 %97, label %98, label %99, !dbg !637

; <label>:98:                                     ; preds = %93
  store %struct.pthread_cond_t_* null, %struct.pthread_cond_t_** %0, align 8, !dbg !638, !tbaa !520
  br label %99, !dbg !640

; <label>:99:                                     ; preds = %93, %98
  %100 = phi i32 [ 0, %98 ], [ 16, %93 ], !dbg !641
  store volatile i32 42, i32* @__A_VARIABLE, align 4
  %101 = load %struct.uk_mutex*, %struct.uk_mutex** @pte_cond_test_init_lock, align 8, !dbg !643, !tbaa !520
  %102 = tail call i32 @pte_osMutexUnlock(%struct.uk_mutex* %101) #3, !dbg !644
  br label %103

; <label>:103:                                    ; preds = %99, %87
  %104 = phi i32 [ %88, %87 ], [ %100, %99 ], !dbg !589
  %105 = phi i32 [ %89, %87 ], [ 0, %99 ], !dbg !589
  %106 = phi i32 [ %90, %87 ], [ 0, %99 ], !dbg !589
  store volatile i32 42, i32* @__A_VARIABLE, align 4
  %107 = icmp eq i32 %104, 0, !dbg !645
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !646
  %108 = icmp eq i32 %105, 0, !dbg !647
  %109 = select i1 %108, i32 %106, i32 %105, !dbg !648
  %110 = select i1 %107, i32 %109, i32 %104, !dbg !646
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !589
  br label %111, !dbg !649

; <label>:111:                                    ; preds = %1, %3, %103, %22, %15
  %112 = phi i32 [ %17, %15 ], [ %20, %22 ], [ %110, %103 ], [ 22, %3 ], [ 22, %1 ], !dbg !589
...
!523 = !{!"Simple C/C++ TBAA"}
!524 = !DILocation(line: 131, column: 29, scope: !517)
!525 = !DILocation(line: 131, column: 7, scope: !502)
!526 = !DILocation(line: 136, column: 13, scope: !527)
!527 = distinct !DILexicalBlock(scope: !502, file: !1, line: 136, column: 7)
!528 = !DILocation(line: 136, column: 7, scope: !502)
!529 = !DILocation(line: 139, column: 24, scope: !530)
!530 = distinct !DILexicalBlock(scope: !527, file: !1, line: 137, column: 5)
!531 = !DILocation(line: 139, column: 7, scope: !530)
!532 = !DILocation(line: 141, column: 12, scope: !530)
!533 = !DILocation(line: 125, column: 18, scope: !502)
!534 = !DILocation(line: 148, column: 27, scope: !535)
!535 = distinct !DILexicalBlock(scope: !530, file: !1, line: 148, column: 11)
!536 = !DILocation(line: 148, column: 11, scope: !535)
!537 = !DILocation(line: 148, column: 42, scope: !535)
!538 = !DILocation(line: 148, column: 11, scope: !530)
!539 = !DILocation(line: 150, column: 18, scope: !540)
!540 = distinct !DILexicalBlock(scope: !535, file: !1, line: 149, column: 9)
!541 = !{!542, !542, i64 0}
!542 = !{!"int", !522, i64 0}
!543 = !DILocation(line: 150, column: 11, scope: !540)
!544 = !DILocation(line: 158, column: 50, scope: !545)
!545 = distinct !DILexicalBlock(scope: !530, file: !1, line: 158, column: 11)
!546 = !DILocation(line: 158, column: 21, scope: !545)
!547 = !DILocation(line: 158, column: 68, scope: !545)
!548 = !DILocation(line: 158, column: 11, scope: !530)
!549 = !DILocation(line: 160, column: 18, scope: !550)
!550 = distinct !DILexicalBlock(scope: !545, file: !1, line: 159, column: 9)
!551 = !DILocation(line: 161, column: 11, scope: !550)
!552 = !DILocation(line: 167, column: 15, scope: !553)
!553 = distinct !DILexicalBlock(scope: !530, file: !1, line: 167, column: 11)
!554 = !{!555, !556, i64 0}
!555 = !{!"pthread_cond_t_", !556, i64 0, !556, i64 8, !556, i64 16, !521, i64 24, !521, i64 32, !521, i64 40, !521, i64 48, !521, i64 56}
!556 = !{!"long", !522, i64 0}
!557 = !DILocation(line: 167, column: 37, scope: !553)
!558 = !{!555, !556, i64 8}
!559 = !DILocation(line: 167, column: 31, scope: !553)
!560 = !DILocation(line: 167, column: 11, scope: !530)
!561 = !DILocation(line: 169, column: 15, scope: !562)
!562 = distinct !DILexicalBlock(scope: !563, file: !1, line: 169, column: 15)
!563 = distinct !DILexicalBlock(scope: !553, file: !1, line: 168, column: 9)
!564 = !DILocation(line: 169, column: 46, scope: !562)
!565 = !DILocation(line: 169, column: 15, scope: !563)
!566 = !DILocation(line: 171, column: 24, scope: !567)
!567 = distinct !DILexicalBlock(scope: !562, file: !1, line: 170, column: 13)
!568 = !DILocation(line: 172, column: 13, scope: !567)
!569 = !DILocation(line: 0, scope: !545)
!570 = !DILocation(line: 173, column: 21, scope: !563)
!571 = !DILocation(line: 175, column: 9, scope: !563)
!572 = !DILocation(line: 181, column: 17, scope: !573)
!573 = distinct !DILexicalBlock(scope: !553, file: !1, line: 177, column: 9)
!574 = !DILocation(line: 183, column: 15, scope: !575)
!575 = distinct !DILexicalBlock(scope: !573, file: !1, line: 183, column: 15)
!576 = !DILocation(line: 183, column: 49, scope: !575)
!577 = !DILocation(line: 183, column: 15, scope: !573)
!578 = !DILocation(line: 185, column: 24, scope: !579)
!579 = distinct !DILexicalBlock(scope: !575, file: !1, line: 184, column: 13)
!580 = !DILocation(line: 186, column: 13, scope: !579)
!581 = !DILocation(line: 187, column: 34, scope: !582)
!582 = distinct !DILexicalBlock(scope: !573, file: !1, line: 187, column: 15)
!583 = !DILocation(line: 187, column: 15, scope: !582)
!584 = !DILocation(line: 187, column: 50, scope: !582)
!585 = !DILocation(line: 187, column: 15, scope: !573)
!586 = !DILocation(line: 189, column: 25, scope: !587)
!587 = distinct !DILexicalBlock(scope: !582, file: !1, line: 188, column: 13)
!588 = !DILocation(line: 190, column: 13, scope: !587)
!589 = !DILocation(line: 0, scope: !502)
!590 = !DILocation(line: 191, column: 26, scope: !591)
!591 = distinct !DILexicalBlock(scope: !573, file: !1, line: 191, column: 15)
!592 = !DILocation(line: 191, column: 72, scope: !591)
!593 = !DILocation(line: 191, column: 15, scope: !573)
!594 = !DILocation(line: 193, column: 25, scope: !595)
!595 = distinct !DILexicalBlock(scope: !591, file: !1, line: 192, column: 13)
!596 = !DILocation(line: 194, column: 13, scope: !595)
!597 = !DILocation(line: 0, scope: !591)
!598 = !DILocation(line: 198, column: 15, scope: !599)
!599 = distinct !DILexicalBlock(scope: !573, file: !1, line: 198, column: 15)
!600 = !DILocation(line: 198, column: 34, scope: !599)
!601 = !DILocation(line: 0, scope: !602)
!602 = distinct !DILexicalBlock(scope: !599, file: !1, line: 203, column: 13)
!603 = !{!555, !521, i64 48}
!604 = !DILocation(line: 198, column: 15, scope: !573)
!605 = !DILocation(line: 200, column: 34, scope: !606)
!606 = distinct !DILexicalBlock(scope: !599, file: !1, line: 199, column: 13)
!607 = !DILocation(line: 201, column: 13, scope: !606)
!608 = !DILocation(line: 0, scope: !609)
!609 = distinct !DILexicalBlock(scope: !610, file: !1, line: 212, column: 13)
!610 = distinct !DILexicalBlock(scope: !573, file: !1, line: 207, column: 15)
!611 = !{!555, !521, i64 56}
!612 = !DILocation(line: 204, column: 19, scope: !602)
!613 = !DILocation(line: 204, column: 25, scope: !602)
!614 = !DILocation(line: 204, column: 30, scope: !602)
!615 = !DILocation(line: 207, column: 15, scope: !610)
!616 = !DILocation(line: 207, column: 34, scope: !610)
!617 = !DILocation(line: 207, column: 15, scope: !573)
!618 = !DILocation(line: 213, column: 19, scope: !609)
!619 = !DILocation(line: 213, column: 25, scope: !609)
!620 = !DILocation(line: 213, column: 30, scope: !609)
!621 = !DILocation(line: 0, scope: !622)
!622 = distinct !DILexicalBlock(scope: !610, file: !1, line: 208, column: 13)
!623 = !DILocation(line: 216, column: 24, scope: !573)
!624 = !DILocation(line: 216, column: 18, scope: !573)
!625 = !DILocation(line: 0, scope: !579)
!626 = !DILocation(line: 0, scope: !587)
!627 = !DILocation(line: 0, scope: !595)
!628 = !DILocation(line: 219, column: 25, scope: !530)
!629 = !DILocation(line: 219, column: 7, scope: !530)
!630 = !DILocation(line: 221, column: 5, scope: !530)
!631 = !DILocation(line: 228, column: 24, scope: !632)
!632 = distinct !DILexicalBlock(scope: !527, file: !1, line: 223, column: 5)
!633 = !DILocation(line: 228, column: 7, scope: !632)
!634 = !DILocation(line: 233, column: 11, scope: !635)
!635 = distinct !DILexicalBlock(scope: !632, file: !1, line: 233, column: 11)
!636 = !DILocation(line: 233, column: 17, scope: !635)
!637 = !DILocation(line: 233, column: 11, scope: !632)
!638 = !DILocation(line: 241, column: 17, scope: !639)
!639 = distinct !DILexicalBlock(scope: !635, file: !1, line: 234, column: 9)
!640 = !DILocation(line: 242, column: 9, scope: !639)
!641 = !DILocation(line: 0, scope: !642)
!642 = distinct !DILexicalBlock(scope: !635, file: !1, line: 244, column: 9)
!643 = !DILocation(line: 252, column: 25, scope: !632)
!644 = !DILocation(line: 252, column: 7, scope: !632)
!645 = !DILocation(line: 255, column: 19, scope: !502)
!646 = !DILocation(line: 255, column: 11, scope: !502)
!647 = !DILocation(line: 255, column: 46, scope: !502)
!648 = !DILocation(line: 255, column: 37, scope: !502)
!649 = !DILocation(line: 255, column: 3, scope: !502)
!650 = !DILocation(line: 0, scope: !651)
!651 = distinct !DILexicalBlock(scope: !517, file: !1, line: 132, column: 5)
!652 = !DILocation(line: 256, column: 1, scope: !502)
