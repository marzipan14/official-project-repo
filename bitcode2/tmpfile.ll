...
; <label>:5:                                      ; preds = %11, %1
  ...
  br i1 %7, label %23, label %8, !dbg !253
...
; <label>:8:                                      ; preds = %5
  ...
  br i1 %10, label %11, label %15, !dbg !257
...
; <label>:11:                                     ; preds = %8
  ...
  br i1 %13, label %5, label %14, !dbg !269, !llvm.loop !270
...
; <label>:15:                                     ; preds = %8
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !272
  %16 = call %struct.__sFILE* @_fdopen_r(%struct._reent* %0, i32 %9, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i64 0, i64 0)) #5, !dbg !275
  %17 = load i32, i32* %4, align 8, !dbg !277, !tbaa !259
  %18 = icmp eq %struct.__sFILE* %16, null, !dbg !279
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !281
  br i1 %18, label %19, label %21, !dbg !281

; <label>:19:                                     ; preds = %15
  %20 = call i32 @_close_r(%struct._reent* nonnull %0, i32 %9) #5, !dbg !282
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !282
  br label %21, !dbg !282

; <label>:21:                                     ; preds = %15, %19
  %22 = call i32 @_remove_r(%struct._reent* nonnull %0, i8* nonnull %6) #5, !dbg !283
  store i32 %17, i32* %4, align 8, !dbg !284, !tbaa !259
  br label %23, !dbg !285

; <label>:23:                                     ; preds = %5, %21, %14
  %24 = phi %struct.__sFILE* [ null, %14 ], [ %16, %21 ], [ null, %5 ], !dbg !286
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !287
  call void @llvm.lifetime.end.p0i8(i64 1024, i8* nonnull %3) #4, !dbg !288
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !288
  ret %struct.__sFILE* %24, !dbg !288
}
...
; Function Attrs: noredzone nounwind
define dso_local %struct.__sFILE* @tmpfile() local_unnamed_addr #0 !dbg !289 {
  %1 = tail call %struct._reent* @__getreent() #5, !dbg !292
  %2 = tail call %struct.__sFILE* @_tmpfile_r(%struct._reent* %1) #6, !dbg !293
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !294
  ret %struct.__sFILE* %2, !dbg !294
}
...
!272 = !DILocation(line: 77, column: 7, scope: !9)
!273 = !DILocation(line: 78, column: 5, scope: !274)
!274 = distinct !DILexicalBlock(scope: !9, file: !1, line: 77, column: 7)
!275 = !DILocation(line: 79, column: 8, scope: !9)
!276 = !DILocation(line: 63, column: 9, scope: !9)
!277 = !DILocation(line: 80, column: 12, scope: !9)
!278 = !DILocation(line: 64, column: 7, scope: !9)
!279 = !DILocation(line: 81, column: 8, scope: !280)
!280 = distinct !DILexicalBlock(scope: !9, file: !1, line: 81, column: 7)
!281 = !DILocation(line: 81, column: 7, scope: !9)
!282 = !DILocation(line: 82, column: 5, scope: !280)
!283 = !DILocation(line: 83, column: 14, scope: !9)
!284 = !DILocation(line: 84, column: 15, scope: !9)
!285 = !DILocation(line: 85, column: 3, scope: !9)
!286 = !DILocation(line: 0, scope: !9)
!287 = !DILocation(line: 0, scope: !249)
!288 = !DILocation(line: 86, column: 1, scope: !9)
!289 = distinct !DISubprogram(name: "tmpfile", scope: !1, file: !1, line: 91, type: !290, isLocal: false, isDefinition: true, scopeLine: 92, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !2)
!290 = !DISubroutineType(types: !291)
!291 = !{!12}
!292 = !DILocation(line: 93, column: 22, scope: !289)
!293 = !DILocation(line: 93, column: 10, scope: !289)
!294 = !DILocation(line: 93, column: 3, scope: !289)
