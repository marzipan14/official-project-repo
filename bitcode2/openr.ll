; ModuleID = '/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/reent/openr.c'
source_filename = "/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/reent/openr.c"
...
define dso_local i32 @_open_r(%struct._reent* nocapture, i8*, i32, i32) local_unnamed_addr #0 !dbg !7 {
  store i32 0, i32* @errno, align 4, !dbg !237, !tbaa !238
  %5 = tail call i32 (i8*, i32, ...) @open(i8* %1, i32 %2, i32 %3) #3, !dbg !242
  %6 = icmp eq i32 %5, -1, !dbg !245
  %7 = load i32, i32* @errno, align 4, !dbg !246
  %8 = icmp ne i32 %7, 0, !dbg !247
  %9 = and i1 %6, %8, !dbg !248
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !248
  br i1 %9, label %10, label %12, !dbg !248

; <label>:10:                                     ; preds = %4
  %11 = getelementptr inbounds %struct._reent, %struct._reent* %0, i64 0, i32 0, !dbg !249
  store i32 %7, i32* %11, align 8, !dbg !250, !tbaa !251
...
!1 = !DIFile(filename: "/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/reent/openr.c", directory: "/root/.unikraft/apps/redis/build")
!2 = !{}
!3 = !{i32 2, !"Dwarf Version", i32 4}
!4 = !{i32 2, !"Debug Info Version", i32 3}
!5 = !{i32 1, !"wchar_size", i32 4}
!6 = !{!"clang version 7.0.1-8+deb10u2 (tags/RELEASE_701/final)"}
!7 = distinct !DISubprogram(name: "_open_r", scope: !1, file: !1, line: 50, type: !8, isLocal: false, isDefinition: true, scopeLine: 55, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !230)
...
!232 = !DILocalVariable(name: "file", arg: 2, scope: !7, file: !1, line: 50, type: !50)
!233 = !DILocalVariable(name: "flags", arg: 3, scope: !7, file: !1, line: 50, type: !10)
!234 = !DILocalVariable(name: "mode", arg: 4, scope: !7, file: !1, line: 50, type: !10)
!235 = !DILocalVariable(name: "ret", scope: !7, file: !1, line: 56, type: !10)
!236 = !DILocation(line: 50, column: 1, scope: !7)
!237 = !DILocation(line: 58, column: 9, scope: !7)
!238 = !{!239, !239, i64 0}
!239 = !{!"int", !240, i64 0}
!240 = !{!"omnipotent char", !241, i64 0}
!241 = !{!"Simple C/C++ TBAA"}
!242 = !DILocation(line: 59, column: 14, scope: !243)
!243 = distinct !DILexicalBlock(scope: !7, file: !1, line: 59, column: 7)
!244 = !DILocation(line: 56, column: 7, scope: !7)
!245 = !DILocation(line: 59, column: 41, scope: !243)
!246 = !DILocation(line: 59, column: 50, scope: !243)
!247 = !DILocation(line: 59, column: 56, scope: !243)
!248 = !DILocation(line: 59, column: 47, scope: !243)
!249 = !DILocation(line: 60, column: 10, scope: !243)
!250 = !DILocation(line: 60, column: 17, scope: !243)
!251 = !{!252, !239, i64 0}
!252 = !{!"_reent", !239, i64 0, !253, i64 8, !253, i64 16, !253, i64 24, !239, i64 32, !240, i64 36, !239, i64 64, !253, i64 72, !239, i64 80, !253, i64 88, !253, i64 96, !239, i64 104, !253, i64 112, !253, i64 120, !239, i64 128, !253, i64 136, !240, i64 144, !253, i64 504, !254, i64 512, !253, i64 1304, !256, i64 1312, !240, i64 1336}
!253 = !{!"any pointer", !240, i64 0}
!254 = !{!"_atexit", !253, i64 0, !239, i64 8, !240, i64 16, !255, i64 272}
!255 = !{!"_on_exit_args", !240, i64 0, !240, i64 256, !239, i64 512, !239, i64 516}
!256 = !{!"_glue", !253, i64 0, !239, i64 8, !253, i64 16}
!257 = !DILocation(line: 60, column: 5, scope: !243)
!258 = !DILocation(line: 61, column: 3, scope: !7)
