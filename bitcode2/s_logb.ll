...
; <label>:20:                                     ; preds = %18
  ...
  %21 = icmp sgt i32 %5, 0, !dbg !61
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !63
  br i1 %21, label %22, label %38, !dbg !63

; <label>:22:                                     ; preds = %20, %22
  %23 = phi i32 [ %25, %22 ], [ -1043, %20 ]
  %24 = phi i32 [ %26, %22 ], [ %5, %20 ]
  %25 = add nsw i32 %23, -1, !dbg !64
  %26 = shl i32 %24, 1, !dbg !65
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !66
  %27 = icmp sgt i32 %26, 0, !dbg !61
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !63
  br i1 %27, label %22, label %38, !dbg !63, !llvm.loop !67

; <label>:28:                                     ; preds = %18
  %29 = shl nuw nsw i64 %3, 11, !dbg !69
  %30 = trunc i64 %29 to i32, !dbg !69
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !72
  %31 = icmp sgt i32 %30, 0, !dbg !73
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !75
  br i1 %31, label %32, label %38, !dbg !75

; <label>:32:                                     ; preds = %28, %32
  %33 = phi i32 [ %36, %32 ], [ %30, %28 ]
  %34 = phi i32 [ %35, %32 ], [ -1022, %28 ]
  %35 = add nsw i32 %34, -1, !dbg !76
  %36 = shl i32 %33, 1, !dbg !77
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !78
  %37 = icmp sgt i32 %36, 0, !dbg !73
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !75
  br i1 %37, label %32, label %38, !dbg !75, !llvm.loop !79

; <label>:38:                                     ; preds = %32, %22, %28, %20
  %39 = phi i32 [ -1043, %20 ], [ -1022, %28 ], [ %25, %22 ], [ %35, %32 ], !dbg !81
  %40 = sitofp i32 %39 to double, !dbg !82
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !83
  br label %52, !dbg !83

; <label>:41:                                     ; preds = %1
  %42 = icmp ult i32 %6, 2146435072, !dbg !84
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !86
  br i1 %42, label %43, label %47, !dbg !86

; <label>:43:                                     ; preds = %41
  %44 = lshr i32 %6, 20, !dbg !87
  %45 = add nsw i32 %44, -1023, !dbg !88
  %46 = sitofp i32 %45 to double, !dbg !89
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !90
  br label %52, !dbg !90

; <label>:47:                                     ; preds = %41
  %48 = icmp ne i32 %6, 2146435072, !dbg !91
  %49 = icmp ne i32 %5, 0, !dbg !93
  %50 = or i1 %49, %48, !dbg !94
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !94
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !95
  %51 = select i1 %50, double %0, double 0x7FF0000000000000, !dbg !96
  br label %52, !dbg !96

; <label>:52:                                     ; preds = %47, %43, %38, %11
  %53 = phi double [ %17, %11 ], [ %40, %38 ], [ %46, %43 ], [ %51, %47 ], !dbg !95
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !97
  ret double %53, !dbg !97
}
...
!58 = !DILocation(line: 99, column: 12, scope: !59)
!59 = distinct !DILexicalBlock(scope: !60, file: !1, line: 99, column: 7)
!60 = distinct !DILexicalBlock(scope: !55, file: !1, line: 98, column: 13)
!61 = !DILocation(line: 99, column: 26, scope: !62)
!62 = distinct !DILexicalBlock(scope: !59, file: !1, line: 99, column: 7)
!63 = !DILocation(line: 99, column: 7, scope: !59)
!64 = !DILocation(line: 99, column: 41, scope: !62)
!65 = !DILocation(line: 99, column: 32, scope: !62)
!66 = !DILocation(line: 99, column: 7, scope: !62)
!67 = distinct !{!67, !63, !68}
!68 = !DILocation(line: 99, column: 43, scope: !59)
!69 = !DILocation(line: 101, column: 25, scope: !70)
!70 = distinct !DILexicalBlock(scope: !71, file: !1, line: 101, column: 7)
!71 = distinct !DILexicalBlock(scope: !55, file: !1, line: 100, column: 10)
!72 = !DILocation(line: 101, column: 12, scope: !70)
!73 = !DILocation(line: 101, column: 34, scope: !74)
!74 = distinct !DILexicalBlock(scope: !70, file: !1, line: 101, column: 7)
!75 = !DILocation(line: 101, column: 7, scope: !70)
!76 = !DILocation(line: 101, column: 49, scope: !74)
!77 = !DILocation(line: 101, column: 40, scope: !74)
!78 = !DILocation(line: 101, column: 7, scope: !74)
!79 = distinct !{!79, !75, !80}
!80 = !DILocation(line: 101, column: 51, scope: !70)
!81 = !DILocation(line: 0, scope: !70)
!82 = !DILocation(line: 103, column: 13, scope: !37)
!83 = !DILocation(line: 103, column: 6, scope: !37)
!84 = !DILocation(line: 105, column: 13, scope: !85)
!85 = distinct !DILexicalBlock(scope: !38, file: !1, line: 105, column: 11)
!86 = !DILocation(line: 105, column: 11, scope: !38)
!87 = !DILocation(line: 105, column: 36, scope: !85)
!88 = !DILocation(line: 105, column: 41, scope: !85)
!89 = !DILocation(line: 105, column: 33, scope: !85)
!90 = !DILocation(line: 105, column: 26, scope: !85)
!91 = !DILocation(line: 106, column: 13, scope: !92)
!92 = distinct !DILexicalBlock(scope: !85, file: !1, line: 106, column: 11)
!93 = !DILocation(line: 106, column: 28, scope: !92)
!94 = !DILocation(line: 106, column: 25, scope: !92)
!95 = !DILocation(line: 0, scope: !92)
!96 = !DILocation(line: 106, column: 33, scope: !92)
!97 = !DILocation(line: 108, column: 1, scope: !9)
