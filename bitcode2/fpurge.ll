...
; <label>:10:                                     ; preds = %5, %2, %9
  ...
  br i1 %16, label %17, label %21, !dbg !284

; <label>:17:                                     ; preds = %10
  %18 = getelementptr inbounds %struct._reent, %struct._reent* %0, i64 0, i32 0, !dbg !285
  store i32 9, i32* %18, align 8, !dbg !287, !tbaa !288
  %19 = load i32, i32* %3, align 4, !dbg !289, !tbaa !290
  %20 = call i32 @pthread_setcancelstate(i32 %19, i32* nonnull %3) #4, !dbg !289
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !291
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %11) #5, !dbg !292
  br label %51

; <label>:21:                                     ; preds = %10
  %22 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %1, i64 0, i32 5, !dbg !293
  %23 = bitcast %struct.__sbuf* %22 to i64*, !dbg !294
  %24 = load i64, i64* %23, align 8, !dbg !294, !tbaa !295
  %25 = bitcast %struct.__sFILE* %1 to i64*, !dbg !296
  store i64 %24, i64* %25, align 8, !dbg !296, !tbaa !297
  %26 = and i32 %15, 8, !dbg !298
  %27 = icmp eq i32 %26, 0, !dbg !300
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !301
  br i1 %27, label %28, label %38, !dbg !301

; <label>:28:                                     ; preds = %21
  %29 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %1, i64 0, i32 1, !dbg !302
  store i32 0, i32* %29, align 8, !dbg !304, !tbaa !305
  %30 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %1, i64 0, i32 12, i32 0, !dbg !306
  %31 = load i8*, i8** %30, align 8, !dbg !306, !tbaa !308
  %32 = icmp eq i8* %31, null, !dbg !306
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !309
  br i1 %32, label %48, label %33, !dbg !309

; <label>:33:                                     ; preds = %28
  %34 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %1, i64 0, i32 15, i64 0, !dbg !310
  %35 = icmp eq i8* %31, %34, !dbg !310
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !313
  br i1 %35, label %37, label %36, !dbg !313

; <label>:36:                                     ; preds = %33
  call void @free(i8* nonnull %31) #4, !dbg !310
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !310
  br label %37, !dbg !310

; <label>:37:                                     ; preds = %33, %36
  store i8* null, i8** %30, align 8, !dbg !313, !tbaa !308
  br label %47, !dbg !313

; <label>:38:                                     ; preds = %21
  %39 = and i32 %15, 3, !dbg !314
  %40 = icmp eq i32 %39, 0, !dbg !314
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !315
  br i1 %40, label %41, label %44, !dbg !315

; <label>:41:                                     ; preds = %38
  %42 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %1, i64 0, i32 5, i32 1, !dbg !316
  %43 = load i32, i32* %42, align 8, !dbg !316, !tbaa !317
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !315
  br label %44, !dbg !315

; <label>:44:                                     ; preds = %38, %41
  %45 = phi i32 [ %43, %41 ], [ 0, %38 ], !dbg !315
  %46 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %1, i64 0, i32 2, !dbg !318
  store i32 %45, i32* %46, align 4, !dbg !319, !tbaa !320
  br label %47
...
; <label>:48:                                     ; preds = %47, %28
  %49 = load i32, i32* %3, align 4, !dbg !321, !tbaa !290
  %50 = call i32 @pthread_setcancelstate(i32 %49, i32* nonnull %3) #4, !dbg !321
...
; Function Attrs: noredzone nounwind
define dso_local i32 @fpurge(%struct.__sFILE*) local_unnamed_addr #0 !dbg !324 {
  %2 = tail call %struct._reent* @__getreent() #4, !dbg !330
  %3 = tail call i32 @_fpurge_r(%struct._reent* %2, %struct.__sFILE* %0) #6, !dbg !331
...
; Function Attrs: noredzone nounwind
define dso_local void @__fpurge(%struct.__sFILE*) local_unnamed_addr #0 !dbg !333 {
  %2 = tail call %struct._reent* @__getreent() #4, !dbg !339
  %3 = tail call i32 @_fpurge_r(%struct._reent* %2, %struct.__sFILE* %0) #6, !dbg !340
...
!285 = !DILocation(line: 76, column: 12, scope: !286)
!286 = distinct !DILexicalBlock(scope: !283, file: !1, line: 75, column: 5)
!287 = !DILocation(line: 76, column: 19, scope: !286)
!288 = !{!264, !265, i64 0}
!289 = !DILocation(line: 77, column: 7, scope: !286)
!290 = !{!265, !265, i64 0}
!291 = !DILocation(line: 78, column: 7, scope: !286)
!292 = !DILocation(line: 89, column: 3, scope: !29)
!293 = !DILocation(line: 80, column: 16, scope: !258)
!294 = !DILocation(line: 80, column: 20, scope: !258)
!295 = !{!275, !268, i64 24}
!296 = !DILocation(line: 80, column: 10, scope: !258)
!297 = !{!275, !268, i64 0}
!298 = !DILocation(line: 81, column: 10, scope: !299)
!299 = distinct !DILexicalBlock(scope: !258, file: !1, line: 81, column: 7)
!300 = !DILocation(line: 81, column: 19, scope: !299)
!301 = !DILocation(line: 81, column: 7, scope: !258)
!302 = !DILocation(line: 83, column: 11, scope: !303)
!303 = distinct !DILexicalBlock(scope: !299, file: !1, line: 82, column: 5)
!304 = !DILocation(line: 83, column: 14, scope: !303)
!305 = !{!275, !265, i64 8}
!306 = !DILocation(line: 84, column: 11, scope: !307)
!307 = distinct !DILexicalBlock(scope: !303, file: !1, line: 84, column: 11)
!308 = !{!275, !268, i64 88}
!309 = !DILocation(line: 84, column: 11, scope: !303)
!310 = !DILocation(line: 85, column: 2, scope: !311)
!311 = distinct !DILexicalBlock(scope: !312, file: !1, line: 85, column: 2)
!312 = distinct !DILexicalBlock(scope: !307, file: !1, line: 85, column: 2)
!313 = !DILocation(line: 85, column: 2, scope: !312)
!314 = !DILocation(line: 88, column: 16, scope: !299)
!315 = !DILocation(line: 88, column: 14, scope: !299)
!316 = !DILocation(line: 88, column: 50, scope: !299)
!317 = !{!275, !265, i64 32}
!318 = !DILocation(line: 88, column: 9, scope: !299)
!319 = !DILocation(line: 88, column: 12, scope: !299)
!320 = !{!275, !265, i64 12}
!321 = !DILocation(line: 89, column: 3, scope: !258)
!322 = !DILocation(line: 90, column: 3, scope: !29)
!323 = !DILocation(line: 91, column: 1, scope: !29)
!324 = distinct !DISubprogram(name: "fpurge", scope: !1, file: !1, line: 96, type: !325, isLocal: false, isDefinition: true, scopeLine: 98, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !327)
!325 = !DISubroutineType(types: !326)
!326 = !{!5, !248}
!327 = !{!328}
!328 = !DILocalVariable(name: "fp", arg: 1, scope: !324, file: !1, line: 96, type: !248)
!329 = !DILocation(line: 96, column: 1, scope: !324)
!330 = !DILocation(line: 99, column: 21, scope: !324)
!331 = !DILocation(line: 99, column: 10, scope: !324)
!332 = !DILocation(line: 99, column: 3, scope: !324)
!333 = distinct !DISubprogram(name: "__fpurge", scope: !1, file: !1, line: 105, type: !334, isLocal: false, isDefinition: true, scopeLine: 107, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !336)
!334 = !DISubroutineType(types: !335)
!335 = !{null, !248}
!336 = !{!337}
!337 = !DILocalVariable(name: "fp", arg: 1, scope: !333, file: !1, line: 105, type: !248)
!338 = !DILocation(line: 105, column: 1, scope: !333)
!339 = !DILocation(line: 108, column: 14, scope: !333)
!340 = !DILocation(line: 108, column: 3, scope: !333)
!341 = !DILocation(line: 109, column: 1, scope: !333)
