...
define dso_local i32 @pthread_cond_init(%struct.pthread_cond_t_**, %struct.pthread_condattr_t_** readonly) local_unnamed_addr #0 !dbg !518 {
  ...
  br i1 %3, label %78, label %4, !dbg !542
...
; <label>:9:                                      ; preds = %6
  ...
  br i1 %12, label %47, label %13, !dbg !558
...
; <label>:13:                                     ; preds = %6, %4, %9
  ...
  br i1 %16, label %47, label %17, !dbg !563
...
; <label>:36:                                     ; preds = %28
  ...
  br i1 %40, label %41, label %42, !dbg !593
...
; <label>:42:                                     ; preds = %36
  %43 = tail call i32 @sem_destroy(%struct.sem_t_** nonnull %30) #3, !dbg !596
  br label %44, !dbg !597

; <label>:44:                                     ; preds = %42, %33
  %45 = phi i32 [ %35, %33 ], [ %39, %42 ], !dbg !598
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !599
  %46 = tail call i32 @sem_destroy(%struct.sem_t_** nonnull %22) #3, !dbg !600
  br label %50, !dbg !601

; <label>:47:                                     ; preds = %13, %9
  %48 = phi i32 [ 88, %9 ], [ 12, %13 ]
  %49 = phi %struct.pthread_cond_t_* [ null, %9 ], [ %15, %13 ]
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !602
  br label %72, !dbg !595

; <label>:50:                                     ; preds = %25, %44
  %51 = phi i32 [ %27, %25 ], [ %45, %44 ], !dbg !599
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !604
  tail call void @free(i8* nonnull %14) #3, !dbg !605
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !606
  %52 = icmp eq i32 %51, 0, !dbg !607
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !595
  br i1 %52, label %53, label %75, !dbg !595

; <label>:53:                                     ; preds = %41, %50
  %54 = phi %struct.pthread_cond_t_* [ %15, %41 ], [ null, %50 ]
  %55 = load %struct.uk_mutex*, %struct.uk_mutex** @pte_cond_list_lock, align 8, !dbg !609, !tbaa !547
  %56 = tail call i32 @pte_osMutexLock(%struct.uk_mutex* %55) #3, !dbg !611
  %57 = getelementptr inbounds %struct.pthread_cond_t_, %struct.pthread_cond_t_* %54, i64 0, i32 6, !dbg !612
  store %struct.pthread_cond_t_* null, %struct.pthread_cond_t_** %57, align 8, !dbg !613, !tbaa !614
  %58 = load i64, i64* bitcast (%struct.pthread_cond_t_** @pte_cond_list_tail to i64*), align 8, !dbg !615, !tbaa !547
  %59 = getelementptr inbounds %struct.pthread_cond_t_, %struct.pthread_cond_t_* %54, i64 0, i32 7, !dbg !616
  %60 = bitcast %struct.pthread_cond_t_** %59 to i64*, !dbg !617
  store i64 %58, i64* %60, align 8, !dbg !617, !tbaa !618
  %61 = icmp eq i64 %58, 0, !dbg !619
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !621
  br i1 %61, label %65, label %62, !dbg !621

; <label>:62:                                     ; preds = %53
  %63 = inttoptr i64 %58 to %struct.pthread_cond_t_*, !dbg !622
  %64 = getelementptr inbounds %struct.pthread_cond_t_, %struct.pthread_cond_t_* %63, i64 0, i32 6, !dbg !623
  store %struct.pthread_cond_t_* %54, %struct.pthread_cond_t_** %64, align 8, !dbg !625, !tbaa !614
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !626
  br label %65, !dbg !626

; <label>:65:                                     ; preds = %53, %62
  store %struct.pthread_cond_t_* %54, %struct.pthread_cond_t_** @pte_cond_list_tail, align 8, !dbg !627, !tbaa !547
  %66 = load %struct.pthread_cond_t_*, %struct.pthread_cond_t_** @pte_cond_list_head, align 8, !dbg !628, !tbaa !547
  %67 = icmp eq %struct.pthread_cond_t_* %66, null, !dbg !630
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !631
  br i1 %67, label %68, label %69, !dbg !631

; <label>:68:                                     ; preds = %65
  store %struct.pthread_cond_t_* %54, %struct.pthread_cond_t_** @pte_cond_list_head, align 8, !dbg !632, !tbaa !547
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !634
  br label %69, !dbg !634

; <label>:69:                                     ; preds = %68, %65
  %70 = load %struct.uk_mutex*, %struct.uk_mutex** @pte_cond_list_lock, align 8, !dbg !635, !tbaa !547
  %71 = tail call i32 @pte_osMutexUnlock(%struct.uk_mutex* %70) #3, !dbg !636
  br label %72, !dbg !637

; <label>:72:                                     ; preds = %69, %47
  %73 = phi %struct.pthread_cond_t_* [ %54, %69 ], [ %49, %47 ]
  %74 = phi i32 [ 0, %69 ], [ %48, %47 ]
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !638
  br label %75, !dbg !639

; <label>:75:                                     ; preds = %72, %50
  %76 = phi %struct.pthread_cond_t_* [ null, %50 ], [ %73, %72 ]
  %77 = phi i32 [ %51, %50 ], [ %74, %72 ]
  store %struct.pthread_cond_t_* %76, %struct.pthread_cond_t_** %0, align 8, !dbg !639, !tbaa !547
  br label %78, !dbg !640

; <label>:78:                                     ; preds = %2, %75
  %79 = phi i32 [ %77, %75 ], [ 22, %2 ], !dbg !604
...
!594 = !DILocation(line: 129, column: 3, scope: !518)
!595 = !DILocation(line: 147, column: 7, scope: !518)
!596 = !DILocation(line: 137, column: 10, scope: !518)
!597 = !DILocation(line: 137, column: 3, scope: !518)
!598 = !DILocation(line: 0, scope: !590)
!599 = !DILocation(line: 0, scope: !587)
!600 = !DILocation(line: 140, column: 10, scope: !518)
!601 = !DILocation(line: 140, column: 3, scope: !518)
!602 = !DILocation(line: 0, scope: !603)
!603 = distinct !DILexicalBlock(scope: !562, file: !1, line: 101, column: 5)
!604 = !DILocation(line: 0, scope: !518)
!605 = !DILocation(line: 143, column: 10, scope: !518)
!606 = !DILocation(line: 144, column: 3, scope: !518)
!607 = !DILocation(line: 147, column: 9, scope: !608)
!608 = distinct !DILexicalBlock(scope: !518, file: !1, line: 147, column: 7)
!609 = !DILocation(line: 150, column: 24, scope: !610)
!610 = distinct !DILexicalBlock(scope: !608, file: !1, line: 148, column: 5)
!611 = !DILocation(line: 150, column: 7, scope: !610)
!612 = !DILocation(line: 152, column: 11, scope: !610)
!613 = !DILocation(line: 152, column: 16, scope: !610)
!614 = !{!567, !548, i64 48}
!615 = !DILocation(line: 153, column: 18, scope: !610)
!616 = !DILocation(line: 153, column: 11, scope: !610)
!617 = !DILocation(line: 153, column: 16, scope: !610)
!618 = !{!567, !548, i64 56}
!619 = !DILocation(line: 155, column: 30, scope: !620)
!620 = distinct !DILexicalBlock(scope: !610, file: !1, line: 155, column: 11)
!621 = !DILocation(line: 155, column: 11, scope: !610)
!622 = !DILocation(line: 155, column: 11, scope: !620)
!623 = !DILocation(line: 157, column: 31, scope: !624)
!624 = distinct !DILexicalBlock(scope: !620, file: !1, line: 156, column: 9)
!625 = !DILocation(line: 157, column: 36, scope: !624)
!626 = !DILocation(line: 158, column: 9, scope: !624)
!627 = !DILocation(line: 160, column: 26, scope: !610)
!628 = !DILocation(line: 162, column: 11, scope: !629)
!629 = distinct !DILexicalBlock(scope: !610, file: !1, line: 162, column: 11)
!630 = !DILocation(line: 162, column: 30, scope: !629)
!631 = !DILocation(line: 162, column: 11, scope: !610)
!632 = !DILocation(line: 164, column: 30, scope: !633)
!633 = distinct !DILexicalBlock(scope: !629, file: !1, line: 163, column: 9)
!634 = !DILocation(line: 165, column: 9, scope: !633)
!635 = !DILocation(line: 167, column: 25, scope: !610)
!636 = !DILocation(line: 167, column: 7, scope: !610)
!637 = !DILocation(line: 168, column: 5, scope: !610)
!638 = !DILocation(line: 0, scope: !610)
!639 = !DILocation(line: 170, column: 9, scope: !518)
!640 = !DILocation(line: 172, column: 3, scope: !518)
!641 = !DILocation(line: 0, scope: !642)
!642 = distinct !DILexicalBlock(scope: !541, file: !1, line: 83, column: 5)
!643 = !DILocation(line: 174, column: 1, scope: !518)
