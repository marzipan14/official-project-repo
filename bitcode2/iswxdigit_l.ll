...
define dso_local i32 @iswxdigit_l(i32, %struct.__locale_t* nocapture readnone) local_unnamed_addr #0 !dbg !11 {
  ...
  br i1 %4, label %12, label %5, !dbg !23

; <label>:5:                                      ; preds = %2
  %6 = add i32 %0, -97, !dbg !24
  %7 = icmp ult i32 %6, 6, !dbg !24
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !24
  br i1 %7, label %12, label %8, !dbg !24

; <label>:8:                                      ; preds = %5
  %9 = add i32 %0, -65, !dbg !25
  %10 = icmp ult i32 %9, 6, !dbg !25
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !25
  %11 = zext i1 %10 to i32, !dbg !25
  br label %12, !dbg !25

; <label>:12:                                     ; preds = %8, %5, %2
  %13 = phi i32 [ 1, %2 ], [ 1, %5 ], [ %11, %8 ]
...
!24 = !DILocation(line: 8, column: 22, scope: !11)
!25 = !DILocation(line: 9, column: 22, scope: !11)
