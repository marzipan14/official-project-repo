...
; <label>:29:                                     ; preds = %25
  ...
  store volatile i32 42, i32* @__A_VARIABLE, align 4
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !38
  br i1 %31, label %33, label %25, !dbg !38
...
; <label>:33:                                     ; preds = %29, %16
  %34 = phi i8* [ %14, %16 ], [ %27, %29 ]
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !48
  %35 = icmp eq i8* %34, %0, !dbg !49
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !50
  br i1 %35, label %39, label %36, !dbg !50

; <label>:36:                                     ; preds = %33
  store i8 0, i8* %34, align 1, !dbg !51, !tbaa !22
  br label %37, !dbg !50

; <label>:37:                                     ; preds = %36, %32
  %38 = phi i8* [ getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), %32 ], [ %0, %36 ]
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !52
  br label %39, !dbg !53

; <label>:39:                                     ; preds = %18, %33, %37, %1, %3
  %40 = phi i8* [ getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), %3 ], [ getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), %1 ], [ getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i64 0, i64 0), %33 ], [ %38, %37 ], [ %0, %18 ], !dbg !52
...
!30 = !DILocation(line: 19, column: 2, scope: !9)
!31 = !DILocation(line: 0, scope: !32)
!32 = distinct !DILexicalBlock(scope: !9, file: !1, line: 19, column: 21)
...
!40 = distinct !DILexicalBlock(scope: !32, file: !1, line: 20, column: 7)
!41 = !DILocation(line: 20, column: 7, scope: !32)
!42 = !DILocation(line: 22, column: 8, scope: !32)
...
!48 = !DILocation(line: 27, column: 3, scope: !9)
!49 = !DILocation(line: 28, column: 5, scope: !9)
!50 = !DILocation(line: 28, column: 3, scope: !9)
!51 = !DILocation(line: 29, column: 7, scope: !9)
!52 = !DILocation(line: 0, scope: !9)
!53 = !DILocation(line: 26, column: 2, scope: !9)
!54 = !DILocation(line: 0, scope: !19)
!55 = !DILocation(line: 30, column: 1, scope: !9)
