...
; <label>:14:                                     ; preds = %6
  %15 = add nsw i32 %11, %9, !dbg !47
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !48
  store volatile i32 42, i32* @__A_VARIABLE, align 4
  %16 = load i32, i32* %8, align 4, !dbg !49, !tbaa !36
  %17 = icmp eq i32 %16, 0, !dbg !49
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !50
  br i1 %17, label %22, label %18, !dbg !50

; <label>:18:                                     ; preds = %14
  %19 = getelementptr inbounds i32, i32* %8, i64 1, !dbg !51
  %20 = add i64 %7, -1, !dbg !52
  %21 = icmp eq i64 %20, 0, !dbg !53
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !54
  br i1 %21, label %22, label %6, !dbg !54, !llvm.loop !55

; <label>:22:                                     ; preds = %14, %18, %2, %13
  %23 = phi i32 [ -1, %13 ], [ 0, %2 ], [ %15, %18 ], [ %15, %14 ], !dbg !58
  store volatile i32 42, i32* @__A_VARIABLE, align 4
...
!46 = !DILocation(line: 69, column: 7, scope: !42)
!47 = !DILocation(line: 70, column: 9, scope: !26)
!48 = !DILocation(line: 71, column: 3, scope: !7)
!49 = !DILocation(line: 71, column: 12, scope: !7)
!50 = !DILocation(line: 71, column: 20, scope: !7)
!51 = !DILocation(line: 71, column: 17, scope: !7)
!52 = !DILocation(line: 71, column: 23, scope: !7)
!53 = !DILocation(line: 71, column: 27, scope: !7)
!54 = !DILocation(line: 71, column: 3, scope: !26)
!55 = distinct !{!55, !56, !57}
!56 = !DILocation(line: 51, column: 3, scope: !7)
!57 = !DILocation(line: 71, column: 30, scope: !7)
!58 = !DILocation(line: 0, scope: !42)
!59 = !DILocation(line: 73, column: 1, scope: !7)
