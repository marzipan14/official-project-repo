...
; <label>:29:                                     ; preds = %24, %22
  ...
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !282
  %31 = icmp eq i32 %30, 10, !dbg !292
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !279
  br i1 %31, label %42, label %32, !dbg !279

; <label>:32:                                     ; preds = %29
  %33 = icmp eq i32 %30, -1, !dbg !293
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !294
  br i1 %33, label %34, label %39, !dbg !294

; <label>:34:                                     ; preds = %32
  %35 = icmp eq i8* %18, %1, !dbg !295
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !297
  br i1 %35, label %36, label %42, !dbg !297

; <label>:36:                                     ; preds = %34
  %37 = load i32, i32* %3, align 4, !dbg !298, !tbaa !300
  %38 = call i32 @pthread_setcancelstate(i32 %37, i32* nonnull %3) #4, !dbg !298
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !301
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %13) #5, !dbg !302
  br label %45

; <label>:39:                                     ; preds = %32
  %40 = trunc i32 %30 to i8, !dbg !303
  %41 = getelementptr inbounds i8, i8* %18, i64 1, !dbg !304
  store i8 %40, i8* %18, align 1, !dbg !305, !tbaa !290
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !279
  br label %17, !dbg !279, !llvm.loop !306

; <label>:42:                                     ; preds = %29, %34
  store i8 0, i8* %18, align 1, !dbg !308, !tbaa !290
  %43 = load i32, i32* %3, align 4, !dbg !309, !tbaa !300
  %44 = call i32 @pthread_setcancelstate(i32 %43, i32* nonnull %3) #4, !dbg !309
...
; <label>:45:                                     ; preds = %36, %42
  %46 = phi i8* [ %1, %42 ], [ null, %36 ], !dbg !311
  store volatile i32 42, i32* @__A_VARIABLE, align 4
...
; Function Attrs: noredzone nounwind
define dso_local i8* @gets(i8*) local_unnamed_addr #0 !dbg !313 {
  %2 = tail call %struct._reent* @__getreent() #4, !dbg !319
  %3 = tail call i8* @_gets_r(%struct._reent* %2, i8* %0) #6, !dbg !320
...
!292 = !DILocation(line: 88, column: 36, scope: !260)
!293 = !DILocation(line: 89, column: 11, scope: !281)
!294 = !DILocation(line: 89, column: 9, scope: !260)
!295 = !DILocation(line: 90, column: 13, scope: !296)
!296 = distinct !DILexicalBlock(scope: !281, file: !1, line: 90, column: 11)
!297 = !DILocation(line: 90, column: 11, scope: !281)
!298 = !DILocation(line: 92, column: 4, scope: !299)
!299 = distinct !DILexicalBlock(scope: !296, file: !1, line: 91, column: 2)
!300 = !{!266, !266, i64 0}
!301 = !DILocation(line: 93, column: 4, scope: !299)
!302 = !DILocation(line: 100, column: 3, scope: !26)
!303 = !DILocation(line: 98, column: 14, scope: !281)
!304 = !DILocation(line: 98, column: 9, scope: !281)
!305 = !DILocation(line: 98, column: 12, scope: !281)
!306 = distinct !{!306, !279, !307}
!307 = !DILocation(line: 98, column: 14, scope: !260)
!308 = !DILocation(line: 99, column: 6, scope: !260)
!309 = !DILocation(line: 100, column: 3, scope: !260)
!310 = !DILocation(line: 101, column: 3, scope: !26)
!311 = !DILocation(line: 0, scope: !299)
!312 = !DILocation(line: 102, column: 1, scope: !26)
!313 = distinct !DISubprogram(name: "gets", scope: !1, file: !1, line: 107, type: !314, isLocal: false, isDefinition: true, scopeLine: 109, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !316)
!314 = !DISubroutineType(types: !315)
!315 = !{!29, !29}
!316 = !{!317}
!317 = !DILocalVariable(name: "buf", arg: 1, scope: !313, file: !1, line: 107, type: !29)
!318 = !DILocation(line: 107, column: 1, scope: !313)
!319 = !DILocation(line: 110, column: 19, scope: !313)
!320 = !DILocation(line: 110, column: 10, scope: !313)
!321 = !DILocation(line: 110, column: 3, scope: !313)
