...
; <label>:29:                                     ; preds = %27, %24
  ...
  call void @llvm.lifetime.end.p0i8(i64 10, i8* nonnull %6) #4, !dbg !351
...
; Function Attrs: noredzone nounwind
define dso_local i64 @wcrtomb(i8* noalias, i32, %struct._mbstate_t* noalias) local_unnamed_addr #0 !dbg !352 {
  %4 = alloca [10 x i8], align 1
  %5 = tail call %struct._reent* @__getreent() #5, !dbg !366
  %6 = getelementptr inbounds [10 x i8], [10 x i8]* %4, i64 0, i64 0, !dbg !368
  call void @llvm.lifetime.start.p0i8(i64 10, i8* nonnull %6) #4, !dbg !368
  %7 = icmp eq i8* %0, null, !dbg !370
  %8 = tail call %struct._reent* @__getreent() #5, !dbg !372
  %9 = getelementptr inbounds %struct._reent, %struct._reent* %8, i64 0, i32 7, !dbg !374
  %10 = load %struct.__locale_t*, %struct.__locale_t** %9, align 8, !dbg !374, !tbaa !314
  %11 = icmp eq %struct.__locale_t* %10, null, !dbg !372
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !372
  br i1 %11, label %12, label %13, !dbg !372
...
; <label>:13:                                     ; preds = %3, %12
  %14 = phi %struct.__locale_t* [ @__global_locale, %12 ], [ %10, %3 ], !dbg !372
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !377
  %15 = getelementptr inbounds %struct.__locale_t, %struct.__locale_t* %14, i64 0, i32 1, !dbg !378
  %16 = load i32 (%struct._reent*, i8*, i32, %struct._mbstate_t*)*, i32 (%struct._reent*, i8*, i32, %struct._mbstate_t*)** %15, align 8, !dbg !378, !tbaa !328
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !379
  br i1 %7, label %17, label %19, !dbg !379

; <label>:17:                                     ; preds = %13
  %18 = call i32 %16(%struct._reent* %5, i8* nonnull %6, i32 0, %struct._mbstate_t* %2) #5, !dbg !380
  br label %21, !dbg !381

; <label>:19:                                     ; preds = %13
  %20 = tail call i32 %16(%struct._reent* %5, i8* nonnull %0, i32 %1, %struct._mbstate_t* %2) #5, !dbg !382
  br label %21

; <label>:21:                                     ; preds = %19, %17
  %22 = phi i32 [ %18, %17 ], [ %20, %19 ], !dbg !378
  store volatile i32 42, i32* @__A_VARIABLE, align 4
  %23 = icmp eq i32 %22, -1, !dbg !383
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !385
  br i1 %23, label %24, label %27, !dbg !385

; <label>:24:                                     ; preds = %21
  %25 = getelementptr inbounds %struct._mbstate_t, %struct._mbstate_t* %2, i64 0, i32 0, !dbg !386
  store i32 0, i32* %25, align 4, !dbg !388, !tbaa !341
  %26 = getelementptr inbounds %struct._reent, %struct._reent* %5, i64 0, i32 0, !dbg !389
  store i32 138, i32* %26, align 8, !dbg !390, !tbaa !345
  br label %29, !dbg !391

; <label>:27:                                     ; preds = %21
  %28 = sext i32 %22 to i64, !dbg !392
  br label %29, !dbg !393

; <label>:29:                                     ; preds = %27, %24
  %30 = phi i64 [ -1, %24 ], [ %28, %27 ], !dbg !394
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !395
  call void @llvm.lifetime.end.p0i8(i64 10, i8* nonnull %6) #4, !dbg !396
...
!350 = !DILocation(line: 0, scope: !339)
!351 = !DILocation(line: 40, column: 1, scope: !14)
!352 = distinct !DISubprogram(name: "wcrtomb", scope: !1, file: !1, line: 44, type: !353, isLocal: false, isDefinition: true, scopeLine: 48, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !357)
!353 = !DISubroutineType(types: !354)
!354 = !{!17, !355, !126, !356}
!355 = !DIDerivedType(tag: DW_TAG_restrict_type, baseType: !51)
!356 = !DIDerivedType(tag: DW_TAG_restrict_type, baseType: !127)
!357 = !{!358, !359, !360, !361, !362, !363}
!358 = !DILocalVariable(name: "s", arg: 1, scope: !352, file: !1, line: 44, type: !355)
!359 = !DILocalVariable(name: "wc", arg: 2, scope: !352, file: !1, line: 44, type: !126)
!360 = !DILocalVariable(name: "ps", arg: 3, scope: !352, file: !1, line: 44, type: !356)
!361 = !DILocalVariable(name: "retval", scope: !352, file: !1, line: 52, type: !24)
!362 = !DILocalVariable(name: "reent", scope: !352, file: !1, line: 53, type: !19)
!363 = !DILocalVariable(name: "buf", scope: !352, file: !1, line: 54, type: !299)
!364 = !DILocation(line: 44, column: 1, scope: !352)
!365 = !DILocation(line: 52, column: 7, scope: !352)
!366 = !DILocation(line: 53, column: 26, scope: !352)
!367 = !DILocation(line: 53, column: 18, scope: !352)
!368 = !DILocation(line: 54, column: 3, scope: !352)
!369 = !DILocation(line: 54, column: 8, scope: !352)
!370 = !DILocation(line: 64, column: 9, scope: !371)
!371 = distinct !DILexicalBlock(scope: !352, file: !1, line: 64, column: 7)
!372 = !DILocation(line: 230, column: 10, scope: !309, inlinedAt: !373)
!373 = distinct !DILocation(line: 0, scope: !371)
!374 = !DILocation(line: 230, column: 18, scope: !309, inlinedAt: !373)
!375 = !DILocation(line: 213, column: 3, scope: !324, inlinedAt: !376)
!376 = distinct !DILocation(line: 230, column: 29, scope: !309, inlinedAt: !373)
!377 = !DILocation(line: 230, column: 3, scope: !309, inlinedAt: !373)
!378 = !DILocation(line: 0, scope: !371)
!379 = !DILocation(line: 64, column: 7, scope: !352)
!380 = !DILocation(line: 65, column: 14, scope: !371)
!381 = !DILocation(line: 65, column: 5, scope: !371)
!382 = !DILocation(line: 67, column: 14, scope: !371)
!383 = !DILocation(line: 69, column: 14, scope: !384)
!384 = distinct !DILexicalBlock(scope: !352, file: !1, line: 69, column: 7)
!385 = !DILocation(line: 69, column: 7, scope: !352)
!386 = !DILocation(line: 71, column: 11, scope: !387)
!387 = distinct !DILexicalBlock(scope: !384, file: !1, line: 70, column: 5)
!388 = !DILocation(line: 71, column: 19, scope: !387)
!389 = !DILocation(line: 72, column: 14, scope: !387)
!390 = !DILocation(line: 72, column: 21, scope: !387)
!391 = !DILocation(line: 73, column: 7, scope: !387)
!392 = !DILocation(line: 76, column: 12, scope: !384)
!393 = !DILocation(line: 76, column: 5, scope: !384)
!394 = !DILocation(line: 0, scope: !384)
!395 = !DILocation(line: 0, scope: !387)
!396 = !DILocation(line: 78, column: 1, scope: !352)
