...
; <label>:23:                                     ; preds = %19, %12
  ...
  br i1 %25, label %26, label %72, !dbg !289
...
; <label>:42:                                     ; preds = %34
  ...
  %44 = icmp sgt i32 %37, %43, !dbg !317
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !318
  br i1 %44, label %45, label %52, !dbg !318

; <label>:45:                                     ; preds = %42
  %46 = and i32 %36, 255, !dbg !319
  %47 = icmp eq i32 %46, 10, !dbg !319
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !320
  br i1 %47, label %52, label %48, !dbg !320

; <label>:48:                                     ; preds = %45, %40
  %49 = phi i32 [ %41, %40 ], [ %46, %45 ], !dbg !314
  %50 = load i8*, i8** %28, align 8, !dbg !321, !tbaa !322
  %51 = getelementptr inbounds i8, i8* %50, i64 1, !dbg !321
  store i8* %51, i8** %28, align 8, !dbg !321, !tbaa !322
  store i8 %32, i8* %50, align 1, !dbg !323, !tbaa !295
  br label %54, !dbg !324

; <label>:52:                                     ; preds = %45, %42
  %53 = call i32 @__swbuf_r(%struct._reent* %0, i32 %36, %struct.__sFILE* nonnull %5) #4, !dbg !325
  br label %54, !dbg !326

; <label>:54:                                     ; preds = %48, %52
  %55 = phi i32 [ %49, %48 ], [ %53, %52 ], !dbg !327
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !291
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !328
  %56 = icmp eq i32 %55, -1, !dbg !329
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !330
  br i1 %56, label %72, label %30, !dbg !330, !llvm.loop !331

; <label>:57:                                     ; preds = %30
  %58 = load i32, i32* %27, align 4, !dbg !338, !tbaa !311
  %59 = add nsw i32 %58, -1, !dbg !338
  store i32 %59, i32* %27, align 4, !dbg !338, !tbaa !311
  %60 = icmp sgt i32 %58, 0, !dbg !339
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !340
  br i1 %60, label %61, label %64, !dbg !340

; <label>:61:                                     ; preds = %57
  %62 = load i8*, i8** %28, align 8, !dbg !341, !tbaa !322
  %63 = getelementptr inbounds i8, i8* %62, i64 1, !dbg !341
  store i8* %63, i8** %28, align 8, !dbg !341, !tbaa !322
  store i8 10, i8* %62, align 1, !dbg !342, !tbaa !295
...
; <label>:64:                                     ; preds = %57
  %65 = load i32, i32* %29, align 8, !dbg !346, !tbaa !316
  %66 = icmp sgt i32 %58, %65, !dbg !347
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !348
  br i1 %66, label %67, label %68, !dbg !348
...
; <label>:68:                                     ; preds = %64, %67
  %69 = call i32 @__swbuf_r(%struct._reent* %0, i32 10, %struct.__sFILE* nonnull %5) #4, !dbg !350
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !351
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !344
  %70 = icmp eq i32 %69, -1, !dbg !352
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !345
  br i1 %70, label %72, label %71, !dbg !345

; <label>:71:                                     ; preds = %61, %68
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !353
  br label %72, !dbg !353

; <label>:72:                                     ; preds = %54, %23, %68, %71
  %73 = phi i32 [ -1, %23 ], [ -1, %68 ], [ 10, %71 ], [ -1, %54 ], !dbg !354
  %74 = load i32, i32* %3, align 4, !dbg !355, !tbaa !356
  %75 = call i32 @pthread_setcancelstate(i32 %74, i32* nonnull %3) #4, !dbg !355
...
; Function Attrs: noredzone nounwind
define dso_local i32 @puts(i8* nocapture readonly) local_unnamed_addr #0 !dbg !359 {
  %2 = tail call %struct._reent* @__getreent() #4, !dbg !365
  %3 = tail call i32 @_puts_r(%struct._reent* %2, i8* %0) #6, !dbg !366
...
!318 = !DILocation(line: 692, column: 47, scope: !310, inlinedAt: !306)
!319 = !DILocation(line: 692, column: 59, scope: !310, inlinedAt: !306)
!320 = !DILocation(line: 692, column: 6, scope: !299, inlinedAt: !306)
!321 = !DILocation(line: 693, column: 18, scope: !310, inlinedAt: !306)
!322 = !{!283, !270, i64 0}
!323 = !DILocation(line: 693, column: 21, scope: !310, inlinedAt: !306)
!324 = !DILocation(line: 693, column: 3, scope: !310, inlinedAt: !306)
!325 = !DILocation(line: 695, column: 11, scope: !310, inlinedAt: !306)
!326 = !DILocation(line: 695, column: 3, scope: !310, inlinedAt: !306)
!327 = !DILocation(line: 0, scope: !310, inlinedAt: !306)
!328 = !DILocation(line: 696, column: 1, scope: !299, inlinedAt: !306)
!329 = !DILocation(line: 120, column: 37, scope: !292)
!330 = !DILocation(line: 120, column: 11, scope: !293)
!331 = distinct !{!331, !290, !332}
!332 = !DILocation(line: 122, column: 5, scope: !260)
!333 = !DILocation(line: 687, column: 47, scope: !299, inlinedAt: !334)
!334 = distinct !DILocation(line: 123, column: 7, scope: !335)
!335 = distinct !DILexicalBlock(scope: !260, file: !1, line: 123, column: 7)
!336 = !DILocation(line: 687, column: 57, scope: !299, inlinedAt: !334)
!337 = !DILocation(line: 687, column: 67, scope: !299, inlinedAt: !334)
!338 = !DILocation(line: 692, column: 6, scope: !310, inlinedAt: !334)
!339 = !DILocation(line: 692, column: 15, scope: !310, inlinedAt: !334)
!340 = !DILocation(line: 692, column: 20, scope: !310, inlinedAt: !334)
!341 = !DILocation(line: 693, column: 18, scope: !310, inlinedAt: !334)
!342 = !DILocation(line: 693, column: 21, scope: !310, inlinedAt: !334)
!343 = !DILocation(line: 693, column: 3, scope: !310, inlinedAt: !334)
!344 = !DILocation(line: 696, column: 1, scope: !299, inlinedAt: !334)
!345 = !DILocation(line: 123, column: 7, scope: !260)
!346 = !DILocation(line: 692, column: 38, scope: !310, inlinedAt: !334)
!347 = !DILocation(line: 692, column: 31, scope: !310, inlinedAt: !334)
!348 = !DILocation(line: 692, column: 47, scope: !310, inlinedAt: !334)
!349 = !DILocation(line: 692, column: 6, scope: !299, inlinedAt: !334)
!350 = !DILocation(line: 695, column: 11, scope: !310, inlinedAt: !334)
!351 = !DILocation(line: 695, column: 3, scope: !310, inlinedAt: !334)
!352 = !DILocation(line: 123, column: 33, scope: !335)
!353 = !DILocation(line: 126, column: 3, scope: !260)
!354 = !DILocation(line: 0, scope: !260)
!355 = !DILocation(line: 129, column: 3, scope: !260)
!356 = !{!267, !267, i64 0}
!357 = !DILocation(line: 129, column: 3, scope: !28)
!358 = !DILocation(line: 130, column: 3, scope: !28)
!359 = distinct !DISubprogram(name: "puts", scope: !1, file: !1, line: 137, type: !360, isLocal: false, isDefinition: true, scopeLine: 139, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !362)
!360 = !DISubroutineType(types: !361)
!361 = !{!5, !68}
!362 = !{!363}
!363 = !DILocalVariable(name: "s", arg: 1, scope: !359, file: !1, line: 137, type: !68)
!364 = !DILocation(line: 137, column: 1, scope: !359)
!365 = !DILocation(line: 140, column: 19, scope: !359)
!366 = !DILocation(line: 140, column: 10, scope: !359)
!367 = !DILocation(line: 140, column: 3, scope: !359)
