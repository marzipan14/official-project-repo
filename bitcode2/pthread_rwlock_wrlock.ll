; ModuleID = '/root/.unikraft/apps/redis/build/libpthread-embedded/origin/pthread-embedded-44b41d760a433915d70a7be9809651b0a65e001d/pthread_rwlock_wrlock.c'
source_filename = "/root/.unikraft/apps/redis/build/libpthread-embedded/origin/pthread-embedded-44b41d760a433915d70a7be9809651b0a65e001d/pthread_rwlock_wrlock.c"
...
define dso_local i32 @pthread_rwlock_wrlock(%struct.pthread_rwlock_t_**) local_unnamed_addr #0 !dbg !514 {
  %2 = alloca %struct.pte_cleanup_t, align 8
  %3 = icmp eq %struct.pthread_rwlock_t_** %0, null, !dbg !536
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !538
  br i1 %3, label %66, label %4, !dbg !538

; <label>:4:                                      ; preds = %1
  %5 = load %struct.pthread_rwlock_t_*, %struct.pthread_rwlock_t_** %0, align 8, !dbg !539, !tbaa !540
  %6 = icmp eq %struct.pthread_rwlock_t_* %5, null, !dbg !544
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !545
  br i1 %6, label %66, label %7, !dbg !545

; <label>:7:                                      ; preds = %4
  %8 = icmp eq %struct.pthread_rwlock_t_* %5, inttoptr (i64 -1 to %struct.pthread_rwlock_t_*), !dbg !546
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !548
  br i1 %8, label %9, label %15, !dbg !548

; <label>:9:                                      ; preds = %7
  %10 = tail call i32 @pte_rwlock_check_need_init(%struct.pthread_rwlock_t_** nonnull %0) #4, !dbg !549
  %11 = or i32 %10, 16, !dbg !552
  %12 = icmp eq i32 %11, 16, !dbg !552
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !552
  br i1 %12, label %13, label %66, !dbg !552

; <label>:13:                                     ; preds = %9
  %14 = load %struct.pthread_rwlock_t_*, %struct.pthread_rwlock_t_** %0, align 8, !dbg !554, !tbaa !540
  br label %15, !dbg !552

; <label>:15:                                     ; preds = %13, %7
  %16 = phi %struct.pthread_rwlock_t_* [ %14, %13 ], [ %5, %7 ], !dbg !554
  %17 = getelementptr inbounds %struct.pthread_rwlock_t_, %struct.pthread_rwlock_t_* %16, i64 0, i32 6, !dbg !556
  %18 = load i32, i32* %17, align 4, !dbg !556, !tbaa !558
  %19 = icmp eq i32 %18, 262974946, !dbg !561
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !562
  br i1 %19, label %20, label %66, !dbg !562

; <label>:20:                                     ; preds = %15
  %21 = getelementptr inbounds %struct.pthread_rwlock_t_, %struct.pthread_rwlock_t_* %16, i64 0, i32 0, !dbg !563
  %22 = tail call i32 @pthread_mutex_lock(%struct.pthread_mutex_t_** %21) #4, !dbg !565
  %23 = icmp eq i32 %22, 0, !dbg !566
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !567
  br i1 %23, label %24, label %66, !dbg !567

; <label>:24:                                     ; preds = %20
  %25 = getelementptr inbounds %struct.pthread_rwlock_t_, %struct.pthread_rwlock_t_* %16, i64 0, i32 1, !dbg !568
  %26 = tail call i32 @pthread_mutex_lock(%struct.pthread_mutex_t_** nonnull %25) #4, !dbg !570
  %27 = icmp eq i32 %26, 0, !dbg !571
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !572
  br i1 %27, label %30, label %28, !dbg !572

; <label>:28:                                     ; preds = %24
  %29 = tail call i32 @pthread_mutex_unlock(%struct.pthread_mutex_t_** %21) #4, !dbg !573
  br label %66, !dbg !575

; <label>:30:                                     ; preds = %24
  %31 = getelementptr inbounds %struct.pthread_rwlock_t_, %struct.pthread_rwlock_t_* %16, i64 0, i32 4, !dbg !576
  %32 = load i32, i32* %31, align 4, !dbg !576, !tbaa !577
  %33 = icmp eq i32 %32, 0, !dbg !578
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !579
  br i1 %33, label %34, label %61, !dbg !579

; <label>:34:                                     ; preds = %30
  %35 = getelementptr inbounds %struct.pthread_rwlock_t_, %struct.pthread_rwlock_t_* %16, i64 0, i32 5, !dbg !580
  %36 = load i32, i32* %35, align 8, !dbg !580, !tbaa !582
  %37 = icmp sgt i32 %36, 0, !dbg !583
  ...
  %39 = load i32, i32* %38, align 8, !dbg !585, !tbaa !586
  br i1 %37, label %40, label %42, !dbg !584

; <label>:40:                                     ; preds = %34
  %41 = sub nsw i32 %39, %36, !dbg !587
  store i32 %41, i32* %38, align 8, !dbg !587, !tbaa !586
  store i32 0, i32* %35, align 8, !dbg !589, !tbaa !582
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !590
  br label %42, !dbg !590

; <label>:42:                                     ; preds = %34, %40
  %43 = phi i32 [ %41, %40 ], [ %39, %34 ], !dbg !591
  %44 = icmp sgt i32 %43, 0, !dbg !592
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !593
  br i1 %44, label %45, label %61, !dbg !593

; <label>:45:                                     ; preds = %42
  %46 = sub nsw i32 0, %43, !dbg !594
  store i32 %46, i32* %35, align 8, !dbg !595, !tbaa !582
  %47 = bitcast %struct.pte_cleanup_t* %2 to i8*, !dbg !596
  call void @llvm.lifetime.start.p0i8(i64 24, i8* nonnull %47) #5, !dbg !596
  %48 = bitcast %struct.pthread_rwlock_t_* %16 to i8*, !dbg !596
  call void @pte_push_cleanup(%struct.pte_cleanup_t* nonnull %2, void (i8*)* nonnull @pte_rwlock_cancelwrwait, i8* %48) #4, !dbg !596
...
; <label>:50:                                     ; preds = %53, %45
  %51 = call i32 @pthread_cond_wait(%struct.pthread_cond_t_** nonnull %49, %struct.pthread_mutex_t_** nonnull %25) #4, !dbg !598
  %52 = icmp eq i32 %51, 0, !dbg !600
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !601
  br i1 %52, label %53, label %59, !dbg !601

; <label>:53:                                     ; preds = %50
  %54 = load i32, i32* %35, align 8, !dbg !602, !tbaa !582
  %55 = icmp slt i32 %54, 0, !dbg !603
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !604
  br i1 %55, label %50, label %56, !dbg !604, !llvm.loop !605

; <label>:56:                                     ; preds = %53
  %57 = call %struct.pte_cleanup_t* @pte_pop_cleanup(i32 0) #4, !dbg !607
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %47) #5, !dbg !608
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !609
  store i32 0, i32* %38, align 8, !dbg !610, !tbaa !586
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !613
  %58 = load i32, i32* %31, align 4, !dbg !614, !tbaa !577
  br label %61, !dbg !613

; <label>:59:                                     ; preds = %50
  %60 = call %struct.pte_cleanup_t* @pte_pop_cleanup(i32 1) #4, !dbg !607
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %47) #5, !dbg !608
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !609
  br label %64

; <label>:61:                                     ; preds = %56, %42, %30
  %62 = phi i32 [ %58, %56 ], [ 0, %42 ], [ %32, %30 ], !dbg !614
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !617
  %63 = add nsw i32 %62, 1, !dbg !614
  store i32 %63, i32* %31, align 4, !dbg !614, !tbaa !577
  br label %64, !dbg !618

; <label>:64:                                     ; preds = %59, %61
  %65 = phi i32 [ 0, %61 ], [ %51, %59 ]
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !619
  br label %66, !dbg !620

; <label>:66:                                     ; preds = %20, %15, %9, %1, %4, %64, %28
  %67 = phi i32 [ %26, %28 ], [ %65, %64 ], [ 22, %4 ], [ 22, %1 ], [ %10, %9 ], [ 22, %15 ], [ %22, %20 ], !dbg !621
...
!1 = !DIFile(filename: "/root/.unikraft/apps/redis/build/libpthread-embedded/origin/pthread-embedded-44b41d760a433915d70a7be9809651b0a65e001d/pthread_rwlock_wrlock.c", directory: "/root/.unikraft/apps/redis/build")
!2 = !{!3}
...
!514 = distinct !DISubprogram(name: "pthread_rwlock_wrlock", scope: !1, file: !1, line: 50, type: !515, isLocal: false, isDefinition: true, scopeLine: 51, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !518)
!515 = !DISubroutineType(types: !516)
!516 = !{!41, !517}
!517 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !12, size: 64)
!518 = !{!519, !520, !521, !522}
!519 = !DILocalVariable(name: "rwlock", arg: 1, scope: !514, file: !1, line: 50, type: !517)
!520 = !DILocalVariable(name: "result", scope: !514, file: !1, line: 52, type: !41)
!521 = !DILocalVariable(name: "rwl", scope: !514, file: !1, line: 53, type: !12)
!522 = !DILocalVariable(name: "_cleanup", scope: !523, file: !1, line: 110, type: !528)
!523 = distinct !DILexicalBlock(scope: !524, file: !1, line: 110, column: 11)
!524 = distinct !DILexicalBlock(scope: !525, file: !1, line: 103, column: 9)
!525 = distinct !DILexicalBlock(scope: !526, file: !1, line: 102, column: 11)
!526 = distinct !DILexicalBlock(scope: !527, file: !1, line: 95, column: 5)
!527 = distinct !DILexicalBlock(scope: !514, file: !1, line: 94, column: 7)
!528 = !DIDerivedType(tag: DW_TAG_typedef, name: "pte_cleanup_t", file: !13, line: 555, baseType: !529)
!529 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "pte_cleanup_t", file: !13, line: 559, size: 192, elements: !530)
!530 = !{!531, !532, !533}
!531 = !DIDerivedType(tag: DW_TAG_member, name: "routine", scope: !529, file: !13, line: 561, baseType: !509, size: 64)
!532 = !DIDerivedType(tag: DW_TAG_member, name: "arg", scope: !529, file: !13, line: 562, baseType: !11, size: 64, offset: 64)
!533 = !DIDerivedType(tag: DW_TAG_member, name: "prev", scope: !529, file: !13, line: 563, baseType: !534, size: 64, offset: 128)
!534 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !529, size: 64)
!535 = !DILocation(line: 50, column: 43, scope: !514)
!536 = !DILocation(line: 55, column: 14, scope: !537)
!537 = distinct !DILexicalBlock(scope: !514, file: !1, line: 55, column: 7)
!538 = !DILocation(line: 55, column: 22, scope: !537)
!539 = !DILocation(line: 55, column: 25, scope: !537)
!540 = !{!541, !541, i64 0}
!541 = !{!"any pointer", !542, i64 0}
!542 = !{!"omnipotent char", !543, i64 0}
!543 = !{!"Simple C/C++ TBAA"}
!544 = !DILocation(line: 55, column: 33, scope: !537)
!545 = !DILocation(line: 55, column: 7, scope: !514)
!546 = !DILocation(line: 66, column: 15, scope: !547)
!547 = distinct !DILexicalBlock(scope: !514, file: !1, line: 66, column: 7)
!548 = !DILocation(line: 66, column: 7, scope: !514)
!549 = !DILocation(line: 68, column: 16, scope: !550)
!550 = distinct !DILexicalBlock(scope: !547, file: !1, line: 67, column: 5)
!551 = !DILocation(line: 52, column: 7, scope: !514)
!552 = !DILocation(line: 70, column: 23, scope: !553)
!553 = distinct !DILexicalBlock(scope: !550, file: !1, line: 70, column: 11)
!554 = !DILocation(line: 76, column: 9, scope: !514)
!555 = !DILocation(line: 53, column: 20, scope: !514)
!556 = !DILocation(line: 78, column: 12, scope: !557)
!557 = distinct !DILexicalBlock(scope: !514, file: !1, line: 78, column: 7)
!558 = !{!559, !560, i64 36}
!559 = !{!"pthread_rwlock_t_", !541, i64 0, !541, i64 8, !541, i64 16, !560, i64 24, !560, i64 28, !560, i64 32, !560, i64 36}
!560 = !{!"int", !542, i64 0}
!561 = !DILocation(line: 78, column: 19, scope: !557)
!562 = !DILocation(line: 78, column: 7, scope: !514)
!563 = !DILocation(line: 83, column: 44, scope: !564)
!564 = distinct !DILexicalBlock(scope: !514, file: !1, line: 83, column: 7)
!565 = !DILocation(line: 83, column: 17, scope: !564)
!566 = !DILocation(line: 83, column: 66, scope: !564)
!567 = !DILocation(line: 83, column: 7, scope: !514)
!568 = !DILocation(line: 88, column: 44, scope: !569)
!569 = distinct !DILexicalBlock(scope: !514, file: !1, line: 88, column: 7)
!570 = !DILocation(line: 88, column: 17, scope: !569)
!571 = !DILocation(line: 88, column: 72, scope: !569)
!572 = !DILocation(line: 88, column: 7, scope: !514)
!573 = !DILocation(line: 90, column: 14, scope: !574)
!574 = distinct !DILexicalBlock(scope: !569, file: !1, line: 89, column: 5)
!575 = !DILocation(line: 91, column: 7, scope: !574)
!576 = !DILocation(line: 94, column: 12, scope: !527)
!577 = !{!559, !560, i64 28}
!578 = !DILocation(line: 94, column: 34, scope: !527)
!579 = !DILocation(line: 94, column: 7, scope: !514)
!580 = !DILocation(line: 96, column: 16, scope: !581)
!581 = distinct !DILexicalBlock(scope: !526, file: !1, line: 96, column: 11)
!582 = !{!559, !560, i64 32}
!583 = !DILocation(line: 96, column: 44, scope: !581)
!584 = !DILocation(line: 96, column: 11, scope: !526)
!585 = !DILocation(line: 0, scope: !525)
!586 = !{!559, !560, i64 24}
!587 = !DILocation(line: 98, column: 35, scope: !588)
!588 = distinct !DILexicalBlock(scope: !581, file: !1, line: 97, column: 9)
!589 = !DILocation(line: 99, column: 44, scope: !588)
!590 = !DILocation(line: 100, column: 9, scope: !588)
!591 = !DILocation(line: 102, column: 16, scope: !525)
!592 = !DILocation(line: 102, column: 35, scope: !525)
!593 = !DILocation(line: 102, column: 11, scope: !526)
!594 = !DILocation(line: 104, column: 46, scope: !524)
!595 = !DILocation(line: 104, column: 44, scope: !524)
!596 = !DILocation(line: 110, column: 11, scope: !523)
!597 = !DILocation(line: 112, column: 11, scope: !523)
!598 = !DILocation(line: 114, column: 24, scope: !599)
!599 = distinct !DILexicalBlock(scope: !523, file: !1, line: 113, column: 13)
!600 = !DILocation(line: 117, column: 25, scope: !523)
!601 = !DILocation(line: 117, column: 30, scope: !523)
!602 = !DILocation(line: 117, column: 38, scope: !523)
!603 = !DILocation(line: 117, column: 66, scope: !523)
!604 = !DILocation(line: 116, column: 13, scope: !599)
!605 = distinct !{!605, !597, !606}
!606 = !DILocation(line: 117, column: 69, scope: !523)
!607 = !DILocation(line: 119, column: 11, scope: !523)
!608 = !DILocation(line: 119, column: 11, scope: !524)
!609 = !DILocation(line: 121, column: 15, scope: !524)
!610 = !DILocation(line: 123, column: 39, scope: !611)
!611 = distinct !DILexicalBlock(scope: !612, file: !1, line: 122, column: 13)
!612 = distinct !DILexicalBlock(scope: !524, file: !1, line: 121, column: 15)
!613 = !DILocation(line: 124, column: 13, scope: !611)
!614 = !DILocation(line: 130, column: 33, scope: !615)
!615 = distinct !DILexicalBlock(scope: !616, file: !1, line: 129, column: 5)
!616 = distinct !DILexicalBlock(scope: !514, file: !1, line: 128, column: 7)
!617 = !DILocation(line: 128, column: 7, scope: !514)
!618 = !DILocation(line: 131, column: 5, scope: !615)
!619 = !DILocation(line: 0, scope: !615)
!620 = !DILocation(line: 133, column: 3, scope: !514)
!621 = !DILocation(line: 0, scope: !514)
!622 = !DILocation(line: 0, scope: !623)
!623 = distinct !DILexicalBlock(scope: !537, file: !1, line: 56, column: 5)
!624 = !DILocation(line: 134, column: 1, scope: !514)
