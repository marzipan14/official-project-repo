...
define dso_local i8* @memchr(i8*, i32, i64) local_unnamed_addr #0 !dbg !16 {
  ...
  %4 = ptrtoint i8* %0 to i64, !dbg !40
  %5 = and i64 %4, 7, !dbg !40
  %6 = icmp eq i64 %5, 0, !dbg !39
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !39
  br i1 %6, label %22, label %7, !dbg !39
...
; <label>:17:                                     ; preds = %14
  ...
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !39
  %19 = ptrtoint i8* %18 to i64, !dbg !40
  %20 = and i64 %19, 7, !dbg !40
  %21 = icmp eq i64 %20, 0, !dbg !39
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !39
  br i1 %21, label %22, label %9, !dbg !39, !llvm.loop !53
...
; <label>:26:                                     ; preds = %22
  ...
  %33 = shl nuw i64 %32, 32, !dbg !71
  %34 = or i64 %33, %32, !dbg !73
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !74
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !70
  %35 = bitcast i8* %24 to i64*, !dbg !75
...
; <label>:36:                                     ; preds = %26, %46
  ...
  %39 = load i64, i64* %37, align 8, !dbg !77, !tbaa !80
  %40 = xor i64 %39, %34, !dbg !77
  %41 = add i64 %40, -72340172838076673, !dbg !77
  %42 = and i64 %40, -9187201950435737472, !dbg !77
  %43 = xor i64 %42, -9187201950435737472, !dbg !77
  %44 = and i64 %43, %41, !dbg !77
  %45 = icmp eq i64 %44, 0, !dbg !77
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !82
  br i1 %45, label %46, label %50, !dbg !82

; <label>:46:                                     ; preds = %36
  %47 = add i64 %38, -8, !dbg !83
  %48 = getelementptr inbounds i64, i64* %37, i64 1, !dbg !84
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !76
  %49 = icmp ugt i64 %47, 7, !dbg !85
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !76
  br i1 %49, label %36, label %50, !dbg !76, !llvm.loop !86

; <label>:50:                                     ; preds = %46, %36
  %51 = phi i64 [ %47, %46 ], [ %38, %36 ]
  %52 = phi i64* [ %48, %46 ], [ %37, %36 ]
  %53 = bitcast i64* %52 to i8*, !dbg !88
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !89
  br label %54, !dbg !89

; <label>:54:                                     ; preds = %50, %22
  %55 = phi i64 [ %23, %22 ], [ %51, %50 ]
  %56 = phi i8* [ %24, %22 ], [ %53, %50 ], !dbg !90
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !91
  %57 = icmp eq i64 %55, 0, !dbg !91
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !91
  br i1 %57, label %69, label %58, !dbg !91
...
; <label>:60:                                     ; preds = %58, %66
  ...
  %63 = add i64 %61, -1, !dbg !92
  %64 = load i8, i8* %62, align 1, !dbg !93, !tbaa !47
  %65 = icmp eq i8 %64, %59, !dbg !96
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !97
  br i1 %65, label %69, label %66, !dbg !97

; <label>:66:                                     ; preds = %60
  %67 = getelementptr inbounds i8, i8* %62, i64 1, !dbg !98
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !91
  %68 = icmp eq i64 %63, 0, !dbg !91
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !91
  br i1 %68, label %69, label %60, !dbg !91, !llvm.loop !99

; <label>:69:                                     ; preds = %14, %9, %66, %60, %54
  %70 = phi i8* [ null, %54 ], [ null, %66 ], [ %62, %60 ], [ %10, %14 ], [ null, %9 ], !dbg !101
...
!39 = !DILocation(line: 85, column: 3, scope: !16)
!40 = !DILocation(line: 85, column: 10, scope: !16)
...
!68 = !DILocation(line: 107, column: 12, scope: !69)
!69 = distinct !DILexicalBlock(scope: !61, file: !1, line: 107, column: 7)
!70 = !DILocation(line: 107, column: 7, scope: !69)
!71 = !DILocation(line: 108, column: 22, scope: !72)
!72 = distinct !DILexicalBlock(scope: !69, file: !1, line: 107, column: 7)
!73 = !DILocation(line: 108, column: 28, scope: !72)
!74 = !DILocation(line: 107, column: 7, scope: !72)
!75 = !DILocation(line: 104, column: 14, scope: !61)
!76 = !DILocation(line: 110, column: 7, scope: !61)
!77 = !DILocation(line: 112, column: 15, scope: !78)
!78 = distinct !DILexicalBlock(scope: !79, file: !1, line: 112, column: 15)
!79 = distinct !DILexicalBlock(scope: !61, file: !1, line: 111, column: 9)
!80 = !{!81, !81, i64 0}
!81 = !{!"long", !48, i64 0}
!82 = !DILocation(line: 112, column: 15, scope: !79)
!83 = !DILocation(line: 114, column: 18, scope: !79)
!84 = !DILocation(line: 115, column: 15, scope: !79)
!85 = !DILocation(line: 110, column: 21, scope: !61)
!86 = distinct !{!86, !76, !87}
!87 = !DILocation(line: 116, column: 9, scope: !61)
!88 = !DILocation(line: 121, column: 13, scope: !61)
!89 = !DILocation(line: 122, column: 5, scope: !61)
!90 = !DILocation(line: 0, scope: !61)
!91 = !DILocation(line: 126, column: 3, scope: !16)
!92 = !DILocation(line: 126, column: 16, scope: !16)
!93 = !DILocation(line: 128, column: 11, scope: !94)
!94 = distinct !DILexicalBlock(scope: !95, file: !1, line: 128, column: 11)
!95 = distinct !DILexicalBlock(scope: !16, file: !1, line: 127, column: 5)
!96 = !DILocation(line: 128, column: 16, scope: !94)
!97 = !DILocation(line: 128, column: 11, scope: !95)
!98 = !DILocation(line: 130, column: 10, scope: !95)
!99 = distinct !{!99, !91, !100}
!100 = !DILocation(line: 131, column: 5, scope: !16)
!101 = !DILocation(line: 0, scope: !16)
!102 = !DILocation(line: 0, scope: !42)
!103 = !DILocation(line: 134, column: 1, scope: !16)
