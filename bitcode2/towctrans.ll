...
define dso_local i32 @_towctrans_r(%struct._reent* nocapture, i32, i32) local_unnamed_addr #0 !dbg !7 {
  %4 = icmp eq i32 %2, 1, !dbg !297
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !299
  br i1 %4, label %5, label %7, !dbg !299

; <label>:5:                                      ; preds = %3
  %6 = tail call i32 @towlower(i32 %1) #3, !dbg !300
  br label %13, !dbg !301

; <label>:7:                                      ; preds = %3
  %8 = icmp eq i32 %2, 2, !dbg !302
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !304
  br i1 %8, label %9, label %11, !dbg !304

; <label>:9:                                      ; preds = %7
  %10 = tail call i32 @towupper(i32 %1) #3, !dbg !305
  br label %13, !dbg !306

; <label>:11:                                     ; preds = %7
  %12 = getelementptr inbounds %struct._reent, %struct._reent* %0, i64 0, i32 0, !dbg !307
  store i32 22, i32* %12, align 8, !dbg !309, !tbaa !310
  br label %13, !dbg !319

; <label>:13:                                     ; preds = %11, %9, %5
  %14 = phi i32 [ %6, %5 ], [ %10, %9 ], [ %1, %11 ], !dbg !320
...
; Function Attrs: noredzone nounwind
define dso_local i32 @towctrans(i32, i32) local_unnamed_addr #0 !dbg !323 {
  %3 = tail call %struct._reent* @__getreent() #3, !dbg !330
  %4 = icmp eq i32 %1, 1, !dbg !333
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !334
  br i1 %4, label %5, label %7, !dbg !334

; <label>:5:                                      ; preds = %2
  %6 = tail call i32 @towlower(i32 %0) #3, !dbg !335
  br label %13, !dbg !336

; <label>:7:                                      ; preds = %2
  %8 = icmp eq i32 %1, 2, !dbg !337
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !338
  br i1 %8, label %9, label %11, !dbg !338

; <label>:9:                                      ; preds = %7
  %10 = tail call i32 @towupper(i32 %0) #3, !dbg !339
  br label %13, !dbg !340

; <label>:11:                                     ; preds = %7
  %12 = getelementptr inbounds %struct._reent, %struct._reent* %3, i64 0, i32 0, !dbg !341
  store i32 22, i32* %12, align 8, !dbg !342, !tbaa !310
  br label %13, !dbg !343

; <label>:13:                                     ; preds = %5, %9, %11
  %14 = phi i32 [ %6, %5 ], [ %10, %9 ], [ %0, %11 ], !dbg !344
...
!297 = !DILocation(line: 90, column: 9, scope: !298)
!298 = distinct !DILexicalBlock(scope: !7, file: !1, line: 90, column: 7)
!299 = !DILocation(line: 90, column: 7, scope: !7)
!300 = !DILocation(line: 91, column: 12, scope: !298)
!301 = !DILocation(line: 91, column: 5, scope: !298)
!302 = !DILocation(line: 92, column: 14, scope: !303)
!303 = distinct !DILexicalBlock(scope: !298, file: !1, line: 92, column: 12)
!304 = !DILocation(line: 92, column: 12, scope: !298)
!305 = !DILocation(line: 93, column: 12, scope: !303)
!306 = !DILocation(line: 93, column: 5, scope: !303)
!307 = !DILocation(line: 96, column: 10, scope: !308)
!308 = distinct !DILexicalBlock(scope: !303, file: !1, line: 95, column: 5)
!309 = !DILocation(line: 96, column: 17, scope: !308)
!310 = !{!311, !312, i64 0}
...
!319 = !DILocation(line: 97, column: 7, scope: !308)
!320 = !DILocation(line: 0, scope: !308)
!321 = !DILocation(line: 0, scope: !298)
!322 = !DILocation(line: 99, column: 1, scope: !7)
!323 = distinct !DISubprogram(name: "towctrans", scope: !1, file: !1, line: 103, type: !324, isLocal: false, isDefinition: true, scopeLine: 106, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !326)
!324 = !DISubroutineType(types: !325)
!325 = !{!10, !10, !290}
!326 = !{!327, !328}
!327 = !DILocalVariable(name: "c", arg: 1, scope: !323, file: !1, line: 103, type: !10)
!328 = !DILocalVariable(name: "w", arg: 2, scope: !323, file: !1, line: 103, type: !290)
!329 = !DILocation(line: 103, column: 1, scope: !323)
!330 = !DILocation(line: 107, column: 24, scope: !323)
!331 = !DILocation(line: 85, column: 1, scope: !7, inlinedAt: !332)
!332 = distinct !DILocation(line: 107, column: 10, scope: !323)
!333 = !DILocation(line: 90, column: 9, scope: !298, inlinedAt: !332)
!334 = !DILocation(line: 90, column: 7, scope: !7, inlinedAt: !332)
!335 = !DILocation(line: 91, column: 12, scope: !298, inlinedAt: !332)
!336 = !DILocation(line: 91, column: 5, scope: !298, inlinedAt: !332)
!337 = !DILocation(line: 92, column: 14, scope: !303, inlinedAt: !332)
!338 = !DILocation(line: 92, column: 12, scope: !298, inlinedAt: !332)
!339 = !DILocation(line: 93, column: 12, scope: !303, inlinedAt: !332)
!340 = !DILocation(line: 93, column: 5, scope: !303, inlinedAt: !332)
!341 = !DILocation(line: 96, column: 10, scope: !308, inlinedAt: !332)
!342 = !DILocation(line: 96, column: 17, scope: !308, inlinedAt: !332)
!343 = !DILocation(line: 97, column: 7, scope: !308, inlinedAt: !332)
!344 = !DILocation(line: 0, scope: !308, inlinedAt: !332)
!345 = !DILocation(line: 0, scope: !323)
!346 = !DILocation(line: 99, column: 1, scope: !7, inlinedAt: !332)
!347 = !DILocation(line: 107, column: 3, scope: !323)
