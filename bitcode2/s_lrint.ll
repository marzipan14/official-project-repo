...
; <label>:12:                                     ; preds = %1
  ...
  br i1 %13, label %81, label %14, !dbg !70
...
; <label>:14:                                     ; preds = %12
  ...
  br i1 %23, label %81, label %24, !dbg !86
...
; <label>:35:                                     ; preds = %1
  ...
  br i1 %36, label %37, label %74, !dbg !97
...
; <label>:49:                                     ; preds = %37
  ...
  br i1 %66, label %67, label %71, !dbg !120

; <label>:67:                                     ; preds = %49
  %68 = trunc i64 %55 to i32, !dbg !114
  %69 = lshr i32 %68, %65, !dbg !120
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !120
  %70 = zext i32 %69 to i64, !dbg !120
  br label %71, !dbg !120

; <label>:71:                                     ; preds = %49, %67
  %72 = phi i64 [ %70, %67 ], [ 0, %49 ]
  %73 = or i64 %72, %64, !dbg !121
  br label %76

; <label>:74:                                     ; preds = %35
  %75 = fptosi double %0 to i64, !dbg !122
  br label %81, !dbg !124

; <label>:76:                                     ; preds = %71, %39, %24
  %77 = phi i64 [ %34, %24 ], [ %48, %39 ], [ %73, %71 ], !dbg !125
  store volatile i32 42, i32* @__A_VARIABLE, align 4
  %78 = icmp eq i64 %7, 0, !dbg !126
  %79 = sub nsw i64 0, %77, !dbg !127
  %80 = select i1 %78, i64 %77, i64 %79, !dbg !126
  br label %81, !dbg !128

; <label>:81:                                     ; preds = %14, %12, %76, %74
  %82 = phi i64 [ %80, %76 ], [ %75, %74 ], [ 0, %12 ], [ 0, %14 ], !dbg !129
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !130
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %3), !dbg !131
...
!130 = !DILocation(line: 0, scope: !50)
!131 = !DILocation(line: 164, column: 1, scope: !18)
