...
; <label>:12:                                     ; preds = %75, %4
  %13 = phi i32 [ 0, %4 ], [ %14, %75 ], !dbg !597
  %14 = add nuw nsw i32 %13, 1, !dbg !599
  %15 = tail call i32 @pthread_mutex_lock(%struct.pthread_mutex_t_** nonnull %6) #7, !dbg !600
  %16 = load i64, i64* %8, align 8, !dbg !601, !tbaa !602
  store i64 %16, i64* %10, align 8, !dbg !609, !tbaa !610
  %17 = tail call i32 @pthread_mutex_unlock(%struct.pthread_mutex_t_** nonnull %6) #7, !dbg !611
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !612
  %18 = tail call i32 @pthread_mutex_lock(%struct.pthread_mutex_t_** nonnull %6) #7, !dbg !613
  %19 = load %struct.ThreadKeyAssoc*, %struct.ThreadKeyAssoc** %11, align 8, !dbg !614, !tbaa !610
  %20 = icmp eq %struct.ThreadKeyAssoc* %19, null, !dbg !617
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !618
  br i1 %20, label %75, label %21, !dbg !618

; <label>:21:                                     ; preds = %12
  %22 = icmp ult i32 %14, 5
  br label %23, !dbg !618

; <label>:23:                                     ; preds = %21, %70
  %24 = phi %struct.ThreadKeyAssoc* [ %19, %21 ], [ %73, %70 ]
  %25 = phi i32 [ 0, %21 ], [ %71, %70 ]
  %26 = getelementptr inbounds %struct.ThreadKeyAssoc, %struct.ThreadKeyAssoc* %24, i64 0, i32 1, !dbg !619
  %27 = load %struct.pthread_key_t_*, %struct.pthread_key_t_** %26, align 8, !dbg !619, !tbaa !622
  %28 = getelementptr inbounds %struct.pthread_key_t_, %struct.pthread_key_t_* %27, i64 0, i32 2, !dbg !624
  %29 = tail call i32 @pthread_mutex_trylock(%struct.pthread_mutex_t_** nonnull %28) #7, !dbg !625
  %30 = icmp eq i32 %29, 16, !dbg !626
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !627
  br i1 %30, label %31, label %47, !dbg !627

; <label>:31:                                     ; preds = %23
  %32 = tail call i32 @pthread_mutex_unlock(%struct.pthread_mutex_t_** nonnull %6) #7, !dbg !628
  %33 = tail call i64 asm sideeffect "mov %rsp, $0", "=r,~{dirflag},~{fpsr},~{flags}"() #6, !dbg !630, !srcloc !654
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !656
  %34 = and i64 %33, -65536, !dbg !658
  %35 = inttoptr i64 %34 to %struct.uk_thread**, !dbg !659
  %36 = load %struct.uk_thread*, %struct.uk_thread** %35, align 65536, !dbg !661, !tbaa !662
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !663
  %37 = icmp eq %struct.uk_thread* %36, null, !dbg !665
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !668
  br i1 %37, label %38, label %39, !dbg !668, !prof !669

; <label>:38:                                     ; preds = %31
  tail call void (i8*, ...) @uk_pr_crit(i8* undef, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.1, i64 0, i64 0)) #7, !dbg !670
  tail call void @ukplat_terminate(i32 3) #8, !dbg !670
  unreachable

; <label>:39:                                     ; preds = %31
  %40 = getelementptr inbounds %struct.uk_thread, %struct.uk_thread* %36, i64 0, i32 9, !dbg !672
  %41 = load %struct.uk_sched*, %struct.uk_sched** %40, align 8, !dbg !672, !tbaa !673
  %42 = icmp eq %struct.uk_sched* %41, null, !dbg !680
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !683
  br i1 %42, label %43, label %44, !dbg !683, !prof !669

; <label>:43:                                     ; preds = %39
  tail call void (i8*, ...) @uk_pr_crit(i8* undef, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i64 0, i64 0)) #7, !dbg !684
  tail call void @ukplat_terminate(i32 3) #8, !dbg !684
  unreachable

; <label>:44:                                     ; preds = %39
  %45 = getelementptr inbounds %struct.uk_sched, %struct.uk_sched* %41, i64 0, i32 0, !dbg !686
  %46 = load void (%struct.uk_sched*)*, void (%struct.uk_sched*)** %45, align 8, !dbg !686, !tbaa !687
  tail call void %46(%struct.uk_sched* nonnull %41) #7, !dbg !691
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !692
  br label %70, !dbg !693, !llvm.loop !694

; <label>:47:                                     ; preds = %23
  %48 = getelementptr inbounds %struct.ThreadKeyAssoc, %struct.ThreadKeyAssoc* %24, i64 0, i32 2, !dbg !697
  %49 = bitcast %struct.ThreadKeyAssoc** %48 to i64*, !dbg !697
  %50 = load i64, i64* %49, align 8, !dbg !697, !tbaa !698
  store i64 %50, i64* %10, align 8, !dbg !699, !tbaa !610
  %51 = load %struct.pthread_key_t_*, %struct.pthread_key_t_** %26, align 8, !dbg !700, !tbaa !622
  %52 = getelementptr inbounds %struct.pthread_key_t_, %struct.pthread_key_t_* %51, i64 0, i32 1, !dbg !702
  %53 = load void (i8*)*, void (i8*)** %52, align 8, !dbg !702, !tbaa !703
  %54 = getelementptr inbounds %struct.pthread_key_t_, %struct.pthread_key_t_* %51, i64 0, i32 0, !dbg !706
  %55 = load i32, i32* %54, align 8, !dbg !706, !tbaa !707
  %56 = tail call i8* @pte_osTlsGetValue(i32 %55) #7, !dbg !708
  %57 = load i32, i32* %54, align 8, !dbg !710, !tbaa !707
  %58 = tail call i32 @pte_osTlsSetValue(i32 %57, i8* null) #7, !dbg !711
  %59 = icmp ne i8* %56, null, !dbg !712
  %60 = and i1 %22, %59, !dbg !714
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !714
  br i1 %60, label %61, label %66, !dbg !714

; <label>:61:                                     ; preds = %47
  %62 = tail call i32 @pthread_mutex_unlock(%struct.pthread_mutex_t_** nonnull %6) #7, !dbg !715
  %63 = getelementptr inbounds %struct.pthread_key_t_, %struct.pthread_key_t_* %51, i64 0, i32 2, !dbg !717
  %64 = tail call i32 @pthread_mutex_unlock(%struct.pthread_mutex_t_** nonnull %63) #7, !dbg !718
  %65 = add nsw i32 %25, 1, !dbg !719
  tail call void %53(i8* nonnull %56) #7, !dbg !720
  br label %70, !dbg !721

; <label>:66:                                     ; preds = %47
  tail call void @pte_tkAssocDestroy(%struct.ThreadKeyAssoc* nonnull %24) #7, !dbg !722
  %67 = tail call i32 @pthread_mutex_unlock(%struct.pthread_mutex_t_** nonnull %6) #7, !dbg !724
  %68 = getelementptr inbounds %struct.pthread_key_t_, %struct.pthread_key_t_* %51, i64 0, i32 2, !dbg !725
  %69 = tail call i32 @pthread_mutex_unlock(%struct.pthread_mutex_t_** nonnull %68) #7, !dbg !726
  br label %70

; <label>:70:                                     ; preds = %61, %66, %44
  %71 = phi i32 [ %25, %44 ], [ %65, %61 ], [ %25, %66 ], !dbg !727
  store volatile i32 42, i32* @__A_VARIABLE, align 4
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !728
  store volatile i32 42, i32* @__A_VARIABLE, align 4
  %72 = tail call i32 @pthread_mutex_lock(%struct.pthread_mutex_t_** nonnull %6) #7, !dbg !613
  %73 = load %struct.ThreadKeyAssoc*, %struct.ThreadKeyAssoc** %11, align 8, !dbg !614, !tbaa !610
  %74 = icmp eq %struct.ThreadKeyAssoc* %73, null, !dbg !617
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !618
  br i1 %74, label %75, label %23, !dbg !618

; <label>:75:                                     ; preds = %70, %12
  %76 = phi i32 [ 0, %12 ], [ %71, %70 ], !dbg !729
  %77 = tail call i32 @pthread_mutex_unlock(%struct.pthread_mutex_t_** nonnull %6) #7, !dbg !730
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !732
  store volatile i32 42, i32* @__A_VARIABLE, align 4
  %78 = icmp eq i32 %76, 0, !dbg !733
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !733
  br i1 %78, label %79, label %12, !dbg !733, !llvm.loop !734
...
define internal void @uk_pr_crit(i8* nocapture readnone, ...) unnamed_addr #4 !dbg !2 {
  ...
  %3 = bitcast [1 x %struct.__va_list_tag]* %2 to i8*, !dbg !738
  call void @llvm.lifetime.start.p0i8(i64 24, i8* nonnull %3) #6, !dbg !738
  %4 = getelementptr inbounds [1 x %struct.__va_list_tag], [1 x %struct.__va_list_tag]* %2, i64 0, i64 0, !dbg !740
  call void @llvm.va_start(i8* nonnull %3), !dbg !740
  call void @_uk_vprintk(i32 0, i8* getelementptr inbounds ([20 x i8], [20 x i8]* @uk_pr_crit.__str, i64 0, i64 0), i8* getelementptr inbounds ([30 x i8], [30 x i8]* @uk_pr_crit.__str.3, i64 0, i64 0), i32 198, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str, i64 0, i64 0), %struct.__va_list_tag* nonnull %4) #7, !dbg !741
  call void @llvm.va_end(i8* nonnull %3), !dbg !744
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %3) #6, !dbg !745
...
!594 = !DILocation(line: 81, column: 11, scope: !580)
!595 = !DILocation(line: 82, column: 22, scope: !580)
!596 = !DILocation(line: 90, column: 7, scope: !580)
!597 = !DILocation(line: 0, scope: !588)
!598 = !DILocation(line: 80, column: 11, scope: !580)
!599 = !DILocation(line: 93, column: 21, scope: !588)
!600 = !DILocation(line: 95, column: 18, scope: !588)
!601 = !DILocation(line: 104, column: 31, scope: !588)
!602 = !{!603, !604, i64 176}
!603 = !{!"pte_thread_t_", !604, i64 0, !607, i64 8, !604, i64 24, !605, i64 32, !604, i64 40, !604, i64 48, !608, i64 56, !608, i64 60, !604, i64 64, !608, i64 72, !604, i64 80, !608, i64 88, !608, i64 92, !608, i64 96, !605, i64 104, !608, i64 168, !604, i64 176, !604, i64 184}
!604 = !{!"any pointer", !605, i64 0}
!605 = !{!"omnipotent char", !606, i64 0}
!606 = !{!"Simple C/C++ TBAA"}
!607 = !{!"", !604, i64 0, !608, i64 8}
!608 = !{!"int", !605, i64 0}
!609 = !DILocation(line: 104, column: 25, scope: !588)
!610 = !{!603, !604, i64 184}
!611 = !DILocation(line: 105, column: 18, scope: !588)
!612 = !DILocation(line: 107, column: 11, scope: !588)
!613 = !DILocation(line: 118, column: 22, scope: !585)
!614 = !DILocation(line: 120, column: 50, scope: !615)
!615 = distinct !DILexicalBlock(scope: !585, file: !10, line: 120, column: 19)
!616 = !DILocation(line: 76, column: 20, scope: !573)
!617 = !DILocation(line: 120, column: 61, scope: !615)
!618 = !DILocation(line: 120, column: 19, scope: !585)
!619 = !DILocation(line: 138, column: 54, scope: !620)
!620 = distinct !DILexicalBlock(scope: !621, file: !10, line: 138, column: 23)
!621 = distinct !DILexicalBlock(scope: !615, file: !10, line: 127, column: 17)
!622 = !{!623, !604, i64 8}
!623 = !{!"ThreadKeyAssoc", !604, i64 0, !604, i64 8, !604, i64 16, !604, i64 24, !604, i64 32, !604, i64 40}
...
!656 = !DILocation(line: 121, column: 2, scope: !631, inlinedAt: !637)
!657 = !DILocation(line: 154, column: 16, scope: !638, inlinedAt: !644)
!658 = !DILocation(line: 156, column: 38, scope: !638, inlinedAt: !644)
!659 = !DILocation(line: 156, column: 12, scope: !638, inlinedAt: !644)
!660 = !DILocation(line: 153, column: 21, scope: !638, inlinedAt: !644)
!661 = !DILocation(line: 158, column: 9, scope: !638, inlinedAt: !644)
!662 = !{!604, !604, i64 0}
!663 = !DILocation(line: 158, column: 2, scope: !638, inlinedAt: !644)
!664 = !DILocation(line: 117, column: 20, scope: !645, inlinedAt: !649)
!665 = !DILocation(line: 119, column: 2, scope: !666, inlinedAt: !649)
!666 = distinct !DILexicalBlock(scope: !667, file: !92, line: 119, column: 2)
!667 = distinct !DILexicalBlock(scope: !645, file: !92, line: 119, column: 2)
!668 = !DILocation(line: 119, column: 2, scope: !667, inlinedAt: !649)
!669 = !{!"branch_weights", i32 1, i32 2000}
!670 = !DILocation(line: 119, column: 2, scope: !671, inlinedAt: !649)
!671 = distinct !DILexicalBlock(scope: !666, file: !92, line: 119, column: 2)
!672 = !DILocation(line: 121, column: 15, scope: !645, inlinedAt: !649)
!673 = !{!674, !604, i64 88}
!674 = !{!"uk_thread", !604, i64 0, !604, i64 8, !604, i64 16, !604, i64 24, !675, i64 32, !608, i64 48, !676, i64 56, !677, i64 64, !678, i64 72, !604, i64 88, !604, i64 96, !608, i64 104, !604, i64 112, !604, i64 120}
!675 = !{!"", !604, i64 0, !604, i64 8}
!676 = !{!"long", !605, i64 0}
!677 = !{!"_Bool", !605, i64 0}
!678 = !{!"uk_waitq", !604, i64 0, !604, i64 8}
!679 = !DILocation(line: 116, column: 19, scope: !645, inlinedAt: !649)
!680 = !DILocation(line: 122, column: 2, scope: !681, inlinedAt: !649)
!681 = distinct !DILexicalBlock(scope: !682, file: !92, line: 122, column: 2)
!682 = distinct !DILexicalBlock(scope: !645, file: !92, line: 122, column: 2)
!683 = !DILocation(line: 122, column: 2, scope: !682, inlinedAt: !649)
!684 = !DILocation(line: 122, column: 2, scope: !685, inlinedAt: !649)
!685 = distinct !DILexicalBlock(scope: !681, file: !92, line: 122, column: 2)
!686 = !DILocation(line: 123, column: 5, scope: !645, inlinedAt: !649)
!687 = !{!688, !604, i64 0}
!688 = !{!"uk_sched", !604, i64 0, !604, i64 8, !604, i64 16, !604, i64 24, !604, i64 32, !604, i64 40, !604, i64 48, !604, i64 56, !604, i64 64, !677, i64 72, !674, i64 80, !689, i64 208, !690, i64 224, !604, i64 248, !604, i64 256, !604, i64 264}
!689 = !{!"uk_thread_list", !604, i64 0, !604, i64 8}
!690 = !{!"ukplat_ctx_callbacks", !604, i64 0, !604, i64 8, !604, i64 16}
!691 = !DILocation(line: 123, column: 2, scope: !645, inlinedAt: !649)
!692 = !DILocation(line: 124, column: 1, scope: !645, inlinedAt: !649)
!693 = !DILocation(line: 147, column: 23, scope: !629)
!694 = distinct !{!694, !695, !696}
!695 = !DILocation(line: 107, column: 11, scope: !587)
!696 = !DILocation(line: 225, column: 13, scope: !587)
!697 = !DILocation(line: 153, column: 38, scope: !585)
!698 = !{!623, !604, i64 16}
!699 = !DILocation(line: 153, column: 29, scope: !585)
!700 = !DILocation(line: 162, column: 26, scope: !585)
!701 = !DILocation(line: 110, column: 29, scope: !585)
!702 = !DILocation(line: 163, column: 31, scope: !585)
!703 = !{!704, !604, i64 8}
!704 = !{!"pthread_key_t_", !608, i64 0, !604, i64 8, !604, i64 16, !604, i64 24}
!705 = !DILocation(line: 111, column: 22, scope: !585)
!706 = !DILocation(line: 164, column: 44, scope: !585)
!707 = !{!704, !608, i64 0}
!708 = !DILocation(line: 164, column: 23, scope: !585)
!709 = !DILocation(line: 109, column: 22, scope: !585)
!710 = !DILocation(line: 165, column: 37, scope: !585)
!711 = !DILocation(line: 165, column: 15, scope: !585)
!712 = !DILocation(line: 168, column: 25, scope: !713)
!713 = distinct !DILexicalBlock(scope: !585, file: !10, line: 168, column: 19)
!714 = !DILocation(line: 168, column: 33, scope: !713)
!715 = !DILocation(line: 177, column: 26, scope: !716)
!716 = distinct !DILexicalBlock(scope: !713, file: !10, line: 169, column: 17)
!717 = !DILocation(line: 178, column: 52, scope: !716)
!718 = !DILocation(line: 178, column: 26, scope: !716)
!719 = !DILocation(line: 180, column: 34, scope: !716)
!720 = !DILocation(line: 210, column: 19, scope: !716)
!721 = !DILocation(line: 214, column: 17, scope: !716)
!722 = !DILocation(line: 221, column: 19, scope: !723)
!723 = distinct !DILexicalBlock(scope: !713, file: !10, line: 216, column: 17)
!724 = !DILocation(line: 222, column: 26, scope: !723)
!725 = !DILocation(line: 223, column: 52, scope: !723)
!726 = !DILocation(line: 223, column: 26, scope: !723)
!727 = !DILocation(line: 0, scope: !716)
!728 = !DILocation(line: 0, scope: !629)
!729 = !DILocation(line: 92, column: 27, scope: !588)
!730 = !DILocation(line: 123, column: 19, scope: !731)
!731 = distinct !DILexicalBlock(scope: !615, file: !10, line: 121, column: 17)
!732 = !DILocation(line: 124, column: 19, scope: !731)
!733 = !DILocation(line: 226, column: 9, scope: !588)
!734 = distinct !{!734, !596, !735}
!735 = !DILocation(line: 227, column: 29, scope: !580)
!736 = !DILocation(line: 228, column: 5, scope: !580)
!737 = !DILocation(line: 229, column: 1, scope: !573)
!738 = !DILocation(line: 196, column: 2, scope: !2)
!739 = !DILocation(line: 196, column: 10, scope: !2)
!740 = !DILocation(line: 197, column: 2, scope: !2)
!741 = !DILocation(line: 198, column: 2, scope: !742)
!742 = distinct !DILexicalBlock(scope: !743, file: !3, line: 198, column: 2)
!743 = distinct !DILexicalBlock(scope: !2, file: !3, line: 198, column: 2)
!744 = !DILocation(line: 199, column: 2, scope: !2)
!745 = !DILocation(line: 200, column: 1, scope: !2)
