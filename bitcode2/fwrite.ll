...
; <label>:21:                                     ; preds = %14
  ...
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !291
  br i1 %24, label %25, label %28, !dbg !291
...
; <label>:25:                                     ; preds = %21, %14
  ...
  br i1 %27, label %28, label %61, !dbg !300

; <label>:28:                                     ; preds = %25, %21
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !301
  %29 = icmp eq i64 %7, 0, !dbg !302
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !301
  br i1 %29, label %61, label %30, !dbg !301

; <label>:30:                                     ; preds = %28
  %31 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %4, i64 0, i32 2
  %32 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %4, i64 0, i32 0
  %33 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %4, i64 0, i32 6
  br label %34, !dbg !301

; <label>:34:                                     ; preds = %30, %58
  %35 = phi i64 [ 0, %30 ], [ %59, %58 ]
  %36 = getelementptr inbounds i8, i8* %1, i64 %35, !dbg !303
  %37 = load i8, i8* %36, align 1, !dbg !303, !tbaa !306
  %38 = sext i8 %37 to i32, !dbg !303
  %39 = load i32, i32* %31, align 4, !dbg !318, !tbaa !320
  %40 = add nsw i32 %39, -1, !dbg !318
  store i32 %40, i32* %31, align 4, !dbg !318, !tbaa !320
  %41 = icmp sgt i32 %39, 0, !dbg !321
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !322
  br i1 %41, label %48, label %42, !dbg !322

; <label>:42:                                     ; preds = %34
  %43 = load i32, i32* %33, align 8, !dbg !323, !tbaa !324
  %44 = icmp sgt i32 %39, %43, !dbg !325
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !326
  br i1 %44, label %45, label %51, !dbg !326

; <label>:45:                                     ; preds = %42
  %46 = and i32 %38, 255, !dbg !327
  %47 = icmp eq i32 %46, 10, !dbg !327
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !328
  br i1 %47, label %51, label %48, !dbg !328

; <label>:48:                                     ; preds = %45, %34
  %49 = load i8*, i8** %32, align 8, !dbg !329, !tbaa !330
  %50 = getelementptr inbounds i8, i8* %49, i64 1, !dbg !329
  store i8* %50, i8** %32, align 8, !dbg !329, !tbaa !330
  store i8 %37, i8* %49, align 1, !dbg !331, !tbaa !306
...
; <label>:51:                                     ; preds = %42, %45
  %52 = call i32 @__swbuf_r(%struct._reent* %0, i32 %38, %struct.__sFILE* nonnull %4) #4, !dbg !335
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !336
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !333
  %53 = icmp eq i32 %52, -1, !dbg !337
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !334
  br i1 %53, label %54, label %58, !dbg !334

; <label>:54:                                     ; preds = %51
  %55 = icmp eq i8 %37, 10, !dbg !338
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !341
  br i1 %55, label %56, label %61, !dbg !341

; <label>:56:                                     ; preds = %54
  %57 = add i64 %35, 1, !dbg !342
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !343
  br label %61, !dbg !343

; <label>:58:                                     ; preds = %48, %51
  %59 = add nuw i64 %35, 1, !dbg !344
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !301
  %60 = icmp ult i64 %59, %7, !dbg !302
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !301
  br i1 %60, label %34, label %61, !dbg !301, !llvm.loop !345

; <label>:61:                                     ; preds = %58, %28, %25, %56, %54
  %62 = phi i64 [ 0, %25 ], [ %57, %56 ], [ %35, %54 ], [ 0, %28 ], [ %59, %58 ], !dbg !347
  %63 = load i32, i32* %6, align 4, !dbg !348, !tbaa !349
  %64 = call i32 @pthread_setcancelstate(i32 %63, i32* nonnull %6) #4, !dbg !348
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %15) #5, !dbg !350
  %65 = udiv i64 %62, %2, !dbg !351
...
; Function Attrs: noredzone nounwind
define dso_local i64 @fwrite(i8* noalias nocapture readonly, i64, i64, %struct.__sFILE*) local_unnamed_addr #0 !dbg !353 {
  %5 = tail call %struct._reent* @__getreent() #4, !dbg !362
  %6 = tail call i64 @_fwrite_r(%struct._reent* %5, i8* %0, i64 %1, i64 %2, %struct.__sFILE* %3) #6, !dbg !363
...
!299 = !{!294, !286, i64 24}
!300 = !DILocation(line: 186, column: 7, scope: !272)
!301 = !DILocation(line: 189, column: 3, scope: !272)
!302 = !DILocation(line: 189, column: 12, scope: !272)
...
!326 = !DILocation(line: 692, column: 47, scope: !319, inlinedAt: !315)
!327 = !DILocation(line: 692, column: 59, scope: !319, inlinedAt: !315)
!328 = !DILocation(line: 692, column: 6, scope: !308, inlinedAt: !315)
!329 = !DILocation(line: 693, column: 18, scope: !319, inlinedAt: !315)
!330 = !{!294, !286, i64 0}
!331 = !DILocation(line: 693, column: 21, scope: !319, inlinedAt: !315)
!332 = !DILocation(line: 693, column: 3, scope: !319, inlinedAt: !315)
!333 = !DILocation(line: 696, column: 1, scope: !308, inlinedAt: !315)
!334 = !DILocation(line: 191, column: 11, scope: !305)
!335 = !DILocation(line: 695, column: 11, scope: !319, inlinedAt: !315)
!336 = !DILocation(line: 695, column: 3, scope: !319, inlinedAt: !315)
!337 = !DILocation(line: 191, column: 37, scope: !304)
!338 = !DILocation(line: 192, column: 12, scope: !339)
!339 = distinct !DILexicalBlock(scope: !340, file: !1, line: 192, column: 7)
!340 = distinct !DILexicalBlock(scope: !304, file: !1, line: 191, column: 45)
!341 = !DILocation(line: 192, column: 7, scope: !340)
!342 = !DILocation(line: 193, column: 5, scope: !339)
!343 = !DILocation(line: 193, column: 4, scope: !339)
!344 = !DILocation(line: 197, column: 8, scope: !305)
!345 = distinct !{!345, !301, !346}
!346 = !DILocation(line: 198, column: 5, scope: !272)
!347 = !DILocation(line: 0, scope: !28)
!348 = !DILocation(line: 201, column: 3, scope: !272)
!349 = !{!283, !283, i64 0}
!350 = !DILocation(line: 201, column: 3, scope: !28)
!351 = !DILocation(line: 202, column: 12, scope: !28)
!352 = !DILocation(line: 202, column: 3, scope: !28)
!353 = distinct !DISubprogram(name: "fwrite", scope: !1, file: !1, line: 208, type: !354, isLocal: false, isDefinition: true, scopeLine: 213, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !356)
!354 = !DISubroutineType(types: !355)
!355 = !{!31, !250, !253, !253, !257}
!356 = !{!357, !358, !359, !360}
!357 = !DILocalVariable(name: "buf", arg: 1, scope: !353, file: !1, line: 208, type: !250)
!358 = !DILocalVariable(name: "size", arg: 2, scope: !353, file: !1, line: 208, type: !253)
!359 = !DILocalVariable(name: "count", arg: 3, scope: !353, file: !1, line: 208, type: !253)
!360 = !DILocalVariable(name: "fp", arg: 4, scope: !353, file: !1, line: 208, type: !257)
!361 = !DILocation(line: 208, column: 1, scope: !353)
!362 = !DILocation(line: 214, column: 21, scope: !353)
!363 = !DILocation(line: 214, column: 10, scope: !353)
!364 = !DILocation(line: 214, column: 3, scope: !353)
