...
; <label>:4:                                      ; preds = %2
  ...
  %6 = icmp eq %struct.pthread_mutexattr_t_* %5, null, !dbg !37
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !38
  br i1 %6, label %11, label %7, !dbg !38

; <label>:7:                                      ; preds = %4
  %8 = icmp ult i32 %1, 3, !dbg !39
...
; <label>:11:                                     ; preds = %2, %4, %7, %9
  %12 = phi i32 [ 0, %9 ], [ 22, %7 ], [ 22, %4 ], [ 22, %2 ], !dbg !48
...
!38 = !DILocation(line: 129, column: 7, scope: !9)
!39 = !DILocation(line: 131, column: 7, scope: !40)
!40 = distinct !DILexicalBlock(scope: !30, file: !1, line: 130, column: 5)
!41 = !DILocation(line: 136, column: 20, scope: !42)
!42 = distinct !DILexicalBlock(scope: !40, file: !1, line: 132, column: 9)
