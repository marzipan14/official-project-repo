...
; <label>:7:                                      ; preds = %2
  ...
  br i1 %9, label %10, label %89, !dbg !542
...
; <label>:17:                                     ; preds = %12
  ...
  br i1 %20, label %89, label %21, !dbg !556
...
; <label>:25:                                     ; preds = %21, %35
  ...
  br i1 %27, label %89, label %28, !dbg !560
...
; <label>:35:                                     ; preds = %30, %32
  ...
  store volatile i32 42, i32* @__A_VARIABLE, align 4
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %23) #5, !dbg !595
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !596
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !597
  br i1 %37, label %89, label %25, !dbg !597, !llvm.loop !598

; <label>:38:                                     ; preds = %12
  %39 = tail call { i8*, i32 } @pthread_self() #4, !dbg !600
  %40 = extractvalue { i8*, i32 } %39, 0, !dbg !600
  %41 = extractvalue { i8*, i32 } %39, 1, !dbg !600
  %42 = getelementptr inbounds %struct.pthread_mutex_t_, %struct.pthread_mutex_t_* %13, i64 0, i32 1, !dbg !602
  %43 = load i32, i32* %42, align 8, !dbg !602, !tbaa !603
  %44 = cmpxchg i32* %42, i32 0, i32 1 seq_cst seq_cst, !dbg !604
  %45 = extractvalue { i32, i1 } %44, 1, !dbg !604
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !604
  br i1 %45, label %47, label %46, !dbg !604
...
; <label>:47:                                     ; preds = %46, %38
  %48 = icmp eq i32 %43, 0, !dbg !605
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !606
  br i1 %48, label %49, label %53, !dbg !606

; <label>:49:                                     ; preds = %47
  %50 = getelementptr inbounds %struct.pthread_mutex_t_, %struct.pthread_mutex_t_* %13, i64 0, i32 2, !dbg !607
  store i32 1, i32* %50, align 4, !dbg !609, !tbaa !610
  %51 = getelementptr inbounds %struct.pthread_mutex_t_, %struct.pthread_mutex_t_* %13, i64 0, i32 4, i32 0, !dbg !611
  store i8* %40, i8** %51, align 8, !dbg !611
  %52 = getelementptr inbounds %struct.pthread_mutex_t_, %struct.pthread_mutex_t_* %13, i64 0, i32 4, i32 1, !dbg !611
  store i32 %41, i32* %52, align 8, !dbg !611
  br label %88, !dbg !612

; <label>:53:                                     ; preds = %47
  %54 = getelementptr inbounds %struct.pthread_mutex_t_, %struct.pthread_mutex_t_* %13, i64 0, i32 4, i32 0, !dbg !613
  %55 = load i8*, i8** %54, align 8, !dbg !613
  %56 = getelementptr inbounds %struct.pthread_mutex_t_, %struct.pthread_mutex_t_* %13, i64 0, i32 4, i32 1, !dbg !613
  %57 = load i32, i32* %56, align 8, !dbg !613
  %58 = tail call i32 @pthread_equal(i8* %55, i32 %57, i8* %40, i32 %41) #4, !dbg !613
  %59 = icmp eq i32 %58, 0, !dbg !613
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !616
  br i1 %59, label %60, label %64, !dbg !616

; <label>:60:                                     ; preds = %53
  %61 = getelementptr inbounds %struct.pthread_mutex_t_, %struct.pthread_mutex_t_* %13, i64 0, i32 0
  %62 = bitcast i32* %3 to i8*
  %63 = icmp eq %struct.timespec* %1, null
  br label %71, !dbg !617

; <label>:64:                                     ; preds = %53
  %65 = load i32, i32* %14, align 8, !dbg !619, !tbaa !546
  %66 = icmp eq i32 %65, 1, !dbg !622
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !623
  br i1 %66, label %67, label %86, !dbg !623

; <label>:67:                                     ; preds = %64
  %68 = getelementptr inbounds %struct.pthread_mutex_t_, %struct.pthread_mutex_t_* %13, i64 0, i32 2, !dbg !624
  %69 = load i32, i32* %68, align 4, !dbg !626, !tbaa !610
  %70 = add nsw i32 %69, 1, !dbg !626
  store i32 %70, i32* %68, align 4, !dbg !626, !tbaa !610
  br label %88, !dbg !627

; <label>:71:                                     ; preds = %60, %81
  %72 = atomicrmw xchg i32* %42, i32 -1 seq_cst, !dbg !617
  %73 = icmp eq i32 %72, 0, !dbg !628
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !629
  br i1 %73, label %84, label %74, !dbg !629

; <label>:74:                                     ; preds = %71
  %75 = load %struct.uk_semaphore*, %struct.uk_semaphore** %61, align 8, !dbg !630, !tbaa !564
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %62) #5, !dbg !636
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !637
  br i1 %63, label %76, label %78, !dbg !637

; <label>:76:                                     ; preds = %74
  %77 = call i32 @pte_osSemaphorePend(%struct.uk_semaphore* %75, i32* null) #4, !dbg !638
  br label %81, !dbg !640

; <label>:78:                                     ; preds = %74
  %79 = call i32 @pte_relmillisecs(%struct.timespec* nonnull %1) #4, !dbg !641
  store i32 %79, i32* %3, align 4, !dbg !643, !tbaa !589
  %80 = call i32 @pte_osSemaphorePend(%struct.uk_semaphore* %75, i32* nonnull %3) #4, !dbg !644
  br label %81

; <label>:81:                                     ; preds = %76, %78
  %82 = phi i32 [ %77, %76 ], [ %80, %78 ], !dbg !645
  store volatile i32 42, i32* @__A_VARIABLE, align 4
  %83 = icmp eq i32 %82, 3, !dbg !646
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !647
  store volatile i32 42, i32* @__A_VARIABLE, align 4
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %62) #5, !dbg !648
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !649
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !650
  br i1 %83, label %86, label %71, !dbg !650, !llvm.loop !651

; <label>:84:                                     ; preds = %71
  %85 = getelementptr inbounds %struct.pthread_mutex_t_, %struct.pthread_mutex_t_* %13, i64 0, i32 2, !dbg !653
  store i32 1, i32* %85, align 4, !dbg !654, !tbaa !610
  store i8* %40, i8** %54, align 8, !dbg !655
  store i32 %41, i32* %56, align 8, !dbg !655
  br label %88

; <label>:86:                                     ; preds = %81, %64
  %87 = phi i32 [ 45, %64 ], [ 116, %81 ]
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !656
  br label %89

; <label>:88:                                     ; preds = %49, %84, %67
  store volatile i32 42, i32* @__A_VARIABLE, align 4
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !658
  store volatile i32 42, i32* @__A_VARIABLE, align 4
  br label %89

; <label>:89:                                     ; preds = %25, %35, %17, %88, %7, %86
  %90 = phi i32 [ %87, %86 ], [ %8, %7 ], [ 0, %88 ], [ 0, %17 ], [ 0, %25 ], [ 116, %35 ]
  store volatile i32 42, i32* @__A_VARIABLE, align 4
...
!594 = !DILocation(line: 96, column: 7, scope: !566, inlinedAt: !576)
!595 = !DILocation(line: 107, column: 1, scope: !566, inlinedAt: !576)
!596 = !DILocation(line: 105, column: 3, scope: !566, inlinedAt: !576)
!597 = !DILocation(line: 143, column: 19, scope: !563)
!598 = distinct !{!598, !560, !599}
!599 = !DILocation(line: 147, column: 13, scope: !558)
!600 = !DILocation(line: 152, column: 24, scope: !520)
!601 = !DILocation(line: 152, column: 17, scope: !520)
!602 = !DILocation(line: 154, column: 11, scope: !523)
!603 = !{!547, !548, i64 8}
!604 = !DILocation(line: 154, column: 11, scope: !526)
!605 = !DILocation(line: 154, column: 58, scope: !524)
!606 = !DILocation(line: 154, column: 11, scope: !520)
!607 = !DILocation(line: 156, column: 15, scope: !608)
!608 = distinct !DILexicalBlock(scope: !524, file: !1, line: 155, column: 9)
!609 = !DILocation(line: 156, column: 31, scope: !608)
!610 = !{!547, !548, i64 12}
!611 = !DILocation(line: 157, column: 29, scope: !608)
!612 = !DILocation(line: 158, column: 9, scope: !608)
!613 = !DILocation(line: 161, column: 15, scope: !614)
!614 = distinct !DILexicalBlock(scope: !615, file: !1, line: 161, column: 15)
!615 = distinct !DILexicalBlock(scope: !524, file: !1, line: 160, column: 9)
!616 = !DILocation(line: 161, column: 15, scope: !615)
!617 = !DILocation(line: 174, column: 22, scope: !618)
!618 = distinct !DILexicalBlock(scope: !614, file: !1, line: 173, column: 13)
!619 = !DILocation(line: 163, column: 23, scope: !620)
!620 = distinct !DILexicalBlock(scope: !621, file: !1, line: 163, column: 19)
!621 = distinct !DILexicalBlock(scope: !614, file: !1, line: 162, column: 13)
!622 = !DILocation(line: 163, column: 28, scope: !620)
!623 = !DILocation(line: 163, column: 19, scope: !621)
!624 = !DILocation(line: 165, column: 23, scope: !625)
!625 = distinct !DILexicalBlock(scope: !620, file: !1, line: 164, column: 17)
!626 = !DILocation(line: 165, column: 38, scope: !625)
!627 = !DILocation(line: 171, column: 13, scope: !621)
!628 = !DILocation(line: 174, column: 60, scope: !618)
!629 = !DILocation(line: 174, column: 15, scope: !618)
!630 = !DILocation(line: 176, column: 63, scope: !631)
!631 = distinct !DILexicalBlock(scope: !632, file: !1, line: 176, column: 23)
!632 = distinct !DILexicalBlock(scope: !618, file: !1, line: 175, column: 17)
!633 = !DILocation(line: 53, column: 44, scope: !566, inlinedAt: !634)
!634 = distinct !DILocation(line: 176, column: 38, scope: !631)
!635 = !DILocation(line: 53, column: 74, scope: !566, inlinedAt: !634)
!636 = !DILocation(line: 77, column: 3, scope: !566, inlinedAt: !634)
!637 = !DILocation(line: 81, column: 7, scope: !566, inlinedAt: !634)
!638 = !DILocation(line: 83, column: 16, scope: !581, inlinedAt: !634)
!639 = !DILocation(line: 78, column: 16, scope: !566, inlinedAt: !634)
!640 = !DILocation(line: 84, column: 5, scope: !581, inlinedAt: !634)
!641 = !DILocation(line: 90, column: 22, scope: !586, inlinedAt: !634)
!642 = !DILocation(line: 77, column: 16, scope: !566, inlinedAt: !634)
!643 = !DILocation(line: 90, column: 20, scope: !586, inlinedAt: !634)
!644 = !DILocation(line: 92, column: 16, scope: !586, inlinedAt: !634)
!645 = !DILocation(line: 0, scope: !586, inlinedAt: !634)
!646 = !DILocation(line: 96, column: 14, scope: !593, inlinedAt: !634)
!647 = !DILocation(line: 96, column: 7, scope: !566, inlinedAt: !634)
!648 = !DILocation(line: 107, column: 1, scope: !566, inlinedAt: !634)
!649 = !DILocation(line: 105, column: 3, scope: !566, inlinedAt: !634)
!650 = !DILocation(line: 176, column: 23, scope: !632)
!651 = distinct !{!651, !629, !652}
!652 = !DILocation(line: 180, column: 17, scope: !618)
!653 = !DILocation(line: 182, column: 19, scope: !618)
!654 = !DILocation(line: 182, column: 35, scope: !618)
!655 = !DILocation(line: 183, column: 33, scope: !618)
!656 = !DILocation(line: 0, scope: !657)
!657 = distinct !DILexicalBlock(scope: !631, file: !1, line: 177, column: 21)
!658 = !DILocation(line: 186, column: 5, scope: !521)
!659 = !DILocation(line: 189, column: 1, scope: !502)
