; ModuleID = '/root/.unikraft/apps/redis/build/libpthread-embedded/origin/pthread-embedded-44b41d760a433915d70a7be9809651b0a65e001d/pthread_rwlock_init.c'
source_filename = "/root/.unikraft/apps/redis/build/libpthread-embedded/origin/pthread-embedded-44b41d760a433915d70a7be9809651b0a65e001d/pthread_rwlock_init.c"
...
define dso_local i32 @pthread_rwlock_init(%struct.pthread_rwlock_t_**, %struct.pthread_rwlockattr_t_** readonly) local_unnamed_addr #0 !dbg !513 {
  %3 = icmp eq %struct.pthread_rwlock_t_** %0, null, !dbg !532
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !534
  br i1 %3, label %46, label %4, !dbg !534

; <label>:4:                                      ; preds = %2
  %5 = icmp eq %struct.pthread_rwlockattr_t_** %1, null, !dbg !535
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !537
  br i1 %5, label %9, label %6, !dbg !537

; <label>:6:                                      ; preds = %4
  %7 = load %struct.pthread_rwlockattr_t_*, %struct.pthread_rwlockattr_t_** %1, align 8, !dbg !538, !tbaa !539
  %8 = icmp eq %struct.pthread_rwlockattr_t_* %7, null, !dbg !543
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !544
  br i1 %8, label %9, label %43, !dbg !544

; <label>:9:                                      ; preds = %6, %4
  %10 = tail call i8* @calloc(i64 1, i64 40) #3, !dbg !545
  %11 = bitcast i8* %10 to %struct.pthread_rwlock_t_*, !dbg !546
  %12 = icmp eq i8* %10, null, !dbg !547
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !549
  br i1 %12, label %43, label %13, !dbg !549

; <label>:13:                                     ; preds = %9
  %14 = getelementptr inbounds i8, i8* %10, i64 24, !dbg !550
  %15 = bitcast i8* %14 to i32*, !dbg !550
  store i32 0, i32* %15, align 8, !dbg !551, !tbaa !552
  %16 = getelementptr inbounds i8, i8* %10, i64 28, !dbg !555
  %17 = bitcast i8* %16 to i32*, !dbg !555
  store i32 0, i32* %17, align 4, !dbg !556, !tbaa !557
  %18 = getelementptr inbounds i8, i8* %10, i64 32, !dbg !558
  %19 = bitcast i8* %18 to i32*, !dbg !558
  store i32 0, i32* %19, align 8, !dbg !559, !tbaa !560
  %20 = bitcast i8* %10 to %struct.pthread_mutex_t_**, !dbg !561
  %21 = tail call i32 @pthread_mutex_init(%struct.pthread_mutex_t_** %20, %struct.pthread_mutexattr_t_** null) #3, !dbg !562
  %22 = icmp eq i32 %21, 0, !dbg !564
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !566
  br i1 %22, label %23, label %41, !dbg !566

; <label>:23:                                     ; preds = %13
  %24 = getelementptr inbounds i8, i8* %10, i64 8, !dbg !567
  %25 = bitcast i8* %24 to %struct.pthread_mutex_t_**, !dbg !567
  %26 = tail call i32 @pthread_mutex_init(%struct.pthread_mutex_t_** nonnull %25, %struct.pthread_mutexattr_t_** null) #3, !dbg !568
  %27 = icmp eq i32 %26, 0, !dbg !569
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !571
  br i1 %27, label %28, label %38, !dbg !571

; <label>:28:                                     ; preds = %23
  %29 = getelementptr inbounds i8, i8* %10, i64 16, !dbg !572
  %30 = bitcast i8* %29 to %struct.pthread_cond_t_**, !dbg !572
  %31 = tail call i32 @pthread_cond_init(%struct.pthread_cond_t_** nonnull %30, %struct.pthread_condattr_t_** null) #3, !dbg !573
  %32 = icmp eq i32 %31, 0, !dbg !574
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !576
  br i1 %32, label %33, label %36, !dbg !576

; <label>:33:                                     ; preds = %28
  %34 = getelementptr inbounds i8, i8* %10, i64 36, !dbg !577
  %35 = bitcast i8* %34 to i32*, !dbg !577
  store i32 262974946, i32* %35, align 4, !dbg !578, !tbaa !579
  br label %43, !dbg !580

; <label>:36:                                     ; preds = %28
  %37 = tail call i32 @pthread_mutex_destroy(%struct.pthread_mutex_t_** nonnull %25) #3, !dbg !581
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !582
  br label %38, !dbg !582

; <label>:38:                                     ; preds = %23, %36
  %39 = phi i32 [ %26, %23 ], [ %31, %36 ], !dbg !583
  %40 = tail call i32 @pthread_mutex_destroy(%struct.pthread_mutex_t_** %20) #3, !dbg !584
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !585
  br label %41, !dbg !585

; <label>:41:                                     ; preds = %13, %38
  %42 = phi i32 [ %21, %13 ], [ %39, %38 ], !dbg !583
  tail call void @free(i8* nonnull %10) #3, !dbg !586
  br label %43, !dbg !587

; <label>:43:                                     ; preds = %9, %6, %41, %33
  %44 = phi i32 [ %42, %41 ], [ 0, %33 ], [ 22, %6 ], [ 12, %9 ], !dbg !583
  %45 = phi %struct.pthread_rwlock_t_* [ null, %41 ], [ %11, %33 ], [ null, %6 ], [ %11, %9 ], !dbg !583
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !588
  store %struct.pthread_rwlock_t_* %45, %struct.pthread_rwlock_t_** %0, align 8, !dbg !590, !tbaa !539
  br label %46, !dbg !591

; <label>:46:                                     ; preds = %2, %43
  %47 = phi i32 [ %44, %43 ], [ 22, %2 ], !dbg !583
...
!1 = !DIFile(filename: "/root/.unikraft/apps/redis/build/libpthread-embedded/origin/pthread-embedded-44b41d760a433915d70a7be9809651b0a65e001d/pthread_rwlock_init.c", directory: "/root/.unikraft/apps/redis/build")
!2 = !{!3}
...
!513 = distinct !DISubprogram(name: "pthread_rwlock_init", scope: !1, file: !1, line: 51, type: !514, isLocal: false, isDefinition: true, scopeLine: 53, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !524)
...
!519 = !DIDerivedType(tag: DW_TAG_typedef, name: "pthread_rwlockattr_t", file: !13, line: 422, baseType: !520)
!520 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !521, size: 64)
!521 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "pthread_rwlockattr_t_", file: !16, line: 270, size: 32, elements: !522)
!522 = !{!523}
!523 = !DIDerivedType(tag: DW_TAG_member, name: "pshared", scope: !521, file: !16, line: 272, baseType: !41, size: 32)
!524 = !{!525, !526, !527, !528}
!525 = !DILocalVariable(name: "rwlock", arg: 1, scope: !513, file: !1, line: 51, type: !516)
!526 = !DILocalVariable(name: "attr", arg: 2, scope: !513, file: !1, line: 52, type: !517)
!527 = !DILocalVariable(name: "result", scope: !513, file: !1, line: 54, type: !41)
!528 = !DILocalVariable(name: "rwl", scope: !513, file: !1, line: 55, type: !12)
!529 = !DILocation(line: 51, column: 41, scope: !513)
!530 = !DILocation(line: 52, column: 51, scope: !513)
!531 = !DILocation(line: 55, column: 20, scope: !513)
!532 = !DILocation(line: 57, column: 14, scope: !533)
!533 = distinct !DILexicalBlock(scope: !513, file: !1, line: 57, column: 7)
!534 = !DILocation(line: 57, column: 7, scope: !513)
!535 = !DILocation(line: 62, column: 12, scope: !536)
!536 = distinct !DILexicalBlock(scope: !513, file: !1, line: 62, column: 7)
!537 = !DILocation(line: 62, column: 20, scope: !536)
!538 = !DILocation(line: 62, column: 23, scope: !536)
!539 = !{!540, !540, i64 0}
!540 = !{!"any pointer", !541, i64 0}
!541 = !{!"omnipotent char", !542, i64 0}
!542 = !{!"Simple C/C++ TBAA"}
!543 = !DILocation(line: 62, column: 29, scope: !536)
!544 = !DILocation(line: 62, column: 7, scope: !513)
!545 = !DILocation(line: 68, column: 28, scope: !513)
!546 = !DILocation(line: 68, column: 9, scope: !513)
!547 = !DILocation(line: 70, column: 11, scope: !548)
!548 = distinct !DILexicalBlock(scope: !513, file: !1, line: 70, column: 7)
!549 = !DILocation(line: 70, column: 7, scope: !513)
!550 = !DILocation(line: 76, column: 8, scope: !513)
!551 = !DILocation(line: 76, column: 27, scope: !513)
!552 = !{!553, !554, i64 24}
!553 = !{!"pthread_rwlock_t_", !540, i64 0, !540, i64 8, !540, i64 16, !554, i64 24, !554, i64 28, !554, i64 32, !554, i64 36}
!554 = !{!"int", !541, i64 0}
!555 = !DILocation(line: 77, column: 8, scope: !513)
!556 = !DILocation(line: 77, column: 30, scope: !513)
!557 = !{!553, !554, i64 28}
!558 = !DILocation(line: 78, column: 8, scope: !513)
!559 = !DILocation(line: 78, column: 36, scope: !513)
!560 = !{!553, !554, i64 32}
!561 = !DILocation(line: 80, column: 38, scope: !513)
!562 = !DILocation(line: 80, column: 12, scope: !513)
!563 = !DILocation(line: 54, column: 7, scope: !513)
!564 = !DILocation(line: 81, column: 14, scope: !565)
!565 = distinct !DILexicalBlock(scope: !513, file: !1, line: 81, column: 7)
!566 = !DILocation(line: 81, column: 7, scope: !513)
!567 = !DILocation(line: 86, column: 38, scope: !513)
!568 = !DILocation(line: 86, column: 12, scope: !513)
!569 = !DILocation(line: 87, column: 14, scope: !570)
!570 = distinct !DILexicalBlock(scope: !513, file: !1, line: 87, column: 7)
!571 = !DILocation(line: 87, column: 7, scope: !513)
!572 = !DILocation(line: 92, column: 37, scope: !513)
!573 = !DILocation(line: 92, column: 12, scope: !513)
!574 = !DILocation(line: 93, column: 14, scope: !575)
!575 = distinct !DILexicalBlock(scope: !513, file: !1, line: 93, column: 7)
!576 = !DILocation(line: 93, column: 7, scope: !513)
!577 = !DILocation(line: 98, column: 8, scope: !513)
!578 = !DILocation(line: 98, column: 15, scope: !513)
!579 = !{!553, !554, i64 36}
!580 = !DILocation(line: 101, column: 3, scope: !513)
!581 = !DILocation(line: 104, column: 10, scope: !513)
!582 = !DILocation(line: 104, column: 3, scope: !513)
!583 = !DILocation(line: 0, scope: !513)
!584 = !DILocation(line: 107, column: 10, scope: !513)
!585 = !DILocation(line: 107, column: 3, scope: !513)
!586 = !DILocation(line: 110, column: 10, scope: !513)
!587 = !DILocation(line: 111, column: 3, scope: !513)
!588 = !DILocation(line: 0, scope: !589)
!589 = distinct !DILexicalBlock(scope: !536, file: !1, line: 63, column: 5)
!590 = !DILocation(line: 114, column: 11, scope: !513)
!591 = !DILocation(line: 116, column: 3, scope: !513)
!592 = !DILocation(line: 0, scope: !593)
!593 = distinct !DILexicalBlock(scope: !533, file: !1, line: 58, column: 5)
!594 = !DILocation(line: 117, column: 1, scope: !513)
