...
define dso_local i32 @getw(%struct.__sFILE*) local_unnamed_addr #0 !dbg !10 {
  ...
  %6 = load i32, i32* %2, align 4, !dbg !243
  %7 = select i1 %5, i32 %6, i32 -1, !dbg !242
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !245
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %3) #4, !dbg !246
...
!242 = !DILocation(line: 66, column: 7, scope: !10)
!243 = !DILocation(line: 68, column: 10, scope: !10)
!244 = !DILocation(line: 65, column: 7, scope: !10)
!245 = !DILocation(line: 0, scope: !240)
!246 = !DILocation(line: 69, column: 1, scope: !10)
