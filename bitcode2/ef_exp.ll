...
; <label>:47:                                     ; preds = %19
  ...
  br i1 %48, label %49, label %54, !dbg !137

; <label>:49:                                     ; preds = %47
  %50 = fadd float %0, 0x46293E5940000000, !dbg !138
  %51 = fcmp ogt float %50, 1.000000e+00, !dbg !141
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !142
  br i1 %51, label %52, label %54, !dbg !142

; <label>:52:                                     ; preds = %49
  %53 = fadd float %0, 1.000000e+00, !dbg !143
  br label %93, !dbg !144

; <label>:54:                                     ; preds = %47, %49, %41
  %55 = phi i32 [ %42, %41 ], [ 0, %49 ], [ 0, %47 ], !dbg !145
  %56 = phi float [ %43, %41 ], [ undef, %49 ], [ undef, %47 ]
  %57 = phi float [ %45, %41 ], [ undef, %49 ], [ undef, %47 ]
  %58 = phi float [ %46, %41 ], [ %0, %49 ], [ %0, %47 ]
  %59 = fmul float %58, %58, !dbg !146
  %60 = fmul float %59, 0x3E66376980000000, !dbg !147
  %61 = fadd float %60, 0xBEBBBD41C0000000, !dbg !148
  %62 = fmul float %59, %61, !dbg !149
  %63 = fadd float %62, 0x3F11566AA0000000, !dbg !150
  %64 = fmul float %59, %63, !dbg !151
  %65 = fadd float %64, 0xBF66C16C20000000, !dbg !152
  %66 = fmul float %59, %65, !dbg !153
  %67 = fadd float %66, 0x3FC5555560000000, !dbg !154
  %68 = fmul float %59, %67, !dbg !155
  %69 = fsub float %58, %68, !dbg !156
  %70 = icmp eq i32 %55, 0, !dbg !158
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !160
  %71 = fmul float %58, %69, !dbg !161
  br i1 %70, label %72, label %77, !dbg !160

; <label>:72:                                     ; preds = %54
  %73 = fadd float %69, -2.000000e+00, !dbg !162
  %74 = fdiv float %71, %73, !dbg !163
  %75 = fsub float %58, %74, !dbg !164
  %76 = fadd float %75, 1.000000e+00, !dbg !164
  br label %93, !dbg !165

; <label>:77:                                     ; preds = %54
  %78 = fsub float 2.000000e+00, %69, !dbg !166
  %79 = fdiv float %71, %78, !dbg !167
  %80 = fsub float %56, %79, !dbg !168
  %81 = fsub float %57, %80, !dbg !169
  %82 = fadd float %81, 1.000000e+00, !dbg !169
  %83 = icmp sgt i32 %55, -126, !dbg !171
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !172
  %84 = bitcast float %82 to i32, !dbg !173
  %85 = shl i32 %55, 23, !dbg !174
  %86 = add i32 %85, %84, !dbg !174
  br i1 %83, label %87, label %89, !dbg !172

; <label>:87:                                     ; preds = %77
  %88 = bitcast i32 %86 to float, !dbg !176
  br label %93

; <label>:89:                                     ; preds = %77
  %90 = add i32 %86, 838860800, !dbg !179
  %91 = bitcast i32 %90 to float, !dbg !179
  %92 = fmul float %91, 0x39B0000000000000, !dbg !180
  br label %93

; <label>:93:                                     ; preds = %15, %13, %89, %87, %72, %52, %10, %6
  %94 = phi float [ %7, %6 ], [ %12, %10 ], [ %76, %72 ], [ %88, %87 ], [ %92, %89 ], [ %53, %52 ], [ 0x7FF0000000000000, %13 ], [ 0.000000e+00, %15 ], !dbg !181
  store volatile i32 42, i32* @__A_VARIABLE, align 4
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !182
  ret float %94, !dbg !182
}
...
!137 = !DILocation(line: 79, column: 10, scope: !105)
!138 = !DILocation(line: 80, column: 13, scope: !139)
!139 = distinct !DILexicalBlock(scope: !140, file: !3, line: 80, column: 9)
!140 = distinct !DILexicalBlock(scope: !136, file: !3, line: 79, column: 28)
!141 = !DILocation(line: 80, column: 15, scope: !139)
!142 = !DILocation(line: 80, column: 9, scope: !140)
!143 = !DILocation(line: 80, column: 31, scope: !139)
!144 = !DILocation(line: 80, column: 21, scope: !139)
!145 = !DILocation(line: 0, scope: !38)
!146 = !DILocation(line: 84, column: 8, scope: !38)
!147 = !DILocation(line: 85, column: 36, scope: !38)
!148 = !DILocation(line: 85, column: 34, scope: !38)
!149 = !DILocation(line: 85, column: 30, scope: !38)
!150 = !DILocation(line: 85, column: 28, scope: !38)
!151 = !DILocation(line: 85, column: 24, scope: !38)
!152 = !DILocation(line: 85, column: 22, scope: !38)
!153 = !DILocation(line: 85, column: 18, scope: !38)
!154 = !DILocation(line: 85, column: 16, scope: !38)
!155 = !DILocation(line: 85, column: 12, scope: !38)
!156 = !DILocation(line: 85, column: 9, scope: !38)
!157 = !DILocation(line: 49, column: 16, scope: !38)
!158 = !DILocation(line: 86, column: 6, scope: !159)
!159 = distinct !DILexicalBlock(scope: !38, file: !3, line: 86, column: 5)
!160 = !DILocation(line: 86, column: 5, scope: !38)
!161 = !DILocation(line: 0, scope: !159)
!162 = !DILocation(line: 86, column: 32, scope: !159)
!163 = !DILocation(line: 86, column: 29, scope: !159)
!164 = !DILocation(line: 86, column: 22, scope: !159)
!165 = !DILocation(line: 86, column: 12, scope: !159)
!166 = !DILocation(line: 87, column: 39, scope: !159)
!167 = !DILocation(line: 87, column: 27, scope: !159)
!168 = !DILocation(line: 87, column: 21, scope: !159)
!169 = !DILocation(line: 87, column: 16, scope: !159)
!170 = !DILocation(line: 49, column: 8, scope: !38)
!171 = !DILocation(line: 88, column: 7, scope: !67)
!172 = !DILocation(line: 88, column: 5, scope: !38)
!173 = !DILocation(line: 0, scope: !75)
!174 = !DILocation(line: 0, scope: !77)
!175 = !DILocation(line: 89, column: 17, scope: !66)
!176 = !DILocation(line: 91, column: 6, scope: !71)
!177 = !DILocation(line: 95, column: 6, scope: !75)
!178 = !DILocation(line: 94, column: 17, scope: !73)
!179 = !DILocation(line: 96, column: 6, scope: !77)
!180 = !DILocation(line: 97, column: 14, scope: !73)
!181 = !DILocation(line: 0, scope: !139)
!182 = !DILocation(line: 99, column: 1, scope: !38)
