...
define dso_local i32 @_vsiprintf_r(%struct._reent*, i8*, i8*, %struct.__va_list_tag*) local_unnamed_addr #0 !dbg !34 {
  ...
  %6 = bitcast %struct.__sFILE* %5 to i8*, !dbg !296
  call void @llvm.lifetime.start.p0i8(i64 176, i8* nonnull %6) #5, !dbg !296
  %7 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %5, i64 0, i32 3, !dbg !297
  store i16 520, i16* %7, align 8, !dbg !298, !tbaa !261
  %8 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %5, i64 0, i32 0, !dbg !299
  store i8* %1, i8** %8, align 8, !dbg !300, !tbaa !273
  %9 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %5, i64 0, i32 5, i32 0, !dbg !301
  store i8* %1, i8** %9, align 8, !dbg !302, !tbaa !276
  %10 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %5, i64 0, i32 2, !dbg !303
  store i32 2147483647, i32* %10, align 4, !dbg !304, !tbaa !279
  %11 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %5, i64 0, i32 5, i32 1, !dbg !305
  store i32 2147483647, i32* %11, align 8, !dbg !306, !tbaa !282
  %12 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %5, i64 0, i32 4, !dbg !307
  store i16 -1, i16* %12, align 2, !dbg !308, !tbaa !285
  %13 = call i32 @_svfiprintf_r(%struct._reent* %0, %struct.__sFILE* nonnull %5, i8* %2, %struct.__va_list_tag* %3) #4, !dbg !310
  %14 = load i8*, i8** %8, align 8, !dbg !312, !tbaa !273
  store i8 0, i8* %14, align 1, !dbg !313, !tbaa !291
  call void @llvm.lifetime.end.p0i8(i64 176, i8* nonnull %6) #5, !dbg !314
...
!293 = !DILocation(line: 60, column: 3, scope: !34, inlinedAt: !257)
!294 = !DILocation(line: 39, column: 3, scope: !10)
!295 = !DILocation(line: 45, column: 1, scope: !34)
!296 = !DILocation(line: 52, column: 3, scope: !34)
!297 = !DILocation(line: 54, column: 5, scope: !34)
!298 = !DILocation(line: 54, column: 12, scope: !34)
!299 = !DILocation(line: 55, column: 19, scope: !34)
!300 = !DILocation(line: 55, column: 22, scope: !34)
!301 = !DILocation(line: 55, column: 9, scope: !34)
!302 = !DILocation(line: 55, column: 15, scope: !34)
!303 = !DILocation(line: 56, column: 19, scope: !34)
!304 = !DILocation(line: 56, column: 22, scope: !34)
!305 = !DILocation(line: 56, column: 9, scope: !34)
!306 = !DILocation(line: 56, column: 15, scope: !34)
!307 = !DILocation(line: 57, column: 5, scope: !34)
!308 = !DILocation(line: 57, column: 11, scope: !34)
!309 = !DILocation(line: 52, column: 8, scope: !34)
!310 = !DILocation(line: 58, column: 9, scope: !34)
!311 = !DILocation(line: 51, column: 7, scope: !34)
!312 = !DILocation(line: 59, column: 6, scope: !34)
!313 = !DILocation(line: 59, column: 9, scope: !34)
!314 = !DILocation(line: 61, column: 1, scope: !34)
!315 = !DILocation(line: 60, column: 3, scope: !34)
