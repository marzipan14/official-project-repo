...
define dso_local i32 @pthread_condattr_init(%struct.pthread_condattr_t_** nocapture) local_unnamed_addr #0 !dbg !20 {
  ...
  br i1 %3, label %4, label %5, !dbg !34
...
; <label>:5:                                      ; preds = %4, %1
  %6 = phi i32 [ 12, %4 ], [ 0, %1 ], !dbg !37
  %7 = bitcast %struct.pthread_condattr_t_** %0 to i8**, !dbg !38
  store i8* %2, i8** %7, align 8, !dbg !38, !tbaa !39
...
!35 = !DILocation(line: 89, column: 5, scope: !36)
!36 = distinct !DILexicalBlock(scope: !33, file: !1, line: 87, column: 5)
!37 = !DILocation(line: 0, scope: !20)
!38 = !DILocation(line: 91, column: 9, scope: !20)
!39 = !{!40, !40, i64 0}
!40 = !{!"any pointer", !41, i64 0}
!41 = !{!"omnipotent char", !42, i64 0}
!42 = !{!"Simple C/C++ TBAA"}
!43 = !DILocation(line: 93, column: 3, scope: !20)
