...
; <label>:6:                                      ; preds = %3
  ...
  br i1 %9, label %10, label %22, !dbg !38
...
; <label>:20:                                     ; preds = %13, %19
  %21 = phi i8* [ null, %19 ], [ %11, %13 ]
  store volatile i32 42, i32* @__A_VARIABLE, align 4
  br label %22

; <label>:22:                                     ; preds = %20, %6
  %23 = phi i8* [ null, %6 ], [ %21, %20 ]
  store volatile i32 42, i32* @__A_VARIABLE, align 4
...
!47 = !DILocation(line: 49, column: 3, scope: !26)
!48 = !DILocation(line: 51, column: 1, scope: !7)
