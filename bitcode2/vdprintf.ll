; ModuleID = '/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/stdio/vdprintf.c'
source_filename = "/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/stdio/vdprintf.c"
...
define dso_local i32 @_vdprintf_r(%struct._reent*, i32, i8* noalias, %struct.__va_list_tag*) local_unnamed_addr #0 !dbg !7 {
  %5 = alloca [512 x i8], align 16
  %6 = alloca i64, align 8
  %7 = getelementptr inbounds [512 x i8], [512 x i8]* %5, i64 0, i64 0, !dbg !252
  call void @llvm.lifetime.start.p0i8(i64 512, i8* nonnull %7) #4, !dbg !252
  %8 = bitcast i64* %6 to i8*, !dbg !254
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %8) #4, !dbg !254
  store i64 512, i64* %6, align 8, !dbg !255, !tbaa !256
  %9 = call i8* @_vasnprintf_r(%struct._reent* %0, i8* nonnull %7, i64* nonnull %6, i8* %2, %struct.__va_list_tag* %3) #5, !dbg !260
  %10 = icmp eq i8* %9, null, !dbg !262
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !264
  br i1 %10, label %20, label %11, !dbg !264

; <label>:11:                                     ; preds = %4
  %12 = load i64, i64* %6, align 8, !dbg !265, !tbaa !256
  %13 = call i64 @_write_r(%struct._reent* %0, i32 %1, i8* nonnull %9, i64 %12) #5, !dbg !266
  store i64 %13, i64* %6, align 8, !dbg !267, !tbaa !256
  %14 = icmp eq i8* %9, %7, !dbg !268
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !270
  br i1 %14, label %17, label %15, !dbg !270

; <label>:15:                                     ; preds = %11
  call void @free(i8* nonnull %9) #5, !dbg !271
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !271
  %16 = load i64, i64* %6, align 8, !dbg !272, !tbaa !256
  br label %17, !dbg !271

; <label>:17:                                     ; preds = %11, %15
  %18 = phi i64 [ %13, %11 ], [ %16, %15 ], !dbg !272
  %19 = trunc i64 %18 to i32, !dbg !272
  br label %20, !dbg !273

; <label>:20:                                     ; preds = %4, %17
  %21 = phi i32 [ %19, %17 ], [ -1, %4 ], !dbg !274
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !274
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %8) #4, !dbg !275
  call void @llvm.lifetime.end.p0i8(i64 512, i8* nonnull %7) #4, !dbg !275
...
declare dso_local i8* @_vasnprintf_r(%struct._reent*, i8*, i64*, i8*, %struct.__va_list_tag*) local_unnamed_addr #3

; Function Attrs: noredzone
declare dso_local i64 @_write_r(%struct._reent*, i32, i8*, i64) local_unnamed_addr #3
...
; Function Attrs: noredzone nounwind
define dso_local i32 @vdprintf(i32, i8* noalias, %struct.__va_list_tag*) local_unnamed_addr #0 !dbg !276 {
  %4 = alloca [512 x i8], align 16
  %5 = alloca i64, align 8
  %6 = tail call %struct._reent* @__getreent() #5, !dbg !286
  %7 = getelementptr inbounds [512 x i8], [512 x i8]* %4, i64 0, i64 0, !dbg !288
  call void @llvm.lifetime.start.p0i8(i64 512, i8* nonnull %7) #4, !dbg !288, !noalias !289
  %8 = bitcast i64* %5 to i8*, !dbg !292
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %8) #4, !dbg !292, !noalias !289
  store i64 512, i64* %5, align 8, !dbg !293, !tbaa !256, !noalias !289
  %9 = call i8* @_vasnprintf_r(%struct._reent* %6, i8* nonnull %7, i64* nonnull %5, i8* %1, %struct.__va_list_tag* %2) #5, !dbg !294
  %10 = icmp eq i8* %9, null, !dbg !296
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !297
  br i1 %10, label %20, label %11, !dbg !297

; <label>:11:                                     ; preds = %3
  %12 = load i64, i64* %5, align 8, !dbg !298, !tbaa !256, !noalias !289
  %13 = call i64 @_write_r(%struct._reent* %6, i32 %0, i8* nonnull %9, i64 %12) #5, !dbg !299
  store i64 %13, i64* %5, align 8, !dbg !300, !tbaa !256, !noalias !289
  %14 = icmp eq i8* %9, %7, !dbg !301
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !302
  br i1 %14, label %17, label %15, !dbg !302

; <label>:15:                                     ; preds = %11
  call void @free(i8* nonnull %9) #5, !dbg !303
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !303
  %16 = load i64, i64* %5, align 8, !dbg !304, !tbaa !256, !noalias !289
  br label %17, !dbg !303

; <label>:17:                                     ; preds = %15, %11
  %18 = phi i64 [ %13, %11 ], [ %16, %15 ], !dbg !304
  %19 = trunc i64 %18 to i32, !dbg !304
  br label %20, !dbg !305

; <label>:20:                                     ; preds = %3, %17
  %21 = phi i32 [ %19, %17 ], [ -1, %3 ], !dbg !306
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !307
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %8) #4, !dbg !308, !noalias !289
  call void @llvm.lifetime.end.p0i8(i64 512, i8* nonnull %7) #4, !dbg !308, !noalias !289
...
!1 = !DIFile(filename: "/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/stdio/vdprintf.c", directory: "/root/.unikraft/apps/redis/build")
!2 = !{}
!3 = !{i32 2, !"Dwarf Version", i32 4}
!4 = !{i32 2, !"Debug Info Version", i32 3}
!5 = !{i32 1, !"wchar_size", i32 4}
!6 = !{!"clang version 7.0.1-8+deb10u2 (tags/RELEASE_701/final)"}
!7 = distinct !DISubprogram(name: "_vdprintf_r", scope: !1, file: !1, line: 16, type: !8, isLocal: false, isDefinition: true, scopeLine: 21, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !238)
...
!230 = !DIDerivedType(tag: DW_TAG_restrict_type, baseType: !50)
!231 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !232, size: 64)
!232 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "__va_list_tag", file: !1, size: 192, elements: !233)
!233 = !{!234, !235, !236, !237}
!234 = !DIDerivedType(tag: DW_TAG_member, name: "gp_offset", scope: !232, file: !1, baseType: !92, size: 32)
!235 = !DIDerivedType(tag: DW_TAG_member, name: "fp_offset", scope: !232, file: !1, baseType: !92, size: 32, offset: 32)
!236 = !DIDerivedType(tag: DW_TAG_member, name: "overflow_arg_area", scope: !232, file: !1, baseType: !36, size: 64, offset: 64)
!237 = !DIDerivedType(tag: DW_TAG_member, name: "reg_save_area", scope: !232, file: !1, baseType: !36, size: 64, offset: 128)
!238 = !{!239, !240, !241, !242, !243, !244, !248}
!239 = !DILocalVariable(name: "ptr", arg: 1, scope: !7, file: !1, line: 16, type: !11)
!240 = !DILocalVariable(name: "fd", arg: 2, scope: !7, file: !1, line: 16, type: !10)
!241 = !DILocalVariable(name: "format", arg: 3, scope: !7, file: !1, line: 16, type: !230)
!242 = !DILocalVariable(name: "ap", arg: 4, scope: !7, file: !1, line: 16, type: !231)
!243 = !DILocalVariable(name: "p", scope: !7, file: !1, line: 22, type: !44)
!244 = !DILocalVariable(name: "buf", scope: !7, file: !1, line: 23, type: !245)
!245 = !DICompositeType(tag: DW_TAG_array_type, baseType: !45, size: 4096, elements: !246)
!246 = !{!247}
!247 = !DISubrange(count: 512)
!248 = !DILocalVariable(name: "n", scope: !7, file: !1, line: 24, type: !249)
!249 = !DIDerivedType(tag: DW_TAG_typedef, name: "size_t", file: !91, line: 58, baseType: !250)
!250 = !DIBasicType(name: "long unsigned int", size: 64, encoding: DW_ATE_unsigned)
!251 = !DILocation(line: 16, column: 1, scope: !7)
!252 = !DILocation(line: 23, column: 3, scope: !7)
!253 = !DILocation(line: 23, column: 8, scope: !7)
!254 = !DILocation(line: 24, column: 3, scope: !7)
!255 = !DILocation(line: 24, column: 10, scope: !7)
!256 = !{!257, !257, i64 0}
!257 = !{!"long", !258, i64 0}
!258 = !{!"omnipotent char", !259, i64 0}
!259 = !{!"Simple C/C++ TBAA"}
!260 = !DILocation(line: 27, column: 7, scope: !7)
!261 = !DILocation(line: 22, column: 9, scope: !7)
!262 = !DILocation(line: 28, column: 8, scope: !263)
!263 = distinct !DILexicalBlock(scope: !7, file: !1, line: 28, column: 7)
!264 = !DILocation(line: 28, column: 7, scope: !7)
!265 = !DILocation(line: 30, column: 29, scope: !7)
!266 = !DILocation(line: 30, column: 7, scope: !7)
!267 = !DILocation(line: 30, column: 5, scope: !7)
!268 = !DILocation(line: 31, column: 9, scope: !269)
!269 = distinct !DILexicalBlock(scope: !7, file: !1, line: 31, column: 7)
!270 = !DILocation(line: 31, column: 7, scope: !7)
!271 = !DILocation(line: 32, column: 5, scope: !269)
!272 = !DILocation(line: 33, column: 10, scope: !7)
!273 = !DILocation(line: 33, column: 3, scope: !7)
!274 = !DILocation(line: 0, scope: !263)
!275 = !DILocation(line: 34, column: 1, scope: !7)
!276 = distinct !DISubprogram(name: "vdprintf", scope: !1, file: !1, line: 45, type: !277, isLocal: false, isDefinition: true, scopeLine: 49, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !279)
!277 = !DISubroutineType(types: !278)
!278 = !{!10, !10, !230, !231}
!279 = !{!280, !281, !282}
!280 = !DILocalVariable(name: "fd", arg: 1, scope: !276, file: !1, line: 45, type: !10)
!281 = !DILocalVariable(name: "format", arg: 2, scope: !276, file: !1, line: 45, type: !230)
!282 = !DILocalVariable(name: "ap", arg: 3, scope: !276, file: !1, line: 45, type: !231)
!283 = !DILocation(line: 23, column: 8, scope: !7, inlinedAt: !284)
!284 = distinct !DILocation(line: 50, column: 10, scope: !276)
!285 = !DILocation(line: 45, column: 1, scope: !276)
!286 = !DILocation(line: 50, column: 23, scope: !276)
!287 = !DILocation(line: 16, column: 1, scope: !7, inlinedAt: !284)
!288 = !DILocation(line: 23, column: 3, scope: !7, inlinedAt: !284)
!289 = !{!290}
!290 = distinct !{!290, !291, !"_vdprintf_r: argument 0"}
!291 = distinct !{!291, !"_vdprintf_r"}
!292 = !DILocation(line: 24, column: 3, scope: !7, inlinedAt: !284)
!293 = !DILocation(line: 24, column: 10, scope: !7, inlinedAt: !284)
!294 = !DILocation(line: 27, column: 7, scope: !7, inlinedAt: !284)
!295 = !DILocation(line: 22, column: 9, scope: !7, inlinedAt: !284)
!296 = !DILocation(line: 28, column: 8, scope: !263, inlinedAt: !284)
!297 = !DILocation(line: 28, column: 7, scope: !7, inlinedAt: !284)
!298 = !DILocation(line: 30, column: 29, scope: !7, inlinedAt: !284)
!299 = !DILocation(line: 30, column: 7, scope: !7, inlinedAt: !284)
!300 = !DILocation(line: 30, column: 5, scope: !7, inlinedAt: !284)
!301 = !DILocation(line: 31, column: 9, scope: !269, inlinedAt: !284)
!302 = !DILocation(line: 31, column: 7, scope: !7, inlinedAt: !284)
!303 = !DILocation(line: 32, column: 5, scope: !269, inlinedAt: !284)
!304 = !DILocation(line: 33, column: 10, scope: !7, inlinedAt: !284)
!305 = !DILocation(line: 33, column: 3, scope: !7, inlinedAt: !284)
!306 = !DILocation(line: 0, scope: !263, inlinedAt: !284)
!307 = !DILocation(line: 0, scope: !276)
!308 = !DILocation(line: 34, column: 1, scope: !7, inlinedAt: !284)
!309 = !DILocation(line: 50, column: 3, scope: !276)
