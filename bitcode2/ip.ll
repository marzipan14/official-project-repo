...
define dso_local i8* @ipaddr_ntoa(%struct.ip_addr*) local_unnamed_addr #0 !dbg !219 {
  ...
  br i1 %2, label %15, label %3, !dbg !229

; <label>:3:                                      ; preds = %1
  %4 = getelementptr inbounds %struct.ip_addr, %struct.ip_addr* %0, i64 0, i32 1, !dbg !232
  %5 = load i8, i8* %4, align 4, !dbg !232, !tbaa !233
  %6 = icmp eq i8 %5, 6, !dbg !232
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !237
  br i1 %6, label %7, label %10, !dbg !237

; <label>:7:                                      ; preds = %3
  %8 = getelementptr inbounds %struct.ip_addr, %struct.ip_addr* %0, i64 0, i32 0, i32 0, !dbg !238
  %9 = tail call i8* @ip6addr_ntoa(%struct.ip6_addr* nonnull %8) #3, !dbg !240
  br label %13, !dbg !241

; <label>:10:                                     ; preds = %3
  %11 = bitcast %struct.ip_addr* %0 to %struct.ip4_addr*, !dbg !242
  %12 = tail call i8* @ip4addr_ntoa(%struct.ip4_addr* %11) #3, !dbg !244
  br label %13, !dbg !245
...
; <label>:15:                                     ; preds = %13, %1
  %16 = phi i8* [ null, %1 ], [ %14, %13 ], !dbg !248
...
; Function Attrs: noredzone nounwind
define dso_local i8* @ipaddr_ntoa_r(%struct.ip_addr*, i8*, i32) local_unnamed_addr #0 !dbg !249 {
  %4 = icmp eq %struct.ip_addr* %0, null, !dbg !259
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !261
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !262
  br i1 %4, label %17, label %5, !dbg !261

; <label>:5:                                      ; preds = %3
  %6 = getelementptr inbounds %struct.ip_addr, %struct.ip_addr* %0, i64 0, i32 1, !dbg !264
  %7 = load i8, i8* %6, align 4, !dbg !264, !tbaa !233
  %8 = icmp eq i8 %7, 6, !dbg !264
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !265
  br i1 %8, label %9, label %12, !dbg !265

; <label>:9:                                      ; preds = %5
  %10 = getelementptr inbounds %struct.ip_addr, %struct.ip_addr* %0, i64 0, i32 0, i32 0, !dbg !266
  %11 = tail call i8* @ip6addr_ntoa_r(%struct.ip6_addr* nonnull %10, i8* %1, i32 %2) #3, !dbg !268
  br label %15, !dbg !269

; <label>:12:                                     ; preds = %5
  %13 = bitcast %struct.ip_addr* %0 to %struct.ip4_addr*, !dbg !270
  %14 = tail call i8* @ip4addr_ntoa_r(%struct.ip4_addr* %13, i8* %1, i32 %2) #3, !dbg !272
  br label %15, !dbg !273

; <label>:15:                                     ; preds = %9, %12
  %16 = phi i8* [ %14, %12 ], [ %11, %9 ]
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !274
  br label %17, !dbg !275

; <label>:17:                                     ; preds = %15, %3
  %18 = phi i8* [ null, %3 ], [ %16, %15 ], !dbg !276
...
; Function Attrs: noredzone nounwind
define dso_local i32 @ipaddr_aton(i8*, %struct.ip_addr*) local_unnamed_addr #0 !dbg !277 {
  %3 = icmp eq i8* %0, null, !dbg !291
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !292
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !293
  br i1 %3, label %33, label %4, !dbg !292

; <label>:4:                                      ; preds = %2
  %5 = load i8, i8* %0, align 1, !dbg !296, !tbaa !298
  %6 = icmp eq i8 %5, 0, !dbg !299
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !300
  br i1 %6, label %24, label %7, !dbg !300

; <label>:7:                                      ; preds = %4, %20
  %8 = phi i8 [ %22, %20 ], [ %5, %4 ]
  %9 = phi i8* [ %21, %20 ], [ %0, %4 ]
  %10 = icmp eq i8 %8, 58, !dbg !301
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !304
  br i1 %10, label %11, label %18, !dbg !304

; <label>:11:                                     ; preds = %7
  %12 = icmp eq %struct.ip_addr* %1, null, !dbg !305
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !308
  br i1 %12, label %15, label %13, !dbg !308

; <label>:13:                                     ; preds = %11
  %14 = getelementptr inbounds %struct.ip_addr, %struct.ip_addr* %1, i64 0, i32 1, !dbg !309
  store i8 6, i8* %14, align 4, !dbg !309, !tbaa !233
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !312
  br label %15, !dbg !312

; <label>:15:                                     ; preds = %11, %13
  %16 = getelementptr inbounds %struct.ip_addr, %struct.ip_addr* %1, i64 0, i32 0, i32 0, !dbg !313
  %17 = tail call i32 @ip6addr_aton(i8* nonnull %0, %struct.ip6_addr* %16) #3, !dbg !314
  br label %31, !dbg !315

; <label>:18:                                     ; preds = %7
  %19 = icmp eq i8 %8, 46, !dbg !316
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !318
  br i1 %19, label %24, label %20, !dbg !318

; <label>:20:                                     ; preds = %18
  %21 = getelementptr inbounds i8, i8* %9, i64 1, !dbg !319
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !320
  %22 = load i8, i8* %21, align 1, !dbg !296, !tbaa !298
  %23 = icmp eq i8 %22, 0, !dbg !299
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !300
  br i1 %23, label %24, label %7, !dbg !300, !llvm.loop !321

; <label>:24:                                     ; preds = %18, %20, %4
  %25 = icmp eq %struct.ip_addr* %1, null, !dbg !323
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !325
  br i1 %25, label %28, label %26, !dbg !325

; <label>:26:                                     ; preds = %24
  %27 = getelementptr inbounds %struct.ip_addr, %struct.ip_addr* %1, i64 0, i32 1, !dbg !326
  store i8 0, i8* %27, align 4, !dbg !326, !tbaa !233
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !329
  br label %28, !dbg !329

; <label>:28:                                     ; preds = %24, %26
  %29 = bitcast %struct.ip_addr* %1 to %struct.ip4_addr*, !dbg !330
  %30 = tail call i32 @ip4addr_aton(i8* nonnull %0, %struct.ip4_addr* %29) #3, !dbg !331
  br label %31, !dbg !332

; <label>:31:                                     ; preds = %28, %15
  %32 = phi i32 [ %17, %15 ], [ %30, %28 ], !dbg !333
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !334
  store volatile i32 42, i32* @__A_VARIABLE, align 4
  br label %33

; <label>:33:                                     ; preds = %2, %31
  %34 = phi i32 [ %32, %31 ], [ 0, %2 ], !dbg !335
...
; Function Attrs: noredzone nounwind
define dso_local signext i8 @ip_input(%struct.pbuf*, %struct.netif*) local_unnamed_addr #0 !dbg !337 {
  %3 = icmp eq %struct.pbuf* %0, null, !dbg !343
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !345
  br i1 %3, label %14, label %4, !dbg !345

; <label>:4:                                      ; preds = %2
  %5 = getelementptr inbounds %struct.pbuf, %struct.pbuf* %0, i64 0, i32 1, !dbg !346
  %6 = load i8*, i8** %5, align 8, !dbg !346, !tbaa !349
  %7 = load i8, i8* %6, align 1, !dbg !346, !tbaa !298
  %8 = and i8 %7, -16, !dbg !353
  %9 = icmp eq i8 %8, 96, !dbg !353
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !354
  br i1 %9, label %10, label %12, !dbg !354

; <label>:10:                                     ; preds = %4
  %11 = tail call signext i8 @ip6_input(%struct.pbuf* nonnull %0, %struct.netif* %1) #3, !dbg !355
  br label %14, !dbg !357

; <label>:12:                                     ; preds = %4
  %13 = tail call signext i8 @ip4_input(%struct.pbuf* nonnull %0, %struct.netif* %1) #3, !dbg !358
  br label %14, !dbg !359

; <label>:14:                                     ; preds = %2, %12, %10
  %15 = phi i8 [ %11, %10 ], [ %13, %12 ], [ -6, %2 ], !dbg !360
...
!232 = !DILocation(line: 84, column: 7, scope: !231)
!233 = !{!234, !235, i64 20}
!234 = !{!"ip_addr", !235, i64 0, !235, i64 20}
!235 = !{!"omnipotent char", !236, i64 0}
!236 = !{!"Simple C/C++ TBAA"}
!237 = !DILocation(line: 84, column: 7, scope: !219)
!238 = !DILocation(line: 85, column: 25, scope: !239)
!239 = distinct !DILexicalBlock(scope: !231, file: !3, line: 84, column: 23)
!240 = !DILocation(line: 85, column: 12, scope: !239)
!241 = !DILocation(line: 85, column: 5, scope: !239)
!242 = !DILocation(line: 87, column: 25, scope: !243)
!243 = distinct !DILexicalBlock(scope: !231, file: !3, line: 86, column: 10)
!244 = !DILocation(line: 87, column: 12, scope: !243)
!245 = !DILocation(line: 87, column: 5, scope: !243)
!246 = !DILocation(line: 0, scope: !239)
!247 = !DILocation(line: 89, column: 1, scope: !219)
!248 = !DILocation(line: 0, scope: !243)
!249 = distinct !DISubprogram(name: "ipaddr_ntoa_r", scope: !3, file: !3, line: 101, type: !250, isLocal: false, isDefinition: true, scopeLine: 102, flags: DIFlagPrototyped, isOptimized: true, unit: !2, retainedNodes: !252)
!250 = !DISubroutineType(types: !251)
!251 = !{!222, !223, !222, !19}
!252 = !{!253, !254, !255}
!253 = !DILocalVariable(name: "addr", arg: 1, scope: !249, file: !3, line: 101, type: !223)
!254 = !DILocalVariable(name: "buf", arg: 2, scope: !249, file: !3, line: 101, type: !222)
!255 = !DILocalVariable(name: "buflen", arg: 3, scope: !249, file: !3, line: 101, type: !19)
!256 = !DILocation(line: 101, column: 38, scope: !249)
!257 = !DILocation(line: 101, column: 50, scope: !249)
!258 = !DILocation(line: 101, column: 59, scope: !249)
!259 = !DILocation(line: 103, column: 12, scope: !260)
!260 = distinct !DILexicalBlock(scope: !249, file: !3, line: 103, column: 7)
!261 = !DILocation(line: 103, column: 7, scope: !249)
!262 = !DILocation(line: 0, scope: !263)
!263 = distinct !DILexicalBlock(scope: !249, file: !3, line: 106, column: 7)
!264 = !DILocation(line: 106, column: 7, scope: !263)
!265 = !DILocation(line: 106, column: 7, scope: !249)
!266 = !DILocation(line: 107, column: 27, scope: !267)
!267 = distinct !DILexicalBlock(scope: !263, file: !3, line: 106, column: 23)
!268 = !DILocation(line: 107, column: 12, scope: !267)
!269 = !DILocation(line: 107, column: 5, scope: !267)
!270 = !DILocation(line: 109, column: 27, scope: !271)
!271 = distinct !DILexicalBlock(scope: !263, file: !3, line: 108, column: 10)
!272 = !DILocation(line: 109, column: 12, scope: !271)
!273 = !DILocation(line: 109, column: 5, scope: !271)
!274 = !DILocation(line: 0, scope: !267)
!275 = !DILocation(line: 111, column: 1, scope: !249)
!276 = !DILocation(line: 0, scope: !271)
!277 = distinct !DISubprogram(name: "ipaddr_aton", scope: !3, file: !3, line: 123, type: !278, isLocal: false, isDefinition: true, scopeLine: 124, flags: DIFlagPrototyped, isOptimized: true, unit: !2, retainedNodes: !283)
!278 = !DISubroutineType(types: !279)
!279 = !{!19, !280, !282}
!280 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !281, size: 64)
!281 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !164)
!282 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !60, size: 64)
!283 = !{!284, !285, !286}
!284 = !DILocalVariable(name: "cp", arg: 1, scope: !277, file: !3, line: 123, type: !280)
!285 = !DILocalVariable(name: "addr", arg: 2, scope: !277, file: !3, line: 123, type: !282)
!286 = !DILocalVariable(name: "c", scope: !287, file: !3, line: 126, type: !280)
!287 = distinct !DILexicalBlock(scope: !288, file: !3, line: 125, column: 19)
!288 = distinct !DILexicalBlock(scope: !277, file: !3, line: 125, column: 7)
!289 = !DILocation(line: 123, column: 25, scope: !277)
!290 = !DILocation(line: 123, column: 40, scope: !277)
!291 = !DILocation(line: 125, column: 10, scope: !288)
!292 = !DILocation(line: 125, column: 7, scope: !277)
!293 = !DILocation(line: 0, scope: !294)
!294 = distinct !DILexicalBlock(scope: !287, file: !3, line: 127, column: 5)
!295 = !DILocation(line: 126, column: 17, scope: !287)
!296 = !DILocation(line: 127, column: 18, scope: !297)
!297 = distinct !DILexicalBlock(scope: !294, file: !3, line: 127, column: 5)
!298 = !{!235, !235, i64 0}
!299 = !DILocation(line: 127, column: 21, scope: !297)
!300 = !DILocation(line: 127, column: 5, scope: !294)
!301 = !DILocation(line: 128, column: 14, scope: !302)
!302 = distinct !DILexicalBlock(scope: !303, file: !3, line: 128, column: 11)
!303 = distinct !DILexicalBlock(scope: !297, file: !3, line: 127, column: 32)
!304 = !DILocation(line: 128, column: 11, scope: !303)
!305 = !DILocation(line: 130, column: 13, scope: !306)
!306 = distinct !DILexicalBlock(scope: !307, file: !3, line: 130, column: 13)
!307 = distinct !DILexicalBlock(scope: !302, file: !3, line: 128, column: 22)
!308 = !DILocation(line: 130, column: 13, scope: !307)
!309 = !DILocation(line: 131, column: 11, scope: !310)
!310 = distinct !DILexicalBlock(scope: !311, file: !3, line: 131, column: 11)
!311 = distinct !DILexicalBlock(scope: !306, file: !3, line: 130, column: 19)
!312 = !DILocation(line: 132, column: 9, scope: !311)
!313 = !DILocation(line: 133, column: 33, scope: !307)
!314 = !DILocation(line: 133, column: 16, scope: !307)
!315 = !DILocation(line: 133, column: 9, scope: !307)
!316 = !DILocation(line: 134, column: 21, scope: !317)
!317 = distinct !DILexicalBlock(scope: !302, file: !3, line: 134, column: 18)
!318 = !DILocation(line: 134, column: 18, scope: !302)
!319 = !DILocation(line: 127, column: 28, scope: !297)
!320 = !DILocation(line: 127, column: 5, scope: !297)
!321 = distinct !{!321, !300, !322}
!322 = !DILocation(line: 138, column: 5, scope: !294)
!323 = !DILocation(line: 140, column: 9, scope: !324)
!324 = distinct !DILexicalBlock(scope: !287, file: !3, line: 140, column: 9)
!325 = !DILocation(line: 140, column: 9, scope: !287)
!326 = !DILocation(line: 141, column: 7, scope: !327)
!327 = distinct !DILexicalBlock(scope: !328, file: !3, line: 141, column: 7)
!328 = distinct !DILexicalBlock(scope: !324, file: !3, line: 140, column: 15)
!329 = !DILocation(line: 142, column: 5, scope: !328)
!330 = !DILocation(line: 143, column: 29, scope: !287)
!331 = !DILocation(line: 143, column: 12, scope: !287)
!332 = !DILocation(line: 143, column: 5, scope: !287)
!333 = !DILocation(line: 0, scope: !287)
!334 = !DILocation(line: 0, scope: !307)
!335 = !DILocation(line: 0, scope: !277)
!336 = !DILocation(line: 146, column: 1, scope: !277)
!337 = distinct !DISubprogram(name: "ip_input", scope: !3, file: !3, line: 154, type: !100, isLocal: false, isDefinition: true, scopeLine: 155, flags: DIFlagPrototyped, isOptimized: true, unit: !2, retainedNodes: !338)
!338 = !{!339, !340}
!339 = !DILocalVariable(name: "p", arg: 1, scope: !337, file: !3, line: 154, type: !107)
!340 = !DILocalVariable(name: "inp", arg: 2, scope: !337, file: !3, line: 154, type: !55)
!341 = !DILocation(line: 154, column: 23, scope: !337)
!342 = !DILocation(line: 154, column: 40, scope: !337)
!343 = !DILocation(line: 156, column: 9, scope: !344)
!344 = distinct !DILexicalBlock(scope: !337, file: !3, line: 156, column: 7)
!345 = !DILocation(line: 156, column: 7, scope: !337)
!346 = !DILocation(line: 157, column: 9, scope: !347)
!347 = distinct !DILexicalBlock(scope: !348, file: !3, line: 157, column: 9)
!348 = distinct !DILexicalBlock(scope: !344, file: !3, line: 156, column: 18)
!349 = !{!350, !351, i64 8}
!350 = !{!"pbuf", !351, i64 0, !351, i64 8, !352, i64 16, !352, i64 18, !235, i64 20, !235, i64 21, !235, i64 22, !235, i64 23}
!351 = !{!"any pointer", !235, i64 0}
!352 = !{!"short", !235, i64 0}
!353 = !DILocation(line: 157, column: 40, scope: !347)
!354 = !DILocation(line: 157, column: 9, scope: !348)
!355 = !DILocation(line: 158, column: 14, scope: !356)
!356 = distinct !DILexicalBlock(scope: !347, file: !3, line: 157, column: 46)
!357 = !DILocation(line: 158, column: 7, scope: !356)
!358 = !DILocation(line: 160, column: 12, scope: !348)
!359 = !DILocation(line: 160, column: 5, scope: !348)
!360 = !DILocation(line: 0, scope: !337)
!361 = !DILocation(line: 0, scope: !356)
!362 = !DILocation(line: 163, column: 1, scope: !337)
