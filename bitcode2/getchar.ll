; ModuleID = '/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/stdio/getchar.c'
source_filename = "/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/stdio/getchar.c"
...
define dso_local i32 @_getchar_r(%struct._reent*) local_unnamed_addr #0 !dbg !7 {
  %2 = getelementptr inbounds %struct._reent, %struct._reent* %0, i64 0, i32 1, !dbg !233
  %3 = load %struct.__sFILE*, %struct.__sFILE** %2, align 8, !dbg !233, !tbaa !234
  %4 = tail call i32 @_getc_r(%struct._reent* %0, %struct.__sFILE* %3) #3, !dbg !243
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !244
  ret i32 %4, !dbg !244
}

; Function Attrs: noredzone
declare dso_local i32 @_getc_r(%struct._reent*, %struct.__sFILE*) local_unnamed_addr #1

; Function Attrs: noredzone nounwind
define dso_local i32 @getchar() local_unnamed_addr #0 !dbg !245 {
  %1 = tail call %struct._reent* @__getreent() #3, !dbg !250
  %2 = getelementptr inbounds %struct._reent, %struct._reent* %1, i64 0, i32 1, !dbg !252
  %3 = load %struct.__sFILE*, %struct.__sFILE** %2, align 8, !dbg !252, !tbaa !234
  %4 = tail call i32 @_getc_r(%struct._reent* %1, %struct.__sFILE* %3) #3, !dbg !253
...
!1 = !DIFile(filename: "/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/stdio/getchar.c", directory: "/root/.unikraft/apps/redis/build")
!2 = !{}
!3 = !{i32 2, !"Dwarf Version", i32 4}
!4 = !{i32 2, !"Debug Info Version", i32 3}
!5 = !{i32 1, !"wchar_size", i32 4}
!6 = !{!"clang version 7.0.1-8+deb10u2 (tags/RELEASE_701/final)"}
!7 = distinct !DISubprogram(name: "_getchar_r", scope: !1, file: !1, line: 82, type: !8, isLocal: false, isDefinition: true, scopeLine: 84, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !230)
...
!230 = !{!231}
!231 = !DILocalVariable(name: "reent", arg: 1, scope: !7, file: !1, line: 82, type: !11)
!232 = !DILocation(line: 82, column: 1, scope: !7)
!233 = !DILocation(line: 86, column: 26, scope: !7)
!234 = !{!235, !239, i64 8}
...
!243 = !DILocation(line: 86, column: 10, scope: !7)
!244 = !DILocation(line: 86, column: 3, scope: !7)
!245 = distinct !DISubprogram(name: "getchar", scope: !1, file: !1, line: 92, type: !246, isLocal: false, isDefinition: true, scopeLine: 93, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !248)
!246 = !DISubroutineType(types: !247)
!247 = !{!10}
!248 = !{!249}
!249 = !DILocalVariable(name: "reent", scope: !245, file: !1, line: 94, type: !11)
!250 = !DILocation(line: 94, column: 26, scope: !245)
!251 = !DILocation(line: 94, column: 18, scope: !245)
!252 = !DILocation(line: 98, column: 26, scope: !245)
!253 = !DILocation(line: 98, column: 10, scope: !245)
!254 = !DILocation(line: 98, column: 3, scope: !245)
