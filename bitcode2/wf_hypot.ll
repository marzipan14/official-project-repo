...
; <label>:17:                                     ; preds = %14
  ...
  br i1 %27, label %29, label %30, !dbg !77

; <label>:29:                                     ; preds = %17
  store double 0x47EFFFFFE0000000, double* %28, align 8, !dbg !78, !tbaa !79
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !80
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !81
  br label %34, !dbg !81

; <label>:30:                                     ; preds = %17
  store double 0x7FF0000000000000, double* %28, align 8, !dbg !82, !tbaa !79
  store volatile i32 42, i32* @__A_VARIABLE, align 4
  %31 = icmp eq i32 %26, 2, !dbg !83
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !81
...
; <label>:39:                                     ; preds = %32, %37
  ...
  store i32 34, i32* %40, align 4, !dbg !93, !tbaa !94
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !93
  br label %41, !dbg !95

; <label>:41:                                     ; preds = %39, %34
  %42 = load i32, i32* %20, align 8, !dbg !95, !tbaa !68
...
; <label>:46:                                     ; preds = %41, %44
  %47 = load double, double* %28, align 8, !dbg !101, !tbaa !79
  %48 = fptrunc double %47 to float, !dbg !102
  br label %49, !dbg !103

; <label>:49:                                     ; preds = %8, %11, %14, %2, %46
  %50 = phi float [ %48, %46 ], [ %5, %2 ], [ %5, %14 ], [ %5, %11 ], [ %5, %8 ], !dbg !104
...
!77 = !DILocation(line: 50, column: 10, scope: !56)
!78 = !DILocation(line: 51, column: 20, scope: !74)
!79 = !{!59, !62, i64 32}
!80 = !DILocation(line: 51, column: 9, scope: !74)
!81 = !DILocation(line: 54, column: 10, scope: !56)
!82 = !DILocation(line: 53, column: 20, scope: !74)
!83 = !DILocation(line: 54, column: 23, scope: !84)
!84 = distinct !DILexicalBlock(scope: !56, file: !1, line: 54, column: 10)
!85 = !DILocation(line: 55, column: 9, scope: !84)
!86 = !DILocation(line: 34, column: 19, scope: !18)
!87 = !DILocation(line: 56, column: 16, scope: !88)
!88 = distinct !DILexicalBlock(scope: !84, file: !1, line: 56, column: 15)
!89 = !DILocation(line: 56, column: 15, scope: !84)
!90 = !DILocation(line: 57, column: 8, scope: !91)
!91 = distinct !DILexicalBlock(scope: !88, file: !1, line: 56, column: 31)
!92 = !DILocation(line: 58, column: 6, scope: !91)
!93 = !DILocation(line: 0, scope: !84)
!94 = !{!60, !60, i64 0}
!95 = !DILocation(line: 59, column: 14, scope: !96)
!96 = distinct !DILexicalBlock(scope: !56, file: !1, line: 59, column: 10)
!97 = !DILocation(line: 59, column: 18, scope: !96)
!98 = !DILocation(line: 59, column: 10, scope: !56)
!99 = !DILocation(line: 60, column: 9, scope: !96)
!100 = !DILocation(line: 60, column: 15, scope: !96)
!101 = !DILocation(line: 61, column: 31, scope: !56)
!102 = !DILocation(line: 61, column: 20, scope: !56)
!103 = !DILocation(line: 61, column: 13, scope: !56)
!104 = !DILocation(line: 0, scope: !56)
!105 = !DILocation(line: 0, scope: !42)
!106 = !DILocation(line: 65, column: 1, scope: !18)
