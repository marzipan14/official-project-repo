; ModuleID = '/root/.unikraft/apps/redis/build/libpthread-embedded/origin/pthread-embedded-44b41d760a433915d70a7be9809651b0a65e001d/pthread_rwlock_unlock.c'
source_filename = "/root/.unikraft/apps/redis/build/libpthread-embedded/origin/pthread-embedded-44b41d760a433915d70a7be9809651b0a65e001d/pthread_rwlock_unlock.c"
...
define dso_local i32 @pthread_rwlock_unlock(%struct.pthread_rwlock_t_** readonly) local_unnamed_addr #0 !dbg !513 {
  %2 = icmp eq %struct.pthread_rwlock_t_** %0, null, !dbg !523
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !525
  br i1 %2, label %39, label %3, !dbg !525
...
; <label>:3:                                      ; preds = %1
  ...
  br i1 %5, label %39, label %6, !dbg !532
...
; <label>:6:                                      ; preds = %3
  ...
  br i1 %7, label %39, label %8, !dbg !535

; <label>:8:                                      ; preds = %6
  %9 = getelementptr inbounds %struct.pthread_rwlock_t_, %struct.pthread_rwlock_t_* %4, i64 0, i32 6, !dbg !537
  %10 = load i32, i32* %9, align 4, !dbg !537, !tbaa !539
  %11 = icmp eq i32 %10, 262974946, !dbg !542
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !543
  br i1 %11, label %12, label %39, !dbg !543

; <label>:12:                                     ; preds = %8
  %13 = getelementptr inbounds %struct.pthread_rwlock_t_, %struct.pthread_rwlock_t_* %4, i64 0, i32 4, !dbg !544
  %14 = load i32, i32* %13, align 4, !dbg !544, !tbaa !546
  %15 = icmp eq i32 %14, 0, !dbg !547
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !548
  br i1 %15, label %16, label %28, !dbg !548

; <label>:16:                                     ; preds = %12
  %17 = getelementptr inbounds %struct.pthread_rwlock_t_, %struct.pthread_rwlock_t_* %4, i64 0, i32 1, !dbg !549
  %18 = tail call i32 @pthread_mutex_lock(%struct.pthread_mutex_t_** nonnull %17) #3, !dbg !552
  %19 = icmp eq i32 %18, 0, !dbg !554
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !555
  br i1 %19, label %20, label %39, !dbg !555

; <label>:20:                                     ; preds = %16
  %21 = getelementptr inbounds %struct.pthread_rwlock_t_, %struct.pthread_rwlock_t_* %4, i64 0, i32 5, !dbg !556
  %22 = load i32, i32* %21, align 8, !dbg !558, !tbaa !559
  %23 = add nsw i32 %22, 1, !dbg !558
  store i32 %23, i32* %21, align 8, !dbg !558, !tbaa !559
  %24 = icmp eq i32 %23, 0, !dbg !560
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !561
  br i1 %24, label %25, label %33, !dbg !561

; <label>:25:                                     ; preds = %20
  %26 = getelementptr inbounds %struct.pthread_rwlock_t_, %struct.pthread_rwlock_t_* %4, i64 0, i32 2, !dbg !562
  %27 = tail call i32 @pthread_cond_signal(%struct.pthread_cond_t_** nonnull %26) #3, !dbg !564
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !565
  br label %33, !dbg !565

; <label>:28:                                     ; preds = %12
  %29 = add nsw i32 %14, -1, !dbg !566
  store i32 %29, i32* %13, align 4, !dbg !566, !tbaa !546
  %30 = getelementptr inbounds %struct.pthread_rwlock_t_, %struct.pthread_rwlock_t_* %4, i64 0, i32 1, !dbg !568
  %31 = tail call i32 @pthread_mutex_unlock(%struct.pthread_mutex_t_** nonnull %30) #3, !dbg !569
  %32 = getelementptr inbounds %struct.pthread_rwlock_t_, %struct.pthread_rwlock_t_* %4, i64 0, i32 0, !dbg !570
  br label %33

; <label>:33:                                     ; preds = %20, %25, %28
  %34 = phi %struct.pthread_mutex_t_** [ %32, %28 ], [ %17, %25 ], [ %17, %20 ]
  %35 = phi i32 [ %31, %28 ], [ %27, %25 ], [ 0, %20 ], !dbg !572
  %36 = tail call i32 @pthread_mutex_unlock(%struct.pthread_mutex_t_** nonnull %34) #3, !dbg !573
  store volatile i32 42, i32* @__A_VARIABLE, align 4
  %37 = icmp eq i32 %35, 0, !dbg !574
  %38 = select i1 %37, i32 %36, i32 %35, !dbg !575
  br label %39, !dbg !576

; <label>:39:                                     ; preds = %16, %8, %6, %1, %3, %33
  %40 = phi i32 [ %38, %33 ], [ 22, %3 ], [ 22, %1 ], [ 0, %6 ], [ 22, %8 ], [ %18, %16 ], !dbg !577
...
; Function Attrs: noredzone
declare dso_local i32 @pthread_cond_signal(%struct.pthread_cond_t_**) local_unnamed_addr #1
...
!1 = !DIFile(filename: "/root/.unikraft/apps/redis/build/libpthread-embedded/origin/pthread-embedded-44b41d760a433915d70a7be9809651b0a65e001d/pthread_rwlock_unlock.c", directory: "/root/.unikraft/apps/redis/build")
!2 = !{!3}
...
!513 = distinct !DISubprogram(name: "pthread_rwlock_unlock", scope: !1, file: !1, line: 50, type: !514, isLocal: false, isDefinition: true, scopeLine: 51, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !517)
...
!522 = !DILocation(line: 50, column: 43, scope: !513)
...
!533 = !DILocation(line: 60, column: 15, scope: !534)
!534 = distinct !DILexicalBlock(scope: !513, file: !1, line: 60, column: 7)
!535 = !DILocation(line: 60, column: 7, scope: !513)
!536 = !DILocation(line: 53, column: 20, scope: !513)
!537 = !DILocation(line: 70, column: 12, scope: !538)
!538 = distinct !DILexicalBlock(scope: !513, file: !1, line: 70, column: 7)
!539 = !{!540, !541, i64 36}
!540 = !{!"pthread_rwlock_t_", !528, i64 0, !528, i64 8, !528, i64 16, !541, i64 24, !541, i64 28, !541, i64 32, !541, i64 36}
!541 = !{!"int", !529, i64 0}
!542 = !DILocation(line: 70, column: 19, scope: !538)
!543 = !DILocation(line: 70, column: 7, scope: !513)
!544 = !DILocation(line: 75, column: 12, scope: !545)
!545 = distinct !DILexicalBlock(scope: !513, file: !1, line: 75, column: 7)
!546 = !{!540, !541, i64 28}
!547 = !DILocation(line: 75, column: 34, scope: !545)
!548 = !DILocation(line: 75, column: 7, scope: !513)
!549 = !DILocation(line: 78, column: 41, scope: !550)
!550 = distinct !DILexicalBlock(scope: !551, file: !1, line: 77, column: 11)
!551 = distinct !DILexicalBlock(scope: !545, file: !1, line: 76, column: 5)
!552 = !DILocation(line: 78, column: 14, scope: !550)
!553 = !DILocation(line: 52, column: 7, scope: !513)
!554 = !DILocation(line: 78, column: 69, scope: !550)
!555 = !DILocation(line: 77, column: 11, scope: !551)
!556 = !DILocation(line: 83, column: 18, scope: !557)
!557 = distinct !DILexicalBlock(scope: !551, file: !1, line: 83, column: 11)
!558 = !DILocation(line: 83, column: 11, scope: !557)
!559 = !{!540, !541, i64 32}
!560 = !DILocation(line: 83, column: 46, scope: !557)
!561 = !DILocation(line: 83, column: 11, scope: !551)
!562 = !DILocation(line: 85, column: 48, scope: !563)
!563 = distinct !DILexicalBlock(scope: !557, file: !1, line: 84, column: 9)
!564 = !DILocation(line: 85, column: 20, scope: !563)
!565 = !DILocation(line: 86, column: 9, scope: !563)
!566 = !DILocation(line: 92, column: 33, scope: !567)
!567 = distinct !DILexicalBlock(scope: !545, file: !1, line: 91, column: 5)
!568 = !DILocation(line: 94, column: 45, scope: !567)
!569 = !DILocation(line: 94, column: 16, scope: !567)
!570 = !DILocation(line: 95, column: 46, scope: !567)
!571 = !DILocation(line: 52, column: 15, scope: !513)
!572 = !DILocation(line: 0, scope: !567)
!573 = !DILocation(line: 0, scope: !551)
!574 = !DILocation(line: 99, column: 19, scope: !513)
!575 = !DILocation(line: 99, column: 11, scope: !513)
!576 = !DILocation(line: 99, column: 3, scope: !513)
!577 = !DILocation(line: 0, scope: !513)
!578 = !DILocation(line: 0, scope: !579)
!579 = distinct !DILexicalBlock(scope: !524, file: !1, line: 56, column: 5)
!580 = !DILocation(line: 100, column: 1, scope: !513)
