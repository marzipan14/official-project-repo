...
define dso_local i32 @rpmatch(i8*) local_unnamed_addr #0 !dbg !70 {
  ...
  br i1 %8, label %9, label %24, !dbg !102
...
; <label>:18:                                     ; preds = %14
  %19 = call i32 @regexec(%struct.regex_t* nonnull %3, i8* %0, i64 0, %struct.regmatch_t* null, i32 0) #5, !dbg !118
  %20 = icmp ne i32 %19, 0, !dbg !120
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !121
  store volatile i32 42, i32* @__A_VARIABLE, align 4
  %21 = sext i1 %20 to i32, !dbg !122
  br label %22, !dbg !122

; <label>:22:                                     ; preds = %18, %17
  %23 = phi i32 [ 1, %17 ], [ %21, %18 ], !dbg !123
  call void @regfree(%struct.regex_t* nonnull %2) #5, !dbg !124
  call void @regfree(%struct.regex_t* nonnull %3) #5, !dbg !125
  br label %24, !dbg !126

; <label>:24:                                     ; preds = %1, %22, %13
  %25 = phi i32 [ -1, %13 ], [ %23, %22 ], [ -1, %1 ], !dbg !127
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !128
  call void @llvm.lifetime.end.p0i8(i64 32, i8* nonnull %5) #4, !dbg !129
  call void @llvm.lifetime.end.p0i8(i64 32, i8* nonnull %4) #4, !dbg !129
...
!116 = !DILocation(line: 71, column: 6, scope: !70)
!117 = !DILocation(line: 80, column: 3, scope: !113)
!118 = !DILocation(line: 81, column: 11, scope: !119)
!119 = distinct !DILexicalBlock(scope: !113, file: !1, line: 81, column: 11)
!120 = !DILocation(line: 81, column: 46, scope: !119)
!121 = !DILocation(line: 81, column: 11, scope: !113)
!122 = !DILocation(line: 82, column: 3, scope: !119)
!123 = !DILocation(line: 0, scope: !119)
!124 = !DILocation(line: 85, column: 2, scope: !70)
!125 = !DILocation(line: 86, column: 2, scope: !70)
!126 = !DILocation(line: 87, column: 2, scope: !70)
!127 = !DILocation(line: 0, scope: !70)
!128 = !DILocation(line: 0, scope: !98)
!129 = !DILocation(line: 88, column: 1, scope: !70)
