...
# %bb.46:                               #   in Loop: Header=BB4_37 Depth=1
	...
	andl	$7, %eax
	jmpq	*.LJTI4_2(,%rax,8)
.LBB4_47:                               #   in Loop: Header=BB4_37 Depth=1
	shrq	$3, %rdx
	jmp	.LBB4_53
...
.LBB4_53:                               #   in Loop: Header=BB4_37 Depth=1
	...
	movl	$1, %eax
	.p2align	4, 0x90
.LBB4_54:                               #   Parent Loop BB4_37 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	movzbl	-65(%rbp,%rax), %ecx
	xorb	%cl, -1(%r14,%rax)
	movl	$42, __A_VARIABLE(%rip)
...
.LBB4_62:                               #   in Loop: Header=BB4_60 Depth=1
	shrq	$3, %rdx
	jmp	.LBB4_68
.LBB4_63:                               #   in Loop: Header=BB4_60 Depth=1
	movq	-17(%rbx), %rdx
	jmp	.LBB4_68
...
.LBB4_66:                               #   in Loop: Header=BB4_60 Depth=1
	movzbl	-3(%rbx), %edx
	jmp	.LBB4_68
.LBB4_67:                               #   in Loop: Header=BB4_60 Depth=1
	xorl	%edx, %edx
	.p2align	4, 0x90
...
.LBB4_80:                               #   in Loop: Header=BB4_76 Depth=1
	movq	-17(%r15), %rdx
	jmp	.LBB4_85
.LBB4_81:                               #   in Loop: Header=BB4_76 Depth=1
	movzwl	-5(%r15), %edx
	jmp	.LBB4_85
.LBB4_82:                               #   in Loop: Header=BB4_76 Depth=1
	movl	-9(%r15), %edx
	jmp	.LBB4_85
.LBB4_83:                               #   in Loop: Header=BB4_76 Depth=1
	movzbl	-3(%r15), %edx
	jmp	.LBB4_85
.LBB4_84:                               #   in Loop: Header=BB4_76 Depth=1
	xorl	%edx, %edx
	.p2align	4, 0x90
.LBB4_85:                               #   in Loop: Header=BB4_76 Depth=1
	movl	$42, __A_VARIABLE(%rip)
	movl	$42, __A_VARIABLE(%rip)
	movq	%r14, %rdi
	movq	%r15, %rsi
	...
	jb	.LBB4_75
	.p2align	4, 0x90
.LBB4_86:                               #   Parent Loop BB4_76 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	movq	%r15, %rdi
	leaq	-160(%rbp), %rsi
	movq	%rdx, %r13
...
.LBB7_20:                               #   in Loop: Header=BB7_6 Depth=2
	movl	-9(%r15), %edx
	jmp	.LBB7_22
.LBB7_21:                               #   in Loop: Header=BB7_6 Depth=2
	movq	-17(%r15), %rdx
	.p2align	4, 0x90
.LBB7_22:                               #   in Loop: Header=BB7_6 Depth=2
	movl	$42, __A_VARIABLE(%rip)
	movl	$42, __A_VARIABLE(%rip)
	movq	%r12, %rdi
	movq	%r15, %rsi
	...
	movl	$1, %eax
	.p2align	4, 0x90
.LBB7_23:                               #   Parent Loop BB7_2 Depth=1
                                        #     Parent Loop BB7_6 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	movzbl	-97(%rbp,%rax), %ecx
	xorb	%cl, -1(%rbx,%rax)
	movl	$42, __A_VARIABLE(%rip)
	movl	$42, __A_VARIABLE(%rip)
...
.LBB8_67:                               #   in Loop: Header=BB8_65 Depth=1
	...
	xorl	%ebx, %ebx
	.p2align	4, 0x90
.LBB8_68:                               #   Parent Loop BB8_65 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	movzbl	-4176(%rbp,%rbx), %edx
	movl	$.L.str.66, %esi
	movq	%r13, %rdi
	...
	cmpq	$20, %rbx
	jne	.LBB8_68
# %bb.69:                               #   in Loop: Header=BB8_65 Depth=1
	movq	%r14, %rdi
	movq	%r13, %rsi
	callq	addReplyStatus
	movq	%r13, %rdi
...
# %bb.75:
	...
	jmp	.LBB8_31
.LBB8_117:                              #   in Loop: Header=BB8_119 Depth=1
	movq	16(%r14), %rdi
	movq	%r13, %rsi
...
.LBB8_121:                              #   in Loop: Header=BB8_119 Depth=1
	...
	movl	$42, __A_VARIABLE(%rip)
	jne	.LBB8_117
# %bb.122:                              #   in Loop: Header=BB8_119 Depth=1
	movq	72(%r14), %rax
	movq	32(%rax), %rsi
	movq	%r14, %rdi
	leaq	-64(%rbp), %rdx
	...
	je	.LBB8_117
	jmp	.LBB8_109
.LBB8_123:                              #   in Loop: Header=BB8_119 Depth=1
	movl	$128, %esi
	movl	$.L.str.64, %edx
	movq	%r12, %rdi
	movq	%rbx, %rcx
	...
	testq	%r15, %r15
	je	.LBB8_125
# %bb.124:                              #   in Loop: Header=BB8_119 Depth=1
	movq	-64(%rbp), %rsi
	xorl	%edi, %edi
	...
	callq	memcpy
	jmp	.LBB8_126
.LBB8_125:                              #   in Loop: Header=BB8_119 Depth=1
	movq	%r12, %rdi
	movq	%rax, %rsi
	callq	createStringObject
	movq	%rax, %r15
.LBB8_126:                              #   in Loop: Header=BB8_119 Depth=1
	movl	$42, __A_VARIABLE(%rip)
	movq	16(%r14), %rdi
	movq	%r13, %rsi
	movq	%r15, %rdx
