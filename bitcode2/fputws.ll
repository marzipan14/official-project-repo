...
; <label>:18:                                     ; preds = %14, %3
  ...
  br i1 %20, label %22, label %62, !dbg !287
...
; <label>:22:                                     ; preds = %21, %18
  %23 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %2, i64 0, i32 22
  %24 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %2, i64 0, i32 2
  %25 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %2, i64 0, i32 0
  %26 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %2, i64 0, i32 6
  br label %27, !dbg !288

; <label>:27:                                     ; preds = %22, %56
  %28 = call i64 @_wcsrtombs_r(%struct._reent* %0, i8* nonnull %7, i32** nonnull %4, i64 1024, %struct._mbstate_t* nonnull %23) #5, !dbg !290
  %29 = icmp eq i64 %28, -1, !dbg !292
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !294
  br i1 %29, label %55, label %30, !dbg !294

; <label>:30:                                     ; preds = %27
  %31 = icmp eq i64 %28, 0, !dbg !295
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !296
  br i1 %31, label %56, label %32, !dbg !296

; <label>:32:                                     ; preds = %30, %52
  %33 = phi i64 [ %53, %52 ], [ 0, %30 ]
  %34 = getelementptr inbounds [1024 x i8], [1024 x i8]* %5, i64 0, i64 %33, !dbg !297
  %35 = load i8, i8* %34, align 1, !dbg !297, !tbaa !300
  %36 = sext i8 %35 to i32, !dbg !297
  %37 = load i32, i32* %24, align 4, !dbg !312, !tbaa !314
  %38 = add nsw i32 %37, -1, !dbg !312
  store i32 %38, i32* %24, align 4, !dbg !312, !tbaa !314
  %39 = icmp sgt i32 %37, 0, !dbg !315
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !316
  br i1 %39, label %46, label %40, !dbg !316

; <label>:40:                                     ; preds = %32
  %41 = load i32, i32* %26, align 8, !dbg !317, !tbaa !318
  %42 = icmp sgt i32 %37, %41, !dbg !319
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !320
  br i1 %42, label %43, label %49, !dbg !320

; <label>:43:                                     ; preds = %40
  %44 = and i32 %36, 255, !dbg !321
  %45 = icmp eq i32 %44, 10, !dbg !321
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !322
  br i1 %45, label %49, label %46, !dbg !322

; <label>:46:                                     ; preds = %43, %32
  %47 = load i8*, i8** %25, align 8, !dbg !323, !tbaa !324
  %48 = getelementptr inbounds i8, i8* %47, i64 1, !dbg !323
  store i8* %48, i8** %25, align 8, !dbg !323, !tbaa !324
  store i8 %35, i8* %47, align 1, !dbg !325, !tbaa !300
...
; <label>:49:                                     ; preds = %40, %43
  %50 = call i32 @__swbuf_r(%struct._reent* %0, i32 %36, %struct.__sFILE* nonnull %2) #5, !dbg !329
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !330
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !327
  %51 = icmp eq i32 %50, -1, !dbg !331
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !328
  br i1 %51, label %55, label %52, !dbg !328

; <label>:52:                                     ; preds = %46, %49
  %53 = add nuw i64 %33, 1, !dbg !332
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !296
  %54 = icmp ult i64 %53, %28, !dbg !295
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !296
  br i1 %54, label %32, label %56, !dbg !296, !llvm.loop !333

; <label>:55:                                     ; preds = %27, %49
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !335
  store volatile i32 42, i32* @__A_VARIABLE, align 4
  br label %62

; <label>:56:                                     ; preds = %52, %30
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !336
  store volatile i32 42, i32* @__A_VARIABLE, align 4
  %57 = load i32*, i32** %4, align 8, !dbg !337, !tbaa !270
  %58 = icmp eq i32* %57, null, !dbg !338
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !339
  br i1 %58, label %59, label %27, !dbg !339, !llvm.loop !340

; <label>:59:                                     ; preds = %56
  %60 = load i32, i32* %6, align 4, !dbg !343, !tbaa !344
  %61 = call i32 @pthread_setcancelstate(i32 %60, i32* nonnull %6) #5, !dbg !343
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !345
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %8) #4, !dbg !346
  br label %65

; <label>:62:                                     ; preds = %18, %55
  %63 = load i32, i32* %6, align 4, !dbg !347, !tbaa !344
  %64 = call i32 @pthread_setcancelstate(i32 %63, i32* nonnull %6) #5, !dbg !347
...
; <label>:65:                                     ; preds = %59, %62
  %66 = phi i32 [ -1, %62 ], [ 0, %59 ]
  store volatile i32 42, i32* @__A_VARIABLE, align 4
  call void @llvm.lifetime.end.p0i8(i64 1024, i8* nonnull %7) #4, !dbg !349
...
; Function Attrs: noredzone nounwind
define dso_local i32 @fputws(i32* noalias, %struct.__sFILE* noalias) local_unnamed_addr #0 !dbg !350 {
  %3 = tail call %struct._reent* @__getreent() #5, !dbg !362
  %4 = icmp eq %struct._reent* %3, null, !dbg !365
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !365
  br i1 %4, label %10, label %5, !dbg !365

; <label>:5:                                      ; preds = %2
  %6 = getelementptr inbounds %struct._reent, %struct._reent* %3, i64 0, i32 8, !dbg !365
  %7 = load i32, i32* %6, align 8, !dbg !365, !tbaa !367
  %8 = icmp eq i32 %7, 0, !dbg !365
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !364
  br i1 %8, label %9, label %10, !dbg !364

; <label>:9:                                      ; preds = %5
  tail call void @__sinit(%struct._reent* nonnull %3) #5, !dbg !365
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !365
  br label %10, !dbg !365

; <label>:10:                                     ; preds = %5, %2, %9
  %11 = tail call i32 @_fputws_r(%struct._reent* %3, i32* %0, %struct.__sFILE* %1) #6, !dbg !372
...
!292 = !DILocation(line: 165, column: 18, scope: !293)
!293 = distinct !DILexicalBlock(scope: !268, file: !1, line: 165, column: 11)
!294 = !DILocation(line: 165, column: 11, scope: !268)
!295 = !DILocation(line: 167, column: 16, scope: !268)
!296 = !DILocation(line: 167, column: 7, scope: !268)
!297 = !DILocation(line: 169, column: 24, scope: !298)
!298 = distinct !DILexicalBlock(scope: !299, file: !1, line: 169, column: 8)
!299 = distinct !DILexicalBlock(scope: !268, file: !1, line: 168, column: 9)
!300 = !{!272, !272, i64 0}
!301 = !DILocalVariable(name: "_ptr", arg: 1, scope: !302, file: !255, line: 687, type: !34)
!302 = distinct !DISubprogram(name: "__sputc_r", scope: !255, file: !255, line: 687, type: !303, isLocal: true, isDefinition: true, scopeLine: 687, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !305)
!303 = !DISubroutineType(types: !304)
!304 = !{!5, !34, !5, !253}
!305 = !{!301, !306, !307}
!306 = !DILocalVariable(name: "_c", arg: 2, scope: !302, file: !255, line: 687, type: !5)
!307 = !DILocalVariable(name: "_p", arg: 3, scope: !302, file: !255, line: 687, type: !253)
!308 = !DILocation(line: 687, column: 47, scope: !302, inlinedAt: !309)
!309 = distinct !DILocation(line: 169, column: 8, scope: !298)
!310 = !DILocation(line: 687, column: 57, scope: !302, inlinedAt: !309)
!311 = !DILocation(line: 687, column: 67, scope: !302, inlinedAt: !309)
!312 = !DILocation(line: 692, column: 6, scope: !313, inlinedAt: !309)
!313 = distinct !DILexicalBlock(scope: !302, file: !255, line: 692, column: 6)
!314 = !{!280, !281, i64 12}
!315 = !DILocation(line: 692, column: 15, scope: !313, inlinedAt: !309)
!316 = !DILocation(line: 692, column: 20, scope: !313, inlinedAt: !309)
!317 = !DILocation(line: 692, column: 38, scope: !313, inlinedAt: !309)
!318 = !{!280, !281, i64 40}
!319 = !DILocation(line: 692, column: 31, scope: !313, inlinedAt: !309)
!320 = !DILocation(line: 692, column: 47, scope: !313, inlinedAt: !309)
!321 = !DILocation(line: 692, column: 59, scope: !313, inlinedAt: !309)
!322 = !DILocation(line: 692, column: 6, scope: !302, inlinedAt: !309)
!323 = !DILocation(line: 693, column: 18, scope: !313, inlinedAt: !309)
!324 = !{!280, !271, i64 0}
!325 = !DILocation(line: 693, column: 21, scope: !313, inlinedAt: !309)
!326 = !DILocation(line: 693, column: 3, scope: !313, inlinedAt: !309)
!327 = !DILocation(line: 696, column: 1, scope: !302, inlinedAt: !309)
!328 = !DILocation(line: 169, column: 8, scope: !299)
!329 = !DILocation(line: 695, column: 11, scope: !313, inlinedAt: !309)
!330 = !DILocation(line: 695, column: 3, scope: !313, inlinedAt: !309)
!331 = !DILocation(line: 169, column: 36, scope: !298)
!332 = !DILocation(line: 171, column: 5, scope: !299)
!333 = distinct !{!333, !296, !334}
!334 = !DILocation(line: 172, column: 9, scope: !268)
!335 = !DILocation(line: 0, scope: !298)
!336 = !DILocation(line: 173, column: 5, scope: !266)
!337 = !DILocation(line: 174, column: 10, scope: !266)
!338 = !DILocation(line: 174, column: 13, scope: !266)
!339 = !DILocation(line: 173, column: 5, scope: !268)
!340 = distinct !{!340, !341, !342}
!341 = !DILocation(line: 161, column: 3, scope: !266)
!342 = !DILocation(line: 174, column: 20, scope: !266)
!343 = !DILocation(line: 175, column: 3, scope: !266)
!344 = !{!281, !281, i64 0}
!345 = !DILocation(line: 176, column: 3, scope: !266)
!346 = !DILocation(line: 179, column: 3, scope: !31)
!347 = !DILocation(line: 179, column: 3, scope: !266)
!348 = !DILocation(line: 180, column: 3, scope: !31)
!349 = !DILocation(line: 182, column: 1, scope: !31)
!350 = distinct !DISubprogram(name: "fputws", scope: !1, file: !1, line: 185, type: !351, isLocal: false, isDefinition: true, scopeLine: 188, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !355)
!351 = !DISubroutineType(types: !352)
!352 = !{!5, !353, !354}
!353 = !DIDerivedType(tag: DW_TAG_restrict_type, baseType: !250)
!354 = !DIDerivedType(tag: DW_TAG_restrict_type, baseType: !253)
!355 = !{!356, !357, !358, !359}
!356 = !DILocalVariable(name: "ws", arg: 1, scope: !350, file: !1, line: 185, type: !353)
!357 = !DILocalVariable(name: "fp", arg: 2, scope: !350, file: !1, line: 185, type: !354)
!358 = !DILocalVariable(name: "reent", scope: !350, file: !1, line: 189, type: !34)
!359 = !DILocalVariable(name: "_check_init_ptr", scope: !360, file: !1, line: 191, type: !34)
!360 = distinct !DILexicalBlock(scope: !350, file: !1, line: 191, column: 3)
!361 = !DILocation(line: 185, column: 1, scope: !350)
!362 = !DILocation(line: 189, column: 26, scope: !350)
!363 = !DILocation(line: 189, column: 18, scope: !350)
!364 = !DILocation(line: 191, column: 3, scope: !360)
!365 = !DILocation(line: 191, column: 3, scope: !366)
!366 = distinct !DILexicalBlock(scope: !360, file: !1, line: 191, column: 3)
!367 = !{!368, !281, i64 80}
!368 = !{!"_reent", !281, i64 0, !271, i64 8, !271, i64 16, !271, i64 24, !281, i64 32, !272, i64 36, !281, i64 64, !271, i64 72, !281, i64 80, !271, i64 88, !271, i64 96, !281, i64 104, !271, i64 112, !271, i64 120, !281, i64 128, !271, i64 136, !272, i64 144, !271, i64 504, !369, i64 512, !271, i64 1304, !371, i64 1312, !272, i64 1336}
!369 = !{!"_atexit", !271, i64 0, !281, i64 8, !272, i64 16, !370, i64 272}
!370 = !{!"_on_exit_args", !272, i64 0, !272, i64 256, !281, i64 512, !281, i64 516}
!371 = !{!"_glue", !271, i64 0, !281, i64 8, !271, i64 16}
!372 = !DILocation(line: 192, column: 10, scope: !350)
!373 = !DILocation(line: 192, column: 3, scope: !350)
