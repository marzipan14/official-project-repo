...
; <label>:44:                                     ; preds = %31
  ...
  br i1 %46, label %47, label %70, !dbg !284

; <label>:47:                                     ; preds = %44
  %48 = load i8*, i8** %35, align 8, !dbg !286, !tbaa !272
  br label %49, !dbg !284

; <label>:49:                                     ; preds = %47, %31
  %50 = phi i8* [ %43, %31 ], [ %48, %47 ], !dbg !286
  %51 = phi i32 [ %39, %31 ], [ 0, %47 ], !dbg !287
  %52 = load i32, i32* %13, align 4, !dbg !288, !tbaa !263
  %53 = add nsw i32 %52, -1, !dbg !288
  store i32 %53, i32* %13, align 4, !dbg !288, !tbaa !263
  %54 = getelementptr inbounds i8, i8* %50, i64 1, !dbg !286
  store i8* %54, i8** %35, align 8, !dbg !286, !tbaa !272
  store i8 %33, i8* %50, align 1, !dbg !289, !tbaa !290
  %55 = add nsw i32 %51, 1, !dbg !291
  %56 = load i32, i32* %40, align 8, !dbg !293, !tbaa !278
  %57 = icmp eq i32 %55, %56, !dbg !294
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !295
  br i1 %57, label %64, label %58, !dbg !295

; <label>:58:                                     ; preds = %49
  %59 = load i16, i16* %14, align 8, !dbg !296, !tbaa !266
  %60 = and i16 %59, 1, !dbg !297
  %61 = icmp ne i16 %60, 0, !dbg !297
  %62 = icmp eq i32 %34, 10, !dbg !298
  %63 = and i1 %62, %61, !dbg !299
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !299
  br i1 %63, label %64, label %67, !dbg !299

; <label>:64:                                     ; preds = %58, %49
  %65 = tail call i32 @_fflush_r(%struct._reent* %0, %struct.__sFILE* nonnull %2) #3, !dbg !300
  %66 = icmp eq i32 %65, 0, !dbg !300
...
; <label>:68:                                     ; preds = %64, %24, %67
  %69 = phi i32 [ %34, %67 ], [ -1, %24 ], [ -1, %64 ]
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !304
  br label %70, !dbg !305

; <label>:70:                                     ; preds = %68, %44
  %71 = phi i32 [ -1, %44 ], [ %69, %68 ], !dbg !287
...
; Function Attrs: noredzone nounwind
define dso_local i32 @__swbuf(i32, %struct.__sFILE*) local_unnamed_addr #0 !dbg !306 {
  %3 = tail call %struct._reent* @__getreent() #3, !dbg !313
  %4 = tail call i32 @__swbuf_r(%struct._reent* %3, i32 %0, %struct.__sFILE* %1) #4, !dbg !314
...
!286 = !DILocation(line: 80, column: 10, scope: !10)
!287 = !DILocation(line: 0, scope: !10)
!288 = !DILocation(line: 79, column: 9, scope: !10)
!289 = !DILocation(line: 80, column: 13, scope: !10)
!290 = !{!248, !248, i64 0}
!291 = !DILocation(line: 81, column: 7, scope: !292)
!292 = distinct !DILexicalBlock(scope: !10, file: !1, line: 81, column: 7)
!293 = !DILocation(line: 81, column: 22, scope: !292)
!294 = !DILocation(line: 81, column: 11, scope: !292)
!295 = !DILocation(line: 81, column: 28, scope: !292)
!296 = !DILocation(line: 81, column: 36, scope: !292)
!297 = !DILocation(line: 81, column: 43, scope: !292)
!298 = !DILocation(line: 81, column: 57, scope: !292)
!299 = !DILocation(line: 81, column: 52, scope: !292)
!300 = !DILocation(line: 82, column: 9, scope: !301)
!301 = distinct !DILexicalBlock(scope: !292, file: !1, line: 82, column: 9)
!302 = !DILocation(line: 82, column: 9, scope: !292)
!303 = !DILocation(line: 84, column: 3, scope: !10)
!304 = !DILocation(line: 0, scope: !265)
!305 = !DILocation(line: 85, column: 1, scope: !10)
!306 = distinct !DISubprogram(name: "__swbuf", scope: !1, file: !1, line: 91, type: !307, isLocal: false, isDefinition: true, scopeLine: 94, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !309)
!307 = !DISubroutineType(types: !308)
!308 = !{!13, !13, !231}
!309 = !{!310, !311}
!310 = !DILocalVariable(name: "c", arg: 1, scope: !306, file: !1, line: 91, type: !13)
!311 = !DILocalVariable(name: "fp", arg: 2, scope: !306, file: !1, line: 91, type: !231)
!312 = !DILocation(line: 91, column: 1, scope: !306)
!313 = !DILocation(line: 95, column: 21, scope: !306)
!314 = !DILocation(line: 95, column: 10, scope: !306)
!315 = !DILocation(line: 95, column: 3, scope: !306)
