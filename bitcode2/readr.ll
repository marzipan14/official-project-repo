; ModuleID = '/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/reent/readr.c'
source_filename = "/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/reent/readr.c"
...
define dso_local i64 @_read_r(%struct._reent* nocapture, i32, i8*, i64) local_unnamed_addr #0 !dbg !11 {
  store i32 0, i32* @errno, align 4, !dbg !240, !tbaa !241
  %5 = tail call i64 @read(i32 %1, i8* %2, i64 %3) #3, !dbg !245
  %6 = icmp eq i64 %5, -1, !dbg !248
  %7 = load i32, i32* @errno, align 4, !dbg !249
  %8 = icmp ne i32 %7, 0, !dbg !250
  %9 = and i1 %6, %8, !dbg !251
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !251
  br i1 %9, label %10, label %12, !dbg !251

; <label>:10:                                     ; preds = %4
  %11 = getelementptr inbounds %struct._reent, %struct._reent* %0, i64 0, i32 0, !dbg !252
  store i32 %7, i32* %11, align 8, !dbg !253, !tbaa !254
...
!1 = !DIFile(filename: "/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/reent/readr.c", directory: "/root/.unikraft/apps/redis/build")
!2 = !{}
!3 = !{!4}
...
!11 = distinct !DISubprogram(name: "_read_r", scope: !1, file: !1, line: 49, type: !12, isLocal: false, isDefinition: true, scopeLine: 54, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !233)
...
!234 = !DILocalVariable(name: "ptr", arg: 1, scope: !11, file: !1, line: 49, type: !14)
!235 = !DILocalVariable(name: "fd", arg: 2, scope: !11, file: !1, line: 49, type: !19)
!236 = !DILocalVariable(name: "buf", arg: 3, scope: !11, file: !1, line: 49, type: !40)
!237 = !DILocalVariable(name: "cnt", arg: 4, scope: !11, file: !1, line: 49, type: !231)
!238 = !DILocalVariable(name: "ret", scope: !11, file: !1, line: 55, type: !4)
!239 = !DILocation(line: 49, column: 1, scope: !11)
!240 = !DILocation(line: 57, column: 9, scope: !11)
!241 = !{!242, !242, i64 0}
!242 = !{!"int", !243, i64 0}
!243 = !{!"omnipotent char", !244, i64 0}
!244 = !{!"Simple C/C++ TBAA"}
!245 = !DILocation(line: 58, column: 24, scope: !246)
!246 = distinct !DILexicalBlock(scope: !11, file: !1, line: 58, column: 7)
!247 = !DILocation(line: 55, column: 12, scope: !11)
!248 = !DILocation(line: 58, column: 46, scope: !246)
!249 = !DILocation(line: 58, column: 55, scope: !246)
!250 = !DILocation(line: 58, column: 61, scope: !246)
!251 = !DILocation(line: 58, column: 52, scope: !246)
!252 = !DILocation(line: 59, column: 10, scope: !246)
!253 = !DILocation(line: 59, column: 17, scope: !246)
!254 = !{!255, !242, i64 0}
!255 = !{!"_reent", !242, i64 0, !256, i64 8, !256, i64 16, !256, i64 24, !242, i64 32, !243, i64 36, !242, i64 64, !256, i64 72, !242, i64 80, !256, i64 88, !256, i64 96, !242, i64 104, !256, i64 112, !256, i64 120, !242, i64 128, !256, i64 136, !243, i64 144, !256, i64 504, !257, i64 512, !256, i64 1304, !259, i64 1312, !243, i64 1336}
!256 = !{!"any pointer", !243, i64 0}
!257 = !{!"_atexit", !256, i64 0, !242, i64 8, !243, i64 16, !258, i64 272}
!258 = !{!"_on_exit_args", !243, i64 0, !243, i64 256, !242, i64 512, !242, i64 516}
!259 = !{!"_glue", !256, i64 0, !242, i64 8, !256, i64 16}
!260 = !DILocation(line: 59, column: 5, scope: !246)
!261 = !DILocation(line: 60, column: 3, scope: !11)
