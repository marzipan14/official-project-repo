...
; <label>:92:                                     ; preds = %82, %87
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !411
  br label %93, !dbg !412

; <label>:93:                                     ; preds = %92, %35
  %94 = tail call zeroext i8 @pbuf_free(%struct.pbuf* nonnull %0) #7, !dbg !412
  br label %95, !dbg !413

; <label>:95:                                     ; preds = %93, %60, %53, %44, %39, %38, %29, %8
...
; Function Attrs: noredzone nounwind
define dso_local void @icmp6_dest_unreach(%struct.pbuf* nocapture readonly, i32) local_unnamed_addr #0 !dbg !415 {
  %3 = trunc i32 %1 to i8, !dbg !423
  tail call fastcc void @icmp6_send_response(%struct.pbuf* %0, i8 zeroext %3, i32 0, i8 zeroext 1) #8, !dbg !424
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !425
  ret void, !dbg !425
}

; Function Attrs: noredzone nounwind
define internal fastcc void @icmp6_send_response(%struct.pbuf* nocapture readonly, i8 zeroext, i32, i8 zeroext) unnamed_addr #0 !dbg !426 {
  %5 = load %struct.netif*, %struct.netif** getelementptr inbounds (%struct.ip_globals, %struct.ip_globals* @ip_data, i64 0, i32 0), align 8, !dbg !443, !tbaa !444
  %6 = icmp eq %struct.netif* %5, null, !dbg !447
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !450
  br i1 %6, label %7, label %8, !dbg !450

; <label>:7:                                      ; preds = %4
  tail call void (i8*, ...) @uk_pr_crit(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str, i64 0, i64 0)) #8, !dbg !451
  tail call void (i8*, ...) @uk_pr_crit(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.1, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0)) #8, !dbg !454
  tail call void @ukplat_terminate(i32 3) #9, !dbg !454
  unreachable

; <label>:8:                                      ; preds = %4
  %9 = tail call %struct.ip_addr* @ip6_select_source_address(%struct.netif* nonnull %5, %struct.ip6_addr* getelementptr inbounds (%struct.ip_globals, %struct.ip_globals* @ip_data, i64 0, i32 5, i32 0, i32 0)) #7, !dbg !458
  %10 = icmp eq %struct.ip_addr* %9, null, !dbg !459
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !461
  br i1 %10, label %11, label %14, !dbg !461

; <label>:11:                                     ; preds = %8
  %12 = load i16, i16* getelementptr inbounds (%struct.stats_, %struct.stats_* @lwip_stats, i64 0, i32 9, i32 7), align 2, !dbg !462, !tbaa !464
  %13 = add i16 %12, 1, !dbg !462
  store i16 %13, i16* getelementptr inbounds (%struct.stats_, %struct.stats_* @lwip_stats, i64 0, i32 9, i32 7), align 2, !dbg !462, !tbaa !464
  br label %16, !dbg !465

; <label>:14:                                     ; preds = %8
  %15 = getelementptr inbounds %struct.ip_addr, %struct.ip_addr* %9, i64 0, i32 0, i32 0, !dbg !458
  tail call fastcc void @icmp6_send_response_with_addrs_and_netif(%struct.pbuf* %0, i8 zeroext %1, i32 %2, i8 zeroext %3, %struct.ip6_addr* nonnull %15, %struct.ip6_addr* getelementptr inbounds (%struct.ip_globals, %struct.ip_globals* @ip_data, i64 0, i32 5, i32 0, i32 0), %struct.netif* nonnull %5) #8, !dbg !467
  br label %16, !dbg !468
...
; Function Attrs: noredzone nounwind
define dso_local void @icmp6_packet_too_big(%struct.pbuf* nocapture readonly, i32) local_unnamed_addr #0 !dbg !470 {
  tail call fastcc void @icmp6_send_response(%struct.pbuf* %0, i8 zeroext 0, i32 %1, i8 zeroext 2) #8, !dbg !478
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !479
  ret void, !dbg !479
}

; Function Attrs: noredzone nounwind
define dso_local void @icmp6_time_exceeded(%struct.pbuf* nocapture readonly, i32) local_unnamed_addr #0 !dbg !480 {
  %3 = trunc i32 %1 to i8, !dbg !488
  tail call fastcc void @icmp6_send_response(%struct.pbuf* %0, i8 zeroext %3, i32 0, i8 zeroext 3) #8, !dbg !489
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !490
  ret void, !dbg !490
}

; Function Attrs: noredzone nounwind
define dso_local void @icmp6_time_exceeded_with_addrs(%struct.pbuf* nocapture readonly, i32, %struct.ip6_addr*, %struct.ip6_addr*) local_unnamed_addr #0 !dbg !491 {
  %5 = trunc i32 %1 to i8, !dbg !503
  %6 = icmp eq %struct.ip6_addr* %2, null, !dbg !524
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !527
  br i1 %6, label %7, label %8, !dbg !527

; <label>:7:                                      ; preds = %4
  tail call void (i8*, ...) @uk_pr_crit(i8* getelementptr inbounds ([41 x i8], [41 x i8]* @.str.5, i64 0, i64 0)) #7, !dbg !528
  tail call void (i8*, ...) @uk_pr_crit(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.1, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0)) #7, !dbg !531
  tail call void @ukplat_terminate(i32 3) #9, !dbg !531
  unreachable

; <label>:8:                                      ; preds = %4
  %9 = icmp eq %struct.ip6_addr* %3, null, !dbg !535
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !538
  br i1 %9, label %10, label %11, !dbg !538

; <label>:10:                                     ; preds = %8
  tail call void (i8*, ...) @uk_pr_crit(i8* getelementptr inbounds ([41 x i8], [41 x i8]* @.str.5, i64 0, i64 0)) #7, !dbg !539
  tail call void (i8*, ...) @uk_pr_crit(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.1, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0)) #7, !dbg !542
  tail call void @ukplat_terminate(i32 3) #9, !dbg !542
  unreachable

; <label>:11:                                     ; preds = %8
  %12 = tail call %struct.netif* @ip6_route(%struct.ip6_addr* nonnull %3, %struct.ip6_addr* nonnull %2) #7, !dbg !548
  %13 = icmp eq %struct.netif* %12, null, !dbg !550
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !552
  br i1 %13, label %14, label %17, !dbg !552

; <label>:14:                                     ; preds = %11
  %15 = load i16, i16* getelementptr inbounds (%struct.stats_, %struct.stats_* @lwip_stats, i64 0, i32 9, i32 7), align 2, !dbg !553, !tbaa !464
  %16 = add i16 %15, 1, !dbg !553
  store i16 %16, i16* getelementptr inbounds (%struct.stats_, %struct.stats_* @lwip_stats, i64 0, i32 9, i32 7), align 2, !dbg !553, !tbaa !464
  br label %18, !dbg !555

; <label>:17:                                     ; preds = %11
  tail call fastcc void @icmp6_send_response_with_addrs_and_netif(%struct.pbuf* %0, i8 zeroext %5, i32 0, i8 zeroext 3, %struct.ip6_addr* nonnull %3, %struct.ip6_addr* nonnull %2, %struct.netif* nonnull %12) #7, !dbg !556
  br label %18, !dbg !557
...
; Function Attrs: noredzone nounwind
define dso_local void @icmp6_param_problem(%struct.pbuf* nocapture readonly, i32, i8*) local_unnamed_addr #0 !dbg !560 {
  %4 = load i64, i64* bitcast (%struct.ip6_hdr** getelementptr inbounds (%struct.ip_globals, %struct.ip_globals* @ip_data, i64 0, i32 3) to i64*), align 8, !dbg !573, !tbaa !574
  %5 = ptrtoint i8* %2 to i64, !dbg !575
  %6 = sub i64 %5, %4, !dbg !575
  %7 = trunc i64 %6 to i32, !dbg !576
  %8 = trunc i32 %1 to i8, !dbg !578
  tail call fastcc void @icmp6_send_response(%struct.pbuf* %0, i8 zeroext %8, i32 %7, i8 zeroext 4) #8, !dbg !579
...
define internal void @uk_pr_crit(i8*, ...) unnamed_addr #4 !dbg !2 {
  ...
  %3 = bitcast [1 x %struct.__va_list_tag]* %2 to i8*, !dbg !582
  call void @llvm.lifetime.start.p0i8(i64 24, i8* nonnull %3) #6, !dbg !582
  %4 = getelementptr inbounds [1 x %struct.__va_list_tag], [1 x %struct.__va_list_tag]* %2, i64 0, i64 0, !dbg !584
  call void @llvm.va_start(i8* nonnull %3), !dbg !584
  call void @_uk_vprintk(i32 0, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @uk_pr_crit.__str, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8], [8 x i8]* @uk_pr_crit.__str.3, i64 0, i64 0), i32 198, i8* %0, %struct.__va_list_tag* nonnull %4) #7, !dbg !585
  call void @llvm.va_end(i8* nonnull %3), !dbg !588
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %3) #6, !dbg !589
...
; Function Attrs: noredzone nounwind
define internal fastcc void @icmp6_send_response_with_addrs_and_netif(%struct.pbuf* nocapture readonly, i8 zeroext, i32, i8 zeroext, %struct.ip6_addr*, %struct.ip6_addr*, %struct.netif*) unnamed_addr #0 !dbg !590 {
  %8 = tail call %struct.pbuf* @pbuf_alloc(i32 54, i16 zeroext 56, i32 640) #7, !dbg !610
  %9 = icmp eq %struct.pbuf* %8, null, !dbg !612
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !614
  br i1 %9, label %10, label %13, !dbg !614

; <label>:10:                                     ; preds = %7
  %11 = load i16, i16* getelementptr inbounds (%struct.stats_, %struct.stats_* @lwip_stats, i64 0, i32 9, i32 6), align 2, !dbg !615, !tbaa !372
  %12 = add i16 %11, 1, !dbg !615
  store i16 %12, i16* getelementptr inbounds (%struct.stats_, %struct.stats_* @lwip_stats, i64 0, i32 9, i32 6), align 2, !dbg !615, !tbaa !372
  br label %47, !dbg !617

; <label>:13:                                     ; preds = %7
  %14 = getelementptr inbounds %struct.pbuf, %struct.pbuf* %8, i64 0, i32 3, !dbg !618
  %15 = load i16, i16* %14, align 2, !dbg !618, !tbaa !311
  %16 = icmp ugt i16 %15, 55, !dbg !618
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !621
  br i1 %16, label %18, label %17, !dbg !621

; <label>:17:                                     ; preds = %13
  tail call void (i8*, ...) @uk_pr_crit(i8* getelementptr inbounds ([45 x i8], [45 x i8]* @.str.4, i64 0, i64 0)) #8, !dbg !622
...
; <label>:18:                                     ; preds = %13
  %19 = getelementptr inbounds %struct.pbuf, %struct.pbuf* %8, i64 0, i32 1, !dbg !629
  %20 = bitcast i8** %19 to %struct.icmp6_hdr**, !dbg !629
  %21 = load %struct.icmp6_hdr*, %struct.icmp6_hdr** %20, align 8, !dbg !629, !tbaa !324
  %22 = getelementptr inbounds %struct.icmp6_hdr, %struct.icmp6_hdr* %21, i64 0, i32 0, !dbg !631
  store i8 %3, i8* %22, align 1, !dbg !632, !tbaa !346
  %23 = getelementptr inbounds %struct.icmp6_hdr, %struct.icmp6_hdr* %21, i64 0, i32 1, !dbg !633
  store i8 %1, i8* %23, align 1, !dbg !634, !tbaa !635
  %24 = tail call i32 @lwip_htonl(i32 %2) #7, !dbg !636
  %25 = getelementptr inbounds %struct.icmp6_hdr, %struct.icmp6_hdr* %21, i64 0, i32 3, !dbg !637
  store i32 %24, i32* %25, align 1, !dbg !638, !tbaa !639
  %26 = load i8*, i8** %19, align 8, !dbg !640, !tbaa !324
  %27 = getelementptr inbounds i8, i8* %26, i64 8, !dbg !640
  %28 = getelementptr inbounds %struct.pbuf, %struct.pbuf* %0, i64 0, i32 1, !dbg !640
  %29 = load i8*, i8** %28, align 8, !dbg !640, !tbaa !324
  %30 = tail call i8* @memcpy(i8* nonnull %27, i8* %29, i64 48) #7, !dbg !640
  %31 = getelementptr inbounds %struct.icmp6_hdr, %struct.icmp6_hdr* %21, i64 0, i32 2, !dbg !641
  store i16 0, i16* %31, align 1, !dbg !642, !tbaa !643
  %32 = icmp eq %struct.netif* %6, null, !dbg !644
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !644
  br i1 %32, label %38, label %33, !dbg !644

; <label>:33:                                     ; preds = %18
  %34 = getelementptr inbounds %struct.netif, %struct.netif* %6, i64 0, i32 16, !dbg !644
  %35 = load i16, i16* %34, align 8, !dbg !644, !tbaa !328
  %36 = and i16 %35, 16, !dbg !644
  %37 = icmp eq i16 %36, 0, !dbg !644
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !646
  br i1 %37, label %42, label %38, !dbg !646

; <label>:38:                                     ; preds = %33, %18
  %39 = getelementptr inbounds %struct.pbuf, %struct.pbuf* %8, i64 0, i32 2, !dbg !647
  %40 = load i16, i16* %39, align 8, !dbg !647, !tbaa !335
  %41 = tail call zeroext i16 @ip6_chksum_pseudo(%struct.pbuf* nonnull %8, i8 zeroext 58, i16 zeroext %40, %struct.ip6_addr* %4, %struct.ip6_addr* %5) #7, !dbg !649
  store i16 %41, i16* %31, align 1, !dbg !650, !tbaa !643
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !651
  br label %42, !dbg !651

; <label>:42:                                     ; preds = %33, %38
  %43 = load i16, i16* getelementptr inbounds (%struct.stats_, %struct.stats_* @lwip_stats, i64 0, i32 9, i32 0), align 2, !dbg !652, !tbaa !403
  %44 = add i16 %43, 1, !dbg !652
  store i16 %44, i16* getelementptr inbounds (%struct.stats_, %struct.stats_* @lwip_stats, i64 0, i32 9, i32 0), align 2, !dbg !652, !tbaa !403
  %45 = tail call signext i8 @ip6_output_if(%struct.pbuf* nonnull %8, %struct.ip6_addr* %4, %struct.ip6_addr* %5, i8 zeroext -1, i8 zeroext 0, i8 zeroext 58, %struct.netif* %6) #7, !dbg !653
  %46 = tail call zeroext i8 @pbuf_free(%struct.pbuf* nonnull %8) #7, !dbg !654
  br label %47, !dbg !655
...
!411 = !DILocation(line: 0, scope: !351)
!412 = !DILocation(line: 205, column: 3, scope: !181)
!413 = !DILocation(line: 206, column: 1, scope: !181)
!414 = !DILocation(line: 0, scope: !317)
!415 = distinct !DISubprogram(name: "icmp6_dest_unreach", scope: !10, file: !10, line: 220, type: !416, isLocal: false, isDefinition: true, scopeLine: 221, flags: DIFlagPrototyped, isOptimized: true, unit: !9, retainedNodes: !418)
!416 = !DISubroutineType(types: !417)
!417 = !{null, !184, !79}
!418 = !{!419, !420}
!419 = !DILocalVariable(name: "p", arg: 1, scope: !415, file: !10, line: 220, type: !184)
!420 = !DILocalVariable(name: "c", arg: 2, scope: !415, file: !10, line: 220, type: !79)
!421 = !DILocation(line: 220, column: 33, scope: !415)
!422 = !DILocation(line: 220, column: 56, scope: !415)
!423 = !DILocation(line: 222, column: 26, scope: !415)
!424 = !DILocation(line: 222, column: 3, scope: !415)
!425 = !DILocation(line: 223, column: 1, scope: !415)
!426 = distinct !DISubprogram(name: "icmp6_send_response", scope: !10, file: !10, line: 309, type: !427, isLocal: true, isDefinition: true, scopeLine: 310, flags: DIFlagPrototyped, isOptimized: true, unit: !9, retainedNodes: !429)
!427 = !DISubroutineType(types: !428)
!428 = !{null, !184, !109, !123, !109}
!429 = !{!430, !431, !432, !433, !434, !437, !438}
!430 = !DILocalVariable(name: "p", arg: 1, scope: !426, file: !10, line: 309, type: !184)
!431 = !DILocalVariable(name: "code", arg: 2, scope: !426, file: !10, line: 309, type: !109)
!432 = !DILocalVariable(name: "data", arg: 3, scope: !426, file: !10, line: 309, type: !123)
!433 = !DILocalVariable(name: "type", arg: 4, scope: !426, file: !10, line: 309, type: !109)
!434 = !DILocalVariable(name: "reply_src", scope: !426, file: !10, line: 311, type: !435)
!435 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !436, size: 64)
!436 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !210)
!437 = !DILocalVariable(name: "reply_dest", scope: !426, file: !10, line: 311, type: !435)
!438 = !DILocalVariable(name: "netif", scope: !426, file: !10, line: 312, type: !195)
!439 = !DILocation(line: 309, column: 34, scope: !426)
!440 = !DILocation(line: 309, column: 42, scope: !426)
!441 = !DILocation(line: 309, column: 54, scope: !426)
!442 = !DILocation(line: 309, column: 65, scope: !426)
!443 = !DILocation(line: 312, column: 25, scope: !426)
!444 = !{!445, !313, i64 0}
!445 = !{!"ip_globals", !313, i64 0, !313, i64 8, !313, i64 16, !313, i64 24, !303, i64 32, !330, i64 36, !330, i64 60}
!446 = !DILocation(line: 312, column: 17, scope: !426)
!447 = !DILocation(line: 314, column: 3, scope: !448)
!448 = distinct !DILexicalBlock(scope: !449, file: !10, line: 314, column: 3)
!449 = distinct !DILexicalBlock(scope: !426, file: !10, line: 314, column: 3)
!450 = !DILocation(line: 314, column: 3, scope: !449)
!451 = !DILocation(line: 314, column: 3, scope: !452)
!452 = distinct !DILexicalBlock(scope: !453, file: !10, line: 314, column: 3)
!453 = distinct !DILexicalBlock(scope: !448, file: !10, line: 314, column: 3)
!454 = !DILocation(line: 314, column: 3, scope: !455)
!455 = distinct !DILexicalBlock(scope: !456, file: !10, line: 314, column: 3)
!456 = distinct !DILexicalBlock(scope: !457, file: !10, line: 314, column: 3)
!457 = distinct !DILexicalBlock(scope: !452, file: !10, line: 314, column: 3)
!458 = !DILocation(line: 318, column: 15, scope: !426)
!459 = !DILocation(line: 319, column: 17, scope: !460)
!460 = distinct !DILexicalBlock(scope: !426, file: !10, line: 319, column: 7)
!461 = !DILocation(line: 319, column: 7, scope: !426)
!462 = !DILocation(line: 320, column: 5, scope: !463)
!463 = distinct !DILexicalBlock(scope: !460, file: !10, line: 319, column: 26)
!464 = !{!301, !303, i64 224}
!465 = !DILocation(line: 321, column: 5, scope: !463)
!466 = !DILocation(line: 311, column: 26, scope: !426)
!467 = !DILocation(line: 323, column: 3, scope: !426)
!468 = !DILocation(line: 324, column: 1, scope: !426)
!469 = !DILocation(line: 0, scope: !463)
!470 = distinct !DISubprogram(name: "icmp6_packet_too_big", scope: !10, file: !10, line: 236, type: !471, isLocal: false, isDefinition: true, scopeLine: 237, flags: DIFlagPrototyped, isOptimized: true, unit: !9, retainedNodes: !473)
!471 = !DISubroutineType(types: !472)
!472 = !{null, !184, !123}
!473 = !{!474, !475}
!474 = !DILocalVariable(name: "p", arg: 1, scope: !470, file: !10, line: 236, type: !184)
!475 = !DILocalVariable(name: "mtu", arg: 2, scope: !470, file: !10, line: 236, type: !123)
!476 = !DILocation(line: 236, column: 35, scope: !470)
!477 = !DILocation(line: 236, column: 44, scope: !470)
!478 = !DILocation(line: 238, column: 3, scope: !470)
!479 = !DILocation(line: 239, column: 1, scope: !470)
!480 = distinct !DISubprogram(name: "icmp6_time_exceeded", scope: !10, file: !10, line: 252, type: !481, isLocal: false, isDefinition: true, scopeLine: 253, flags: DIFlagPrototyped, isOptimized: true, unit: !9, retainedNodes: !483)
!481 = !DISubroutineType(types: !482)
!482 = !{null, !184, !88}
!483 = !{!484, !485}
!484 = !DILocalVariable(name: "p", arg: 1, scope: !480, file: !10, line: 252, type: !184)
!485 = !DILocalVariable(name: "c", arg: 2, scope: !480, file: !10, line: 252, type: !88)
!486 = !DILocation(line: 252, column: 34, scope: !480)
!487 = !DILocation(line: 252, column: 56, scope: !480)
!488 = !DILocation(line: 254, column: 26, scope: !480)
!489 = !DILocation(line: 254, column: 3, scope: !480)
!490 = !DILocation(line: 255, column: 1, scope: !480)
!491 = distinct !DISubprogram(name: "icmp6_time_exceeded_with_addrs", scope: !10, file: !10, line: 273, type: !492, isLocal: false, isDefinition: true, scopeLine: 275, flags: DIFlagPrototyped, isOptimized: true, unit: !9, retainedNodes: !494)
!492 = !DISubroutineType(types: !493)
!493 = !{null, !184, !88, !259, !259}
!494 = !{!495, !496, !497, !498}
!495 = !DILocalVariable(name: "p", arg: 1, scope: !491, file: !10, line: 273, type: !184)
!496 = !DILocalVariable(name: "c", arg: 2, scope: !491, file: !10, line: 273, type: !88)
!497 = !DILocalVariable(name: "src_addr", arg: 3, scope: !491, file: !10, line: 274, type: !259)
!498 = !DILocalVariable(name: "dest_addr", arg: 4, scope: !491, file: !10, line: 274, type: !259)
!499 = !DILocation(line: 273, column: 45, scope: !491)
!500 = !DILocation(line: 273, column: 67, scope: !491)
!501 = !DILocation(line: 274, column: 23, scope: !491)
!502 = !DILocation(line: 274, column: 51, scope: !491)
!503 = !DILocation(line: 276, column: 37, scope: !491)
!504 = !DILocalVariable(name: "p", arg: 1, scope: !505, file: !10, line: 346, type: !184)
!505 = distinct !DISubprogram(name: "icmp6_send_response_with_addrs", scope: !10, file: !10, line: 346, type: !506, isLocal: true, isDefinition: true, scopeLine: 348, flags: DIFlagPrototyped, isOptimized: true, unit: !9, retainedNodes: !508)
!506 = !DISubroutineType(types: !507)
!507 = !{null, !184, !109, !123, !109, !259, !259}
!508 = !{!504, !509, !510, !511, !512, !513, !514, !515, !516}
!509 = !DILocalVariable(name: "code", arg: 2, scope: !505, file: !10, line: 346, type: !109)
!510 = !DILocalVariable(name: "data", arg: 3, scope: !505, file: !10, line: 346, type: !123)
!511 = !DILocalVariable(name: "type", arg: 4, scope: !505, file: !10, line: 346, type: !109)
!512 = !DILocalVariable(name: "src_addr", arg: 5, scope: !505, file: !10, line: 347, type: !259)
!513 = !DILocalVariable(name: "dest_addr", arg: 6, scope: !505, file: !10, line: 347, type: !259)
!514 = !DILocalVariable(name: "reply_src", scope: !505, file: !10, line: 349, type: !435)
!515 = !DILocalVariable(name: "reply_dest", scope: !505, file: !10, line: 349, type: !435)
!516 = !DILocalVariable(name: "netif", scope: !505, file: !10, line: 350, type: !195)
!517 = !DILocation(line: 346, column: 45, scope: !505, inlinedAt: !518)
!518 = distinct !DILocation(line: 276, column: 3, scope: !491)
!519 = !DILocation(line: 346, column: 53, scope: !505, inlinedAt: !518)
!520 = !DILocation(line: 346, column: 65, scope: !505, inlinedAt: !518)
!521 = !DILocation(line: 346, column: 76, scope: !505, inlinedAt: !518)
!522 = !DILocation(line: 347, column: 23, scope: !505, inlinedAt: !518)
!523 = !DILocation(line: 347, column: 51, scope: !505, inlinedAt: !518)
!524 = !DILocation(line: 353, column: 3, scope: !525, inlinedAt: !518)
!525 = distinct !DILexicalBlock(scope: !526, file: !10, line: 353, column: 3)
!526 = distinct !DILexicalBlock(scope: !505, file: !10, line: 353, column: 3)
!527 = !DILocation(line: 353, column: 3, scope: !526, inlinedAt: !518)
!528 = !DILocation(line: 353, column: 3, scope: !529, inlinedAt: !518)
!529 = distinct !DILexicalBlock(scope: !530, file: !10, line: 353, column: 3)
!530 = distinct !DILexicalBlock(scope: !525, file: !10, line: 353, column: 3)
!531 = !DILocation(line: 353, column: 3, scope: !532, inlinedAt: !518)
!532 = distinct !DILexicalBlock(scope: !533, file: !10, line: 353, column: 3)
!533 = distinct !DILexicalBlock(scope: !534, file: !10, line: 353, column: 3)
!534 = distinct !DILexicalBlock(scope: !529, file: !10, line: 353, column: 3)
!535 = !DILocation(line: 354, column: 3, scope: !536, inlinedAt: !518)
!536 = distinct !DILexicalBlock(scope: !537, file: !10, line: 354, column: 3)
!537 = distinct !DILexicalBlock(scope: !505, file: !10, line: 354, column: 3)
!538 = !DILocation(line: 354, column: 3, scope: !537, inlinedAt: !518)
!539 = !DILocation(line: 354, column: 3, scope: !540, inlinedAt: !518)
!540 = distinct !DILexicalBlock(scope: !541, file: !10, line: 354, column: 3)
!541 = distinct !DILexicalBlock(scope: !536, file: !10, line: 354, column: 3)
!542 = !DILocation(line: 354, column: 3, scope: !543, inlinedAt: !518)
!543 = distinct !DILexicalBlock(scope: !544, file: !10, line: 354, column: 3)
!544 = distinct !DILexicalBlock(scope: !545, file: !10, line: 354, column: 3)
!545 = distinct !DILexicalBlock(scope: !540, file: !10, line: 354, column: 3)
!546 = !DILocation(line: 349, column: 38, scope: !505, inlinedAt: !518)
!547 = !DILocation(line: 349, column: 26, scope: !505, inlinedAt: !518)
!548 = !DILocation(line: 363, column: 11, scope: !505, inlinedAt: !518)
!549 = !DILocation(line: 350, column: 17, scope: !505, inlinedAt: !518)
!550 = !DILocation(line: 364, column: 13, scope: !551, inlinedAt: !518)
!551 = distinct !DILexicalBlock(scope: !505, file: !10, line: 364, column: 7)
!552 = !DILocation(line: 364, column: 7, scope: !505, inlinedAt: !518)
!553 = !DILocation(line: 365, column: 5, scope: !554, inlinedAt: !518)
!554 = distinct !DILexicalBlock(scope: !551, file: !10, line: 364, column: 22)
!555 = !DILocation(line: 366, column: 5, scope: !554, inlinedAt: !518)
!556 = !DILocation(line: 368, column: 3, scope: !505, inlinedAt: !518)
!557 = !DILocation(line: 370, column: 1, scope: !505, inlinedAt: !518)
!558 = !DILocation(line: 0, scope: !491)
!559 = !DILocation(line: 277, column: 1, scope: !491)
!560 = distinct !DISubprogram(name: "icmp6_param_problem", scope: !10, file: !10, line: 292, type: !561, isLocal: false, isDefinition: true, scopeLine: 293, flags: DIFlagPrototyped, isOptimized: true, unit: !9, retainedNodes: !565)
!561 = !DISubroutineType(types: !562)
!562 = !{null, !184, !92, !563}
!563 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !564, size: 64)
!564 = !DIDerivedType(tag: DW_TAG_const_type, baseType: null)
!565 = !{!566, !567, !568, !569}
!566 = !DILocalVariable(name: "p", arg: 1, scope: !560, file: !10, line: 292, type: !184)
!567 = !DILocalVariable(name: "c", arg: 2, scope: !560, file: !10, line: 292, type: !92)
!568 = !DILocalVariable(name: "pointer", arg: 3, scope: !560, file: !10, line: 292, type: !563)
!569 = !DILocalVariable(name: "pointer_u32", scope: !560, file: !10, line: 294, type: !123)
!570 = !DILocation(line: 292, column: 34, scope: !560)
!571 = !DILocation(line: 292, column: 56, scope: !560)
!572 = !DILocation(line: 292, column: 71, scope: !560)
!573 = !DILocation(line: 294, column: 69, scope: !560)
!574 = !{!445, !313, i64 24}
!575 = !DILocation(line: 294, column: 53, scope: !560)
!576 = !DILocation(line: 294, column: 23, scope: !560)
!577 = !DILocation(line: 294, column: 9, scope: !560)
!578 = !DILocation(line: 295, column: 26, scope: !560)
!579 = !DILocation(line: 295, column: 3, scope: !560)
!580 = !DILocation(line: 296, column: 1, scope: !560)
!581 = !DILocation(line: 194, column: 43, scope: !2)
!582 = !DILocation(line: 196, column: 2, scope: !2)
!583 = !DILocation(line: 196, column: 10, scope: !2)
!584 = !DILocation(line: 197, column: 2, scope: !2)
!585 = !DILocation(line: 198, column: 2, scope: !586)
!586 = distinct !DILexicalBlock(scope: !587, file: !3, line: 198, column: 2)
!587 = distinct !DILexicalBlock(scope: !2, file: !3, line: 198, column: 2)
!588 = !DILocation(line: 199, column: 2, scope: !2)
!589 = !DILocation(line: 200, column: 1, scope: !2)
!590 = distinct !DISubprogram(name: "icmp6_send_response_with_addrs_and_netif", scope: !10, file: !10, line: 385, type: !591, isLocal: true, isDefinition: true, scopeLine: 387, flags: DIFlagPrototyped, isOptimized: true, unit: !9, retainedNodes: !593)
!591 = !DISubroutineType(types: !592)
!592 = !{null, !184, !109, !123, !109, !259, !259, !195}
!593 = !{!594, !595, !596, !597, !598, !599, !600, !601, !602}
!594 = !DILocalVariable(name: "p", arg: 1, scope: !590, file: !10, line: 385, type: !184)
!595 = !DILocalVariable(name: "code", arg: 2, scope: !590, file: !10, line: 385, type: !109)
!596 = !DILocalVariable(name: "data", arg: 3, scope: !590, file: !10, line: 385, type: !123)
!597 = !DILocalVariable(name: "type", arg: 4, scope: !590, file: !10, line: 385, type: !109)
!598 = !DILocalVariable(name: "reply_src", arg: 5, scope: !590, file: !10, line: 386, type: !259)
!599 = !DILocalVariable(name: "reply_dest", arg: 6, scope: !590, file: !10, line: 386, type: !259)
!600 = !DILocalVariable(name: "netif", arg: 7, scope: !590, file: !10, line: 386, type: !195)
!601 = !DILocalVariable(name: "q", scope: !590, file: !10, line: 388, type: !184)
!602 = !DILocalVariable(name: "icmp6hdr", scope: !590, file: !10, line: 389, type: !105)
!603 = !DILocation(line: 385, column: 55, scope: !590)
!604 = !DILocation(line: 385, column: 63, scope: !590)
!605 = !DILocation(line: 385, column: 75, scope: !590)
!606 = !DILocation(line: 385, column: 86, scope: !590)
!607 = !DILocation(line: 386, column: 23, scope: !590)
!608 = !DILocation(line: 386, column: 52, scope: !590)
!609 = !DILocation(line: 386, column: 78, scope: !590)
!610 = !DILocation(line: 392, column: 7, scope: !590)
!611 = !DILocation(line: 388, column: 16, scope: !590)
!612 = !DILocation(line: 394, column: 9, scope: !613)
!613 = distinct !DILexicalBlock(scope: !590, file: !10, line: 394, column: 7)
!614 = !DILocation(line: 394, column: 7, scope: !590)
!615 = !DILocation(line: 396, column: 5, scope: !616)
!616 = distinct !DILexicalBlock(scope: !613, file: !10, line: 394, column: 18)
!617 = !DILocation(line: 397, column: 5, scope: !616)
!618 = !DILocation(line: 399, column: 3, scope: !619)
!619 = distinct !DILexicalBlock(scope: !620, file: !10, line: 399, column: 3)
!620 = distinct !DILexicalBlock(scope: !590, file: !10, line: 399, column: 3)
!621 = !DILocation(line: 399, column: 3, scope: !620)
!622 = !DILocation(line: 399, column: 3, scope: !623)
!623 = distinct !DILexicalBlock(scope: !624, file: !10, line: 399, column: 3)
!624 = distinct !DILexicalBlock(scope: !619, file: !10, line: 399, column: 3)
!625 = !DILocation(line: 399, column: 3, scope: !626)
!626 = distinct !DILexicalBlock(scope: !627, file: !10, line: 399, column: 3)
!627 = distinct !DILexicalBlock(scope: !628, file: !10, line: 399, column: 3)
!628 = distinct !DILexicalBlock(scope: !623, file: !10, line: 399, column: 3)
!629 = !DILocation(line: 402, column: 37, scope: !590)
!630 = !DILocation(line: 389, column: 21, scope: !590)
!631 = !DILocation(line: 403, column: 13, scope: !590)
!632 = !DILocation(line: 403, column: 18, scope: !590)
!633 = !DILocation(line: 404, column: 13, scope: !590)
!634 = !DILocation(line: 404, column: 18, scope: !590)
!635 = !{!347, !304, i64 1}
!636 = !DILocation(line: 405, column: 20, scope: !590)
!637 = !DILocation(line: 405, column: 13, scope: !590)
!638 = !DILocation(line: 405, column: 18, scope: !590)
!639 = !{!347, !348, i64 4}
!640 = !DILocation(line: 408, column: 3, scope: !590)
!641 = !DILocation(line: 412, column: 13, scope: !590)
!642 = !DILocation(line: 412, column: 20, scope: !590)
!643 = !{!347, !303, i64 2}
!644 = !DILocation(line: 414, column: 3, scope: !645)
!645 = distinct !DILexicalBlock(scope: !590, file: !10, line: 414, column: 3)
!646 = !DILocation(line: 414, column: 3, scope: !590)
!647 = !DILocation(line: 415, column: 65, scope: !648)
!648 = distinct !DILexicalBlock(scope: !645, file: !10, line: 414, column: 63)
!649 = !DILocation(line: 415, column: 24, scope: !648)
!650 = !DILocation(line: 415, column: 22, scope: !648)
!651 = !DILocation(line: 417, column: 3, scope: !648)
!652 = !DILocation(line: 420, column: 3, scope: !590)
!653 = !DILocation(line: 421, column: 3, scope: !590)
!654 = !DILocation(line: 422, column: 3, scope: !590)
!655 = !DILocation(line: 423, column: 1, scope: !590)
!656 = !DILocation(line: 0, scope: !616)
