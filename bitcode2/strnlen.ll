...
define dso_local i64 @strnlen(i8*, i64) local_unnamed_addr #0 !dbg !7 {
  ...
  br i1 %3, label %13, label %4, !dbg !26

; <label>:4:                                      ; preds = %2, %10
  %5 = phi i64 [ %7, %10 ], [ %1, %2 ]
  %6 = phi i8* [ %11, %10 ], [ %0, %2 ]
  %7 = add i64 %5, -1, !dbg !27
  %8 = load i8, i8* %6, align 1, !dbg !28, !tbaa !29
  %9 = icmp eq i8 %8, 0, !dbg !26
  store volatile i32 42, i32* @__A_VARIABLE, align 4
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !24
  br i1 %9, label %15, label %10, !dbg !24

; <label>:10:                                     ; preds = %4
  %11 = getelementptr inbounds i8, i8* %6, i64 1, !dbg !32
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !24
  %12 = icmp eq i64 %7, 0, !dbg !25
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !26
  br i1 %12, label %13, label %4, !dbg !26, !llvm.loop !33
...
; <label>:15:                                     ; preds = %4, %13
  %16 = phi i8* [ %14, %13 ], [ %6, %4 ]
  %17 = ptrtoint i8* %16 to i64, !dbg !34
  %18 = ptrtoint i8* %0 to i64, !dbg !34
  %19 = sub i64 %17, %18, !dbg !34
...
!24 = !DILocation(line: 45, column: 3, scope: !7)
!25 = !DILocation(line: 45, column: 14, scope: !7)
!26 = !DILocation(line: 45, column: 18, scope: !7)
!27 = !DILocation(line: 45, column: 11, scope: !7)
!28 = !DILocation(line: 45, column: 21, scope: !7)
!29 = !{!30, !30, i64 0}
!30 = !{!"omnipotent char", !31, i64 0}
!31 = !{!"Simple C/C++ TBAA"}
!32 = !DILocation(line: 46, column: 8, scope: !7)
!33 = distinct !{!33, !24, !32}
