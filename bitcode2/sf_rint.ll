...
; <label>:46:                                     ; preds = %1
  ...
  %48 = fadd float %0, %0, !dbg !115
  %49 = select i1 %47, float %0, float %48, !dbg !114
  br label %59, !dbg !114
...
; <label>:59:                                     ; preds = %46, %33, %10, %50, %14
  ...
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %3), !dbg !126
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !126
  ret float %60, !dbg !126
}
...
!115 = !DILocation(line: 63, column: 43, scope: !112)
...
!125 = !DILocation(line: 0, scope: !69)
!126 = !DILocation(line: 70, column: 1, scope: !15)
