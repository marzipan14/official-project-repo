...
; <label>:41:                                     ; preds = %33, %30, %36, %12
  ...
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %7) #4, !dbg !253
  call void @llvm.lifetime.end.p0i8(i64 6, i8* nonnull %6) #4, !dbg !253
...
!252 = !DILocation(line: 0, scope: !212)
!253 = !DILocation(line: 121, column: 1, scope: !76)
