; ModuleID = '/root/.unikraft/apps/redis/build/libpthread-embedded/origin/pthread-embedded-44b41d760a433915d70a7be9809651b0a65e001d/pthread_rwlock_trywrlock.c'
source_filename = "/root/.unikraft/apps/redis/build/libpthread-embedded/origin/pthread-embedded-44b41d760a433915d70a7be9809651b0a65e001d/pthread_rwlock_trywrlock.c"
...
define dso_local i32 @pthread_rwlock_trywrlock(%struct.pthread_rwlock_t_**) local_unnamed_addr #0 !dbg !513 {
  %2 = icmp eq %struct.pthread_rwlock_t_** %0, null, !dbg !523
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !525
  br i1 %2, label %56, label %3, !dbg !525

; <label>:3:                                      ; preds = %1
  %4 = load %struct.pthread_rwlock_t_*, %struct.pthread_rwlock_t_** %0, align 8, !dbg !526, !tbaa !527
  %5 = icmp eq %struct.pthread_rwlock_t_* %4, null, !dbg !531
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !532
  br i1 %5, label %56, label %6, !dbg !532

; <label>:6:                                      ; preds = %3
  %7 = icmp eq %struct.pthread_rwlock_t_* %4, inttoptr (i64 -1 to %struct.pthread_rwlock_t_*), !dbg !533
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !535
  br i1 %7, label %8, label %14, !dbg !535

; <label>:8:                                      ; preds = %6
  %9 = tail call i32 @pte_rwlock_check_need_init(%struct.pthread_rwlock_t_** nonnull %0) #3, !dbg !536
  %10 = or i32 %9, 16, !dbg !539
  %11 = icmp eq i32 %10, 16, !dbg !539
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !539
  br i1 %11, label %12, label %56, !dbg !539

; <label>:12:                                     ; preds = %8
  %13 = load %struct.pthread_rwlock_t_*, %struct.pthread_rwlock_t_** %0, align 8, !dbg !541, !tbaa !527
  br label %14, !dbg !539

; <label>:14:                                     ; preds = %12, %6
  %15 = phi %struct.pthread_rwlock_t_* [ %13, %12 ], [ %4, %6 ], !dbg !541
  %16 = getelementptr inbounds %struct.pthread_rwlock_t_, %struct.pthread_rwlock_t_* %15, i64 0, i32 6, !dbg !543
  %17 = load i32, i32* %16, align 4, !dbg !543, !tbaa !545
  %18 = icmp eq i32 %17, 262974946, !dbg !548
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !549
  br i1 %18, label %19, label %56, !dbg !549

; <label>:19:                                     ; preds = %14
  %20 = getelementptr inbounds %struct.pthread_rwlock_t_, %struct.pthread_rwlock_t_* %15, i64 0, i32 0, !dbg !550
  %21 = tail call i32 @pthread_mutex_trylock(%struct.pthread_mutex_t_** %20) #3, !dbg !552
  %22 = icmp eq i32 %21, 0, !dbg !553
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !554
  br i1 %22, label %23, label %56, !dbg !554

; <label>:23:                                     ; preds = %19
  %24 = getelementptr inbounds %struct.pthread_rwlock_t_, %struct.pthread_rwlock_t_* %15, i64 0, i32 1, !dbg !555
  %25 = tail call i32 @pthread_mutex_trylock(%struct.pthread_mutex_t_** nonnull %24) #3, !dbg !557
  %26 = icmp eq i32 %25, 0, !dbg !558
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !559
  br i1 %26, label %31, label %27, !dbg !559

; <label>:27:                                     ; preds = %23
  %28 = tail call i32 @pthread_mutex_unlock(%struct.pthread_mutex_t_** %20) #3, !dbg !560
  %29 = icmp eq i32 %28, 0, !dbg !563
  %30 = select i1 %29, i32 %25, i32 %28, !dbg !564
  br label %56, !dbg !565

; <label>:31:                                     ; preds = %23
  %32 = getelementptr inbounds %struct.pthread_rwlock_t_, %struct.pthread_rwlock_t_* %15, i64 0, i32 4, !dbg !566
  %33 = load i32, i32* %32, align 4, !dbg !566, !tbaa !568
  %34 = icmp eq i32 %33, 0, !dbg !569
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !570
  br i1 %34, label %35, label %54, !dbg !570

; <label>:35:                                     ; preds = %31
  %36 = getelementptr inbounds %struct.pthread_rwlock_t_, %struct.pthread_rwlock_t_* %15, i64 0, i32 5, !dbg !571
  %37 = load i32, i32* %36, align 8, !dbg !571, !tbaa !574
  %38 = icmp sgt i32 %37, 0, !dbg !575
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !576
  %39 = getelementptr inbounds %struct.pthread_rwlock_t_, %struct.pthread_rwlock_t_* %15, i64 0, i32 3
  %40 = load i32, i32* %39, align 8, !dbg !577, !tbaa !579
  br i1 %38, label %41, label %43, !dbg !576

; <label>:41:                                     ; preds = %35
  %42 = sub nsw i32 %40, %37, !dbg !580
  store i32 %42, i32* %39, align 8, !dbg !580, !tbaa !579
  store i32 0, i32* %36, align 8, !dbg !582, !tbaa !574
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !583
  br label %43, !dbg !583

; <label>:43:                                     ; preds = %35, %41
  %44 = phi i32 [ %42, %41 ], [ %40, %35 ], !dbg !584
  %45 = icmp sgt i32 %44, 0, !dbg !585
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !586
  br i1 %45, label %46, label %53, !dbg !586

; <label>:46:                                     ; preds = %43
  %47 = tail call i32 @pthread_mutex_unlock(%struct.pthread_mutex_t_** nonnull %24) #3, !dbg !587
  %48 = icmp eq i32 %47, 0, !dbg !590
  %49 = tail call i32 @pthread_mutex_unlock(%struct.pthread_mutex_t_** nonnull %20) #3, !dbg !591
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !593
  br i1 %48, label %50, label %56, !dbg !593

; <label>:50:                                     ; preds = %46
  %51 = icmp eq i32 %49, 0, !dbg !594
  %52 = select i1 %51, i32 16, i32 %49, !dbg !595
  br label %54, !dbg !596

; <label>:53:                                     ; preds = %43
  store i32 1, i32* %32, align 4, !dbg !597, !tbaa !568
  br label %54

; <label>:54:                                     ; preds = %31, %50, %53
  %55 = phi i32 [ %52, %50 ], [ 0, %53 ], [ 16, %31 ], !dbg !599
  store volatile i32 42, i32* @__A_VARIABLE, align 4
  br label %56, !dbg !601

; <label>:56:                                     ; preds = %46, %19, %14, %8, %1, %3, %54, %27
  %57 = phi i32 [ %30, %27 ], [ %55, %54 ], [ 22, %3 ], [ 22, %1 ], [ %9, %8 ], [ 22, %14 ], [ %21, %19 ], [ %47, %46 ], !dbg !602
...
!1 = !DIFile(filename: "/root/.unikraft/apps/redis/build/libpthread-embedded/origin/pthread-embedded-44b41d760a433915d70a7be9809651b0a65e001d/pthread_rwlock_trywrlock.c", directory: "/root/.unikraft/apps/redis/build")
!2 = !{!3}
...
!513 = distinct !DISubprogram(name: "pthread_rwlock_trywrlock", scope: !1, file: !1, line: 50, type: !514, isLocal: false, isDefinition: true, scopeLine: 51, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !517)
...
!520 = !DILocalVariable(name: "result1", scope: !513, file: !1, line: 52, type: !41)
!521 = !DILocalVariable(name: "rwl", scope: !513, file: !1, line: 53, type: !12)
!522 = !DILocation(line: 50, column: 46, scope: !513)
!523 = !DILocation(line: 55, column: 14, scope: !524)
!524 = distinct !DILexicalBlock(scope: !513, file: !1, line: 55, column: 7)
!525 = !DILocation(line: 55, column: 22, scope: !524)
!526 = !DILocation(line: 55, column: 25, scope: !524)
!527 = !{!528, !528, i64 0}
!528 = !{!"any pointer", !529, i64 0}
!529 = !{!"omnipotent char", !530, i64 0}
!530 = !{!"Simple C/C++ TBAA"}
!531 = !DILocation(line: 55, column: 33, scope: !524)
!532 = !DILocation(line: 55, column: 7, scope: !513)
!533 = !DILocation(line: 66, column: 15, scope: !534)
!534 = distinct !DILexicalBlock(scope: !513, file: !1, line: 66, column: 7)
!535 = !DILocation(line: 66, column: 7, scope: !513)
!536 = !DILocation(line: 68, column: 16, scope: !537)
!537 = distinct !DILexicalBlock(scope: !534, file: !1, line: 67, column: 5)
!538 = !DILocation(line: 52, column: 7, scope: !513)
!539 = !DILocation(line: 70, column: 23, scope: !540)
!540 = distinct !DILexicalBlock(scope: !537, file: !1, line: 70, column: 11)
!541 = !DILocation(line: 76, column: 9, scope: !513)
!542 = !DILocation(line: 53, column: 20, scope: !513)
!543 = !DILocation(line: 78, column: 12, scope: !544)
!544 = distinct !DILexicalBlock(scope: !513, file: !1, line: 78, column: 7)
!545 = !{!546, !547, i64 36}
!546 = !{!"pthread_rwlock_t_", !528, i64 0, !528, i64 8, !528, i64 16, !547, i64 24, !547, i64 28, !547, i64 32, !547, i64 36}
!547 = !{!"int", !529, i64 0}
!548 = !DILocation(line: 78, column: 19, scope: !544)
!549 = !DILocation(line: 78, column: 7, scope: !513)
!550 = !DILocation(line: 83, column: 47, scope: !551)
!551 = distinct !DILexicalBlock(scope: !513, file: !1, line: 83, column: 7)
!552 = !DILocation(line: 83, column: 17, scope: !551)
!553 = !DILocation(line: 83, column: 69, scope: !551)
!554 = !DILocation(line: 83, column: 7, scope: !513)
!555 = !DILocation(line: 89, column: 40, scope: !556)
!556 = distinct !DILexicalBlock(scope: !513, file: !1, line: 88, column: 7)
!557 = !DILocation(line: 89, column: 10, scope: !556)
!558 = !DILocation(line: 89, column: 68, scope: !556)
!559 = !DILocation(line: 88, column: 7, scope: !513)
!560 = !DILocation(line: 91, column: 17, scope: !561)
!561 = distinct !DILexicalBlock(scope: !556, file: !1, line: 90, column: 5)
!562 = !DILocation(line: 52, column: 15, scope: !513)
!563 = !DILocation(line: 92, column: 24, scope: !561)
!564 = !DILocation(line: 92, column: 15, scope: !561)
!565 = !DILocation(line: 92, column: 7, scope: !561)
!566 = !DILocation(line: 95, column: 12, scope: !567)
!567 = distinct !DILexicalBlock(scope: !513, file: !1, line: 95, column: 7)
!568 = !{!546, !547, i64 28}
!569 = !DILocation(line: 95, column: 34, scope: !567)
!570 = !DILocation(line: 95, column: 7, scope: !513)
!571 = !DILocation(line: 97, column: 16, scope: !572)
!572 = distinct !DILexicalBlock(scope: !573, file: !1, line: 97, column: 11)
!573 = distinct !DILexicalBlock(scope: !567, file: !1, line: 96, column: 5)
!574 = !{!546, !547, i64 32}
!575 = !DILocation(line: 97, column: 44, scope: !572)
!576 = !DILocation(line: 97, column: 11, scope: !573)
!577 = !DILocation(line: 0, scope: !578)
!578 = distinct !DILexicalBlock(scope: !573, file: !1, line: 103, column: 11)
!579 = !{!546, !547, i64 24}
!580 = !DILocation(line: 99, column: 35, scope: !581)
!581 = distinct !DILexicalBlock(scope: !572, file: !1, line: 98, column: 9)
!582 = !DILocation(line: 100, column: 44, scope: !581)
!583 = !DILocation(line: 101, column: 9, scope: !581)
!584 = !DILocation(line: 103, column: 16, scope: !578)
!585 = !DILocation(line: 103, column: 35, scope: !578)
!586 = !DILocation(line: 103, column: 11, scope: !573)
!587 = !DILocation(line: 106, column: 18, scope: !588)
!588 = distinct !DILexicalBlock(scope: !589, file: !1, line: 105, column: 15)
!589 = distinct !DILexicalBlock(scope: !578, file: !1, line: 104, column: 9)
!590 = !DILocation(line: 106, column: 75, scope: !588)
!591 = !DILocation(line: 0, scope: !592)
!592 = distinct !DILexicalBlock(scope: !589, file: !1, line: 112, column: 15)
!593 = !DILocation(line: 105, column: 15, scope: !589)
!594 = !DILocation(line: 113, column: 69, scope: !592)
!595 = !DILocation(line: 112, column: 15, scope: !589)
!596 = !DILocation(line: 117, column: 9, scope: !589)
!597 = !DILocation(line: 120, column: 38, scope: !598)
!598 = distinct !DILexicalBlock(scope: !578, file: !1, line: 119, column: 9)
!599 = !DILocation(line: 0, scope: !600)
!600 = distinct !DILexicalBlock(scope: !567, file: !1, line: 124, column: 5)
!601 = !DILocation(line: 128, column: 3, scope: !513)
!602 = !DILocation(line: 0, scope: !513)
!603 = !DILocation(line: 0, scope: !604)
!604 = distinct !DILexicalBlock(scope: !524, file: !1, line: 56, column: 5)
!605 = !DILocation(line: 129, column: 1, scope: !513)
