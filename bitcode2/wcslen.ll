...
define dso_local i64 @wcslen(i32*) local_unnamed_addr #0 !dbg !7 {
  ...
  %2 = load i32, i32* %0, align 4, !dbg !23, !tbaa !24
  %3 = icmp eq i32 %2, 0, !dbg !22
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !22
  br i1 %3, label %9, label %4, !dbg !22
...
; <label>:4:                                      ; preds = %1, %4
  ...
  %8 = icmp eq i32 %7, 0, !dbg !22
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !22
  br i1 %8, label %9, label %4, !dbg !22, !llvm.loop !29

; <label>:9:                                      ; preds = %4, %1
  %10 = phi i32* [ %0, %1 ], [ %6, %4 ], !dbg !30
  %11 = ptrtoint i32* %10 to i64, !dbg !31
  %12 = ptrtoint i32* %0 to i64, !dbg !31
  %13 = sub i64 %11, %12, !dbg !31
  %14 = ashr exact i64 %13, 2, !dbg !31
...
!23 = !DILocation(line: 68, column: 10, scope: !7)
!24 = !{!25, !25, i64 0}
!25 = !{!"int", !26, i64 0}
!26 = !{!"omnipotent char", !27, i64 0}
!27 = !{!"Simple C/C++ TBAA"}
!28 = !DILocation(line: 69, column: 6, scope: !7)
!29 = distinct !{!29, !22, !28}
