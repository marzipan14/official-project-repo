...
; <label>:15:                                     ; preds = %11, %3
  ...
  br i1 %17, label %19, label %56, !dbg !268
...
; <label>:19:                                     ; preds = %18, %15
  %20 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %2, i64 0, i32 22
  %21 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %2, i64 0, i32 2
  %22 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %2, i64 0, i32 0
  %23 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %2, i64 0, i32 6
  br label %24, !dbg !269

; <label>:24:                                     ; preds = %19, %53
  %25 = call i64 @_wcsrtombs_r(%struct._reent* %0, i8* nonnull %6, i32** nonnull %4, i64 1024, %struct._mbstate_t* nonnull %20) #5, !dbg !271
  %26 = icmp eq i64 %25, -1, !dbg !273
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !275
  br i1 %26, label %52, label %27, !dbg !275

; <label>:27:                                     ; preds = %24
  %28 = icmp eq i64 %25, 0, !dbg !276
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !277
  br i1 %28, label %53, label %29, !dbg !277

; <label>:29:                                     ; preds = %27, %49
  %30 = phi i64 [ %50, %49 ], [ 0, %27 ]
  %31 = getelementptr inbounds [1024 x i8], [1024 x i8]* %5, i64 0, i64 %30, !dbg !278
  %32 = load i8, i8* %31, align 1, !dbg !278, !tbaa !281
  %33 = sext i8 %32 to i32, !dbg !278
  %34 = load i32, i32* %21, align 4, !dbg !293, !tbaa !295
  %35 = add nsw i32 %34, -1, !dbg !293
  store i32 %35, i32* %21, align 4, !dbg !293, !tbaa !295
  %36 = icmp sgt i32 %34, 0, !dbg !296
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !297
  br i1 %36, label %43, label %37, !dbg !297

; <label>:37:                                     ; preds = %29
  %38 = load i32, i32* %23, align 8, !dbg !298, !tbaa !299
  %39 = icmp sgt i32 %34, %38, !dbg !300
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !301
  br i1 %39, label %40, label %46, !dbg !301

; <label>:40:                                     ; preds = %37
  %41 = and i32 %33, 255, !dbg !302
  %42 = icmp eq i32 %41, 10, !dbg !302
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !303
  br i1 %42, label %46, label %43, !dbg !303

; <label>:43:                                     ; preds = %40, %29
  %44 = load i8*, i8** %22, align 8, !dbg !304, !tbaa !305
  %45 = getelementptr inbounds i8, i8* %44, i64 1, !dbg !304
  store i8* %45, i8** %22, align 8, !dbg !304, !tbaa !305
  store i8 %32, i8* %44, align 1, !dbg !306, !tbaa !281
...
; <label>:46:                                     ; preds = %37, %40
  %47 = call i32 @__swbuf_r(%struct._reent* %0, i32 %33, %struct.__sFILE* nonnull %2) #5, !dbg !310
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !311
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !308
  %48 = icmp eq i32 %47, -1, !dbg !312
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !309
  br i1 %48, label %52, label %49, !dbg !309

; <label>:49:                                     ; preds = %43, %46
  %50 = add nuw i64 %30, 1, !dbg !313
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !277
  %51 = icmp ult i64 %50, %25, !dbg !276
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !277
  br i1 %51, label %29, label %53, !dbg !277, !llvm.loop !314

; <label>:52:                                     ; preds = %24, %46
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !316
  store volatile i32 42, i32* @__A_VARIABLE, align 4
  br label %56

; <label>:53:                                     ; preds = %49, %27
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !317
  store volatile i32 42, i32* @__A_VARIABLE, align 4
  %54 = load i32*, i32** %4, align 8, !dbg !318, !tbaa !252
  %55 = icmp eq i32* %54, null, !dbg !319
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !320
  br i1 %55, label %56, label %24, !dbg !320, !llvm.loop !321

; <label>:56:                                     ; preds = %53, %52, %15
  %57 = phi i32 [ -1, %15 ], [ -1, %52 ], [ 0, %53 ]
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !324
  call void @llvm.lifetime.end.p0i8(i64 1024, i8* nonnull %6) #4, !dbg !325
...
; Function Attrs: noredzone nounwind
define dso_local i32 @fputws_unlocked(i32* noalias, %struct.__sFILE* noalias) local_unnamed_addr #0 !dbg !326 {
  %3 = tail call %struct._reent* @__getreent() #5, !dbg !338
  %4 = icmp eq %struct._reent* %3, null, !dbg !341
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !341
  br i1 %4, label %10, label %5, !dbg !341

; <label>:5:                                      ; preds = %2
  %6 = getelementptr inbounds %struct._reent, %struct._reent* %3, i64 0, i32 8, !dbg !341
  %7 = load i32, i32* %6, align 8, !dbg !341, !tbaa !343
  %8 = icmp eq i32 %7, 0, !dbg !341
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !340
  br i1 %8, label %9, label %10, !dbg !340

; <label>:9:                                      ; preds = %5
  tail call void @__sinit(%struct._reent* nonnull %3) #5, !dbg !341
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !341
  br label %10, !dbg !341

; <label>:10:                                     ; preds = %5, %2, %9
  %11 = tail call i32 @_fputws_unlocked_r(%struct._reent* %3, i32* %0, %struct.__sFILE* %1) #6, !dbg !348
...
!273 = !DILocation(line: 165, column: 18, scope: !274)
!274 = distinct !DILexicalBlock(scope: !250, file: !14, line: 165, column: 11)
!275 = !DILocation(line: 165, column: 11, scope: !250)
!276 = !DILocation(line: 167, column: 16, scope: !250)
!277 = !DILocation(line: 167, column: 7, scope: !250)
!278 = !DILocation(line: 169, column: 24, scope: !279)
!279 = distinct !DILexicalBlock(scope: !280, file: !14, line: 169, column: 8)
!280 = distinct !DILexicalBlock(scope: !250, file: !14, line: 168, column: 9)
!281 = !{!254, !254, i64 0}
!282 = !DILocalVariable(name: "_ptr", arg: 1, scope: !283, file: !239, line: 687, type: !18)
!283 = distinct !DISubprogram(name: "__sputc_r", scope: !239, file: !239, line: 687, type: !284, isLocal: true, isDefinition: true, scopeLine: 687, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !286)
!284 = !DISubroutineType(types: !285)
!285 = !{!17, !18, !17, !237}
!286 = !{!282, !287, !288}
!287 = !DILocalVariable(name: "_c", arg: 2, scope: !283, file: !239, line: 687, type: !17)
!288 = !DILocalVariable(name: "_p", arg: 3, scope: !283, file: !239, line: 687, type: !237)
!289 = !DILocation(line: 687, column: 47, scope: !283, inlinedAt: !290)
!290 = distinct !DILocation(line: 169, column: 8, scope: !279)
!291 = !DILocation(line: 687, column: 57, scope: !283, inlinedAt: !290)
!292 = !DILocation(line: 687, column: 67, scope: !283, inlinedAt: !290)
!293 = !DILocation(line: 692, column: 6, scope: !294, inlinedAt: !290)
!294 = distinct !DILexicalBlock(scope: !283, file: !239, line: 692, column: 6)
!295 = !{!261, !262, i64 12}
!296 = !DILocation(line: 692, column: 15, scope: !294, inlinedAt: !290)
!297 = !DILocation(line: 692, column: 20, scope: !294, inlinedAt: !290)
!298 = !DILocation(line: 692, column: 38, scope: !294, inlinedAt: !290)
!299 = !{!261, !262, i64 40}
!300 = !DILocation(line: 692, column: 31, scope: !294, inlinedAt: !290)
!301 = !DILocation(line: 692, column: 47, scope: !294, inlinedAt: !290)
!302 = !DILocation(line: 692, column: 59, scope: !294, inlinedAt: !290)
!303 = !DILocation(line: 692, column: 6, scope: !283, inlinedAt: !290)
!304 = !DILocation(line: 693, column: 18, scope: !294, inlinedAt: !290)
!305 = !{!261, !253, i64 0}
!306 = !DILocation(line: 693, column: 21, scope: !294, inlinedAt: !290)
!307 = !DILocation(line: 693, column: 3, scope: !294, inlinedAt: !290)
!308 = !DILocation(line: 696, column: 1, scope: !283, inlinedAt: !290)
!309 = !DILocation(line: 169, column: 8, scope: !280)
!310 = !DILocation(line: 695, column: 11, scope: !294, inlinedAt: !290)
!311 = !DILocation(line: 695, column: 3, scope: !294, inlinedAt: !290)
!312 = !DILocation(line: 169, column: 36, scope: !279)
!313 = !DILocation(line: 171, column: 5, scope: !280)
!314 = distinct !{!314, !277, !315}
!315 = !DILocation(line: 172, column: 9, scope: !250)
!316 = !DILocation(line: 0, scope: !279)
!317 = !DILocation(line: 173, column: 5, scope: !13)
!318 = !DILocation(line: 174, column: 10, scope: !13)
!319 = !DILocation(line: 174, column: 13, scope: !13)
!320 = !DILocation(line: 173, column: 5, scope: !250)
!321 = distinct !{!321, !322, !323}
!322 = !DILocation(line: 161, column: 3, scope: !13)
!323 = !DILocation(line: 174, column: 20, scope: !13)
!324 = !DILocation(line: 0, scope: !13)
!325 = !DILocation(line: 182, column: 1, scope: !13)
!326 = distinct !DISubprogram(name: "fputws_unlocked", scope: !14, file: !14, line: 185, type: !327, isLocal: false, isDefinition: true, scopeLine: 188, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !331)
!327 = !DISubroutineType(types: !328)
!328 = !{!17, !329, !330}
!329 = !DIDerivedType(tag: DW_TAG_restrict_type, baseType: !234)
!330 = !DIDerivedType(tag: DW_TAG_restrict_type, baseType: !237)
!331 = !{!332, !333, !334, !335}
!332 = !DILocalVariable(name: "ws", arg: 1, scope: !326, file: !14, line: 185, type: !329)
!333 = !DILocalVariable(name: "fp", arg: 2, scope: !326, file: !14, line: 185, type: !330)
!334 = !DILocalVariable(name: "reent", scope: !326, file: !14, line: 189, type: !18)
!335 = !DILocalVariable(name: "_check_init_ptr", scope: !336, file: !14, line: 191, type: !18)
!336 = distinct !DILexicalBlock(scope: !326, file: !14, line: 191, column: 3)
!337 = !DILocation(line: 185, column: 1, scope: !326)
!338 = !DILocation(line: 189, column: 26, scope: !326)
!339 = !DILocation(line: 189, column: 18, scope: !326)
!340 = !DILocation(line: 191, column: 3, scope: !336)
!341 = !DILocation(line: 191, column: 3, scope: !342)
!342 = distinct !DILexicalBlock(scope: !336, file: !14, line: 191, column: 3)
!343 = !{!344, !262, i64 80}
!344 = !{!"_reent", !262, i64 0, !253, i64 8, !253, i64 16, !253, i64 24, !262, i64 32, !254, i64 36, !262, i64 64, !253, i64 72, !262, i64 80, !253, i64 88, !253, i64 96, !262, i64 104, !253, i64 112, !253, i64 120, !262, i64 128, !253, i64 136, !254, i64 144, !253, i64 504, !345, i64 512, !253, i64 1304, !347, i64 1312, !254, i64 1336}
!345 = !{!"_atexit", !253, i64 0, !262, i64 8, !254, i64 16, !346, i64 272}
!346 = !{!"_on_exit_args", !254, i64 0, !254, i64 256, !262, i64 512, !262, i64 516}
!347 = !{!"_glue", !253, i64 0, !262, i64 8, !253, i64 16}
!348 = !DILocation(line: 192, column: 10, scope: !326)
!349 = !DILocation(line: 192, column: 3, scope: !326)
