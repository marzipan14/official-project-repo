...
define dso_local i64 @_fread_r(%struct._reent*, i8* noalias, i64, i64, %struct.__sFILE* noalias) local_unnamed_addr #0 !dbg !36 {
  ...
  br i1 %8, label %124, label %9, !dbg !285
...
; <label>:29:                                     ; preds = %23
  ...
  br i1 %32, label %87, label %107, !dbg !323
...
; <label>:60:                                     ; preds = %34
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !344
  %61 = icmp eq i64 %49, 0, !dbg !345
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !344
  br i1 %61, label %83, label %62, !dbg !344

; <label>:62:                                     ; preds = %59, %60
  %63 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %4, i64 0, i32 5
  %64 = getelementptr inbounds %struct.__sbuf, %struct.__sbuf* %63, i64 0, i32 0
  %65 = bitcast %struct.__sbuf* %63 to i64*
  %66 = bitcast %struct.__sFILE* %4 to i64*
  %67 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %4, i64 0, i32 5, i32 1
  %68 = load i64, i64* %65, align 8, !dbg !346, !tbaa !347
  %69 = load i64, i64* %66, align 8, !dbg !348, !tbaa !322
  %70 = load i32, i32* %67, align 8, !dbg !349, !tbaa !350
  br label %71, !dbg !344

; <label>:71:                                     ; preds = %62, %80
  %72 = phi i64 [ %49, %62 ], [ %78, %80 ]
  %73 = phi i8* [ %48, %62 ], [ %81, %80 ]
  store i8* %73, i8** %64, align 8, !dbg !355, !tbaa !347
  %74 = trunc i64 %72 to i32, !dbg !356
  store i32 %74, i32* %67, align 8, !dbg !357, !tbaa !350
  store i8* %73, i8** %39, align 8, !dbg !358, !tbaa !322
  %75 = call i32 @__srefill_r(%struct._reent* %0, %struct.__sFILE* nonnull %4) #4, !dbg !359
  store i64 %68, i64* %65, align 8, !dbg !360, !tbaa !347
  store i32 %70, i32* %67, align 8, !dbg !361, !tbaa !350
  store i64 %69, i64* %66, align 8, !dbg !362, !tbaa !322
  %76 = load i32, i32* %19, align 8, !dbg !363, !tbaa !301
  %77 = sext i32 %76 to i64, !dbg !364
  %78 = sub i64 %72, %77, !dbg !365
  store i32 0, i32* %19, align 8, !dbg !366, !tbaa !301
  %79 = icmp eq i32 %75, 0, !dbg !367
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !369
  br i1 %79, label %80, label %84, !dbg !369

; <label>:80:                                     ; preds = %71
  %81 = getelementptr inbounds i8, i8* %73, i64 %77, !dbg !370
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !371
  store volatile i32 42, i32* @__A_VARIABLE, align 4
  %82 = icmp eq i64 %78, 0, !dbg !345
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !344
  br i1 %82, label %83, label %71, !dbg !344
...
; <label>:84:                                     ; preds = %71
  %85 = load i32, i32* %6, align 4, !dbg !373, !tbaa !375
  %86 = call i32 @pthread_setcancelstate(i32 %85, i32* nonnull %6) #4, !dbg !373
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !376
  store volatile i32 42, i32* @__A_VARIABLE, align 4
  br label %117

; <label>:87:                                     ; preds = %29, %98
  %88 = phi i8* [ %103, %98 ], [ %33, %29 ]
  %89 = phi i64 [ %101, %98 ], [ %31, %29 ]
  %90 = phi i64 [ %95, %98 ], [ %7, %29 ]
  %91 = phi i8* [ %99, %98 ], [ %1, %29 ]
  %92 = call i8* @memcpy(i8* %91, i8* %88, i64 %89) #4, !dbg !377
  %93 = load i8*, i8** %30, align 8, !dbg !379, !tbaa !322
  %94 = getelementptr inbounds i8, i8* %93, i64 %89, !dbg !379
  store i8* %94, i8** %30, align 8, !dbg !379, !tbaa !322
  %95 = sub i64 %90, %89, !dbg !380
  %96 = call i32 @__srefill_r(%struct._reent* %0, %struct.__sFILE* nonnull %4) #4, !dbg !381
  %97 = icmp eq i32 %96, 0, !dbg !381
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !383
  br i1 %97, label %98, label %104, !dbg !383, !llvm.loop !384

; <label>:98:                                     ; preds = %87
  %99 = getelementptr inbounds i8, i8* %91, i64 %89, !dbg !386
  %100 = load i32, i32* %19, align 8, !dbg !387, !tbaa !301
  %101 = sext i32 %100 to i64, !dbg !318
  %102 = icmp ugt i64 %95, %101, !dbg !320
  %103 = load i8*, i8** %30, align 8, !dbg !321, !tbaa !322
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !323
  br i1 %102, label %87, label %107, !dbg !323

; <label>:104:                                    ; preds = %87
  %105 = load i32, i32* %6, align 4, !dbg !388, !tbaa !375
  %106 = call i32 @pthread_setcancelstate(i32 %105, i32* nonnull %6) #4, !dbg !388
  br label %117, !dbg !390

; <label>:107:                                    ; preds = %98, %29
  %108 = phi i8* [ %1, %29 ], [ %99, %98 ], !dbg !391
  %109 = phi i64 [ %7, %29 ], [ %95, %98 ], !dbg !391
  %110 = phi i8* [ %33, %29 ], [ %103, %98 ], !dbg !321
  %111 = call i8* @memcpy(i8* %108, i8* %110, i64 %109) #4, !dbg !392
  %112 = load i32, i32* %19, align 8, !dbg !393, !tbaa !301
  %113 = trunc i64 %109 to i32, !dbg !393
  %114 = sub i32 %112, %113, !dbg !393
  store i32 %114, i32* %19, align 8, !dbg !393, !tbaa !301
  %115 = load i8*, i8** %30, align 8, !dbg !394, !tbaa !322
  %116 = getelementptr inbounds i8, i8* %115, i64 %109, !dbg !394
  store i8* %116, i8** %30, align 8, !dbg !394, !tbaa !322
  br label %121

; <label>:117:                                    ; preds = %84, %104
  %118 = phi i64 [ %95, %104 ], [ %78, %84 ]
  store volatile i32 42, i32* @__A_VARIABLE, align 4
  %119 = sub i64 %7, %118, !dbg !395
  %120 = udiv i64 %119, %2, !dbg !395
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %17) #5, !dbg !396
  br label %124

; <label>:121:                                    ; preds = %83, %107
  store volatile i32 42, i32* @__A_VARIABLE, align 4
  %122 = load i32, i32* %6, align 4, !dbg !397, !tbaa !375
  %123 = call i32 @pthread_setcancelstate(i32 %122, i32* nonnull %6) #4, !dbg !397
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !396
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %17) #5, !dbg !396
  store volatile i32 42, i32* @__A_VARIABLE, align 4
  br label %124, !dbg !398

; <label>:124:                                    ; preds = %5, %117, %121
  %125 = phi i64 [ %3, %121 ], [ %120, %117 ], [ 0, %5 ], !dbg !395
  store volatile i32 42, i32* @__A_VARIABLE, align 4
...
; Function Attrs: noredzone nounwind
define dso_local i64 @fread(i8* noalias, i64, i64, %struct.__sFILE* noalias) local_unnamed_addr #0 !dbg !400 {
  %5 = tail call %struct._reent* @__getreent() #4, !dbg !409
  %6 = tail call i64 @_fread_r(%struct._reent* %5, i8* %0, i64 %1, i64 %2, %struct.__sFILE* %3) #6, !dbg !410
...
!345 = !DILocation(line: 219, column: 20, scope: !273)
!346 = !DILocation(line: 223, column: 29, scope: !276)
!347 = !{!302, !294, i64 24}
!348 = !DILocation(line: 224, column: 23, scope: !276)
!349 = !DILocation(line: 225, column: 27, scope: !276)
!350 = !{!302, !291, i64 32}
!351 = !DILocation(line: 221, column: 8, scope: !276)
!352 = !DILocation(line: 223, column: 10, scope: !276)
!353 = !DILocation(line: 224, column: 11, scope: !276)
!354 = !DILocation(line: 225, column: 8, scope: !276)
!355 = !DILocation(line: 227, column: 18, scope: !276)
!356 = !DILocation(line: 228, column: 20, scope: !276)
!357 = !DILocation(line: 228, column: 18, scope: !276)
!358 = !DILocation(line: 229, column: 11, scope: !276)
!359 = !DILocation(line: 230, column: 9, scope: !276)
!360 = !DILocation(line: 232, column: 18, scope: !276)
!361 = !DILocation(line: 233, column: 18, scope: !276)
!362 = !DILocation(line: 234, column: 11, scope: !276)
!363 = !DILocation(line: 235, column: 17, scope: !276)
!364 = !DILocation(line: 235, column: 13, scope: !276)
!365 = !DILocation(line: 235, column: 10, scope: !276)
!366 = !DILocation(line: 237, column: 11, scope: !276)
!367 = !DILocation(line: 238, column: 8, scope: !368)
!368 = distinct !DILexicalBlock(scope: !276, file: !1, line: 238, column: 8)
!369 = !DILocation(line: 238, column: 8, scope: !276)
!370 = !DILocation(line: 236, column: 6, scope: !276)
!371 = !DILocation(line: 250, column: 2, scope: !273)
!372 = !DILocation(line: 251, column: 5, scope: !274)
!373 = !DILocation(line: 247, column: 8, scope: !374)
!374 = distinct !DILexicalBlock(scope: !368, file: !1, line: 239, column: 6)
!375 = !{!291, !291, i64 0}
!376 = !DILocation(line: 248, column: 8, scope: !374)
!377 = !DILocation(line: 257, column: 15, scope: !378)
!378 = distinct !DILexicalBlock(scope: !319, file: !1, line: 256, column: 2)
!379 = !DILocation(line: 258, column: 11, scope: !378)
!380 = !DILocation(line: 261, column: 10, scope: !378)
!381 = !DILocation(line: 262, column: 8, scope: !382)
!382 = distinct !DILexicalBlock(scope: !378, file: !1, line: 262, column: 8)
!383 = !DILocation(line: 262, column: 8, scope: !378)
!384 = distinct !{!384, !323, !385}
!385 = !DILocation(line: 275, column: 2, scope: !319)
!386 = !DILocation(line: 260, column: 6, scope: !378)
!387 = !DILocation(line: 255, column: 31, scope: !319)
!388 = !DILocation(line: 272, column: 8, scope: !389)
!389 = distinct !DILexicalBlock(scope: !382, file: !1, line: 263, column: 6)
!390 = !DILocation(line: 273, column: 8, scope: !389)
!391 = !DILocation(line: 0, scope: !378)
!392 = !DILocation(line: 276, column: 18, scope: !319)
!393 = !DILocation(line: 277, column: 14, scope: !319)
!394 = !DILocation(line: 278, column: 14, scope: !319)
!395 = !DILocation(line: 0, scope: !374)
!396 = !DILocation(line: 289, column: 3, scope: !36)
!397 = !DILocation(line: 289, column: 3, scope: !271)
!398 = !DILocation(line: 290, column: 3, scope: !36)
!399 = !DILocation(line: 291, column: 1, scope: !36)
!400 = distinct !DISubprogram(name: "fread", scope: !1, file: !1, line: 295, type: !401, isLocal: false, isDefinition: true, scopeLine: 300, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !403)
!401 = !DISubroutineType(types: !402)
!402 = !{!39, !253, !23, !23, !254}
!403 = !{!404, !405, !406, !407}
!404 = !DILocalVariable(name: "buf", arg: 1, scope: !400, file: !1, line: 295, type: !253)
!405 = !DILocalVariable(name: "size", arg: 2, scope: !400, file: !1, line: 295, type: !23)
!406 = !DILocalVariable(name: "count", arg: 3, scope: !400, file: !1, line: 295, type: !23)
!407 = !DILocalVariable(name: "fp", arg: 4, scope: !400, file: !1, line: 295, type: !254)
!408 = !DILocation(line: 295, column: 1, scope: !400)
!409 = !DILocation(line: 301, column: 21, scope: !400)
!410 = !DILocation(line: 301, column: 11, scope: !400)
!411 = !DILocation(line: 301, column: 4, scope: !400)
