...
; <label>:41:                                     ; preds = %33
  ...
  %43 = icmp sgt i32 %36, %42, !dbg !314
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !315
  br i1 %43, label %44, label %51, !dbg !315

; <label>:44:                                     ; preds = %41
  %45 = and i32 %35, 255, !dbg !316
  %46 = icmp eq i32 %45, 10, !dbg !316
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !317
  br i1 %46, label %51, label %47, !dbg !317

; <label>:47:                                     ; preds = %44, %39
  %48 = phi i32 [ %40, %39 ], [ %45, %44 ], !dbg !311
  %49 = load i8*, i8** %27, align 8, !dbg !318, !tbaa !319
  %50 = getelementptr inbounds i8, i8* %49, i64 1, !dbg !318
  store i8* %50, i8** %27, align 8, !dbg !318, !tbaa !319
  store i8 %31, i8* %49, align 1, !dbg !320, !tbaa !292
  br label %53, !dbg !321

; <label>:51:                                     ; preds = %44, %41
  %52 = call i32 @__swbuf_r(%struct._reent* %0, i32 %35, %struct.__sFILE* nonnull %2) #4, !dbg !322
  br label %53, !dbg !323

; <label>:53:                                     ; preds = %47, %51
  %54 = phi i32 [ %48, %47 ], [ %52, %51 ], !dbg !324
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !288
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !325
  %55 = icmp eq i32 %54, -1, !dbg !326
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !327
  br i1 %55, label %59, label %29, !dbg !327, !llvm.loop !328

; <label>:56:                                     ; preds = %29
  %57 = load i32, i32* %4, align 4, !dbg !330, !tbaa !331
  %58 = call i32 @pthread_setcancelstate(i32 %57, i32* nonnull %4) #4, !dbg !330
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !332
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %12) #5, !dbg !333
  br label %62

; <label>:59:                                     ; preds = %53, %22
  %60 = load i32, i32* %4, align 4, !dbg !334, !tbaa !331
  %61 = call i32 @pthread_setcancelstate(i32 %60, i32* nonnull %4) #4, !dbg !334
...
; Function Attrs: noredzone nounwind
define dso_local i32 @fputs(i8* noalias nocapture readonly, %struct.__sFILE* noalias) local_unnamed_addr #0 !dbg !337 {
  %3 = tail call %struct._reent* @__getreent() #4, !dbg !344
  %4 = tail call i32 @_fputs_r(%struct._reent* %3, i8* %0, %struct.__sFILE* %1) #6, !dbg !345
...
!315 = !DILocation(line: 692, column: 47, scope: !307, inlinedAt: !303)
!316 = !DILocation(line: 692, column: 59, scope: !307, inlinedAt: !303)
!317 = !DILocation(line: 692, column: 6, scope: !296, inlinedAt: !303)
!318 = !DILocation(line: 693, column: 18, scope: !307, inlinedAt: !303)
!319 = !{!280, !272, i64 0}
!320 = !DILocation(line: 693, column: 21, scope: !307, inlinedAt: !303)
!321 = !DILocation(line: 693, column: 3, scope: !307, inlinedAt: !303)
!322 = !DILocation(line: 695, column: 11, scope: !307, inlinedAt: !303)
!323 = !DILocation(line: 695, column: 3, scope: !307, inlinedAt: !303)
!324 = !DILocation(line: 0, scope: !307, inlinedAt: !303)
!325 = !DILocation(line: 696, column: 1, scope: !296, inlinedAt: !303)
!326 = !DILocation(line: 148, column: 37, scope: !289)
!327 = !DILocation(line: 148, column: 11, scope: !290)
!328 = distinct !{!328, !287, !329}
!329 = !DILocation(line: 150, column: 5, scope: !261)
!330 = !DILocation(line: 151, column: 3, scope: !261)
!331 = !{!269, !269, i64 0}
!332 = !DILocation(line: 152, column: 3, scope: !261)
!333 = !DILocation(line: 155, column: 3, scope: !28)
!334 = !DILocation(line: 155, column: 3, scope: !261)
!335 = !DILocation(line: 156, column: 3, scope: !28)
!336 = !DILocation(line: 158, column: 1, scope: !28)
!337 = distinct !DISubprogram(name: "fputs", scope: !1, file: !1, line: 162, type: !338, isLocal: false, isDefinition: true, scopeLine: 165, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !340)
!338 = !DISubroutineType(types: !339)
!339 = !{!5, !248, !249}
!340 = !{!341, !342}
!341 = !DILocalVariable(name: "s", arg: 1, scope: !337, file: !1, line: 162, type: !248)
!342 = !DILocalVariable(name: "fp", arg: 2, scope: !337, file: !1, line: 162, type: !249)
!343 = !DILocation(line: 162, column: 1, scope: !337)
!344 = !DILocation(line: 166, column: 20, scope: !337)
!345 = !DILocation(line: 166, column: 10, scope: !337)
!346 = !DILocation(line: 166, column: 3, scope: !337)
