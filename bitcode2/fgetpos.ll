; ModuleID = '/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/stdio/fgetpos.c'
source_filename = "/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/stdio/fgetpos.c"
...
define dso_local i32 @_fgetpos_r(%struct._reent*, %struct.__sFILE* noalias, i64* noalias nocapture) local_unnamed_addr #0 !dbg !7 {
  %4 = tail call i64 @_ftell_r(%struct._reent* %0, %struct.__sFILE* %1) #3, !dbg !241
  store i64 %4, i64* %2, align 8, !dbg !242, !tbaa !243
  %5 = icmp eq i64 %4, -1, !dbg !247
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !249
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !250
  %6 = zext i1 %5 to i32, !dbg !252
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !253
  ret i32 %6, !dbg !253
}

; Function Attrs: noredzone
declare dso_local i64 @_ftell_r(%struct._reent*, %struct.__sFILE*) local_unnamed_addr #1

; Function Attrs: noredzone nounwind
define dso_local i32 @fgetpos(%struct.__sFILE* noalias, i64* noalias nocapture) local_unnamed_addr #0 !dbg !254 {
  %3 = tail call %struct._reent* @__getreent() #3, !dbg !261
  %4 = tail call i64 @_ftell_r(%struct._reent* %3, %struct.__sFILE* %0) #3, !dbg !264, !noalias !265
  store i64 %4, i64* %1, align 8, !dbg !268, !tbaa !243, !alias.scope !265, !noalias !269
  %5 = icmp eq i64 %4, -1, !dbg !271
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !272, !noalias !265
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !273, !noalias !265
  %6 = zext i1 %5 to i32, !dbg !274
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !275, !noalias !265
...
!1 = !DIFile(filename: "/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/stdio/fgetpos.c", directory: "/root/.unikraft/apps/redis/build")
!2 = !{}
!3 = !{i32 2, !"Dwarf Version", i32 4}
!4 = !{i32 2, !"Debug Info Version", i32 3}
!5 = !{i32 1, !"wchar_size", i32 4}
!6 = !{!"clang version 7.0.1-8+deb10u2 (tags/RELEASE_701/final)"}
!7 = distinct !DISubprogram(name: "_fgetpos_r", scope: !1, file: !1, line: 79, type: !8, isLocal: false, isDefinition: true, scopeLine: 83, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !236)
...
!236 = !{!237, !238, !239}
!237 = !DILocalVariable(name: "ptr", arg: 1, scope: !7, file: !1, line: 79, type: !11)
!238 = !DILocalVariable(name: "fp", arg: 2, scope: !7, file: !1, line: 79, type: !230)
!239 = !DILocalVariable(name: "pos", arg: 3, scope: !7, file: !1, line: 79, type: !234)
!240 = !DILocation(line: 79, column: 1, scope: !7)
!241 = !DILocation(line: 84, column: 10, scope: !7)
!242 = !DILocation(line: 84, column: 8, scope: !7)
!243 = !{!244, !244, i64 0}
!244 = !{!"long", !245, i64 0}
!245 = !{!"omnipotent char", !246, i64 0}
!246 = !{!"Simple C/C++ TBAA"}
!247 = !DILocation(line: 86, column: 12, scope: !248)
!248 = distinct !DILexicalBlock(scope: !7, file: !1, line: 86, column: 7)
!249 = !DILocation(line: 86, column: 7, scope: !7)
!250 = !DILocation(line: 0, scope: !251)
!251 = distinct !DILexicalBlock(scope: !248, file: !1, line: 87, column: 5)
!252 = !DILocation(line: 90, column: 3, scope: !7)
!253 = !DILocation(line: 91, column: 1, scope: !7)
!254 = distinct !DISubprogram(name: "fgetpos", scope: !1, file: !1, line: 96, type: !255, isLocal: false, isDefinition: true, scopeLine: 99, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !257)
!255 = !DISubroutineType(types: !256)
!256 = !{!10, !230, !234}
!257 = !{!258, !259}
!258 = !DILocalVariable(name: "fp", arg: 1, scope: !254, file: !1, line: 96, type: !230)
!259 = !DILocalVariable(name: "pos", arg: 2, scope: !254, file: !1, line: 96, type: !234)
!260 = !DILocation(line: 96, column: 1, scope: !254)
!261 = !DILocation(line: 100, column: 22, scope: !254)
!262 = !DILocation(line: 79, column: 1, scope: !7, inlinedAt: !263)
!263 = distinct !DILocation(line: 100, column: 10, scope: !254)
!264 = !DILocation(line: 84, column: 10, scope: !7, inlinedAt: !263)
!265 = !{!266}
!266 = distinct !{!266, !267, !"_fgetpos_r: argument 1"}
!267 = distinct !{!267, !"_fgetpos_r"}
!268 = !DILocation(line: 84, column: 8, scope: !7, inlinedAt: !263)
!269 = !{!270}
!270 = distinct !{!270, !267, !"_fgetpos_r: argument 0"}
!271 = !DILocation(line: 86, column: 12, scope: !248, inlinedAt: !263)
!272 = !DILocation(line: 86, column: 7, scope: !7, inlinedAt: !263)
!273 = !DILocation(line: 0, scope: !251, inlinedAt: !263)
!274 = !DILocation(line: 90, column: 3, scope: !7, inlinedAt: !263)
!275 = !DILocation(line: 91, column: 1, scope: !7, inlinedAt: !263)
!276 = !DILocation(line: 100, column: 3, scope: !254)
