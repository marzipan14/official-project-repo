...
; <label>:11:                                     ; preds = %7
  %12 = load i32, i32* %3, align 4, !dbg !547, !tbaa !531
  %13 = icmp sgt i32 %12, 1, !dbg !542
  %14 = icmp eq i32 %1, 1, !dbg !549
  %15 = and i1 %14, %13, !dbg !546
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !546
  br i1 %15, label %48, label %16, !dbg !546

; <label>:16:                                     ; preds = %10, %11
  %17 = call i8* @calloc(i64 1, i64 16) #5, !dbg !552
  %18 = icmp eq i8* %17, null, !dbg !554
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !556
  br i1 %18, label %48, label %19, !dbg !556

; <label>:19:                                     ; preds = %16
  %20 = load i32, i32* %3, align 4, !dbg !557, !tbaa !531
  %21 = icmp sgt i32 %20, 1, !dbg !558
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !559
  br i1 %21, label %22, label %26, !dbg !559

; <label>:22:                                     ; preds = %19
  %23 = getelementptr inbounds i8, i8* %17, i64 8, !dbg !560
  %24 = bitcast i8* %23 to i32*, !dbg !562
  store i32 %20, i32* %24, align 8, !dbg !563, !tbaa !564
  %25 = bitcast i8* %17 to i32*, !dbg !565
  store i32 1, i32* %25, align 8, !dbg !566, !tbaa !567
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !569
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !570
  br label %43, !dbg !570

; <label>:26:                                     ; preds = %19
  %27 = bitcast %struct.pthread_mutexattr_t_** %4 to i8*, !dbg !571
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %27) #4, !dbg !571
  %28 = call i32 @pthread_mutexattr_init(%struct.pthread_mutexattr_t_** nonnull %4) #5, !dbg !573
  %29 = icmp eq i32 %28, 0, !dbg !574
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !576
  br i1 %29, label %30, label %39, !dbg !576

; <label>:30:                                     ; preds = %26
  %31 = load %struct.pthread_mutexattr_t_*, %struct.pthread_mutexattr_t_** %4, align 8, !dbg !577, !tbaa !579
  %32 = getelementptr inbounds %struct.pthread_mutexattr_t_, %struct.pthread_mutexattr_t_* %31, i64 0, i32 0, !dbg !581
  store i32 %1, i32* %32, align 4, !dbg !582, !tbaa !583
  %33 = getelementptr inbounds i8, i8* %17, i64 8, !dbg !585
  %34 = bitcast i8* %33 to %struct.pthread_mutex_t_**, !dbg !586
  %35 = call i32 @pthread_mutex_init(%struct.pthread_mutex_t_** nonnull %34, %struct.pthread_mutexattr_t_** nonnull %4) #5, !dbg !587
  %36 = icmp eq i32 %35, 0, !dbg !588
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !590
  br i1 %36, label %37, label %39, !dbg !590

; <label>:37:                                     ; preds = %30
  %38 = bitcast i8* %17 to i32*, !dbg !591
  store i32 3, i32* %38, align 8, !dbg !593, !tbaa !567
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !594
  br label %39, !dbg !594

; <label>:39:                                     ; preds = %26, %37, %30
  %40 = phi i32 [ 0, %37 ], [ %35, %30 ], [ %28, %26 ], !dbg !595
  %41 = call i32 @pthread_mutexattr_destroy(%struct.pthread_mutexattr_t_** nonnull %4) #5, !dbg !596
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %27) #4, !dbg !597
  store volatile i32 42, i32* @__A_VARIABLE, align 4
  %42 = icmp eq i32 %40, 0, !dbg !598
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !570
  br i1 %42, label %43, label %45, !dbg !570

; <label>:43:                                     ; preds = %22, %39
  %44 = bitcast %struct.pthread_spinlock_t_** %0 to i8**, !dbg !600
  store i8* %17, i8** %44, align 8, !dbg !600, !tbaa !579
  br label %46, !dbg !602

; <label>:45:                                     ; preds = %39
  call void @free(i8* nonnull %17) #5, !dbg !603
  store %struct.pthread_spinlock_t_* null, %struct.pthread_spinlock_t_** %0, align 8, !dbg !605, !tbaa !579
  br label %46

; <label>:46:                                     ; preds = %45, %43
  %47 = phi i32 [ %40, %45 ], [ 0, %43 ]
  store volatile i32 42, i32* @__A_VARIABLE, align 4
  br label %48, !dbg !606

; <label>:48:                                     ; preds = %16, %11, %2, %46
  %49 = phi i32 [ %47, %46 ], [ 22, %2 ], [ 88, %11 ], [ 12, %16 ], !dbg !607
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !608
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %5) #4, !dbg !610
...
!545 = !DILocation(line: 64, column: 5, scope: !544)
!546 = !DILocation(line: 66, column: 7, scope: !508)
!547 = !DILocation(line: 66, column: 7, scope: !548)
!548 = distinct !DILexicalBlock(scope: !508, file: !1, line: 66, column: 7)
!549 = !DILocation(line: 68, column: 19, scope: !550)
!550 = distinct !DILexicalBlock(scope: !551, file: !1, line: 68, column: 11)
!551 = distinct !DILexicalBlock(scope: !548, file: !1, line: 67, column: 5)
!552 = !DILocation(line: 91, column: 28, scope: !508)
...
!569 = !DILocation(line: 102, column: 5, scope: !561)
!570 = !DILocation(line: 120, column: 7, scope: !508)
!571 = !DILocation(line: 105, column: 7, scope: !519)
!572 = !DILocation(line: 105, column: 27, scope: !519)
!573 = !DILocation(line: 106, column: 16, scope: !519)
!574 = !DILocation(line: 108, column: 13, scope: !575)
!575 = distinct !DILexicalBlock(scope: !519, file: !1, line: 108, column: 11)
!576 = !DILocation(line: 108, column: 11, scope: !519)
!577 = !DILocation(line: 110, column: 11, scope: !578)
!578 = distinct !DILexicalBlock(scope: !575, file: !1, line: 109, column: 9)
!579 = !{!580, !580, i64 0}
!580 = !{!"any pointer", !533, i64 0}
!581 = !DILocation(line: 110, column: 15, scope: !578)
!582 = !DILocation(line: 110, column: 23, scope: !578)
!583 = !{!584, !532, i64 0}
!584 = !{!"pthread_mutexattr_t_", !532, i64 0, !532, i64 4}
!585 = !DILocation(line: 111, column: 45, scope: !578)
!586 = !DILocation(line: 111, column: 47, scope: !578)
!587 = !DILocation(line: 111, column: 20, scope: !578)
!588 = !DILocation(line: 112, column: 17, scope: !589)
!589 = distinct !DILexicalBlock(scope: !578, file: !1, line: 112, column: 15)
!590 = !DILocation(line: 112, column: 15, scope: !578)
!591 = !DILocation(line: 114, column: 18, scope: !592)
!592 = distinct !DILexicalBlock(scope: !589, file: !1, line: 113, column: 13)
!593 = !DILocation(line: 114, column: 28, scope: !592)
!594 = !DILocation(line: 115, column: 13, scope: !592)
!595 = !DILocation(line: 0, scope: !519)
!596 = !DILocation(line: 117, column: 14, scope: !519)
!597 = !DILocation(line: 118, column: 5, scope: !520)
!598 = !DILocation(line: 120, column: 9, scope: !599)
!599 = distinct !DILexicalBlock(scope: !508, file: !1, line: 120, column: 7)
!600 = !DILocation(line: 122, column: 13, scope: !601)
!601 = distinct !DILexicalBlock(scope: !599, file: !1, line: 121, column: 5)
!602 = !DILocation(line: 123, column: 5, scope: !601)
!603 = !DILocation(line: 126, column: 14, scope: !604)
!604 = distinct !DILexicalBlock(scope: !599, file: !1, line: 125, column: 5)
!605 = !DILocation(line: 127, column: 13, scope: !604)
!606 = !DILocation(line: 130, column: 3, scope: !508)
!607 = !DILocation(line: 0, scope: !508)
!608 = !DILocation(line: 0, scope: !609)
!609 = distinct !DILexicalBlock(scope: !537, file: !1, line: 57, column: 5)
!610 = !DILocation(line: 131, column: 1, scope: !508)
