...
define dso_local i64 @crc64(i64, i8* nocapture readonly, i64) local_unnamed_addr #0 !dbg !23 {
  ...
  %4 = icmp eq i64 %2, 0, !dbg !42
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !43
  br i1 %4, label %51, label %5, !dbg !43

; <label>:5:                                      ; preds = %3
  %6 = and i64 %2, 1, !dbg !44
  %7 = icmp eq i64 %2, 1, !dbg !44
  br i1 %7, label %36, label %8, !dbg !44

; <label>:8:                                      ; preds = %5
  %9 = sub i64 %2, %6, !dbg !44
  br label %10, !dbg !44
...
; <label>:10:                                     ; preds = %10, %8
  ...
  %14 = getelementptr inbounds i8, i8* %1, i64 %12, !dbg !44
  %15 = load i8, i8* %14, align 1, !dbg !44, !tbaa !45
  %16 = and i64 %11, 255, !dbg !49
  %17 = zext i8 %15 to i64, !dbg !50
  %18 = xor i64 %16, %17, !dbg !51
  %19 = getelementptr inbounds [256 x i64], [256 x i64]* @crc64_tab, i64 0, i64 %18, !dbg !52
  %20 = load i64, i64* %19, align 8, !dbg !52, !tbaa !53
  %21 = lshr i64 %11, 8, !dbg !55
  %22 = xor i64 %20, %21, !dbg !56
  %23 = or i64 %12, 1, !dbg !57
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !58
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !43
  %24 = getelementptr inbounds i8, i8* %1, i64 %23, !dbg !44
  %25 = load i8, i8* %24, align 1, !dbg !44, !tbaa !45
  %26 = and i64 %22, 255, !dbg !49
  %27 = zext i8 %25 to i64, !dbg !50
  %28 = xor i64 %26, %27, !dbg !51
  %29 = getelementptr inbounds [256 x i64], [256 x i64]* @crc64_tab, i64 0, i64 %28, !dbg !52
  %30 = load i64, i64* %29, align 8, !dbg !52, !tbaa !53
  %31 = lshr i64 %22, 8, !dbg !55
  %32 = xor i64 %30, %31, !dbg !56
  %33 = add i64 %12, 2, !dbg !57
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !58
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !43
  %34 = add i64 %13, -2, !dbg !43
  %35 = icmp eq i64 %34, 0, !dbg !43
  br i1 %35, label %36, label %10, !dbg !43, !llvm.loop !59

; <label>:36:                                     ; preds = %10, %5
  %37 = phi i64 [ undef, %5 ], [ %32, %10 ]
  %38 = phi i64 [ %0, %5 ], [ %32, %10 ]
  %39 = phi i64 [ 0, %5 ], [ %33, %10 ]
  %40 = icmp eq i64 %6, 0, !dbg !43
  br i1 %40, label %51, label %41, !dbg !43

; <label>:41:                                     ; preds = %36
  %42 = getelementptr inbounds i8, i8* %1, i64 %39, !dbg !44
  %43 = load i8, i8* %42, align 1, !dbg !44, !tbaa !45
  %44 = and i64 %38, 255, !dbg !49
  %45 = zext i8 %43 to i64, !dbg !50
  %46 = xor i64 %44, %45, !dbg !51
  %47 = getelementptr inbounds [256 x i64], [256 x i64]* @crc64_tab, i64 0, i64 %46, !dbg !52
  %48 = load i64, i64* %47, align 8, !dbg !52, !tbaa !53
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !58
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !43
  %49 = lshr i64 %38, 8, !dbg !55
  %50 = xor i64 %48, %49, !dbg !56
  br label %51, !dbg !61
...
!41 = !DILocation(line: 176, column: 10, scope: !36)
!42 = !DILocation(line: 176, column: 19, scope: !35)
!43 = !DILocation(line: 176, column: 5, scope: !36)
!44 = !DILocation(line: 177, column: 24, scope: !34)
!45 = !{!46, !46, i64 0}
!46 = !{!"omnipotent char", !47, i64 0}
!47 = !{!"Simple C/C++ TBAA"}
!48 = !DILocation(line: 177, column: 17, scope: !34)
!49 = !DILocation(line: 178, column: 25, scope: !34)
!50 = !DILocation(line: 178, column: 40, scope: !34)
!51 = !DILocation(line: 178, column: 38, scope: !34)
!52 = !DILocation(line: 178, column: 15, scope: !34)
!53 = !{!54, !54, i64 0}
!54 = !{!"long", !46, i64 0}
!55 = !DILocation(line: 178, column: 53, scope: !34)
!56 = !DILocation(line: 178, column: 46, scope: !34)
!57 = !DILocation(line: 176, column: 25, scope: !35)
!58 = !DILocation(line: 176, column: 5, scope: !35)
!59 = distinct !{!59, !43, !60}
!60 = !DILocation(line: 179, column: 5, scope: !36)
!61 = !DILocation(line: 180, column: 5, scope: !23)
