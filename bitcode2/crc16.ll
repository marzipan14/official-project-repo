...
define dso_local zeroext i16 @crc16(i8* nocapture readonly, i32) local_unnamed_addr #0 !dbg !19 {
  ...
  %3 = icmp sgt i32 %1, 0, !dbg !37
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !39
  br i1 %3, label %4, label %50, !dbg !39

; <label>:4:                                      ; preds = %2
  %5 = and i32 %1, 1, !dbg !40
  %6 = icmp eq i32 %1, 1, !dbg !40
  br i1 %6, label %35, label %7, !dbg !40

; <label>:7:                                      ; preds = %4
  %8 = sub i32 %1, %5, !dbg !40
  br label %9, !dbg !40
...
; <label>:9:                                      ; preds = %9, %7
  ...
  %11 = phi i8* [ %0, %7 ], [ %26, %9 ]
  %12 = phi i32 [ %8, %7 ], [ %33, %9 ]
  %13 = shl i16 %10, 8, !dbg !40
  %14 = lshr i16 %10, 8, !dbg !41
  %15 = zext i16 %14 to i64, !dbg !41
  %16 = getelementptr inbounds i8, i8* %11, i64 1, !dbg !42
  %17 = load i8, i8* %11, align 1, !dbg !43, !tbaa !44
  %18 = zext i8 %17 to i64, !dbg !43
  %19 = xor i64 %18, %15, !dbg !47
  %20 = getelementptr inbounds [256 x i16], [256 x i16]* @crc16tab, i64 0, i64 %19, !dbg !48
  %21 = load i16, i16* %20, align 2, !dbg !48, !tbaa !49
  %22 = xor i16 %21, %13, !dbg !51
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !52
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !39
  %23 = shl i16 %21, 8, !dbg !40
  %24 = lshr i16 %22, 8, !dbg !41
  %25 = zext i16 %24 to i64, !dbg !41
  %26 = getelementptr inbounds i8, i8* %11, i64 2, !dbg !42
  %27 = load i8, i8* %16, align 1, !dbg !43, !tbaa !44
  %28 = zext i8 %27 to i64, !dbg !43
  %29 = xor i64 %28, %25, !dbg !47
  %30 = getelementptr inbounds [256 x i16], [256 x i16]* @crc16tab, i64 0, i64 %29, !dbg !48
  %31 = load i16, i16* %30, align 2, !dbg !48, !tbaa !49
  %32 = xor i16 %31, %23, !dbg !51
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !52
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !39
  %33 = add i32 %12, -2, !dbg !39
  %34 = icmp eq i32 %33, 0, !dbg !39
  br i1 %34, label %35, label %9, !dbg !39, !llvm.loop !53

; <label>:35:                                     ; preds = %9, %4
  %36 = phi i16 [ undef, %4 ], [ %32, %9 ]
  %37 = phi i16 [ 0, %4 ], [ %32, %9 ]
  %38 = phi i8* [ %0, %4 ], [ %26, %9 ]
  %39 = icmp eq i32 %5, 0, !dbg !39
  br i1 %39, label %50, label %40, !dbg !39

; <label>:40:                                     ; preds = %35
  %41 = lshr i16 %37, 8, !dbg !41
  %42 = zext i16 %41 to i64, !dbg !41
  %43 = load i8, i8* %38, align 1, !dbg !43, !tbaa !44
  %44 = zext i8 %43 to i64, !dbg !43
  %45 = xor i64 %44, %42, !dbg !47
  %46 = getelementptr inbounds [256 x i16], [256 x i16]* @crc16tab, i64 0, i64 %45, !dbg !48
  %47 = load i16, i16* %46, align 2, !dbg !48, !tbaa !49
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !52
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !39
  %48 = shl i16 %37, 8, !dbg !40
  %49 = xor i16 %47, %48, !dbg !51
  br label %50, !dbg !55

; <label>:50:                                     ; preds = %40, %35, %2
  %51 = phi i16 [ 0, %2 ], [ %36, %35 ], [ %49, %40 ], !dbg !56
...
!35 = !DILocation(line: 85, column: 10, scope: !36)
!36 = distinct !DILexicalBlock(scope: !19, file: !3, line: 85, column: 5)
!37 = !DILocation(line: 85, column: 31, scope: !38)
!38 = distinct !DILexicalBlock(scope: !36, file: !3, line: 85, column: 5)
!39 = !DILocation(line: 85, column: 5, scope: !36)
!40 = !DILocation(line: 86, column: 23, scope: !38)
!41 = !DILocation(line: 86, column: 44, scope: !38)
!42 = !DILocation(line: 86, column: 55, scope: !38)
!43 = !DILocation(line: 86, column: 51, scope: !38)
!44 = !{!45, !45, i64 0}
!45 = !{!"omnipotent char", !46, i64 0}
!46 = !{!"Simple C/C++ TBAA"}
!47 = !DILocation(line: 86, column: 49, scope: !38)
!48 = !DILocation(line: 86, column: 30, scope: !38)
!49 = !{!50, !50, i64 0}
!50 = !{!"short", !45, i64 0}
!51 = !DILocation(line: 86, column: 28, scope: !38)
!52 = !DILocation(line: 85, column: 5, scope: !38)
!53 = distinct !{!53, !39, !54}
!54 = !DILocation(line: 86, column: 65, scope: !36)
!55 = !DILocation(line: 87, column: 5, scope: !19)
