...
define dso_local i32 @pthread_rwlock_timedwrlock(%struct.pthread_rwlock_t_**, %struct.timespec*) local_unnamed_addr #0 !dbg !514 {
  ...
  br i1 %4, label %67, label %5, !dbg !548

; <label>:5:                                      ; preds = %2
  %6 = load %struct.pthread_rwlock_t_*, %struct.pthread_rwlock_t_** %0, align 8, !dbg !549, !tbaa !550
  %7 = icmp eq %struct.pthread_rwlock_t_* %6, null, !dbg !554
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !555
  br i1 %7, label %67, label %8, !dbg !555

; <label>:8:                                      ; preds = %5
  %9 = icmp eq %struct.pthread_rwlock_t_* %6, inttoptr (i64 -1 to %struct.pthread_rwlock_t_*), !dbg !556
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !558
  br i1 %9, label %10, label %16, !dbg !558

; <label>:10:                                     ; preds = %8
  %11 = tail call i32 @pte_rwlock_check_need_init(%struct.pthread_rwlock_t_** nonnull %0) #4, !dbg !559
  %12 = or i32 %11, 16, !dbg !562
  %13 = icmp eq i32 %12, 16, !dbg !562
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !562
  br i1 %13, label %14, label %67, !dbg !562

; <label>:14:                                     ; preds = %10
  %15 = load %struct.pthread_rwlock_t_*, %struct.pthread_rwlock_t_** %0, align 8, !dbg !564, !tbaa !550
  br label %16, !dbg !562

; <label>:16:                                     ; preds = %14, %8
  %17 = phi %struct.pthread_rwlock_t_* [ %15, %14 ], [ %6, %8 ], !dbg !564
  %18 = getelementptr inbounds %struct.pthread_rwlock_t_, %struct.pthread_rwlock_t_* %17, i64 0, i32 6, !dbg !566
  %19 = load i32, i32* %18, align 4, !dbg !566, !tbaa !568
  %20 = icmp eq i32 %19, 262974946, !dbg !571
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !572
  br i1 %20, label %21, label %67, !dbg !572

; <label>:21:                                     ; preds = %16
  %22 = getelementptr inbounds %struct.pthread_rwlock_t_, %struct.pthread_rwlock_t_* %17, i64 0, i32 0, !dbg !573
  %23 = tail call i32 @pthread_mutex_timedlock(%struct.pthread_mutex_t_** %22, %struct.timespec* %1) #4, !dbg !575
  %24 = icmp eq i32 %23, 0, !dbg !576
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !577
  br i1 %24, label %25, label %67, !dbg !577

; <label>:25:                                     ; preds = %21
  %26 = getelementptr inbounds %struct.pthread_rwlock_t_, %struct.pthread_rwlock_t_* %17, i64 0, i32 1, !dbg !578
  %27 = tail call i32 @pthread_mutex_timedlock(%struct.pthread_mutex_t_** nonnull %26, %struct.timespec* %1) #4, !dbg !580
  %28 = icmp eq i32 %27, 0, !dbg !581
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !582
  br i1 %28, label %31, label %29, !dbg !582

; <label>:29:                                     ; preds = %25
  %30 = tail call i32 @pthread_mutex_unlock(%struct.pthread_mutex_t_** %22) #4, !dbg !583
  br label %67, !dbg !585

; <label>:31:                                     ; preds = %25
  %32 = getelementptr inbounds %struct.pthread_rwlock_t_, %struct.pthread_rwlock_t_* %17, i64 0, i32 4, !dbg !586
  %33 = load i32, i32* %32, align 4, !dbg !586, !tbaa !587
  %34 = icmp eq i32 %33, 0, !dbg !588
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !589
  br i1 %34, label %35, label %62, !dbg !589

; <label>:35:                                     ; preds = %31
  %36 = getelementptr inbounds %struct.pthread_rwlock_t_, %struct.pthread_rwlock_t_* %17, i64 0, i32 5, !dbg !590
  %37 = load i32, i32* %36, align 8, !dbg !590, !tbaa !592
  %38 = icmp sgt i32 %37, 0, !dbg !593
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !594
  %39 = getelementptr inbounds %struct.pthread_rwlock_t_, %struct.pthread_rwlock_t_* %17, i64 0, i32 3
  %40 = load i32, i32* %39, align 8, !dbg !595, !tbaa !596
  br i1 %38, label %41, label %43, !dbg !594

; <label>:41:                                     ; preds = %35
  %42 = sub nsw i32 %40, %37, !dbg !597
  store i32 %42, i32* %39, align 8, !dbg !597, !tbaa !596
  store i32 0, i32* %36, align 8, !dbg !599, !tbaa !592
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !600
  br label %43, !dbg !600

; <label>:43:                                     ; preds = %35, %41
  %44 = phi i32 [ %42, %41 ], [ %40, %35 ], !dbg !601
  %45 = icmp sgt i32 %44, 0, !dbg !602
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !603
  br i1 %45, label %46, label %62, !dbg !603

; <label>:46:                                     ; preds = %43
  %47 = sub nsw i32 0, %44, !dbg !604
  store i32 %47, i32* %36, align 8, !dbg !605, !tbaa !592
  %48 = bitcast %struct.pte_cleanup_t* %3 to i8*, !dbg !606
  call void @llvm.lifetime.start.p0i8(i64 24, i8* nonnull %48) #5, !dbg !606
  %49 = bitcast %struct.pthread_rwlock_t_* %17 to i8*, !dbg !606
  call void @pte_push_cleanup(%struct.pte_cleanup_t* nonnull %3, void (i8*)* nonnull @pte_rwlock_cancelwrwait, i8* %49) #4, !dbg !606
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !607
  %50 = getelementptr inbounds %struct.pthread_rwlock_t_, %struct.pthread_rwlock_t_* %17, i64 0, i32 2
  br label %51, !dbg !607

; <label>:51:                                     ; preds = %54, %46
  %52 = call i32 @pthread_cond_timedwait(%struct.pthread_cond_t_** nonnull %50, %struct.pthread_mutex_t_** nonnull %26, %struct.timespec* %1) #4, !dbg !608
  %53 = icmp eq i32 %52, 0, !dbg !610
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !611
  br i1 %53, label %54, label %60, !dbg !611

; <label>:54:                                     ; preds = %51
  %55 = load i32, i32* %36, align 8, !dbg !612, !tbaa !592
  %56 = icmp slt i32 %55, 0, !dbg !613
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !614
  br i1 %56, label %51, label %57, !dbg !614, !llvm.loop !615

; <label>:57:                                     ; preds = %54
  %58 = call %struct.pte_cleanup_t* @pte_pop_cleanup(i32 0) #4, !dbg !617
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %48) #5, !dbg !618
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !619
  store i32 0, i32* %39, align 8, !dbg !620, !tbaa !596
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !623
  %59 = load i32, i32* %32, align 4, !dbg !624, !tbaa !587
  br label %62, !dbg !623

; <label>:60:                                     ; preds = %51
  %61 = call %struct.pte_cleanup_t* @pte_pop_cleanup(i32 1) #4, !dbg !617
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %48) #5, !dbg !618
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !619
  br label %65

; <label>:62:                                     ; preds = %57, %43, %31
  %63 = phi i32 [ %59, %57 ], [ 0, %43 ], [ %33, %31 ], !dbg !624
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !627
  %64 = add nsw i32 %63, 1, !dbg !624
  store i32 %64, i32* %32, align 4, !dbg !624, !tbaa !587
  br label %65, !dbg !628

; <label>:65:                                     ; preds = %60, %62
  %66 = phi i32 [ 0, %62 ], [ %52, %60 ]
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !629
  br label %67, !dbg !630

; <label>:67:                                     ; preds = %21, %16, %10, %2, %5, %65, %29
  %68 = phi i32 [ %27, %29 ], [ %66, %65 ], [ 22, %5 ], [ 22, %2 ], [ %11, %10 ], [ 22, %16 ], [ %23, %21 ], !dbg !631
...
!553 = !{!"Simple C/C++ TBAA"}
!554 = !DILocation(line: 56, column: 33, scope: !547)
!555 = !DILocation(line: 56, column: 7, scope: !514)
!556 = !DILocation(line: 67, column: 15, scope: !557)
!557 = distinct !DILexicalBlock(scope: !514, file: !1, line: 67, column: 7)
!558 = !DILocation(line: 67, column: 7, scope: !514)
!559 = !DILocation(line: 69, column: 16, scope: !560)
!560 = distinct !DILexicalBlock(scope: !557, file: !1, line: 68, column: 5)
!561 = !DILocation(line: 53, column: 7, scope: !514)
!562 = !DILocation(line: 71, column: 23, scope: !563)
!563 = distinct !DILexicalBlock(scope: !560, file: !1, line: 71, column: 11)
!564 = !DILocation(line: 77, column: 9, scope: !514)
!565 = !DILocation(line: 54, column: 20, scope: !514)
!566 = !DILocation(line: 79, column: 12, scope: !567)
!567 = distinct !DILexicalBlock(scope: !514, file: !1, line: 79, column: 7)
!568 = !{!569, !570, i64 36}
!569 = !{!"pthread_rwlock_t_", !551, i64 0, !551, i64 8, !551, i64 16, !570, i64 24, !570, i64 28, !570, i64 32, !570, i64 36}
!570 = !{!"int", !552, i64 0}
!571 = !DILocation(line: 79, column: 19, scope: !567)
!572 = !DILocation(line: 79, column: 7, scope: !514)
!573 = !DILocation(line: 85, column: 42, scope: !574)
!574 = distinct !DILexicalBlock(scope: !514, file: !1, line: 84, column: 7)
!575 = !DILocation(line: 85, column: 10, scope: !574)
!576 = !DILocation(line: 85, column: 73, scope: !574)
!577 = !DILocation(line: 84, column: 7, scope: !514)
!578 = !DILocation(line: 91, column: 42, scope: !579)
!579 = distinct !DILexicalBlock(scope: !514, file: !1, line: 90, column: 7)
!580 = !DILocation(line: 91, column: 10, scope: !579)
!581 = !DILocation(line: 92, column: 45, scope: !579)
!582 = !DILocation(line: 90, column: 7, scope: !514)
!583 = !DILocation(line: 94, column: 14, scope: !584)
!584 = distinct !DILexicalBlock(scope: !579, file: !1, line: 93, column: 5)
!585 = !DILocation(line: 95, column: 7, scope: !584)
!586 = !DILocation(line: 98, column: 12, scope: !536)
!587 = !{!569, !570, i64 28}
!588 = !DILocation(line: 98, column: 34, scope: !536)
!589 = !DILocation(line: 98, column: 7, scope: !514)
!590 = !DILocation(line: 100, column: 16, scope: !591)
!591 = distinct !DILexicalBlock(scope: !535, file: !1, line: 100, column: 11)
!592 = !{!569, !570, i64 32}
!593 = !DILocation(line: 100, column: 44, scope: !591)
!594 = !DILocation(line: 100, column: 11, scope: !535)
!595 = !DILocation(line: 0, scope: !534)
!596 = !{!569, !570, i64 24}
!597 = !DILocation(line: 102, column: 35, scope: !598)
!598 = distinct !DILexicalBlock(scope: !591, file: !1, line: 101, column: 9)
!599 = !DILocation(line: 103, column: 44, scope: !598)
!600 = !DILocation(line: 104, column: 9, scope: !598)
!601 = !DILocation(line: 106, column: 16, scope: !534)
!602 = !DILocation(line: 106, column: 35, scope: !534)
!603 = !DILocation(line: 106, column: 11, scope: !535)
!604 = !DILocation(line: 108, column: 46, scope: !533)
!605 = !DILocation(line: 108, column: 44, scope: !533)
!606 = !DILocation(line: 114, column: 11, scope: !532)
!607 = !DILocation(line: 116, column: 11, scope: !532)
!608 = !DILocation(line: 119, column: 17, scope: !609)
!609 = distinct !DILexicalBlock(scope: !532, file: !1, line: 117, column: 13)
!610 = !DILocation(line: 123, column: 25, scope: !532)
!611 = !DILocation(line: 123, column: 30, scope: !532)
!612 = !DILocation(line: 123, column: 38, scope: !532)
!613 = !DILocation(line: 123, column: 66, scope: !532)
!614 = !DILocation(line: 122, column: 13, scope: !609)
!615 = distinct !{!615, !607, !616}
!616 = !DILocation(line: 123, column: 69, scope: !532)
!617 = !DILocation(line: 125, column: 11, scope: !532)
!618 = !DILocation(line: 125, column: 11, scope: !533)
!619 = !DILocation(line: 127, column: 15, scope: !533)
!620 = !DILocation(line: 129, column: 39, scope: !621)
!621 = distinct !DILexicalBlock(scope: !622, file: !1, line: 128, column: 13)
!622 = distinct !DILexicalBlock(scope: !533, file: !1, line: 127, column: 15)
!623 = !DILocation(line: 130, column: 13, scope: !621)
!624 = !DILocation(line: 136, column: 33, scope: !625)
!625 = distinct !DILexicalBlock(scope: !626, file: !1, line: 135, column: 5)
!626 = distinct !DILexicalBlock(scope: !514, file: !1, line: 134, column: 7)
!627 = !DILocation(line: 134, column: 7, scope: !514)
!628 = !DILocation(line: 137, column: 5, scope: !625)
!629 = !DILocation(line: 0, scope: !625)
!630 = !DILocation(line: 139, column: 3, scope: !514)
!631 = !DILocation(line: 0, scope: !514)
!632 = !DILocation(line: 0, scope: !633)
!633 = distinct !DILexicalBlock(scope: !547, file: !1, line: 57, column: 5)
!634 = !DILocation(line: 140, column: 1, scope: !514)
