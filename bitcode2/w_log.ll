...
; <label>:7:                                      ; preds = %1
  ...
  br i1 %11, label %53, label %12, !dbg !48
...
; <label>:27:                                     ; preds = %23
  ...
  br i1 %29, label %30, label %46, !dbg !88
...
; <label>:46:                                     ; preds = %45, %27
  %47 = load i32, i32* %14, align 8, !dbg !107, !tbaa !58
  %48 = icmp eq i32 %47, 0, !dbg !109
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !110
  br i1 %48, label %51, label %49, !dbg !110

; <label>:49:                                     ; preds = %46
  %50 = call i32* @__errno() #5, !dbg !111
  store i32 %47, i32* %50, align 4, !dbg !112, !tbaa !84
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !111
  br label %51, !dbg !111

; <label>:51:                                     ; preds = %46, %49
  %52 = load double, double* %19, align 8, !dbg !113, !tbaa !70
  br label %53, !dbg !114

; <label>:53:                                     ; preds = %1, %7, %51
  %54 = phi double [ %52, %51 ], [ %4, %7 ], [ %4, %1 ], !dbg !115
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !116
  call void @llvm.lifetime.end.p0i8(i64 48, i8* nonnull %3) #4, !dbg !117
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !117
  ret double %54, !dbg !117
}
...
!69 = !DILocation(line: 88, column: 6, scope: !17)
!70 = !{!52, !55, i64 32}
...
!117 = !DILocation(line: 114, column: 1, scope: !17)
