; ModuleID = '/root/.unikraft/apps/redis/build/libpthread-embedded/origin/pthread-embedded-44b41d760a433915d70a7be9809651b0a65e001d/pthread_testcancel.c'
source_filename = "/root/.unikraft/apps/redis/build/libpthread-embedded/origin/pthread-embedded-44b41d760a433915d70a7be9809651b0a65e001d/pthread_testcancel.c"
...
define dso_local void @pthread_testcancel() local_unnamed_addr #0 !dbg !536 {
  %1 = tail call { i8*, i32 } @pthread_self() #3, !dbg !540
  %2 = extractvalue { i8*, i32 } %1, 0, !dbg !540
  %3 = icmp eq i8* %2, null, !dbg !543
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !545
  br i1 %3, label %21, label %4, !dbg !545

; <label>:4:                                      ; preds = %0
  %5 = getelementptr inbounds i8, i8* %2, i64 32, !dbg !546
  %6 = bitcast i8* %5 to i32*, !dbg !546
  %7 = load volatile i32, i32* %6, align 8, !dbg !546, !tbaa !548
  %8 = icmp eq i32 %7, 3, !dbg !555
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !556
  br i1 %8, label %9, label %21, !dbg !556

; <label>:9:                                      ; preds = %4
  %10 = getelementptr inbounds i8, i8* %2, i64 80, !dbg !557
  %11 = bitcast i8* %10 to %struct.pthread_mutex_t_**, !dbg !557
  %12 = tail call i32 @pthread_mutex_lock(%struct.pthread_mutex_t_** nonnull %11) #3, !dbg !558
  %13 = getelementptr inbounds i8, i8* %2, i64 88, !dbg !559
  %14 = bitcast i8* %13 to i32*, !dbg !559
  %15 = load i32, i32* %14, align 8, !dbg !559, !tbaa !561
  %16 = icmp eq i32 %15, 1, !dbg !562
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !563
  br i1 %16, label %19, label %17, !dbg !563

; <label>:17:                                     ; preds = %9
  store volatile i32 4, i32* %6, align 8, !dbg !564, !tbaa !548
  store i32 1, i32* %14, align 8, !dbg !566, !tbaa !561
  %18 = tail call i32 @pthread_mutex_unlock(%struct.pthread_mutex_t_** nonnull %11) #3, !dbg !567
  tail call void @pte_throw(i32 2) #3, !dbg !568
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !569
  br label %19, !dbg !569

; <label>:19:                                     ; preds = %9, %17
  %20 = tail call i32 @pthread_mutex_unlock(%struct.pthread_mutex_t_** nonnull %11) #3, !dbg !570
  br label %21, !dbg !571

; <label>:21:                                     ; preds = %4, %0, %19
...
!1 = !DIFile(filename: "/root/.unikraft/apps/redis/build/libpthread-embedded/origin/pthread-embedded-44b41d760a433915d70a7be9809651b0a65e001d/pthread_testcancel.c", directory: "/root/.unikraft/apps/redis/build")
!2 = !{!3, !10, !20}
...
!536 = distinct !DISubprogram(name: "pthread_testcancel", scope: !1, file: !1, line: 48, type: !430, isLocal: false, isDefinition: true, scopeLine: 76, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !537)
!537 = !{!538, !539}
!538 = !DILocalVariable(name: "self", scope: !536, file: !1, line: 77, type: !488)
!539 = !DILocalVariable(name: "sp", scope: !536, file: !1, line: 78, type: !39)
!540 = !DILocation(line: 77, column: 20, scope: !536)
!541 = !DILocation(line: 77, column: 13, scope: !536)
!542 = !DILocation(line: 78, column: 18, scope: !536)
!543 = !DILocation(line: 80, column: 10, scope: !544)
!544 = distinct !DILexicalBlock(scope: !536, file: !1, line: 80, column: 7)
!545 = !DILocation(line: 80, column: 7, scope: !536)
!546 = !DILocation(line: 90, column: 11, scope: !547)
!547 = distinct !DILexicalBlock(scope: !536, file: !1, line: 90, column: 7)
!548 = !{!549, !551, i64 32}
!549 = !{!"pte_thread_t_", !550, i64 0, !553, i64 8, !550, i64 24, !551, i64 32, !550, i64 40, !550, i64 48, !554, i64 56, !554, i64 60, !550, i64 64, !554, i64 72, !550, i64 80, !554, i64 88, !554, i64 92, !554, i64 96, !551, i64 104, !554, i64 168, !550, i64 176, !550, i64 184}
!550 = !{!"any pointer", !551, i64 0}
!551 = !{!"omnipotent char", !552, i64 0}
!552 = !{!"Simple C/C++ TBAA"}
!553 = !{!"", !550, i64 0, !554, i64 8}
!554 = !{!"int", !551, i64 0}
!555 = !DILocation(line: 90, column: 17, scope: !547)
!556 = !DILocation(line: 90, column: 7, scope: !536)
!557 = !DILocation(line: 95, column: 35, scope: !536)
!558 = !DILocation(line: 95, column: 10, scope: !536)
!559 = !DILocation(line: 97, column: 11, scope: !560)
!560 = distinct !DILexicalBlock(scope: !536, file: !1, line: 97, column: 7)
!561 = !{!549, !554, i64 88}
!562 = !DILocation(line: 97, column: 23, scope: !560)
!563 = !DILocation(line: 97, column: 7, scope: !536)
!564 = !DILocation(line: 99, column: 17, scope: !565)
!565 = distinct !DILexicalBlock(scope: !560, file: !1, line: 98, column: 5)
!566 = !DILocation(line: 100, column: 23, scope: !565)
!567 = !DILocation(line: 102, column: 14, scope: !565)
!568 = !DILocation(line: 103, column: 7, scope: !565)
!569 = !DILocation(line: 104, column: 5, scope: !565)
!570 = !DILocation(line: 106, column: 10, scope: !536)
!571 = !DILocation(line: 107, column: 1, scope: !536)
!572 = !DILocation(line: 0, scope: !573)
!573 = distinct !DILexicalBlock(scope: !544, file: !1, line: 81, column: 5)
