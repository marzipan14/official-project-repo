; ModuleID = '/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/stdio/putchar_u.c'
source_filename = "/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/stdio/putchar_u.c"
...
define dso_local i32 @_putchar_unlocked_r(%struct._reent* nocapture readonly, i32) local_unnamed_addr #0 !dbg !7 {
  %3 = getelementptr inbounds %struct._reent, %struct._reent* %0, i64 0, i32 2, !dbg !234
  %4 = load %struct.__sFILE*, %struct.__sFILE** %3, align 8, !dbg !234, !tbaa !235
  %5 = tail call i32 @putc_unlocked(i32 %1, %struct.__sFILE* %4) #3, !dbg !244
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !245
  ret i32 %5, !dbg !245
}

; Function Attrs: noredzone
declare dso_local i32 @putc_unlocked(i32, %struct.__sFILE*) local_unnamed_addr #1

; Function Attrs: noredzone nounwind
define dso_local i32 @putchar_unlocked(i32) local_unnamed_addr #0 !dbg !246 {
  %2 = tail call %struct._reent* @__getreent() #3, !dbg !252
  %3 = getelementptr inbounds %struct._reent, %struct._reent* %2, i64 0, i32 2, !dbg !255
  %4 = load %struct.__sFILE*, %struct.__sFILE** %3, align 8, !dbg !255, !tbaa !235
  %5 = tail call i32 @putc_unlocked(i32 %0, %struct.__sFILE* %4) #3, !dbg !256
...
!1 = !DIFile(filename: "/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/stdio/putchar_u.c", directory: "/root/.unikraft/apps/redis/build")
!2 = !{}
!3 = !{i32 2, !"Dwarf Version", i32 4}
!4 = !{i32 2, !"Debug Info Version", i32 3}
!5 = !{i32 1, !"wchar_size", i32 4}
!6 = !{!"clang version 7.0.1-8+deb10u2 (tags/RELEASE_701/final)"}
!7 = distinct !DISubprogram(name: "_putchar_unlocked_r", scope: !1, file: !1, line: 64, type: !8, isLocal: false, isDefinition: true, scopeLine: 67, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !230)
...
!230 = !{!231, !232}
!231 = !DILocalVariable(name: "ptr", arg: 1, scope: !7, file: !1, line: 64, type: !11)
!232 = !DILocalVariable(name: "c", arg: 2, scope: !7, file: !1, line: 64, type: !10)
!233 = !DILocation(line: 64, column: 1, scope: !7)
!234 = !DILocation(line: 68, column: 28, scope: !7)
!235 = !{!236, !240, i64 16}
!236 = !{!"_reent", !237, i64 0, !240, i64 8, !240, i64 16, !240, i64 24, !237, i64 32, !238, i64 36, !237, i64 64, !240, i64 72, !237, i64 80, !240, i64 88, !240, i64 96, !237, i64 104, !240, i64 112, !240, i64 120, !237, i64 128, !240, i64 136, !238, i64 144, !240, i64 504, !241, i64 512, !240, i64 1304, !243, i64 1312, !238, i64 1336}
!237 = !{!"int", !238, i64 0}
!238 = !{!"omnipotent char", !239, i64 0}
!239 = !{!"Simple C/C++ TBAA"}
!240 = !{!"any pointer", !238, i64 0}
!241 = !{!"_atexit", !240, i64 0, !237, i64 8, !238, i64 16, !242, i64 272}
!242 = !{!"_on_exit_args", !238, i64 0, !238, i64 256, !237, i64 512, !237, i64 516}
!243 = !{!"_glue", !240, i64 0, !237, i64 8, !240, i64 16}
!244 = !DILocation(line: 68, column: 10, scope: !7)
!245 = !DILocation(line: 68, column: 3, scope: !7)
!246 = distinct !DISubprogram(name: "putchar_unlocked", scope: !1, file: !1, line: 74, type: !247, isLocal: false, isDefinition: true, scopeLine: 76, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !249)
!247 = !DISubroutineType(types: !248)
!248 = !{!10, !10}
!249 = !{!250}
!250 = !DILocalVariable(name: "c", arg: 1, scope: !246, file: !1, line: 74, type: !10)
!251 = !DILocation(line: 74, column: 1, scope: !246)
!252 = !DILocation(line: 79, column: 31, scope: !246)
!253 = !DILocation(line: 64, column: 1, scope: !7, inlinedAt: !254)
!254 = distinct !DILocation(line: 79, column: 10, scope: !246)
!255 = !DILocation(line: 68, column: 28, scope: !7, inlinedAt: !254)
!256 = !DILocation(line: 68, column: 10, scope: !7, inlinedAt: !254)
!257 = !DILocation(line: 68, column: 3, scope: !7, inlinedAt: !254)
!258 = !DILocation(line: 79, column: 3, scope: !246)
