...
define dso_local i32 @main(i32, i8**) local_unnamed_addr #0 !dbg !41 {
  ...
  br i1 %10, label %11, label %19, !dbg !72
...
; <label>:11:                                     ; preds = %2
  ...
  %17 = icmp eq i32 %16, 0, !dbg !75
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !77
  br i1 %17, label %19, label %18, !dbg !77

; <label>:18:                                     ; preds = %11
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !78
  br label %19, !dbg !78

; <label>:19:                                     ; preds = %2, %18, %11
  %20 = phi i32 [ %9, %2 ], [ 0, %11 ], [ %16, %18 ], !dbg !79
  call void @llvm.lifetime.end.p0i8(i64 16, i8* nonnull %6) #5, !dbg !80
  call void @llvm.lifetime.end.p0i8(i64 16, i8* nonnull %5) #5, !dbg !80
...
!75 = !DILocation(line: 112, column: 6, scope: !76)
!76 = distinct !DILexicalBlock(scope: !41, file: !1, line: 112, column: 6)
!77 = !DILocation(line: 112, column: 10, scope: !76)
!78 = !DILocation(line: 113, column: 3, scope: !76)
!79 = !DILocation(line: 0, scope: !76)
!80 = !DILocation(line: 118, column: 1, scope: !41)
!81 = !DILocation(line: 117, column: 2, scope: !41)
