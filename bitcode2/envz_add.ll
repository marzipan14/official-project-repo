...
; <label>:6:                                      ; preds = %4
  ...
  br i1 %14, label %30, label %15, !dbg !51
...
; <label>:28:                                     ; preds = %26, %15
  %29 = phi i32 [ %25, %15 ], [ %27, %26 ], !dbg !67
  store volatile i32 42, i32* @__A_VARIABLE, align 4
  br label %30, !dbg !68

; <label>:30:                                     ; preds = %6, %28
  %31 = phi i32 [ %29, %28 ], [ 12, %6 ], !dbg !69
...
!68 = !DILocation(line: 46, column: 3, scope: !10)
!69 = !DILocation(line: 0, scope: !47)
!70 = !DILocation(line: 47, column: 1, scope: !10)
