...
; <label>:4:                                      ; preds = %1
  ...
  br i1 %6, label %7, label %47, !dbg !520
...
; <label>:9:                                      ; preds = %7, %1
  ...
  %14 = extractvalue { i32, i1 } %13, 1, !dbg !528
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !528
  br i1 %14, label %16, label %15, !dbg !528
...
; <label>:16:                                     ; preds = %15, %9
  %17 = icmp eq i32 %12, 0, !dbg !529
  %18 = getelementptr inbounds %struct.pthread_mutex_t_, %struct.pthread_mutex_t_* %10, i64 0, i32 3, !dbg !530
  %19 = load i32, i32* %18, align 8, !dbg !530, !tbaa !533
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !534
  br i1 %17, label %20, label %29, !dbg !534

; <label>:20:                                     ; preds = %16
  %21 = icmp eq i32 %19, 0, !dbg !535
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !538
  br i1 %21, label %47, label %22, !dbg !538

; <label>:22:                                     ; preds = %20
  %23 = getelementptr inbounds %struct.pthread_mutex_t_, %struct.pthread_mutex_t_* %10, i64 0, i32 2, !dbg !539
  store i32 1, i32* %23, align 4, !dbg !541, !tbaa !542
  %24 = tail call { i8*, i32 } @pthread_self() #3, !dbg !543
  %25 = extractvalue { i8*, i32 } %24, 0, !dbg !543
  %26 = extractvalue { i8*, i32 } %24, 1, !dbg !543
  %27 = getelementptr inbounds %struct.pthread_mutex_t_, %struct.pthread_mutex_t_* %10, i64 0, i32 4, i32 0, !dbg !543
  store i8* %25, i8** %27, align 8, !dbg !543
  %28 = getelementptr inbounds %struct.pthread_mutex_t_, %struct.pthread_mutex_t_* %10, i64 0, i32 4, i32 1, !dbg !543
  store i32 %26, i32* %28, align 8, !dbg !543
  br label %45, !dbg !544

; <label>:29:                                     ; preds = %16
  %30 = icmp eq i32 %19, 1, !dbg !545
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !546
  br i1 %30, label %31, label %45, !dbg !546

; <label>:31:                                     ; preds = %29
  %32 = tail call { i8*, i32 } @pthread_self() #3, !dbg !547
  %33 = extractvalue { i8*, i32 } %32, 0, !dbg !547
  %34 = extractvalue { i8*, i32 } %32, 1, !dbg !547
  %35 = getelementptr inbounds %struct.pthread_mutex_t_, %struct.pthread_mutex_t_* %10, i64 0, i32 4, i32 0, !dbg !548
  %36 = load i8*, i8** %35, align 8, !dbg !548
  %37 = getelementptr inbounds %struct.pthread_mutex_t_, %struct.pthread_mutex_t_* %10, i64 0, i32 4, i32 1, !dbg !548
  %38 = load i32, i32* %37, align 8, !dbg !548
  %39 = tail call i32 @pthread_equal(i8* %36, i32 %38, i8* %33, i32 %34) #3, !dbg !548
  %40 = icmp eq i32 %39, 0, !dbg !548
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !549
  br i1 %40, label %45, label %41, !dbg !549

; <label>:41:                                     ; preds = %31
  %42 = getelementptr inbounds %struct.pthread_mutex_t_, %struct.pthread_mutex_t_* %10, i64 0, i32 2, !dbg !550
  %43 = load i32, i32* %42, align 4, !dbg !552, !tbaa !542
  %44 = add nsw i32 %43, 1, !dbg !552
  store i32 %44, i32* %42, align 4, !dbg !552, !tbaa !542
  br label %45, !dbg !553

; <label>:45:                                     ; preds = %29, %31, %22, %41
  %46 = phi i32 [ 0, %41 ], [ 0, %22 ], [ 16, %31 ], [ 16, %29 ]
  store volatile i32 42, i32* @__A_VARIABLE, align 4
  br label %47, !dbg !554

; <label>:47:                                     ; preds = %20, %45, %4
  %48 = phi i32 [ %5, %4 ], [ 0, %20 ], [ %46, %45 ], !dbg !555
...
!554 = !DILocation(line: 94, column: 3, scope: !493)
!555 = !DILocation(line: 0, scope: !493)
!556 = !DILocation(line: 0, scope: !557)
!557 = distinct !DILexicalBlock(scope: !517, file: !1, line: 66, column: 9)
!558 = !DILocation(line: 95, column: 1, scope: !493)
