; ModuleID = '/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/stdio/fputc_u.c'
source_filename = "/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/stdio/fputc_u.c"
...
define dso_local i32 @_fputc_unlocked_r(%struct._reent*, i32, %struct.__sFILE*) local_unnamed_addr #0 !dbg !7 {
  %4 = icmp eq %struct._reent* %0, null, !dbg !241
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !241
  br i1 %4, label %10, label %5, !dbg !241

; <label>:5:                                      ; preds = %3
  %6 = getelementptr inbounds %struct._reent, %struct._reent* %0, i64 0, i32 8, !dbg !241
...
; <label>:10:                                     ; preds = %5, %3, %9
  %11 = tail call i32 @_putc_unlocked_r(%struct._reent* %0, i32 %1, %struct.__sFILE* %2) #3, !dbg !252
...
; Function Attrs: noredzone
declare dso_local i32 @_putc_unlocked_r(%struct._reent*, i32, %struct.__sFILE*) local_unnamed_addr #1

; Function Attrs: noredzone nounwind
define dso_local i32 @fputc_unlocked(i32, %struct.__sFILE*) local_unnamed_addr #0 !dbg !254 {
  %3 = tail call %struct._reent* @__getreent() #3, !dbg !264
  %4 = icmp eq %struct._reent* %3, null, !dbg !267
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !267
  br i1 %4, label %10, label %5, !dbg !267

; <label>:5:                                      ; preds = %2
  %6 = getelementptr inbounds %struct._reent, %struct._reent* %3, i64 0, i32 8, !dbg !267
  %7 = load i32, i32* %6, align 8, !dbg !267, !tbaa !243
  %8 = icmp eq i32 %7, 0, !dbg !267
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !266
  br i1 %8, label %9, label %10, !dbg !266

; <label>:9:                                      ; preds = %5
  tail call void @__sinit(%struct._reent* nonnull %3) #3, !dbg !267
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !267
  br label %10, !dbg !267

; <label>:10:                                     ; preds = %5, %2, %9
  %11 = tail call i32 @_putc_unlocked_r(%struct._reent* %3, i32 %0, %struct.__sFILE* %1) #3, !dbg !269
...
!1 = !DIFile(filename: "/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/stdio/fputc_u.c", directory: "/root/.unikraft/apps/redis/build")
!2 = !{}
!3 = !{i32 2, !"Dwarf Version", i32 4}
!4 = !{i32 2, !"Debug Info Version", i32 3}
!5 = !{i32 1, !"wchar_size", i32 4}
!6 = !{!"clang version 7.0.1-8+deb10u2 (tags/RELEASE_701/final)"}
!7 = distinct !DISubprogram(name: "_fputc_unlocked_r", scope: !1, file: !1, line: 32, type: !8, isLocal: false, isDefinition: true, scopeLine: 36, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !233)
...
!233 = !{!234, !235, !236, !237}
!234 = !DILocalVariable(name: "ptr", arg: 1, scope: !7, file: !1, line: 32, type: !11)
!235 = !DILocalVariable(name: "ch", arg: 2, scope: !7, file: !1, line: 32, type: !10)
!236 = !DILocalVariable(name: "file", arg: 3, scope: !7, file: !1, line: 32, type: !230)
!237 = !DILocalVariable(name: "_check_init_ptr", scope: !238, file: !1, line: 37, type: !11)
!238 = distinct !DILexicalBlock(scope: !7, file: !1, line: 37, column: 3)
!239 = !DILocation(line: 32, column: 1, scope: !7)
!240 = !DILocation(line: 37, column: 3, scope: !238)
!241 = !DILocation(line: 37, column: 3, scope: !242)
...
!252 = !DILocation(line: 38, column: 10, scope: !7)
!253 = !DILocation(line: 38, column: 3, scope: !7)
!254 = distinct !DISubprogram(name: "fputc_unlocked", scope: !1, file: !1, line: 43, type: !255, isLocal: false, isDefinition: true, scopeLine: 46, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !257)
!255 = !DISubroutineType(types: !256)
!256 = !{!10, !10, !230}
!257 = !{!258, !259, !260, !261}
!258 = !DILocalVariable(name: "ch", arg: 1, scope: !254, file: !1, line: 43, type: !10)
!259 = !DILocalVariable(name: "file", arg: 2, scope: !254, file: !1, line: 43, type: !230)
!260 = !DILocalVariable(name: "reent", scope: !254, file: !1, line: 48, type: !11)
!261 = !DILocalVariable(name: "_check_init_ptr", scope: !262, file: !1, line: 50, type: !11)
!262 = distinct !DILexicalBlock(scope: !254, file: !1, line: 50, column: 3)
!263 = !DILocation(line: 43, column: 1, scope: !254)
!264 = !DILocation(line: 48, column: 26, scope: !254)
!265 = !DILocation(line: 48, column: 18, scope: !254)
!266 = !DILocation(line: 50, column: 3, scope: !262)
!267 = !DILocation(line: 50, column: 3, scope: !268)
!268 = distinct !DILexicalBlock(scope: !262, file: !1, line: 50, column: 3)
!269 = !DILocation(line: 51, column: 10, scope: !254)
!270 = !DILocation(line: 51, column: 3, scope: !254)
