; ModuleID = '/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/stdio/fcloseall.c'
source_filename = "/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/stdio/fcloseall.c"
...
define dso_local i32 @_fcloseall_r(%struct._reent*) local_unnamed_addr #0 !dbg !7 {
  %2 = tail call i32 @_fwalk_reent(%struct._reent* %0, i32 (%struct._reent*, %struct.__sFILE*)* nonnull @_fclose_r) #3, !dbg !233
...
; Function Attrs: noredzone
declare dso_local i32 @_fclose_r(%struct._reent*, %struct.__sFILE*) #1

; Function Attrs: noredzone nounwind
define dso_local i32 @fcloseall() local_unnamed_addr #0 !dbg !235 {
  %1 = load %struct._reent*, %struct._reent** @_global_impure_ptr, align 8, !dbg !238, !tbaa !239
  %2 = tail call i32 @_fwalk_reent(%struct._reent* %1, i32 (%struct._reent*, %struct.__sFILE*)* nonnull @_fclose_r) #3, !dbg !245
...
!1 = !DIFile(filename: "/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/stdio/fcloseall.c", directory: "/root/.unikraft/apps/redis/build")
!2 = !{}
!3 = !{i32 2, !"Dwarf Version", i32 4}
!4 = !{i32 2, !"Debug Info Version", i32 3}
!5 = !{i32 1, !"wchar_size", i32 4}
!6 = !{!"clang version 7.0.1-8+deb10u2 (tags/RELEASE_701/final)"}
!7 = distinct !DISubprogram(name: "_fcloseall_r", scope: !1, file: !1, line: 67, type: !8, isLocal: false, isDefinition: true, scopeLine: 69, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !230)
...
!230 = !{!231}
!231 = !DILocalVariable(name: "ptr", arg: 1, scope: !7, file: !1, line: 67, type: !11)
!232 = !DILocation(line: 67, column: 1, scope: !7)
!233 = !DILocation(line: 70, column: 10, scope: !7)
!234 = !DILocation(line: 70, column: 3, scope: !7)
!235 = distinct !DISubprogram(name: "fcloseall", scope: !1, file: !1, line: 76, type: !236, isLocal: false, isDefinition: true, scopeLine: 77, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !2)
!236 = !DISubroutineType(types: !237)
!237 = !{!10}
!238 = !DILocation(line: 78, column: 24, scope: !235)
!239 = !{!240, !240, i64 0}
!240 = !{!"any pointer", !241, i64 0}
!241 = !{!"omnipotent char", !242, i64 0}
!242 = !{!"Simple C/C++ TBAA"}
!243 = !DILocation(line: 67, column: 1, scope: !7, inlinedAt: !244)
!244 = distinct !DILocation(line: 78, column: 10, scope: !235)
!245 = !DILocation(line: 70, column: 10, scope: !7, inlinedAt: !244)
!246 = !DILocation(line: 70, column: 3, scope: !7, inlinedAt: !244)
!247 = !DILocation(line: 78, column: 3, scope: !235)
