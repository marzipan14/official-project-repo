...
define dso_local i32 @sem_trywait(%struct.sem_t_** nocapture readonly) local_unnamed_addr #0 !dbg !16 {
  ...
  br i1 %3, label %4, label %5, !dbg !508
...
; <label>:5:                                      ; preds = %1
  %6 = getelementptr inbounds %struct.sem_t_, %struct.sem_t_* %2, i64 0, i32 1, !dbg !511
  %7 = tail call i32 @pthread_mutex_lock(%struct.pthread_mutex_t_** nonnull %6) #3, !dbg !513
  %8 = icmp eq i32 %7, 0, !dbg !514
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !515
  br i1 %8, label %9, label %20, !dbg !515

; <label>:9:                                      ; preds = %5
  %10 = load %struct.sem_t_*, %struct.sem_t_** %0, align 8, !dbg !516, !tbaa !501
  %11 = icmp eq %struct.sem_t_* %10, null, !dbg !519
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !520
  br i1 %11, label %12, label %14, !dbg !520

; <label>:12:                                     ; preds = %9
  %13 = tail call i32 @pthread_mutex_unlock(%struct.pthread_mutex_t_** nonnull %6) #3, !dbg !521
  br label %26, !dbg !523

; <label>:14:                                     ; preds = %9
  %15 = getelementptr inbounds %struct.sem_t_, %struct.sem_t_* %2, i64 0, i32 0, !dbg !524
  %16 = load i32, i32* %15, align 8, !dbg !524, !tbaa !526
  %17 = icmp sgt i32 %16, 0, !dbg !529
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !530
  br i1 %17, label %18, label %22, !dbg !530

; <label>:18:                                     ; preds = %14
  %19 = add nsw i32 %16, -1, !dbg !531
  store i32 %19, i32* %15, align 8, !dbg !531, !tbaa !526
  br label %22, !dbg !533
...
; <label>:22:                                     ; preds = %14, %18
  %23 = phi i32 [ 0, %18 ], [ 11, %14 ], !dbg !535
  store volatile i32 42, i32* @__A_VARIABLE, align 4
  %24 = tail call i32 @pthread_mutex_unlock(%struct.pthread_mutex_t_** nonnull %6) #3, !dbg !537
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !538
  %25 = icmp eq i32 %23, 0, !dbg !539
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !534
  br i1 %25, label %29, label %26, !dbg !534

; <label>:26:                                     ; preds = %22, %20, %12
  %27 = phi i32 [ 22, %12 ], [ %21, %20 ], [ %23, %22 ]
  %28 = tail call i32* @__errno() #3, !dbg !541
  store i32 %27, i32* %28, align 4, !dbg !541, !tbaa !542
  br label %29, !dbg !541

; <label>:29:                                     ; preds = %26, %22
  %30 = phi i32 [ 0, %22 ], [ -1, %26 ], !dbg !541
...
!509 = !DILocation(line: 91, column: 5, scope: !510)
!510 = distinct !DILexicalBlock(scope: !507, file: !1, line: 89, column: 5)
!511 = !DILocation(line: 92, column: 46, scope: !512)
!512 = distinct !DILexicalBlock(scope: !507, file: !1, line: 92, column: 12)
!513 = !DILocation(line: 92, column: 22, scope: !512)
!514 = !DILocation(line: 92, column: 53, scope: !512)
!515 = !DILocation(line: 92, column: 12, scope: !507)
!516 = !DILocation(line: 96, column: 11, scope: !517)
!517 = distinct !DILexicalBlock(scope: !518, file: !1, line: 96, column: 11)
!518 = distinct !DILexicalBlock(scope: !512, file: !1, line: 93, column: 5)
!519 = !DILocation(line: 96, column: 16, scope: !517)
!520 = !DILocation(line: 96, column: 11, scope: !518)
!521 = !DILocation(line: 98, column: 18, scope: !522)
!522 = distinct !DILexicalBlock(scope: !517, file: !1, line: 97, column: 9)
!523 = !DILocation(line: 100, column: 11, scope: !522)
!524 = !DILocation(line: 103, column: 14, scope: !525)
!525 = distinct !DILexicalBlock(scope: !518, file: !1, line: 103, column: 11)
!526 = !{!527, !528, i64 0}
!527 = !{!"sem_t_", !528, i64 0, !502, i64 8, !502, i64 16}
!528 = !{!"int", !503, i64 0}
!529 = !DILocation(line: 103, column: 20, scope: !525)
!530 = !DILocation(line: 103, column: 11, scope: !518)
!531 = !DILocation(line: 105, column: 19, scope: !532)
!532 = distinct !DILexicalBlock(scope: !525, file: !1, line: 104, column: 9)
!533 = !DILocation(line: 106, column: 9, scope: !532)
!534 = !DILocation(line: 115, column: 7, scope: !16)
!535 = !DILocation(line: 0, scope: !536)
!536 = distinct !DILexicalBlock(scope: !525, file: !1, line: 108, column: 9)
!537 = !DILocation(line: 112, column: 14, scope: !518)
!538 = !DILocation(line: 113, column: 5, scope: !518)
!539 = !DILocation(line: 115, column: 14, scope: !540)
!540 = distinct !DILexicalBlock(scope: !16, file: !1, line: 115, column: 7)
!541 = !DILocation(line: 0, scope: !522)
!542 = !{!528, !528, i64 0}
!543 = !DILocation(line: 123, column: 1, scope: !16)
