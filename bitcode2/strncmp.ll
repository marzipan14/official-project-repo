...
define dso_local i32 @strncmp(i8*, i8*, i64) local_unnamed_addr #0 !dbg !15 {
  ...
  br i1 %4, label %72, label %5, !dbg !34
...
; <label>:25:                                     ; preds = %22
  ...
  br i1 %30, label %31, label %72, !dbg !59

; <label>:31:                                     ; preds = %25
  %32 = getelementptr inbounds i64, i64* %17, i64 1, !dbg !60
  %33 = getelementptr inbounds i64, i64* %16, i64 1, !dbg !61
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !43
  %34 = icmp ugt i64 %23, 7, !dbg !44
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !45
  br i1 %34, label %15, label %35, !dbg !45, !llvm.loop !62
...
; <label>:41:                                     ; preds = %5, %35
  ...
  %45 = load i8, i8* %42, align 1, !dbg !70, !tbaa !71
  %46 = load i8, i8* %43, align 1, !dbg !72, !tbaa !71
  %47 = icmp eq i8 %45, %46, !dbg !73
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !68
  br i1 %47, label %48, label %66, !dbg !68
...
; <label>:48:                                     ; preds = %41, %57
  ...
  %53 = add i64 %50, -1, !dbg !74
  %54 = icmp eq i64 %53, 0, !dbg !75
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !78
  br i1 %54, label %72, label %55, !dbg !78

; <label>:55:                                     ; preds = %48
  %56 = icmp eq i8 %49, 0, !dbg !79
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !80
  br i1 %56, label %72, label %57, !dbg !80

; <label>:57:                                     ; preds = %55
  %58 = getelementptr inbounds i8, i8* %52, i64 1, !dbg !81
  %59 = getelementptr inbounds i8, i8* %51, i64 1, !dbg !82
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !68
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !69
  %60 = load i8, i8* %58, align 1, !dbg !70, !tbaa !71
  %61 = load i8, i8* %59, align 1, !dbg !72, !tbaa !71
  %62 = icmp eq i8 %60, %61, !dbg !73
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !68
  br i1 %62, label %48, label %63, !dbg !68, !llvm.loop !83

; <label>:63:                                     ; preds = %57
  %64 = load i8, i8* %58, align 1, !dbg !85, !tbaa !71
  %65 = load i8, i8* %59, align 1, !dbg !86, !tbaa !71
  br label %66, !dbg !85

; <label>:66:                                     ; preds = %63, %41
  %67 = phi i8 [ %46, %41 ], [ %65, %63 ], !dbg !86
  %68 = phi i8 [ %45, %41 ], [ %64, %63 ], !dbg !85
  %69 = zext i8 %68 to i32, !dbg !87
  %70 = zext i8 %67 to i32, !dbg !88
  %71 = sub nsw i32 %69, %70, !dbg !89
  br label %72, !dbg !90

; <label>:72:                                     ; preds = %22, %25, %48, %55, %3, %66
  %73 = phi i32 [ %71, %66 ], [ 0, %3 ], [ 0, %55 ], [ 0, %48 ], [ 0, %25 ], [ 0, %22 ], !dbg !91
...
!43 = !DILocation(line: 93, column: 7, scope: !39)
!44 = !DILocation(line: 93, column: 16, scope: !39)
!45 = !DILocation(line: 93, column: 33, scope: !39)
!46 = !DILocation(line: 93, column: 36, scope: !39)
!47 = !{!48, !48, i64 0}
!48 = !{!"long", !49, i64 0}
!49 = !{!"omnipotent char", !50, i64 0}
!50 = !{!"Simple C/C++ TBAA"}
!51 = !DILocation(line: 93, column: 43, scope: !39)
!52 = !DILocation(line: 93, column: 40, scope: !39)
...
!69 = !DILocation(line: 111, column: 18, scope: !15)
!70 = !DILocation(line: 111, column: 21, scope: !15)
!71 = !{!49, !49, i64 0}
!72 = !DILocation(line: 111, column: 28, scope: !15)
!73 = !DILocation(line: 111, column: 25, scope: !15)
!74 = !DILocation(line: 111, column: 11, scope: !15)
!75 = !DILocation(line: 115, column: 13, scope: !76)
!76 = distinct !DILexicalBlock(scope: !77, file: !1, line: 115, column: 11)
!77 = distinct !DILexicalBlock(scope: !15, file: !1, line: 112, column: 5)
!78 = !DILocation(line: 115, column: 18, scope: !76)
!79 = !DILocation(line: 115, column: 25, scope: !76)
!80 = !DILocation(line: 115, column: 11, scope: !77)
!81 = !DILocation(line: 117, column: 9, scope: !77)
!82 = !DILocation(line: 118, column: 9, scope: !77)
!83 = distinct !{!83, !68, !84}
!84 = !DILocation(line: 119, column: 5, scope: !15)
!85 = !DILocation(line: 120, column: 11, scope: !15)
!86 = !DILocation(line: 120, column: 37, scope: !15)
!87 = !DILocation(line: 120, column: 10, scope: !15)
!88 = !DILocation(line: 120, column: 36, scope: !15)
!89 = !DILocation(line: 120, column: 34, scope: !15)
!90 = !DILocation(line: 120, column: 3, scope: !15)
!91 = !DILocation(line: 0, scope: !56)
!92 = !DILocation(line: 0, scope: !33)
!93 = !DILocation(line: 122, column: 1, scope: !15)
