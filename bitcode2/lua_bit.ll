...
; <label>:13:                                     ; preds = %1, %8, %11
  ...
  br i1 %15, label %16, label %18, !dbg !492

; <label>:16:                                     ; preds = %13
  %17 = getelementptr inbounds [8 x i8], [8 x i8]* %2, i64 0, i64 0, !dbg !494
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %17) #5, !dbg !494
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !496
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !498
  br label %38, !dbg !498

; <label>:18:                                     ; preds = %13
  %19 = tail call double @lua_tonumber(%struct.lua_State* %0, i32 2) #4, !dbg !502
  %20 = fadd double %19, 0x4338000000000000, !dbg !504
  %21 = bitcast double %20 to i64, !dbg !504
  %22 = trunc i64 %21 to i32, !dbg !505
  %23 = icmp eq i32 %22, 0, !dbg !507
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !508
  br i1 %23, label %24, label %29, !dbg !508

; <label>:24:                                     ; preds = %18
  %25 = tail call i32 @lua_isnumber(%struct.lua_State* %0, i32 2) #4, !dbg !509
  %26 = icmp eq i32 %25, 0, !dbg !509
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !510
  br i1 %26, label %27, label %29, !dbg !510

; <label>:27:                                     ; preds = %24
  %28 = tail call i32 @luaL_typerror(%struct.lua_State* %0, i32 2, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.4, i64 0, i64 0)) #4, !dbg !511
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !512
  br label %29, !dbg !512

; <label>:29:                                     ; preds = %27, %24, %18
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !513
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !492
  %30 = getelementptr inbounds [8 x i8], [8 x i8]* %2, i64 0, i64 0, !dbg !494
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %30) #5, !dbg !494
  %31 = icmp slt i32 %22, 0, !dbg !514
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !496
  br i1 %31, label %32, label %34, !dbg !496

; <label>:32:                                     ; preds = %29
  %33 = sub nsw i32 0, %22, !dbg !516
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !518
  br label %34, !dbg !518

; <label>:34:                                     ; preds = %32, %29
  %35 = phi i32 [ %33, %32 ], [ %22, %29 ], !dbg !519
  %36 = phi i8* [ getelementptr inbounds ([17 x i8], [17 x i8]* @.str.18, i64 0, i64 0), %32 ], [ getelementptr inbounds ([17 x i8], [17 x i8]* @.str.17, i64 0, i64 0), %29 ], !dbg !519
  %37 = icmp sgt i32 %35, 8, !dbg !520
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !498
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !522
  br i1 %37, label %38, label %41, !dbg !498

; <label>:38:                                     ; preds = %34, %16
  %39 = phi i8* [ getelementptr inbounds ([17 x i8], [17 x i8]* @.str.17, i64 0, i64 0), %16 ], [ %36, %34 ]
  %40 = phi i8* [ %17, %16 ], [ %30, %34 ]
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !525
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !526
  br label %45, !dbg !526

; <label>:41:                                     ; preds = %34
  %42 = icmp sgt i32 %35, 0, !dbg !527
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !526
  br i1 %42, label %45, label %43, !dbg !526

; <label>:43:                                     ; preds = %41
  %44 = sext i32 %35 to i64, !dbg !529
  br label %61, !dbg !526

; <label>:45:                                     ; preds = %38, %41
  %46 = phi i32 [ 8, %38 ], [ %35, %41 ]
  %47 = phi i8* [ %40, %38 ], [ %30, %41 ]
  %48 = phi i8* [ %39, %38 ], [ %36, %41 ]
  %49 = sext i32 %46 to i64, !dbg !530
  br label %50, !dbg !530

; <label>:50:                                     ; preds = %45, %50
  %51 = phi i64 [ %49, %45 ], [ %53, %50 ]
  %52 = phi i32 [ %6, %45 ], [ %59, %50 ]
  %53 = add nsw i64 %51, -1, !dbg !530
  %54 = and i32 %52, 15, !dbg !531
  %55 = zext i32 %54 to i64, !dbg !533
  %56 = getelementptr inbounds i8, i8* %48, i64 %55, !dbg !533
  %57 = load i8, i8* %56, align 1, !dbg !533, !tbaa !534
  %58 = getelementptr inbounds [8 x i8], [8 x i8]* %2, i64 0, i64 %53, !dbg !537
  store i8 %57, i8* %58, align 1, !dbg !538, !tbaa !534
  %59 = lshr i32 %52, 4, !dbg !539
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !540
  %60 = icmp sgt i64 %51, 1, !dbg !527
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !526
  br i1 %60, label %50, label %61, !dbg !526, !llvm.loop !541

; <label>:61:                                     ; preds = %50, %43
  %62 = phi i8* [ %30, %43 ], [ %47, %50 ]
  %63 = phi i64 [ %44, %43 ], [ %49, %50 ], !dbg !529
  call void @lua_pushlstring(%struct.lua_State* %0, i8* nonnull %62, i64 %63) #4, !dbg !543
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %62) #5, !dbg !544
...
!493 = !DILocation(line: 130, column: 9, scope: !464)
!494 = !DILocation(line: 132, column: 3, scope: !464)
!495 = !DILocation(line: 132, column: 8, scope: !464)
!496 = !DILocation(line: 134, column: 7, scope: !464)
!497 = !DILocation(line: 131, column: 15, scope: !464)
!498 = !DILocation(line: 135, column: 7, scope: !464)
!499 = !DILocation(line: 57, column: 30, scope: !56, inlinedAt: !500)
!500 = distinct !DILocation(line: 130, column: 43, scope: !464)
!501 = !DILocation(line: 57, column: 37, scope: !56, inlinedAt: !500)
!502 = !DILocation(line: 62, column: 10, scope: !56, inlinedAt: !500)
!503 = !DILocation(line: 59, column: 10, scope: !56, inlinedAt: !500)
!504 = !DILocation(line: 67, column: 8, scope: !56, inlinedAt: !500)
!505 = !DILocation(line: 71, column: 7, scope: !56, inlinedAt: !500)
!506 = !DILocation(line: 60, column: 9, scope: !56, inlinedAt: !500)
!507 = !DILocation(line: 86, column: 9, scope: !79, inlinedAt: !500)
!508 = !DILocation(line: 86, column: 14, scope: !79, inlinedAt: !500)
!509 = !DILocation(line: 86, column: 18, scope: !79, inlinedAt: !500)
!510 = !DILocation(line: 86, column: 7, scope: !56, inlinedAt: !500)
!511 = !DILocation(line: 87, column: 5, scope: !84, inlinedAt: !500)
!512 = !DILocation(line: 88, column: 3, scope: !84, inlinedAt: !500)
!513 = !DILocation(line: 90, column: 3, scope: !56, inlinedAt: !500)
!514 = !DILocation(line: 134, column: 9, scope: !515)
!515 = distinct !DILexicalBlock(scope: !464, file: !3, line: 134, column: 7)
!516 = !DILocation(line: 134, column: 20, scope: !517)
!517 = distinct !DILexicalBlock(scope: !515, file: !3, line: 134, column: 14)
!518 = !DILocation(line: 134, column: 56, scope: !517)
!519 = !DILocation(line: 0, scope: !464)
!520 = !DILocation(line: 135, column: 9, scope: !521)
!521 = distinct !DILexicalBlock(scope: !464, file: !3, line: 135, column: 7)
!522 = !DILocation(line: 0, scope: !523)
!523 = distinct !DILexicalBlock(scope: !464, file: !3, line: 136, column: 3)
!524 = !DILocation(line: 133, column: 7, scope: !464)
!525 = !DILocation(line: 136, column: 8, scope: !523)
!526 = !DILocation(line: 136, column: 3, scope: !523)
!527 = !DILocation(line: 136, column: 24, scope: !528)
!528 = distinct !DILexicalBlock(scope: !523, file: !3, line: 136, column: 3)
!529 = !DILocation(line: 137, column: 27, scope: !464)
!530 = !DILocation(line: 136, column: 20, scope: !528)
!531 = !DILocation(line: 136, column: 55, scope: !532)
!532 = distinct !DILexicalBlock(scope: !528, file: !3, line: 136, column: 32)
!533 = !DILocation(line: 136, column: 43, scope: !532)
!534 = !{!535, !535, i64 0}
!535 = !{!"omnipotent char", !536, i64 0}
!536 = !{!"Simple C/C++ TBAA"}
!537 = !DILocation(line: 136, column: 34, scope: !532)
!538 = !DILocation(line: 136, column: 41, scope: !532)
!539 = !DILocation(line: 136, column: 64, scope: !532)
!540 = !DILocation(line: 136, column: 3, scope: !528)
!541 = distinct !{!541, !526, !542}
!542 = !DILocation(line: 136, column: 71, scope: !523)
!543 = !DILocation(line: 137, column: 3, scope: !464)
!544 = !DILocation(line: 139, column: 1, scope: !464)
!545 = !DILocation(line: 138, column: 3, scope: !464)
