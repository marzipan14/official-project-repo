...
; <label>:43:                                     ; preds = %10, %3, %40, %17
  ...
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %7) #4, !dbg !330
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !330
  ret %struct.__sFILE* %44, !dbg !330
}
...
; Function Attrs: noredzone nounwind
define dso_local %struct.__sFILE* @fopen(i8*, i8*) local_unnamed_addr #0 !dbg !331 {
  %3 = tail call %struct._reent* @__getreent() #5, !dbg !338
  %4 = tail call %struct.__sFILE* @_fopen_r(%struct._reent* %3, i8* %0, i8* %1) #6, !dbg !339
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !340
  ret %struct.__sFILE* %4, !dbg !340
}
...
!330 = !DILocation(line: 172, column: 1, scope: !27)
!331 = distinct !DISubprogram(name: "fopen", scope: !1, file: !1, line: 177, type: !332, isLocal: false, isDefinition: true, scopeLine: 180, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !334)
!332 = !DISubroutineType(types: !333)
!333 = !{!30, !222, !222}
!334 = !{!335, !336}
!335 = !DILocalVariable(name: "file", arg: 1, scope: !331, file: !1, line: 177, type: !222)
!336 = !DILocalVariable(name: "mode", arg: 2, scope: !331, file: !1, line: 177, type: !222)
!337 = !DILocation(line: 177, column: 1, scope: !331)
!338 = !DILocation(line: 181, column: 20, scope: !331)
!339 = !DILocation(line: 181, column: 10, scope: !331)
!340 = !DILocation(line: 181, column: 3, scope: !331)
