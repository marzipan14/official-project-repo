...
; <label>:38:                                     ; preds = %30
  ...
  %40 = icmp sgt i32 %33, %39, !dbg !295
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !296
  br i1 %40, label %41, label %48, !dbg !296

; <label>:41:                                     ; preds = %38
  %42 = and i32 %32, 255, !dbg !297
  %43 = icmp eq i32 %42, 10, !dbg !297
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !298
  br i1 %43, label %48, label %44, !dbg !298

; <label>:44:                                     ; preds = %41, %36
  %45 = phi i32 [ %37, %36 ], [ %42, %41 ], !dbg !292
  %46 = load i8*, i8** %24, align 8, !dbg !299, !tbaa !300
  %47 = getelementptr inbounds i8, i8* %46, i64 1, !dbg !299
  store i8* %47, i8** %24, align 8, !dbg !299, !tbaa !300
  store i8 %28, i8* %46, align 1, !dbg !301, !tbaa !273
  br label %50, !dbg !302

; <label>:48:                                     ; preds = %41, %38
  %49 = tail call i32 @__swbuf_r(%struct._reent* %0, i32 %32, %struct.__sFILE* nonnull %2) #3, !dbg !303
  br label %50, !dbg !304

; <label>:50:                                     ; preds = %44, %48
  %51 = phi i32 [ %45, %44 ], [ %49, %48 ], !dbg !305
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !269
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !306
  %52 = icmp eq i32 %51, -1, !dbg !307
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !308
  br i1 %52, label %53, label %26, !dbg !308, !llvm.loop !309

; <label>:53:                                     ; preds = %50, %26, %19
  %54 = phi i32 [ -1, %19 ], [ -1, %50 ], [ 0, %26 ], !dbg !311
...
; Function Attrs: noredzone nounwind
define dso_local i32 @fputs_unlocked(i8* noalias nocapture readonly, %struct.__sFILE* noalias) local_unnamed_addr #0 !dbg !313 {
  %3 = tail call %struct._reent* @__getreent() #3, !dbg !320
  %4 = tail call i32 @_fputs_unlocked_r(%struct._reent* %3, i8* %0, %struct.__sFILE* %1) #5, !dbg !321
...
!296 = !DILocation(line: 692, column: 47, scope: !288, inlinedAt: !284)
!297 = !DILocation(line: 692, column: 59, scope: !288, inlinedAt: !284)
!298 = !DILocation(line: 692, column: 6, scope: !277, inlinedAt: !284)
!299 = !DILocation(line: 693, column: 18, scope: !288, inlinedAt: !284)
!300 = !{!261, !254, i64 0}
!301 = !DILocation(line: 693, column: 21, scope: !288, inlinedAt: !284)
!302 = !DILocation(line: 693, column: 3, scope: !288, inlinedAt: !284)
!303 = !DILocation(line: 695, column: 11, scope: !288, inlinedAt: !284)
!304 = !DILocation(line: 695, column: 3, scope: !288, inlinedAt: !284)
!305 = !DILocation(line: 0, scope: !288, inlinedAt: !284)
!306 = !DILocation(line: 696, column: 1, scope: !277, inlinedAt: !284)
!307 = !DILocation(line: 148, column: 37, scope: !270)
!308 = !DILocation(line: 148, column: 11, scope: !271)
!309 = distinct !{!309, !268, !310}
!310 = !DILocation(line: 150, column: 5, scope: !10)
!311 = !DILocation(line: 0, scope: !10)
!312 = !DILocation(line: 158, column: 1, scope: !10)
!313 = distinct !DISubprogram(name: "fputs_unlocked", scope: !11, file: !11, line: 162, type: !314, isLocal: false, isDefinition: true, scopeLine: 165, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !316)
!314 = !DISubroutineType(types: !315)
!315 = !{!14, !232, !233}
!316 = !{!317, !318}
!317 = !DILocalVariable(name: "s", arg: 1, scope: !313, file: !11, line: 162, type: !232)
!318 = !DILocalVariable(name: "fp", arg: 2, scope: !313, file: !11, line: 162, type: !233)
!319 = !DILocation(line: 162, column: 1, scope: !313)
!320 = !DILocation(line: 166, column: 20, scope: !313)
!321 = !DILocation(line: 166, column: 10, scope: !313)
!322 = !DILocation(line: 166, column: 3, scope: !313)
