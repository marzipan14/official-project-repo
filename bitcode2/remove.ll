; ModuleID = '/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/stdio/remove.c'
source_filename = "/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/stdio/remove.c"
...
define dso_local i32 @_remove_r(%struct._reent*, i8*) local_unnamed_addr #0 !dbg !7 {
  %3 = tail call i32 @_unlink_r(%struct._reent* %0, i8* %1) #3, !dbg !234
  %4 = icmp eq i32 %3, -1, !dbg !236
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !237
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !238
  %5 = sext i1 %4 to i32, !dbg !239
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !240
  ret i32 %5, !dbg !240
}

; Function Attrs: noredzone
declare dso_local i32 @_unlink_r(%struct._reent*, i8*) local_unnamed_addr #1

; Function Attrs: noredzone nounwind
define dso_local i32 @remove(i8*) local_unnamed_addr #0 !dbg !241 {
  %2 = tail call %struct._reent* @__getreent() #3, !dbg !247
  %3 = tail call i32 @_unlink_r(%struct._reent* %2, i8* %0) #3, !dbg !250
...
!1 = !DIFile(filename: "/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/stdio/remove.c", directory: "/root/.unikraft/apps/redis/build")
!2 = !{}
!3 = !{i32 2, !"Dwarf Version", i32 4}
!4 = !{i32 2, !"Debug Info Version", i32 3}
!5 = !{i32 1, !"wchar_size", i32 4}
!6 = !{!"clang version 7.0.1-8+deb10u2 (tags/RELEASE_701/final)"}
!7 = distinct !DISubprogram(name: "_remove_r", scope: !1, file: !1, line: 71, type: !8, isLocal: false, isDefinition: true, scopeLine: 74, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !230)
...
!230 = !{!231, !232}
!231 = !DILocalVariable(name: "ptr", arg: 1, scope: !7, file: !1, line: 71, type: !11)
!232 = !DILocalVariable(name: "filename", arg: 2, scope: !7, file: !1, line: 71, type: !50)
!233 = !DILocation(line: 71, column: 1, scope: !7)
!234 = !DILocation(line: 75, column: 7, scope: !235)
!235 = distinct !DILexicalBlock(scope: !7, file: !1, line: 75, column: 7)
!236 = !DILocation(line: 75, column: 33, scope: !235)
!237 = !DILocation(line: 75, column: 7, scope: !7)
!238 = !DILocation(line: 0, scope: !7)
!239 = !DILocation(line: 76, column: 5, scope: !235)
!240 = !DILocation(line: 79, column: 1, scope: !7)
!241 = distinct !DISubprogram(name: "remove", scope: !1, file: !1, line: 84, type: !242, isLocal: false, isDefinition: true, scopeLine: 86, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !244)
!242 = !DISubroutineType(types: !243)
!243 = !{!10, !50}
!244 = !{!245}
!245 = !DILocalVariable(name: "filename", arg: 1, scope: !241, file: !1, line: 84, type: !50)
!246 = !DILocation(line: 84, column: 1, scope: !241)
!247 = !DILocation(line: 87, column: 21, scope: !241)
!248 = !DILocation(line: 71, column: 1, scope: !7, inlinedAt: !249)
!249 = distinct !DILocation(line: 87, column: 10, scope: !241)
!250 = !DILocation(line: 75, column: 7, scope: !235, inlinedAt: !249)
!251 = !DILocation(line: 75, column: 33, scope: !235, inlinedAt: !249)
!252 = !DILocation(line: 75, column: 7, scope: !7, inlinedAt: !249)
!253 = !DILocation(line: 0, scope: !7, inlinedAt: !249)
!254 = !DILocation(line: 76, column: 5, scope: !235, inlinedAt: !249)
!255 = !DILocation(line: 79, column: 1, scope: !7, inlinedAt: !249)
!256 = !DILocation(line: 87, column: 3, scope: !241)
