; ModuleID = '/root/.unikraft/apps/redis/build/libpthread-embedded/origin/pthread-embedded-44b41d760a433915d70a7be9809651b0a65e001d/pthread_rwlock_timedrdlock.c'
source_filename = "/root/.unikraft/apps/redis/build/libpthread-embedded/origin/pthread-embedded-44b41d760a433915d70a7be9809651b0a65e001d/pthread_rwlock_timedrdlock.c"
...
define dso_local i32 @pthread_rwlock_timedrdlock(%struct.pthread_rwlock_t_**, %struct.timespec*) local_unnamed_addr #0 !dbg !513 {
  %3 = icmp eq %struct.pthread_rwlock_t_** %0, null, !dbg !532
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !534
  br i1 %3, label %52, label %4, !dbg !534

; <label>:4:                                      ; preds = %2
  %5 = load %struct.pthread_rwlock_t_*, %struct.pthread_rwlock_t_** %0, align 8, !dbg !535, !tbaa !536
  %6 = icmp eq %struct.pthread_rwlock_t_* %5, null, !dbg !540
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !541
  br i1 %6, label %52, label %7, !dbg !541

; <label>:7:                                      ; preds = %4
  %8 = icmp eq %struct.pthread_rwlock_t_* %5, inttoptr (i64 -1 to %struct.pthread_rwlock_t_*), !dbg !542
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !544
  br i1 %8, label %9, label %15, !dbg !544

; <label>:9:                                      ; preds = %7
  %10 = tail call i32 @pte_rwlock_check_need_init(%struct.pthread_rwlock_t_** nonnull %0) #3, !dbg !545
  %11 = or i32 %10, 16, !dbg !548
  %12 = icmp eq i32 %11, 16, !dbg !548
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !548
  br i1 %12, label %13, label %52, !dbg !548

; <label>:13:                                     ; preds = %9
  %14 = load %struct.pthread_rwlock_t_*, %struct.pthread_rwlock_t_** %0, align 8, !dbg !550, !tbaa !536
  br label %15, !dbg !548

; <label>:15:                                     ; preds = %13, %7
  %16 = phi %struct.pthread_rwlock_t_* [ %14, %13 ], [ %5, %7 ], !dbg !550
  %17 = getelementptr inbounds %struct.pthread_rwlock_t_, %struct.pthread_rwlock_t_* %16, i64 0, i32 6, !dbg !552
  %18 = load i32, i32* %17, align 4, !dbg !552, !tbaa !554
  %19 = icmp eq i32 %18, 262974946, !dbg !557
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !558
  br i1 %19, label %20, label %52, !dbg !558

; <label>:20:                                     ; preds = %15
  %21 = getelementptr inbounds %struct.pthread_rwlock_t_, %struct.pthread_rwlock_t_* %16, i64 0, i32 0, !dbg !559
  %22 = tail call i32 @pthread_mutex_timedlock(%struct.pthread_mutex_t_** %21, %struct.timespec* %1) #3, !dbg !561
  %23 = icmp eq i32 %22, 0, !dbg !562
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !563
  br i1 %23, label %24, label %52, !dbg !563

; <label>:24:                                     ; preds = %20
  %25 = getelementptr inbounds %struct.pthread_rwlock_t_, %struct.pthread_rwlock_t_* %16, i64 0, i32 3, !dbg !564
  %26 = load i32, i32* %25, align 8, !dbg !566, !tbaa !567
  %27 = add nsw i32 %26, 1, !dbg !566
  store i32 %27, i32* %25, align 8, !dbg !566, !tbaa !567
  %28 = icmp eq i32 %27, 2147483647, !dbg !568
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !569
  br i1 %28, label %29, label %50, !dbg !569

; <label>:29:                                     ; preds = %24
  %30 = getelementptr inbounds %struct.pthread_rwlock_t_, %struct.pthread_rwlock_t_* %16, i64 0, i32 1, !dbg !570
  %31 = tail call i32 @pthread_mutex_timedlock(%struct.pthread_mutex_t_** nonnull %30, %struct.timespec* %1) #3, !dbg !573
  %32 = icmp eq i32 %31, 0, !dbg !574
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !575
  br i1 %32, label %41, label %33, !dbg !575

; <label>:33:                                     ; preds = %29
  %34 = icmp eq i32 %31, 116, !dbg !576
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !579
  br i1 %34, label %35, label %39, !dbg !579

; <label>:35:                                     ; preds = %33
  %36 = getelementptr inbounds %struct.pthread_rwlock_t_, %struct.pthread_rwlock_t_* %16, i64 0, i32 5, !dbg !580
  %37 = load i32, i32* %36, align 8, !dbg !582, !tbaa !583
  %38 = add nsw i32 %37, 1, !dbg !582
  store i32 %38, i32* %36, align 8, !dbg !582, !tbaa !583
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !584
  br label %39, !dbg !584

; <label>:39:                                     ; preds = %35, %33
  %40 = tail call i32 @pthread_mutex_unlock(%struct.pthread_mutex_t_** nonnull %21) #3, !dbg !585
  br label %52, !dbg !586

; <label>:41:                                     ; preds = %29
  %42 = getelementptr inbounds %struct.pthread_rwlock_t_, %struct.pthread_rwlock_t_* %16, i64 0, i32 5, !dbg !587
  %43 = load i32, i32* %42, align 8, !dbg !587, !tbaa !583
  %44 = load i32, i32* %25, align 8, !dbg !588, !tbaa !567
  %45 = sub nsw i32 %44, %43, !dbg !588
  store i32 %45, i32* %25, align 8, !dbg !588, !tbaa !567
  store i32 0, i32* %42, align 8, !dbg !589, !tbaa !583
  %46 = tail call i32 @pthread_mutex_unlock(%struct.pthread_mutex_t_** nonnull %30) #3, !dbg !590
  %47 = icmp eq i32 %46, 0, !dbg !592
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !593
  br i1 %47, label %50, label %48, !dbg !593

; <label>:48:                                     ; preds = %41
  %49 = tail call i32 @pthread_mutex_unlock(%struct.pthread_mutex_t_** nonnull %21) #3, !dbg !594
  br label %52, !dbg !596

; <label>:50:                                     ; preds = %41, %24
  %51 = tail call i32 @pthread_mutex_unlock(%struct.pthread_mutex_t_** nonnull %21) #3, !dbg !597
  br label %52, !dbg !598

; <label>:52:                                     ; preds = %20, %15, %9, %2, %4, %50, %48, %39
  %53 = phi i32 [ %31, %39 ], [ %46, %48 ], [ %51, %50 ], [ 22, %4 ], [ 22, %2 ], [ %10, %9 ], [ 22, %15 ], [ %22, %20 ], !dbg !599
...
; Function Attrs: noredzone
declare dso_local i32 @pthread_mutex_timedlock(%struct.pthread_mutex_t_**, %struct.timespec*) local_unnamed_addr #1
...
!1 = !DIFile(filename: "/root/.unikraft/apps/redis/build/libpthread-embedded/origin/pthread-embedded-44b41d760a433915d70a7be9809651b0a65e001d/pthread_rwlock_timedrdlock.c", directory: "/root/.unikraft/apps/redis/build")
!2 = !{!3}
...
!513 = distinct !DISubprogram(name: "pthread_rwlock_timedrdlock", scope: !1, file: !1, line: 50, type: !514, isLocal: false, isDefinition: true, scopeLine: 52, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !525)
...
!519 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "timespec", file: !520, line: 52, size: 128, elements: !521)
!520 = !DIFile(filename: "/root/.unikraft/unikraft/lib/uktime/include/uk/time_types.h", directory: "/root/.unikraft/apps/redis/build")
!521 = !{!522, !524}
!522 = !DIDerivedType(tag: DW_TAG_member, name: "tv_sec", scope: !519, file: !520, line: 53, baseType: !523, size: 64)
!523 = !DIDerivedType(tag: DW_TAG_typedef, name: "time_t", file: !520, line: 34, baseType: !31)
!524 = !DIDerivedType(tag: DW_TAG_member, name: "tv_nsec", scope: !519, file: !520, line: 54, baseType: !31, size: 64, offset: 64)
!525 = !{!526, !527, !528, !529}
!526 = !DILocalVariable(name: "rwlock", arg: 1, scope: !513, file: !1, line: 50, type: !516)
!527 = !DILocalVariable(name: "abstime", arg: 2, scope: !513, file: !1, line: 51, type: !517)
!528 = !DILocalVariable(name: "result", scope: !513, file: !1, line: 53, type: !41)
!529 = !DILocalVariable(name: "rwl", scope: !513, file: !1, line: 54, type: !12)
!530 = !DILocation(line: 50, column: 48, scope: !513)
!531 = !DILocation(line: 51, column: 52, scope: !513)
!532 = !DILocation(line: 56, column: 14, scope: !533)
!533 = distinct !DILexicalBlock(scope: !513, file: !1, line: 56, column: 7)
!534 = !DILocation(line: 56, column: 22, scope: !533)
!535 = !DILocation(line: 56, column: 25, scope: !533)
!536 = !{!537, !537, i64 0}
!537 = !{!"any pointer", !538, i64 0}
!538 = !{!"omnipotent char", !539, i64 0}
!539 = !{!"Simple C/C++ TBAA"}
!540 = !DILocation(line: 56, column: 33, scope: !533)
!541 = !DILocation(line: 56, column: 7, scope: !513)
!542 = !DILocation(line: 67, column: 15, scope: !543)
!543 = distinct !DILexicalBlock(scope: !513, file: !1, line: 67, column: 7)
!544 = !DILocation(line: 67, column: 7, scope: !513)
!545 = !DILocation(line: 69, column: 16, scope: !546)
!546 = distinct !DILexicalBlock(scope: !543, file: !1, line: 68, column: 5)
!547 = !DILocation(line: 53, column: 7, scope: !513)
!548 = !DILocation(line: 71, column: 23, scope: !549)
!549 = distinct !DILexicalBlock(scope: !546, file: !1, line: 71, column: 11)
!550 = !DILocation(line: 77, column: 9, scope: !513)
!551 = !DILocation(line: 54, column: 20, scope: !513)
!552 = !DILocation(line: 79, column: 12, scope: !553)
!553 = distinct !DILexicalBlock(scope: !513, file: !1, line: 79, column: 7)
!554 = !{!555, !556, i64 36}
!555 = !{!"pthread_rwlock_t_", !537, i64 0, !537, i64 8, !537, i64 16, !556, i64 24, !556, i64 28, !556, i64 32, !556, i64 36}
!556 = !{!"int", !538, i64 0}
!557 = !DILocation(line: 79, column: 19, scope: !553)
!558 = !DILocation(line: 79, column: 7, scope: !513)
!559 = !DILocation(line: 85, column: 42, scope: !560)
!560 = distinct !DILexicalBlock(scope: !513, file: !1, line: 84, column: 7)
!561 = !DILocation(line: 85, column: 10, scope: !560)
!562 = !DILocation(line: 85, column: 73, scope: !560)
!563 = !DILocation(line: 84, column: 7, scope: !513)
!564 = !DILocation(line: 90, column: 14, scope: !565)
!565 = distinct !DILexicalBlock(scope: !513, file: !1, line: 90, column: 7)
!566 = !DILocation(line: 90, column: 7, scope: !565)
!567 = !{!555, !556, i64 24}
!568 = !DILocation(line: 90, column: 33, scope: !565)
!569 = !DILocation(line: 90, column: 7, scope: !513)
!570 = !DILocation(line: 93, column: 46, scope: !571)
!571 = distinct !DILexicalBlock(scope: !572, file: !1, line: 92, column: 11)
!572 = distinct !DILexicalBlock(scope: !565, file: !1, line: 91, column: 5)
!573 = !DILocation(line: 93, column: 14, scope: !571)
!574 = !DILocation(line: 94, column: 49, scope: !571)
!575 = !DILocation(line: 92, column: 11, scope: !572)
!576 = !DILocation(line: 96, column: 22, scope: !577)
!577 = distinct !DILexicalBlock(scope: !578, file: !1, line: 96, column: 15)
!578 = distinct !DILexicalBlock(scope: !571, file: !1, line: 95, column: 9)
!579 = !DILocation(line: 96, column: 15, scope: !578)
!580 = !DILocation(line: 98, column: 22, scope: !581)
!581 = distinct !DILexicalBlock(scope: !577, file: !1, line: 97, column: 13)
!582 = !DILocation(line: 98, column: 15, scope: !581)
!583 = !{!555, !556, i64 32}
!584 = !DILocation(line: 99, column: 13, scope: !581)
!585 = !DILocation(line: 100, column: 18, scope: !578)
!586 = !DILocation(line: 101, column: 11, scope: !578)
!587 = !DILocation(line: 104, column: 39, scope: !572)
!588 = !DILocation(line: 104, column: 31, scope: !572)
!589 = !DILocation(line: 105, column: 40, scope: !572)
!590 = !DILocation(line: 108, column: 14, scope: !591)
!591 = distinct !DILexicalBlock(scope: !572, file: !1, line: 107, column: 11)
!592 = !DILocation(line: 108, column: 71, scope: !591)
!593 = !DILocation(line: 107, column: 11, scope: !572)
!594 = !DILocation(line: 110, column: 18, scope: !595)
!595 = distinct !DILexicalBlock(scope: !591, file: !1, line: 109, column: 9)
!596 = !DILocation(line: 111, column: 11, scope: !595)
!597 = !DILocation(line: 115, column: 11, scope: !513)
!598 = !DILocation(line: 115, column: 3, scope: !513)
!599 = !DILocation(line: 0, scope: !513)
!600 = !DILocation(line: 0, scope: !601)
!601 = distinct !DILexicalBlock(scope: !533, file: !1, line: 57, column: 5)
!602 = !DILocation(line: 116, column: 1, scope: !513)
