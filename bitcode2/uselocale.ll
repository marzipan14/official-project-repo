...
define dso_local %struct.__locale_t* @_uselocale_r(%struct._reent* nocapture, %struct.__locale_t*) local_unnamed_addr #0 !dbg !288 {
  ...
  %7 = icmp eq %struct.__locale_t* %1, inttoptr (i64 -1 to %struct.__locale_t*), !dbg !319
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !321
  br i1 %7, label %10, label %8, !dbg !321

; <label>:8:                                      ; preds = %2
  %9 = icmp eq %struct.__locale_t* %1, null, !dbg !322
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !324
  br i1 %9, label %12, label %10, !dbg !324

; <label>:10:                                     ; preds = %8, %2
  %11 = phi %struct.__locale_t* [ null, %2 ], [ %1, %8 ]
  store %struct.__locale_t* %11, %struct.__locale_t** %3, align 8, !dbg !325, !tbaa !305
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !325
  br label %12, !dbg !326

; <label>:12:                                     ; preds = %10, %8
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !326
  ret %struct.__locale_t* %6, !dbg !326
}

; Function Attrs: noredzone nounwind
define dso_local %struct.__locale_t* @uselocale(%struct.__locale_t*) local_unnamed_addr #0 !dbg !327 {
  %2 = tail call %struct._reent* @__getreent() #3, !dbg !335
  %3 = getelementptr inbounds %struct._reent, %struct._reent* %2, i64 0, i32 7, !dbg !341
  %4 = load %struct.__locale_t*, %struct.__locale_t** %3, align 8, !dbg !341, !tbaa !305
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !342
  %5 = icmp eq %struct.__locale_t* %4, null, !dbg !344
  %6 = select i1 %5, %struct.__locale_t* inttoptr (i64 -1 to %struct.__locale_t*), %struct.__locale_t* %4, !dbg !345
  %7 = icmp eq %struct.__locale_t* %0, inttoptr (i64 -1 to %struct.__locale_t*), !dbg !346
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !347
  br i1 %7, label %10, label %8, !dbg !347

; <label>:8:                                      ; preds = %1
  %9 = icmp eq %struct.__locale_t* %0, null, !dbg !348
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !349
  br i1 %9, label %12, label %10, !dbg !349

; <label>:10:                                     ; preds = %8, %1
  %11 = phi %struct.__locale_t* [ null, %1 ], [ %0, %8 ]
  store %struct.__locale_t* %11, %struct.__locale_t** %3, align 8, !dbg !350, !tbaa !305
...
; <label>:12:                                     ; preds = %10, %8
  ...
  ret %struct.__locale_t* %6, !dbg !352
}
...
!319 = !DILocation(line: 66, column: 14, scope: !320)
!320 = distinct !DILexicalBlock(scope: !288, file: !1, line: 66, column: 7)
!321 = !DILocation(line: 66, column: 7, scope: !288)
!322 = !DILocation(line: 68, column: 12, scope: !323)
!323 = distinct !DILexicalBlock(scope: !320, file: !1, line: 68, column: 12)
!324 = !DILocation(line: 68, column: 12, scope: !320)
!325 = !DILocation(line: 0, scope: !320)
!326 = !DILocation(line: 70, column: 3, scope: !288)
!327 = distinct !DISubprogram(name: "uselocale", scope: !1, file: !1, line: 75, type: !328, isLocal: false, isDefinition: true, scopeLine: 76, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !332)
!328 = !DISubroutineType(types: !329)
!329 = !{!330, !4}
!330 = !DIDerivedType(tag: DW_TAG_typedef, name: "locale_t", file: !331, line: 10, baseType: !4)
!331 = !DIFile(filename: "/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/include/xlocale.h", directory: "/root/.unikraft/apps/redis/build")
!332 = !{!333}
!333 = !DILocalVariable(name: "newloc", arg: 1, scope: !327, file: !1, line: 75, type: !4)
!334 = !DILocation(line: 75, column: 31, scope: !327)
!335 = !DILocation(line: 77, column: 24, scope: !327)
!336 = !DILocation(line: 59, column: 30, scope: !288, inlinedAt: !337)
!337 = distinct !DILocation(line: 77, column: 10, scope: !327)
!338 = !DILocation(line: 59, column: 52, scope: !288, inlinedAt: !337)
!339 = !DILocation(line: 218, column: 32, scope: !298, inlinedAt: !340)
!340 = distinct !DILocation(line: 63, column: 20, scope: !288, inlinedAt: !337)
!341 = !DILocation(line: 220, column: 13, scope: !298, inlinedAt: !340)
!342 = !DILocation(line: 220, column: 3, scope: !298, inlinedAt: !340)
!343 = !DILocation(line: 61, column: 22, scope: !288, inlinedAt: !337)
!344 = !DILocation(line: 64, column: 8, scope: !317, inlinedAt: !337)
!345 = !DILocation(line: 64, column: 7, scope: !288, inlinedAt: !337)
!346 = !DILocation(line: 66, column: 14, scope: !320, inlinedAt: !337)
!347 = !DILocation(line: 66, column: 7, scope: !288, inlinedAt: !337)
!348 = !DILocation(line: 68, column: 12, scope: !323, inlinedAt: !337)
!349 = !DILocation(line: 68, column: 12, scope: !320, inlinedAt: !337)
!350 = !DILocation(line: 0, scope: !327)
!351 = !DILocation(line: 70, column: 3, scope: !288, inlinedAt: !337)
!352 = !DILocation(line: 77, column: 3, scope: !327)
