; ModuleID = '/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/stdio/vdiprintf.c'
source_filename = "/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/stdio/vdiprintf.c"
...
define dso_local i32 @_vdiprintf_r(%struct._reent*, i32, i8*, %struct.__va_list_tag*) local_unnamed_addr #0 !dbg !7 {
  %5 = alloca [512 x i8], align 16
  %6 = alloca i64, align 8
  %7 = getelementptr inbounds [512 x i8], [512 x i8]* %5, i64 0, i64 0, !dbg !251
  call void @llvm.lifetime.start.p0i8(i64 512, i8* nonnull %7) #4, !dbg !251
  %8 = bitcast i64* %6 to i8*, !dbg !253
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %8) #4, !dbg !253
  store i64 512, i64* %6, align 8, !dbg !254, !tbaa !255
  %9 = call i8* @_vasniprintf_r(%struct._reent* %0, i8* nonnull %7, i64* nonnull %6, i8* %2, %struct.__va_list_tag* %3) #5, !dbg !259
  %10 = icmp eq i8* %9, null, !dbg !261
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !263
  br i1 %10, label %20, label %11, !dbg !263

; <label>:11:                                     ; preds = %4
  %12 = load i64, i64* %6, align 8, !dbg !264, !tbaa !255
  %13 = call i64 @_write_r(%struct._reent* %0, i32 %1, i8* nonnull %9, i64 %12) #5, !dbg !265
  store i64 %13, i64* %6, align 8, !dbg !266, !tbaa !255
  %14 = icmp eq i8* %9, %7, !dbg !267
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !269
  br i1 %14, label %17, label %15, !dbg !269

; <label>:15:                                     ; preds = %11
  call void @free(i8* nonnull %9) #5, !dbg !270
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !270
  %16 = load i64, i64* %6, align 8, !dbg !271, !tbaa !255
  br label %17, !dbg !270

; <label>:17:                                     ; preds = %11, %15
  %18 = phi i64 [ %13, %11 ], [ %16, %15 ], !dbg !271
  %19 = trunc i64 %18 to i32, !dbg !271
  br label %20, !dbg !272

; <label>:20:                                     ; preds = %4, %17
  %21 = phi i32 [ %19, %17 ], [ -1, %4 ], !dbg !273
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !273
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %8) #4, !dbg !274
  call void @llvm.lifetime.end.p0i8(i64 512, i8* nonnull %7) #4, !dbg !274
...
declare dso_local i8* @_vasniprintf_r(%struct._reent*, i8*, i64*, i8*, %struct.__va_list_tag*) local_unnamed_addr #3
...
; Function Attrs: noredzone nounwind
define dso_local i32 @vdiprintf(i32, i8*, %struct.__va_list_tag*) local_unnamed_addr #0 !dbg !275 {
  %4 = alloca [512 x i8], align 16
  %5 = alloca i64, align 8
  %6 = tail call %struct._reent* @__getreent() #5, !dbg !285
  %7 = getelementptr inbounds [512 x i8], [512 x i8]* %4, i64 0, i64 0, !dbg !287
  call void @llvm.lifetime.start.p0i8(i64 512, i8* nonnull %7) #4, !dbg !287
  %8 = bitcast i64* %5 to i8*, !dbg !288
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %8) #4, !dbg !288
  store i64 512, i64* %5, align 8, !dbg !289, !tbaa !255
  %9 = call i8* @_vasniprintf_r(%struct._reent* %6, i8* nonnull %7, i64* nonnull %5, i8* %1, %struct.__va_list_tag* %2) #5, !dbg !290
  %10 = icmp eq i8* %9, null, !dbg !292
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !293
  br i1 %10, label %20, label %11, !dbg !293

; <label>:11:                                     ; preds = %3
  %12 = load i64, i64* %5, align 8, !dbg !294, !tbaa !255
  %13 = call i64 @_write_r(%struct._reent* %6, i32 %0, i8* nonnull %9, i64 %12) #5, !dbg !295
  store i64 %13, i64* %5, align 8, !dbg !296, !tbaa !255
  %14 = icmp eq i8* %9, %7, !dbg !297
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !298
  br i1 %14, label %17, label %15, !dbg !298

; <label>:15:                                     ; preds = %11
  call void @free(i8* nonnull %9) #5, !dbg !299
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !299
  %16 = load i64, i64* %5, align 8, !dbg !300, !tbaa !255
  br label %17, !dbg !299

; <label>:17:                                     ; preds = %15, %11
  %18 = phi i64 [ %13, %11 ], [ %16, %15 ], !dbg !300
  %19 = trunc i64 %18 to i32, !dbg !300
  br label %20, !dbg !301

; <label>:20:                                     ; preds = %3, %17
  %21 = phi i32 [ %19, %17 ], [ -1, %3 ], !dbg !302
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !303
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %8) #4, !dbg !304
  call void @llvm.lifetime.end.p0i8(i64 512, i8* nonnull %7) #4, !dbg !304
...
!1 = !DIFile(filename: "/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/stdio/vdiprintf.c", directory: "/root/.unikraft/apps/redis/build")
!2 = !{}
!3 = !{i32 2, !"Dwarf Version", i32 4}
!4 = !{i32 2, !"Debug Info Version", i32 3}
!5 = !{i32 1, !"wchar_size", i32 4}
!6 = !{!"clang version 7.0.1-8+deb10u2 (tags/RELEASE_701/final)"}
!7 = distinct !DISubprogram(name: "_vdiprintf_r", scope: !1, file: !1, line: 16, type: !8, isLocal: false, isDefinition: true, scopeLine: 21, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !237)
...
!231 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "__va_list_tag", file: !1, size: 192, elements: !232)
!232 = !{!233, !234, !235, !236}
!233 = !DIDerivedType(tag: DW_TAG_member, name: "gp_offset", scope: !231, file: !1, baseType: !92, size: 32)
!234 = !DIDerivedType(tag: DW_TAG_member, name: "fp_offset", scope: !231, file: !1, baseType: !92, size: 32, offset: 32)
!235 = !DIDerivedType(tag: DW_TAG_member, name: "overflow_arg_area", scope: !231, file: !1, baseType: !36, size: 64, offset: 64)
!236 = !DIDerivedType(tag: DW_TAG_member, name: "reg_save_area", scope: !231, file: !1, baseType: !36, size: 64, offset: 128)
!237 = !{!238, !239, !240, !241, !242, !243, !247}
!238 = !DILocalVariable(name: "ptr", arg: 1, scope: !7, file: !1, line: 16, type: !11)
!239 = !DILocalVariable(name: "fd", arg: 2, scope: !7, file: !1, line: 16, type: !10)
!240 = !DILocalVariable(name: "format", arg: 3, scope: !7, file: !1, line: 16, type: !50)
!241 = !DILocalVariable(name: "ap", arg: 4, scope: !7, file: !1, line: 16, type: !230)
!242 = !DILocalVariable(name: "p", scope: !7, file: !1, line: 22, type: !44)
!243 = !DILocalVariable(name: "buf", scope: !7, file: !1, line: 23, type: !244)
!244 = !DICompositeType(tag: DW_TAG_array_type, baseType: !45, size: 4096, elements: !245)
!245 = !{!246}
!246 = !DISubrange(count: 512)
!247 = !DILocalVariable(name: "n", scope: !7, file: !1, line: 24, type: !248)
!248 = !DIDerivedType(tag: DW_TAG_typedef, name: "size_t", file: !91, line: 58, baseType: !249)
!249 = !DIBasicType(name: "long unsigned int", size: 64, encoding: DW_ATE_unsigned)
!250 = !DILocation(line: 16, column: 1, scope: !7)
!251 = !DILocation(line: 23, column: 3, scope: !7)
!252 = !DILocation(line: 23, column: 8, scope: !7)
!253 = !DILocation(line: 24, column: 3, scope: !7)
!254 = !DILocation(line: 24, column: 10, scope: !7)
!255 = !{!256, !256, i64 0}
!256 = !{!"long", !257, i64 0}
!257 = !{!"omnipotent char", !258, i64 0}
!258 = !{!"Simple C/C++ TBAA"}
!259 = !DILocation(line: 27, column: 7, scope: !7)
!260 = !DILocation(line: 22, column: 9, scope: !7)
!261 = !DILocation(line: 28, column: 8, scope: !262)
!262 = distinct !DILexicalBlock(scope: !7, file: !1, line: 28, column: 7)
!263 = !DILocation(line: 28, column: 7, scope: !7)
!264 = !DILocation(line: 30, column: 29, scope: !7)
!265 = !DILocation(line: 30, column: 7, scope: !7)
!266 = !DILocation(line: 30, column: 5, scope: !7)
!267 = !DILocation(line: 31, column: 9, scope: !268)
!268 = distinct !DILexicalBlock(scope: !7, file: !1, line: 31, column: 7)
!269 = !DILocation(line: 31, column: 7, scope: !7)
!270 = !DILocation(line: 32, column: 5, scope: !268)
!271 = !DILocation(line: 33, column: 10, scope: !7)
!272 = !DILocation(line: 33, column: 3, scope: !7)
!273 = !DILocation(line: 0, scope: !262)
!274 = !DILocation(line: 34, column: 1, scope: !7)
!275 = distinct !DISubprogram(name: "vdiprintf", scope: !1, file: !1, line: 39, type: !276, isLocal: false, isDefinition: true, scopeLine: 43, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !278)
!276 = !DISubroutineType(types: !277)
!277 = !{!10, !10, !50, !230}
!278 = !{!279, !280, !281}
!279 = !DILocalVariable(name: "fd", arg: 1, scope: !275, file: !1, line: 39, type: !10)
!280 = !DILocalVariable(name: "format", arg: 2, scope: !275, file: !1, line: 39, type: !50)
!281 = !DILocalVariable(name: "ap", arg: 3, scope: !275, file: !1, line: 39, type: !230)
!282 = !DILocation(line: 23, column: 8, scope: !7, inlinedAt: !283)
!283 = distinct !DILocation(line: 44, column: 10, scope: !275)
!284 = !DILocation(line: 39, column: 1, scope: !275)
!285 = !DILocation(line: 44, column: 24, scope: !275)
!286 = !DILocation(line: 16, column: 1, scope: !7, inlinedAt: !283)
!287 = !DILocation(line: 23, column: 3, scope: !7, inlinedAt: !283)
!288 = !DILocation(line: 24, column: 3, scope: !7, inlinedAt: !283)
!289 = !DILocation(line: 24, column: 10, scope: !7, inlinedAt: !283)
!290 = !DILocation(line: 27, column: 7, scope: !7, inlinedAt: !283)
!291 = !DILocation(line: 22, column: 9, scope: !7, inlinedAt: !283)
!292 = !DILocation(line: 28, column: 8, scope: !262, inlinedAt: !283)
!293 = !DILocation(line: 28, column: 7, scope: !7, inlinedAt: !283)
!294 = !DILocation(line: 30, column: 29, scope: !7, inlinedAt: !283)
!295 = !DILocation(line: 30, column: 7, scope: !7, inlinedAt: !283)
!296 = !DILocation(line: 30, column: 5, scope: !7, inlinedAt: !283)
!297 = !DILocation(line: 31, column: 9, scope: !268, inlinedAt: !283)
!298 = !DILocation(line: 31, column: 7, scope: !7, inlinedAt: !283)
!299 = !DILocation(line: 32, column: 5, scope: !268, inlinedAt: !283)
!300 = !DILocation(line: 33, column: 10, scope: !7, inlinedAt: !283)
!301 = !DILocation(line: 33, column: 3, scope: !7, inlinedAt: !283)
!302 = !DILocation(line: 0, scope: !262, inlinedAt: !283)
!303 = !DILocation(line: 0, scope: !275)
!304 = !DILocation(line: 34, column: 1, scope: !7, inlinedAt: !283)
!305 = !DILocation(line: 44, column: 3, scope: !275)
