...
; <label>:11:                                     ; preds = %6, %3, %10
  ...
  %14 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %1, i64 0, i32 23, !dbg !273
  %15 = load i32, i32* %14, align 4, !dbg !273, !tbaa !275
  %16 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %1, i64 0, i32 3, !dbg !281
  %17 = load i16, i16* %16, align 8, !dbg !281, !tbaa !283
  %18 = and i16 %17, 8192, !dbg !284
  %19 = icmp eq i16 %18, 0, !dbg !284
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !285
  br i1 %19, label %24, label %20, !dbg !285

; <label>:20:                                     ; preds = %11
  %21 = and i32 %15, 8192, !dbg !286
  %22 = icmp eq i32 %21, 0, !dbg !287
  %23 = select i1 %22, i32 -1, i32 1, !dbg !287
  br label %24

; <label>:24:                                     ; preds = %11, %20
  %25 = phi i32 [ %23, %20 ], [ 0, %11 ], !dbg !289
...
; <label>:11:                                     ; preds = %10, %6, %2
  ...
  %14 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %0, i64 0, i32 23, !dbg !307
  %15 = load i32, i32* %14, align 4, !dbg !307, !tbaa !275
  %16 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %0, i64 0, i32 3, !dbg !308
  %17 = load i16, i16* %16, align 8, !dbg !308, !tbaa !283
  %18 = and i16 %17, 8192, !dbg !309
  %19 = icmp eq i16 %18, 0, !dbg !309
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !310
  br i1 %19, label %24, label %20, !dbg !310

; <label>:20:                                     ; preds = %11
  %21 = and i32 %15, 8192, !dbg !311
  %22 = icmp eq i32 %21, 0, !dbg !312
  %23 = select i1 %22, i32 -1, i32 1, !dbg !312
  br label %24

; <label>:24:                                     ; preds = %11, %20
  %25 = phi i32 [ %23, %20 ], [ 0, %11 ], !dbg !314
  store volatile i32 42, i32* @__A_VARIABLE, align 4
...
!273 = !DILocation(line: 71, column: 3, scope: !274)
!274 = distinct !DILexicalBlock(scope: !258, file: !1, line: 71, column: 3)
!275 = !{!276, !265, i64 172}
...
!281 = !DILocation(line: 75, column: 13, scope: !282)
!282 = distinct !DILexicalBlock(scope: !258, file: !1, line: 75, column: 7)
!283 = !{!276, !277, i64 16}
!284 = !DILocation(line: 75, column: 20, scope: !282)
!285 = !DILocation(line: 75, column: 7, scope: !258)
!286 = !DILocation(line: 78, column: 24, scope: !282)
!287 = !DILocation(line: 78, column: 11, scope: !282)
...
!307 = !DILocation(line: 71, column: 3, scope: !274, inlinedAt: !303)
!308 = !DILocation(line: 75, column: 13, scope: !282, inlinedAt: !303)
!309 = !DILocation(line: 75, column: 20, scope: !282, inlinedAt: !303)
!310 = !DILocation(line: 75, column: 7, scope: !258, inlinedAt: !303)
!311 = !DILocation(line: 78, column: 24, scope: !282, inlinedAt: !303)
!312 = !DILocation(line: 78, column: 11, scope: !282, inlinedAt: !303)
!313 = !DILocation(line: 67, column: 7, scope: !25, inlinedAt: !303)
!314 = !DILocation(line: 0, scope: !282, inlinedAt: !303)
