; ModuleID = '/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/stdio/printf.c'
source_filename = "/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/stdio/printf.c"
...
define dso_local i32 @_printf_r(%struct._reent*, i8* noalias, ...) local_unnamed_addr #0 !dbg !7 {
  %3 = alloca [1 x %struct.__va_list_tag], align 16
  %4 = bitcast [1 x %struct.__va_list_tag]* %3 to i8*, !dbg !249
  call void @llvm.lifetime.start.p0i8(i64 24, i8* nonnull %4) #3, !dbg !249
  %5 = getelementptr inbounds [1 x %struct.__va_list_tag], [1 x %struct.__va_list_tag]* %3, i64 0, i64 0, !dbg !251
  call void @llvm.va_start(i8* nonnull %4), !dbg !251
  %6 = getelementptr inbounds %struct._reent, %struct._reent* %0, i64 0, i32 2, !dbg !252
  %7 = load %struct.__sFILE*, %struct.__sFILE** %6, align 8, !dbg !252, !tbaa !253
  %8 = call i32 @_vfprintf_r(%struct._reent* %0, %struct.__sFILE* %7, i8* %1, %struct.__va_list_tag* nonnull %5) #5, !dbg !262
  call void @llvm.va_end(i8* nonnull %4), !dbg !264
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %4) #3, !dbg !265
...
declare dso_local i32 @_vfprintf_r(%struct._reent*, %struct.__sFILE*, i8*, %struct.__va_list_tag*) local_unnamed_addr #4
...
; Function Attrs: noredzone nounwind
define dso_local i32 @printf(i8* noalias, ...) local_unnamed_addr #0 !dbg !267 {
  %2 = alloca [1 x %struct.__va_list_tag], align 16
  %3 = bitcast [1 x %struct.__va_list_tag]* %2 to i8*, !dbg !276
  call void @llvm.lifetime.start.p0i8(i64 24, i8* nonnull %3) #3, !dbg !276
  %4 = tail call %struct._reent* @__getreent() #5, !dbg !278
  %5 = getelementptr inbounds [1 x %struct.__va_list_tag], [1 x %struct.__va_list_tag]* %2, i64 0, i64 0, !dbg !280
  call void @llvm.va_start(i8* nonnull %3), !dbg !280
  %6 = getelementptr inbounds %struct._reent, %struct._reent* %4, i64 0, i32 2, !dbg !281
  %7 = load %struct.__sFILE*, %struct.__sFILE** %6, align 8, !dbg !281, !tbaa !253
  %8 = call i32 @_vfprintf_r(%struct._reent* %4, %struct.__sFILE* %7, i8* %0, %struct.__va_list_tag* nonnull %5) #5, !dbg !282
  call void @llvm.va_end(i8* nonnull %3), !dbg !284
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %3) #3, !dbg !285
...
!1 = !DIFile(filename: "/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/stdio/printf.c", directory: "/root/.unikraft/apps/redis/build")
!2 = !{}
!3 = !{i32 2, !"Dwarf Version", i32 4}
!4 = !{i32 2, !"Debug Info Version", i32 3}
!5 = !{i32 1, !"wchar_size", i32 4}
!6 = !{!"clang version 7.0.1-8+deb10u2 (tags/RELEASE_701/final)"}
!7 = distinct !DISubprogram(name: "_printf_r", scope: !1, file: !1, line: 26, type: !8, isLocal: false, isDefinition: true, scopeLine: 29, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !231)
...
!231 = !{!232, !233, !234, !235}
!232 = !DILocalVariable(name: "ptr", arg: 1, scope: !7, file: !1, line: 26, type: !11)
!233 = !DILocalVariable(name: "fmt", arg: 2, scope: !7, file: !1, line: 26, type: !230)
!234 = !DILocalVariable(name: "ret", scope: !7, file: !1, line: 30, type: !10)
!235 = !DILocalVariable(name: "ap", scope: !7, file: !1, line: 31, type: !236)
!236 = !DIDerivedType(tag: DW_TAG_typedef, name: "va_list", file: !237, line: 46, baseType: !238)
...
!238 = !DIDerivedType(tag: DW_TAG_typedef, name: "__gnuc_va_list", file: !239, line: 51, baseType: !240)
!239 = !DIFile(filename: "/root/.unikraft/libs/newlib/include/stdarg.h", directory: "/root/.unikraft/apps/redis/build")
!240 = !DIDerivedType(tag: DW_TAG_typedef, name: "__builtin_va_list", file: !1, line: 31, baseType: !241)
!241 = !DICompositeType(tag: DW_TAG_array_type, baseType: !242, size: 192, elements: !70)
!242 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "__va_list_tag", file: !1, line: 31, size: 192, elements: !243)
!243 = !{!244, !245, !246, !247}
!244 = !DIDerivedType(tag: DW_TAG_member, name: "gp_offset", scope: !242, file: !1, line: 31, baseType: !92, size: 32)
!245 = !DIDerivedType(tag: DW_TAG_member, name: "fp_offset", scope: !242, file: !1, line: 31, baseType: !92, size: 32, offset: 32)
!246 = !DIDerivedType(tag: DW_TAG_member, name: "overflow_arg_area", scope: !242, file: !1, line: 31, baseType: !36, size: 64, offset: 64)
!247 = !DIDerivedType(tag: DW_TAG_member, name: "reg_save_area", scope: !242, file: !1, line: 31, baseType: !36, size: 64, offset: 128)
!248 = !DILocation(line: 26, column: 1, scope: !7)
!249 = !DILocation(line: 31, column: 3, scope: !7)
!250 = !DILocation(line: 31, column: 11, scope: !7)
!251 = !DILocation(line: 34, column: 3, scope: !7)
!252 = !DILocation(line: 35, column: 27, scope: !7)
!253 = !{!254, !258, i64 16}
...
!262 = !DILocation(line: 35, column: 9, scope: !7)
!263 = !DILocation(line: 30, column: 7, scope: !7)
!264 = !DILocation(line: 36, column: 3, scope: !7)
!265 = !DILocation(line: 38, column: 1, scope: !7)
!266 = !DILocation(line: 37, column: 3, scope: !7)
!267 = distinct !DISubprogram(name: "printf", scope: !1, file: !1, line: 49, type: !268, isLocal: false, isDefinition: true, scopeLine: 51, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !270)
!268 = !DISubroutineType(types: !269)
!269 = !{!10, !230, null}
!270 = !{!271, !272, !273, !274}
!271 = !DILocalVariable(name: "fmt", arg: 1, scope: !267, file: !1, line: 49, type: !230)
!272 = !DILocalVariable(name: "ret", scope: !267, file: !1, line: 52, type: !10)
!273 = !DILocalVariable(name: "ap", scope: !267, file: !1, line: 53, type: !236)
!274 = !DILocalVariable(name: "ptr", scope: !267, file: !1, line: 54, type: !11)
!275 = !DILocation(line: 49, column: 1, scope: !267)
!276 = !DILocation(line: 53, column: 3, scope: !267)
!277 = !DILocation(line: 53, column: 11, scope: !267)
!278 = !DILocation(line: 54, column: 24, scope: !267)
!279 = !DILocation(line: 54, column: 18, scope: !267)
!280 = !DILocation(line: 57, column: 3, scope: !267)
!281 = !DILocation(line: 58, column: 27, scope: !267)
!282 = !DILocation(line: 58, column: 9, scope: !267)
!283 = !DILocation(line: 52, column: 7, scope: !267)
!284 = !DILocation(line: 59, column: 3, scope: !267)
!285 = !DILocation(line: 61, column: 1, scope: !267)
!286 = !DILocation(line: 60, column: 3, scope: !267)
