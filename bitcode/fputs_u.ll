...
; <label>:50:                                     ; preds = %44, %48
  ...
  %52 = icmp eq i32 %51, -1, !dbg !306
  br i1 %52, label %53, label %26, !dbg !307, !llvm.loop !308

; <label>:53:                                     ; preds = %50, %26, %19
  %54 = phi i32 [ -1, %19 ], [ -1, %50 ], [ 0, %26 ], !dbg !310
...
; Function Attrs: noredzone nounwind
define dso_local i32 @fputs_unlocked(i8* noalias nocapture readonly, %struct.__sFILE* noalias) local_unnamed_addr #0 !dbg !312 {
  %3 = tail call %struct._reent* @__getreent() #3, !dbg !319
  %4 = tail call i32 @_fputs_unlocked_r(%struct._reent* %3, i8* %0, %struct.__sFILE* %1) #5, !dbg !320
...
!305 = !DILocation(line: 696, column: 1, scope: !277, inlinedAt: !284)
!306 = !DILocation(line: 148, column: 37, scope: !270)
!307 = !DILocation(line: 148, column: 11, scope: !271)
!308 = distinct !{!308, !268, !309}
!309 = !DILocation(line: 150, column: 5, scope: !10)
!310 = !DILocation(line: 0, scope: !10)
!311 = !DILocation(line: 158, column: 1, scope: !10)
!312 = distinct !DISubprogram(name: "fputs_unlocked", scope: !11, file: !11, line: 162, type: !313, isLocal: false, isDefinition: true, scopeLine: 165, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !315)
!313 = !DISubroutineType(types: !314)
!314 = !{!14, !232, !233}
!315 = !{!316, !317}
!316 = !DILocalVariable(name: "s", arg: 1, scope: !312, file: !11, line: 162, type: !232)
!317 = !DILocalVariable(name: "fp", arg: 2, scope: !312, file: !11, line: 162, type: !233)
!318 = !DILocation(line: 162, column: 1, scope: !312)
!319 = !DILocation(line: 166, column: 20, scope: !312)
!320 = !DILocation(line: 166, column: 10, scope: !312)
!321 = !DILocation(line: 166, column: 3, scope: !312)
