...
define dso_local %struct.hostent* @gethostbyname(i8*) local_unnamed_addr #0 !dbg !7 {
  %2 = tail call %struct.hostent* @lwip_gethostbyname(i8* %0) #3, !dbg !28
...
define dso_local i32 @gethostbyname_r(i8*, %struct.hostent*, i8*, i64, %struct.hostent**, i32*) local_unnamed_addr #0 !dbg !30 {
  %7 = tail call i32 @lwip_gethostbyname_r(i8* %0, %struct.hostent* %1, i8* %2, i64 %3, %struct.hostent** %4, i32* %5) #3, !dbg !53
...
; Function Attrs: noredzone nounwind
define dso_local noalias %struct.hostent* @gethostbyaddr(i8* nocapture readnone, i32, i32) local_unnamed_addr #0 !dbg !55 {
