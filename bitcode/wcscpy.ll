...
define dso_local i32* @wcscpy(i32* noalias returned, i32* noalias nocapture readonly) local_unnamed_addr #0 !dbg !7 {
  ...
  %3 = load i32, i32* %1, align 4, !dbg !31, !tbaa !25
  %4 = icmp eq i32 %3, 0, !dbg !32
  br i1 %4, label %13, label %5, !dbg !32
...
; <label>:5:                                      ; preds = %2, %5
  ...
  %11 = load i32, i32* %9, align 4, !dbg !31, !tbaa !25
  %12 = icmp eq i32 %11, 0, !dbg !32
  br i1 %12, label %13, label %5, !dbg !32, !llvm.loop !36
...
!31 = !DILocation(line: 75, column: 10, scope: !7)
!32 = !DILocation(line: 75, column: 3, scope: !7)
