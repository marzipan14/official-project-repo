...
; <label>:10:                                     ; preds = %4, %9
  %11 = phi %struct.__locale_t* [ @__global_locale, %9 ], [ %7, %4 ], !dbg !439
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !449
  %12 = tail call i64 @_wcstoull_l(%struct._reent* %0, i32* %1, i32** %2, i32 %3, %struct.__locale_t* nonnull %11) #4, !dbg !450
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !451
  ret i64 %12, !dbg !451
}

; Function Attrs: noredzone nounwind
define dso_local i64 @wcstoull_l(i32* noalias, i32** noalias, i32, %struct.__locale_t*) local_unnamed_addr #0 !dbg !452 {
  %5 = tail call %struct._reent* @__getreent() #3, !dbg !466
  %6 = tail call i64 @_wcstoull_l(%struct._reent* %5, i32* %0, i32** %1, i32 %2, %struct.__locale_t* %3) #4, !dbg !467
...
; Function Attrs: noredzone nounwind
define dso_local i64 @wcstoull(i32* noalias, i32** noalias, i32) local_unnamed_addr #0 !dbg !469 {
  %4 = tail call %struct._reent* @__getreent() #3, !dbg !477
  %5 = tail call %struct._reent* @__getreent() #3, !dbg !478
  %6 = getelementptr inbounds %struct._reent, %struct._reent* %5, i64 0, i32 7, !dbg !480
  %7 = load %struct.__locale_t*, %struct.__locale_t** %6, align 8, !dbg !480, !tbaa !445
  %8 = icmp eq %struct.__locale_t* %7, null, !dbg !478
  br i1 %8, label %9, label %10, !dbg !478
...
; <label>:10:                                     ; preds = %3, %9
  %11 = phi %struct.__locale_t* [ @__global_locale, %9 ], [ %7, %3 ], !dbg !478
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !483
  %12 = tail call i64 @_wcstoull_l(%struct._reent* %4, i32* %0, i32** %1, i32 %2, %struct.__locale_t* nonnull %11) #4, !dbg !484
...
!445 = !{!323, !327, i64 72}
!446 = !DILocation(line: 213, column: 3, scope: !447, inlinedAt: !448)
!447 = distinct !DISubprogram(name: "__get_global_locale", scope: !113, file: !113, line: 210, type: !441, isLocal: true, isDefinition: true, scopeLine: 211, isOptimized: true, unit: !0, retainedNodes: !2)
!448 = distinct !DILocation(line: 230, column: 29, scope: !440, inlinedAt: !443)
!449 = !DILocation(line: 230, column: 3, scope: !440, inlinedAt: !443)
!450 = !DILocation(line: 230, column: 9, scope: !430)
!451 = !DILocation(line: 230, column: 2, scope: !430)
!452 = distinct !DISubprogram(name: "wcstoull_l", scope: !1, file: !1, line: 236, type: !453, isLocal: false, isDefinition: true, scopeLine: 238, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !457)
!453 = !DISubroutineType(types: !454)
!454 = !{!4, !455, !456, !8, !294}
!455 = !DIDerivedType(tag: DW_TAG_restrict_type, baseType: !291)
!456 = !DIDerivedType(tag: DW_TAG_restrict_type, baseType: !293)
!457 = !{!458, !459, !460, !461}
!458 = !DILocalVariable(name: "s", arg: 1, scope: !452, file: !1, line: 236, type: !455)
!459 = !DILocalVariable(name: "ptr", arg: 2, scope: !452, file: !1, line: 236, type: !456)
!460 = !DILocalVariable(name: "base", arg: 3, scope: !452, file: !1, line: 236, type: !8)
!461 = !DILocalVariable(name: "loc", arg: 4, scope: !452, file: !1, line: 237, type: !294)
!462 = !DILocation(line: 236, column: 39, scope: !452)
!463 = !DILocation(line: 236, column: 63, scope: !452)
!464 = !DILocation(line: 236, column: 72, scope: !452)
!465 = !DILocation(line: 237, column: 15, scope: !452)
!466 = !DILocation(line: 239, column: 22, scope: !452)
!467 = !DILocation(line: 239, column: 9, scope: !452)
!468 = !DILocation(line: 239, column: 2, scope: !452)
!469 = distinct !DISubprogram(name: "wcstoull", scope: !1, file: !1, line: 243, type: !470, isLocal: false, isDefinition: true, scopeLine: 247, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !472)
!470 = !DISubroutineType(types: !471)
!471 = !{!4, !455, !456, !8}
!472 = !{!473, !474, !475}
!473 = !DILocalVariable(name: "s", arg: 1, scope: !469, file: !1, line: 243, type: !455)
!474 = !DILocalVariable(name: "ptr", arg: 2, scope: !469, file: !1, line: 243, type: !456)
!475 = !DILocalVariable(name: "base", arg: 3, scope: !469, file: !1, line: 243, type: !8)
!476 = !DILocation(line: 243, column: 1, scope: !469)
!477 = !DILocation(line: 248, column: 22, scope: !469)
!478 = !DILocation(line: 230, column: 10, scope: !440, inlinedAt: !479)
!479 = distinct !DILocation(line: 248, column: 44, scope: !469)
!480 = !DILocation(line: 230, column: 18, scope: !440, inlinedAt: !479)
!481 = !DILocation(line: 213, column: 3, scope: !447, inlinedAt: !482)
!482 = distinct !DILocation(line: 230, column: 29, scope: !440, inlinedAt: !479)
!483 = !DILocation(line: 230, column: 3, scope: !440, inlinedAt: !479)
!484 = !DILocation(line: 248, column: 9, scope: !469)
!485 = !DILocation(line: 248, column: 2, scope: !469)
