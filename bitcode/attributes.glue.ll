...
; Function Attrs: noredzone nounwind
define dso_local i32 @pthread_attr_getguardsize(%struct.pthread_attr_t_** nocapture readnone, i64*) local_unnamed_addr #0 !dbg !567 {
...
; Function Attrs: noredzone nounwind
define dso_local i32 @pthread_attr_setstack(%struct.pthread_attr_t_**, i8*, i64) local_unnamed_addr #0 !dbg !589 {
  %4 = tail call i32 @pthread_attr_setstacksize(%struct.pthread_attr_t_** %0, i64 %2) #4, !dbg !600
  %5 = icmp eq i32 %4, 0, !dbg !602
  br i1 %5, label %6, label %8, !dbg !604

; <label>:6:                                      ; preds = %3
  %7 = tail call i32 @pthread_attr_setstackaddr(%struct.pthread_attr_t_** %0, i8* %1) #4, !dbg !605
  br label %8, !dbg !606
...
; Function Attrs: noredzone nounwind
define dso_local i32 @pthread_attr_getstack(%struct.pthread_attr_t_**, i8**, i64*) local_unnamed_addr #0 !dbg !609 {
  %4 = tail call i32 @pthread_attr_getstacksize(%struct.pthread_attr_t_** %0, i64* %2) #4, !dbg !620
  %5 = icmp eq i32 %4, 0, !dbg !622
  br i1 %5, label %6, label %8, !dbg !624

; <label>:6:                                      ; preds = %3
  %7 = tail call i32 @pthread_attr_getstackaddr(%struct.pthread_attr_t_** %0, i8** %1) #4, !dbg !625
  br label %8, !dbg !626
...
; Function Attrs: noredzone nounwind
define dso_local i32 @pthread_getattr_np(i8* readonly, i32, %struct.pthread_attr_t_** readonly) local_unnamed_addr #0 !dbg !629 {
  %4 = alloca i32, align 4
  %5 = bitcast i32* %4 to i8*, !dbg !642
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %5) #5, !dbg !642
...
; <label>:16:                                     ; preds = %13
  ...
  %27 = call i32 @uk_thread_get_prio(%struct.uk_thread* nonnull %9, i32* nonnull %4) #4, !dbg !686
...
; <label>:32:                                     ; preds = %16, %29, %11, %13, %3, %7
  ...
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %5) #5, !dbg !698
...
; Function Attrs: noredzone nounwind
define dso_local i32 @pthread_setname_np(i8* readonly, i32, i8*) local_unnamed_addr #0 !dbg !699 {
...
; <label>:9:                                      ; preds = %5
  %10 = tail call i64 @strnlen(i8* %2, i64 16) #4, !dbg !718
...
; Function Attrs: noredzone nounwind
define dso_local i32 @pthread_getname_np(i8* readonly, i32, i8*, i64) local_unnamed_addr #0 !dbg !729 {
...
; <label>:10:                                     ; preds = %6
  ...
  %13 = tail call i64 @strlen(i8* %12) #4, !dbg !751
...
; <label>:16:                                     ; preds = %10
  ...
  %18 = tail call i32 (i8*, i8*, ...) @sprintf(i8* %2, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i8* %17) #4, !dbg !758
  br label %19, !dbg !759
