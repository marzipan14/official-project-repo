...
define dso_local i64 @_mbstowcs_r(%struct._reent*, i32* noalias, i8* noalias, i64, %struct._mbstate_t*) local_unnamed_addr #0 !dbg !15 {
  ...
  br i1 %8, label %42, label %9, !dbg !309

; <label>:9:                                      ; preds = %5, %31
  %10 = phi i8* [ %33, %31 ], [ %2, %5 ]
  %11 = phi i64 [ %34, %31 ], [ 0, %5 ]
  %12 = phi i32* [ %40, %31 ], [ %1, %5 ]
  %13 = phi i64 [ %39, %31 ], [ %7, %5 ]
  ...
  br i1 %17, label %18, label %19, !dbg !310
...
; <label>:19:                                     ; preds = %9, %18
  %20 = phi %struct.__locale_t* [ @__global_locale, %18 ], [ %16, %9 ], !dbg !310
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !329
  %21 = getelementptr inbounds %struct.__locale_t, %struct.__locale_t* %20, i64 0, i32 2, !dbg !330
  %22 = load i32 (%struct._reent*, i32*, i8*, i64, %struct._mbstate_t*)*, i32 (%struct._reent*, i32*, i8*, i64, %struct._mbstate_t*)** %21, align 8, !dbg !330, !tbaa !331
  %23 = tail call i32 @__locale_mb_cur_max() #3, !dbg !334
  %24 = sext i32 %23 to i64, !dbg !334
  %25 = tail call i32 %22(%struct._reent* %0, i32* %12, i8* %10, i64 %24, %struct._mbstate_t* %4) #3, !dbg !330
  %26 = icmp slt i32 %25, 0, !dbg !336
  br i1 %26, label %27, label %29, !dbg !338

; <label>:27:                                     ; preds = %19
  %28 = getelementptr inbounds %struct._mbstate_t, %struct._mbstate_t* %4, i64 0, i32 0, !dbg !339
  store i32 0, i32* %28, align 4, !dbg !341, !tbaa !342
  br label %42, !dbg !344

; <label>:29:                                     ; preds = %19
  %30 = icmp eq i32 %25, 0, !dbg !345
  br i1 %30, label %42, label %31, !dbg !347

; <label>:31:                                     ; preds = %29
  %32 = sext i32 %25 to i64, !dbg !348
  %33 = getelementptr inbounds i8, i8* %10, i64 %32, !dbg !348
  %34 = add i64 %11, 1, !dbg !349
  %35 = icmp eq i32* %12, null, !dbg !350
  %36 = getelementptr inbounds i32, i32* %12, i64 1, !dbg !352
  %37 = xor i1 %35, true
  %38 = sext i1 %37 to i64
  %39 = add i64 %13, %38
  %40 = select i1 %35, i32* null, i32* %36
  %41 = icmp eq i64 %39, 0, !dbg !308
  br i1 %41, label %42, label %9, !dbg !309

; <label>:42:                                     ; preds = %31, %29, %5, %27
  %43 = phi i64 [ -1, %27 ], [ 0, %5 ], [ %34, %31 ], [ %11, %29 ], !dbg !354
...
!327 = distinct !DISubprogram(name: "__get_global_locale", scope: !115, file: !115, line: 210, type: !312, isLocal: true, isDefinition: true, scopeLine: 211, isOptimized: true, unit: !0, retainedNodes: !2)
!328 = distinct !DILocation(line: 230, column: 29, scope: !311, inlinedAt: !314)
!329 = !DILocation(line: 230, column: 3, scope: !311, inlinedAt: !314)
!330 = !DILocation(line: 21, column: 15, scope: !315)
!331 = !{!332, !322, i64 232}
!332 = !{!"__locale_t", !320, i64 0, !322, i64 224, !322, i64 232, !319, i64 240, !322, i64 248, !333, i64 256, !320, i64 352, !320, i64 354, !320, i64 386}
!333 = !{!"lconv", !322, i64 0, !322, i64 8, !322, i64 16, !322, i64 24, !322, i64 32, !322, i64 40, !322, i64 48, !322, i64 56, !322, i64 64, !322, i64 72, !320, i64 80, !320, i64 81, !320, i64 82, !320, i64 83, !320, i64 84, !320, i64 85, !320, i64 86, !320, i64 87, !320, i64 88, !320, i64 89, !320, i64 90, !320, i64 91, !320, i64 92, !320, i64 93}
!334 = !DILocation(line: 21, column: 37, scope: !315)
!335 = !DILocation(line: 15, column: 7, scope: !15)
!336 = !DILocation(line: 22, column: 17, scope: !337)
!337 = distinct !DILexicalBlock(scope: !315, file: !1, line: 22, column: 11)
!338 = !DILocation(line: 22, column: 11, scope: !315)
!339 = !DILocation(line: 24, column: 11, scope: !340)
!340 = distinct !DILexicalBlock(scope: !337, file: !1, line: 23, column: 2)
!341 = !DILocation(line: 24, column: 19, scope: !340)
!342 = !{!343, !319, i64 0}
!343 = !{!"", !319, i64 0, !320, i64 4}
!344 = !DILocation(line: 25, column: 4, scope: !340)
!345 = !DILocation(line: 27, column: 22, scope: !346)
!346 = distinct !DILexicalBlock(scope: !337, file: !1, line: 27, column: 16)
!347 = !DILocation(line: 27, column: 16, scope: !337)
!348 = !DILocation(line: 29, column: 9, scope: !315)
!349 = !DILocation(line: 30, column: 7, scope: !315)
!350 = !DILocation(line: 31, column: 11, scope: !351)
!351 = distinct !DILexicalBlock(scope: !315, file: !1, line: 31, column: 11)
!352 = !DILocation(line: 33, column: 4, scope: !353)
!353 = distinct !DILexicalBlock(scope: !351, file: !1, line: 32, column: 2)
!354 = !DILocation(line: 0, scope: !15)
!355 = !DILocation(line: 38, column: 1, scope: !15)
