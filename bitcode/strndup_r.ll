...
define dso_local i8* @_strndup_r(%struct._reent* nocapture readnone, i8*, i64) local_unnamed_addr #0 !dbg !7 {
  %4 = icmp eq i64 %2, 0, !dbg !243
  br i1 %4, label %14, label %5, !dbg !244

; <label>:5:                                      ; preds = %3, %11
  %6 = phi i64 [ %8, %11 ], [ %2, %3 ]
  %7 = phi i8* [ %12, %11 ], [ %1, %3 ]
  %8 = add i64 %6, -1, !dbg !245
  %9 = load i8, i8* %7, align 1, !dbg !246, !tbaa !247
  %10 = icmp eq i8 %9, 0, !dbg !244
  br i1 %10, label %14, label %11, !dbg !250

; <label>:11:                                     ; preds = %5
  %12 = getelementptr inbounds i8, i8* %7, i64 1, !dbg !251
  %13 = icmp eq i64 %8, 0, !dbg !243
  br i1 %13, label %14, label %5, !dbg !244, !llvm.loop !252

; <label>:14:                                     ; preds = %11, %5, %3
  %15 = phi i8* [ %1, %3 ], [ %7, %5 ], [ %12, %11 ], !dbg !253
  %16 = ptrtoint i8* %15 to i64, !dbg !254
  %17 = ptrtoint i8* %1 to i64, !dbg !254
  %18 = sub i64 %16, %17, !dbg !254
  %19 = add i64 %18, 1, !dbg !256
  %20 = tail call i8* @malloc(i64 %19) #3, !dbg !256
  %21 = icmp eq i8* %20, null, !dbg !258
  br i1 %21, label %25, label %22, !dbg !260

; <label>:22:                                     ; preds = %14
  %23 = tail call i8* @memcpy(i8* nonnull %20, i8* %1, i64 %18) #3, !dbg !261
  %24 = getelementptr inbounds i8, i8* %20, i64 %18, !dbg !263
  store i8 0, i8* %24, align 1, !dbg !264, !tbaa !247
  br label %25, !dbg !265
...
!243 = !DILocation(line: 15, column: 14, scope: !7)
!244 = !DILocation(line: 15, column: 18, scope: !7)
!245 = !DILocation(line: 15, column: 11, scope: !7)
!246 = !DILocation(line: 15, column: 21, scope: !7)
!247 = !{!248, !248, i64 0}
!248 = !{!"omnipotent char", !249, i64 0}
!249 = !{!"Simple C/C++ TBAA"}
!250 = !DILocation(line: 15, column: 3, scope: !7)
!251 = !DILocation(line: 16, column: 8, scope: !7)
!252 = distinct !{!252, !250, !251}
