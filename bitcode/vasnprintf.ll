...
; <label>:21:                                     ; preds = %5
  ...
  %26 = call i32 @_svfprintf_r(%struct._reent* %0, %struct.__sFILE* nonnull %6, i8* %3, %struct.__va_list_tag* %4) #5, !dbg !305
...
; Function Attrs: noredzone nounwind
define dso_local i8* @vasnprintf(i8*, i64* nocapture, i8*, %struct.__va_list_tag*) local_unnamed_addr #0 !dbg !319 {
...
; <label>:21:                                     ; preds = %4
  ...
  %26 = call i32 @_svfprintf_r(%struct._reent* %6, %struct.__sFILE* nonnull %5, i8* %2, %struct.__va_list_tag* %3) #5, !dbg !357
...
!319 = distinct !DISubprogram(name: "vasnprintf", scope: !1, file: !1, line: 69, type: !320, isLocal: false, isDefinition: true, scopeLine: 74, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !322)
!320 = !DISubroutineType(types: !321)
!321 = !{!6, !6, !231, !51, !234}
!322 = !{!323, !324, !325, !326}
!323 = !DILocalVariable(name: "buf", arg: 1, scope: !319, file: !1, line: 69, type: !6)
!324 = !DILocalVariable(name: "lenp", arg: 2, scope: !319, file: !1, line: 69, type: !231)
!325 = !DILocalVariable(name: "fmt", arg: 3, scope: !319, file: !1, line: 69, type: !51)
!326 = !DILocalVariable(name: "ap", arg: 4, scope: !319, file: !1, line: 69, type: !234)
!327 = !DILocation(line: 69, column: 1, scope: !319)
!328 = !DILocation(line: 75, column: 25, scope: !319)
!329 = !DILocation(line: 17, column: 1, scope: !12, inlinedAt: !330)
!330 = distinct !DILocation(line: 75, column: 10, scope: !319)
...
!369 = !DILocation(line: 75, column: 3, scope: !319)
