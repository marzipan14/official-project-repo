; ModuleID = '/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/stdio/putwchar.c'
source_filename = "/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/stdio/putwchar.c"
...
define dso_local i32 @_putwchar_r(%struct._reent*, i32) local_unnamed_addr #0 !dbg !7 {
  ...
  %6 = tail call i32 @_fputwc_r(%struct._reent* %0, i32 %1, %struct.__sFILE* %5) #3, !dbg !245
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !246
  ret i32 %6, !dbg !246
}

; Function Attrs: noredzone
declare dso_local i32 @_fputwc_r(%struct._reent*, i32, %struct.__sFILE*) local_unnamed_addr #1

; Function Attrs: noredzone
declare dso_local %struct._reent* @__getreent() local_unnamed_addr #1

; Function Attrs: noredzone nounwind
define dso_local i32 @putwchar(i32) local_unnamed_addr #0 !dbg !247 {
  ...
  %5 = tail call i32 @fputwc(i32 %0, %struct.__sFILE* %4) #3, !dbg !254
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !255
  ret i32 %5, !dbg !255
}

; Function Attrs: noredzone
declare dso_local i32 @fputwc(i32, %struct.__sFILE*) local_unnamed_addr #1
...
!1 = !DIFile(filename: "/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/stdio/putwchar.c", directory: "/root/.unikraft/apps/redis/build")
!2 = !{}
!3 = !{i32 2, !"Dwarf Version", i32 4}
!4 = !{i32 2, !"Debug Info Version", i32 3}
!5 = !{i32 1, !"wchar_size", i32 4}
!6 = !{!"clang version 7.0.1-8+deb10u2 (tags/RELEASE_701/final)"}
!7 = distinct !DISubprogram(name: "_putwchar_r", scope: !1, file: !1, line: 109, type: !8, isLocal: false, isDefinition: true, scopeLine: 112, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !231)
...
!231 = !{!232, !233}
!232 = !DILocalVariable(name: "ptr", arg: 1, scope: !7, file: !1, line: 109, type: !13)
!233 = !DILocalVariable(name: "wc", arg: 2, scope: !7, file: !1, line: 109, type: !230)
!234 = !DILocation(line: 109, column: 1, scope: !7)
!235 = !DILocation(line: 113, column: 30, scope: !7)
!236 = !{!237, !241, i64 16}
...
!245 = !DILocation(line: 113, column: 10, scope: !7)
!246 = !DILocation(line: 113, column: 3, scope: !7)
!247 = distinct !DISubprogram(name: "putwchar", scope: !1, file: !1, line: 120, type: !248, isLocal: false, isDefinition: true, scopeLine: 122, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !250)
!248 = !DISubroutineType(types: !249)
!249 = !{!10, !230}
!250 = !{!251}
!251 = !DILocalVariable(name: "wc", arg: 1, scope: !247, file: !1, line: 120, type: !230)
!252 = !DILocation(line: 120, column: 1, scope: !247)
!253 = !DILocation(line: 124, column: 22, scope: !247)
!254 = !DILocation(line: 124, column: 10, scope: !247)
!255 = !DILocation(line: 124, column: 3, scope: !247)
