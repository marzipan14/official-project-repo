...
; <label>:10:                                     ; preds = %3
  ...
  %13 = icmp sle i32 %5, %12, !dbg !266
  %14 = and i32 %1, 255, !dbg !267
  %15 = icmp eq i32 %14, 10, !dbg !267
  %16 = or i1 %15, %13, !dbg !268
  br i1 %16, label %23, label %17, !dbg !268

; <label>:17:                                     ; preds = %10, %8
  %18 = phi i32 [ %9, %8 ], [ %14, %10 ], !dbg !263
  %19 = trunc i32 %1 to i8, !dbg !269
  %20 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %2, i64 0, i32 0, !dbg !270
  %21 = load i8*, i8** %20, align 8, !dbg !271, !tbaa !272
  %22 = getelementptr inbounds i8, i8* %21, i64 1, !dbg !271
  store i8* %22, i8** %20, align 8, !dbg !271, !tbaa !272
  store i8 %19, i8* %21, align 1, !dbg !273, !tbaa !274
  br label %25, !dbg !275

; <label>:23:                                     ; preds = %10
  %24 = tail call i32 @__swbuf_r(%struct._reent* %0, i32 %1, %struct.__sFILE* nonnull %2) #4, !dbg !276
  br label %25, !dbg !277

; <label>:25:                                     ; preds = %17, %23
  %26 = phi i32 [ %18, %17 ], [ %24, %23 ], !dbg !278
...
; Function Attrs: noredzone nounwind
define dso_local i32 @putc_unlocked(i32, %struct.__sFILE*) local_unnamed_addr #0 !dbg !281 {
  %3 = tail call %struct._reent* @__getreent() #4, !dbg !288
  %4 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %1, i64 0, i32 2, !dbg !293
  %5 = load i32, i32* %4, align 4, !dbg !294, !tbaa !251
  %6 = add nsw i32 %5, -1, !dbg !294
  store i32 %6, i32* %4, align 4, !dbg !294, !tbaa !251
  %7 = icmp sgt i32 %5, 0, !dbg !295
  br i1 %7, label %8, label %10, !dbg !296

; <label>:8:                                      ; preds = %2
  %9 = and i32 %0, 255, !dbg !297
  br label %17, !dbg !296

; <label>:10:                                     ; preds = %2
  %11 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %1, i64 0, i32 6, !dbg !298
  %12 = load i32, i32* %11, align 8, !dbg !298, !tbaa !265
  %13 = icmp sle i32 %5, %12, !dbg !299
  %14 = and i32 %0, 255, !dbg !300
  %15 = icmp eq i32 %14, 10, !dbg !300
  %16 = or i1 %15, %13, !dbg !301
  br i1 %16, label %23, label %17, !dbg !301

; <label>:17:                                     ; preds = %10, %8
  %18 = phi i32 [ %9, %8 ], [ %14, %10 ], !dbg !297
  %19 = trunc i32 %0 to i8, !dbg !302
  %20 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %1, i64 0, i32 0, !dbg !303
  %21 = load i8*, i8** %20, align 8, !dbg !304, !tbaa !272
  %22 = getelementptr inbounds i8, i8* %21, i64 1, !dbg !304
  store i8* %22, i8** %20, align 8, !dbg !304, !tbaa !272
  store i8 %19, i8* %21, align 1, !dbg !305, !tbaa !274
  br label %25, !dbg !306

; <label>:23:                                     ; preds = %10
  %24 = tail call i32 @__swbuf_r(%struct._reent* %3, i32 %0, %struct.__sFILE* nonnull %1) #4, !dbg !307
  br label %25, !dbg !308

; <label>:25:                                     ; preds = %17, %23
  %26 = phi i32 [ %18, %17 ], [ %24, %23 ], !dbg !309
...
!267 = !DILocation(line: 692, column: 59, scope: !249, inlinedAt: !245)
!268 = !DILocation(line: 692, column: 47, scope: !249, inlinedAt: !245)
!269 = !DILocation(line: 693, column: 23, scope: !249, inlinedAt: !245)
!270 = !DILocation(line: 693, column: 16, scope: !249, inlinedAt: !245)
!271 = !DILocation(line: 693, column: 18, scope: !249, inlinedAt: !245)
!272 = !{!252, !253, i64 0}
!273 = !DILocation(line: 693, column: 21, scope: !249, inlinedAt: !245)
!274 = !{!254, !254, i64 0}
!275 = !DILocation(line: 693, column: 3, scope: !249, inlinedAt: !245)
!276 = !DILocation(line: 695, column: 11, scope: !249, inlinedAt: !245)
!277 = !DILocation(line: 695, column: 3, scope: !249, inlinedAt: !245)
!278 = !DILocation(line: 0, scope: !249, inlinedAt: !245)
!279 = !DILocation(line: 696, column: 1, scope: !240, inlinedAt: !245)
!280 = !DILocation(line: 80, column: 3, scope: !9)
!281 = distinct !DISubprogram(name: "putc_unlocked", scope: !1, file: !1, line: 85, type: !282, isLocal: false, isDefinition: true, scopeLine: 88, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !284)
!282 = !DISubroutineType(types: !283)
!283 = !{!12, !12, !231}
!284 = !{!285, !286}
!285 = !DILocalVariable(name: "c", arg: 1, scope: !281, file: !1, line: 85, type: !12)
!286 = !DILocalVariable(name: "fp", arg: 2, scope: !281, file: !1, line: 85, type: !231)
!287 = !DILocation(line: 85, column: 1, scope: !281)
!288 = !DILocation(line: 91, column: 21, scope: !281)
!289 = !DILocation(line: 687, column: 47, scope: !240, inlinedAt: !290)
!290 = distinct !DILocation(line: 91, column: 10, scope: !281)
!291 = !DILocation(line: 687, column: 57, scope: !240, inlinedAt: !290)
!292 = !DILocation(line: 687, column: 67, scope: !240, inlinedAt: !290)
!293 = !DILocation(line: 692, column: 12, scope: !249, inlinedAt: !290)
!294 = !DILocation(line: 692, column: 6, scope: !249, inlinedAt: !290)
!295 = !DILocation(line: 692, column: 15, scope: !249, inlinedAt: !290)
!296 = !DILocation(line: 692, column: 20, scope: !249, inlinedAt: !290)
!297 = !DILocation(line: 693, column: 10, scope: !249, inlinedAt: !290)
!298 = !DILocation(line: 692, column: 38, scope: !249, inlinedAt: !290)
!299 = !DILocation(line: 692, column: 31, scope: !249, inlinedAt: !290)
!300 = !DILocation(line: 692, column: 59, scope: !249, inlinedAt: !290)
!301 = !DILocation(line: 692, column: 47, scope: !249, inlinedAt: !290)
!302 = !DILocation(line: 693, column: 23, scope: !249, inlinedAt: !290)
!303 = !DILocation(line: 693, column: 16, scope: !249, inlinedAt: !290)
!304 = !DILocation(line: 693, column: 18, scope: !249, inlinedAt: !290)
!305 = !DILocation(line: 693, column: 21, scope: !249, inlinedAt: !290)
!306 = !DILocation(line: 693, column: 3, scope: !249, inlinedAt: !290)
!307 = !DILocation(line: 695, column: 11, scope: !249, inlinedAt: !290)
!308 = !DILocation(line: 695, column: 3, scope: !249, inlinedAt: !290)
!309 = !DILocation(line: 0, scope: !249, inlinedAt: !290)
!310 = !DILocation(line: 696, column: 1, scope: !240, inlinedAt: !290)
!311 = !DILocation(line: 91, column: 3, scope: !281)
