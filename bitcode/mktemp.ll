...
define dso_local i8* @_mkdtemp_r(%struct._reent*, i8*) local_unnamed_addr #0 !dbg !447 {
  %3 = tail call fastcc i32 @_gettemp(%struct._reent* %0, i8* %1, i32* null, i32 1, i64 0, i32 0) #5, !dbg !454
  %4 = icmp eq i32 %3, 0, !dbg !454
  %5 = select i1 %4, i8* null, i8* %1, !dbg !454
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !455
  ret i8* %5, !dbg !455
}

; Function Attrs: noredzone nounwind
define dso_local i32 @_mkstemps_r(%struct._reent*, i8*, i32) local_unnamed_addr #0 !dbg !456 {
  %4 = alloca i32, align 4
  %5 = bitcast i32* %4 to i8*, !dbg !465
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %5) #4, !dbg !465
  %6 = sext i32 %2 to i64, !dbg !466
  %7 = call fastcc i32 @_gettemp(%struct._reent* %0, i8* %1, i32* nonnull %4, i32 0, i64 %6, i32 0) #5, !dbg !468
  %8 = icmp eq i32 %7, 0, !dbg !468
  %9 = load i32, i32* %4, align 4, !dbg !469
  %10 = select i1 %8, i32 -1, i32 %9, !dbg !468
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %5) #4, !dbg !470
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !471
  ret i32 %10, !dbg !471
}

; Function Attrs: noredzone nounwind
define dso_local i32 @_mkostemp_r(%struct._reent*, i8*, i32) local_unnamed_addr #0 !dbg !472 {
  %4 = alloca i32, align 4
  %5 = bitcast i32* %4 to i8*, !dbg !479
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %5) #4, !dbg !479
  %6 = and i32 %2, -4, !dbg !480
  %7 = call fastcc i32 @_gettemp(%struct._reent* %0, i8* %1, i32* nonnull %4, i32 0, i64 0, i32 %6) #5, !dbg !482
  %8 = icmp eq i32 %7, 0, !dbg !482
  %9 = load i32, i32* %4, align 4, !dbg !483
  %10 = select i1 %8, i32 -1, i32 %9, !dbg !482
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %5) #4, !dbg !484
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !485
  ret i32 %10, !dbg !485
}

; Function Attrs: noredzone nounwind
define dso_local i32 @_mkostemps_r(%struct._reent*, i8*, i32, i32) local_unnamed_addr #0 !dbg !486 {
  %5 = alloca i32, align 4
  %6 = bitcast i32* %5 to i8*, !dbg !496
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %6) #4, !dbg !496
  %7 = sext i32 %2 to i64, !dbg !497
  %8 = and i32 %3, -4, !dbg !498
  %9 = call fastcc i32 @_gettemp(%struct._reent* %0, i8* %1, i32* nonnull %5, i32 0, i64 %7, i32 %8) #5, !dbg !500
  %10 = icmp eq i32 %9, 0, !dbg !500
  %11 = load i32, i32* %5, align 4, !dbg !501
  %12 = select i1 %10, i32 -1, i32 %11, !dbg !500
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %6) #4, !dbg !502
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !503
  ret i32 %12, !dbg !503
}

; Function Attrs: noredzone nounwind
define dso_local i8* @_mktemp_r(%struct._reent*, i8*) local_unnamed_addr #0 !dbg !504 {
  %3 = tail call fastcc i32 @_gettemp(%struct._reent* %0, i8* %1, i32* null, i32 0, i64 0, i32 0) #5, !dbg !509
  %4 = icmp eq i32 %3, 0, !dbg !509
  %5 = select i1 %4, i8* null, i8* %1, !dbg !509
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !510
  ret i8* %5, !dbg !510
}

; Function Attrs: noredzone nounwind
define dso_local i32 @mkstemp(i8*) local_unnamed_addr #0 !dbg !511 {
  %2 = alloca i32, align 4
  %3 = bitcast i32* %2 to i8*, !dbg !518
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %3) #4, !dbg !518
  %4 = tail call %struct._reent* @__getreent() #6, !dbg !519
  %5 = call fastcc i32 @_gettemp(%struct._reent* %4, i8* %0, i32* nonnull %2, i32 0, i64 0, i32 0) #5, !dbg !521
  %6 = icmp eq i32 %5, 0, !dbg !521
  %7 = load i32, i32* %2, align 4, !dbg !522
  %8 = select i1 %6, i32 -1, i32 %7, !dbg !521
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %3) #4, !dbg !523
...
; Function Attrs: noredzone nounwind
define dso_local i8* @mkdtemp(i8*) local_unnamed_addr #0 !dbg !525 {
  %2 = tail call %struct._reent* @__getreent() #6, !dbg !531
  %3 = tail call fastcc i32 @_gettemp(%struct._reent* %2, i8* %0, i32* null, i32 1, i64 0, i32 0) #5, !dbg !532
  %4 = icmp eq i32 %3, 0, !dbg !532
  %5 = select i1 %4, i8* null, i8* %0, !dbg !532
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !533
  ret i8* %5, !dbg !533
}

; Function Attrs: noredzone nounwind
define dso_local i32 @mkstemps(i8*, i32) local_unnamed_addr #0 !dbg !534 {
  %3 = alloca i32, align 4
  %4 = bitcast i32* %3 to i8*, !dbg !542
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %4) #4, !dbg !542
  %5 = tail call %struct._reent* @__getreent() #6, !dbg !543
  %6 = sext i32 %1 to i64, !dbg !544
  %7 = call fastcc i32 @_gettemp(%struct._reent* %5, i8* %0, i32* nonnull %3, i32 0, i64 %6, i32 0) #5, !dbg !546
  %8 = icmp eq i32 %7, 0, !dbg !546
  %9 = load i32, i32* %3, align 4, !dbg !547
  %10 = select i1 %8, i32 -1, i32 %9, !dbg !546
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %4) #4, !dbg !548
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !549
  ret i32 %10, !dbg !549
}

; Function Attrs: noredzone nounwind
define dso_local i32 @mkostemp(i8*, i32) local_unnamed_addr #0 !dbg !550 {
  %3 = alloca i32, align 4
  %4 = bitcast i32* %3 to i8*, !dbg !556
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %4) #4, !dbg !556
  %5 = tail call %struct._reent* @__getreent() #6, !dbg !557
  %6 = and i32 %1, -4, !dbg !558
  %7 = call fastcc i32 @_gettemp(%struct._reent* %5, i8* %0, i32* nonnull %3, i32 0, i64 0, i32 %6) #5, !dbg !560
  %8 = icmp eq i32 %7, 0, !dbg !560
  %9 = load i32, i32* %3, align 4, !dbg !561
  %10 = select i1 %8, i32 -1, i32 %9, !dbg !560
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %4) #4, !dbg !562
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !563
  ret i32 %10, !dbg !563
}

; Function Attrs: noredzone nounwind
define dso_local i32 @mkostemps(i8*, i32, i32) local_unnamed_addr #0 !dbg !564 {
  %4 = alloca i32, align 4
  %5 = bitcast i32* %4 to i8*, !dbg !573
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %5) #4, !dbg !573
  %6 = tail call %struct._reent* @__getreent() #6, !dbg !574
  %7 = sext i32 %1 to i64, !dbg !575
  %8 = and i32 %2, -4, !dbg !576
  %9 = call fastcc i32 @_gettemp(%struct._reent* %6, i8* %0, i32* nonnull %4, i32 0, i64 %7, i32 %8) #5, !dbg !578
  %10 = icmp eq i32 %9, 0, !dbg !578
  %11 = load i32, i32* %4, align 4, !dbg !579
  %12 = select i1 %10, i32 -1, i32 %11, !dbg !578
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %5) #4, !dbg !580
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !581
  ret i32 %12, !dbg !581
}

; Function Attrs: noredzone nounwind
define dso_local i8* @mktemp(i8*) local_unnamed_addr #0 !dbg !582 {
  %2 = tail call %struct._reent* @__getreent() #6, !dbg !586
  %3 = tail call fastcc i32 @_gettemp(%struct._reent* %2, i8* %0, i32* null, i32 0, i64 0, i32 0) #5, !dbg !587
  %4 = icmp eq i32 %3, 0, !dbg !587
  %5 = select i1 %4, i8* null, i8* %0, !dbg !587
...
!454 = !DILocation(line: 281, column: 11, scope: !447)
!455 = !DILocation(line: 281, column: 3, scope: !447)
!456 = distinct !DISubprogram(name: "_mkstemps_r", scope: !1, file: !1, line: 285, type: !457, isLocal: false, isDefinition: true, scopeLine: 289, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !459)
!457 = !DISubroutineType(types: !458)
!458 = !{!5, !17, !7, !5}
!459 = !{!460, !461, !462, !463}
!460 = !DILocalVariable(name: "ptr", arg: 1, scope: !456, file: !1, line: 285, type: !17)
!461 = !DILocalVariable(name: "path", arg: 2, scope: !456, file: !1, line: 285, type: !7)
!462 = !DILocalVariable(name: "len", arg: 3, scope: !456, file: !1, line: 285, type: !5)
!463 = !DILocalVariable(name: "fd", scope: !456, file: !1, line: 290, type: !5)
!464 = !DILocation(line: 285, column: 1, scope: !456)
!465 = !DILocation(line: 290, column: 3, scope: !456)
!466 = !DILocation(line: 292, column: 40, scope: !456)
!467 = !DILocation(line: 290, column: 7, scope: !456)
!468 = !DILocation(line: 292, column: 11, scope: !456)
!469 = !DILocation(line: 292, column: 57, scope: !456)
!470 = !DILocation(line: 293, column: 1, scope: !456)
!471 = !DILocation(line: 292, column: 3, scope: !456)
!472 = distinct !DISubprogram(name: "_mkostemp_r", scope: !1, file: !1, line: 296, type: !457, isLocal: false, isDefinition: true, scopeLine: 300, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !473)
!473 = !{!474, !475, !476, !477}
!474 = !DILocalVariable(name: "ptr", arg: 1, scope: !472, file: !1, line: 296, type: !17)
!475 = !DILocalVariable(name: "path", arg: 2, scope: !472, file: !1, line: 296, type: !7)
!476 = !DILocalVariable(name: "flags", arg: 3, scope: !472, file: !1, line: 296, type: !5)
!477 = !DILocalVariable(name: "fd", scope: !472, file: !1, line: 301, type: !5)
!478 = !DILocation(line: 296, column: 1, scope: !472)
!479 = !DILocation(line: 301, column: 3, scope: !472)
!480 = !DILocation(line: 303, column: 49, scope: !472)
!481 = !DILocation(line: 301, column: 7, scope: !472)
!482 = !DILocation(line: 303, column: 11, scope: !472)
!483 = !DILocation(line: 303, column: 65, scope: !472)
!484 = !DILocation(line: 304, column: 1, scope: !472)
!485 = !DILocation(line: 303, column: 3, scope: !472)
!486 = distinct !DISubprogram(name: "_mkostemps_r", scope: !1, file: !1, line: 307, type: !487, isLocal: false, isDefinition: true, scopeLine: 312, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !489)
!487 = !DISubroutineType(types: !488)
!488 = !{!5, !17, !7, !5, !5}
!489 = !{!490, !491, !492, !493, !494}
!490 = !DILocalVariable(name: "ptr", arg: 1, scope: !486, file: !1, line: 307, type: !17)
!491 = !DILocalVariable(name: "path", arg: 2, scope: !486, file: !1, line: 307, type: !7)
!492 = !DILocalVariable(name: "len", arg: 3, scope: !486, file: !1, line: 307, type: !5)
!493 = !DILocalVariable(name: "flags", arg: 4, scope: !486, file: !1, line: 307, type: !5)
!494 = !DILocalVariable(name: "fd", scope: !486, file: !1, line: 313, type: !5)
!495 = !DILocation(line: 307, column: 1, scope: !486)
!496 = !DILocation(line: 313, column: 3, scope: !486)
!497 = !DILocation(line: 315, column: 40, scope: !486)
!498 = !DILocation(line: 315, column: 51, scope: !486)
!499 = !DILocation(line: 313, column: 7, scope: !486)
!500 = !DILocation(line: 315, column: 11, scope: !486)
!501 = !DILocation(line: 315, column: 67, scope: !486)
!502 = !DILocation(line: 316, column: 1, scope: !486)
!503 = !DILocation(line: 315, column: 3, scope: !486)
!504 = distinct !DISubprogram(name: "_mktemp_r", scope: !1, file: !1, line: 320, type: !448, isLocal: false, isDefinition: true, scopeLine: 323, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !505)
!505 = !{!506, !507}
!506 = !DILocalVariable(name: "ptr", arg: 1, scope: !504, file: !1, line: 320, type: !17)
!507 = !DILocalVariable(name: "path", arg: 2, scope: !504, file: !1, line: 320, type: !7)
!508 = !DILocation(line: 320, column: 1, scope: !504)
!509 = !DILocation(line: 324, column: 11, scope: !504)
!510 = !DILocation(line: 324, column: 3, scope: !504)
!511 = distinct !DISubprogram(name: "mkstemp", scope: !1, file: !1, line: 330, type: !512, isLocal: false, isDefinition: true, scopeLine: 332, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !514)
!512 = !DISubroutineType(types: !513)
!513 = !{!5, !7}
!514 = !{!515, !516}
!515 = !DILocalVariable(name: "path", arg: 1, scope: !511, file: !1, line: 330, type: !7)
!516 = !DILocalVariable(name: "fd", scope: !511, file: !1, line: 333, type: !5)
!517 = !DILocation(line: 330, column: 1, scope: !511)
!518 = !DILocation(line: 333, column: 3, scope: !511)
!519 = !DILocation(line: 335, column: 21, scope: !511)
!520 = !DILocation(line: 333, column: 7, scope: !511)
!521 = !DILocation(line: 335, column: 11, scope: !511)
!522 = !DILocation(line: 335, column: 58, scope: !511)
!523 = !DILocation(line: 336, column: 1, scope: !511)
!524 = !DILocation(line: 335, column: 3, scope: !511)
!525 = distinct !DISubprogram(name: "mkdtemp", scope: !1, file: !1, line: 340, type: !526, isLocal: false, isDefinition: true, scopeLine: 342, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !528)
!526 = !DISubroutineType(types: !527)
!527 = !{!7, !7}
!528 = !{!529}
!529 = !DILocalVariable(name: "path", arg: 1, scope: !525, file: !1, line: 340, type: !7)
!530 = !DILocation(line: 340, column: 1, scope: !525)
!531 = !DILocation(line: 343, column: 21, scope: !525)
!532 = !DILocation(line: 343, column: 11, scope: !525)
!533 = !DILocation(line: 343, column: 3, scope: !525)
!534 = distinct !DISubprogram(name: "mkstemps", scope: !1, file: !1, line: 347, type: !535, isLocal: false, isDefinition: true, scopeLine: 350, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !537)
!535 = !DISubroutineType(types: !536)
!536 = !{!5, !7, !5}
!537 = !{!538, !539, !540}
!538 = !DILocalVariable(name: "path", arg: 1, scope: !534, file: !1, line: 347, type: !7)
!539 = !DILocalVariable(name: "len", arg: 2, scope: !534, file: !1, line: 347, type: !5)
!540 = !DILocalVariable(name: "fd", scope: !534, file: !1, line: 351, type: !5)
!541 = !DILocation(line: 347, column: 1, scope: !534)
!542 = !DILocation(line: 351, column: 3, scope: !534)
!543 = !DILocation(line: 353, column: 21, scope: !534)
!544 = !DILocation(line: 353, column: 43, scope: !534)
!545 = !DILocation(line: 351, column: 7, scope: !534)
!546 = !DILocation(line: 353, column: 11, scope: !534)
!547 = !DILocation(line: 353, column: 60, scope: !534)
!548 = !DILocation(line: 354, column: 1, scope: !534)
!549 = !DILocation(line: 353, column: 3, scope: !534)
!550 = distinct !DISubprogram(name: "mkostemp", scope: !1, file: !1, line: 357, type: !535, isLocal: false, isDefinition: true, scopeLine: 360, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !551)
!551 = !{!552, !553, !554}
!552 = !DILocalVariable(name: "path", arg: 1, scope: !550, file: !1, line: 357, type: !7)
!553 = !DILocalVariable(name: "flags", arg: 2, scope: !550, file: !1, line: 357, type: !5)
!554 = !DILocalVariable(name: "fd", scope: !550, file: !1, line: 361, type: !5)
!555 = !DILocation(line: 357, column: 1, scope: !550)
!556 = !DILocation(line: 361, column: 3, scope: !550)
!557 = !DILocation(line: 363, column: 21, scope: !550)
!558 = !DILocation(line: 363, column: 52, scope: !550)
!559 = !DILocation(line: 361, column: 7, scope: !550)
!560 = !DILocation(line: 363, column: 11, scope: !550)
!561 = !DILocation(line: 363, column: 68, scope: !550)
!562 = !DILocation(line: 364, column: 1, scope: !550)
!563 = !DILocation(line: 363, column: 3, scope: !550)
!564 = distinct !DISubprogram(name: "mkostemps", scope: !1, file: !1, line: 367, type: !565, isLocal: false, isDefinition: true, scopeLine: 371, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !567)
!565 = !DISubroutineType(types: !566)
!566 = !{!5, !7, !5, !5}
!567 = !{!568, !569, !570, !571}
!568 = !DILocalVariable(name: "path", arg: 1, scope: !564, file: !1, line: 367, type: !7)
!569 = !DILocalVariable(name: "len", arg: 2, scope: !564, file: !1, line: 367, type: !5)
!570 = !DILocalVariable(name: "flags", arg: 3, scope: !564, file: !1, line: 367, type: !5)
!571 = !DILocalVariable(name: "fd", scope: !564, file: !1, line: 372, type: !5)
!572 = !DILocation(line: 367, column: 1, scope: !564)
!573 = !DILocation(line: 372, column: 3, scope: !564)
!574 = !DILocation(line: 374, column: 21, scope: !564)
!575 = !DILocation(line: 374, column: 43, scope: !564)
!576 = !DILocation(line: 374, column: 54, scope: !564)
!577 = !DILocation(line: 372, column: 7, scope: !564)
!578 = !DILocation(line: 374, column: 11, scope: !564)
!579 = !DILocation(line: 374, column: 70, scope: !564)
!580 = !DILocation(line: 375, column: 1, scope: !564)
!581 = !DILocation(line: 374, column: 3, scope: !564)
!582 = distinct !DISubprogram(name: "mktemp", scope: !1, file: !1, line: 379, type: !526, isLocal: false, isDefinition: true, scopeLine: 381, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !583)
!583 = !{!584}
!584 = !DILocalVariable(name: "path", arg: 1, scope: !582, file: !1, line: 379, type: !7)
!585 = !DILocation(line: 379, column: 1, scope: !582)
!586 = !DILocation(line: 382, column: 21, scope: !582)
!587 = !DILocation(line: 382, column: 11, scope: !582)
!588 = !DILocation(line: 382, column: 3, scope: !582)
