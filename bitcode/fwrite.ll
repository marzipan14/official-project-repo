...
; <label>:53:                                     ; preds = %44
  %54 = call i32 @__swbuf_r(%struct._reent* %0, i32 %40, %struct.__sFILE* nonnull %4) #4, !dbg !333
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !331
  %55 = icmp eq i32 %54, -1, !dbg !334
  br i1 %55, label %56, label %60, !dbg !332

; <label>:56:                                     ; preds = %53
  %57 = icmp eq i8 %39, 10, !dbg !335
  %58 = zext i1 %57 to i64, !dbg !338
  %59 = add i64 %37, %58, !dbg !338
  br label %63, !dbg !338

; <label>:60:                                     ; preds = %50, %53
  %61 = add nuw i64 %37, 1, !dbg !339
  %62 = icmp ult i64 %61, %7, !dbg !300
  br i1 %62, label %36, label %63, !dbg !302, !llvm.loop !340

; <label>:63:                                     ; preds = %60, %30, %56, %25
  %64 = phi i64 [ 0, %25 ], [ %59, %56 ], [ 0, %30 ], [ %61, %60 ], !dbg !342
  %65 = load i32, i32* %6, align 4, !dbg !343, !tbaa !344
  %66 = call i32 @pthread_setcancelstate(i32 %65, i32* nonnull %6) #4, !dbg !343
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %15) #5, !dbg !345
  %67 = udiv i64 %64, %2, !dbg !346
...
; Function Attrs: noredzone nounwind
define dso_local i64 @fwrite(i8* noalias nocapture readonly, i64, i64, %struct.__sFILE*) local_unnamed_addr #0 !dbg !348 {
  %5 = tail call %struct._reent* @__getreent() #4, !dbg !357
  %6 = tail call i64 @_fwrite_r(%struct._reent* %5, i8* %0, i64 %1, i64 %2, %struct.__sFILE* %3) #6, !dbg !358
...
!331 = !DILocation(line: 696, column: 1, scope: !308, inlinedAt: !315)
!332 = !DILocation(line: 191, column: 11, scope: !305)
!333 = !DILocation(line: 695, column: 11, scope: !319, inlinedAt: !315)
!334 = !DILocation(line: 191, column: 37, scope: !304)
!335 = !DILocation(line: 192, column: 12, scope: !336)
!336 = distinct !DILexicalBlock(scope: !337, file: !1, line: 192, column: 7)
!337 = distinct !DILexicalBlock(scope: !304, file: !1, line: 191, column: 45)
!338 = !DILocation(line: 192, column: 7, scope: !337)
!339 = !DILocation(line: 197, column: 8, scope: !305)
!340 = distinct !{!340, !302, !341}
!341 = !DILocation(line: 198, column: 5, scope: !272)
!342 = !DILocation(line: 0, scope: !28)
!343 = !DILocation(line: 201, column: 3, scope: !272)
!344 = !{!283, !283, i64 0}
!345 = !DILocation(line: 201, column: 3, scope: !28)
!346 = !DILocation(line: 202, column: 12, scope: !28)
!347 = !DILocation(line: 202, column: 3, scope: !28)
!348 = distinct !DISubprogram(name: "fwrite", scope: !1, file: !1, line: 208, type: !349, isLocal: false, isDefinition: true, scopeLine: 213, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !351)
!349 = !DISubroutineType(types: !350)
!350 = !{!31, !250, !253, !253, !257}
!351 = !{!352, !353, !354, !355}
!352 = !DILocalVariable(name: "buf", arg: 1, scope: !348, file: !1, line: 208, type: !250)
!353 = !DILocalVariable(name: "size", arg: 2, scope: !348, file: !1, line: 208, type: !253)
!354 = !DILocalVariable(name: "count", arg: 3, scope: !348, file: !1, line: 208, type: !253)
!355 = !DILocalVariable(name: "fp", arg: 4, scope: !348, file: !1, line: 208, type: !257)
!356 = !DILocation(line: 208, column: 1, scope: !348)
!357 = !DILocation(line: 214, column: 21, scope: !348)
!358 = !DILocation(line: 214, column: 10, scope: !348)
!359 = !DILocation(line: 214, column: 3, scope: !348)
