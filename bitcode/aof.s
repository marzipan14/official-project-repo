...
.LBB32_6:                               #   in Loop: Header=BB32_4 Depth=2
	...
	testq	%rax, %rax
	je	.LBB32_7
# %bb.10:                               #   in Loop: Header=BB32_4 Depth=2
	addq	%rbx, %r12
	addq	%rbx, 48(%r13)
	subq	%rbx, %r15
	jne	.LBB32_4
...
# %bb.13:                               # %.preheader1
	...
	leaq	-88(%rbp), %r15
	jmp	.LBB32_14
.LBB32_45:                              #   in Loop: Header=BB32_14 Depth=2
	movl	$42, __A_VARIABLE(%rip)
	movq	%r15, -72(%rbp)         # 8-byte Spill
.LBB32_46:                              #   in Loop: Header=BB32_14 Depth=2
	movq	-56(%rbp), %rbx         # 8-byte Reload
	movq	%rbx, %rdi
	callq	dictNext
	testq	%rax, %rax
...
.LBB32_16:                              #   in Loop: Header=BB32_14 Depth=2
	...
	leaq	-65664(%rbp), %rbx
	.p2align	4, 0x90
.LBB32_17:                              #   Parent Loop BB32_2 Depth=1
...
# %bb.23:                               #   in Loop: Header=BB32_14 Depth=2
	...
	movq	-48(%rbp), %rbx         # 8-byte Reload
	jmp	.LBB32_33
.LBB32_28:                              #   in Loop: Header=BB32_14 Depth=2
	movq	%r13, %rdi
	movq	%r15, %rsi
	movq	%r12, %rdx
	callq	rewriteHashObject
	jmp	.LBB32_25
.LBB32_26:                              #   in Loop: Header=BB32_14 Depth=2
	movq	%r13, %rdi
	movq	%r15, %rsi
	movq	%r12, %rdx
	callq	rewriteSetObject
	jmp	.LBB32_25
.LBB32_24:                              #   in Loop: Header=BB32_14 Depth=2
	movq	%r13, %rdi
	movq	%r15, %rsi
	movq	%r12, %rdx
	callq	rewriteListObject
	jmp	.LBB32_25
.LBB32_27:                              #   in Loop: Header=BB32_14 Depth=2
	movq	%r13, %rdi
	movq	%r15, %rsi
	movq	%r12, %rdx
...
# %bb.31:                               #   in Loop: Header=BB32_14 Depth=2
	...
	movq	-65632(%rbp), %rdi
	callq	zfree
.LBB32_32:                              #   in Loop: Header=BB32_14 Depth=2
	cmpl	$0, -65640(%rbp)
	movl	$42, __A_VARIABLE(%rip)
	je	.LBB32_33
	jmp	.LBB32_8
.LBB32_29:                              #   in Loop: Header=BB32_14 Depth=2
	movq	%r13, %rdi
	movq	%r15, %rsi
	movq	%r12, %rdx
...
.LBB32_25:                              #   in Loop: Header=BB32_14 Depth=2
	...
	leaq	-65664(%rbp), %r12
	je	.LBB32_8
.LBB32_33:                              #   in Loop: Header=BB32_14 Depth=2
	cmpq	$-1, %rbx
	je	.LBB32_42
# %bb.34:                               #   in Loop: Header=BB32_14 Depth=2
	movq	%rbx, -48(%rbp)         # 8-byte Spill
	...
	movq	%r12, %r15
	.p2align	4, 0x90
.LBB32_35:                              #   Parent Loop BB32_2 Depth=1
                                        #     Parent Loop BB32_14 Depth=2
                                        # =>    This Inner Loop Header: Depth=3
	movq	32(%r13), %rax
	movq	56(%r13), %rcx
...
# %bb.36:                               #   in Loop: Header=BB32_35 Depth=3
	...
	movq	%rbx, %rdx
	callq	*%rax
.LBB32_37:                              #   in Loop: Header=BB32_35 Depth=3
	movq	%r13, %rdi
	movq	%r15, %rsi
	movq	%rbx, %rdx
	callq	*8(%r13)
...
# %bb.38:                               #   in Loop: Header=BB32_35 Depth=3
	...
	subq	%rbx, %r14
	jne	.LBB32_35
# %bb.39:                               #   in Loop: Header=BB32_14 Depth=2
	movl	$42, __A_VARIABLE(%rip)
	movq	%r13, %rdi
	leaq	-88(%rbp), %rsi
	callq	rioWriteBulkObject
	testl	%eax, %eax
	je	.LBB32_8
# %bb.40:                               #   in Loop: Header=BB32_14 Depth=2
	movq	%r13, %rdi
	movq	-48(%rbp), %rsi         # 8-byte Reload
	callq	rioWriteBulkLongLong
	testq	%rax, %rax
	je	.LBB32_8
# %bb.41:                               #   in Loop: Header=BB32_14 Depth=2
	movq	-64(%rbp), %r14         # 8-byte Reload
.LBB32_42:                              #   in Loop: Header=BB32_14 Depth=2
	movq	48(%r13), %r15
...
.LBB32_44:                              #   Parent Loop BB32_2 Depth=1
	...
	testq	%rax, %rax
	jle	.LBB32_45
# %bb.43:                               #   in Loop: Header=BB32_44 Depth=3
	movq	server+2072(%rip), %rdi
	movq	%r12, %rsi
	movq	%rax, %rdx
	callq	sdscatlen
