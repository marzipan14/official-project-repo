...
define dso_local { i64, i64 } @lldiv(i64, i64) local_unnamed_addr #0 !dbg !7 {
  ...
  %7 = and i1 %5, %6, !dbg !28
  %8 = zext i1 %7 to i64, !dbg !28
  %9 = add nsw i64 %3, %8, !dbg !28
  %10 = select i1 %7, i64 %1, i64 0, !dbg !28
  %11 = sub nsw i64 %4, %10, !dbg !28
  %12 = insertvalue { i64, i64 } undef, i64 %9, 0, !dbg !29
  %13 = insertvalue { i64, i64 } %12, i64 %11, 1, !dbg !29
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !29
  ret { i64, i64 } %13, !dbg !29
}
...
!27 = !DILocation(line: 109, column: 31, scope: !26)
!28 = !DILocation(line: 109, column: 17, scope: !26)
!29 = !DILocation(line: 113, column: 2, scope: !7)
