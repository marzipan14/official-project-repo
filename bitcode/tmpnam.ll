...
; <label>:20:                                     ; preds = %8
  %21 = tail call i32 @_close_r(%struct._reent* nonnull %0, i32 %13) #3, !dbg !291
  br label %8

; <label>:22:                                     ; preds = %15
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !289
  %23 = load i32, i32* %7, align 8, !dbg !292, !tbaa !294
  %24 = add nsw i32 %23, 1, !dbg !292
  store i32 %24, i32* %7, align 8, !dbg !292, !tbaa !294
  br label %25, !dbg !295

; <label>:25:                                     ; preds = %19, %22
  %26 = phi i8* [ %5, %22 ], [ null, %19 ], !dbg !296
...
; Function Attrs: noredzone nounwind
define dso_local i8* @_tempnam_r(%struct._reent*, i8*, i8*) local_unnamed_addr #0 !dbg !298 {
  %4 = icmp eq i8* %2, null, !dbg !309
  %5 = select i1 %4, i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str.2, i64 0, i64 0), i8* %2, !dbg !309
  %6 = icmp eq i8* %1, null, !dbg !311
  br i1 %6, label %7, label %11, !dbg !313

; <label>:7:                                      ; preds = %3
  %8 = tail call i8* @getenv(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.3, i64 0, i64 0)) #3, !dbg !314
  %9 = icmp eq i8* %8, null, !dbg !315
  %10 = select i1 %9, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i8* %8, !dbg !316
  br label %11, !dbg !316

; <label>:11:                                     ; preds = %7, %3
  %12 = phi i8* [ %10, %7 ], [ %1, %3 ]
  %13 = tail call i64 @strlen(i8* %12) #3, !dbg !317
  %14 = tail call i64 @strlen(i8* %5) #3, !dbg !318
  %15 = add i64 %14, %13, !dbg !319
  %16 = shl i64 %15, 32, !dbg !320
  %17 = add i64 %16, 81604378624, !dbg !320
  %18 = ashr exact i64 %17, 32, !dbg !320
  %19 = tail call i8* @malloc(i64 %18) #3, !dbg !320
  %20 = icmp eq i8* %19, null, !dbg !322
  br i1 %20, label %43, label %21, !dbg !324

; <label>:21:                                     ; preds = %11
  %22 = tail call i32 @_getpid_r(%struct._reent* %0) #3, !dbg !325
  %23 = ptrtoint %struct._reent* %0 to i64, !dbg !328
  %24 = trunc i64 %23 to i32, !dbg !329
  %25 = xor i32 %22, %24, !dbg !330
  %26 = getelementptr inbounds %struct._reent, %struct._reent* %0, i64 0, i32 4, !dbg !331
  br label %27, !dbg !334

; <label>:27:                                     ; preds = %39, %21
  %28 = load i32, i32* %26, align 4, !dbg !335, !tbaa !264
  %29 = tail call i32 (%struct._reent*, i8*, i8*, ...) @_sprintf_r(%struct._reent* %0, i8* nonnull %19, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.4, i64 0, i64 0), i8* %12, i8* %5, i32 %25, i32 %28) #3, !dbg !336
  %30 = load i32, i32* %26, align 4, !dbg !337, !tbaa !264
  %31 = add nsw i32 %30, 1, !dbg !337
  store i32 %31, i32* %26, align 4, !dbg !337, !tbaa !264
  %32 = tail call i32 @_open_r(%struct._reent* %0, i8* nonnull %19, i32 0, i32 0) #3, !dbg !338
  %33 = icmp eq i32 %32, -1, !dbg !340
  br i1 %33, label %34, label %39, !dbg !341

; <label>:34:                                     ; preds = %27
  %35 = getelementptr inbounds %struct._reent, %struct._reent* %0, i64 0, i32 0, !dbg !342
  %36 = load i32, i32* %35, align 8, !dbg !342, !tbaa !278
  %37 = icmp eq i32 %36, 88, !dbg !343
  br i1 %37, label %38, label %41, !dbg !344

; <label>:38:                                     ; preds = %34
  store i8 0, i8* %19, align 1, !dbg !345, !tbaa !288
  br label %41, !dbg !346

; <label>:39:                                     ; preds = %27
  %40 = tail call i32 @_close_r(%struct._reent* nonnull %0, i32 %32) #3, !dbg !347
  br label %27

; <label>:41:                                     ; preds = %34, %38
  %42 = phi i8* [ null, %38 ], [ %19, %34 ]
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !348
  br label %43, !dbg !349

; <label>:43:                                     ; preds = %41, %11
  %44 = phi i8* [ null, %11 ], [ %42, %41 ], !dbg !350
...
; Function Attrs: noredzone nounwind
define dso_local i8* @tempnam(i8*, i8*) local_unnamed_addr #0 !dbg !351 {
  %3 = tail call %struct._reent* @__getreent() #3, !dbg !358
  %4 = tail call i8* @_tempnam_r(%struct._reent* %3, i8* %0, i8* %1) #5, !dbg !359
...
; Function Attrs: noredzone nounwind
define dso_local i8* @tmpnam(i8*) local_unnamed_addr #0 !dbg !361 {
  %2 = tail call %struct._reent* @__getreent() #3, !dbg !367
  %3 = tail call i8* @_tmpnam_r(%struct._reent* %2, i8* %0) #5, !dbg !368
...
!288 = !{!266, !266, i64 0}
!289 = !DILocation(line: 136, column: 1, scope: !248, inlinedAt: !261)
!290 = !DILocation(line: 158, column: 7, scope: !11)
!291 = !DILocation(line: 133, column: 7, scope: !259, inlinedAt: !261)
...
!296 = !DILocation(line: 0, scope: !11)
!297 = !DILocation(line: 165, column: 1, scope: !11)
!298 = distinct !DISubprogram(name: "_tempnam_r", scope: !1, file: !1, line: 168, type: !299, isLocal: false, isDefinition: true, scopeLine: 172, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !301)
!299 = !DISubroutineType(types: !300)
!300 = !{!14, !16, !51, !51}
!301 = !{!302, !303, !304, !305, !306, !307}
!302 = !DILocalVariable(name: "p", arg: 1, scope: !298, file: !1, line: 168, type: !16)
!303 = !DILocalVariable(name: "dir", arg: 2, scope: !298, file: !1, line: 168, type: !51)
!304 = !DILocalVariable(name: "pfx", arg: 3, scope: !298, file: !1, line: 168, type: !51)
!305 = !DILocalVariable(name: "filename", scope: !298, file: !1, line: 173, type: !14)
!306 = !DILocalVariable(name: "length", scope: !298, file: !1, line: 174, type: !5)
!307 = !DILocalVariable(name: "prefix", scope: !298, file: !1, line: 175, type: !51)
!308 = !DILocation(line: 168, column: 1, scope: !298)
!309 = !DILocation(line: 175, column: 25, scope: !298)
!310 = !DILocation(line: 175, column: 16, scope: !298)
!311 = !DILocation(line: 176, column: 11, scope: !312)
!312 = distinct !DILexicalBlock(scope: !298, file: !1, line: 176, column: 7)
!313 = !DILocation(line: 176, column: 19, scope: !312)
!314 = !DILocation(line: 176, column: 29, scope: !312)
!315 = !DILocation(line: 176, column: 48, scope: !312)
!316 = !DILocation(line: 176, column: 7, scope: !298)
!317 = !DILocation(line: 180, column: 12, scope: !298)
!318 = !DILocation(line: 180, column: 27, scope: !298)
!319 = !DILocation(line: 180, column: 25, scope: !298)
!320 = !DILocation(line: 182, column: 14, scope: !298)
!321 = !DILocation(line: 173, column: 9, scope: !298)
!322 = !DILocation(line: 183, column: 7, scope: !323)
!323 = distinct !DILexicalBlock(scope: !298, file: !1, line: 183, column: 7)
!324 = !DILocation(line: 183, column: 7, scope: !298)
!325 = !DILocation(line: 186, column: 7, scope: !326)
!326 = distinct !DILexicalBlock(scope: !327, file: !1, line: 185, column: 11)
!327 = distinct !DILexicalBlock(scope: !323, file: !1, line: 184, column: 5)
!328 = !DILocation(line: 186, column: 29, scope: !326)
!329 = !DILocation(line: 186, column: 23, scope: !326)
!330 = !DILocation(line: 186, column: 21, scope: !326)
!331 = !DILocation(line: 186, column: 51, scope: !326)
!332 = !DILocation(line: 107, column: 1, scope: !248, inlinedAt: !333)
!333 = distinct !DILocation(line: 185, column: 13, scope: !326)
!334 = !DILocation(line: 118, column: 3, scope: !248, inlinedAt: !333)
!335 = !DILocation(line: 121, column: 67, scope: !259, inlinedAt: !333)
!336 = !DILocation(line: 121, column: 7, scope: !259, inlinedAt: !333)
!337 = !DILocation(line: 122, column: 15, scope: !259, inlinedAt: !333)
!338 = !DILocation(line: 123, column: 11, scope: !259, inlinedAt: !333)
!339 = !DILocation(line: 120, column: 11, scope: !259, inlinedAt: !333)
!340 = !DILocation(line: 124, column: 13, scope: !273, inlinedAt: !333)
!341 = !DILocation(line: 124, column: 11, scope: !259, inlinedAt: !333)
!342 = !DILocation(line: 126, column: 13, scope: !276, inlinedAt: !333)
!343 = !DILocation(line: 126, column: 20, scope: !276, inlinedAt: !333)
!344 = !DILocation(line: 126, column: 8, scope: !277, inlinedAt: !333)
!345 = !DILocation(line: 128, column: 18, scope: !287, inlinedAt: !333)
!346 = !DILocation(line: 185, column: 11, scope: !327)
!347 = !DILocation(line: 133, column: 7, scope: !259, inlinedAt: !333)
!348 = !DILocation(line: 136, column: 1, scope: !248, inlinedAt: !333)
!349 = !DILocation(line: 190, column: 1, scope: !298)
!350 = !DILocation(line: 0, scope: !326)
!351 = distinct !DISubprogram(name: "tempnam", scope: !1, file: !1, line: 195, type: !352, isLocal: false, isDefinition: true, scopeLine: 198, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !354)
!352 = !DISubroutineType(types: !353)
!353 = !{!14, !51, !51}
!354 = !{!355, !356}
!355 = !DILocalVariable(name: "dir", arg: 1, scope: !351, file: !1, line: 195, type: !51)
!356 = !DILocalVariable(name: "pfx", arg: 2, scope: !351, file: !1, line: 195, type: !51)
!357 = !DILocation(line: 195, column: 1, scope: !351)
!358 = !DILocation(line: 199, column: 22, scope: !351)
!359 = !DILocation(line: 199, column: 10, scope: !351)
!360 = !DILocation(line: 199, column: 3, scope: !351)
!361 = distinct !DISubprogram(name: "tmpnam", scope: !1, file: !1, line: 203, type: !362, isLocal: false, isDefinition: true, scopeLine: 205, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !364)
!362 = !DISubroutineType(types: !363)
!363 = !{!14, !14}
!364 = !{!365}
!365 = !DILocalVariable(name: "s", arg: 1, scope: !361, file: !1, line: 203, type: !14)
!366 = !DILocation(line: 203, column: 1, scope: !361)
!367 = !DILocation(line: 206, column: 21, scope: !361)
!368 = !DILocation(line: 206, column: 10, scope: !361)
!369 = !DILocation(line: 206, column: 3, scope: !361)
