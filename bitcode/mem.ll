...
define internal void @uk_pr_crit(i8*, ...) unnamed_addr #5 !dbg !2 {
  ...
  call void @llvm.lifetime.start.p0i8(i64 24, i8* nonnull %3) #7, !dbg !98
  ...
  call void @_uk_vprintk(i32 0, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @uk_pr_crit.__str, i64 0, i64 0), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @uk_pr_crit.__str.5, i64 0, i64 0), i32 198, i8* %0, %struct.__va_list_tag* nonnull %4) #8, !dbg !101
  call void @llvm.va_end(i8* nonnull %3), !dbg !104
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %3) #7, !dbg !105
...
; Function Attrs: noredzone nounwind
define dso_local void @mem_free(i8*) local_unnamed_addr #1 !dbg !106 {
  %2 = icmp eq i8* %0, null, !dbg !112
  br i1 %2, label %3, label %4, !dbg !115

; <label>:3:                                      ; preds = %1
  tail call void (i8*, ...) @uk_pr_crit(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.3, i64 0, i64 0)) #9, !dbg !116
  tail call void (i8*, ...) @uk_pr_crit(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.1, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0)) #9, !dbg !119
  tail call void @ukplat_terminate(i32 3) #10, !dbg !119
  unreachable, !dbg !119

; <label>:4:                                      ; preds = %1
  tail call void @sys_free(i8* nonnull %0) #8, !dbg !123
...
; Function Attrs: noredzone nounwind
define dso_local i8* @mem_calloc(i64, i64) local_unnamed_addr #1 !dbg !125 {
  %3 = trunc i64 %0 to i32, !dbg !133
  %4 = tail call i8* @sys_calloc(i32 %3, i64 %1) #8, !dbg !134
