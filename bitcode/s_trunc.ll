...
define dso_local double @trunc(double) local_unnamed_addr #0 !dbg !7 {
  ...
  br i1 %11, label %12, label %25, !dbg !56
...
; <label>:14:                                     ; preds = %12
  ...
  %17 = bitcast i64 %16 to double, !dbg !59
  br label %40, !dbg !60

; <label>:18:                                     ; preds = %12
  %19 = ashr i32 -1048576, %10, !dbg !61
  %20 = and i32 %19, %4, !dbg !61
  %21 = or i32 %20, %6, !dbg !61
  %22 = zext i32 %21 to i64, !dbg !61
  %23 = shl nuw i64 %22, 32, !dbg !61
  %24 = bitcast i64 %23 to double, !dbg !61
  br label %40

; <label>:25:                                     ; preds = %1
  %26 = icmp ugt i32 %9, 1074, !dbg !62
  br i1 %26, label %27, label %31, !dbg !63

; <label>:27:                                     ; preds = %25
  %28 = icmp eq i32 %10, 1024, !dbg !64
  %29 = fadd double %0, %0, !dbg !67
  %30 = select i1 %28, double %29, double %0, !dbg !69
  br label %40, !dbg !69

; <label>:31:                                     ; preds = %25
  %32 = and i64 %2, -4294967296, !dbg !70
  %33 = add nsw i32 %9, -1043, !dbg !70
  %34 = lshr i32 -1, %33, !dbg !70
  %35 = xor i32 %34, -1, !dbg !70
  %36 = and i32 %35, %5, !dbg !70
  %37 = zext i32 %36 to i64, !dbg !70
  %38 = or i64 %32, %37, !dbg !70
  %39 = bitcast i64 %38 to double, !dbg !70
  br label %40

; <label>:40:                                     ; preds = %27, %18, %14, %31
  %41 = phi double [ %17, %14 ], [ %24, %18 ], [ %39, %31 ], [ %30, %27 ], !dbg !71
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !72
  ret double %41, !dbg !72
}
