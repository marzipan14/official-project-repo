...
# %bb.13:
	...
	ja	.LBB1_15
# %bb.14:
	movss	.LCPI1_16(%rip), %xmm2  # xmm2 = mem[0],zero,zero,zero
	mulss	%xmm0, %xmm2
	addss	.LCPI1_17(%rip), %xmm2
	mulss	%xmm0, %xmm2
	addss	.LCPI1_18(%rip), %xmm2
	mulss	%xmm0, %xmm2
	addss	.LCPI1_19(%rip), %xmm2
	mulss	%xmm0, %xmm2
	addss	.LCPI1_20(%rip), %xmm2
	mulss	%xmm0, %xmm2
	addss	.LCPI1_21(%rip), %xmm2
	mulss	%xmm0, %xmm2
	addss	.LCPI1_22(%rip), %xmm2
	mulss	%xmm0, %xmm2
	addss	.LCPI1_23(%rip), %xmm2
	movss	.LCPI1_24(%rip), %xmm1  # xmm1 = mem[0],zero,zero,zero
	mulss	%xmm0, %xmm1
	addss	.LCPI1_25(%rip), %xmm1
	mulss	%xmm0, %xmm1
	addss	.LCPI1_26(%rip), %xmm1
	movss	.LCPI1_27(%rip), %xmm8  # xmm8 = mem[0],zero,zero,zero
...
.LBB1_15:
	...
	jns	.LBB1_17
# %bb.16:
	cmpl	$1086324735, %ebx       # imm = 0x40BFFFFF
	jbe	.LBB1_17
.LBB1_21:
...
.LBB1_17:
	...
	mulss	%xmm0, %xmm2
	addss	.LCPI1_3(%rip), %xmm2
	mulss	%xmm0, %xmm2
	addss	.LCPI1_4(%rip), %xmm2
	mulss	%xmm0, %xmm2
	addss	.LCPI1_5(%rip), %xmm2
	mulss	%xmm0, %xmm2
	addss	.LCPI1_6(%rip), %xmm2
	mulss	%xmm0, %xmm2
	addss	.LCPI1_7(%rip), %xmm2
	mulss	%xmm0, %xmm2
	addss	.LCPI1_8(%rip), %xmm2
	movss	.LCPI1_9(%rip), %xmm1   # xmm1 = mem[0],zero,zero,zero
	mulss	%xmm0, %xmm1
	addss	.LCPI1_10(%rip), %xmm1
	movss	.LCPI1_11(%rip), %xmm8  # xmm8 = mem[0],zero,zero,zero
