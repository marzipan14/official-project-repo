; ModuleID = '/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/stdio/fputwc_u.c'
source_filename = "/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/stdio/fputwc_u.c"
...
define dso_local i32 @_fputwc_unlocked_r(%struct._reent*, i32, %struct.__sFILE*) local_unnamed_addr #0 !dbg !7 {
  %4 = tail call i32 @__fputwc(%struct._reent* %0, i32 %1, %struct.__sFILE* %2) #3, !dbg !239
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !240
  ret i32 %4, !dbg !240
}

; Function Attrs: noredzone
declare dso_local i32 @__fputwc(%struct._reent*, i32, %struct.__sFILE*) local_unnamed_addr #1

; Function Attrs: noredzone nounwind
define dso_local i32 @fputwc_unlocked(i32, %struct.__sFILE*) local_unnamed_addr #0 !dbg !241 {
  %3 = tail call %struct._reent* @__getreent() #3, !dbg !251
  %4 = icmp eq %struct._reent* %3, null, !dbg !254
  br i1 %4, label %10, label %5, !dbg !254

; <label>:5:                                      ; preds = %2
  %6 = getelementptr inbounds %struct._reent, %struct._reent* %3, i64 0, i32 8, !dbg !254
  %7 = load i32, i32* %6, align 8, !dbg !254, !tbaa !256
  %8 = icmp eq i32 %7, 0, !dbg !254
  br i1 %8, label %9, label %10, !dbg !253

; <label>:9:                                      ; preds = %5
  tail call void @__sinit(%struct._reent* nonnull %3) #3, !dbg !254
  br label %10, !dbg !254

; <label>:10:                                     ; preds = %5, %2, %9
  %11 = tail call i32 @__fputwc(%struct._reent* %3, i32 %0, %struct.__sFILE* %1) #3, !dbg !267
...
!1 = !DIFile(filename: "/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/stdio/fputwc_u.c", directory: "/root/.unikraft/apps/redis/build")
!2 = !{}
!3 = !{i32 2, !"Dwarf Version", i32 4}
!4 = !{i32 2, !"Debug Info Version", i32 3}
!5 = !{i32 1, !"wchar_size", i32 4}
!6 = !{!"clang version 7.0.1-8+deb10u2 (tags/RELEASE_701/final)"}
!7 = distinct !DISubprogram(name: "_fputwc_unlocked_r", scope: !1, file: !1, line: 33, type: !8, isLocal: false, isDefinition: true, scopeLine: 37, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !234)
...
!230 = !DIDerivedType(tag: DW_TAG_typedef, name: "wchar_t", file: !11, line: 83, baseType: !18)
...
!234 = !{!235, !236, !237}
!235 = !DILocalVariable(name: "ptr", arg: 1, scope: !7, file: !1, line: 33, type: !13)
!236 = !DILocalVariable(name: "wc", arg: 2, scope: !7, file: !1, line: 33, type: !230)
!237 = !DILocalVariable(name: "fp", arg: 3, scope: !7, file: !1, line: 33, type: !231)
!238 = !DILocation(line: 33, column: 1, scope: !7)
!239 = !DILocation(line: 39, column: 10, scope: !7)
!240 = !DILocation(line: 39, column: 3, scope: !7)
!241 = distinct !DISubprogram(name: "fputwc_unlocked", scope: !1, file: !1, line: 43, type: !242, isLocal: false, isDefinition: true, scopeLine: 46, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !244)
!242 = !DISubroutineType(types: !243)
!243 = !{!10, !230, !231}
!244 = !{!245, !246, !247, !248}
!245 = !DILocalVariable(name: "wc", arg: 1, scope: !241, file: !1, line: 43, type: !230)
!246 = !DILocalVariable(name: "fp", arg: 2, scope: !241, file: !1, line: 43, type: !231)
!247 = !DILocalVariable(name: "reent", scope: !241, file: !1, line: 47, type: !13)
!248 = !DILocalVariable(name: "_check_init_ptr", scope: !249, file: !1, line: 49, type: !13)
!249 = distinct !DILexicalBlock(scope: !241, file: !1, line: 49, column: 3)
!250 = !DILocation(line: 43, column: 1, scope: !241)
!251 = !DILocation(line: 47, column: 26, scope: !241)
!252 = !DILocation(line: 47, column: 18, scope: !241)
!253 = !DILocation(line: 49, column: 3, scope: !249)
!254 = !DILocation(line: 49, column: 3, scope: !255)
!255 = distinct !DILexicalBlock(scope: !249, file: !1, line: 49, column: 3)
!256 = !{!257, !258, i64 80}
!257 = !{!"_reent", !258, i64 0, !261, i64 8, !261, i64 16, !261, i64 24, !258, i64 32, !259, i64 36, !258, i64 64, !261, i64 72, !258, i64 80, !261, i64 88, !261, i64 96, !258, i64 104, !261, i64 112, !261, i64 120, !258, i64 128, !261, i64 136, !259, i64 144, !261, i64 504, !262, i64 512, !261, i64 1304, !264, i64 1312, !259, i64 1336}
!258 = !{!"int", !259, i64 0}
!259 = !{!"omnipotent char", !260, i64 0}
!260 = !{!"Simple C/C++ TBAA"}
!261 = !{!"any pointer", !259, i64 0}
!262 = !{!"_atexit", !261, i64 0, !258, i64 8, !259, i64 16, !263, i64 272}
!263 = !{!"_on_exit_args", !259, i64 0, !259, i64 256, !258, i64 512, !258, i64 516}
!264 = !{!"_glue", !261, i64 0, !258, i64 8, !261, i64 16}
!265 = !DILocation(line: 33, column: 1, scope: !7, inlinedAt: !266)
!266 = distinct !DILocation(line: 50, column: 10, scope: !241)
!267 = !DILocation(line: 39, column: 10, scope: !7, inlinedAt: !266)
!268 = !DILocation(line: 39, column: 3, scope: !7, inlinedAt: !266)
!269 = !DILocation(line: 50, column: 3, scope: !241)
