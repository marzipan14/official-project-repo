...
; <label>:6:                                      ; preds = %1
  ...
  br i1 %8, label %9, label %41, !dbg !520
...
; <label>:41:                                     ; preds = %6, %22, %28, %29, %37
  %42 = phi i32 [ 0, %22 ], [ %19, %28 ], [ 16, %29 ], [ %7, %6 ], [ %38, %37 ], !dbg !567
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %3) #4, !dbg !568
...
!567 = !DILocation(line: 0, scope: !495)
!568 = !DILocation(line: 154, column: 1, scope: !495)
