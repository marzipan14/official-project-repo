...
; <label>:112:                                    ; preds = %70, %110
  ...
  br label %113, !dbg !553

; <label>:113:                                    ; preds = %48, %59, %112
  %114 = phi %union.TString* [ %73, %112 ], [ %49, %48 ], [ %49, %59 ], !dbg !554
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !555
  ret %union.TString* %114, !dbg !555
}
...
; Function Attrs: noredzone nounwind
define hidden %union.Udata* @luaS_newudata(%struct.lua_State*, i64, %struct.Table*) local_unnamed_addr #0 !dbg !556 {
  %4 = icmp ugt i64 %1, -43, !dbg !569
  br i1 %4, label %5, label %7, !dbg !571

; <label>:5:                                      ; preds = %3
  %6 = tail call i8* @luaM_toobig(%struct.lua_State* %0) #3, !dbg !572
  br label %7, !dbg !572

; <label>:7:                                      ; preds = %5, %3
  %8 = add i64 %1, 40, !dbg !573
  %9 = tail call i8* @luaM_realloc_(%struct.lua_State* %0, i8* null, i64 0, i64 %8) #3, !dbg !573
  %10 = bitcast i8* %9 to %union.Udata*, !dbg !573
  %11 = getelementptr inbounds %struct.lua_State, %struct.lua_State* %0, i64 0, i32 6, !dbg !575
  %12 = load %struct.global_State*, %struct.global_State** %11, align 8, !dbg !575, !tbaa !366
  %13 = getelementptr inbounds %struct.global_State, %struct.global_State* %12, i64 0, i32 3, !dbg !575
  %14 = load i8, i8* %13, align 8, !dbg !575, !tbaa !490
  %15 = and i8 %14, 3, !dbg !575
  %16 = getelementptr inbounds i8, i8* %9, i64 9, !dbg !576
  store i8 %15, i8* %16, align 1, !dbg !577, !tbaa !415
  %17 = getelementptr inbounds i8, i8* %9, i64 8, !dbg !578
  store i8 7, i8* %17, align 8, !dbg !579, !tbaa !415
  %18 = getelementptr inbounds i8, i8* %9, i64 32, !dbg !580
  %19 = bitcast i8* %18 to i64*, !dbg !580
  store i64 %1, i64* %19, align 8, !dbg !581, !tbaa !415
  %20 = getelementptr inbounds i8, i8* %9, i64 16, !dbg !582
  %21 = bitcast i8* %20 to %struct.Table**, !dbg !582
  store %struct.Table* null, %struct.Table** %21, align 8, !dbg !583, !tbaa !415
  %22 = getelementptr inbounds i8, i8* %9, i64 24, !dbg !584
  %23 = bitcast i8* %22 to %struct.Table**, !dbg !584
  store %struct.Table* %2, %struct.Table** %23, align 8, !dbg !585, !tbaa !415
  %24 = load %struct.global_State*, %struct.global_State** %11, align 8, !dbg !586, !tbaa !366
  %25 = getelementptr inbounds %struct.global_State, %struct.global_State* %24, i64 0, i32 21, !dbg !587
  %26 = bitcast %struct.lua_State** %25 to i64**, !dbg !587
  %27 = load i64*, i64** %26, align 8, !dbg !587, !tbaa !588
  %28 = load i64, i64* %27, align 8, !dbg !589, !tbaa !590
  %29 = bitcast i8* %9 to i64*, !dbg !591
  store i64 %28, i64* %29, align 8, !dbg !591, !tbaa !415
  %30 = load %struct.global_State*, %struct.global_State** %11, align 8, !dbg !592, !tbaa !366
  %31 = getelementptr inbounds %struct.global_State, %struct.global_State* %30, i64 0, i32 21, !dbg !593
  %32 = bitcast %struct.lua_State** %31 to i8***, !dbg !593
  %33 = load i8**, i8*** %32, align 8, !dbg !593, !tbaa !588
  store i8* %9, i8** %33, align 8, !dbg !594, !tbaa !590
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !595
  ret %union.Udata* %10, !dbg !595
}
...
!552 = !DILocation(line: 71, column: 3, scope: !497, inlinedAt: !507)
!553 = !DILocation(line: 92, column: 3, scope: !432)
!554 = !DILocation(line: 0, scope: !432)
!555 = !DILocation(line: 93, column: 1, scope: !432)
!556 = distinct !DISubprogram(name: "luaS_newudata", scope: !1, file: !1, line: 96, type: !557, isLocal: false, isDefinition: true, scopeLine: 96, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !561)
!557 = !DISubroutineType(types: !558)
!558 = !{!338, !128, !44, !559}
!559 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !560, size: 64)
!560 = !DIDerivedType(tag: DW_TAG_typedef, name: "Table", file: !7, line: 348, baseType: !61)
!561 = !{!562, !563, !564, !565}
!562 = !DILocalVariable(name: "L", arg: 1, scope: !556, file: !1, line: 96, type: !128)
!563 = !DILocalVariable(name: "s", arg: 2, scope: !556, file: !1, line: 96, type: !44)
!564 = !DILocalVariable(name: "e", arg: 3, scope: !556, file: !1, line: 96, type: !559)
!565 = !DILocalVariable(name: "u", scope: !556, file: !1, line: 97, type: !338)
!566 = !DILocation(line: 96, column: 34, scope: !556)
!567 = !DILocation(line: 96, column: 44, scope: !556)
!568 = !DILocation(line: 96, column: 54, scope: !556)
!569 = !DILocation(line: 98, column: 9, scope: !570)
!570 = distinct !DILexicalBlock(scope: !556, file: !1, line: 98, column: 7)
!571 = !DILocation(line: 98, column: 7, scope: !556)
!572 = !DILocation(line: 99, column: 5, scope: !570)
!573 = !DILocation(line: 100, column: 7, scope: !556)
!574 = !DILocation(line: 97, column: 10, scope: !556)
!575 = !DILocation(line: 101, column: 18, scope: !556)
!576 = !DILocation(line: 101, column: 9, scope: !556)
!577 = !DILocation(line: 101, column: 16, scope: !556)
!578 = !DILocation(line: 102, column: 9, scope: !556)
!579 = !DILocation(line: 102, column: 12, scope: !556)
!580 = !DILocation(line: 103, column: 9, scope: !556)
!581 = !DILocation(line: 103, column: 13, scope: !556)
!582 = !DILocation(line: 104, column: 9, scope: !556)
!583 = !DILocation(line: 104, column: 19, scope: !556)
!584 = !DILocation(line: 105, column: 9, scope: !556)
!585 = !DILocation(line: 105, column: 13, scope: !556)
!586 = !DILocation(line: 107, column: 16, scope: !556)
!587 = !DILocation(line: 107, column: 22, scope: !556)
!588 = !{!377, !368, i64 176}
!589 = !DILocation(line: 107, column: 34, scope: !556)
!590 = !{!367, !368, i64 0}
!591 = !DILocation(line: 107, column: 14, scope: !556)
!592 = !DILocation(line: 108, column: 3, scope: !556)
!593 = !DILocation(line: 108, column: 9, scope: !556)
!594 = !DILocation(line: 108, column: 26, scope: !556)
!595 = !DILocation(line: 109, column: 3, scope: !556)
