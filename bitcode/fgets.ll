...
; <label>:70:                                     ; preds = %66, %64, %4
  %71 = phi i8* [ null, %4 ], [ %1, %66 ], [ %65, %64 ], !dbg !353
...
; Function Attrs: noredzone nounwind
define dso_local i8* @fgets(i8* noalias, i32, %struct.__sFILE* noalias) local_unnamed_addr #0 !dbg !355 {
  %4 = tail call %struct._reent* @__getreent() #4, !dbg !363
  %5 = tail call i8* @_fgets_r(%struct._reent* %4, i8* %0, i32 %1, %struct.__sFILE* %2) #6, !dbg !364
...
!353 = !DILocation(line: 0, scope: !312)
!354 = !DILocation(line: 215, column: 1, scope: !29)
!355 = distinct !DISubprogram(name: "fgets", scope: !1, file: !1, line: 220, type: !356, isLocal: false, isDefinition: true, scopeLine: 224, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !358)
!356 = !DISubroutineType(types: !357)
!357 = !{!32, !248, !5, !249}
!358 = !{!359, !360, !361}
!359 = !DILocalVariable(name: "buf", arg: 1, scope: !355, file: !1, line: 220, type: !248)
!360 = !DILocalVariable(name: "n", arg: 2, scope: !355, file: !1, line: 220, type: !5)
!361 = !DILocalVariable(name: "fp", arg: 3, scope: !355, file: !1, line: 220, type: !249)
!362 = !DILocation(line: 220, column: 1, scope: !355)
!363 = !DILocation(line: 225, column: 20, scope: !355)
!364 = !DILocation(line: 225, column: 10, scope: !355)
!365 = !DILocation(line: 225, column: 3, scope: !355)
