...
; <label>:18:                                     ; preds = %10, %21
  ...
  br i1 %20, label %27, label %21, !dbg !291
...
; <label>:27:                                     ; preds = %21, %18, %3, %14
  %28 = phi i32 [ -1, %14 ], [ -1, %3 ], [ -1, %21 ], [ %1, %18 ]
  %29 = load i32, i32* %5, align 4, !dbg !302, !tbaa !303
  %30 = call i32 @pthread_setcancelstate(i32 %29, i32* nonnull %5) #5, !dbg !302
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %7) #4, !dbg !304
  call void @llvm.lifetime.end.p0i8(i64 1, i8* nonnull %6) #4, !dbg !305
...
; Function Attrs: noredzone nounwind
define dso_local i32 @ungetwc(i32, %struct.__sFILE*) local_unnamed_addr #0 !dbg !307 {
  %3 = alloca [1 x i8], align 1
  %4 = alloca i32, align 4
  %5 = tail call %struct._reent* @__getreent() #5, !dbg !319
  %6 = icmp eq %struct._reent* %5, null, !dbg !322
  br i1 %6, label %12, label %7, !dbg !322

; <label>:7:                                      ; preds = %2
  %8 = getelementptr inbounds %struct._reent, %struct._reent* %5, i64 0, i32 8, !dbg !322
  %9 = load i32, i32* %8, align 8, !dbg !322, !tbaa !324
  %10 = icmp eq i32 %9, 0, !dbg !322
  br i1 %10, label %11, label %12, !dbg !321

; <label>:11:                                     ; preds = %7
  tail call void @__sinit(%struct._reent* nonnull %5) #5, !dbg !322
  br label %12, !dbg !322

; <label>:12:                                     ; preds = %7, %2, %11
  %13 = getelementptr inbounds [1 x i8], [1 x i8]* %3, i64 0, i64 0, !dbg !330
  call void @llvm.lifetime.start.p0i8(i64 1, i8* nonnull %13) #4, !dbg !330
  %14 = bitcast i32* %4 to i8*, !dbg !331
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %14) #4, !dbg !331
  %15 = call i32 @pthread_setcancelstate(i32 1, i32* nonnull %4) #5, !dbg !331
  %16 = icmp eq i32 %0, -1, !dbg !332
  br i1 %16, label %34, label %17, !dbg !333

; <label>:17:                                     ; preds = %12
  %18 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %1, i64 0, i32 22, !dbg !334
  %19 = call i64 @_wcrtomb_r(%struct._reent* %5, i8* nonnull %13, i32 %0, %struct._mbstate_t* nonnull %18) #5, !dbg !335
  %20 = icmp eq i64 %19, -1, !dbg !337
  br i1 %20, label %21, label %25, !dbg !338

; <label>:21:                                     ; preds = %17
  %22 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %1, i64 0, i32 3, !dbg !339
  %23 = load i16, i16* %22, align 8, !dbg !340, !tbaa !278
  %24 = or i16 %23, 64, !dbg !340
  store i16 %24, i16* %22, align 8, !dbg !340, !tbaa !278
  br label %34, !dbg !341

; <label>:25:                                     ; preds = %17, %28
  %26 = phi i64 [ %29, %28 ], [ %19, %17 ], !dbg !342
  %27 = icmp eq i64 %26, 0, !dbg !343
  br i1 %27, label %34, label %28, !dbg !344

; <label>:28:                                     ; preds = %25
  %29 = add i64 %26, -1, !dbg !345
  %30 = load i8, i8* %13, align 1, !dbg !346, !tbaa !295
  %31 = zext i8 %30 to i32, !dbg !347
  %32 = call i32 @_ungetc_r(%struct._reent* %5, i32 %31, %struct.__sFILE* %1) #5, !dbg !348
  %33 = icmp eq i32 %32, -1, !dbg !349
  br i1 %33, label %34, label %25, !dbg !350, !llvm.loop !300

; <label>:34:                                     ; preds = %25, %28, %12, %21
  %35 = phi i32 [ -1, %21 ], [ -1, %12 ], [ %0, %25 ], [ -1, %28 ]
  %36 = load i32, i32* %4, align 4, !dbg !351, !tbaa !303
  %37 = call i32 @pthread_setcancelstate(i32 %36, i32* nonnull %4) #5, !dbg !351
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %14) #4, !dbg !352
  call void @llvm.lifetime.end.p0i8(i64 1, i8* nonnull %13) #4, !dbg !353
...
!302 = !DILocation(line: 101, column: 3, scope: !261)
!303 = !{!283, !283, i64 0}
!304 = !DILocation(line: 101, column: 3, scope: !32)
!305 = !DILocation(line: 103, column: 1, scope: !32)
!306 = !DILocation(line: 102, column: 3, scope: !32)
!307 = distinct !DISubprogram(name: "ungetwc", scope: !1, file: !1, line: 109, type: !308, isLocal: false, isDefinition: true, scopeLine: 112, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !310)
!308 = !DISubroutineType(types: !309)
!309 = !{!22, !22, !250}
!310 = !{!311, !312, !313, !314}
!311 = !DILocalVariable(name: "wc", arg: 1, scope: !307, file: !1, line: 109, type: !22)
!312 = !DILocalVariable(name: "fp", arg: 2, scope: !307, file: !1, line: 109, type: !250)
!313 = !DILocalVariable(name: "reent", scope: !307, file: !1, line: 113, type: !35)
!314 = !DILocalVariable(name: "_check_init_ptr", scope: !315, file: !1, line: 115, type: !35)
!315 = distinct !DILexicalBlock(scope: !307, file: !1, line: 115, column: 3)
!316 = !DILocation(line: 82, column: 8, scope: !32, inlinedAt: !317)
!317 = distinct !DILocation(line: 116, column: 10, scope: !307)
!318 = !DILocation(line: 109, column: 1, scope: !307)
!319 = !DILocation(line: 113, column: 26, scope: !307)
!320 = !DILocation(line: 113, column: 18, scope: !307)
!321 = !DILocation(line: 115, column: 3, scope: !315)
!322 = !DILocation(line: 115, column: 3, scope: !323)
!323 = distinct !DILexicalBlock(scope: !315, file: !1, line: 115, column: 3)
!324 = !{!325, !283, i64 80}
!325 = !{!"_reent", !283, i64 0, !280, i64 8, !280, i64 16, !280, i64 24, !283, i64 32, !281, i64 36, !283, i64 64, !280, i64 72, !283, i64 80, !280, i64 88, !280, i64 96, !283, i64 104, !280, i64 112, !280, i64 120, !283, i64 128, !280, i64 136, !281, i64 144, !280, i64 504, !326, i64 512, !280, i64 1304, !328, i64 1312, !281, i64 1336}
!326 = !{!"_atexit", !280, i64 0, !283, i64 8, !281, i64 16, !327, i64 272}
!327 = !{!"_on_exit_args", !281, i64 0, !281, i64 256, !283, i64 512, !283, i64 516}
!328 = !{!"_glue", !280, i64 0, !283, i64 8, !280, i64 16}
!329 = !DILocation(line: 77, column: 1, scope: !32, inlinedAt: !317)
!330 = !DILocation(line: 82, column: 3, scope: !32, inlinedAt: !317)
!331 = !DILocation(line: 85, column: 3, scope: !261, inlinedAt: !317)
!332 = !DILocation(line: 87, column: 10, scope: !267, inlinedAt: !317)
!333 = !DILocation(line: 87, column: 7, scope: !261, inlinedAt: !317)
!334 = !DILocation(line: 89, column: 49, scope: !270, inlinedAt: !317)
!335 = !DILocation(line: 89, column: 19, scope: !270, inlinedAt: !317)
!336 = !DILocation(line: 83, column: 10, scope: !32, inlinedAt: !317)
!337 = !DILocation(line: 89, column: 60, scope: !270, inlinedAt: !317)
!338 = !DILocation(line: 89, column: 12, scope: !267, inlinedAt: !317)
!339 = !DILocation(line: 91, column: 11, scope: !276, inlinedAt: !317)
!340 = !DILocation(line: 91, column: 18, scope: !276, inlinedAt: !317)
!341 = !DILocation(line: 93, column: 5, scope: !276, inlinedAt: !317)
!342 = !DILocation(line: 0, scope: !270, inlinedAt: !317)
!343 = !DILocation(line: 95, column: 18, scope: !270, inlinedAt: !317)
!344 = !DILocation(line: 95, column: 5, scope: !270, inlinedAt: !317)
!345 = !DILocation(line: 95, column: 15, scope: !270, inlinedAt: !317)
!346 = !DILocation(line: 96, column: 41, scope: !294, inlinedAt: !317)
!347 = !DILocation(line: 96, column: 26, scope: !294, inlinedAt: !317)
!348 = !DILocation(line: 96, column: 11, scope: !294, inlinedAt: !317)
!349 = !DILocation(line: 96, column: 55, scope: !294, inlinedAt: !317)
!350 = !DILocation(line: 96, column: 11, scope: !270, inlinedAt: !317)
!351 = !DILocation(line: 101, column: 3, scope: !261, inlinedAt: !317)
!352 = !DILocation(line: 101, column: 3, scope: !32, inlinedAt: !317)
!353 = !DILocation(line: 103, column: 1, scope: !32, inlinedAt: !317)
!354 = !DILocation(line: 102, column: 3, scope: !32, inlinedAt: !317)
!355 = !DILocation(line: 116, column: 3, scope: !307)
