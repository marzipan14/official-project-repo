...
define dso_local i32 @_rename_r(%struct._reent*, i8*, i8*) local_unnamed_addr #0 !dbg !7 {
  ...
  br i1 %5, label %10, label %6, !dbg !240

; <label>:6:                                      ; preds = %3
  %7 = tail call i32 @_unlink_r(%struct._reent* %0, i8* %1) #3, !dbg !241
  %8 = icmp eq i32 %7, -1, !dbg !243
  %9 = sext i1 %8 to i32, !dbg !244
  br label %10, !dbg !244

; <label>:10:                                     ; preds = %6, %3
  %11 = phi i32 [ -1, %3 ], [ %9, %6 ], !dbg !246
...
!241 = !DILocation(line: 65, column: 7, scope: !242)
!242 = distinct !DILexicalBlock(scope: !7, file: !1, line: 65, column: 7)
!243 = !DILocation(line: 65, column: 28, scope: !242)
!244 = !DILocation(line: 68, column: 7, scope: !245)
!245 = distinct !DILexicalBlock(scope: !242, file: !1, line: 66, column: 5)
!246 = !DILocation(line: 0, scope: !7)
!247 = !DILocation(line: 72, column: 1, scope: !7)
