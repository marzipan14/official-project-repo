...
define dso_local i64 @regerror(i32, %struct.regex_t* noalias nocapture readonly, i8* noalias, i64) local_unnamed_addr #0 !dbg !21 {
  ...
  br i1 %8, label %9, label %67, !dbg !69
...
; <label>:17:                                     ; preds = %62, %59, %56, %53, %50, %47, %44, %41, %38, %35, %32, %29, %26, %23, %14, %9
  ...
  br i1 %20, label %65, label %21, !dbg !100
...
; <label>:62:                                     ; preds = %59
  ...
  br i1 %64, label %17, label %65, !dbg !94

; <label>:65:                                     ; preds = %17, %21, %62
  %66 = phi i8* [ %7, %21 ], [ getelementptr inbounds ([2 x i8], [2 x i8]* @.str.35, i64 0, i64 0), %17 ], [ getelementptr inbounds ([2 x i8], [2 x i8]* @.str.35, i64 0, i64 0), %62 ], !dbg !103
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !104
  br label %88, !dbg !106

; <label>:67:                                     ; preds = %4, %67
  %68 = phi %struct.rerr* [ %74, %67 ], [ getelementptr inbounds ([17 x %struct.rerr], [17 x %struct.rerr]* @rerrs, i64 0, i64 0), %4 ], !dbg !107
  %69 = getelementptr inbounds %struct.rerr, %struct.rerr* %68, i64 0, i32 0, !dbg !112
  %70 = load i32, i32* %69, align 8, !dbg !112, !tbaa !97
  %71 = icmp eq i32 %70, 0, !dbg !113
  %72 = icmp eq i32 %70, %6, !dbg !114
  %73 = or i1 %71, %72, !dbg !116
  %74 = getelementptr inbounds %struct.rerr, %struct.rerr* %68, i64 1, !dbg !117
  br i1 %73, label %75, label %67, !dbg !116, !llvm.loop !118

; <label>:75:                                     ; preds = %67
  %76 = and i32 %0, 256, !dbg !120
  %77 = icmp eq i32 %76, 0, !dbg !120
  br i1 %77, label %85, label %78, !dbg !122

; <label>:78:                                     ; preds = %75
  br i1 %71, label %83, label %79, !dbg !123

; <label>:79:                                     ; preds = %78
  %80 = getelementptr inbounds %struct.rerr, %struct.rerr* %68, i64 0, i32 1, !dbg !125
  %81 = load i8*, i8** %80, align 8, !dbg !125, !tbaa !127
  %82 = call i8* @strcpy(i8* nonnull %7, i8* %81) #5, !dbg !128
  br label %88, !dbg !129

; <label>:83:                                     ; preds = %78
  %84 = call i32 (i8*, i8*, ...) @sprintf(i8* nonnull %7, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str, i64 0, i64 0), i32 %6) #5, !dbg !130
  br label %88

; <label>:85:                                     ; preds = %75
  %86 = getelementptr inbounds %struct.rerr, %struct.rerr* %68, i64 0, i32 2, !dbg !131
  %87 = load i8*, i8** %86, align 8, !dbg !131, !tbaa !132
  br label %88

; <label>:88:                                     ; preds = %79, %83, %85, %65
  %89 = phi i8* [ %66, %65 ], [ %87, %85 ], [ %7, %83 ], [ %7, %79 ], !dbg !133
  %90 = call i64 @strlen(i8* %89) #5, !dbg !134
  %91 = add i64 %90, 1, !dbg !135
  %92 = icmp eq i64 %3, 0, !dbg !137
  br i1 %92, label %101, label %93, !dbg !139

; <label>:93:                                     ; preds = %88
  %94 = icmp ult i64 %91, %3, !dbg !140
  br i1 %94, label %95, label %97, !dbg !143

; <label>:95:                                     ; preds = %93
  %96 = call i8* @strcpy(i8* %2, i8* %89) #5, !dbg !144
  br label %101, !dbg !145

; <label>:97:                                     ; preds = %93
  %98 = add i64 %3, -1, !dbg !146
  %99 = call i8* @strncpy(i8* %2, i8* %89, i64 %98) #5, !dbg !148
  %100 = getelementptr inbounds i8, i8* %2, i64 %98, !dbg !149
  store i8 0, i8* %100, align 1, !dbg !150, !tbaa !151
  br label %101

; <label>:101:                                    ; preds = %88, %95, %97
  call void @llvm.lifetime.end.p0i8(i64 50, i8* nonnull %7) #4, !dbg !152
...
!103 = !DILocation(line: 0, scope: !71, inlinedAt: !78)
!104 = !DILocation(line: 177, column: 1, scope: !71, inlinedAt: !78)
!105 = !DILocation(line: 124, column: 8, scope: !21)
!106 = !DILocation(line: 128, column: 3, scope: !68)
!107 = !DILocation(line: 0, scope: !108)
!108 = distinct !DILexicalBlock(scope: !109, file: !3, line: 130, column: 3)
!109 = distinct !DILexicalBlock(scope: !110, file: !3, line: 130, column: 3)
!110 = distinct !DILexicalBlock(scope: !68, file: !3, line: 129, column: 7)
!111 = !DILocation(line: 121, column: 15, scope: !21)
!112 = !DILocation(line: 130, column: 22, scope: !108)
!113 = !DILocation(line: 130, column: 27, scope: !108)
!114 = !DILocation(line: 131, column: 16, scope: !115)
!115 = distinct !DILexicalBlock(scope: !108, file: !3, line: 131, column: 8)
!116 = !DILocation(line: 130, column: 3, scope: !109)
!117 = !DILocation(line: 130, column: 34, scope: !108)
!118 = distinct !{!118, !116, !119}
!119 = !DILocation(line: 132, column: 5, scope: !109)
!120 = !DILocation(line: 134, column: 14, scope: !121)
!121 = distinct !DILexicalBlock(scope: !110, file: !3, line: 134, column: 7)
!122 = !DILocation(line: 134, column: 7, scope: !110)
!123 = !DILocation(line: 135, column: 8, scope: !124)
!124 = distinct !DILexicalBlock(scope: !121, file: !3, line: 134, column: 25)
!125 = !DILocation(line: 136, column: 31, scope: !126)
!126 = distinct !DILexicalBlock(scope: !124, file: !3, line: 135, column: 8)
!127 = !{!98, !91, i64 8}
!128 = !DILocation(line: 136, column: 12, scope: !126)
!129 = !DILocation(line: 136, column: 5, scope: !126)
!130 = !DILocation(line: 138, column: 5, scope: !126)
!131 = !DILocation(line: 142, column: 11, scope: !121)
!132 = !{!98, !91, i64 16}
!133 = !DILocation(line: 0, scope: !121)
!134 = !DILocation(line: 145, column: 8, scope: !21)
!135 = !DILocation(line: 145, column: 18, scope: !21)
!136 = !DILocation(line: 122, column: 9, scope: !21)
!137 = !DILocation(line: 146, column: 18, scope: !138)
!138 = distinct !DILexicalBlock(scope: !21, file: !3, line: 146, column: 6)
!139 = !DILocation(line: 146, column: 6, scope: !21)
!140 = !DILocation(line: 147, column: 19, scope: !141)
!141 = distinct !DILexicalBlock(scope: !142, file: !3, line: 147, column: 7)
!142 = distinct !DILexicalBlock(scope: !138, file: !3, line: 146, column: 23)
!143 = !DILocation(line: 147, column: 7, scope: !142)
!144 = !DILocation(line: 148, column: 11, scope: !141)
!145 = !DILocation(line: 148, column: 4, scope: !141)
!146 = !DILocation(line: 150, column: 41, scope: !147)
!147 = distinct !DILexicalBlock(scope: !141, file: !3, line: 149, column: 8)
!148 = !DILocation(line: 150, column: 11, scope: !147)
!149 = !DILocation(line: 151, column: 4, scope: !147)
!150 = !DILocation(line: 151, column: 26, scope: !147)
!151 = !{!88, !88, i64 0}
!152 = !DILocation(line: 156, column: 1, scope: !21)
!153 = !DILocation(line: 155, column: 2, scope: !21)
