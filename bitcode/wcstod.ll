...
; <label>:9:                                      ; preds = %3, %8
  %10 = phi %struct.__locale_t* [ @__global_locale, %8 ], [ %6, %3 ], !dbg !399
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !413
  %11 = tail call double @_wcstod_l(%struct._reent* %0, i32* %1, i32** %2, %struct.__locale_t* nonnull %10) #6, !dbg !414
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !415
  ret double %11, !dbg !415
}

; Function Attrs: noredzone nounwind
define dso_local float @_wcstof_r(%struct._reent*, i32*, i32**) local_unnamed_addr #0 !dbg !416 {
  %4 = tail call %struct._reent* @__getreent() #5, !dbg !425
  %5 = getelementptr inbounds %struct._reent, %struct._reent* %4, i64 0, i32 7, !dbg !427
  %6 = load %struct.__locale_t*, %struct.__locale_t** %5, align 8, !dbg !427, !tbaa !405
  %7 = icmp eq %struct.__locale_t* %6, null, !dbg !425
...
; <label>:9:                                      ; preds = %3, %8
  %10 = phi %struct.__locale_t* [ @__global_locale, %8 ], [ %6, %3 ], !dbg !425
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !430
  %11 = tail call double @_wcstod_l(%struct._reent* %0, i32* %1, i32** %2, %struct.__locale_t* nonnull %10) #6, !dbg !431
  %12 = tail call i32 @__fpclassifyd(double %11) #5, !dbg !433
  %13 = icmp eq i32 %12, 0, !dbg !433
  br i1 %13, label %14, label %16, !dbg !435

; <label>:14:                                     ; preds = %9
  %15 = tail call float @nanf(i8* null) #5, !dbg !436
  br label %18, !dbg !437

; <label>:16:                                     ; preds = %9
  %17 = fptrunc double %11 to float, !dbg !438
  br label %18, !dbg !439

; <label>:18:                                     ; preds = %16, %14
  %19 = phi float [ %15, %14 ], [ %17, %16 ], !dbg !440
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !441
  ret float %19, !dbg !441
}
...
; Function Attrs: noredzone nounwind
define dso_local double @wcstod_l(i32* noalias, i32** noalias, %struct.__locale_t*) local_unnamed_addr #0 !dbg !442 {
  %4 = tail call %struct._reent* @__getreent() #5, !dbg !454
  %5 = tail call double @_wcstod_l(%struct._reent* %4, i32* %0, i32** %1, %struct.__locale_t* %2) #6, !dbg !455
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !456
  ret double %5, !dbg !456
}
...
; Function Attrs: noredzone nounwind
define dso_local double @wcstod(i32* noalias, i32** noalias) local_unnamed_addr #0 !dbg !457 {
  %3 = tail call %struct._reent* @__getreent() #5, !dbg !464
  %4 = tail call %struct._reent* @__getreent() #5, !dbg !465
  %5 = getelementptr inbounds %struct._reent, %struct._reent* %4, i64 0, i32 7, !dbg !467
  %6 = load %struct.__locale_t*, %struct.__locale_t** %5, align 8, !dbg !467, !tbaa !405
  %7 = icmp eq %struct.__locale_t* %6, null, !dbg !465
  br i1 %7, label %8, label %9, !dbg !465
...
; <label>:9:                                      ; preds = %2, %8
  %10 = phi %struct.__locale_t* [ @__global_locale, %8 ], [ %6, %2 ], !dbg !465
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !470
  %11 = tail call double @_wcstod_l(%struct._reent* %3, i32* %0, i32** %1, %struct.__locale_t* nonnull %10) #6, !dbg !471
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !472
  ret double %11, !dbg !472
}

; Function Attrs: noredzone nounwind
define dso_local float @wcstof_l(i32* noalias, i32** noalias, %struct.__locale_t*) local_unnamed_addr #0 !dbg !473 {
  %4 = tail call %struct._reent* @__getreent() #5, !dbg !485
  %5 = tail call double @_wcstod_l(%struct._reent* %4, i32* %0, i32** %1, %struct.__locale_t* %2) #6, !dbg !486
  %6 = tail call i32 @__fpclassifyd(double %5) #5, !dbg !488
  %7 = icmp eq i32 %6, 0, !dbg !488
  br i1 %7, label %8, label %10, !dbg !490

; <label>:8:                                      ; preds = %3
  %9 = tail call float @nanf(i8* null) #5, !dbg !491
  br label %20, !dbg !492

; <label>:10:                                     ; preds = %3
  %11 = fptrunc double %5 to float, !dbg !493
  %12 = tail call i32 @__fpclassifyf(float %11) #5, !dbg !495
  %13 = icmp eq i32 %12, 1, !dbg !495
  br i1 %13, label %14, label %20, !dbg !497

; <label>:14:                                     ; preds = %10
  %15 = tail call i32 @__fpclassifyd(double %5) #5, !dbg !498
  %16 = icmp eq i32 %15, 1, !dbg !498
  br i1 %16, label %20, label %17, !dbg !499

; <label>:17:                                     ; preds = %14
  %18 = tail call %struct._reent* @__getreent() #5, !dbg !500
  %19 = getelementptr inbounds %struct._reent, %struct._reent* %18, i64 0, i32 0, !dbg !501
  store i32 34, i32* %19, align 8, !dbg !502, !tbaa !503
  br label %20, !dbg !500

; <label>:20:                                     ; preds = %10, %14, %17, %8
  %21 = phi float [ %9, %8 ], [ %11, %17 ], [ %11, %14 ], [ %11, %10 ], !dbg !504
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !505
  ret float %21, !dbg !505
}
...
; Function Attrs: noredzone nounwind
define dso_local float @wcstof(i32* noalias, i32** noalias) local_unnamed_addr #0 !dbg !506 {
  %3 = tail call %struct._reent* @__getreent() #5, !dbg !515
  %4 = tail call %struct._reent* @__getreent() #5, !dbg !516
  %5 = getelementptr inbounds %struct._reent, %struct._reent* %4, i64 0, i32 7, !dbg !518
  %6 = load %struct.__locale_t*, %struct.__locale_t** %5, align 8, !dbg !518, !tbaa !405
  %7 = icmp eq %struct.__locale_t* %6, null, !dbg !516
  br i1 %7, label %8, label %9, !dbg !516
...
; <label>:9:                                      ; preds = %2, %8
  %10 = phi %struct.__locale_t* [ @__global_locale, %8 ], [ %6, %2 ], !dbg !516
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !521
  %11 = tail call double @_wcstod_l(%struct._reent* %3, i32* %0, i32** %1, %struct.__locale_t* nonnull %10) #6, !dbg !522
  %12 = tail call i32 @__fpclassifyd(double %11) #5, !dbg !524
  %13 = icmp eq i32 %12, 0, !dbg !524
  br i1 %13, label %14, label %16, !dbg !526

; <label>:14:                                     ; preds = %9
  %15 = tail call float @nanf(i8* null) #5, !dbg !527
  br label %26, !dbg !528

; <label>:16:                                     ; preds = %9
  %17 = fptrunc double %11 to float, !dbg !529
  %18 = tail call i32 @__fpclassifyf(float %17) #5, !dbg !531
  %19 = icmp eq i32 %18, 1, !dbg !531
  br i1 %19, label %20, label %26, !dbg !533

; <label>:20:                                     ; preds = %16
  %21 = tail call i32 @__fpclassifyd(double %11) #5, !dbg !534
  %22 = icmp eq i32 %21, 1, !dbg !534
  br i1 %22, label %26, label %23, !dbg !535

; <label>:23:                                     ; preds = %20
  %24 = tail call %struct._reent* @__getreent() #5, !dbg !536
  %25 = getelementptr inbounds %struct._reent, %struct._reent* %24, i64 0, i32 0, !dbg !537
  store i32 34, i32* %25, align 8, !dbg !538, !tbaa !503
  br label %26, !dbg !536

; <label>:26:                                     ; preds = %16, %20, %23, %14
  %27 = phi float [ %15, %14 ], [ %17, %23 ], [ %17, %20 ], [ %17, %16 ], !dbg !539
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !540
  ret float %27, !dbg !540
}
...
!410 = !DILocation(line: 213, column: 3, scope: !411, inlinedAt: !412)
!411 = distinct !DISubprogram(name: "__get_global_locale", scope: !117, file: !117, line: 210, type: !401, isLocal: true, isDefinition: true, scopeLine: 211, isOptimized: true, unit: !0, retainedNodes: !2)
!412 = distinct !DILocation(line: 230, column: 29, scope: !400, inlinedAt: !403)
!413 = !DILocation(line: 230, column: 3, scope: !400, inlinedAt: !403)
!414 = !DILocation(line: 242, column: 10, scope: !391)
!415 = !DILocation(line: 242, column: 3, scope: !391)
!416 = distinct !DISubprogram(name: "_wcstof_r", scope: !1, file: !1, line: 246, type: !417, isLocal: false, isDefinition: true, scopeLine: 250, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !419)
!417 = !DISubroutineType(types: !418)
!418 = !{!14, !22, !292, !294}
!419 = !{!420, !421, !422, !423}
!420 = !DILocalVariable(name: "ptr", arg: 1, scope: !416, file: !1, line: 246, type: !22)
!421 = !DILocalVariable(name: "nptr", arg: 2, scope: !416, file: !1, line: 246, type: !292)
!422 = !DILocalVariable(name: "endptr", arg: 3, scope: !416, file: !1, line: 246, type: !294)
!423 = !DILocalVariable(name: "retval", scope: !416, file: !1, line: 251, type: !21)
!424 = !DILocation(line: 246, column: 1, scope: !416)
!425 = !DILocation(line: 230, column: 10, scope: !400, inlinedAt: !426)
!426 = distinct !DILocation(line: 251, column: 49, scope: !416)
!427 = !DILocation(line: 230, column: 18, scope: !400, inlinedAt: !426)
!428 = !DILocation(line: 213, column: 3, scope: !411, inlinedAt: !429)
!429 = distinct !DILocation(line: 230, column: 29, scope: !400, inlinedAt: !426)
!430 = !DILocation(line: 230, column: 3, scope: !400, inlinedAt: !426)
!431 = !DILocation(line: 251, column: 19, scope: !416)
!432 = !DILocation(line: 251, column: 10, scope: !416)
!433 = !DILocation(line: 252, column: 7, scope: !434)
!434 = distinct !DILexicalBlock(scope: !416, file: !1, line: 252, column: 7)
!435 = !DILocation(line: 252, column: 7, scope: !416)
!436 = !DILocation(line: 253, column: 12, scope: !434)
!437 = !DILocation(line: 253, column: 5, scope: !434)
!438 = !DILocation(line: 254, column: 10, scope: !416)
!439 = !DILocation(line: 254, column: 3, scope: !416)
!440 = !DILocation(line: 0, scope: !416)
!441 = !DILocation(line: 255, column: 1, scope: !416)
!442 = distinct !DISubprogram(name: "wcstod_l", scope: !1, file: !1, line: 260, type: !443, isLocal: false, isDefinition: true, scopeLine: 262, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !447)
!443 = !DISubroutineType(types: !444)
!444 = !{!21, !445, !446, !295}
!445 = !DIDerivedType(tag: DW_TAG_restrict_type, baseType: !292)
!446 = !DIDerivedType(tag: DW_TAG_restrict_type, baseType: !294)
!447 = !{!448, !449, !450}
!448 = !DILocalVariable(name: "nptr", arg: 1, scope: !442, file: !1, line: 260, type: !445)
!449 = !DILocalVariable(name: "endptr", arg: 2, scope: !442, file: !1, line: 260, type: !446)
!450 = !DILocalVariable(name: "loc", arg: 3, scope: !442, file: !1, line: 261, type: !295)
!451 = !DILocation(line: 260, column: 37, scope: !442)
!452 = !DILocation(line: 260, column: 64, scope: !442)
!453 = !DILocation(line: 261, column: 13, scope: !442)
!454 = !DILocation(line: 263, column: 21, scope: !442)
!455 = !DILocation(line: 263, column: 10, scope: !442)
!456 = !DILocation(line: 263, column: 3, scope: !442)
!457 = distinct !DISubprogram(name: "wcstod", scope: !1, file: !1, line: 267, type: !458, isLocal: false, isDefinition: true, scopeLine: 269, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !460)
!458 = !DISubroutineType(types: !459)
!459 = !{!21, !445, !446}
!460 = !{!461, !462}
!461 = !DILocalVariable(name: "nptr", arg: 1, scope: !457, file: !1, line: 267, type: !445)
!462 = !DILocalVariable(name: "endptr", arg: 2, scope: !457, file: !1, line: 267, type: !446)
!463 = !DILocation(line: 267, column: 1, scope: !457)
!464 = !DILocation(line: 270, column: 21, scope: !457)
!465 = !DILocation(line: 230, column: 10, scope: !400, inlinedAt: !466)
!466 = distinct !DILocation(line: 270, column: 43, scope: !457)
!467 = !DILocation(line: 230, column: 18, scope: !400, inlinedAt: !466)
!468 = !DILocation(line: 213, column: 3, scope: !411, inlinedAt: !469)
!469 = distinct !DILocation(line: 230, column: 29, scope: !400, inlinedAt: !466)
!470 = !DILocation(line: 230, column: 3, scope: !400, inlinedAt: !466)
!471 = !DILocation(line: 270, column: 10, scope: !457)
!472 = !DILocation(line: 270, column: 3, scope: !457)
!473 = distinct !DISubprogram(name: "wcstof_l", scope: !1, file: !1, line: 274, type: !474, isLocal: false, isDefinition: true, scopeLine: 276, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !476)
!474 = !DISubroutineType(types: !475)
!475 = !{!14, !445, !446, !295}
!476 = !{!477, !478, !479, !480, !481}
!477 = !DILocalVariable(name: "nptr", arg: 1, scope: !473, file: !1, line: 274, type: !445)
!478 = !DILocalVariable(name: "endptr", arg: 2, scope: !473, file: !1, line: 274, type: !446)
!479 = !DILocalVariable(name: "loc", arg: 3, scope: !473, file: !1, line: 275, type: !295)
!480 = !DILocalVariable(name: "val", scope: !473, file: !1, line: 277, type: !21)
!481 = !DILocalVariable(name: "retval", scope: !473, file: !1, line: 280, type: !14)
!482 = !DILocation(line: 274, column: 37, scope: !473)
!483 = !DILocation(line: 274, column: 64, scope: !473)
!484 = !DILocation(line: 275, column: 13, scope: !473)
!485 = !DILocation(line: 277, column: 27, scope: !473)
!486 = !DILocation(line: 277, column: 16, scope: !473)
!487 = !DILocation(line: 277, column: 10, scope: !473)
!488 = !DILocation(line: 278, column: 7, scope: !489)
!489 = distinct !DILexicalBlock(scope: !473, file: !1, line: 278, column: 7)
!490 = !DILocation(line: 278, column: 7, scope: !473)
!491 = !DILocation(line: 279, column: 12, scope: !489)
!492 = !DILocation(line: 279, column: 5, scope: !489)
!493 = !DILocation(line: 280, column: 18, scope: !473)
!494 = !DILocation(line: 280, column: 9, scope: !473)
!495 = !DILocation(line: 282, column: 7, scope: !496)
!496 = distinct !DILexicalBlock(scope: !473, file: !1, line: 282, column: 7)
!497 = !DILocation(line: 282, column: 22, scope: !496)
!498 = !DILocation(line: 282, column: 26, scope: !496)
!499 = !DILocation(line: 282, column: 7, scope: !473)
!500 = !DILocation(line: 283, column: 5, scope: !496)
!501 = !DILocation(line: 283, column: 13, scope: !496)
!502 = !DILocation(line: 283, column: 20, scope: !496)
!503 = !{!406, !328, i64 0}
!504 = !DILocation(line: 0, scope: !473)
!505 = !DILocation(line: 286, column: 1, scope: !473)
!506 = distinct !DISubprogram(name: "wcstof", scope: !1, file: !1, line: 289, type: !507, isLocal: false, isDefinition: true, scopeLine: 292, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !509)
!507 = !DISubroutineType(types: !508)
!508 = !{!14, !445, !446}
!509 = !{!510, !511, !512, !513}
!510 = !DILocalVariable(name: "nptr", arg: 1, scope: !506, file: !1, line: 289, type: !445)
!511 = !DILocalVariable(name: "endptr", arg: 2, scope: !506, file: !1, line: 289, type: !446)
!512 = !DILocalVariable(name: "val", scope: !506, file: !1, line: 293, type: !21)
!513 = !DILocalVariable(name: "retval", scope: !506, file: !1, line: 296, type: !14)
!514 = !DILocation(line: 289, column: 1, scope: !506)
!515 = !DILocation(line: 293, column: 27, scope: !506)
!516 = !DILocation(line: 230, column: 10, scope: !400, inlinedAt: !517)
!517 = distinct !DILocation(line: 293, column: 49, scope: !506)
!518 = !DILocation(line: 230, column: 18, scope: !400, inlinedAt: !517)
!519 = !DILocation(line: 213, column: 3, scope: !411, inlinedAt: !520)
!520 = distinct !DILocation(line: 230, column: 29, scope: !400, inlinedAt: !517)
!521 = !DILocation(line: 230, column: 3, scope: !400, inlinedAt: !517)
!522 = !DILocation(line: 293, column: 16, scope: !506)
!523 = !DILocation(line: 293, column: 10, scope: !506)
!524 = !DILocation(line: 294, column: 7, scope: !525)
!525 = distinct !DILexicalBlock(scope: !506, file: !1, line: 294, column: 7)
!526 = !DILocation(line: 294, column: 7, scope: !506)
!527 = !DILocation(line: 295, column: 12, scope: !525)
!528 = !DILocation(line: 295, column: 5, scope: !525)
!529 = !DILocation(line: 296, column: 18, scope: !506)
!530 = !DILocation(line: 296, column: 9, scope: !506)
!531 = !DILocation(line: 298, column: 7, scope: !532)
!532 = distinct !DILexicalBlock(scope: !506, file: !1, line: 298, column: 7)
!533 = !DILocation(line: 298, column: 22, scope: !532)
!534 = !DILocation(line: 298, column: 26, scope: !532)
!535 = !DILocation(line: 298, column: 7, scope: !506)
!536 = !DILocation(line: 299, column: 5, scope: !532)
!537 = !DILocation(line: 299, column: 13, scope: !532)
!538 = !DILocation(line: 299, column: 20, scope: !532)
!539 = !DILocation(line: 0, scope: !506)
!540 = !DILocation(line: 303, column: 1, scope: !506)
