; ModuleID = '/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/stdio/rget.c'
source_filename = "/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/stdio/rget.c"
...
define dso_local i32 @__srget_r(%struct._reent*, %struct.__sFILE*) local_unnamed_addr #0 !dbg !7 {
  %3 = icmp eq %struct._reent* %0, null, !dbg !240
  br i1 %3, label %9, label %4, !dbg !240

; <label>:4:                                      ; preds = %2
  %5 = getelementptr inbounds %struct._reent, %struct._reent* %0, i64 0, i32 8, !dbg !240
  %6 = load i32, i32* %5, align 8, !dbg !240, !tbaa !242
  %7 = icmp eq i32 %6, 0, !dbg !240
  br i1 %7, label %8, label %9, !dbg !239

; <label>:8:                                      ; preds = %4
  tail call void @__sinit(%struct._reent* nonnull %0) #3, !dbg !240
  br label %9, !dbg !240

; <label>:9:                                      ; preds = %4, %2, %8
  %10 = tail call i32 @__srefill_r(%struct._reent* %0, %struct.__sFILE* %1) #3, !dbg !251
  %11 = icmp eq i32 %10, 0, !dbg !253
  br i1 %11, label %12, label %21, !dbg !254

; <label>:12:                                     ; preds = %9
  %13 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %1, i64 0, i32 1, !dbg !255
  %14 = load i32, i32* %13, align 8, !dbg !257, !tbaa !258
  %15 = add nsw i32 %14, -1, !dbg !257
  store i32 %15, i32* %13, align 8, !dbg !257, !tbaa !258
  %16 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %1, i64 0, i32 0, !dbg !264
  %17 = load i8*, i8** %16, align 8, !dbg !265, !tbaa !266
  %18 = getelementptr inbounds i8, i8* %17, i64 1, !dbg !265
  store i8* %18, i8** %16, align 8, !dbg !265, !tbaa !266
  %19 = load i8, i8* %17, align 1, !dbg !267, !tbaa !268
  %20 = zext i8 %19 to i32, !dbg !267
  br label %21, !dbg !269

; <label>:21:                                     ; preds = %9, %12
  %22 = phi i32 [ %20, %12 ], [ -1, %9 ], !dbg !270
...
; Function Attrs: noredzone nounwind
define dso_local i32 @__srget(%struct.__sFILE*) local_unnamed_addr #0 !dbg !272 {
  %2 = tail call %struct._reent* @__getreent() #3, !dbg !278
  %3 = icmp eq %struct._reent* %2, null, !dbg !282
  br i1 %3, label %9, label %4, !dbg !282

; <label>:4:                                      ; preds = %1
  %5 = getelementptr inbounds %struct._reent, %struct._reent* %2, i64 0, i32 8, !dbg !282
  %6 = load i32, i32* %5, align 8, !dbg !282, !tbaa !242
  %7 = icmp eq i32 %6, 0, !dbg !282
  br i1 %7, label %8, label %9, !dbg !281

; <label>:8:                                      ; preds = %4
  tail call void @__sinit(%struct._reent* nonnull %2) #3, !dbg !282
  br label %9, !dbg !282

; <label>:9:                                      ; preds = %8, %4, %1
  %10 = tail call i32 @__srefill_r(%struct._reent* %2, %struct.__sFILE* %0) #3, !dbg !283
  %11 = icmp eq i32 %10, 0, !dbg !284
  br i1 %11, label %12, label %21, !dbg !285

; <label>:12:                                     ; preds = %9
  %13 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %0, i64 0, i32 1, !dbg !286
  %14 = load i32, i32* %13, align 8, !dbg !287, !tbaa !258
  %15 = add nsw i32 %14, -1, !dbg !287
  store i32 %15, i32* %13, align 8, !dbg !287, !tbaa !258
  %16 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %0, i64 0, i32 0, !dbg !288
  %17 = load i8*, i8** %16, align 8, !dbg !289, !tbaa !266
  %18 = getelementptr inbounds i8, i8* %17, i64 1, !dbg !289
  store i8* %18, i8** %16, align 8, !dbg !289, !tbaa !266
  %19 = load i8, i8* %17, align 1, !dbg !290, !tbaa !268
  %20 = zext i8 %19 to i32, !dbg !290
  br label %21, !dbg !291

; <label>:21:                                     ; preds = %9, %12
  %22 = phi i32 [ %20, %12 ], [ -1, %9 ], !dbg !292
...
!1 = !DIFile(filename: "/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/stdio/rget.c", directory: "/root/.unikraft/apps/redis/build")
!2 = !{}
!3 = !{i32 2, !"Dwarf Version", i32 4}
!4 = !{i32 2, !"Debug Info Version", i32 3}
!5 = !{i32 1, !"wchar_size", i32 4}
!6 = !{!"clang version 7.0.1-8+deb10u2 (tags/RELEASE_701/final)"}
!7 = distinct !DISubprogram(name: "__srget_r", scope: !1, file: !1, line: 35, type: !8, isLocal: false, isDefinition: true, scopeLine: 38, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !233)
...
!233 = !{!234, !235, !236}
!234 = !DILocalVariable(name: "ptr", arg: 1, scope: !7, file: !1, line: 35, type: !11)
!235 = !DILocalVariable(name: "fp", arg: 2, scope: !7, file: !1, line: 35, type: !230)
!236 = !DILocalVariable(name: "_check_init_ptr", scope: !237, file: !1, line: 41, type: !11)
!237 = distinct !DILexicalBlock(scope: !7, file: !1, line: 41, column: 3)
!238 = !DILocation(line: 35, column: 1, scope: !7)
!239 = !DILocation(line: 41, column: 3, scope: !237)
!240 = !DILocation(line: 41, column: 3, scope: !241)
!241 = distinct !DILexicalBlock(scope: !237, file: !1, line: 41, column: 3)
!242 = !{!243, !244, i64 80}
...
!251 = !DILocation(line: 43, column: 7, scope: !252)
!252 = distinct !DILexicalBlock(scope: !7, file: !1, line: 43, column: 7)
!253 = !DILocation(line: 43, column: 29, scope: !252)
!254 = !DILocation(line: 43, column: 7, scope: !7)
!255 = !DILocation(line: 45, column: 11, scope: !256)
!256 = distinct !DILexicalBlock(scope: !252, file: !1, line: 44, column: 5)
!257 = !DILocation(line: 45, column: 13, scope: !256)
!258 = !{!259, !244, i64 8}
!259 = !{!"__sFILE", !247, i64 0, !244, i64 8, !244, i64 12, !260, i64 16, !260, i64 18, !261, i64 24, !244, i64 40, !247, i64 48, !247, i64 56, !247, i64 64, !247, i64 72, !247, i64 80, !261, i64 88, !247, i64 104, !244, i64 112, !245, i64 116, !245, i64 119, !261, i64 120, !244, i64 136, !262, i64 144, !247, i64 152, !244, i64 160, !263, i64 164, !244, i64 172}
!260 = !{!"short", !245, i64 0}
!261 = !{!"__sbuf", !247, i64 0, !244, i64 8}
!262 = !{!"long", !245, i64 0}
!263 = !{!"", !244, i64 0, !245, i64 4}
!264 = !DILocation(line: 46, column: 19, scope: !256)
!265 = !DILocation(line: 46, column: 21, scope: !256)
!266 = !{!259, !247, i64 0}
!267 = !DILocation(line: 46, column: 14, scope: !256)
!268 = !{!245, !245, i64 0}
!269 = !DILocation(line: 46, column: 7, scope: !256)
!270 = !DILocation(line: 0, scope: !7)
!271 = !DILocation(line: 49, column: 1, scope: !7)
!272 = distinct !DISubprogram(name: "__srget", scope: !1, file: !1, line: 55, type: !273, isLocal: false, isDefinition: true, scopeLine: 57, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !275)
!273 = !DISubroutineType(types: !274)
!274 = !{!10, !230}
!275 = !{!276}
!276 = !DILocalVariable(name: "fp", arg: 1, scope: !272, file: !1, line: 55, type: !230)
!277 = !DILocation(line: 55, column: 1, scope: !272)
!278 = !DILocation(line: 58, column: 21, scope: !272)
!279 = !DILocation(line: 35, column: 1, scope: !7, inlinedAt: !280)
!280 = distinct !DILocation(line: 58, column: 10, scope: !272)
!281 = !DILocation(line: 41, column: 3, scope: !237, inlinedAt: !280)
!282 = !DILocation(line: 41, column: 3, scope: !241, inlinedAt: !280)
!283 = !DILocation(line: 43, column: 7, scope: !252, inlinedAt: !280)
!284 = !DILocation(line: 43, column: 29, scope: !252, inlinedAt: !280)
!285 = !DILocation(line: 43, column: 7, scope: !7, inlinedAt: !280)
!286 = !DILocation(line: 45, column: 11, scope: !256, inlinedAt: !280)
!287 = !DILocation(line: 45, column: 13, scope: !256, inlinedAt: !280)
!288 = !DILocation(line: 46, column: 19, scope: !256, inlinedAt: !280)
!289 = !DILocation(line: 46, column: 21, scope: !256, inlinedAt: !280)
!290 = !DILocation(line: 46, column: 14, scope: !256, inlinedAt: !280)
!291 = !DILocation(line: 46, column: 7, scope: !256, inlinedAt: !280)
!292 = !DILocation(line: 0, scope: !7, inlinedAt: !280)
!293 = !DILocation(line: 49, column: 1, scope: !7, inlinedAt: !280)
!294 = !DILocation(line: 58, column: 3, scope: !272)
