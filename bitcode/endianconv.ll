...
; Function Attrs: noredzone nounwind
define dso_local zeroext i16 @intrev16(i16 zeroext) local_unnamed_addr #0 !dbg !70 {
...
; Function Attrs: noredzone nounwind
define dso_local i32 @intrev32(i32) local_unnamed_addr #0 !dbg !87 {
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !100
  %2 = tail call i32 @llvm.bswap.i32(i32 %0), !dbg !95
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !101
  ret i32 %2, !dbg !101
}

; Function Attrs: noredzone nounwind
define dso_local i64 @intrev64(i64) local_unnamed_addr #0 !dbg !102 {
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !115
  %2 = tail call i64 @llvm.bswap.i64(i64 %0), !dbg !110
...
!81 = !DILocation(line: 49, column: 21, scope: !7, inlinedAt: !82)
!82 = distinct !DILocation(line: 90, column: 5, scope: !70)
!83 = !DILocation(line: 50, column: 20, scope: !7, inlinedAt: !82)
!84 = !DILocation(line: 50, column: 27, scope: !7, inlinedAt: !82)
!85 = !DILocation(line: 55, column: 1, scope: !7, inlinedAt: !82)
!86 = !DILocation(line: 91, column: 5, scope: !70)
!87 = distinct !DISubprogram(name: "intrev32", scope: !1, file: !1, line: 94, type: !88, isLocal: false, isDefinition: true, scopeLine: 94, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !93)
!88 = !DISubroutineType(types: !89)
!89 = !{!90, !90}
!90 = !DIDerivedType(tag: DW_TAG_typedef, name: "uint32_t", file: !74, line: 48, baseType: !91)
!91 = !DIDerivedType(tag: DW_TAG_typedef, name: "__uint32_t", file: !76, line: 79, baseType: !92)
!92 = !DIBasicType(name: "unsigned int", size: 32, encoding: DW_ATE_unsigned)
!93 = !{!94}
!94 = !DILocalVariable(name: "v", arg: 1, scope: !87, file: !1, line: 94, type: !90)
!95 = !DILocation(line: 94, column: 28, scope: !87)
!96 = !DILocation(line: 59, column: 21, scope: !28, inlinedAt: !97)
!97 = distinct !DILocation(line: 95, column: 5, scope: !87)
!98 = !DILocation(line: 60, column: 20, scope: !28, inlinedAt: !97)
!99 = !DILocation(line: 60, column: 27, scope: !28, inlinedAt: !97)
!100 = !DILocation(line: 68, column: 1, scope: !28, inlinedAt: !97)
!101 = !DILocation(line: 96, column: 5, scope: !87)
!102 = distinct !DISubprogram(name: "intrev64", scope: !1, file: !1, line: 99, type: !103, isLocal: false, isDefinition: true, scopeLine: 99, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !108)
!103 = !DISubroutineType(types: !104)
!104 = !{!105, !105}
!105 = !DIDerivedType(tag: DW_TAG_typedef, name: "uint64_t", file: !74, line: 60, baseType: !106)
!106 = !DIDerivedType(tag: DW_TAG_typedef, name: "__uint64_t", file: !76, line: 105, baseType: !107)
!107 = !DIBasicType(name: "long unsigned int", size: 64, encoding: DW_ATE_unsigned)
!108 = !{!109}
!109 = !DILocalVariable(name: "v", arg: 1, scope: !102, file: !1, line: 99, type: !105)
!110 = !DILocation(line: 99, column: 28, scope: !102)
!111 = !DILocation(line: 72, column: 21, scope: !45, inlinedAt: !112)
!112 = distinct !DILocation(line: 100, column: 5, scope: !102)
!113 = !DILocation(line: 73, column: 20, scope: !45, inlinedAt: !112)
!114 = !DILocation(line: 73, column: 27, scope: !45, inlinedAt: !112)
!115 = !DILocation(line: 87, column: 1, scope: !45, inlinedAt: !112)
