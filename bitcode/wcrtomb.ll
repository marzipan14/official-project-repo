...
define dso_local i64 @_wcrtomb_r(%struct._reent*, i8*, i32, %struct._mbstate_t*) local_unnamed_addr #0 !dbg !14 {
  ...
  br i1 %11, label %12, label %13, !dbg !308
...
; <label>:13:                                     ; preds = %4, %12
  %14 = phi %struct.__locale_t* [ @__global_locale, %12 ], [ %10, %4 ], !dbg !308
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !326
  %15 = getelementptr inbounds %struct.__locale_t, %struct.__locale_t* %14, i64 0, i32 1, !dbg !327
  %16 = load i32 (%struct._reent*, i8*, i32, %struct._mbstate_t*)*, i32 (%struct._reent*, i8*, i32, %struct._mbstate_t*)** %15, align 8, !dbg !327, !tbaa !328
  br i1 %7, label %17, label %19, !dbg !331

; <label>:17:                                     ; preds = %13
  %18 = call i32 %16(%struct._reent* %0, i8* nonnull %6, i32 0, %struct._mbstate_t* %3) #5, !dbg !332
  br label %21, !dbg !333

; <label>:19:                                     ; preds = %13
  %20 = tail call i32 %16(%struct._reent* %0, i8* nonnull %1, i32 %2, %struct._mbstate_t* %3) #5, !dbg !334
  br label %21

; <label>:21:                                     ; preds = %19, %17
  %22 = phi i32 [ %18, %17 ], [ %20, %19 ], !dbg !327
  %23 = icmp eq i32 %22, -1, !dbg !335
  br i1 %23, label %24, label %27, !dbg !337

; <label>:24:                                     ; preds = %21
  %25 = getelementptr inbounds %struct._mbstate_t, %struct._mbstate_t* %3, i64 0, i32 0, !dbg !338
  store i32 0, i32* %25, align 4, !dbg !340, !tbaa !341
  %26 = getelementptr inbounds %struct._reent, %struct._reent* %0, i64 0, i32 0, !dbg !343
  store i32 138, i32* %26, align 8, !dbg !344, !tbaa !345
  br label %29, !dbg !346

; <label>:27:                                     ; preds = %21
  %28 = sext i32 %22 to i64, !dbg !347
  br label %29, !dbg !348

; <label>:29:                                     ; preds = %27, %24
  %30 = phi i64 [ -1, %24 ], [ %28, %27 ], !dbg !349
  call void @llvm.lifetime.end.p0i8(i64 10, i8* nonnull %6) #4, !dbg !350
...
; Function Attrs: noredzone nounwind
define dso_local i64 @wcrtomb(i8* noalias, i32, %struct._mbstate_t* noalias) local_unnamed_addr #0 !dbg !351 {
  %4 = alloca [10 x i8], align 1
  %5 = tail call %struct._reent* @__getreent() #5, !dbg !365
  %6 = getelementptr inbounds [10 x i8], [10 x i8]* %4, i64 0, i64 0, !dbg !367
  call void @llvm.lifetime.start.p0i8(i64 10, i8* nonnull %6) #4, !dbg !367
  %7 = icmp eq i8* %0, null, !dbg !369
  %8 = tail call %struct._reent* @__getreent() #5, !dbg !371
  %9 = getelementptr inbounds %struct._reent, %struct._reent* %8, i64 0, i32 7, !dbg !373
  %10 = load %struct.__locale_t*, %struct.__locale_t** %9, align 8, !dbg !373, !tbaa !314
  %11 = icmp eq %struct.__locale_t* %10, null, !dbg !371
  br i1 %11, label %12, label %13, !dbg !371
...
; <label>:13:                                     ; preds = %3, %12
  %14 = phi %struct.__locale_t* [ @__global_locale, %12 ], [ %10, %3 ], !dbg !371
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !376
  %15 = getelementptr inbounds %struct.__locale_t, %struct.__locale_t* %14, i64 0, i32 1, !dbg !377
  %16 = load i32 (%struct._reent*, i8*, i32, %struct._mbstate_t*)*, i32 (%struct._reent*, i8*, i32, %struct._mbstate_t*)** %15, align 8, !dbg !377, !tbaa !328
  br i1 %7, label %17, label %19, !dbg !378

; <label>:17:                                     ; preds = %13
  %18 = call i32 %16(%struct._reent* %5, i8* nonnull %6, i32 0, %struct._mbstate_t* %2) #5, !dbg !379
  br label %21, !dbg !380

; <label>:19:                                     ; preds = %13
  %20 = tail call i32 %16(%struct._reent* %5, i8* nonnull %0, i32 %1, %struct._mbstate_t* %2) #5, !dbg !381
  br label %21

; <label>:21:                                     ; preds = %19, %17
  %22 = phi i32 [ %18, %17 ], [ %20, %19 ], !dbg !377
  %23 = icmp eq i32 %22, -1, !dbg !382
  br i1 %23, label %24, label %27, !dbg !384

; <label>:24:                                     ; preds = %21
  %25 = getelementptr inbounds %struct._mbstate_t, %struct._mbstate_t* %2, i64 0, i32 0, !dbg !385
  store i32 0, i32* %25, align 4, !dbg !387, !tbaa !341
  %26 = getelementptr inbounds %struct._reent, %struct._reent* %5, i64 0, i32 0, !dbg !388
  store i32 138, i32* %26, align 8, !dbg !389, !tbaa !345
  br label %29, !dbg !390

; <label>:27:                                     ; preds = %21
  %28 = sext i32 %22 to i64, !dbg !391
  br label %29, !dbg !392

; <label>:29:                                     ; preds = %27, %24
  %30 = phi i64 [ -1, %24 ], [ %28, %27 ], !dbg !393
  call void @llvm.lifetime.end.p0i8(i64 10, i8* nonnull %6) #4, !dbg !394
...
!323 = !DILocation(line: 213, column: 3, scope: !324, inlinedAt: !325)
!324 = distinct !DISubprogram(name: "__get_global_locale", scope: !115, file: !115, line: 210, type: !310, isLocal: true, isDefinition: true, scopeLine: 211, isOptimized: true, unit: !0, retainedNodes: !2)
!325 = distinct !DILocation(line: 230, column: 29, scope: !309, inlinedAt: !312)
!326 = !DILocation(line: 230, column: 3, scope: !309, inlinedAt: !312)
!327 = !DILocation(line: 0, scope: !307)
!328 = !{!329, !319, i64 224}
!329 = !{!"__locale_t", !317, i64 0, !319, i64 224, !319, i64 232, !316, i64 240, !319, i64 248, !330, i64 256, !317, i64 352, !317, i64 354, !317, i64 386}
!330 = !{!"lconv", !319, i64 0, !319, i64 8, !319, i64 16, !319, i64 24, !319, i64 32, !319, i64 40, !319, i64 48, !319, i64 56, !319, i64 64, !319, i64 72, !317, i64 80, !317, i64 81, !317, i64 82, !317, i64 83, !317, i64 84, !317, i64 85, !317, i64 86, !317, i64 87, !317, i64 88, !317, i64 89, !317, i64 90, !317, i64 91, !317, i64 92, !317, i64 93}
!331 = !DILocation(line: 27, column: 7, scope: !14)
!332 = !DILocation(line: 28, column: 14, scope: !307)
!333 = !DILocation(line: 28, column: 5, scope: !307)
!334 = !DILocation(line: 30, column: 14, scope: !307)
!335 = !DILocation(line: 32, column: 14, scope: !336)
!336 = distinct !DILexicalBlock(scope: !14, file: !1, line: 32, column: 7)
!337 = !DILocation(line: 32, column: 7, scope: !14)
!338 = !DILocation(line: 34, column: 11, scope: !339)
!339 = distinct !DILexicalBlock(scope: !336, file: !1, line: 33, column: 5)
!340 = !DILocation(line: 34, column: 19, scope: !339)
!341 = !{!342, !316, i64 0}
!342 = !{!"", !316, i64 0, !317, i64 4}
!343 = !DILocation(line: 35, column: 12, scope: !339)
