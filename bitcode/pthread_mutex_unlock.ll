...
define dso_local i32 @pthread_mutex_unlock(%struct.pthread_mutex_t_** nocapture readonly) local_unnamed_addr #0 !dbg !502 {
  ...
  br i1 %3, label %4, label %48, !dbg !524
...
; <label>:4:                                      ; preds = %1
  ...
  br i1 %7, label %8, label %20, !dbg !531
...
; <label>:8:                                      ; preds = %4
  ...
  br i1 %11, label %48, label %12, !dbg !536

; <label>:12:                                     ; preds = %8
  %13 = icmp slt i32 %10, 0, !dbg !537
  br i1 %13, label %14, label %48, !dbg !540
...
; <label>:14:                                     ; preds = %12
  ...
  %19 = select i1 %18, i32 0, i32 22, !dbg !547
  br label %48, !dbg !547

; <label>:20:                                     ; preds = %4
  %21 = tail call { i8*, i32 } @pthread_self() #3, !dbg !548
  %22 = extractvalue { i8*, i32 } %21, 0, !dbg !548
  %23 = extractvalue { i8*, i32 } %21, 1, !dbg !548
  %24 = getelementptr inbounds %struct.pthread_mutex_t_, %struct.pthread_mutex_t_* %2, i64 0, i32 4, i32 0, !dbg !551
  %25 = load i8*, i8** %24, align 8, !dbg !551
  %26 = getelementptr inbounds %struct.pthread_mutex_t_, %struct.pthread_mutex_t_* %2, i64 0, i32 4, i32 1, !dbg !551
  %27 = load i32, i32* %26, align 8, !dbg !551
  %28 = tail call i32 @pthread_equal(i8* %25, i32 %27, i8* %22, i32 %23) #3, !dbg !551
  %29 = icmp eq i32 %28, 0, !dbg !551
  br i1 %29, label %48, label %30, !dbg !552

; <label>:30:                                     ; preds = %20
  %31 = load i32, i32* %5, align 8, !dbg !553, !tbaa !526
  %32 = icmp eq i32 %31, 1, !dbg !556
  br i1 %32, label %33, label %38, !dbg !557

; <label>:33:                                     ; preds = %30
  %34 = getelementptr inbounds %struct.pthread_mutex_t_, %struct.pthread_mutex_t_* %2, i64 0, i32 2, !dbg !558
  %35 = load i32, i32* %34, align 4, !dbg !559, !tbaa !560
  %36 = add nsw i32 %35, -1, !dbg !559
  store i32 %36, i32* %34, align 4, !dbg !559, !tbaa !560
  %37 = icmp eq i32 %36, 0, !dbg !561
  br i1 %37, label %38, label %48, !dbg !562

; <label>:38:                                     ; preds = %30, %33
  store i8* null, i8** %24, align 8, !dbg !563, !tbaa !565
  %39 = getelementptr inbounds %struct.pthread_mutex_t_, %struct.pthread_mutex_t_* %2, i64 0, i32 1, !dbg !566
  %40 = atomicrmw xchg i32* %39, i32 0 seq_cst, !dbg !566
  %41 = icmp slt i32 %40, 0, !dbg !568
  br i1 %41, label %42, label %48, !dbg !569

; <label>:42:                                     ; preds = %38
  %43 = getelementptr inbounds %struct.pthread_mutex_t_, %struct.pthread_mutex_t_* %2, i64 0, i32 0, !dbg !570
  %44 = load %struct.uk_semaphore*, %struct.uk_semaphore** %43, align 8, !dbg !570, !tbaa !544
  %45 = tail call i32 @pte_osSemaphorePost(%struct.uk_semaphore* %44, i32 1) #3, !dbg !573
  %46 = icmp eq i32 %45, 0, !dbg !574
  %47 = select i1 %46, i32 0, i32 22, !dbg !575
  br label %48, !dbg !575

; <label>:48:                                     ; preds = %42, %14, %1, %20, %12, %8, %33, %38
  %49 = phi i32 [ 0, %38 ], [ 0, %33 ], [ 0, %12 ], [ %19, %14 ], [ 1, %8 ], [ %47, %42 ], [ 1, %20 ], [ 22, %1 ], !dbg !576
...
!548 = !DILocation(line: 101, column: 47, scope: !549)
!549 = distinct !DILexicalBlock(scope: !550, file: !1, line: 101, column: 15)
!550 = distinct !DILexicalBlock(scope: !512, file: !1, line: 100, column: 9)
!551 = !DILocation(line: 101, column: 15, scope: !549)
!552 = !DILocation(line: 101, column: 15, scope: !550)
!553 = !DILocation(line: 103, column: 23, scope: !554)
!554 = distinct !DILexicalBlock(scope: !555, file: !1, line: 103, column: 19)
!555 = distinct !DILexicalBlock(scope: !549, file: !1, line: 102, column: 13)
!556 = !DILocation(line: 103, column: 28, scope: !554)
!557 = !DILocation(line: 104, column: 19, scope: !554)
!558 = !DILocation(line: 104, column: 33, scope: !554)
!559 = !DILocation(line: 104, column: 27, scope: !554)
!560 = !{!527, !528, i64 12}
!561 = !DILocation(line: 104, column: 24, scope: !554)
!562 = !DILocation(line: 103, column: 19, scope: !555)
!563 = !DILocation(line: 106, column: 37, scope: !564)
!564 = distinct !DILexicalBlock(scope: !554, file: !1, line: 105, column: 17)
!565 = !{!527, !519, i64 24}
!566 = !DILocation(line: 108, column: 23, scope: !567)
!567 = distinct !DILexicalBlock(scope: !564, file: !1, line: 108, column: 23)
!568 = !DILocation(line: 108, column: 61, scope: !567)
!569 = !DILocation(line: 108, column: 23, scope: !564)
!570 = !DILocation(line: 110, column: 51, scope: !571)
!571 = distinct !DILexicalBlock(scope: !572, file: !1, line: 110, column: 27)
!572 = distinct !DILexicalBlock(scope: !567, file: !1, line: 109, column: 21)
!573 = !DILocation(line: 110, column: 27, scope: !571)
!574 = !DILocation(line: 110, column: 61, scope: !571)
!575 = !DILocation(line: 110, column: 27, scope: !572)
!576 = !DILocation(line: 0, scope: !577)
!577 = distinct !DILexicalBlock(scope: !514, file: !1, line: 125, column: 5)
!578 = !DILocation(line: 129, column: 3, scope: !502)
