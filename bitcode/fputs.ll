...
; <label>:53:                                     ; preds = %47, %51
  ...
  %55 = icmp eq i32 %54, -1, !dbg !325
  br i1 %55, label %59, label %29, !dbg !326, !llvm.loop !327

; <label>:56:                                     ; preds = %29
  %57 = load i32, i32* %4, align 4, !dbg !329, !tbaa !330
  %58 = call i32 @pthread_setcancelstate(i32 %57, i32* nonnull %4) #4, !dbg !329
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %12) #5, !dbg !331
  br label %62

; <label>:59:                                     ; preds = %53, %22
  %60 = load i32, i32* %4, align 4, !dbg !332, !tbaa !330
  %61 = call i32 @pthread_setcancelstate(i32 %60, i32* nonnull %4) #4, !dbg !332
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %12) #5, !dbg !331
  br label %62
...
; Function Attrs: noredzone nounwind
define dso_local i32 @fputs(i8* noalias nocapture readonly, %struct.__sFILE* noalias) local_unnamed_addr #0 !dbg !334 {
  %3 = tail call %struct._reent* @__getreent() #4, !dbg !341
  %4 = tail call i32 @_fputs_r(%struct._reent* %3, i8* %0, %struct.__sFILE* %1) #6, !dbg !342
...
!324 = !DILocation(line: 696, column: 1, scope: !296, inlinedAt: !303)
!325 = !DILocation(line: 148, column: 37, scope: !289)
!326 = !DILocation(line: 148, column: 11, scope: !290)
!327 = distinct !{!327, !287, !328}
!328 = !DILocation(line: 150, column: 5, scope: !261)
!329 = !DILocation(line: 151, column: 3, scope: !261)
!330 = !{!269, !269, i64 0}
!331 = !DILocation(line: 155, column: 3, scope: !28)
!332 = !DILocation(line: 155, column: 3, scope: !261)
!333 = !DILocation(line: 158, column: 1, scope: !28)
!334 = distinct !DISubprogram(name: "fputs", scope: !1, file: !1, line: 162, type: !335, isLocal: false, isDefinition: true, scopeLine: 165, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !337)
!335 = !DISubroutineType(types: !336)
!336 = !{!5, !248, !249}
!337 = !{!338, !339}
!338 = !DILocalVariable(name: "s", arg: 1, scope: !334, file: !1, line: 162, type: !248)
!339 = !DILocalVariable(name: "fp", arg: 2, scope: !334, file: !1, line: 162, type: !249)
!340 = !DILocation(line: 162, column: 1, scope: !334)
!341 = !DILocation(line: 166, column: 20, scope: !334)
!342 = !DILocation(line: 166, column: 10, scope: !334)
!343 = !DILocation(line: 166, column: 3, scope: !334)
