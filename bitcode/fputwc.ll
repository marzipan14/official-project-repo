...
; <label>:40:                                     ; preds = %32
  %41 = call i32 @__swbuf_r(%struct._reent* %0, i32 %28, %struct.__sFILE* nonnull %2) #5, !dbg !326
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !324
  %42 = icmp eq i32 %41, -1, !dbg !327
  br i1 %42, label %46, label %43, !dbg !325

; <label>:43:                                     ; preds = %37, %40
  %44 = add nuw i64 %26, 1, !dbg !328
  %45 = icmp ult i64 %44, %21, !dbg !329
  br i1 %45, label %25, label %46, !dbg !277, !llvm.loop !330

; <label>:46:                                     ; preds = %40, %43, %13, %16
  %47 = phi i32 [ -1, %16 ], [ %1, %13 ], [ -1, %40 ], [ %1, %43 ], !dbg !332
  call void @llvm.lifetime.end.p0i8(i64 1, i8* nonnull %5) #4, !dbg !333
...
; Function Attrs: noredzone nounwind
define dso_local i32 @_fputwc_r(%struct._reent*, i32, %struct.__sFILE*) local_unnamed_addr #0 !dbg !334 {
  %4 = alloca i32, align 4
  %5 = bitcast i32* %4 to i8*, !dbg !343
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %5) #4, !dbg !343
  %6 = call i32 @pthread_setcancelstate(i32 1, i32* nonnull %4) #5, !dbg !343
  %7 = call i32 @__fputwc(%struct._reent* %0, i32 %1, %struct.__sFILE* %2) #6, !dbg !344
  %8 = load i32, i32* %4, align 4, !dbg !346, !tbaa !347
  %9 = call i32 @pthread_setcancelstate(i32 %8, i32* nonnull %4) #5, !dbg !346
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %5) #4, !dbg !348
...
; Function Attrs: noredzone nounwind
define dso_local i32 @fputwc(i32, %struct.__sFILE*) local_unnamed_addr #0 !dbg !350 {
  %3 = alloca i32, align 4
  %4 = tail call %struct._reent* @__getreent() #5, !dbg !360
  %5 = icmp eq %struct._reent* %4, null, !dbg !363
  br i1 %5, label %11, label %6, !dbg !363

; <label>:6:                                      ; preds = %2
  %7 = getelementptr inbounds %struct._reent, %struct._reent* %4, i64 0, i32 8, !dbg !363
  %8 = load i32, i32* %7, align 8, !dbg !363, !tbaa !365
  %9 = icmp eq i32 %8, 0, !dbg !363
  br i1 %9, label %10, label %11, !dbg !362

; <label>:10:                                     ; preds = %6
  tail call void @__sinit(%struct._reent* nonnull %4) #5, !dbg !363
  br label %11, !dbg !363

; <label>:11:                                     ; preds = %6, %2, %10
  %12 = bitcast i32* %3 to i8*, !dbg !372
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %12) #4, !dbg !372
  %13 = call i32 @pthread_setcancelstate(i32 1, i32* nonnull %3) #5, !dbg !372
  %14 = call i32 @__fputwc(%struct._reent* %4, i32 %0, %struct.__sFILE* %1) #5, !dbg !373
  %15 = load i32, i32* %3, align 4, !dbg !375, !tbaa !347
  %16 = call i32 @pthread_setcancelstate(i32 %15, i32* nonnull %3) #5, !dbg !375
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %12) #4, !dbg !376
...
!324 = !DILocation(line: 696, column: 1, scope: !301, inlinedAt: !308)
!325 = !DILocation(line: 214, column: 9, scope: !298)
!326 = !DILocation(line: 695, column: 11, scope: !312, inlinedAt: !308)
!327 = !DILocation(line: 214, column: 53, scope: !297)
!328 = !DILocation(line: 213, column: 25, scope: !298)
!329 = !DILocation(line: 213, column: 17, scope: !298)
!330 = distinct !{!330, !277, !331}
!331 = !DILocation(line: 215, column: 14, scope: !278)
!332 = !DILocation(line: 0, scope: !285)
!333 = !DILocation(line: 218, column: 1, scope: !33)
!334 = distinct !DISubprogram(name: "_fputwc_r", scope: !1, file: !1, line: 221, type: !34, isLocal: false, isDefinition: true, scopeLine: 225, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !335)
!335 = !{!336, !337, !338, !339, !340}
!336 = !DILocalVariable(name: "ptr", arg: 1, scope: !334, file: !1, line: 221, type: !36)
!337 = !DILocalVariable(name: "wc", arg: 2, scope: !334, file: !1, line: 221, type: !250)
!338 = !DILocalVariable(name: "fp", arg: 3, scope: !334, file: !1, line: 221, type: !251)
!339 = !DILocalVariable(name: "r", scope: !334, file: !1, line: 226, type: !26)
!340 = !DILocalVariable(name: "__oldfpcancel", scope: !341, file: !1, line: 228, type: !5)
!341 = distinct !DILexicalBlock(scope: !334, file: !1, line: 228, column: 3)
!342 = !DILocation(line: 221, column: 1, scope: !334)
!343 = !DILocation(line: 228, column: 3, scope: !341)
!344 = !DILocation(line: 230, column: 7, scope: !341)
!345 = !DILocation(line: 226, column: 10, scope: !334)
!346 = !DILocation(line: 231, column: 3, scope: !341)
!347 = !{!290, !290, i64 0}
!348 = !DILocation(line: 231, column: 3, scope: !334)
!349 = !DILocation(line: 232, column: 3, scope: !334)
!350 = distinct !DISubprogram(name: "fputwc", scope: !1, file: !1, line: 236, type: !351, isLocal: false, isDefinition: true, scopeLine: 239, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !353)
!351 = !DISubroutineType(types: !352)
!352 = !{!26, !250, !251}
!353 = !{!354, !355, !356, !357}
!354 = !DILocalVariable(name: "wc", arg: 1, scope: !350, file: !1, line: 236, type: !250)
!355 = !DILocalVariable(name: "fp", arg: 2, scope: !350, file: !1, line: 236, type: !251)
!356 = !DILocalVariable(name: "reent", scope: !350, file: !1, line: 240, type: !36)
!357 = !DILocalVariable(name: "_check_init_ptr", scope: !358, file: !1, line: 242, type: !36)
!358 = distinct !DILexicalBlock(scope: !350, file: !1, line: 242, column: 3)
!359 = !DILocation(line: 236, column: 1, scope: !350)
!360 = !DILocation(line: 240, column: 26, scope: !350)
!361 = !DILocation(line: 240, column: 18, scope: !350)
!362 = !DILocation(line: 242, column: 3, scope: !358)
!363 = !DILocation(line: 242, column: 3, scope: !364)
!364 = distinct !DILexicalBlock(scope: !358, file: !1, line: 242, column: 3)
!365 = !{!366, !290, i64 80}
!366 = !{!"_reent", !290, i64 0, !289, i64 8, !289, i64 16, !289, i64 24, !290, i64 32, !273, i64 36, !290, i64 64, !289, i64 72, !290, i64 80, !289, i64 88, !289, i64 96, !290, i64 104, !289, i64 112, !289, i64 120, !290, i64 128, !289, i64 136, !273, i64 144, !289, i64 504, !367, i64 512, !289, i64 1304, !369, i64 1312, !273, i64 1336}
!367 = !{!"_atexit", !289, i64 0, !290, i64 8, !273, i64 16, !368, i64 272}
!368 = !{!"_on_exit_args", !273, i64 0, !273, i64 256, !290, i64 512, !290, i64 516}
!369 = !{!"_glue", !289, i64 0, !290, i64 8, !289, i64 16}
!370 = !DILocation(line: 221, column: 1, scope: !334, inlinedAt: !371)
!371 = distinct !DILocation(line: 243, column: 10, scope: !350)
!372 = !DILocation(line: 228, column: 3, scope: !341, inlinedAt: !371)
!373 = !DILocation(line: 230, column: 7, scope: !341, inlinedAt: !371)
!374 = !DILocation(line: 226, column: 10, scope: !334, inlinedAt: !371)
!375 = !DILocation(line: 231, column: 3, scope: !341, inlinedAt: !371)
!376 = !DILocation(line: 231, column: 3, scope: !334, inlinedAt: !371)
!377 = !DILocation(line: 232, column: 3, scope: !334, inlinedAt: !371)
!378 = !DILocation(line: 243, column: 3, scope: !350)
