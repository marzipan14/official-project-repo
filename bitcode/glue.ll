...
; <label>:32:                                     ; preds = %5, %13, %4
  ...
  ret %struct.uk_alloc* %33, !dbg !153
}
...
define internal void @uk_pr_err(i8* nocapture readnone, ...) unnamed_addr #3 !dbg !2 {
  ...
  %3 = bitcast [1 x %struct.__va_list_tag]* %2 to i8*, !dbg !154
  call void @llvm.lifetime.start.p0i8(i64 24, i8* nonnull %3) #5, !dbg !154
  %4 = getelementptr inbounds [1 x %struct.__va_list_tag], [1 x %struct.__va_list_tag]* %2, i64 0, i64 0, !dbg !156
  call void @llvm.va_start(i8* nonnull %3), !dbg !156
  call void @_uk_vprintk(i32 1, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @uk_pr_err.__str, i64 0, i64 0), i8* getelementptr inbounds ([7 x i8], [7 x i8]* @uk_pr_err.__str.2, i64 0, i64 0), i32 190, i8* getelementptr inbounds ([70 x i8], [70 x i8]* @.str, i64 0, i64 0), %struct.__va_list_tag* nonnull %4) #7, !dbg !157
  call void @llvm.va_end(i8* nonnull %3), !dbg !160
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %3) #5, !dbg !161
...
; Function Attrs: noredzone nounwind
define internal i8* @uk_tlsf_malloc(%struct.uk_alloc*, i64) #0 !dbg !162 {
  %3 = ptrtoint %struct.uk_alloc* %0 to i64, !dbg !168
  %4 = add i64 %3, 104, !dbg !169
  %5 = inttoptr i64 %4 to i8*, !dbg !170
  %6 = tail call i8* @tlsf_malloc(i64 %1, i8* %5) #7, !dbg !171
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !172
  ret i8* %6, !dbg !172
}

; Function Attrs: noredzone nounwind
define internal void @uk_tlsf_free(%struct.uk_alloc*, i8*) #0 !dbg !173 {
  %3 = ptrtoint %struct.uk_alloc* %0 to i64, !dbg !179
  %4 = add i64 %3, 104, !dbg !180
  %5 = inttoptr i64 %4 to i8*, !dbg !181
  tail call void @tlsf_free(i8* %1, i8* %5) #7, !dbg !182
...
!153 = !DILocation(line: 89, column: 1, scope: !109)
!154 = !DILocation(line: 188, column: 2, scope: !2)
!155 = !DILocation(line: 188, column: 10, scope: !2)
!156 = !DILocation(line: 189, column: 2, scope: !2)
!157 = !DILocation(line: 190, column: 2, scope: !158)
!158 = distinct !DILexicalBlock(scope: !159, file: !3, line: 190, column: 2)
!159 = distinct !DILexicalBlock(scope: !2, file: !3, line: 190, column: 2)
!160 = !DILocation(line: 191, column: 2, scope: !2)
!161 = !DILocation(line: 192, column: 1, scope: !2)
!162 = distinct !DISubprogram(name: "uk_tlsf_malloc", scope: !10, file: !10, line: 40, type: !20, isLocal: true, isDefinition: true, scopeLine: 41, flags: DIFlagPrototyped, isOptimized: true, unit: !9, retainedNodes: !163)
!163 = !{!164, !165}
!164 = !DILocalVariable(name: "a", arg: 1, scope: !162, file: !10, line: 40, type: !13)
!165 = !DILocalVariable(name: "size", arg: 2, scope: !162, file: !10, line: 40, type: !23)
!166 = !DILocation(line: 40, column: 46, scope: !162)
!167 = !DILocation(line: 40, column: 56, scope: !162)
!168 = !DILocation(line: 42, column: 36, scope: !162)
!169 = !DILocation(line: 42, column: 50, scope: !162)
!170 = !DILocation(line: 42, column: 27, scope: !162)
!171 = !DILocation(line: 42, column: 9, scope: !162)
!172 = !DILocation(line: 42, column: 2, scope: !162)
!173 = distinct !DISubprogram(name: "uk_tlsf_free", scope: !10, file: !10, line: 46, type: !48, isLocal: true, isDefinition: true, scopeLine: 47, flags: DIFlagPrototyped, isOptimized: true, unit: !9, retainedNodes: !174)
!174 = !{!175, !176}
!175 = !DILocalVariable(name: "a", arg: 1, scope: !173, file: !10, line: 46, type: !13)
!176 = !DILocalVariable(name: "ptr", arg: 2, scope: !173, file: !10, line: 46, type: !22)
!177 = !DILocation(line: 46, column: 43, scope: !173)
!178 = !DILocation(line: 46, column: 52, scope: !173)
!179 = !DILocation(line: 58, column: 26, scope: !173)
!180 = !DILocation(line: 58, column: 40, scope: !173)
!181 = !DILocation(line: 58, column: 17, scope: !173)
!182 = !DILocation(line: 58, column: 2, scope: !173)
!183 = !DILocation(line: 59, column: 1, scope: !173)
