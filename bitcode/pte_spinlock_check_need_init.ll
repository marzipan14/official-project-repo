...
define dso_local i32 @pte_spinlock_check_need_init(%struct.pthread_spinlock_t_**) local_unnamed_addr #0 !dbg !508 {
  ...
  %4 = bitcast %struct.pthread_spinlock_t_** %0 to i64*, !dbg !523
  %5 = load i64, i64* %4, align 8, !dbg !523, !tbaa !518
...
; <label>:6:                                      ; preds = %1
  %7 = tail call i32 @pthread_spin_init(%struct.pthread_spinlock_t_** nonnull %0, i32 0) #3, !dbg !526
  br label %9, !dbg !528
...
; <label>:9:                                      ; preds = %1, %8, %6
  %10 = phi i32 [ %7, %6 ], [ 22, %8 ], [ 0, %1 ], !dbg !532
  %11 = load %struct.uk_mutex*, %struct.uk_mutex** @pte_spinlock_test_init_lock, align 8, !dbg !533, !tbaa !518
  %12 = tail call i32 @pte_osMutexUnlock(%struct.uk_mutex* %11) #3, !dbg !534
...
!525 = !DILocation(line: 72, column: 7, scope: !508)
!526 = !DILocation(line: 74, column: 16, scope: !527)
!527 = distinct !DILexicalBlock(scope: !524, file: !1, line: 73, column: 5)
!528 = !DILocation(line: 75, column: 5, scope: !527)
!529 = !DILocation(line: 84, column: 5, scope: !530)
!530 = distinct !DILexicalBlock(scope: !531, file: !1, line: 77, column: 5)
!531 = distinct !DILexicalBlock(scope: !524, file: !1, line: 76, column: 12)
!532 = !DILocation(line: 0, scope: !508)
!533 = !DILocation(line: 86, column: 21, scope: !508)
!534 = !DILocation(line: 86, column: 3, scope: !508)
!535 = !DILocation(line: 88, column: 3, scope: !508)
