...
.Ltmp11:
	...
	#NO_APP
.LBB4_86:                               #   in Loop: Header=BB4_21 Depth=1
	addq	$1, %r14
	movl	-68(%rbp), %eax
	cmpq	%rax, %r14
	jae	.LBB4_87
...
.Ltmp15:
	...
	movl	-72(%rbp), %eax
	jmp	.LBB4_30
.LBB4_28:                               #   in Loop: Header=BB4_21 Depth=1
	movq	-64(%rbp), %rdi
	callq	uk_netdev_state_get
	movl	%eax, -72(%rbp)
.LBB4_30:                               #   in Loop: Header=BB4_21 Depth=1
	#APP
	movq	%rsp, %rcx
	#NO_APP
	movl	$42, __A_VARIABLE(%rip)
...
# %bb.36:                               #   in Loop: Header=BB4_21 Depth=1
	...
	cmpq	%rcx, %rax
	jbe	.LBB4_37
.LBB4_38:                               #   in Loop: Header=BB4_21 Depth=1
	#APP
	movq	%rsp, %rax
	#NO_APP
	movl	$42, __A_VARIABLE(%rip)
...
.LBB4_37:                               #   in Loop: Header=BB4_21 Depth=1
	movl	$42, __A_VARIABLE(%rip)
.LBB4_39:                               #   in Loop: Header=BB4_21 Depth=1
	#APP
	movq	%rsp, %rax
	#NO_APP
	movl	$42, __A_VARIABLE(%rip)
...
.Ltmp19:
	...
	#NO_APP
	jmp	.LBB4_43
.LBB4_41:                               #   in Loop: Header=BB4_21 Depth=1
	movq	-64(%rbp), %rdi
	movl	$1, %esi
	movq	%r12, %rdx
	callq	uk_netdev_einfo_get_with_copy
...
.LBB4_46:                               #   in Loop: Header=BB4_21 Depth=1
	cmpq	%rbx, %rcx
	jb	.LBB4_49
# %bb.47:                               #   in Loop: Header=BB4_21 Depth=1
	#APP
	movq	%rsp, %rax
	#NO_APP
	movl	$42, __A_VARIABLE(%rip)
...
# %bb.55:                               #   in Loop: Header=BB4_21 Depth=1
	...
	cmpl	$1, %eax
	je	.LBB4_62
# %bb.56:                               #   in Loop: Header=BB4_21 Depth=1
	#APP
	movq	%rsp, %rax
	#NO_APP
	movl	$42, __A_VARIABLE(%rip)
...
# %bb.57:                               #   in Loop: Header=BB4_21 Depth=1
	...
	cmpq	%rcx, %rax
	jbe	.LBB4_58
.LBB4_59:                               #   in Loop: Header=BB4_21 Depth=1
	#APP
	movq	%rsp, %rax
	#NO_APP
	movl	$42, __A_VARIABLE(%rip)
...
.Ltmp27:
	...
	#NO_APP
	jmp	.LBB4_66
.LBB4_48:                               #   in Loop: Header=BB4_21 Depth=1
	movq	(%r12), %rsi
...
.LBB4_64:                               #   in Loop: Header=BB4_21 Depth=1
	...
	movq	%r12, %rdx
	callq	uk_netdev_einfo_get_with_copy
.LBB4_66:                               #   in Loop: Header=BB4_21 Depth=1
	movq	(%r12), %rdi
	testq	%rdi, %rdi
	je	.LBB4_72
# %bb.67:                               #   in Loop: Header=BB4_21 Depth=1
	leaq	-88(%rbp), %r15
	movq	%r15, %rsi
	callq	ip4addr_aton
	movq	%r15, %rcx
...
# %bb.68:                               #   in Loop: Header=BB4_21 Depth=1
	...
	cmpq	%rbx, %rax
	jb	.LBB4_71
# %bb.69:                               #   in Loop: Header=BB4_21 Depth=1
	#APP
	movq	%rsp, %rax
	#NO_APP
	movl	$42, __A_VARIABLE(%rip)
	...
	cmpq	%rcx, %rax
	jbe	.LBB4_70
.LBB4_71:                               #   in Loop: Header=BB4_21 Depth=1
	#APP
	movq	%rsp, %rax
	#NO_APP
	movl	$42, __A_VARIABLE(%rip)
...
.Ltmp29:
	...
	#NO_APP
	jmp	.LBB4_72
.LBB4_58:                               #   in Loop: Header=BB4_21 Depth=1
	movq	(%r12), %rsi
	movl	$_liblwip_init.__str.8, %edi
	xorl	%eax, %eax
	callq	uk_pr_err
.LBB4_60:                               #   in Loop: Header=BB4_21 Depth=1
	xorl	%ecx, %ecx
	xorl	%edx, %edx
	jmp	.LBB4_73
.LBB4_70:                               #   in Loop: Header=BB4_21 Depth=1
	movq	(%r12), %rsi
	movl	$_liblwip_init.__str.10, %edi
	xorl	%eax, %eax
	callq	uk_pr_err
.LBB4_72:                               #   in Loop: Header=BB4_21 Depth=1
	xorl	%ecx, %ecx
	leaq	-56(%rbp), %rdx
.LBB4_73:                               #   in Loop: Header=BB4_21 Depth=1
	leaq	-48(%rbp), %rsi
.LBB4_74:                               #   in Loop: Header=BB4_21 Depth=1
	movl	$_intrstack_start, %r15d
	movq	-64(%rbp), %rdi
	callq	uknetdev_addif
	testq	%rax, %rax
	je	.LBB4_75
# %bb.79:                               #   in Loop: Header=BB4_21 Depth=1
	movq	%rax, %rbx
	testl	%r13d, %r13d
	je	.LBB4_85
# %bb.80:                               #   in Loop: Header=BB4_21 Depth=1
	#APP
	movq	%rsp, %rax
	#NO_APP
	movl	$42, __A_VARIABLE(%rip)
...
.Ltmp31:
	...
	#NO_APP
	jmp	.LBB4_84
.LBB4_75:                               #   in Loop: Header=BB4_21 Depth=1
	#APP
	movq	%rsp, %rax
	#NO_APP
	movl	$42, __A_VARIABLE(%rip)
	...
	cmpq	%rbx, %rax
	jb	.LBB4_78
# %bb.76:                               #   in Loop: Header=BB4_21 Depth=1
	#APP
	movq	%rsp, %rax
	#NO_APP
	movl	$42, __A_VARIABLE(%rip)
	...
	cmpq	%rcx, %rax
	jbe	.LBB4_77
.LBB4_78:                               #   in Loop: Header=BB4_21 Depth=1
	#APP
	movq	%rsp, %rax
	#NO_APP
	movl	$42, __A_VARIABLE(%rip)
...
.Ltmp33:
	...
	jmp	.LBB4_86
.LBB4_82:                               #   in Loop: Header=BB4_21 Depth=1
	movl	$42, __A_VARIABLE(%rip)
.LBB4_84:                               #   in Loop: Header=BB4_21 Depth=1
	movq	%rbx, %rdi
	callq	netif_set_default
.LBB4_85:                               #   in Loop: Header=BB4_21 Depth=1
	movq	%rbx, %rdi
	callq	netif_set_up
	xorl	%r13d, %r13d
	movq	-80(%rbp), %r12         # 8-byte Reload
	movl	$_intrstack_start, %ebx
	jmp	.LBB4_86
.LBB4_77:                               #   in Loop: Header=BB4_21 Depth=1
