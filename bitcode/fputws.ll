...
; <label>:45:                                     ; preds = %36
  %46 = call i32 @__swbuf_r(%struct._reent* %0, i32 %32, %struct.__sFILE* nonnull %2) #5, !dbg !323
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !321
  %47 = icmp eq i32 %46, -1, !dbg !324
  br i1 %47, label %57, label %48, !dbg !322

; <label>:48:                                     ; preds = %42, %45
  %49 = add nuw i64 %29, 1, !dbg !325
  %50 = icmp ult i64 %49, %27, !dbg !326
  br i1 %50, label %28, label %51, !dbg !327, !llvm.loop !328

; <label>:51:                                     ; preds = %48, %26
  %52 = load i32*, i32** %4, align 8, !dbg !330, !tbaa !270
  %53 = icmp eq i32* %52, null, !dbg !331
  br i1 %53, label %54, label %26, !dbg !332, !llvm.loop !333

; <label>:54:                                     ; preds = %51
  %55 = load i32, i32* %6, align 4, !dbg !336, !tbaa !337
  %56 = call i32 @pthread_setcancelstate(i32 %55, i32* nonnull %6) #5, !dbg !336
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %8) #4, !dbg !338
  br label %60

; <label>:57:                                     ; preds = %26, %45, %18
  %58 = load i32, i32* %6, align 4, !dbg !339, !tbaa !337
  %59 = call i32 @pthread_setcancelstate(i32 %58, i32* nonnull %6) #5, !dbg !339
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %8) #4, !dbg !338
  br label %60

; <label>:60:                                     ; preds = %54, %57
  %61 = phi i32 [ -1, %57 ], [ 0, %54 ]
  call void @llvm.lifetime.end.p0i8(i64 1024, i8* nonnull %7) #4, !dbg !340
...
; Function Attrs: noredzone nounwind
define dso_local i32 @fputws(i32* noalias, %struct.__sFILE* noalias) local_unnamed_addr #0 !dbg !341 {
...
; <label>:10:                                     ; preds = %5, %2, %9
  %11 = tail call i32 @_fputws_r(%struct._reent* %3, i32* %0, %struct.__sFILE* %1) #6, !dbg !363
...
!321 = !DILocation(line: 696, column: 1, scope: !298, inlinedAt: !305)
!322 = !DILocation(line: 169, column: 8, scope: !295)
!323 = !DILocation(line: 695, column: 11, scope: !309, inlinedAt: !305)
!324 = !DILocation(line: 169, column: 36, scope: !294)
!325 = !DILocation(line: 171, column: 5, scope: !295)
!326 = !DILocation(line: 167, column: 16, scope: !268)
!327 = !DILocation(line: 167, column: 7, scope: !268)
!328 = distinct !{!328, !327, !329}
!329 = !DILocation(line: 172, column: 9, scope: !268)
!330 = !DILocation(line: 174, column: 10, scope: !266)
!331 = !DILocation(line: 174, column: 13, scope: !266)
!332 = !DILocation(line: 173, column: 5, scope: !268)
!333 = distinct !{!333, !334, !335}
!334 = !DILocation(line: 161, column: 3, scope: !266)
!335 = !DILocation(line: 174, column: 20, scope: !266)
!336 = !DILocation(line: 175, column: 3, scope: !266)
!337 = !{!281, !281, i64 0}
!338 = !DILocation(line: 179, column: 3, scope: !31)
!339 = !DILocation(line: 179, column: 3, scope: !266)
!340 = !DILocation(line: 182, column: 1, scope: !31)
!341 = distinct !DISubprogram(name: "fputws", scope: !1, file: !1, line: 185, type: !342, isLocal: false, isDefinition: true, scopeLine: 188, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !346)
!342 = !DISubroutineType(types: !343)
!343 = !{!5, !344, !345}
!344 = !DIDerivedType(tag: DW_TAG_restrict_type, baseType: !250)
!345 = !DIDerivedType(tag: DW_TAG_restrict_type, baseType: !253)
!346 = !{!347, !348, !349, !350}
!347 = !DILocalVariable(name: "ws", arg: 1, scope: !341, file: !1, line: 185, type: !344)
!348 = !DILocalVariable(name: "fp", arg: 2, scope: !341, file: !1, line: 185, type: !345)
!349 = !DILocalVariable(name: "reent", scope: !341, file: !1, line: 189, type: !34)
!350 = !DILocalVariable(name: "_check_init_ptr", scope: !351, file: !1, line: 191, type: !34)
!351 = distinct !DILexicalBlock(scope: !341, file: !1, line: 191, column: 3)
!352 = !DILocation(line: 185, column: 1, scope: !341)
!353 = !DILocation(line: 189, column: 26, scope: !341)
!354 = !DILocation(line: 189, column: 18, scope: !341)
!355 = !DILocation(line: 191, column: 3, scope: !351)
!356 = !DILocation(line: 191, column: 3, scope: !357)
!357 = distinct !DILexicalBlock(scope: !351, file: !1, line: 191, column: 3)
!358 = !{!359, !281, i64 80}
!359 = !{!"_reent", !281, i64 0, !271, i64 8, !271, i64 16, !271, i64 24, !281, i64 32, !272, i64 36, !281, i64 64, !271, i64 72, !281, i64 80, !271, i64 88, !271, i64 96, !281, i64 104, !271, i64 112, !271, i64 120, !281, i64 128, !271, i64 136, !272, i64 144, !271, i64 504, !360, i64 512, !271, i64 1304, !362, i64 1312, !272, i64 1336}
!360 = !{!"_atexit", !271, i64 0, !281, i64 8, !272, i64 16, !361, i64 272}
!361 = !{!"_on_exit_args", !272, i64 0, !272, i64 256, !281, i64 512, !281, i64 516}
!362 = !{!"_glue", !271, i64 0, !281, i64 8, !271, i64 16}
!363 = !DILocation(line: 192, column: 10, scope: !341)
!364 = !DILocation(line: 192, column: 3, scope: !341)
