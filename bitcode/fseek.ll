; ModuleID = '/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/stdio/fseek.c'
source_filename = "/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/stdio/fseek.c"
...
define dso_local i32 @_fseek_r(%struct._reent*, %struct.__sFILE*, i64, i32) local_unnamed_addr #0 !dbg !7 {
  %5 = tail call i32 @_fseeko_r(%struct._reent* %0, %struct.__sFILE* %1, i64 %2, i32 %3) #3, !dbg !239
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !240
  ret i32 %5, !dbg !240
}

; Function Attrs: noredzone
declare dso_local i32 @_fseeko_r(%struct._reent*, %struct.__sFILE*, i64, i32) local_unnamed_addr #1

; Function Attrs: noredzone nounwind
define dso_local i32 @fseek(%struct.__sFILE*, i64, i32) local_unnamed_addr #0 !dbg !241 {
  %4 = tail call %struct._reent* @__getreent() #3, !dbg !249
  %5 = tail call i32 @_fseeko_r(%struct._reent* %4, %struct.__sFILE* %0, i64 %1, i32 %2) #3, !dbg !252
...
!1 = !DIFile(filename: "/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/stdio/fseek.c", directory: "/root/.unikraft/apps/redis/build")
!2 = !{}
!3 = !{i32 2, !"Dwarf Version", i32 4}
!4 = !{i32 2, !"Debug Info Version", i32 3}
!5 = !{i32 1, !"wchar_size", i32 4}
!6 = !{!"clang version 7.0.1-8+deb10u2 (tags/RELEASE_701/final)"}
!7 = distinct !DISubprogram(name: "_fseek_r", scope: !1, file: !1, line: 108, type: !8, isLocal: false, isDefinition: true, scopeLine: 113, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !233)
...
!233 = !{!234, !235, !236, !237}
!234 = !DILocalVariable(name: "ptr", arg: 1, scope: !7, file: !1, line: 108, type: !11)
!235 = !DILocalVariable(name: "fp", arg: 2, scope: !7, file: !1, line: 108, type: !230)
!236 = !DILocalVariable(name: "offset", arg: 3, scope: !7, file: !1, line: 108, type: !43)
!237 = !DILocalVariable(name: "whence", arg: 4, scope: !7, file: !1, line: 108, type: !10)
!238 = !DILocation(line: 108, column: 1, scope: !7)
!239 = !DILocation(line: 114, column: 10, scope: !7)
!240 = !DILocation(line: 114, column: 3, scope: !7)
!241 = distinct !DISubprogram(name: "fseek", scope: !1, file: !1, line: 120, type: !242, isLocal: false, isDefinition: true, scopeLine: 124, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !244)
!242 = !DISubroutineType(types: !243)
!243 = !{!10, !230, !43, !10}
!244 = !{!245, !246, !247}
!245 = !DILocalVariable(name: "fp", arg: 1, scope: !241, file: !1, line: 120, type: !230)
!246 = !DILocalVariable(name: "offset", arg: 2, scope: !241, file: !1, line: 120, type: !43)
!247 = !DILocalVariable(name: "whence", arg: 3, scope: !241, file: !1, line: 120, type: !10)
!248 = !DILocation(line: 120, column: 1, scope: !241)
!249 = !DILocation(line: 125, column: 20, scope: !241)
!250 = !DILocation(line: 108, column: 1, scope: !7, inlinedAt: !251)
!251 = distinct !DILocation(line: 125, column: 10, scope: !241)
!252 = !DILocation(line: 114, column: 10, scope: !7, inlinedAt: !251)
!253 = !DILocation(line: 114, column: 3, scope: !7, inlinedAt: !251)
!254 = !DILocation(line: 125, column: 3, scope: !241)
