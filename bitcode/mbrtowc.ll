...
define dso_local i64 @_mbrtowc_r(%struct._reent*, i32*, i8*, i64, %struct._mbstate_t*) local_unnamed_addr #0 !dbg !14 {
  ...
  br i1 %10, label %11, label %12, !dbg !303
...
; <label>:12:                                     ; preds = %5, %11
  %13 = phi %struct.__locale_t* [ @__global_locale, %11 ], [ %9, %5 ], !dbg !303
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !321
  %14 = getelementptr inbounds %struct.__locale_t, %struct.__locale_t* %13, i64 0, i32 2, !dbg !322
  %15 = load i32 (%struct._reent*, i32*, i8*, i64, %struct._mbstate_t*)*, i32 (%struct._reent*, i32*, i8*, i64, %struct._mbstate_t*)** %14, align 8, !dbg !322, !tbaa !323
  br i1 %6, label %16, label %18, !dbg !326

; <label>:16:                                     ; preds = %12
  %17 = tail call i32 %15(%struct._reent* %0, i32* null, i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str, i64 0, i64 0), i64 1, %struct._mbstate_t* %4) #3, !dbg !327
  br label %20, !dbg !328

; <label>:18:                                     ; preds = %12
  %19 = tail call i32 %15(%struct._reent* %0, i32* %1, i8* nonnull %2, i64 %3, %struct._mbstate_t* %4) #3, !dbg !329
  br label %20

; <label>:20:                                     ; preds = %18, %16
  %21 = phi i32 [ %17, %16 ], [ %19, %18 ], !dbg !322
  %22 = icmp eq i32 %21, -1, !dbg !330
  br i1 %22, label %23, label %26, !dbg !332

; <label>:23:                                     ; preds = %20
  %24 = getelementptr inbounds %struct._mbstate_t, %struct._mbstate_t* %4, i64 0, i32 0, !dbg !333
  store i32 0, i32* %24, align 4, !dbg !335, !tbaa !336
  %25 = getelementptr inbounds %struct._reent, %struct._reent* %0, i64 0, i32 0, !dbg !338
  store i32 138, i32* %25, align 8, !dbg !339, !tbaa !340
  br label %28, !dbg !341

; <label>:26:                                     ; preds = %20
  %27 = sext i32 %21 to i64, !dbg !342
  br label %28, !dbg !343

; <label>:28:                                     ; preds = %26, %23
  %29 = phi i64 [ -1, %23 ], [ %27, %26 ], !dbg !344
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !345
  ret i64 %29, !dbg !345
}

; Function Attrs: noredzone nounwind
define dso_local i64 @mbrtowc(i32* noalias, i8* noalias, i64, %struct._mbstate_t* noalias) local_unnamed_addr #0 !dbg !346 {
  %5 = tail call %struct._reent* @__getreent() #3, !dbg !361
  %6 = icmp eq i8* %1, null, !dbg !363
  %7 = tail call %struct._reent* @__getreent() #3, !dbg !365
  %8 = getelementptr inbounds %struct._reent, %struct._reent* %7, i64 0, i32 7, !dbg !367
  %9 = load %struct.__locale_t*, %struct.__locale_t** %8, align 8, !dbg !367, !tbaa !309
  %10 = icmp eq %struct.__locale_t* %9, null, !dbg !365
...
; <label>:12:                                     ; preds = %4, %11
  %13 = phi %struct.__locale_t* [ @__global_locale, %11 ], [ %9, %4 ], !dbg !365
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !370
  %14 = getelementptr inbounds %struct.__locale_t, %struct.__locale_t* %13, i64 0, i32 2, !dbg !371
  %15 = load i32 (%struct._reent*, i32*, i8*, i64, %struct._mbstate_t*)*, i32 (%struct._reent*, i32*, i8*, i64, %struct._mbstate_t*)** %14, align 8, !dbg !371, !tbaa !323
  br i1 %6, label %16, label %18, !dbg !372

; <label>:16:                                     ; preds = %12
  %17 = tail call i32 %15(%struct._reent* %5, i32* null, i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str, i64 0, i64 0), i64 1, %struct._mbstate_t* %3) #3, !dbg !373
  br label %20, !dbg !374

; <label>:18:                                     ; preds = %12
  %19 = tail call i32 %15(%struct._reent* %5, i32* %0, i8* nonnull %1, i64 %2, %struct._mbstate_t* %3) #3, !dbg !375
  br label %20

; <label>:20:                                     ; preds = %18, %16
  %21 = phi i32 [ %17, %16 ], [ %19, %18 ], !dbg !371
  %22 = icmp eq i32 %21, -1, !dbg !376
  br i1 %22, label %23, label %26, !dbg !378

; <label>:23:                                     ; preds = %20
  %24 = getelementptr inbounds %struct._mbstate_t, %struct._mbstate_t* %3, i64 0, i32 0, !dbg !379
  store i32 0, i32* %24, align 4, !dbg !381, !tbaa !336
  %25 = getelementptr inbounds %struct._reent, %struct._reent* %5, i64 0, i32 0, !dbg !382
  store i32 138, i32* %25, align 8, !dbg !383, !tbaa !340
  br label %28, !dbg !384

; <label>:26:                                     ; preds = %20
  %27 = sext i32 %21 to i64, !dbg !385
  br label %28, !dbg !386

; <label>:28:                                     ; preds = %26, %23
  %29 = phi i64 [ -1, %23 ], [ %27, %26 ], !dbg !387
...
!319 = distinct !DISubprogram(name: "__get_global_locale", scope: !115, file: !115, line: 210, type: !305, isLocal: true, isDefinition: true, scopeLine: 211, isOptimized: true, unit: !0, retainedNodes: !2)
...
!322 = !DILocation(line: 0, scope: !302)
!323 = !{!324, !314, i64 232}
!324 = !{!"__locale_t", !312, i64 0, !314, i64 224, !314, i64 232, !311, i64 240, !314, i64 248, !325, i64 256, !312, i64 352, !312, i64 354, !312, i64 386}
!325 = !{!"lconv", !314, i64 0, !314, i64 8, !314, i64 16, !314, i64 24, !314, i64 32, !314, i64 40, !314, i64 48, !314, i64 56, !314, i64 64, !314, i64 72, !312, i64 80, !312, i64 81, !312, i64 82, !312, i64 83, !312, i64 84, !312, i64 85, !312, i64 86, !312, i64 87, !312, i64 88, !312, i64 89, !312, i64 90, !312, i64 91, !312, i64 92, !312, i64 93}
!326 = !DILocation(line: 28, column: 7, scope: !14)
!327 = !DILocation(line: 29, column: 14, scope: !302)
!328 = !DILocation(line: 29, column: 5, scope: !302)
!329 = !DILocation(line: 31, column: 14, scope: !302)
!330 = !DILocation(line: 33, column: 14, scope: !331)
!331 = distinct !DILexicalBlock(scope: !14, file: !1, line: 33, column: 7)
!332 = !DILocation(line: 33, column: 7, scope: !14)
!333 = !DILocation(line: 35, column: 11, scope: !334)
!334 = distinct !DILexicalBlock(scope: !331, file: !1, line: 34, column: 5)
!335 = !DILocation(line: 35, column: 19, scope: !334)
!336 = !{!337, !311, i64 0}
!337 = !{!"", !311, i64 0, !312, i64 4}
!338 = !DILocation(line: 36, column: 12, scope: !334)
!339 = !DILocation(line: 36, column: 19, scope: !334)
!340 = !{!310, !311, i64 0}
!341 = !DILocation(line: 37, column: 7, scope: !334)
!342 = !DILocation(line: 40, column: 12, scope: !331)
!343 = !DILocation(line: 40, column: 5, scope: !331)
!344 = !DILocation(line: 0, scope: !331)
!345 = !DILocation(line: 41, column: 1, scope: !14)
!346 = distinct !DISubprogram(name: "mbrtowc", scope: !1, file: !1, line: 45, type: !347, isLocal: false, isDefinition: true, scopeLine: 50, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !352)
!347 = !DISubroutineType(types: !348)
!348 = !{!17, !349, !350, !5, !351}
!349 = !DIDerivedType(tag: DW_TAG_restrict_type, baseType: !134)
!350 = !DIDerivedType(tag: DW_TAG_restrict_type, baseType: !57)
!351 = !DIDerivedType(tag: DW_TAG_restrict_type, baseType: !127)
!352 = !{!353, !354, !355, !356, !357, !358}
!353 = !DILocalVariable(name: "pwc", arg: 1, scope: !346, file: !1, line: 45, type: !349)
!354 = !DILocalVariable(name: "s", arg: 2, scope: !346, file: !1, line: 45, type: !350)
!355 = !DILocalVariable(name: "n", arg: 3, scope: !346, file: !1, line: 45, type: !5)
!356 = !DILocalVariable(name: "ps", arg: 4, scope: !346, file: !1, line: 45, type: !351)
!357 = !DILocalVariable(name: "retval", scope: !346, file: !1, line: 54, type: !24)
!358 = !DILocalVariable(name: "reent", scope: !346, file: !1, line: 55, type: !19)
!359 = !DILocation(line: 45, column: 1, scope: !346)
!360 = !DILocation(line: 54, column: 7, scope: !346)
!361 = !DILocation(line: 55, column: 26, scope: !346)
!362 = !DILocation(line: 55, column: 18, scope: !346)
!363 = !DILocation(line: 65, column: 9, scope: !364)
!364 = distinct !DILexicalBlock(scope: !346, file: !1, line: 65, column: 7)
!365 = !DILocation(line: 230, column: 10, scope: !304, inlinedAt: !366)
!366 = distinct !DILocation(line: 0, scope: !364)
!367 = !DILocation(line: 230, column: 18, scope: !304, inlinedAt: !366)
!368 = !DILocation(line: 213, column: 3, scope: !319, inlinedAt: !369)
!369 = distinct !DILocation(line: 230, column: 29, scope: !304, inlinedAt: !366)
!370 = !DILocation(line: 230, column: 3, scope: !304, inlinedAt: !366)
!371 = !DILocation(line: 0, scope: !364)
!372 = !DILocation(line: 65, column: 7, scope: !346)
!373 = !DILocation(line: 66, column: 14, scope: !364)
!374 = !DILocation(line: 66, column: 5, scope: !364)
!375 = !DILocation(line: 68, column: 14, scope: !364)
!376 = !DILocation(line: 70, column: 14, scope: !377)
!377 = distinct !DILexicalBlock(scope: !346, file: !1, line: 70, column: 7)
!378 = !DILocation(line: 70, column: 7, scope: !346)
!379 = !DILocation(line: 72, column: 11, scope: !380)
!380 = distinct !DILexicalBlock(scope: !377, file: !1, line: 71, column: 5)
!381 = !DILocation(line: 72, column: 19, scope: !380)
!382 = !DILocation(line: 73, column: 14, scope: !380)
!383 = !DILocation(line: 73, column: 21, scope: !380)
!384 = !DILocation(line: 74, column: 7, scope: !380)
!385 = !DILocation(line: 77, column: 12, scope: !377)
!386 = !DILocation(line: 77, column: 5, scope: !377)
!387 = !DILocation(line: 0, scope: !377)
!388 = !DILocation(line: 79, column: 1, scope: !346)
