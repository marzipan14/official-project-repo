...
; <label>:33:                                     ; preds = %25
  ...
  %36 = and i64 %35, -65536, !dbg !658
  %37 = inttoptr i64 %36 to %struct.uk_thread**, !dbg !659
  %38 = load %struct.uk_thread*, %struct.uk_thread** %37, align 65536, !dbg !661, !tbaa !662
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !663
  %39 = icmp eq %struct.uk_thread* %38, null, !dbg !665
  br i1 %39, label %40, label %41, !dbg !668, !prof !669
...
; <label>:41:                                     ; preds = %33
  %42 = getelementptr inbounds %struct.uk_thread, %struct.uk_thread* %38, i64 0, i32 9, !dbg !672
  %43 = load %struct.uk_sched*, %struct.uk_sched** %42, align 8, !dbg !672, !tbaa !673
  %44 = icmp eq %struct.uk_sched* %43, null, !dbg !680
  br i1 %44, label %45, label %46, !dbg !683, !prof !669
...
; <label>:46:                                     ; preds = %41
  %47 = getelementptr inbounds %struct.uk_sched, %struct.uk_sched* %43, i64 0, i32 0, !dbg !686
  %48 = load void (%struct.uk_sched*)*, void (%struct.uk_sched*)** %47, align 8, !dbg !686, !tbaa !687
  tail call void %48(%struct.uk_sched* nonnull %43) #7, !dbg !691
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !692
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !693
  br label %72, !dbg !694, !llvm.loop !695

; <label>:49:                                     ; preds = %25
  %50 = getelementptr inbounds %struct.ThreadKeyAssoc, %struct.ThreadKeyAssoc* %26, i64 0, i32 2, !dbg !698
  %51 = bitcast %struct.ThreadKeyAssoc** %50 to i64*, !dbg !698
  %52 = load i64, i64* %51, align 8, !dbg !698, !tbaa !699
  store i64 %52, i64* %10, align 8, !dbg !700, !tbaa !608
  %53 = load %struct.pthread_key_t_*, %struct.pthread_key_t_** %28, align 8, !dbg !701, !tbaa !622
  %54 = getelementptr inbounds %struct.pthread_key_t_, %struct.pthread_key_t_* %53, i64 0, i32 1, !dbg !703
  %55 = load void (i8*)*, void (i8*)** %54, align 8, !dbg !703, !tbaa !704
  %56 = getelementptr inbounds %struct.pthread_key_t_, %struct.pthread_key_t_* %53, i64 0, i32 0, !dbg !707
  %57 = load i32, i32* %56, align 8, !dbg !707, !tbaa !708
  %58 = tail call i8* @pte_osTlsGetValue(i32 %57) #7, !dbg !709
  %59 = load i32, i32* %56, align 8, !dbg !711, !tbaa !708
  %60 = tail call i32 @pte_osTlsSetValue(i32 %59, i8* null) #7, !dbg !712
  %61 = icmp ne i8* %58, null, !dbg !713
  %62 = and i1 %24, %61, !dbg !715
  br i1 %62, label %63, label %68, !dbg !715

; <label>:63:                                     ; preds = %49
  %64 = tail call i32 @pthread_mutex_unlock(%struct.pthread_mutex_t_** nonnull %6) #7, !dbg !716
  %65 = getelementptr inbounds %struct.pthread_key_t_, %struct.pthread_key_t_* %53, i64 0, i32 2, !dbg !718
  %66 = tail call i32 @pthread_mutex_unlock(%struct.pthread_mutex_t_** nonnull %65) #7, !dbg !719
  %67 = add nsw i32 %27, 1, !dbg !720
  tail call void %55(i8* nonnull %58) #7, !dbg !721
  br label %72, !dbg !722

; <label>:68:                                     ; preds = %49
  tail call void @pte_tkAssocDestroy(%struct.ThreadKeyAssoc* nonnull %26) #7, !dbg !723
  %69 = tail call i32 @pthread_mutex_unlock(%struct.pthread_mutex_t_** nonnull %6) #7, !dbg !725
  %70 = getelementptr inbounds %struct.pthread_key_t_, %struct.pthread_key_t_* %53, i64 0, i32 2, !dbg !726
  %71 = tail call i32 @pthread_mutex_unlock(%struct.pthread_mutex_t_** nonnull %70) #7, !dbg !727
  br label %72

; <label>:72:                                     ; preds = %63, %68, %46
  %73 = phi i32 [ %27, %46 ], [ %67, %63 ], [ %27, %68 ], !dbg !728
...
; <label>:77:                                     ; preds = %72
  ...
  br i1 %79, label %80, label %12, !dbg !618, !llvm.loop !729
...
define internal void @uk_pr_crit(i8* nocapture readnone, ...) unnamed_addr #4 !dbg !2 {
  ...
  %3 = bitcast [1 x %struct.__va_list_tag]* %2 to i8*, !dbg !733
  call void @llvm.lifetime.start.p0i8(i64 24, i8* nonnull %3) #6, !dbg !733
  %4 = getelementptr inbounds [1 x %struct.__va_list_tag], [1 x %struct.__va_list_tag]* %2, i64 0, i64 0, !dbg !735
  call void @llvm.va_start(i8* nonnull %3), !dbg !735
  call void @_uk_vprintk(i32 0, i8* getelementptr inbounds ([20 x i8], [20 x i8]* @uk_pr_crit.__str, i64 0, i64 0), i8* getelementptr inbounds ([30 x i8], [30 x i8]* @uk_pr_crit.__str.3, i64 0, i64 0), i32 198, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str, i64 0, i64 0), %struct.__va_list_tag* nonnull %4) #7, !dbg !736
  call void @llvm.va_end(i8* nonnull %3), !dbg !739
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %3) #6, !dbg !740
...
!673 = !{!674, !602, i64 88}
!674 = !{!"uk_thread", !602, i64 0, !602, i64 8, !602, i64 16, !602, i64 24, !675, i64 32, !606, i64 48, !676, i64 56, !677, i64 64, !678, i64 72, !602, i64 88, !602, i64 96, !606, i64 104, !602, i64 112, !602, i64 120}
!675 = !{!"", !602, i64 0, !602, i64 8}
!676 = !{!"long", !603, i64 0}
!677 = !{!"_Bool", !603, i64 0}
!678 = !{!"uk_waitq", !602, i64 0, !602, i64 8}
...
!687 = !{!688, !602, i64 0}
!688 = !{!"uk_sched", !602, i64 0, !602, i64 8, !602, i64 16, !602, i64 24, !602, i64 32, !602, i64 40, !602, i64 48, !602, i64 56, !602, i64 64, !677, i64 72, !674, i64 80, !689, i64 208, !690, i64 224, !602, i64 248, !602, i64 256, !602, i64 264}
!689 = !{!"uk_thread_list", !602, i64 0, !602, i64 8}
!690 = !{!"ukplat_ctx_callbacks", !602, i64 0, !602, i64 8, !602, i64 16}
!691 = !DILocation(line: 123, column: 2, scope: !645, inlinedAt: !649)
!692 = !DILocation(line: 124, column: 1, scope: !645, inlinedAt: !649)
!693 = !DILocation(line: 245, column: 1, scope: !650, inlinedAt: !653)
!694 = !DILocation(line: 147, column: 23, scope: !629)
!695 = distinct !{!695, !696, !697}
!696 = !DILocation(line: 107, column: 11, scope: !587)
!697 = !DILocation(line: 225, column: 13, scope: !587)
!698 = !DILocation(line: 153, column: 38, scope: !585)
!699 = !{!623, !602, i64 16}
!700 = !DILocation(line: 153, column: 29, scope: !585)
!701 = !DILocation(line: 162, column: 26, scope: !585)
!702 = !DILocation(line: 110, column: 29, scope: !585)
!703 = !DILocation(line: 163, column: 31, scope: !585)
!704 = !{!705, !602, i64 8}
!705 = !{!"pthread_key_t_", !606, i64 0, !602, i64 8, !602, i64 16, !602, i64 24}
!706 = !DILocation(line: 111, column: 22, scope: !585)
!707 = !DILocation(line: 164, column: 44, scope: !585)
!708 = !{!705, !606, i64 0}
!709 = !DILocation(line: 164, column: 23, scope: !585)
!710 = !DILocation(line: 109, column: 22, scope: !585)
!711 = !DILocation(line: 165, column: 37, scope: !585)
!712 = !DILocation(line: 165, column: 15, scope: !585)
!713 = !DILocation(line: 168, column: 25, scope: !714)
!714 = distinct !DILexicalBlock(scope: !585, file: !10, line: 168, column: 19)
!715 = !DILocation(line: 168, column: 33, scope: !714)
!716 = !DILocation(line: 177, column: 26, scope: !717)
!717 = distinct !DILexicalBlock(scope: !714, file: !10, line: 169, column: 17)
!718 = !DILocation(line: 178, column: 52, scope: !717)
!719 = !DILocation(line: 178, column: 26, scope: !717)
!720 = !DILocation(line: 180, column: 34, scope: !717)
!721 = !DILocation(line: 210, column: 19, scope: !717)
!722 = !DILocation(line: 214, column: 17, scope: !717)
!723 = !DILocation(line: 221, column: 19, scope: !724)
!724 = distinct !DILexicalBlock(scope: !714, file: !10, line: 216, column: 17)
!725 = !DILocation(line: 222, column: 26, scope: !724)
!726 = !DILocation(line: 223, column: 52, scope: !724)
!727 = !DILocation(line: 223, column: 26, scope: !724)
!728 = !DILocation(line: 0, scope: !717)
!729 = distinct !{!729, !730, !731}
!730 = !DILocation(line: 90, column: 7, scope: !580)
!731 = !DILocation(line: 227, column: 29, scope: !580)
!732 = !DILocation(line: 229, column: 1, scope: !573)
!733 = !DILocation(line: 196, column: 2, scope: !2)
!734 = !DILocation(line: 196, column: 10, scope: !2)
!735 = !DILocation(line: 197, column: 2, scope: !2)
!736 = !DILocation(line: 198, column: 2, scope: !737)
!737 = distinct !DILexicalBlock(scope: !738, file: !3, line: 198, column: 2)
!738 = distinct !DILexicalBlock(scope: !2, file: !3, line: 198, column: 2)
!739 = !DILocation(line: 199, column: 2, scope: !2)
!740 = !DILocation(line: 200, column: 1, scope: !2)
