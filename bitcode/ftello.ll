...
; <label>:79:                                     ; preds = %16, %43
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %11) #5, !dbg !348
  br label %84

; <label>:80:                                     ; preds = %52, %68, %65, %72, %60
  %81 = phi i64 [ %64, %60 ], [ %56, %52 ], [ %78, %72 ], [ %48, %68 ], [ %48, %65 ], !dbg !349
  %82 = load i32, i32* %3, align 4, !dbg !350, !tbaa !288
  %83 = call i32 @pthread_setcancelstate(i32 %82, i32* nonnull %3) #4, !dbg !350
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %11) #5, !dbg !348
  br label %84

; <label>:84:                                     ; preds = %79, %80
  %85 = phi i64 [ %81, %80 ], [ -1, %79 ]
...
; Function Attrs: noredzone nounwind
define dso_local i64 @ftello(%struct.__sFILE*) local_unnamed_addr #0 !dbg !352 {
  %2 = tail call %struct._reent* @__getreent() #4, !dbg !361
  %3 = tail call i64 @_ftello_r(%struct._reent* %2, %struct.__sFILE* %0) #6, !dbg !362
...
!348 = !DILocation(line: 159, column: 3, scope: !30)
!349 = !DILocation(line: 0, scope: !297)
!350 = !DILocation(line: 159, column: 3, scope: !258)
!351 = !DILocation(line: 161, column: 1, scope: !30)
!352 = distinct !DISubprogram(name: "ftello", scope: !1, file: !1, line: 166, type: !353, isLocal: false, isDefinition: true, scopeLine: 168, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !358)
!353 = !DISubroutineType(types: !354)
!354 = !{!355, !248}
!355 = !DIDerivedType(tag: DW_TAG_typedef, name: "off_t", file: !356, line: 173, baseType: !357)
!356 = !DIFile(filename: "/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/include/sys/types.h", directory: "/root/.unikraft/apps/redis/build")
!357 = !DIDerivedType(tag: DW_TAG_typedef, name: "__off_t", file: !24, line: 100, baseType: !33)
!358 = !{!359}
!359 = !DILocalVariable(name: "fp", arg: 1, scope: !352, file: !1, line: 166, type: !248)
!360 = !DILocation(line: 166, column: 1, scope: !352)
!361 = !DILocation(line: 169, column: 21, scope: !352)
!362 = !DILocation(line: 169, column: 10, scope: !352)
!363 = !DILocation(line: 169, column: 3, scope: !352)
