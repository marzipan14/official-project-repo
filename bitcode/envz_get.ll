...
; <label>:15:                                     ; preds = %12
  %16 = getelementptr inbounds i8, i8* %13, i64 1, !dbg !48
  store i8* %16, i8** %4, align 8, !dbg !48, !tbaa !29
  br label %20, !dbg !50

; <label>:17:                                     ; preds = %12, %9
  %18 = load i64, i64* %5, align 8, !dbg !51, !tbaa !35
  %19 = icmp eq i64 %18, 0, !dbg !37
  br i1 %19, label %20, label %9, !dbg !37, !llvm.loop !52

; <label>:20:                                     ; preds = %12, %17, %3, %15
  %21 = phi i8* [ %16, %15 ], [ null, %3 ], [ null, %17 ], [ null, %12 ], !dbg !54
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %7) #4, !dbg !55
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %6) #4, !dbg !55
...
!49 = distinct !DILexicalBlock(scope: !43, file: !1, line: 29, column: 13)
!50 = !DILocation(line: 31, column: 15, scope: !49)
!51 = !DILocation(line: 24, column: 9, scope: !10)
!52 = distinct !{!52, !37, !53}
!53 = !DILocation(line: 40, column: 5, scope: !10)
!54 = !DILocation(line: 0, scope: !10)
!55 = !DILocation(line: 43, column: 1, scope: !10)
