...
; <label>:29:                                     ; preds = %20
  ...
  br i1 %30, label %31, label %34, !dbg !79
...
; <label>:34:                                     ; preds = %22, %31, %29
  %35 = phi double [ %33, %31 ], [ %0, %29 ], [ %0, %22 ]
  %36 = sub nsw i32 %12, %11, !dbg !83
  %37 = sub i32 %6, %10, !dbg !85
  %38 = or i32 %36, %37, !dbg !86
  %39 = icmp eq i32 %38, 0, !dbg !87
  br i1 %39, label %40, label %42, !dbg !88

; <label>:40:                                     ; preds = %34
  %41 = fmul double %35, 0.000000e+00, !dbg !89
  br label %72, !dbg !90

; <label>:42:                                     ; preds = %34
  %43 = tail call double @fabs(double %35) #3, !dbg !91
  %44 = tail call double @fabs(double %1) #3, !dbg !92
  %45 = icmp ult i32 %11, 2097152, !dbg !93
  br i1 %45, label %46, label %55, !dbg !95

; <label>:46:                                     ; preds = %42
  %47 = fadd double %43, %43, !dbg !96
  %48 = fcmp ogt double %47, %44, !dbg !99
  br i1 %48, label %49, label %63, !dbg !100

; <label>:49:                                     ; preds = %46
  %50 = fsub double %43, %44, !dbg !101
  %51 = fadd double %50, %50, !dbg !103
  %52 = fcmp ult double %51, %44, !dbg !105
  br i1 %52, label %63, label %53, !dbg !106

; <label>:53:                                     ; preds = %49
  %54 = fsub double %50, %44, !dbg !107
  br label %63, !dbg !108

; <label>:55:                                     ; preds = %42
  %56 = fmul double %44, 5.000000e-01, !dbg !109
  %57 = fcmp ogt double %43, %56, !dbg !112
  br i1 %57, label %58, label %63, !dbg !114

; <label>:58:                                     ; preds = %55
  %59 = fsub double %43, %44, !dbg !115
  %60 = fcmp ult double %59, %56, !dbg !117
  br i1 %60, label %63, label %61, !dbg !119

; <label>:61:                                     ; preds = %58
  %62 = fsub double %59, %44, !dbg !120
  br label %63, !dbg !121

; <label>:63:                                     ; preds = %49, %58, %53, %46, %61, %55
  %64 = phi double [ %54, %53 ], [ %50, %49 ], [ %43, %46 ], [ %62, %61 ], [ %59, %58 ], [ %43, %55 ], !dbg !122
  %65 = bitcast double %64 to i64, !dbg !123
  %66 = and i64 %3, -9223372036854775808, !dbg !124
  %67 = and i64 %65, -4294967296, !dbg !124
  %68 = xor i64 %67, %66, !dbg !124
  %69 = and i64 %65, 4294967295, !dbg !124
  %70 = or i64 %68, %69, !dbg !124
  %71 = bitcast i64 %70 to double, !dbg !124
  br label %72, !dbg !125

; <label>:72:                                     ; preds = %63, %40, %26, %15
  %73 = phi double [ %17, %15 ], [ %28, %26 ], [ %41, %40 ], [ %71, %63 ], !dbg !122
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !126
  ret double %73, !dbg !126
}
...
!83 = !DILocation(line: 60, column: 10, scope: !84)
!84 = distinct !DILexicalBlock(scope: !12, file: !1, line: 60, column: 6)
!85 = !DILocation(line: 60, column: 18, scope: !84)
!86 = !DILocation(line: 60, column: 14, scope: !84)
!87 = !DILocation(line: 60, column: 23, scope: !84)
!88 = !DILocation(line: 60, column: 6, scope: !12)
!89 = !DILocation(line: 60, column: 39, scope: !84)
!90 = !DILocation(line: 60, column: 28, scope: !84)
!91 = !DILocation(line: 61, column: 7, scope: !12)
!92 = !DILocation(line: 62, column: 7, scope: !12)
!93 = !DILocation(line: 63, column: 8, scope: !94)
!94 = distinct !DILexicalBlock(scope: !12, file: !1, line: 63, column: 6)
!95 = !DILocation(line: 63, column: 6, scope: !12)
!96 = !DILocation(line: 64, column: 10, scope: !97)
!97 = distinct !DILexicalBlock(scope: !98, file: !1, line: 64, column: 9)
!98 = distinct !DILexicalBlock(scope: !94, file: !1, line: 63, column: 21)
!99 = !DILocation(line: 64, column: 12, scope: !97)
!100 = !DILocation(line: 64, column: 9, scope: !98)
!101 = !DILocation(line: 65, column: 4, scope: !102)
!102 = distinct !DILexicalBlock(scope: !97, file: !1, line: 64, column: 16)
!103 = !DILocation(line: 66, column: 7, scope: !104)
!104 = distinct !DILexicalBlock(scope: !102, file: !1, line: 66, column: 6)
!105 = !DILocation(line: 66, column: 9, scope: !104)
!106 = !DILocation(line: 66, column: 6, scope: !102)
!107 = !DILocation(line: 66, column: 16, scope: !104)
!108 = !DILocation(line: 66, column: 14, scope: !104)
!109 = !DILocation(line: 69, column: 18, scope: !110)
!110 = distinct !DILexicalBlock(scope: !94, file: !1, line: 68, column: 9)
!111 = !DILocation(line: 43, column: 9, scope: !12)
!112 = !DILocation(line: 70, column: 10, scope: !113)
!113 = distinct !DILexicalBlock(scope: !110, file: !1, line: 70, column: 9)
!114 = !DILocation(line: 70, column: 9, scope: !110)
!115 = !DILocation(line: 71, column: 4, scope: !116)
!116 = distinct !DILexicalBlock(scope: !113, file: !1, line: 70, column: 19)
!117 = !DILocation(line: 72, column: 7, scope: !118)
!118 = distinct !DILexicalBlock(scope: !116, file: !1, line: 72, column: 6)
!119 = !DILocation(line: 72, column: 6, scope: !116)
!120 = !DILocation(line: 72, column: 19, scope: !118)
!121 = !DILocation(line: 72, column: 17, scope: !118)
!122 = !DILocation(line: 0, scope: !12)
!123 = !DILocation(line: 75, column: 2, scope: !44)
!124 = !DILocation(line: 76, column: 2, scope: !46)
!125 = !DILocation(line: 77, column: 2, scope: !12)
!126 = !DILocation(line: 78, column: 1, scope: !12)
