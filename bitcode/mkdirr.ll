; ModuleID = '/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/reent/mkdirr.c'
source_filename = "/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/reent/mkdirr.c"
...
define dso_local i32 @_mkdir_r(%struct._reent* nocapture, i8*, i32) local_unnamed_addr #0 !dbg !7 {
  store i32 0, i32* @errno, align 4, !dbg !236, !tbaa !237
  %4 = tail call i32 @mkdir(i8* %1, i32 %2) #3, !dbg !241
...
declare dso_local i32 @mkdir(i8*, i32) local_unnamed_addr #1
...
!1 = !DIFile(filename: "/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/reent/mkdirr.c", directory: "/root/.unikraft/apps/redis/build")
!2 = !{}
!3 = !{i32 2, !"Dwarf Version", i32 4}
!4 = !{i32 2, !"Debug Info Version", i32 3}
!5 = !{i32 1, !"wchar_size", i32 4}
!6 = !{!"clang version 7.0.1-8+deb10u2 (tags/RELEASE_701/final)"}
!7 = distinct !DISubprogram(name: "_mkdir_r", scope: !1, file: !1, line: 50, type: !8, isLocal: false, isDefinition: true, scopeLine: 54, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !230)
...
!232 = !DILocalVariable(name: "path", arg: 2, scope: !7, file: !1, line: 50, type: !50)
!233 = !DILocalVariable(name: "mode", arg: 3, scope: !7, file: !1, line: 50, type: !10)
...
!244 = !DILocation(line: 58, column: 35, scope: !242)
!245 = !DILocation(line: 58, column: 44, scope: !242)
!246 = !DILocation(line: 58, column: 50, scope: !242)
!247 = !DILocation(line: 58, column: 41, scope: !242)
