...
.LBB16_63:
	movl	$42, __A_VARIABLE(%rip)
	jmp	.LBB16_64
.LBB16_97:                              #   in Loop: Header=BB16_64 Depth=1
	movq	-48(%rbp), %rsi
	movq	%r13, %rdi
	callq	addReplyBulkLongLong
	movq	-48(%rbp), %rdi
	callq	createStringObjectFromLongLong
.LBB16_89:                              #   in Loop: Header=BB16_64 Depth=1
	movq	%rax, %rbx
	movq	%rax, -64(%rbp)
	movq	server+952(%rip), %rdi
	movq	16(%r13), %rax
...
# %bb.65:                               #   in Loop: Header=BB16_64 Depth=1
	cmpl	$2, %eax
	jne	.LBB16_96
# %bb.66:                               #   in Loop: Header=BB16_64 Depth=1
...
# %bb.67:                               #   in Loop: Header=BB16_64 Depth=1
	...
	movq	$-123456789, -48(%rbp)  # imm = 0xF8A432EB
	jmp	.LBB16_70
.LBB16_68:                              #   in Loop: Header=BB16_64 Depth=1
	movq	(%r15), %rax
	movq	8(%rax), %rdi
	movl	12(%r15), %esi
	leal	1(%rsi), %eax
	...
	testb	%al, %al
	je	.LBB16_90
# %bb.69:                               #   in Loop: Header=BB16_64 Depth=1
	xorl	%r14d, %r14d
.LBB16_70:                              #   in Loop: Header=BB16_64 Depth=1
	movl	8(%r15), %eax
	movl	$42, __A_VARIABLE(%rip)
	cmpl	$6, %eax
	je	.LBB16_97
# %bb.71:                               #   in Loop: Header=BB16_64 Depth=1
	cmpl	$-1, %eax
	je	.LBB16_92
# %bb.72:                               #   in Loop: Header=BB16_64 Depth=1
	movzbl	-1(%r14), %edx
	movl	%edx, %eax
	andb	$7, %al
	cmpb	$4, %al
	ja	.LBB16_73
# %bb.74:                               #   in Loop: Header=BB16_64 Depth=1
	movl	%edx, %eax
	andl	$7, %eax
	jmpq	*.LJTI16_0(,%rax,8)
.LBB16_75:                              #   in Loop: Header=BB16_64 Depth=1
	shrq	$3, %rdx
	jmp	.LBB16_80
.LBB16_79:                              #   in Loop: Header=BB16_64 Depth=1
	movq	-17(%r14), %rdx
	jmp	.LBB16_80
.LBB16_77:                              #   in Loop: Header=BB16_64 Depth=1
	movzwl	-5(%r14), %edx
	jmp	.LBB16_80
.LBB16_78:                              #   in Loop: Header=BB16_64 Depth=1
	movl	-9(%r14), %edx
	jmp	.LBB16_80
.LBB16_76:                              #   in Loop: Header=BB16_64 Depth=1
	movzbl	-3(%r14), %edx
	jmp	.LBB16_80
.LBB16_73:                              #   in Loop: Header=BB16_64 Depth=1
	xorl	%edx, %edx
.LBB16_80:                              #   in Loop: Header=BB16_64 Depth=1
	movl	$42, __A_VARIABLE(%rip)
	movq	%r13, %rdi
	movq	%r14, %rsi
	callq	addReplyBulkCBuffer
	...
	cmpb	$4, %al
	ja	.LBB16_81
# %bb.82:                               #   in Loop: Header=BB16_64 Depth=1
	movl	%esi, %eax
	andl	$7, %eax
	jmpq	*.LJTI16_1(,%rax,8)
.LBB16_83:                              #   in Loop: Header=BB16_64 Depth=1
	shrq	$3, %rsi
	jmp	.LBB16_88
.LBB16_87:                              #   in Loop: Header=BB16_64 Depth=1
	movq	-17(%r14), %rsi
	jmp	.LBB16_88
.LBB16_85:                              #   in Loop: Header=BB16_64 Depth=1
	movzwl	-5(%r14), %esi
	jmp	.LBB16_88
.LBB16_86:                              #   in Loop: Header=BB16_64 Depth=1
	movl	-9(%r14), %esi
	jmp	.LBB16_88
.LBB16_84:                              #   in Loop: Header=BB16_64 Depth=1
	movzbl	-3(%r14), %esi
	jmp	.LBB16_88
.LBB16_81:                              #   in Loop: Header=BB16_64 Depth=1
	xorl	%esi, %esi
.LBB16_88:                              #   in Loop: Header=BB16_64 Depth=1
	movl	$42, __A_VARIABLE(%rip)
	movq	%r14, %rdi
	callq	createStringObject
	jmp	.LBB16_89
...
# %bb.33:
	xorl	%r13d, %r13d
	jmp	.LBB19_34
.LBB19_83:                              #   in Loop: Header=BB19_34 Depth=1
	movq	%rbx, %rdi
	callq	decrRefCount
	cmpq	%r14, %r13
	jae	.LBB19_85
...
.LBB19_69:                              #   in Loop: Header=BB19_34 Depth=1
	...
	callq	intsetRandom
	xorl	%edi, %edi
.LBB19_70:                              #   in Loop: Header=BB19_34 Depth=1
	movq	%rax, -56(%rbp)
	movl	(%r15), %ecx
	movl	$240, %edx
	andl	%edx, %ecx
	...
	cmpl	$96, %ecx
	jne	.LBB19_72
# %bb.71:                               #   in Loop: Header=BB19_34 Depth=1
	movq	%rax, %rdi
	callq	createStringObjectFromLongLong
	jmp	.LBB19_81
.LBB19_72:                              #   in Loop: Header=BB19_34 Depth=1
	...
	cmpb	$4, %al
	ja	.LBB19_73
# %bb.74:                               #   in Loop: Header=BB19_34 Depth=1
	movl	%esi, %eax
	andl	$7, %eax
	jmpq	*.LJTI19_0(,%rax,8)
...
.LBB19_76:                              #   in Loop: Header=BB19_34 Depth=1
	movzbl	-3(%rdi), %esi
	jmp	.LBB19_80
.LBB19_73:                              #   in Loop: Header=BB19_34 Depth=1
	xorl	%esi, %esi
.LBB19_80:                              #   in Loop: Header=BB19_34 Depth=1
	movl	$42, __A_VARIABLE(%rip)
	callq	createStringObject
.LBB19_81:                              #   in Loop: Header=BB19_34 Depth=1
	movq	%rax, %rbx
	movq	-48(%rbp), %rdi         # 8-byte Reload
	movq	%rax, %rsi
	xorl	%edx, %edx
	...
	testl	%eax, %eax
	jne	.LBB19_83
# %bb.82:                               #   in Loop: Header=BB19_34 Depth=1
	addq	$1, %r13
	cmpq	%r14, %r13
	jb	.LBB19_34
	jmp	.LBB19_85
...
.LBB19_42:
	movl	$42, __A_VARIABLE(%rip)
	jmp	.LBB19_43
.LBB19_91:                              #   in Loop: Header=BB19_43 Depth=1
	movq	-56(%rbp), %rdi
	callq	createStringObjectFromLongLong
.LBB19_60:                              #   in Loop: Header=BB19_43 Depth=1
	movq	-48(%rbp), %rdi         # 8-byte Reload
	movq	%rax, %rsi
	xorl	%edx, %edx
	callq	dictAdd
...
# %bb.44:                               #   in Loop: Header=BB19_43 Depth=1
	cmpl	$2, %eax
	jne	.LBB19_90
# %bb.45:                               #   in Loop: Header=BB19_43 Depth=1
	movq	(%r15), %rdi
	callq	dictNext
	testq	%rax, %rax
	je	.LBB19_63
...
.LBB19_47:                              #   in Loop: Header=BB19_43 Depth=1
	...
	testb	%al, %al
	je	.LBB19_63
# %bb.48:                               #   in Loop: Header=BB19_43 Depth=1
	xorl	%edi, %edi
.LBB19_49:                              #   in Loop: Header=BB19_43 Depth=1
	movl	8(%rbx), %eax
	movl	$42, __A_VARIABLE(%rip)
	cmpl	$6, %eax
	je	.LBB19_91
# %bb.50:                               #   in Loop: Header=BB19_43 Depth=1
	cmpl	$-1, %eax
	je	.LBB19_65
# %bb.51:                               #   in Loop: Header=BB19_43 Depth=1
	movzbl	-1(%rdi), %esi
	movl	%esi, %eax
	andb	$7, %al
	cmpb	$4, %al
	ja	.LBB19_52
# %bb.53:                               #   in Loop: Header=BB19_43 Depth=1
	movl	%esi, %eax
	andl	$7, %eax
	jmpq	*.LJTI19_1(,%rax,8)
.LBB19_54:                              #   in Loop: Header=BB19_43 Depth=1
	shrq	$3, %rsi
	jmp	.LBB19_59
.LBB19_58:                              #   in Loop: Header=BB19_43 Depth=1
	movq	-17(%rdi), %rsi
	jmp	.LBB19_59
.LBB19_56:                              #   in Loop: Header=BB19_43 Depth=1
	movzwl	-5(%rdi), %esi
	jmp	.LBB19_59
.LBB19_57:                              #   in Loop: Header=BB19_43 Depth=1
	movl	-9(%rdi), %esi
	jmp	.LBB19_59
.LBB19_55:                              #   in Loop: Header=BB19_43 Depth=1
	movzbl	-3(%rdi), %esi
	jmp	.LBB19_59
.LBB19_52:                              #   in Loop: Header=BB19_43 Depth=1
	xorl	%esi, %esi
.LBB19_59:                              #   in Loop: Header=BB19_43 Depth=1
	movl	$42, __A_VARIABLE(%rip)
	callq	createStringObject
	jmp	.LBB19_60
.LBB19_63:
...
.LBB19_87:                              # =>This Inner Loop Header: Depth=1
	...
	testq	%rax, %rax
	je	.LBB19_88
# %bb.86:                               #   in Loop: Header=BB19_87 Depth=1
	movq	(%rax), %rsi
	movq	%r12, %rdi
	callq	addReplyBulk
	movq	%rbx, %rdi
