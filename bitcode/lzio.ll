...
define hidden i64 @luaZ_read(%struct.Zio* nocapture, i8*, i64) local_unnamed_addr #0 !dbg !455 {
  ...
  br i1 %5, label %45, label %6, !dbg !467
...
; <label>:21:                                     ; preds = %14
  ...
  br i1 %29, label %30, label %31, !dbg !488
...
; <label>:31:                                     ; preds = %21
  store i64 %27, i64* %7, align 8, !dbg !492, !tbaa !389
  store i8* %25, i8** %12, align 8, !dbg !493, !tbaa !392
  br label %32, !dbg !494

; <label>:32:                                     ; preds = %19, %31
  %33 = phi i8* [ %20, %19 ], [ %25, %31 ], !dbg !474
  %34 = phi i64 [ %15, %19 ], [ %27, %31 ], !dbg !495
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !490
  %35 = icmp ugt i64 %16, %34, !dbg !496
  %36 = select i1 %35, i64 %34, i64 %16, !dbg !497
  %37 = call i8* @memcpy(i8* %17, i8* %33, i64 %36) #5, !dbg !499
  %38 = load i64, i64* %7, align 8, !dbg !500, !tbaa !389
  %39 = sub i64 %38, %36, !dbg !500
  store i64 %39, i64* %7, align 8, !dbg !500, !tbaa !389
  %40 = load i8*, i8** %12, align 8, !dbg !501, !tbaa !392
  %41 = getelementptr inbounds i8, i8* %40, i64 %36, !dbg !501
  store i8* %41, i8** %12, align 8, !dbg !501, !tbaa !392
  %42 = getelementptr inbounds i8, i8* %17, i64 %36, !dbg !502
  %43 = sub i64 %16, %36, !dbg !503
  %44 = icmp eq i64 %43, 0, !dbg !467
  br i1 %44, label %45, label %14, !dbg !467
...
; Function Attrs: noredzone nounwind
define hidden i8* @luaZ_openspace(%struct.lua_State*, %struct.Mbuffer* nocapture, i64) local_unnamed_addr #0 !dbg !505 {
  %4 = getelementptr inbounds %struct.Mbuffer, %struct.Mbuffer* %1, i64 0, i32 2, !dbg !516
  %5 = load i64, i64* %4, align 8, !dbg !516, !tbaa !518
  %6 = icmp ult i64 %5, %2, !dbg !520
  br i1 %6, label %10, label %7, !dbg !521

; <label>:7:                                      ; preds = %3
  %8 = getelementptr inbounds %struct.Mbuffer, %struct.Mbuffer* %1, i64 0, i32 0
  %9 = load i8*, i8** %8, align 8, !dbg !522, !tbaa !523
  br label %25, !dbg !521

; <label>:10:                                     ; preds = %3
  %11 = icmp ugt i64 %2, 32, !dbg !524
  %12 = select i1 %11, i64 %2, i64 32, !dbg !524
  %13 = add i64 %12, 1, !dbg !526
  %14 = icmp ult i64 %13, -2, !dbg !526
  br i1 %14, label %15, label %19, !dbg !526

; <label>:15:                                     ; preds = %10
  %16 = getelementptr inbounds %struct.Mbuffer, %struct.Mbuffer* %1, i64 0, i32 0, !dbg !526
  %17 = load i8*, i8** %16, align 8, !dbg !526, !tbaa !523
  %18 = tail call i8* @luaM_realloc_(%struct.lua_State* %0, i8* %17, i64 %5, i64 %12) #5, !dbg !526
  br label %22, !dbg !526

; <label>:19:                                     ; preds = %10
  %20 = tail call i8* @luaM_toobig(%struct.lua_State* %0) #5, !dbg !526
  %21 = getelementptr inbounds %struct.Mbuffer, %struct.Mbuffer* %1, i64 0, i32 0, !dbg !526
  br label %22, !dbg !526

; <label>:22:                                     ; preds = %19, %15
  %23 = phi i8** [ %21, %19 ], [ %16, %15 ], !dbg !526
  %24 = phi i8* [ %20, %19 ], [ %18, %15 ], !dbg !526
  store i8* %24, i8** %23, align 8, !dbg !526, !tbaa !523
  store i64 %12, i64* %4, align 8, !dbg !526, !tbaa !518
  br label %25, !dbg !527

; <label>:25:                                     ; preds = %7, %22
  %26 = phi i8* [ %9, %7 ], [ %24, %22 ], !dbg !522
...
!490 = !DILocation(line: 45, column: 1, scope: !397, inlinedAt: !469)
!491 = !DILocation(line: 61, column: 9, scope: !463)
!492 = !DILocation(line: 40, column: 11, scope: !426, inlinedAt: !469)
!493 = !DILocation(line: 41, column: 11, scope: !426, inlinedAt: !469)
!494 = !DILocation(line: 43, column: 3, scope: !409, inlinedAt: !469)
!495 = !DILocation(line: 63, column: 18, scope: !463)
!496 = !DILocation(line: 63, column: 12, scope: !463)
!497 = !DILocation(line: 63, column: 9, scope: !463)
!498 = !DILocation(line: 60, column: 12, scope: !463)
!499 = !DILocation(line: 64, column: 5, scope: !463)
!500 = !DILocation(line: 65, column: 10, scope: !463)
!501 = !DILocation(line: 66, column: 10, scope: !463)
!502 = !DILocation(line: 67, column: 19, scope: !463)
!503 = !DILocation(line: 68, column: 7, scope: !463)
!504 = !DILocation(line: 71, column: 1, scope: !455)
!505 = distinct !DISubprogram(name: "luaZ_openspace", scope: !1, file: !1, line: 74, type: !506, isLocal: false, isDefinition: true, scopeLine: 74, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !509)
!506 = !DISubroutineType(types: !507)
!507 = !{!7, !36, !508, !9}
!508 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !270, size: 64)
!509 = !{!510, !511, !512}
!510 = !DILocalVariable(name: "L", arg: 1, scope: !505, file: !1, line: 74, type: !36)
!511 = !DILocalVariable(name: "buff", arg: 2, scope: !505, file: !1, line: 74, type: !508)
!512 = !DILocalVariable(name: "n", arg: 3, scope: !505, file: !1, line: 74, type: !9)
!513 = !DILocation(line: 74, column: 34, scope: !505)
!514 = !DILocation(line: 74, column: 46, scope: !505)
!515 = !DILocation(line: 74, column: 59, scope: !505)
!516 = !DILocation(line: 75, column: 17, scope: !517)
!517 = distinct !DILexicalBlock(scope: !505, file: !1, line: 75, column: 7)
!518 = !{!519, !369, i64 16}
!519 = !{!"Mbuffer", !372, i64 0, !369, i64 8, !369, i64 16}
!520 = !DILocation(line: 75, column: 9, scope: !517)
!521 = !DILocation(line: 75, column: 7, scope: !505)
!522 = !DILocation(line: 79, column: 16, scope: !505)
!523 = !{!519, !372, i64 0}
!524 = !DILocation(line: 76, column: 9, scope: !525)
!525 = distinct !DILexicalBlock(scope: !517, file: !1, line: 75, column: 27)
!526 = !DILocation(line: 77, column: 5, scope: !525)
!527 = !DILocation(line: 78, column: 3, scope: !525)
!528 = !DILocation(line: 79, column: 3, scope: !505)
