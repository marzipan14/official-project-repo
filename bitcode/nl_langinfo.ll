...
; <label>:59:                                     ; preds = %2
  ...
  br i1 %62, label %107, label %63, !dbg !606
...
; <label>:63:                                     ; preds = %59
  ...
  br i1 %70, label %71, label %107, !dbg !616
...
; <label>:77:                                     ; preds = %71
  %78 = icmp eq i8 %66, 0, !dbg !630
  %79 = select i1 %78, i8 43, i8 45, !dbg !630
  br label %80

; <label>:80:                                     ; preds = %73, %77
  %81 = phi i8 [ %79, %77 ], [ 46, %73 ]
  %82 = tail call i64 @strlen(i8* %60) #3, !dbg !631
  %83 = load i8*, i8** @nl_langinfo_l.csym, align 8, !dbg !632, !tbaa !442
  %84 = shl i64 %82, 32, !dbg !633
  %85 = add i64 %84, 8589934592, !dbg !633
  %86 = ashr exact i64 %85, 32, !dbg !633
  %87 = tail call i8* @realloc(i8* %83, i64 %86) #3, !dbg !634
  %88 = icmp eq i8* %87, null, !dbg !636
  %89 = load i8*, i8** @nl_langinfo_l.csym, align 8, !dbg !638
  %90 = icmp ne i8* %89, null, !dbg !638
  %91 = and i1 %88, %90, !dbg !639
  br i1 %91, label %92, label %93, !dbg !639

; <label>:92:                                     ; preds = %80
  tail call void @free(i8* nonnull %89) #3, !dbg !640
  br label %93, !dbg !640

; <label>:93:                                     ; preds = %80, %92
  store i8* %87, i8** @nl_langinfo_l.csym, align 8, !dbg !641, !tbaa !442
  br i1 %88, label %107, label %94, !dbg !642

; <label>:94:                                     ; preds = %93
  store i8 %81, i8* %87, align 1, !dbg !643, !tbaa !604
  %95 = getelementptr inbounds i8, i8* %87, i64 1, !dbg !646
  %96 = tail call i8* @strcpy(i8* nonnull %95, i8* %60) #3, !dbg !647
  %97 = load i8*, i8** @nl_langinfo_l.csym, align 8, !dbg !648, !tbaa !442
  br label %107, !dbg !649

; <label>:98:                                     ; preds = %2
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !652
  %99 = load i8*, i8** getelementptr inbounds (%struct.lc_time_T, %struct.lc_time_T* @_C_time_locale, i64 0, i32 10), align 8, !dbg !653, !tbaa !654
  br label %107, !dbg !655

; <label>:100:                                    ; preds = %2
  %101 = add i32 %0, -100001, !dbg !656
  %102 = icmp ult i32 %101, 6, !dbg !656
  br i1 %102, label %103, label %107, !dbg !656

; <label>:103:                                    ; preds = %100
  %104 = add nsw i32 %0, -100000, !dbg !658
  %105 = sext i32 %104 to i64, !dbg !660
  %106 = getelementptr inbounds %struct.__locale_t, %struct.__locale_t* %1, i64 0, i32 0, i64 %105, i64 0, !dbg !660
  br label %107, !dbg !661

; <label>:107:                                    ; preds = %73, %3, %5, %7, %9, %11, %13, %15, %20, %25, %30, %35, %37, %39, %41, %43, %45, %47, %49, %51, %53, %55, %57, %98, %59, %2, %93, %94, %63, %100, %103
  %108 = phi i8* [ %106, %103 ], [ %99, %98 ], [ getelementptr inbounds ([1 x i8], [1 x i8]* @.str.1, i64 0, i64 0), %59 ], [ %58, %57 ], [ %56, %55 ], [ %54, %53 ], [ %52, %51 ], [ %50, %49 ], [ %48, %47 ], [ %46, %45 ], [ %44, %43 ], [ %42, %41 ], [ %40, %39 ], [ %38, %37 ], [ %36, %35 ], [ %34, %30 ], [ %29, %25 ], [ %24, %20 ], [ %19, %15 ], [ %14, %13 ], [ %12, %11 ], [ %10, %9 ], [ %8, %7 ], [ %6, %5 ], [ %4, %3 ], [ getelementptr inbounds ([9 x i8], [9 x i8]* @.str, i64 0, i64 0), %2 ], [ getelementptr inbounds ([1 x i8], [1 x i8]* @.str.1, i64 0, i64 0), %63 ], [ %97, %94 ], [ getelementptr inbounds ([1 x i8], [1 x i8]* @.str.1, i64 0, i64 0), %93 ], [ getelementptr inbounds ([1 x i8], [1 x i8]* @.str.1, i64 0, i64 0), %100 ], [ getelementptr inbounds ([1 x i8], [1 x i8]* @.str.1, i64 0, i64 0), %73 ], !dbg !662
...
; Function Attrs: noredzone nounwind
define dso_local i8* @nl_langinfo(i32) local_unnamed_addr #0 !dbg !664 {
  %2 = tail call %struct._reent* @__getreent() #3, !dbg !670
  %3 = getelementptr inbounds %struct._reent, %struct._reent* %2, i64 0, i32 7, !dbg !676
  %4 = load %struct.__locale_t*, %struct.__locale_t** %3, align 8, !dbg !676, !tbaa !677
  %5 = icmp eq %struct.__locale_t* %4, null, !dbg !670
  br i1 %5, label %6, label %7, !dbg !670
...
; <label>:7:                                      ; preds = %1, %6
  %8 = phi %struct.__locale_t* [ @__global_locale, %6 ], [ %4, %1 ], !dbg !670
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !686
  %9 = tail call i8* @nl_langinfo_l(i32 %0, %struct.__locale_t* nonnull %8) #4, !dbg !687
...
!630 = !DILocation(line: 345, column: 12, scope: !619)
!631 = !DILocation(line: 347, column: 17, scope: !368)
!632 = !DILocation(line: 349, column: 56, scope: !368)
!633 = !DILocation(line: 349, column: 62, scope: !368)
!634 = !DILocation(line: 349, column: 48, scope: !368)
!635 = !DILocation(line: 180, column: 10, scope: !2)
!636 = !DILocation(line: 350, column: 46, scope: !637)
!637 = distinct !DILexicalBlock(scope: !368, file: !3, line: 350, column: 45)
!638 = !DILocation(line: 350, column: 54, scope: !637)
!639 = !DILocation(line: 350, column: 51, scope: !637)
!640 = !DILocation(line: 351, column: 43, scope: !637)
!641 = !DILocation(line: 353, column: 46, scope: !368)
!642 = !DILocation(line: 355, column: 10, scope: !368)
!643 = !DILocation(line: 356, column: 13, scope: !644)
!644 = distinct !DILexicalBlock(scope: !645, file: !3, line: 355, column: 24)
!645 = distinct !DILexicalBlock(scope: !368, file: !3, line: 355, column: 10)
!646 = !DILocation(line: 357, column: 19, scope: !644)
!647 = !DILocation(line: 357, column: 7, scope: !644)
!648 = !DILocation(line: 358, column: 13, scope: !644)
!649 = !DILocation(line: 359, column: 6, scope: !644)
!650 = !DILocation(line: 364, column: 39, scope: !378, inlinedAt: !651)
!651 = distinct !DILocation(line: 365, column: 18, scope: !363)
!652 = !DILocation(line: 366, column: 3, scope: !378, inlinedAt: !651)
!653 = !DILocation(line: 365, column: 46, scope: !363)
!654 = !{!414, !417, i64 448}
!655 = !DILocation(line: 366, column: 3, scope: !363)
!656 = !DILocation(line: 376, column: 7, scope: !657)
!657 = distinct !DILexicalBlock(scope: !363, file: !3, line: 375, column: 7)
!658 = !DILocation(line: 378, column: 9, scope: !659)
!659 = distinct !DILexicalBlock(scope: !657, file: !3, line: 376, column: 43)
!660 = !DILocation(line: 377, column: 11, scope: !659)
!661 = !DILocation(line: 377, column: 4, scope: !659)
!662 = !DILocation(line: 0, scope: !2)
!663 = !DILocation(line: 391, column: 1, scope: !2)
!664 = distinct !DISubprogram(name: "nl_langinfo", scope: !3, file: !3, line: 393, type: !665, isLocal: false, isDefinition: true, scopeLine: 394, flags: DIFlagPrototyped, isOptimized: true, unit: !288, retainedNodes: !667)
!665 = !DISubroutineType(types: !666)
!666 = !{!6, !8}
!667 = !{!668}
!668 = !DILocalVariable(name: "item", arg: 1, scope: !664, file: !3, line: 393, type: !8)
!669 = !DILocation(line: 393, column: 28, scope: !664)
!670 = !DILocation(line: 230, column: 10, scope: !671, inlinedAt: !675)
!671 = distinct !DISubprogram(name: "__get_current_locale", scope: !13, file: !13, line: 228, type: !672, isLocal: true, isDefinition: true, scopeLine: 229, flags: DIFlagPrototyped, isOptimized: true, unit: !288, retainedNodes: !674)
!672 = !DISubroutineType(types: !673)
!673 = !{!11}
!674 = !{}
!675 = distinct !DILocation(line: 395, column: 31, scope: !664)
!676 = !DILocation(line: 230, column: 18, scope: !671, inlinedAt: !675)
!677 = !{!678, !417, i64 72}
!678 = !{!"_reent", !679, i64 0, !417, i64 8, !417, i64 16, !417, i64 24, !679, i64 32, !415, i64 36, !679, i64 64, !417, i64 72, !679, i64 80, !417, i64 88, !417, i64 96, !679, i64 104, !417, i64 112, !417, i64 120, !679, i64 128, !417, i64 136, !415, i64 144, !417, i64 504, !680, i64 512, !417, i64 1304, !682, i64 1312, !415, i64 1336}
!679 = !{!"int", !415, i64 0}
!680 = !{!"_atexit", !417, i64 0, !679, i64 8, !415, i64 16, !681, i64 272}
!681 = !{!"_on_exit_args", !415, i64 0, !415, i64 256, !679, i64 512, !679, i64 516}
!682 = !{!"_glue", !417, i64 0, !679, i64 8, !417, i64 16}
!683 = !DILocation(line: 213, column: 3, scope: !684, inlinedAt: !685)
!684 = distinct !DISubprogram(name: "__get_global_locale", scope: !13, file: !13, line: 210, type: !672, isLocal: true, isDefinition: true, scopeLine: 211, isOptimized: true, unit: !288, retainedNodes: !674)
!685 = distinct !DILocation(line: 230, column: 29, scope: !671, inlinedAt: !675)
!686 = !DILocation(line: 230, column: 3, scope: !671, inlinedAt: !675)
!687 = !DILocation(line: 395, column: 10, scope: !664)
!688 = !DILocation(line: 395, column: 3, scope: !664)
