...
define dso_local void @_freelocale_r(%struct._reent* nocapture readnone, %struct.__locale_t* nocapture readnone) local_unnamed_addr #0 !dbg !7 {
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !295
  ret void, !dbg !295
}

; Function Attrs: noredzone nounwind
define dso_local void @freelocale(%struct.__locale_t* nocapture readnone) local_unnamed_addr #0 !dbg !296 {
  %2 = tail call %struct._reent* @__getreent() #3, !dbg !302
...
!303 = !DILocation(line: 41, column: 31, scope: !7, inlinedAt: !304)
!304 = distinct !DILocation(line: 63, column: 3, scope: !296)
!305 = !DILocation(line: 41, column: 53, scope: !7, inlinedAt: !304)
!306 = !DILocation(line: 58, column: 1, scope: !7, inlinedAt: !304)
!307 = !DILocation(line: 64, column: 1, scope: !296)
