; ModuleID = '/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/stdlib/putenv_r.c'
source_filename = "/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/stdlib/putenv_r.c"
...
define dso_local i32 @_putenv_r(%struct._reent*, i8*) local_unnamed_addr #0 !dbg !7 {
  %3 = tail call i8* @_strdup_r(%struct._reent* %0, i8* %1) #3, !dbg !237
  %4 = icmp eq i8* %3, null, !dbg !239
  br i1 %4, label %12, label %5, !dbg !241

; <label>:5:                                      ; preds = %2
  %6 = tail call i8* @strchr(i8* nonnull %3, i32 61) #3, !dbg !242
  %7 = icmp eq i8* %6, null, !dbg !245
  br i1 %7, label %8, label %9, !dbg !246

; <label>:8:                                      ; preds = %5
  tail call void @free(i8* nonnull %3) #3, !dbg !247
  br label %12, !dbg !249

; <label>:9:                                      ; preds = %5
  store i8 0, i8* %6, align 1, !dbg !250, !tbaa !251
  %10 = getelementptr inbounds i8, i8* %6, i64 1, !dbg !254
  %11 = tail call i32 @_setenv_r(%struct._reent* %0, i8* nonnull %3, i8* nonnull %10, i32 1) #3, !dbg !255
  tail call void @free(i8* nonnull %3) #3, !dbg !257
  br label %12, !dbg !258

; <label>:12:                                     ; preds = %2, %9, %8
  %13 = phi i32 [ %11, %9 ], [ 1, %8 ], [ 1, %2 ], !dbg !259
...
!1 = !DIFile(filename: "/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/stdlib/putenv_r.c", directory: "/root/.unikraft/apps/redis/build")
!2 = !{}
!3 = !{i32 2, !"Dwarf Version", i32 4}
!4 = !{i32 2, !"Debug Info Version", i32 3}
!5 = !{i32 1, !"wchar_size", i32 4}
!6 = !{!"clang version 7.0.1-8+deb10u2 (tags/RELEASE_701/final)"}
!7 = distinct !DISubprogram(name: "_putenv_r", scope: !1, file: !1, line: 34, type: !8, isLocal: false, isDefinition: true, scopeLine: 37, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !230)
...
!231 = !DILocalVariable(name: "reent_ptr", arg: 1, scope: !7, file: !1, line: 34, type: !11)
!232 = !DILocalVariable(name: "str", arg: 2, scope: !7, file: !1, line: 34, type: !44)
!233 = !DILocalVariable(name: "p", scope: !7, file: !1, line: 38, type: !44)
!234 = !DILocalVariable(name: "equal", scope: !7, file: !1, line: 38, type: !44)
!235 = !DILocalVariable(name: "rval", scope: !7, file: !1, line: 39, type: !10)
!236 = !DILocation(line: 34, column: 1, scope: !7)
!237 = !DILocation(line: 41, column: 7, scope: !7)
!238 = !DILocation(line: 38, column: 18, scope: !7)
!239 = !DILocation(line: 43, column: 8, scope: !240)
!240 = distinct !DILexicalBlock(scope: !7, file: !1, line: 43, column: 7)
!241 = !DILocation(line: 43, column: 7, scope: !7)
!242 = !DILocation(line: 46, column: 17, scope: !243)
!243 = distinct !DILexicalBlock(scope: !7, file: !1, line: 46, column: 7)
!244 = !DILocation(line: 38, column: 22, scope: !7)
!245 = !DILocation(line: 46, column: 15, scope: !243)
!246 = !DILocation(line: 46, column: 7, scope: !7)
!247 = !DILocation(line: 48, column: 14, scope: !248)
!248 = distinct !DILexicalBlock(scope: !243, file: !1, line: 47, column: 5)
!249 = !DILocation(line: 49, column: 7, scope: !248)
!250 = !DILocation(line: 52, column: 10, scope: !7)
!251 = !{!252, !252, i64 0}
!252 = !{!"omnipotent char", !253, i64 0}
!253 = !{!"Simple C/C++ TBAA"}
!254 = !DILocation(line: 53, column: 41, scope: !7)
!255 = !DILocation(line: 53, column: 10, scope: !7)
!256 = !DILocation(line: 39, column: 7, scope: !7)
!257 = !DILocation(line: 54, column: 10, scope: !7)
!258 = !DILocation(line: 56, column: 3, scope: !7)
!259 = !DILocation(line: 0, scope: !240)
!260 = !DILocation(line: 57, column: 1, scope: !7)
