...
; <label>:24:                                     ; preds = %1, %15
  ...
  call void @llvm.lifetime.end.p0i8(i64 1, i8* nonnull %5) #4, !dbg !335
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %4) #4, !dbg !335
...
!335 = !DILocation(line: 25, column: 1, scope: !14)
