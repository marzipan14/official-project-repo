...
define dso_local i64 @_wcstoll_r(%struct._reent* nocapture, i32*, i32**, i32) local_unnamed_addr #0 !dbg !424 {
  ...
  br i1 %8, label %9, label %10, !dbg !433
...
; <label>:10:                                     ; preds = %4, %9
  %11 = phi %struct.__locale_t* [ @__global_locale, %9 ], [ %7, %4 ], !dbg !433
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !443
  %12 = tail call i64 @_wcstoll_l(%struct._reent* %0, i32* %1, i32** %2, i32 %3, %struct.__locale_t* nonnull %11) #4, !dbg !444
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !445
  ret i64 %12, !dbg !445
}

; Function Attrs: noredzone nounwind
define dso_local i64 @wcstoll_l(i32* noalias, i32** noalias, i32, %struct.__locale_t*) local_unnamed_addr #0 !dbg !446 {
  %5 = tail call %struct._reent* @__getreent() #3, !dbg !460
  %6 = tail call i64 @_wcstoll_l(%struct._reent* %5, i32* %0, i32** %1, i32 %2, %struct.__locale_t* %3) #4, !dbg !461
...
; Function Attrs: noredzone nounwind
define dso_local i64 @wcstoll(i32* noalias, i32** noalias, i32) local_unnamed_addr #0 !dbg !463 {
  ...
  %7 = load %struct.__locale_t*, %struct.__locale_t** %6, align 8, !dbg !474, !tbaa !439
...
; <label>:10:                                     ; preds = %3, %9
  ...
  %12 = tail call i64 @_wcstoll_l(%struct._reent* %4, i32* %0, i32** %1, i32 %2, %struct.__locale_t* nonnull %11) #4, !dbg !478
...
!439 = !{!405, !406, i64 72}
!440 = !DILocation(line: 213, column: 3, scope: !441, inlinedAt: !442)
!441 = distinct !DISubprogram(name: "__get_global_locale", scope: !114, file: !114, line: 210, type: !435, isLocal: true, isDefinition: true, scopeLine: 211, isOptimized: true, unit: !0, retainedNodes: !2)
!442 = distinct !DILocation(line: 230, column: 29, scope: !434, inlinedAt: !437)
!443 = !DILocation(line: 230, column: 3, scope: !434, inlinedAt: !437)
!444 = !DILocation(line: 235, column: 9, scope: !424)
!445 = !DILocation(line: 235, column: 2, scope: !424)
!446 = distinct !DISubprogram(name: "wcstoll_l", scope: !1, file: !1, line: 241, type: !447, isLocal: false, isDefinition: true, scopeLine: 243, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !451)
!447 = !DISubroutineType(types: !448)
!448 = !{!16, !449, !450, !8, !295}
!449 = !DIDerivedType(tag: DW_TAG_restrict_type, baseType: !292)
!450 = !DIDerivedType(tag: DW_TAG_restrict_type, baseType: !294)
!451 = !{!452, !453, !454, !455}
!452 = !DILocalVariable(name: "s", arg: 1, scope: !446, file: !1, line: 241, type: !449)
!453 = !DILocalVariable(name: "ptr", arg: 2, scope: !446, file: !1, line: 241, type: !450)
!454 = !DILocalVariable(name: "base", arg: 3, scope: !446, file: !1, line: 241, type: !8)
!455 = !DILocalVariable(name: "loc", arg: 4, scope: !446, file: !1, line: 242, type: !295)
!456 = !DILocation(line: 241, column: 38, scope: !446)
!457 = !DILocation(line: 241, column: 62, scope: !446)
!458 = !DILocation(line: 241, column: 71, scope: !446)
!459 = !DILocation(line: 242, column: 14, scope: !446)
!460 = !DILocation(line: 244, column: 21, scope: !446)
!461 = !DILocation(line: 244, column: 9, scope: !446)
!462 = !DILocation(line: 244, column: 2, scope: !446)
!463 = distinct !DISubprogram(name: "wcstoll", scope: !1, file: !1, line: 248, type: !464, isLocal: false, isDefinition: true, scopeLine: 252, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !466)
!464 = !DISubroutineType(types: !465)
!465 = !{!16, !449, !450, !8}
!466 = !{!467, !468, !469}
!467 = !DILocalVariable(name: "s", arg: 1, scope: !463, file: !1, line: 248, type: !449)
!468 = !DILocalVariable(name: "ptr", arg: 2, scope: !463, file: !1, line: 248, type: !450)
!469 = !DILocalVariable(name: "base", arg: 3, scope: !463, file: !1, line: 248, type: !8)
!470 = !DILocation(line: 248, column: 1, scope: !463)
!471 = !DILocation(line: 253, column: 21, scope: !463)
!472 = !DILocation(line: 230, column: 10, scope: !434, inlinedAt: !473)
!473 = distinct !DILocation(line: 253, column: 43, scope: !463)
!474 = !DILocation(line: 230, column: 18, scope: !434, inlinedAt: !473)
!475 = !DILocation(line: 213, column: 3, scope: !441, inlinedAt: !476)
!476 = distinct !DILocation(line: 230, column: 29, scope: !434, inlinedAt: !473)
!477 = !DILocation(line: 230, column: 3, scope: !434, inlinedAt: !473)
!478 = !DILocation(line: 253, column: 9, scope: !463)
!479 = !DILocation(line: 253, column: 2, scope: !463)
