...
.LBB2_137:                              #   in Loop: Header=BB2_1 Depth=1
	...
	testl	%esi, %esi
	jns	.LBB2_139
# %bb.138:                              #   in Loop: Header=BB2_1 Depth=1
	movl	$1, %eax
	cmpl	$-1899, 20(%rbx)        # imm = 0xF895
	movl	$1, %edx
	jl	.LBB2_140
.LBB2_139:                              #   in Loop: Header=BB2_1 Depth=1
	...
	movb	%bl, %al
	cmpl	$-1900, -112(%rbp)      # 4-byte Folded Reload
                                        # imm = 0xF894
	cmovgel	%esi, %edx
...
.LBB2_151:                              #   in Loop: Header=BB2_1 Depth=1
	...
	testl	%eax, %eax
	jne	.LBB2_154
# %bb.152:                              #   in Loop: Header=BB2_1 Depth=1
	leaq	-240(%rbp), %rdi
	xorl	%eax, %eax
	cmpl	$43, -96(%rbp)          # 4-byte Folded Reload
	jne	.LBB2_155
...
.LBB2_164:                              #   in Loop: Header=BB2_1 Depth=1
	...
	testb	$3, %al
	jne	.LBB2_166
# %bb.165:                              #   in Loop: Header=BB2_1 Depth=1
	movslq	%eax, %rcx
