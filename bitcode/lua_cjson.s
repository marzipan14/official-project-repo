...
# %bb.45:                               #   in Loop: Header=BB13_39 Depth=1
	cmpl	$3, %eax
	jne	.LBB13_36
# %bb.46:                               #   in Loop: Header=BB13_39 Depth=1
	movl	12(%r13), %esi
	movl	%esi, %eax
	notl	%eax
	addl	8(%r13), %eax
	...
	testl	%eax, %eax
	jg	.LBB13_48
# %bb.47:                               #   in Loop: Header=BB13_39 Depth=1
	addl	$1, %esi
	movq	%r13, %rdi
                                        # kill: def $esi killed $esi killed $rsi
	callq	strbuf_resize
	movl	12(%r13), %esi
.LBB13_48:                              #   in Loop: Header=BB13_39 Depth=1
	movl	$42, __A_VARIABLE(%rip)
	movq	(%r13), %rax
	leal	1(%rsi), %ecx
	movl	%ecx, 12(%r13)
...
# %bb.49:                               #   in Loop: Header=BB13_39 Depth=1
	...
	callq	strbuf_resize
	movl	12(%r13), %esi
.LBB13_50:                              #   in Loop: Header=BB13_39 Depth=1
	movl	$42, __A_VARIABLE(%rip)
	movslq	%esi, %rdi
	addq	(%r13), %rdi
	movl	$.L.str.61, %esi
	...
	jmp	.LBB13_38
	.p2align	4, 0x90
.LBB13_51:                              #   in Loop: Header=BB13_39 Depth=1
	movq	%r14, %rdi
	movq	%r13, %rsi
	movl	$-2, %edx
	callq	json_append_string
	...
	testl	%eax, %eax
	jg	.LBB13_53
# %bb.52:                               #   in Loop: Header=BB13_39 Depth=1
	addl	$1, %esi
	movq	%r13, %rdi
                                        # kill: def $esi killed $esi killed $rsi
	callq	strbuf_resize
	movl	12(%r13), %esi
.LBB13_53:                              #   in Loop: Header=BB13_39 Depth=1
	movl	$42, __A_VARIABLE(%rip)
	movq	(%r13), %rax
	leal	1(%rsi), %ecx
	movl	%ecx, 12(%r13)
	...
	movb	$58, (%rax,%rcx)
	jmp	.LBB13_38
.LBB13_54:                              #   in Loop: Header=BB13_39 Depth=1
	movq	%r13, %rdi
	callq	strbuf_free
	jmp	.LBB13_37
.LBB13_55:
...
.LBB13_72:
	...
	jmp	.LBB13_75
	.p2align	4, 0x90
.LBB13_73:                              #   in Loop: Header=BB13_75 Depth=1
	movl	$42, __A_VARIABLE(%rip)
	movq	(%r13), %rax
	leal	1(%rsi), %ecx
	movl	%ecx, 12(%r13)
	...
	movl	$42, __A_VARIABLE(%rip)
	movl	%r15d, %r12d
.LBB13_74:                              #   in Loop: Header=BB13_75 Depth=1
	movq	%r14, %rdi
	movl	$-1, %esi
	movl	%ebx, %edx
	callq	lua_rawgeti
...
# %bb.76:                               #   in Loop: Header=BB13_75 Depth=1
	...
	testl	%eax, %eax
	jg	.LBB13_73
# %bb.77:                               #   in Loop: Header=BB13_75 Depth=1
	addl	$1, %esi
	movq	%r13, %rdi
                                        # kill: def $esi killed $esi killed $rsi
	callq	strbuf_resize
...
.LBB16_24:                              #   in Loop: Header=BB16_13 Depth=1
	...
	cmpl	$127, %r13d
	jle	.LBB16_31
.LBB16_32:                              #   in Loop: Header=BB16_13 Depth=1
...
.LBB16_34:                              #   in Loop: Header=BB16_13 Depth=1
	...
	jg	.LBB16_36
# %bb.35:                               #   in Loop: Header=BB16_13 Depth=1
	movl	%r13d, %eax
	shrl	$12, %eax
	orb	$-32, %al
	movb	%al, -48(%rbp)
	...
	movl	$3, %eax
	jmp	.LBB16_38
.LBB16_36:                              #   in Loop: Header=BB16_13 Depth=1
	cmpl	$2097151, %r13d         # imm = 0x1FFFFF
	jg	.LBB16_39
# %bb.37:                               #   in Loop: Header=BB16_13 Depth=1
	movl	%r13d, %eax
	shrl	$18, %eax
	orb	$-16, %al
	movb	%al, -48(%rbp)
...
.LBB18_8:
	...
	retq
.Lfunc_end18:
	.size	decode_hex4, .Lfunc_end18-decode_hex4
                                        # -- End function
...
.LBB19_6:
	...
	retq
.Lfunc_end19:
	.size	json_arg_init, .Lfunc_end19-json_arg_init
                                        # -- End function
...
.LBB20_8:
	...
	retq
.Lfunc_end20:
	.size	json_enum_option, .Lfunc_end20-json_enum_option
                                        # -- End function
...
.LBB21_2:
	...
	retq
.Lfunc_end21:
	.size	json_destroy_config, .Lfunc_end21-json_destroy_config
                                        # -- End function
...
.LBB22_6:
	...
	retq
.Lfunc_end22:
	.size	json_protect_conversion, .Lfunc_end22-json_protect_conversion
                                        # -- End function
