; ModuleID = '/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/reent/statr.c'
source_filename = "/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/reent/statr.c"
...
define dso_local i32 @_stat_r(%struct._reent* nocapture, i8*, %struct.stat*) local_unnamed_addr #0 !dbg !7 {
  store i32 0, i32* @errno, align 4, !dbg !280, !tbaa !281
  %4 = tail call i32 @stat(i8* %1, %struct.stat* %2) #3, !dbg !285
  %5 = icmp eq i32 %4, -1, !dbg !288
  %6 = load i32, i32* @errno, align 4, !dbg !289
  %7 = icmp ne i32 %6, 0, !dbg !290
  %8 = and i1 %5, %7, !dbg !291
  br i1 %8, label %9, label %11, !dbg !291

; <label>:9:                                      ; preds = %3
  %10 = getelementptr inbounds %struct._reent, %struct._reent* %0, i64 0, i32 0, !dbg !292
  store i32 %6, i32* %10, align 8, !dbg !293, !tbaa !294
  br label %11, !dbg !300
...
declare dso_local i32 @stat(i8*, %struct.stat*) local_unnamed_addr #1
...
!1 = !DIFile(filename: "/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/reent/statr.c", directory: "/root/.unikraft/apps/redis/build")
!2 = !{}
!3 = !{i32 2, !"Dwarf Version", i32 4}
!4 = !{i32 2, !"Debug Info Version", i32 3}
!5 = !{i32 1, !"wchar_size", i32 4}
!6 = !{!"clang version 7.0.1-8+deb10u2 (tags/RELEASE_701/final)"}
!7 = distinct !DISubprogram(name: "_stat_r", scope: !1, file: !1, line: 55, type: !8, isLocal: false, isDefinition: true, scopeLine: 59, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !274)
...
!231 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "stat", file: !232, line: 27, size: 704, elements: !233)
!232 = !DIFile(filename: "/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/include/sys/stat.h", directory: "/root/.unikraft/apps/redis/build")
!233 = !{!234, !238, !241, !246, !249, !252, !255, !256, !259, !266, !267, !268, !271}
!234 = !DIDerivedType(tag: DW_TAG_member, name: "st_dev", scope: !231, file: !232, line: 29, baseType: !235, size: 16)
!235 = !DIDerivedType(tag: DW_TAG_typedef, name: "dev_t", file: !236, line: 177, baseType: !237)
!236 = !DIFile(filename: "/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/include/sys/types.h", directory: "/root/.unikraft/apps/redis/build")
!237 = !DIDerivedType(tag: DW_TAG_typedef, name: "__dev_t", file: !42, line: 54, baseType: !27)
!238 = !DIDerivedType(tag: DW_TAG_member, name: "st_ino", scope: !231, file: !232, line: 30, baseType: !239, size: 16, offset: 16)
!239 = !DIDerivedType(tag: DW_TAG_typedef, name: "ino_t", file: !236, line: 155, baseType: !240)
!240 = !DIDerivedType(tag: DW_TAG_typedef, name: "__ino_t", file: !42, line: 73, baseType: !164)
!241 = !DIDerivedType(tag: DW_TAG_member, name: "st_mode", scope: !231, file: !232, line: 31, baseType: !242, size: 32, offset: 32)
!242 = !DIDerivedType(tag: DW_TAG_typedef, name: "mode_t", file: !236, line: 205, baseType: !243)
!243 = !DIDerivedType(tag: DW_TAG_typedef, name: "__mode_t", file: !42, line: 88, baseType: !244)
!244 = !DIDerivedType(tag: DW_TAG_typedef, name: "__uint32_t", file: !245, line: 79, baseType: !92)
...
!246 = !DIDerivedType(tag: DW_TAG_member, name: "st_nlink", scope: !231, file: !232, line: 32, baseType: !247, size: 16, offset: 64)
!247 = !DIDerivedType(tag: DW_TAG_typedef, name: "nlink_t", file: !236, line: 210, baseType: !248)
!248 = !DIDerivedType(tag: DW_TAG_typedef, name: "__nlink_t", file: !42, line: 210, baseType: !164)
!249 = !DIDerivedType(tag: DW_TAG_member, name: "st_uid", scope: !231, file: !232, line: 33, baseType: !250, size: 16, offset: 80)
!250 = !DIDerivedType(tag: DW_TAG_typedef, name: "uid_t", file: !236, line: 181, baseType: !251)
!251 = !DIDerivedType(tag: DW_TAG_typedef, name: "__uid_t", file: !42, line: 58, baseType: !164)
!252 = !DIDerivedType(tag: DW_TAG_member, name: "st_gid", scope: !231, file: !232, line: 34, baseType: !253, size: 16, offset: 96)
!253 = !DIDerivedType(tag: DW_TAG_typedef, name: "gid_t", file: !236, line: 185, baseType: !254)
!254 = !DIDerivedType(tag: DW_TAG_typedef, name: "__gid_t", file: !42, line: 61, baseType: !164)
!255 = !DIDerivedType(tag: DW_TAG_member, name: "st_rdev", scope: !231, file: !232, line: 35, baseType: !235, size: 16, offset: 112)
!256 = !DIDerivedType(tag: DW_TAG_member, name: "st_size", scope: !231, file: !232, line: 36, baseType: !257, size: 64, offset: 128)
!257 = !DIDerivedType(tag: DW_TAG_typedef, name: "off_t", file: !236, line: 173, baseType: !258)
!258 = !DIDerivedType(tag: DW_TAG_typedef, name: "__off_t", file: !42, line: 100, baseType: !75)
!259 = !DIDerivedType(tag: DW_TAG_member, name: "st_atim", scope: !231, file: !232, line: 37, baseType: !260, size: 128, offset: 192)
!260 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "timespec", file: !261, line: 52, size: 128, elements: !262)
!261 = !DIFile(filename: "/root/.unikraft/unikraft/lib/uktime/include/uk/time_types.h", directory: "/root/.unikraft/apps/redis/build")
!262 = !{!263, !265}
!263 = !DIDerivedType(tag: DW_TAG_member, name: "tv_sec", scope: !260, file: !261, line: 53, baseType: !264, size: 64)
!264 = !DIDerivedType(tag: DW_TAG_typedef, name: "time_t", file: !261, line: 34, baseType: !43)
!265 = !DIDerivedType(tag: DW_TAG_member, name: "tv_nsec", scope: !260, file: !261, line: 54, baseType: !43, size: 64, offset: 64)
!266 = !DIDerivedType(tag: DW_TAG_member, name: "st_mtim", scope: !231, file: !232, line: 38, baseType: !260, size: 128, offset: 320)
!267 = !DIDerivedType(tag: DW_TAG_member, name: "st_ctim", scope: !231, file: !232, line: 39, baseType: !260, size: 128, offset: 448)
!268 = !DIDerivedType(tag: DW_TAG_member, name: "st_blksize", scope: !231, file: !232, line: 40, baseType: !269, size: 64, offset: 576)
!269 = !DIDerivedType(tag: DW_TAG_typedef, name: "blksize_t", file: !236, line: 118, baseType: !270)
!270 = !DIDerivedType(tag: DW_TAG_typedef, name: "__blksize_t", file: !42, line: 32, baseType: !43)
!271 = !DIDerivedType(tag: DW_TAG_member, name: "st_blocks", scope: !231, file: !232, line: 41, baseType: !272, size: 64, offset: 640)
!272 = !DIDerivedType(tag: DW_TAG_typedef, name: "blkcnt_t", file: !236, line: 113, baseType: !273)
!273 = !DIDerivedType(tag: DW_TAG_typedef, name: "__blkcnt_t", file: !42, line: 28, baseType: !43)
!274 = !{!275, !276, !277, !278}
!275 = !DILocalVariable(name: "ptr", arg: 1, scope: !7, file: !1, line: 55, type: !11)
!276 = !DILocalVariable(name: "file", arg: 2, scope: !7, file: !1, line: 55, type: !50)
!277 = !DILocalVariable(name: "pstat", arg: 3, scope: !7, file: !1, line: 55, type: !230)
!278 = !DILocalVariable(name: "ret", scope: !7, file: !1, line: 60, type: !10)
!279 = !DILocation(line: 55, column: 1, scope: !7)
!280 = !DILocation(line: 62, column: 9, scope: !7)
!281 = !{!282, !282, i64 0}
!282 = !{!"int", !283, i64 0}
!283 = !{!"omnipotent char", !284, i64 0}
!284 = !{!"Simple C/C++ TBAA"}
!285 = !DILocation(line: 63, column: 14, scope: !286)
!286 = distinct !DILexicalBlock(scope: !7, file: !1, line: 63, column: 7)
!287 = !DILocation(line: 60, column: 7, scope: !7)
!288 = !DILocation(line: 63, column: 35, scope: !286)
!289 = !DILocation(line: 63, column: 44, scope: !286)
!290 = !DILocation(line: 63, column: 50, scope: !286)
!291 = !DILocation(line: 63, column: 41, scope: !286)
!292 = !DILocation(line: 64, column: 10, scope: !286)
!293 = !DILocation(line: 64, column: 17, scope: !286)
!294 = !{!295, !282, i64 0}
!295 = !{!"_reent", !282, i64 0, !296, i64 8, !296, i64 16, !296, i64 24, !282, i64 32, !283, i64 36, !282, i64 64, !296, i64 72, !282, i64 80, !296, i64 88, !296, i64 96, !282, i64 104, !296, i64 112, !296, i64 120, !282, i64 128, !296, i64 136, !283, i64 144, !296, i64 504, !297, i64 512, !296, i64 1304, !299, i64 1312, !283, i64 1336}
!296 = !{!"any pointer", !283, i64 0}
!297 = !{!"_atexit", !296, i64 0, !282, i64 8, !283, i64 16, !298, i64 272}
!298 = !{!"_on_exit_args", !283, i64 0, !283, i64 256, !282, i64 512, !282, i64 516}
!299 = !{!"_glue", !296, i64 0, !282, i64 8, !296, i64 16}
!300 = !DILocation(line: 64, column: 5, scope: !286)
!301 = !DILocation(line: 65, column: 3, scope: !7)
