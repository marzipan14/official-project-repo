...
define dso_local i32 @pthread_delay_np(%struct.timespec* readonly) local_unnamed_addr #0 !dbg !582 {
  ...
  br i1 %2, label %59, label %3, !dbg !606

; <label>:3:                                      ; preds = %1
  %4 = getelementptr inbounds %struct.timespec, %struct.timespec* %0, i64 0, i32 0, !dbg !607
  %5 = load i64, i64* %4, align 8, !dbg !607, !tbaa !609
  %6 = getelementptr inbounds %struct.timespec, %struct.timespec* %0, i64 0, i32 1
  %7 = load i64, i64* %6, align 8, !dbg !614, !tbaa !615
  %8 = or i64 %5, %7, !dbg !616
  %9 = icmp eq i64 %8, 0, !dbg !616
  br i1 %9, label %10, label %25, !dbg !616

; <label>:10:                                     ; preds = %3
  tail call void @pthread_testcancel() #7, !dbg !617
  %11 = tail call i64 asm sideeffect "mov %rsp, $0", "=r,~{dirflag},~{fpsr},~{flags}"() #6, !dbg !619, !srcloc !642
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !644
  %12 = and i64 %11, -65536, !dbg !646
  %13 = inttoptr i64 %12 to %struct.uk_thread**, !dbg !647
  %14 = load %struct.uk_thread*, %struct.uk_thread** %13, align 65536, !dbg !649, !tbaa !650
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !652
  %15 = icmp eq %struct.uk_thread* %14, null, !dbg !654
  br i1 %15, label %16, label %17, !dbg !657, !prof !658

; <label>:16:                                     ; preds = %10
  tail call void (i8*, ...) @uk_pr_crit(i8* undef, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.1, i64 0, i64 0)) #7, !dbg !659
  tail call void @ukplat_terminate(i32 3) #8, !dbg !659
  unreachable, !dbg !659

; <label>:17:                                     ; preds = %10
  %18 = getelementptr inbounds %struct.uk_thread, %struct.uk_thread* %14, i64 0, i32 9, !dbg !661
  %19 = load %struct.uk_sched*, %struct.uk_sched** %18, align 8, !dbg !661, !tbaa !662
  %20 = icmp eq %struct.uk_sched* %19, null, !dbg !669
  br i1 %20, label %21, label %22, !dbg !672, !prof !658

; <label>:21:                                     ; preds = %17
  tail call void (i8*, ...) @uk_pr_crit(i8* undef, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i64 0, i64 0)) #7, !dbg !673
  tail call void @ukplat_terminate(i32 3) #8, !dbg !673
  unreachable, !dbg !673

; <label>:22:                                     ; preds = %17
  %23 = getelementptr inbounds %struct.uk_sched, %struct.uk_sched* %19, i64 0, i32 0, !dbg !675
  %24 = load void (%struct.uk_sched*)*, void (%struct.uk_sched*)** %23, align 8, !dbg !675, !tbaa !676
  tail call void %24(%struct.uk_sched* nonnull %19) #7, !dbg !680
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !681
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !682
  tail call void @pthread_testcancel() #7, !dbg !683
  br label %59, !dbg !684

; <label>:25:                                     ; preds = %3
  %26 = trunc i64 %5 to i32, !dbg !685
  %27 = mul i32 %26, 1000, !dbg !685
  %28 = add nsw i64 %7, 999999, !dbg !687
  %29 = sdiv i64 %28, 1000000, !dbg !688
  %30 = trunc i64 %29 to i32, !dbg !689
  %31 = add i32 %27, %30, !dbg !691
  %32 = tail call { i8*, i32 } @pthread_self() #7, !dbg !693
  %33 = extractvalue { i8*, i32 } %32, 0, !dbg !693
  %34 = icmp eq i8* %33, null, !dbg !696
  br i1 %34, label %59, label %35, !dbg !697

; <label>:35:                                     ; preds = %25
  %36 = getelementptr inbounds i8, i8* %33, i64 88, !dbg !699
  %37 = bitcast i8* %36 to i32*, !dbg !699
  %38 = load i32, i32* %37, align 8, !dbg !699, !tbaa !700
  %39 = icmp eq i32 %38, 0, !dbg !703
  br i1 %39, label %40, label %58, !dbg !704

; <label>:40:                                     ; preds = %35
  %41 = bitcast i8* %33 to %struct.uk_thread**, !dbg !705
  %42 = load %struct.uk_thread*, %struct.uk_thread** %41, align 8, !dbg !705, !tbaa !706
  %43 = tail call i32 @pte_osThreadCheckCancel(%struct.uk_thread* %42) #7, !dbg !707
...
; <label>:44:                                     ; preds = %40
  %45 = getelementptr inbounds i8, i8* %33, i64 80, !dbg !710
  %46 = bitcast i8* %45 to %struct.pthread_mutex_t_**, !dbg !710
  %47 = tail call i32 @pthread_mutex_lock(%struct.pthread_mutex_t_** nonnull %46) #7, !dbg !713
  %48 = getelementptr inbounds i8, i8* %33, i64 32, !dbg !714
  %49 = bitcast i8* %48 to i32*, !dbg !714
  %50 = load volatile i32, i32* %49, align 8, !dbg !714, !tbaa !716
  %51 = icmp ult i32 %50, 4, !dbg !717
  br i1 %51, label %52, label %54, !dbg !718

; <label>:52:                                     ; preds = %44
  store volatile i32 4, i32* %49, align 8, !dbg !719, !tbaa !716
  store i32 1, i32* %37, align 8, !dbg !721, !tbaa !700
  %53 = tail call i32 @pthread_mutex_unlock(%struct.pthread_mutex_t_** nonnull %46) #7, !dbg !722
  tail call void @pte_throw(i32 2) #7, !dbg !723
  br label %54, !dbg !724

; <label>:54:                                     ; preds = %52, %44
  %55 = tail call i32 @pthread_mutex_unlock(%struct.pthread_mutex_t_** nonnull %46) #7, !dbg !725
  br label %56, !dbg !726

; <label>:56:                                     ; preds = %54, %40
  %57 = phi i32 [ 22, %40 ], [ 3, %54 ]
  br label %59

; <label>:58:                                     ; preds = %35
  tail call void @pte_osThreadSleep(i32 %31) #7, !dbg !727
  br label %59

; <label>:59:                                     ; preds = %58, %40, %56, %25, %1, %22
  %60 = phi i32 [ 0, %22 ], [ 22, %1 ], [ 12, %25 ], [ %57, %56 ], [ %43, %40 ], [ 0, %58 ], !dbg !729
...
define internal void @uk_pr_crit(i8* nocapture readnone, ...) unnamed_addr #4 !dbg !2 {
  ...
  %3 = bitcast [1 x %struct.__va_list_tag]* %2 to i8*, !dbg !731
  call void @llvm.lifetime.start.p0i8(i64 24, i8* nonnull %3) #6, !dbg !731
  %4 = getelementptr inbounds [1 x %struct.__va_list_tag], [1 x %struct.__va_list_tag]* %2, i64 0, i64 0, !dbg !733
  call void @llvm.va_start(i8* nonnull %3), !dbg !733
  call void @_uk_vprintk(i32 0, i8* getelementptr inbounds ([20 x i8], [20 x i8]* @uk_pr_crit.__str, i64 0, i64 0), i8* getelementptr inbounds ([19 x i8], [19 x i8]* @uk_pr_crit.__str.3, i64 0, i64 0), i32 198, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str, i64 0, i64 0), %struct.__va_list_tag* nonnull %4) #7, !dbg !734
  call void @llvm.va_end(i8* nonnull %3), !dbg !737
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %3) #6, !dbg !738
...
!613 = !{!"Simple C/C++ TBAA"}
!614 = !DILocation(line: 0, scope: !582)
!615 = !{!610, !611, i64 8}
!616 = !DILocation(line: 104, column: 30, scope: !608)
!617 = !DILocation(line: 106, column: 7, scope: !618)
!618 = distinct !DILexicalBlock(scope: !608, file: !10, line: 105, column: 5)
!619 = !DILocation(line: 120, column: 2, scope: !620, inlinedAt: !626)
!620 = distinct !DISubprogram(name: "ukarch_read_sp", scope: !621, file: !621, line: 116, type: !622, isLocal: true, isDefinition: true, scopeLine: 117, flags: DIFlagPrototyped, isOptimized: true, unit: !9, retainedNodes: !624)
!621 = !DIFile(filename: "/root/.unikraft/unikraft/arch/x86/x86_64/include/uk/asm/lcpu.h", directory: "/root/.unikraft/apps/redis/build")
!622 = !DISubroutineType(types: !623)
!623 = !{!142}
!624 = !{!625}
!625 = !DILocalVariable(name: "sp", scope: !620, file: !621, line: 118, type: !142)
!626 = distinct !DILocation(line: 154, column: 21, scope: !627, inlinedAt: !633)
!627 = distinct !DISubprogram(name: "uk_thread_current", scope: !74, file: !74, line: 151, type: !628, isLocal: true, isDefinition: true, scopeLine: 152, flags: DIFlagPrototyped, isOptimized: true, unit: !9, retainedNodes: !630)
!628 = !DISubroutineType(types: !629)
!629 = !{!72}
!630 = !{!631, !632}
!631 = !DILocalVariable(name: "current", scope: !627, file: !74, line: 153, type: !85)
!632 = !DILocalVariable(name: "sp", scope: !627, file: !74, line: 154, type: !142)
!633 = distinct !DILocation(line: 117, column: 30, scope: !634, inlinedAt: !638)
!634 = distinct !DISubprogram(name: "uk_sched_yield", scope: !118, file: !118, line: 114, type: !452, isLocal: true, isDefinition: true, scopeLine: 115, flags: DIFlagPrototyped, isOptimized: true, unit: !9, retainedNodes: !635)
!635 = !{!636, !637}
!636 = !DILocalVariable(name: "s", scope: !634, file: !118, line: 116, type: !116)
!637 = !DILocalVariable(name: "current", scope: !634, file: !118, line: 117, type: !72)
!638 = distinct !DILocation(line: 244, column: 2, scope: !639, inlinedAt: !641)
!639 = distinct !DISubprogram(name: "pte_osYield", scope: !48, file: !48, line: 242, type: !452, isLocal: true, isDefinition: true, scopeLine: 243, flags: DIFlagPrototyped, isOptimized: true, unit: !9, retainedNodes: !640)
!640 = !{}
!641 = distinct !DILocation(line: 107, column: 7, scope: !618)
!642 = !{i32 508062}
!643 = !DILocation(line: 118, column: 16, scope: !620, inlinedAt: !626)
!644 = !DILocation(line: 121, column: 2, scope: !620, inlinedAt: !626)
!645 = !DILocation(line: 154, column: 16, scope: !627, inlinedAt: !633)
!646 = !DILocation(line: 156, column: 38, scope: !627, inlinedAt: !633)
!647 = !DILocation(line: 156, column: 12, scope: !627, inlinedAt: !633)
!648 = !DILocation(line: 153, column: 21, scope: !627, inlinedAt: !633)
!649 = !DILocation(line: 158, column: 9, scope: !627, inlinedAt: !633)
!650 = !{!651, !651, i64 0}
!651 = !{!"any pointer", !612, i64 0}
!652 = !DILocation(line: 158, column: 2, scope: !627, inlinedAt: !633)
!653 = !DILocation(line: 117, column: 20, scope: !634, inlinedAt: !638)
!654 = !DILocation(line: 119, column: 2, scope: !655, inlinedAt: !638)
!655 = distinct !DILexicalBlock(scope: !656, file: !118, line: 119, column: 2)
!656 = distinct !DILexicalBlock(scope: !634, file: !118, line: 119, column: 2)
!657 = !DILocation(line: 119, column: 2, scope: !656, inlinedAt: !638)
!658 = !{!"branch_weights", i32 1, i32 2000}
!659 = !DILocation(line: 119, column: 2, scope: !660, inlinedAt: !638)
!660 = distinct !DILexicalBlock(scope: !655, file: !118, line: 119, column: 2)
!661 = !DILocation(line: 121, column: 15, scope: !634, inlinedAt: !638)
!662 = !{!663, !651, i64 88}
!663 = !{!"uk_thread", !651, i64 0, !651, i64 8, !651, i64 16, !651, i64 24, !664, i64 32, !665, i64 48, !611, i64 56, !666, i64 64, !667, i64 72, !651, i64 88, !651, i64 96, !665, i64 104, !651, i64 112, !651, i64 120}
!664 = !{!"", !651, i64 0, !651, i64 8}
!665 = !{!"int", !612, i64 0}
!666 = !{!"_Bool", !612, i64 0}
!667 = !{!"uk_waitq", !651, i64 0, !651, i64 8}
!668 = !DILocation(line: 116, column: 19, scope: !634, inlinedAt: !638)
!669 = !DILocation(line: 122, column: 2, scope: !670, inlinedAt: !638)
!670 = distinct !DILexicalBlock(scope: !671, file: !118, line: 122, column: 2)
!671 = distinct !DILexicalBlock(scope: !634, file: !118, line: 122, column: 2)
!672 = !DILocation(line: 122, column: 2, scope: !671, inlinedAt: !638)
!673 = !DILocation(line: 122, column: 2, scope: !674, inlinedAt: !638)
!674 = distinct !DILexicalBlock(scope: !670, file: !118, line: 122, column: 2)
!675 = !DILocation(line: 123, column: 5, scope: !634, inlinedAt: !638)
!676 = !{!677, !651, i64 0}
!677 = !{!"uk_sched", !651, i64 0, !651, i64 8, !651, i64 16, !651, i64 24, !651, i64 32, !651, i64 40, !651, i64 48, !651, i64 56, !651, i64 64, !666, i64 72, !663, i64 80, !678, i64 208, !679, i64 224, !651, i64 248, !651, i64 256, !651, i64 264}
!678 = !{!"uk_thread_list", !651, i64 0, !651, i64 8}
!679 = !{!"ukplat_ctx_callbacks", !651, i64 0, !651, i64 8, !651, i64 16}
!680 = !DILocation(line: 123, column: 2, scope: !634, inlinedAt: !638)
!681 = !DILocation(line: 124, column: 1, scope: !634, inlinedAt: !638)
!682 = !DILocation(line: 245, column: 1, scope: !639, inlinedAt: !641)
!683 = !DILocation(line: 108, column: 7, scope: !618)
!684 = !DILocation(line: 109, column: 7, scope: !618)
!685 = !DILocation(line: 113, column: 23, scope: !582)
!686 = !DILocation(line: 94, column: 16, scope: !582)
!687 = !DILocation(line: 116, column: 34, scope: !582)
!688 = !DILocation(line: 116, column: 45, scope: !582)
!689 = !DILocation(line: 116, column: 15, scope: !582)
!690 = !DILocation(line: 95, column: 16, scope: !582)
!691 = !DILocation(line: 118, column: 33, scope: !582)
!692 = !DILocation(line: 93, column: 16, scope: !582)
!693 = !DILocation(line: 120, column: 23, scope: !694)
!694 = distinct !DILexicalBlock(scope: !582, file: !10, line: 120, column: 7)
!695 = !DILocation(line: 96, column: 13, scope: !582)
!696 = !DILocation(line: 120, column: 12, scope: !694)
!697 = !DILocation(line: 120, column: 7, scope: !582)
!698 = !DILocation(line: 97, column: 18, scope: !582)
!699 = !DILocation(line: 127, column: 11, scope: !601)
!700 = !{!701, !665, i64 88}
!701 = !{!"pte_thread_t_", !651, i64 0, !702, i64 8, !651, i64 24, !612, i64 32, !651, i64 40, !651, i64 48, !665, i64 56, !665, i64 60, !651, i64 64, !665, i64 72, !651, i64 80, !665, i64 88, !665, i64 92, !665, i64 96, !612, i64 104, !665, i64 168, !651, i64 176, !651, i64 184}
!702 = !{!"", !651, i64 0, !665, i64 8}
!703 = !DILocation(line: 127, column: 23, scope: !601)
!704 = !DILocation(line: 127, column: 7, scope: !582)
!705 = !DILocation(line: 134, column: 50, scope: !600)
!706 = !{!701, !651, i64 0}
!707 = !DILocation(line: 134, column: 22, scope: !600)
!708 = !DILocation(line: 129, column: 20, scope: !600)
!709 = !DILocation(line: 136, column: 11, scope: !600)
!710 = !DILocation(line: 141, column: 43, scope: !711)
!711 = distinct !DILexicalBlock(scope: !712, file: !10, line: 137, column: 9)
!712 = distinct !DILexicalBlock(scope: !600, file: !10, line: 136, column: 11)
!713 = !DILocation(line: 141, column: 18, scope: !711)
!714 = !DILocation(line: 142, column: 19, scope: !715)
!715 = distinct !DILexicalBlock(scope: !711, file: !10, line: 142, column: 15)
!716 = !{!701, !612, i64 32}
!717 = !DILocation(line: 142, column: 25, scope: !715)
!718 = !DILocation(line: 142, column: 15, scope: !711)
!719 = !DILocation(line: 144, column: 25, scope: !720)
!720 = distinct !DILexicalBlock(scope: !715, file: !10, line: 143, column: 13)
!721 = !DILocation(line: 145, column: 31, scope: !720)
!722 = !DILocation(line: 146, column: 22, scope: !720)
!723 = !DILocation(line: 148, column: 15, scope: !720)
!724 = !DILocation(line: 149, column: 13, scope: !720)
!725 = !DILocation(line: 151, column: 18, scope: !711)
!726 = !DILocation(line: 152, column: 11, scope: !711)
!727 = !DILocation(line: 162, column: 7, scope: !728)
!728 = distinct !DILexicalBlock(scope: !601, file: !10, line: 161, column: 5)
!729 = !DILocation(line: 0, scope: !711)
!730 = !DILocation(line: 166, column: 1, scope: !582)
!731 = !DILocation(line: 196, column: 2, scope: !2)
!732 = !DILocation(line: 196, column: 10, scope: !2)
!733 = !DILocation(line: 197, column: 2, scope: !2)
!734 = !DILocation(line: 198, column: 2, scope: !735)
!735 = distinct !DILexicalBlock(scope: !736, file: !3, line: 198, column: 2)
!736 = distinct !DILexicalBlock(scope: !2, file: !3, line: 198, column: 2)
!737 = !DILocation(line: 199, column: 2, scope: !2)
!738 = !DILocation(line: 200, column: 1, scope: !2)
