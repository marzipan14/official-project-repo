...
# %bb.43:                               #   in Loop: Header=BB56_42 Depth=1
	cmpl	$7, %ecx
	jne	.LBB56_46
# %bb.44:                               #   in Loop: Header=BB56_42 Depth=1
...
# %bb.50:                               # %.preheader2
	...
	jmp	.LBB56_51
	.p2align	4, 0x90
.LBB56_55:                              #   in Loop: Header=BB56_51 Depth=1
	movq	%r14, %rdi
	callq	listNext
	testq	%rax, %rax
	je	.LBB56_56
...
# %bb.53:                               #   in Loop: Header=BB56_51 Depth=1
	...
	cmpq	%rcx, %rax
	jle	.LBB56_55
# %bb.54:                               #   in Loop: Header=BB56_51 Depth=1
	movq	%rbx, %rdi
	callq	replicationGetSlaveName
	movl	$.L.str.170, %esi
	movl	$replicationGetSlaveName.buf, %edx
...
# %bb.82:                               # %.preheader
	...
	jmp	.LBB56_83
	.p2align	4, 0x90
.LBB56_85:                              #   in Loop: Header=BB56_83 Depth=1
	movq	%r14, %rdi
	callq	listNext
	testq	%rax, %rax
	je	.LBB56_86
...
.LBB56_72:                              # =>This Inner Loop Header: Depth=1
	...
	cmpl	$6, 168(%rax)
	jne	.LBB56_74
# %bb.73:                               #   in Loop: Header=BB56_72 Depth=1
	movq	server+2872(%rip), %rcx
	subq	144(%rax), %rcx
	cmpq	%rbx, %rcx
	cmovgeq	%rcx, %rbx
