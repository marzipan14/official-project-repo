...
; <label>:54:                                     ; preds = %48, %52
  ...
  %56 = icmp eq i32 %55, -1, !dbg !328
  br i1 %56, label %68, label %30, !dbg !329, !llvm.loop !330

; <label>:57:                                     ; preds = %30
  %58 = load i32, i32* %27, align 4, !dbg !337, !tbaa !311
  %59 = add nsw i32 %58, -1, !dbg !337
  store i32 %59, i32* %27, align 4, !dbg !337, !tbaa !311
  %60 = icmp sgt i32 %58, 0, !dbg !338
  br i1 %60, label %61, label %64, !dbg !339

; <label>:61:                                     ; preds = %57
  %62 = load i8*, i8** %28, align 8, !dbg !340, !tbaa !321
  %63 = getelementptr inbounds i8, i8* %62, i64 1, !dbg !340
  store i8* %63, i8** %28, align 8, !dbg !340, !tbaa !321
  store i8 10, i8* %62, align 1, !dbg !341, !tbaa !295
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !342
  br label %68, !dbg !343

; <label>:64:                                     ; preds = %57
  %65 = call i32 @__swbuf_r(%struct._reent* %0, i32 10, %struct.__sFILE* nonnull %5) #4, !dbg !344
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !342
  %66 = icmp eq i32 %65, -1, !dbg !345
  %67 = select i1 %66, i32 -1, i32 10, !dbg !343
  br label %68, !dbg !343

; <label>:68:                                     ; preds = %54, %64, %61, %23
  %69 = phi i32 [ -1, %23 ], [ 10, %61 ], [ %67, %64 ], [ -1, %54 ], !dbg !346
  %70 = load i32, i32* %3, align 4, !dbg !347, !tbaa !348
  %71 = call i32 @pthread_setcancelstate(i32 %70, i32* nonnull %3) #4, !dbg !347
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %13) #5, !dbg !349
...
; Function Attrs: noredzone nounwind
define dso_local i32 @puts(i8* nocapture readonly) local_unnamed_addr #0 !dbg !351 {
  %2 = tail call %struct._reent* @__getreent() #4, !dbg !357
  %3 = tail call i32 @_puts_r(%struct._reent* %2, i8* %0) #6, !dbg !358
...
!327 = !DILocation(line: 696, column: 1, scope: !299, inlinedAt: !306)
!328 = !DILocation(line: 120, column: 37, scope: !292)
!329 = !DILocation(line: 120, column: 11, scope: !293)
!330 = distinct !{!330, !290, !331}
!331 = !DILocation(line: 122, column: 5, scope: !260)
!332 = !DILocation(line: 687, column: 47, scope: !299, inlinedAt: !333)
!333 = distinct !DILocation(line: 123, column: 7, scope: !334)
!334 = distinct !DILexicalBlock(scope: !260, file: !1, line: 123, column: 7)
!335 = !DILocation(line: 687, column: 57, scope: !299, inlinedAt: !333)
!336 = !DILocation(line: 687, column: 67, scope: !299, inlinedAt: !333)
!337 = !DILocation(line: 692, column: 6, scope: !310, inlinedAt: !333)
!338 = !DILocation(line: 692, column: 15, scope: !310, inlinedAt: !333)
!339 = !DILocation(line: 692, column: 20, scope: !310, inlinedAt: !333)
!340 = !DILocation(line: 693, column: 18, scope: !310, inlinedAt: !333)
!341 = !DILocation(line: 693, column: 21, scope: !310, inlinedAt: !333)
!342 = !DILocation(line: 696, column: 1, scope: !299, inlinedAt: !333)
!343 = !DILocation(line: 123, column: 7, scope: !260)
!344 = !DILocation(line: 695, column: 11, scope: !310, inlinedAt: !333)
!345 = !DILocation(line: 123, column: 33, scope: !334)
!346 = !DILocation(line: 0, scope: !260)
!347 = !DILocation(line: 129, column: 3, scope: !260)
!348 = !{!267, !267, i64 0}
!349 = !DILocation(line: 129, column: 3, scope: !28)
!350 = !DILocation(line: 130, column: 3, scope: !28)
!351 = distinct !DISubprogram(name: "puts", scope: !1, file: !1, line: 137, type: !352, isLocal: false, isDefinition: true, scopeLine: 139, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !354)
!352 = !DISubroutineType(types: !353)
!353 = !{!5, !68}
!354 = !{!355}
!355 = !DILocalVariable(name: "s", arg: 1, scope: !351, file: !1, line: 137, type: !68)
!356 = !DILocation(line: 137, column: 1, scope: !351)
!357 = !DILocation(line: 140, column: 19, scope: !351)
!358 = !DILocation(line: 140, column: 10, scope: !351)
!359 = !DILocation(line: 140, column: 3, scope: !351)
