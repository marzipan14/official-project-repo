...
.LBB23_31:                              #   in Loop: Header=BB23_15 Depth=1
	...
	cmpb	$37, %al
	je	.LBB23_23
.LBB23_32:                              #   in Loop: Header=BB23_15 Depth=1
	movb	%al, (%r14,%rbx)
	movzbl	-1(%r14), %eax
	movl	%eax, %ecx
	andb	$7, %cl
	cmpb	$4, %cl
	ja	.LBB23_13
# %bb.33:                               #   in Loop: Header=BB23_15 Depth=1
	movl	%eax, %ecx
	andl	$7, %ecx
	jmpq	*.LJTI23_2(,%rcx,8)
.LBB23_34:                              #   in Loop: Header=BB23_15 Depth=1
	...
	movb	%al, -1(%r14)
	jmp	.LBB23_13
.LBB23_35:                              #   in Loop: Header=BB23_15 Depth=1
	movslq	-64(%rbp), %rcx
	cmpb	$105, %al
	movq	%rbx, -112(%rbp)        # 8-byte Spill
	jne	.LBB23_48
# %bb.36:                               #   in Loop: Header=BB23_15 Depth=1
	cmpl	$40, %ecx
	ja	.LBB23_57
# %bb.37:                               #   in Loop: Header=BB23_15 Depth=1
	movq	%rcx, %rax
	addq	-48(%rbp), %rax
	addl	$8, %ecx
	movl	%ecx, -64(%rbp)
...
.LBB23_60:                              #   in Loop: Header=BB23_15 Depth=1
	...
	xorl	%ebx, %ebx
	.p2align	4, 0x90
.LBB23_61:                              #   Parent Loop BB23_15 Depth=1
	...
	movq	%rdx, %rcx
	ja	.LBB23_61
# %bb.62:                               #   in Loop: Header=BB23_15 Depth=1
	movb	$0, (%rsi)
	cmpq	$-1, %rbx
	je	.LBB23_66
...
# %bb.64:                               # %.preheader1
	...
	leaq	-94(%rbp), %rcx
	.p2align	4, 0x90
.LBB23_65:                              #   Parent Loop BB23_15 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	movzbl	(%rax), %edx
	movzbl	-1(%rcx), %esi
	movb	%dl, -1(%rcx)
	...
	leaq	1(%rcx), %rcx
	jb	.LBB23_65
.LBB23_66:                              #   in Loop: Header=BB23_15 Depth=1
	movl	$42, __A_VARIABLE(%rip)
	sarq	$32, %r15
	movb	-1(%r14), %al
	andb	$7, %al
	...
	cmpb	$3, %al
	ja	.LBB23_82
# %bb.67:                               #   in Loop: Header=BB23_15 Depth=1
	movzbl	%al, %eax
	jmpq	*.LJTI23_3(,%rax,8)
...
.LBB23_71:                              #   in Loop: Header=BB23_15 Depth=1
	...
	xorl	%r13d, %r13d
	.p2align	4, 0x90
.LBB23_72:                              #   Parent Loop BB23_15 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	movq	%rcx, %rax
	mulq	%r8
	shrq	$3, %rdx
	...
	movq	%rdx, %rcx
	ja	.LBB23_72
# %bb.73:                               #   in Loop: Header=BB23_15 Depth=1
	testq	%rsi, %rsi
	jns	.LBB23_75
...
# %bb.77:                               # %.preheader
	...
	leaq	-94(%rbp), %rcx
	.p2align	4, 0x90
.LBB23_78:                              #   Parent Loop BB23_15 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	movzbl	(%rax), %edx
	movzbl	-1(%rcx), %ebx
	movb	%dl, -1(%rcx)
...
.LBB23_89:                              #   in Loop: Header=BB23_15 Depth=1
	...
	movabsq	$4294967296, %r9        # imm = 0x100000000
	ja	.LBB23_109
# %bb.90:                               #   in Loop: Header=BB23_15 Depth=1
	movl	%eax, %ecx
	andl	$7, %ecx
	jmpq	*.LJTI23_4(,%rcx,8)
...
.LBB23_99:                              #   in Loop: Header=BB23_15 Depth=1
	...
	movabsq	$4294967296, %r9        # imm = 0x100000000
	ja	.LBB23_109
# %bb.100:                              #   in Loop: Header=BB23_15 Depth=1
	movl	%eax, %ecx
	andl	$7, %ecx
	jmpq	*.LJTI23_6(,%rcx,8)
.LBB23_101:                             #   in Loop: Header=BB23_15 Depth=1
	shlb	$3, %r13b
	addb	%al, %r13b
	andb	$-8, %r13b
	movb	%r13b, (%rbx)
...
.LBB23_118:                             #   in Loop: Header=BB23_15 Depth=1
	...
	cmpb	$3, %al
	ja	.LBB23_121
# %bb.119:                              #   in Loop: Header=BB23_15 Depth=1
	movzbl	%al, %eax
	jmpq	*.LJTI23_8(,%rax,8)
...
.LBB23_125:                             #   in Loop: Header=BB23_15 Depth=1
	...
	cmpq	%r15, %rax
	jae	.LBB23_127
# %bb.126:                              #   in Loop: Header=BB23_15 Depth=1
	movq	%r14, %rdi
	movq	%r15, %rsi
	callq	sdsMakeRoomFor
	movq	%rax, %r14
...
.LBB23_128:                             #   in Loop: Header=BB23_15 Depth=1
	...
	movabsq	$4294967296, %r9        # imm = 0x100000000
	ja	.LBB23_135
# %bb.129:                              #   in Loop: Header=BB23_15 Depth=1
	movl	%eax, %ecx
	andl	$7, %ecx
	jmpq	*.LJTI23_9(,%rcx,8)
.LBB23_130:                             #   in Loop: Header=BB23_15 Depth=1
	leal	(,%r15,8), %ecx
	addb	%al, %cl
	andb	$-8, %cl
	movb	%cl, (%r13)
...
.LBB23_134:                             #   in Loop: Header=BB23_15 Depth=1
	addq	%r15, -17(%r14)
.LBB23_135:                             #   in Loop: Header=BB23_15 Depth=1
	movl	$42, __A_VARIABLE(%rip)
	addq	%rbx, %r15
	jmp	.LBB23_14
.LBB23_136:
...
# %bb.8:                                #   in Loop: Header=BB34_2 Depth=1
	...
	jmp	.LBB34_10
.LBB34_57:                              #   in Loop: Header=BB34_2 Depth=1
	callq	__errno
	movl	$12, (%rax)
	movl	$42, __A_VARIABLE(%rip)
	movl	$42, __A_VARIABLE(%rip)
...
.LBB34_10:                              #   in Loop: Header=BB34_2 Depth=1
	...
	jmp	.LBB34_14
	.p2align	4, 0x90
.LBB34_11:                              #   in Loop: Header=BB34_14 Depth=2
	movl	$1, %edx
	movq	%r14, %rdi
	movq	%r12, %rsi
	callq	sdscatlen
...
.LBB34_13:                              #   in Loop: Header=BB34_14 Depth=2
	...
	cmpb	$0, (%r13)
	cmoveq	%r13, %r12
.LBB34_14:                              #   Parent Loop BB34_2 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	testl	%r15d, %r15d
	je	.LBB34_28
...
# %bb.20:                               #   in Loop: Header=BB34_14 Depth=2
	...
	jbe	.LBB34_42
	.p2align	4, 0x90
.LBB34_21:                              #   in Loop: Header=BB34_14 Depth=2
	movzbl	(%r12), %eax
	cmpb	$92, %al
	jne	.LBB34_26
...
# %bb.23:                               #   in Loop: Header=BB34_14 Depth=2
	...
	cmpl	$19, %ecx
	ja	.LBB34_45
# %bb.24:                               #   in Loop: Header=BB34_14 Depth=2
	jmpq	*.LJTI34_0(,%rcx,8)
.LBB34_25:                              #   in Loop: Header=BB34_14 Depth=2
	movb	$7, -41(%rbp)
	jmp	.LBB34_50
	.p2align	4, 0x90
.LBB34_26:                              #   in Loop: Header=BB34_14 Depth=2
	testb	%al, %al
	je	.LBB34_64
# %bb.27:                               #   in Loop: Header=BB34_14 Depth=2
	cmpb	$34, %al
	jne	.LBB34_11
	jmp	.LBB34_52
	.p2align	4, 0x90
.LBB34_28:                              #   in Loop: Header=BB34_14 Depth=2
	movsbl	(%r12), %eax
	testl	%ebx, %ebx
	je	.LBB34_32
# %bb.29:                               #   in Loop: Header=BB34_14 Depth=2
	cmpb	$92, %al
	je	.LBB34_36
# %bb.30:                               #   in Loop: Header=BB34_14 Depth=2
	testb	%al, %al
	je	.LBB34_64
# %bb.31:                               #   in Loop: Header=BB34_14 Depth=2
	...
	jne	.LBB34_38
	jmp	.LBB34_52
.LBB34_32:                              #   in Loop: Header=BB34_14 Depth=2
	cmpl	$39, %eax
	ja	.LBB34_44
# %bb.33:                               #   in Loop: Header=BB34_14 Depth=2
	movl	%eax, %eax
	cmpq	$34, %rax
	je	.LBB34_41
# %bb.34:                               #   in Loop: Header=BB34_14 Depth=2
	cmpq	$39, %rax
	jne	.LBB34_43
# %bb.35:                               #   in Loop: Header=BB34_14 Depth=2
	movl	$1, %ebx
	jmp	.LBB34_40
.LBB34_36:                              #   in Loop: Header=BB34_14 Depth=2
	cmpb	$39, 1(%r12)
	jne	.LBB34_38
# %bb.37:                               #   in Loop: Header=BB34_14 Depth=2
	addq	$1, %r12
	movl	$.L.str.16, %esi
	movl	$1, %edx
	movq	%r14, %rdi
	jmp	.LBB34_39
.LBB34_38:                              #   in Loop: Header=BB34_14 Depth=2
	movl	$1, %edx
	movq	%r14, %rdi
	movq	%r12, %rsi
.LBB34_39:                              #   in Loop: Header=BB34_14 Depth=2
	callq	sdscatlen
	movq	%rax, %r14
.LBB34_40:                              #   in Loop: Header=BB34_14 Depth=2
	xorl	%r15d, %r15d
	jmp	.LBB34_12
.LBB34_41:                              #   in Loop: Header=BB34_14 Depth=2
	xorl	%ebx, %ebx
	movl	$1, %r15d
	jmp	.LBB34_12
.LBB34_42:                              #   in Loop: Header=BB34_14 Depth=2
	movsbl	2(%r12), %edi
	...
	leaq	-42(%rbp), %rsi
	jmp	.LBB34_51
.LBB34_43:                              #   in Loop: Header=BB34_14 Depth=2
	movabsq	$4294977025, %rcx       # imm = 0x100002601
	btq	%rax, %rcx
	jb	.LBB34_54
.LBB34_44:                              #   in Loop: Header=BB34_14 Depth=2
	movl	$1, %edx
	movq	%r14, %rdi
	movq	%r12, %rsi
	callq	sdscatlen
	...
	xorl	%ebx, %ebx
	jmp	.LBB34_13
.LBB34_45:                              #   in Loop: Header=BB34_14 Depth=2
	movb	%al, -41(%rbp)
	jmp	.LBB34_50
.LBB34_46:                              #   in Loop: Header=BB34_14 Depth=2
	movb	$10, -41(%rbp)
	jmp	.LBB34_50
.LBB34_47:                              #   in Loop: Header=BB34_14 Depth=2
	movb	$8, -41(%rbp)
	jmp	.LBB34_50
.LBB34_48:                              #   in Loop: Header=BB34_14 Depth=2
	movb	$13, -41(%rbp)
	jmp	.LBB34_50
.LBB34_49:                              #   in Loop: Header=BB34_14 Depth=2
	movb	$9, -41(%rbp)
.LBB34_50:                              #   in Loop: Header=BB34_14 Depth=2
	movl	$1, %edx
	movq	%r14, %rdi
	leaq	-41(%rbp), %rsi
.LBB34_51:                              #   in Loop: Header=BB34_14 Depth=2
	callq	sdscatlen
	movq	%rax, %r14
	jmp	.LBB34_13
...
.LBB34_70:
	...
	retq
	.p2align	4, 0x90
.LBB34_71:                              #   in Loop: Header=BB34_72 Depth=1
	movl	$42, __A_VARIABLE(%rip)
	subl	$1, %eax
	movl	%eax, (%rbx)
	jb	.LBB34_65
.LBB34_72:                              # =>This Inner Loop Header: Depth=1
	...
	testq	%rsi, %rsi
	je	.LBB34_71
# %bb.73:                               #   in Loop: Header=BB34_72 Depth=1
	movzbl	-1(%rsi), %eax
	movl	$42, __A_VARIABLE(%rip)
	movq	flexos_shared_alloc(%rip), %rdi
	testq	%rdi, %rdi
	je	.LBB34_76
# %bb.74:                               #   in Loop: Header=BB34_72 Depth=1
	andl	$7, %eax
	xorq	$4, %rax
	addq	.Lswitch.table.sdssplitargs.20(,%rax,8), %rsi
	callq	*40(%rdi)
