...
; Function Attrs: noredzone nounwind
define dso_local i32 @pte_thread_detach_np() local_unnamed_addr #0 !dbg !598 {
  tail call fastcc void @pte_thread_detach_common(i8 zeroext 0) #3, !dbg !599
...
!597 = !DILocation(line: 94, column: 3, scope: !542)
!598 = distinct !DISubprogram(name: "pte_thread_detach_np", scope: !1, file: !1, line: 102, type: !537, isLocal: false, isDefinition: true, scopeLine: 103, isOptimized: true, unit: !0, retainedNodes: !539)
!599 = !DILocation(line: 104, column: 10, scope: !598)
!600 = !DILocation(line: 104, column: 3, scope: !598)
