...
# %bb.30:                               #   in Loop: Header=BB6_24 Depth=2
	...
	callq	rdbCheckInfo
	jmp	.LBB6_24
.LBB6_31:                               #   in Loop: Header=BB6_24 Depth=2
	movq	%r15, -72(%rbp)         # 8-byte Spill
	movl	$1, %r15d
	leaq	-64(%rbp), %r12
	jmp	.LBB6_33
.LBB6_32:                               #   in Loop: Header=BB6_33 Depth=3
	addq	%rbx, %r12
	addq	%rbx, redis_check_rdb.rdb+48(%rip)
	subq	%rbx, %r15
	je	.LBB6_42
.LBB6_33:                               #   Parent Loop BB6_23 Depth=1
	...
	testq	%rax, %rax
	je	.LBB6_41
# %bb.34:                               #   in Loop: Header=BB6_33 Depth=3
	movq	redis_check_rdb.rdb+32(%rip), %rax
	testq	%rax, %rax
	je	.LBB6_32
# %bb.35:                               #   in Loop: Header=BB6_33 Depth=3
	movl	$redis_check_rdb.rdb, %edi
	movq	%r12, %rsi
	movq	%rbx, %rdx
	callq	*%rax
	jmp	.LBB6_32
.LBB6_36:                               #   in Loop: Header=BB6_24 Depth=2
	movl	$6, rdbstate+48(%rip)
	movl	$redis_check_rdb.rdb, %edi
	xorl	%esi, %esi
	callq	rdbLoadLen
...
.LBB6_37:                               #   in Loop: Header=BB6_24 Depth=2
	...
	xorl	%ecx, %ecx
	jmp	.LBB6_39
.LBB6_38:                               #   in Loop: Header=BB6_24 Depth=2
...
.LBB6_39:                               #   in Loop: Header=BB6_24 Depth=2
	cmpq	$-1, %rax
	setne	%cl
	addl	%ecx, %ecx
	addl	$2, %ecx
	jmp	.LBB6_44
.LBB6_40:                               #   in Loop: Header=BB6_24 Depth=2
	movl	$2, rdbstate+48(%rip)
	movl	$redis_check_rdb.rdb, %edi
	callq	rdbLoadTime
	...
	jmp	.LBB6_44
.LBB6_41:                               #   in Loop: Header=BB6_24 Depth=2
	movl	$2, %ecx
	jmp	.LBB6_43
.LBB6_42:                               #   in Loop: Header=BB6_24 Depth=2
	movl	$4, %ecx
.LBB6_43:                               #   in Loop: Header=BB6_24 Depth=2
	movl	$42, __A_VARIABLE(%rip)
	movq	-72(%rbp), %r15         # 8-byte Reload
.LBB6_44:                               #   in Loop: Header=BB6_24 Depth=2
	cmpl	$5, %ecx
	ja	.LBB6_73
# %bb.45:                               #   in Loop: Header=BB6_24 Depth=2
	movl	%ecx, %eax
	jmpq	*.LJTI6_1(,%rax,8)
.LBB6_46:                               #   in Loop: Header=BB6_23 Depth=1
	movl	%ebx, %eax
	addl	$1, %eax
	cmpl	$16, %eax
	ja	.LBB6_57
# %bb.47:                               #   in Loop: Header=BB6_23 Depth=1
	movl	$130558, %ecx           # imm = 0x1FDFE
	btl	%eax, %ecx
	jae	.LBB6_56
# %bb.48:                               #   in Loop: Header=BB6_23 Depth=1
	...
	testq	%rax, %rax
	je	.LBB6_8
# %bb.49:                               #   in Loop: Header=BB6_23 Depth=1
	movq	%rax, %r12
	...
	testq	%rax, %rax
	je	.LBB6_8
# %bb.50:                               #   in Loop: Header=BB6_23 Depth=1
	movq	%rax, %rbx
	movq	-48(%rbp), %rax         # 8-byte Reload
	cmpq	$-1, %rax
	je	.LBB6_53
# %bb.51:                               #   in Loop: Header=BB6_23 Depth=1
	cmpq	-56(%rbp), %rax         # 8-byte Folded Reload
	jge	.LBB6_53
# %bb.52:                               #   in Loop: Header=BB6_23 Depth=1
	addq	$1, rdbstate+40(%rip)
.LBB6_53:                               #   in Loop: Header=BB6_23 Depth=1
	cmpq	$-1, %rax
	je	.LBB6_55
# %bb.54:                               #   in Loop: Header=BB6_23 Depth=1
	addq	$1, rdbstate+32(%rip)
.LBB6_55:                               #   in Loop: Header=BB6_23 Depth=1
