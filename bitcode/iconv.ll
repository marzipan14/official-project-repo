...
define dso_local i32 @_iconv_close_r(%struct._reent*, i8*) local_unnamed_addr #0 !dbg !520 {
  %3 = ptrtoint i8* %1 to i64, !dbg !555
  switch i64 %3, label %4 [
    i64 -1, label %15
    i64 0, label %15
  ], !dbg !555
...
; <label>:4:                                      ; preds = %2
  %5 = getelementptr inbounds i8, i8* %1, i64 8, !dbg !556
  %6 = bitcast i8* %5 to i8**, !dbg !556
  %7 = load i8*, i8** %6, align 8, !dbg !556, !tbaa !346
  %8 = icmp eq i8* %7, null, !dbg !557
  br i1 %8, label %15, label %9, !dbg !558

; <label>:9:                                      ; preds = %4
  %10 = bitcast i8* %1 to %struct.iconv_conversion_handlers_t**, !dbg !559
  %11 = load %struct.iconv_conversion_handlers_t*, %struct.iconv_conversion_handlers_t** %10, align 8, !dbg !559, !tbaa !337
  %12 = icmp eq %struct.iconv_conversion_handlers_t* %11, @_iconv_null_conversion_handlers, !dbg !560
  %13 = icmp eq %struct.iconv_conversion_handlers_t* %11, @_iconv_ucs_conversion_handlers, !dbg !561
  %14 = or i1 %12, %13, !dbg !562
  br i1 %14, label %17, label %15, !dbg !562

; <label>:15:                                     ; preds = %9, %2, %2, %4
  %16 = getelementptr inbounds %struct._reent, %struct._reent* %0, i64 0, i32 0, !dbg !563
  store i32 9, i32* %16, align 8, !dbg !564, !tbaa !411
  br label %22, !dbg !565

; <label>:17:                                     ; preds = %9
  %18 = getelementptr inbounds %struct.iconv_conversion_handlers_t, %struct.iconv_conversion_handlers_t* %11, i64 0, i32 1, !dbg !566
  %19 = load i64 (%struct._reent*, i8*)*, i64 (%struct._reent*, i8*)** %18, align 8, !dbg !566, !tbaa !544
  %20 = tail call i64 %19(%struct._reent* %0, i8* nonnull %7) #4, !dbg !567
  %21 = trunc i64 %20 to i32, !dbg !568
  tail call void @free(i8* nonnull %1) #4, !dbg !570
  br label %22, !dbg !571

; <label>:22:                                     ; preds = %17, %15
  %23 = phi i32 [ -1, %15 ], [ %21, %17 ], !dbg !572
...
!551 = !DILocation(line: 349, column: 1, scope: !520, inlinedAt: !528)
!552 = !DILocation(line: 185, column: 5, scope: !512)
!553 = !DILocation(line: 329, column: 1, scope: !520)
!554 = !DILocation(line: 334, column: 23, scope: !520)
!555 = !DILocation(line: 336, column: 29, scope: !531)
!556 = !DILocation(line: 336, column: 57, scope: !531)
!557 = !DILocation(line: 336, column: 62, scope: !531)
!558 = !DILocation(line: 337, column: 8, scope: !531)
!559 = !DILocation(line: 337, column: 16, scope: !531)
!560 = !DILocation(line: 337, column: 25, scope: !531)
!561 = !DILocation(line: 338, column: 28, scope: !531)
!562 = !DILocation(line: 338, column: 12, scope: !531)
!563 = !DILocation(line: 340, column: 7, scope: !540)
!564 = !DILocation(line: 340, column: 24, scope: !540)
!565 = !DILocation(line: 341, column: 7, scope: !540)
!566 = !DILocation(line: 344, column: 28, scope: !520)
!567 = !DILocation(line: 344, column: 14, scope: !520)
!568 = !DILocation(line: 344, column: 9, scope: !520)
!569 = !DILocation(line: 333, column: 7, scope: !520)
!570 = !DILocation(line: 346, column: 3, scope: !520)
!571 = !DILocation(line: 348, column: 3, scope: !520)
!572 = !DILocation(line: 0, scope: !520)
!573 = !DILocation(line: 349, column: 1, scope: !520)
