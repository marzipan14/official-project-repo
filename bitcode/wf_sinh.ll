...
; <label>:27:                                     ; preds = %13
  %28 = select i1 %22, double 0x7FF0000000000000, double 0xFFF0000000000000, !dbg !83
  %29 = getelementptr inbounds %struct.exception, %struct.exception* %2, i64 0, i32 4, !dbg !84
  store double %28, double* %29, align 8, !dbg !85, !tbaa !81
  %30 = icmp eq i32 %20, 2, !dbg !86
  br i1 %30, label %31, label %33, !dbg !82

; <label>:31:                                     ; preds = %27
  %32 = tail call i32* @__errno() #5, !dbg !88
  br label %38, !dbg !88

; <label>:33:                                     ; preds = %23, %27
  %34 = call i32 @matherr(%struct.exception* nonnull %2) #5, !dbg !90
  %35 = icmp eq i32 %34, 0, !dbg !90
  br i1 %35, label %36, label %40, !dbg !92

; <label>:36:                                     ; preds = %33
  %37 = call i32* @__errno() #5, !dbg !93
  br label %38, !dbg !95

; <label>:38:                                     ; preds = %31, %36
  %39 = phi i32* [ %37, %36 ], [ %32, %31 ]
  store i32 34, i32* %39, align 4, !dbg !96, !tbaa !97
  br label %40, !dbg !98

; <label>:40:                                     ; preds = %38, %33
  %41 = load i32, i32* %16, align 8, !dbg !98, !tbaa !64
  %42 = icmp eq i32 %41, 0, !dbg !100
  br i1 %42, label %45, label %43, !dbg !101

; <label>:43:                                     ; preds = %40
  %44 = call i32* @__errno() #5, !dbg !102
  store i32 %41, i32* %44, align 4, !dbg !103, !tbaa !97
  br label %45, !dbg !102

; <label>:45:                                     ; preds = %40, %43
  %46 = getelementptr inbounds %struct.exception, %struct.exception* %2, i64 0, i32 4, !dbg !104
  %47 = load double, double* %46, align 8, !dbg !104, !tbaa !81
  %48 = fptrunc double %47 to float, !dbg !105
  br label %49, !dbg !106

; <label>:49:                                     ; preds = %7, %10, %1, %45
  %50 = phi float [ %48, %45 ], [ %4, %1 ], [ %4, %10 ], [ %4, %7 ], !dbg !107
  call void @llvm.lifetime.end.p0i8(i64 48, i8* nonnull %3) #4, !dbg !108
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !108
  ret float %50, !dbg !108
}
...
!81 = !{!55, !58, i64 32}
!82 = !DILocation(line: 53, column: 10, scope: !52)
!83 = !DILocation(line: 52, column: 24, scope: !73)
!84 = !DILocation(line: 52, column: 13, scope: !73)
!85 = !DILocation(line: 52, column: 20, scope: !73)
!86 = !DILocation(line: 53, column: 23, scope: !87)
!87 = distinct !DILexicalBlock(scope: !52, file: !1, line: 53, column: 10)
!88 = !DILocation(line: 54, column: 9, scope: !87)
!89 = !DILocation(line: 34, column: 19, scope: !18)
!90 = !DILocation(line: 55, column: 16, scope: !91)
!91 = distinct !DILexicalBlock(scope: !87, file: !1, line: 55, column: 15)
!92 = !DILocation(line: 55, column: 15, scope: !87)
!93 = !DILocation(line: 56, column: 9, scope: !94)
!94 = distinct !DILexicalBlock(scope: !91, file: !1, line: 55, column: 31)
!95 = !DILocation(line: 57, column: 6, scope: !94)
!96 = !DILocation(line: 0, scope: !87)
!97 = !{!56, !56, i64 0}
!98 = !DILocation(line: 58, column: 14, scope: !99)
!99 = distinct !DILexicalBlock(scope: !52, file: !1, line: 58, column: 10)
!100 = !DILocation(line: 58, column: 18, scope: !99)
!101 = !DILocation(line: 58, column: 10, scope: !52)
!102 = !DILocation(line: 59, column: 9, scope: !99)
!103 = !DILocation(line: 59, column: 15, scope: !99)
!104 = !DILocation(line: 60, column: 31, scope: !52)
!105 = !DILocation(line: 60, column: 20, scope: !52)
!106 = !DILocation(line: 60, column: 13, scope: !52)
!107 = !DILocation(line: 0, scope: !52)
!108 = !DILocation(line: 64, column: 1, scope: !18)
