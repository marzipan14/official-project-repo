...
; <label>:42:                                     ; preds = %33
  %43 = call i32 @__swbuf_r(%struct._reent* %0, i32 %29, %struct.__sFILE* nonnull %2) #5, !dbg !304
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !302
  %44 = icmp eq i32 %43, -1, !dbg !305
  br i1 %44, label %51, label %45, !dbg !303

; <label>:45:                                     ; preds = %39, %42
  %46 = add nuw i64 %26, 1, !dbg !306
  %47 = icmp ult i64 %46, %24, !dbg !307
  br i1 %47, label %25, label %48, !dbg !308, !llvm.loop !309

; <label>:48:                                     ; preds = %45, %23
  %49 = load i32*, i32** %4, align 8, !dbg !311, !tbaa !252
  %50 = icmp eq i32* %49, null, !dbg !312
  br i1 %50, label %51, label %23, !dbg !313, !llvm.loop !314

; <label>:51:                                     ; preds = %48, %23, %42, %15
  %52 = phi i32 [ -1, %15 ], [ -1, %42 ], [ -1, %23 ], [ 0, %48 ]
  call void @llvm.lifetime.end.p0i8(i64 1024, i8* nonnull %6) #4, !dbg !317
...
; Function Attrs: noredzone nounwind
define dso_local i32 @fputws_unlocked(i32* noalias, %struct.__sFILE* noalias) local_unnamed_addr #0 !dbg !318 {
  %3 = tail call %struct._reent* @__getreent() #5, !dbg !330
  %4 = icmp eq %struct._reent* %3, null, !dbg !333
  br i1 %4, label %10, label %5, !dbg !333

; <label>:5:                                      ; preds = %2
  %6 = getelementptr inbounds %struct._reent, %struct._reent* %3, i64 0, i32 8, !dbg !333
  %7 = load i32, i32* %6, align 8, !dbg !333, !tbaa !335
  %8 = icmp eq i32 %7, 0, !dbg !333
  br i1 %8, label %9, label %10, !dbg !332

; <label>:9:                                      ; preds = %5
  tail call void @__sinit(%struct._reent* nonnull %3) #5, !dbg !333
  br label %10, !dbg !333

; <label>:10:                                     ; preds = %5, %2, %9
  %11 = tail call i32 @_fputws_unlocked_r(%struct._reent* %3, i32* %0, %struct.__sFILE* %1) #6, !dbg !340
...
!302 = !DILocation(line: 696, column: 1, scope: !279, inlinedAt: !286)
!303 = !DILocation(line: 169, column: 8, scope: !276)
!304 = !DILocation(line: 695, column: 11, scope: !290, inlinedAt: !286)
!305 = !DILocation(line: 169, column: 36, scope: !275)
!306 = !DILocation(line: 171, column: 5, scope: !276)
!307 = !DILocation(line: 167, column: 16, scope: !250)
!308 = !DILocation(line: 167, column: 7, scope: !250)
!309 = distinct !{!309, !308, !310}
!310 = !DILocation(line: 172, column: 9, scope: !250)
!311 = !DILocation(line: 174, column: 10, scope: !13)
!312 = !DILocation(line: 174, column: 13, scope: !13)
!313 = !DILocation(line: 173, column: 5, scope: !250)
!314 = distinct !{!314, !315, !316}
!315 = !DILocation(line: 161, column: 3, scope: !13)
!316 = !DILocation(line: 174, column: 20, scope: !13)
!317 = !DILocation(line: 182, column: 1, scope: !13)
!318 = distinct !DISubprogram(name: "fputws_unlocked", scope: !14, file: !14, line: 185, type: !319, isLocal: false, isDefinition: true, scopeLine: 188, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !323)
!319 = !DISubroutineType(types: !320)
!320 = !{!17, !321, !322}
!321 = !DIDerivedType(tag: DW_TAG_restrict_type, baseType: !234)
!322 = !DIDerivedType(tag: DW_TAG_restrict_type, baseType: !237)
!323 = !{!324, !325, !326, !327}
!324 = !DILocalVariable(name: "ws", arg: 1, scope: !318, file: !14, line: 185, type: !321)
!325 = !DILocalVariable(name: "fp", arg: 2, scope: !318, file: !14, line: 185, type: !322)
!326 = !DILocalVariable(name: "reent", scope: !318, file: !14, line: 189, type: !18)
!327 = !DILocalVariable(name: "_check_init_ptr", scope: !328, file: !14, line: 191, type: !18)
!328 = distinct !DILexicalBlock(scope: !318, file: !14, line: 191, column: 3)
!329 = !DILocation(line: 185, column: 1, scope: !318)
!330 = !DILocation(line: 189, column: 26, scope: !318)
!331 = !DILocation(line: 189, column: 18, scope: !318)
!332 = !DILocation(line: 191, column: 3, scope: !328)
!333 = !DILocation(line: 191, column: 3, scope: !334)
!334 = distinct !DILexicalBlock(scope: !328, file: !14, line: 191, column: 3)
!335 = !{!336, !262, i64 80}
!336 = !{!"_reent", !262, i64 0, !253, i64 8, !253, i64 16, !253, i64 24, !262, i64 32, !254, i64 36, !262, i64 64, !253, i64 72, !262, i64 80, !253, i64 88, !253, i64 96, !262, i64 104, !253, i64 112, !253, i64 120, !262, i64 128, !253, i64 136, !254, i64 144, !253, i64 504, !337, i64 512, !253, i64 1304, !339, i64 1312, !254, i64 1336}
!337 = !{!"_atexit", !253, i64 0, !262, i64 8, !254, i64 16, !338, i64 272}
!338 = !{!"_on_exit_args", !254, i64 0, !254, i64 256, !262, i64 512, !262, i64 516}
!339 = !{!"_glue", !253, i64 0, !262, i64 8, !253, i64 16}
!340 = !DILocation(line: 192, column: 10, scope: !318)
!341 = !DILocation(line: 192, column: 3, scope: !318)
