...
; <label>:20:                                     ; preds = %11
  ...
  %23 = icmp sle i32 %15, %22, !dbg !297
  %24 = and i32 %1, 255, !dbg !298
  %25 = icmp eq i32 %24, 10, !dbg !298
  %26 = or i1 %25, %23, !dbg !299
  br i1 %26, label %33, label %27, !dbg !299

; <label>:27:                                     ; preds = %20, %18
  %28 = phi i32 [ %19, %18 ], [ %24, %20 ], !dbg !294
  %29 = trunc i32 %1 to i8, !dbg !300
  %30 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %2, i64 0, i32 0, !dbg !301
  %31 = load i8*, i8** %30, align 8, !dbg !302, !tbaa !303
  %32 = getelementptr inbounds i8, i8* %31, i64 1, !dbg !302
  store i8* %32, i8** %30, align 8, !dbg !302, !tbaa !303
  store i8 %29, i8* %31, align 1, !dbg !304, !tbaa !305
  br label %35, !dbg !306

; <label>:33:                                     ; preds = %20
  %34 = call i32 @__swbuf_r(%struct._reent* %0, i32 %1, %struct.__sFILE* nonnull %2) #4, !dbg !307
  br label %35, !dbg !308

; <label>:35:                                     ; preds = %27, %33
  %36 = phi i32 [ %28, %27 ], [ %34, %33 ], !dbg !309
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !310
  %37 = load i32, i32* %4, align 4, !dbg !312, !tbaa !313
  %38 = call i32 @pthread_setcancelstate(i32 %37, i32* nonnull %4) #4, !dbg !312
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %12) #5, !dbg !314
...
; Function Attrs: noredzone nounwind
define dso_local i32 @putc(i32, %struct.__sFILE*) local_unnamed_addr #0 !dbg !316 {
  %3 = alloca i32, align 4
  %4 = tail call %struct._reent* @__getreent() #4, !dbg !329
  %5 = icmp eq %struct._reent* %4, null, !dbg !332
  br i1 %5, label %11, label %6, !dbg !332

; <label>:6:                                      ; preds = %2
  %7 = getelementptr inbounds %struct._reent, %struct._reent* %4, i64 0, i32 8, !dbg !332
  %8 = load i32, i32* %7, align 8, !dbg !332, !tbaa !264
  %9 = icmp eq i32 %8, 0, !dbg !332
  br i1 %9, label %10, label %11, !dbg !331

; <label>:10:                                     ; preds = %6
  tail call void @__sinit(%struct._reent* nonnull %4) #4, !dbg !332
  br label %11, !dbg !332

; <label>:11:                                     ; preds = %6, %2, %10
  %12 = bitcast i32* %3 to i8*, !dbg !334
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %12) #5, !dbg !334
  %13 = call i32 @pthread_setcancelstate(i32 1, i32* nonnull %3) #4, !dbg !334
  %14 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %1, i64 0, i32 2, !dbg !339
  %15 = load i32, i32* %14, align 4, !dbg !340, !tbaa !286
  %16 = add nsw i32 %15, -1, !dbg !340
  store i32 %16, i32* %14, align 4, !dbg !340, !tbaa !286
  %17 = icmp sgt i32 %15, 0, !dbg !341
  br i1 %17, label %18, label %20, !dbg !342

; <label>:18:                                     ; preds = %11
  %19 = and i32 %0, 255, !dbg !343
  br label %27, !dbg !342

; <label>:20:                                     ; preds = %11
  %21 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %1, i64 0, i32 6, !dbg !344
  %22 = load i32, i32* %21, align 8, !dbg !344, !tbaa !296
  %23 = icmp sle i32 %15, %22, !dbg !345
  %24 = and i32 %0, 255, !dbg !346
  %25 = icmp eq i32 %24, 10, !dbg !346
  %26 = or i1 %25, %23, !dbg !347
  br i1 %26, label %33, label %27, !dbg !347

; <label>:27:                                     ; preds = %20, %18
  %28 = phi i32 [ %19, %18 ], [ %24, %20 ], !dbg !343
  %29 = trunc i32 %0 to i8, !dbg !348
  %30 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %1, i64 0, i32 0, !dbg !349
  %31 = load i8*, i8** %30, align 8, !dbg !350, !tbaa !303
  %32 = getelementptr inbounds i8, i8* %31, i64 1, !dbg !350
  store i8* %32, i8** %30, align 8, !dbg !350, !tbaa !303
  store i8 %29, i8* %31, align 1, !dbg !351, !tbaa !305
  br label %35, !dbg !352

; <label>:33:                                     ; preds = %20
  %34 = call i32 @__swbuf_r(%struct._reent* %4, i32 %0, %struct.__sFILE* nonnull %1) #4, !dbg !353
  br label %35, !dbg !354

; <label>:35:                                     ; preds = %27, %33
  %36 = phi i32 [ %28, %27 ], [ %34, %33 ], !dbg !355
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !356
  %37 = load i32, i32* %3, align 4, !dbg !358, !tbaa !313
  %38 = call i32 @pthread_setcancelstate(i32 %37, i32* nonnull %3) #4, !dbg !358
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %12) #5, !dbg !359
...
!298 = !DILocation(line: 692, column: 59, scope: !284, inlinedAt: !280)
!299 = !DILocation(line: 692, column: 47, scope: !284, inlinedAt: !280)
!300 = !DILocation(line: 693, column: 23, scope: !284, inlinedAt: !280)
!301 = !DILocation(line: 693, column: 16, scope: !284, inlinedAt: !280)
!302 = !DILocation(line: 693, column: 18, scope: !284, inlinedAt: !280)
!303 = !{!287, !269, i64 0}
!304 = !DILocation(line: 693, column: 21, scope: !284, inlinedAt: !280)
!305 = !{!267, !267, i64 0}
!306 = !DILocation(line: 693, column: 3, scope: !284, inlinedAt: !280)
!307 = !DILocation(line: 695, column: 11, scope: !284, inlinedAt: !280)
!308 = !DILocation(line: 695, column: 3, scope: !284, inlinedAt: !280)
!309 = !DILocation(line: 0, scope: !284, inlinedAt: !280)
!310 = !DILocation(line: 696, column: 1, scope: !275, inlinedAt: !280)
!311 = !DILocation(line: 98, column: 7, scope: !27)
!312 = !DILocation(line: 102, column: 3, scope: !259)
!313 = !{!266, !266, i64 0}
!314 = !DILocation(line: 102, column: 3, scope: !27)
!315 = !DILocation(line: 103, column: 3, scope: !27)
!316 = distinct !DISubprogram(name: "putc", scope: !1, file: !1, line: 108, type: !317, isLocal: false, isDefinition: true, scopeLine: 111, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !319)
!317 = !DISubroutineType(types: !318)
!318 = !{!5, !5, !248}
!319 = !{!320, !321, !322, !323, !324, !326}
!320 = !DILocalVariable(name: "c", arg: 1, scope: !316, file: !1, line: 108, type: !5)
!321 = !DILocalVariable(name: "fp", arg: 2, scope: !316, file: !1, line: 108, type: !248)
!322 = !DILocalVariable(name: "result", scope: !316, file: !1, line: 113, type: !5)
!323 = !DILocalVariable(name: "reent", scope: !316, file: !1, line: 114, type: !30)
!324 = !DILocalVariable(name: "_check_init_ptr", scope: !325, file: !1, line: 116, type: !30)
!325 = distinct !DILexicalBlock(scope: !316, file: !1, line: 116, column: 3)
!326 = !DILocalVariable(name: "__oldfpcancel", scope: !327, file: !1, line: 117, type: !5)
!327 = distinct !DILexicalBlock(scope: !316, file: !1, line: 117, column: 3)
!328 = !DILocation(line: 108, column: 1, scope: !316)
!329 = !DILocation(line: 114, column: 26, scope: !316)
!330 = !DILocation(line: 114, column: 18, scope: !316)
!331 = !DILocation(line: 116, column: 3, scope: !325)
!332 = !DILocation(line: 116, column: 3, scope: !333)
!333 = distinct !DILexicalBlock(scope: !325, file: !1, line: 116, column: 3)
!334 = !DILocation(line: 117, column: 3, scope: !327)
!335 = !DILocation(line: 687, column: 47, scope: !275, inlinedAt: !336)
!336 = distinct !DILocation(line: 118, column: 12, scope: !327)
!337 = !DILocation(line: 687, column: 57, scope: !275, inlinedAt: !336)
!338 = !DILocation(line: 687, column: 67, scope: !275, inlinedAt: !336)
!339 = !DILocation(line: 692, column: 12, scope: !284, inlinedAt: !336)
!340 = !DILocation(line: 692, column: 6, scope: !284, inlinedAt: !336)
!341 = !DILocation(line: 692, column: 15, scope: !284, inlinedAt: !336)
!342 = !DILocation(line: 692, column: 20, scope: !284, inlinedAt: !336)
!343 = !DILocation(line: 693, column: 10, scope: !284, inlinedAt: !336)
!344 = !DILocation(line: 692, column: 38, scope: !284, inlinedAt: !336)
!345 = !DILocation(line: 692, column: 31, scope: !284, inlinedAt: !336)
!346 = !DILocation(line: 692, column: 59, scope: !284, inlinedAt: !336)
!347 = !DILocation(line: 692, column: 47, scope: !284, inlinedAt: !336)
!348 = !DILocation(line: 693, column: 23, scope: !284, inlinedAt: !336)
!349 = !DILocation(line: 693, column: 16, scope: !284, inlinedAt: !336)
!350 = !DILocation(line: 693, column: 18, scope: !284, inlinedAt: !336)
!351 = !DILocation(line: 693, column: 21, scope: !284, inlinedAt: !336)
!352 = !DILocation(line: 693, column: 3, scope: !284, inlinedAt: !336)
!353 = !DILocation(line: 695, column: 11, scope: !284, inlinedAt: !336)
!354 = !DILocation(line: 695, column: 3, scope: !284, inlinedAt: !336)
!355 = !DILocation(line: 0, scope: !284, inlinedAt: !336)
!356 = !DILocation(line: 696, column: 1, scope: !275, inlinedAt: !336)
!357 = !DILocation(line: 113, column: 7, scope: !316)
!358 = !DILocation(line: 119, column: 3, scope: !327)
!359 = !DILocation(line: 119, column: 3, scope: !316)
!360 = !DILocation(line: 120, column: 3, scope: !316)
