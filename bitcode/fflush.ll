...
; <label>:25:                                     ; preds = %15, %19
  %26 = phi i32 [ %22, %19 ], [ 0, %15 ], !dbg !469
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !470
  br label %27, !dbg !471

; <label>:27:                                     ; preds = %25, %4
  %28 = phi i32 [ %6, %4 ], [ %26, %25 ], !dbg !472
...
!469 = !DILocation(line: 0, scope: !430, inlinedAt: !457)
!470 = !DILocation(line: 284, column: 1, scope: !415, inlinedAt: !457)
!471 = !DILocation(line: 295, column: 3, scope: !442)
!472 = !DILocation(line: 0, scope: !442)
!473 = !DILocation(line: 296, column: 1, scope: !442)
