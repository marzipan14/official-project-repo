...
define dso_local i32 @pthread_rwlock_trywrlock(%struct.pthread_rwlock_t_**) local_unnamed_addr #0 !dbg !513 {
  ...
  br i1 %2, label %53, label %3, !dbg !525

; <label>:3:                                      ; preds = %1
  %4 = bitcast %struct.pthread_rwlock_t_** %0 to i64*, !dbg !526
  %5 = load i64, i64* %4, align 8, !dbg !526, !tbaa !527
  %6 = inttoptr i64 %5 to %struct.pthread_rwlock_t_*, !dbg !531
...
; <label>:7:                                      ; preds = %3
  %8 = tail call i32 @pte_rwlock_check_need_init(%struct.pthread_rwlock_t_** nonnull %0) #3, !dbg !532
  %9 = or i32 %8, 16, !dbg !536
  %10 = icmp eq i32 %9, 16, !dbg !536
  br i1 %10, label %11, label %53, !dbg !536

; <label>:11:                                     ; preds = %7
  %12 = load %struct.pthread_rwlock_t_*, %struct.pthread_rwlock_t_** %0, align 8, !dbg !538, !tbaa !527
  br label %13, !dbg !536

; <label>:13:                                     ; preds = %11, %3
  %14 = phi %struct.pthread_rwlock_t_* [ %12, %11 ], [ %6, %3 ], !dbg !538
  %15 = getelementptr inbounds %struct.pthread_rwlock_t_, %struct.pthread_rwlock_t_* %14, i64 0, i32 6, !dbg !540
  %16 = load i32, i32* %15, align 4, !dbg !540, !tbaa !542
  %17 = icmp eq i32 %16, 262974946, !dbg !545
  br i1 %17, label %18, label %53, !dbg !546

; <label>:18:                                     ; preds = %13
  %19 = getelementptr inbounds %struct.pthread_rwlock_t_, %struct.pthread_rwlock_t_* %14, i64 0, i32 0, !dbg !547
  %20 = tail call i32 @pthread_mutex_trylock(%struct.pthread_mutex_t_** %19) #3, !dbg !549
  %21 = icmp eq i32 %20, 0, !dbg !550
  br i1 %21, label %22, label %53, !dbg !551

; <label>:22:                                     ; preds = %18
  %23 = getelementptr inbounds %struct.pthread_rwlock_t_, %struct.pthread_rwlock_t_* %14, i64 0, i32 1, !dbg !552
  %24 = tail call i32 @pthread_mutex_trylock(%struct.pthread_mutex_t_** nonnull %23) #3, !dbg !554
  %25 = icmp eq i32 %24, 0, !dbg !555
  br i1 %25, label %30, label %26, !dbg !556

; <label>:26:                                     ; preds = %22
  %27 = tail call i32 @pthread_mutex_unlock(%struct.pthread_mutex_t_** %19) #3, !dbg !557
  %28 = icmp eq i32 %27, 0, !dbg !560
  %29 = select i1 %28, i32 %24, i32 %27, !dbg !561
  br label %53, !dbg !562

; <label>:30:                                     ; preds = %22
  %31 = getelementptr inbounds %struct.pthread_rwlock_t_, %struct.pthread_rwlock_t_* %14, i64 0, i32 4, !dbg !563
  %32 = load i32, i32* %31, align 4, !dbg !563, !tbaa !565
  %33 = icmp eq i32 %32, 0, !dbg !566
  br i1 %33, label %34, label %53, !dbg !567

; <label>:34:                                     ; preds = %30
  %35 = getelementptr inbounds %struct.pthread_rwlock_t_, %struct.pthread_rwlock_t_* %14, i64 0, i32 5, !dbg !568
  %36 = load i32, i32* %35, align 8, !dbg !568, !tbaa !571
  %37 = icmp sgt i32 %36, 0, !dbg !572
  %38 = getelementptr inbounds %struct.pthread_rwlock_t_, %struct.pthread_rwlock_t_* %14, i64 0, i32 3
  %39 = load i32, i32* %38, align 8, !dbg !573, !tbaa !575
  br i1 %37, label %40, label %42, !dbg !576

; <label>:40:                                     ; preds = %34
  %41 = sub nsw i32 %39, %36, !dbg !577
  store i32 %41, i32* %38, align 8, !dbg !577, !tbaa !575
  store i32 0, i32* %35, align 8, !dbg !579, !tbaa !571
  br label %42, !dbg !580

; <label>:42:                                     ; preds = %34, %40
  %43 = phi i32 [ %41, %40 ], [ %39, %34 ], !dbg !581
  %44 = icmp sgt i32 %43, 0, !dbg !582
  br i1 %44, label %45, label %52, !dbg !583

; <label>:45:                                     ; preds = %42
  %46 = tail call i32 @pthread_mutex_unlock(%struct.pthread_mutex_t_** nonnull %23) #3, !dbg !584
  %47 = icmp eq i32 %46, 0, !dbg !587
  %48 = tail call i32 @pthread_mutex_unlock(%struct.pthread_mutex_t_** nonnull %19) #3, !dbg !588
  br i1 %47, label %49, label %53, !dbg !590

; <label>:49:                                     ; preds = %45
  %50 = icmp eq i32 %48, 0, !dbg !591
  %51 = select i1 %50, i32 16, i32 %48, !dbg !592
  br label %53, !dbg !593

; <label>:52:                                     ; preds = %42
  store i32 1, i32* %31, align 4, !dbg !594, !tbaa !565
  br label %53

; <label>:53:                                     ; preds = %52, %49, %30, %45, %18, %13, %7, %3, %1, %26
  %54 = phi i32 [ %29, %26 ], [ 22, %3 ], [ 22, %1 ], [ %8, %7 ], [ 22, %13 ], [ %20, %18 ], [ %46, %45 ], [ %51, %49 ], [ 0, %52 ], [ 16, %30 ], !dbg !596
...
!532 = !DILocation(line: 68, column: 16, scope: !533)
!533 = distinct !DILexicalBlock(scope: !534, file: !1, line: 67, column: 5)
!534 = distinct !DILexicalBlock(scope: !513, file: !1, line: 66, column: 7)
!535 = !DILocation(line: 52, column: 7, scope: !513)
!536 = !DILocation(line: 70, column: 23, scope: !537)
!537 = distinct !DILexicalBlock(scope: !533, file: !1, line: 70, column: 11)
!538 = !DILocation(line: 76, column: 9, scope: !513)
!539 = !DILocation(line: 53, column: 20, scope: !513)
!540 = !DILocation(line: 78, column: 12, scope: !541)
!541 = distinct !DILexicalBlock(scope: !513, file: !1, line: 78, column: 7)
!542 = !{!543, !544, i64 36}
!543 = !{!"pthread_rwlock_t_", !528, i64 0, !528, i64 8, !528, i64 16, !544, i64 24, !544, i64 28, !544, i64 32, !544, i64 36}
!544 = !{!"int", !529, i64 0}
!545 = !DILocation(line: 78, column: 19, scope: !541)
!546 = !DILocation(line: 78, column: 7, scope: !513)
!547 = !DILocation(line: 83, column: 47, scope: !548)
!548 = distinct !DILexicalBlock(scope: !513, file: !1, line: 83, column: 7)
!549 = !DILocation(line: 83, column: 17, scope: !548)
!550 = !DILocation(line: 83, column: 69, scope: !548)
!551 = !DILocation(line: 83, column: 7, scope: !513)
!552 = !DILocation(line: 89, column: 40, scope: !553)
!553 = distinct !DILexicalBlock(scope: !513, file: !1, line: 88, column: 7)
!554 = !DILocation(line: 89, column: 10, scope: !553)
!555 = !DILocation(line: 89, column: 68, scope: !553)
!556 = !DILocation(line: 88, column: 7, scope: !513)
!557 = !DILocation(line: 91, column: 17, scope: !558)
!558 = distinct !DILexicalBlock(scope: !553, file: !1, line: 90, column: 5)
!559 = !DILocation(line: 52, column: 15, scope: !513)
!560 = !DILocation(line: 92, column: 24, scope: !558)
!561 = !DILocation(line: 92, column: 15, scope: !558)
!562 = !DILocation(line: 92, column: 7, scope: !558)
!563 = !DILocation(line: 95, column: 12, scope: !564)
!564 = distinct !DILexicalBlock(scope: !513, file: !1, line: 95, column: 7)
!565 = !{!543, !544, i64 28}
!566 = !DILocation(line: 95, column: 34, scope: !564)
!567 = !DILocation(line: 95, column: 7, scope: !513)
!568 = !DILocation(line: 97, column: 16, scope: !569)
!569 = distinct !DILexicalBlock(scope: !570, file: !1, line: 97, column: 11)
!570 = distinct !DILexicalBlock(scope: !564, file: !1, line: 96, column: 5)
!571 = !{!543, !544, i64 32}
!572 = !DILocation(line: 97, column: 44, scope: !569)
!573 = !DILocation(line: 0, scope: !574)
!574 = distinct !DILexicalBlock(scope: !570, file: !1, line: 103, column: 11)
!575 = !{!543, !544, i64 24}
!576 = !DILocation(line: 97, column: 11, scope: !570)
!577 = !DILocation(line: 99, column: 35, scope: !578)
!578 = distinct !DILexicalBlock(scope: !569, file: !1, line: 98, column: 9)
!579 = !DILocation(line: 100, column: 44, scope: !578)
!580 = !DILocation(line: 101, column: 9, scope: !578)
!581 = !DILocation(line: 103, column: 16, scope: !574)
!582 = !DILocation(line: 103, column: 35, scope: !574)
!583 = !DILocation(line: 103, column: 11, scope: !570)
!584 = !DILocation(line: 106, column: 18, scope: !585)
!585 = distinct !DILexicalBlock(scope: !586, file: !1, line: 105, column: 15)
!586 = distinct !DILexicalBlock(scope: !574, file: !1, line: 104, column: 9)
!587 = !DILocation(line: 106, column: 75, scope: !585)
!588 = !DILocation(line: 0, scope: !589)
!589 = distinct !DILexicalBlock(scope: !586, file: !1, line: 112, column: 15)
!590 = !DILocation(line: 105, column: 15, scope: !586)
!591 = !DILocation(line: 113, column: 69, scope: !589)
!592 = !DILocation(line: 112, column: 15, scope: !586)
!593 = !DILocation(line: 117, column: 9, scope: !586)
!594 = !DILocation(line: 120, column: 38, scope: !595)
!595 = distinct !DILexicalBlock(scope: !574, file: !1, line: 119, column: 9)
!596 = !DILocation(line: 0, scope: !513)
!597 = !DILocation(line: 129, column: 1, scope: !513)
