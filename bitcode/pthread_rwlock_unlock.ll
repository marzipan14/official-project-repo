...
define dso_local i32 @pthread_rwlock_unlock(%struct.pthread_rwlock_t_** readonly) local_unnamed_addr #0 !dbg !513 {
  ...
  br i1 %2, label %38, label %3, !dbg !525

; <label>:3:                                      ; preds = %1
  %4 = load %struct.pthread_rwlock_t_*, %struct.pthread_rwlock_t_** %0, align 8, !dbg !526, !tbaa !527
  %5 = ptrtoint %struct.pthread_rwlock_t_* %4 to i64, !dbg !531
...
; <label>:7:                                      ; preds = %3
  %8 = getelementptr inbounds %struct.pthread_rwlock_t_, %struct.pthread_rwlock_t_* %4, i64 0, i32 6, !dbg !536
  %9 = load i32, i32* %8, align 4, !dbg !536, !tbaa !538
  %10 = icmp eq i32 %9, 262974946, !dbg !541
  br i1 %10, label %11, label %38, !dbg !542

; <label>:11:                                     ; preds = %7
  %12 = getelementptr inbounds %struct.pthread_rwlock_t_, %struct.pthread_rwlock_t_* %4, i64 0, i32 4, !dbg !543
  %13 = load i32, i32* %12, align 4, !dbg !543, !tbaa !545
  %14 = icmp eq i32 %13, 0, !dbg !546
  br i1 %14, label %15, label %27, !dbg !547

; <label>:15:                                     ; preds = %11
  %16 = getelementptr inbounds %struct.pthread_rwlock_t_, %struct.pthread_rwlock_t_* %4, i64 0, i32 1, !dbg !548
  %17 = tail call i32 @pthread_mutex_lock(%struct.pthread_mutex_t_** nonnull %16) #3, !dbg !551
  %18 = icmp eq i32 %17, 0, !dbg !553
  br i1 %18, label %19, label %38, !dbg !554

; <label>:19:                                     ; preds = %15
  %20 = getelementptr inbounds %struct.pthread_rwlock_t_, %struct.pthread_rwlock_t_* %4, i64 0, i32 5, !dbg !555
  %21 = load i32, i32* %20, align 8, !dbg !557, !tbaa !558
  %22 = add nsw i32 %21, 1, !dbg !557
  store i32 %22, i32* %20, align 8, !dbg !557, !tbaa !558
  %23 = icmp eq i32 %22, 0, !dbg !559
  br i1 %23, label %24, label %32, !dbg !560

; <label>:24:                                     ; preds = %19
  %25 = getelementptr inbounds %struct.pthread_rwlock_t_, %struct.pthread_rwlock_t_* %4, i64 0, i32 2, !dbg !561
  %26 = tail call i32 @pthread_cond_signal(%struct.pthread_cond_t_** nonnull %25) #3, !dbg !563
  br label %32, !dbg !564

; <label>:27:                                     ; preds = %11
  %28 = add nsw i32 %13, -1, !dbg !565
  store i32 %28, i32* %12, align 4, !dbg !565, !tbaa !545
  %29 = getelementptr inbounds %struct.pthread_rwlock_t_, %struct.pthread_rwlock_t_* %4, i64 0, i32 1, !dbg !567
  %30 = tail call i32 @pthread_mutex_unlock(%struct.pthread_mutex_t_** nonnull %29) #3, !dbg !568
  %31 = getelementptr inbounds %struct.pthread_rwlock_t_, %struct.pthread_rwlock_t_* %4, i64 0, i32 0, !dbg !569
  br label %32

; <label>:32:                                     ; preds = %19, %24, %27
  %33 = phi %struct.pthread_mutex_t_** [ %31, %27 ], [ %16, %24 ], [ %16, %19 ]
  %34 = phi i32 [ %30, %27 ], [ %26, %24 ], [ 0, %19 ], !dbg !571
  %35 = tail call i32 @pthread_mutex_unlock(%struct.pthread_mutex_t_** nonnull %33) #3, !dbg !572
  %36 = icmp eq i32 %34, 0, !dbg !573
  %37 = select i1 %36, i32 %35, i32 %34, !dbg !574
  br label %38, !dbg !575

; <label>:38:                                     ; preds = %15, %7, %3, %1, %32, %6
  %39 = phi i32 [ 0, %6 ], [ %37, %32 ], [ 22, %3 ], [ 22, %1 ], [ 22, %7 ], [ %17, %15 ], !dbg !576
...
!532 = !DILocation(line: 65, column: 7, scope: !533)
!533 = distinct !DILexicalBlock(scope: !534, file: !1, line: 61, column: 5)
!534 = distinct !DILexicalBlock(scope: !513, file: !1, line: 60, column: 7)
!535 = !DILocation(line: 53, column: 20, scope: !513)
!536 = !DILocation(line: 70, column: 12, scope: !537)
!537 = distinct !DILexicalBlock(scope: !513, file: !1, line: 70, column: 7)
!538 = !{!539, !540, i64 36}
!539 = !{!"pthread_rwlock_t_", !528, i64 0, !528, i64 8, !528, i64 16, !540, i64 24, !540, i64 28, !540, i64 32, !540, i64 36}
!540 = !{!"int", !529, i64 0}
!541 = !DILocation(line: 70, column: 19, scope: !537)
!542 = !DILocation(line: 70, column: 7, scope: !513)
!543 = !DILocation(line: 75, column: 12, scope: !544)
!544 = distinct !DILexicalBlock(scope: !513, file: !1, line: 75, column: 7)
!545 = !{!539, !540, i64 28}
!546 = !DILocation(line: 75, column: 34, scope: !544)
!547 = !DILocation(line: 75, column: 7, scope: !513)
!548 = !DILocation(line: 78, column: 41, scope: !549)
!549 = distinct !DILexicalBlock(scope: !550, file: !1, line: 77, column: 11)
!550 = distinct !DILexicalBlock(scope: !544, file: !1, line: 76, column: 5)
!551 = !DILocation(line: 78, column: 14, scope: !549)
!552 = !DILocation(line: 52, column: 7, scope: !513)
!553 = !DILocation(line: 78, column: 69, scope: !549)
!554 = !DILocation(line: 77, column: 11, scope: !550)
!555 = !DILocation(line: 83, column: 18, scope: !556)
!556 = distinct !DILexicalBlock(scope: !550, file: !1, line: 83, column: 11)
!557 = !DILocation(line: 83, column: 11, scope: !556)
!558 = !{!539, !540, i64 32}
!559 = !DILocation(line: 83, column: 46, scope: !556)
!560 = !DILocation(line: 83, column: 11, scope: !550)
!561 = !DILocation(line: 85, column: 48, scope: !562)
!562 = distinct !DILexicalBlock(scope: !556, file: !1, line: 84, column: 9)
!563 = !DILocation(line: 85, column: 20, scope: !562)
!564 = !DILocation(line: 86, column: 9, scope: !562)
!565 = !DILocation(line: 92, column: 33, scope: !566)
!566 = distinct !DILexicalBlock(scope: !544, file: !1, line: 91, column: 5)
!567 = !DILocation(line: 94, column: 45, scope: !566)
!568 = !DILocation(line: 94, column: 16, scope: !566)
!569 = !DILocation(line: 95, column: 46, scope: !566)
!570 = !DILocation(line: 52, column: 15, scope: !513)
!571 = !DILocation(line: 0, scope: !566)
!572 = !DILocation(line: 0, scope: !550)
!573 = !DILocation(line: 99, column: 19, scope: !513)
!574 = !DILocation(line: 99, column: 11, scope: !513)
!575 = !DILocation(line: 99, column: 3, scope: !513)
!576 = !DILocation(line: 0, scope: !513)
!577 = !DILocation(line: 100, column: 1, scope: !513)
