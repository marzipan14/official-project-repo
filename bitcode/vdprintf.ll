...
; <label>:20:                                     ; preds = %3, %17
  ...
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %8) #4, !dbg !307, !noalias !289
  call void @llvm.lifetime.end.p0i8(i64 512, i8* nonnull %7) #4, !dbg !307, !noalias !289
...
!307 = !DILocation(line: 34, column: 1, scope: !7, inlinedAt: !284)
!308 = !DILocation(line: 50, column: 3, scope: !276)
