...
; <label>:35:                                     ; preds = %30, %32
  ...
  br i1 %37, label %83, label %25, !dbg !596, !llvm.loop !597

; <label>:38:                                     ; preds = %12
  %39 = tail call { i8*, i32 } @pthread_self() #4, !dbg !599
  %40 = extractvalue { i8*, i32 } %39, 0, !dbg !599
  %41 = extractvalue { i8*, i32 } %39, 1, !dbg !599
  %42 = getelementptr inbounds %struct.pthread_mutex_t_, %struct.pthread_mutex_t_* %13, i64 0, i32 1, !dbg !601
  %43 = load i32, i32* %42, align 8, !dbg !601, !tbaa !602
  %44 = cmpxchg i32* %42, i32 0, i32 1 seq_cst seq_cst, !dbg !603
  %45 = icmp eq i32 %43, 0, !dbg !604
  br i1 %45, label %46, label %50, !dbg !605

; <label>:46:                                     ; preds = %38
  %47 = getelementptr inbounds %struct.pthread_mutex_t_, %struct.pthread_mutex_t_* %13, i64 0, i32 2, !dbg !606
  store i32 1, i32* %47, align 4, !dbg !608, !tbaa !609
  %48 = getelementptr inbounds %struct.pthread_mutex_t_, %struct.pthread_mutex_t_* %13, i64 0, i32 4, i32 0, !dbg !610
  store i8* %40, i8** %48, align 8, !dbg !610
  %49 = getelementptr inbounds %struct.pthread_mutex_t_, %struct.pthread_mutex_t_* %13, i64 0, i32 4, i32 1, !dbg !610
  store i32 %41, i32* %49, align 8, !dbg !610
  br label %83, !dbg !611

; <label>:50:                                     ; preds = %38
  %51 = getelementptr inbounds %struct.pthread_mutex_t_, %struct.pthread_mutex_t_* %13, i64 0, i32 4, i32 0, !dbg !612
  %52 = load i8*, i8** %51, align 8, !dbg !612
  %53 = getelementptr inbounds %struct.pthread_mutex_t_, %struct.pthread_mutex_t_* %13, i64 0, i32 4, i32 1, !dbg !612
  %54 = load i32, i32* %53, align 8, !dbg !612
  %55 = tail call i32 @pthread_equal(i8* %52, i32 %54, i8* %40, i32 %41) #4, !dbg !612
  %56 = icmp eq i32 %55, 0, !dbg !612
  br i1 %56, label %57, label %61, !dbg !615
...
; <label>:61:                                     ; preds = %50
  %62 = load i32, i32* %14, align 8, !dbg !618, !tbaa !546
  %63 = icmp eq i32 %62, 1, !dbg !621
  br i1 %63, label %64, label %83, !dbg !622

; <label>:64:                                     ; preds = %61
  %65 = getelementptr inbounds %struct.pthread_mutex_t_, %struct.pthread_mutex_t_* %13, i64 0, i32 2, !dbg !623
  %66 = load i32, i32* %65, align 4, !dbg !625, !tbaa !609
  %67 = add nsw i32 %66, 1, !dbg !625
  store i32 %67, i32* %65, align 4, !dbg !625, !tbaa !609
  br label %83, !dbg !626

; <label>:68:                                     ; preds = %57, %78
  %69 = atomicrmw xchg i32* %42, i32 -1 seq_cst, !dbg !616
  %70 = icmp eq i32 %69, 0, !dbg !627
  br i1 %70, label %81, label %71, !dbg !628

; <label>:71:                                     ; preds = %68
  %72 = load %struct.uk_semaphore*, %struct.uk_semaphore** %58, align 8, !dbg !629, !tbaa !564
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %59) #5, !dbg !635
  br i1 %60, label %73, label %75, !dbg !636

; <label>:73:                                     ; preds = %71
  %74 = call i32 @pte_osSemaphorePend(%struct.uk_semaphore* %72, i32* null) #4, !dbg !637
  br label %78, !dbg !639

; <label>:75:                                     ; preds = %71
  %76 = call i32 @pte_relmillisecs(%struct.timespec* nonnull %1) #4, !dbg !640
  store i32 %76, i32* %3, align 4, !dbg !642, !tbaa !589
  %77 = call i32 @pte_osSemaphorePend(%struct.uk_semaphore* %72, i32* nonnull %3) #4, !dbg !643
  br label %78

; <label>:78:                                     ; preds = %73, %75
  %79 = phi i32 [ %74, %73 ], [ %77, %75 ], !dbg !644
  %80 = icmp eq i32 %79, 3, !dbg !645
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %59) #5, !dbg !646
  store volatile i32 42, i32* @__A_VARIABLE, align 4, !dbg !647
  br i1 %80, label %83, label %68, !dbg !648, !llvm.loop !649

; <label>:81:                                     ; preds = %68
  %82 = getelementptr inbounds %struct.pthread_mutex_t_, %struct.pthread_mutex_t_* %13, i64 0, i32 2, !dbg !651
  store i32 1, i32* %82, align 4, !dbg !652, !tbaa !609
  store i8* %40, i8** %51, align 8, !dbg !653
  store i32 %41, i32* %53, align 8, !dbg !653
  br label %83
...
!595 = !DILocation(line: 105, column: 3, scope: !566, inlinedAt: !576)
!596 = !DILocation(line: 143, column: 19, scope: !563)
!597 = distinct !{!597, !560, !598}
!598 = !DILocation(line: 147, column: 13, scope: !558)
!599 = !DILocation(line: 152, column: 24, scope: !520)
!600 = !DILocation(line: 152, column: 17, scope: !520)
!601 = !DILocation(line: 154, column: 11, scope: !523)
!602 = !{!547, !548, i64 8}
!603 = !DILocation(line: 154, column: 11, scope: !526)
!604 = !DILocation(line: 154, column: 58, scope: !524)
!605 = !DILocation(line: 154, column: 11, scope: !520)
!606 = !DILocation(line: 156, column: 15, scope: !607)
!607 = distinct !DILexicalBlock(scope: !524, file: !1, line: 155, column: 9)
!608 = !DILocation(line: 156, column: 31, scope: !607)
!609 = !{!547, !548, i64 12}
!610 = !DILocation(line: 157, column: 29, scope: !607)
!611 = !DILocation(line: 158, column: 9, scope: !607)
!612 = !DILocation(line: 161, column: 15, scope: !613)
!613 = distinct !DILexicalBlock(scope: !614, file: !1, line: 161, column: 15)
!614 = distinct !DILexicalBlock(scope: !524, file: !1, line: 160, column: 9)
!615 = !DILocation(line: 161, column: 15, scope: !614)
!616 = !DILocation(line: 174, column: 22, scope: !617)
!617 = distinct !DILexicalBlock(scope: !613, file: !1, line: 173, column: 13)
!618 = !DILocation(line: 163, column: 23, scope: !619)
!619 = distinct !DILexicalBlock(scope: !620, file: !1, line: 163, column: 19)
!620 = distinct !DILexicalBlock(scope: !613, file: !1, line: 162, column: 13)
!621 = !DILocation(line: 163, column: 28, scope: !619)
!622 = !DILocation(line: 163, column: 19, scope: !620)
!623 = !DILocation(line: 165, column: 23, scope: !624)
!624 = distinct !DILexicalBlock(scope: !619, file: !1, line: 164, column: 17)
!625 = !DILocation(line: 165, column: 38, scope: !624)
!626 = !DILocation(line: 171, column: 13, scope: !620)
!627 = !DILocation(line: 174, column: 60, scope: !617)
!628 = !DILocation(line: 174, column: 15, scope: !617)
!629 = !DILocation(line: 176, column: 63, scope: !630)
!630 = distinct !DILexicalBlock(scope: !631, file: !1, line: 176, column: 23)
!631 = distinct !DILexicalBlock(scope: !617, file: !1, line: 175, column: 17)
!632 = !DILocation(line: 53, column: 44, scope: !566, inlinedAt: !633)
!633 = distinct !DILocation(line: 176, column: 38, scope: !630)
!634 = !DILocation(line: 53, column: 74, scope: !566, inlinedAt: !633)
!635 = !DILocation(line: 77, column: 3, scope: !566, inlinedAt: !633)
!636 = !DILocation(line: 81, column: 7, scope: !566, inlinedAt: !633)
!637 = !DILocation(line: 83, column: 16, scope: !581, inlinedAt: !633)
!638 = !DILocation(line: 78, column: 16, scope: !566, inlinedAt: !633)
!639 = !DILocation(line: 84, column: 5, scope: !581, inlinedAt: !633)
!640 = !DILocation(line: 90, column: 22, scope: !586, inlinedAt: !633)
!641 = !DILocation(line: 77, column: 16, scope: !566, inlinedAt: !633)
!642 = !DILocation(line: 90, column: 20, scope: !586, inlinedAt: !633)
!643 = !DILocation(line: 92, column: 16, scope: !586, inlinedAt: !633)
!644 = !DILocation(line: 0, scope: !586, inlinedAt: !633)
!645 = !DILocation(line: 96, column: 14, scope: !593, inlinedAt: !633)
!646 = !DILocation(line: 107, column: 1, scope: !566, inlinedAt: !633)
!647 = !DILocation(line: 105, column: 3, scope: !566, inlinedAt: !633)
!648 = !DILocation(line: 176, column: 23, scope: !631)
!649 = distinct !{!649, !628, !650}
!650 = !DILocation(line: 180, column: 17, scope: !617)
!651 = !DILocation(line: 182, column: 19, scope: !617)
!652 = !DILocation(line: 182, column: 35, scope: !617)
!653 = !DILocation(line: 183, column: 33, scope: !617)
!654 = !DILocation(line: 189, column: 1, scope: !502)
