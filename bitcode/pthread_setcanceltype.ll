...
; <label>:10:                                     ; preds = %6
  ...
  %15 = getelementptr inbounds i8, i8* %4, i64 92, !dbg !571
  %16 = bitcast i8* %15 to i32*, !dbg !571
  br i1 %14, label %19, label %17, !dbg !573
...
; <label>:19:                                     ; preds = %10, %17
  store i32 1, i32* %16, align 4, !dbg !585, !tbaa !575
  %20 = tail call i32 @pthread_mutex_unlock(%struct.pthread_mutex_t_** nonnull %12) #3, !dbg !586
  br label %21, !dbg !587

; <label>:21:                                     ; preds = %6, %2, %19
  %22 = phi i32 [ 0, %19 ], [ 1, %2 ], [ 22, %6 ], !dbg !588
...
!565 = !DILocation(line: 105, column: 11, scope: !564)
!566 = !DILocation(line: 104, column: 7, scope: !564)
...
!572 = distinct !DILexicalBlock(scope: !570, file: !1, line: 116, column: 5)
!573 = !DILocation(line: 115, column: 7, scope: !545)
!574 = !DILocation(line: 117, column: 22, scope: !572)
!575 = !{!576, !581, i64 92}
...
!581 = !{!"int", !578, i64 0}
!582 = !DILocation(line: 117, column: 16, scope: !572)
!583 = !{!581, !581, i64 0}
!584 = !DILocation(line: 118, column: 5, scope: !572)
!585 = !DILocation(line: 120, column: 18, scope: !545)
!586 = !DILocation(line: 138, column: 10, scope: !545)
!587 = !DILocation(line: 140, column: 3, scope: !545)
!588 = !DILocation(line: 0, scope: !545)
!589 = !DILocation(line: 142, column: 1, scope: !545)
