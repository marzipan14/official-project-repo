; ModuleID = '/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/stdio/fprintf.c'
source_filename = "/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/stdio/fprintf.c"
...
define dso_local i32 @_fprintf_r(%struct._reent*, %struct.__sFILE* noalias, i8* noalias, ...) local_unnamed_addr #0 !dbg !7 {
  %4 = alloca [1 x %struct.__va_list_tag], align 16
  %5 = bitcast [1 x %struct.__va_list_tag]* %4 to i8*, !dbg !253
  call void @llvm.lifetime.start.p0i8(i64 24, i8* nonnull %5) #3, !dbg !253
  %6 = getelementptr inbounds [1 x %struct.__va_list_tag], [1 x %struct.__va_list_tag]* %4, i64 0, i64 0, !dbg !255
  call void @llvm.va_start(i8* nonnull %5), !dbg !255
  %7 = call i32 @_vfprintf_r(%struct._reent* %0, %struct.__sFILE* %1, i8* %2, %struct.__va_list_tag* nonnull %6) #5, !dbg !256
  call void @llvm.va_end(i8* nonnull %5), !dbg !258
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %5) #3, !dbg !259
...
; Function Attrs: noredzone nounwind
define dso_local i32 @fprintf(%struct.__sFILE* noalias, i8* noalias, ...) local_unnamed_addr #0 !dbg !261 {
  %3 = alloca [1 x %struct.__va_list_tag], align 16
  %4 = bitcast [1 x %struct.__va_list_tag]* %3 to i8*, !dbg !270
  call void @llvm.lifetime.start.p0i8(i64 24, i8* nonnull %4) #3, !dbg !270
  %5 = getelementptr inbounds [1 x %struct.__va_list_tag], [1 x %struct.__va_list_tag]* %3, i64 0, i64 0, !dbg !272
  call void @llvm.va_start(i8* nonnull %4), !dbg !272
  %6 = call %struct._reent* @__getreent() #5, !dbg !273
  %7 = call i32 @_vfprintf_r(%struct._reent* %6, %struct.__sFILE* %0, i8* %1, %struct.__va_list_tag* nonnull %5) #5, !dbg !274
  call void @llvm.va_end(i8* nonnull %4), !dbg !276
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %4) #3, !dbg !277
...
!1 = !DIFile(filename: "/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/stdio/fprintf.c", directory: "/root/.unikraft/apps/redis/build")
!2 = !{}
!3 = !{i32 2, !"Dwarf Version", i32 4}
!4 = !{i32 2, !"Debug Info Version", i32 3}
!5 = !{i32 1, !"wchar_size", i32 4}
!6 = !{!"clang version 7.0.1-8+deb10u2 (tags/RELEASE_701/final)"}
!7 = distinct !DISubprogram(name: "_fprintf_r", scope: !1, file: !1, line: 25, type: !8, isLocal: false, isDefinition: true, scopeLine: 29, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !235)
!8 = !DISubroutineType(types: !9)
!9 = !{!10, !11, !230, !234, null}
...
!232 = !DIDerivedType(tag: DW_TAG_typedef, name: "FILE", file: !233, line: 66, baseType: !18)
...
!234 = !DIDerivedType(tag: DW_TAG_restrict_type, baseType: !50)
!235 = !{!236, !237, !238, !239, !240}
!236 = !DILocalVariable(name: "ptr", arg: 1, scope: !7, file: !1, line: 25, type: !11)
!237 = !DILocalVariable(name: "fp", arg: 2, scope: !7, file: !1, line: 25, type: !230)
!238 = !DILocalVariable(name: "fmt", arg: 3, scope: !7, file: !1, line: 25, type: !234)
!239 = !DILocalVariable(name: "ret", scope: !7, file: !1, line: 30, type: !10)
!240 = !DILocalVariable(name: "ap", scope: !7, file: !1, line: 31, type: !241)
!241 = !DIDerivedType(tag: DW_TAG_typedef, name: "va_list", file: !233, line: 46, baseType: !242)
...
!244 = !DIDerivedType(tag: DW_TAG_typedef, name: "__builtin_va_list", file: !1, line: 31, baseType: !245)
!245 = !DICompositeType(tag: DW_TAG_array_type, baseType: !246, size: 192, elements: !70)
!246 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "__va_list_tag", file: !1, line: 31, size: 192, elements: !247)
!247 = !{!248, !249, !250, !251}
!248 = !DIDerivedType(tag: DW_TAG_member, name: "gp_offset", scope: !246, file: !1, line: 31, baseType: !92, size: 32)
!249 = !DIDerivedType(tag: DW_TAG_member, name: "fp_offset", scope: !246, file: !1, line: 31, baseType: !92, size: 32, offset: 32)
!250 = !DIDerivedType(tag: DW_TAG_member, name: "overflow_arg_area", scope: !246, file: !1, line: 31, baseType: !36, size: 64, offset: 64)
!251 = !DIDerivedType(tag: DW_TAG_member, name: "reg_save_area", scope: !246, file: !1, line: 31, baseType: !36, size: 64, offset: 128)
!252 = !DILocation(line: 25, column: 1, scope: !7)
!253 = !DILocation(line: 31, column: 3, scope: !7)
!254 = !DILocation(line: 31, column: 11, scope: !7)
!255 = !DILocation(line: 33, column: 3, scope: !7)
!256 = !DILocation(line: 34, column: 9, scope: !7)
!257 = !DILocation(line: 30, column: 7, scope: !7)
!258 = !DILocation(line: 35, column: 3, scope: !7)
!259 = !DILocation(line: 37, column: 1, scope: !7)
!260 = !DILocation(line: 36, column: 3, scope: !7)
!261 = distinct !DISubprogram(name: "fprintf", scope: !1, file: !1, line: 48, type: !262, isLocal: false, isDefinition: true, scopeLine: 51, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !264)
!262 = !DISubroutineType(types: !263)
!263 = !{!10, !230, !234, null}
!264 = !{!265, !266, !267, !268}
!265 = !DILocalVariable(name: "fp", arg: 1, scope: !261, file: !1, line: 48, type: !230)
!266 = !DILocalVariable(name: "fmt", arg: 2, scope: !261, file: !1, line: 48, type: !234)
!267 = !DILocalVariable(name: "ret", scope: !261, file: !1, line: 52, type: !10)
!268 = !DILocalVariable(name: "ap", scope: !261, file: !1, line: 53, type: !241)
!269 = !DILocation(line: 48, column: 1, scope: !261)
!270 = !DILocation(line: 53, column: 3, scope: !261)
!271 = !DILocation(line: 53, column: 11, scope: !261)
!272 = !DILocation(line: 55, column: 3, scope: !261)
!273 = !DILocation(line: 56, column: 22, scope: !261)
!274 = !DILocation(line: 56, column: 9, scope: !261)
!275 = !DILocation(line: 52, column: 7, scope: !261)
!276 = !DILocation(line: 57, column: 3, scope: !261)
!277 = !DILocation(line: 59, column: 1, scope: !261)
!278 = !DILocation(line: 58, column: 3, scope: !261)
