...
define dso_local i8* @pthread_timechange_handler_np(i8* nocapture readnone) local_unnamed_addr #0 !dbg !16 {
  ...
  %6 = bitcast %struct.pthread_cond_t_** %2 to i64*, !dbg !519
  %7 = load i64, i64* bitcast (%struct.pthread_cond_t_** @pte_cond_list_head to i64*), align 8, !dbg !520, !tbaa !513
  store i64 %7, i64* %6, align 8, !dbg !520, !tbaa !513
  %8 = icmp eq i64 %7, 0, !dbg !522
  br i1 %8, label %20, label %9, !dbg !523

; <label>:9:                                      ; preds = %1, %9
  %10 = call i32 @pthread_cond_broadcast(%struct.pthread_cond_t_** nonnull %2) #5, !dbg !524
  ...
  %14 = load i64, i64* %13, align 8, !dbg !520, !tbaa !513
  store i64 %14, i64* %6, align 8, !dbg !520, !tbaa !513
  %15 = icmp ne i64 %14, 0, !dbg !522
  %16 = icmp eq i32 %10, 0, !dbg !527
  %17 = and i1 %16, %15, !dbg !528
  br i1 %17, label %9, label %18, !dbg !523, !llvm.loop !529

; <label>:18:                                     ; preds = %9
  %19 = select i1 %16, i8* null, i8* inttoptr (i64 11 to i8*), !dbg !531
  br label %20, !dbg !531

; <label>:20:                                     ; preds = %18, %1
  %21 = phi i8* [ null, %1 ], [ %19, %18 ]
  %22 = load %struct.uk_mutex*, %struct.uk_mutex** @pte_cond_list_lock, align 8, !dbg !531, !tbaa !513
  %23 = call i32 @pte_osMutexUnlock(%struct.uk_mutex* %22) #5, !dbg !532
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %3) #4, !dbg !533
...
!518 = !DILocation(line: 98, column: 18, scope: !16)
!519 = !DILocation(line: 103, column: 6, scope: !16)
!520 = !DILocation(line: 0, scope: !521)
!521 = distinct !DILexicalBlock(scope: !16, file: !1, line: 106, column: 5)
!522 = !DILocation(line: 105, column: 13, scope: !16)
!523 = !DILocation(line: 105, column: 3, scope: !16)
!524 = !DILocation(line: 107, column: 16, scope: !521)
!525 = !DILocation(line: 108, column: 12, scope: !521)
!526 = !DILocation(line: 108, column: 16, scope: !521)
!527 = !DILocation(line: 105, column: 26, scope: !16)
!528 = !DILocation(line: 105, column: 21, scope: !16)
!529 = distinct !{!529, !523, !530}
!530 = !DILocation(line: 109, column: 5, scope: !16)
!531 = !DILocation(line: 111, column: 21, scope: !16)
!532 = !DILocation(line: 111, column: 3, scope: !16)
!533 = !DILocation(line: 114, column: 1, scope: !16)
!534 = !DILocation(line: 113, column: 3, scope: !16)
