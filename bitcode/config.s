...
# %bb.371:                              #   in Loop: Header=BB8_5 Depth=1
	...
	je	.LBB8_64
	jmp	.LBB8_513
.LBB8_372:                              #   in Loop: Header=BB8_5 Depth=1
	movl	$.L.str.163, %esi
	movq	%rbx, %rdi
	callq	strcasecmp
	cmpl	$2, -48(%rbp)           # 4-byte Folded Reload
...
# %bb.374:                              #   in Loop: Header=BB8_5 Depth=1
	...
	jmp	.LBB8_23
.LBB8_375:                              #   in Loop: Header=BB8_5 Depth=1
	movl	$.L.str.164, %esi
	movq	%rbx, %rdi
	callq	strcasecmp
	cmpl	$2, -48(%rbp)           # 4-byte Folded Reload
...
# %bb.377:                              #   in Loop: Header=BB8_5 Depth=1
	...
	jmp	.LBB8_23
.LBB8_378:                              #   in Loop: Header=BB8_5 Depth=1
	movl	$.L.str.165, %esi
	movq	%rbx, %rdi
	callq	strcasecmp
	cmpl	$2, -48(%rbp)           # 4-byte Folded Reload
...
# %bb.381:                              #   in Loop: Header=BB8_5 Depth=1
	...
	jmp	.LBB8_19
.LBB8_382:                              #   in Loop: Header=BB8_5 Depth=1
	movl	$.L.str.166, %esi
	movq	%rbx, %rdi
	callq	strcasecmp
	cmpl	$2, -48(%rbp)           # 4-byte Folded Reload
...
# %bb.384:                              #   in Loop: Header=BB8_5 Depth=1
	...
	jg	.LBB8_64
	jmp	.LBB8_511
.LBB8_385:                              #   in Loop: Header=BB8_5 Depth=1
	movl	$.L.str.168, %esi
	movq	%rbx, %rdi
	callq	strcasecmp
	cmpl	$2, -48(%rbp)           # 4-byte Folded Reload
...
# %bb.395:                              #   in Loop: Header=BB8_5 Depth=1
	...
	cmpl	$2, -48(%rbp)           # 4-byte Folded Reload
	jne	.LBB8_397
# %bb.396:                              #   in Loop: Header=BB8_5 Depth=1
	testl	%eax, %eax
	je	.LBB8_401
...
# %bb.398:                              #   in Loop: Header=BB8_5 Depth=1
	testl	%eax, %eax
	jne	.LBB8_404
# %bb.399:                              #   in Loop: Header=BB8_5 Depth=1
	movq	8(%r14), %rdi
	xorl	%esi, %esi
	movl	$10, %edx
	callq	strtoll
...
# %bb.406:                              #   in Loop: Header=BB8_5 Depth=1
	...
	testl	%eax, %eax
	je	.LBB8_414
# %bb.407:                              #   in Loop: Header=BB8_5 Depth=1
	movl	$.L.str.24, %esi
	movq	%rbx, %rdi
	callq	strcasecmp
	negl	%eax
	sbbl	%eax, %eax
	jmp	.LBB8_415
.LBB8_408:                              #   in Loop: Header=BB8_5 Depth=1
	movl	$.L.str.177, %esi
	movq	%rbx, %rdi
	callq	strcasecmp
	cmpl	$2, -48(%rbp)           # 4-byte Folded Reload
...
# %bb.409:                              #   in Loop: Header=BB8_5 Depth=1
	testl	%eax, %eax
	jne	.LBB8_411
# %bb.410:                              #   in Loop: Header=BB8_5 Depth=1
	movq	8(%r14), %rdi
	xorl	%esi, %esi
	movl	$10, %edx
	callq	strtoll
...
.LBB8_415:                              #   in Loop: Header=BB8_5 Depth=1
	...
	jmp	.LBB8_64
.LBB8_416:                              #   in Loop: Header=BB8_5 Depth=1
	movl	$.L.str.180, %esi
	movq	%rbx, %rdi
	callq	strcasecmp
	cmpl	$2, -48(%rbp)           # 4-byte Folded Reload
...
# %bb.422:                              #   in Loop: Header=BB8_5 Depth=1
	cmpl	$3, %ebx
	je	.LBB8_534
# %bb.423:                              #   in Loop: Header=BB8_5 Depth=1
	movq	16(%r14), %rdi
	xorl	%esi, %esi
	callq	memtoll
	movq	%rax, -48(%rbp)         # 8-byte Spill
...
# %bb.424:                              #   in Loop: Header=BB8_5 Depth=1
	...
	jmp	.LBB8_64
.LBB8_425:                              #   in Loop: Header=BB8_5 Depth=1
	movl	$.L.str.184, %esi
	movq	%rbx, %rdi
	callq	strcasecmp
	cmpl	$2, -48(%rbp)           # 4-byte Folded Reload
...
# %bb.428:                              #   in Loop: Header=BB8_5 Depth=1
	...
	jmp	.LBB8_19
.LBB8_429:                              #   in Loop: Header=BB8_5 Depth=1
	movl	$.L.str.185, %esi
	movq	%rbx, %rdi
	callq	strcasecmp
	testl	%eax, %eax
...
.LBB8_432:                              #   in Loop: Header=BB8_5 Depth=1
	...
	jmp	.LBB8_64
.LBB8_433:                              #   in Loop: Header=BB8_5 Depth=1
	cmpl	$2, -48(%rbp)           # 4-byte Folded Reload
	je	.LBB8_432
.LBB8_434:                              #   in Loop: Header=BB8_5 Depth=1
	movl	$.L.str.187, %esi
	movq	%rbx, %rdi
	callq	strcasecmp
	testl	%eax, %eax
...
# %bb.435:                              #   in Loop: Header=BB8_5 Depth=1
	...
	cmpl	$2, -48(%rbp)           # 4-byte Folded Reload
	jne	.LBB8_440
# %bb.436:                              #   in Loop: Header=BB8_5 Depth=1
	testl	%eax, %eax
	jne	.LBB8_440
...
.LBB8_440:                              #   in Loop: Header=BB8_5 Depth=1
	...
	testl	%eax, %eax
	je	.LBB8_444
# %bb.441:                              #   in Loop: Header=BB8_5 Depth=1
	movl	$.L.str.190, %esi
	movq	%rbx, %rdi
	callq	strcasecmp
	cmpl	$2, -48(%rbp)           # 4-byte Folded Reload
	jne	.LBB8_445
# %bb.442:                              #   in Loop: Header=BB8_5 Depth=1
	testl	%eax, %eax
	jne	.LBB8_445
.LBB8_443:                              #   in Loop: Header=BB8_5 Depth=1
	...
	jmp	.LBB8_23
.LBB8_444:                              #   in Loop: Header=BB8_5 Depth=1
	cmpl	$2, -48(%rbp)           # 4-byte Folded Reload
	je	.LBB8_443
.LBB8_445:                              #   in Loop: Header=BB8_5 Depth=1
	...
	testl	%eax, %eax
	je	.LBB8_449
# %bb.446:                              #   in Loop: Header=BB8_5 Depth=1
	movl	$.L.str.192, %esi
	movq	%rbx, %rdi
	callq	strcasecmp
	cmpl	$2, -48(%rbp)           # 4-byte Folded Reload
	jne	.LBB8_450
# %bb.447:                              #   in Loop: Header=BB8_5 Depth=1
	testl	%eax, %eax
	jne	.LBB8_450
.LBB8_448:                              #   in Loop: Header=BB8_5 Depth=1
	...
	jns	.LBB8_64
	jmp	.LBB8_507
.LBB8_449:                              #   in Loop: Header=BB8_5 Depth=1
	cmpl	$2, -48(%rbp)           # 4-byte Folded Reload
	je	.LBB8_448
.LBB8_450:                              #   in Loop: Header=BB8_5 Depth=1
	...
	testl	%eax, %eax
	je	.LBB8_457
# %bb.451:                              #   in Loop: Header=BB8_5 Depth=1
	movl	$.L.str.195, %esi
	movq	%rbx, %rdi
	callq	strcasecmp
	cmpl	$2, -48(%rbp)           # 4-byte Folded Reload
...
# %bb.455:                              #   in Loop: Header=BB8_5 Depth=1
	...
	cmpl	$-1, %eax
	je	.LBB8_502
# %bb.456:                              #   in Loop: Header=BB8_5 Depth=1
...
.LBB8_458:                              #   in Loop: Header=BB8_5 Depth=1
	...
	jns	.LBB8_64
	jmp	.LBB8_504
.LBB8_459:                              #   in Loop: Header=BB8_5 Depth=1
	movl	$.L.str.199, %esi
	movq	%rbx, %rdi
	callq	strcasecmp
	cmpl	$2, -48(%rbp)           # 4-byte Folded Reload
...
# %bb.460:                              #   in Loop: Header=BB8_5 Depth=1
	testl	%eax, %eax
	jne	.LBB8_465
# %bb.461:                              #   in Loop: Header=BB8_5 Depth=1
...
.LBB8_463:                              #   Parent Loop BB8_5 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	movq	-48(%rbp), %rsi         # 8-byte Reload
	callq	strcasecmp
	testl	%eax, %eax
...
# %bb.464:                              #   in Loop: Header=BB8_463 Depth=2
	...
	jne	.LBB8_463
	jmp	.LBB8_501
.LBB8_465:                              #   in Loop: Header=BB8_5 Depth=1
	movl	$.L.str.201, %esi
	movq	%rbx, %rdi
	callq	strcasecmp
	cmpl	$2, -48(%rbp)           # 4-byte Folded Reload
...
# %bb.467:                              #   in Loop: Header=BB8_5 Depth=1
	...
	jmp	.LBB8_64
.LBB8_468:                              #   in Loop: Header=BB8_5 Depth=1
	movl	$.L.str.202, %esi
	movq	%rbx, %rdi
	callq	strcasecmp
	testl	%eax, %eax
...
# %bb.469:                              #   in Loop: Header=BB8_5 Depth=1
	...
	je	.LBB8_64
# %bb.470:                              #   in Loop: Header=BB8_5 Depth=1
	cmpl	$0, server+164(%rip)
	je	.LBB8_505
# %bb.471:                              #   in Loop: Header=BB8_5 Depth=1
	movq	%r14, %rdi
	addq	$8, %rdi
	...
	je	.LBB8_64
	jmp	.LBB8_534
.LBB8_472:                              #   in Loop: Header=BB8_5 Depth=1
	movl	-8(%rbx), %eax
	movl	$42, __A_VARIABLE(%rip)
...
# %bb.156:                              #   in Loop: Header=BB10_155 Depth=1
	testb	$1, %bl
	jne	.LBB10_158
# %bb.157:                              #   in Loop: Header=BB10_155 Depth=1
	testq	%rax, %rax
	jle	.LBB10_160
.LBB10_158:                             #   in Loop: Header=BB10_155 Depth=1
	testb	$1, %bl
	je	.LBB10_154
# %bb.159:                              #   in Loop: Header=BB10_155 Depth=1
	testq	%rax, %rax
	jns	.LBB10_154
.LBB10_160:
	movl	-52(%rbp), %esi
...
# %bb.178:                              #   in Loop: Header=BB10_176 Depth=1
	...
	je	.LBB10_175
	jmp	.LBB10_181
.LBB10_179:                             #   in Loop: Header=BB10_176 Depth=1
	callq	getClientTypeByName
	cmpl	$3, %eax
	je	.LBB10_181
...
# %bb.450:                              # %.preheader7
	movq	8(%r15), %r14
	movl	$maxmemory_policy_enum+16, %ebx
.LBB10_451:                             # =>This Inner Loop Header: Depth=1
	movq	%r14, %rsi
	callq	strcasecmp
	testl	%eax, %eax
	je	.LBB10_460
...
# %bb.454:                              # %.preheader9
	movq	8(%r15), %r14
	movl	$aof_fsync_enum+16, %ebx
.LBB10_455:                             # =>This Inner Loop Header: Depth=1
	movq	%r14, %rsi
	callq	strcasecmp
	testl	%eax, %eax
	je	.LBB10_462
# %bb.456:                              #   in Loop: Header=BB10_455 Depth=1
	movq	(%rbx), %rdi
	addq	$16, %rbx
	testq	%rdi, %rdi
	jne	.LBB10_455
