...
# %bb.60:                               #   in Loop: Header=BB1_11 Depth=1
	movl	ip_data+36(%rip), %r9d
	cmpb	$6, %dl
	jne	.LBB1_67
# %bb.61:                               #   in Loop: Header=BB1_11 Depth=1
	cmpl	%r9d, %edi
	jne	.LBB1_72
# %bb.62:                               #   in Loop: Header=BB1_11 Depth=1
	movl	28(%rcx), %edx
...
.LBB1_72:                               #   in Loop: Header=BB1_11 Depth=1
	movq	%rbx, %r14
	jmp	.LBB1_10
.LBB1_67:                               #   in Loop: Header=BB1_11 Depth=1
	movq	%rbx, %r14
	cmpl	%r9d, %edi
	jne	.LBB1_10
.LBB1_84:
