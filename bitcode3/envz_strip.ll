...
define dso_local void @envz_strip(i8** nocapture, i64* nocapture) local_unnamed_addr #0 !dbg !10 {
  %3 = load i8*, i8** %0, align 8, !dbg !31, !tbaa !32
  %4 = load i64, i64* %1, align 8, !dbg !36, !tbaa !37
  %5 = tail call i8* @argz_next(i8* %3, i64 %4, i8* null) #3, !dbg !39
  %6 = icmp eq i8* %5, null, !dbg !40
  br i1 %6, label %47, label %7, !dbg !40
...
; <label>:12:                                     ; preds = %7
  %13 = load i64, i64* %1, align 8, !dbg !36, !tbaa !37
  br label %35, !dbg !44

; <label>:14:                                     ; preds = %7
  %15 = tail call i64 @strlen(i8* nonnull %8) #3, !dbg !45
  %16 = load i8*, i8** %0, align 8, !dbg !47, !tbaa !32
  %17 = load i64, i64* %1, align 8, !dbg !49, !tbaa !37
...
; <label>:25:                                     ; preds = %14
  ...
  %31 = load i64, i64* %1, align 8, !dbg !59, !tbaa !37
  br label %32, !dbg !60

; <label>:32:                                     ; preds = %14, %25
  %33 = phi i64 [ %17, %14 ], [ %31, %25 ], !dbg !59
  %34 = sub i64 %33, %21, !dbg !59
  store i64 %34, i64* %1, align 8, !dbg !59, !tbaa !37
  br label %35, !dbg !61

; <label>:35:                                     ; preds = %12, %32
  %36 = phi i64 [ %13, %12 ], [ %34, %32 ], !dbg !36
  %37 = phi i32 [ %9, %12 ], [ 1, %32 ], !dbg !62
  %38 = load i8*, i8** %0, align 8, !dbg !31, !tbaa !32
  %39 = tail call i8* @argz_next(i8* %38, i64 %36, i8* nonnull %8) #3, !dbg !39
  %40 = icmp eq i8* %39, null, !dbg !40
  br i1 %40, label %41, label %7, !dbg !40, !llvm.loop !63

; <label>:41:                                     ; preds = %35
  %42 = icmp eq i32 %37, 0, !dbg !65
  br i1 %42, label %47, label %43, !dbg !67

; <label>:43:                                     ; preds = %41
  %44 = load i8*, i8** %0, align 8, !dbg !68, !tbaa !32
  %45 = load i64, i64* %1, align 8, !dbg !70, !tbaa !37
  %46 = tail call i8* @realloc(i8* %44, i64 %45) #3, !dbg !71
  store i8* %46, i8** %0, align 8, !dbg !72, !tbaa !32
  br label %47, !dbg !73

; <label>:47:                                     ; preds = %2, %41, %43
  ret void, !dbg !74
}
...
!31 = !DILocation(line: 23, column: 28, scope: !10)
!32 = !{!33, !33, i64 0}
!33 = !{!"any pointer", !34, i64 0}
!34 = !{!"omnipotent char", !35, i64 0}
!35 = !{!"Simple C/C++ TBAA"}
!36 = !DILocation(line: 23, column: 35, scope: !10)
!37 = !{!38, !38, i64 0}
!38 = !{!"long", !34, i64 0}
!39 = !DILocation(line: 23, column: 18, scope: !10)
!40 = !DILocation(line: 23, column: 3, scope: !10)
...
!59 = !DILocation(line: 35, column: 21, scope: !46)
!60 = !DILocation(line: 34, column: 13, scope: !56)
...
!74 = !DILocation(line: 42, column: 1, scope: !10)
