...
define dso_local i32 @btowc(i32) local_unnamed_addr #0 !dbg !15 {
  ...
  br i1 %7, label %23, label %8, !dbg !49
...
; <label>:8:                                      ; preds = %1
  ...
  %15 = select i1 %14, %struct.__locale_t* @__global_locale, %struct.__locale_t* %13, !dbg !56
  %16 = getelementptr inbounds %struct.__locale_t, %struct.__locale_t* %15, i64 0, i32 2, !dbg !325
  %17 = load i32 (%struct._reent*, i32*, i8*, i64, %struct._mbstate_t*)*, i32 (%struct._reent*, i32*, i8*, i64, %struct._mbstate_t*)** %16, align 8, !dbg !325, !tbaa !326
  %18 = call %struct._reent* @__getreent() #5, !dbg !329
  %19 = call i32 %17(%struct._reent* %18, i32* nonnull %3, i8* nonnull %4, i64 1, %struct._mbstate_t* nonnull %2) #5, !dbg !325
  %20 = icmp ugt i32 %19, 1, !dbg !332
  %21 = load i32, i32* %3, align 4, !dbg !334
  %22 = select i1 %20, i32 -1, i32 %21, !dbg !332
  br label %23, !dbg !332

; <label>:23:                                     ; preds = %8, %1
  %24 = phi i32 [ -1, %1 ], [ %22, %8 ], !dbg !335
  call void @llvm.lifetime.end.p0i8(i64 1, i8* nonnull %4) #4, !dbg !336
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %6) #4, !dbg !336
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %5) #4, !dbg !336
  ret i32 %24, !dbg !336
}
...
!325 = !DILocation(line: 26, column: 12, scope: !15)
!326 = !{!327, !321, i64 232}
!327 = !{!"__locale_t", !53, i64 0, !321, i64 224, !321, i64 232, !320, i64 240, !321, i64 248, !328, i64 256, !53, i64 352, !53, i64 354, !53, i64 386}
!328 = !{!"lconv", !321, i64 0, !321, i64 8, !321, i64 16, !321, i64 24, !321, i64 32, !321, i64 40, !321, i64 48, !321, i64 56, !321, i64 64, !321, i64 72, !53, i64 80, !53, i64 81, !53, i64 82, !53, i64 83, !53, i64 84, !53, i64 85, !53, i64 86, !53, i64 87, !53, i64 88, !53, i64 89, !53, i64 90, !53, i64 91, !53, i64 92, !53, i64 93}
!329 = !DILocation(line: 26, column: 22, scope: !15)
!330 = !DILocation(line: 11, column: 13, scope: !15)
!331 = !DILocation(line: 13, column: 11, scope: !15)
!332 = !DILocation(line: 28, column: 19, scope: !333)
!333 = distinct !DILexicalBlock(scope: !15, file: !1, line: 28, column: 7)
!334 = !DILocation(line: 31, column: 18, scope: !15)
!335 = !DILocation(line: 0, scope: !15)
!336 = !DILocation(line: 32, column: 1, scope: !15)
