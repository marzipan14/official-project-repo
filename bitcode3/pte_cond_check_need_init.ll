...
define dso_local i32 @pte_cond_check_need_init(%struct.pthread_cond_t_**) local_unnamed_addr #0 !dbg !502 {
  ...
  %4 = bitcast %struct.pthread_cond_t_** %0 to i64*, !dbg !517
  %5 = load i64, i64* %4, align 8, !dbg !517, !tbaa !512
...
; <label>:6:                                      ; preds = %1
  %7 = tail call i32 @pthread_cond_init(%struct.pthread_cond_t_** nonnull %0, %struct.pthread_condattr_t_** null) #3, !dbg !520
  br label %9, !dbg !522
...
; <label>:9:                                      ; preds = %1, %8, %6
  %10 = phi i32 [ %7, %6 ], [ 22, %8 ], [ 0, %1 ], !dbg !526
  %11 = load %struct.uk_mutex*, %struct.uk_mutex** @pte_cond_test_init_lock, align 8, !dbg !527, !tbaa !512
  %12 = tail call i32 @pte_osMutexUnlock(%struct.uk_mutex* %11) #3, !dbg !528
  ret i32 %10, !dbg !529
}
...
!519 = !DILocation(line: 85, column: 7, scope: !502)
!520 = !DILocation(line: 87, column: 16, scope: !521)
!521 = distinct !DILexicalBlock(scope: !518, file: !1, line: 86, column: 5)
!522 = !DILocation(line: 88, column: 5, scope: !521)
!523 = !DILocation(line: 97, column: 5, scope: !524)
!524 = distinct !DILexicalBlock(scope: !525, file: !1, line: 90, column: 5)
!525 = distinct !DILexicalBlock(scope: !518, file: !1, line: 89, column: 12)
!526 = !DILocation(line: 0, scope: !502)
!527 = !DILocation(line: 100, column: 21, scope: !502)
!528 = !DILocation(line: 100, column: 3, scope: !502)
!529 = !DILocation(line: 102, column: 3, scope: !502)
