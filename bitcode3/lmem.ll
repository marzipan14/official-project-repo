...
; <label>:46:                                     ; preds = %45, %40
  ...
  store i32 %18, i32* %2, align 4, !dbg !428, !tbaa !359
  ret i8* %47, !dbg !429
}
...
define hidden i8* @luaM_realloc_(%struct.lua_State*, i8*, i64, i64) local_unnamed_addr #0 !dbg !379 {
  %5 = getelementptr inbounds %struct.lua_State, %struct.lua_State* %0, i64 0, i32 6, !dbg !434
  %6 = load %struct.global_State*, %struct.global_State** %5, align 8, !dbg !434, !tbaa !393
  %7 = getelementptr inbounds %struct.global_State, %struct.global_State* %6, i64 0, i32 1, !dbg !436
  %8 = load i8* (i8*, i8*, i64, i64)*, i8* (i8*, i8*, i64, i64)** %7, align 8, !dbg !436, !tbaa !401
  %9 = getelementptr inbounds %struct.global_State, %struct.global_State* %6, i64 0, i32 2, !dbg !437
  %10 = load i8*, i8** %9, align 8, !dbg !437, !tbaa !407
  %11 = tail call i8* %8(i8* %10, i8* %1, i64 %2, i64 %3) #3, !dbg !438
  %12 = icmp eq i8* %11, null, !dbg !439
  %13 = icmp ne i64 %3, 0, !dbg !440
  %14 = and i1 %13, %12, !dbg !441
  br i1 %14, label %15, label %16, !dbg !441

; <label>:15:                                     ; preds = %4
  tail call void @luaD_throw(%struct.lua_State* nonnull %0, i32 4) #3, !dbg !442
  br label %16, !dbg !442

; <label>:16:                                     ; preds = %15, %4
  %17 = getelementptr inbounds %struct.global_State, %struct.global_State* %6, i64 0, i32 14, !dbg !443
  %18 = load i64, i64* %17, align 8, !dbg !443, !tbaa !415
  %19 = sub i64 %3, %2, !dbg !444
  %20 = add i64 %19, %18, !dbg !445
  store i64 %20, i64* %17, align 8, !dbg !446, !tbaa !415
  ret i8* %11, !dbg !447
}

; Function Attrs: noredzone nounwind
define hidden noalias i8* @luaM_toobig(%struct.lua_State*) local_unnamed_addr #0 !dbg !420 {
  tail call void (%struct.lua_State*, i8*, ...) @luaG_runerror(%struct.lua_State* %0, i8* getelementptr inbounds ([39 x i8], [39 x i8]* @.str, i64 0, i64 0)) #3, !dbg !449
  ret i8* null, !dbg !450
}
...
!427 = !DILocation(line: 48, column: 9, scope: !12)
!428 = !DILocation(line: 61, column: 9, scope: !12)
!429 = !DILocation(line: 62, column: 3, scope: !12)
!430 = !DILocation(line: 76, column: 33, scope: !379)
!431 = !DILocation(line: 76, column: 42, scope: !379)
!432 = !DILocation(line: 76, column: 56, scope: !379)
!433 = !DILocation(line: 76, column: 70, scope: !379)
!434 = !DILocation(line: 77, column: 21, scope: !379)
!435 = !DILocation(line: 77, column: 17, scope: !379)
!436 = !DILocation(line: 79, column: 16, scope: !379)
!437 = !DILocation(line: 79, column: 29, scope: !379)
!438 = !DILocation(line: 79, column: 11, scope: !379)
!439 = !DILocation(line: 80, column: 13, scope: !410)
!440 = !DILocation(line: 80, column: 30, scope: !410)
!441 = !DILocation(line: 80, column: 21, scope: !410)
!442 = !DILocation(line: 81, column: 5, scope: !410)
!443 = !DILocation(line: 83, column: 23, scope: !379)
!444 = !DILocation(line: 83, column: 34, scope: !379)
!445 = !DILocation(line: 83, column: 43, scope: !379)
!446 = !DILocation(line: 83, column: 17, scope: !379)
!447 = !DILocation(line: 84, column: 3, scope: !379)
!448 = !DILocation(line: 66, column: 31, scope: !420)
!449 = !DILocation(line: 67, column: 3, scope: !420)
!450 = !DILocation(line: 68, column: 3, scope: !420)
