...
; <label>:121:                                    ; preds = %5, %114, %118
  %122 = phi i64 [ %3, %118 ], [ %117, %114 ], [ 0, %5 ]
  ret i64 %122
}
...
; Function Attrs: noredzone nounwind
define dso_local i64 @fread(i8* noalias, i64, i64, %struct.__sFILE* noalias) local_unnamed_addr #0 !dbg !396 {
  %5 = tail call %struct._reent* @__getreent() #4, !dbg !405
  %6 = tail call i64 @_fread_r(%struct._reent* %5, i8* %0, i64 %1, i64 %2, %struct.__sFILE* %3) #6, !dbg !406
  ret i64 %6, !dbg !407
}
...
!396 = distinct !DISubprogram(name: "fread", scope: !1, file: !1, line: 295, type: !397, isLocal: false, isDefinition: true, scopeLine: 300, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !399)
!397 = !DISubroutineType(types: !398)
!398 = !{!39, !253, !23, !23, !254}
!399 = !{!400, !401, !402, !403}
!400 = !DILocalVariable(name: "buf", arg: 1, scope: !396, file: !1, line: 295, type: !253)
!401 = !DILocalVariable(name: "size", arg: 2, scope: !396, file: !1, line: 295, type: !23)
!402 = !DILocalVariable(name: "count", arg: 3, scope: !396, file: !1, line: 295, type: !23)
!403 = !DILocalVariable(name: "fp", arg: 4, scope: !396, file: !1, line: 295, type: !254)
!404 = !DILocation(line: 295, column: 1, scope: !396)
!405 = !DILocation(line: 301, column: 21, scope: !396)
!406 = !DILocation(line: 301, column: 11, scope: !396)
!407 = !DILocation(line: 301, column: 4, scope: !396)
