; ModuleID = '/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/reent/closer.c'
source_filename = "/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/reent/closer.c"
...
define dso_local i32 @_close_r(%struct._reent* nocapture, i32) local_unnamed_addr #0 !dbg !7 {
  store i32 0, i32* @errno, align 4, !dbg !236, !tbaa !237
  %3 = tail call i32 @close(i32 %1) #3, !dbg !241
  %4 = icmp eq i32 %3, -1, !dbg !244
  %5 = load i32, i32* @errno, align 4, !dbg !245
  %6 = icmp ne i32 %5, 0, !dbg !246
  %7 = and i1 %4, %6, !dbg !247
  br i1 %7, label %8, label %10, !dbg !247

; <label>:8:                                      ; preds = %2
  %9 = getelementptr inbounds %struct._reent, %struct._reent* %0, i64 0, i32 0, !dbg !248
  store i32 %5, i32* %9, align 8, !dbg !249, !tbaa !250
  br label %10, !dbg !256
...
!1 = !DIFile(filename: "/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/reent/closer.c", directory: "/root/.unikraft/apps/redis/build")
!2 = !{}
!3 = !{i32 2, !"Dwarf Version", i32 4}
!4 = !{i32 2, !"Debug Info Version", i32 3}
!5 = !{i32 1, !"wchar_size", i32 4}
!6 = !{!"clang version 7.0.1-8+deb10u2 (tags/RELEASE_701/final)"}
!7 = distinct !DISubprogram(name: "_close_r", scope: !1, file: !1, line: 46, type: !8, isLocal: false, isDefinition: true, scopeLine: 49, isOptimized: true, unit: !0, retainedNodes: !230)
...
!232 = !DILocalVariable(name: "fd", arg: 2, scope: !7, file: !1, line: 48, type: !10)
!233 = !DILocalVariable(name: "ret", scope: !7, file: !1, line: 50, type: !10)
!234 = !DILocation(line: 47, column: 21, scope: !7)
!235 = !DILocation(line: 48, column: 10, scope: !7)
!236 = !DILocation(line: 52, column: 9, scope: !7)
!237 = !{!238, !238, i64 0}
!238 = !{!"int", !239, i64 0}
!239 = !{!"omnipotent char", !240, i64 0}
!240 = !{!"Simple C/C++ TBAA"}
!241 = !DILocation(line: 53, column: 14, scope: !242)
!242 = distinct !DILexicalBlock(scope: !7, file: !1, line: 53, column: 7)
!243 = !DILocation(line: 50, column: 7, scope: !7)
!244 = !DILocation(line: 53, column: 27, scope: !242)
!245 = !DILocation(line: 53, column: 36, scope: !242)
!246 = !DILocation(line: 53, column: 42, scope: !242)
!247 = !DILocation(line: 53, column: 33, scope: !242)
!248 = !DILocation(line: 54, column: 10, scope: !242)
!249 = !DILocation(line: 54, column: 17, scope: !242)
!250 = !{!251, !238, i64 0}
...
!256 = !DILocation(line: 54, column: 5, scope: !242)
!257 = !DILocation(line: 55, column: 3, scope: !7)
