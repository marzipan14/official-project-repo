...
.LBB17_20:                              #   in Loop: Header=BB17_1 Depth=1
	orl	$2048, %r13d            # imm = 0x800
	jmp	.LBB17_27
.LBB17_22:                              #   in Loop: Header=BB17_1 Depth=1
	orl	$8192, %r13d            # imm = 0x2000
	jmp	.LBB17_27
...
# %bb.0:
	jmp	compareStringObjects    # TAILCALL
.Lfunc_end37:
...
.LBB56_2:                               #   in Loop: Header=BB56_1 Depth=1
	cmpb	$33, %al
	jne	.LBB56_3
# %bb.37:                               #   in Loop: Header=BB56_1 Depth=1
	testq	%r15, %r15
	je	.LBB56_39
# %bb.38:                               #   in Loop: Header=BB56_1 Depth=1
	orb	$1, (%r15)
.LBB56_39:                              #   in Loop: Header=BB56_1 Depth=1
	addq	$1, %r12
	jmp	.LBB56_1
...
# %bb.24:                               #   in Loop: Header=BB56_1 Depth=1
	...
	movl	%ecx, (%r14)
	jmp	.LBB56_26
.LBB56_12:                              #   in Loop: Header=BB56_1 Depth=1
	movslq	(%r14), %rcx
	cmpq	$40, %rcx
	ja	.LBB56_14
...
# %bb.30:                               #   in Loop: Header=BB56_1 Depth=1
	...
	cmpl	$40, %ecx
	ja	.LBB56_29
# %bb.31:                               #   in Loop: Header=BB56_1 Depth=1
	movslq	%ecx, %rcx
	addq	16(%r14), %rcx
	addl	$16, %eax
	movl	%eax, (%r14)
	jmp	.LBB56_32
.LBB56_17:                              #   in Loop: Header=BB56_1 Depth=1
	movq	8(%r14), %rax
	leaq	8(%rax), %rcx
	movq	%rcx, 8(%r14)
	movq	(%rax), %rdi
...
.LBB56_28:                              #   in Loop: Header=BB56_1 Depth=1
	...
	movq	%rcx, 8(%r14)
	movq	(%rax), %rbx
.LBB56_29:                              #   in Loop: Header=BB56_1 Depth=1
	movq	8(%r14), %rcx
	leaq	8(%rcx), %rax
	movq	%rax, 8(%r14)
...
# %bb.34:                               #   in Loop: Header=BB56_1 Depth=1
	...
	xorl	%r13d, %r13d
	.p2align	4, 0x90
.LBB56_35:                              #   Parent Loop BB56_1 Depth=1
...
# %bb.3:
	...
	jmpq	*.LJTI65_0(,%rax,8)
.LBB65_4:
	jmp	stringObjectLen         # TAILCALL
.LBB65_9:
	xorl	%eax, %eax
	retq
.LBB65_5:
	jmp	listTypeLength          # TAILCALL
.LBB65_6:
	jmp	setTypeSize             # TAILCALL
.LBB65_7:
	jmp	zsetLength              # TAILCALL
.LBB65_8:
	jmp	hashTypeLength          # TAILCALL
.Lfunc_end65:
...
# %bb.0:
	movl	$1, %ecx
	jmp	zsetInitScoreRange      # TAILCALL
.Lfunc_end83:
...
# %bb.9:                                #   in Loop: Header=BB91_7 Depth=1
	...
	jmp	.LBB91_11
	.p2align	4, 0x90
.LBB91_13:                              #   in Loop: Header=BB91_7 Depth=1
	cmpl	$40, %eax
	ja	.LBB91_15
# %bb.14:                               #   in Loop: Header=BB91_7 Depth=1
	addq	-64(%rbp), %rcx
	addl	$8, %eax
	movl	%eax, -80(%rbp)
	jmp	.LBB91_16
...
.LBB91_15:                              #   in Loop: Header=BB91_7 Depth=1
	...
	leaq	8(%rcx), %rdx
	movq	%rdx, -72(%rbp)
.LBB91_16:                              #   in Loop: Header=BB91_7 Depth=1
	movq	(%rcx), %r13
	testq	%r13, %r13
	je	.LBB91_33
.LBB91_17:                              #   in Loop: Header=BB91_7 Depth=1
	cmpl	$40, %eax
	ja	.LBB91_19
# %bb.18:                               #   in Loop: Header=BB91_7 Depth=1
	movslq	%eax, %rcx
	addq	-64(%rbp), %rcx
	addl	$8, %eax
	movl	%eax, -80(%rbp)
	jmp	.LBB91_20
	.p2align	4, 0x90
.LBB91_19:                              #   in Loop: Header=BB91_7 Depth=1
	movq	-72(%rbp), %rcx
	leaq	8(%rcx), %rax
	movq	%rax, -72(%rbp)
.LBB91_20:                              #   in Loop: Header=BB91_7 Depth=1
	movq	(%rcx), %rbx
	testb	$3, %r12b
	je	.LBB91_26
# %bb.21:                               #   in Loop: Header=BB91_7 Depth=1
	movq	24(%r14), %rdi
	movq	8(%r13), %rsi
	callq	hashTypeExists
	testb	$2, %r12b
	je	.LBB91_23
# %bb.22:                               #   in Loop: Header=BB91_7 Depth=1
	testl	%eax, %eax
	jne	.LBB91_23
# %bb.28:                               #   in Loop: Header=BB91_7 Depth=1
	testl	%r15d, %r15d
	je	.LBB91_7
	jmp	.LBB91_29
	.p2align	4, 0x90
.LBB91_23:                              #   in Loop: Header=BB91_7 Depth=1
	testl	%eax, %eax
	setne	%al
	andb	%r12b, %al
	testl	%r15d, %r15d
	je	.LBB91_25
# %bb.24:                               #   in Loop: Header=BB91_7 Depth=1
	testb	%al, %al
	jne	.LBB91_29
.LBB91_25:                              #   in Loop: Header=BB91_7 Depth=1
	testb	%al, %al
	jne	.LBB91_7
.LBB91_26:                              #   in Loop: Header=BB91_7 Depth=1
	cmpq	$1, %rbx
	je	.LBB91_27
# %bb.30:                               #   in Loop: Header=BB91_7 Depth=1
	...
	testl	%r15d, %r15d
	je	.LBB91_32
# %bb.31:                               #   in Loop: Header=BB91_7 Depth=1
	movq	$0, 8(%r13)
	movq	%r13, %rdi
	callq	decrRefCount
.LBB91_32:                              #   in Loop: Header=BB91_7 Depth=1
	...
	jmp	.LBB91_7
.LBB91_27:                              #   in Loop: Header=BB91_7 Depth=1
	movq	24(%r14), %rdi
	movq	8(%r13), %rsi
...
.LBB94_6:
	...
	popq	%r15
	popq	%rbp
	jmp	moduleParseCallReply_Array # TAILCALL
.LBB94_7:
	leaq	1(%r12), %r14
	movq	%r14, %rdi
	movl	$13, %esi
...
.LBB111_8:                              # =>This Loop Header: Depth=1
	...
	callq	listRewind
	.p2align	4, 0x90
.LBB111_9:                              #   Parent Loop BB111_8 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	movq	%r12, %rdi
	callq	listNext
	testq	%rax, %rax
	je	.LBB111_10
# %bb.11:                               #   in Loop: Header=BB111_9 Depth=2
	movq	16(%rax), %rbx
	movq	(%rbx), %rax
	xorq	%r14, %rax
...
# %bb.6:                                #   in Loop: Header=BB131_3 Depth=2
	...
	cmpq	$-1, %rax
	je	.LBB131_7
# %bb.8:                                #   in Loop: Header=BB131_3 Depth=2
	addq	%rax, %r12
	jmp	.LBB131_3
.LBB131_7:
	movq	%r14, %rdi
...
# %bb.0:
	jmp	getRandomHexChars       # TAILCALL
.Lfunc_end198:
...
.LBB221_28:                             #   in Loop: Header=BB221_20 Depth=1
	movq	-17(%rbx), %rdx
	.p2align	4, 0x90
.LBB221_29:                             #   in Loop: Header=BB221_20 Depth=1
	movq	%r15, %rdi
	movq	%rbx, %rsi
	callq	addReplyBulkCBuffer
	movl	$.L.str.64, %esi
...
.LBB221_26:                             #   in Loop: Header=BB221_20 Depth=1
	movzwl	-5(%rbx), %edx
	jmp	.LBB221_29
.LBB221_27:                             #   in Loop: Header=BB221_20 Depth=1
	movl	-9(%rbx), %edx
	jmp	.LBB221_29
.LBB221_32:
