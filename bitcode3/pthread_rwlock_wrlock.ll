...
define dso_local i32 @pthread_rwlock_wrlock(%struct.pthread_rwlock_t_**) local_unnamed_addr #0 !dbg !514 {
  ...
  br i1 %3, label %63, label %4, !dbg !538

; <label>:4:                                      ; preds = %1
  %5 = bitcast %struct.pthread_rwlock_t_** %0 to i64*, !dbg !539
  %6 = load i64, i64* %5, align 8, !dbg !539, !tbaa !540
  %7 = inttoptr i64 %6 to %struct.pthread_rwlock_t_*, !dbg !544
...
; <label>:8:                                      ; preds = %4
  %9 = tail call i32 @pte_rwlock_check_need_init(%struct.pthread_rwlock_t_** nonnull %0) #4, !dbg !545
  %10 = or i32 %9, 16, !dbg !549
  %11 = icmp eq i32 %10, 16, !dbg !549
  br i1 %11, label %12, label %63, !dbg !549

; <label>:12:                                     ; preds = %8
  %13 = load %struct.pthread_rwlock_t_*, %struct.pthread_rwlock_t_** %0, align 8, !dbg !551, !tbaa !540
  br label %14, !dbg !549

; <label>:14:                                     ; preds = %12, %4
  %15 = phi %struct.pthread_rwlock_t_* [ %13, %12 ], [ %7, %4 ], !dbg !551
  %16 = getelementptr inbounds %struct.pthread_rwlock_t_, %struct.pthread_rwlock_t_* %15, i64 0, i32 6, !dbg !553
  %17 = load i32, i32* %16, align 4, !dbg !553, !tbaa !555
  %18 = icmp eq i32 %17, 262974946, !dbg !558
  br i1 %18, label %19, label %63, !dbg !559

; <label>:19:                                     ; preds = %14
  %20 = getelementptr inbounds %struct.pthread_rwlock_t_, %struct.pthread_rwlock_t_* %15, i64 0, i32 0, !dbg !560
  %21 = tail call i32 @pthread_mutex_lock(%struct.pthread_mutex_t_** %20) #4, !dbg !562
  %22 = icmp eq i32 %21, 0, !dbg !563
  br i1 %22, label %23, label %63, !dbg !564

; <label>:23:                                     ; preds = %19
  %24 = getelementptr inbounds %struct.pthread_rwlock_t_, %struct.pthread_rwlock_t_* %15, i64 0, i32 1, !dbg !565
  %25 = tail call i32 @pthread_mutex_lock(%struct.pthread_mutex_t_** nonnull %24) #4, !dbg !567
  %26 = icmp eq i32 %25, 0, !dbg !568
  br i1 %26, label %29, label %27, !dbg !569

; <label>:27:                                     ; preds = %23
  %28 = tail call i32 @pthread_mutex_unlock(%struct.pthread_mutex_t_** %20) #4, !dbg !570
  br label %63, !dbg !572

; <label>:29:                                     ; preds = %23
  %30 = getelementptr inbounds %struct.pthread_rwlock_t_, %struct.pthread_rwlock_t_* %15, i64 0, i32 4, !dbg !573
  %31 = load i32, i32* %30, align 4, !dbg !573, !tbaa !574
  %32 = icmp eq i32 %31, 0, !dbg !575
  br i1 %32, label %33, label %60, !dbg !576

; <label>:33:                                     ; preds = %29
  %34 = getelementptr inbounds %struct.pthread_rwlock_t_, %struct.pthread_rwlock_t_* %15, i64 0, i32 5, !dbg !577
  %35 = load i32, i32* %34, align 8, !dbg !577, !tbaa !579
  %36 = icmp sgt i32 %35, 0, !dbg !580
  %37 = getelementptr inbounds %struct.pthread_rwlock_t_, %struct.pthread_rwlock_t_* %15, i64 0, i32 3
  %38 = load i32, i32* %37, align 8, !dbg !581, !tbaa !582
  br i1 %36, label %39, label %41, !dbg !583

; <label>:39:                                     ; preds = %33
  %40 = sub nsw i32 %38, %35, !dbg !584
  store i32 %40, i32* %37, align 8, !dbg !584, !tbaa !582
  store i32 0, i32* %34, align 8, !dbg !586, !tbaa !579
  br label %41, !dbg !587

; <label>:41:                                     ; preds = %33, %39
  %42 = phi i32 [ %40, %39 ], [ %38, %33 ], !dbg !588
  %43 = icmp sgt i32 %42, 0, !dbg !589
  br i1 %43, label %44, label %60, !dbg !590

; <label>:44:                                     ; preds = %41
  %45 = sub nsw i32 0, %42, !dbg !591
  store i32 %45, i32* %34, align 8, !dbg !592, !tbaa !579
  %46 = bitcast %struct.pte_cleanup_t* %2 to i8*, !dbg !593
  call void @llvm.lifetime.start.p0i8(i64 24, i8* nonnull %46) #5, !dbg !593
  %47 = bitcast %struct.pthread_rwlock_t_* %15 to i8*, !dbg !593
  call void @pte_push_cleanup(%struct.pte_cleanup_t* nonnull %2, void (i8*)* nonnull @pte_rwlock_cancelwrwait, i8* %47) #4, !dbg !593
  %48 = getelementptr inbounds %struct.pthread_rwlock_t_, %struct.pthread_rwlock_t_* %15, i64 0, i32 2
  br label %49, !dbg !594

; <label>:49:                                     ; preds = %52, %44
  %50 = call i32 @pthread_cond_wait(%struct.pthread_cond_t_** nonnull %48, %struct.pthread_mutex_t_** nonnull %24) #4, !dbg !595
  %51 = icmp eq i32 %50, 0, !dbg !597
  br i1 %51, label %52, label %58, !dbg !598

; <label>:52:                                     ; preds = %49
  %53 = load i32, i32* %34, align 8, !dbg !599, !tbaa !579
  %54 = icmp slt i32 %53, 0, !dbg !600
  br i1 %54, label %49, label %55, !dbg !601, !llvm.loop !602

; <label>:55:                                     ; preds = %52
  %56 = call %struct.pte_cleanup_t* @pte_pop_cleanup(i32 0) #4, !dbg !604
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %46) #5, !dbg !605
  store i32 0, i32* %37, align 8, !dbg !606, !tbaa !582
  %57 = load i32, i32* %30, align 4, !dbg !609, !tbaa !574
  br label %60, !dbg !612

; <label>:58:                                     ; preds = %49
  %59 = call %struct.pte_cleanup_t* @pte_pop_cleanup(i32 1) #4, !dbg !604
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %46) #5, !dbg !605
  br label %63

; <label>:60:                                     ; preds = %55, %41, %29
  %61 = phi i32 [ %57, %55 ], [ 0, %41 ], [ %31, %29 ], !dbg !609
  %62 = add nsw i32 %61, 1, !dbg !609
  store i32 %62, i32* %30, align 4, !dbg !609, !tbaa !574
  br label %63, !dbg !613

; <label>:63:                                     ; preds = %58, %60, %19, %14, %8, %4, %1, %27
  %64 = phi i32 [ %25, %27 ], [ 22, %4 ], [ 22, %1 ], [ %9, %8 ], [ 22, %14 ], [ %21, %19 ], [ 0, %60 ], [ %50, %58 ], !dbg !614
  ret i32 %64, !dbg !615
}
...
!543 = !{!"Simple C/C++ TBAA"}
!544 = !DILocation(line: 55, column: 7, scope: !514)
!545 = !DILocation(line: 68, column: 16, scope: !546)
!546 = distinct !DILexicalBlock(scope: !547, file: !1, line: 67, column: 5)
!547 = distinct !DILexicalBlock(scope: !514, file: !1, line: 66, column: 7)
!548 = !DILocation(line: 52, column: 7, scope: !514)
!549 = !DILocation(line: 70, column: 23, scope: !550)
!550 = distinct !DILexicalBlock(scope: !546, file: !1, line: 70, column: 11)
!551 = !DILocation(line: 76, column: 9, scope: !514)
!552 = !DILocation(line: 53, column: 20, scope: !514)
!553 = !DILocation(line: 78, column: 12, scope: !554)
!554 = distinct !DILexicalBlock(scope: !514, file: !1, line: 78, column: 7)
!555 = !{!556, !557, i64 36}
!556 = !{!"pthread_rwlock_t_", !541, i64 0, !541, i64 8, !541, i64 16, !557, i64 24, !557, i64 28, !557, i64 32, !557, i64 36}
!557 = !{!"int", !542, i64 0}
!558 = !DILocation(line: 78, column: 19, scope: !554)
!559 = !DILocation(line: 78, column: 7, scope: !514)
!560 = !DILocation(line: 83, column: 44, scope: !561)
!561 = distinct !DILexicalBlock(scope: !514, file: !1, line: 83, column: 7)
!562 = !DILocation(line: 83, column: 17, scope: !561)
!563 = !DILocation(line: 83, column: 66, scope: !561)
!564 = !DILocation(line: 83, column: 7, scope: !514)
!565 = !DILocation(line: 88, column: 44, scope: !566)
!566 = distinct !DILexicalBlock(scope: !514, file: !1, line: 88, column: 7)
!567 = !DILocation(line: 88, column: 17, scope: !566)
!568 = !DILocation(line: 88, column: 72, scope: !566)
!569 = !DILocation(line: 88, column: 7, scope: !514)
!570 = !DILocation(line: 90, column: 14, scope: !571)
!571 = distinct !DILexicalBlock(scope: !566, file: !1, line: 89, column: 5)
!572 = !DILocation(line: 91, column: 7, scope: !571)
!573 = !DILocation(line: 94, column: 12, scope: !527)
!574 = !{!556, !557, i64 28}
!575 = !DILocation(line: 94, column: 34, scope: !527)
!576 = !DILocation(line: 94, column: 7, scope: !514)
!577 = !DILocation(line: 96, column: 16, scope: !578)
!578 = distinct !DILexicalBlock(scope: !526, file: !1, line: 96, column: 11)
!579 = !{!556, !557, i64 32}
!580 = !DILocation(line: 96, column: 44, scope: !578)
!581 = !DILocation(line: 0, scope: !525)
!582 = !{!556, !557, i64 24}
!583 = !DILocation(line: 96, column: 11, scope: !526)
!584 = !DILocation(line: 98, column: 35, scope: !585)
!585 = distinct !DILexicalBlock(scope: !578, file: !1, line: 97, column: 9)
!586 = !DILocation(line: 99, column: 44, scope: !585)
!587 = !DILocation(line: 100, column: 9, scope: !585)
!588 = !DILocation(line: 102, column: 16, scope: !525)
!589 = !DILocation(line: 102, column: 35, scope: !525)
!590 = !DILocation(line: 102, column: 11, scope: !526)
!591 = !DILocation(line: 104, column: 46, scope: !524)
!592 = !DILocation(line: 104, column: 44, scope: !524)
!593 = !DILocation(line: 110, column: 11, scope: !523)
!594 = !DILocation(line: 112, column: 11, scope: !523)
!595 = !DILocation(line: 114, column: 24, scope: !596)
!596 = distinct !DILexicalBlock(scope: !523, file: !1, line: 113, column: 13)
!597 = !DILocation(line: 117, column: 25, scope: !523)
!598 = !DILocation(line: 117, column: 30, scope: !523)
!599 = !DILocation(line: 117, column: 38, scope: !523)
!600 = !DILocation(line: 117, column: 66, scope: !523)
!601 = !DILocation(line: 116, column: 13, scope: !596)
!602 = distinct !{!602, !594, !603}
!603 = !DILocation(line: 117, column: 69, scope: !523)
!604 = !DILocation(line: 119, column: 11, scope: !523)
!605 = !DILocation(line: 119, column: 11, scope: !524)
!606 = !DILocation(line: 123, column: 39, scope: !607)
!607 = distinct !DILexicalBlock(scope: !608, file: !1, line: 122, column: 13)
!608 = distinct !DILexicalBlock(scope: !524, file: !1, line: 121, column: 15)
!609 = !DILocation(line: 130, column: 33, scope: !610)
!610 = distinct !DILexicalBlock(scope: !611, file: !1, line: 129, column: 5)
!611 = distinct !DILexicalBlock(scope: !514, file: !1, line: 128, column: 7)
!612 = !DILocation(line: 124, column: 13, scope: !607)
!613 = !DILocation(line: 131, column: 5, scope: !610)
!614 = !DILocation(line: 0, scope: !514)
!615 = !DILocation(line: 134, column: 1, scope: !514)
