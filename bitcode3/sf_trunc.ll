...
define dso_local float @truncf(float) local_unnamed_addr #0 !dbg !7 {
  ...
  br i1 %7, label %8, label %14, !dbg !47

; <label>:8:                                      ; preds = %1
  %9 = icmp ult i32 %5, 127, !dbg !48
  br i1 %9, label %15, label %10, !dbg !49

; <label>:10:                                     ; preds = %8
  %11 = ashr i32 -8388608, %6, !dbg !50
  %12 = and i32 %11, %2, !dbg !50
  %13 = or i32 %12, %3, !dbg !50
  br label %15
...
; <label>:15:                                     ; preds = %8, %10
  %16 = phi i32 [ %13, %10 ], [ %3, %8 ]
  %17 = bitcast i32 %16 to float, !dbg !53
  ret float %17, !dbg !55
}
...
!50 = !DILocation(line: 40, column: 11, scope: !36)
!51 = !DILocation(line: 45, column: 11, scope: !52)
!52 = distinct !DILexicalBlock(scope: !34, file: !1, line: 44, column: 5)
!53 = !DILocation(line: 0, scope: !54)
!54 = distinct !DILexicalBlock(scope: !52, file: !1, line: 45, column: 11)
!55 = !DILocation(line: 52, column: 1, scope: !7)
