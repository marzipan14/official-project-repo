...
define dso_local i32 @pthread_rwlock_destroy(%struct.pthread_rwlock_t_**) local_unnamed_addr #0 !dbg !513 {
  ...
  br i1 %2, label %71, label %3, !dbg !529

; <label>:3:                                      ; preds = %1
  %4 = load %struct.pthread_rwlock_t_*, %struct.pthread_rwlock_t_** %0, align 8, !dbg !530, !tbaa !531
  %5 = ptrtoint %struct.pthread_rwlock_t_* %4 to i64, !dbg !535
...
; <label>:6:                                      ; preds = %3
  %7 = getelementptr inbounds %struct.pthread_rwlock_t_, %struct.pthread_rwlock_t_* %4, i64 0, i32 6, !dbg !537
  %8 = load i32, i32* %7, align 4, !dbg !537, !tbaa !541
  %9 = icmp eq i32 %8, 262974946, !dbg !544
  br i1 %9, label %10, label %71, !dbg !545

; <label>:10:                                     ; preds = %6
  %11 = getelementptr inbounds %struct.pthread_rwlock_t_, %struct.pthread_rwlock_t_* %4, i64 0, i32 0, !dbg !546
  %12 = tail call i32 @pthread_mutex_lock(%struct.pthread_mutex_t_** nonnull %11) #3, !dbg !548
  %13 = icmp eq i32 %12, 0, !dbg !549
  br i1 %13, label %14, label %71, !dbg !550

; <label>:14:                                     ; preds = %10
  %15 = getelementptr inbounds %struct.pthread_rwlock_t_, %struct.pthread_rwlock_t_* %4, i64 0, i32 1, !dbg !551
  %16 = tail call i32 @pthread_mutex_lock(%struct.pthread_mutex_t_** nonnull %15) #3, !dbg !553
  %17 = icmp eq i32 %16, 0, !dbg !554
  br i1 %17, label %20, label %18, !dbg !555

; <label>:18:                                     ; preds = %14
  %19 = tail call i32 @pthread_mutex_unlock(%struct.pthread_mutex_t_** nonnull %11) #3, !dbg !556
  br label %71, !dbg !558

; <label>:20:                                     ; preds = %14
  %21 = getelementptr inbounds %struct.pthread_rwlock_t_, %struct.pthread_rwlock_t_* %4, i64 0, i32 4, !dbg !559
  %22 = load i32, i32* %21, align 4, !dbg !559, !tbaa !561
  %23 = icmp sgt i32 %22, 0, !dbg !562
  br i1 %23, label %30, label %24, !dbg !563

; <label>:24:                                     ; preds = %20
  %25 = getelementptr inbounds %struct.pthread_rwlock_t_, %struct.pthread_rwlock_t_* %4, i64 0, i32 3, !dbg !564
  %26 = load i32, i32* %25, align 8, !dbg !564, !tbaa !565
  %27 = getelementptr inbounds %struct.pthread_rwlock_t_, %struct.pthread_rwlock_t_* %4, i64 0, i32 5, !dbg !566
  %28 = load i32, i32* %27, align 8, !dbg !566, !tbaa !567
  %29 = icmp sgt i32 %26, %28, !dbg !568
  br i1 %29, label %30, label %33, !dbg !569

; <label>:30:                                     ; preds = %24, %20
  %31 = tail call i32 @pthread_mutex_unlock(%struct.pthread_mutex_t_** nonnull %15) #3, !dbg !570
  %32 = tail call i32 @pthread_mutex_unlock(%struct.pthread_mutex_t_** nonnull %11) #3, !dbg !572
  br label %56, !dbg !573

; <label>:33:                                     ; preds = %24
  store i32 0, i32* %7, align 4, !dbg !574, !tbaa !541
  %34 = tail call i32 @pthread_mutex_unlock(%struct.pthread_mutex_t_** nonnull %15) #3, !dbg !576
  %35 = icmp eq i32 %34, 0, !dbg !578
  %36 = tail call i32 @pthread_mutex_unlock(%struct.pthread_mutex_t_** nonnull %11) #3, !dbg !579
  br i1 %35, label %37, label %71, !dbg !581

; <label>:37:                                     ; preds = %33
  %38 = icmp eq i32 %36, 0, !dbg !582
  br i1 %38, label %39, label %71, !dbg !583

; <label>:39:                                     ; preds = %37
  store %struct.pthread_rwlock_t_* null, %struct.pthread_rwlock_t_** %0, align 8, !dbg !584, !tbaa !531
  %40 = getelementptr inbounds %struct.pthread_rwlock_t_, %struct.pthread_rwlock_t_* %4, i64 0, i32 2, !dbg !585
  %41 = tail call i32 @pthread_cond_destroy(%struct.pthread_cond_t_** nonnull %40) #3, !dbg !586
  %42 = tail call i32 @pthread_mutex_destroy(%struct.pthread_mutex_t_** nonnull %15) #3, !dbg !587
  %43 = tail call i32 @pthread_mutex_destroy(%struct.pthread_mutex_t_** nonnull %11) #3, !dbg !588
  %44 = bitcast %struct.pthread_rwlock_t_* %4 to i8*, !dbg !589
  tail call void @free(i8* %44) #3, !dbg !590
  br label %56

; <label>:45:                                     ; preds = %3
  %46 = load %struct.uk_mutex*, %struct.uk_mutex** @pte_rwlock_test_init_lock, align 8, !dbg !591, !tbaa !531
  %47 = tail call i32 @pte_osMutexLock(%struct.uk_mutex* %46) #3, !dbg !593
  %48 = load %struct.pthread_rwlock_t_*, %struct.pthread_rwlock_t_** %0, align 8, !dbg !594, !tbaa !531
  %49 = icmp eq %struct.pthread_rwlock_t_* %48, inttoptr (i64 -1 to %struct.pthread_rwlock_t_*), !dbg !596
  br i1 %49, label %50, label %51, !dbg !597

; <label>:50:                                     ; preds = %45
  store %struct.pthread_rwlock_t_* null, %struct.pthread_rwlock_t_** %0, align 8, !dbg !598, !tbaa !531
  br label %51, !dbg !600

; <label>:51:                                     ; preds = %50, %45
  %52 = phi i32 [ 0, %50 ], [ 16, %45 ], !dbg !601
  %53 = load %struct.uk_mutex*, %struct.uk_mutex** @pte_rwlock_test_init_lock, align 8, !dbg !603, !tbaa !531
  %54 = tail call i32 @pte_osMutexUnlock(%struct.uk_mutex* %53) #3, !dbg !604
  %55 = icmp eq i32 %52, 0, !dbg !605
  br label %62, !dbg !606

; <label>:56:                                     ; preds = %30, %39
  %57 = phi i32 [ %31, %30 ], [ %41, %39 ], !dbg !607
  %58 = phi i32 [ %32, %30 ], [ %42, %39 ], !dbg !607
  %59 = phi i32 [ 16, %30 ], [ %43, %39 ], !dbg !607
  %60 = icmp eq i32 %57, 0, !dbg !605
  %61 = icmp eq i32 %58, 0, !dbg !608
  br i1 %61, label %62, label %66, !dbg !606

; <label>:62:                                     ; preds = %51, %56
  %63 = phi i1 [ %55, %51 ], [ %60, %56 ]
  %64 = phi i32 [ 0, %51 ], [ %59, %56 ]
  %65 = phi i32 [ %52, %51 ], [ %57, %56 ]
  br label %66, !dbg !606

; <label>:66:                                     ; preds = %56, %62
  %67 = phi i1 [ %63, %62 ], [ %60, %56 ]
  %68 = phi i32 [ %65, %62 ], [ %57, %56 ]
  %69 = phi i32 [ %64, %62 ], [ %58, %56 ]
  %70 = select i1 %67, i32 %69, i32 %68, !dbg !609
  br label %71, !dbg !609

; <label>:71:                                     ; preds = %66, %37, %33, %10, %6, %3, %1, %18
  %72 = phi i32 [ %16, %18 ], [ 22, %3 ], [ 22, %1 ], [ 22, %6 ], [ %12, %10 ], [ %34, %33 ], [ %36, %37 ], [ %70, %66 ], !dbg !610
  ret i32 %72, !dbg !612
}
...
!534 = !{!"Simple C/C++ TBAA"}
!535 = !DILocation(line: 56, column: 7, scope: !513)
!536 = !DILocation(line: 53, column: 20, scope: !513)
!537 = !DILocation(line: 65, column: 16, scope: !538)
!538 = distinct !DILexicalBlock(scope: !539, file: !1, line: 65, column: 11)
!539 = distinct !DILexicalBlock(scope: !540, file: !1, line: 62, column: 5)
!540 = distinct !DILexicalBlock(scope: !513, file: !1, line: 61, column: 7)
!541 = !{!542, !543, i64 36}
!542 = !{!"pthread_rwlock_t_", !532, i64 0, !532, i64 8, !532, i64 16, !543, i64 24, !543, i64 28, !543, i64 32, !543, i64 36}
!543 = !{!"int", !533, i64 0}
!544 = !DILocation(line: 65, column: 23, scope: !538)
!545 = !DILocation(line: 65, column: 11, scope: !539)
!546 = !DILocation(line: 70, column: 48, scope: !547)
!547 = distinct !DILexicalBlock(scope: !539, file: !1, line: 70, column: 11)
!548 = !DILocation(line: 70, column: 21, scope: !547)
!549 = !DILocation(line: 70, column: 70, scope: !547)
!550 = !DILocation(line: 70, column: 11, scope: !539)
!551 = !DILocation(line: 76, column: 41, scope: !552)
!552 = distinct !DILexicalBlock(scope: !539, file: !1, line: 75, column: 11)
!553 = !DILocation(line: 76, column: 14, scope: !552)
!554 = !DILocation(line: 76, column: 69, scope: !552)
!555 = !DILocation(line: 75, column: 11, scope: !539)
!556 = !DILocation(line: 78, column: 18, scope: !557)
!557 = distinct !DILexicalBlock(scope: !552, file: !1, line: 77, column: 9)
!558 = !DILocation(line: 79, column: 11, scope: !557)
!559 = !DILocation(line: 86, column: 16, scope: !560)
!560 = distinct !DILexicalBlock(scope: !539, file: !1, line: 86, column: 11)
!561 = !{!542, !543, i64 28}
!562 = !DILocation(line: 86, column: 38, scope: !560)
!563 = !DILocation(line: 87, column: 11, scope: !560)
!564 = !DILocation(line: 87, column: 19, scope: !560)
!565 = !{!542, !543, i64 24}
!566 = !DILocation(line: 87, column: 45, scope: !560)
!567 = !{!542, !543, i64 32}
!568 = !DILocation(line: 87, column: 38, scope: !560)
!569 = !DILocation(line: 86, column: 11, scope: !539)
!570 = !DILocation(line: 89, column: 20, scope: !571)
!571 = distinct !DILexicalBlock(scope: !560, file: !1, line: 88, column: 9)
!572 = !DILocation(line: 90, column: 21, scope: !571)
!573 = !DILocation(line: 92, column: 9, scope: !571)
!574 = !DILocation(line: 95, column: 23, scope: !575)
!575 = distinct !DILexicalBlock(scope: !560, file: !1, line: 94, column: 9)
!576 = !DILocation(line: 98, column: 18, scope: !577)
!577 = distinct !DILexicalBlock(scope: !575, file: !1, line: 97, column: 15)
!578 = !DILocation(line: 98, column: 75, scope: !577)
!579 = !DILocation(line: 0, scope: !580)
!580 = distinct !DILexicalBlock(scope: !575, file: !1, line: 104, column: 15)
!581 = !DILocation(line: 97, column: 15, scope: !575)
!582 = !DILocation(line: 105, column: 69, scope: !580)
!583 = !DILocation(line: 104, column: 15, scope: !575)
!584 = !DILocation(line: 110, column: 19, scope: !575)
!585 = !DILocation(line: 111, column: 49, scope: !575)
!586 = !DILocation(line: 111, column: 20, scope: !575)
!587 = !DILocation(line: 112, column: 21, scope: !575)
!588 = !DILocation(line: 113, column: 21, scope: !575)
!589 = !DILocation(line: 114, column: 24, scope: !575)
!590 = !DILocation(line: 114, column: 18, scope: !575)
!591 = !DILocation(line: 123, column: 24, scope: !592)
!592 = distinct !DILexicalBlock(scope: !540, file: !1, line: 118, column: 5)
!593 = !DILocation(line: 123, column: 7, scope: !592)
!594 = !DILocation(line: 128, column: 11, scope: !595)
!595 = distinct !DILexicalBlock(scope: !592, file: !1, line: 128, column: 11)
!596 = !DILocation(line: 128, column: 19, scope: !595)
!597 = !DILocation(line: 128, column: 11, scope: !592)
!598 = !DILocation(line: 136, column: 19, scope: !599)
!599 = distinct !DILexicalBlock(scope: !595, file: !1, line: 129, column: 9)
!600 = !DILocation(line: 137, column: 9, scope: !599)
!601 = !DILocation(line: 0, scope: !602)
!602 = distinct !DILexicalBlock(scope: !595, file: !1, line: 139, column: 9)
!603 = !DILocation(line: 147, column: 25, scope: !592)
!604 = !DILocation(line: 147, column: 7, scope: !592)
!605 = !DILocation(line: 151, column: 19, scope: !513)
!606 = !DILocation(line: 151, column: 37, scope: !513)
!607 = !DILocation(line: 0, scope: !513)
!608 = !DILocation(line: 151, column: 46, scope: !513)
!609 = !DILocation(line: 151, column: 11, scope: !513)
!610 = !DILocation(line: 0, scope: !611)
!611 = distinct !DILexicalBlock(scope: !580, file: !1, line: 106, column: 13)
!612 = !DILocation(line: 152, column: 1, scope: !513)
