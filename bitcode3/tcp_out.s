...
.LBB5_4:
	...
	popq	%r15
	popq	%rbp
	jmp	tcp_enqueue_flags       # TAILCALL
.LBB5_6:
	movq	24(%rbx), %rax
	movzwl	12(%rax), %r15d
	movl	$1, %edi
...
.LBB7_35:
	...
	jmp	.LBB7_36
	.p2align	4, 0x90
.LBB7_87:                               #   in Loop: Header=BB7_36 Depth=1
	movq	%r14, %rdi
	callq	tcp_seg_free
...
# %bb.51:                               #   in Loop: Header=BB7_36 Depth=1
	movb	273(%r15), %cl
	shrl	%cl, %eax
.LBB7_52:                               #   in Loop: Header=BB7_36 Depth=1
...
# %bb.53:                               #   in Loop: Header=BB7_36 Depth=1
	...
	jmp	.LBB7_57
	.p2align	4, 0x90
.LBB7_54:                               #   in Loop: Header=BB7_36 Depth=1
...
# %bb.59:                               #   in Loop: Header=BB7_36 Depth=1
	cmpl	$0, 112(%r15)
	je	.LBB7_60
.LBB7_61:                               #   in Loop: Header=BB7_36 Depth=1
	movq	8(%r14), %rdi
	movq	24(%r14), %rdx
	movl	8(%rdi), %ecx
	movl	%edx, %esi
	...
	cmpq	%rbx, %rax
	jne	.LBB7_62
# %bb.63:                               #   in Loop: Header=BB7_36 Depth=1
	movq	-64(%rbp), %rdx         # 8-byte Reload
	testb	$4, 248(%rdx)
	je	.LBB7_65
# %bb.64:                               #   in Loop: Header=BB7_36 Depth=1
	movzwl	%cx, %edx
	movl	$6, %esi
	movq	%r15, %rcx
	movq	%r13, %r8
...
.LBB7_65:                               #   in Loop: Header=BB7_36 Depth=1
	...
	movzbl	50(%r15), %r8d
	jne	.LBB7_67
# %bb.66:                               #   in Loop: Header=BB7_36 Depth=1
	movq	%rdx, (%rsp)
	movq	%r15, %rsi
	movq	%r13, %rdx
	movl	$6, %r9d
	...
	jmp	.LBB7_68
	.p2align	4, 0x90
.LBB7_67:                               #   in Loop: Header=BB7_36 Depth=1
	movq	%rdx, (%rsp)
	movq	%r15, %rsi
	movq	%r13, %rdx
	movl	$6, %r9d
...
.LBB7_68:                               #   in Loop: Header=BB7_36 Depth=1
	...
	testb	%al, %al
	jne	.LBB7_69
.LBB7_70:                               #   in Loop: Header=BB7_36 Depth=1
	movq	(%r14), %rax
	movq	%rax, 184(%r15)
	cmpl	$2, 72(%r15)
	je	.LBB7_72
# %bb.71:                               #   in Loop: Header=BB7_36 Depth=1
	andb	$-4, 82(%r15)
.LBB7_72:                               #   in Loop: Header=BB7_36 Depth=1
	movq	24(%r14), %rax
	movl	4(%rax), %edi
	callq	lwip_htonl
	movl	%eax, %r13d
	...
	cmpl	%ebx, 144(%r15)
	jns	.LBB7_74
# %bb.73:                               #   in Loop: Header=BB7_36 Depth=1
	movl	%ebx, 144(%r15)
...
# %bb.75:                               #   in Loop: Header=BB7_36 Depth=1
	...
	cmpq	$0, (%r13)
	je	.LBB7_76
# %bb.77:                               #   in Loop: Header=BB7_36 Depth=1
	movq	24(%r14), %rax
	movl	4(%rax), %edi
	callq	lwip_htonl
	movl	%eax, %ebx
...
# %bb.46:                               #   in Loop: Header=BB7_36 Depth=1
	...
	jae	.LBB7_47
	jmp	.LBB7_89
.LBB7_58:                               #   in Loop: Header=BB7_36 Depth=1
	movw	$0, 108(%r15)
	cmpl	$0, 112(%r15)
	jne	.LBB7_61
...
.LBB7_76:                               #   in Loop: Header=BB7_36 Depth=1
	...
	movq	%r14, %r12
	jmp	.LBB7_88
.LBB7_78:                               #   in Loop: Header=BB7_36 Depth=1
	movq	(%r13), %rcx
	testq	%rcx, %rcx
	je	.LBB7_79
# %bb.80:                               # %.preheader
	...
	movq	%r13, %rbx
	.p2align	4, 0x90
.LBB7_81:                               #   Parent Loop BB7_36 Depth=1
...
# %bb.83:                               #   in Loop: Header=BB7_36 Depth=1
	movq	%rax, %rbx
	xorl	%eax, %eax
.LBB7_84:                               #   in Loop: Header=BB7_36 Depth=1
	movq	-56(%rbp), %r13         # 8-byte Reload
	jmp	.LBB7_85
...
# %bb.7:
	...
	popq	%r15
	popq	%rbp
	jmp	tcp_output_control_segment # TAILCALL
.LBB14_6:
	addq	$24, %rsp
	popq	%rbx
	popq	%r12
