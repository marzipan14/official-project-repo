; ModuleID = '/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/stdio/clearerr.c'
source_filename = "/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/stdio/clearerr.c"
...
define dso_local void @clearerr(%struct.__sFILE* nocapture) local_unnamed_addr #0 !dbg !25 {
  %2 = alloca i32, align 4
  %3 = tail call %struct._reent* @__getreent() #4, !dbg !257
  %4 = icmp eq %struct._reent* %3, null, !dbg !258
  br i1 %4, label %10, label %5, !dbg !258

; <label>:5:                                      ; preds = %1
  %6 = getelementptr inbounds %struct._reent, %struct._reent* %3, i64 0, i32 8, !dbg !258
  %7 = load i32, i32* %6, align 8, !dbg !258, !tbaa !260
  %8 = icmp eq i32 %7, 0, !dbg !258
  br i1 %8, label %9, label %10, !dbg !257

; <label>:9:                                      ; preds = %5
  tail call void @__sinit(%struct._reent* nonnull %3) #4, !dbg !258
  br label %10, !dbg !258

; <label>:10:                                     ; preds = %5, %1, %9
  %11 = bitcast i32* %2 to i8*, !dbg !269
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %11) #5, !dbg !269
  %12 = call i32 @pthread_setcancelstate(i32 1, i32* nonnull %2) #4, !dbg !269
  %13 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %0, i64 0, i32 3, !dbg !270
  %14 = load i16, i16* %13, align 8, !dbg !270, !tbaa !271
  %15 = and i16 %14, -97, !dbg !270
  store i16 %15, i16* %13, align 8, !dbg !270, !tbaa !271
  %16 = load i32, i32* %2, align 4, !dbg !277, !tbaa !278
  %17 = call i32 @pthread_setcancelstate(i32 %16, i32* nonnull %2) #4, !dbg !277
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %11) #5, !dbg !279
  ret void, !dbg !280
}
...
!1 = !DIFile(filename: "/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/stdio/clearerr.c", directory: "/root/.unikraft/apps/redis/build")
!2 = !{!3}
...
!25 = distinct !DISubprogram(name: "clearerr", scope: !1, file: !1, line: 85, type: !26, isLocal: false, isDefinition: true, scopeLine: 87, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !250)
...
!250 = !{!251, !252, !254}
!251 = !DILocalVariable(name: "fp", arg: 1, scope: !25, file: !1, line: 85, type: !28)
!252 = !DILocalVariable(name: "_check_init_ptr", scope: !253, file: !1, line: 88, type: !58)
!253 = distinct !DILexicalBlock(scope: !25, file: !1, line: 88, column: 3)
!254 = !DILocalVariable(name: "__oldfpcancel", scope: !255, file: !1, line: 89, type: !5)
!255 = distinct !DILexicalBlock(scope: !25, file: !1, line: 89, column: 3)
!256 = !DILocation(line: 85, column: 1, scope: !25)
!257 = !DILocation(line: 88, column: 3, scope: !253)
!258 = !DILocation(line: 88, column: 3, scope: !259)
!259 = distinct !DILexicalBlock(scope: !253, file: !1, line: 88, column: 3)
!260 = !{!261, !262, i64 80}
...
!269 = !DILocation(line: 89, column: 3, scope: !255)
!270 = !DILocation(line: 90, column: 3, scope: !255)
!271 = !{!272, !273, i64 16}
!272 = !{!"__sFILE", !265, i64 0, !262, i64 8, !262, i64 12, !273, i64 16, !273, i64 18, !274, i64 24, !262, i64 40, !265, i64 48, !265, i64 56, !265, i64 64, !265, i64 72, !265, i64 80, !274, i64 88, !265, i64 104, !262, i64 112, !263, i64 116, !263, i64 119, !274, i64 120, !262, i64 136, !275, i64 144, !265, i64 152, !262, i64 160, !276, i64 164, !262, i64 172}
!273 = !{!"short", !263, i64 0}
!274 = !{!"__sbuf", !265, i64 0, !262, i64 8}
!275 = !{!"long", !263, i64 0}
!276 = !{!"", !262, i64 0, !263, i64 4}
!277 = !DILocation(line: 91, column: 3, scope: !255)
!278 = !{!262, !262, i64 0}
!279 = !DILocation(line: 91, column: 3, scope: !25)
!280 = !DILocation(line: 92, column: 1, scope: !25)
