...
; <label>:29:                                     ; preds = %9, %26, %27
  ...
  call void @llvm.lifetime.end.p0i8(i64 176, i8* nonnull %7) #5, !dbg !328, !noalias !265
  ret i32 %30, !dbg !329
}
...
define dso_local i32 @_vsnprintf_r(%struct._reent*, i8* noalias, i64, i8* noalias, %struct.__va_list_tag*) local_unnamed_addr #0 !dbg !40 {
  ...
  %7 = bitcast %struct.__sFILE* %6 to i8*, !dbg !331
  call void @llvm.lifetime.start.p0i8(i64 176, i8* nonnull %7) #5, !dbg !331
  %8 = icmp ugt i64 %2, 2147483647, !dbg !332
  br i1 %8, label %9, label %11, !dbg !333

; <label>:9:                                      ; preds = %5
  %10 = getelementptr inbounds %struct._reent, %struct._reent* %0, i64 0, i32 0, !dbg !334
  store i32 139, i32* %10, align 8, !dbg !335, !tbaa !275
  br label %29, !dbg !336

; <label>:11:                                     ; preds = %5
  %12 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %6, i64 0, i32 3, !dbg !337
  store i16 520, i16* %12, align 8, !dbg !338, !tbaa !287
  %13 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %6, i64 0, i32 0, !dbg !339
  store i8* %1, i8** %13, align 8, !dbg !340, !tbaa !295
  %14 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %6, i64 0, i32 5, i32 0, !dbg !341
  store i8* %1, i8** %14, align 8, !dbg !342, !tbaa !298
  %15 = icmp ne i64 %2, 0, !dbg !343
  %16 = add i64 %2, 4294967295, !dbg !344
  %17 = select i1 %15, i64 %16, i64 0, !dbg !345
  %18 = trunc i64 %17 to i32, !dbg !346
  %19 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %6, i64 0, i32 2, !dbg !347
  store i32 %18, i32* %19, align 4, !dbg !348, !tbaa !305
  %20 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %6, i64 0, i32 5, i32 1, !dbg !349
  store i32 %18, i32* %20, align 8, !dbg !350, !tbaa !308
  %21 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %6, i64 0, i32 4, !dbg !351
  store i16 -1, i16* %21, align 2, !dbg !352, !tbaa !311
  %22 = call i32 @_svfprintf_r(%struct._reent* %0, %struct.__sFILE* nonnull %6, i8* %3, %struct.__va_list_tag* %4) #4, !dbg !354
  %23 = icmp slt i32 %22, -1, !dbg !356
  br i1 %23, label %24, label %26, !dbg !357

; <label>:24:                                     ; preds = %11
  %25 = getelementptr inbounds %struct._reent, %struct._reent* %0, i64 0, i32 0, !dbg !358
  store i32 139, i32* %25, align 8, !dbg !359, !tbaa !275
  br label %26, !dbg !360

; <label>:26:                                     ; preds = %24, %11
  br i1 %15, label %27, label %29, !dbg !361

; <label>:27:                                     ; preds = %26
  %28 = load i8*, i8** %13, align 8, !dbg !362, !tbaa !295
  store i8 0, i8* %28, align 1, !dbg !363, !tbaa !325
  br label %29, !dbg !364

; <label>:29:                                     ; preds = %26, %27, %9
  %30 = phi i32 [ -1, %9 ], [ %22, %27 ], [ %22, %26 ], !dbg !365
  call void @llvm.lifetime.end.p0i8(i64 176, i8* nonnull %7) #5, !dbg !366
  ret i32 %30, !dbg !366
}
...
!328 = !DILocation(line: 78, column: 1, scope: !40, inlinedAt: !263)
!329 = !DILocation(line: 41, column: 3, scope: !10)
!330 = !DILocation(line: 53, column: 1, scope: !40)
!331 = !DILocation(line: 61, column: 3, scope: !40)
!332 = !DILocation(line: 63, column: 12, scope: !270)
!333 = !DILocation(line: 63, column: 7, scope: !40)
!334 = !DILocation(line: 65, column: 12, scope: !273)
!335 = !DILocation(line: 65, column: 19, scope: !273)
!336 = !DILocation(line: 66, column: 7, scope: !273)
!337 = !DILocation(line: 68, column: 5, scope: !40)
!338 = !DILocation(line: 68, column: 12, scope: !40)
!339 = !DILocation(line: 69, column: 19, scope: !40)
!340 = !DILocation(line: 69, column: 22, scope: !40)
!341 = !DILocation(line: 69, column: 9, scope: !40)
!342 = !DILocation(line: 69, column: 15, scope: !40)
!343 = !DILocation(line: 70, column: 30, scope: !40)
!344 = !DILocation(line: 70, column: 41, scope: !40)
!345 = !DILocation(line: 70, column: 25, scope: !40)
!346 = !DILocation(line: 70, column: 24, scope: !40)
!347 = !DILocation(line: 70, column: 19, scope: !40)
!348 = !DILocation(line: 70, column: 22, scope: !40)
!349 = !DILocation(line: 70, column: 9, scope: !40)
!350 = !DILocation(line: 70, column: 15, scope: !40)
!351 = !DILocation(line: 71, column: 5, scope: !40)
!352 = !DILocation(line: 71, column: 11, scope: !40)
!353 = !DILocation(line: 61, column: 8, scope: !40)
!354 = !DILocation(line: 72, column: 9, scope: !40)
!355 = !DILocation(line: 60, column: 7, scope: !40)
!356 = !DILocation(line: 73, column: 11, scope: !316)
!357 = !DILocation(line: 73, column: 7, scope: !40)
!358 = !DILocation(line: 74, column: 10, scope: !316)
!359 = !DILocation(line: 74, column: 17, scope: !316)
!360 = !DILocation(line: 74, column: 5, scope: !316)
!361 = !DILocation(line: 75, column: 7, scope: !40)
!362 = !DILocation(line: 76, column: 8, scope: !323)
!363 = !DILocation(line: 76, column: 11, scope: !323)
!364 = !DILocation(line: 76, column: 5, scope: !323)
!365 = !DILocation(line: 0, scope: !40)
!366 = !DILocation(line: 78, column: 1, scope: !40)
