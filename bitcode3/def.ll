...
define dso_local i8* @lwip_strnstr(i8*, i8*, i64) local_unnamed_addr #1 !dbg !44 {
  %4 = tail call i64 @strlen(i8* %1) #5, !dbg !58
...
; <label>:19:                                     ; preds = %16
  %20 = tail call i32 @strncmp(i8* nonnull %13, i8* nonnull %1, i64 %4) #5, !dbg !79
...
define dso_local i32 @lwip_stricmp(i8* nocapture readonly, i8* nocapture readonly) local_unnamed_addr #3 !dbg !87 {
  br label %3, !dbg !105
...
; Function Attrs: noredzone nounwind readonly
define dso_local i32 @lwip_strnicmp(i8* nocapture readonly, i8* nocapture readonly, i64) local_unnamed_addr #3 !dbg !127 {
  br label %4, !dbg !146
...
; Function Attrs: noredzone nounwind
define dso_local void @lwip_itoa(i8*, i64, i32) local_unnamed_addr #1 !dbg !171 {
...
; <label>:42:                                     ; preds = %38
  ...
  %46 = tail call i8* @memmove(i8* %17, i8* nonnull %35, i64 %45) #5, !dbg !239
  br label %47, !dbg !240
