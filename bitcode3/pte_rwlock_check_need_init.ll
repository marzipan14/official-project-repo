...
define dso_local i32 @pte_rwlock_check_need_init(%struct.pthread_rwlock_t_**) local_unnamed_addr #0 !dbg !513 {
  ...
  %4 = bitcast %struct.pthread_rwlock_t_** %0 to i64*, !dbg !528
  %5 = load i64, i64* %4, align 8, !dbg !528, !tbaa !523
...
; <label>:6:                                      ; preds = %1
  %7 = tail call i32 @pthread_rwlock_init(%struct.pthread_rwlock_t_** nonnull %0, %struct.pthread_rwlockattr_t_** null) #3, !dbg !531
  br label %9, !dbg !533
...
; <label>:9:                                      ; preds = %1, %8, %6
  %10 = phi i32 [ %7, %6 ], [ 22, %8 ], [ 0, %1 ], !dbg !537
  %11 = load %struct.uk_mutex*, %struct.uk_mutex** @pte_rwlock_test_init_lock, align 8, !dbg !538, !tbaa !523
  %12 = tail call i32 @pte_osMutexUnlock(%struct.uk_mutex* %11) #3, !dbg !539
  ret i32 %10, !dbg !540
}
...
!530 = !DILocation(line: 85, column: 7, scope: !513)
!531 = !DILocation(line: 87, column: 16, scope: !532)
!532 = distinct !DILexicalBlock(scope: !529, file: !1, line: 86, column: 5)
!533 = !DILocation(line: 88, column: 5, scope: !532)
!534 = !DILocation(line: 97, column: 5, scope: !535)
!535 = distinct !DILexicalBlock(scope: !536, file: !1, line: 90, column: 5)
!536 = distinct !DILexicalBlock(scope: !529, file: !1, line: 89, column: 12)
!537 = !DILocation(line: 0, scope: !513)
!538 = !DILocation(line: 99, column: 21, scope: !513)
!539 = !DILocation(line: 99, column: 3, scope: !513)
!540 = !DILocation(line: 101, column: 3, scope: !513)
