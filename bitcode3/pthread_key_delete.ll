...
; <label>:43:                                     ; preds = %39, %55
  ...
  %45 = and i64 %44, -65536, !dbg !670
  %46 = inttoptr i64 %45 to %struct.uk_thread**, !dbg !671
  %47 = load %struct.uk_thread*, %struct.uk_thread** %46, align 65536, !dbg !673, !tbaa !674
  %48 = icmp eq %struct.uk_thread* %47, null, !dbg !676
  br i1 %48, label %49, label %50, !dbg !679, !prof !680

; <label>:49:                                     ; preds = %43
  tail call void (i8*, ...) @uk_pr_crit(i8* undef, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.1, i64 0, i64 0)) #7, !dbg !681
  tail call void @ukplat_terminate(i32 3) #8, !dbg !681
  unreachable, !dbg !681

; <label>:50:                                     ; preds = %43
  %51 = getelementptr inbounds %struct.uk_thread, %struct.uk_thread* %47, i64 0, i32 9, !dbg !683
  %52 = load %struct.uk_sched*, %struct.uk_sched** %51, align 8, !dbg !683, !tbaa !684
  %53 = icmp eq %struct.uk_sched* %52, null, !dbg !691
  br i1 %53, label %54, label %55, !dbg !694, !prof !680

; <label>:54:                                     ; preds = %50
  tail call void (i8*, ...) @uk_pr_crit(i8* undef, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i64 0, i64 0)) #7, !dbg !695
  tail call void @ukplat_terminate(i32 3) #8, !dbg !695
  unreachable, !dbg !695

; <label>:55:                                     ; preds = %50
  %56 = getelementptr inbounds %struct.uk_sched, %struct.uk_sched* %52, i64 0, i32 0, !dbg !697
  %57 = load void (%struct.uk_sched*)*, void (%struct.uk_sched*)** %56, align 8, !dbg !697, !tbaa !698
  tail call void %57(%struct.uk_sched* nonnull %52) #7, !dbg !702
  %58 = tail call i32 @pthread_mutex_destroy(%struct.pthread_mutex_t_** nonnull %40) #7, !dbg !639
  %59 = icmp eq i32 %58, 16, !dbg !640
  br i1 %59, label %43, label %60, !dbg !641, !llvm.loop !703

; <label>:60:                                     ; preds = %55, %39, %33
  %61 = phi i32 [ 0, %33 ], [ %41, %39 ], [ %58, %55 ], !dbg !705
  %62 = bitcast %struct.pthread_key_t_* %0 to i8*, !dbg !706
  tail call void @free(i8* %62) #7, !dbg !707
  br label %63, !dbg !708

; <label>:63:                                     ; preds = %1, %60
  %64 = phi i32 [ %61, %60 ], [ 0, %1 ], !dbg !705
  ret i32 %64, !dbg !709
}
...
define internal void @uk_pr_crit(i8* nocapture readnone, ...) unnamed_addr #4 !dbg !2 {
  ...
  %3 = bitcast [1 x %struct.__va_list_tag]* %2 to i8*, !dbg !710
  call void @llvm.lifetime.start.p0i8(i64 24, i8* nonnull %3) #6, !dbg !710
  %4 = getelementptr inbounds [1 x %struct.__va_list_tag], [1 x %struct.__va_list_tag]* %2, i64 0, i64 0, !dbg !712
  call void @llvm.va_start(i8* nonnull %3), !dbg !712
  call void @_uk_vprintk(i32 0, i8* getelementptr inbounds ([20 x i8], [20 x i8]* @uk_pr_crit.__str, i64 0, i64 0), i8* getelementptr inbounds ([21 x i8], [21 x i8]* @uk_pr_crit.__str.3, i64 0, i64 0), i32 198, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str, i64 0, i64 0), %struct.__va_list_tag* nonnull %4) #7, !dbg !713
  call void @llvm.va_end(i8* nonnull %3), !dbg !716
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %3) #6, !dbg !717
  ret void, !dbg !717
}
...
!669 = !DILocation(line: 154, column: 16, scope: !650, inlinedAt: !656)
!670 = !DILocation(line: 156, column: 38, scope: !650, inlinedAt: !656)
!671 = !DILocation(line: 156, column: 12, scope: !650, inlinedAt: !656)
!672 = !DILocation(line: 153, column: 21, scope: !650, inlinedAt: !656)
!673 = !DILocation(line: 158, column: 9, scope: !650, inlinedAt: !656)
!674 = !{!598, !598, i64 0}
!675 = !DILocation(line: 117, column: 20, scope: !657, inlinedAt: !661)
!676 = !DILocation(line: 119, column: 2, scope: !677, inlinedAt: !661)
!677 = distinct !DILexicalBlock(scope: !678, file: !97, line: 119, column: 2)
!678 = distinct !DILexicalBlock(scope: !657, file: !97, line: 119, column: 2)
!679 = !DILocation(line: 119, column: 2, scope: !678, inlinedAt: !661)
!680 = !{!"branch_weights", i32 1, i32 2000}
!681 = !DILocation(line: 119, column: 2, scope: !682, inlinedAt: !661)
!682 = distinct !DILexicalBlock(scope: !677, file: !97, line: 119, column: 2)
!683 = !DILocation(line: 121, column: 15, scope: !657, inlinedAt: !661)
!684 = !{!685, !598, i64 88}
!685 = !{!"uk_thread", !598, i64 0, !598, i64 8, !598, i64 16, !598, i64 24, !686, i64 32, !595, i64 48, !687, i64 56, !688, i64 64, !689, i64 72, !598, i64 88, !598, i64 96, !595, i64 104, !598, i64 112, !598, i64 120}
!686 = !{!"", !598, i64 0, !598, i64 8}
!687 = !{!"long", !596, i64 0}
!688 = !{!"_Bool", !596, i64 0}
!689 = !{!"uk_waitq", !598, i64 0, !598, i64 8}
!690 = !DILocation(line: 116, column: 19, scope: !657, inlinedAt: !661)
!691 = !DILocation(line: 122, column: 2, scope: !692, inlinedAt: !661)
!692 = distinct !DILexicalBlock(scope: !693, file: !97, line: 122, column: 2)
!693 = distinct !DILexicalBlock(scope: !657, file: !97, line: 122, column: 2)
!694 = !DILocation(line: 122, column: 2, scope: !693, inlinedAt: !661)
!695 = !DILocation(line: 122, column: 2, scope: !696, inlinedAt: !661)
!696 = distinct !DILexicalBlock(scope: !692, file: !97, line: 122, column: 2)
!697 = !DILocation(line: 123, column: 5, scope: !657, inlinedAt: !661)
!698 = !{!699, !598, i64 0}
!699 = !{!"uk_sched", !598, i64 0, !598, i64 8, !598, i64 16, !598, i64 24, !598, i64 32, !598, i64 40, !598, i64 48, !598, i64 56, !598, i64 64, !688, i64 72, !685, i64 80, !700, i64 208, !701, i64 224, !598, i64 248, !598, i64 256, !598, i64 264}
!700 = !{!"uk_thread_list", !598, i64 0, !598, i64 8}
!701 = !{!"ukplat_ctx_callbacks", !598, i64 0, !598, i64 8, !598, i64 16}
!702 = !DILocation(line: 123, column: 2, scope: !657, inlinedAt: !661)
!703 = distinct !{!703, !641, !704}
!704 = !DILocation(line: 133, column: 13, scope: !638)
!705 = !DILocation(line: 0, scope: !575)
!706 = !DILocation(line: 136, column: 13, scope: !584)
!707 = !DILocation(line: 136, column: 7, scope: !584)
!708 = !DILocation(line: 137, column: 5, scope: !584)
!709 = !DILocation(line: 139, column: 3, scope: !575)
!710 = !DILocation(line: 196, column: 2, scope: !2)
!711 = !DILocation(line: 196, column: 10, scope: !2)
!712 = !DILocation(line: 197, column: 2, scope: !2)
!713 = !DILocation(line: 198, column: 2, scope: !714)
!714 = distinct !DILexicalBlock(scope: !715, file: !3, line: 198, column: 2)
!715 = distinct !DILexicalBlock(scope: !2, file: !3, line: 198, column: 2)
!716 = !DILocation(line: 199, column: 2, scope: !2)
!717 = !DILocation(line: 200, column: 1, scope: !2)
