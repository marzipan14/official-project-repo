...
.LBB0_7:
	...
	je	.LBB0_14
# %bb.8:
	cmpl	$-610510404, %ecx       # imm = 0xDB9C59BC
	jne	.LBB0_14
# %bb.9:
...
.LBB1_34:                               #   Parent Loop BB1_32 Depth=1
	...
	xorl	-2200(%rbp,%rdx,4), %eax
	movzbl	%bl, %edx
	xorl	-4312(%rbp,%rsi,4), %ecx
	addq	$2, %rsi
	addl	-1176(%rbp,%rdx,4), %eax
	movl	%eax, %edx
	xorl	%ecx, %edx
	cmpq	$16, %rsi
	jb	.LBB1_34
...
.LBB1_39:                               #   Parent Loop BB1_32 Depth=1
	...
	shrl	$24, %r11d
	movl	%ebx, %esi
	movl	-4248(%rbp,%r11,4), %ebx
	addl	-3224(%rbp,%rdx,4), %ebx
	xorl	-2200(%rbp,%rax,4), %ebx
	xorl	-4316(%rbp,%rdi,4), %esi
	addl	-1176(%rbp,%r10,4), %ebx
	...
	movl	%ebx, %esi
	shrl	$24, %esi
	movl	-4248(%rbp,%rsi,4), %esi
	addl	-3224(%rbp,%rdx,4), %esi
	xorl	-2200(%rbp,%rax,4), %esi
	movzbl	%bl, %eax
	xorl	-4312(%rbp,%rdi,4), %ecx
	addq	$2, %rdi
	addl	-1176(%rbp,%rax,4), %esi
	movl	%esi, %edx
	xorl	%ecx, %edx
	cmpq	$16, %rdi
	jb	.LBB1_39
...
.LBB1_44:                               # =>This Loop Header: Depth=1
	...
	pxor	-4320(%rbp), %xmm0
	movups	-104(%rbp), %xmm3
	movdqa	%xmm0, -4320(%rbp)
	pxor	-4304(%rbp), %xmm1
	movdqa	%xmm1, -4304(%rbp)
	pxor	-4288(%rbp), %xmm2
	movdqa	%xmm2, -4288(%rbp)
	xorps	-4272(%rbp), %xmm3
	movaps	%xmm3, -4272(%rbp)
	movl	-88(%rbp), %eax
	xorl	%eax, -4256(%rbp)
	movl	-84(%rbp), %eax
	xorl	%eax, -4252(%rbp)
...
.LBB1_56:                               #   Parent Loop BB1_54 Depth=1
	...
	shrl	$24, %edi
	movl	%eax, %edx
	movl	-4248(%rbp,%rdi,4), %eax
	addl	-3224(%rbp,%rbx,4), %eax
	xorl	-2200(%rbp,%r8,4), %eax
	xorl	-4316(%rbp,%rsi,4), %edx
...
# %bb.59:
	...
	movq	%rcx, %rdx
	shrq	$4, %rdx
	movb	BF_itoa64(%rdx,%rax), %al
	movb	%al, 30(%r14)
	andl	$15, %ecx
	movzbl	-78(%rbp), %eax
	movq	%rax, %rdx
	shrq	$6, %rdx
	movb	BF_itoa64(%rdx,%rcx,4), %cl
	movb	%cl, 31(%r14)
	andl	$63, %eax
	movb	BF_itoa64(%rax), %al
	movb	%al, 32(%r14)
