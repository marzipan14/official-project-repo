...
; <label>:35:                                     ; preds = %27, %33
  ...
  %37 = load i32, i32* %4, align 4, !dbg !311, !tbaa !312
  %38 = call i32 @pthread_setcancelstate(i32 %37, i32* nonnull %4) #4, !dbg !311
...
; Function Attrs: noredzone nounwind
define dso_local i32 @putc(i32, %struct.__sFILE*) local_unnamed_addr #0 !dbg !315 {
  %3 = alloca i32, align 4
  %4 = tail call %struct._reent* @__getreent() #4, !dbg !328
  %5 = icmp eq %struct._reent* %4, null, !dbg !331
  br i1 %5, label %11, label %6, !dbg !331

; <label>:6:                                      ; preds = %2
  %7 = getelementptr inbounds %struct._reent, %struct._reent* %4, i64 0, i32 8, !dbg !331
  %8 = load i32, i32* %7, align 8, !dbg !331, !tbaa !264
  %9 = icmp eq i32 %8, 0, !dbg !331
  br i1 %9, label %10, label %11, !dbg !330

; <label>:10:                                     ; preds = %6
  tail call void @__sinit(%struct._reent* nonnull %4) #4, !dbg !331
  br label %11, !dbg !331

; <label>:11:                                     ; preds = %6, %2, %10
  %12 = bitcast i32* %3 to i8*, !dbg !333
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %12) #5, !dbg !333
  %13 = call i32 @pthread_setcancelstate(i32 1, i32* nonnull %3) #4, !dbg !333
  %14 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %1, i64 0, i32 2, !dbg !338
  %15 = load i32, i32* %14, align 4, !dbg !339, !tbaa !286
  %16 = add nsw i32 %15, -1, !dbg !339
  store i32 %16, i32* %14, align 4, !dbg !339, !tbaa !286
  %17 = icmp sgt i32 %15, 0, !dbg !340
  br i1 %17, label %18, label %20, !dbg !341

; <label>:18:                                     ; preds = %11
  %19 = and i32 %0, 255, !dbg !342
  br label %27, !dbg !341

; <label>:20:                                     ; preds = %11
  %21 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %1, i64 0, i32 6, !dbg !343
  %22 = load i32, i32* %21, align 8, !dbg !343, !tbaa !296
  %23 = icmp sle i32 %15, %22, !dbg !344
  %24 = and i32 %0, 255, !dbg !345
  %25 = icmp eq i32 %24, 10, !dbg !345
  %26 = or i1 %25, %23, !dbg !346
  br i1 %26, label %33, label %27, !dbg !346

; <label>:27:                                     ; preds = %20, %18
  %28 = phi i32 [ %19, %18 ], [ %24, %20 ], !dbg !342
  %29 = trunc i32 %0 to i8, !dbg !347
  %30 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %1, i64 0, i32 0, !dbg !348
  %31 = load i8*, i8** %30, align 8, !dbg !349, !tbaa !303
  %32 = getelementptr inbounds i8, i8* %31, i64 1, !dbg !349
  store i8* %32, i8** %30, align 8, !dbg !349, !tbaa !303
  store i8 %29, i8* %31, align 1, !dbg !350, !tbaa !305
  br label %35, !dbg !351

; <label>:33:                                     ; preds = %20
  %34 = call i32 @__swbuf_r(%struct._reent* %4, i32 %0, %struct.__sFILE* nonnull %1) #4, !dbg !352
  br label %35, !dbg !353

; <label>:35:                                     ; preds = %27, %33
  %36 = phi i32 [ %28, %27 ], [ %34, %33 ], !dbg !354
  %37 = load i32, i32* %3, align 4, !dbg !356, !tbaa !312
  %38 = call i32 @pthread_setcancelstate(i32 %37, i32* nonnull %3) #4, !dbg !356
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %12) #5, !dbg !357
  ret i32 %36, !dbg !358
}
...
!310 = !DILocation(line: 98, column: 7, scope: !27)
!311 = !DILocation(line: 102, column: 3, scope: !259)
!312 = !{!266, !266, i64 0}
!313 = !DILocation(line: 102, column: 3, scope: !27)
!314 = !DILocation(line: 103, column: 3, scope: !27)
!315 = distinct !DISubprogram(name: "putc", scope: !1, file: !1, line: 108, type: !316, isLocal: false, isDefinition: true, scopeLine: 111, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !318)
!316 = !DISubroutineType(types: !317)
!317 = !{!5, !5, !248}
!318 = !{!319, !320, !321, !322, !323, !325}
!319 = !DILocalVariable(name: "c", arg: 1, scope: !315, file: !1, line: 108, type: !5)
!320 = !DILocalVariable(name: "fp", arg: 2, scope: !315, file: !1, line: 108, type: !248)
!321 = !DILocalVariable(name: "result", scope: !315, file: !1, line: 113, type: !5)
!322 = !DILocalVariable(name: "reent", scope: !315, file: !1, line: 114, type: !30)
!323 = !DILocalVariable(name: "_check_init_ptr", scope: !324, file: !1, line: 116, type: !30)
!324 = distinct !DILexicalBlock(scope: !315, file: !1, line: 116, column: 3)
!325 = !DILocalVariable(name: "__oldfpcancel", scope: !326, file: !1, line: 117, type: !5)
!326 = distinct !DILexicalBlock(scope: !315, file: !1, line: 117, column: 3)
!327 = !DILocation(line: 108, column: 1, scope: !315)
!328 = !DILocation(line: 114, column: 26, scope: !315)
!329 = !DILocation(line: 114, column: 18, scope: !315)
!330 = !DILocation(line: 116, column: 3, scope: !324)
!331 = !DILocation(line: 116, column: 3, scope: !332)
!332 = distinct !DILexicalBlock(scope: !324, file: !1, line: 116, column: 3)
!333 = !DILocation(line: 117, column: 3, scope: !326)
!334 = !DILocation(line: 687, column: 47, scope: !275, inlinedAt: !335)
!335 = distinct !DILocation(line: 118, column: 12, scope: !326)
!336 = !DILocation(line: 687, column: 57, scope: !275, inlinedAt: !335)
!337 = !DILocation(line: 687, column: 67, scope: !275, inlinedAt: !335)
!338 = !DILocation(line: 692, column: 12, scope: !284, inlinedAt: !335)
!339 = !DILocation(line: 692, column: 6, scope: !284, inlinedAt: !335)
!340 = !DILocation(line: 692, column: 15, scope: !284, inlinedAt: !335)
!341 = !DILocation(line: 692, column: 20, scope: !284, inlinedAt: !335)
!342 = !DILocation(line: 693, column: 10, scope: !284, inlinedAt: !335)
!343 = !DILocation(line: 692, column: 38, scope: !284, inlinedAt: !335)
!344 = !DILocation(line: 692, column: 31, scope: !284, inlinedAt: !335)
!345 = !DILocation(line: 692, column: 59, scope: !284, inlinedAt: !335)
!346 = !DILocation(line: 692, column: 47, scope: !284, inlinedAt: !335)
!347 = !DILocation(line: 693, column: 23, scope: !284, inlinedAt: !335)
!348 = !DILocation(line: 693, column: 16, scope: !284, inlinedAt: !335)
!349 = !DILocation(line: 693, column: 18, scope: !284, inlinedAt: !335)
!350 = !DILocation(line: 693, column: 21, scope: !284, inlinedAt: !335)
!351 = !DILocation(line: 693, column: 3, scope: !284, inlinedAt: !335)
!352 = !DILocation(line: 695, column: 11, scope: !284, inlinedAt: !335)
!353 = !DILocation(line: 695, column: 3, scope: !284, inlinedAt: !335)
!354 = !DILocation(line: 0, scope: !284, inlinedAt: !335)
!355 = !DILocation(line: 113, column: 7, scope: !315)
!356 = !DILocation(line: 119, column: 3, scope: !326)
!357 = !DILocation(line: 119, column: 3, scope: !315)
!358 = !DILocation(line: 120, column: 3, scope: !315)
