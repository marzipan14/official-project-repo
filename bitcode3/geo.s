...
# %bb.0:
	...
	movq	%rax, %rdi
	movl	$26, %esi
	jmp	geohashDecodeToLongLatWGS84 # TAILCALL
.Lfunc_end3:
...
# %bb.0:
	...
	popq	%r15
	popq	%rbp
	jmp	geoGetPointsInRange     # TAILCALL
.Lfunc_end12:
...
# %bb.28:                               #   in Loop: Header=BB15_15 Depth=1
	...
	jge	.LBB15_32
# %bb.29:                               #   in Loop: Header=BB15_15 Depth=1
...
.LBB15_24:                              #   in Loop: Header=BB15_15 Depth=1
	...
	jmp	.LBB15_17
.LBB15_32:                              #   in Loop: Header=BB15_15 Depth=1
	movl	$.L.str.32, %esi
	movq	%r13, %rdi
	callq	strcasecmp
	testl	%eax, %eax
	je	.LBB15_33
.LBB15_36:                              #   in Loop: Header=BB15_15 Depth=1
	movl	$.L.str.33, %esi
	movq	%r13, %rdi
	callq	strcasecmp
	testl	%eax, %eax
	movl	-48(%rbp), %ecx         # 4-byte Reload
	jne	.LBB15_104
# %bb.37:                               #   in Loop: Header=BB15_15 Depth=1
...
# %bb.38:                               #   in Loop: Header=BB15_15 Depth=1
	...
	cmpl	%ecx, %r15d
	jge	.LBB15_104
# %bb.39:                               #   in Loop: Header=BB15_15 Depth=1
	...
	movq	-72(%rbp), %rbx         # 8-byte Reload
	jmp	.LBB15_40
.LBB15_26:                              #   in Loop: Header=BB15_15 Depth=1
...
.LBB15_18:                              #   in Loop: Header=BB15_15 Depth=1
	movq	-72(%rbp), %rbx         # 8-byte Reload
	movl	-48(%rbp), %ecx         # 4-byte Reload
.LBB15_40:                              #   in Loop: Header=BB15_15 Depth=1
	addl	$1, %r12d
	movl	%r12d, %r15d
	cmpl	%ecx, %r12d
...
# %bb.34:                               #   in Loop: Header=BB15_15 Depth=1
	...
	cmpl	-48(%rbp), %r12d        # 4-byte Folded Reload
	jge	.LBB15_36
# %bb.35:                               #   in Loop: Header=BB15_15 Depth=1
	movq	8(%rbx,%r14,8), %rax
	movq	%rax, -88(%rbp)         # 8-byte Spill
	movl	$0, -76(%rbp)           # 4-byte Folded Spill
	jmp	.LBB15_18
...
# %bb.66:
	...
	jmp	.LBB15_67
	.p2align	4, 0x90
.LBB15_75:                              #   in Loop: Header=BB15_67 Depth=1
	addq	$40, %rbx
	movq	%r13, %r14
	addq	$-1, %r14
	je	.LBB15_98
...
# %bb.68:                               #   in Loop: Header=BB15_67 Depth=1
	...
	callq	addReplyMultiBulkLen
.LBB15_69:                              #   in Loop: Header=BB15_67 Depth=1
	movq	(%r14,%rbx), %rsi
	movq	%r15, %rdi
...
# %bb.70:                               #   in Loop: Header=BB15_67 Depth=1
	...
	movq	%r12, %rsi
	callq	addReplyBulkCBuffer
.LBB15_71:                              #   in Loop: Header=BB15_67 Depth=1
...
.LBB15_82:                              #   in Loop: Header=BB15_80 Depth=1
	movq	(%r14,%rbx), %rsi
	movzbl	-1(%rsi), %r15d
	movl	%r15d, %eax
	andb	$7, %al
...
.LBB15_85:                              #   in Loop: Header=BB15_80 Depth=1
	shrq	$3, %r15
	jmp	.LBB15_90
.LBB15_89:                              #   in Loop: Header=BB15_80 Depth=1
	movq	-17(%rsi), %r15
	jmp	.LBB15_90
.LBB15_87:                              #   in Loop: Header=BB15_80 Depth=1
	movzwl	-5(%rsi), %r15d
	jmp	.LBB15_90
.LBB15_86:                              #   in Loop: Header=BB15_80 Depth=1
	movzbl	-3(%rsi), %r15d
	jmp	.LBB15_90
...
.LBB15_83:                              #   in Loop: Header=BB15_80 Depth=1
	xorl	%r15d, %r15d
.LBB15_90:                              #   in Loop: Header=BB15_80 Depth=1
	movq	8(%r13), %rdi
	callq	zslInsert
	movq	(%r13), %rdi
	movq	(%r14,%rbx), %rsi
	...
	testl	%eax, %eax
	jne	.LBB15_106
# %bb.91:                               #   in Loop: Header=BB15_80 Depth=1
...
# %bb.99:                               # %.preheader1
	...
	xorl	%ebx, %ebx
	.p2align	4, 0x90
.LBB15_100:                             # =>This Inner Loop Header: Depth=1
	movq	(%rdi,%r14), %rdi
	callq	sdsfree
	addq	$1, %rbx
	movq	(%r15), %rdi
