...
# %bb.74:                               #   in Loop: Header=BB8_71 Depth=1
	...
	je	.LBB8_69
	jmp	.LBB8_20
.LBB8_75:                               #   in Loop: Header=BB8_71 Depth=1
	movl	$128, %esi
	movl	$.L.str.64, %edx
	movq	%r12, %rdi
	movq	%rbx, %rcx
	...
	testq	%r15, %r15
	je	.LBB8_77
# %bb.76:                               #   in Loop: Header=BB8_71 Depth=1
	movq	-64(%rbp), %rsi
	xorl	%edi, %edi
	movq	%rax, -48(%rbp)         # 8-byte Spill
	callq	createStringObject
	...
	callq	memcpy
	jmp	.LBB8_78
.LBB8_77:                               #   in Loop: Header=BB8_71 Depth=1
	movq	%r12, %rdi
	movq	%rax, %rsi
	callq	createStringObject
	movq	%rax, %r15
.LBB8_78:                               #   in Loop: Header=BB8_71 Depth=1
	movq	16(%r14), %rdi
	movq	%r13, %rsi
	movq	%r15, %rdx
	callq	dbAdd
...
.LBB13_2:
	...
	popq	%rbx
	popq	%rbp
	jmp	serverLogObjectDebugInfo # TAILCALL
.Lfunc_end13:
...
# %bb.0:
	...
	movl	$3, %edi
	popq	%rbp
	jmp	serverLogFromHandler    # TAILCALL
.Lfunc_end15:
