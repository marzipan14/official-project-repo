...
# %bb.2:
	...
	callq	cosf
	movaps	.LCPI0_12(%rip), %xmm7  # xmm7 = [-0.0E+0,-0.0E+0,-0.0E+0,-0.0E+0]
...
.LBB0_11:
	...
	cmpl	$1090519039, %ecx       # imm = 0x40FFFFFF
	jbe	.LBB0_13
# %bb.12:
	movl	$pr8, %edx
	movl	$ps8, %ecx
	jmp	.LBB0_16
.LBB0_13:
	cmpl	$1089936471, %ecx       # imm = 0x40F71C57
	jbe	.LBB0_15
# %bb.14:
	movl	$pr5, %edx
	movl	$ps5, %ecx
...
# %bb.4:
	...
	movss	-20(%rbp), %xmm0        # 4-byte Reload
                                        # xmm0 = mem[0],zero,zero,zero
	callq	cosf
	movaps	.LCPI1_15(%rip), %xmm2  # xmm2 = [-0.0E+0,-0.0E+0,-0.0E+0,-0.0E+0]
	xorps	-80(%rbp), %xmm2        # 16-byte Folded Reload
	subss	%xmm0, %xmm2
	cmpl	$2130706431, %ebx       # imm = 0x7EFFFFFF
	ja	.LBB1_12
# %bb.5:
...
.LBB1_13:
	...
	addss	-80(%rbp), %xmm2        # 4-byte Folded Reload
	jmp	.LBB1_24
.LBB1_14:
	movaps	-80(%rbp), %xmm1        # 16-byte Reload
	subss	%xmm3, %xmm1
...
.LBB1_21:
	movaps	%xmm7, %xmm1
	mulss	%xmm7, %xmm1
	movss	.LCPI1_0(%rip), %xmm8   # xmm8 = mem[0],zero,zero,zero
	movaps	%xmm8, %xmm3
	divss	%xmm1, %xmm3
	...
	addss	%xmm8, %xmm6
	divss	%xmm6, %xmm5
	addss	.LCPI1_16(%rip), %xmm5
	divss	%xmm7, %xmm5
	mulss	%xmm5, %xmm0
	mulss	%xmm1, %xmm2
	addss	%xmm0, %xmm2
.LBB1_22:
	mulss	.LCPI1_17(%rip), %xmm2
	movaps	%xmm2, -48(%rbp)        # 16-byte Spill
	movaps	%xmm7, %xmm0
	callq	__ieee754_sqrtf
	movaps	-48(%rbp), %xmm2        # 16-byte Reload
