...
; <label>:14:                                     ; preds = %10
  ...
  %18 = call i8* @strsep(i8** nonnull %6, i8* nonnull %7) #5, !dbg !75
  %19 = icmp eq i8* %18, null, !dbg !76
  br i1 %19, label %32, label %20, !dbg !76
...
; <label>:20:                                     ; preds = %14, %20
  ...
  %30 = call i8* @strsep(i8** nonnull %6, i8* nonnull %7) #5, !dbg !75
  %31 = icmp eq i8* %30, null, !dbg !76
  br i1 %31, label %32, label %20, !dbg !76, !llvm.loop !82
...
; <label>:32:                                     ; preds = %20, %14
  ...
  br i1 %36, label %55, label %37, !dbg !89

; <label>:37:                                     ; preds = %32
  call void @free(i8* %17) #5, !dbg !90
  %38 = call i8* @strdup(i8* nonnull %0) #5, !dbg !91
  store i8* %38, i8** %6, align 8, !dbg !92, !tbaa !49
  %39 = icmp eq i32 %33, 0, !dbg !93
  br i1 %39, label %54, label %40, !dbg !96

; <label>:40:                                     ; preds = %37
  %41 = load i8*, i8** %2, align 8, !dbg !97, !tbaa !49
  br label %42, !dbg !98

; <label>:42:                                     ; preds = %42, %40
  %43 = phi i8* [ %51, %42 ], [ %41, %40 ]
  %44 = phi i32 [ %52, %42 ], [ 0, %40 ]
  %45 = call i8* @strsep(i8** nonnull %6, i8* nonnull %7) #5, !dbg !98
  %46 = call i64 @strlen(i8* %45) #5, !dbg !100
  %47 = shl i64 %46, 32, !dbg !101
  %48 = add i64 %47, 4294967296, !dbg !101
  %49 = ashr exact i64 %48, 32, !dbg !101
  %50 = call i8* @memcpy(i8* %43, i8* %45, i64 %49) #5, !dbg !102
  %51 = getelementptr inbounds i8, i8* %43, i64 %49, !dbg !103
  %52 = add nuw nsw i32 %44, 1, !dbg !104
  %53 = icmp eq i32 %52, %33, !dbg !93
  br i1 %53, label %54, label %42, !dbg !96, !llvm.loop !105

; <label>:54:                                     ; preds = %42, %37
  call void @free(i8* %38) #5, !dbg !107
  br label %55, !dbg !108

; <label>:55:                                     ; preds = %32, %54, %13
  %56 = phi i32 [ 0, %13 ], [ 0, %54 ], [ 12, %32 ], !dbg !109
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %8) #4, !dbg !110
  call void @llvm.lifetime.end.p0i8(i64 2, i8* nonnull %7) #4, !dbg !110
  ret i32 %56, !dbg !110
}
...
!75 = !DILocation(line: 43, column: 19, scope: !10)
!76 = !DILocation(line: 43, column: 3, scope: !10)
...
!93 = !DILocation(line: 59, column: 17, scope: !94)
!94 = distinct !DILexicalBlock(scope: !95, file: !1, line: 59, column: 3)
!95 = distinct !DILexicalBlock(scope: !10, file: !1, line: 59, column: 3)
!96 = !DILocation(line: 59, column: 3, scope: !95)
!97 = !DILocation(line: 58, column: 10, scope: !10)
!98 = !DILocation(line: 61, column: 15, scope: !99)
!99 = distinct !DILexicalBlock(scope: !94, file: !1, line: 60, column: 5)
!100 = !DILocation(line: 62, column: 13, scope: !99)
!101 = !DILocation(line: 63, column: 27, scope: !99)
!102 = !DILocation(line: 63, column: 7, scope: !99)
!103 = !DILocation(line: 64, column: 12, scope: !99)
!104 = !DILocation(line: 59, column: 33, scope: !94)
!105 = distinct !{!105, !96, !106}
!106 = !DILocation(line: 65, column: 5, scope: !95)
!107 = !DILocation(line: 67, column: 3, scope: !10)
!108 = !DILocation(line: 68, column: 3, scope: !10)
!109 = !DILocation(line: 0, scope: !86)
!110 = !DILocation(line: 69, column: 1, scope: !10)
