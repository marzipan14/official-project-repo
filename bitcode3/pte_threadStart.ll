...
define dso_local i32 @pte_threadStart(i8* nocapture readonly) local_unnamed_addr #0 !dbg !530 {
  ...
  %2 = bitcast i8* %0 to i8**, !dbg !555
  %3 = load i8*, i8** %2, align 8, !dbg !555
  %4 = getelementptr inbounds i8, i8* %0, i64 16, !dbg !557
  %5 = bitcast i8* %4 to i8* (i8*)**, !dbg !557
  %6 = load i8* (i8*)*, i8* (i8*)** %5, align 8, !dbg !557, !tbaa !558
  %7 = getelementptr inbounds i8, i8* %0, i64 24, !dbg !566
  %8 = bitcast i8* %7 to i8**, !dbg !566
  %9 = load i8*, i8** %8, align 8, !dbg !566, !tbaa !567
  %10 = load %struct.pthread_key_t_*, %struct.pthread_key_t_** @pte_selfThreadKey, align 8, !dbg !569, !tbaa !570
  %11 = tail call i32 @pthread_setspecific(%struct.pthread_key_t_* %10, i8* %3) #4, !dbg !571
  %12 = getelementptr inbounds i8, i8* %3, i64 32, !dbg !572
  %13 = bitcast i8* %12 to i32*, !dbg !572
  store volatile i32 1, i32* %13, align 8, !dbg !573, !tbaa !574
  %14 = getelementptr inbounds i8, i8* %3, i64 104, !dbg !576
  %15 = bitcast i8* %14 to i64*, !dbg !577
  %16 = tail call i32 @setjmp(i64* nonnull %15) #4, !dbg !578
...
; <label>:17:                                     ; preds = %1
  %18 = tail call i8* %6(i8* %9) #4, !dbg !582
  br label %19, !dbg !585

; <label>:19:                                     ; preds = %1, %17
  %20 = phi i8* [ %18, %17 ], [ inttoptr (i64 -1 to i8*), %1 ]
  %21 = getelementptr inbounds i8, i8* %3, i64 40, !dbg !586
  %22 = bitcast i8* %21 to i8**, !dbg !586
  store i8* %20, i8** %22, align 8, !dbg !586, !tbaa !587
  br label %23, !dbg !588

; <label>:23:                                     ; preds = %1, %19
  %24 = tail call i32 (...) @pte_thread_detach_and_exit_np() #4, !dbg !588
  ret i32 0, !dbg !589
}
...
!552 = !{i32 404758}
!553 = !DILocation(line: 83, column: 17, scope: !530)
!554 = !DILocation(line: 95, column: 10, scope: !530)
!555 = !DILocation(line: 97, column: 23, scope: !530)
!556 = !DILocation(line: 84, column: 13, scope: !530)
!557 = !DILocation(line: 99, column: 24, scope: !530)
!558 = !{!559, !561, i64 16}
!559 = !{!"ThreadParms", !560, i64 0, !561, i64 16, !561, i64 24}
!560 = !{!"", !561, i64 0, !564, i64 8}
!561 = !{!"any pointer", !562, i64 0}
!562 = !{!"omnipotent char", !563, i64 0}
!563 = !{!"Simple C/C++ TBAA"}
!564 = !{!"int", !562, i64 0}
!565 = !DILocation(line: 86, column: 11, scope: !530)
!566 = !DILocation(line: 100, column: 22, scope: !530)
!567 = !{!559, !561, i64 24}
!568 = !DILocation(line: 87, column: 10, scope: !530)
!569 = !DILocation(line: 103, column: 24, scope: !530)
!570 = !{!561, !561, i64 0}
!571 = !DILocation(line: 103, column: 3, scope: !530)
!572 = !DILocation(line: 105, column: 7, scope: !530)
!573 = !DILocation(line: 105, column: 13, scope: !530)
!574 = !{!575, !562, i64 32}
!575 = !{!"pte_thread_t_", !561, i64 0, !560, i64 8, !561, i64 24, !562, i64 32, !561, i64 40, !561, i64 48, !564, i64 56, !564, i64 60, !561, i64 64, !564, i64 72, !561, i64 80, !564, i64 88, !564, i64 92, !564, i64 96, !562, i64 104, !564, i64 168, !561, i64 176, !561, i64 184}
!576 = !DILocation(line: 110, column: 27, scope: !530)
!577 = !DILocation(line: 110, column: 23, scope: !530)
!578 = !DILocation(line: 110, column: 15, scope: !530)
!579 = !DILocation(line: 92, column: 7, scope: !530)
!580 = !DILocation(line: 113, column: 7, scope: !530)
!581 = !DILocation(line: 85, column: 18, scope: !530)
!582 = !DILocation(line: 119, column: 33, scope: !583)
!583 = distinct !DILexicalBlock(scope: !584, file: !1, line: 114, column: 5)
!584 = distinct !DILexicalBlock(scope: !530, file: !1, line: 113, column: 7)
!585 = !DILocation(line: 120, column: 5, scope: !583)
!586 = !DILocation(line: 0, scope: !583)
!587 = !{!575, !561, i64 40}
!588 = !DILocation(line: 240, column: 10, scope: !530)
!589 = !DILocation(line: 249, column: 3, scope: !530)
