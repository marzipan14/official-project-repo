...
; <label>:10:                                     ; preds = %8
  ...
  %12 = fsub float %0, %1, !dbg !31
  %13 = select i1 %11, float %12, float 0.000000e+00, !dbg !32
  br label %14, !dbg !32

; <label>:14:                                     ; preds = %10, %8, %5, %2
  %15 = phi float [ %0, %2 ], [ %1, %5 ], [ 0x7FF0000000000000, %8 ], [ %13, %10 ], !dbg !33
  ret float %15, !dbg !34
}
...
!31 = !DILocation(line: 23, column: 20, scope: !7)
!32 = !DILocation(line: 23, column: 10, scope: !7)
!33 = !DILocation(line: 0, scope: !7)
!34 = !DILocation(line: 24, column: 1, scope: !7)
