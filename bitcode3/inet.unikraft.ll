...
define dso_local i8* @inet_ntop(i32, i8*, i8*, i32) local_unnamed_addr #0 !dbg !7 {
  %5 = tail call i8* @lwip_inet_ntop(i32 %0, i8* %1, i8* %2, i32 %3) #4, !dbg !35
  ret i8* %5, !dbg !36
}
...
define dso_local i32 @inet_pton(i32, i8*, i8*) local_unnamed_addr #0 !dbg !37 {
  %4 = tail call i32 @lwip_inet_pton(i32 %0, i8* %1, i8* %2) #4, !dbg !48
  ret i32 %4, !dbg !49
}
...
define dso_local i32 @getaddrinfo(i8*, i8*, %struct.addrinfo*, %struct.addrinfo**) local_unnamed_addr #0 !dbg !50 {
  %5 = tail call i32 @lwip_getaddrinfo(i8* %0, i8* %1, %struct.addrinfo* %2, %struct.addrinfo** %3) #4, !dbg !91
  ret i32 %5, !dbg !92
}
...
define dso_local void @freeaddrinfo(%struct.addrinfo*) local_unnamed_addr #0 !dbg !93 {
  tail call void @lwip_freeaddrinfo(%struct.addrinfo* %0) #4, !dbg !99
  ret void, !dbg !100
}
...
define dso_local i8* @gai_strerror(i32) local_unnamed_addr #2 !dbg !101 {
