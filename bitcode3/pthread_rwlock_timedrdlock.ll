...
define dso_local i32 @pthread_rwlock_timedrdlock(%struct.pthread_rwlock_t_**, %struct.timespec*) local_unnamed_addr #0 !dbg !513 {
  ...
  br i1 %3, label %48, label %4, !dbg !534

; <label>:4:                                      ; preds = %2
  %5 = bitcast %struct.pthread_rwlock_t_** %0 to i64*, !dbg !535
  %6 = load i64, i64* %5, align 8, !dbg !535, !tbaa !536
  %7 = inttoptr i64 %6 to %struct.pthread_rwlock_t_*, !dbg !540
...
; <label>:8:                                      ; preds = %4
  %9 = tail call i32 @pte_rwlock_check_need_init(%struct.pthread_rwlock_t_** nonnull %0) #3, !dbg !541
  %10 = or i32 %9, 16, !dbg !545
  %11 = icmp eq i32 %10, 16, !dbg !545
  br i1 %11, label %12, label %48, !dbg !545

; <label>:12:                                     ; preds = %8
  %13 = load %struct.pthread_rwlock_t_*, %struct.pthread_rwlock_t_** %0, align 8, !dbg !547, !tbaa !536
  br label %14, !dbg !545

; <label>:14:                                     ; preds = %12, %4
  %15 = phi %struct.pthread_rwlock_t_* [ %13, %12 ], [ %7, %4 ], !dbg !547
  %16 = getelementptr inbounds %struct.pthread_rwlock_t_, %struct.pthread_rwlock_t_* %15, i64 0, i32 6, !dbg !549
  %17 = load i32, i32* %16, align 4, !dbg !549, !tbaa !551
  %18 = icmp eq i32 %17, 262974946, !dbg !554
  br i1 %18, label %19, label %48, !dbg !555

; <label>:19:                                     ; preds = %14
  %20 = getelementptr inbounds %struct.pthread_rwlock_t_, %struct.pthread_rwlock_t_* %15, i64 0, i32 0, !dbg !556
  %21 = tail call i32 @pthread_mutex_timedlock(%struct.pthread_mutex_t_** %20, %struct.timespec* %1) #3, !dbg !558
  %22 = icmp eq i32 %21, 0, !dbg !559
  br i1 %22, label %23, label %48, !dbg !560

; <label>:23:                                     ; preds = %19
  %24 = getelementptr inbounds %struct.pthread_rwlock_t_, %struct.pthread_rwlock_t_* %15, i64 0, i32 3, !dbg !561
  %25 = load i32, i32* %24, align 8, !dbg !563, !tbaa !564
  %26 = add nsw i32 %25, 1, !dbg !563
  store i32 %26, i32* %24, align 8, !dbg !563, !tbaa !564
  %27 = icmp eq i32 %26, 2147483647, !dbg !565
  br i1 %27, label %28, label %46, !dbg !566

; <label>:28:                                     ; preds = %23
  %29 = getelementptr inbounds %struct.pthread_rwlock_t_, %struct.pthread_rwlock_t_* %15, i64 0, i32 1, !dbg !567
  %30 = tail call i32 @pthread_mutex_timedlock(%struct.pthread_mutex_t_** nonnull %29, %struct.timespec* %1) #3, !dbg !570
...
; <label>:31:                                     ; preds = %28
  %32 = getelementptr inbounds %struct.pthread_rwlock_t_, %struct.pthread_rwlock_t_* %15, i64 0, i32 5, !dbg !572
  %33 = load i32, i32* %32, align 8, !dbg !576, !tbaa !577
  %34 = add nsw i32 %33, 1, !dbg !576
  store i32 %34, i32* %32, align 8, !dbg !576, !tbaa !577
  br label %35, !dbg !578

; <label>:35:                                     ; preds = %28, %31
  %36 = tail call i32 @pthread_mutex_unlock(%struct.pthread_mutex_t_** nonnull %20) #3, !dbg !579
  br label %48, !dbg !580

; <label>:37:                                     ; preds = %28
  %38 = getelementptr inbounds %struct.pthread_rwlock_t_, %struct.pthread_rwlock_t_* %15, i64 0, i32 5, !dbg !581
  %39 = load i32, i32* %38, align 8, !dbg !581, !tbaa !577
  %40 = load i32, i32* %24, align 8, !dbg !582, !tbaa !564
  %41 = sub nsw i32 %40, %39, !dbg !582
  store i32 %41, i32* %24, align 8, !dbg !582, !tbaa !564
  store i32 0, i32* %38, align 8, !dbg !583, !tbaa !577
  %42 = tail call i32 @pthread_mutex_unlock(%struct.pthread_mutex_t_** nonnull %29) #3, !dbg !584
  %43 = icmp eq i32 %42, 0, !dbg !586
  br i1 %43, label %46, label %44, !dbg !587

; <label>:44:                                     ; preds = %37
  %45 = tail call i32 @pthread_mutex_unlock(%struct.pthread_mutex_t_** nonnull %20) #3, !dbg !588
  br label %48, !dbg !590

; <label>:46:                                     ; preds = %37, %23
  %47 = tail call i32 @pthread_mutex_unlock(%struct.pthread_mutex_t_** nonnull %20) #3, !dbg !591
  br label %48, !dbg !592

; <label>:48:                                     ; preds = %19, %14, %8, %4, %2, %46, %44, %35
  %49 = phi i32 [ %30, %35 ], [ %42, %44 ], [ %47, %46 ], [ 22, %4 ], [ 22, %2 ], [ %9, %8 ], [ 22, %14 ], [ %21, %19 ], !dbg !593
  ret i32 %49, !dbg !594
}
...
!539 = !{!"Simple C/C++ TBAA"}
!540 = !DILocation(line: 56, column: 7, scope: !513)
!541 = !DILocation(line: 69, column: 16, scope: !542)
!542 = distinct !DILexicalBlock(scope: !543, file: !1, line: 68, column: 5)
!543 = distinct !DILexicalBlock(scope: !513, file: !1, line: 67, column: 7)
!544 = !DILocation(line: 53, column: 7, scope: !513)
!545 = !DILocation(line: 71, column: 23, scope: !546)
!546 = distinct !DILexicalBlock(scope: !542, file: !1, line: 71, column: 11)
!547 = !DILocation(line: 77, column: 9, scope: !513)
!548 = !DILocation(line: 54, column: 20, scope: !513)
!549 = !DILocation(line: 79, column: 12, scope: !550)
!550 = distinct !DILexicalBlock(scope: !513, file: !1, line: 79, column: 7)
!551 = !{!552, !553, i64 36}
!552 = !{!"pthread_rwlock_t_", !537, i64 0, !537, i64 8, !537, i64 16, !553, i64 24, !553, i64 28, !553, i64 32, !553, i64 36}
!553 = !{!"int", !538, i64 0}
!554 = !DILocation(line: 79, column: 19, scope: !550)
!555 = !DILocation(line: 79, column: 7, scope: !513)
!556 = !DILocation(line: 85, column: 42, scope: !557)
!557 = distinct !DILexicalBlock(scope: !513, file: !1, line: 84, column: 7)
!558 = !DILocation(line: 85, column: 10, scope: !557)
!559 = !DILocation(line: 85, column: 73, scope: !557)
!560 = !DILocation(line: 84, column: 7, scope: !513)
!561 = !DILocation(line: 90, column: 14, scope: !562)
!562 = distinct !DILexicalBlock(scope: !513, file: !1, line: 90, column: 7)
!563 = !DILocation(line: 90, column: 7, scope: !562)
!564 = !{!552, !553, i64 24}
!565 = !DILocation(line: 90, column: 33, scope: !562)
!566 = !DILocation(line: 90, column: 7, scope: !513)
!567 = !DILocation(line: 93, column: 46, scope: !568)
!568 = distinct !DILexicalBlock(scope: !569, file: !1, line: 92, column: 11)
!569 = distinct !DILexicalBlock(scope: !562, file: !1, line: 91, column: 5)
!570 = !DILocation(line: 93, column: 14, scope: !568)
!571 = !DILocation(line: 92, column: 11, scope: !569)
!572 = !DILocation(line: 98, column: 22, scope: !573)
!573 = distinct !DILexicalBlock(scope: !574, file: !1, line: 97, column: 13)
!574 = distinct !DILexicalBlock(scope: !575, file: !1, line: 96, column: 15)
!575 = distinct !DILexicalBlock(scope: !568, file: !1, line: 95, column: 9)
!576 = !DILocation(line: 98, column: 15, scope: !573)
!577 = !{!552, !553, i64 32}
!578 = !DILocation(line: 99, column: 13, scope: !573)
!579 = !DILocation(line: 100, column: 18, scope: !575)
!580 = !DILocation(line: 101, column: 11, scope: !575)
!581 = !DILocation(line: 104, column: 39, scope: !569)
!582 = !DILocation(line: 104, column: 31, scope: !569)
!583 = !DILocation(line: 105, column: 40, scope: !569)
!584 = !DILocation(line: 108, column: 14, scope: !585)
!585 = distinct !DILexicalBlock(scope: !569, file: !1, line: 107, column: 11)
!586 = !DILocation(line: 108, column: 71, scope: !585)
!587 = !DILocation(line: 107, column: 11, scope: !569)
!588 = !DILocation(line: 110, column: 18, scope: !589)
!589 = distinct !DILexicalBlock(scope: !585, file: !1, line: 109, column: 9)
!590 = !DILocation(line: 111, column: 11, scope: !589)
!591 = !DILocation(line: 115, column: 11, scope: !513)
!592 = !DILocation(line: 115, column: 3, scope: !513)
!593 = !DILocation(line: 0, scope: !513)
!594 = !DILocation(line: 116, column: 1, scope: !513)
