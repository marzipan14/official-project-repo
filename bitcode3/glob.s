...
.LBB1_48:                               #   in Loop: Header=BB1_42 Depth=1
	...
	jmp	.LBB1_67
	.p2align	4, 0x90
.LBB1_56:                               #   in Loop: Header=BB1_42 Depth=1
	cmpw	$123, %ax
	je	.LBB1_59
...
.LBB1_63:                               #   in Loop: Header=BB1_42 Depth=1
	...
	cmpq	%r12, %r14
	jae	.LBB1_64
# %bb.69:                               #   in Loop: Header=BB1_42 Depth=1
	movq	%r14, %rax
	notq	%rax
	addq	%r12, %rax
	movq	%rax, %r10
...
# %bb.72:                               # %.preheader2
	...
	xorl	%esi, %esi
	.p2align	4, 0x90
.LBB1_73:                               #   Parent Loop BB1_42 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
...
# %bb.76:                               # %.preheader1
	...
	xorl	%esi, %esi
	.p2align	4, 0x90
.LBB1_77:                               #   Parent Loop BB1_42 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	movzwl	(%r14,%rsi), %eax
	movw	%ax, (%rdx,%rsi)
	...
	jb	.LBB1_77
	jmp	.LBB1_78
.LBB1_81:                               #   in Loop: Header=BB1_42 Depth=1
	movq	%r9, %r8
	andq	$-16, %r8
	leaq	-16(%r8), %rcx
	movq	%rcx, %rax
	...
	cmpq	$48, %rcx
	jae	.LBB1_83
# %bb.82:                               #   in Loop: Header=BB1_42 Depth=1
	xorl	%esi, %esi
	jmp	.LBB1_85
.LBB1_83:                               #   in Loop: Header=BB1_42 Depth=1
	...
	xorl	%esi, %esi
	.p2align	4, 0x90
.LBB1_84:                               #   Parent Loop BB1_42 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	...
	addq	$4, %rdi
	jne	.LBB1_84
.LBB1_85:                               #   in Loop: Header=BB1_42 Depth=1
	testq	%rdx, %rdx
	je	.LBB1_88
# %bb.86:                               # %.preheader4
                                        #   in Loop: Header=BB1_42 Depth=1
...
.LBB2_38:                               #   in Loop: Header=BB2_24 Depth=1
	...
	cmpw	$33, %r8w
	jne	.LBB2_40
# %bb.39:                               #   in Loop: Header=BB2_24 Depth=1
...
# %bb.49:                               #   in Loop: Header=BB6_47 Depth=2
	...
	cmpw	$46, (%rcx)
	jne	.LBB6_46
.LBB6_50:                               #   in Loop: Header=BB6_47 Depth=2
	movq	%rbx, %r14
	addq	$19, %rax
	movq	%r12, %rbx
	movq	-80(%rbp), %rsi         # 8-byte Reload
	.p2align	4, 0x90
.LBB6_51:                               #   Parent Loop BB6_45 Depth=1
...
# %bb.52:                               #   in Loop: Header=BB6_51 Depth=3
	...
	testw	%cx, %cx
	jne	.LBB6_51
.LBB6_53:                               #   in Loop: Header=BB6_47 Depth=2
	movq	%r12, %rdi
	movq	%r15, %rdx
	callq	match
	testl	%eax, %eax
	jne	.LBB6_55
# %bb.54:                               #   in Loop: Header=BB6_47 Depth=2
	movw	$0, (%r12)
	movq	%r14, %rbx
	jmp	.LBB6_46
