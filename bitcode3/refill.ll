...
; <label>:9:                                      ; preds = %4, %2, %8
  ...
  br i1 %15, label %16, label %92, !dbg !268
...
; <label>:28:                                     ; preds = %25
  ...
  br i1 %30, label %31, label %92, !dbg !290
...
; <label>:61:                                     ; preds = %60, %56
  ...
  br i1 %65, label %73, label %66, !dbg !332
...
; <label>:73:                                     ; preds = %66, %71, %61
  %74 = load i8*, i8** %57, align 8, !dbg !344, !tbaa !325
  %75 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %1, i64 0, i32 0, !dbg !345
  store i8* %74, i8** %75, align 8, !dbg !346, !tbaa !321
  %76 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %1, i64 0, i32 8, !dbg !347
  %77 = load i64 (%struct._reent*, i8*, i8*, i32)*, i64 (%struct._reent*, i8*, i8*, i32)** %76, align 8, !dbg !347, !tbaa !348
  %78 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %1, i64 0, i32 7, !dbg !349
  %79 = load i8*, i8** %78, align 8, !dbg !349, !tbaa !350
  %80 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %1, i64 0, i32 5, i32 1, !dbg !351
  %81 = load i32, i32* %80, align 8, !dbg !351, !tbaa !352
  %82 = tail call i64 %77(%struct._reent* %0, i8* %79, i8* %74, i32 %81) #3, !dbg !353
  %83 = trunc i64 %82 to i32, !dbg !353
  store i32 %83, i32* %10, align 8, !dbg !354, !tbaa !257
  %84 = icmp slt i32 %83, 1, !dbg !355
  br i1 %84, label %85, label %92, !dbg !357

; <label>:85:                                     ; preds = %73
  %86 = icmp eq i32 %83, 0, !dbg !358
  br i1 %86, label %88, label %87, !dbg !361

; <label>:87:                                     ; preds = %85
  store i32 0, i32* %10, align 8, !dbg !362, !tbaa !257
  br label %88

; <label>:88:                                     ; preds = %85, %87
  %89 = phi i16 [ 64, %87 ], [ 32, %85 ]
  %90 = load i16, i16* %11, align 8, !dbg !364, !tbaa !265
  %91 = or i16 %90, %89, !dbg !364
  store i16 %91, i16* %11, align 8, !dbg !364, !tbaa !265
  br label %92, !dbg !365

; <label>:92:                                     ; preds = %73, %28, %9, %88, %51, %22
  %93 = phi i32 [ -1, %22 ], [ -1, %88 ], [ 0, %51 ], [ -1, %9 ], [ -1, %28 ], [ 0, %73 ], !dbg !366
  ret i32 %93, !dbg !367
}
...
; Function Attrs: noredzone nounwind
define internal i32 @lflush(%struct.__sFILE*) #0 !dbg !368 {
  %2 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %0, i64 0, i32 3, !dbg !374
  %3 = load i16, i16* %2, align 8, !dbg !374, !tbaa !265
  %4 = and i16 %3, 9, !dbg !376
  %5 = icmp eq i16 %4, 9, !dbg !377
  br i1 %5, label %6, label %8, !dbg !378

; <label>:6:                                      ; preds = %1
  %7 = tail call i32 @fflush(%struct.__sFILE* nonnull %0) #3, !dbg !379
  br label %8, !dbg !380

; <label>:8:                                      ; preds = %1, %6
  %9 = phi i32 [ %7, %6 ], [ 0, %1 ], !dbg !381
  ret i32 %9, !dbg !382
}
...
!344 = !DILocation(line: 118, column: 20, scope: !11)
!345 = !DILocation(line: 118, column: 7, scope: !11)
!346 = !DILocation(line: 118, column: 10, scope: !11)
!347 = !DILocation(line: 119, column: 16, scope: !11)
!348 = !{!258, !251, i64 56}
!349 = !DILocation(line: 119, column: 32, scope: !11)
!350 = !{!258, !251, i64 48}
!351 = !DILocation(line: 119, column: 66, scope: !11)
!352 = !{!258, !248, i64 32}
!353 = !DILocation(line: 119, column: 12, scope: !11)
!354 = !DILocation(line: 119, column: 10, scope: !11)
!355 = !DILocation(line: 121, column: 14, scope: !356)
!356 = distinct !DILexicalBlock(scope: !11, file: !1, line: 121, column: 7)
!357 = !DILocation(line: 121, column: 7, scope: !11)
!358 = !DILocation(line: 128, column: 18, scope: !359)
!359 = distinct !DILexicalBlock(scope: !360, file: !1, line: 128, column: 11)
!360 = distinct !DILexicalBlock(scope: !356, file: !1, line: 127, column: 5)
!361 = !DILocation(line: 128, column: 11, scope: !360)
!362 = !DILocation(line: 132, column: 11, scope: !363)
!363 = distinct !DILexicalBlock(scope: !359, file: !1, line: 131, column: 2)
!364 = !DILocation(line: 0, scope: !359)
!365 = !DILocation(line: 135, column: 7, scope: !360)
!366 = !DILocation(line: 0, scope: !318)
!367 = !DILocation(line: 138, column: 1, scope: !11)
!368 = distinct !DISubprogram(name: "lflush", scope: !1, file: !1, line: 26, type: !369, isLocal: true, isDefinition: true, scopeLine: 28, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !371)
!369 = !DISubroutineType(types: !370)
!370 = !{!14, !231}
!371 = !{!372}
!372 = !DILocalVariable(name: "fp", arg: 1, scope: !368, file: !1, line: 26, type: !231)
!373 = !DILocation(line: 26, column: 1, scope: !368)
!374 = !DILocation(line: 29, column: 12, scope: !375)
!375 = distinct !DILexicalBlock(scope: !368, file: !1, line: 29, column: 7)
!376 = !DILocation(line: 29, column: 19, scope: !375)
!377 = !DILocation(line: 29, column: 39, scope: !375)
!378 = !DILocation(line: 29, column: 7, scope: !368)
!379 = !DILocation(line: 30, column: 12, scope: !375)
!380 = !DILocation(line: 30, column: 5, scope: !375)
!381 = !DILocation(line: 0, scope: !368)
!382 = !DILocation(line: 32, column: 1, scope: !368)
