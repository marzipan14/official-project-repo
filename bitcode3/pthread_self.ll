...
; <label>:11:                                     ; preds = %0
  ...
  br i1 %15, label %28, label %16, !dbg !560
...
; <label>:28:                                     ; preds = %11, %16, %4
  %29 = phi i8* [ %7, %4 ], [ %13, %16 ], [ null, %11 ], !dbg !580
  %30 = phi i32 [ %10, %4 ], [ %14, %16 ], [ %14, %11 ], !dbg !580
  %31 = insertvalue { i8*, i32 } undef, i8* %29, 0, !dbg !581
  %32 = insertvalue { i8*, i32 } %31, i32 %30, 1, !dbg !581
  ret { i8*, i32 } %32, !dbg !581
}
