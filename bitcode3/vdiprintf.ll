...
; <label>:20:                                     ; preds = %3, %17
  ...
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %8) #4, !dbg !303
  call void @llvm.lifetime.end.p0i8(i64 512, i8* nonnull %7) #4, !dbg !303
  ret i32 %21, !dbg !304
}
...
!303 = !DILocation(line: 34, column: 1, scope: !7, inlinedAt: !283)
!304 = !DILocation(line: 44, column: 3, scope: !275)
