...
define internal fastcc void @pte_thread_detach_common(i8 zeroext) unnamed_addr #0 !dbg !542 {
  ...
  br i1 %3, label %33, label %4, !dbg !556
...
; <label>:33:                                     ; preds = %31, %32, %29, %30, %4, %1
  ret void
}

; Function Attrs: noredzone nounwind
define dso_local i32 @pte_thread_detach_np() local_unnamed_addr #0 !dbg !597 {
  %1 = load i32, i32* @pte_processInitialized, align 4, !dbg !600, !tbaa !552
  %2 = icmp eq i32 %1, 0, !dbg !600
  br i1 %2, label %27, label %3, !dbg !601

; <label>:3:                                      ; preds = %0
  %4 = load %struct.pthread_key_t_*, %struct.pthread_key_t_** @pte_selfThreadKey, align 8, !dbg !602, !tbaa !558
  %5 = tail call i8* @pthread_getspecific(%struct.pthread_key_t_* %4) #4, !dbg !603
  %6 = icmp eq i8* %5, null, !dbg !604
  br i1 %6, label %27, label %7, !dbg !605

; <label>:7:                                      ; preds = %3
  %8 = getelementptr inbounds i8, i8* %5, i64 8, !dbg !607
  %9 = bitcast i8* %8 to i8**, !dbg !608
  %10 = load i8*, i8** %9, align 8, !dbg !608
  %11 = getelementptr inbounds i8, i8* %5, i64 16, !dbg !608
  %12 = bitcast i8* %11 to i32*, !dbg !608
  %13 = load i32, i32* %12, align 8, !dbg !608
  tail call void @pte_callUserDestroyRoutines(i8* %10, i32 %13) #4, !dbg !608
  %14 = getelementptr inbounds i8, i8* %5, i64 80, !dbg !609
  %15 = bitcast i8* %14 to %struct.pthread_mutex_t_**, !dbg !609
  %16 = tail call i32 @pthread_mutex_lock(%struct.pthread_mutex_t_** nonnull %15) #4, !dbg !610
  %17 = getelementptr inbounds i8, i8* %5, i64 32, !dbg !611
  %18 = bitcast i8* %17 to i32*, !dbg !611
  store volatile i32 6, i32* %18, align 8, !dbg !612, !tbaa !572
  %19 = tail call i32 @pthread_mutex_unlock(%struct.pthread_mutex_t_** nonnull %15) #4, !dbg !613
  %20 = getelementptr inbounds i8, i8* %5, i64 60, !dbg !614
  %21 = bitcast i8* %20 to i32*, !dbg !614
  %22 = load i32, i32* %21, align 4, !dbg !614, !tbaa !578
  %23 = icmp eq i32 %22, 1, !dbg !615
  br i1 %23, label %24, label %27, !dbg !616

; <label>:24:                                     ; preds = %7
  %25 = load i8*, i8** %9, align 8, !dbg !617
  %26 = load i32, i32* %12, align 8, !dbg !617
  tail call void @pte_threadDestroy(i8* %25, i32 %26) #4, !dbg !618
  br label %27

; <label>:27:                                     ; preds = %7, %0, %3, %24
  ret i32 1, !dbg !619
}
...
!597 = distinct !DISubprogram(name: "pte_thread_detach_np", scope: !1, file: !1, line: 102, type: !537, isLocal: false, isDefinition: true, scopeLine: 103, isOptimized: true, unit: !0, retainedNodes: !539)
!598 = !DILocation(line: 47, column: 41, scope: !542, inlinedAt: !599)
!599 = distinct !DILocation(line: 104, column: 10, scope: !597)
!600 = !DILocation(line: 49, column: 7, scope: !549, inlinedAt: !599)
!601 = !DILocation(line: 49, column: 7, scope: !542, inlinedAt: !599)
!602 = !DILocation(line: 55, column: 65, scope: !548, inlinedAt: !599)
!603 = !DILocation(line: 55, column: 44, scope: !548, inlinedAt: !599)
!604 = !DILocation(line: 57, column: 14, scope: !562, inlinedAt: !599)
!605 = !DILocation(line: 57, column: 11, scope: !548, inlinedAt: !599)
!606 = !DILocation(line: 55, column: 22, scope: !548, inlinedAt: !599)
!607 = !DILocation(line: 60, column: 44, scope: !566, inlinedAt: !599)
!608 = !DILocation(line: 60, column: 11, scope: !566, inlinedAt: !599)
!609 = !DILocation(line: 62, column: 43, scope: !566, inlinedAt: !599)
!610 = !DILocation(line: 62, column: 18, scope: !566, inlinedAt: !599)
!611 = !DILocation(line: 63, column: 15, scope: !566, inlinedAt: !599)
!612 = !DILocation(line: 63, column: 21, scope: !566, inlinedAt: !599)
!613 = !DILocation(line: 69, column: 18, scope: !566, inlinedAt: !599)
!614 = !DILocation(line: 71, column: 19, scope: !577, inlinedAt: !599)
!615 = !DILocation(line: 71, column: 31, scope: !577, inlinedAt: !599)
!616 = !DILocation(line: 71, column: 15, scope: !566, inlinedAt: !599)
!617 = !DILocation(line: 0, scope: !585, inlinedAt: !599)
!618 = !DILocation(line: 79, column: 19, scope: !585, inlinedAt: !599)
!619 = !DILocation(line: 104, column: 3, scope: !597)
