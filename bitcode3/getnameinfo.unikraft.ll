...
; <label>:15:                                     ; preds = %7
  ...
  br i1 %17, label %25, label %84, !dbg !360

; <label>:18:                                     ; preds = %7
  %19 = icmp eq i32 %1, 28, !dbg !361
  br i1 %19, label %20, label %84, !dbg !363
...
; <label>:47:                                     ; preds = %44
  ...
  br i1 %50, label %51, label %84, !dbg !399
...
; <label>:57:                                     ; preds = %54, %35
  %58 = call i32 @fclose(%struct.__sFILE* nonnull %33) #5, !dbg !403
  br label %59, !dbg !403

; <label>:59:                                     ; preds = %57, %29, %20
  %60 = phi i8* [ %21, %20 ], [ %16, %29 ], [ %16, %57 ]
  %61 = and i32 %6, 8, !dbg !405
  %62 = icmp eq i32 %61, 0, !dbg !405
  br i1 %62, label %63, label %84, !dbg !410

; <label>:63:                                     ; preds = %59
  %64 = call i8* @inet_ntop(i32 %13, i8* %60, i8* nonnull %10, i32 256) #5, !dbg !411
  %65 = call i64 @strlen(i8* nonnull %10) #5, !dbg !412
  %66 = zext i32 %3 to i64, !dbg !414
  %67 = icmp ult i64 %65, %66, !dbg !415
  br i1 %67, label %68, label %84, !dbg !416

; <label>:68:                                     ; preds = %63
  %69 = call i8* @strcpy(i8* %2, i8* nonnull %10) #5, !dbg !417
  br label %70, !dbg !418

; <label>:70:                                     ; preds = %25, %20, %68
  %71 = icmp ne i8* %4, null, !dbg !419
  %72 = icmp ne i32 %5, 0, !dbg !421
  %73 = and i1 %71, %72, !dbg !422
  br i1 %73, label %74, label %84, !dbg !422

; <label>:74:                                     ; preds = %70
  %75 = getelementptr inbounds %struct.sockaddr, %struct.sockaddr* %0, i64 0, i32 2, !dbg !423
  %76 = bitcast [14 x i8]* %75 to i16*, !dbg !423
  %77 = load i16, i16* %76, align 2, !dbg !423, !tbaa !426
  %78 = call zeroext i16 @lwip_htons(i16 zeroext %77) #5, !dbg !423
  %79 = zext i16 %78 to i32, !dbg !423
  %80 = call i32 (i8*, i64, i8*, ...) @snprintf(i8* nonnull %10, i64 256, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @getnameinfo.__str, i64 0, i64 0), i32 %79) #5, !dbg !431
  %81 = icmp slt i32 %80, %5, !dbg !432
  br i1 %81, label %82, label %84, !dbg !433

; <label>:82:                                     ; preds = %74
  %83 = call i8* @strcpy(i8* nonnull %4, i8* nonnull %10) #5, !dbg !434
  br label %84, !dbg !435

; <label>:84:                                     ; preds = %47, %51, %70, %82, %74, %63, %59, %7, %18, %15
  %85 = phi i32 [ 204, %15 ], [ 204, %18 ], [ 204, %7 ], [ 200, %59 ], [ -12, %63 ], [ -12, %74 ], [ 0, %82 ], [ 0, %70 ], [ -12, %47 ], [ 0, %51 ]
  call void @llvm.lifetime.end.p0i8(i64 512, i8* nonnull %14) #4, !dbg !436
  call void @llvm.lifetime.end.p0i8(i64 256, i8* nonnull %10) #4, !dbg !436
  ret i32 %85, !dbg !436
}
...
!403 = !DILocation(line: 122, column: 4, scope: !404)
!404 = distinct !DILexicalBlock(scope: !321, file: !3, line: 121, column: 7)
!405 = !DILocation(line: 135, column: 14, scope: !406)
!406 = distinct !DILexicalBlock(scope: !407, file: !3, line: 135, column: 8)
!407 = distinct !DILexicalBlock(scope: !408, file: !3, line: 133, column: 10)
!408 = distinct !DILexicalBlock(scope: !409, file: !3, line: 127, column: 7)
!409 = distinct !DILexicalBlock(scope: !369, file: !3, line: 126, column: 23)
!410 = !DILocation(line: 135, column: 8, scope: !407)
!411 = !DILocation(line: 137, column: 4, scope: !407)
!412 = !DILocation(line: 139, column: 7, scope: !413)
!413 = distinct !DILexicalBlock(scope: !409, file: !3, line: 139, column: 7)
!414 = !DILocation(line: 139, column: 22, scope: !413)
!415 = !DILocation(line: 139, column: 19, scope: !413)
!416 = !DILocation(line: 139, column: 7, scope: !409)
!417 = !DILocation(line: 141, column: 3, scope: !409)
!418 = !DILocation(line: 142, column: 2, scope: !409)
!419 = !DILocation(line: 144, column: 6, scope: !420)
!420 = distinct !DILexicalBlock(scope: !2, file: !3, line: 144, column: 6)
!421 = !DILocation(line: 144, column: 14, scope: !420)
!422 = !DILocation(line: 144, column: 11, scope: !420)
!423 = !DILocation(line: 146, column: 4, scope: !424)
!424 = distinct !DILexicalBlock(scope: !425, file: !3, line: 145, column: 7)
!425 = distinct !DILexicalBlock(scope: !420, file: !3, line: 144, column: 23)
!426 = !{!427, !428, i64 2}
!427 = !{!"sockaddr_in", !348, i64 0, !348, i64 1, !428, i64 2, !429, i64 4, !348, i64 8}
!428 = !{!"short", !348, i64 0}
!429 = !{!"in_addr", !430, i64 0}
!430 = !{!"int", !348, i64 0}
!431 = !DILocation(line: 145, column: 7, scope: !424)
!432 = !DILocation(line: 146, column: 50, scope: !424)
!433 = !DILocation(line: 145, column: 7, scope: !425)
!434 = !DILocation(line: 148, column: 3, scope: !425)
!435 = !DILocation(line: 149, column: 2, scope: !425)
!436 = !DILocation(line: 152, column: 1, scope: !2)
