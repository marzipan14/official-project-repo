; ModuleID = '/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/search/qsort_r.c'
source_filename = "/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/search/qsort_r.c"
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu"

; Function Attrs: noredzone nounwind
define dso_local void @qsort_r(i8*, i64, i64, i32 (i8*, i8*, i8*)*, i8*) local_unnamed_addr #0 !dbg !12 {
...
; <label>:301:                                    ; preds = %289, %496
  ...
  %323 = tail call i32 %3(i8* %322, i8* %303, i8* %4) #2, !dbg !98
...
; <label>:518:                                    ; preds = %513
  ...
  %524 = tail call i32 %3(i8* %507, i8* %521, i8* %4) #2, !dbg !192
  %525 = icmp slt i32 %524, 0, !dbg !193
  %526 = tail call i32 %3(i8* %521, i8* %523, i8* %4) #2, !dbg !194
...
; <label>:529:                                    ; preds = %527
  %530 = tail call i32 %3(i8* %507, i8* %523, i8* %4) #2, !dbg !197
...
; <label>:535:                                    ; preds = %533
  %536 = tail call i32 %3(i8* %507, i8* %523, i8* %4) #2, !dbg !201
...
; <label>:539:                                    ; preds = %527, %529, %533, %535
  ...
  %544 = tail call i32 %3(i8* %542, i8* %511, i8* %4) #2, !dbg !207
  %545 = icmp slt i32 %544, 0, !dbg !208
  %546 = tail call i32 %3(i8* %511, i8* %543, i8* %4) #2, !dbg !209
...
; <label>:549:                                    ; preds = %547
  %550 = tail call i32 %3(i8* %542, i8* %543, i8* %4) #2, !dbg !212
...
; <label>:555:                                    ; preds = %553
  %556 = tail call i32 %3(i8* %542, i8* %543, i8* %4) #2, !dbg !216
...
; <label>:559:                                    ; preds = %547, %549, %553, %555
  ...
  %564 = tail call i32 %3(i8* %562, i8* %563, i8* %4) #2, !dbg !222
  %565 = icmp slt i32 %564, 0, !dbg !223
  %566 = tail call i32 %3(i8* %563, i8* %516, i8* %4) #2, !dbg !224
...
; <label>:569:                                    ; preds = %567
  %570 = tail call i32 %3(i8* %562, i8* %516, i8* %4) #2, !dbg !227
...
; <label>:575:                                    ; preds = %573
  %576 = tail call i32 %3(i8* %562, i8* %516, i8* %4) #2, !dbg !231
...
; <label>:579:                                    ; preds = %575, %573, %569, %567, %513
  ...
  %583 = tail call i32 %3(i8* %582, i8* %581, i8* %4) #2, !dbg !237
  %584 = icmp slt i32 %583, 0, !dbg !238
  %585 = tail call i32 %3(i8* %581, i8* %580, i8* %4) #2, !dbg !239
...
; <label>:588:                                    ; preds = %586
  %589 = tail call i32 %3(i8* %582, i8* %580, i8* %4) #2, !dbg !242
...
; <label>:594:                                    ; preds = %592
  %595 = tail call i32 %3(i8* %582, i8* %580, i8* %4) #2, !dbg !246
...
; <label>:787:                                    ; preds = %780, %979
  ...
  %800 = tail call i32 %3(i8* %790, i8* %507, i8* %4) #2, !dbg !286
...
; <label>:990:                                    ; preds = %985, %1182
  ...
  %1003 = tail call i32 %3(i8* %992, i8* %507, i8* %4) #2, !dbg !91
...
; <label>:1440:                                   ; preds = %1428, %1635
  ...
  %1462 = tail call i32 %3(i8* %1461, i8* %1442, i8* %4) #2, !dbg !390
...
; <label>:2120:                                   ; preds = %2118
  ...
  tail call void @qsort_r(i8* %507, i64 %2121, i64 %2, i32 (i8*, i8*, i8*)* %3, i8* %4) #4, !dbg !480
...
!1 = !DIFile(filename: "/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/search/qsort_r.c", directory: "/root/.unikraft/apps/redis/build")
!2 = !{}
!3 = !{!4, !6}
...
!12 = distinct !DISubprogram(name: "qsort_r", scope: !13, file: !13, line: 168, type: !14, isLocal: false, isDefinition: true, scopeLine: 183, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !27)
...
!21 = !DIDerivedType(tag: DW_TAG_typedef, name: "cmp_t", file: !13, line: 84, baseType: !22)
...
!28 = !DILocalVariable(name: "a", arg: 1, scope: !12, file: !13, line: 168, type: !16)
!29 = !DILocalVariable(name: "n", arg: 2, scope: !12, file: !13, line: 168, type: !17)
!30 = !DILocalVariable(name: "es", arg: 3, scope: !12, file: !13, line: 168, type: !17)
!31 = !DILocalVariable(name: "cmp", arg: 4, scope: !12, file: !13, line: 168, type: !20)
!32 = !DILocalVariable(name: "thunk", arg: 5, scope: !12, file: !13, line: 168, type: !16)
...
!85 = !DILocation(line: 168, column: 1, scope: !12)
...
!479 = !DILocation(line: 255, column: 16, scope: !477)
!480 = !DILocation(line: 255, column: 3, scope: !477)
