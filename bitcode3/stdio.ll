...
define dso_local i64 @__sread(%struct._reent*, i8* nocapture, i8*, i32) local_unnamed_addr #0 !dbg !231 {
  ...
  %10 = tail call i64 @_read_r(%struct._reent* %0, i32 %8, i8* %2, i64 %9) #4, !dbg !255
...
define dso_local i64 @__seofread(%struct._reent* nocapture readnone, i8* nocapture readnone, i8* nocapture readnone, i32) local_unnamed_addr #2 !dbg !269 {
  ret i64 0, !dbg !276
}
...
; <label>:12:                                     ; preds = %4
  ...
  %15 = tail call i64 @_lseek_r(%struct._reent* %0, i32 %14, i64 0, i32 2) #4, !dbg !294
...
; <label>:17:                                     ; preds = %4, %12
  ...
  %23 = tail call i64 @_write_r(%struct._reent* %0, i32 %21, i8* %2, i64 %22) #4, !dbg !299
  ret i64 %23, !dbg !301
}
...
define dso_local i64 @__sseek(%struct._reent*, i8* nocapture, i64, i32) local_unnamed_addr #0 !dbg !302 {
  ...
  %9 = tail call i64 @_lseek_r(%struct._reent* %0, i32 %8, i64 %2, i32 %3) #4, !dbg !313
...
define dso_local i32 @__sclose(%struct._reent*, i8* nocapture readonly) local_unnamed_addr #0 !dbg !327 {
  ...
  %7 = tail call i32 @_close_r(%struct._reent* %0, i32 %6) #4, !dbg !336
  ret i32 %7, !dbg !337
}
