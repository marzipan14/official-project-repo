...
; <label>:10:                                     ; preds = %7
  ...
  ret double %13, !dbg !34

; <label>:14:                                     ; preds = %7
  %15 = lshr i32 %0, 1, !dbg !41
  %16 = tail call double @__exp10(i32 %15) #2, !dbg !42
  %17 = fmul double %16, %16, !dbg !44
  ret double %17, !dbg !34
}
...
!41 = !DILocation(line: 27, column: 29, scope: !14)
!42 = !DILocation(line: 27, column: 18, scope: !14)
!43 = !DILocation(line: 27, column: 14, scope: !14)
!44 = !DILocation(line: 28, column: 16, scope: !14)
