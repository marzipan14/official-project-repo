; ModuleID = '/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/stdio/fgetc_u.c'
source_filename = "/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/stdio/fgetc_u.c"
...
define dso_local i32 @_fgetc_unlocked_r(%struct._reent*, %struct.__sFILE*) local_unnamed_addr #0 !dbg !9 {
  %3 = icmp eq %struct._reent* %0, null, !dbg !241
  br i1 %3, label %9, label %4, !dbg !241

; <label>:4:                                      ; preds = %2
  %5 = getelementptr inbounds %struct._reent, %struct._reent* %0, i64 0, i32 8, !dbg !241
  %6 = load i32, i32* %5, align 8, !dbg !241, !tbaa !243
  %7 = icmp eq i32 %6, 0, !dbg !241
  br i1 %7, label %8, label %9, !dbg !240

; <label>:8:                                      ; preds = %4
  tail call void @__sinit(%struct._reent* nonnull %0) #3, !dbg !241
  br label %9, !dbg !241

; <label>:9:                                      ; preds = %4, %2, %8
  %10 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %1, i64 0, i32 1, !dbg !252
  %11 = load i32, i32* %10, align 8, !dbg !252, !tbaa !253
  %12 = add nsw i32 %11, -1, !dbg !252
  store i32 %12, i32* %10, align 8, !dbg !252, !tbaa !253
  %13 = icmp slt i32 %11, 1, !dbg !252
  br i1 %13, label %14, label %16, !dbg !252

; <label>:14:                                     ; preds = %9
  %15 = tail call i32 @__srget_r(%struct._reent* %0, %struct.__sFILE* nonnull %1) #3, !dbg !252
  br label %22, !dbg !252

; <label>:16:                                     ; preds = %9
  %17 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %1, i64 0, i32 0, !dbg !252
  %18 = load i8*, i8** %17, align 8, !dbg !252, !tbaa !259
  %19 = getelementptr inbounds i8, i8* %18, i64 1, !dbg !252
  store i8* %19, i8** %17, align 8, !dbg !252, !tbaa !259
  %20 = load i8, i8* %18, align 1, !dbg !252, !tbaa !260
  %21 = zext i8 %20 to i32, !dbg !252
  br label %22, !dbg !252

; <label>:22:                                     ; preds = %16, %14
  %23 = phi i32 [ %15, %14 ], [ %21, %16 ], !dbg !252
  ret i32 %23, !dbg !261
}
...
; Function Attrs: noredzone nounwind
define dso_local i32 @fgetc_unlocked(%struct.__sFILE*) local_unnamed_addr #0 !dbg !262 {
  %2 = tail call %struct._reent* @__getreent() #3, !dbg !271
  %3 = icmp eq %struct._reent* %2, null, !dbg !274
  br i1 %3, label %9, label %4, !dbg !274

; <label>:4:                                      ; preds = %1
  %5 = getelementptr inbounds %struct._reent, %struct._reent* %2, i64 0, i32 8, !dbg !274
  %6 = load i32, i32* %5, align 8, !dbg !274, !tbaa !243
  %7 = icmp eq i32 %6, 0, !dbg !274
  br i1 %7, label %8, label %9, !dbg !273

; <label>:8:                                      ; preds = %4
  tail call void @__sinit(%struct._reent* nonnull %2) #3, !dbg !274
  br label %9, !dbg !274

; <label>:9:                                      ; preds = %4, %1, %8
  %10 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %0, i64 0, i32 1, !dbg !276
  %11 = load i32, i32* %10, align 8, !dbg !276, !tbaa !253
  %12 = add nsw i32 %11, -1, !dbg !276
  store i32 %12, i32* %10, align 8, !dbg !276, !tbaa !253
  %13 = icmp slt i32 %11, 1, !dbg !276
  br i1 %13, label %14, label %16, !dbg !276

; <label>:14:                                     ; preds = %9
  %15 = tail call i32 @__srget_r(%struct._reent* %2, %struct.__sFILE* nonnull %0) #3, !dbg !276
  br label %22, !dbg !276

; <label>:16:                                     ; preds = %9
  %17 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %0, i64 0, i32 0, !dbg !276
  %18 = load i8*, i8** %17, align 8, !dbg !276, !tbaa !259
  %19 = getelementptr inbounds i8, i8* %18, i64 1, !dbg !276
  store i8* %19, i8** %17, align 8, !dbg !276, !tbaa !259
  %20 = load i8, i8* %18, align 1, !dbg !276, !tbaa !260
  %21 = zext i8 %20 to i32, !dbg !276
  br label %22, !dbg !276

; <label>:22:                                     ; preds = %16, %14
  %23 = phi i32 [ %15, %14 ], [ %21, %16 ], !dbg !276
  ret i32 %23, !dbg !277
}
...
!1 = !DIFile(filename: "/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/stdio/fgetc_u.c", directory: "/root/.unikraft/apps/redis/build")
!2 = !{}
!3 = !{!4}
...
!9 = distinct !DISubprogram(name: "_fgetc_unlocked_r", scope: !1, file: !1, line: 32, type: !10, isLocal: false, isDefinition: true, scopeLine: 35, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !234)
...
!234 = !{!235, !236, !237}
!235 = !DILocalVariable(name: "ptr", arg: 1, scope: !9, file: !1, line: 32, type: !12)
!236 = !DILocalVariable(name: "fp", arg: 2, scope: !9, file: !1, line: 32, type: !231)
!237 = !DILocalVariable(name: "_check_init_ptr", scope: !238, file: !1, line: 36, type: !12)
!238 = distinct !DILexicalBlock(scope: !9, file: !1, line: 36, column: 3)
!239 = !DILocation(line: 32, column: 1, scope: !9)
!240 = !DILocation(line: 36, column: 3, scope: !238)
!241 = !DILocation(line: 36, column: 3, scope: !242)
!242 = distinct !DILexicalBlock(scope: !238, file: !1, line: 36, column: 3)
!243 = !{!244, !245, i64 80}
...
!252 = !DILocation(line: 37, column: 10, scope: !9)
!253 = !{!254, !245, i64 8}
...
!259 = !{!254, !248, i64 0}
!260 = !{!246, !246, i64 0}
!261 = !DILocation(line: 37, column: 3, scope: !9)
!262 = distinct !DISubprogram(name: "fgetc_unlocked", scope: !1, file: !1, line: 43, type: !263, isLocal: false, isDefinition: true, scopeLine: 45, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !265)
!263 = !DISubroutineType(types: !264)
!264 = !{!4, !231}
!265 = !{!266, !267, !268}
!266 = !DILocalVariable(name: "fp", arg: 1, scope: !262, file: !1, line: 43, type: !231)
!267 = !DILocalVariable(name: "reent", scope: !262, file: !1, line: 47, type: !12)
!268 = !DILocalVariable(name: "_check_init_ptr", scope: !269, file: !1, line: 49, type: !12)
!269 = distinct !DILexicalBlock(scope: !262, file: !1, line: 49, column: 3)
!270 = !DILocation(line: 43, column: 1, scope: !262)
!271 = !DILocation(line: 47, column: 26, scope: !262)
!272 = !DILocation(line: 47, column: 18, scope: !262)
!273 = !DILocation(line: 49, column: 3, scope: !269)
!274 = !DILocation(line: 49, column: 3, scope: !275)
!275 = distinct !DILexicalBlock(scope: !269, file: !1, line: 49, column: 3)
!276 = !DILocation(line: 50, column: 10, scope: !262)
!277 = !DILocation(line: 50, column: 3, scope: !262)
