; ModuleID = '/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/ctype/iswalnum_l.c'
source_filename = "/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/ctype/iswalnum_l.c"
...
define dso_local i32 @iswalnum_l(i32, %struct.__locale_t* nocapture readnone) local_unnamed_addr #0 !dbg !7 {
  %3 = tail call i32 @iswalpha(i32 %0) #3, !dbg !22
  %4 = icmp eq i32 %3, 0, !dbg !22
  br i1 %4, label %5, label %9, !dbg !23

; <label>:5:                                      ; preds = %2
  %6 = tail call i32 @iswdigit(i32 %0) #3, !dbg !24
  %7 = icmp ne i32 %6, 0, !dbg !23
  %8 = zext i1 %7 to i32, !dbg !23
  br label %9, !dbg !23
...
!1 = !DIFile(filename: "/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/ctype/iswalnum_l.c", directory: "/root/.unikraft/apps/redis/build")
!2 = !{}
!3 = !{i32 2, !"Dwarf Version", i32 4}
!4 = !{i32 2, !"Debug Info Version", i32 3}
!5 = !{i32 1, !"wchar_size", i32 4}
!6 = !{!"clang version 7.0.1-8+deb10u2 (tags/RELEASE_701/final)"}
!7 = distinct !DISubprogram(name: "iswalnum_l", scope: !1, file: !1, line: 5, type: !8, isLocal: false, isDefinition: true, scopeLine: 6, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !17)
...
!24 = !DILocation(line: 9, column: 26, scope: !7)
