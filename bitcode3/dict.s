...
# %bb.0:
	...
	movq	%rbx, (%rax)
	movq	%r14, 8(%rax)
	movaps	.LCPI4_0(%rip), %xmm0   # xmm0 = [0,0,0,0,0,0,0,0,255,255,255,255,255,255,255,255]
	movups	%xmm0, 72(%rax)
	movq	$0, 88(%rax)
	popq	%rbx
	popq	%r14
...
.Lfunc_end6:
	.size	dictExpand, .Lfunc_end6-dictExpand
                                        # -- End function
	.section	.rodata.cst16,"aM",@progbits,16
	.p2align	4               # -- Begin function dictRehash
.LCPI7_0:
	.byte	0                       # 0x0
	.byte	0                       # 0x0
	.byte	0                       # 0x0
...
# %bb.13:
	...
	xorps	%xmm0, %xmm0
	movups	%xmm0, 56(%r15)
	movaps	.LCPI7_0(%rip), %xmm0   # xmm0 = [0,0,0,0,0,0,0,0,255,255,255,255,255,255,255,255]
	movups	%xmm0, 72(%r15)
	xorl	%eax, %eax
.LBB7_14:
	addq	$8, %rsp
...
.LBB15_27:                              #   in Loop: Header=BB15_13 Depth=1
	...
	testq	%r13, %r13
	je	.LBB15_28
# %bb.11:                               #   in Loop: Header=BB15_13 Depth=1
	movq	(%r13), %rdx
	movq	%r14, %rbx
	cmpq	%r12, %rdx
	jne	.LBB15_13
...
# %bb.36:                               #   in Loop: Header=BB15_35 Depth=1
	...
	testl	%eax, %eax
	jne	.LBB15_37
.LBB15_31:                              #   in Loop: Header=BB15_35 Depth=1
	movq	16(%rbx), %r13
	testq	%r13, %r13
	je	.LBB15_29
# %bb.32:                               #   in Loop: Header=BB15_35 Depth=1
	movq	(%r13), %rdx
	movq	%rbx, %r14
	cmpq	%r12, %rdx
	jne	.LBB15_35
...
# %bb.0:
	movl	$1, %edx
	jmp	dictGenericDelete       # TAILCALL
.Lfunc_end16:
