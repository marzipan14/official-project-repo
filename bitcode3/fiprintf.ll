; ModuleID = '/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/stdio/fiprintf.c'
source_filename = "/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/stdio/fiprintf.c"
...
define dso_local i32 @_fiprintf_r(%struct._reent*, %struct.__sFILE*, i8*, ...) local_unnamed_addr #0 !dbg !7 {
  %4 = alloca [1 x %struct.__va_list_tag], align 16
  %5 = bitcast [1 x %struct.__va_list_tag]* %4 to i8*, !dbg !251
  call void @llvm.lifetime.start.p0i8(i64 24, i8* nonnull %5) #3, !dbg !251
  %6 = getelementptr inbounds [1 x %struct.__va_list_tag], [1 x %struct.__va_list_tag]* %4, i64 0, i64 0, !dbg !253
  call void @llvm.va_start(i8* nonnull %5), !dbg !253
  %7 = call i32 @_vfiprintf_r(%struct._reent* %0, %struct.__sFILE* %1, i8* %2, %struct.__va_list_tag* nonnull %6) #5, !dbg !254
  call void @llvm.va_end(i8* nonnull %5), !dbg !256
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %5) #3, !dbg !257
  ret i32 %7, !dbg !258
}
...
declare dso_local i32 @_vfiprintf_r(%struct._reent*, %struct.__sFILE*, i8*, %struct.__va_list_tag*) local_unnamed_addr #4
...
; Function Attrs: noredzone nounwind
define dso_local i32 @fiprintf(%struct.__sFILE*, i8*, ...) local_unnamed_addr #0 !dbg !259 {
  ...
  %5 = getelementptr inbounds [1 x %struct.__va_list_tag], [1 x %struct.__va_list_tag]* %3, i64 0, i64 0, !dbg !270
  call void @llvm.va_start(i8* nonnull %4), !dbg !270
  %6 = call %struct._reent* @__getreent() #5, !dbg !271
  %7 = call i32 @_vfiprintf_r(%struct._reent* %6, %struct.__sFILE* %0, i8* %1, %struct.__va_list_tag* nonnull %5) #5, !dbg !272
  call void @llvm.va_end(i8* nonnull %4), !dbg !274
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %4) #3, !dbg !275
  ret i32 %7, !dbg !276
}
...
!1 = !DIFile(filename: "/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/stdio/fiprintf.c", directory: "/root/.unikraft/apps/redis/build")
!2 = !{}
!3 = !{i32 2, !"Dwarf Version", i32 4}
!4 = !{i32 2, !"Debug Info Version", i32 3}
!5 = !{i32 1, !"wchar_size", i32 4}
!6 = !{!"clang version 7.0.1-8+deb10u2 (tags/RELEASE_701/final)"}
!7 = distinct !DISubprogram(name: "_fiprintf_r", scope: !1, file: !1, line: 25, type: !8, isLocal: false, isDefinition: true, scopeLine: 29, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !233)
...
!234 = !DILocalVariable(name: "ptr", arg: 1, scope: !7, file: !1, line: 25, type: !11)
!235 = !DILocalVariable(name: "fp", arg: 2, scope: !7, file: !1, line: 25, type: !230)
!236 = !DILocalVariable(name: "fmt", arg: 3, scope: !7, file: !1, line: 25, type: !50)
!237 = !DILocalVariable(name: "ret", scope: !7, file: !1, line: 30, type: !10)
!238 = !DILocalVariable(name: "ap", scope: !7, file: !1, line: 31, type: !239)
!239 = !DIDerivedType(tag: DW_TAG_typedef, name: "va_list", file: !232, line: 46, baseType: !240)
...
!242 = !DIDerivedType(tag: DW_TAG_typedef, name: "__builtin_va_list", file: !1, line: 31, baseType: !243)
!243 = !DICompositeType(tag: DW_TAG_array_type, baseType: !244, size: 192, elements: !70)
!244 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "__va_list_tag", file: !1, line: 31, size: 192, elements: !245)
!245 = !{!246, !247, !248, !249}
!246 = !DIDerivedType(tag: DW_TAG_member, name: "gp_offset", scope: !244, file: !1, line: 31, baseType: !92, size: 32)
!247 = !DIDerivedType(tag: DW_TAG_member, name: "fp_offset", scope: !244, file: !1, line: 31, baseType: !92, size: 32, offset: 32)
!248 = !DIDerivedType(tag: DW_TAG_member, name: "overflow_arg_area", scope: !244, file: !1, line: 31, baseType: !36, size: 64, offset: 64)
!249 = !DIDerivedType(tag: DW_TAG_member, name: "reg_save_area", scope: !244, file: !1, line: 31, baseType: !36, size: 64, offset: 128)
!250 = !DILocation(line: 25, column: 1, scope: !7)
!251 = !DILocation(line: 31, column: 3, scope: !7)
!252 = !DILocation(line: 31, column: 11, scope: !7)
!253 = !DILocation(line: 33, column: 3, scope: !7)
!254 = !DILocation(line: 34, column: 9, scope: !7)
!255 = !DILocation(line: 30, column: 7, scope: !7)
!256 = !DILocation(line: 35, column: 3, scope: !7)
!257 = !DILocation(line: 37, column: 1, scope: !7)
!258 = !DILocation(line: 36, column: 3, scope: !7)
!259 = distinct !DISubprogram(name: "fiprintf", scope: !1, file: !1, line: 42, type: !260, isLocal: false, isDefinition: true, scopeLine: 45, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !262)
!260 = !DISubroutineType(types: !261)
!261 = !{!10, !230, !50, null}
!262 = !{!263, !264, !265, !266}
!263 = !DILocalVariable(name: "fp", arg: 1, scope: !259, file: !1, line: 42, type: !230)
!264 = !DILocalVariable(name: "fmt", arg: 2, scope: !259, file: !1, line: 42, type: !50)
!265 = !DILocalVariable(name: "ret", scope: !259, file: !1, line: 46, type: !10)
!266 = !DILocalVariable(name: "ap", scope: !259, file: !1, line: 47, type: !239)
!267 = !DILocation(line: 42, column: 1, scope: !259)
!268 = !DILocation(line: 47, column: 3, scope: !259)
!269 = !DILocation(line: 47, column: 11, scope: !259)
!270 = !DILocation(line: 49, column: 3, scope: !259)
!271 = !DILocation(line: 50, column: 23, scope: !259)
!272 = !DILocation(line: 50, column: 9, scope: !259)
!273 = !DILocation(line: 46, column: 7, scope: !259)
!274 = !DILocation(line: 51, column: 3, scope: !259)
!275 = !DILocation(line: 53, column: 1, scope: !259)
!276 = !DILocation(line: 52, column: 3, scope: !259)
