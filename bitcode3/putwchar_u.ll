; ModuleID = '/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/stdio/putwchar_u.c'
source_filename = "/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/stdio/putwchar_u.c"
...
define dso_local i32 @_putwchar_unlocked_r(%struct._reent*, i32) local_unnamed_addr #0 !dbg !7 {
  %3 = tail call %struct._reent* @__getreent() #3, !dbg !235
  %4 = getelementptr inbounds %struct._reent, %struct._reent* %3, i64 0, i32 2, !dbg !235
  %5 = load %struct.__sFILE*, %struct.__sFILE** %4, align 8, !dbg !235, !tbaa !236
  %6 = tail call i32 @_fputwc_unlocked_r(%struct._reent* %0, i32 %1, %struct.__sFILE* %5) #3, !dbg !245
  ret i32 %6, !dbg !246
}

; Function Attrs: noredzone
declare dso_local i32 @_fputwc_unlocked_r(%struct._reent*, i32, %struct.__sFILE*) local_unnamed_addr #1

; Function Attrs: noredzone
declare dso_local %struct._reent* @__getreent() local_unnamed_addr #1

; Function Attrs: noredzone nounwind
define dso_local i32 @putwchar_unlocked(i32) local_unnamed_addr #0 !dbg !247 {
  %2 = tail call %struct._reent* @__getreent() #3, !dbg !253
  %3 = getelementptr inbounds %struct._reent, %struct._reent* %2, i64 0, i32 2, !dbg !253
  %4 = load %struct.__sFILE*, %struct.__sFILE** %3, align 8, !dbg !253, !tbaa !236
  %5 = tail call i32 @fputwc_unlocked(i32 %0, %struct.__sFILE* %4) #3, !dbg !254
  ret i32 %5, !dbg !255
}

; Function Attrs: noredzone
declare dso_local i32 @fputwc_unlocked(i32, %struct.__sFILE*) local_unnamed_addr #1
...
!1 = !DIFile(filename: "/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/stdio/putwchar_u.c", directory: "/root/.unikraft/apps/redis/build")
!2 = !{}
!3 = !{i32 2, !"Dwarf Version", i32 4}
!4 = !{i32 2, !"Debug Info Version", i32 3}
!5 = !{i32 1, !"wchar_size", i32 4}
!6 = !{!"clang version 7.0.1-8+deb10u2 (tags/RELEASE_701/final)"}
!7 = distinct !DISubprogram(name: "_putwchar_unlocked_r", scope: !1, file: !1, line: 37, type: !8, isLocal: false, isDefinition: true, scopeLine: 40, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !231)
...
!231 = !{!232, !233}
!232 = !DILocalVariable(name: "ptr", arg: 1, scope: !7, file: !1, line: 37, type: !13)
!233 = !DILocalVariable(name: "wc", arg: 2, scope: !7, file: !1, line: 37, type: !230)
!234 = !DILocation(line: 37, column: 1, scope: !7)
!235 = !DILocation(line: 41, column: 39, scope: !7)
!236 = !{!237, !241, i64 16}
!237 = !{!"_reent", !238, i64 0, !241, i64 8, !241, i64 16, !241, i64 24, !238, i64 32, !239, i64 36, !238, i64 64, !241, i64 72, !238, i64 80, !241, i64 88, !241, i64 96, !238, i64 104, !241, i64 112, !241, i64 120, !238, i64 128, !241, i64 136, !239, i64 144, !241, i64 504, !242, i64 512, !241, i64 1304, !244, i64 1312, !239, i64 1336}
!238 = !{!"int", !239, i64 0}
!239 = !{!"omnipotent char", !240, i64 0}
!240 = !{!"Simple C/C++ TBAA"}
!241 = !{!"any pointer", !239, i64 0}
!242 = !{!"_atexit", !241, i64 0, !238, i64 8, !239, i64 16, !243, i64 272}
!243 = !{!"_on_exit_args", !239, i64 0, !239, i64 256, !238, i64 512, !238, i64 516}
!244 = !{!"_glue", !241, i64 0, !238, i64 8, !241, i64 16}
!245 = !DILocation(line: 41, column: 10, scope: !7)
!246 = !DILocation(line: 41, column: 3, scope: !7)
!247 = distinct !DISubprogram(name: "putwchar_unlocked", scope: !1, file: !1, line: 48, type: !248, isLocal: false, isDefinition: true, scopeLine: 50, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !250)
!248 = !DISubroutineType(types: !249)
!249 = !{!10, !230}
!250 = !{!251}
!251 = !DILocalVariable(name: "wc", arg: 1, scope: !247, file: !1, line: 48, type: !230)
!252 = !DILocation(line: 48, column: 1, scope: !247)
!253 = !DILocation(line: 52, column: 31, scope: !247)
!254 = !DILocation(line: 52, column: 10, scope: !247)
!255 = !DILocation(line: 52, column: 3, scope: !247)
