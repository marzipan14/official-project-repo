...
; <label>:43:                                     ; preds = %31, %25
  %44 = load i32, i32* %3, align 4, !dbg !611, !tbaa !548
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %12) #4, !dbg !577
  %45 = icmp eq i32 %44, 0, !dbg !613
  br i1 %45, label %49, label %46, !dbg !561

; <label>:46:                                     ; preds = %21, %10, %43
  %47 = phi i32 [ 22, %10 ], [ %44, %43 ], [ %19, %21 ]
  %48 = call i32* @__errno() #5, !dbg !614
  store i32 %47, i32* %48, align 4, !dbg !616, !tbaa !548
  br label %49, !dbg !617

; <label>:49:                                     ; preds = %40, %43, %46
  %50 = phi i32 [ -1, %46 ], [ -1, %40 ], [ 0, %43 ], !dbg !618
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %7) #4, !dbg !619
  ret i32 %50, !dbg !619
}
...
; Function Attrs: noredzone nounwind
define internal void @pte_sem_timedwait_cleanup(i8* nocapture readonly) #0 !dbg !620 {
  %2 = alloca i32, align 4
  %3 = bitcast i8* %0 to %struct.sem_t_**, !dbg !630
  %4 = load %struct.sem_t_*, %struct.sem_t_** %3, align 8, !dbg !630, !tbaa !593
  %5 = getelementptr inbounds %struct.sem_t_, %struct.sem_t_* %4, i64 0, i32 1, !dbg !632
  %6 = tail call i32 @pthread_mutex_lock(%struct.pthread_mutex_t_** nonnull %5) #5, !dbg !633
  %7 = icmp eq i32 %6, 0, !dbg !634
  br i1 %7, label %8, label %24, !dbg !635

; <label>:8:                                      ; preds = %1
  %9 = bitcast i32* %2 to i8*, !dbg !636
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %9) #4, !dbg !636
  store i32 0, i32* %2, align 4, !dbg !637, !tbaa !548
  %10 = getelementptr inbounds %struct.sem_t_, %struct.sem_t_* %4, i64 0, i32 2, !dbg !638
  %11 = load %struct.uk_semaphore*, %struct.uk_semaphore** %10, align 8, !dbg !638, !tbaa !600
  %12 = call i32 @pte_osSemaphorePend(%struct.uk_semaphore* %11, i32* nonnull %2) #5, !dbg !640
  %13 = icmp eq i32 %12, 0, !dbg !641
  br i1 %13, label %14, label %18, !dbg !642

; <label>:14:                                     ; preds = %8
  %15 = getelementptr inbounds i8, i8* %0, i64 8, !dbg !643
  %16 = bitcast i8* %15 to i32**, !dbg !643
  %17 = load i32*, i32** %16, align 8, !dbg !643, !tbaa !597
  store i32 0, i32* %17, align 4, !dbg !645, !tbaa !548
  br label %22, !dbg !646

; <label>:18:                                     ; preds = %8
  %19 = getelementptr inbounds %struct.sem_t_, %struct.sem_t_* %4, i64 0, i32 0, !dbg !647
  %20 = load i32, i32* %19, align 8, !dbg !649, !tbaa !584
  %21 = add nsw i32 %20, 1, !dbg !649
  store i32 %21, i32* %19, align 8, !dbg !649, !tbaa !584
  br label %22

; <label>:22:                                     ; preds = %18, %14
  %23 = call i32 @pthread_mutex_unlock(%struct.pthread_mutex_t_** nonnull %5) #5, !dbg !650
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %9) #4, !dbg !651
  br label %24, !dbg !652
...
!611 = !DILocation(line: 206, column: 7, scope: !612)
!612 = distinct !DILexicalBlock(scope: !506, file: !1, line: 206, column: 7)
!613 = !DILocation(line: 206, column: 14, scope: !612)
!614 = !DILocation(line: 209, column: 7, scope: !615)
!615 = distinct !DILexicalBlock(scope: !612, file: !1, line: 207, column: 5)
!616 = !DILocation(line: 209, column: 13, scope: !615)
!617 = !DILocation(line: 210, column: 7, scope: !615)
!618 = !DILocation(line: 0, scope: !608)
!619 = !DILocation(line: 216, column: 1, scope: !506)
!620 = distinct !DISubprogram(name: "pte_sem_timedwait_cleanup", scope: !1, file: !1, line: 64, type: !24, isLocal: true, isDefinition: true, scopeLine: 65, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !621)
!621 = !{!622, !623, !624, !625}
!622 = !DILocalVariable(name: "args", arg: 1, scope: !620, file: !1, line: 64, type: !20)
!623 = !DILocalVariable(name: "a", scope: !620, file: !1, line: 66, type: !26)
!624 = !DILocalVariable(name: "s", scope: !620, file: !1, line: 67, type: !31)
!625 = !DILocalVariable(name: "timeout", scope: !626, file: !1, line: 79, type: !5)
!626 = distinct !DILexicalBlock(scope: !627, file: !1, line: 70, column: 5)
!627 = distinct !DILexicalBlock(scope: !620, file: !1, line: 69, column: 7)
!628 = !DILocation(line: 64, column: 35, scope: !620)
!629 = !DILocation(line: 66, column: 34, scope: !620)
!630 = !DILocation(line: 67, column: 16, scope: !620)
!631 = !DILocation(line: 67, column: 9, scope: !620)
!632 = !DILocation(line: 69, column: 31, scope: !627)
!633 = !DILocation(line: 69, column: 7, scope: !627)
!634 = !DILocation(line: 69, column: 37, scope: !627)
!635 = !DILocation(line: 69, column: 7, scope: !620)
!636 = !DILocation(line: 79, column: 7, scope: !626)
!637 = !DILocation(line: 79, column: 20, scope: !626)
!638 = !DILocation(line: 80, column: 34, scope: !639)
!639 = distinct !DILexicalBlock(scope: !626, file: !1, line: 80, column: 11)
!640 = !DILocation(line: 80, column: 11, scope: !639)
!641 = !DILocation(line: 80, column: 49, scope: !639)
!642 = !DILocation(line: 80, column: 11, scope: !626)
!643 = !DILocation(line: 83, column: 16, scope: !644)
!644 = distinct !DILexicalBlock(scope: !639, file: !1, line: 81, column: 9)
!645 = !DILocation(line: 83, column: 27, scope: !644)
!646 = !DILocation(line: 84, column: 9, scope: !644)
!647 = !DILocation(line: 88, column: 14, scope: !648)
!648 = distinct !DILexicalBlock(scope: !639, file: !1, line: 86, column: 9)
!649 = !DILocation(line: 88, column: 19, scope: !648)
!650 = !DILocation(line: 96, column: 14, scope: !626)
!651 = !DILocation(line: 97, column: 5, scope: !627)
!652 = !DILocation(line: 97, column: 5, scope: !626)
!653 = !DILocation(line: 98, column: 1, scope: !620)
