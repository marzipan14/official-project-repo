...
define dso_local i32 @_vsprintf_r(%struct._reent*, i8* noalias, i8* noalias, %struct.__va_list_tag*) local_unnamed_addr #0 !dbg !36 {
  ...
  store i16 520, i16* %7, align 8, !dbg !303, !tbaa !267
  %8 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %5, i64 0, i32 0, !dbg !304
  store i8* %1, i8** %8, align 8, !dbg !305, !tbaa !279
  %9 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %5, i64 0, i32 5, i32 0, !dbg !306
  store i8* %1, i8** %9, align 8, !dbg !307, !tbaa !282
  %10 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %5, i64 0, i32 2, !dbg !308
  store i32 2147483647, i32* %10, align 4, !dbg !309, !tbaa !285
  %11 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %5, i64 0, i32 5, i32 1, !dbg !310
  store i32 2147483647, i32* %11, align 8, !dbg !311, !tbaa !288
  %12 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %5, i64 0, i32 4, !dbg !312
  store i16 -1, i16* %12, align 2, !dbg !313, !tbaa !291
  %13 = call i32 @_svfprintf_r(%struct._reent* %0, %struct.__sFILE* nonnull %5, i8* %2, %struct.__va_list_tag* %3) #4, !dbg !315
  %14 = load i8*, i8** %8, align 8, !dbg !317, !tbaa !279
  store i8 0, i8* %14, align 1, !dbg !318, !tbaa !297
  call void @llvm.lifetime.end.p0i8(i64 176, i8* nonnull %6) #5, !dbg !319
  ret i32 %13, !dbg !320
}
...
!299 = !DILocation(line: 39, column: 3, scope: !10)
!300 = !DILocation(line: 51, column: 1, scope: !36)
!301 = !DILocation(line: 58, column: 3, scope: !36)
!302 = !DILocation(line: 60, column: 5, scope: !36)
!303 = !DILocation(line: 60, column: 12, scope: !36)
!304 = !DILocation(line: 61, column: 19, scope: !36)
!305 = !DILocation(line: 61, column: 22, scope: !36)
!306 = !DILocation(line: 61, column: 9, scope: !36)
!307 = !DILocation(line: 61, column: 15, scope: !36)
!308 = !DILocation(line: 62, column: 19, scope: !36)
!309 = !DILocation(line: 62, column: 22, scope: !36)
!310 = !DILocation(line: 62, column: 9, scope: !36)
!311 = !DILocation(line: 62, column: 15, scope: !36)
!312 = !DILocation(line: 63, column: 5, scope: !36)
!313 = !DILocation(line: 63, column: 11, scope: !36)
!314 = !DILocation(line: 58, column: 8, scope: !36)
!315 = !DILocation(line: 64, column: 9, scope: !36)
!316 = !DILocation(line: 57, column: 7, scope: !36)
!317 = !DILocation(line: 65, column: 6, scope: !36)
!318 = !DILocation(line: 65, column: 9, scope: !36)
!319 = !DILocation(line: 67, column: 1, scope: !36)
!320 = !DILocation(line: 66, column: 3, scope: !36)
