; ModuleID = '/root/.unikraft/apps/redis/build/libpthread-embedded/origin/pthread-embedded-44b41d760a433915d70a7be9809651b0a65e001d/sem_trywait.c'
source_filename = "/root/.unikraft/apps/redis/build/libpthread-embedded/origin/pthread-embedded-44b41d760a433915d70a7be9809651b0a65e001d/sem_trywait.c"
...
define dso_local i32 @sem_trywait(%struct.sem_t_** nocapture readonly) local_unnamed_addr #0 !dbg !16 {
  %2 = load %struct.sem_t_*, %struct.sem_t_** %0, align 8, !dbg !500, !tbaa !501
  %3 = icmp eq %struct.sem_t_* %2, null, !dbg !506
  br i1 %3, label %23, label %4, !dbg !508

; <label>:4:                                      ; preds = %1
  %5 = getelementptr inbounds %struct.sem_t_, %struct.sem_t_* %2, i64 0, i32 1, !dbg !509
  %6 = tail call i32 @pthread_mutex_lock(%struct.pthread_mutex_t_** nonnull %5) #3, !dbg !511
  %7 = icmp eq i32 %6, 0, !dbg !512
  br i1 %7, label %8, label %23, !dbg !513

; <label>:8:                                      ; preds = %4
  %9 = load %struct.sem_t_*, %struct.sem_t_** %0, align 8, !dbg !514, !tbaa !501
  %10 = icmp eq %struct.sem_t_* %9, null, !dbg !517
  br i1 %10, label %11, label %14, !dbg !518

; <label>:11:                                     ; preds = %8
  %12 = tail call i32 @pthread_mutex_unlock(%struct.pthread_mutex_t_** nonnull %5) #3, !dbg !519
  %13 = tail call i32* @__errno() #3, !dbg !521
  store i32 22, i32* %13, align 4, !dbg !522, !tbaa !523
  br label %26, !dbg !525

; <label>:14:                                     ; preds = %8
  %15 = getelementptr inbounds %struct.sem_t_, %struct.sem_t_* %2, i64 0, i32 0, !dbg !526
  %16 = load i32, i32* %15, align 8, !dbg !526, !tbaa !528
  %17 = icmp sgt i32 %16, 0, !dbg !530
  br i1 %17, label %18, label %21, !dbg !531

; <label>:18:                                     ; preds = %14
  %19 = add nsw i32 %16, -1, !dbg !532
  store i32 %19, i32* %15, align 8, !dbg !532, !tbaa !528
  %20 = tail call i32 @pthread_mutex_unlock(%struct.pthread_mutex_t_** nonnull %5) #3, !dbg !534
  br label %26, !dbg !535

; <label>:21:                                     ; preds = %14
  %22 = tail call i32 @pthread_mutex_unlock(%struct.pthread_mutex_t_** nonnull %5) #3, !dbg !534
  br label %23

; <label>:23:                                     ; preds = %1, %4, %21
  %24 = phi i32 [ 11, %21 ], [ 22, %1 ], [ %6, %4 ]
  %25 = tail call i32* @__errno() #3, !dbg !536
  store i32 %24, i32* %25, align 4, !dbg !539, !tbaa !523
  br label %26, !dbg !540

; <label>:26:                                     ; preds = %18, %23, %11
  %27 = phi i32 [ -1, %23 ], [ -1, %11 ], [ 0, %18 ], !dbg !541
  ret i32 %27, !dbg !542
}
...
!1 = !DIFile(filename: "/root/.unikraft/apps/redis/build/libpthread-embedded/origin/pthread-embedded-44b41d760a433915d70a7be9809651b0a65e001d/sem_trywait.c", directory: "/root/.unikraft/apps/redis/build")
!2 = !{!3}
...
!16 = distinct !DISubprogram(name: "sem_trywait", scope: !1, file: !1, line: 56, type: !17, isLocal: false, isDefinition: true, scopeLine: 84, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !494)
...
!496 = !DILocalVariable(name: "result", scope: !16, file: !1, line: 85, type: !19)
!497 = !DILocalVariable(name: "s", scope: !16, file: !1, line: 86, type: !21)
!498 = !DILocation(line: 56, column: 22, scope: !16)
!499 = !DILocation(line: 85, column: 7, scope: !16)
!500 = !DILocation(line: 86, column: 13, scope: !16)
!501 = !{!502, !502, i64 0}
!502 = !{!"any pointer", !503, i64 0}
!503 = !{!"omnipotent char", !504, i64 0}
!504 = !{!"Simple C/C++ TBAA"}
!505 = !DILocation(line: 86, column: 9, scope: !16)
!506 = !DILocation(line: 88, column: 9, scope: !507)
!507 = distinct !DILexicalBlock(scope: !16, file: !1, line: 88, column: 7)
!508 = !DILocation(line: 88, column: 7, scope: !16)
!509 = !DILocation(line: 92, column: 46, scope: !510)
!510 = distinct !DILexicalBlock(scope: !507, file: !1, line: 92, column: 12)
!511 = !DILocation(line: 92, column: 22, scope: !510)
!512 = !DILocation(line: 92, column: 53, scope: !510)
!513 = !DILocation(line: 92, column: 12, scope: !507)
!514 = !DILocation(line: 96, column: 11, scope: !515)
!515 = distinct !DILexicalBlock(scope: !516, file: !1, line: 96, column: 11)
!516 = distinct !DILexicalBlock(scope: !510, file: !1, line: 93, column: 5)
!517 = !DILocation(line: 96, column: 16, scope: !515)
!518 = !DILocation(line: 96, column: 11, scope: !516)
!519 = !DILocation(line: 98, column: 18, scope: !520)
!520 = distinct !DILexicalBlock(scope: !515, file: !1, line: 97, column: 9)
!521 = !DILocation(line: 99, column: 11, scope: !520)
!522 = !DILocation(line: 99, column: 17, scope: !520)
!523 = !{!524, !524, i64 0}
!524 = !{!"int", !503, i64 0}
!525 = !DILocation(line: 100, column: 11, scope: !520)
!526 = !DILocation(line: 103, column: 14, scope: !527)
!527 = distinct !DILexicalBlock(scope: !516, file: !1, line: 103, column: 11)
!528 = !{!529, !524, i64 0}
!529 = !{!"sem_t_", !524, i64 0, !502, i64 8, !502, i64 16}
!530 = !DILocation(line: 103, column: 20, scope: !527)
!531 = !DILocation(line: 103, column: 11, scope: !516)
!532 = !DILocation(line: 105, column: 19, scope: !533)
!533 = distinct !DILexicalBlock(scope: !527, file: !1, line: 104, column: 9)
!534 = !DILocation(line: 112, column: 14, scope: !516)
!535 = !DILocation(line: 115, column: 7, scope: !16)
!536 = !DILocation(line: 117, column: 7, scope: !537)
!537 = distinct !DILexicalBlock(scope: !538, file: !1, line: 116, column: 5)
!538 = distinct !DILexicalBlock(scope: !16, file: !1, line: 115, column: 7)
!539 = !DILocation(line: 117, column: 13, scope: !537)
!540 = !DILocation(line: 118, column: 7, scope: !537)
!541 = !DILocation(line: 0, scope: !520)
!542 = !DILocation(line: 123, column: 1, scope: !16)
