...
; <label>:27:                                     ; preds = %9, %3, %12
  ...
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %6) #4, !dbg !308
  ret %struct.__sFILE* %28, !dbg !308
}
...
; Function Attrs: noredzone nounwind
define dso_local %struct.__sFILE* @fdopen(i32, i8*) local_unnamed_addr #0 !dbg !309 {
  %3 = alloca i32, align 4
  %4 = alloca i32, align 4
  %5 = tail call %struct._reent* @__getreent() #5, !dbg !316
  %6 = bitcast i32* %3 to i8*, !dbg !319
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %6) #4, !dbg !319
  %7 = call i32 @__sflags(%struct._reent* %5, i8* %1, i32* nonnull %3) #5, !dbg !321
  %8 = icmp eq i32 %7, 0, !dbg !323
  br i1 %8, label %27, label %9, !dbg !324

; <label>:9:                                      ; preds = %2
  %10 = call %struct.__sFILE* @__sfp(%struct._reent* %5) #5, !dbg !325
  %11 = icmp eq %struct.__sFILE* %10, null, !dbg !327
  br i1 %11, label %27, label %12, !dbg !328

; <label>:12:                                     ; preds = %9
  %13 = bitcast i32* %4 to i8*, !dbg !329
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %13) #4, !dbg !329
  %14 = call i32 @pthread_setcancelstate(i32 1, i32* nonnull %4) #5, !dbg !329
  %15 = trunc i32 %7 to i16, !dbg !330
  %16 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %10, i64 0, i32 3, !dbg !331
  store i16 %15, i16* %16, align 8, !dbg !332, !tbaa !277
  %17 = trunc i32 %0 to i16, !dbg !333
  %18 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %10, i64 0, i32 4, !dbg !334
  store i16 %17, i16* %18, align 2, !dbg !335, !tbaa !290
  %19 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %10, i64 0, i32 7, !dbg !336
  %20 = bitcast i8** %19 to %struct.__sFILE**, !dbg !337
  store %struct.__sFILE* %10, %struct.__sFILE** %20, align 8, !dbg !337, !tbaa !293
  %21 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %10, i64 0, i32 8, !dbg !338
  %22 = bitcast i64 (%struct._reent*, i8*, i8*, i32)** %21 to <2 x i64 (%struct._reent*, i8*, i8*, i32)*>*, !dbg !339
  store <2 x i64 (%struct._reent*, i8*, i8*, i32)*> <i64 (%struct._reent*, i8*, i8*, i32)* @__sread, i64 (%struct._reent*, i8*, i8*, i32)* @__swrite>, <2 x i64 (%struct._reent*, i8*, i8*, i32)*>* %22, align 8, !dbg !339, !tbaa !296
  %23 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %10, i64 0, i32 10, !dbg !340
  store i64 (%struct._reent*, i8*, i64, i32)* @__sseek, i64 (%struct._reent*, i8*, i64, i32)** %23, align 8, !dbg !341, !tbaa !299
  %24 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %10, i64 0, i32 11, !dbg !342
  store i32 (%struct._reent*, i8*)* @__sclose, i32 (%struct._reent*, i8*)** %24, align 8, !dbg !343, !tbaa !302
  %25 = load i32, i32* %4, align 4, !dbg !344, !tbaa !304
  %26 = call i32 @pthread_setcancelstate(i32 %25, i32* nonnull %4) #5, !dbg !344
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %13) #4, !dbg !345
  br label %27, !dbg !346

; <label>:27:                                     ; preds = %2, %9, %12
  %28 = phi %struct.__sFILE* [ %10, %12 ], [ null, %2 ], [ null, %9 ], !dbg !347
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %6) #4, !dbg !348
  ret %struct.__sFILE* %28, !dbg !349
}
...
!308 = !DILocation(line: 132, column: 1, scope: !27)
!309 = distinct !DISubprogram(name: "fdopen", scope: !1, file: !1, line: 137, type: !310, isLocal: false, isDefinition: true, scopeLine: 140, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !312)
!310 = !DISubroutineType(types: !311)
!311 = !{!30, !5, !222}
!312 = !{!313, !314}
!313 = !DILocalVariable(name: "fd", arg: 1, scope: !309, file: !1, line: 137, type: !5)
!314 = !DILocalVariable(name: "mode", arg: 2, scope: !309, file: !1, line: 137, type: !222)
!315 = !DILocation(line: 137, column: 1, scope: !309)
!316 = !DILocation(line: 141, column: 21, scope: !309)
!317 = !DILocation(line: 67, column: 1, scope: !27, inlinedAt: !318)
!318 = distinct !DILocation(line: 141, column: 10, scope: !309)
!319 = !DILocation(line: 73, column: 3, scope: !27, inlinedAt: !318)
!320 = !DILocation(line: 73, column: 14, scope: !27, inlinedAt: !318)
!321 = !DILocation(line: 78, column: 16, scope: !264, inlinedAt: !318)
!322 = !DILocation(line: 73, column: 7, scope: !27, inlinedAt: !318)
!323 = !DILocation(line: 78, column: 47, scope: !264, inlinedAt: !318)
!324 = !DILocation(line: 78, column: 7, scope: !27, inlinedAt: !318)
!325 = !DILocation(line: 93, column: 13, scope: !269, inlinedAt: !318)
!326 = !DILocation(line: 72, column: 18, scope: !27, inlinedAt: !318)
!327 = !DILocation(line: 93, column: 26, scope: !269, inlinedAt: !318)
!328 = !DILocation(line: 93, column: 7, scope: !27, inlinedAt: !318)
!329 = !DILocation(line: 96, column: 3, scope: !259, inlinedAt: !318)
!330 = !DILocation(line: 98, column: 16, scope: !259, inlinedAt: !318)
!331 = !DILocation(line: 98, column: 7, scope: !259, inlinedAt: !318)
!332 = !DILocation(line: 98, column: 14, scope: !259, inlinedAt: !318)
!333 = !DILocation(line: 107, column: 15, scope: !259, inlinedAt: !318)
!334 = !DILocation(line: 107, column: 7, scope: !259, inlinedAt: !318)
!335 = !DILocation(line: 107, column: 13, scope: !259, inlinedAt: !318)
!336 = !DILocation(line: 108, column: 7, scope: !259, inlinedAt: !318)
!337 = !DILocation(line: 108, column: 15, scope: !259, inlinedAt: !318)
!338 = !DILocation(line: 115, column: 7, scope: !259, inlinedAt: !318)
!339 = !DILocation(line: 115, column: 13, scope: !259, inlinedAt: !318)
!340 = !DILocation(line: 117, column: 7, scope: !259, inlinedAt: !318)
!341 = !DILocation(line: 117, column: 13, scope: !259, inlinedAt: !318)
!342 = !DILocation(line: 118, column: 7, scope: !259, inlinedAt: !318)
!343 = !DILocation(line: 118, column: 14, scope: !259, inlinedAt: !318)
!344 = !DILocation(line: 130, column: 3, scope: !259, inlinedAt: !318)
!345 = !DILocation(line: 130, column: 3, scope: !27, inlinedAt: !318)
!346 = !DILocation(line: 131, column: 3, scope: !27, inlinedAt: !318)
!347 = !DILocation(line: 0, scope: !27, inlinedAt: !318)
!348 = !DILocation(line: 132, column: 1, scope: !27, inlinedAt: !318)
!349 = !DILocation(line: 141, column: 3, scope: !309)
