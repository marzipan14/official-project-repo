...
; <label>:25:                                     ; preds = %37, %23
  ...
  %27 = and i64 %26, -65536, !dbg !619
  %28 = inttoptr i64 %27 to %struct.uk_thread**, !dbg !620
  %29 = load %struct.uk_thread*, %struct.uk_thread** %28, align 65536, !dbg !622, !tbaa !558
  %30 = icmp eq %struct.uk_thread* %29, null, !dbg !624
  br i1 %30, label %31, label %32, !dbg !627, !prof !628

; <label>:31:                                     ; preds = %25
  tail call void (i8*, ...) @uk_pr_crit(i8* undef, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.1, i64 0, i64 0)) #7, !dbg !629
  tail call void @ukplat_terminate(i32 3) #8, !dbg !629
  unreachable, !dbg !629

; <label>:32:                                     ; preds = %25
  %33 = getelementptr inbounds %struct.uk_thread, %struct.uk_thread* %29, i64 0, i32 9, !dbg !631
  %34 = load %struct.uk_sched*, %struct.uk_sched** %33, align 8, !dbg !631, !tbaa !632
  %35 = icmp eq %struct.uk_sched* %34, null, !dbg !639
  br i1 %35, label %36, label %37, !dbg !642, !prof !628

; <label>:36:                                     ; preds = %32
  tail call void (i8*, ...) @uk_pr_crit(i8* undef, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i64 0, i64 0)) #7, !dbg !643
  tail call void @ukplat_terminate(i32 3) #8, !dbg !643
  unreachable, !dbg !643

; <label>:37:                                     ; preds = %32
  %38 = getelementptr inbounds %struct.uk_sched, %struct.uk_sched* %34, i64 0, i32 0, !dbg !645
  %39 = load void (%struct.uk_sched*)*, void (%struct.uk_sched*)** %38, align 8, !dbg !645, !tbaa !646
  tail call void %39(%struct.uk_sched* nonnull %34) #7, !dbg !650
  %40 = tail call i32 @pthread_mutex_destroy(%struct.pthread_mutex_t_** nonnull %7) #7, !dbg !651
  %41 = icmp eq i32 %40, 16, !dbg !652
  br i1 %41, label %25, label %45, !dbg !653, !llvm.loop !654

; <label>:42:                                     ; preds = %21, %1, %3, %6, %14
  %43 = phi i32 [ 22, %21 ], [ 22, %1 ], [ 22, %3 ], [ %8, %6 ], [ 16, %14 ]
  %44 = tail call i32* @__errno() #7, !dbg !656
  store i32 %43, i32* %44, align 4, !dbg !659, !tbaa !660
  br label %47, !dbg !661

; <label>:45:                                     ; preds = %37
  %46 = bitcast %struct.sem_t_* %4 to i8*, !dbg !662
  tail call void @free(i8* %46) #7, !dbg !663
  br label %47, !dbg !664

; <label>:47:                                     ; preds = %45, %42
  %48 = phi i32 [ -1, %42 ], [ 0, %45 ], !dbg !665
  ret i32 %48, !dbg !666
}
...
define internal void @uk_pr_crit(i8* nocapture readnone, ...) unnamed_addr #4 !dbg !2 {
  ...
  %3 = bitcast [1 x %struct.__va_list_tag]* %2 to i8*, !dbg !667
  call void @llvm.lifetime.start.p0i8(i64 24, i8* nonnull %3) #6, !dbg !667
  %4 = getelementptr inbounds [1 x %struct.__va_list_tag], [1 x %struct.__va_list_tag]* %2, i64 0, i64 0, !dbg !669
  call void @llvm.va_start(i8* nonnull %3), !dbg !669
  call void @_uk_vprintk(i32 0, i8* getelementptr inbounds ([20 x i8], [20 x i8]* @uk_pr_crit.__str, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8], [14 x i8]* @uk_pr_crit.__str.3, i64 0, i64 0), i32 198, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str, i64 0, i64 0), %struct.__va_list_tag* nonnull %4) #7, !dbg !670
  call void @llvm.va_end(i8* nonnull %3), !dbg !673
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %3) #6, !dbg !674
  ret void, !dbg !674
}
...
!618 = !DILocation(line: 154, column: 16, scope: !600, inlinedAt: !606)
!619 = !DILocation(line: 156, column: 38, scope: !600, inlinedAt: !606)
!620 = !DILocation(line: 156, column: 12, scope: !600, inlinedAt: !606)
!621 = !DILocation(line: 153, column: 21, scope: !600, inlinedAt: !606)
!622 = !DILocation(line: 158, column: 9, scope: !600, inlinedAt: !606)
!623 = !DILocation(line: 117, column: 20, scope: !607, inlinedAt: !611)
!624 = !DILocation(line: 119, column: 2, scope: !625, inlinedAt: !611)
!625 = distinct !DILexicalBlock(scope: !626, file: !84, line: 119, column: 2)
!626 = distinct !DILexicalBlock(scope: !607, file: !84, line: 119, column: 2)
!627 = !DILocation(line: 119, column: 2, scope: !626, inlinedAt: !611)
!628 = !{!"branch_weights", i32 1, i32 2000}
!629 = !DILocation(line: 119, column: 2, scope: !630, inlinedAt: !611)
!630 = distinct !DILexicalBlock(scope: !625, file: !84, line: 119, column: 2)
!631 = !DILocation(line: 121, column: 15, scope: !607, inlinedAt: !611)
!632 = !{!633, !559, i64 88}
!633 = !{!"uk_thread", !559, i64 0, !559, i64 8, !559, i64 16, !559, i64 24, !634, i64 32, !571, i64 48, !635, i64 56, !636, i64 64, !637, i64 72, !559, i64 88, !559, i64 96, !571, i64 104, !559, i64 112, !559, i64 120}
!634 = !{!"", !559, i64 0, !559, i64 8}
!635 = !{!"long", !560, i64 0}
!636 = !{!"_Bool", !560, i64 0}
!637 = !{!"uk_waitq", !559, i64 0, !559, i64 8}
!638 = !DILocation(line: 116, column: 19, scope: !607, inlinedAt: !611)
!639 = !DILocation(line: 122, column: 2, scope: !640, inlinedAt: !611)
!640 = distinct !DILexicalBlock(scope: !641, file: !84, line: 122, column: 2)
!641 = distinct !DILexicalBlock(scope: !607, file: !84, line: 122, column: 2)
!642 = !DILocation(line: 122, column: 2, scope: !641, inlinedAt: !611)
!643 = !DILocation(line: 122, column: 2, scope: !644, inlinedAt: !611)
!644 = distinct !DILexicalBlock(scope: !640, file: !84, line: 122, column: 2)
!645 = !DILocation(line: 123, column: 5, scope: !607, inlinedAt: !611)
!646 = !{!647, !559, i64 0}
!647 = !{!"uk_sched", !559, i64 0, !559, i64 8, !559, i64 16, !559, i64 24, !559, i64 32, !559, i64 40, !559, i64 48, !559, i64 56, !559, i64 64, !636, i64 72, !633, i64 80, !648, i64 208, !649, i64 224, !559, i64 248, !559, i64 256, !559, i64 264}
!648 = !{!"uk_thread_list", !559, i64 0, !559, i64 8}
!649 = !{!"ukplat_ctx_callbacks", !559, i64 0, !559, i64 8, !559, i64 16}
!650 = !DILocation(line: 123, column: 2, scope: !607, inlinedAt: !611)
!651 = !DILocation(line: 140, column: 26, scope: !588)
!652 = !DILocation(line: 140, column: 59, scope: !588)
!653 = !DILocation(line: 139, column: 21, scope: !615)
!654 = distinct !{!654, !591, !655}
!655 = !DILocation(line: 140, column: 67, scope: !588)
!656 = !DILocation(line: 148, column: 7, scope: !657)
!657 = distinct !DILexicalBlock(scope: !658, file: !10, line: 147, column: 5)
!658 = distinct !DILexicalBlock(scope: !503, file: !10, line: 146, column: 7)
!659 = !DILocation(line: 148, column: 13, scope: !657)
!660 = !{!571, !571, i64 0}
!661 = !DILocation(line: 149, column: 7, scope: !657)
!662 = !DILocation(line: 152, column: 9, scope: !503)
!663 = !DILocation(line: 152, column: 3, scope: !503)
!664 = !DILocation(line: 154, column: 3, scope: !503)
!665 = !DILocation(line: 0, scope: !503)
!666 = !DILocation(line: 156, column: 1, scope: !503)
!667 = !DILocation(line: 196, column: 2, scope: !2)
!668 = !DILocation(line: 196, column: 10, scope: !2)
!669 = !DILocation(line: 197, column: 2, scope: !2)
!670 = !DILocation(line: 198, column: 2, scope: !671)
!671 = distinct !DILexicalBlock(scope: !672, file: !3, line: 198, column: 2)
!672 = distinct !DILexicalBlock(scope: !2, file: !3, line: 198, column: 2)
!673 = !DILocation(line: 199, column: 2, scope: !2)
!674 = !DILocation(line: 200, column: 1, scope: !2)
