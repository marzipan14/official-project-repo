; ModuleID = '/root/.unikraft/apps/redis/build/libpthread-embedded/origin/pthread-embedded-44b41d760a433915d70a7be9809651b0a65e001d/pte_new.c'
source_filename = "/root/.unikraft/apps/redis/build/libpthread-embedded/origin/pthread-embedded-44b41d760a433915d70a7be9809651b0a65e001d/pte_new.c"
...
define dso_local { i8*, i32 } @pte_new() local_unnamed_addr #0 !dbg !536 {
  %1 = tail call { i8*, i32 } @pte_threadReusePop() #3, !dbg !544
  %2 = extractvalue { i8*, i32 } %1, 0, !dbg !544
  %3 = icmp eq i8* %2, null, !dbg !546
  br i1 %3, label %6, label %4, !dbg !548

; <label>:4:                                      ; preds = %0
  %5 = extractvalue { i8*, i32 } %1, 1, !dbg !544
  br label %14, !dbg !550

; <label>:6:                                      ; preds = %0
  %7 = tail call i8* @calloc(i64 1, i64 192) #3, !dbg !552
  %8 = icmp eq i8* %7, null, !dbg !554
  br i1 %8, label %30, label %9, !dbg !556

; <label>:9:                                      ; preds = %6
  %10 = getelementptr inbounds i8, i8* %7, i64 8, !dbg !557
  %11 = bitcast i8* %10 to i8**, !dbg !558
  store i8* %7, i8** %11, align 8, !dbg !559, !tbaa !560
  %12 = getelementptr inbounds i8, i8* %7, i64 16, !dbg !567
  %13 = bitcast i8* %12 to i32*, !dbg !567
  store i32 0, i32* %13, align 8, !dbg !568, !tbaa !569
  br label %14

; <label>:14:                                     ; preds = %9, %4
  %15 = phi i32 [ %5, %4 ], [ 0, %9 ], !dbg !570
  %16 = phi i8* [ %2, %4 ], [ %7, %9 ], !dbg !570
  %17 = tail call i32 (...) @pte_osThreadGetMinPriority() #3, !dbg !571
  %18 = getelementptr inbounds i8, i8* %16, i64 72, !dbg !572
  %19 = bitcast i8* %18 to i32*, !dbg !572
  store i32 %17, i32* %19, align 8, !dbg !573, !tbaa !574
  %20 = getelementptr inbounds i8, i8* %16, i64 60, !dbg !575
  %21 = bitcast i8* %20 to i32*, !dbg !575
  store i32 0, i32* %21, align 4, !dbg !576, !tbaa !577
  %22 = getelementptr inbounds i8, i8* %16, i64 88, !dbg !578
  %23 = bitcast i8* %22 to i32*, !dbg !578
  store i32 0, i32* %23, align 8, !dbg !579, !tbaa !580
  %24 = getelementptr inbounds i8, i8* %16, i64 92, !dbg !581
  %25 = bitcast i8* %24 to i32*, !dbg !581
  store i32 1, i32* %25, align 4, !dbg !582, !tbaa !583
  %26 = getelementptr inbounds i8, i8* %16, i64 80, !dbg !584
  %27 = bitcast i8* %26 to %struct.pthread_mutex_t_**, !dbg !584
  store %struct.pthread_mutex_t_* inttoptr (i64 -1 to %struct.pthread_mutex_t_*), %struct.pthread_mutex_t_** %27, align 8, !dbg !585, !tbaa !586
  %28 = getelementptr inbounds i8, i8* %16, i64 64, !dbg !587
  %29 = bitcast i8* %28 to %struct.pthread_mutex_t_**, !dbg !587
  store %struct.pthread_mutex_t_* inttoptr (i64 -1 to %struct.pthread_mutex_t_*), %struct.pthread_mutex_t_** %29, align 8, !dbg !588, !tbaa !589
  br label %30, !dbg !590

; <label>:30:                                     ; preds = %6, %14
  %31 = phi i8* [ %16, %14 ], [ null, %6 ], !dbg !591
  %32 = phi i32 [ %15, %14 ], [ 0, %6 ], !dbg !591
  %33 = insertvalue { i8*, i32 } undef, i8* %31, 0, !dbg !593
  %34 = insertvalue { i8*, i32 } %33, i32 %32, 1, !dbg !593
  ret { i8*, i32 } %34, !dbg !593
}

; Function Attrs: noredzone
declare dso_local { i8*, i32 } @pte_threadReusePop() local_unnamed_addr #1
...
!1 = !DIFile(filename: "/root/.unikraft/apps/redis/build/libpthread-embedded/origin/pthread-embedded-44b41d760a433915d70a7be9809651b0a65e001d/pte_new.c", directory: "/root/.unikraft/apps/redis/build")
!2 = !{!3, !10, !20}
...
!41 = !DIDerivedType(tag: DW_TAG_typedef, name: "pte_thread_t", file: !11, line: 83, baseType: !42)
!42 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "pte_thread_t_", file: !11, line: 85, size: 1536, elements: !43)
!43 = !{!44, !487, !494, !495, !498, !499, !500, !501, !502, !519, !520, !521, !522, !523, !524, !529, !530, !531}
!44 = !DIDerivedType(tag: DW_TAG_member, name: "threadId", scope: !42, file: !11, line: 87, baseType: !45, size: 64)
!45 = !DIDerivedType(tag: DW_TAG_typedef, name: "pte_osThreadHandle", file: !46, line: 11, baseType: !47)
...
!48 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "uk_thread", file: !49, line: 59, size: 1024, elements: !50)
!49 = !DIFile(filename: "/root/.unikraft/unikraft/lib/uksched/include/uk/thread.h", directory: "/root/.unikraft/apps/redis/build")
!50 = !{!51, !55, !56, !57, !58, !64, !69, !75, !77, !93, !242, !243, !244, !457}
!51 = !DIDerivedType(tag: DW_TAG_member, name: "name", scope: !48, file: !49, line: 60, baseType: !52, size: 64)
!52 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !53, size: 64)
!53 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !54)
!54 = !DIBasicType(name: "char", size: 8, encoding: DW_ATE_signed_char)
!55 = !DIDerivedType(tag: DW_TAG_member, name: "stack", scope: !48, file: !49, line: 61, baseType: !39, size: 64, offset: 64)
!56 = !DIDerivedType(tag: DW_TAG_member, name: "tls", scope: !48, file: !49, line: 62, baseType: !39, size: 64, offset: 128)
!57 = !DIDerivedType(tag: DW_TAG_member, name: "ctx", scope: !48, file: !49, line: 63, baseType: !39, size: 64, offset: 192)
!58 = !DIDerivedType(tag: DW_TAG_member, name: "thread_list", scope: !48, file: !49, line: 64, baseType: !59, size: 128, offset: 256)
!59 = distinct !DICompositeType(tag: DW_TAG_structure_type, scope: !48, file: !49, line: 64, size: 128, elements: !60)
!60 = !{!61, !62}
!61 = !DIDerivedType(tag: DW_TAG_member, name: "tqe_next", scope: !59, file: !49, line: 64, baseType: !47, size: 64)
!62 = !DIDerivedType(tag: DW_TAG_member, name: "tqe_prev", scope: !59, file: !49, line: 64, baseType: !63, size: 64, offset: 64)
!63 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !47, size: 64)
!64 = !DIDerivedType(tag: DW_TAG_member, name: "flags", scope: !48, file: !49, line: 65, baseType: !65, size: 32, offset: 384)
...
!69 = !DIDerivedType(tag: DW_TAG_member, name: "wakeup_time", scope: !48, file: !49, line: 66, baseType: !70, size: 64, offset: 448)
...
!75 = !DIDerivedType(tag: DW_TAG_member, name: "detached", scope: !48, file: !49, line: 67, baseType: !76, size: 8, offset: 512)
!76 = !DIBasicType(name: "_Bool", size: 8, encoding: DW_ATE_boolean)
!77 = !DIDerivedType(tag: DW_TAG_member, name: "waiting_threads", scope: !48, file: !49, line: 68, baseType: !78, size: 128, offset: 576)
...
!86 = !DIDerivedType(tag: DW_TAG_member, name: "thread", scope: !83, file: !79, line: 37, baseType: !47, size: 64, offset: 64)
...
!93 = !DIDerivedType(tag: DW_TAG_member, name: "sched", scope: !48, file: !49, line: 69, baseType: !94, size: 64, offset: 704)
...
!155 = !DIDerivedType(tag: DW_TAG_member, name: "idle", scope: !95, file: !96, line: 105, baseType: !48, size: 1024, offset: 640)
!156 = !DIDerivedType(tag: DW_TAG_member, name: "exited_threads", scope: !95, file: !96, line: 106, baseType: !157, size: 128, offset: 1664)
!157 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "uk_thread_list", file: !49, line: 93, size: 128, elements: !158)
!158 = !{!159, !160}
!159 = !DIDerivedType(tag: DW_TAG_member, name: "tqh_first", scope: !157, file: !49, line: 93, baseType: !47, size: 64)
!160 = !DIDerivedType(tag: DW_TAG_member, name: "tqh_last", scope: !157, file: !49, line: 93, baseType: !63, size: 64, offset: 64)
...
!241 = !DIDerivedType(tag: DW_TAG_member, name: "prv", scope: !95, file: !96, line: 110, baseType: !39, size: 64, offset: 2112)
!242 = !DIDerivedType(tag: DW_TAG_member, name: "prv", scope: !48, file: !49, line: 70, baseType: !39, size: 64, offset: 768)
!243 = !DIDerivedType(tag: DW_TAG_member, name: "tid", scope: !48, file: !49, line: 72, baseType: !22, size: 32, offset: 832)
!244 = !DIDerivedType(tag: DW_TAG_member, name: "reent", scope: !48, file: !49, line: 82, baseType: !245, size: 64, offset: 896)
...
!269 = !DIDerivedType(tag: DW_TAG_member, name: "_cookie", scope: !253, file: !247, line: 195, baseType: !39, size: 64, offset: 384)
...
!276 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !54, size: 64)
...
!329 = !DICompositeType(tag: DW_TAG_array_type, baseType: !54, size: 200, elements: !330)
!330 = !{!331}
...
!368 = !DICompositeType(tag: DW_TAG_array_type, baseType: !54, size: 208, elements: !369)
!369 = !{!370}
...
!398 = !DICompositeType(tag: DW_TAG_array_type, baseType: !54, size: 64, elements: !399)
!399 = !{!400}
...
!402 = !DICompositeType(tag: DW_TAG_array_type, baseType: !54, size: 192, elements: !403)
!403 = !{!404}
...
!438 = !DICompositeType(tag: DW_TAG_array_type, baseType: !39, size: 2048, elements: !432)
...
!457 = !DIDerivedType(tag: DW_TAG_member, name: "signals_container", scope: !48, file: !49, line: 85, baseType: !458, size: 64, offset: 960)
...
!487 = !DIDerivedType(tag: DW_TAG_member, name: "ptHandle", scope: !42, file: !11, line: 88, baseType: !488, size: 128, offset: 64)
...
!491 = !{!492, !493}
!492 = !DIDerivedType(tag: DW_TAG_member, name: "p", scope: !490, file: !21, line: 398, baseType: !39, size: 64)
!493 = !DIDerivedType(tag: DW_TAG_member, name: "x", scope: !490, file: !21, line: 399, baseType: !5, size: 32, offset: 64)
!494 = !DIDerivedType(tag: DW_TAG_member, name: "prevReuse", scope: !42, file: !11, line: 89, baseType: !40, size: 64, offset: 192)
!495 = !DIDerivedType(tag: DW_TAG_member, name: "state", scope: !42, file: !11, line: 90, baseType: !496, size: 32, offset: 256)
...
!498 = !DIDerivedType(tag: DW_TAG_member, name: "exitStatus", scope: !42, file: !11, line: 91, baseType: !39, size: 64, offset: 320)
!499 = !DIDerivedType(tag: DW_TAG_member, name: "parms", scope: !42, file: !11, line: 92, baseType: !39, size: 64, offset: 384)
!500 = !DIDerivedType(tag: DW_TAG_member, name: "ptErrno", scope: !42, file: !11, line: 93, baseType: !22, size: 32, offset: 448)
!501 = !DIDerivedType(tag: DW_TAG_member, name: "detachState", scope: !42, file: !11, line: 94, baseType: !22, size: 32, offset: 480)
!502 = !DIDerivedType(tag: DW_TAG_member, name: "threadLock", scope: !42, file: !11, line: 95, baseType: !503, size: 64, offset: 512)
...
!508 = !DIDerivedType(tag: DW_TAG_typedef, name: "pte_osSemaphoreHandle", file: !46, line: 12, baseType: !509)
...
!519 = !DIDerivedType(tag: DW_TAG_member, name: "sched_priority", scope: !42, file: !11, line: 96, baseType: !22, size: 32, offset: 576)
!520 = !DIDerivedType(tag: DW_TAG_member, name: "cancelLock", scope: !42, file: !11, line: 97, baseType: !503, size: 64, offset: 640)
!521 = !DIDerivedType(tag: DW_TAG_member, name: "cancelState", scope: !42, file: !11, line: 98, baseType: !22, size: 32, offset: 704)
!522 = !DIDerivedType(tag: DW_TAG_member, name: "cancelType", scope: !42, file: !11, line: 99, baseType: !22, size: 32, offset: 736)
!523 = !DIDerivedType(tag: DW_TAG_member, name: "cancelEvent", scope: !42, file: !11, line: 100, baseType: !22, size: 32, offset: 768)
!524 = !DIDerivedType(tag: DW_TAG_member, name: "start_mark", scope: !42, file: !11, line: 102, baseType: !525, size: 512, offset: 832)
...
!529 = !DIDerivedType(tag: DW_TAG_member, name: "implicit", scope: !42, file: !11, line: 104, baseType: !22, size: 1, offset: 1344, flags: DIFlagBitField, extraData: i64 1344)
!530 = !DIDerivedType(tag: DW_TAG_member, name: "keys", scope: !42, file: !11, line: 106, baseType: !39, size: 64, offset: 1408)
!531 = !DIDerivedType(tag: DW_TAG_member, name: "nextAssoc", scope: !42, file: !11, line: 107, baseType: !39, size: 64, offset: 1472)
...
!536 = distinct !DISubprogram(name: "pte_new", scope: !1, file: !1, line: 52, type: !537, isLocal: false, isDefinition: true, scopeLine: 53, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !539)
!537 = !DISubroutineType(types: !538)
!538 = !{!488}
!539 = !{!540, !541, !542}
!540 = !DILocalVariable(name: "t", scope: !536, file: !1, line: 54, type: !488)
!541 = !DILocalVariable(name: "nil", scope: !536, file: !1, line: 55, type: !488)
!542 = !DILocalVariable(name: "tp", scope: !536, file: !1, line: 56, type: !40)
!543 = !DILocation(line: 55, column: 13, scope: !536)
!544 = !DILocation(line: 61, column: 7, scope: !536)
!545 = !DILocation(line: 54, column: 13, scope: !536)
!546 = !DILocation(line: 63, column: 12, scope: !547)
!547 = distinct !DILexicalBlock(scope: !536, file: !1, line: 63, column: 7)
!548 = !DILocation(line: 63, column: 7, scope: !536)
!549 = !DILocation(line: 56, column: 18, scope: !536)
!550 = !DILocation(line: 66, column: 5, scope: !551)
!551 = distinct !DILexicalBlock(scope: !547, file: !1, line: 64, column: 5)
!552 = !DILocation(line: 70, column: 29, scope: !553)
!553 = distinct !DILexicalBlock(scope: !547, file: !1, line: 68, column: 5)
!554 = !DILocation(line: 72, column: 14, scope: !555)
!555 = distinct !DILexicalBlock(scope: !553, file: !1, line: 72, column: 11)
!556 = !DILocation(line: 72, column: 11, scope: !553)
!557 = !DILocation(line: 78, column: 17, scope: !553)
!558 = !DILocation(line: 78, column: 26, scope: !553)
!559 = !DILocation(line: 78, column: 28, scope: !553)
!560 = !{!561, !562, i64 8}
!561 = !{!"pte_thread_t_", !562, i64 0, !565, i64 8, !562, i64 24, !563, i64 32, !562, i64 40, !562, i64 48, !566, i64 56, !566, i64 60, !562, i64 64, !566, i64 72, !562, i64 80, !566, i64 88, !566, i64 92, !566, i64 96, !563, i64 104, !566, i64 168, !562, i64 176, !562, i64 184}
!562 = !{!"any pointer", !563, i64 0}
!563 = !{!"omnipotent char", !564, i64 0}
!564 = !{!"Simple C/C++ TBAA"}
!565 = !{!"", !562, i64 0, !566, i64 8}
!566 = !{!"int", !563, i64 0}
!567 = !DILocation(line: 79, column: 26, scope: !553)
!568 = !DILocation(line: 79, column: 28, scope: !553)
!569 = !{!561, !566, i64 16}
!570 = !DILocation(line: 0, scope: !553)
!571 = !DILocation(line: 83, column: 24, scope: !536)
!572 = !DILocation(line: 83, column: 7, scope: !536)
!573 = !DILocation(line: 83, column: 22, scope: !536)
!574 = !{!561, !566, i64 72}
!575 = !DILocation(line: 85, column: 7, scope: !536)
!576 = !DILocation(line: 85, column: 19, scope: !536)
!577 = !{!561, !566, i64 60}
!578 = !DILocation(line: 86, column: 7, scope: !536)
!579 = !DILocation(line: 86, column: 19, scope: !536)
!580 = !{!561, !566, i64 88}
!581 = !DILocation(line: 87, column: 7, scope: !536)
!582 = !DILocation(line: 87, column: 18, scope: !536)
!583 = !{!561, !566, i64 92}
!584 = !DILocation(line: 88, column: 7, scope: !536)
!585 = !DILocation(line: 88, column: 18, scope: !536)
!586 = !{!561, !562, i64 80}
!587 = !DILocation(line: 89, column: 7, scope: !536)
!588 = !DILocation(line: 89, column: 18, scope: !536)
!589 = !{!561, !562, i64 64}
!590 = !DILocation(line: 91, column: 3, scope: !536)
!591 = !DILocation(line: 0, scope: !592)
!592 = distinct !DILexicalBlock(scope: !555, file: !1, line: 73, column: 9)
!593 = !DILocation(line: 93, column: 1, scope: !536)
