...
# %bb.0:
	movq	%rsi, %rdi
	jmp	releaseSentinelRedisInstance # TAILCALL
.Lfunc_end0:
...
# %bb.29:
	...
	popq	%r15
	popq	%rbp
	jmp	addReplySentinelRedisInstance # TAILCALL
.LBB2_30:
	cmpl	$3, 64(%r12)
	jne	.LBB2_105
# %bb.31:
...
# %bb.62:
	...
	popq	%r15
	popq	%rbp
	jmp	sentinelPendingScriptsCommand # TAILCALL
.LBB2_63:
	cmpl	$6, 64(%r12)
	jne	.LBB2_73
# %bb.64:
...
# %bb.100:
	...
	popq	%r15
	popq	%rbp
	jmp	sentinelSetCommand      # TAILCALL
.LBB2_101:
	movl	$.L.str.230, %edi
.LBB2_102:
	callq	sdsnew
...
.LBB2_115:                              #   in Loop: Header=BB2_109 Depth=1
	...
	xorl	%eax, %eax
	callq	serverLog
.LBB2_116:                              #   in Loop: Header=BB2_109 Depth=1
	movslq	64(%r12), %rax
	cmpq	%rax, %r15
	jge	.LBB2_79
# %bb.117:                              #   in Loop: Header=BB2_109 Depth=1
	movq	72(%r12), %r14
	addq	$1, %r15
	jmp	.LBB2_109
.LBB2_118:
...
# %bb.133:                              #   in Loop: Header=BB2_130 Depth=1
	...
	andl	$7, %eax
	jmpq	*.LJTI2_0(,%rax,8)
.LBB2_134:                              #   in Loop: Header=BB2_130 Depth=1
	shrq	$3, %rdx
	jmp	.LBB2_141
.LBB2_135:                              #   in Loop: Header=BB2_130 Depth=1
...
.LBB2_136:                              #   in Loop: Header=BB2_130 Depth=1
	xorl	%edx, %edx
	jmp	.LBB2_141
.LBB2_137:                              #   in Loop: Header=BB2_130 Depth=1
	movzbl	-3(%rsi), %edx
	jmp	.LBB2_141
.LBB2_138:                              #   in Loop: Header=BB2_130 Depth=1
	movzwl	-5(%rsi), %edx
	jmp	.LBB2_141
.LBB2_139:                              #   in Loop: Header=BB2_130 Depth=1
	movl	-9(%rsi), %edx
	jmp	.LBB2_141
.LBB2_140:                              #   in Loop: Header=BB2_130 Depth=1
	movq	-17(%rsi), %rdx
.LBB2_141:                              #   in Loop: Header=BB2_130 Depth=1
	movq	%r12, %rdi
	callq	addReplyBulkCBuffer
.LBB2_142:                              #   in Loop: Header=BB2_130 Depth=1
	movq	144(%r15), %rdi
	callq	dictGetIterator
	movq	%rax, %r15
	movq	%rax, %rdi
...
.LBB2_144:                              #   in Loop: Header=BB2_145 Depth=2
	...
	callq	addReplyBulkCBuffer
	movq	%r15, %rdi
.LBB2_145:                              #   Parent Loop BB2_130 Depth=1
...
# %bb.148:                              #   in Loop: Header=BB2_145 Depth=2
	...
	andl	$7, %eax
	jmpq	*.LJTI2_1(,%rax,8)
.LBB2_149:                              #   in Loop: Header=BB2_145 Depth=2
	shrq	$3, %rdx
	jmp	.LBB2_144
...
.LBB2_151:                              #   in Loop: Header=BB2_145 Depth=2
	xorl	%edx, %edx
	jmp	.LBB2_144
.LBB2_152:                              #   in Loop: Header=BB2_145 Depth=2
	movzbl	-3(%rsi), %edx
	jmp	.LBB2_144
.LBB2_153:                              #   in Loop: Header=BB2_145 Depth=2
	movzwl	-5(%rsi), %edx
	jmp	.LBB2_144
.LBB2_154:                              #   in Loop: Header=BB2_145 Depth=2
	movl	-9(%rsi), %edx
	jmp	.LBB2_144
.LBB2_155:
	movq	%r13, %rdi
...
# %bb.61:                               # %.preheader
	...
	jmp	.LBB4_62
	.p2align	4, 0x90
.LBB4_64:                               #   in Loop: Header=BB4_62 Depth=1
	leal	1(%rdx), %r13d
	movq	8(%rax), %rcx
	movq	32(%rax), %rsi
	movq	(%rsi), %r9
...
# %bb.0:
	...
	jmp	.LBB51_1
	.p2align	4, 0x90
.LBB51_32:                              #   in Loop: Header=BB51_1 Depth=1
	movq	%r12, %rdi
	callq	dictReleaseIterator
	movq	-48(%rbp), %rdi         # 8-byte Reload
...
# %bb.20:                               #   in Loop: Header=BB51_19 Depth=2
	...
	cmpl	8(%r12), %eax
	jne	.LBB51_23
# %bb.21:                               #   in Loop: Header=BB51_19 Depth=2
	movq	(%rbx), %rdi
	movq	(%r12), %rsi
	callq	strcasecmp
	testl	%eax, %eax
...
# %bb.22:                               #   in Loop: Header=BB51_19 Depth=2
	...
	jmp	.LBB51_23
	.p2align	4, 0x90
.LBB51_24:                              #   in Loop: Header=BB51_1 Depth=1
	movq	%r13, %rdi
	callq	dictReleaseIterator
	movq	136(%r14), %rdi
	callq	dictGetIterator
	...
	jmp	.LBB51_25
	.p2align	4, 0x90
.LBB51_28:                              #   in Loop: Header=BB51_25 Depth=2
	movq	%r12, %rdi
.LBB51_25:                              #   Parent Loop BB51_1 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	callq	dictNext
	testq	%rax, %rax
	je	.LBB51_29
...
# %bb.27:                               #   in Loop: Header=BB51_25 Depth=2
	...
	jmp	.LBB51_28
	.p2align	4, 0x90
.LBB51_29:                              #   in Loop: Header=BB51_1 Depth=1
	movq	%r12, %rdi
	callq	dictReleaseIterator
	movq	104(%r14), %rdi
	callq	dictGetIterator
	...
	movq	%rax, %rdi
	.p2align	4, 0x90
.LBB51_31:                              #   Parent Loop BB51_1 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	callq	dictNext
	testq	%rax, %rax
	je	.LBB51_32
# %bb.30:                               #   in Loop: Header=BB51_31 Depth=2
	movq	(%rax), %rbx
	movq	8(%rax), %r13
	callq	sdsempty
	movq	8(%r14), %rdx
...
.LBB56_10:
	...
	popq	%r14
	popq	%rbp
	jmp	sentinelProcessHelloMessage # TAILCALL
.Lfunc_end56:
...
.LBB58_72:                              #   in Loop: Header=BB58_3 Depth=1
	...
	testl	%eax, %eax
	jne	.LBB58_75
# %bb.73:                               #   in Loop: Header=BB58_3 Depth=1
	leaq	12(%rbx), %rdi
	callq	atoi
	cmpl	%eax, 208(%r15)
	je	.LBB58_75
...
.LBB58_85:                              #   in Loop: Header=BB58_3 Depth=1
	...
	cmpb	$4, %cl
	ja	.LBB58_95
# %bb.86:                               #   in Loop: Header=BB58_3 Depth=1
	movl	%eax, %ecx
	andl	$7, %ecx
	jmpq	*.LJTI58_6(,%rcx,8)
...
# %bb.104:                              #   in Loop: Header=BB58_3 Depth=1
	...
	movq	%rax, 216(%r15)
	jmp	.LBB58_105
.LBB58_26:                              #   in Loop: Header=BB58_3 Depth=1
	movl	$.L.str.126, %esi
	movq	%rbx, %rdi
	callq	strstr
	testq	%rax, %rax
...
# %bb.33:                               #   in Loop: Header=BB58_3 Depth=1
	movb	$0, (%rax)
.LBB58_34:                              #   in Loop: Header=BB58_3 Depth=1
	movq	-56(%rbp), %rdi         # 8-byte Reload
	movl	$44, %esi
	callq	strchr
	testq	%rax, %rax
...
# %bb.29:                               #   in Loop: Header=BB58_3 Depth=1
	...
	testq	%rax, %rax
	je	.LBB58_105
.LBB58_35:                              #   in Loop: Header=BB58_3 Depth=1
	movb	$0, (%rax)
...
# %bb.4:
	movq	24(%rsi), %rsi
	movq	%rdx, %rdi
	jmp	sentinelRefreshInstanceInfo # TAILCALL
.LBB62_3:
	retq
.Lfunc_end62:
...
# %bb.16:
	...
	popq	%r15
	popq	%rbp
	jmp	sentinelSendHello       # TAILCALL
.LBB68_15:
	addq	$8, %rsp
	popq	%rbx
	popq	%r12
...
# %bb.78:                               #   in Loop: Header=BB77_6 Depth=1
	cmpl	$1, %eax
	je	.LBB77_3
# %bb.79:                               #   in Loop: Header=BB77_6 Depth=1
	movq	72(%r12), %rax
	movq	-64(%rbp), %rcx         # 8-byte Reload
	movq	(%rax,%rcx,8), %rax
	movq	8(%rax), %r8
...
# %bb.7:
	...
	popq	%r15
	popq	%rbp
	jmp	sentinelAbortFailover   # TAILCALL
.LBB86_4:
	xorl	%edi, %edi
	callq	sdsfree
	testb	$8, 1(%r14)
...
.LBB92_16:
	...
	popq	%r15
	popq	%rbp
	jmp	sentinelFailoverDetectEnd # TAILCALL
.Lfunc_end92:
...
# %bb.0:
	...
	popq	%r15
	popq	%rbp
	jmp	sentinelResetMasterAndChangeAddress # TAILCALL
.Lfunc_end93:
...
.LBB94_4:
	...
	popq	%rbx
	popq	%rbp
	jmp	sentinelFailoverWaitStart # TAILCALL
.LBB94_9:
	movq	%rbx, %rdi
	addq	$8, %rsp
	popq	%rbx
	popq	%rbp
	jmp	sentinelFailoverReconfNextSlave # TAILCALL
.LBB94_6:
	movq	%rbx, %rdi
	addq	$8, %rsp
	popq	%rbx
	popq	%rbp
	jmp	sentinelFailoverSendSlaveOfNoOne # TAILCALL
.LBB94_5:
	movq	%rbx, %rdi
	addq	$8, %rsp
	popq	%rbx
	popq	%rbp
	jmp	sentinelFailoverSelectSlave # TAILCALL
.LBB94_7:
	callq	mstime
	subq	256(%rbx), %rax
	cmpq	272(%rbx), %rax
...
.LBB99_2:
	...
	movl	$1, %edx
	jmp	aeCreateFileEvent       # TAILCALL
.Lfunc_end99:
...
# %bb.0:
	movq	(%rdx), %rdi
	jmp	redisAsyncHandleRead    # TAILCALL
.Lfunc_end104:
...
# %bb.0:
	movq	(%rdx), %rdi
	jmp	redisAsyncHandleWrite   # TAILCALL
.Lfunc_end105:
