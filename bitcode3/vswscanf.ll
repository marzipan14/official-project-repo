...
define dso_local i32 @_vswscanf_r(%struct._reent*, i32*, i32*, %struct.__va_list_tag*) local_unnamed_addr #0 !dbg !37 {
  ...
  %6 = bitcast %struct.__sFILE* %5 to i8*, !dbg !311
  call void @llvm.lifetime.start.p0i8(i64 176, i8* nonnull %6) #5, !dbg !311
  %7 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %5, i64 0, i32 3, !dbg !312
  store i16 516, i16* %7, align 8, !dbg !313, !tbaa !269
  %8 = bitcast %struct.__sFILE* %5 to i32**, !dbg !314
  store i32* %1, i32** %8, align 8, !dbg !314, !tbaa !280
  %9 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %5, i64 0, i32 5, !dbg !315
  %10 = bitcast %struct.__sbuf* %9 to i32**, !dbg !316
  store i32* %1, i32** %10, align 8, !dbg !316, !tbaa !283
  %11 = tail call i64 @wcslen(i32* %1) #4, !dbg !317
  %12 = trunc i64 %11 to i32, !dbg !317
  %13 = shl i32 %12, 2, !dbg !317
  %14 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %5, i64 0, i32 1, !dbg !318
  store i32 %13, i32* %14, align 8, !dbg !319, !tbaa !287
  %15 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %5, i64 0, i32 5, i32 1, !dbg !320
  store i32 %13, i32* %15, align 8, !dbg !321, !tbaa !290
  %16 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %5, i64 0, i32 8, !dbg !322
  store i64 (%struct._reent*, i8*, i8*, i32)* @__seofread, i64 (%struct._reent*, i8*, i8*, i32)** %16, align 8, !dbg !323, !tbaa !293
  %17 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %5, i64 0, i32 12, i32 0, !dbg !324
  store i8* null, i8** %17, align 8, !dbg !325, !tbaa !296
  %18 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %5, i64 0, i32 17, i32 0, !dbg !326
  store i8* null, i8** %18, align 8, !dbg !327, !tbaa !299
  %19 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %5, i64 0, i32 4, !dbg !328
  store i16 -1, i16* %19, align 2, !dbg !329, !tbaa !302
  %20 = call i32 @__ssvfwscanf_r(%struct._reent* %0, %struct.__sFILE* nonnull %5, i32* %2, %struct.__va_list_tag* %3) #4, !dbg !331
  call void @llvm.lifetime.end.p0i8(i64 176, i8* nonnull %6) #5, !dbg !332
  ret i32 %20, !dbg !333
}
...
!306 = !DILocation(line: 43, column: 3, scope: !10)
!307 = !DILocation(line: 49, column: 29, scope: !37)
!308 = !DILocation(line: 49, column: 50, scope: !37)
!309 = !DILocation(line: 49, column: 71, scope: !37)
!310 = !DILocation(line: 50, column: 15, scope: !37)
!311 = !DILocation(line: 52, column: 3, scope: !37)
!312 = !DILocation(line: 54, column: 5, scope: !37)
!313 = !DILocation(line: 54, column: 12, scope: !37)
!314 = !DILocation(line: 55, column: 22, scope: !37)
!315 = !DILocation(line: 55, column: 5, scope: !37)
!316 = !DILocation(line: 55, column: 15, scope: !37)
!317 = !DILocation(line: 56, column: 24, scope: !37)
!318 = !DILocation(line: 56, column: 19, scope: !37)
!319 = !DILocation(line: 56, column: 22, scope: !37)
!320 = !DILocation(line: 56, column: 9, scope: !37)
!321 = !DILocation(line: 56, column: 15, scope: !37)
!322 = !DILocation(line: 57, column: 5, scope: !37)
!323 = !DILocation(line: 57, column: 11, scope: !37)
!324 = !DILocation(line: 58, column: 9, scope: !37)
!325 = !DILocation(line: 58, column: 15, scope: !37)
!326 = !DILocation(line: 59, column: 9, scope: !37)
!327 = !DILocation(line: 59, column: 15, scope: !37)
!328 = !DILocation(line: 60, column: 5, scope: !37)
!329 = !DILocation(line: 60, column: 11, scope: !37)
!330 = !DILocation(line: 52, column: 8, scope: !37)
!331 = !DILocation(line: 61, column: 10, scope: !37)
!332 = !DILocation(line: 62, column: 1, scope: !37)
!333 = !DILocation(line: 61, column: 3, scope: !37)
