...
define internal i64 @null_conversion_convert(%struct._reent* nocapture, i8* nocapture readnone, i8** nocapture, i64* nocapture, i8** nocapture, i64* nocapture, i32) #1 !dbg !288 {
...
; <label>:18:                                     ; preds = %13
  ...
  %21 = tail call i8* @memcpy(i8* %19, i8* %20, i64 %15) #4, !dbg !329
...
; Function Attrs: noredzone nounwind readnone
define internal void @null_conversion_get_state(i8* nocapture, %struct._mbstate_t* nocapture, i32) #0 !dbg !335 {
  ret void, !dbg !341
}
