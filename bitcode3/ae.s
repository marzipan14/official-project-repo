...
# %bb.26:
	...
	jmp	.LBB10_27
	.p2align	4, 0x90
.LBB10_32:                              #   in Loop: Header=BB10_27 Depth=1
	movq	32(%r9), %rdi
	movslq	%r15d, %r15
	movl	%edx, (%rdi,%r15,8)
...
.LBB10_30:                              #   in Loop: Header=BB10_27 Depth=1
	testb	$2, %dil
	je	.LBB10_32
# %bb.31:                               #   in Loop: Header=BB10_27 Depth=1
	movq	%rdx, %rdi
	shrq	$6, %rdi
...
.LBB10_51:                              #   in Loop: Header=BB10_40 Depth=1
	movq	8(%r14,%r12), %rax
.LBB10_53:                              #   in Loop: Header=BB10_40 Depth=1
	movq	24(%r14,%r12), %rdx
	movq	%r9, %rdi
...
.LBB10_46:                              #   in Loop: Header=BB10_40 Depth=1
	...
	movq	-48(%rbp), %r9          # 8-byte Reload
.LBB10_47:                              #   in Loop: Header=BB10_40 Depth=1
	movl	$1, %eax
...
# %bb.49:                               #   in Loop: Header=BB10_40 Depth=1
	...
	testb	$1, %dl
	je	.LBB10_54
# %bb.50:                               #   in Loop: Header=BB10_40 Depth=1
	testl	%eax, %eax
	je	.LBB10_51
# %bb.52:                               #   in Loop: Header=BB10_40 Depth=1
	movq	8(%r14,%r12), %rax
	cmpq	%rax, 16(%r14,%r12)
	jne	.LBB10_53
	jmp	.LBB10_54
...
# %bb.62:
	...
	xorl	%r12d, %r12d
	jmp	.LBB10_63
.LBB10_78:                              #   in Loop: Header=BB10_63 Depth=1
	movq	$-1, (%r14)
.LBB10_79:                              #   in Loop: Header=BB10_63 Depth=1
	movq	-48(%rbp), %rdi         # 8-byte Reload
.LBB10_80:                              #   in Loop: Header=BB10_63 Depth=1
	movq	56(%r14), %rbx
.LBB10_81:                              #   in Loop: Header=BB10_63 Depth=1
	movq	%rbx, %r14
	testq	%rbx, %rbx
	je	.LBB10_82
.LBB10_63:                              # =>This Inner Loop Header: Depth=1
	...
	cmpq	$-1, %rax
	je	.LBB10_64
# %bb.72:                               #   in Loop: Header=BB10_63 Depth=1
	cmpq	%r13, %rax
	jge	.LBB10_80
# %bb.73:                               #   in Loop: Header=BB10_63 Depth=1
	leaq	65472(%rbp), %rdi
	xorl	%esi, %esi
	callq	gettimeofday
	movq	-48(%rbp), %rdi         # 8-byte Reload
	...
	cmpq	%rax, 65472(%rbp)
	jg	.LBB10_76
# %bb.74:                               #   in Loop: Header=BB10_63 Depth=1
	jne	.LBB10_80
# %bb.75:                               #   in Loop: Header=BB10_63 Depth=1
	cmpq	16(%r14), %rdx
	jl	.LBB10_80
.LBB10_76:                              #   in Loop: Header=BB10_63 Depth=1
	movq	(%r14), %rsi
	movq	40(%r14), %rdx
	callq	*24(%r14)
	addl	$1, %r12d
	cmpl	$-1, %eax
	je	.LBB10_78
# %bb.77:                               #   in Loop: Header=BB10_63 Depth=1
	movq	%r12, %rbx
	movslq	%eax, %r12
	leaq	65472(%rbp), %rdi
	xorl	%esi, %esi
	...
	jmp	.LBB10_79
	.p2align	4, 0x90
.LBB10_64:                              #   in Loop: Header=BB10_63 Depth=1
	movq	48(%r14), %rax
	movq	56(%r14), %rbx
	testq	%rax, %rax
	je	.LBB10_66
...
.LBB10_68:                              #   in Loop: Header=BB10_63 Depth=1
	movq	%rax, 48(%rcx)
.LBB10_69:                              #   in Loop: Header=BB10_63 Depth=1
	movq	32(%r14), %rax
	testq	%rax, %rax
	je	.LBB10_71
# %bb.70:                               #   in Loop: Header=BB10_63 Depth=1
	movq	40(%r14), %rsi
	movq	-48(%rbp), %rdi         # 8-byte Reload
	callq	*%rax
.LBB10_71:                              #   in Loop: Header=BB10_63 Depth=1
	movq	%r14, %rdi
	callq	zfree
	movq	-48(%rbp), %rdi         # 8-byte Reload
	jmp	.LBB10_81
.LBB10_66:                              #   in Loop: Header=BB10_63 Depth=1
	movq	%rbx, 40(%rdi)
	movq	%rbx, %rcx
	testq	%rcx, %rcx
	jne	.LBB10_68
