...
; <label>:48:                                     ; preds = %14, %8, %11
  ...
  %50 = fcmp une float %5, %0, !dbg !103
  %51 = and i1 %49, %50, !dbg !104
  br i1 %51, label %52, label %83, !dbg !104

; <label>:52:                                     ; preds = %48
  %53 = getelementptr inbounds %struct.exception, %struct.exception* %3, i64 0, i32 0, !dbg !105
  store i32 4, i32* %53, align 8, !dbg !107, !tbaa !58
  %54 = getelementptr inbounds %struct.exception, %struct.exception* %3, i64 0, i32 1, !dbg !108
  store i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i8** %54, align 8, !dbg !109, !tbaa !65
  %55 = getelementptr inbounds %struct.exception, %struct.exception* %3, i64 0, i32 5, !dbg !110
  store i32 0, i32* %55, align 8, !dbg !111, !tbaa !68
  %56 = getelementptr inbounds %struct.exception, %struct.exception* %3, i64 0, i32 2, !dbg !112
  %57 = insertelement <2 x float> undef, float %0, i32 0, !dbg !113
  %58 = insertelement <2 x float> %57, float %1, i32 1, !dbg !113
  %59 = fpext <2 x float> %58 to <2 x double>, !dbg !113
  %60 = bitcast double* %56 to <2 x double>*, !dbg !114
  store <2 x double> %59, <2 x double>* %60, align 8, !dbg !114, !tbaa !72
  %61 = extractelement <2 x double> %59, i32 0, !dbg !115
  %62 = tail call double @copysign(double 0.000000e+00, double %61) #5, !dbg !115
  %63 = getelementptr inbounds %struct.exception, %struct.exception* %3, i64 0, i32 4, !dbg !116
  store double %62, double* %63, align 8, !dbg !117, !tbaa !77
  %64 = load i32, i32* @__fdlib_version, align 4, !dbg !118, !tbaa !43
  %65 = icmp eq i32 %64, 2, !dbg !120
  br i1 %65, label %66, label %68, !dbg !121

; <label>:66:                                     ; preds = %52
  %67 = tail call i32* @__errno() #5, !dbg !122
  br label %73, !dbg !122

; <label>:68:                                     ; preds = %52
  %69 = call i32 @matherr(%struct.exception* nonnull %3) #5, !dbg !123
  %70 = icmp eq i32 %69, 0, !dbg !123
  br i1 %70, label %71, label %75, !dbg !125

; <label>:71:                                     ; preds = %68
  %72 = call i32* @__errno() #5, !dbg !126
  br label %73, !dbg !128

; <label>:73:                                     ; preds = %66, %71
  %74 = phi i32* [ %72, %71 ], [ %67, %66 ]
  store i32 34, i32* %74, align 4, !dbg !129, !tbaa !91
  br label %75, !dbg !130

; <label>:75:                                     ; preds = %73, %68
  %76 = load i32, i32* %55, align 8, !dbg !130, !tbaa !68
  %77 = icmp eq i32 %76, 0, !dbg !132
  br i1 %77, label %80, label %78, !dbg !133

; <label>:78:                                     ; preds = %75
  %79 = call i32* @__errno() #5, !dbg !134
  store i32 %76, i32* %79, align 4, !dbg !135, !tbaa !91
  br label %80, !dbg !134

; <label>:80:                                     ; preds = %75, %78
  %81 = load double, double* %63, align 8, !dbg !136, !tbaa !77
  %82 = fptrunc double %81 to float, !dbg !137
  br label %88, !dbg !138

; <label>:83:                                     ; preds = %48
  %84 = tail call i32 @finitef(float %1) #5, !dbg !139
  %85 = icmp eq i32 %84, 0, !dbg !139
  br i1 %85, label %86, label %88, !dbg !141

; <label>:86:                                     ; preds = %83
  %87 = tail call i32* @__errno() #5, !dbg !142
  store i32 34, i32* %87, align 4, !dbg !143, !tbaa !91
  br label %88, !dbg !142

; <label>:88:                                     ; preds = %86, %83, %2, %80, %45
  %89 = phi float [ %82, %80 ], [ %47, %45 ], [ %5, %2 ], [ %5, %83 ], [ %5, %86 ], !dbg !144
  call void @llvm.lifetime.end.p0i8(i64 48, i8* nonnull %4) #4, !dbg !145
  ret float %89, !dbg !145
}
...
!103 = !DILocation(line: 70, column: 21, scope: !102)
!104 = !DILocation(line: 70, column: 18, scope: !102)
!105 = !DILocation(line: 72, column: 10, scope: !106)
!106 = distinct !DILexicalBlock(scope: !102, file: !1, line: 70, column: 26)
!107 = !DILocation(line: 72, column: 15, scope: !106)
!108 = !DILocation(line: 73, column: 10, scope: !106)
!109 = !DILocation(line: 73, column: 15, scope: !106)
!110 = !DILocation(line: 74, column: 10, scope: !106)
!111 = !DILocation(line: 74, column: 14, scope: !106)
!112 = !DILocation(line: 75, column: 10, scope: !106)
!113 = !DILocation(line: 75, column: 17, scope: !106)
!114 = !DILocation(line: 75, column: 15, scope: !106)
!115 = !DILocation(line: 77, column: 19, scope: !106)
!116 = !DILocation(line: 77, column: 10, scope: !106)
!117 = !DILocation(line: 77, column: 17, scope: !106)
!118 = !DILocation(line: 78, column: 10, scope: !119)
!119 = distinct !DILexicalBlock(scope: !106, file: !1, line: 78, column: 10)
!120 = !DILocation(line: 78, column: 23, scope: !119)
!121 = !DILocation(line: 78, column: 10, scope: !106)
...
!131 = distinct !DILexicalBlock(scope: !106, file: !1, line: 83, column: 10)
!132 = !DILocation(line: 83, column: 18, scope: !131)
!133 = !DILocation(line: 83, column: 10, scope: !106)
!134 = !DILocation(line: 84, column: 9, scope: !131)
!135 = !DILocation(line: 84, column: 15, scope: !131)
!136 = !DILocation(line: 85, column: 24, scope: !106)
!137 = !DILocation(line: 85, column: 20, scope: !106)
!138 = !DILocation(line: 85, column: 13, scope: !106)
!139 = !DILocation(line: 88, column: 6, scope: !140)
!140 = distinct !DILexicalBlock(scope: !18, file: !1, line: 88, column: 5)
!141 = !DILocation(line: 88, column: 5, scope: !18)
!142 = !DILocation(line: 88, column: 19, scope: !140)
!143 = !DILocation(line: 88, column: 25, scope: !140)
!144 = !DILocation(line: 0, scope: !56)
!145 = !DILocation(line: 92, column: 1, scope: !18)
