...
; <label>:10:                                     ; preds = %5
  ...
  %12 = icmp ult i64 %11, ptrtoint ([0 x i8]* @_intrstack_start to i64), !dbg !537
  br i1 %12, label %19, label %13, !dbg !537

; <label>:13:                                     ; preds = %10
  %14 = tail call i64 asm sideeffect "mov %rsp, $0", "=r,~{dirflag},~{fpsr},~{flags}"() #5, !dbg !538, !srcloc !535
  %15 = icmp ugt i64 %14, ptrtoint ([0 x i8]* @_end to i64), !dbg !537
  br i1 %15, label %19, label %16, !dbg !541

; <label>:16:                                     ; preds = %13
  %17 = tail call %struct.uk_sched* @uk_sched_get_default() #9, !dbg !567
  %18 = tail call %struct.uk_thread* @uk_sched_thread_create(%struct.uk_sched* %17, i8* %0, %struct.uk_thread_attr* null, void (i8*)* %1, i8* %2) #9, !dbg !568
  store %struct.uk_thread* %18, %struct.uk_thread** %6, align 8, !dbg !570, !tbaa !571
  br label %31, !dbg !570

; <label>:19:                                     ; preds = %13, %10
  %20 = tail call i64 asm sideeffect "mov %rsp, $0", "=r,~{dirflag},~{fpsr},~{flags}"() #5, !dbg !575, !srcloc !535
  %21 = and i64 %20, -65536, !dbg !586
  %22 = or i64 %21, 4097, !dbg !586
  %23 = add nsw i64 %22, -1, !dbg !586
  %24 = inttoptr i64 %23 to i32*, !dbg !587
  %25 = load i32, i32* %24, align 4096, !dbg !588, !tbaa !589
  %26 = ptrtoint i8* %2 to i64, !dbg !591
  %27 = ptrtoint i8* %0 to i64, !dbg !591
  %28 = ptrtoint void (i8*)* %1 to i64, !dbg !591
  ...
  call void asm sideeffect "mov %r11, $0\0A\09", "=*m,{r11},~{dirflag},~{fpsr},~{flags}"(%struct.uk_thread** nonnull %6, i64 %29) #5, !dbg !593, !srcloc !597
  %30 = load %struct.uk_thread*, %struct.uk_thread** %6, align 8, !dbg !598, !tbaa !571
  br label %31

; <label>:31:                                     ; preds = %19, %16
  %32 = phi %struct.uk_thread* [ %30, %19 ], [ %18, %16 ], !dbg !598
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %7) #5, !dbg !599
  ret %struct.uk_thread* %32, !dbg !600
}
...
define internal void @uk_pr_crit(i8* nocapture readnone, ...) unnamed_addr #3 !dbg !2 {
  ...
  %3 = bitcast [1 x %struct.__va_list_tag]* %2 to i8*, !dbg !601
  call void @llvm.lifetime.start.p0i8(i64 24, i8* nonnull %3) #5, !dbg !601
  %4 = getelementptr inbounds [1 x %struct.__va_list_tag], [1 x %struct.__va_list_tag]* %2, i64 0, i64 0, !dbg !603
  call void @llvm.va_start(i8* nonnull %3), !dbg !603
  call void @_uk_vprintk(i32 0, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @uk_pr_crit.__str, i64 0, i64 0), i8* getelementptr inbounds ([10 x i8], [10 x i8]* @uk_pr_crit.__str.1, i64 0, i64 0), i32 198, i8* getelementptr inbounds ([73 x i8], [73 x i8]* @.str, i64 0, i64 0), %struct.__va_list_tag* nonnull %4) #9, !dbg !604
  call void @llvm.va_end(i8* nonnull %3), !dbg !607
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %3) #5, !dbg !608
  ret void, !dbg !608
}
...
; Function Attrs: inlinehint noredzone nounwind
define internal %struct.uk_thread* @uk_thread_create(i8*, void (i8*)*, i8*) #3 !dbg !543 {
  %4 = tail call %struct.uk_sched* @uk_sched_get_default() #9, !dbg !617
  %5 = tail call %struct.uk_thread* @uk_sched_thread_create(%struct.uk_sched* %4, i8* %0, %struct.uk_thread_attr* null, void (i8*)* %1, i8* %2) #9, !dbg !618
  ret %struct.uk_thread* %5, !dbg !619
}
...
!537 = !DILocation(line: 58, column: 2, scope: !511)
!538 = !DILocation(line: 120, column: 2, scope: !528, inlinedAt: !539)
!539 = distinct !DILocation(line: 58, column: 2, scope: !511)
!540 = !DILocation(line: 118, column: 16, scope: !528, inlinedAt: !539)
!541 = !DILocation(line: 58, column: 2, scope: !512)
!542 = !DILocalVariable(name: "name", arg: 1, scope: !543, file: !75, line: 108, type: !6)
!543 = distinct !DISubprogram(name: "uk_thread_create", scope: !75, file: !75, line: 108, type: !544, isLocal: true, isDefinition: true, scopeLine: 110, flags: DIFlagPrototyped, isOptimized: true, unit: !9, retainedNodes: !546)
!544 = !DISubroutineType(types: !545)
!545 = !{!73, !6, !247, !57}
!546 = !{!542, !547, !548}
!547 = !DILocalVariable(name: "function", arg: 2, scope: !543, file: !75, line: 109, type: !247)
!548 = !DILocalVariable(name: "arg", arg: 3, scope: !543, file: !75, line: 109, type: !57)
!549 = !DILocation(line: 108, column: 62, scope: !543, inlinedAt: !550)
!550 = distinct !DILocation(line: 58, column: 2, scope: !551)
!551 = distinct !DILexicalBlock(scope: !511, file: !10, line: 58, column: 2)
!552 = !DILocation(line: 109, column: 9, scope: !543, inlinedAt: !550)
!553 = !DILocation(line: 109, column: 34, scope: !543, inlinedAt: !550)
!554 = !DILocalVariable(name: "name", arg: 1, scope: !555, file: !75, line: 101, type: !6)
!555 = distinct !DISubprogram(name: "uk_thread_create_attr", scope: !75, file: !75, line: 101, type: !556, isLocal: true, isDefinition: true, scopeLine: 103, flags: DIFlagPrototyped, isOptimized: true, unit: !9, retainedNodes: !558)
!556 = !DISubroutineType(types: !557)
!557 = !{!73, !6, !126, !247, !57}
!558 = !{!554, !559, !560, !561}
!559 = !DILocalVariable(name: "attr", arg: 2, scope: !555, file: !75, line: 102, type: !126)
!560 = !DILocalVariable(name: "function", arg: 3, scope: !555, file: !75, line: 102, type: !247)
!561 = !DILocalVariable(name: "arg", arg: 4, scope: !555, file: !75, line: 102, type: !57)
!562 = !DILocation(line: 101, column: 67, scope: !555, inlinedAt: !563)
!563 = distinct !DILocation(line: 111, column: 9, scope: !543, inlinedAt: !550)
!564 = !DILocation(line: 102, column: 26, scope: !555, inlinedAt: !563)
!565 = !DILocation(line: 102, column: 38, scope: !555, inlinedAt: !563)
!566 = !DILocation(line: 102, column: 63, scope: !555, inlinedAt: !563)
!567 = !DILocation(line: 104, column: 32, scope: !555, inlinedAt: !563)
!568 = !DILocation(line: 104, column: 9, scope: !555, inlinedAt: !563)
!569 = !DILocation(line: 52, column: 20, scope: !68)
!570 = !DILocation(line: 58, column: 2, scope: !551)
!571 = !{!572, !572, i64 0}
!572 = !{!"any pointer", !573, i64 0}
!573 = !{!"omnipotent char", !574, i64 0}
!574 = !{!"Simple C/C++ TBAA"}
!575 = !DILocation(line: 120, column: 2, scope: !528, inlinedAt: !576)
!576 = distinct !DILocation(line: 49, column: 21, scope: !577, inlinedAt: !583)
!577 = distinct !DISubprogram(name: "uk_thread_get_tid", scope: !578, file: !578, line: 47, type: !579, isLocal: true, isDefinition: true, scopeLine: 48, flags: DIFlagPrototyped, isOptimized: true, unit: !9, retainedNodes: !581)
!578 = !DIFile(filename: "/root/.unikraft/unikraft/lib/flexos-core/include/flexos/impl/intelpku-impl.h", directory: "/root/.unikraft/apps/redis/build")
!579 = !DISubroutineType(types: !580)
!580 = !{!38}
!581 = !{!582}
!582 = !DILocalVariable(name: "sp", scope: !577, file: !578, line: 49, type: !32)
!583 = distinct !DILocation(line: 58, column: 2, scope: !508)
!584 = !DILocation(line: 118, column: 16, scope: !528, inlinedAt: !576)
!585 = !DILocation(line: 49, column: 16, scope: !577, inlinedAt: !583)
!586 = !DILocation(line: 50, column: 19, scope: !577, inlinedAt: !583)
!587 = !DILocation(line: 50, column: 11, scope: !577, inlinedAt: !583)
!588 = !DILocation(line: 50, column: 9, scope: !577, inlinedAt: !583)
!589 = !{!590, !590, i64 0}
!590 = !{!"int", !573, i64 0}
!591 = !DILocation(line: 58, column: 2, scope: !508)
!592 = !{i32 -2146446055, i32 -2146446042, i32 -2146446017, i32 -2146445993, i32 -2146445968, i32 -2146445893, i32 -2146445868, i32 -2146445724, i32 -2146442516, i32 -2146442427, i32 -2146442306, i32 -2146442211, i32 -2146442110, i32 -2146442083, i32 -2146442000, i32 -2146441911, i32 -2146441790, i32 -2146441690, i32 -2146441584, i32 -2146441476, i32 -2146445394, i32 -2146445341, i32 -2146445310, i32 -2146445279, i32 -2146445258, i32 -2146445236, i32 -2146445187, i32 -2146445166, i32 -2146445063, i32 -2146441393, i32 -2146441304, i32 -2146441183, i32 -2146441084, i32 -2146440978, i32 -2146440876, i32 -2146440843, i32 -2146440770, i32 -2146440702, i32 -2146444873, i32 -2146444814, i32 -2146444761, i32 -2146444730, i32 -2146444699, i32 -2146444678, i32 -2146444656, i32 -2146444607, i32 -2146444586, i32 -2146440650, i32 -2146440561, i32 -2146440440, i32 -2146440341, i32 -2146440235, i32 -2146440133, i32 -2146440100, i32 -2146440017, i32 -2146439928, i32 -2146439807, i32 -2146439707, i32 -2146439681, i32 -2146439578, i32 -2146439552, i32 -2146444328, i32 -2146444261, i32 -2146444236, i32 -2146444172, i32 -2146444090, i32 -2146444067, i32 -2146444042, i32 -2146444017}
!593 = !DILocation(line: 58, column: 2, scope: !594)
!594 = distinct !DILexicalBlock(scope: !595, file: !10, line: 58, column: 2)
!595 = distinct !DILexicalBlock(scope: !596, file: !10, line: 58, column: 2)
!596 = distinct !DILexicalBlock(scope: !508, file: !10, line: 58, column: 2)
!597 = !{i32 -2146442772, i32 -2146442756}
!598 = !DILocation(line: 59, column: 9, scope: !68)
!599 = !DILocation(line: 60, column: 1, scope: !68)
!600 = !DILocation(line: 59, column: 2, scope: !68)
!601 = !DILocation(line: 196, column: 2, scope: !2)
!602 = !DILocation(line: 196, column: 10, scope: !2)
!603 = !DILocation(line: 197, column: 2, scope: !2)
!604 = !DILocation(line: 198, column: 2, scope: !605)
!605 = distinct !DILexicalBlock(scope: !606, file: !3, line: 198, column: 2)
!606 = distinct !DILexicalBlock(scope: !2, file: !3, line: 198, column: 2)
!607 = !DILocation(line: 199, column: 2, scope: !2)
!608 = !DILocation(line: 200, column: 1, scope: !2)
!609 = !DILocation(line: 108, column: 62, scope: !543)
!610 = !DILocation(line: 109, column: 9, scope: !543)
!611 = !DILocation(line: 109, column: 34, scope: !543)
!612 = !DILocation(line: 101, column: 67, scope: !555, inlinedAt: !613)
!613 = distinct !DILocation(line: 111, column: 9, scope: !543)
!614 = !DILocation(line: 102, column: 26, scope: !555, inlinedAt: !613)
!615 = !DILocation(line: 102, column: 38, scope: !555, inlinedAt: !613)
!616 = !DILocation(line: 102, column: 63, scope: !555, inlinedAt: !613)
!617 = !DILocation(line: 104, column: 32, scope: !555, inlinedAt: !613)
!618 = !DILocation(line: 104, column: 9, scope: !555, inlinedAt: !613)
!619 = !DILocation(line: 111, column: 2, scope: !543)
