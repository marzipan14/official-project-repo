...
; <label>:19:                                     ; preds = %15
  ...
  %21 = fadd double %0, 1.000000e+300, !dbg !67
  %22 = fcmp ogt double %21, 0.000000e+00, !dbg !68
  %23 = and i1 %22, %20, !dbg !69
  br i1 %23, label %47, label %24, !dbg !69

; <label>:24:                                     ; preds = %19
  %25 = zext i32 %6 to i64, !dbg !70
  %26 = shl nuw nsw i64 %25, 32, !dbg !70
  %27 = and i64 %2, 4294967295, !dbg !70
  %28 = or i64 %26, %27, !dbg !70
  %29 = bitcast i64 %28 to double, !dbg !70
  %30 = icmp ult i32 %6, 1071644672, !dbg !71
  %31 = fadd double %29, %29, !dbg !73
  br i1 %30, label %32, label %37, !dbg !74

; <label>:32:                                     ; preds = %24
  %33 = fmul double %31, %29, !dbg !76
  %34 = fsub double 1.000000e+00, %29, !dbg !78
  %35 = fdiv double %33, %34, !dbg !79
  %36 = fadd double %31, %35, !dbg !80
  br label %40, !dbg !81

; <label>:37:                                     ; preds = %24
  %38 = fsub double 1.000000e+00, %29, !dbg !82
  %39 = fdiv double %31, %38, !dbg !83
  br label %40

; <label>:40:                                     ; preds = %37, %32
  %41 = phi double [ %39, %37 ], [ %36, %32 ]
  %42 = tail call double @log1p(double %41) #3, !dbg !84
  %43 = fmul double %42, 5.000000e-01, !dbg !73
  %44 = icmp sgt i32 %4, -1, !dbg !85
  %45 = fsub double -0.000000e+00, %43, !dbg !87
  %46 = select i1 %44, double %43, double %45, !dbg !88
  ret double %46, !dbg !88

; <label>:47:                                     ; preds = %19, %17, %12
  %48 = phi double [ %14, %12 ], [ %18, %17 ], [ %0, %19 ], !dbg !89
  ret double %48, !dbg !90
}
...
!67 = !DILocation(line: 65, column: 25, scope: !66)
!68 = !DILocation(line: 65, column: 28, scope: !66)
!69 = !DILocation(line: 65, column: 18, scope: !66)
!70 = !DILocation(line: 66, column: 2, scope: !43)
!71 = !DILocation(line: 67, column: 7, scope: !72)
!72 = distinct !DILexicalBlock(scope: !16, file: !1, line: 67, column: 5)
!73 = !DILocation(line: 0, scope: !72)
!74 = !DILocation(line: 67, column: 5, scope: !16)
!75 = !DILocation(line: 56, column: 9, scope: !16)
!76 = !DILocation(line: 69, column: 23, scope: !77)
!77 = distinct !DILexicalBlock(scope: !72, file: !1, line: 67, column: 20)
!78 = !DILocation(line: 69, column: 30, scope: !77)
!79 = !DILocation(line: 69, column: 25, scope: !77)
!80 = !DILocation(line: 69, column: 21, scope: !77)
!81 = !DILocation(line: 70, column: 2, scope: !77)
!82 = !DILocation(line: 71, column: 30, scope: !72)
!83 = !DILocation(line: 71, column: 25, scope: !72)
!84 = !DILocation(line: 0, scope: !77)
!85 = !DILocation(line: 72, column: 7, scope: !86)
!86 = distinct !DILexicalBlock(scope: !16, file: !1, line: 72, column: 5)
!87 = !DILocation(line: 72, column: 34, scope: !86)
!88 = !DILocation(line: 72, column: 5, scope: !16)
!89 = !DILocation(line: 0, scope: !86)
!90 = !DILocation(line: 73, column: 1, scope: !16)
