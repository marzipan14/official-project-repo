; ModuleID = '/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/stdio/dprintf.c'
source_filename = "/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/stdio/dprintf.c"
...
define dso_local i32 @_dprintf_r(%struct._reent*, i32, i8* noalias, ...) local_unnamed_addr #0 !dbg !7 {
  %4 = alloca [1 x %struct.__va_list_tag], align 16
  %5 = bitcast [1 x %struct.__va_list_tag]* %4 to i8*, !dbg !250
  call void @llvm.lifetime.start.p0i8(i64 24, i8* nonnull %5) #3, !dbg !250
  %6 = getelementptr inbounds [1 x %struct.__va_list_tag], [1 x %struct.__va_list_tag]* %4, i64 0, i64 0, !dbg !252
  call void @llvm.va_start(i8* nonnull %5), !dbg !252
  %7 = call i32 @_vdprintf_r(%struct._reent* %0, i32 %1, i8* %2, %struct.__va_list_tag* nonnull %6) #5, !dbg !253
  call void @llvm.va_end(i8* nonnull %5), !dbg !255
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %5) #3, !dbg !256
  ret i32 %7, !dbg !257
}
...
declare dso_local i32 @_vdprintf_r(%struct._reent*, i32, i8*, %struct.__va_list_tag*) local_unnamed_addr #4
...
; Function Attrs: noredzone nounwind
define dso_local i32 @dprintf(i32, i8* noalias, ...) local_unnamed_addr #0 !dbg !258 {
  %3 = alloca [1 x %struct.__va_list_tag], align 16
  %4 = bitcast [1 x %struct.__va_list_tag]* %3 to i8*, !dbg !268
  call void @llvm.lifetime.start.p0i8(i64 24, i8* nonnull %4) #3, !dbg !268
  %5 = tail call %struct._reent* @__getreent() #5, !dbg !270
  %6 = getelementptr inbounds [1 x %struct.__va_list_tag], [1 x %struct.__va_list_tag]* %3, i64 0, i64 0, !dbg !272
  call void @llvm.va_start(i8* nonnull %4), !dbg !272
  %7 = call i32 @_vdprintf_r(%struct._reent* %5, i32 %0, i8* %1, %struct.__va_list_tag* nonnull %6) #5, !dbg !273
  call void @llvm.va_end(i8* nonnull %4), !dbg !275
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %4) #3, !dbg !276
  ret i32 %7, !dbg !277
}
...
!1 = !DIFile(filename: "/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/stdio/dprintf.c", directory: "/root/.unikraft/apps/redis/build")
!2 = !{}
!3 = !{i32 2, !"Dwarf Version", i32 4}
!4 = !{i32 2, !"Debug Info Version", i32 3}
!5 = !{i32 1, !"wchar_size", i32 4}
!6 = !{!"clang version 7.0.1-8+deb10u2 (tags/RELEASE_701/final)"}
!7 = distinct !DISubprogram(name: "_dprintf_r", scope: !1, file: !1, line: 56, type: !8, isLocal: false, isDefinition: true, scopeLine: 60, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !231)
...
!231 = !{!232, !233, !234, !235, !248}
!232 = !DILocalVariable(name: "ptr", arg: 1, scope: !7, file: !1, line: 56, type: !11)
!233 = !DILocalVariable(name: "fd", arg: 2, scope: !7, file: !1, line: 56, type: !10)
!234 = !DILocalVariable(name: "format", arg: 3, scope: !7, file: !1, line: 56, type: !230)
!235 = !DILocalVariable(name: "ap", scope: !7, file: !1, line: 61, type: !236)
...
!240 = !DIDerivedType(tag: DW_TAG_typedef, name: "__builtin_va_list", file: !1, line: 61, baseType: !241)
!241 = !DICompositeType(tag: DW_TAG_array_type, baseType: !242, size: 192, elements: !70)
!242 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "__va_list_tag", file: !1, line: 61, size: 192, elements: !243)
!243 = !{!244, !245, !246, !247}
!244 = !DIDerivedType(tag: DW_TAG_member, name: "gp_offset", scope: !242, file: !1, line: 61, baseType: !92, size: 32)
!245 = !DIDerivedType(tag: DW_TAG_member, name: "fp_offset", scope: !242, file: !1, line: 61, baseType: !92, size: 32, offset: 32)
!246 = !DIDerivedType(tag: DW_TAG_member, name: "overflow_arg_area", scope: !242, file: !1, line: 61, baseType: !36, size: 64, offset: 64)
!247 = !DIDerivedType(tag: DW_TAG_member, name: "reg_save_area", scope: !242, file: !1, line: 61, baseType: !36, size: 64, offset: 128)
!248 = !DILocalVariable(name: "n", scope: !7, file: !1, line: 62, type: !10)
!249 = !DILocation(line: 56, column: 1, scope: !7)
!250 = !DILocation(line: 61, column: 2, scope: !7)
!251 = !DILocation(line: 61, column: 10, scope: !7)
!252 = !DILocation(line: 64, column: 2, scope: !7)
!253 = !DILocation(line: 65, column: 6, scope: !7)
!254 = !DILocation(line: 62, column: 6, scope: !7)
!255 = !DILocation(line: 66, column: 2, scope: !7)
!256 = !DILocation(line: 68, column: 1, scope: !7)
!257 = !DILocation(line: 67, column: 2, scope: !7)
!258 = distinct !DISubprogram(name: "dprintf", scope: !1, file: !1, line: 79, type: !259, isLocal: false, isDefinition: true, scopeLine: 82, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !261)
!259 = !DISubroutineType(types: !260)
!260 = !{!10, !10, !230, null}
!261 = !{!262, !263, !264, !265, !266}
!262 = !DILocalVariable(name: "fd", arg: 1, scope: !258, file: !1, line: 79, type: !10)
!263 = !DILocalVariable(name: "format", arg: 2, scope: !258, file: !1, line: 79, type: !230)
!264 = !DILocalVariable(name: "ap", scope: !258, file: !1, line: 83, type: !236)
!265 = !DILocalVariable(name: "n", scope: !258, file: !1, line: 84, type: !10)
!266 = !DILocalVariable(name: "ptr", scope: !258, file: !1, line: 85, type: !11)
!267 = !DILocation(line: 79, column: 1, scope: !258)
!268 = !DILocation(line: 83, column: 3, scope: !258)
!269 = !DILocation(line: 83, column: 11, scope: !258)
!270 = !DILocation(line: 85, column: 24, scope: !258)
!271 = !DILocation(line: 85, column: 18, scope: !258)
!272 = !DILocation(line: 88, column: 3, scope: !258)
!273 = !DILocation(line: 89, column: 7, scope: !258)
!274 = !DILocation(line: 84, column: 7, scope: !258)
!275 = !DILocation(line: 90, column: 3, scope: !258)
!276 = !DILocation(line: 92, column: 1, scope: !258)
!277 = !DILocation(line: 91, column: 3, scope: !258)
