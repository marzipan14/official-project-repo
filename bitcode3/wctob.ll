...
define dso_local i32 @wctob(i32) local_unnamed_addr #0 !dbg !14 {
  ...
  br i1 %6, label %22, label %7, !dbg !302
...
; <label>:7:                                      ; preds = %1
  ...
  %14 = select i1 %13, %struct.__locale_t* @__global_locale, %struct.__locale_t* %12, !dbg !306
  %15 = getelementptr inbounds %struct.__locale_t, %struct.__locale_t* %14, i64 0, i32 1, !dbg !321
  %16 = load i32 (%struct._reent*, i8*, i32, %struct._mbstate_t*)*, i32 (%struct._reent*, i8*, i32, %struct._mbstate_t*)** %15, align 8, !dbg !321, !tbaa !322
  %17 = call i32 %16(%struct._reent* %9, i8* nonnull %5, i32 %0, %struct._mbstate_t* nonnull %2) #5, !dbg !321
  %18 = icmp eq i32 %17, 1, !dbg !326
  %19 = load i8, i8* %5, align 1, !dbg !327
  %20 = zext i8 %19 to i32, !dbg !328
  %21 = select i1 %18, i32 %20, i32 -1, !dbg !321
  br label %22, !dbg !329

; <label>:22:                                     ; preds = %1, %7
  %23 = phi i32 [ %21, %7 ], [ -1, %1 ], !dbg !330
  call void @llvm.lifetime.end.p0i8(i64 1, i8* nonnull %5) #4, !dbg !331
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %4) #4, !dbg !331
  ret i32 %23, !dbg !331
}
...
!321 = !DILocation(line: 24, column: 10, scope: !14)
!322 = !{!323, !317, i64 224}
!323 = !{!"__locale_t", !315, i64 0, !317, i64 224, !317, i64 232, !314, i64 240, !317, i64 248, !324, i64 256, !315, i64 352, !315, i64 354, !315, i64 386}
!324 = !{!"lconv", !317, i64 0, !317, i64 8, !317, i64 16, !317, i64 24, !317, i64 32, !317, i64 40, !317, i64 48, !317, i64 56, !317, i64 64, !317, i64 72, !315, i64 80, !315, i64 81, !315, i64 82, !315, i64 83, !315, i64 84, !315, i64 85, !315, i64 86, !315, i64 87, !315, i64 88, !315, i64 89, !315, i64 90, !315, i64 91, !315, i64 92, !315, i64 93}
!325 = !DILocation(line: 12, column: 13, scope: !14)
!326 = !DILocation(line: 24, column: 51, scope: !14)
!327 = !DILocation(line: 24, column: 64, scope: !14)
!328 = !DILocation(line: 24, column: 58, scope: !14)
!329 = !DILocation(line: 24, column: 3, scope: !14)
!330 = !DILocation(line: 0, scope: !14)
!331 = !DILocation(line: 25, column: 1, scope: !14)
