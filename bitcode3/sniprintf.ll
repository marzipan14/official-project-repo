...
; <label>:31:                                     ; preds = %28, %29, %10
  ...
  call void @llvm.lifetime.end.p0i8(i64 176, i8* nonnull %8) #3, !dbg !319
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %7) #3, !dbg !319
  ret i32 %32, !dbg !319
}
...
; Function Attrs: noredzone nounwind
define dso_local i32 @sniprintf(i8*, i64, i8*, ...) local_unnamed_addr #0 !dbg !320 {
  ...
  %9 = icmp ugt i64 %1, 2147483647, !dbg !337
  br i1 %9, label %10, label %12, !dbg !339

; <label>:10:                                     ; preds = %3
  %11 = getelementptr inbounds %struct._reent, %struct._reent* %8, i64 0, i32 0, !dbg !340
  store i32 139, i32* %11, align 8, !dbg !342, !tbaa !264
  br label %31, !dbg !343

; <label>:12:                                     ; preds = %3
  %13 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %5, i64 0, i32 3, !dbg !344
  store i16 520, i16* %13, align 8, !dbg !345, !tbaa !276
  %14 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %5, i64 0, i32 0, !dbg !346
  store i8* %0, i8** %14, align 8, !dbg !347, !tbaa !284
  %15 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %5, i64 0, i32 5, i32 0, !dbg !348
  store i8* %0, i8** %15, align 8, !dbg !349, !tbaa !287
  %16 = icmp ne i64 %1, 0, !dbg !350
  %17 = add i64 %1, 4294967295, !dbg !351
  %18 = select i1 %16, i64 %17, i64 0, !dbg !352
  %19 = trunc i64 %18 to i32, !dbg !353
  %20 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %5, i64 0, i32 2, !dbg !354
  store i32 %19, i32* %20, align 4, !dbg !355, !tbaa !294
  %21 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %5, i64 0, i32 5, i32 1, !dbg !356
  store i32 %19, i32* %21, align 8, !dbg !357, !tbaa !297
  %22 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %5, i64 0, i32 4, !dbg !358
  store i16 -1, i16* %22, align 2, !dbg !359, !tbaa !300
  %23 = getelementptr inbounds [1 x %struct.__va_list_tag], [1 x %struct.__va_list_tag]* %4, i64 0, i64 0, !dbg !360
  call void @llvm.va_start(i8* nonnull %6), !dbg !360
  %24 = call i32 @_svfiprintf_r(%struct._reent* %8, %struct.__sFILE* nonnull %5, i8* %2, %struct.__va_list_tag* nonnull %23) #5, !dbg !362
  call void @llvm.va_end(i8* nonnull %6), !dbg !364
  %25 = icmp slt i32 %24, -1, !dbg !365
  br i1 %25, label %26, label %28, !dbg !367

; <label>:26:                                     ; preds = %12
  %27 = getelementptr inbounds %struct._reent, %struct._reent* %8, i64 0, i32 0, !dbg !368
  store i32 139, i32* %27, align 8, !dbg !369, !tbaa !264
  br label %28, !dbg !370

; <label>:28:                                     ; preds = %26, %12
  br i1 %16, label %29, label %31, !dbg !371

; <label>:29:                                     ; preds = %28
  %30 = load i8*, i8** %14, align 8, !dbg !372, !tbaa !284
  store i8 0, i8* %30, align 1, !dbg !374, !tbaa !316
  br label %31, !dbg !375

; <label>:31:                                     ; preds = %28, %29, %10
  %32 = phi i32 [ -1, %10 ], [ %24, %29 ], [ %24, %28 ], !dbg !376
  call void @llvm.lifetime.end.p0i8(i64 176, i8* nonnull %7) #3, !dbg !377
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %6) #3, !dbg !377
  ret i32 %32, !dbg !377
}
...
!319 = !DILocation(line: 74, column: 1, scope: !10)
!320 = distinct !DISubprogram(name: "sniprintf", scope: !1, file: !1, line: 80, type: !321, isLocal: false, isDefinition: true, scopeLine: 91, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !323)
!321 = !DISubroutineType(types: !322)
!322 = !{!13, !45, !231, !51, null}
!323 = !{!324, !325, !326, !327, !328, !329, !330}
!324 = !DILocalVariable(name: "str", arg: 1, scope: !320, file: !1, line: 80, type: !45)
!325 = !DILocalVariable(name: "size", arg: 2, scope: !320, file: !1, line: 80, type: !231)
!326 = !DILocalVariable(name: "fmt", arg: 3, scope: !320, file: !1, line: 80, type: !51)
!327 = !DILocalVariable(name: "ret", scope: !320, file: !1, line: 92, type: !13)
!328 = !DILocalVariable(name: "ap", scope: !320, file: !1, line: 93, type: !240)
!329 = !DILocalVariable(name: "f", scope: !320, file: !1, line: 94, type: !253)
!330 = !DILocalVariable(name: "ptr", scope: !320, file: !1, line: 95, type: !14)
!331 = !DILocation(line: 80, column: 1, scope: !320)
!332 = !DILocation(line: 93, column: 3, scope: !320)
!333 = !DILocation(line: 93, column: 11, scope: !320)
!334 = !DILocation(line: 94, column: 3, scope: !320)
!335 = !DILocation(line: 95, column: 24, scope: !320)
!336 = !DILocation(line: 95, column: 18, scope: !320)
!337 = !DILocation(line: 97, column: 12, scope: !338)
!338 = distinct !DILexicalBlock(scope: !320, file: !1, line: 97, column: 7)
!339 = !DILocation(line: 97, column: 7, scope: !320)
!340 = !DILocation(line: 99, column: 12, scope: !341)
!341 = distinct !DILexicalBlock(scope: !338, file: !1, line: 98, column: 5)
!342 = !DILocation(line: 99, column: 19, scope: !341)
!343 = !DILocation(line: 100, column: 7, scope: !341)
!344 = !DILocation(line: 102, column: 5, scope: !320)
!345 = !DILocation(line: 102, column: 12, scope: !320)
!346 = !DILocation(line: 103, column: 19, scope: !320)
!347 = !DILocation(line: 103, column: 22, scope: !320)
!348 = !DILocation(line: 103, column: 9, scope: !320)
!349 = !DILocation(line: 103, column: 15, scope: !320)
!350 = !DILocation(line: 104, column: 30, scope: !320)
!351 = !DILocation(line: 104, column: 41, scope: !320)
!352 = !DILocation(line: 104, column: 25, scope: !320)
!353 = !DILocation(line: 104, column: 24, scope: !320)
!354 = !DILocation(line: 104, column: 19, scope: !320)
!355 = !DILocation(line: 104, column: 22, scope: !320)
!356 = !DILocation(line: 104, column: 9, scope: !320)
!357 = !DILocation(line: 104, column: 15, scope: !320)
!358 = !DILocation(line: 105, column: 5, scope: !320)
!359 = !DILocation(line: 105, column: 11, scope: !320)
!360 = !DILocation(line: 107, column: 3, scope: !320)
!361 = !DILocation(line: 94, column: 8, scope: !320)
!362 = !DILocation(line: 111, column: 9, scope: !320)
!363 = !DILocation(line: 92, column: 7, scope: !320)
!364 = !DILocation(line: 112, column: 3, scope: !320)
!365 = !DILocation(line: 113, column: 11, scope: !366)
!366 = distinct !DILexicalBlock(scope: !320, file: !1, line: 113, column: 7)
!367 = !DILocation(line: 113, column: 7, scope: !320)
!368 = !DILocation(line: 114, column: 10, scope: !366)
!369 = !DILocation(line: 114, column: 17, scope: !366)
!370 = !DILocation(line: 114, column: 5, scope: !366)
!371 = !DILocation(line: 115, column: 7, scope: !320)
!372 = !DILocation(line: 116, column: 8, scope: !373)
!373 = distinct !DILexicalBlock(scope: !320, file: !1, line: 115, column: 7)
!374 = !DILocation(line: 116, column: 11, scope: !373)
!375 = !DILocation(line: 116, column: 5, scope: !373)
!376 = !DILocation(line: 0, scope: !320)
!377 = !DILocation(line: 118, column: 1, scope: !320)
