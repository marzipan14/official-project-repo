...
define dso_local i64 @_wcstoul_r(%struct._reent* nocapture, i32*, i32**, i32) local_unnamed_addr #0 !dbg !423 {
  ...
  %9 = select i1 %8, %struct.__locale_t* @__global_locale, %struct.__locale_t* %7, !dbg !432
  %10 = tail call i64 @_wcstoul_l(%struct._reent* %0, i32* %1, i32** %2, i32 %3, %struct.__locale_t* %9) #4, !dbg !439
  ret i64 %10, !dbg !440
}

; Function Attrs: noredzone nounwind
define dso_local i64 @wcstoul_l(i32* noalias, i32** noalias, i32, %struct.__locale_t*) local_unnamed_addr #0 !dbg !441 {
  %5 = tail call %struct._reent* @__getreent() #3, !dbg !455
  %6 = tail call i64 @_wcstoul_l(%struct._reent* %5, i32* %0, i32** %1, i32 %2, %struct.__locale_t* %3) #4, !dbg !456
  ret i64 %6, !dbg !457
}
...
; Function Attrs: noredzone nounwind
define dso_local i64 @wcstoul(i32* noalias, i32** noalias, i32) local_unnamed_addr #0 !dbg !458 {
  ...
  %7 = load %struct.__locale_t*, %struct.__locale_t** %6, align 8, !dbg !469, !tbaa !438
  %8 = icmp eq %struct.__locale_t* %7, null, !dbg !467
  %9 = select i1 %8, %struct.__locale_t* @__global_locale, %struct.__locale_t* %7, !dbg !467
  %10 = tail call i64 @_wcstoul_l(%struct._reent* %4, i32* %0, i32** %1, i32 %2, %struct.__locale_t* %9) #4, !dbg !470
  ret i64 %10, !dbg !471
}
...
!438 = !{!403, !404, i64 72}
!439 = !DILocation(line: 214, column: 9, scope: !423)
!440 = !DILocation(line: 214, column: 2, scope: !423)
!441 = distinct !DISubprogram(name: "wcstoul_l", scope: !1, file: !1, line: 220, type: !442, isLocal: false, isDefinition: true, scopeLine: 222, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !446)
!442 = !DISubroutineType(types: !443)
!443 = !{!4, !444, !445, !8, !294}
!444 = !DIDerivedType(tag: DW_TAG_restrict_type, baseType: !291)
!445 = !DIDerivedType(tag: DW_TAG_restrict_type, baseType: !293)
!446 = !{!447, !448, !449, !450}
!447 = !DILocalVariable(name: "s", arg: 1, scope: !441, file: !1, line: 220, type: !444)
!448 = !DILocalVariable(name: "ptr", arg: 2, scope: !441, file: !1, line: 220, type: !445)
!449 = !DILocalVariable(name: "base", arg: 3, scope: !441, file: !1, line: 220, type: !8)
!450 = !DILocalVariable(name: "loc", arg: 4, scope: !441, file: !1, line: 221, type: !294)
!451 = !DILocation(line: 220, column: 38, scope: !441)
!452 = !DILocation(line: 220, column: 62, scope: !441)
!453 = !DILocation(line: 220, column: 71, scope: !441)
!454 = !DILocation(line: 221, column: 14, scope: !441)
!455 = !DILocation(line: 223, column: 21, scope: !441)
!456 = !DILocation(line: 223, column: 9, scope: !441)
!457 = !DILocation(line: 223, column: 2, scope: !441)
!458 = distinct !DISubprogram(name: "wcstoul", scope: !1, file: !1, line: 227, type: !459, isLocal: false, isDefinition: true, scopeLine: 231, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !461)
!459 = !DISubroutineType(types: !460)
!460 = !{!4, !444, !445, !8}
!461 = !{!462, !463, !464}
!462 = !DILocalVariable(name: "s", arg: 1, scope: !458, file: !1, line: 227, type: !444)
!463 = !DILocalVariable(name: "ptr", arg: 2, scope: !458, file: !1, line: 227, type: !445)
!464 = !DILocalVariable(name: "base", arg: 3, scope: !458, file: !1, line: 227, type: !8)
!465 = !DILocation(line: 227, column: 1, scope: !458)
!466 = !DILocation(line: 232, column: 21, scope: !458)
!467 = !DILocation(line: 230, column: 10, scope: !433, inlinedAt: !468)
!468 = distinct !DILocation(line: 232, column: 43, scope: !458)
!469 = !DILocation(line: 230, column: 18, scope: !433, inlinedAt: !468)
!470 = !DILocation(line: 232, column: 9, scope: !458)
!471 = !DILocation(line: 232, column: 2, scope: !458)
