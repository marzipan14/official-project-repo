...
.LBB3_4:
	movl	%eax, 36(%r12)
	movl	68(%r12,%r10,4), %r14d
	addl	$1, %r14d
	movl	%r14d, 68(%r12,%r10,4)
	testl	%r9d, %r9d
	je	.LBB3_6
# %bb.5:
	movl	64(%r12,%r10,4), %r11d
.LBB3_6:
	subl	%r11d, %r14d
...
# %bb.8:
	...
	movl	%r9d, 32(%r12)
	movl	68(%r12,%r10,4), %eax
	movl	%eax, 72(%r12,%r10,4)
	addl	$-1, %eax
	movl	%eax, 68(%r12,%r10,4)
	movl	$1, %r14d
.LBB3_9:
	movslq	12(%r12), %rax
	leal	-1(,%rax,8), %ecx
...
# %bb.16:                               #   in Loop: Header=BB3_14 Depth=1
	...
	movslq	12(%r12), %rdi
	callq	malloc
	movq	%rax, 336(%r12,%r14,8)
	testq	%rax, %rax
	je	.LBB3_59
# %bb.17:                               #   in Loop: Header=BB3_14 Depth=1
	movzwl	196(%r12,%r14,2), %edx
	movq	%r12, %rdi
	movq	%rax, %rsi
	xorl	%ecx, %ecx
	movl	$1, %r8d
...
# %bb.50:
	orb	$1, 40(%rax)
	movzwl	(%r15), %edx
	movzwl	4(%r15,%rdx,2), %ecx
	movw	%cx, 8(%r15,%rdx,2)
	movzwl	2(%r15,%rdx,2), %ecx
	addl	$-4, %ecx
	movw	%cx, 6(%r15,%rdx,2)
	movw	%r14w, 2(%r15,%rdx,2)
	movw	$0, 4(%r15,%rdx,2)
	leaq	2(%rdx), %rcx
	movw	%cx, (%r15)
	jmp	.LBB3_60
...
# %bb.43:
	...
	movw	%bx, 198(%r12,%rax,2)
	movq	%r13, 344(%r12,%rax,8)
	movslq	%r15d, %rax
	addl	$1, 68(%r12,%rax,4)
...
# %bb.45:
	leal	1(%rax), %r9d
	movl	%r9d, 32(%r12)
	movl	68(%r12,%rax,4), %ecx
	movslq	%r9d, %rdx
	movl	%ecx, 68(%r12,%rdx,4)
	addl	$-1, %ecx
	movl	%ecx, 68(%r12,%rax,4)
	xorl	%r14d, %r14d
...
.LBB7_5:
	...
	movslq	12(%rbx), %r15
	movslq	%eax, %r13
	movq	336(%rbx,%r13,8), %rdi
	testq	%rdi, %rdi
	jne	.LBB7_8
# %bb.6:
	movq	%r15, %rdi
	callq	malloc
	movq	%rax, 336(%rbx,%r13,8)
	movzwl	196(%rbx,%r13,2), %edx
	movq	%rbx, %rdi
	movq	%rax, %rsi
	xorl	%ecx, %ecx
	movl	$1, %r8d
