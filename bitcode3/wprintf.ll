; ModuleID = '/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/stdio/wprintf.c'
source_filename = "/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/stdio/wprintf.c"
...
define dso_local i32 @_wprintf_r(%struct._reent*, i32*, ...) local_unnamed_addr #0 !dbg !7 {
  %3 = alloca [1 x %struct.__va_list_tag], align 16
  %4 = bitcast [1 x %struct.__va_list_tag]* %3 to i8*, !dbg !251
  call void @llvm.lifetime.start.p0i8(i64 24, i8* nonnull %4) #3, !dbg !251
  %5 = getelementptr inbounds [1 x %struct.__va_list_tag], [1 x %struct.__va_list_tag]* %3, i64 0, i64 0, !dbg !253
  call void @llvm.va_start(i8* nonnull %4), !dbg !253
  %6 = getelementptr inbounds %struct._reent, %struct._reent* %0, i64 0, i32 2, !dbg !254
  %7 = load %struct.__sFILE*, %struct.__sFILE** %6, align 8, !dbg !254, !tbaa !255
  %8 = call i32 @_vfwprintf_r(%struct._reent* %0, %struct.__sFILE* %7, i32* %1, %struct.__va_list_tag* nonnull %5) #5, !dbg !264
  call void @llvm.va_end(i8* nonnull %4), !dbg !266
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %4) #3, !dbg !267
  ret i32 %8, !dbg !268
}
...
; Function Attrs: noredzone nounwind
define dso_local i32 @wprintf(i32* noalias, ...) local_unnamed_addr #0 !dbg !269 {
  %2 = alloca [1 x %struct.__va_list_tag], align 16
  %3 = bitcast [1 x %struct.__va_list_tag]* %2 to i8*, !dbg !279
  call void @llvm.lifetime.start.p0i8(i64 24, i8* nonnull %3) #3, !dbg !279
  %4 = tail call %struct._reent* @__getreent() #5, !dbg !281
  %5 = getelementptr inbounds [1 x %struct.__va_list_tag], [1 x %struct.__va_list_tag]* %2, i64 0, i64 0, !dbg !283
  call void @llvm.va_start(i8* nonnull %3), !dbg !283
  %6 = getelementptr inbounds %struct._reent, %struct._reent* %4, i64 0, i32 2, !dbg !284
  %7 = load %struct.__sFILE*, %struct.__sFILE** %6, align 8, !dbg !284, !tbaa !255
  %8 = call i32 @_vfwprintf_r(%struct._reent* %4, %struct.__sFILE* %7, i32* %0, %struct.__va_list_tag* nonnull %5) #5, !dbg !285
  call void @llvm.va_end(i8* nonnull %3), !dbg !287
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %3) #3, !dbg !288
  ret i32 %8, !dbg !289
}
...
!1 = !DIFile(filename: "/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/stdio/wprintf.c", directory: "/root/.unikraft/apps/redis/build")
!2 = !{}
!3 = !{i32 2, !"Dwarf Version", i32 4}
!4 = !{i32 2, !"Debug Info Version", i32 3}
!5 = !{i32 1, !"wchar_size", i32 4}
!6 = !{!"clang version 7.0.1-8+deb10u2 (tags/RELEASE_701/final)"}
!7 = distinct !DISubprogram(name: "_wprintf_r", scope: !1, file: !1, line: 27, type: !8, isLocal: false, isDefinition: true, scopeLine: 30, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !233)
...
!232 = !DIDerivedType(tag: DW_TAG_typedef, name: "wchar_t", file: !91, line: 83, baseType: !10)
!233 = !{!234, !235, !236, !237}
!234 = !DILocalVariable(name: "ptr", arg: 1, scope: !7, file: !1, line: 27, type: !11)
!235 = !DILocalVariable(name: "fmt", arg: 2, scope: !7, file: !1, line: 27, type: !230)
!236 = !DILocalVariable(name: "ret", scope: !7, file: !1, line: 31, type: !10)
!237 = !DILocalVariable(name: "ap", scope: !7, file: !1, line: 32, type: !238)
!238 = !DIDerivedType(tag: DW_TAG_typedef, name: "va_list", file: !239, line: 46, baseType: !240)
...
!240 = !DIDerivedType(tag: DW_TAG_typedef, name: "__gnuc_va_list", file: !241, line: 51, baseType: !242)
!241 = !DIFile(filename: "/root/.unikraft/libs/newlib/include/stdarg.h", directory: "/root/.unikraft/apps/redis/build")
!242 = !DIDerivedType(tag: DW_TAG_typedef, name: "__builtin_va_list", file: !1, line: 32, baseType: !243)
!243 = !DICompositeType(tag: DW_TAG_array_type, baseType: !244, size: 192, elements: !70)
!244 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "__va_list_tag", file: !1, line: 32, size: 192, elements: !245)
!245 = !{!246, !247, !248, !249}
!246 = !DIDerivedType(tag: DW_TAG_member, name: "gp_offset", scope: !244, file: !1, line: 32, baseType: !92, size: 32)
!247 = !DIDerivedType(tag: DW_TAG_member, name: "fp_offset", scope: !244, file: !1, line: 32, baseType: !92, size: 32, offset: 32)
!248 = !DIDerivedType(tag: DW_TAG_member, name: "overflow_arg_area", scope: !244, file: !1, line: 32, baseType: !36, size: 64, offset: 64)
!249 = !DIDerivedType(tag: DW_TAG_member, name: "reg_save_area", scope: !244, file: !1, line: 32, baseType: !36, size: 64, offset: 128)
!250 = !DILocation(line: 27, column: 1, scope: !7)
!251 = !DILocation(line: 32, column: 3, scope: !7)
!252 = !DILocation(line: 32, column: 11, scope: !7)
!253 = !DILocation(line: 35, column: 3, scope: !7)
!254 = !DILocation(line: 36, column: 28, scope: !7)
!255 = !{!256, !260, i64 16}
...
!264 = !DILocation(line: 36, column: 9, scope: !7)
!265 = !DILocation(line: 31, column: 7, scope: !7)
!266 = !DILocation(line: 37, column: 3, scope: !7)
!267 = !DILocation(line: 39, column: 1, scope: !7)
!268 = !DILocation(line: 38, column: 3, scope: !7)
!269 = distinct !DISubprogram(name: "wprintf", scope: !1, file: !1, line: 44, type: !270, isLocal: false, isDefinition: true, scopeLine: 46, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !273)
!270 = !DISubroutineType(types: !271)
!271 = !{!10, !272, null}
!272 = !DIDerivedType(tag: DW_TAG_restrict_type, baseType: !230)
!273 = !{!274, !275, !276, !277}
!274 = !DILocalVariable(name: "fmt", arg: 1, scope: !269, file: !1, line: 44, type: !272)
!275 = !DILocalVariable(name: "ret", scope: !269, file: !1, line: 47, type: !10)
!276 = !DILocalVariable(name: "ap", scope: !269, file: !1, line: 48, type: !238)
!277 = !DILocalVariable(name: "ptr", scope: !269, file: !1, line: 49, type: !11)
!278 = !DILocation(line: 44, column: 1, scope: !269)
!279 = !DILocation(line: 48, column: 3, scope: !269)
!280 = !DILocation(line: 48, column: 11, scope: !269)
!281 = !DILocation(line: 49, column: 24, scope: !269)
!282 = !DILocation(line: 49, column: 18, scope: !269)
!283 = !DILocation(line: 52, column: 3, scope: !269)
!284 = !DILocation(line: 53, column: 28, scope: !269)
!285 = !DILocation(line: 53, column: 9, scope: !269)
!286 = !DILocation(line: 47, column: 7, scope: !269)
!287 = !DILocation(line: 54, column: 3, scope: !269)
!288 = !DILocation(line: 56, column: 1, scope: !269)
!289 = !DILocation(line: 55, column: 3, scope: !269)
