...
define dso_local i32 @pteTlsGlobalInit(i32) local_unnamed_addr #0 !dbg !482 {
  %2 = tail call i32 @pte_osMutexCreate(%struct.uk_mutex** nonnull @globalTlsLock) #4, !dbg !491
  %3 = sext i32 %0 to i64, !dbg !492
  %4 = shl nsw i64 %3, 2, !dbg !493
  %5 = tail call i8* @malloc(i64 %4) #4, !dbg !494
...
define dso_local i8* @pteTlsThreadInit() local_unnamed_addr #0 !dbg !528 {
  ...
  %4 = tail call i8* @malloc(i64 %3) #4, !dbg !536
...
define dso_local i32 @pteTlsAlloc(i32* nocapture) local_unnamed_addr #0 !dbg !554 {
  ...
  %3 = tail call i32 @pte_osMutexLock(%struct.uk_mutex* %2) #4, !dbg !565
...
; <label>:22:                                     ; preds = %19, %1, %14
  ...
  %25 = tail call i32 @pte_osMutexUnlock(%struct.uk_mutex* %24) #4, !dbg !587
  ret i32 %23, !dbg !588
}
...
define dso_local i8* @pteTlsGetValue(i8* readonly, i32) local_unnamed_addr #2 !dbg !589 {
...
; <label>:4:                                      ; preds = %1
  ...
  %6 = tail call i32 @pte_osMutexLock(%struct.uk_mutex* %5) #4, !dbg !652
  ...
  %12 = tail call i32 @pte_osMutexUnlock(%struct.uk_mutex* %11) #4, !dbg !657
  br label %13, !dbg !659
...
define dso_local void @pteTlsThreadDestroy(i8*) local_unnamed_addr #0 !dbg !663 {
  tail call void @free(i8* %0) #4, !dbg !667
  ret void, !dbg !668
}
...
define dso_local void @pteTlsGlobalDestroy() local_unnamed_addr #0 !dbg !669 {
  ...
  %2 = tail call i32 @pte_osMutexDelete(%struct.uk_mutex* %1) #4, !dbg !672
  %3 = load i8*, i8** bitcast (i32** @keysUsed to i8**), align 8, !dbg !673, !tbaa !496
  tail call void @free(i8* %3) #4, !dbg !674
  ret void, !dbg !675
}
