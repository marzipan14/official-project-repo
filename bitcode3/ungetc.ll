...
define dso_local i32 @_ungetc_r(%struct._reent*, i32, %struct.__sFILE*) local_unnamed_addr #0 !dbg !312 {
  ...
  br i1 %5, label %135, label %6, !dbg !326
...
; <label>:45:                                     ; preds = %42, %13
  ...
  br i1 %50, label %97, label %51, !dbg !376
...
; <label>:63:                                     ; preds = %60
  ...
  br i1 %65, label %86, label %66, !dbg !393
...
; <label>:76:                                     ; preds = %60
  ...
  br i1 %80, label %86, label %81, !dbg !406
...
; <label>:86:                                     ; preds = %76, %63
  %87 = load i32, i32* %4, align 4, !dbg !414, !tbaa !351
  %88 = call i32 @pthread_setcancelstate(i32 %87, i32* nonnull %4) #4, !dbg !414
  br label %120, !dbg !416

; <label>:89:                                     ; preds = %57, %81, %66
  %90 = phi i8** [ %58, %57 ], [ %85, %81 ], [ %75, %66 ], !dbg !417
  %91 = phi i8* [ %59, %57 ], [ %83, %81 ], [ %67, %66 ], !dbg !384
  %92 = getelementptr inbounds i8, i8* %91, i64 -1, !dbg !384
  store i8* %92, i8** %90, align 8, !dbg !384, !tbaa !296
  store i8 %46, i8* %92, align 1, !dbg !418, !tbaa !291
  %93 = load i32, i32* %52, align 8, !dbg !419, !tbaa !380
  %94 = add nsw i32 %93, 1, !dbg !419
  store i32 %94, i32* %52, align 8, !dbg !419, !tbaa !380
  %95 = load i32, i32* %4, align 4, !dbg !420, !tbaa !351
  %96 = call i32 @pthread_setcancelstate(i32 %95, i32* nonnull %4) #4, !dbg !420
  br label %120, !dbg !421

; <label>:97:                                     ; preds = %45
  %98 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %2, i64 0, i32 5, i32 0, !dbg !422
  %99 = load i8*, i8** %98, align 8, !dbg !422, !tbaa !424
  %100 = icmp eq i8* %99, null, !dbg !425
  br i1 %100, label %101, label %105, !dbg !426

; <label>:101:                                    ; preds = %97
  %102 = bitcast %struct.__sFILE* %2 to i64*
  %103 = load i64, i64* %102, align 8, !dbg !427, !tbaa !296
  %104 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %2, i64 0, i32 0, !dbg !427
  br label %122, !dbg !426

; <label>:105:                                    ; preds = %97
  %106 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %2, i64 0, i32 0, !dbg !428
  %107 = load i8*, i8** %106, align 8, !dbg !428, !tbaa !296
  %108 = icmp ugt i8* %107, %99, !dbg !429
  %109 = ptrtoint i8* %107 to i64, !dbg !430
  br i1 %108, label %110, label %122, !dbg !430

; <label>:110:                                    ; preds = %105
  %111 = getelementptr inbounds i8, i8* %107, i64 -1, !dbg !431
  %112 = load i8, i8* %111, align 1, !dbg !431, !tbaa !291
  %113 = icmp eq i8 %112, %46, !dbg !432
  br i1 %113, label %114, label %122, !dbg !433

; <label>:114:                                    ; preds = %110
  store i8* %111, i8** %106, align 8, !dbg !434, !tbaa !296
  %115 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %2, i64 0, i32 1, !dbg !436
  %116 = load i32, i32* %115, align 8, !dbg !437, !tbaa !380
  %117 = add nsw i32 %116, 1, !dbg !437
  store i32 %117, i32* %115, align 8, !dbg !437, !tbaa !380
  %118 = load i32, i32* %4, align 4, !dbg !438, !tbaa !351
  %119 = call i32 @pthread_setcancelstate(i32 %118, i32* nonnull %4) #4, !dbg !438
  br label %120, !dbg !439

; <label>:120:                                    ; preds = %25, %34, %86, %89, %114
  %121 = phi i32 [ %47, %114 ], [ %47, %89 ], [ -1, %86 ], [ -1, %34 ], [ -1, %25 ]
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %14) #5, !dbg !440
  br label %135

; <label>:122:                                    ; preds = %101, %110, %105
  %123 = phi i8** [ %104, %101 ], [ %106, %110 ], [ %106, %105 ], !dbg !427
  %124 = phi i64 [ %103, %101 ], [ %109, %110 ], [ %109, %105 ], !dbg !427
  %125 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %2, i64 0, i32 1, !dbg !441
  %126 = load i32, i32* %125, align 8, !dbg !441, !tbaa !380
  %127 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %2, i64 0, i32 14, !dbg !442
  store i32 %126, i32* %127, align 8, !dbg !443, !tbaa !444
  %128 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %2, i64 0, i32 13, !dbg !445
  %129 = bitcast i8** %128 to i64*, !dbg !446
  store i64 %124, i64* %129, align 8, !dbg !446, !tbaa !447
  %130 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %2, i64 0, i32 15, i64 0, !dbg !448
  store i8* %130, i8** %48, align 8, !dbg !449, !tbaa !263
  %131 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %2, i64 0, i32 12, i32 1, !dbg !450
  store i32 3, i32* %131, align 8, !dbg !451, !tbaa !285
  %132 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %2, i64 0, i32 15, i64 2, !dbg !452
  store i8 %46, i8* %132, align 2, !dbg !453, !tbaa !291
  store i8* %132, i8** %123, align 8, !dbg !454, !tbaa !296
  store i32 1, i32* %125, align 8, !dbg !455, !tbaa !380
  %133 = load i32, i32* %4, align 4, !dbg !456, !tbaa !351
  %134 = call i32 @pthread_setcancelstate(i32 %133, i32* nonnull %4) #4, !dbg !456
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %14) #5, !dbg !440
  br label %135

; <label>:135:                                    ; preds = %3, %120, %122
  %136 = phi i32 [ %47, %122 ], [ %121, %120 ], [ -1, %3 ]
  ret i32 %136
}
...
; Function Attrs: noredzone nounwind
define dso_local i32 @ungetc(i32, %struct.__sFILE*) local_unnamed_addr #0 !dbg !457 {
  %3 = tail call %struct._reent* @__getreent() #4, !dbg !464
  %4 = tail call i32 @_ungetc_r(%struct._reent* %3, i32 %0, %struct.__sFILE* %1) #6, !dbg !465
  ret i32 %4, !dbg !466
}
...
!414 = !DILocation(line: 170, column: 11, scope: !415)
!415 = distinct !DILexicalBlock(scope: !378, file: !1, line: 169, column: 9)
!416 = !DILocation(line: 171, column: 11, scope: !415)
!417 = !DILocation(line: 173, column: 14, scope: !379)
!418 = !DILocation(line: 173, column: 17, scope: !379)
!419 = !DILocation(line: 174, column: 13, scope: !379)
!420 = !DILocation(line: 175, column: 7, scope: !379)
!421 = !DILocation(line: 176, column: 7, scope: !379)
!422 = !DILocation(line: 185, column: 15, scope: !423)
!423 = distinct !DILexicalBlock(scope: !322, file: !1, line: 185, column: 7)
!424 = !{!264, !265, i64 24}
!425 = !DILocation(line: 185, column: 21, scope: !423)
!426 = !DILocation(line: 185, column: 29, scope: !423)
!427 = !DILocation(line: 199, column: 17, scope: !322)
!428 = !DILocation(line: 185, column: 36, scope: !423)
!429 = !DILocation(line: 185, column: 39, scope: !423)
!430 = !DILocation(line: 185, column: 55, scope: !423)
!431 = !DILocation(line: 185, column: 58, scope: !423)
!432 = !DILocation(line: 185, column: 69, scope: !423)
!433 = !DILocation(line: 185, column: 7, scope: !322)
!434 = !DILocation(line: 187, column: 13, scope: !435)
!435 = distinct !DILexicalBlock(scope: !423, file: !1, line: 186, column: 5)
!436 = !DILocation(line: 188, column: 11, scope: !435)
!437 = !DILocation(line: 188, column: 13, scope: !435)
!438 = !DILocation(line: 189, column: 7, scope: !435)
!439 = !DILocation(line: 190, column: 7, scope: !435)
!440 = !DILocation(line: 205, column: 3, scope: !312)
!441 = !DILocation(line: 198, column: 17, scope: !322)
!442 = !DILocation(line: 198, column: 7, scope: !322)
!443 = !DILocation(line: 198, column: 11, scope: !322)
!444 = !{!264, !268, i64 112}
!445 = !DILocation(line: 199, column: 7, scope: !322)
!446 = !DILocation(line: 199, column: 11, scope: !322)
!447 = !{!264, !265, i64 104}
!448 = !DILocation(line: 200, column: 19, scope: !322)
!449 = !DILocation(line: 200, column: 17, scope: !322)
!450 = !DILocation(line: 201, column: 11, scope: !322)
!451 = !DILocation(line: 201, column: 17, scope: !322)
!452 = !DILocation(line: 202, column: 3, scope: !322)
!453 = !DILocation(line: 202, column: 37, scope: !322)
!454 = !DILocation(line: 203, column: 10, scope: !322)
!455 = !DILocation(line: 204, column: 10, scope: !322)
!456 = !DILocation(line: 205, column: 3, scope: !322)
!457 = distinct !DISubprogram(name: "ungetc", scope: !1, file: !1, line: 211, type: !458, isLocal: false, isDefinition: true, scopeLine: 214, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !460)
!458 = !DISubroutineType(types: !459)
!459 = !{!5, !5, !252}
!460 = !{!461, !462}
!461 = !DILocalVariable(name: "c", arg: 1, scope: !457, file: !1, line: 211, type: !5)
!462 = !DILocalVariable(name: "fp", arg: 2, scope: !457, file: !1, line: 211, type: !252)
!463 = !DILocation(line: 211, column: 1, scope: !457)
!464 = !DILocation(line: 215, column: 21, scope: !457)
!465 = !DILocation(line: 215, column: 10, scope: !457)
!466 = !DILocation(line: 215, column: 3, scope: !457)
