...
; <label>:10:                                     ; preds = %3
  ...
  %12 = and i64 %11, -65536, !dbg !645
  %13 = inttoptr i64 %12 to %struct.uk_thread**, !dbg !646
  %14 = load %struct.uk_thread*, %struct.uk_thread** %13, align 65536, !dbg !648, !tbaa !649
  %15 = icmp eq %struct.uk_thread* %14, null, !dbg !652
  br i1 %15, label %16, label %17, !dbg !655, !prof !656

; <label>:16:                                     ; preds = %10
  tail call void (i8*, ...) @uk_pr_crit(i8* undef, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.1, i64 0, i64 0)) #7, !dbg !657
  tail call void @ukplat_terminate(i32 3) #8, !dbg !657
  unreachable, !dbg !657

; <label>:17:                                     ; preds = %10
  %18 = getelementptr inbounds %struct.uk_thread, %struct.uk_thread* %14, i64 0, i32 9, !dbg !659
  %19 = load %struct.uk_sched*, %struct.uk_sched** %18, align 8, !dbg !659, !tbaa !660
  %20 = icmp eq %struct.uk_sched* %19, null, !dbg !667
  br i1 %20, label %21, label %22, !dbg !670, !prof !656

; <label>:21:                                     ; preds = %17
  tail call void (i8*, ...) @uk_pr_crit(i8* undef, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i64 0, i64 0)) #7, !dbg !671
  tail call void @ukplat_terminate(i32 3) #8, !dbg !671
  unreachable, !dbg !671

; <label>:22:                                     ; preds = %17
  %23 = getelementptr inbounds %struct.uk_sched, %struct.uk_sched* %19, i64 0, i32 0, !dbg !673
  %24 = load void (%struct.uk_sched*)*, void (%struct.uk_sched*)** %23, align 8, !dbg !673, !tbaa !674
  tail call void %24(%struct.uk_sched* nonnull %19) #7, !dbg !678
  tail call void @pthread_testcancel() #7, !dbg !679
  br label %59, !dbg !680

; <label>:25:                                     ; preds = %3
  %26 = trunc i64 %5 to i32, !dbg !681
  %27 = mul i32 %26, 1000, !dbg !681
  %28 = add nsw i64 %7, 999999, !dbg !683
  %29 = sdiv i64 %28, 1000000, !dbg !684
  %30 = trunc i64 %29 to i32, !dbg !685
  %31 = add i32 %27, %30, !dbg !687
  %32 = tail call { i8*, i32 } @pthread_self() #7, !dbg !689
  %33 = extractvalue { i8*, i32 } %32, 0, !dbg !689
  %34 = icmp eq i8* %33, null, !dbg !692
  br i1 %34, label %59, label %35, !dbg !693

; <label>:35:                                     ; preds = %25
  %36 = getelementptr inbounds i8, i8* %33, i64 88, !dbg !695
  %37 = bitcast i8* %36 to i32*, !dbg !695
  %38 = load i32, i32* %37, align 8, !dbg !695, !tbaa !696
  %39 = icmp eq i32 %38, 0, !dbg !699
  br i1 %39, label %40, label %58, !dbg !700

; <label>:40:                                     ; preds = %35
  %41 = bitcast i8* %33 to %struct.uk_thread**, !dbg !701
  %42 = load %struct.uk_thread*, %struct.uk_thread** %41, align 8, !dbg !701, !tbaa !702
  %43 = tail call i32 @pte_osThreadCheckCancel(%struct.uk_thread* %42) #7, !dbg !703
...
; <label>:44:                                     ; preds = %40
  %45 = getelementptr inbounds i8, i8* %33, i64 80, !dbg !706
  %46 = bitcast i8* %45 to %struct.pthread_mutex_t_**, !dbg !706
  %47 = tail call i32 @pthread_mutex_lock(%struct.pthread_mutex_t_** nonnull %46) #7, !dbg !709
  %48 = getelementptr inbounds i8, i8* %33, i64 32, !dbg !710
  %49 = bitcast i8* %48 to i32*, !dbg !710
  %50 = load volatile i32, i32* %49, align 8, !dbg !710, !tbaa !712
  %51 = icmp ult i32 %50, 4, !dbg !713
  br i1 %51, label %52, label %54, !dbg !714

; <label>:52:                                     ; preds = %44
  store volatile i32 4, i32* %49, align 8, !dbg !715, !tbaa !712
  store i32 1, i32* %37, align 8, !dbg !717, !tbaa !696
  %53 = tail call i32 @pthread_mutex_unlock(%struct.pthread_mutex_t_** nonnull %46) #7, !dbg !718
  tail call void @pte_throw(i32 2) #7, !dbg !719
  br label %54, !dbg !720

; <label>:54:                                     ; preds = %52, %44
  %55 = tail call i32 @pthread_mutex_unlock(%struct.pthread_mutex_t_** nonnull %46) #7, !dbg !721
  br label %56, !dbg !722
...
; <label>:58:                                     ; preds = %35
  tail call void @pte_osThreadSleep(i32 %31) #7, !dbg !723
  br label %59

; <label>:59:                                     ; preds = %58, %40, %56, %25, %1, %22
  %60 = phi i32 [ 0, %22 ], [ 22, %1 ], [ 12, %25 ], [ %57, %56 ], [ %43, %40 ], [ 0, %58 ], !dbg !725
  ret i32 %60, !dbg !726
}
...
define internal void @uk_pr_crit(i8* nocapture readnone, ...) unnamed_addr #4 !dbg !2 {
  ...
  %3 = bitcast [1 x %struct.__va_list_tag]* %2 to i8*, !dbg !727
  call void @llvm.lifetime.start.p0i8(i64 24, i8* nonnull %3) #6, !dbg !727
  %4 = getelementptr inbounds [1 x %struct.__va_list_tag], [1 x %struct.__va_list_tag]* %2, i64 0, i64 0, !dbg !729
  call void @llvm.va_start(i8* nonnull %3), !dbg !729
  call void @_uk_vprintk(i32 0, i8* getelementptr inbounds ([20 x i8], [20 x i8]* @uk_pr_crit.__str, i64 0, i64 0), i8* getelementptr inbounds ([19 x i8], [19 x i8]* @uk_pr_crit.__str.3, i64 0, i64 0), i32 198, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str, i64 0, i64 0), %struct.__va_list_tag* nonnull %4) #7, !dbg !730
  call void @llvm.va_end(i8* nonnull %3), !dbg !733
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %3) #6, !dbg !734
  ret void, !dbg !734
}
...
!644 = !DILocation(line: 154, column: 16, scope: !627, inlinedAt: !633)
!645 = !DILocation(line: 156, column: 38, scope: !627, inlinedAt: !633)
!646 = !DILocation(line: 156, column: 12, scope: !627, inlinedAt: !633)
!647 = !DILocation(line: 153, column: 21, scope: !627, inlinedAt: !633)
!648 = !DILocation(line: 158, column: 9, scope: !627, inlinedAt: !633)
!649 = !{!650, !650, i64 0}
!650 = !{!"any pointer", !612, i64 0}
!651 = !DILocation(line: 117, column: 20, scope: !634, inlinedAt: !638)
!652 = !DILocation(line: 119, column: 2, scope: !653, inlinedAt: !638)
!653 = distinct !DILexicalBlock(scope: !654, file: !118, line: 119, column: 2)
!654 = distinct !DILexicalBlock(scope: !634, file: !118, line: 119, column: 2)
!655 = !DILocation(line: 119, column: 2, scope: !654, inlinedAt: !638)
!656 = !{!"branch_weights", i32 1, i32 2000}
!657 = !DILocation(line: 119, column: 2, scope: !658, inlinedAt: !638)
!658 = distinct !DILexicalBlock(scope: !653, file: !118, line: 119, column: 2)
!659 = !DILocation(line: 121, column: 15, scope: !634, inlinedAt: !638)
!660 = !{!661, !650, i64 88}
!661 = !{!"uk_thread", !650, i64 0, !650, i64 8, !650, i64 16, !650, i64 24, !662, i64 32, !663, i64 48, !611, i64 56, !664, i64 64, !665, i64 72, !650, i64 88, !650, i64 96, !663, i64 104, !650, i64 112, !650, i64 120}
!662 = !{!"", !650, i64 0, !650, i64 8}
!663 = !{!"int", !612, i64 0}
!664 = !{!"_Bool", !612, i64 0}
!665 = !{!"uk_waitq", !650, i64 0, !650, i64 8}
!666 = !DILocation(line: 116, column: 19, scope: !634, inlinedAt: !638)
!667 = !DILocation(line: 122, column: 2, scope: !668, inlinedAt: !638)
!668 = distinct !DILexicalBlock(scope: !669, file: !118, line: 122, column: 2)
!669 = distinct !DILexicalBlock(scope: !634, file: !118, line: 122, column: 2)
!670 = !DILocation(line: 122, column: 2, scope: !669, inlinedAt: !638)
!671 = !DILocation(line: 122, column: 2, scope: !672, inlinedAt: !638)
!672 = distinct !DILexicalBlock(scope: !668, file: !118, line: 122, column: 2)
!673 = !DILocation(line: 123, column: 5, scope: !634, inlinedAt: !638)
!674 = !{!675, !650, i64 0}
!675 = !{!"uk_sched", !650, i64 0, !650, i64 8, !650, i64 16, !650, i64 24, !650, i64 32, !650, i64 40, !650, i64 48, !650, i64 56, !650, i64 64, !664, i64 72, !661, i64 80, !676, i64 208, !677, i64 224, !650, i64 248, !650, i64 256, !650, i64 264}
!676 = !{!"uk_thread_list", !650, i64 0, !650, i64 8}
!677 = !{!"ukplat_ctx_callbacks", !650, i64 0, !650, i64 8, !650, i64 16}
!678 = !DILocation(line: 123, column: 2, scope: !634, inlinedAt: !638)
!679 = !DILocation(line: 108, column: 7, scope: !618)
!680 = !DILocation(line: 109, column: 7, scope: !618)
!681 = !DILocation(line: 113, column: 23, scope: !582)
!682 = !DILocation(line: 94, column: 16, scope: !582)
!683 = !DILocation(line: 116, column: 34, scope: !582)
!684 = !DILocation(line: 116, column: 45, scope: !582)
!685 = !DILocation(line: 116, column: 15, scope: !582)
!686 = !DILocation(line: 95, column: 16, scope: !582)
!687 = !DILocation(line: 118, column: 33, scope: !582)
!688 = !DILocation(line: 93, column: 16, scope: !582)
!689 = !DILocation(line: 120, column: 23, scope: !690)
!690 = distinct !DILexicalBlock(scope: !582, file: !10, line: 120, column: 7)
!691 = !DILocation(line: 96, column: 13, scope: !582)
!692 = !DILocation(line: 120, column: 12, scope: !690)
!693 = !DILocation(line: 120, column: 7, scope: !582)
!694 = !DILocation(line: 97, column: 18, scope: !582)
!695 = !DILocation(line: 127, column: 11, scope: !601)
!696 = !{!697, !663, i64 88}
!697 = !{!"pte_thread_t_", !650, i64 0, !698, i64 8, !650, i64 24, !612, i64 32, !650, i64 40, !650, i64 48, !663, i64 56, !663, i64 60, !650, i64 64, !663, i64 72, !650, i64 80, !663, i64 88, !663, i64 92, !663, i64 96, !612, i64 104, !663, i64 168, !650, i64 176, !650, i64 184}
!698 = !{!"", !650, i64 0, !663, i64 8}
!699 = !DILocation(line: 127, column: 23, scope: !601)
!700 = !DILocation(line: 127, column: 7, scope: !582)
!701 = !DILocation(line: 134, column: 50, scope: !600)
!702 = !{!697, !650, i64 0}
!703 = !DILocation(line: 134, column: 22, scope: !600)
!704 = !DILocation(line: 129, column: 20, scope: !600)
!705 = !DILocation(line: 136, column: 11, scope: !600)
!706 = !DILocation(line: 141, column: 43, scope: !707)
!707 = distinct !DILexicalBlock(scope: !708, file: !10, line: 137, column: 9)
!708 = distinct !DILexicalBlock(scope: !600, file: !10, line: 136, column: 11)
!709 = !DILocation(line: 141, column: 18, scope: !707)
!710 = !DILocation(line: 142, column: 19, scope: !711)
!711 = distinct !DILexicalBlock(scope: !707, file: !10, line: 142, column: 15)
!712 = !{!697, !612, i64 32}
!713 = !DILocation(line: 142, column: 25, scope: !711)
!714 = !DILocation(line: 142, column: 15, scope: !707)
!715 = !DILocation(line: 144, column: 25, scope: !716)
!716 = distinct !DILexicalBlock(scope: !711, file: !10, line: 143, column: 13)
!717 = !DILocation(line: 145, column: 31, scope: !716)
!718 = !DILocation(line: 146, column: 22, scope: !716)
!719 = !DILocation(line: 148, column: 15, scope: !716)
!720 = !DILocation(line: 149, column: 13, scope: !716)
!721 = !DILocation(line: 151, column: 18, scope: !707)
!722 = !DILocation(line: 152, column: 11, scope: !707)
!723 = !DILocation(line: 162, column: 7, scope: !724)
!724 = distinct !DILexicalBlock(scope: !601, file: !10, line: 161, column: 5)
!725 = !DILocation(line: 0, scope: !707)
!726 = !DILocation(line: 166, column: 1, scope: !582)
!727 = !DILocation(line: 196, column: 2, scope: !2)
!728 = !DILocation(line: 196, column: 10, scope: !2)
!729 = !DILocation(line: 197, column: 2, scope: !2)
!730 = !DILocation(line: 198, column: 2, scope: !731)
!731 = distinct !DILexicalBlock(scope: !732, file: !3, line: 198, column: 2)
!732 = distinct !DILexicalBlock(scope: !2, file: !3, line: 198, column: 2)
!733 = !DILocation(line: 199, column: 2, scope: !2)
!734 = !DILocation(line: 200, column: 1, scope: !2)
