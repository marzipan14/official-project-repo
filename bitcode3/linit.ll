...
define dso_local void @luaL_openlibs(%struct.lua_State*) local_unnamed_addr #0 !dbg !32 {
  tail call void @lua_pushcclosure(%struct.lua_State* %0, i32 (%struct.lua_State*)* nonnull @luaopen_base, i32 0) #3, !dbg !40
  tail call void @lua_pushstring(%struct.lua_State* %0, i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str, i64 0, i64 0)) #3, !dbg !44
  tail call void @lua_call(%struct.lua_State* %0, i32 1, i32 0) #3, !dbg !45
  tail call void @lua_pushcclosure(%struct.lua_State* %0, i32 (%struct.lua_State*)* nonnull @luaopen_package, i32 0) #3, !dbg !40
  tail call void @lua_pushstring(%struct.lua_State* %0, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.1, i64 0, i64 0)) #3, !dbg !44
  tail call void @lua_call(%struct.lua_State* %0, i32 1, i32 0) #3, !dbg !45
  tail call void @lua_pushcclosure(%struct.lua_State* %0, i32 (%struct.lua_State*)* nonnull @luaopen_table, i32 0) #3, !dbg !40
  tail call void @lua_pushstring(%struct.lua_State* %0, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.2, i64 0, i64 0)) #3, !dbg !44
  tail call void @lua_call(%struct.lua_State* %0, i32 1, i32 0) #3, !dbg !45
  tail call void @lua_pushcclosure(%struct.lua_State* %0, i32 (%struct.lua_State*)* nonnull @luaopen_io, i32 0) #3, !dbg !40
  tail call void @lua_pushstring(%struct.lua_State* %0, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i64 0, i64 0)) #3, !dbg !44
  tail call void @lua_call(%struct.lua_State* %0, i32 1, i32 0) #3, !dbg !45
  tail call void @lua_pushcclosure(%struct.lua_State* %0, i32 (%struct.lua_State*)* nonnull @luaopen_os, i32 0) #3, !dbg !40
  tail call void @lua_pushstring(%struct.lua_State* %0, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.4, i64 0, i64 0)) #3, !dbg !44
  tail call void @lua_call(%struct.lua_State* %0, i32 1, i32 0) #3, !dbg !45
  tail call void @lua_pushcclosure(%struct.lua_State* %0, i32 (%struct.lua_State*)* nonnull @luaopen_string, i32 0) #3, !dbg !40
  tail call void @lua_pushstring(%struct.lua_State* %0, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.5, i64 0, i64 0)) #3, !dbg !44
  tail call void @lua_call(%struct.lua_State* %0, i32 1, i32 0) #3, !dbg !45
  tail call void @lua_pushcclosure(%struct.lua_State* %0, i32 (%struct.lua_State*)* nonnull @luaopen_math, i32 0) #3, !dbg !40
  tail call void @lua_pushstring(%struct.lua_State* %0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.6, i64 0, i64 0)) #3, !dbg !44
  tail call void @lua_call(%struct.lua_State* %0, i32 1, i32 0) #3, !dbg !45
  tail call void @lua_pushcclosure(%struct.lua_State* %0, i32 (%struct.lua_State*)* nonnull @luaopen_debug, i32 0) #3, !dbg !40
  tail call void @lua_pushstring(%struct.lua_State* %0, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.7, i64 0, i64 0)) #3, !dbg !44
  tail call void @lua_call(%struct.lua_State* %0, i32 1, i32 0) #3, !dbg !45
  ret void, !dbg !46
}
...
!41 = distinct !DILexicalBlock(scope: !42, file: !1, line: 32, column: 28)
!42 = distinct !DILexicalBlock(scope: !43, file: !1, line: 32, column: 3)
!43 = distinct !DILexicalBlock(scope: !32, file: !1, line: 32, column: 3)
!44 = !DILocation(line: 34, column: 5, scope: !41)
!45 = !DILocation(line: 35, column: 5, scope: !41)
!46 = !DILocation(line: 37, column: 1, scope: !32)
