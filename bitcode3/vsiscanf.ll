...
define dso_local i32 @_vsiscanf_r(%struct._reent*, i8*, i8*, %struct.__va_list_tag*) local_unnamed_addr #0 !dbg !33 {
  ...
  %6 = bitcast %struct.__sFILE* %5 to i8*, !dbg !300
  call void @llvm.lifetime.start.p0i8(i64 176, i8* nonnull %6) #5, !dbg !300
  %7 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %5, i64 0, i32 3, !dbg !301
  store i16 516, i16* %7, align 8, !dbg !302, !tbaa !260
  %8 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %5, i64 0, i32 0, !dbg !303
  store i8* %1, i8** %8, align 8, !dbg !304, !tbaa !272
  %9 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %5, i64 0, i32 5, i32 0, !dbg !305
  store i8* %1, i8** %9, align 8, !dbg !306, !tbaa !275
  %10 = tail call i64 @strlen(i8* %1) #4, !dbg !307
  %11 = trunc i64 %10 to i32, !dbg !307
  %12 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %5, i64 0, i32 1, !dbg !308
  store i32 %11, i32* %12, align 8, !dbg !309, !tbaa !279
  %13 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %5, i64 0, i32 5, i32 1, !dbg !310
  store i32 %11, i32* %13, align 8, !dbg !311, !tbaa !282
  %14 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %5, i64 0, i32 8, !dbg !312
  store i64 (%struct._reent*, i8*, i8*, i32)* @__seofread, i64 (%struct._reent*, i8*, i8*, i32)** %14, align 8, !dbg !313, !tbaa !285
  %15 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %5, i64 0, i32 12, i32 0, !dbg !314
  store i8* null, i8** %15, align 8, !dbg !315, !tbaa !288
  %16 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %5, i64 0, i32 17, i32 0, !dbg !316
  store i8* null, i8** %16, align 8, !dbg !317, !tbaa !291
  %17 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %5, i64 0, i32 4, !dbg !318
  store i16 -1, i16* %17, align 2, !dbg !319, !tbaa !294
  %18 = call i32 @__ssvfiscanf_r(%struct._reent* %0, %struct.__sFILE* nonnull %5, i8* %2, %struct.__va_list_tag* %3) #4, !dbg !321
  call void @llvm.lifetime.end.p0i8(i64 176, i8* nonnull %6) #5, !dbg !322
  ret i32 %18, !dbg !323
}
...
!298 = !DILocation(line: 43, column: 3, scope: !10)
!299 = !DILocation(line: 49, column: 1, scope: !33)
!300 = !DILocation(line: 55, column: 3, scope: !33)
!301 = !DILocation(line: 57, column: 5, scope: !33)
!302 = !DILocation(line: 57, column: 12, scope: !33)
!303 = !DILocation(line: 58, column: 19, scope: !33)
!304 = !DILocation(line: 58, column: 22, scope: !33)
!305 = !DILocation(line: 58, column: 9, scope: !33)
!306 = !DILocation(line: 58, column: 15, scope: !33)
!307 = !DILocation(line: 59, column: 24, scope: !33)
!308 = !DILocation(line: 59, column: 19, scope: !33)
!309 = !DILocation(line: 59, column: 22, scope: !33)
!310 = !DILocation(line: 59, column: 9, scope: !33)
!311 = !DILocation(line: 59, column: 15, scope: !33)
!312 = !DILocation(line: 60, column: 5, scope: !33)
!313 = !DILocation(line: 60, column: 11, scope: !33)
!314 = !DILocation(line: 61, column: 9, scope: !33)
!315 = !DILocation(line: 61, column: 15, scope: !33)
!316 = !DILocation(line: 62, column: 9, scope: !33)
!317 = !DILocation(line: 62, column: 15, scope: !33)
!318 = !DILocation(line: 63, column: 5, scope: !33)
!319 = !DILocation(line: 63, column: 11, scope: !33)
!320 = !DILocation(line: 55, column: 8, scope: !33)
!321 = !DILocation(line: 64, column: 10, scope: !33)
!322 = !DILocation(line: 65, column: 1, scope: !33)
!323 = !DILocation(line: 64, column: 3, scope: !33)
