...
; <label>:7:                                      ; preds = %3, %10
  %8 = phi i8* [ %11, %10 ], [ %1, %3 ], !dbg !256
  %9 = load i8, i8* %8, align 1, !dbg !258, !tbaa !259
...
; <label>:10:                                     ; preds = %7
  %11 = getelementptr inbounds i8, i8* %8, i64 1, !dbg !261
  br label %7, !dbg !260, !llvm.loop !262

; <label>:12:                                     ; preds = %7
  %13 = load i8*, i8** %4, align 8, !dbg !264, !tbaa !248
  %14 = icmp eq i8* %13, null, !dbg !269
  br i1 %14, label %43, label %15, !dbg !269

; <label>:15:                                     ; preds = %12
  %16 = ptrtoint i8* %8 to i64, !dbg !270
  %17 = ptrtoint i8* %1 to i64, !dbg !270
  %18 = sub i64 %16, %17, !dbg !270
  %19 = shl i64 %18, 32
  %20 = ashr exact i64 %19, 32
  br label %21, !dbg !269

; <label>:21:                                     ; preds = %15, %39
  %22 = phi i8* [ %13, %15 ], [ %41, %39 ]
  %23 = phi i8** [ %4, %15 ], [ %40, %39 ]
  %24 = tail call i32 @strncmp(i8* nonnull %22, i8* %1, i64 %20) #4, !dbg !271
  %25 = icmp eq i32 %24, 0, !dbg !271
  br i1 %25, label %26, label %39, !dbg !273

; <label>:26:                                     ; preds = %21
  %27 = load i8*, i8** %23, align 8, !dbg !274, !tbaa !248
  %28 = getelementptr inbounds i8, i8* %27, i64 %20, !dbg !276
  %29 = load i8, i8* %28, align 1, !dbg !277, !tbaa !259
  %30 = icmp eq i8 %29, 61, !dbg !278
  br i1 %30, label %31, label %39, !dbg !279

; <label>:31:                                     ; preds = %26
  %32 = getelementptr inbounds i8, i8* %27, i64 %20, !dbg !276
  %33 = load i64, i64* bitcast (i8*** @environ to i64*), align 8, !dbg !280, !tbaa !248
  %34 = ptrtoint i8** %23 to i64, !dbg !282
  %35 = sub i64 %34, %33, !dbg !282
  %36 = lshr exact i64 %35, 3, !dbg !282
  %37 = trunc i64 %36 to i32, !dbg !283
  store i32 %37, i32* %2, align 4, !dbg !284, !tbaa !285
  tail call void @__env_unlock(%struct._reent* %0) #4, !dbg !287
  %38 = getelementptr inbounds i8, i8* %32, i64 1, !dbg !288
  br label %44, !dbg !289

; <label>:39:                                     ; preds = %21, %26
  %40 = getelementptr inbounds i8*, i8** %23, i64 1, !dbg !290
  %41 = load i8*, i8** %40, align 8, !dbg !264, !tbaa !248
  %42 = icmp eq i8* %41, null, !dbg !269
  br i1 %42, label %43, label %21, !dbg !269, !llvm.loop !291

; <label>:43:                                     ; preds = %7, %39, %12
  tail call void @__env_unlock(%struct._reent* %0) #4, !dbg !293
  br label %44, !dbg !294

; <label>:44:                                     ; preds = %43, %31, %6
  %45 = phi i8* [ %38, %31 ], [ null, %43 ], [ null, %6 ], !dbg !295
  ret i8* %45, !dbg !296
}
...
; Function Attrs: noredzone nounwind
define dso_local i8* @_getenv_r(%struct._reent*, i8*) local_unnamed_addr #0 !dbg !297 {
  %3 = alloca i32, align 4
  %4 = bitcast i32* %3 to i8*, !dbg !305
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %4) #5, !dbg !305
  %5 = call i8* @_findenv_r(%struct._reent* %0, i8* %1, i32* nonnull %3) #6, !dbg !307
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %4) #5, !dbg !308
  ret i8* %5, !dbg !309
}
...
!256 = !DILocation(line: 0, scope: !15)
!257 = !DILocation(line: 90, column: 16, scope: !15)
!258 = !DILocation(line: 103, column: 10, scope: !15)
!259 = !{!250, !250, i64 0}
!260 = !DILocation(line: 103, column: 3, scope: !15)
!261 = !DILocation(line: 103, column: 29, scope: !15)
!262 = distinct !{!262, !260, !261}
!263 = !DILocation(line: 89, column: 19, scope: !15)
!264 = !DILocation(line: 109, column: 26, scope: !265)
!265 = distinct !DILexicalBlock(scope: !266, file: !1, line: 109, column: 5)
!266 = distinct !DILexicalBlock(scope: !267, file: !1, line: 109, column: 5)
!267 = distinct !DILexicalBlock(scope: !268, file: !1, line: 107, column: 5)
!268 = distinct !DILexicalBlock(scope: !15, file: !1, line: 106, column: 6)
!269 = !DILocation(line: 109, column: 5, scope: !266)
!270 = !DILocation(line: 108, column: 13, scope: !267)
!271 = !DILocation(line: 110, column: 12, scope: !272)
!272 = distinct !DILexicalBlock(scope: !265, file: !1, line: 110, column: 11)
!273 = !DILocation(line: 110, column: 11, scope: !265)
!274 = !DILocation(line: 111, column: 19, scope: !275)
!275 = distinct !DILexicalBlock(scope: !272, file: !1, line: 111, column: 13)
!276 = !DILocation(line: 111, column: 22, scope: !275)
!277 = !DILocation(line: 111, column: 13, scope: !275)
!278 = !DILocation(line: 111, column: 29, scope: !275)
!279 = !DILocation(line: 111, column: 13, scope: !272)
!280 = !DILocation(line: 113, column: 18, scope: !281)
!281 = distinct !DILexicalBlock(scope: !275, file: !1, line: 112, column: 2)
!282 = !DILocation(line: 113, column: 16, scope: !281)
!283 = !DILocation(line: 113, column: 14, scope: !281)
!284 = !DILocation(line: 113, column: 12, scope: !281)
!285 = !{!286, !286, i64 0}
!286 = !{!"int", !250, i64 0}
!287 = !DILocation(line: 114, column: 4, scope: !281)
!288 = !DILocation(line: 115, column: 21, scope: !281)
!289 = !DILocation(line: 115, column: 4, scope: !281)
!290 = !DILocation(line: 109, column: 30, scope: !265)
!291 = distinct !{!291, !269, !292}
!292 = !DILocation(line: 116, column: 2, scope: !266)
!293 = !DILocation(line: 118, column: 3, scope: !15)
!294 = !DILocation(line: 119, column: 3, scope: !15)
!295 = !DILocation(line: 0, scope: !254)
!296 = !DILocation(line: 120, column: 1, scope: !15)
!297 = distinct !DISubprogram(name: "_getenv_r", scope: !1, file: !1, line: 128, type: !298, isLocal: false, isDefinition: true, scopeLine: 131, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !300)
!298 = !DISubroutineType(types: !299)
!299 = !{!4, !18, !56}
!300 = !{!301, !302, !303}
!301 = !DILocalVariable(name: "reent_ptr", arg: 1, scope: !297, file: !1, line: 128, type: !18)
!302 = !DILocalVariable(name: "name", arg: 2, scope: !297, file: !1, line: 128, type: !56)
!303 = !DILocalVariable(name: "offset", scope: !297, file: !1, line: 132, type: !23)
!304 = !DILocation(line: 128, column: 1, scope: !297)
!305 = !DILocation(line: 132, column: 3, scope: !297)
!306 = !DILocation(line: 132, column: 7, scope: !297)
!307 = !DILocation(line: 134, column: 10, scope: !297)
!308 = !DILocation(line: 135, column: 1, scope: !297)
!309 = !DILocation(line: 134, column: 3, scope: !297)
