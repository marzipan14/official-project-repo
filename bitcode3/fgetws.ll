...
; <label>:86:                                     ; preds = %83
  ...
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %8) #4, !dbg !360
  br label %92

; <label>:89:                                     ; preds = %42, %11, %81, %83, %17
  %90 = load i32, i32* %6, align 4, !dbg !361, !tbaa !277
  %91 = call i32 @pthread_setcancelstate(i32 %90, i32* nonnull %6) #5, !dbg !361
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %8) #4, !dbg !360
  br label %92

; <label>:92:                                     ; preds = %86, %89
  %93 = phi i32* [ null, %89 ], [ %1, %86 ]
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %7) #4, !dbg !362
  ret i32* %93, !dbg !362
}
...
; Function Attrs: noredzone nounwind
define dso_local i32* @fgetws(i32* noalias, i32, %struct.__sFILE* noalias) local_unnamed_addr #0 !dbg !363 {
  %4 = tail call %struct._reent* @__getreent() #5, !dbg !376
  %5 = icmp eq %struct._reent* %4, null, !dbg !379
  br i1 %5, label %11, label %6, !dbg !379

; <label>:6:                                      ; preds = %3
  %7 = getelementptr inbounds %struct._reent, %struct._reent* %4, i64 0, i32 8, !dbg !379
  %8 = load i32, i32* %7, align 8, !dbg !379, !tbaa !381
  %9 = icmp eq i32 %8, 0, !dbg !379
  br i1 %9, label %10, label %11, !dbg !378

; <label>:10:                                     ; preds = %6
  tail call void @__sinit(%struct._reent* nonnull %4) #5, !dbg !379
  br label %11, !dbg !379

; <label>:11:                                     ; preds = %6, %3, %10
  %12 = tail call i32* @_fgetws_r(%struct._reent* %4, i32* %0, i32 %1, %struct.__sFILE* %2) #6, !dbg !386
  ret i32* %12, !dbg !387
}
...
!360 = !DILocation(line: 198, column: 3, scope: !36)
!361 = !DILocation(line: 198, column: 3, scope: !267)
!362 = !DILocation(line: 200, column: 1, scope: !36)
!363 = distinct !DISubprogram(name: "fgetws", scope: !1, file: !1, line: 203, type: !364, isLocal: false, isDefinition: true, scopeLine: 207, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !368)
!364 = !DISubroutineType(types: !365)
!365 = !{!39, !366, !5, !367}
!366 = !DIDerivedType(tag: DW_TAG_restrict_type, baseType: !39)
!367 = !DIDerivedType(tag: DW_TAG_restrict_type, baseType: !254)
!368 = !{!369, !370, !371, !372, !373}
!369 = !DILocalVariable(name: "ws", arg: 1, scope: !363, file: !1, line: 203, type: !366)
!370 = !DILocalVariable(name: "n", arg: 2, scope: !363, file: !1, line: 203, type: !5)
!371 = !DILocalVariable(name: "fp", arg: 3, scope: !363, file: !1, line: 203, type: !367)
!372 = !DILocalVariable(name: "reent", scope: !363, file: !1, line: 208, type: !42)
!373 = !DILocalVariable(name: "_check_init_ptr", scope: !374, file: !1, line: 210, type: !42)
!374 = distinct !DILexicalBlock(scope: !363, file: !1, line: 210, column: 3)
!375 = !DILocation(line: 203, column: 1, scope: !363)
!376 = !DILocation(line: 208, column: 26, scope: !363)
!377 = !DILocation(line: 208, column: 18, scope: !363)
!378 = !DILocation(line: 210, column: 3, scope: !374)
!379 = !DILocation(line: 210, column: 3, scope: !380)
!380 = distinct !DILexicalBlock(scope: !374, file: !1, line: 210, column: 3)
!381 = !{!382, !278, i64 80}
!382 = !{!"_reent", !278, i64 0, !286, i64 8, !286, i64 16, !286, i64 24, !278, i64 32, !279, i64 36, !278, i64 64, !286, i64 72, !278, i64 80, !286, i64 88, !286, i64 96, !278, i64 104, !286, i64 112, !286, i64 120, !278, i64 128, !286, i64 136, !279, i64 144, !286, i64 504, !383, i64 512, !286, i64 1304, !385, i64 1312, !279, i64 1336}
!383 = !{!"_atexit", !286, i64 0, !278, i64 8, !279, i64 16, !384, i64 272}
!384 = !{!"_on_exit_args", !279, i64 0, !279, i64 256, !278, i64 512, !278, i64 516}
!385 = !{!"_glue", !286, i64 0, !278, i64 8, !286, i64 16}
!386 = !DILocation(line: 211, column: 10, scope: !363)
!387 = !DILocation(line: 211, column: 3, scope: !363)
