...
define dso_local i32 @isatty(i32) local_unnamed_addr #0 !dbg !72 {
  ...
  call void @llvm.lifetime.start.p0i8(i64 88, i8* nonnull %3) #5, !dbg !79
  %4 = ptrtoint %struct.stat* %2 to i64, !dbg !80
  %5 = add i64 %4, 65536, !dbg !81
  %6 = inttoptr i64 %5 to %struct.stat*, !dbg !82
  %7 = call i32 @fstat(i32 %0, %struct.stat* %6) #6, !dbg !84
...
; <label>:14:                                     ; preds = %9, %1
  %15 = phi i32 [ 9, %1 ], [ 25, %9 ]
  %16 = call i32* @__errno() #6, !dbg !100
  store i32 %15, i32* %16, align 4, !dbg !100, !tbaa !102
  br label %17, !dbg !103

; <label>:17:                                     ; preds = %14, %9
  %18 = phi i32 [ 1, %9 ], [ 0, %14 ], !dbg !104
  call void @llvm.lifetime.end.p0i8(i64 88, i8* nonnull %3) #5, !dbg !103
  ret i32 %18, !dbg !103
}
...
define dso_local noalias i8* @ttyname(i32) local_unnamed_addr #3 !dbg !105 {
  ret i8* null, !dbg !113
}

; Function Attrs: noredzone nounwind readnone
define dso_local noalias i8* @ctermid(i8* nocapture readnone) local_unnamed_addr #3 !dbg !114 {
  ret i8* null, !dbg !120
}
...
; <label>:4:                                      ; preds = %1, %3
  %5 = tail call i32* @__errno() #6, !dbg !127
  store i32 134, i32* %5, align 4, !dbg !128, !tbaa !102
  ret i32 -1, !dbg !129
}
...
!124 = !DILocation(line: 74, column: 2, scope: !125)
!125 = distinct !DILexicalBlock(scope: !126, file: !3, line: 74, column: 2)
!126 = distinct !DILexicalBlock(scope: !123, file: !3, line: 74, column: 2)
!127 = !DILocation(line: 75, column: 2, scope: !2)
!128 = !DILocation(line: 75, column: 8, scope: !2)
!129 = !DILocation(line: 76, column: 2, scope: !2)
