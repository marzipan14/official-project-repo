...
; <label>:262:                                    ; preds = %258, %252, %30, %61, %22, %22, %114, %243
  ...
  ret float %266, !dbg !230

; <label>:267:                                    ; preds = %20, %18, %6
  %268 = phi float [ %7, %6 ], [ %19, %18 ], [ %21, %20 ], !dbg !231
...
; <label>:51:                                     ; preds = %37, %30
  ...
  ret float %55, !dbg !318

; <label>:56:                                     ; preds = %28, %10, %8, %24, %22, %6
  %57 = phi float [ %7, %6 ], [ %23, %22 ], [ %27, %24 ], [ 0xFFF0000000000000, %8 ], [ 0x7FF8000000000000, %10 ], [ 0.000000e+00, %28 ], !dbg !319
