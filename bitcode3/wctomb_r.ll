...
define dso_local i32 @_wctomb_r(%struct._reent*, i8*, i32, %struct._mbstate_t*) local_unnamed_addr #0 !dbg !15 {
  ...
  %9 = select i1 %8, %struct.__locale_t* @__global_locale, %struct.__locale_t* %7, !dbg !295
  %10 = getelementptr inbounds %struct.__locale_t, %struct.__locale_t* %9, i64 0, i32 1, !dbg !310
  %11 = bitcast {}** %10 to i32 (%struct._reent*, i8*, i32, %struct._mbstate_t*)**, !dbg !310
  %12 = load i32 (%struct._reent*, i8*, i32, %struct._mbstate_t*)*, i32 (%struct._reent*, i8*, i32, %struct._mbstate_t*)** %11, align 8, !dbg !310, !tbaa !311
  %13 = tail call i32 %12(%struct._reent* %0, i8* %1, i32 %2, %struct._mbstate_t* %3) #3, !dbg !310
  ret i32 %13, !dbg !314
}

; Function Attrs: noredzone nounwind
define dso_local i32 @__ascii_wctomb(%struct._reent* nocapture, i8*, i32, %struct._mbstate_t* nocapture readnone) local_unnamed_addr #0 !dbg !315 {
  %5 = icmp eq i8* %1, null, !dbg !324
  br i1 %5, label %12, label %6, !dbg !326

; <label>:6:                                      ; preds = %4
  %7 = icmp ugt i32 %2, 255, !dbg !327
  br i1 %7, label %8, label %10, !dbg !329

; <label>:8:                                      ; preds = %6
  %9 = getelementptr inbounds %struct._reent, %struct._reent* %0, i64 0, i32 0, !dbg !330
  store i32 138, i32* %9, align 8, !dbg !332, !tbaa !333
  br label %12, !dbg !334

; <label>:10:                                     ; preds = %6
  %11 = trunc i32 %2 to i8, !dbg !335
  store i8 %11, i8* %1, align 1, !dbg !336, !tbaa !337
  br label %12, !dbg !338

; <label>:12:                                     ; preds = %4, %10, %8
  %13 = phi i32 [ -1, %8 ], [ 1, %10 ], [ 0, %4 ], !dbg !339
  ret i32 %13, !dbg !340
}
...
!310 = !DILocation(line: 16, column: 10, scope: !15)
!311 = !{!312, !306, i64 224}
!312 = !{!"__locale_t", !304, i64 0, !306, i64 224, !306, i64 232, !303, i64 240, !306, i64 248, !313, i64 256, !304, i64 352, !304, i64 354, !304, i64 386}
!313 = !{!"lconv", !306, i64 0, !306, i64 8, !306, i64 16, !306, i64 24, !306, i64 32, !306, i64 40, !306, i64 48, !306, i64 56, !306, i64 64, !306, i64 72, !304, i64 80, !304, i64 81, !304, i64 82, !304, i64 83, !304, i64 84, !304, i64 85, !304, i64 86, !304, i64 87, !304, i64 88, !304, i64 89, !304, i64 90, !304, i64 91, !304, i64 92, !304, i64 93}
!314 = !DILocation(line: 16, column: 3, scope: !15)
!315 = distinct !DISubprogram(name: "__ascii_wctomb", scope: !1, file: !1, line: 20, type: !16, isLocal: false, isDefinition: true, scopeLine: 25, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !316)
!316 = !{!317, !318, !319, !320, !321}
!317 = !DILocalVariable(name: "r", arg: 1, scope: !315, file: !1, line: 20, type: !19)
!318 = !DILocalVariable(name: "s", arg: 2, scope: !315, file: !1, line: 20, type: !50)
!319 = !DILocalVariable(name: "_wchar", arg: 3, scope: !315, file: !1, line: 20, type: !128)
!320 = !DILocalVariable(name: "state", arg: 4, scope: !315, file: !1, line: 20, type: !129)
!321 = !DILocalVariable(name: "wchar", scope: !315, file: !1, line: 29, type: !95)
!322 = !DILocation(line: 20, column: 1, scope: !315)
!323 = !DILocation(line: 29, column: 10, scope: !315)
!324 = !DILocation(line: 31, column: 9, scope: !325)
!325 = distinct !DILexicalBlock(scope: !315, file: !1, line: 31, column: 7)
!326 = !DILocation(line: 31, column: 7, scope: !315)
!327 = !DILocation(line: 37, column: 21, scope: !328)
!328 = distinct !DILexicalBlock(scope: !315, file: !1, line: 37, column: 7)
!329 = !DILocation(line: 37, column: 7, scope: !315)
!330 = !DILocation(line: 40, column: 10, scope: !331)
!331 = distinct !DILexicalBlock(scope: !328, file: !1, line: 39, column: 5)
!332 = !DILocation(line: 40, column: 17, scope: !331)
!333 = !{!302, !303, i64 0}
!334 = !DILocation(line: 41, column: 7, scope: !331)
!335 = !DILocation(line: 44, column: 8, scope: !315)
!336 = !DILocation(line: 44, column: 6, scope: !315)
!337 = !{!304, !304, i64 0}
!338 = !DILocation(line: 45, column: 3, scope: !315)
!339 = !DILocation(line: 0, scope: !315)
!340 = !DILocation(line: 46, column: 1, scope: !315)
