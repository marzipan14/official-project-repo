...
define dso_local i32 @pthread_attr_setguardsize(%struct.pthread_attr_t_** nocapture readnone, i64) local_unnamed_addr #0 !dbg !536 {
  ...
  %4 = select i1 %3, i32 0, i32 22, !dbg !565
  ret i32 %4, !dbg !566
}

; Function Attrs: noredzone nounwind
define dso_local i32 @pthread_attr_getguardsize(%struct.pthread_attr_t_** nocapture readnone, i64*) local_unnamed_addr #1 !dbg !567 {
  %3 = icmp eq i64* %1, null, !dbg !578
  br i1 %3, label %5, label %4, !dbg !580

; <label>:4:                                      ; preds = %2
  store i64 0, i64* %1, align 8, !dbg !581, !tbaa !582
  br label %5, !dbg !586

; <label>:5:                                      ; preds = %2, %4
  %6 = phi i32 [ 0, %4 ], [ 22, %2 ], !dbg !587
  ret i32 %6, !dbg !588
}

; Function Attrs: noredzone nounwind
define dso_local i32 @pthread_attr_setstack(%struct.pthread_attr_t_**, i8*, i64) local_unnamed_addr #1 !dbg !589 {
  %4 = tail call i32 @pthread_attr_setstacksize(%struct.pthread_attr_t_** %0, i64 %2) #5, !dbg !600
  %5 = icmp eq i32 %4, 0, !dbg !602
  br i1 %5, label %6, label %8, !dbg !604

; <label>:6:                                      ; preds = %3
  %7 = tail call i32 @pthread_attr_setstackaddr(%struct.pthread_attr_t_** %0, i8* %1) #5, !dbg !605
  br label %8, !dbg !606

; <label>:8:                                      ; preds = %3, %6
  %9 = phi i32 [ %4, %3 ], [ %7, %6 ], !dbg !607
  ret i32 %9, !dbg !608
}
...
declare dso_local i32 @pthread_attr_setstacksize(%struct.pthread_attr_t_**, i64) local_unnamed_addr #3

; Function Attrs: noredzone
declare dso_local i32 @pthread_attr_setstackaddr(%struct.pthread_attr_t_**, i8*) local_unnamed_addr #3

; Function Attrs: argmemonly nounwind
declare void @llvm.lifetime.end.p0i8(i64, i8* nocapture) #2

; Function Attrs: noredzone nounwind
define dso_local i32 @pthread_attr_getstack(%struct.pthread_attr_t_**, i8**, i64*) local_unnamed_addr #1 !dbg !609 {
  %4 = tail call i32 @pthread_attr_getstacksize(%struct.pthread_attr_t_** %0, i64* %2) #5, !dbg !620
  %5 = icmp eq i32 %4, 0, !dbg !622
  br i1 %5, label %6, label %8, !dbg !624

; <label>:6:                                      ; preds = %3
  %7 = tail call i32 @pthread_attr_getstackaddr(%struct.pthread_attr_t_** %0, i8** %1) #5, !dbg !625
  br label %8, !dbg !626

; <label>:8:                                      ; preds = %3, %6
  %9 = phi i32 [ %4, %3 ], [ %7, %6 ], !dbg !627
  ret i32 %9, !dbg !628
}

; Function Attrs: noredzone
declare dso_local i32 @pthread_attr_getstacksize(%struct.pthread_attr_t_**, i64*) local_unnamed_addr #3

; Function Attrs: noredzone
declare dso_local i32 @pthread_attr_getstackaddr(%struct.pthread_attr_t_**, i8**) local_unnamed_addr #3

; Function Attrs: noredzone nounwind
define dso_local i32 @pthread_getattr_np(i8* readonly, i32, %struct.pthread_attr_t_** readonly) local_unnamed_addr #1 !dbg !629 {
  %4 = alloca i32, align 4
  %5 = bitcast i32* %4 to i8*, !dbg !642
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %5) #6, !dbg !642
  %6 = icmp eq i8* %0, null, !dbg !643
  br i1 %6, label %32, label %7, !dbg !645

; <label>:7:                                      ; preds = %3
  %8 = bitcast i8* %0 to %struct.uk_thread**, !dbg !647
  %9 = load %struct.uk_thread*, %struct.uk_thread** %8, align 8, !dbg !647, !tbaa !648
  %10 = icmp eq %struct.uk_thread* %9, null, !dbg !653
  br i1 %10, label %32, label %11, !dbg !654

; <label>:11:                                     ; preds = %7
  %12 = icmp eq %struct.pthread_attr_t_** %2, null, !dbg !655
  br i1 %12, label %32, label %13, !dbg !657

; <label>:13:                                     ; preds = %11
  %14 = load %struct.pthread_attr_t_*, %struct.pthread_attr_t_** %2, align 8, !dbg !658, !tbaa !659
  %15 = icmp eq %struct.pthread_attr_t_* %14, null, !dbg !660
  br i1 %15, label %32, label %16, !dbg !661

; <label>:16:                                     ; preds = %13
  %17 = getelementptr inbounds %struct.uk_thread, %struct.uk_thread* %9, i64 0, i32 1, !dbg !664
  %18 = bitcast i8** %17 to i64*, !dbg !664
  %19 = load i64, i64* %18, align 8, !dbg !664, !tbaa !665
  %20 = getelementptr inbounds %struct.pthread_attr_t_, %struct.pthread_attr_t_* %14, i64 0, i32 1, !dbg !670
  %21 = bitcast i8** %20 to i64*, !dbg !671
  store i64 %19, i64* %21, align 8, !dbg !671, !tbaa !672
  %22 = getelementptr inbounds %struct.pthread_attr_t_, %struct.pthread_attr_t_* %14, i64 0, i32 2, !dbg !675
  store i64 65536, i64* %22, align 8, !dbg !676, !tbaa !677
  %23 = getelementptr inbounds %struct.uk_thread, %struct.uk_thread* %9, i64 0, i32 7, !dbg !678
  %24 = load i8, i8* %23, align 8, !dbg !678, !tbaa !679, !range !680
  %25 = zext i8 %24 to i32, !dbg !681
  %26 = getelementptr inbounds %struct.pthread_attr_t_, %struct.pthread_attr_t_* %14, i64 0, i32 3, !dbg !682
  store i32 %25, i32* %26, align 8, !dbg !683, !tbaa !684
  %27 = call i32 @uk_thread_get_prio(%struct.uk_thread* nonnull %9, i32* nonnull %4) #5, !dbg !686
  %28 = icmp eq i32 %27, 0, !dbg !688
  br i1 %28, label %29, label %32, !dbg !690

; <label>:29:                                     ; preds = %16
  %30 = load i32, i32* %4, align 4, !dbg !691, !tbaa !692
  %31 = getelementptr inbounds %struct.pthread_attr_t_, %struct.pthread_attr_t_* %14, i64 0, i32 4, i32 0, !dbg !693
  store i32 %30, i32* %31, align 4, !dbg !694, !tbaa !695
  br label %32, !dbg !696

; <label>:32:                                     ; preds = %16, %29, %11, %13, %3, %7
  %33 = phi i32 [ 2, %7 ], [ 2, %3 ], [ 22, %13 ], [ 22, %11 ], [ 0, %29 ], [ 0, %16 ], !dbg !697
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %5) #6, !dbg !698
  ret i32 %33, !dbg !698
}
...
; Function Attrs: noredzone nounwind
define dso_local i32 @pthread_setname_np(i8* readonly, i32, i8*) local_unnamed_addr #1 !dbg !699 {
  %4 = icmp eq i8* %0, null, !dbg !710
  br i1 %4, label %14, label %5, !dbg !712

; <label>:5:                                      ; preds = %3
  %6 = bitcast i8* %0 to %struct.uk_thread**, !dbg !714
  %7 = load %struct.uk_thread*, %struct.uk_thread** %6, align 8, !dbg !714, !tbaa !648
  %8 = icmp eq %struct.uk_thread* %7, null, !dbg !715
  br i1 %8, label %14, label %9, !dbg !716

; <label>:9:                                      ; preds = %5
  %10 = tail call i64 @strnlen(i8* %2, i64 16) #5, !dbg !718
  %11 = icmp ugt i64 %10, 15, !dbg !720
  br i1 %11, label %14, label %12, !dbg !722

; <label>:12:                                     ; preds = %9
  %13 = getelementptr inbounds %struct.uk_thread, %struct.uk_thread* %7, i64 0, i32 0, !dbg !723
  store i8* %2, i8** %13, align 8, !dbg !724, !tbaa !725
  br label %14, !dbg !726

; <label>:14:                                     ; preds = %9, %3, %5, %12
  %15 = phi i32 [ 0, %12 ], [ 2, %5 ], [ 2, %3 ], [ 34, %9 ], !dbg !727
  ret i32 %15, !dbg !728
}
...
; Function Attrs: noredzone nounwind
define dso_local i32 @pthread_getname_np(i8* readonly, i32, i8*, i64) local_unnamed_addr #1 !dbg !729 {
  %5 = icmp eq i8* %0, null, !dbg !742
  br i1 %5, label %19, label %6, !dbg !744

; <label>:6:                                      ; preds = %4
  %7 = bitcast i8* %0 to %struct.uk_thread**, !dbg !746
  %8 = load %struct.uk_thread*, %struct.uk_thread** %7, align 8, !dbg !746, !tbaa !648
  %9 = icmp eq %struct.uk_thread* %8, null, !dbg !747
  br i1 %9, label %19, label %10, !dbg !748

; <label>:10:                                     ; preds = %6
  %11 = getelementptr inbounds %struct.uk_thread, %struct.uk_thread* %8, i64 0, i32 0, !dbg !750
  %12 = load i8*, i8** %11, align 8, !dbg !750, !tbaa !725
  %13 = tail call i64 @strlen(i8* %12) #5, !dbg !751
  %14 = add i64 %13, 1, !dbg !753
  %15 = icmp ugt i64 %14, %3, !dbg !755
  br i1 %15, label %19, label %16, !dbg !756

; <label>:16:                                     ; preds = %10
  %17 = load i8*, i8** %11, align 8, !dbg !757, !tbaa !725
  %18 = tail call i32 (i8*, i8*, ...) @sprintf(i8* %2, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i8* %17) #5, !dbg !758
  br label %19, !dbg !759

; <label>:19:                                     ; preds = %10, %4, %6, %16
  %20 = phi i32 [ 0, %16 ], [ 2, %6 ], [ 2, %4 ], [ 34, %10 ], !dbg !760
  ret i32 %20, !dbg !761
}
...
!565 = !DILocation(line: 40, column: 2, scope: !536)
!566 = !DILocation(line: 41, column: 1, scope: !536)
!567 = distinct !DISubprogram(name: "pthread_attr_getguardsize", scope: !1, file: !1, line: 43, type: !568, isLocal: false, isDefinition: true, scopeLine: 44, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !573)
!568 = !DISubroutineType(types: !569)
!569 = !{!22, !570, !572}
!570 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !571, size: 64)
!571 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !540)
!572 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !547, size: 64)
!573 = !{!574, !575}
!574 = !DILocalVariable(name: "attr", arg: 1, scope: !567, file: !1, line: 43, type: !570)
!575 = !DILocalVariable(name: "guardsize", arg: 2, scope: !567, file: !1, line: 43, type: !572)
!576 = !DILocation(line: 43, column: 53, scope: !567)
!577 = !DILocation(line: 43, column: 67, scope: !567)
!578 = !DILocation(line: 45, column: 7, scope: !579)
!579 = distinct !DILexicalBlock(scope: !567, file: !1, line: 45, column: 6)
!580 = !DILocation(line: 45, column: 6, scope: !567)
!581 = !DILocation(line: 48, column: 13, scope: !567)
!582 = !{!583, !583, i64 0}
!583 = !{!"long", !584, i64 0}
!584 = !{!"omnipotent char", !585, i64 0}
!585 = !{!"Simple C/C++ TBAA"}
!586 = !DILocation(line: 50, column: 2, scope: !567)
!587 = !DILocation(line: 0, scope: !579)
!588 = !DILocation(line: 51, column: 1, scope: !567)
!589 = distinct !DISubprogram(name: "pthread_attr_setstack", scope: !1, file: !1, line: 53, type: !590, isLocal: false, isDefinition: true, scopeLine: 55, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !592)
!590 = !DISubroutineType(types: !591)
!591 = !{!22, !539, !55, !547}
!592 = !{!593, !594, !595, !596}
!593 = !DILocalVariable(name: "attr", arg: 1, scope: !589, file: !1, line: 53, type: !539)
!594 = !DILocalVariable(name: "stackaddr", arg: 2, scope: !589, file: !1, line: 54, type: !55)
!595 = !DILocalVariable(name: "stacksize", arg: 3, scope: !589, file: !1, line: 54, type: !547)
!596 = !DILocalVariable(name: "rc", scope: !589, file: !1, line: 56, type: !22)
!597 = !DILocation(line: 53, column: 43, scope: !589)
!598 = !DILocation(line: 54, column: 9, scope: !589)
!599 = !DILocation(line: 54, column: 27, scope: !589)
!600 = !DILocation(line: 58, column: 7, scope: !589)
!601 = !DILocation(line: 56, column: 6, scope: !589)
!602 = !DILocation(line: 59, column: 6, scope: !603)
!603 = distinct !DILexicalBlock(scope: !589, file: !1, line: 59, column: 6)
!604 = !DILocation(line: 59, column: 6, scope: !589)
!605 = !DILocation(line: 62, column: 7, scope: !589)
!606 = !DILocation(line: 62, column: 2, scope: !589)
!607 = !DILocation(line: 0, scope: !589)
!608 = !DILocation(line: 65, column: 2, scope: !589)
!609 = distinct !DISubprogram(name: "pthread_attr_getstack", scope: !1, file: !1, line: 68, type: !610, isLocal: false, isDefinition: true, scopeLine: 70, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !612)
!610 = !DISubroutineType(types: !611)
!611 = !{!22, !570, !196, !572}
!612 = !{!613, !614, !615, !616}
!613 = !DILocalVariable(name: "attr", arg: 1, scope: !609, file: !1, line: 68, type: !570)
!614 = !DILocalVariable(name: "stackaddr", arg: 2, scope: !609, file: !1, line: 69, type: !196)
!615 = !DILocalVariable(name: "stacksize", arg: 3, scope: !609, file: !1, line: 69, type: !572)
!616 = !DILocalVariable(name: "rc", scope: !609, file: !1, line: 71, type: !22)
!617 = !DILocation(line: 68, column: 49, scope: !609)
!618 = !DILocation(line: 69, column: 10, scope: !609)
!619 = !DILocation(line: 69, column: 29, scope: !609)
!620 = !DILocation(line: 73, column: 7, scope: !609)
!621 = !DILocation(line: 71, column: 6, scope: !609)
!622 = !DILocation(line: 74, column: 6, scope: !623)
!623 = distinct !DILexicalBlock(scope: !609, file: !1, line: 74, column: 6)
!624 = !DILocation(line: 74, column: 6, scope: !609)
!625 = !DILocation(line: 77, column: 7, scope: !609)
!626 = !DILocation(line: 77, column: 2, scope: !609)
!627 = !DILocation(line: 0, scope: !609)
!628 = !DILocation(line: 80, column: 2, scope: !609)
!629 = distinct !DISubprogram(name: "pthread_getattr_np", scope: !1, file: !1, line: 83, type: !630, isLocal: false, isDefinition: true, scopeLine: 84, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !632)
!630 = !DISubroutineType(types: !631)
!631 = !{!22, !488, !539}
!632 = !{!633, !634, !635, !636, !637, !638, !639}
!633 = !DILocalVariable(name: "thread", arg: 1, scope: !629, file: !1, line: 83, type: !488)
!634 = !DILocalVariable(name: "attr", arg: 2, scope: !629, file: !1, line: 83, type: !539)
!635 = !DILocalVariable(name: "tp", scope: !629, file: !1, line: 85, type: !39)
!636 = !DILocalVariable(name: "_uk_thread", scope: !629, file: !1, line: 86, type: !46)
!637 = !DILocalVariable(name: "_attr", scope: !629, file: !1, line: 87, type: !540)
!638 = !DILocalVariable(name: "prio", scope: !629, file: !1, line: 88, type: !116)
!639 = !DILocalVariable(name: "rc", scope: !629, file: !1, line: 89, type: !22)
!640 = !DILocation(line: 83, column: 34, scope: !629)
!641 = !DILocation(line: 83, column: 58, scope: !629)
!642 = !DILocation(line: 88, column: 2, scope: !629)
!643 = !DILocation(line: 91, column: 9, scope: !644)
!644 = distinct !DILexicalBlock(scope: !629, file: !1, line: 91, column: 6)
!645 = !DILocation(line: 91, column: 17, scope: !644)
!646 = !DILocation(line: 85, column: 16, scope: !629)
!647 = !DILocation(line: 91, column: 24, scope: !644)
!648 = !{!649, !650, i64 0}
!649 = !{!"pte_thread_t_", !650, i64 0, !651, i64 8, !650, i64 24, !584, i64 32, !650, i64 40, !650, i64 48, !652, i64 56, !652, i64 60, !650, i64 64, !652, i64 72, !650, i64 80, !652, i64 88, !652, i64 92, !652, i64 96, !584, i64 104, !652, i64 168, !650, i64 176, !650, i64 184}
!650 = !{!"any pointer", !584, i64 0}
!651 = !{!"", !650, i64 0, !652, i64 8}
!652 = !{!"int", !584, i64 0}
!653 = !DILocation(line: 91, column: 33, scope: !644)
!654 = !DILocation(line: 91, column: 6, scope: !629)
!655 = !DILocation(line: 94, column: 11, scope: !656)
!656 = distinct !DILexicalBlock(scope: !629, file: !1, line: 94, column: 6)
!657 = !DILocation(line: 94, column: 19, scope: !656)
!658 = !DILocation(line: 94, column: 22, scope: !656)
!659 = !{!650, !650, i64 0}
!660 = !DILocation(line: 94, column: 28, scope: !656)
!661 = !DILocation(line: 94, column: 6, scope: !629)
!662 = !DILocation(line: 86, column: 20, scope: !629)
!663 = !DILocation(line: 87, column: 17, scope: !629)
!664 = !DILocation(line: 99, column: 33, scope: !629)
!665 = !{!666, !650, i64 8}
!666 = !{!"uk_thread", !650, i64 0, !650, i64 8, !650, i64 16, !650, i64 24, !667, i64 32, !652, i64 48, !583, i64 56, !668, i64 64, !669, i64 72, !650, i64 88, !650, i64 96, !652, i64 104, !650, i64 112, !650, i64 120}
!667 = !{!"", !650, i64 0, !650, i64 8}
!668 = !{!"_Bool", !584, i64 0}
!669 = !{!"uk_waitq", !650, i64 0, !650, i64 8}
!670 = !DILocation(line: 99, column: 9, scope: !629)
!671 = !DILocation(line: 99, column: 19, scope: !629)
!672 = !{!673, !650, i64 8}
!673 = !{!"pthread_attr_t_", !583, i64 0, !650, i64 8, !583, i64 16, !652, i64 24, !674, i64 28, !652, i64 32, !652, i64 36}
!674 = !{!"sched_param", !652, i64 0}
!675 = !DILocation(line: 100, column: 9, scope: !629)
!676 = !DILocation(line: 100, column: 19, scope: !629)
!677 = !{!673, !583, i64 16}
!678 = !DILocation(line: 102, column: 36, scope: !629)
!679 = !{!666, !668, i64 64}
!680 = !{i8 0, i8 2}
!681 = !DILocation(line: 102, column: 24, scope: !629)
!682 = !DILocation(line: 102, column: 9, scope: !629)
!683 = !DILocation(line: 102, column: 21, scope: !629)
!684 = !{!673, !652, i64 24}
!685 = !DILocation(line: 88, column: 9, scope: !629)
!686 = !DILocation(line: 105, column: 2, scope: !629)
!687 = !DILocation(line: 89, column: 6, scope: !629)
!688 = !DILocation(line: 106, column: 9, scope: !689)
!689 = distinct !DILexicalBlock(scope: !629, file: !1, line: 106, column: 6)
!690 = !DILocation(line: 106, column: 6, scope: !629)
!691 = !DILocation(line: 107, column: 33, scope: !689)
!692 = !{!652, !652, i64 0}
!693 = !DILocation(line: 107, column: 16, scope: !689)
!694 = !DILocation(line: 107, column: 31, scope: !689)
!695 = !{!673, !652, i64 28}
!696 = !DILocation(line: 107, column: 3, scope: !689)
!697 = !DILocation(line: 0, scope: !629)
!698 = !DILocation(line: 112, column: 1, scope: !629)
!699 = distinct !DISubprogram(name: "pthread_setname_np", scope: !1, file: !1, line: 114, type: !700, isLocal: false, isDefinition: true, scopeLine: 115, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !702)
!700 = !DISubroutineType(types: !701)
!701 = !{!22, !488, !51}
!702 = !{!703, !704, !705, !706, !707}
!703 = !DILocalVariable(name: "thread", arg: 1, scope: !699, file: !1, line: 114, type: !488)
!704 = !DILocalVariable(name: "name", arg: 2, scope: !699, file: !1, line: 114, type: !51)
!705 = !DILocalVariable(name: "tp", scope: !699, file: !1, line: 116, type: !39)
!706 = !DILocalVariable(name: "_uk_thread", scope: !699, file: !1, line: 117, type: !46)
!707 = !DILocalVariable(name: "len", scope: !699, file: !1, line: 118, type: !547)
!708 = !DILocation(line: 114, column: 34, scope: !699)
!709 = !DILocation(line: 114, column: 54, scope: !699)
!710 = !DILocation(line: 120, column: 9, scope: !711)
!711 = distinct !DILexicalBlock(scope: !699, file: !1, line: 120, column: 6)
!712 = !DILocation(line: 120, column: 17, scope: !711)
!713 = !DILocation(line: 116, column: 16, scope: !699)
!714 = !DILocation(line: 120, column: 24, scope: !711)
!715 = !DILocation(line: 120, column: 33, scope: !711)
!716 = !DILocation(line: 120, column: 6, scope: !699)
!717 = !DILocation(line: 117, column: 20, scope: !699)
!718 = !DILocation(line: 125, column: 8, scope: !699)
!719 = !DILocation(line: 118, column: 9, scope: !699)
!720 = !DILocation(line: 126, column: 10, scope: !721)
!721 = distinct !DILexicalBlock(scope: !699, file: !1, line: 126, column: 6)
!722 = !DILocation(line: 126, column: 6, scope: !699)
!723 = !DILocation(line: 129, column: 14, scope: !699)
!724 = !DILocation(line: 129, column: 19, scope: !699)
!725 = !{!666, !650, i64 0}
!726 = !DILocation(line: 131, column: 2, scope: !699)
!727 = !DILocation(line: 0, scope: !699)
!728 = !DILocation(line: 132, column: 1, scope: !699)
!729 = distinct !DISubprogram(name: "pthread_getname_np", scope: !1, file: !1, line: 134, type: !730, isLocal: false, isDefinition: true, scopeLine: 135, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !732)
!730 = !DISubroutineType(types: !731)
!731 = !{!22, !488, !276, !547}
!732 = !{!733, !734, !735, !736, !737, !738}
!733 = !DILocalVariable(name: "thread", arg: 1, scope: !729, file: !1, line: 134, type: !488)
!734 = !DILocalVariable(name: "name", arg: 2, scope: !729, file: !1, line: 134, type: !276)
!735 = !DILocalVariable(name: "len", arg: 3, scope: !729, file: !1, line: 134, type: !547)
!736 = !DILocalVariable(name: "tp", scope: !729, file: !1, line: 136, type: !39)
!737 = !DILocalVariable(name: "_uk_thread", scope: !729, file: !1, line: 137, type: !46)
!738 = !DILocalVariable(name: "_len", scope: !729, file: !1, line: 138, type: !547)
!739 = !DILocation(line: 134, column: 34, scope: !729)
!740 = !DILocation(line: 134, column: 48, scope: !729)
!741 = !DILocation(line: 134, column: 61, scope: !729)
!742 = !DILocation(line: 140, column: 9, scope: !743)
!743 = distinct !DILexicalBlock(scope: !729, file: !1, line: 140, column: 6)
!744 = !DILocation(line: 140, column: 17, scope: !743)
!745 = !DILocation(line: 136, column: 16, scope: !729)
!746 = !DILocation(line: 140, column: 24, scope: !743)
!747 = !DILocation(line: 140, column: 33, scope: !743)
!748 = !DILocation(line: 140, column: 6, scope: !729)
!749 = !DILocation(line: 137, column: 20, scope: !729)
!750 = !DILocation(line: 145, column: 28, scope: !729)
!751 = !DILocation(line: 145, column: 9, scope: !729)
!752 = !DILocation(line: 138, column: 9, scope: !729)
!753 = !DILocation(line: 146, column: 17, scope: !754)
!754 = distinct !DILexicalBlock(scope: !729, file: !1, line: 146, column: 6)
!755 = !DILocation(line: 146, column: 10, scope: !754)
!756 = !DILocation(line: 146, column: 6, scope: !729)
!757 = !DILocation(line: 149, column: 33, scope: !729)
!758 = !DILocation(line: 149, column: 2, scope: !729)
!759 = !DILocation(line: 151, column: 2, scope: !729)
!760 = !DILocation(line: 0, scope: !729)
!761 = !DILocation(line: 152, column: 1, scope: !729)
