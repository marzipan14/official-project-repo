...
define dso_local i32 @pthread_rwlock_tryrdlock(%struct.pthread_rwlock_t_**) local_unnamed_addr #0 !dbg !513 {
  ...
  br i1 %2, label %44, label %3, !dbg !524

; <label>:3:                                      ; preds = %1
  %4 = bitcast %struct.pthread_rwlock_t_** %0 to i64*, !dbg !525
  %5 = load i64, i64* %4, align 8, !dbg !525, !tbaa !526
  %6 = inttoptr i64 %5 to %struct.pthread_rwlock_t_*, !dbg !530
...
; <label>:7:                                      ; preds = %3
  %8 = tail call i32 @pte_rwlock_check_need_init(%struct.pthread_rwlock_t_** nonnull %0) #3, !dbg !531
  %9 = or i32 %8, 16, !dbg !535
  %10 = icmp eq i32 %9, 16, !dbg !535
  br i1 %10, label %11, label %44, !dbg !535

; <label>:11:                                     ; preds = %7
  %12 = load %struct.pthread_rwlock_t_*, %struct.pthread_rwlock_t_** %0, align 8, !dbg !537, !tbaa !526
  br label %13, !dbg !535

; <label>:13:                                     ; preds = %11, %3
  %14 = phi %struct.pthread_rwlock_t_* [ %12, %11 ], [ %6, %3 ], !dbg !537
  %15 = getelementptr inbounds %struct.pthread_rwlock_t_, %struct.pthread_rwlock_t_* %14, i64 0, i32 6, !dbg !539
  %16 = load i32, i32* %15, align 4, !dbg !539, !tbaa !541
  %17 = icmp eq i32 %16, 262974946, !dbg !544
  br i1 %17, label %18, label %44, !dbg !545

; <label>:18:                                     ; preds = %13
  %19 = getelementptr inbounds %struct.pthread_rwlock_t_, %struct.pthread_rwlock_t_* %14, i64 0, i32 0, !dbg !546
  %20 = tail call i32 @pthread_mutex_trylock(%struct.pthread_mutex_t_** %19) #3, !dbg !548
  %21 = icmp eq i32 %20, 0, !dbg !549
  br i1 %21, label %22, label %44, !dbg !550

; <label>:22:                                     ; preds = %18
  %23 = getelementptr inbounds %struct.pthread_rwlock_t_, %struct.pthread_rwlock_t_* %14, i64 0, i32 3, !dbg !551
  %24 = load i32, i32* %23, align 8, !dbg !553, !tbaa !554
  %25 = add nsw i32 %24, 1, !dbg !553
  store i32 %25, i32* %23, align 8, !dbg !553, !tbaa !554
  %26 = icmp eq i32 %25, 2147483647, !dbg !555
  br i1 %26, label %27, label %42, !dbg !556

; <label>:27:                                     ; preds = %22
  %28 = getelementptr inbounds %struct.pthread_rwlock_t_, %struct.pthread_rwlock_t_* %14, i64 0, i32 1, !dbg !557
  %29 = tail call i32 @pthread_mutex_lock(%struct.pthread_mutex_t_** nonnull %28) #3, !dbg !560
  %30 = icmp eq i32 %29, 0, !dbg !561
  br i1 %30, label %33, label %31, !dbg !562

; <label>:31:                                     ; preds = %27
  %32 = tail call i32 @pthread_mutex_unlock(%struct.pthread_mutex_t_** nonnull %19) #3, !dbg !563
  br label %44, !dbg !565

; <label>:33:                                     ; preds = %27
  %34 = getelementptr inbounds %struct.pthread_rwlock_t_, %struct.pthread_rwlock_t_* %14, i64 0, i32 5, !dbg !566
  %35 = load i32, i32* %34, align 8, !dbg !566, !tbaa !567
  %36 = load i32, i32* %23, align 8, !dbg !568, !tbaa !554
  %37 = sub nsw i32 %36, %35, !dbg !568
  store i32 %37, i32* %23, align 8, !dbg !568, !tbaa !554
  store i32 0, i32* %34, align 8, !dbg !569, !tbaa !567
  %38 = tail call i32 @pthread_mutex_unlock(%struct.pthread_mutex_t_** nonnull %28) #3, !dbg !570
  %39 = icmp eq i32 %38, 0, !dbg !572
  br i1 %39, label %42, label %40, !dbg !573

; <label>:40:                                     ; preds = %33
  %41 = tail call i32 @pthread_mutex_unlock(%struct.pthread_mutex_t_** nonnull %19) #3, !dbg !574
  br label %44, !dbg !576

; <label>:42:                                     ; preds = %33, %22
  %43 = tail call i32 @pthread_mutex_unlock(%struct.pthread_mutex_t_** nonnull %19) #3, !dbg !577
  br label %44, !dbg !578

; <label>:44:                                     ; preds = %18, %13, %7, %3, %1, %42, %40, %31
  %45 = phi i32 [ %29, %31 ], [ %38, %40 ], [ %43, %42 ], [ 22, %3 ], [ 22, %1 ], [ %8, %7 ], [ 22, %13 ], [ %20, %18 ], !dbg !579
  ret i32 %45, !dbg !580
}
...
!529 = !{!"Simple C/C++ TBAA"}
!530 = !DILocation(line: 55, column: 7, scope: !513)
!531 = !DILocation(line: 68, column: 16, scope: !532)
!532 = distinct !DILexicalBlock(scope: !533, file: !1, line: 67, column: 5)
!533 = distinct !DILexicalBlock(scope: !513, file: !1, line: 66, column: 7)
!534 = !DILocation(line: 52, column: 7, scope: !513)
!535 = !DILocation(line: 70, column: 23, scope: !536)
!536 = distinct !DILexicalBlock(scope: !532, file: !1, line: 70, column: 11)
!537 = !DILocation(line: 76, column: 9, scope: !513)
!538 = !DILocation(line: 53, column: 20, scope: !513)
!539 = !DILocation(line: 78, column: 12, scope: !540)
!540 = distinct !DILexicalBlock(scope: !513, file: !1, line: 78, column: 7)
!541 = !{!542, !543, i64 36}
!542 = !{!"pthread_rwlock_t_", !527, i64 0, !527, i64 8, !527, i64 16, !543, i64 24, !543, i64 28, !543, i64 32, !543, i64 36}
!543 = !{!"int", !528, i64 0}
!544 = !DILocation(line: 78, column: 19, scope: !540)
!545 = !DILocation(line: 78, column: 7, scope: !513)
!546 = !DILocation(line: 83, column: 47, scope: !547)
!547 = distinct !DILexicalBlock(scope: !513, file: !1, line: 83, column: 7)
!548 = !DILocation(line: 83, column: 17, scope: !547)
!549 = !DILocation(line: 83, column: 69, scope: !547)
!550 = !DILocation(line: 83, column: 7, scope: !513)
!551 = !DILocation(line: 88, column: 14, scope: !552)
!552 = distinct !DILexicalBlock(scope: !513, file: !1, line: 88, column: 7)
!553 = !DILocation(line: 88, column: 7, scope: !552)
!554 = !{!542, !543, i64 24}
!555 = !DILocation(line: 88, column: 33, scope: !552)
!556 = !DILocation(line: 88, column: 7, scope: !513)
!557 = !DILocation(line: 91, column: 41, scope: !558)
!558 = distinct !DILexicalBlock(scope: !559, file: !1, line: 90, column: 11)
!559 = distinct !DILexicalBlock(scope: !552, file: !1, line: 89, column: 5)
!560 = !DILocation(line: 91, column: 14, scope: !558)
!561 = !DILocation(line: 91, column: 69, scope: !558)
!562 = !DILocation(line: 90, column: 11, scope: !559)
!563 = !DILocation(line: 93, column: 18, scope: !564)
!564 = distinct !DILexicalBlock(scope: !558, file: !1, line: 92, column: 9)
!565 = !DILocation(line: 94, column: 11, scope: !564)
!566 = !DILocation(line: 97, column: 39, scope: !559)
!567 = !{!542, !543, i64 32}
!568 = !DILocation(line: 97, column: 31, scope: !559)
!569 = !DILocation(line: 98, column: 40, scope: !559)
!570 = !DILocation(line: 101, column: 14, scope: !571)
!571 = distinct !DILexicalBlock(scope: !559, file: !1, line: 100, column: 11)
!572 = !DILocation(line: 101, column: 71, scope: !571)
!573 = !DILocation(line: 100, column: 11, scope: !559)
!574 = !DILocation(line: 103, column: 18, scope: !575)
!575 = distinct !DILexicalBlock(scope: !571, file: !1, line: 102, column: 9)
!576 = !DILocation(line: 104, column: 11, scope: !575)
!577 = !DILocation(line: 108, column: 11, scope: !513)
!578 = !DILocation(line: 108, column: 3, scope: !513)
!579 = !DILocation(line: 0, scope: !513)
!580 = !DILocation(line: 109, column: 1, scope: !513)
