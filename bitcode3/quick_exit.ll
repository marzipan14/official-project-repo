...
define dso_local void @quick_exit(i32) local_unnamed_addr #2 !dbg !48 {
  %2 = load %struct.quick_exit_handler*, %struct.quick_exit_handler** @handlers, align 8, !dbg !56, !tbaa !41
  %3 = icmp eq %struct.quick_exit_handler* %2, null, !dbg !59
  br i1 %3, label %11, label %4, !dbg !60

; <label>:4:                                      ; preds = %1, %4
  %5 = phi %struct.quick_exit_handler* [ %9, %4 ], [ %2, %1 ]
  %6 = getelementptr inbounds %struct.quick_exit_handler, %struct.quick_exit_handler* %5, i64 0, i32 1, !dbg !61
  %7 = load void ()*, void ()** %6, align 8, !dbg !61, !tbaa !35
  tail call void %7() #5, !dbg !62
  %8 = getelementptr inbounds %struct.quick_exit_handler, %struct.quick_exit_handler* %5, i64 0, i32 0, !dbg !63
  %9 = load %struct.quick_exit_handler*, %struct.quick_exit_handler** %8, align 8, !dbg !56, !tbaa !41
  %10 = icmp eq %struct.quick_exit_handler* %9, null, !dbg !59
  br i1 %10, label %11, label %4, !dbg !60, !llvm.loop !64

; <label>:11:                                     ; preds = %4, %1
  tail call void @_exit(i32 %0) #6, !dbg !66
  unreachable, !dbg !66
}
...
!47 = !DILocation(line: 74, column: 1, scope: !20)
!48 = distinct !DISubprogram(name: "quick_exit", scope: !3, file: !3, line: 77, type: !49, isLocal: false, isDefinition: true, scopeLine: 78, flags: DIFlagPrototyped | DIFlagNoReturn, isOptimized: true, unit: !2, retainedNodes: !51)
!49 = !DISubroutineType(types: !50)
!50 = !{null, !23}
!51 = !{!52, !53}
!52 = !DILocalVariable(name: "status", arg: 1, scope: !48, file: !3, line: 77, type: !23)
!53 = !DILocalVariable(name: "h", scope: !48, file: !3, line: 79, type: !8)
!54 = !DILocation(line: 77, column: 16, scope: !48)
!55 = !DILocation(line: 79, column: 29, scope: !48)
!56 = !DILocation(line: 0, scope: !57)
!57 = distinct !DILexicalBlock(scope: !58, file: !3, line: 85, column: 2)
!58 = distinct !DILexicalBlock(scope: !48, file: !3, line: 85, column: 2)
!59 = !DILocation(line: 85, column: 26, scope: !57)
!60 = !DILocation(line: 85, column: 2, scope: !58)
!61 = !DILocation(line: 86, column: 6, scope: !57)
!62 = !DILocation(line: 86, column: 3, scope: !57)
!63 = !DILocation(line: 85, column: 39, scope: !57)
!64 = distinct !{!64, !60, !65}
!65 = !DILocation(line: 86, column: 14, scope: !58)
!66 = !DILocation(line: 87, column: 2, scope: !48)
