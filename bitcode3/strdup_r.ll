; ModuleID = '/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/string/strdup_r.c'
source_filename = "/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/string/strdup_r.c"
...
define dso_local i8* @_strdup_r(%struct._reent* nocapture readnone, i8*) local_unnamed_addr #0 !dbg !7 {
  %3 = tail call i64 @strlen(i8* %1) #3, !dbg !240
  %4 = add i64 %3, 1, !dbg !241
  %5 = tail call i8* @malloc(i64 %4) #3, !dbg !243
  %6 = icmp eq i8* %5, null, !dbg !245
  br i1 %6, label %9, label %7, !dbg !247

; <label>:7:                                      ; preds = %2
  %8 = tail call i8* @memcpy(i8* nonnull %5, i8* %1, i64 %4) #3, !dbg !248
  br label %9, !dbg !250
...
!1 = !DIFile(filename: "/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/string/strdup_r.c", directory: "/root/.unikraft/apps/redis/build")
!2 = !{}
!3 = !{i32 2, !"Dwarf Version", i32 4}
!4 = !{i32 2, !"Debug Info Version", i32 3}
!5 = !{i32 1, !"wchar_size", i32 4}
!6 = !{!"clang version 7.0.1-8+deb10u2 (tags/RELEASE_701/final)"}
!7 = distinct !DISubprogram(name: "_strdup_r", scope: !1, file: !1, line: 6, type: !8, isLocal: false, isDefinition: true, scopeLine: 9, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !230)
...
!230 = !{!231, !232, !233, !238}
!231 = !DILocalVariable(name: "reent_ptr", arg: 1, scope: !7, file: !1, line: 6, type: !12)
!232 = !DILocalVariable(name: "str", arg: 2, scope: !7, file: !1, line: 6, type: !50)
!233 = !DILocalVariable(name: "len", scope: !7, file: !1, line: 10, type: !234)
!234 = !DIDerivedType(tag: DW_TAG_typedef, name: "size_t", file: !235, line: 40, baseType: !236)
!235 = !DIFile(filename: "/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/include/strings.h", directory: "/root/.unikraft/apps/redis/build")
!236 = !DIDerivedType(tag: DW_TAG_typedef, name: "__size_t", file: !44, line: 129, baseType: !237)
!237 = !DIBasicType(name: "long unsigned int", size: 64, encoding: DW_ATE_unsigned)
!238 = !DILocalVariable(name: "copy", scope: !7, file: !1, line: 11, type: !10)
!239 = !DILocation(line: 6, column: 1, scope: !7)
!240 = !DILocation(line: 10, column: 16, scope: !7)
!241 = !DILocation(line: 10, column: 29, scope: !7)
!242 = !DILocation(line: 10, column: 10, scope: !7)
!243 = !DILocation(line: 11, column: 16, scope: !7)
!244 = !DILocation(line: 11, column: 9, scope: !7)
!245 = !DILocation(line: 12, column: 7, scope: !246)
!246 = distinct !DILexicalBlock(scope: !7, file: !1, line: 12, column: 7)
!247 = !DILocation(line: 12, column: 7, scope: !7)
!248 = !DILocation(line: 14, column: 7, scope: !249)
!249 = distinct !DILexicalBlock(scope: !246, file: !1, line: 13, column: 5)
!250 = !DILocation(line: 15, column: 5, scope: !249)
!251 = !DILocation(line: 16, column: 3, scope: !7)
