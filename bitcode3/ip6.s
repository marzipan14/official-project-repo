...
.LBB2_4:
	...
	callq	pbuf_realloc
	movl	24(%r12), %r13d
	movl	%r13d, ip_data+60(%rip)
	movl	28(%r12), %ebx
	movl	%ebx, ip_data+64(%rip)
	movl	32(%r12), %esi
	movl	%esi, ip_data+68(%rip)
	movl	36(%r12), %edx
	movl	%edx, ip_data+72(%rip)
	movb	$0, ip_data+76(%rip)
	movb	$6, ip_data+80(%rip)
	movl	8(%r12), %r15d
	movl	%r15d, ip_data+36(%rip)
	movl	12(%r12), %ecx
	movl	%ecx, ip_data+40(%rip)
	movl	16(%r12), %r9d
	movl	%r9d, ip_data+44(%rip)
	movl	20(%r12), %r8d
	movl	%r8d, ip_data+48(%rip)
...
# %bb.11:
	movl	%r13d, %r10d
	andl	$49407, %r10d           # imm = 0xC0FF
	cmpl	$33022, %r10d           # imm = 0x80FE
	je	.LBB2_14
# %bb.12:
	movl	%r13d, %eax
...
.LBB2_15:
	...
	andl	$49407, %r15d           # imm = 0xC0FF
	cmpl	$33022, %r15d           # imm = 0x80FE
	jne	.LBB2_17
# %bb.16:
...
.LBB2_18:
	...
	movq	%rdi, ip_data(%rip)
	movq	%rdi, ip_data+8(%rip)
	cmpb	$-1, %r13b
	jne	.LBB2_23
# %bb.19:
	orl	%ebx, %esi
...
.LBB2_28:
	...
	orl	ip_data+36(%rip), %ecx
	jmp	.LBB2_34
.LBB2_29:
	cmpl	$33022, -72(%rbp)       # 4-byte Folded Reload
                                        # imm = 0x80FE
	movl	-60(%rbp), %ecx         # 4-byte Reload
	movl	-56(%rbp), %r9d         # 4-byte Reload
	movl	-52(%rbp), %r8d         # 4-byte Reload
...
# %bb.31:
	...
	jne	.LBB2_98
# %bb.32:
	cmpl	$16777216, -64(%rbp)    # 4-byte Folded Reload
                                        # imm = 0x1000000
	jne	.LBB2_98
.LBB2_33:
	xorl	%ebx, %ebx
...
.LBB2_82:                               #   in Loop: Header=BB2_43 Depth=1
	cmpw	$7, 18(%r14)
	jbe	.LBB2_113
# %bb.83:                               #   in Loop: Header=BB2_43 Depth=1
	movq	8(%r14), %rbx
	movzwl	2(%rbx), %edi
	callq	lwip_htons
                                        # kill: def $ax killed $ax def $eax
...
# %bb.84:                               #   in Loop: Header=BB2_43 Depth=1
	...
	testb	$7, %al
	jne	.LBB2_124
.LBB2_85:                               #   in Loop: Header=BB2_43 Depth=1
	addl	$8, %r13d
	movzwl	2(%rbx), %eax
...
.LBB4_12:
	...
	popq	%r15
	popq	%rbp
	jmp	ip6_output_if_src       # TAILCALL
.LBB4_6:
	movq	16(%rbp), %rdi
	movq	%rbx, %rsi
