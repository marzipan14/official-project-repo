...
; <label>:18:                                     ; preds = %13
  ...
  %20 = tail call i32 @pthread_mutex_lock(%struct.pthread_mutex_t_** %19) #3, !dbg !548
