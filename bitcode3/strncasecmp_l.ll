...
define dso_local i32 @strncasecmp_l(i8* nocapture readonly, i8* nocapture readonly, i64, %struct.__locale_t*) local_unnamed_addr #0 !dbg !7 {
  ...
  br i1 %5, label %25, label %6, !dbg !40

; <label>:6:                                      ; preds = %4, %20
  %7 = phi i8* [ %22, %20 ], [ %0, %4 ]
  %8 = phi i8* [ %21, %20 ], [ %1, %4 ]
  %9 = phi i64 [ %23, %20 ], [ %2, %4 ]
  %10 = load i8, i8* %7, align 1, !dbg !41, !tbaa !42
  %11 = sext i8 %10 to i32, !dbg !41
  %12 = tail call i32 @tolower_l(i32 %11, %struct.__locale_t* %3) #3, !dbg !45
  %13 = load i8, i8* %8, align 1, !dbg !47, !tbaa !42
  %14 = sext i8 %13 to i32, !dbg !47
  %15 = tail call i32 @tolower_l(i32 %14, %struct.__locale_t* %3) #3, !dbg !48
  %16 = sub nsw i32 %12, %15, !dbg !50
  %17 = icmp eq i32 %16, 0, !dbg !52
  %18 = icmp ne i32 %15, 0, !dbg !53
  %19 = and i1 %18, %17, !dbg !54
  br i1 %19, label %20, label %25

; <label>:20:                                     ; preds = %6
  %21 = getelementptr inbounds i8, i8* %8, i64 1, !dbg !55
  %22 = getelementptr inbounds i8, i8* %7, i64 1, !dbg !56
  %23 = add i64 %9, -1, !dbg !57
  %24 = icmp eq i64 %23, 0, !dbg !39
  br i1 %24, label %25, label %6, !dbg !40, !llvm.loop !58

; <label>:25:                                     ; preds = %6, %20, %4
  %26 = phi i32 [ 0, %4 ], [ %16, %6 ], [ 0, %20 ], !dbg !60
  ret i32 %26, !dbg !61
}
...
!39 = !DILocation(line: 48, column: 13, scope: !30)
!40 = !DILocation(line: 48, column: 3, scope: !31)
!41 = !DILocation(line: 50, column: 33, scope: !29)
!42 = !{!43, !43, i64 0}
!43 = !{!"omnipotent char", !44, i64 0}
!44 = !{!"Simple C/C++ TBAA"}
!45 = !DILocation(line: 50, column: 22, scope: !29)
!46 = !DILocation(line: 50, column: 17, scope: !29)
!47 = !DILocation(line: 51, column: 33, scope: !29)
!48 = !DILocation(line: 51, column: 22, scope: !29)
!49 = !DILocation(line: 51, column: 17, scope: !29)
!50 = !DILocation(line: 52, column: 20, scope: !51)
!51 = distinct !DILexicalBlock(scope: !29, file: !1, line: 52, column: 11)
!52 = !DILocation(line: 52, column: 26, scope: !51)
!53 = !DILocation(line: 52, column: 39, scope: !51)
!54 = !DILocation(line: 53, column: 9, scope: !51)
!55 = !DILocation(line: 51, column: 36, scope: !29)
!56 = !DILocation(line: 50, column: 36, scope: !29)
!57 = !DILocation(line: 48, column: 20, scope: !30)
!58 = distinct !{!58, !40, !59}
!59 = !DILocation(line: 54, column: 5, scope: !31)
!60 = !DILocation(line: 0, scope: !7)
!61 = !DILocation(line: 55, column: 3, scope: !7)
