...
; <label>:189:                                    ; preds = %185, %137
  %190 = tail call %struct.netif* @nd6_find_route(%struct.ip6_addr* %1) #8, !dbg !384
...
; <label>:264:                                    ; preds = %261
  ...
  ret %struct.netif* %269, !dbg !415

; <label>:270:                                    ; preds = %40, %35, %166, %175, %383, %392, %415, %424, %247, %336, %365, %88, %93, %133, %123, %287, %312, %28, %75, %76, %9, %261, %189, %18, %23
  %271 = phi %struct.netif* [ %3, %23 ], [ null, %9 ], [ null, %18 ], [ %190, %189 ], [ null, %261 ], [ null, %76 ], [ null, %75 ], [ null, %28 ], [ null, %133 ], [ %98, %123 ], [ %98, %287 ], [ %98, %312 ], [ %83, %88 ], [ null, %93 ], [ %218, %365 ], [ %218, %336 ], [ %218, %247 ], [ %143, %424 ], [ %143, %415 ], [ %143, %392 ], [ %143, %383 ], [ %143, %175 ], [ %143, %166 ], [ null, %40 ], [ %30, %35 ], !dbg !416
...
; <label>:31:                                     ; preds = %28
  %32 = tail call i32 @lwip_htonl(i32 %4) #8, !dbg !454
...
define dso_local signext i8 @ip6_input(%struct.pbuf*, %struct.netif*) local_unnamed_addr #0 !dbg !520 {
  ...
  %10 = tail call i32 @lwip_htonl(i32 %9) #8, !dbg !565
  %11 = and i32 %10, -268435456, !dbg !570
  %12 = icmp eq i32 %11, 1610612736, !dbg !570
  br i1 %12, label %19, label %13, !dbg !571

; <label>:13:                                     ; preds = %2
  %14 = tail call zeroext i8 @pbuf_free(%struct.pbuf* nonnull %0) #8, !dbg !572
...
; <label>:24:                                     ; preds = %19
  ...
  %26 = tail call zeroext i16 @lwip_htons(i16 zeroext %25) #8, !dbg !585
...
; <label>:33:                                     ; preds = %19, %24
  ...
  %35 = tail call zeroext i16 @lwip_htons(i16 zeroext %34) #8, !dbg !593
  %36 = tail call zeroext i8 @pbuf_free(%struct.pbuf* nonnull %0) #8, !dbg !596
  ...
  br label %435, !dbg !600

; <label>:41:                                     ; preds = %24
  %42 = load i16, i16* %23, align 1, !dbg !601, !tbaa !586
  %43 = tail call zeroext i16 @lwip_htons(i16 zeroext %42) #8, !dbg !601
  %44 = add i16 %43, 40, !dbg !602
  tail call void @pbuf_realloc(%struct.pbuf* nonnull %0, i16 zeroext %44) #8, !dbg !603
...
; <label>:73:                                     ; preds = %65, %41
  %74 = tail call zeroext i8 @pbuf_free(%struct.pbuf* nonnull %0) #8, !dbg !621
...
; <label>:97:                                     ; preds = %89, %93
  ...
  br i1 %100, label %101, label %121, !dbg !636
...
; <label>:101:                                    ; preds = %97
  ...
  br i1 %107, label %150, label %108, !dbg !637

; <label>:108:                                    ; preds = %101
  %109 = icmp eq i32 %46, 767, !dbg !640
  %110 = and i1 %109, %104, !dbg !640
  %111 = and i1 %110, %106, !dbg !640
  br i1 %111, label %150, label %112, !dbg !640

; <label>:112:                                    ; preds = %108
  %113 = tail call %struct.mld_group* @mld6_lookfor_group(%struct.netif* %1, %struct.ip6_addr* getelementptr inbounds (%struct.ip_globals, %struct.ip_globals* @ip_data, i64 0, i32 6, i32 0, i32 0)) #8, !dbg !641
  %114 = icmp eq %struct.mld_group* %113, null, !dbg !641
  %115 = select i1 %114, %struct.netif* null, %struct.netif* %1
  %116 = load i32, i32* getelementptr inbounds (%struct.ip_globals, %struct.ip_globals* @ip_data, i64 0, i32 5, i32 0, i32 0, i32 0, i64 0), align 4, !dbg !643, !tbaa !355
  %117 = load i32, i32* getelementptr inbounds (%struct.ip_globals, %struct.ip_globals* @ip_data, i64 0, i32 5, i32 0, i32 0, i32 0, i64 1), align 4, !dbg !643
  %118 = load i32, i32* getelementptr inbounds (%struct.ip_globals, %struct.ip_globals* @ip_data, i64 0, i32 5, i32 0, i32 0, i32 0, i64 2), align 4, !dbg !643
  %119 = load i32, i32* getelementptr inbounds (%struct.ip_globals, %struct.ip_globals* @ip_data, i64 0, i32 5, i32 0, i32 0, i32 0, i64 3), align 4, !dbg !643
  %120 = or i32 %117, %116, !dbg !643
  br label %150

; <label>:121:                                    ; preds = %97
  %122 = tail call fastcc i32 @ip6_input_accept(%struct.netif* %1) #9, !dbg !645
  %123 = icmp eq i32 %122, 0, !dbg !645
  br i1 %123, label %124, label %150, !dbg !648

; <label>:124:                                    ; preds = %121
  %125 = or i1 %81, %92, !dbg !650
  br i1 %125, label %150, label %126, !dbg !650

; <label>:126:                                    ; preds = %124
  %127 = or i32 %50, %48, !dbg !653
  %128 = or i32 %127, %46, !dbg !653
  %129 = icmp eq i32 %128, 0, !dbg !653
  %130 = icmp eq i32 %52, 16777216, !dbg !653
  %131 = and i1 %129, %130, !dbg !653
  br i1 %131, label %150, label %132, !dbg !653

; <label>:132:                                    ; preds = %126
  %133 = or i32 %66, %58, !dbg !655
  %134 = icmp eq i32 %133, 0, !dbg !655
  %135 = icmp eq i32 %60, 16777216, !dbg !655
  %136 = and i1 %134, %135, !dbg !655
  br i1 %136, label %150, label %137, !dbg !655

; <label>:137:                                    ; preds = %132
  %138 = load %struct.netif*, %struct.netif** @netif_list, align 8, !dbg !656, !tbaa !273
  %139 = icmp eq %struct.netif* %138, null, !dbg !658
  br i1 %139, label %150, label %140, !dbg !656

; <label>:140:                                    ; preds = %137, %146
  %141 = phi %struct.netif* [ %148, %146 ], [ %138, %137 ]
  %142 = icmp eq %struct.netif* %141, %1, !dbg !660
  br i1 %142, label %146, label %143, !dbg !663

; <label>:143:                                    ; preds = %140
  %144 = tail call fastcc i32 @ip6_input_accept(%struct.netif* nonnull %141) #9, !dbg !664
  %145 = icmp eq i32 %144, 0, !dbg !664
  br i1 %145, label %146, label %150, !dbg !666

; <label>:146:                                    ; preds = %143, %140
  %147 = getelementptr inbounds %struct.netif, %struct.netif* %141, i64 0, i32 0, !dbg !658
  %148 = load %struct.netif*, %struct.netif** %147, align 8, !dbg !656, !tbaa !273
  %149 = icmp eq %struct.netif* %148, null, !dbg !658
  br i1 %149, label %150, label %140, !dbg !656, !llvm.loop !667

; <label>:150:                                    ; preds = %146, %143, %137, %124, %132, %126, %121, %112, %101, %108
  %151 = phi i32 [ %66, %137 ], [ %66, %124 ], [ %66, %132 ], [ %66, %126 ], [ %66, %121 ], [ %120, %112 ], [ %66, %101 ], [ %66, %108 ], [ %66, %143 ], [ %66, %146 ], !dbg !643
  %152 = phi i32 [ %60, %137 ], [ %60, %124 ], [ 16777216, %132 ], [ %60, %126 ], [ %60, %121 ], [ %119, %112 ], [ %60, %101 ], [ %60, %108 ], [ %60, %143 ], [ %60, %146 ], !dbg !643
  %153 = phi i32 [ %58, %137 ], [ %58, %124 ], [ %58, %132 ], [ %58, %126 ], [ %58, %121 ], [ %118, %112 ], [ %58, %101 ], [ %58, %108 ], [ %58, %143 ], [ %58, %146 ], !dbg !643
  %154 = phi %struct.netif* [ null, %137 ], [ null, %124 ], [ null, %132 ], [ null, %126 ], [ %1, %121 ], [ %115, %112 ], [ %1, %101 ], [ %1, %108 ], [ null, %146 ], [ %141, %143 ], !dbg !669
  %155 = or i32 %151, %153, !dbg !643
  %156 = or i32 %155, %152, !dbg !643
  %157 = icmp eq i32 %156, 0, !dbg !643
  br i1 %157, label %158, label %172, !dbg !643

; <label>:158:                                    ; preds = %150
  %159 = load i32, i32* getelementptr inbounds (%struct.ip_globals, %struct.ip_globals* @ip_data, i64 0, i32 6, i32 0, i32 0, i32 0, i64 0), align 4, !dbg !670, !tbaa !355
  %160 = icmp eq i32 %159, 767, !dbg !670
  %161 = load i32, i32* getelementptr inbounds (%struct.ip_globals, %struct.ip_globals* @ip_data, i64 0, i32 6, i32 0, i32 0, i32 0, i64 2), align 4, !dbg !670
  %162 = icmp eq i32 %161, 16777216, !dbg !670
  %163 = and i1 %160, %162, !dbg !670
  br i1 %163, label %164, label %168, !dbg !670

; <label>:164:                                    ; preds = %158
  %165 = load i32, i32* getelementptr inbounds (%struct.ip_globals, %struct.ip_globals* @ip_data, i64 0, i32 6, i32 0, i32 0, i32 0, i64 3), align 4, !dbg !670, !tbaa !355
  %166 = and i32 %165, 255, !dbg !670
  %167 = icmp eq i32 %166, 255, !dbg !670
  br i1 %167, label %172, label %168, !dbg !671

; <label>:168:                                    ; preds = %164, %158
  %169 = tail call zeroext i8 @pbuf_free(%struct.pbuf* %0) #8, !dbg !672
  %170 = load i16, i16* getelementptr inbounds (%struct.stats_, %struct.stats_* @lwip_stats, i64 0, i32 8, i32 3), align 2, !dbg !674, !tbaa !577
  %171 = add i16 %170, 1, !dbg !674
  store i16 %171, i16* getelementptr inbounds (%struct.stats_, %struct.stats_* @lwip_stats, i64 0, i32 8, i32 3), align 2, !dbg !674, !tbaa !577
  br label %434, !dbg !675

; <label>:172:                                    ; preds = %164, %150
  %173 = icmp eq %struct.netif* %154, null, !dbg !676
  br i1 %173, label %174, label %176, !dbg !678

; <label>:174:                                    ; preds = %172
  %175 = tail call zeroext i8 @pbuf_free(%struct.pbuf* %0) #8, !dbg !679
  br label %434, !dbg !681

; <label>:176:                                    ; preds = %172
  store %struct.netif* %154, %struct.netif** getelementptr inbounds (%struct.ip_globals, %struct.ip_globals* @ip_data, i64 0, i32 0), align 8, !dbg !682, !tbaa !631
  %177 = getelementptr inbounds %struct.ip6_hdr, %struct.ip6_hdr* %7, i64 0, i32 2, !dbg !683
  %178 = tail call zeroext i8 @pbuf_remove_header(%struct.pbuf* %0, i64 40) #8, !dbg !687
  %179 = load i8, i8* %177, align 1, !dbg !688, !tbaa !355
  br label %180, !dbg !689

; <label>:180:                                    ; preds = %399, %176
  %181 = phi i8 [ %404, %399 ], [ %179, %176 ], !dbg !688
  %182 = phi i16 [ %400, %399 ], [ 40, %176 ], !dbg !690
  %183 = phi i8* [ %401, %399 ], [ %177, %176 ], !dbg !691
  %184 = phi %struct.ip6_hdr* [ %402, %399 ], [ %7, %176 ], !dbg !692
  %185 = phi %struct.pbuf* [ %403, %399 ], [ %0, %176 ]
  switch i8 %181, label %410 [
    i8 44, label %351
    i8 0, label %186
    i8 60, label %245
    i8 43, label %304
...
; <label>:186:                                    ; preds = %180
  %187 = getelementptr inbounds %struct.pbuf, %struct.pbuf* %185, i64 0, i32 1, !dbg !693
  %188 = load i8*, i8** %187, align 8, !dbg !693, !tbaa !562
  %189 = getelementptr inbounds i8, i8* %188, i64 1, !dbg !695
  %190 = load i8, i8* %189, align 1, !dbg !695, !tbaa !696
  %191 = zext i8 %190 to i16, !dbg !698
  %192 = shl nuw nsw i16 %191, 3, !dbg !699
  %193 = add nuw nsw i16 %192, 8, !dbg !699
  %194 = getelementptr inbounds %struct.pbuf, %struct.pbuf* %185, i64 0, i32 3, !dbg !700
  %195 = load i16, i16* %194, align 2, !dbg !700, !tbaa !581
  %196 = icmp ult i16 %195, 8, !dbg !702
  br i1 %196, label %200, label %197, !dbg !703

; <label>:197:                                    ; preds = %186
  %198 = zext i16 %193 to i32, !dbg !704
  %199 = icmp ugt i16 %193, %195, !dbg !705
  br i1 %199, label %200, label %206, !dbg !706

; <label>:200:                                    ; preds = %197, %186
  %201 = tail call zeroext i8 @pbuf_free(%struct.pbuf* nonnull %185) #8, !dbg !707
  %202 = load i16, i16* getelementptr inbounds (%struct.stats_, %struct.stats_* @lwip_stats, i64 0, i32 8, i32 5), align 2, !dbg !709, !tbaa !598
  %203 = add i16 %202, 1, !dbg !709
  store i16 %203, i16* getelementptr inbounds (%struct.stats_, %struct.stats_* @lwip_stats, i64 0, i32 8, i32 5), align 2, !dbg !709, !tbaa !598
  %204 = load i16, i16* getelementptr inbounds (%struct.stats_, %struct.stats_* @lwip_stats, i64 0, i32 8, i32 3), align 2, !dbg !710, !tbaa !577
  %205 = add i16 %204, 1, !dbg !710
  store i16 %205, i16* getelementptr inbounds (%struct.stats_, %struct.stats_* @lwip_stats, i64 0, i32 8, i32 3), align 2, !dbg !710, !tbaa !577
  br label %434, !dbg !711

; <label>:206:                                    ; preds = %197
  %207 = add i16 %193, %182, !dbg !712
  br label %208, !dbg !714

; <label>:208:                                    ; preds = %206, %237
  %209 = phi i32 [ 2, %206 ], [ %240, %237 ]
  %210 = sext i32 %209 to i64, !dbg !716
  %211 = getelementptr inbounds i8, i8* %188, i64 %210, !dbg !716
  %212 = load i8, i8* %211, align 1, !dbg !718, !tbaa !719
...
; <label>:213:                                    ; preds = %208
  %214 = lshr i8 %212, 6, !dbg !722
  %215 = trunc i8 %214 to i2, !dbg !724
  switch i2 %215, label %233 [
    i2 1, label %216
    i2 -2, label %220
    i2 -1, label %224
  ], !dbg !724
...
; <label>:216:                                    ; preds = %213
  %217 = tail call zeroext i8 @pbuf_free(%struct.pbuf* %185) #8, !dbg !725
  %218 = load i16, i16* getelementptr inbounds (%struct.stats_, %struct.stats_* @lwip_stats, i64 0, i32 8, i32 3), align 2, !dbg !727, !tbaa !577
  %219 = add i16 %218, 1, !dbg !727
  store i16 %219, i16* getelementptr inbounds (%struct.stats_, %struct.stats_* @lwip_stats, i64 0, i32 8, i32 3), align 2, !dbg !727, !tbaa !577
  br label %434, !dbg !728

; <label>:220:                                    ; preds = %213
  tail call void @icmp6_param_problem(%struct.pbuf* %185, i32 2, i8* %211) #8, !dbg !729
  %221 = tail call zeroext i8 @pbuf_free(%struct.pbuf* %185) #8, !dbg !730
  %222 = load i16, i16* getelementptr inbounds (%struct.stats_, %struct.stats_* @lwip_stats, i64 0, i32 8, i32 3), align 2, !dbg !731, !tbaa !577
  %223 = add i16 %222, 1, !dbg !731
  store i16 %223, i16* getelementptr inbounds (%struct.stats_, %struct.stats_* @lwip_stats, i64 0, i32 8, i32 3), align 2, !dbg !731, !tbaa !577
  br label %434, !dbg !732

; <label>:224:                                    ; preds = %213
  %225 = load i32, i32* getelementptr inbounds (%struct.ip_globals, %struct.ip_globals* @ip_data, i64 0, i32 6, i32 0, i32 0, i32 0, i64 0), align 4, !dbg !733, !tbaa !355
  %226 = and i32 %225, 255, !dbg !733
  %227 = icmp eq i32 %226, 255, !dbg !733
  br i1 %227, label %229, label %228, !dbg !735

; <label>:228:                                    ; preds = %224
  tail call void @icmp6_param_problem(%struct.pbuf* %185, i32 2, i8* %211) #8, !dbg !736
  br label %229, !dbg !738

; <label>:229:                                    ; preds = %228, %224
  %230 = tail call zeroext i8 @pbuf_free(%struct.pbuf* %185) #8, !dbg !739
  %231 = load i16, i16* getelementptr inbounds (%struct.stats_, %struct.stats_* @lwip_stats, i64 0, i32 8, i32 3), align 2, !dbg !740, !tbaa !577
  %232 = add i16 %231, 1, !dbg !740
  store i16 %232, i16* getelementptr inbounds (%struct.stats_, %struct.stats_* @lwip_stats, i64 0, i32 8, i32 3), align 2, !dbg !740, !tbaa !577
  br label %434, !dbg !741

; <label>:233:                                    ; preds = %213, %208, %208, %208
  %234 = getelementptr inbounds i8, i8* %211, i64 1, !dbg !742
  %235 = load i8, i8* %234, align 1, !dbg !742, !tbaa !743
  %236 = zext i8 %235 to i32, !dbg !742
  br label %237, !dbg !744

; <label>:237:                                    ; preds = %233, %208
  %238 = phi i32 [ -1, %208 ], [ %236, %233 ], !dbg !745
  %239 = add nsw i32 %209, 2, !dbg !744
  %240 = add nsw i32 %239, %238, !dbg !746
  %241 = icmp slt i32 %240, %198, !dbg !747
  br i1 %241, label %208, label %242, !dbg !714

; <label>:242:                                    ; preds = %237
  %243 = zext i16 %193 to i64, !dbg !748
  %244 = tail call zeroext i8 @pbuf_remove_header(%struct.pbuf* %185, i64 %243) #8, !dbg !749
  br label %399

; <label>:245:                                    ; preds = %180
  %246 = getelementptr inbounds %struct.pbuf, %struct.pbuf* %185, i64 0, i32 1, !dbg !750
  %247 = load i8*, i8** %246, align 8, !dbg !750, !tbaa !562
  %248 = getelementptr inbounds i8, i8* %247, i64 1, !dbg !752
  %249 = load i8, i8* %248, align 1, !dbg !752, !tbaa !753
  %250 = zext i8 %249 to i16, !dbg !755
  %251 = shl nuw nsw i16 %250, 3, !dbg !756
  %252 = add nuw nsw i16 %251, 8, !dbg !756
  %253 = getelementptr inbounds %struct.pbuf, %struct.pbuf* %185, i64 0, i32 3, !dbg !757
  %254 = load i16, i16* %253, align 2, !dbg !757, !tbaa !581
  %255 = icmp ult i16 %254, 8, !dbg !759
  br i1 %255, label %259, label %256, !dbg !760

; <label>:256:                                    ; preds = %245
  %257 = zext i16 %252 to i32, !dbg !761
  %258 = icmp ugt i16 %252, %254, !dbg !762
  br i1 %258, label %259, label %265, !dbg !763

; <label>:259:                                    ; preds = %256, %245
  %260 = tail call zeroext i8 @pbuf_free(%struct.pbuf* nonnull %185) #8, !dbg !764
  %261 = load i16, i16* getelementptr inbounds (%struct.stats_, %struct.stats_* @lwip_stats, i64 0, i32 8, i32 5), align 2, !dbg !766, !tbaa !598
  %262 = add i16 %261, 1, !dbg !766
  store i16 %262, i16* getelementptr inbounds (%struct.stats_, %struct.stats_* @lwip_stats, i64 0, i32 8, i32 5), align 2, !dbg !766, !tbaa !598
  %263 = load i16, i16* getelementptr inbounds (%struct.stats_, %struct.stats_* @lwip_stats, i64 0, i32 8, i32 3), align 2, !dbg !767, !tbaa !577
  %264 = add i16 %263, 1, !dbg !767
  store i16 %264, i16* getelementptr inbounds (%struct.stats_, %struct.stats_* @lwip_stats, i64 0, i32 8, i32 3), align 2, !dbg !767, !tbaa !577
  br label %434, !dbg !768

; <label>:265:                                    ; preds = %256
  %266 = add i16 %252, %182, !dbg !769
  br label %267, !dbg !771

; <label>:267:                                    ; preds = %265, %296
  %268 = phi i32 [ 2, %265 ], [ %299, %296 ]
  %269 = sext i32 %268 to i64, !dbg !773
  %270 = getelementptr inbounds i8, i8* %247, i64 %269, !dbg !773
  %271 = load i8, i8* %270, align 1, !dbg !775, !tbaa !719
...
; <label>:272:                                    ; preds = %267
  %273 = lshr i8 %271, 6, !dbg !777
  %274 = trunc i8 %273 to i2, !dbg !779
  switch i2 %274, label %292 [
    i2 1, label %275
    i2 -2, label %279
    i2 -1, label %283
  ], !dbg !779
...
; <label>:275:                                    ; preds = %272
  %276 = tail call zeroext i8 @pbuf_free(%struct.pbuf* %185) #8, !dbg !780
  %277 = load i16, i16* getelementptr inbounds (%struct.stats_, %struct.stats_* @lwip_stats, i64 0, i32 8, i32 3), align 2, !dbg !782, !tbaa !577
  %278 = add i16 %277, 1, !dbg !782
  store i16 %278, i16* getelementptr inbounds (%struct.stats_, %struct.stats_* @lwip_stats, i64 0, i32 8, i32 3), align 2, !dbg !782, !tbaa !577
  br label %434, !dbg !783

; <label>:279:                                    ; preds = %272
  tail call void @icmp6_param_problem(%struct.pbuf* %185, i32 2, i8* %270) #8, !dbg !784
  %280 = tail call zeroext i8 @pbuf_free(%struct.pbuf* %185) #8, !dbg !785
  %281 = load i16, i16* getelementptr inbounds (%struct.stats_, %struct.stats_* @lwip_stats, i64 0, i32 8, i32 3), align 2, !dbg !786, !tbaa !577
  %282 = add i16 %281, 1, !dbg !786
  store i16 %282, i16* getelementptr inbounds (%struct.stats_, %struct.stats_* @lwip_stats, i64 0, i32 8, i32 3), align 2, !dbg !786, !tbaa !577
  br label %434, !dbg !787

; <label>:283:                                    ; preds = %272
  %284 = load i32, i32* getelementptr inbounds (%struct.ip_globals, %struct.ip_globals* @ip_data, i64 0, i32 6, i32 0, i32 0, i32 0, i64 0), align 4, !dbg !788, !tbaa !355
  %285 = and i32 %284, 255, !dbg !788
  %286 = icmp eq i32 %285, 255, !dbg !788
  br i1 %286, label %288, label %287, !dbg !790

; <label>:287:                                    ; preds = %283
  tail call void @icmp6_param_problem(%struct.pbuf* %185, i32 2, i8* %270) #8, !dbg !791
  br label %288, !dbg !793

; <label>:288:                                    ; preds = %287, %283
  %289 = tail call zeroext i8 @pbuf_free(%struct.pbuf* %185) #8, !dbg !794
  %290 = load i16, i16* getelementptr inbounds (%struct.stats_, %struct.stats_* @lwip_stats, i64 0, i32 8, i32 3), align 2, !dbg !795, !tbaa !577
  %291 = add i16 %290, 1, !dbg !795
  store i16 %291, i16* getelementptr inbounds (%struct.stats_, %struct.stats_* @lwip_stats, i64 0, i32 8, i32 3), align 2, !dbg !795, !tbaa !577
  br label %434, !dbg !796

; <label>:292:                                    ; preds = %272, %267, %267, %267, %267
  %293 = getelementptr inbounds i8, i8* %270, i64 1, !dbg !797
  %294 = load i8, i8* %293, align 1, !dbg !797, !tbaa !743
  %295 = zext i8 %294 to i32, !dbg !797
  br label %296, !dbg !798

; <label>:296:                                    ; preds = %292, %267
  %297 = phi i32 [ -1, %267 ], [ %295, %292 ], !dbg !799
  %298 = add nsw i32 %268, 2, !dbg !798
  %299 = add nsw i32 %298, %297, !dbg !800
  %300 = icmp slt i32 %299, %257, !dbg !801
  br i1 %300, label %267, label %301, !dbg !771

; <label>:301:                                    ; preds = %296
  %302 = zext i16 %252 to i64, !dbg !802
  %303 = tail call zeroext i8 @pbuf_remove_header(%struct.pbuf* %185, i64 %302) #8, !dbg !803
  br label %399

; <label>:304:                                    ; preds = %180
  %305 = getelementptr inbounds %struct.pbuf, %struct.pbuf* %185, i64 0, i32 1, !dbg !804
  %306 = bitcast i8** %305 to %struct.ip6_rout_hdr**, !dbg !804
  %307 = load %struct.ip6_rout_hdr*, %struct.ip6_rout_hdr** %306, align 8, !dbg !804, !tbaa !562
  %308 = getelementptr inbounds %struct.ip6_rout_hdr, %struct.ip6_rout_hdr* %307, i64 0, i32 0, !dbg !806
  %309 = getelementptr inbounds %struct.ip6_rout_hdr, %struct.ip6_rout_hdr* %307, i64 0, i32 1, !dbg !807
  %310 = load i8, i8* %309, align 1, !dbg !807, !tbaa !808
  %311 = zext i8 %310 to i16, !dbg !810
  %312 = shl nuw nsw i16 %311, 3, !dbg !810
  %313 = add nuw nsw i16 %312, 8, !dbg !810
  %314 = getelementptr inbounds %struct.pbuf, %struct.pbuf* %185, i64 0, i32 3, !dbg !811
  %315 = load i16, i16* %314, align 2, !dbg !811, !tbaa !581
  %316 = icmp ult i16 %315, 8, !dbg !813
  %317 = icmp ugt i16 %313, %315, !dbg !814
  %318 = or i1 %316, %317, !dbg !815
  br i1 %318, label %319, label %325, !dbg !815

; <label>:319:                                    ; preds = %304
  %320 = tail call zeroext i8 @pbuf_free(%struct.pbuf* nonnull %185) #8, !dbg !816
  %321 = load i16, i16* getelementptr inbounds (%struct.stats_, %struct.stats_* @lwip_stats, i64 0, i32 8, i32 5), align 2, !dbg !818, !tbaa !598
  %322 = add i16 %321, 1, !dbg !818
  store i16 %322, i16* getelementptr inbounds (%struct.stats_, %struct.stats_* @lwip_stats, i64 0, i32 8, i32 5), align 2, !dbg !818, !tbaa !598
  %323 = load i16, i16* getelementptr inbounds (%struct.stats_, %struct.stats_* @lwip_stats, i64 0, i32 8, i32 3), align 2, !dbg !819, !tbaa !577
  %324 = add i16 %323, 1, !dbg !819
  store i16 %324, i16* getelementptr inbounds (%struct.stats_, %struct.stats_* @lwip_stats, i64 0, i32 8, i32 3), align 2, !dbg !819, !tbaa !577
  br label %434, !dbg !820

; <label>:325:                                    ; preds = %304
  %326 = add i16 %313, %182, !dbg !821
  %327 = getelementptr inbounds %struct.ip6_rout_hdr, %struct.ip6_rout_hdr* %307, i64 0, i32 3, !dbg !822
  %328 = load i8, i8* %327, align 1, !dbg !822, !tbaa !824
  %329 = icmp eq i8 %328, 0, !dbg !822
  br i1 %329, label %348, label %330, !dbg !825

; <label>:330:                                    ; preds = %325
  %331 = and i8 %310, 1, !dbg !826
  %332 = icmp eq i8 %331, 0, !dbg !826
  br i1 %332, label %338, label %333, !dbg !829

; <label>:333:                                    ; preds = %330
  %334 = getelementptr inbounds %struct.ip6_rout_hdr, %struct.ip6_rout_hdr* %307, i64 0, i32 1, !dbg !807
  tail call void @icmp6_param_problem(%struct.pbuf* nonnull %185, i32 0, i8* nonnull %334) #8, !dbg !830
  %335 = tail call zeroext i8 @pbuf_free(%struct.pbuf* nonnull %185) #8, !dbg !832
  %336 = load i16, i16* getelementptr inbounds (%struct.stats_, %struct.stats_* @lwip_stats, i64 0, i32 8, i32 3), align 2, !dbg !833, !tbaa !577
  %337 = add i16 %336, 1, !dbg !833
  store i16 %337, i16* getelementptr inbounds (%struct.stats_, %struct.stats_* @lwip_stats, i64 0, i32 8, i32 3), align 2, !dbg !833, !tbaa !577
  br label %434, !dbg !834

; <label>:338:                                    ; preds = %330
  %339 = getelementptr inbounds %struct.ip6_rout_hdr, %struct.ip6_rout_hdr* %307, i64 0, i32 2, !dbg !835
  %340 = load i8, i8* %339, align 1, !dbg !835, !tbaa !836
  %341 = and i8 %340, -2, !dbg !837
  %342 = icmp eq i8 %341, 2, !dbg !837
  br i1 %342, label %348, label %343, !dbg !837

; <label>:343:                                    ; preds = %338
  %344 = getelementptr inbounds %struct.ip6_rout_hdr, %struct.ip6_rout_hdr* %307, i64 0, i32 2, !dbg !835
  tail call void @icmp6_param_problem(%struct.pbuf* nonnull %185, i32 0, i8* nonnull %344) #8, !dbg !838
  %345 = tail call zeroext i8 @pbuf_free(%struct.pbuf* nonnull %185) #8, !dbg !840
  %346 = load i16, i16* getelementptr inbounds (%struct.stats_, %struct.stats_* @lwip_stats, i64 0, i32 8, i32 3), align 2, !dbg !841, !tbaa !577
  %347 = add i16 %346, 1, !dbg !841
  store i16 %347, i16* getelementptr inbounds (%struct.stats_, %struct.stats_* @lwip_stats, i64 0, i32 8, i32 3), align 2, !dbg !841, !tbaa !577
  br label %434, !dbg !842

; <label>:348:                                    ; preds = %338, %325
  %349 = zext i16 %313 to i64, !dbg !843
  %350 = tail call zeroext i8 @pbuf_remove_header(%struct.pbuf* nonnull %185, i64 %349) #8, !dbg !844
  br label %399

; <label>:351:                                    ; preds = %180
  %352 = getelementptr inbounds %struct.pbuf, %struct.pbuf* %185, i64 0, i32 1, !dbg !845
  %353 = bitcast i8** %352 to %struct.ip6_frag_hdr**, !dbg !845
  %354 = load %struct.ip6_frag_hdr*, %struct.ip6_frag_hdr** %353, align 8, !dbg !845, !tbaa !562
  %355 = getelementptr inbounds %struct.ip6_frag_hdr, %struct.ip6_frag_hdr* %354, i64 0, i32 0, !dbg !847
  %356 = getelementptr inbounds %struct.pbuf, %struct.pbuf* %185, i64 0, i32 3, !dbg !848
  %357 = load i16, i16* %356, align 2, !dbg !848, !tbaa !581
  %358 = icmp ult i16 %357, 8, !dbg !850
  br i1 %358, label %359, label %365, !dbg !851

; <label>:359:                                    ; preds = %351
  %360 = tail call zeroext i8 @pbuf_free(%struct.pbuf* nonnull %185) #8, !dbg !852
  %361 = load i16, i16* getelementptr inbounds (%struct.stats_, %struct.stats_* @lwip_stats, i64 0, i32 10, i32 5), align 2, !dbg !854, !tbaa !855
  %362 = add i16 %361, 1, !dbg !854
  store i16 %362, i16* getelementptr inbounds (%struct.stats_, %struct.stats_* @lwip_stats, i64 0, i32 10, i32 5), align 2, !dbg !854, !tbaa !855
  %363 = load i16, i16* getelementptr inbounds (%struct.stats_, %struct.stats_* @lwip_stats, i64 0, i32 10, i32 3), align 2, !dbg !856, !tbaa !857
  %364 = add i16 %363, 1, !dbg !856
  store i16 %364, i16* getelementptr inbounds (%struct.stats_, %struct.stats_* @lwip_stats, i64 0, i32 10, i32 3), align 2, !dbg !856, !tbaa !857
  br label %434, !dbg !858

; <label>:365:                                    ; preds = %351
  %366 = add i16 %182, 8, !dbg !859
  %367 = getelementptr inbounds %struct.ip6_frag_hdr, %struct.ip6_frag_hdr* %354, i64 0, i32 2, !dbg !860
  %368 = load i16, i16* %367, align 1, !dbg !860, !tbaa !862
  %369 = tail call zeroext i16 @lwip_htons(i16 zeroext %368) #8, !dbg !860
  %370 = and i16 %369, 1, !dbg !860
  %371 = icmp eq i16 %370, 0, !dbg !860
  br i1 %371, label %384, label %372, !dbg !864

; <label>:372:                                    ; preds = %365
  %373 = getelementptr inbounds %struct.ip6_hdr, %struct.ip6_hdr* %184, i64 0, i32 1, !dbg !865
  %374 = load i16, i16* %373, align 1, !dbg !865, !tbaa !586
  %375 = tail call zeroext i16 @lwip_htons(i16 zeroext %374) #8, !dbg !865
  %376 = and i16 %375, 7, !dbg !866
  %377 = icmp eq i16 %376, 0, !dbg !866
  br i1 %377, label %384, label %378, !dbg !867

; <label>:378:                                    ; preds = %372
  %379 = getelementptr inbounds %struct.ip6_hdr, %struct.ip6_hdr* %184, i64 0, i32 1, !dbg !865
  %380 = bitcast i16* %379 to i8*, !dbg !868
  tail call void @icmp6_param_problem(%struct.pbuf* nonnull %185, i32 0, i8* nonnull %380) #8, !dbg !870
  %381 = tail call zeroext i8 @pbuf_free(%struct.pbuf* nonnull %185) #8, !dbg !871
  %382 = load i16, i16* getelementptr inbounds (%struct.stats_, %struct.stats_* @lwip_stats, i64 0, i32 8, i32 3), align 2, !dbg !872, !tbaa !577
  %383 = add i16 %382, 1, !dbg !872
  store i16 %383, i16* getelementptr inbounds (%struct.stats_, %struct.stats_* @lwip_stats, i64 0, i32 8, i32 3), align 2, !dbg !872, !tbaa !577
  br label %434, !dbg !873

; <label>:384:                                    ; preds = %372, %365
  %385 = load i16, i16* %367, align 1, !dbg !874, !tbaa !862
  %386 = and i16 %385, -1537, !dbg !876
  %387 = icmp eq i16 %386, 0, !dbg !877
  br i1 %387, label %388, label %390, !dbg !878

; <label>:388:                                    ; preds = %384
  %389 = tail call zeroext i8 @pbuf_remove_header(%struct.pbuf* nonnull %185, i64 8) #8, !dbg !879
  br label %399, !dbg !881

; <label>:390:                                    ; preds = %384
  store i16 %366, i16* getelementptr inbounds (%struct.ip_globals, %struct.ip_globals* @ip_data, i64 0, i32 4), align 8, !dbg !882, !tbaa !884
  %391 = tail call %struct.pbuf* @ip6_reass(%struct.pbuf* nonnull %185) #8, !dbg !885
  %392 = icmp eq %struct.pbuf* %391, null, !dbg !886
  br i1 %392, label %434, label %393, !dbg !888

; <label>:393:                                    ; preds = %390
  %394 = getelementptr inbounds %struct.pbuf, %struct.pbuf* %391, i64 0, i32 1, !dbg !889
  %395 = bitcast i8** %394 to %struct.ip6_hdr**, !dbg !889
  %396 = load %struct.ip6_hdr*, %struct.ip6_hdr** %395, align 8, !dbg !889, !tbaa !562
  %397 = getelementptr inbounds %struct.ip6_hdr, %struct.ip6_hdr* %396, i64 0, i32 2, !dbg !890
  %398 = tail call zeroext i8 @pbuf_remove_header(%struct.pbuf* nonnull %391, i64 40) #8, !dbg !891
  br label %399

; <label>:399:                                    ; preds = %393, %388, %348, %301, %242
  %400 = phi i16 [ %326, %348 ], [ %266, %301 ], [ %207, %242 ], [ %366, %388 ], [ 40, %393 ], !dbg !690
  %401 = phi i8* [ %308, %348 ], [ %247, %301 ], [ %188, %242 ], [ %355, %388 ], [ %397, %393 ], !dbg !892
  %402 = phi %struct.ip6_hdr* [ %184, %348 ], [ %184, %301 ], [ %184, %242 ], [ %184, %388 ], [ %396, %393 ], !dbg !692
  %403 = phi %struct.pbuf* [ %185, %348 ], [ %185, %301 ], [ %185, %242 ], [ %185, %388 ], [ %391, %393 ]
  %404 = load i8, i8* %401, align 1, !dbg !893, !tbaa !355
  %405 = icmp eq i8 %404, 0, !dbg !895
  br i1 %405, label %406, label %180, !dbg !896, !llvm.loop !897

; <label>:406:                                    ; preds = %399
  tail call void @icmp6_param_problem(%struct.pbuf* %403, i32 1, i8* nonnull %401) #8, !dbg !899
  %407 = tail call zeroext i8 @pbuf_free(%struct.pbuf* %403) #8, !dbg !901
  %408 = load i16, i16* getelementptr inbounds (%struct.stats_, %struct.stats_* @lwip_stats, i64 0, i32 8, i32 3), align 2, !dbg !902, !tbaa !577
  %409 = add i16 %408, 1, !dbg !902
  store i16 %409, i16* getelementptr inbounds (%struct.stats_, %struct.stats_* @lwip_stats, i64 0, i32 8, i32 3), align 2, !dbg !902, !tbaa !577
  br label %434, !dbg !903

; <label>:410:                                    ; preds = %180
  store i16 %182, i16* getelementptr inbounds (%struct.ip_globals, %struct.ip_globals* @ip_data, i64 0, i32 4), align 8, !dbg !904, !tbaa !884
  %411 = load i8, i8* %183, align 1, !dbg !905, !tbaa !355
...
; <label>:412:                                    ; preds = %410
  %413 = tail call zeroext i8 @pbuf_free(%struct.pbuf* %185) #8, !dbg !908
  br label %434, !dbg !910

; <label>:414:                                    ; preds = %410
  tail call void @udp_input(%struct.pbuf* %185, %struct.netif* %1) #8, !dbg !911
  br label %434, !dbg !912

; <label>:415:                                    ; preds = %410
  tail call void @tcp_input(%struct.pbuf* %185, %struct.netif* %1) #8, !dbg !913
  br label %434, !dbg !914

; <label>:416:                                    ; preds = %410
  tail call void @icmp6_input(%struct.pbuf* %185, %struct.netif* %1) #8, !dbg !915
  br label %434, !dbg !916

; <label>:417:                                    ; preds = %410
  %418 = zext i16 %182 to i64, !dbg !917
  %419 = tail call zeroext i8 @pbuf_add_header_force(%struct.pbuf* %185, i64 %418) #8, !dbg !919
  %420 = load i32, i32* getelementptr inbounds (%struct.ip_globals, %struct.ip_globals* @ip_data, i64 0, i32 6, i32 0, i32 0, i32 0, i64 0), align 4, !dbg !920, !tbaa !355
  %421 = and i32 %420, 255, !dbg !920
  %422 = icmp eq i32 %421, 255, !dbg !920
  br i1 %422, label %428, label %423, !dbg !922

; <label>:423:                                    ; preds = %417
  %424 = getelementptr inbounds %struct.ip6_hdr, %struct.ip6_hdr* %184, i64 0, i32 2, !dbg !923
  %425 = load i8, i8* %424, align 1, !dbg !923, !tbaa !924
  %426 = icmp eq i8 %425, 58, !dbg !925
  br i1 %426, label %428, label %427, !dbg !926

; <label>:427:                                    ; preds = %423
  tail call void @icmp6_param_problem(%struct.pbuf* %185, i32 1, i8* nonnull %183) #8, !dbg !927
  br label %428, !dbg !929

; <label>:428:                                    ; preds = %423, %427, %417
  %429 = load i16, i16* getelementptr inbounds (%struct.stats_, %struct.stats_* @lwip_stats, i64 0, i32 8, i32 8), align 2, !dbg !930, !tbaa !931
  %430 = add i16 %429, 1, !dbg !930
  store i16 %430, i16* getelementptr inbounds (%struct.stats_, %struct.stats_* @lwip_stats, i64 0, i32 8, i32 8), align 2, !dbg !930, !tbaa !931
  %431 = load i16, i16* getelementptr inbounds (%struct.stats_, %struct.stats_* @lwip_stats, i64 0, i32 8, i32 3), align 2, !dbg !932, !tbaa !577
  %432 = add i16 %431, 1, !dbg !932
  store i16 %432, i16* getelementptr inbounds (%struct.stats_, %struct.stats_* @lwip_stats, i64 0, i32 8, i32 3), align 2, !dbg !932, !tbaa !577
  %433 = tail call zeroext i8 @pbuf_free(%struct.pbuf* %185) #8, !dbg !933
  br label %434, !dbg !934

; <label>:434:                                    ; preds = %390, %378, %359, %343, %333, %319, %275, %279, %288, %259, %216, %220, %229, %200, %412, %414, %415, %416, %428, %406, %174, %168
  store <2 x %struct.netif*> zeroinitializer, <2 x %struct.netif*>* bitcast (%struct.ip_globals* @ip_data to <2 x %struct.netif*>*), align 8, !dbg !935, !tbaa !273
  store %struct.ip6_hdr* null, %struct.ip6_hdr** getelementptr inbounds (%struct.ip_globals, %struct.ip_globals* @ip_data, i64 0, i32 3), align 8, !dbg !936, !tbaa !629
  store i16 0, i16* getelementptr inbounds (%struct.ip_globals, %struct.ip_globals* @ip_data, i64 0, i32 4), align 8, !dbg !937, !tbaa !884
  store <4 x i32> zeroinitializer, <4 x i32>* bitcast (i32* getelementptr inbounds (%struct.ip_globals, %struct.ip_globals* @ip_data, i64 0, i32 5, i32 0, i32 0, i32 0, i64 0) to <4 x i32>*), align 4, !dbg !938, !tbaa !355
  store i8 0, i8* getelementptr inbounds (%struct.ip_globals, %struct.ip_globals* @ip_data, i64 0, i32 5, i32 0, i32 0, i32 1), align 4, !dbg !938, !tbaa !355
  store <4 x i32> zeroinitializer, <4 x i32>* bitcast (i32* getelementptr inbounds (%struct.ip_globals, %struct.ip_globals* @ip_data, i64 0, i32 6, i32 0, i32 0, i32 0, i64 0) to <4 x i32>*), align 4, !dbg !940, !tbaa !355
  store i8 0, i8* getelementptr inbounds (%struct.ip_globals, %struct.ip_globals* @ip_data, i64 0, i32 6, i32 0, i32 0, i32 1), align 4, !dbg !940, !tbaa !355
  br label %435, !dbg !942

; <label>:435:                                    ; preds = %434, %73, %33, %13
  ret i8 0, !dbg !943
}
...
define internal fastcc i32 @ip6_input_accept(%struct.netif* nocapture readonly) unnamed_addr #4 !dbg !944 {
  %2 = getelementptr inbounds %struct.netif, %struct.netif* %0, i64 0, i32 21, !dbg !953
  %3 = load i8, i8* %2, align 1, !dbg !953, !tbaa !289
  %4 = and i8 %3, 1, !dbg !953
  %5 = icmp eq i8 %4, 0, !dbg !953
  br i1 %5, label %41, label %6, !dbg !954
...
; <label>:6:                                      ; preds = %1
  ...
  %12 = getelementptr inbounds %struct.netif, %struct.netif* %0, i64 0, i32 5, i64 0, !dbg !956
  %13 = load i8, i8* %12, align 1, !dbg !956, !tbaa !355
  %14 = and i8 %13, 16, !dbg !956
  %15 = icmp eq i8 %14, 0, !dbg !956
  br i1 %15, label %36, label %16, !dbg !961

; <label>:16:                                     ; preds = %6
  %17 = getelementptr inbounds %struct.netif, %struct.netif* %0, i64 0, i32 4, i64 0, i32 0, i32 0, i32 0, i64 0, !dbg !962
  %18 = load i32, i32* %17, align 8, !dbg !962, !tbaa !355
  %19 = icmp eq i32 %7, %18, !dbg !962
  br i1 %19, label %20, label %36, !dbg !962

; <label>:20:                                     ; preds = %16
  %21 = getelementptr inbounds %struct.netif, %struct.netif* %0, i64 0, i32 4, i64 0, i32 0, i32 0, i32 0, i64 1, !dbg !962
  %22 = load i32, i32* %21, align 4, !dbg !962, !tbaa !355
  %23 = icmp eq i32 %8, %22, !dbg !962
  br i1 %23, label %24, label %36, !dbg !962

; <label>:24:                                     ; preds = %20
  %25 = getelementptr inbounds %struct.netif, %struct.netif* %0, i64 0, i32 4, i64 0, i32 0, i32 0, i32 0, i64 2, !dbg !962
  %26 = load i32, i32* %25, align 8, !dbg !962, !tbaa !355
  %27 = icmp eq i32 %9, %26, !dbg !962
  br i1 %27, label %28, label %36, !dbg !962

; <label>:28:                                     ; preds = %24
  %29 = getelementptr inbounds %struct.netif, %struct.netif* %0, i64 0, i32 4, i64 0, i32 0, i32 0, i32 0, i64 3, !dbg !962
  %30 = load i32, i32* %29, align 4, !dbg !962, !tbaa !355
  %31 = icmp eq i32 %10, %30, !dbg !962
  br i1 %31, label %32, label %36, !dbg !962

; <label>:32:                                     ; preds = %28
  %33 = getelementptr inbounds %struct.netif, %struct.netif* %0, i64 0, i32 4, i64 0, i32 0, i32 0, i32 1, !dbg !962
  %34 = load i8, i8* %33, align 8, !dbg !962, !tbaa !355
  %35 = icmp eq i8 %11, %34, !dbg !962
  br i1 %35, label %41, label %36, !dbg !963

; <label>:36:                                     ; preds = %6, %16, %20, %24, %28, %32
  %37 = getelementptr inbounds %struct.netif, %struct.netif* %0, i64 0, i32 5, i64 1, !dbg !956
  %38 = load i8, i8* %37, align 1, !dbg !956, !tbaa !355
  %39 = and i8 %38, 16, !dbg !956
  %40 = icmp eq i8 %39, 0, !dbg !956
  br i1 %40, label %63, label %43, !dbg !961

; <label>:41:                                     ; preds = %32, %59, %84, %88, %1
  %42 = phi i32 [ 0, %1 ], [ 1, %32 ], [ 1, %59 ], [ 1, %84 ], [ 0, %88 ], !dbg !964
  ret i32 %42, !dbg !966

; <label>:43:                                     ; preds = %36
  %44 = getelementptr inbounds %struct.netif, %struct.netif* %0, i64 0, i32 4, i64 1, i32 0, i32 0, i32 0, i64 0, !dbg !962
  %45 = load i32, i32* %44, align 8, !dbg !962, !tbaa !355
  %46 = icmp eq i32 %7, %45, !dbg !962
  br i1 %46, label %47, label %63, !dbg !962

; <label>:47:                                     ; preds = %43
  %48 = getelementptr inbounds %struct.netif, %struct.netif* %0, i64 0, i32 4, i64 1, i32 0, i32 0, i32 0, i64 1, !dbg !962
  %49 = load i32, i32* %48, align 4, !dbg !962, !tbaa !355
  %50 = icmp eq i32 %8, %49, !dbg !962
  br i1 %50, label %51, label %63, !dbg !962

; <label>:51:                                     ; preds = %47
  %52 = getelementptr inbounds %struct.netif, %struct.netif* %0, i64 0, i32 4, i64 1, i32 0, i32 0, i32 0, i64 2, !dbg !962
  %53 = load i32, i32* %52, align 8, !dbg !962, !tbaa !355
  %54 = icmp eq i32 %9, %53, !dbg !962
  br i1 %54, label %55, label %63, !dbg !962

; <label>:55:                                     ; preds = %51
  %56 = getelementptr inbounds %struct.netif, %struct.netif* %0, i64 0, i32 4, i64 1, i32 0, i32 0, i32 0, i64 3, !dbg !962
  %57 = load i32, i32* %56, align 4, !dbg !962, !tbaa !355
  %58 = icmp eq i32 %10, %57, !dbg !962
  br i1 %58, label %59, label %63, !dbg !962

; <label>:59:                                     ; preds = %55
  %60 = getelementptr inbounds %struct.netif, %struct.netif* %0, i64 0, i32 4, i64 1, i32 0, i32 0, i32 1, !dbg !962
  %61 = load i8, i8* %60, align 8, !dbg !962, !tbaa !355
  %62 = icmp eq i8 %11, %61, !dbg !962
  br i1 %62, label %41, label %63, !dbg !963

; <label>:63:                                     ; preds = %59, %55, %51, %47, %43, %36
  %64 = getelementptr inbounds %struct.netif, %struct.netif* %0, i64 0, i32 5, i64 2, !dbg !956
  %65 = load i8, i8* %64, align 1, !dbg !956, !tbaa !355
  %66 = and i8 %65, 16, !dbg !956
  %67 = icmp eq i8 %66, 0, !dbg !956
  br i1 %67, label %88, label %68, !dbg !961

; <label>:68:                                     ; preds = %63
  %69 = getelementptr inbounds %struct.netif, %struct.netif* %0, i64 0, i32 4, i64 2, i32 0, i32 0, i32 0, i64 0, !dbg !962
  %70 = load i32, i32* %69, align 8, !dbg !962, !tbaa !355
  %71 = icmp eq i32 %7, %70, !dbg !962
  br i1 %71, label %72, label %88, !dbg !962

; <label>:72:                                     ; preds = %68
  %73 = getelementptr inbounds %struct.netif, %struct.netif* %0, i64 0, i32 4, i64 2, i32 0, i32 0, i32 0, i64 1, !dbg !962
  %74 = load i32, i32* %73, align 4, !dbg !962, !tbaa !355
  %75 = icmp eq i32 %8, %74, !dbg !962
  br i1 %75, label %76, label %88, !dbg !962

; <label>:76:                                     ; preds = %72
  %77 = getelementptr inbounds %struct.netif, %struct.netif* %0, i64 0, i32 4, i64 2, i32 0, i32 0, i32 0, i64 2, !dbg !962
  %78 = load i32, i32* %77, align 8, !dbg !962, !tbaa !355
  %79 = icmp eq i32 %9, %78, !dbg !962
  br i1 %79, label %80, label %88, !dbg !962

; <label>:80:                                     ; preds = %76
  %81 = getelementptr inbounds %struct.netif, %struct.netif* %0, i64 0, i32 4, i64 2, i32 0, i32 0, i32 0, i64 3, !dbg !962
  %82 = load i32, i32* %81, align 4, !dbg !962, !tbaa !355
  %83 = icmp eq i32 %10, %82, !dbg !962
  br i1 %83, label %84, label %88, !dbg !962

; <label>:84:                                     ; preds = %80
  %85 = getelementptr inbounds %struct.netif, %struct.netif* %0, i64 0, i32 4, i64 2, i32 0, i32 0, i32 1, !dbg !962
  %86 = load i8, i8* %85, align 8, !dbg !962, !tbaa !355
  %87 = icmp eq i8 %11, %86, !dbg !962
  br i1 %87, label %41, label %88, !dbg !963
...
; Function Attrs: noredzone nounwind
define dso_local signext i8 @ip6_output_if(%struct.pbuf*, %struct.ip6_addr* readonly, %struct.ip6_addr*, i8 zeroext, i8 zeroext, i8 zeroext, %struct.netif*) local_unnamed_addr #0 !dbg !967 {
  %8 = icmp ne %struct.ip6_addr* %2, null, !dbg !987
  %9 = icmp ne %struct.ip6_addr* %1, null, !dbg !989
  %10 = and i1 %9, %8, !dbg !992
  br i1 %10, label %11, label %50, !dbg !992

; <label>:11:                                     ; preds = %7
  %12 = getelementptr inbounds %struct.ip6_addr, %struct.ip6_addr* %1, i64 0, i32 0, i64 0, !dbg !993
  %13 = load i32, i32* %12, align 4, !dbg !993, !tbaa !318
  %14 = icmp eq i32 %13, 0, !dbg !993
  br i1 %14, label %15, label %50, !dbg !993

; <label>:15:                                     ; preds = %11
  %16 = getelementptr inbounds %struct.ip6_addr, %struct.ip6_addr* %1, i64 0, i32 0, i64 1, !dbg !993
  %17 = load i32, i32* %16, align 4, !dbg !993, !tbaa !318
  %18 = icmp eq i32 %17, 0, !dbg !993
  br i1 %18, label %19, label %50, !dbg !993

; <label>:19:                                     ; preds = %15
  %20 = getelementptr inbounds %struct.ip6_addr, %struct.ip6_addr* %1, i64 0, i32 0, i64 2, !dbg !993
  %21 = load i32, i32* %20, align 4, !dbg !993, !tbaa !318
  %22 = icmp eq i32 %21, 0, !dbg !993
  br i1 %22, label %23, label %50, !dbg !993

; <label>:23:                                     ; preds = %19
  %24 = getelementptr inbounds %struct.ip6_addr, %struct.ip6_addr* %1, i64 0, i32 0, i64 3, !dbg !993
  %25 = load i32, i32* %24, align 4, !dbg !993, !tbaa !318
  %26 = icmp eq i32 %25, 0, !dbg !993
  br i1 %26, label %27, label %50, !dbg !994

; <label>:27:                                     ; preds = %23
  %28 = tail call %struct.ip_addr* @ip6_select_source_address(%struct.netif* %6, %struct.ip6_addr* nonnull %2) #9, !dbg !995
  %29 = getelementptr inbounds %struct.ip_addr, %struct.ip_addr* %28, i64 0, i32 0, i32 0, !dbg !995
  %30 = icmp eq %struct.ip_addr* %28, null, !dbg !997
  br i1 %30, label %47, label %31, !dbg !999

; <label>:31:                                     ; preds = %27
  %32 = getelementptr inbounds %struct.ip_addr, %struct.ip_addr* %28, i64 0, i32 0, i32 0, i32 0, i64 0, !dbg !1000
  %33 = load i32, i32* %32, align 4, !dbg !1000, !tbaa !318
  %34 = icmp eq i32 %33, 0, !dbg !1000
  br i1 %34, label %35, label %50, !dbg !1000

; <label>:35:                                     ; preds = %31
  %36 = getelementptr inbounds %struct.ip_addr, %struct.ip_addr* %28, i64 0, i32 0, i32 0, i32 0, i64 1, !dbg !1000
  %37 = load i32, i32* %36, align 4, !dbg !1000, !tbaa !318
  %38 = icmp eq i32 %37, 0, !dbg !1000
  br i1 %38, label %39, label %50, !dbg !1000

; <label>:39:                                     ; preds = %35
  %40 = getelementptr inbounds %struct.ip_addr, %struct.ip_addr* %28, i64 0, i32 0, i32 0, i32 0, i64 2, !dbg !1000
  %41 = load i32, i32* %40, align 4, !dbg !1000, !tbaa !318
  %42 = icmp eq i32 %41, 0, !dbg !1000
  br i1 %42, label %43, label %50, !dbg !1000

; <label>:43:                                     ; preds = %39
  %44 = getelementptr inbounds %struct.ip_addr, %struct.ip_addr* %28, i64 0, i32 0, i32 0, i32 0, i64 3, !dbg !1000
  %45 = load i32, i32* %44, align 4, !dbg !1000, !tbaa !318
  %46 = icmp eq i32 %45, 0, !dbg !1000
  br i1 %46, label %47, label %50, !dbg !1001

; <label>:47:                                     ; preds = %43, %27
  %48 = load i16, i16* getelementptr inbounds (%struct.stats_, %struct.stats_* @lwip_stats, i64 0, i32 8, i32 7), align 2, !dbg !1002, !tbaa !1004
  %49 = add i16 %48, 1, !dbg !1002
  store i16 %49, i16* getelementptr inbounds (%struct.stats_, %struct.stats_* @lwip_stats, i64 0, i32 8, i32 7), align 2, !dbg !1002, !tbaa !1004
  br label %53, !dbg !1005

; <label>:50:                                     ; preds = %11, %15, %19, %23, %43, %39, %35, %31, %7
  %51 = phi %struct.ip6_addr* [ %29, %43 ], [ %29, %39 ], [ %29, %35 ], [ %29, %31 ], [ %1, %23 ], [ %1, %19 ], [ %1, %15 ], [ %1, %11 ], [ %1, %7 ], !dbg !1006
  %52 = tail call signext i8 @ip6_output_if_src(%struct.pbuf* %0, %struct.ip6_addr* %51, %struct.ip6_addr* %2, i8 zeroext %3, i8 zeroext %4, i8 zeroext %5, %struct.netif* %6) #9, !dbg !1007
  br label %53, !dbg !1008

; <label>:53:                                     ; preds = %50, %47
  %54 = phi i8 [ -4, %47 ], [ %52, %50 ], !dbg !1006
  ret i8 %54, !dbg !1009
}

; Function Attrs: noredzone nounwind
define dso_local signext i8 @ip6_output_if_src(%struct.pbuf*, %struct.ip6_addr* readonly, %struct.ip6_addr*, i8 zeroext, i8 zeroext, i8 zeroext, %struct.netif*) local_unnamed_addr #0 !dbg !1010 {
  %8 = alloca %struct.ip6_addr, align 16
  %9 = bitcast %struct.ip6_addr* %8 to i8*, !dbg !1028
  call void @llvm.lifetime.start.p0i8(i64 20, i8* nonnull %9) #7, !dbg !1028
  %10 = getelementptr inbounds %struct.pbuf, %struct.pbuf* %0, i64 0, i32 6, !dbg !1029
  %11 = load i8, i8* %10, align 2, !dbg !1029, !tbaa !1032
  %12 = icmp eq i8 %11, 1, !dbg !1029
  br i1 %12, label %14, label %13, !dbg !1033

; <label>:13:                                     ; preds = %7
  tail call void (i8*, ...) @uk_pr_crit(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str, i64 0, i64 0)) #9, !dbg !1034
  tail call void (i8*, ...) @uk_pr_crit(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.1, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0)) #9, !dbg !1037
  tail call void @ukplat_terminate(i32 3) #10, !dbg !1037
  unreachable, !dbg !1037

; <label>:14:                                     ; preds = %7
  %15 = icmp eq %struct.ip6_addr* %2, null, !dbg !1041
  br i1 %15, label %103, label %16, !dbg !1043

; <label>:16:                                     ; preds = %14
  %17 = getelementptr inbounds %struct.ip6_addr, %struct.ip6_addr* %2, i64 0, i32 1, !dbg !1044
  %18 = load i8, i8* %17, align 4, !dbg !1044, !tbaa !292
  %19 = icmp eq i8 %18, 0, !dbg !1044
  br i1 %19, label %20, label %49, !dbg !1044

; <label>:20:                                     ; preds = %16
  %21 = getelementptr inbounds %struct.ip6_addr, %struct.ip6_addr* %2, i64 0, i32 0, i64 0, !dbg !1044
  %22 = load i32, i32* %21, align 4, !dbg !1044, !tbaa !318
  %23 = and i32 %22, 49407, !dbg !1044
  %24 = icmp eq i32 %23, 33022, !dbg !1044
  br i1 %24, label %28, label %25, !dbg !1044

; <label>:25:                                     ; preds = %20
  %26 = trunc i32 %22 to i16, !dbg !1044
  %27 = and i16 %26, -28673, !dbg !1044
...
; <label>:28:                                     ; preds = %25, %25, %20
  %29 = getelementptr inbounds %struct.ip6_addr, %struct.ip6_addr* %8, i64 0, i32 0, i64 0, !dbg !1047
  store i32 %22, i32* %29, align 16, !dbg !1047, !tbaa !318
  %30 = getelementptr inbounds %struct.ip6_addr, %struct.ip6_addr* %2, i64 0, i32 0, i64 1, !dbg !1047
  %31 = load i32, i32* %30, align 4, !dbg !1047, !tbaa !318
  %32 = getelementptr inbounds %struct.ip6_addr, %struct.ip6_addr* %8, i64 0, i32 0, i64 1, !dbg !1047
  store i32 %31, i32* %32, align 4, !dbg !1047, !tbaa !318
  %33 = getelementptr inbounds %struct.ip6_addr, %struct.ip6_addr* %2, i64 0, i32 0, i64 2, !dbg !1047
  %34 = load i32, i32* %33, align 4, !dbg !1047, !tbaa !318
  %35 = getelementptr inbounds %struct.ip6_addr, %struct.ip6_addr* %8, i64 0, i32 0, i64 2, !dbg !1047
  store i32 %34, i32* %35, align 8, !dbg !1047, !tbaa !318
  %36 = getelementptr inbounds %struct.ip6_addr, %struct.ip6_addr* %2, i64 0, i32 0, i64 3, !dbg !1047
  %37 = load i32, i32* %36, align 4, !dbg !1047, !tbaa !318
  %38 = getelementptr inbounds %struct.ip6_addr, %struct.ip6_addr* %8, i64 0, i32 0, i64 3, !dbg !1047
  store i32 %37, i32* %38, align 4, !dbg !1047, !tbaa !318
  %39 = getelementptr inbounds %struct.ip6_addr, %struct.ip6_addr* %8, i64 0, i32 1, !dbg !1047
  store i8 0, i8* %39, align 16, !dbg !1047, !tbaa !292
  br i1 %24, label %43, label %40, !dbg !1050

; <label>:40:                                     ; preds = %28
  %41 = trunc i32 %22 to i16, !dbg !1050
  %42 = and i16 %41, -28673, !dbg !1050
...
; <label>:43:                                     ; preds = %40, %40, %28
  %44 = getelementptr inbounds %struct.netif, %struct.netif* %6, i64 0, i32 23, !dbg !1050
  %45 = load i8, i8* %44, align 8, !dbg !1050, !tbaa !296
  %46 = add i8 %45, 1, !dbg !1050
  br label %47, !dbg !1050

; <label>:47:                                     ; preds = %40, %43
  %48 = phi i8 [ %46, %43 ], [ 0, %40 ]
  store i8 %48, i8* %39, align 16, !dbg !1050, !tbaa !292
  br label %49, !dbg !1051

; <label>:49:                                     ; preds = %25, %16, %47
  %50 = phi %struct.ip6_addr* [ %2, %16 ], [ %8, %47 ], [ %2, %25 ]
  %51 = tail call zeroext i8 @pbuf_add_header(%struct.pbuf* nonnull %0, i64 40) #8, !dbg !1052
  %52 = icmp eq i8 %51, 0, !dbg !1052
  br i1 %52, label %56, label %53, !dbg !1054

; <label>:53:                                     ; preds = %49
  %54 = load i16, i16* getelementptr inbounds (%struct.stats_, %struct.stats_* @lwip_stats, i64 0, i32 8, i32 10), align 2, !dbg !1055, !tbaa !575
  %55 = add i16 %54, 1, !dbg !1055
  store i16 %55, i16* getelementptr inbounds (%struct.stats_, %struct.stats_* @lwip_stats, i64 0, i32 8, i32 10), align 2, !dbg !1055, !tbaa !575
  br label %142, !dbg !1057

; <label>:56:                                     ; preds = %49
  %57 = getelementptr inbounds %struct.pbuf, %struct.pbuf* %0, i64 0, i32 1, !dbg !1058
  %58 = bitcast i8** %57 to %struct.ip6_hdr**, !dbg !1058
  %59 = load %struct.ip6_hdr*, %struct.ip6_hdr** %58, align 8, !dbg !1058, !tbaa !562
  %60 = getelementptr inbounds %struct.pbuf, %struct.pbuf* %0, i64 0, i32 3, !dbg !1060
  %61 = load i16, i16* %60, align 2, !dbg !1060, !tbaa !581
  %62 = icmp ugt i16 %61, 39, !dbg !1060
  br i1 %62, label %64, label %63, !dbg !1063

; <label>:63:                                     ; preds = %56
  tail call void (i8*, ...) @uk_pr_crit(i8* getelementptr inbounds ([46 x i8], [46 x i8]* @.str.3, i64 0, i64 0)) #9, !dbg !1064
  tail call void (i8*, ...) @uk_pr_crit(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.1, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0)) #9, !dbg !1067
  tail call void @ukplat_terminate(i32 3) #10, !dbg !1067
  unreachable, !dbg !1067

; <label>:64:                                     ; preds = %56
  %65 = getelementptr inbounds %struct.ip6_hdr, %struct.ip6_hdr* %59, i64 0, i32 3, !dbg !1071
  store i8 %3, i8* %65, align 1, !dbg !1071, !tbaa !1072
  %66 = getelementptr inbounds %struct.ip6_hdr, %struct.ip6_hdr* %59, i64 0, i32 2, !dbg !1073
  store i8 %5, i8* %66, align 1, !dbg !1073, !tbaa !924
  %67 = getelementptr inbounds %struct.ip6_addr, %struct.ip6_addr* %50, i64 0, i32 0, i64 0, !dbg !1074
  %68 = load i32, i32* %67, align 4, !dbg !1074, !tbaa !318
  %69 = getelementptr inbounds %struct.ip6_hdr, %struct.ip6_hdr* %59, i64 0, i32 5, i32 0, i64 0, !dbg !1074
  store i32 %68, i32* %69, align 1, !dbg !1074, !tbaa !318
  %70 = getelementptr inbounds %struct.ip6_addr, %struct.ip6_addr* %50, i64 0, i32 0, i64 1, !dbg !1074
  %71 = load i32, i32* %70, align 4, !dbg !1074, !tbaa !318
  %72 = getelementptr inbounds %struct.ip6_hdr, %struct.ip6_hdr* %59, i64 0, i32 5, i32 0, i64 1, !dbg !1074
  store i32 %71, i32* %72, align 1, !dbg !1074, !tbaa !318
  %73 = getelementptr inbounds %struct.ip6_addr, %struct.ip6_addr* %50, i64 0, i32 0, i64 2, !dbg !1074
  %74 = load i32, i32* %73, align 4, !dbg !1074, !tbaa !318
  %75 = getelementptr inbounds %struct.ip6_hdr, %struct.ip6_hdr* %59, i64 0, i32 5, i32 0, i64 2, !dbg !1074
  store i32 %74, i32* %75, align 1, !dbg !1074, !tbaa !318
  %76 = getelementptr inbounds %struct.ip6_addr, %struct.ip6_addr* %50, i64 0, i32 0, i64 3, !dbg !1074
  %77 = load i32, i32* %76, align 4, !dbg !1074, !tbaa !318
  %78 = getelementptr inbounds %struct.ip6_hdr, %struct.ip6_hdr* %59, i64 0, i32 5, i32 0, i64 3, !dbg !1074
  store i32 %77, i32* %78, align 1, !dbg !1074, !tbaa !318
  %79 = zext i8 %4 to i32, !dbg !1076
  %80 = shl nuw nsw i32 %79, 20, !dbg !1076
  %81 = or i32 %80, 1610612736, !dbg !1076
  %82 = tail call i32 @lwip_htonl(i32 %81) #8, !dbg !1076
  %83 = getelementptr inbounds %struct.ip6_hdr, %struct.ip6_hdr* %59, i64 0, i32 0, !dbg !1076
  store i32 %82, i32* %83, align 1, !dbg !1076, !tbaa !567
  %84 = getelementptr inbounds %struct.pbuf, %struct.pbuf* %0, i64 0, i32 2, !dbg !1077
  %85 = load i16, i16* %84, align 8, !dbg !1077, !tbaa !588
  %86 = add i16 %85, -40, !dbg !1077
  %87 = tail call zeroext i16 @lwip_htons(i16 zeroext %86) #8, !dbg !1077
  %88 = getelementptr inbounds %struct.ip6_hdr, %struct.ip6_hdr* %59, i64 0, i32 1, !dbg !1077
  store i16 %87, i16* %88, align 1, !dbg !1077, !tbaa !586
  %89 = icmp eq %struct.ip6_addr* %1, null, !dbg !1078
  %90 = select i1 %89, %struct.ip6_addr* getelementptr inbounds (%struct.ip_addr, %struct.ip_addr* @ip6_addr_any, i64 0, i32 0, i32 0), %struct.ip6_addr* %1, !dbg !1080
  %91 = getelementptr inbounds %struct.ip6_addr, %struct.ip6_addr* %90, i64 0, i32 0, i64 0, !dbg !1081
  %92 = load i32, i32* %91, align 4, !dbg !1081, !tbaa !318
  %93 = getelementptr inbounds %struct.ip6_hdr, %struct.ip6_hdr* %59, i64 0, i32 4, i32 0, i64 0, !dbg !1081
  store i32 %92, i32* %93, align 1, !dbg !1081, !tbaa !318
  %94 = getelementptr inbounds %struct.ip6_addr, %struct.ip6_addr* %90, i64 0, i32 0, i64 1, !dbg !1081
  %95 = load i32, i32* %94, align 4, !dbg !1081, !tbaa !318
  %96 = getelementptr inbounds %struct.ip6_hdr, %struct.ip6_hdr* %59, i64 0, i32 4, i32 0, i64 1, !dbg !1081
  store i32 %95, i32* %96, align 1, !dbg !1081, !tbaa !318
  %97 = getelementptr inbounds %struct.ip6_addr, %struct.ip6_addr* %90, i64 0, i32 0, i64 2, !dbg !1081
  %98 = load i32, i32* %97, align 4, !dbg !1081, !tbaa !318
  %99 = getelementptr inbounds %struct.ip6_hdr, %struct.ip6_hdr* %59, i64 0, i32 4, i32 0, i64 2, !dbg !1081
  store i32 %98, i32* %99, align 1, !dbg !1081, !tbaa !318
  %100 = getelementptr inbounds %struct.ip6_addr, %struct.ip6_addr* %90, i64 0, i32 0, i64 3, !dbg !1081
  %101 = load i32, i32* %100, align 4, !dbg !1081, !tbaa !318
  %102 = getelementptr inbounds %struct.ip6_hdr, %struct.ip6_hdr* %59, i64 0, i32 4, i32 0, i64 3, !dbg !1081
  store i32 %101, i32* %102, align 1, !dbg !1081, !tbaa !318
  br label %124, !dbg !1083

; <label>:103:                                    ; preds = %14
  %104 = getelementptr inbounds %struct.pbuf, %struct.pbuf* %0, i64 0, i32 1, !dbg !1084
  %105 = bitcast i8** %104 to %struct.ip6_hdr**, !dbg !1084
  %106 = load %struct.ip6_hdr*, %struct.ip6_hdr** %105, align 8, !dbg !1084, !tbaa !562
  %107 = getelementptr inbounds %struct.ip6_hdr, %struct.ip6_hdr* %106, i64 0, i32 5, i32 0, i64 0, !dbg !1086
  %108 = bitcast i32* %107 to <4 x i32>*, !dbg !1086
  %109 = load <4 x i32>, <4 x i32>* %108, align 1, !dbg !1086, !tbaa !318
  %110 = bitcast %struct.ip6_addr* %8 to <4 x i32>*, !dbg !1086
  store <4 x i32> %109, <4 x i32>* %110, align 16, !dbg !1086, !tbaa !318
  %111 = getelementptr inbounds %struct.ip6_addr, %struct.ip6_addr* %8, i64 0, i32 1, !dbg !1086
  store i8 0, i8* %111, align 16, !dbg !1086, !tbaa !292
  %112 = extractelement <4 x i32> %109, i32 0, !dbg !1088
  %113 = and i32 %112, 49407, !dbg !1088
  %114 = icmp eq i32 %113, 33022, !dbg !1088
  br i1 %114, label %118, label %115, !dbg !1088

; <label>:115:                                    ; preds = %103
  %116 = trunc i32 %112 to i16, !dbg !1088
  %117 = and i16 %116, -28673, !dbg !1088
...
; <label>:118:                                    ; preds = %115, %115, %103
  %119 = getelementptr inbounds %struct.netif, %struct.netif* %6, i64 0, i32 23, !dbg !1088
  %120 = load i8, i8* %119, align 8, !dbg !1088, !tbaa !296
  %121 = add i8 %120, 1, !dbg !1088
  br label %122, !dbg !1088

; <label>:122:                                    ; preds = %115, %118
  %123 = phi i8 [ %121, %118 ], [ 0, %115 ]
  store i8 %123, i8* %111, align 16, !dbg !1088, !tbaa !292
  br label %124

; <label>:124:                                    ; preds = %122, %64
  %125 = phi %struct.ip6_addr* [ %50, %64 ], [ %8, %122 ]
  %126 = load i16, i16* getelementptr inbounds (%struct.stats_, %struct.stats_* @lwip_stats, i64 0, i32 8, i32 0), align 2, !dbg !1089, !tbaa !1090
  %127 = add i16 %126, 1, !dbg !1089
  store i16 %127, i16* getelementptr inbounds (%struct.stats_, %struct.stats_* @lwip_stats, i64 0, i32 8, i32 0), align 2, !dbg !1089, !tbaa !1090
  %128 = getelementptr inbounds %struct.netif, %struct.netif* %6, i64 0, i32 18, !dbg !1091
  %129 = load i16, i16* %128, align 4, !dbg !1091, !tbaa !1093
  %130 = icmp eq i16 %129, 0, !dbg !1091
  br i1 %130, label %138, label %131, !dbg !1094

; <label>:131:                                    ; preds = %124
  %132 = getelementptr inbounds %struct.pbuf, %struct.pbuf* %0, i64 0, i32 2, !dbg !1095
  %133 = load i16, i16* %132, align 8, !dbg !1095, !tbaa !588
  %134 = call zeroext i16 @nd6_get_destination_mtu(%struct.ip6_addr* nonnull %125, %struct.netif* nonnull %6) #8, !dbg !1096
  %135 = icmp ugt i16 %133, %134, !dbg !1097
  br i1 %135, label %136, label %138, !dbg !1098

; <label>:136:                                    ; preds = %131
  %137 = call signext i8 @ip6_frag(%struct.pbuf* nonnull %0, %struct.netif* nonnull %6, %struct.ip6_addr* nonnull %125) #8, !dbg !1099
  br label %142, !dbg !1101

; <label>:138:                                    ; preds = %124, %131
  %139 = getelementptr inbounds %struct.netif, %struct.netif* %6, i64 0, i32 11, !dbg !1102
  %140 = load i8 (%struct.netif*, %struct.pbuf*, %struct.ip6_addr*)*, i8 (%struct.netif*, %struct.pbuf*, %struct.ip6_addr*)** %139, align 8, !dbg !1102, !tbaa !1103
  %141 = call signext i8 %140(%struct.netif* nonnull %6, %struct.pbuf* nonnull %0, %struct.ip6_addr* nonnull %125) #8, !dbg !1104
  br label %142, !dbg !1105

; <label>:142:                                    ; preds = %138, %136, %53
  %143 = phi i8 [ -2, %53 ], [ %137, %136 ], [ %141, %138 ], !dbg !1106
  call void @llvm.lifetime.end.p0i8(i64 20, i8* nonnull %9) #7, !dbg !1107
  ret i8 %143, !dbg !1107
}
...
define internal void @uk_pr_crit(i8*, ...) unnamed_addr #5 !dbg !2 {
  ...
  %3 = bitcast [1 x %struct.__va_list_tag]* %2 to i8*, !dbg !1109
  call void @llvm.lifetime.start.p0i8(i64 24, i8* nonnull %3) #7, !dbg !1109
  %4 = getelementptr inbounds [1 x %struct.__va_list_tag], [1 x %struct.__va_list_tag]* %2, i64 0, i64 0, !dbg !1111
  call void @llvm.va_start(i8* nonnull %3), !dbg !1111
  call void @_uk_vprintk(i32 0, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @uk_pr_crit.__str, i64 0, i64 0), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @uk_pr_crit.__str.4, i64 0, i64 0), i32 198, i8* %0, %struct.__va_list_tag* nonnull %4) #8, !dbg !1112
  call void @llvm.va_end(i8* nonnull %3), !dbg !1115
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %3) #7, !dbg !1116
  ret void, !dbg !1116
}
...
; Function Attrs: noredzone nounwind
define dso_local signext i8 @ip6_output(%struct.pbuf*, %struct.ip6_addr*, %struct.ip6_addr*, i8 zeroext, i8 zeroext, i8 zeroext) local_unnamed_addr #0 !dbg !1117 {
  %7 = alloca %struct.ip6_addr, align 16
  %8 = alloca %struct.ip6_addr, align 16
  %9 = bitcast %struct.ip6_addr* %7 to i8*, !dbg !1137
  call void @llvm.lifetime.start.p0i8(i64 20, i8* nonnull %9) #7, !dbg !1137
  %10 = bitcast %struct.ip6_addr* %8 to i8*, !dbg !1137
  call void @llvm.lifetime.start.p0i8(i64 20, i8* nonnull %10) #7, !dbg !1137
  %11 = getelementptr inbounds %struct.pbuf, %struct.pbuf* %0, i64 0, i32 6, !dbg !1138
  %12 = load i8, i8* %11, align 2, !dbg !1138, !tbaa !1032
  %13 = icmp eq i8 %12, 1, !dbg !1138
  br i1 %13, label %15, label %14, !dbg !1141

; <label>:14:                                     ; preds = %6
  tail call void (i8*, ...) @uk_pr_crit(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str, i64 0, i64 0)) #9, !dbg !1142
  tail call void (i8*, ...) @uk_pr_crit(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.1, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0)) #9, !dbg !1145
  tail call void @ukplat_terminate(i32 3) #10, !dbg !1145
  unreachable, !dbg !1145

; <label>:15:                                     ; preds = %6
  %16 = icmp eq %struct.ip6_addr* %2, null, !dbg !1149
  br i1 %16, label %19, label %17, !dbg !1151

; <label>:17:                                     ; preds = %15
  %18 = tail call %struct.netif* @ip6_route(%struct.ip6_addr* %1, %struct.ip6_addr* nonnull %2) #9, !dbg !1152
  br label %34, !dbg !1155

; <label>:19:                                     ; preds = %15
  %20 = getelementptr inbounds %struct.pbuf, %struct.pbuf* %0, i64 0, i32 1, !dbg !1156
  %21 = bitcast i8** %20 to %struct.ip6_hdr**, !dbg !1156
  %22 = load %struct.ip6_hdr*, %struct.ip6_hdr** %21, align 8, !dbg !1156, !tbaa !562
  %23 = getelementptr inbounds %struct.ip6_hdr, %struct.ip6_hdr* %22, i64 0, i32 4, i32 0, i64 0, !dbg !1159
  %24 = bitcast i32* %23 to <4 x i32>*, !dbg !1159
  %25 = load <4 x i32>, <4 x i32>* %24, align 1, !dbg !1159, !tbaa !318
  %26 = bitcast %struct.ip6_addr* %7 to <4 x i32>*, !dbg !1159
  store <4 x i32> %25, <4 x i32>* %26, align 16, !dbg !1159, !tbaa !318
  %27 = getelementptr inbounds %struct.ip6_addr, %struct.ip6_addr* %7, i64 0, i32 1, !dbg !1159
  store i8 0, i8* %27, align 16, !dbg !1159, !tbaa !292
  %28 = getelementptr inbounds %struct.ip6_hdr, %struct.ip6_hdr* %22, i64 0, i32 5, i32 0, i64 0, !dbg !1161
  %29 = bitcast i32* %28 to <4 x i32>*, !dbg !1161
  %30 = load <4 x i32>, <4 x i32>* %29, align 1, !dbg !1161, !tbaa !318
  %31 = bitcast %struct.ip6_addr* %8 to <4 x i32>*, !dbg !1161
  store <4 x i32> %30, <4 x i32>* %31, align 16, !dbg !1161, !tbaa !318
  %32 = getelementptr inbounds %struct.ip6_addr, %struct.ip6_addr* %8, i64 0, i32 1, !dbg !1161
  store i8 0, i8* %32, align 16, !dbg !1161, !tbaa !292
  %33 = call %struct.netif* @ip6_route(%struct.ip6_addr* nonnull %7, %struct.ip6_addr* nonnull %8) #9, !dbg !1165
  br label %34

; <label>:34:                                     ; preds = %19, %17
  %35 = phi %struct.netif* [ %18, %17 ], [ %33, %19 ], !dbg !1166
  %36 = icmp eq %struct.netif* %35, null, !dbg !1167
  br i1 %36, label %37, label %40, !dbg !1169

; <label>:37:                                     ; preds = %34
  %38 = load i16, i16* getelementptr inbounds (%struct.stats_, %struct.stats_* @lwip_stats, i64 0, i32 8, i32 7), align 2, !dbg !1170, !tbaa !1004
  %39 = add i16 %38, 1, !dbg !1170
  store i16 %39, i16* getelementptr inbounds (%struct.stats_, %struct.stats_* @lwip_stats, i64 0, i32 8, i32 7), align 2, !dbg !1170, !tbaa !1004
  br label %86, !dbg !1172

; <label>:40:                                     ; preds = %34
  %41 = icmp ne %struct.ip6_addr* %2, null, !dbg !1182
  %42 = icmp ne %struct.ip6_addr* %1, null, !dbg !1183
  %43 = and i1 %42, %41, !dbg !1184
  br i1 %43, label %44, label %83, !dbg !1184

; <label>:44:                                     ; preds = %40
  %45 = getelementptr inbounds %struct.ip6_addr, %struct.ip6_addr* %1, i64 0, i32 0, i64 0, !dbg !1185
  %46 = load i32, i32* %45, align 4, !dbg !1185, !tbaa !318
  %47 = icmp eq i32 %46, 0, !dbg !1185
  br i1 %47, label %48, label %83, !dbg !1185

; <label>:48:                                     ; preds = %44
  %49 = getelementptr inbounds %struct.ip6_addr, %struct.ip6_addr* %1, i64 0, i32 0, i64 1, !dbg !1185
  %50 = load i32, i32* %49, align 4, !dbg !1185, !tbaa !318
  %51 = icmp eq i32 %50, 0, !dbg !1185
  br i1 %51, label %52, label %83, !dbg !1185

; <label>:52:                                     ; preds = %48
  %53 = getelementptr inbounds %struct.ip6_addr, %struct.ip6_addr* %1, i64 0, i32 0, i64 2, !dbg !1185
  %54 = load i32, i32* %53, align 4, !dbg !1185, !tbaa !318
  %55 = icmp eq i32 %54, 0, !dbg !1185
  br i1 %55, label %56, label %83, !dbg !1185

; <label>:56:                                     ; preds = %52
  %57 = getelementptr inbounds %struct.ip6_addr, %struct.ip6_addr* %1, i64 0, i32 0, i64 3, !dbg !1185
  %58 = load i32, i32* %57, align 4, !dbg !1185, !tbaa !318
  %59 = icmp eq i32 %58, 0, !dbg !1185
  br i1 %59, label %60, label %83, !dbg !1186

; <label>:60:                                     ; preds = %56
  %61 = call %struct.ip_addr* @ip6_select_source_address(%struct.netif* nonnull %35, %struct.ip6_addr* nonnull %2) #8, !dbg !1187
  %62 = getelementptr inbounds %struct.ip_addr, %struct.ip_addr* %61, i64 0, i32 0, i32 0, !dbg !1187
  %63 = icmp eq %struct.ip_addr* %61, null, !dbg !1188
  br i1 %63, label %80, label %64, !dbg !1189

; <label>:64:                                     ; preds = %60
  %65 = getelementptr inbounds %struct.ip_addr, %struct.ip_addr* %61, i64 0, i32 0, i32 0, i32 0, i64 0, !dbg !1190
  %66 = load i32, i32* %65, align 4, !dbg !1190, !tbaa !318
  %67 = icmp eq i32 %66, 0, !dbg !1190
  br i1 %67, label %68, label %83, !dbg !1190

; <label>:68:                                     ; preds = %64
  %69 = getelementptr inbounds %struct.ip_addr, %struct.ip_addr* %61, i64 0, i32 0, i32 0, i32 0, i64 1, !dbg !1190
  %70 = load i32, i32* %69, align 4, !dbg !1190, !tbaa !318
  %71 = icmp eq i32 %70, 0, !dbg !1190
  br i1 %71, label %72, label %83, !dbg !1190

; <label>:72:                                     ; preds = %68
  %73 = getelementptr inbounds %struct.ip_addr, %struct.ip_addr* %61, i64 0, i32 0, i32 0, i32 0, i64 2, !dbg !1190
  %74 = load i32, i32* %73, align 4, !dbg !1190, !tbaa !318
  %75 = icmp eq i32 %74, 0, !dbg !1190
  br i1 %75, label %76, label %83, !dbg !1190

; <label>:76:                                     ; preds = %72
  %77 = getelementptr inbounds %struct.ip_addr, %struct.ip_addr* %61, i64 0, i32 0, i32 0, i32 0, i64 3, !dbg !1190
  %78 = load i32, i32* %77, align 4, !dbg !1190, !tbaa !318
  %79 = icmp eq i32 %78, 0, !dbg !1190
  br i1 %79, label %80, label %83, !dbg !1191

; <label>:80:                                     ; preds = %76, %60
  %81 = load i16, i16* getelementptr inbounds (%struct.stats_, %struct.stats_* @lwip_stats, i64 0, i32 8, i32 7), align 2, !dbg !1192, !tbaa !1004
  %82 = add i16 %81, 1, !dbg !1192
  store i16 %82, i16* getelementptr inbounds (%struct.stats_, %struct.stats_* @lwip_stats, i64 0, i32 8, i32 7), align 2, !dbg !1192, !tbaa !1004
  br label %86, !dbg !1193

; <label>:83:                                     ; preds = %76, %72, %68, %64, %56, %52, %48, %44, %40
  %84 = phi %struct.ip6_addr* [ %62, %76 ], [ %62, %72 ], [ %62, %68 ], [ %62, %64 ], [ %1, %56 ], [ %1, %52 ], [ %1, %48 ], [ %1, %44 ], [ %1, %40 ], !dbg !1194
  %85 = call signext i8 @ip6_output_if_src(%struct.pbuf* nonnull %0, %struct.ip6_addr* %84, %struct.ip6_addr* %2, i8 zeroext %3, i8 zeroext %4, i8 zeroext %5, %struct.netif* nonnull %35) #8, !dbg !1195
  br label %86, !dbg !1196

; <label>:86:                                     ; preds = %83, %80, %37
  %87 = phi i8 [ -4, %37 ], [ -4, %80 ], [ %85, %83 ], !dbg !1197
  call void @llvm.lifetime.end.p0i8(i64 20, i8* nonnull %10) #7, !dbg !1198
  call void @llvm.lifetime.end.p0i8(i64 20, i8* nonnull %9) #7, !dbg !1198
  ret i8 %87, !dbg !1198
}

; Function Attrs: noredzone nounwind
define dso_local signext i8 @ip6_options_add_hbh_ra(%struct.pbuf*, i8 zeroext, i8 zeroext) local_unnamed_addr #0 !dbg !1199 {
  %4 = tail call zeroext i8 @pbuf_add_header(%struct.pbuf* %0, i64 8) #8, !dbg !1216
  %5 = icmp eq i8 %4, 0, !dbg !1216
  br i1 %5, label %9, label %6, !dbg !1218

; <label>:6:                                      ; preds = %3
  %7 = load i16, i16* getelementptr inbounds (%struct.stats_, %struct.stats_* @lwip_stats, i64 0, i32 8, i32 10), align 2, !dbg !1219, !tbaa !575
  %8 = add i16 %7, 1, !dbg !1219
  store i16 %8, i16* getelementptr inbounds (%struct.stats_, %struct.stats_* @lwip_stats, i64 0, i32 8, i32 10), align 2, !dbg !1219, !tbaa !575
  br label %19, !dbg !1221

; <label>:9:                                      ; preds = %3
  %10 = getelementptr inbounds %struct.pbuf, %struct.pbuf* %0, i64 0, i32 1, !dbg !1222
  %11 = load i8*, i8** %10, align 8, !dbg !1222, !tbaa !562
  store i8 %1, i8* %11, align 1, !dbg !1224, !tbaa !1225
  %12 = getelementptr inbounds i8, i8* %11, i64 1, !dbg !1226
  store i8 0, i8* %12, align 1, !dbg !1227, !tbaa !696
  %13 = getelementptr inbounds i8, i8* %11, i64 2, !dbg !1228
  store i8 5, i8* %13, align 1, !dbg !1230, !tbaa !719
  %14 = getelementptr inbounds i8, i8* %11, i64 3, !dbg !1231
  store i8 2, i8* %14, align 1, !dbg !1232, !tbaa !743
  %15 = getelementptr inbounds i8, i8* %11, i64 4, !dbg !1233
  store i8 %2, i8* %15, align 1, !dbg !1235, !tbaa !355
  %16 = getelementptr inbounds i8, i8* %11, i64 5, !dbg !1236
  store i8 0, i8* %16, align 1, !dbg !1237, !tbaa !355
  %17 = getelementptr inbounds i8, i8* %11, i64 6, !dbg !1238
  store i8 1, i8* %17, align 1, !dbg !1239, !tbaa !719
  %18 = getelementptr inbounds i8, i8* %11, i64 7, !dbg !1240
  store i8 0, i8* %18, align 1, !dbg !1241, !tbaa !743
  br label %19, !dbg !1242

; <label>:19:                                     ; preds = %9, %6
  %20 = phi i8 [ -2, %6 ], [ 0, %9 ], !dbg !1243
  ret i8 %20, !dbg !1244
}
...
!643 = !DILocation(line: 672, column: 7, scope: !644)
!644 = distinct !DILexicalBlock(scope: !520, file: !10, line: 672, column: 7)
!645 = !DILocation(line: 629, column: 9, scope: !646)
!646 = distinct !DILexicalBlock(scope: !647, file: !10, line: 629, column: 9)
!647 = distinct !DILexicalBlock(scope: !635, file: !10, line: 626, column: 10)
!648 = !DILocation(line: 629, column: 9, scope: !647)
!649 = !DILocation(line: 512, column: 17, scope: !520)
!650 = !DILocation(line: 637, column: 57, scope: !651)
!651 = distinct !DILexicalBlock(scope: !652, file: !10, line: 637, column: 11)
!652 = distinct !DILexicalBlock(scope: !646, file: !10, line: 631, column: 12)
!653 = !DILocation(line: 649, column: 11, scope: !654)
!654 = distinct !DILexicalBlock(scope: !652, file: !10, line: 649, column: 11)
!655 = !DILocation(line: 650, column: 11, scope: !654)
!656 = !DILocation(line: 655, column: 7, scope: !657)
!657 = distinct !DILexicalBlock(scope: !652, file: !10, line: 655, column: 7)
!658 = !DILocation(line: 655, column: 7, scope: !659)
!659 = distinct !DILexicalBlock(scope: !657, file: !10, line: 655, column: 7)
!660 = !DILocation(line: 656, column: 19, scope: !661)
!661 = distinct !DILexicalBlock(scope: !662, file: !10, line: 656, column: 13)
!662 = distinct !DILexicalBlock(scope: !659, file: !10, line: 655, column: 28)
!663 = !DILocation(line: 656, column: 13, scope: !662)
!664 = !DILocation(line: 660, column: 13, scope: !665)
!665 = distinct !DILexicalBlock(scope: !662, file: !10, line: 660, column: 13)
!666 = !DILocation(line: 660, column: 13, scope: !662)
!667 = distinct !{!667, !656, !668}
!668 = !DILocation(line: 663, column: 7, scope: !657)
!669 = !DILocation(line: 0, scope: !657)
!670 = !DILocation(line: 673, column: 9, scope: !644)
!671 = !DILocation(line: 672, column: 7, scope: !520)
!672 = !DILocation(line: 677, column: 5, scope: !673)
!673 = distinct !DILexicalBlock(scope: !644, file: !10, line: 673, column: 61)
!674 = !DILocation(line: 678, column: 5, scope: !673)
!675 = !DILocation(line: 679, column: 5, scope: !673)
!676 = !DILocation(line: 683, column: 13, scope: !677)
!677 = distinct !DILexicalBlock(scope: !520, file: !10, line: 683, column: 7)
!678 = !DILocation(line: 683, column: 7, scope: !520)
!679 = !DILocation(line: 693, column: 5, scope: !680)
!680 = distinct !DILexicalBlock(scope: !677, file: !10, line: 683, column: 22)
!681 = !DILocation(line: 694, column: 5, scope: !680)
!682 = !DILocation(line: 698, column: 25, scope: !520)
!683 = !DILocation(line: 701, column: 12, scope: !520)
!684 = !DILocation(line: 513, column: 15, scope: !520)
!685 = !DILocation(line: 514, column: 15, scope: !520)
!686 = !DILocation(line: 514, column: 9, scope: !520)
!687 = !DILocation(line: 707, column: 3, scope: !520)
!688 = !DILocation(line: 710, column: 10, scope: !520)
!689 = !DILocation(line: 710, column: 3, scope: !520)
!690 = !DILocation(line: 704, column: 19, scope: !520)
!691 = !DILocation(line: 0, scope: !551)
!692 = !DILocation(line: 528, column: 10, scope: !520)
!693 = !DILocation(line: 721, column: 42, scope: !532)
!694 = !DILocation(line: 716, column: 27, scope: !532)
!695 = !DILocation(line: 727, column: 40, scope: !532)
!696 = !{!697, !275, i64 1}
!697 = !{!"ip6_hbh_hdr", !275, i64 0, !275, i64 1}
!698 = !DILocation(line: 727, column: 31, scope: !532)
!699 = !DILocation(line: 727, column: 24, scope: !532)
!700 = !DILocation(line: 729, column: 15, scope: !701)
!701 = distinct !DILexicalBlock(scope: !532, file: !10, line: 729, column: 11)
!702 = !DILocation(line: 729, column: 19, scope: !701)
!703 = !DILocation(line: 729, column: 24, scope: !701)
!704 = !DILocation(line: 729, column: 28, scope: !701)
!705 = !DILocation(line: 729, column: 33, scope: !701)
!706 = !DILocation(line: 729, column: 11, scope: !532)
!707 = !DILocation(line: 734, column: 9, scope: !708)
!708 = distinct !DILexicalBlock(scope: !701, file: !10, line: 729, column: 44)
!709 = !DILocation(line: 735, column: 9, scope: !708)
!710 = !DILocation(line: 736, column: 9, scope: !708)
!711 = !DILocation(line: 737, column: 9, scope: !708)
!712 = !DILocation(line: 740, column: 35, scope: !532)
!713 = !DILocation(line: 715, column: 13, scope: !532)
!714 = !DILocation(line: 744, column: 7, scope: !532)
!715 = !DILocation(line: 746, column: 15, scope: !541)
!716 = !DILocation(line: 748, column: 58, scope: !541)
!717 = !DILocation(line: 717, column: 27, scope: !532)
!718 = !DILocation(line: 750, column: 17, scope: !541)
!719 = !{!720, !275, i64 0}
!720 = !{!"ip6_opt_hdr", !275, i64 0, !275, i64 1}
!721 = !DILocation(line: 750, column: 9, scope: !541)
!722 = !DILocation(line: 767, column: 19, scope: !723)
!723 = distinct !DILexicalBlock(scope: !541, file: !10, line: 750, column: 40)
!724 = !DILocation(line: 767, column: 11, scope: !723)
!725 = !DILocation(line: 771, column: 13, scope: !726)
!726 = distinct !DILexicalBlock(scope: !723, file: !10, line: 767, column: 49)
!727 = !DILocation(line: 772, column: 13, scope: !726)
!728 = !DILocation(line: 773, column: 13, scope: !726)
!729 = !DILocation(line: 776, column: 13, scope: !726)
!730 = !DILocation(line: 778, column: 13, scope: !726)
!731 = !DILocation(line: 779, column: 13, scope: !726)
!732 = !DILocation(line: 780, column: 13, scope: !726)
!733 = !DILocation(line: 783, column: 18, scope: !734)
!734 = distinct !DILexicalBlock(scope: !726, file: !10, line: 783, column: 17)
!735 = !DILocation(line: 783, column: 17, scope: !726)
!736 = !DILocation(line: 784, column: 15, scope: !737)
!737 = distinct !DILexicalBlock(scope: !734, file: !10, line: 783, column: 65)
!738 = !DILocation(line: 785, column: 13, scope: !737)
!739 = !DILocation(line: 787, column: 13, scope: !726)
!740 = !DILocation(line: 788, column: 13, scope: !726)
!741 = !DILocation(line: 789, column: 13, scope: !726)
!742 = !DILocation(line: 0, scope: !726)
!743 = !{!720, !275, i64 1}
!744 = !DILocation(line: 799, column: 33, scope: !541)
!745 = !DILocation(line: 0, scope: !723)
!746 = !DILocation(line: 799, column: 48, scope: !541)
!747 = !DILocation(line: 744, column: 25, scope: !532)
!748 = !DILocation(line: 801, column: 29, scope: !532)
!749 = !DILocation(line: 801, column: 7, scope: !532)
!750 = !DILocation(line: 811, column: 44, scope: !543)
!751 = !DILocation(line: 807, column: 28, scope: !543)
!752 = !DILocation(line: 817, column: 33, scope: !543)
!753 = !{!754, !275, i64 1}
!754 = !{!"ip6_dest_hdr", !275, i64 0, !275, i64 1}
!755 = !DILocation(line: 817, column: 23, scope: !543)
!756 = !DILocation(line: 817, column: 16, scope: !543)
!757 = !DILocation(line: 818, column: 15, scope: !758)
!758 = distinct !DILexicalBlock(scope: !543, file: !10, line: 818, column: 11)
!759 = !DILocation(line: 818, column: 19, scope: !758)
!760 = !DILocation(line: 818, column: 24, scope: !758)
!761 = !DILocation(line: 818, column: 28, scope: !758)
!762 = !DILocation(line: 818, column: 33, scope: !758)
!763 = !DILocation(line: 818, column: 11, scope: !543)
!764 = !DILocation(line: 823, column: 9, scope: !765)
!765 = distinct !DILexicalBlock(scope: !758, file: !10, line: 818, column: 44)
!766 = !DILocation(line: 824, column: 9, scope: !765)
!767 = !DILocation(line: 825, column: 9, scope: !765)
!768 = !DILocation(line: 826, column: 9, scope: !765)
!769 = !DILocation(line: 829, column: 35, scope: !543)
!770 = !DILocation(line: 806, column: 13, scope: !543)
!771 = !DILocation(line: 833, column: 7, scope: !543)
!772 = !DILocation(line: 835, column: 15, scope: !547)
!773 = !DILocation(line: 837, column: 59, scope: !547)
!774 = !DILocation(line: 808, column: 27, scope: !543)
!775 = !DILocation(line: 839, column: 17, scope: !547)
!776 = !DILocation(line: 839, column: 9, scope: !547)
!777 = !DILocation(line: 860, column: 19, scope: !778)
!778 = distinct !DILexicalBlock(scope: !547, file: !10, line: 840, column: 9)
!779 = !DILocation(line: 860, column: 11, scope: !778)
!780 = !DILocation(line: 865, column: 13, scope: !781)
!781 = distinct !DILexicalBlock(scope: !778, file: !10, line: 861, column: 11)
!782 = !DILocation(line: 866, column: 13, scope: !781)
!783 = !DILocation(line: 867, column: 13, scope: !781)
!784 = !DILocation(line: 870, column: 13, scope: !781)
!785 = !DILocation(line: 872, column: 13, scope: !781)
!786 = !DILocation(line: 873, column: 13, scope: !781)
!787 = !DILocation(line: 874, column: 13, scope: !781)
!788 = !DILocation(line: 877, column: 18, scope: !789)
!789 = distinct !DILexicalBlock(scope: !781, file: !10, line: 877, column: 17)
!790 = !DILocation(line: 877, column: 17, scope: !781)
!791 = !DILocation(line: 878, column: 15, scope: !792)
!792 = distinct !DILexicalBlock(scope: !789, file: !10, line: 877, column: 65)
!793 = !DILocation(line: 879, column: 13, scope: !792)
!794 = !DILocation(line: 881, column: 13, scope: !781)
!795 = !DILocation(line: 882, column: 13, scope: !781)
!796 = !DILocation(line: 883, column: 13, scope: !781)
!797 = !DILocation(line: 0, scope: !781)
!798 = !DILocation(line: 893, column: 33, scope: !547)
!799 = !DILocation(line: 0, scope: !778)
!800 = !DILocation(line: 893, column: 48, scope: !547)
!801 = !DILocation(line: 833, column: 25, scope: !543)
!802 = !DILocation(line: 896, column: 29, scope: !543)
!803 = !DILocation(line: 896, column: 7, scope: !543)
!804 = !DILocation(line: 904, column: 44, scope: !549)
!805 = !DILocation(line: 901, column: 28, scope: !549)
!806 = !DILocation(line: 907, column: 16, scope: !549)
!807 = !DILocation(line: 910, column: 33, scope: !549)
!808 = !{!809, !275, i64 1}
!809 = !{!"ip6_rout_hdr", !275, i64 0, !275, i64 1, !275, i64 2, !275, i64 3}
!810 = !DILocation(line: 910, column: 14, scope: !549)
!811 = !DILocation(line: 912, column: 15, scope: !812)
!812 = distinct !DILexicalBlock(scope: !549, file: !10, line: 912, column: 11)
!813 = !DILocation(line: 912, column: 19, scope: !812)
!814 = !DILocation(line: 912, column: 33, scope: !812)
!815 = !DILocation(line: 912, column: 24, scope: !812)
!816 = !DILocation(line: 917, column: 9, scope: !817)
!817 = distinct !DILexicalBlock(scope: !812, file: !10, line: 912, column: 44)
!818 = !DILocation(line: 918, column: 9, scope: !817)
!819 = !DILocation(line: 919, column: 9, scope: !817)
!820 = !DILocation(line: 920, column: 9, scope: !817)
!821 = !DILocation(line: 924, column: 35, scope: !549)
!822 = !DILocation(line: 927, column: 11, scope: !823)
!823 = distinct !DILexicalBlock(scope: !549, file: !10, line: 927, column: 11)
!824 = !{!809, !275, i64 3}
!825 = !DILocation(line: 927, column: 11, scope: !549)
!826 = !DILocation(line: 929, column: 29, scope: !827)
!827 = distinct !DILexicalBlock(scope: !828, file: !10, line: 929, column: 13)
!828 = distinct !DILexicalBlock(scope: !823, file: !10, line: 927, column: 40)
!829 = !DILocation(line: 929, column: 13, scope: !828)
!830 = !DILocation(line: 931, column: 11, scope: !831)
!831 = distinct !DILexicalBlock(scope: !827, file: !10, line: 929, column: 36)
!832 = !DILocation(line: 933, column: 11, scope: !831)
!833 = !DILocation(line: 934, column: 11, scope: !831)
!834 = !DILocation(line: 935, column: 11, scope: !831)
!835 = !DILocation(line: 938, column: 17, scope: !828)
!836 = !{!809, !275, i64 2}
!837 = !DILocation(line: 938, column: 9, scope: !828)
!838 = !DILocation(line: 947, column: 11, scope: !839)
!839 = distinct !DILexicalBlock(scope: !828, file: !10, line: 939, column: 9)
!840 = !DILocation(line: 949, column: 11, scope: !839)
!841 = !DILocation(line: 950, column: 11, scope: !839)
!842 = !DILocation(line: 951, column: 11, scope: !839)
!843 = !DILocation(line: 955, column: 29, scope: !549)
!844 = !DILocation(line: 955, column: 7, scope: !549)
!845 = !DILocation(line: 963, column: 44, scope: !551)
!846 = !DILocation(line: 960, column: 28, scope: !551)
!847 = !DILocation(line: 966, column: 16, scope: !551)
!848 = !DILocation(line: 972, column: 21, scope: !849)
!849 = distinct !DILexicalBlock(scope: !551, file: !10, line: 972, column: 11)
!850 = !DILocation(line: 972, column: 16, scope: !849)
!851 = !DILocation(line: 972, column: 11, scope: !551)
!852 = !DILocation(line: 977, column: 9, scope: !853)
!853 = distinct !DILexicalBlock(scope: !849, file: !10, line: 972, column: 26)
!854 = !DILocation(line: 978, column: 9, scope: !853)
!855 = !{!556, !283, i64 244}
!856 = !DILocation(line: 979, column: 9, scope: !853)
!857 = !{!556, !283, i64 240}
!858 = !DILocation(line: 980, column: 9, scope: !853)
!859 = !DILocation(line: 983, column: 35, scope: !551)
!860 = !DILocation(line: 986, column: 11, scope: !861)
!861 = distinct !DILexicalBlock(scope: !551, file: !10, line: 986, column: 11)
!862 = !{!863, !283, i64 2}
!863 = !{!"ip6_frag_hdr", !275, i64 0, !275, i64 1, !283, i64 2, !319, i64 4}
!864 = !DILocation(line: 986, column: 35, scope: !861)
!865 = !DILocation(line: 986, column: 39, scope: !861)
!866 = !DILocation(line: 986, column: 57, scope: !861)
!867 = !DILocation(line: 986, column: 11, scope: !551)
!868 = !DILocation(line: 988, column: 48, scope: !869)
!869 = distinct !DILexicalBlock(scope: !861, file: !10, line: 986, column: 65)
!870 = !DILocation(line: 988, column: 9, scope: !869)
!871 = !DILocation(line: 990, column: 9, scope: !869)
!872 = !DILocation(line: 991, column: 9, scope: !869)
!873 = !DILocation(line: 992, column: 9, scope: !869)
!874 = !DILocation(line: 996, column: 22, scope: !875)
!875 = distinct !DILexicalBlock(scope: !551, file: !10, line: 996, column: 11)
!876 = !DILocation(line: 996, column: 39, scope: !875)
!877 = !DILocation(line: 997, column: 65, scope: !875)
!878 = !DILocation(line: 996, column: 11, scope: !551)
!879 = !DILocation(line: 999, column: 9, scope: !880)
!880 = distinct !DILexicalBlock(scope: !875, file: !10, line: 997, column: 71)
!881 = !DILocation(line: 1000, column: 7, scope: !880)
!882 = !DILocation(line: 1003, column: 43, scope: !883)
!883 = distinct !DILexicalBlock(scope: !875, file: !10, line: 1000, column: 14)
!884 = !{!610, !283, i64 32}
!885 = !DILocation(line: 1004, column: 13, scope: !883)
!886 = !DILocation(line: 1006, column: 15, scope: !887)
!887 = distinct !DILexicalBlock(scope: !883, file: !10, line: 1006, column: 13)
!888 = !DILocation(line: 1006, column: 13, scope: !883)
!889 = !DILocation(line: 1012, column: 39, scope: !883)
!890 = !DILocation(line: 1013, column: 18, scope: !883)
!891 = !DILocation(line: 1015, column: 9, scope: !883)
!892 = !DILocation(line: 0, scope: !532)
!893 = !DILocation(line: 1032, column: 9, scope: !894)
!894 = distinct !DILexicalBlock(scope: !534, file: !10, line: 1032, column: 9)
!895 = !DILocation(line: 1032, column: 16, scope: !894)
!896 = !DILocation(line: 1032, column: 9, scope: !534)
!897 = distinct !{!897, !689, !898}
!898 = !DILocation(line: 1040, column: 3, scope: !520)
!899 = !DILocation(line: 1034, column: 7, scope: !900)
!900 = distinct !DILexicalBlock(scope: !894, file: !10, line: 1032, column: 39)
!901 = !DILocation(line: 1036, column: 7, scope: !900)
!902 = !DILocation(line: 1037, column: 7, scope: !900)
!903 = !DILocation(line: 1038, column: 7, scope: !900)
!904 = !DILocation(line: 1049, column: 37, scope: !520)
!905 = !DILocation(line: 1063, column: 13, scope: !906)
!906 = distinct !DILexicalBlock(scope: !520, file: !10, line: 1061, column: 3)
!907 = !DILocation(line: 1063, column: 5, scope: !906)
!908 = !DILocation(line: 1065, column: 7, scope: !909)
!909 = distinct !DILexicalBlock(scope: !906, file: !10, line: 1063, column: 21)
!910 = !DILocation(line: 1066, column: 7, scope: !909)
!911 = !DILocation(line: 1072, column: 7, scope: !909)
!912 = !DILocation(line: 1073, column: 7, scope: !909)
!913 = !DILocation(line: 1077, column: 7, scope: !909)
!914 = !DILocation(line: 1078, column: 7, scope: !909)
!915 = !DILocation(line: 1082, column: 7, scope: !909)
!916 = !DILocation(line: 1083, column: 7, scope: !909)
!917 = !DILocation(line: 1094, column: 34, scope: !918)
!918 = distinct !DILexicalBlock(scope: !909, file: !10, line: 1091, column: 9)
!919 = !DILocation(line: 1094, column: 9, scope: !918)
!920 = !DILocation(line: 1096, column: 15, scope: !921)
!921 = distinct !DILexicalBlock(scope: !918, file: !10, line: 1096, column: 13)
!922 = !DILocation(line: 1096, column: 62, scope: !921)
!923 = !DILocation(line: 1097, column: 14, scope: !921)
!924 = !{!568, !275, i64 6}
!925 = !DILocation(line: 1097, column: 33, scope: !921)
!926 = !DILocation(line: 1096, column: 13, scope: !918)
!927 = !DILocation(line: 1098, column: 11, scope: !928)
!928 = distinct !DILexicalBlock(scope: !921, file: !10, line: 1097, column: 54)
!929 = !DILocation(line: 1099, column: 9, scope: !928)
!930 = !DILocation(line: 1102, column: 9, scope: !918)
!931 = !{!556, !283, i64 202}
!932 = !DILocation(line: 1103, column: 9, scope: !918)
!933 = !DILocation(line: 1105, column: 7, scope: !909)
!934 = !DILocation(line: 1106, column: 7, scope: !909)
!935 = !DILocation(line: 1111, column: 25, scope: !520)
!936 = !DILocation(line: 1113, column: 30, scope: !520)
!937 = !DILocation(line: 1114, column: 37, scope: !520)
!938 = !DILocation(line: 1115, column: 3, scope: !939)
!939 = distinct !DILexicalBlock(scope: !520, file: !10, line: 1115, column: 3)
!940 = !DILocation(line: 1116, column: 3, scope: !941)
!941 = distinct !DILexicalBlock(scope: !520, file: !10, line: 1116, column: 3)
!942 = !DILocation(line: 1118, column: 3, scope: !520)
!943 = !DILocation(line: 1119, column: 1, scope: !520)
!944 = distinct !DISubprogram(name: "ip6_input_accept", scope: !10, file: !10, line: 469, type: !945, isLocal: true, isDefinition: true, scopeLine: 470, flags: DIFlagPrototyped, isOptimized: true, unit: !9, retainedNodes: !947)
!945 = !DISubroutineType(types: !946)
!946 = !{!20, !181}
!947 = !{!948, !949}
!948 = !DILocalVariable(name: "netif", arg: 1, scope: !944, file: !10, line: 469, type: !181)
!949 = !DILocalVariable(name: "i", scope: !950, file: !10, line: 473, type: !60)
!950 = distinct !DILexicalBlock(scope: !951, file: !10, line: 472, column: 27)
!951 = distinct !DILexicalBlock(scope: !944, file: !10, line: 472, column: 7)
!952 = !DILocation(line: 469, column: 32, scope: !944)
!953 = !DILocation(line: 472, column: 7, scope: !951)
!954 = !DILocation(line: 472, column: 7, scope: !944)
!955 = !DILocation(line: 473, column: 10, scope: !950)
!956 = !DILocation(line: 479, column: 11, scope: !957)
!957 = distinct !DILexicalBlock(scope: !958, file: !10, line: 479, column: 11)
!958 = distinct !DILexicalBlock(scope: !959, file: !10, line: 478, column: 51)
!959 = distinct !DILexicalBlock(scope: !960, file: !10, line: 478, column: 5)
!960 = distinct !DILexicalBlock(scope: !950, file: !10, line: 478, column: 5)
!961 = !DILocation(line: 479, column: 60, scope: !957)
!962 = !DILocation(line: 480, column: 11, scope: !957)
!963 = !DILocation(line: 479, column: 11, scope: !958)
!964 = !DILocation(line: 0, scope: !965)
!965 = distinct !DILexicalBlock(scope: !957, file: !10, line: 485, column: 9)
!966 = !DILocation(line: 492, column: 1, scope: !944)
!967 = distinct !DISubprogram(name: "ip6_output_if", scope: !10, file: !10, line: 1149, type: !968, isLocal: false, isDefinition: true, scopeLine: 1152, flags: DIFlagPrototyped, isOptimized: true, unit: !9, retainedNodes: !970)
!968 = !DISubroutineType(types: !969)
!969 = !{!202, !207, !70, !70, !60, !60, !60, !181}
!970 = !{!971, !972, !973, !974, !975, !976, !977, !978}
!971 = !DILocalVariable(name: "p", arg: 1, scope: !967, file: !10, line: 1149, type: !207)
!972 = !DILocalVariable(name: "src", arg: 2, scope: !967, file: !10, line: 1149, type: !70)
!973 = !DILocalVariable(name: "dest", arg: 3, scope: !967, file: !10, line: 1149, type: !70)
!974 = !DILocalVariable(name: "hl", arg: 4, scope: !967, file: !10, line: 1150, type: !60)
!975 = !DILocalVariable(name: "tc", arg: 5, scope: !967, file: !10, line: 1150, type: !60)
!976 = !DILocalVariable(name: "nexth", arg: 6, scope: !967, file: !10, line: 1151, type: !60)
!977 = !DILocalVariable(name: "netif", arg: 7, scope: !967, file: !10, line: 1151, type: !181)
!978 = !DILocalVariable(name: "src_used", scope: !967, file: !10, line: 1153, type: !70)
!979 = !DILocation(line: 1149, column: 28, scope: !967)
!980 = !DILocation(line: 1149, column: 49, scope: !967)
!981 = !DILocation(line: 1149, column: 72, scope: !967)
!982 = !DILocation(line: 1150, column: 19, scope: !967)
!983 = !DILocation(line: 1150, column: 28, scope: !967)
!984 = !DILocation(line: 1151, column: 19, scope: !967)
!985 = !DILocation(line: 1151, column: 40, scope: !967)
!986 = !DILocation(line: 1153, column: 21, scope: !967)
!987 = !DILocation(line: 1154, column: 12, scope: !988)
!988 = distinct !DILexicalBlock(scope: !967, file: !10, line: 1154, column: 7)
!989 = !DILocation(line: 1155, column: 13, scope: !990)
!990 = distinct !DILexicalBlock(scope: !991, file: !10, line: 1155, column: 9)
!991 = distinct !DILexicalBlock(scope: !988, file: !10, line: 1154, column: 32)
!992 = !DILocation(line: 1154, column: 7, scope: !967)
!993 = !DILocation(line: 1155, column: 24, scope: !990)
!994 = !DILocation(line: 1155, column: 9, scope: !991)
!995 = !DILocation(line: 1156, column: 18, scope: !996)
!996 = distinct !DILexicalBlock(scope: !990, file: !10, line: 1155, column: 45)
!997 = !DILocation(line: 1157, column: 21, scope: !998)
!998 = distinct !DILexicalBlock(scope: !996, file: !10, line: 1157, column: 11)
!999 = !DILocation(line: 1157, column: 30, scope: !998)
!1000 = !DILocation(line: 1157, column: 33, scope: !998)
!1001 = !DILocation(line: 1157, column: 11, scope: !996)
!1002 = !DILocation(line: 1160, column: 9, scope: !1003)
!1003 = distinct !DILexicalBlock(scope: !998, file: !10, line: 1157, column: 59)
!1004 = !{!556, !283, i64 200}
!1005 = !DILocation(line: 1161, column: 9, scope: !1003)
!1006 = !DILocation(line: 0, scope: !967)
!1007 = !DILocation(line: 1165, column: 10, scope: !967)
!1008 = !DILocation(line: 1165, column: 3, scope: !967)
!1009 = !DILocation(line: 1166, column: 1, scope: !967)
!1010 = distinct !DISubprogram(name: "ip6_output_if_src", scope: !10, file: !10, line: 1173, type: !968, isLocal: false, isDefinition: true, scopeLine: 1176, flags: DIFlagPrototyped, isOptimized: true, unit: !9, retainedNodes: !1011)
!1011 = !{!1012, !1013, !1014, !1015, !1016, !1017, !1018, !1019, !1020}
!1012 = !DILocalVariable(name: "p", arg: 1, scope: !1010, file: !10, line: 1173, type: !207)
!1013 = !DILocalVariable(name: "src", arg: 2, scope: !1010, file: !10, line: 1173, type: !70)
!1014 = !DILocalVariable(name: "dest", arg: 3, scope: !1010, file: !10, line: 1173, type: !70)
!1015 = !DILocalVariable(name: "hl", arg: 4, scope: !1010, file: !10, line: 1174, type: !60)
!1016 = !DILocalVariable(name: "tc", arg: 5, scope: !1010, file: !10, line: 1174, type: !60)
!1017 = !DILocalVariable(name: "nexth", arg: 6, scope: !1010, file: !10, line: 1175, type: !60)
!1018 = !DILocalVariable(name: "netif", arg: 7, scope: !1010, file: !10, line: 1175, type: !181)
!1019 = !DILocalVariable(name: "ip6hdr", scope: !1010, file: !10, line: 1177, type: !97)
!1020 = !DILocalVariable(name: "dest_addr", scope: !1010, file: !10, line: 1178, type: !72)
!1021 = !DILocation(line: 1173, column: 32, scope: !1010)
!1022 = !DILocation(line: 1173, column: 53, scope: !1010)
!1023 = !DILocation(line: 1173, column: 76, scope: !1010)
!1024 = !DILocation(line: 1174, column: 19, scope: !1010)
!1025 = !DILocation(line: 1174, column: 28, scope: !1010)
!1026 = !DILocation(line: 1175, column: 19, scope: !1010)
!1027 = !DILocation(line: 1175, column: 40, scope: !1010)
!1028 = !DILocation(line: 1178, column: 3, scope: !1010)
!1029 = !DILocation(line: 1181, column: 3, scope: !1030)
!1030 = distinct !DILexicalBlock(scope: !1031, file: !10, line: 1181, column: 3)
!1031 = distinct !DILexicalBlock(scope: !1010, file: !10, line: 1181, column: 3)
!1032 = !{!563, !275, i64 22}
!1033 = !DILocation(line: 1181, column: 3, scope: !1031)
!1034 = !DILocation(line: 1181, column: 3, scope: !1035)
!1035 = distinct !DILexicalBlock(scope: !1036, file: !10, line: 1181, column: 3)
!1036 = distinct !DILexicalBlock(scope: !1030, file: !10, line: 1181, column: 3)
!1037 = !DILocation(line: 1181, column: 3, scope: !1038)
!1038 = distinct !DILexicalBlock(scope: !1039, file: !10, line: 1181, column: 3)
!1039 = distinct !DILexicalBlock(scope: !1040, file: !10, line: 1181, column: 3)
!1040 = distinct !DILexicalBlock(scope: !1035, file: !10, line: 1181, column: 3)
!1041 = !DILocation(line: 1184, column: 12, scope: !1042)
!1042 = distinct !DILexicalBlock(scope: !1010, file: !10, line: 1184, column: 7)
!1043 = !DILocation(line: 1184, column: 7, scope: !1010)
!1044 = !DILocation(line: 1192, column: 9, scope: !1045)
!1045 = distinct !DILexicalBlock(scope: !1046, file: !10, line: 1192, column: 9)
!1046 = distinct !DILexicalBlock(scope: !1042, file: !10, line: 1184, column: 32)
!1047 = !DILocation(line: 1193, column: 7, scope: !1048)
!1048 = distinct !DILexicalBlock(scope: !1049, file: !10, line: 1193, column: 7)
!1049 = distinct !DILexicalBlock(scope: !1045, file: !10, line: 1192, column: 49)
!1050 = !DILocation(line: 1194, column: 7, scope: !1049)
!1051 = !DILocation(line: 1196, column: 5, scope: !1049)
!1052 = !DILocation(line: 1200, column: 9, scope: !1053)
!1053 = distinct !DILexicalBlock(scope: !1046, file: !10, line: 1200, column: 9)
!1054 = !DILocation(line: 1200, column: 9, scope: !1046)
!1055 = !DILocation(line: 1202, column: 7, scope: !1056)
!1056 = distinct !DILexicalBlock(scope: !1053, file: !10, line: 1200, column: 39)
!1057 = !DILocation(line: 1203, column: 7, scope: !1056)
!1058 = !DILocation(line: 1206, column: 35, scope: !1046)
!1059 = !DILocation(line: 1177, column: 19, scope: !1010)
!1060 = !DILocation(line: 1207, column: 5, scope: !1061)
!1061 = distinct !DILexicalBlock(scope: !1062, file: !10, line: 1207, column: 5)
!1062 = distinct !DILexicalBlock(scope: !1046, file: !10, line: 1207, column: 5)
!1063 = !DILocation(line: 1207, column: 5, scope: !1062)
!1064 = !DILocation(line: 1207, column: 5, scope: !1065)
!1065 = distinct !DILexicalBlock(scope: !1066, file: !10, line: 1207, column: 5)
!1066 = distinct !DILexicalBlock(scope: !1061, file: !10, line: 1207, column: 5)
!1067 = !DILocation(line: 1207, column: 5, scope: !1068)
!1068 = distinct !DILexicalBlock(scope: !1069, file: !10, line: 1207, column: 5)
!1069 = distinct !DILexicalBlock(scope: !1070, file: !10, line: 1207, column: 5)
!1070 = distinct !DILexicalBlock(scope: !1065, file: !10, line: 1207, column: 5)
!1071 = !DILocation(line: 1210, column: 5, scope: !1046)
!1072 = !{!568, !275, i64 7}
!1073 = !DILocation(line: 1211, column: 5, scope: !1046)
!1074 = !DILocation(line: 1214, column: 5, scope: !1075)
!1075 = distinct !DILexicalBlock(scope: !1046, file: !10, line: 1214, column: 5)
!1076 = !DILocation(line: 1216, column: 5, scope: !1046)
!1077 = !DILocation(line: 1217, column: 5, scope: !1046)
!1078 = !DILocation(line: 1219, column: 13, scope: !1079)
!1079 = distinct !DILexicalBlock(scope: !1046, file: !10, line: 1219, column: 9)
!1080 = !DILocation(line: 1219, column: 9, scope: !1046)
!1081 = !DILocation(line: 1223, column: 5, scope: !1082)
!1082 = distinct !DILexicalBlock(scope: !1046, file: !10, line: 1223, column: 5)
!1083 = !DILocation(line: 1225, column: 3, scope: !1046)
!1084 = !DILocation(line: 1227, column: 35, scope: !1085)
!1085 = distinct !DILexicalBlock(scope: !1042, file: !10, line: 1225, column: 10)
!1086 = !DILocation(line: 1228, column: 5, scope: !1087)
!1087 = distinct !DILexicalBlock(scope: !1085, file: !10, line: 1228, column: 5)
!1088 = !DILocation(line: 1229, column: 5, scope: !1085)
!1089 = !DILocation(line: 1233, column: 3, scope: !1010)
!1090 = !{!556, !283, i64 186}
!1091 = !DILocation(line: 1263, column: 7, scope: !1092)
!1092 = distinct !DILexicalBlock(scope: !1010, file: !10, line: 1263, column: 7)
!1093 = !{!281, !283, i64 252}
!1094 = !DILocation(line: 1263, column: 25, scope: !1092)
!1095 = !DILocation(line: 1263, column: 32, scope: !1092)
!1096 = !DILocation(line: 1263, column: 42, scope: !1092)
!1097 = !DILocation(line: 1263, column: 40, scope: !1092)
!1098 = !DILocation(line: 1263, column: 7, scope: !1010)
!1099 = !DILocation(line: 1264, column: 12, scope: !1100)
!1100 = distinct !DILexicalBlock(scope: !1092, file: !10, line: 1263, column: 81)
!1101 = !DILocation(line: 1264, column: 5, scope: !1100)
!1102 = !DILocation(line: 1269, column: 17, scope: !1010)
!1103 = !{!281, !274, i64 208}
!1104 = !DILocation(line: 1269, column: 10, scope: !1010)
!1105 = !DILocation(line: 1269, column: 3, scope: !1010)
!1106 = !DILocation(line: 0, scope: !1010)
!1107 = !DILocation(line: 1270, column: 1, scope: !1010)
!1108 = !DILocation(line: 194, column: 43, scope: !2)
!1109 = !DILocation(line: 196, column: 2, scope: !2)
!1110 = !DILocation(line: 196, column: 10, scope: !2)
!1111 = !DILocation(line: 197, column: 2, scope: !2)
!1112 = !DILocation(line: 198, column: 2, scope: !1113)
!1113 = distinct !DILexicalBlock(scope: !1114, file: !3, line: 198, column: 2)
!1114 = distinct !DILexicalBlock(scope: !2, file: !3, line: 198, column: 2)
!1115 = !DILocation(line: 199, column: 2, scope: !2)
!1116 = !DILocation(line: 200, column: 1, scope: !2)
!1117 = distinct !DISubprogram(name: "ip6_output", scope: !10, file: !10, line: 1291, type: !1118, isLocal: false, isDefinition: true, scopeLine: 1293, flags: DIFlagPrototyped, isOptimized: true, unit: !9, retainedNodes: !1120)
!1118 = !DISubroutineType(types: !1119)
!1119 = !{!202, !207, !70, !70, !60, !60, !60}
!1120 = !{!1121, !1122, !1123, !1124, !1125, !1126, !1127, !1128, !1129, !1130}
!1121 = !DILocalVariable(name: "p", arg: 1, scope: !1117, file: !10, line: 1291, type: !207)
!1122 = !DILocalVariable(name: "src", arg: 2, scope: !1117, file: !10, line: 1291, type: !70)
!1123 = !DILocalVariable(name: "dest", arg: 3, scope: !1117, file: !10, line: 1291, type: !70)
!1124 = !DILocalVariable(name: "hl", arg: 4, scope: !1117, file: !10, line: 1292, type: !60)
!1125 = !DILocalVariable(name: "tc", arg: 5, scope: !1117, file: !10, line: 1292, type: !60)
!1126 = !DILocalVariable(name: "nexth", arg: 6, scope: !1117, file: !10, line: 1292, type: !60)
!1127 = !DILocalVariable(name: "netif", scope: !1117, file: !10, line: 1294, type: !181)
!1128 = !DILocalVariable(name: "ip6hdr", scope: !1117, file: !10, line: 1295, type: !97)
!1129 = !DILocalVariable(name: "src_addr", scope: !1117, file: !10, line: 1296, type: !72)
!1130 = !DILocalVariable(name: "dest_addr", scope: !1117, file: !10, line: 1296, type: !72)
!1131 = !DILocation(line: 1291, column: 25, scope: !1117)
!1132 = !DILocation(line: 1291, column: 46, scope: !1117)
!1133 = !DILocation(line: 1291, column: 69, scope: !1117)
!1134 = !DILocation(line: 1292, column: 16, scope: !1117)
!1135 = !DILocation(line: 1292, column: 25, scope: !1117)
!1136 = !DILocation(line: 1292, column: 34, scope: !1117)
!1137 = !DILocation(line: 1296, column: 3, scope: !1117)
!1138 = !DILocation(line: 1298, column: 3, scope: !1139)
!1139 = distinct !DILexicalBlock(scope: !1140, file: !10, line: 1298, column: 3)
!1140 = distinct !DILexicalBlock(scope: !1117, file: !10, line: 1298, column: 3)
!1141 = !DILocation(line: 1298, column: 3, scope: !1140)
!1142 = !DILocation(line: 1298, column: 3, scope: !1143)
!1143 = distinct !DILexicalBlock(scope: !1144, file: !10, line: 1298, column: 3)
!1144 = distinct !DILexicalBlock(scope: !1139, file: !10, line: 1298, column: 3)
!1145 = !DILocation(line: 1298, column: 3, scope: !1146)
!1146 = distinct !DILexicalBlock(scope: !1147, file: !10, line: 1298, column: 3)
!1147 = distinct !DILexicalBlock(scope: !1148, file: !10, line: 1298, column: 3)
!1148 = distinct !DILexicalBlock(scope: !1143, file: !10, line: 1298, column: 3)
!1149 = !DILocation(line: 1300, column: 12, scope: !1150)
!1150 = distinct !DILexicalBlock(scope: !1117, file: !10, line: 1300, column: 7)
!1151 = !DILocation(line: 1300, column: 7, scope: !1117)
!1152 = !DILocation(line: 1301, column: 13, scope: !1153)
!1153 = distinct !DILexicalBlock(scope: !1150, file: !10, line: 1300, column: 32)
!1154 = !DILocation(line: 1294, column: 17, scope: !1117)
!1155 = !DILocation(line: 1302, column: 3, scope: !1153)
!1156 = !DILocation(line: 1304, column: 35, scope: !1157)
!1157 = distinct !DILexicalBlock(scope: !1150, file: !10, line: 1302, column: 10)
!1158 = !DILocation(line: 1295, column: 19, scope: !1117)
!1159 = !DILocation(line: 1305, column: 5, scope: !1160)
!1160 = distinct !DILexicalBlock(scope: !1157, file: !10, line: 1305, column: 5)
!1161 = !DILocation(line: 1306, column: 5, scope: !1162)
!1162 = distinct !DILexicalBlock(scope: !1157, file: !10, line: 1306, column: 5)
!1163 = !DILocation(line: 1296, column: 14, scope: !1117)
!1164 = !DILocation(line: 1296, column: 24, scope: !1117)
!1165 = !DILocation(line: 1307, column: 13, scope: !1157)
!1166 = !DILocation(line: 0, scope: !1157)
!1167 = !DILocation(line: 1310, column: 13, scope: !1168)
!1168 = distinct !DILexicalBlock(scope: !1117, file: !10, line: 1310, column: 7)
!1169 = !DILocation(line: 1310, column: 7, scope: !1117)
!1170 = !DILocation(line: 1320, column: 5, scope: !1171)
!1171 = distinct !DILexicalBlock(scope: !1168, file: !10, line: 1310, column: 22)
!1172 = !DILocation(line: 1321, column: 5, scope: !1171)
!1173 = !DILocation(line: 1149, column: 28, scope: !967, inlinedAt: !1174)
!1174 = distinct !DILocation(line: 1324, column: 10, scope: !1117)
!1175 = !DILocation(line: 1149, column: 49, scope: !967, inlinedAt: !1174)
!1176 = !DILocation(line: 1149, column: 72, scope: !967, inlinedAt: !1174)
!1177 = !DILocation(line: 1150, column: 19, scope: !967, inlinedAt: !1174)
!1178 = !DILocation(line: 1150, column: 28, scope: !967, inlinedAt: !1174)
!1179 = !DILocation(line: 1151, column: 19, scope: !967, inlinedAt: !1174)
!1180 = !DILocation(line: 1151, column: 40, scope: !967, inlinedAt: !1174)
!1181 = !DILocation(line: 1153, column: 21, scope: !967, inlinedAt: !1174)
!1182 = !DILocation(line: 1154, column: 12, scope: !988, inlinedAt: !1174)
!1183 = !DILocation(line: 1155, column: 13, scope: !990, inlinedAt: !1174)
!1184 = !DILocation(line: 1154, column: 7, scope: !967, inlinedAt: !1174)
!1185 = !DILocation(line: 1155, column: 24, scope: !990, inlinedAt: !1174)
!1186 = !DILocation(line: 1155, column: 9, scope: !991, inlinedAt: !1174)
!1187 = !DILocation(line: 1156, column: 18, scope: !996, inlinedAt: !1174)
!1188 = !DILocation(line: 1157, column: 21, scope: !998, inlinedAt: !1174)
!1189 = !DILocation(line: 1157, column: 30, scope: !998, inlinedAt: !1174)
!1190 = !DILocation(line: 1157, column: 33, scope: !998, inlinedAt: !1174)
!1191 = !DILocation(line: 1157, column: 11, scope: !996, inlinedAt: !1174)
!1192 = !DILocation(line: 1160, column: 9, scope: !1003, inlinedAt: !1174)
!1193 = !DILocation(line: 1161, column: 9, scope: !1003, inlinedAt: !1174)
!1194 = !DILocation(line: 0, scope: !967, inlinedAt: !1174)
!1195 = !DILocation(line: 1165, column: 10, scope: !967, inlinedAt: !1174)
!1196 = !DILocation(line: 1165, column: 3, scope: !967, inlinedAt: !1174)
!1197 = !DILocation(line: 0, scope: !1117)
!1198 = !DILocation(line: 1325, column: 1, scope: !1117)
!1199 = distinct !DISubprogram(name: "ip6_options_add_hbh_ra", scope: !10, file: !10, line: 1403, type: !1200, isLocal: false, isDefinition: true, scopeLine: 1404, flags: DIFlagPrototyped, isOptimized: true, unit: !9, retainedNodes: !1202)
!1200 = !DISubroutineType(types: !1201)
!1201 = !{!202, !207, !60, !60}
!1202 = !{!1203, !1204, !1205, !1206, !1207, !1208, !1209, !1210}
!1203 = !DILocalVariable(name: "p", arg: 1, scope: !1199, file: !10, line: 1403, type: !207)
!1204 = !DILocalVariable(name: "nexth", arg: 2, scope: !1199, file: !10, line: 1403, type: !60)
!1205 = !DILocalVariable(name: "value", arg: 3, scope: !1199, file: !10, line: 1403, type: !60)
!1206 = !DILocalVariable(name: "opt_data", scope: !1199, file: !10, line: 1405, type: !125)
!1207 = !DILocalVariable(name: "offset", scope: !1199, file: !10, line: 1406, type: !67)
!1208 = !DILocalVariable(name: "hbh_hdr", scope: !1199, file: !10, line: 1407, type: !115)
!1209 = !DILocalVariable(name: "opt_hdr", scope: !1199, file: !10, line: 1408, type: !120)
!1210 = !DILocalVariable(name: "hlen", scope: !1199, file: !10, line: 1411, type: !528)
!1211 = !DILocation(line: 1403, column: 37, scope: !1199)
!1212 = !DILocation(line: 1403, column: 45, scope: !1199)
!1213 = !DILocation(line: 1403, column: 57, scope: !1199)
!1214 = !DILocation(line: 1406, column: 9, scope: !1199)
!1215 = !DILocation(line: 1411, column: 14, scope: !1199)
!1216 = !DILocation(line: 1413, column: 7, scope: !1217)
!1217 = distinct !DILexicalBlock(scope: !1199, file: !10, line: 1413, column: 7)
!1218 = !DILocation(line: 1413, column: 7, scope: !1199)
!1219 = !DILocation(line: 1415, column: 5, scope: !1220)
!1220 = distinct !DILexicalBlock(scope: !1217, file: !10, line: 1413, column: 62)
!1221 = !DILocation(line: 1416, column: 5, scope: !1220)
!1222 = !DILocation(line: 1420, column: 38, scope: !1199)
!1223 = !DILocation(line: 1407, column: 23, scope: !1199)
!1224 = !DILocation(line: 1421, column: 26, scope: !1199)
!1225 = !{!697, !275, i64 0}
!1226 = !DILocation(line: 1422, column: 12, scope: !1199)
!1227 = !DILocation(line: 1422, column: 18, scope: !1199)
!1228 = !DILocation(line: 1426, column: 52, scope: !1199)
!1229 = !DILocation(line: 1408, column: 23, scope: !1199)
!1230 = !DILocation(line: 1427, column: 25, scope: !1199)
!1231 = !DILocation(line: 1428, column: 3, scope: !1199)
!1232 = !DILocation(line: 1428, column: 25, scope: !1199)
!1233 = !DILocation(line: 1432, column: 30, scope: !1199)
!1234 = !DILocation(line: 1405, column: 9, scope: !1199)
!1235 = !DILocation(line: 1433, column: 15, scope: !1199)
!1236 = !DILocation(line: 1434, column: 3, scope: !1199)
!1237 = !DILocation(line: 1434, column: 15, scope: !1199)
!1238 = !DILocation(line: 1438, column: 52, scope: !1199)
!1239 = !DILocation(line: 1439, column: 25, scope: !1199)
!1240 = !DILocation(line: 1440, column: 3, scope: !1199)
!1241 = !DILocation(line: 1440, column: 25, scope: !1199)
!1242 = !DILocation(line: 1442, column: 3, scope: !1199)
!1243 = !DILocation(line: 0, scope: !1199)
!1244 = !DILocation(line: 1443, column: 1, scope: !1199)
