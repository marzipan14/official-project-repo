...
; <label>:26:                                     ; preds = %21
  ...
  %31 = select i1 %30, i32 -1, i32 %22, !dbg !303
  br label %32, !dbg !303

; <label>:32:                                     ; preds = %26, %21
  %33 = phi i32 [ %22, %21 ], [ %31, %26 ], !dbg !304
  %34 = load i16, i16* %15, align 8, !dbg !305, !tbaa !279
  %35 = trunc i16 %34 to i8, !dbg !307
  %36 = icmp slt i8 %35, 0, !dbg !307
  br i1 %36, label %37, label %40, !dbg !308

; <label>:37:                                     ; preds = %32
  %38 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %1, i64 0, i32 5, i32 0, !dbg !309
  %39 = load i8*, i8** %38, align 8, !dbg !309, !tbaa !310
  call void @free(i8* %39) #4, !dbg !309
  br label %40, !dbg !309

; <label>:40:                                     ; preds = %37, %32
  %41 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %1, i64 0, i32 12, i32 0, !dbg !311
  %42 = load i8*, i8** %41, align 8, !dbg !311, !tbaa !313
  %43 = icmp eq i8* %42, null, !dbg !311
  br i1 %43, label %49, label %44, !dbg !314

; <label>:44:                                     ; preds = %40
  %45 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %1, i64 0, i32 15, i64 0, !dbg !315
  %46 = icmp eq i8* %42, %45, !dbg !315
  br i1 %46, label %48, label %47, !dbg !318

; <label>:47:                                     ; preds = %44
  call void @free(i8* nonnull %42) #4, !dbg !315
  br label %48, !dbg !315

; <label>:48:                                     ; preds = %44, %47
  store i8* null, i8** %41, align 8, !dbg !318, !tbaa !313
  br label %49, !dbg !318

; <label>:49:                                     ; preds = %40, %48
  %50 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %1, i64 0, i32 17, i32 0, !dbg !319
  %51 = load i8*, i8** %50, align 8, !dbg !319, !tbaa !321
  %52 = icmp eq i8* %51, null, !dbg !319
  br i1 %52, label %54, label %53, !dbg !322

; <label>:53:                                     ; preds = %49
  call void @free(i8* nonnull %51) #4, !dbg !323
  store i8* null, i8** %50, align 8, !dbg !323, !tbaa !321
  br label %54, !dbg !323

; <label>:54:                                     ; preds = %49, %53
  call void @__sfp_lock_acquire() #4, !dbg !325
  store i16 0, i16* %15, align 8, !dbg !326, !tbaa !279
  call void @__sfp_lock_release() #4, !dbg !327
  %55 = load i32, i32* %3, align 4, !dbg !328, !tbaa !289
  %56 = call i32 @pthread_setcancelstate(i32 %55, i32* nonnull %3) #4, !dbg !329
  br label %57, !dbg !330

; <label>:57:                                     ; preds = %54, %18
  %58 = phi i32 [ 0, %18 ], [ %33, %54 ], !dbg !304
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %13) #5, !dbg !331
  br label %59
...
; Function Attrs: noredzone nounwind
define dso_local i32 @fclose(%struct.__sFILE*) local_unnamed_addr #0 !dbg !333 {
  %2 = tail call %struct._reent* @__getreent() #4, !dbg !339
  %3 = tail call i32 @_fclose_r(%struct._reent* %2, %struct.__sFILE* %0) #6, !dbg !340
  ret i32 %3, !dbg !341
}
...
!304 = !DILocation(line: 0, scope: !29)
!305 = !DILocation(line: 108, column: 11, scope: !306)
!306 = distinct !DILexicalBlock(scope: !29, file: !1, line: 108, column: 7)
!307 = !DILocation(line: 108, column: 18, scope: !306)
!308 = !DILocation(line: 108, column: 7, scope: !29)
!309 = !DILocation(line: 109, column: 5, scope: !306)
!310 = !{!280, !270, i64 24}
!311 = !DILocation(line: 110, column: 7, scope: !312)
!312 = distinct !DILexicalBlock(scope: !29, file: !1, line: 110, column: 7)
!313 = !{!280, !270, i64 88}
!314 = !DILocation(line: 110, column: 7, scope: !29)
!315 = !DILocation(line: 111, column: 5, scope: !316)
!316 = distinct !DILexicalBlock(scope: !317, file: !1, line: 111, column: 5)
!317 = distinct !DILexicalBlock(scope: !312, file: !1, line: 111, column: 5)
!318 = !DILocation(line: 111, column: 5, scope: !317)
!319 = !DILocation(line: 112, column: 7, scope: !320)
!320 = distinct !DILexicalBlock(scope: !29, file: !1, line: 112, column: 7)
!321 = !{!280, !270, i64 120}
!322 = !DILocation(line: 112, column: 7, scope: !29)
!323 = !DILocation(line: 113, column: 5, scope: !324)
!324 = distinct !DILexicalBlock(scope: !320, file: !1, line: 113, column: 5)
!325 = !DILocation(line: 114, column: 3, scope: !29)
!326 = !DILocation(line: 115, column: 14, scope: !29)
!327 = !DILocation(line: 122, column: 3, scope: !29)
!328 = !DILocation(line: 124, column: 27, scope: !29)
!329 = !DILocation(line: 124, column: 3, scope: !29)
!330 = !DILocation(line: 127, column: 3, scope: !29)
!331 = !DILocation(line: 128, column: 1, scope: !29)
!332 = !DILocation(line: 0, scope: !288)
!333 = distinct !DISubprogram(name: "fclose", scope: !1, file: !1, line: 133, type: !334, isLocal: false, isDefinition: true, scopeLine: 135, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !336)
!334 = !DISubroutineType(types: !335)
!335 = !{!5, !248}
!336 = !{!337}
!337 = !DILocalVariable(name: "fp", arg: 1, scope: !333, file: !1, line: 133, type: !248)
!338 = !DILocation(line: 133, column: 1, scope: !333)
!339 = !DILocation(line: 136, column: 20, scope: !333)
!340 = !DILocation(line: 136, column: 10, scope: !333)
!341 = !DILocation(line: 136, column: 3, scope: !333)
