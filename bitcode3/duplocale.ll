...
define dso_local nonnull %struct.__locale_t* @_duplocale_r(%struct._reent* nocapture readnone, %struct.__locale_t* nocapture readnone) local_unnamed_addr #0 !dbg !7 {
  ret %struct.__locale_t* @__global_locale, !dbg !298
}

; Function Attrs: noredzone nounwind
define dso_local nonnull %struct.__locale_t* @duplocale(%struct.__locale_t* nocapture readnone) local_unnamed_addr #1 !dbg !299 {
  %2 = tail call %struct._reent* @__getreent() #4, !dbg !307
  ret %struct.__locale_t* @__global_locale, !dbg !308
}
...
!298 = !DILocation(line: 49, column: 3, scope: !7)
!299 = distinct !DISubprogram(name: "duplocale", scope: !1, file: !1, line: 98, type: !300, isLocal: false, isDefinition: true, scopeLine: 99, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !304)
!300 = !DISubroutineType(types: !301)
!301 = !{!302, !10}
!302 = !DIDerivedType(tag: DW_TAG_typedef, name: "locale_t", file: !303, line: 10, baseType: !10)
!303 = !DIFile(filename: "/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/include/xlocale.h", directory: "/root/.unikraft/apps/redis/build")
!304 = !{!305}
!305 = !DILocalVariable(name: "locobj", arg: 1, scope: !299, file: !1, line: 98, type: !10)
!306 = !DILocation(line: 98, column: 31, scope: !299)
!307 = !DILocation(line: 100, column: 24, scope: !299)
!308 = !DILocation(line: 100, column: 3, scope: !299)
