...
; <label>:150:                                    ; preds = %135, %142
  %151 = tail call i8* @memp_malloc(i32 13) #8, !dbg !723
  %152 = bitcast i8* %151 to %struct.ip6_reassdata*, !dbg !724
  %153 = icmp eq i8* %151, null, !dbg !725
  br i1 %153, label %479, label %154, !dbg !727

; <label>:154:                                    ; preds = %150
  %155 = load %struct.ip6_reassdata*, %struct.ip6_reassdata** @reassdatagrams, align 8, !dbg !728, !tbaa !351
  br label %156, !dbg !731

; <label>:156:                                    ; preds = %159, %154
  %157 = phi %struct.ip6_reassdata* [ %155, %154 ], [ %161, %159 ], !dbg !732
  %158 = icmp eq %struct.ip6_reassdata* %157, null, !dbg !734
  br i1 %158, label %163, label %159, !dbg !735

; <label>:159:                                    ; preds = %156
  %160 = getelementptr inbounds %struct.ip6_reassdata, %struct.ip6_reassdata* %157, i64 0, i32 0, !dbg !736
  %161 = load %struct.ip6_reassdata*, %struct.ip6_reassdata** %160, align 8, !dbg !736, !tbaa !371
  %162 = icmp eq %struct.ip6_reassdata* %161, %152, !dbg !739
  br i1 %162, label %163, label %156, !dbg !740, !llvm.loop !741

; <label>:163:                                    ; preds = %156, %159, %108
  %164 = phi %struct.ip6_reassdata* [ %109, %108 ], [ null, %156 ], [ %157, %159 ], !dbg !743
  %165 = phi i8* [ %110, %108 ], [ %151, %159 ], [ %151, %156 ], !dbg !744
  %166 = phi %struct.ip6_reassdata* [ %111, %108 ], [ %152, %159 ], [ %152, %156 ], !dbg !744
  %167 = tail call i8* @memset(i8* %165, i32 0, i64 88) #8, !dbg !745
  %168 = getelementptr inbounds %struct.ip6_reassdata, %struct.ip6_reassdata* %166, i64 0, i32 9, !dbg !746
  store i8 60, i8* %168, align 1, !dbg !747, !tbaa !361
  %169 = load i64, i64* bitcast (%struct.ip6_reassdata** @reassdatagrams to i64*), align 8, !dbg !748, !tbaa !351
  %170 = bitcast %struct.ip6_reassdata* %166 to i64*, !dbg !749
  store i64 %169, i64* %170, align 8, !dbg !749, !tbaa !371
  store i8* %165, i8** bitcast (%struct.ip6_reassdata** @reassdatagrams to i8**), align 8, !dbg !750, !tbaa !351
  %171 = load i64, i64* bitcast (%struct.ip6_hdr** getelementptr inbounds (%struct.ip_globals, %struct.ip_globals* @ip_data, i64 0, i32 3) to i64*), align 8, !dbg !751, !tbaa !592
  %172 = getelementptr inbounds %struct.ip6_reassdata, %struct.ip6_reassdata* %166, i64 0, i32 2, !dbg !752
  %173 = bitcast %struct.ip6_hdr** %172 to i64*, !dbg !753
  store i64 %171, i64* %173, align 8, !dbg !753, !tbaa !419
  %174 = getelementptr inbounds %struct.ip6_reassdata, %struct.ip6_reassdata* %166, i64 0, i32 3, !dbg !754
  %175 = bitcast %struct.ip6_addr_packed* %174 to i8*, !dbg !754
  %176 = inttoptr i64 %171 to %struct.ip6_hdr*, !dbg !754
  %177 = getelementptr inbounds %struct.ip6_hdr, %struct.ip6_hdr* %176, i64 0, i32 4, !dbg !754
  %178 = bitcast %struct.ip6_addr_packed* %177 to i8*, !dbg !754
  %179 = tail call i8* @memcpy(i8* nonnull %175, i8* nonnull %178, i64 16) #8, !dbg !754
  %180 = getelementptr inbounds %struct.ip6_reassdata, %struct.ip6_reassdata* %166, i64 0, i32 4, !dbg !755
  %181 = bitcast %struct.ip6_addr_packed* %180 to i8*, !dbg !755
  %182 = load %struct.ip6_hdr*, %struct.ip6_hdr** getelementptr inbounds (%struct.ip_globals, %struct.ip_globals* @ip_data, i64 0, i32 3), align 8, !dbg !755, !tbaa !592
  %183 = getelementptr inbounds %struct.ip6_hdr, %struct.ip6_hdr* %182, i64 0, i32 5, !dbg !755
  %184 = bitcast %struct.ip6_addr_packed* %183 to i8*, !dbg !755
  %185 = tail call i8* @memcpy(i8* nonnull %181, i8* nonnull %184, i64 16) #8, !dbg !755
  %186 = load i8, i8* getelementptr inbounds (%struct.ip_globals, %struct.ip_globals* @ip_data, i64 0, i32 5, i32 0, i32 0, i32 1), align 4, !dbg !756, !tbaa !757
  %187 = getelementptr inbounds %struct.ip6_reassdata, %struct.ip6_reassdata* %166, i64 0, i32 10, !dbg !758
  store i8 %186, i8* %187, align 8, !dbg !759, !tbaa !439
  %188 = load i8, i8* getelementptr inbounds (%struct.ip_globals, %struct.ip_globals* @ip_data, i64 0, i32 6, i32 0, i32 0, i32 1), align 4, !dbg !760, !tbaa !757
  %189 = getelementptr inbounds %struct.ip6_reassdata, %struct.ip6_reassdata* %166, i64 0, i32 11, !dbg !761
  store i8 %188, i8* %189, align 1, !dbg !762, !tbaa !445
  %190 = getelementptr inbounds %struct.ip6_frag_hdr, %struct.ip6_frag_hdr* %11, i64 0, i32 3, !dbg !763
  %191 = load i32, i32* %190, align 1, !dbg !763, !tbaa !642
  %192 = getelementptr inbounds %struct.ip6_reassdata, %struct.ip6_reassdata* %166, i64 0, i32 6, !dbg !764
  store i32 %191, i32* %192, align 8, !dbg !765, !tbaa !646
  %193 = getelementptr inbounds %struct.ip6_frag_hdr, %struct.ip6_frag_hdr* %11, i64 0, i32 0, !dbg !766
  %194 = load i8, i8* %193, align 1, !dbg !766, !tbaa !767
  %195 = getelementptr inbounds %struct.ip6_reassdata, %struct.ip6_reassdata* %166, i64 0, i32 8, !dbg !768
  store i8 %194, i8* %195, align 2, !dbg !769, !tbaa !770
  br label %196, !dbg !771

; <label>:196:                                    ; preds = %101, %163
  %197 = phi %struct.ip6_reassdata* [ %164, %163 ], [ %57, %101 ], !dbg !743
  %198 = phi %struct.ip6_reassdata* [ %166, %163 ], [ %56, %101 ], !dbg !743
  %199 = load i16, i16* @ip6_reass_pbufcount, align 2, !dbg !772, !tbaa !508
  %200 = zext i16 %199 to i32, !dbg !772
  %201 = zext i16 %12 to i32, !dbg !774
  %202 = add nuw nsw i32 %200, %201, !dbg !775
  %203 = icmp ugt i32 %202, 10, !dbg !776
  br i1 %203, label %204, label %256, !dbg !777

; <label>:204:                                    ; preds = %196
  %205 = load %struct.ip6_reassdata*, %struct.ip6_reassdata** @reassdatagrams, align 8, !dbg !782, !tbaa !351
  br label %206, !dbg !783

; <label>:206:                                    ; preds = %237, %204
  %207 = phi i16 [ %238, %237 ], [ %199, %204 ]
  %208 = phi %struct.ip6_reassdata* [ %239, %237 ], [ %205, %204 ]
  %209 = icmp eq %struct.ip6_reassdata* %208, null, !dbg !786
  br i1 %209, label %226, label %210, !dbg !787

; <label>:210:                                    ; preds = %206, %221
  %211 = phi %struct.ip6_reassdata* [ %222, %221 ], [ %208, %206 ]
  %212 = phi %struct.ip6_reassdata* [ %224, %221 ], [ %208, %206 ]
  %213 = icmp eq %struct.ip6_reassdata* %212, %198, !dbg !788
  br i1 %213, label %221, label %214, !dbg !789

; <label>:214:                                    ; preds = %210
  %215 = getelementptr inbounds %struct.ip6_reassdata, %struct.ip6_reassdata* %212, i64 0, i32 9, !dbg !790
  %216 = load i8, i8* %215, align 1, !dbg !790, !tbaa !361
  %217 = getelementptr inbounds %struct.ip6_reassdata, %struct.ip6_reassdata* %211, i64 0, i32 9, !dbg !791
  %218 = load i8, i8* %217, align 1, !dbg !791, !tbaa !361
  %219 = icmp ugt i8 %216, %218, !dbg !792
  %220 = select i1 %219, %struct.ip6_reassdata* %211, %struct.ip6_reassdata* %212, !dbg !793
  br label %221, !dbg !793

; <label>:221:                                    ; preds = %214, %210
  %222 = phi %struct.ip6_reassdata* [ %211, %210 ], [ %220, %214 ], !dbg !794
  %223 = getelementptr inbounds %struct.ip6_reassdata, %struct.ip6_reassdata* %212, i64 0, i32 0, !dbg !795
  %224 = load %struct.ip6_reassdata*, %struct.ip6_reassdata** %223, align 8, !dbg !795, !tbaa !371
  %225 = icmp eq %struct.ip6_reassdata* %224, null, !dbg !786
  br i1 %225, label %226, label %210, !dbg !787, !llvm.loop !699

; <label>:226:                                    ; preds = %221, %206
  %227 = phi %struct.ip6_reassdata* [ null, %206 ], [ %222, %221 ], !dbg !796
  %228 = icmp eq %struct.ip6_reassdata* %227, %198, !dbg !797
  br i1 %228, label %229, label %232, !dbg !798

; <label>:229:                                    ; preds = %226
  %230 = zext i16 %207 to i32, !dbg !799
  %231 = add nuw nsw i32 %230, %201, !dbg !801
  br label %245, !dbg !798

; <label>:232:                                    ; preds = %226
  %233 = icmp eq %struct.ip6_reassdata* %227, null, !dbg !802
  br i1 %233, label %237, label %234, !dbg !803

; <label>:234:                                    ; preds = %232
  tail call fastcc void @ip6_reass_free_complete_datagram(%struct.ip6_reassdata* nonnull %227) #8, !dbg !804
  %235 = load %struct.ip6_reassdata*, %struct.ip6_reassdata** @reassdatagrams, align 8, !dbg !805
  %236 = load i16, i16* @ip6_reass_pbufcount, align 2, !dbg !806, !tbaa !508
  br label %237, !dbg !807

; <label>:237:                                    ; preds = %234, %232
  %238 = phi i16 [ %207, %232 ], [ %236, %234 ], !dbg !806
  %239 = phi %struct.ip6_reassdata* [ %208, %232 ], [ %235, %234 ], !dbg !805
  %240 = zext i16 %238 to i32, !dbg !806
  %241 = add nuw nsw i32 %240, %201, !dbg !808
  %242 = icmp ugt i32 %241, 10, !dbg !809
  %243 = icmp ne %struct.ip6_reassdata* %239, null, !dbg !810
  %244 = and i1 %243, %242, !dbg !811
  br i1 %244, label %206, label %245, !dbg !812, !llvm.loop !720

; <label>:245:                                    ; preds = %237, %229
  %246 = phi i32 [ %231, %229 ], [ %241, %237 ], !dbg !801
  %247 = phi %struct.ip6_reassdata* [ %208, %229 ], [ %239, %237 ]
  %248 = icmp ult i32 %246, 11, !dbg !813
  br i1 %248, label %249, label %479, !dbg !814

; <label>:249:                                    ; preds = %245, %252
  %250 = phi %struct.ip6_reassdata* [ %254, %252 ], [ %247, %245 ], !dbg !815
  %251 = icmp eq %struct.ip6_reassdata* %250, null, !dbg !819
  br i1 %251, label %256, label %252, !dbg !820

; <label>:252:                                    ; preds = %249
  %253 = getelementptr inbounds %struct.ip6_reassdata, %struct.ip6_reassdata* %250, i64 0, i32 0, !dbg !821
  %254 = load %struct.ip6_reassdata*, %struct.ip6_reassdata** %253, align 8, !dbg !821, !tbaa !371
  %255 = icmp eq %struct.ip6_reassdata* %254, %198, !dbg !824
  br i1 %255, label %256, label %249, !dbg !825, !llvm.loop !826

; <label>:256:                                    ; preds = %249, %252, %196
  %257 = phi %struct.ip6_reassdata* [ %197, %196 ], [ null, %249 ], [ %250, %252 ], !dbg !828
  %258 = tail call zeroext i8 @pbuf_header_force(%struct.pbuf* %0, i16 signext 4) #8, !dbg !829
  %259 = icmp eq i8 %258, 0, !dbg !831
  br i1 %259, label %261, label %260, !dbg !834

; <label>:260:                                    ; preds = %256
  tail call void (i8*, ...) @uk_pr_crit(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.4, i64 0, i64 0)) #7, !dbg !835
  ...
  tail call void @ukplat_terminate(i32 3) #9, !dbg !838
  unreachable, !dbg !838

; <label>:261:                                    ; preds = %256
  %262 = bitcast i8** %9 to %struct.ip6_reass_helper**, !dbg !842
  %263 = load %struct.ip6_reass_helper*, %struct.ip6_reass_helper** %262, align 8, !dbg !842, !tbaa !404
  %264 = add i16 %35, %36, !dbg !845
  %265 = getelementptr inbounds %struct.ip6_reassdata, %struct.ip6_reassdata* %198, i64 0, i32 1, !dbg !847
  %266 = load %struct.pbuf*, %struct.pbuf** %265, align 1, !dbg !850, !tbaa !351
  %267 = icmp eq %struct.pbuf* %266, null, !dbg !853
  %268 = bitcast %struct.ip6_reass_helper* %263 to i8*, !dbg !854
  br i1 %267, label %317, label %269, !dbg !854
...
; <label>:269:                                    ; preds = %261, %303
  ...
  %273 = getelementptr inbounds %struct.pbuf, %struct.pbuf* %270, i64 0, i32 1, !dbg !855
  %274 = bitcast i8** %273 to %struct.ip6_reass_helper**, !dbg !855
  %275 = load %struct.ip6_reass_helper*, %struct.ip6_reass_helper** %274, align 8, !dbg !855, !tbaa !404
  %276 = getelementptr inbounds %struct.ip6_reass_helper, %struct.ip6_reass_helper* %275, i64 0, i32 1, !dbg !857
  %277 = load i16, i16* %276, align 1, !dbg !857, !tbaa !408
  %278 = icmp ult i16 %36, %277, !dbg !859
  br i1 %278, label %279, label %290, !dbg !860

; <label>:279:                                    ; preds = %269
  %280 = icmp ugt i16 %264, %277, !dbg !861
  br i1 %280, label %479, label %281, !dbg !864

; <label>:281:                                    ; preds = %279
  %282 = icmp eq %struct.ip6_reass_helper* %272, null, !dbg !865
  br i1 %282, label %289, label %283, !dbg !867

; <label>:283:                                    ; preds = %281
  %284 = getelementptr inbounds %struct.ip6_reass_helper, %struct.ip6_reass_helper* %272, i64 0, i32 2, !dbg !868
  %285 = load i16, i16* %284, align 1, !dbg !868, !tbaa !871
  %286 = icmp ult i16 %36, %285, !dbg !872
  br i1 %286, label %479, label %287, !dbg !873

; <label>:287:                                    ; preds = %283
  %288 = getelementptr inbounds %struct.ip6_reass_helper, %struct.ip6_reass_helper* %272, i64 0, i32 0, !dbg !874
  store %struct.pbuf* %0, %struct.pbuf** %288, align 1, !dbg !877, !tbaa !414
  br label %318, !dbg !878

; <label>:289:                                    ; preds = %281
  store %struct.pbuf* %0, %struct.pbuf** %265, align 8, !dbg !879, !tbaa !402
  br label %318

; <label>:290:                                    ; preds = %269
  %291 = icmp eq i16 %36, %277, !dbg !881
  br i1 %291, label %483, label %292, !dbg !883

; <label>:292:                                    ; preds = %290
  %293 = getelementptr inbounds %struct.ip6_reass_helper, %struct.ip6_reass_helper* %275, i64 0, i32 2, !dbg !884
  %294 = load i16, i16* %293, align 1, !dbg !884, !tbaa !871
  %295 = icmp ult i16 %36, %294, !dbg !886
  br i1 %295, label %479, label %296, !dbg !887

; <label>:296:                                    ; preds = %292
  %297 = icmp eq %struct.ip6_reass_helper* %272, null, !dbg !888
  br i1 %297, label %303, label %298, !dbg !891

; <label>:298:                                    ; preds = %296
  %299 = getelementptr inbounds %struct.ip6_reass_helper, %struct.ip6_reass_helper* %272, i64 0, i32 2, !dbg !892
  %300 = load i16, i16* %299, align 1, !dbg !892, !tbaa !871
  %301 = icmp eq i16 %300, %277, !dbg !895
  %302 = select i1 %301, i8 %271, i8 0, !dbg !896
  br label %303, !dbg !896

; <label>:303:                                    ; preds = %298, %296
  %304 = phi i8 [ %271, %296 ], [ %302, %298 ], !dbg !897
  %305 = getelementptr inbounds %struct.ip6_reass_helper, %struct.ip6_reass_helper* %275, i64 0, i32 0, !dbg !898
  %306 = load %struct.pbuf*, %struct.pbuf** %305, align 1, !dbg !850, !tbaa !351
  %307 = icmp eq %struct.pbuf* %306, null, !dbg !853
  br i1 %307, label %308, label %269, !dbg !854, !llvm.loop !899

; <label>:308:                                    ; preds = %303
  %309 = getelementptr inbounds %struct.ip6_reass_helper, %struct.ip6_reass_helper* %275, i64 0, i32 2, !dbg !901
  %310 = load i16, i16* %309, align 1, !dbg !901, !tbaa !871
  %311 = icmp ugt i16 %310, %36, !dbg !901
  br i1 %311, label %312, label %313, !dbg !908

; <label>:312:                                    ; preds = %308
  tail call void (i8*, ...) @uk_pr_crit(i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.5, i64 0, i64 0)) #7, !dbg !909
  tail call void (i8*, ...) @uk_pr_crit(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.1, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0)) #7, !dbg !912
  tail call void @ukplat_terminate(i32 3) #9, !dbg !912
  unreachable, !dbg !912

; <label>:313:                                    ; preds = %308
  %314 = getelementptr inbounds %struct.ip6_reass_helper, %struct.ip6_reass_helper* %275, i64 0, i32 0, !dbg !916
  store %struct.pbuf* %0, %struct.pbuf** %314, align 1, !dbg !917, !tbaa !414
  %315 = icmp eq i16 %310, %36, !dbg !918
  %316 = select i1 %315, i8 %304, i8 0, !dbg !920
  br label %318, !dbg !920

; <label>:317:                                    ; preds = %261
  store %struct.pbuf* %0, %struct.pbuf** %265, align 8, !dbg !921, !tbaa !402
  br label %318

; <label>:318:                                    ; preds = %289, %287, %313, %317
  %319 = phi %struct.pbuf* [ null, %317 ], [ null, %313 ], [ %270, %287 ], [ %270, %289 ]
  %320 = phi i8 [ 1, %317 ], [ %316, %313 ], [ %271, %287 ], [ %271, %289 ], !dbg !897
  %321 = load i16, i16* @ip6_reass_pbufcount, align 2, !dbg !923, !tbaa !508
  %322 = add i16 %321, %12, !dbg !924
  store i16 %322, i16* @ip6_reass_pbufcount, align 2, !dbg !925, !tbaa !508
  %323 = icmp eq i16 %36, 0, !dbg !926
  br i1 %323, label %324, label %330, !dbg !928

; <label>:324:                                    ; preds = %318
  %325 = load i64, i64* bitcast (%struct.ip6_hdr** getelementptr inbounds (%struct.ip_globals, %struct.ip_globals* @ip_data, i64 0, i32 3) to i64*), align 8, !dbg !929, !tbaa !592
  %326 = getelementptr inbounds %struct.ip6_reassdata, %struct.ip6_reassdata* %198, i64 0, i32 2, !dbg !931
  %327 = bitcast %struct.ip6_hdr** %326 to i64*, !dbg !932
  store i64 %325, i64* %327, align 8, !dbg !932, !tbaa !419
  %328 = getelementptr inbounds %struct.ip6_reassdata, %struct.ip6_reassdata* %198, i64 0, i32 5, i64 0, !dbg !933
  %329 = tail call i8* @memcpy(i8* nonnull %328, i8* %268, i64 12) #8, !dbg !933
  br label %330, !dbg !934

; <label>:330:                                    ; preds = %324, %318
  %331 = getelementptr inbounds %struct.ip6_reass_helper, %struct.ip6_reass_helper* %263, i64 0, i32 0, !dbg !935
  store %struct.pbuf* %319, %struct.pbuf** %331, align 1, !dbg !936, !tbaa !414
  %332 = getelementptr inbounds %struct.ip6_reass_helper, %struct.ip6_reass_helper* %263, i64 0, i32 1, !dbg !937
  store i16 %36, i16* %332, align 1, !dbg !938, !tbaa !408
  %333 = getelementptr inbounds %struct.ip6_reass_helper, %struct.ip6_reass_helper* %263, i64 0, i32 2, !dbg !939
  store i16 %264, i16* %333, align 1, !dbg !940, !tbaa !871
  %334 = and i16 %15, 1, !dbg !941
  %335 = icmp eq i16 %334, 0, !dbg !943
  %336 = getelementptr inbounds %struct.ip6_reassdata, %struct.ip6_reassdata* %198, i64 0, i32 7
  br i1 %335, label %339, label %337, !dbg !944

; <label>:337:                                    ; preds = %330
  %338 = load i16, i16* %336, align 4, !dbg !945, !tbaa !947
  br label %340, !dbg !944

; <label>:339:                                    ; preds = %330
  store i16 %264, i16* %336, align 4, !dbg !948, !tbaa !947
  br label %340, !dbg !950

; <label>:340:                                    ; preds = %337, %339
  %341 = phi i16 [ %338, %337 ], [ %264, %339 ], !dbg !945
  %342 = load %struct.pbuf*, %struct.pbuf** %265, align 8, !dbg !951, !tbaa !402
  %343 = getelementptr inbounds %struct.pbuf, %struct.pbuf* %342, i64 0, i32 1, !dbg !952
  %344 = bitcast i8** %343 to %struct.ip6_reass_helper**, !dbg !952
  %345 = load %struct.ip6_reass_helper*, %struct.ip6_reass_helper** %344, align 8, !dbg !952, !tbaa !404
  %346 = getelementptr inbounds %struct.ip6_reass_helper, %struct.ip6_reass_helper* %345, i64 0, i32 1, !dbg !953
  %347 = load i16, i16* %346, align 1, !dbg !953, !tbaa !408
  %348 = icmp eq i16 %347, 0, !dbg !955
  %349 = select i1 %348, i8 %320, i8 0, !dbg !956
  %350 = icmp eq i16 %341, 0, !dbg !957
  %351 = select i1 %350, i8 0, i8 %349, !dbg !958
  %352 = icmp ne %struct.pbuf* %319, null, !dbg !959
  %353 = icmp ne i8 %351, 0, !dbg !960
  %354 = and i1 %353, %352, !dbg !960
  %355 = bitcast %struct.ip6_reass_helper* %345 to i8*, !dbg !961
  br i1 %354, label %356, label %377, !dbg !961

; <label>:356:                                    ; preds = %340
  %357 = getelementptr inbounds %struct.pbuf, %struct.pbuf* %319, i64 0, i32 1, !dbg !962
  %358 = bitcast i8** %357 to %struct.ip6_reass_helper**, !dbg !962
  %359 = load %struct.ip6_reass_helper*, %struct.ip6_reass_helper** %358, align 8, !dbg !962, !tbaa !404
  %360 = getelementptr inbounds %struct.ip6_reass_helper, %struct.ip6_reass_helper* %359, i64 0, i32 1, !dbg !964
  %361 = load i16, i16* %360, align 1, !dbg !964, !tbaa !408
  %362 = icmp eq i16 %264, %361, !dbg !966
  br i1 %362, label %363, label %487, !dbg !967

; <label>:363:                                    ; preds = %356, %368
  %364 = phi %struct.ip6_reass_helper* [ %373, %368 ], [ %359, %356 ]
  %365 = getelementptr inbounds %struct.ip6_reass_helper, %struct.ip6_reass_helper* %364, i64 0, i32 0, !dbg !968
  %366 = load %struct.pbuf*, %struct.pbuf** %365, align 1, !dbg !969, !tbaa !414
  %367 = icmp eq %struct.pbuf* %366, null, !dbg !959
  br i1 %367, label %377, label %368, !dbg !961, !llvm.loop !970

; <label>:368:                                    ; preds = %363
  %369 = getelementptr inbounds %struct.ip6_reass_helper, %struct.ip6_reass_helper* %364, i64 0, i32 2
  %370 = load i16, i16* %369, align 1, !dbg !972, !tbaa !871
  %371 = getelementptr inbounds %struct.pbuf, %struct.pbuf* %366, i64 0, i32 1, !dbg !962
  %372 = bitcast i8** %371 to %struct.ip6_reass_helper**, !dbg !962
  %373 = load %struct.ip6_reass_helper*, %struct.ip6_reass_helper** %372, align 8, !dbg !962, !tbaa !404
  %374 = getelementptr inbounds %struct.ip6_reass_helper, %struct.ip6_reass_helper* %373, i64 0, i32 1, !dbg !964
  %375 = load i16, i16* %374, align 1, !dbg !964, !tbaa !408
  %376 = icmp eq i16 %370, %375, !dbg !966
  br i1 %376, label %363, label %487, !dbg !967

; <label>:377:                                    ; preds = %363, %340
  %378 = icmp eq i8 %351, 0, !dbg !973
  br i1 %378, label %487, label %379, !dbg !974

; <label>:379:                                    ; preds = %377
  %380 = icmp eq %struct.ip6_reass_helper* %345, null, !dbg !975
  br i1 %380, label %401, label %381, !dbg !976

; <label>:381:                                    ; preds = %379, %394
  %382 = phi %struct.ip6_reass_helper* [ %389, %394 ], [ %345, %379 ]
  %383 = getelementptr inbounds %struct.ip6_reass_helper, %struct.ip6_reass_helper* %382, i64 0, i32 0, !dbg !977
  %384 = load %struct.pbuf*, %struct.pbuf** %383, align 1, !dbg !977, !tbaa !414
  %385 = icmp eq %struct.pbuf* %384, null, !dbg !978
  br i1 %385, label %397, label %386, !dbg !979

; <label>:386:                                    ; preds = %381
  %387 = getelementptr inbounds %struct.pbuf, %struct.pbuf* %384, i64 0, i32 1, !dbg !980
  %388 = bitcast i8** %387 to %struct.ip6_reass_helper**, !dbg !980
  %389 = load %struct.ip6_reass_helper*, %struct.ip6_reass_helper** %388, align 8, !dbg !980, !tbaa !404
  %390 = tail call zeroext i8 @pbuf_remove_header(%struct.pbuf* nonnull %384, i64 8) #8, !dbg !981
  %391 = tail call zeroext i8 @pbuf_remove_header(%struct.pbuf* nonnull %384, i64 4) #8, !dbg !982
  %392 = icmp eq i8 %391, 0, !dbg !984
  br i1 %392, label %394, label %393, !dbg !987

; <label>:393:                                    ; preds = %386
  tail call void (i8*, ...) @uk_pr_crit(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.4, i64 0, i64 0)) #7, !dbg !988
  tail call void (i8*, ...) @uk_pr_crit(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.1, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0)) #7, !dbg !991
  tail call void @ukplat_terminate(i32 3) #9, !dbg !991
  unreachable, !dbg !991

; <label>:394:                                    ; preds = %386
  %395 = load %struct.pbuf*, %struct.pbuf** %265, align 8, !dbg !995, !tbaa !402
  tail call void @pbuf_cat(%struct.pbuf* %395, %struct.pbuf* nonnull %384) #8, !dbg !996
  %396 = icmp eq %struct.ip6_reass_helper* %389, null, !dbg !975
  br i1 %396, label %397, label %381, !dbg !976, !llvm.loop !997

; <label>:397:                                    ; preds = %381, %394
  %398 = load %struct.pbuf*, %struct.pbuf** %265, align 8, !dbg !999, !tbaa !402
  %399 = getelementptr inbounds %struct.pbuf, %struct.pbuf* %398, i64 0, i32 1
  %400 = load i8*, i8** %399, align 8, !dbg !1000, !tbaa !404
  br label %401, !dbg !999

; <label>:401:                                    ; preds = %397, %379
  %402 = phi i8** [ %399, %397 ], [ %343, %379 ], !dbg !1000
  %403 = phi i8* [ %400, %397 ], [ %355, %379 ], !dbg !1000
  %404 = phi %struct.pbuf* [ %398, %397 ], [ %342, %379 ], !dbg !999
  %405 = getelementptr inbounds %struct.ip6_reassdata, %struct.ip6_reassdata* %198, i64 0, i32 5, i64 0, !dbg !1000
  %406 = tail call i8* @memcpy(i8* %403, i8* nonnull %405, i64 4) #8, !dbg !1000
  %407 = tail call zeroext i8 @pbuf_remove_header(%struct.pbuf* %404, i64 4) #8, !dbg !1001
  %408 = icmp eq i8 %407, 0, !dbg !1003
  br i1 %408, label %410, label %409, !dbg !1006

; <label>:409:                                    ; preds = %401
  tail call void (i8*, ...) @uk_pr_crit(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.4, i64 0, i64 0)) #7, !dbg !1007
  tail call void (i8*, ...) @uk_pr_crit(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.1, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0)) #7, !dbg !1010
  tail call void @ukplat_terminate(i32 3) #9, !dbg !1010
  unreachable, !dbg !1010

; <label>:410:                                    ; preds = %401
  %411 = getelementptr inbounds %struct.ip6_reassdata, %struct.ip6_reassdata* %198, i64 0, i32 2, !dbg !1014
  %412 = bitcast %struct.ip6_hdr** %411 to i8**, !dbg !1014
  %413 = load i8*, i8** %412, align 8, !dbg !1014, !tbaa !419
  %414 = getelementptr inbounds i8, i8* %413, i64 8, !dbg !1014
  %415 = bitcast i8** %402 to i64*, !dbg !1014
  %416 = load i64, i64* %415, align 8, !dbg !1014, !tbaa !404
  %417 = ptrtoint i8* %413 to i64, !dbg !1014
  %418 = sub i64 %416, %417, !dbg !1014
  %419 = tail call i8* @memmove(i8* nonnull %414, i8* %413, i64 %418) #8, !dbg !1014
  %420 = load i8*, i8** %412, align 8, !dbg !1015, !tbaa !419
  %421 = getelementptr inbounds i8, i8* %420, i64 8, !dbg !1016
  %422 = load i16, i16* %336, align 4, !dbg !1018, !tbaa !947
  %423 = load i64, i64* %415, align 8, !dbg !1019, !tbaa !404
  %424 = ptrtoint i8* %421 to i64, !dbg !1020
  %425 = sub i64 %423, %424, !dbg !1020
  %426 = trunc i64 %425 to i16, !dbg !1021
  %427 = add i16 %422, -40, !dbg !1021
  %428 = add i16 %427, %426, !dbg !1021
  store i16 %428, i16* %336, align 4, !dbg !1022, !tbaa !947
  %429 = tail call zeroext i16 @lwip_htons(i16 zeroext %428) #8, !dbg !1023
  %430 = getelementptr inbounds i8, i8* %420, i64 12, !dbg !1024
  %431 = bitcast i8* %430 to i16*, !dbg !1024
  store i16 %429, i16* %431, align 1, !dbg !1025, !tbaa !595
  %432 = getelementptr inbounds i8, i8* %420, i64 14, !dbg !1026
  %433 = load i8, i8* %432, align 1, !dbg !1026, !tbaa !1027
  %434 = icmp eq i8 %433, 44, !dbg !1028
  br i1 %434, label %449, label %435, !dbg !1029

; <label>:435:                                    ; preds = %410
  %436 = getelementptr inbounds i8, i8* %420, i64 48, !dbg !1030
  %437 = load i8, i8* %436, align 1, !dbg !1032, !tbaa !757
  %438 = icmp eq i8 %437, 44, !dbg !1033
  br i1 %438, label %449, label %439, !dbg !1034

; <label>:439:                                    ; preds = %435, %439
  %440 = phi i8* [ %446, %439 ], [ %436, %435 ]
  %441 = getelementptr inbounds i8, i8* %440, i64 1, !dbg !1035
  %442 = load i8, i8* %441, align 1, !dbg !1035, !tbaa !757
  %443 = zext i8 %442 to i64, !dbg !1035
  %444 = shl nuw nsw i64 %443, 3, !dbg !1037
  %445 = add nuw nsw i64 %444, 8, !dbg !1037
  %446 = getelementptr inbounds i8, i8* %440, i64 %445, !dbg !1038
  %447 = load i8, i8* %446, align 1, !dbg !1032, !tbaa !757
  %448 = icmp eq i8 %447, 44, !dbg !1033
  br i1 %448, label %449, label %439, !dbg !1034, !llvm.loop !1039

; <label>:449:                                    ; preds = %439, %435, %410
  %450 = phi i8* [ %432, %410 ], [ %436, %435 ], [ %446, %439 ]
  %451 = getelementptr inbounds %struct.ip6_reassdata, %struct.ip6_reassdata* %198, i64 0, i32 8, !dbg !1041
  %452 = load i8, i8* %451, align 2, !dbg !1041, !tbaa !770
  store i8 %452, i8* %450, align 1, !dbg !1041, !tbaa !757
  %453 = load %struct.ip6_reassdata*, %struct.ip6_reassdata** @reassdatagrams, align 8, !dbg !1043, !tbaa !351
  %454 = icmp eq %struct.ip6_reassdata* %453, %198, !dbg !1045
  br i1 %454, label %455, label %458, !dbg !1046

; <label>:455:                                    ; preds = %449
  %456 = bitcast %struct.ip6_reassdata* %198 to i64*, !dbg !1047
  %457 = load i64, i64* %456, align 8, !dbg !1047, !tbaa !371
  store i64 %457, i64* bitcast (%struct.ip6_reassdata** @reassdatagrams to i64*), align 8, !dbg !1049, !tbaa !351
  br label %465, !dbg !1050

; <label>:458:                                    ; preds = %449
  %459 = icmp eq %struct.ip6_reassdata* %257, null, !dbg !1051
  br i1 %459, label %460, label %461, !dbg !1055

; <label>:460:                                    ; preds = %458
  tail call void (i8*, ...) @uk_pr_crit(i8* getelementptr inbounds ([25 x i8], [25 x i8]* @.str.7, i64 0, i64 0)) #7, !dbg !1056
  tail call void (i8*, ...) @uk_pr_crit(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.1, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0)) #7, !dbg !1059
  tail call void @ukplat_terminate(i32 3) #9, !dbg !1059
  unreachable, !dbg !1059

; <label>:461:                                    ; preds = %458
  %462 = bitcast %struct.ip6_reassdata* %198 to i64*, !dbg !1063
  %463 = load i64, i64* %462, align 8, !dbg !1063, !tbaa !371
  %464 = bitcast %struct.ip6_reassdata* %257 to i64*, !dbg !1064
  store i64 %463, i64* %464, align 8, !dbg !1064, !tbaa !371
  br label %465

; <label>:465:                                    ; preds = %461, %455
  %466 = bitcast %struct.ip6_reassdata* %198 to i8*, !dbg !1065
  tail call void @memp_free(i32 13, i8* %466) #8, !dbg !1066
  %467 = tail call zeroext i16 @pbuf_clen(%struct.pbuf* %404) #8, !dbg !1067
  %468 = load i16, i16* @ip6_reass_pbufcount, align 2, !dbg !1068, !tbaa !508
  %469 = icmp ult i16 %468, %467, !dbg !1068
  br i1 %469, label %470, label %471, !dbg !1071

; <label>:470:                                    ; preds = %465
  tail call void (i8*, ...) @uk_pr_crit(i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.8, i64 0, i64 0)) #7, !dbg !1072
  tail call void (i8*, ...) @uk_pr_crit(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.1, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0)) #7, !dbg !1075
  tail call void @ukplat_terminate(i32 3) #9, !dbg !1075
  unreachable, !dbg !1075

; <label>:471:                                    ; preds = %465
  %472 = sub i16 %468, %467, !dbg !1079
  store i16 %472, i16* @ip6_reass_pbufcount, align 2, !dbg !1080, !tbaa !508
  %473 = load i64, i64* %415, align 8, !dbg !1081, !tbaa !404
  %474 = sub i64 %473, %424, !dbg !1083
  %475 = trunc i64 %474 to i16, !dbg !1084
  %476 = tail call zeroext i8 @pbuf_header_force(%struct.pbuf* %404, i16 signext %475) #8, !dbg !1085
  %477 = icmp eq i8 %476, 0, !dbg !1085
  br i1 %477, label %487, label %478, !dbg !1086

; <label>:478:                                    ; preds = %471
  tail call void (i8*, ...) @uk_pr_crit(i8* getelementptr inbounds ([51 x i8], [51 x i8]* @.str.9, i64 0, i64 0)) #7, !dbg !1087
  tail call void (i8*, ...) @uk_pr_crit(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.1, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0)) #7, !dbg !1093
  tail call void @ukplat_terminate(i32 3) #9, !dbg !1093
...
; <label>:479:                                    ; preds = %292, %283, %279, %245, %150, %33, %29
  ...
  %481 = load i16, i16* %480, align 2, !dbg !1097, !tbaa !508
  %482 = add i16 %481, 1, !dbg !1097
  store i16 %482, i16* %480, align 2, !dbg !1097, !tbaa !508
  br label %483, !dbg !1099

; <label>:483:                                    ; preds = %290, %479
  %484 = load i16, i16* getelementptr inbounds (%struct.stats_, %struct.stats_* @lwip_stats, i64 0, i32 10, i32 3), align 2, !dbg !1099, !tbaa !1100
  %485 = add i16 %484, 1, !dbg !1099
  store i16 %485, i16* getelementptr inbounds (%struct.stats_, %struct.stats_* @lwip_stats, i64 0, i32 10, i32 3), align 2, !dbg !1099, !tbaa !1100
  %486 = tail call zeroext i8 @pbuf_free(%struct.pbuf* %0) #8, !dbg !1101
  br label %487, !dbg !1102

; <label>:487:                                    ; preds = %368, %356, %377, %471, %483
  %488 = phi %struct.pbuf* [ null, %483 ], [ %404, %471 ], [ null, %377 ], [ null, %356 ], [ null, %368 ], !dbg !897
  ret %struct.pbuf* %488, !dbg !1103
}

; Function Attrs: inlinehint noredzone nounwind
define internal void @uk_pr_crit(i8*, ...) unnamed_addr #3 !dbg !313 {
  %2 = alloca [1 x %struct.__va_list_tag], align 16
  %3 = bitcast [1 x %struct.__va_list_tag]* %2 to i8*, !dbg !1105
  call void @llvm.lifetime.start.p0i8(i64 24, i8* nonnull %3) #6, !dbg !1105
  %4 = getelementptr inbounds [1 x %struct.__va_list_tag], [1 x %struct.__va_list_tag]* %2, i64 0, i64 0, !dbg !1107
  call void @llvm.va_start(i8* nonnull %3), !dbg !1107
  call void @_uk_vprintk(i32 0, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @uk_pr_crit.__str, i64 0, i64 0), i8* getelementptr inbounds ([11 x i8], [11 x i8]* @uk_pr_crit.__str.15, i64 0, i64 0), i32 198, i8* %0, %struct.__va_list_tag* nonnull %4) #8, !dbg !1108
  call void @llvm.va_end(i8* nonnull %3), !dbg !1111
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %3) #6, !dbg !1112
  ret void, !dbg !1112
}
...
define dso_local signext i8 @ip6_frag(%struct.pbuf*, %struct.netif*, %struct.ip6_addr*) local_unnamed_addr #0 !dbg !185 {
  %4 = tail call zeroext i16 @nd6_get_destination_mtu(%struct.ip6_addr* %2, %struct.netif* %1) #8, !dbg !1117
  %5 = add i16 %4, -48, !dbg !1119
  %6 = and i16 %5, -8, !dbg !1119
  %7 = load i32, i32* @ip6_frag.identification, align 4, !dbg !1123, !tbaa !437
  %8 = add i32 %7, 1, !dbg !1123
  store i32 %8, i32* @ip6_frag.identification, align 4, !dbg !1123, !tbaa !437
  %9 = getelementptr inbounds %struct.pbuf, %struct.pbuf* %0, i64 0, i32 1, !dbg !1124
  %10 = load i8*, i8** %9, align 8, !dbg !1124, !tbaa !404
  %11 = getelementptr inbounds %struct.pbuf, %struct.pbuf* %0, i64 0, i32 2, !dbg !1126
  %12 = load i16, i16* %11, align 8, !dbg !1126, !tbaa !1129
  %13 = icmp ugt i16 %12, 39, !dbg !1126
  br i1 %13, label %15, label %14, !dbg !1130

; <label>:14:                                     ; preds = %3
  tail call void (i8*, ...) @uk_pr_crit(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.10, i64 0, i64 0)) #7, !dbg !1131
  tail call void (i8*, ...) @uk_pr_crit(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.1, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0)) #7, !dbg !1134
  tail call void @ukplat_terminate(i32 3) #9, !dbg !1134
  unreachable, !dbg !1134

; <label>:15:                                     ; preds = %3
  %16 = add i16 %12, -40, !dbg !1138
  %17 = icmp eq i16 %16, 0, !dbg !1140
  br i1 %17, label %124, label %18, !dbg !1140
...
; <label>:21:                                     ; preds = %18, %93
  ...
  %27 = icmp ugt i16 %26, %6, !dbg !1141
  %28 = icmp ult i16 %26, %6, !dbg !1142
  %29 = select i1 %28, i16 %26, i16 %6, !dbg !1142
  %30 = tail call %struct.pbuf* @pbuf_alloc(i32 14, i16 zeroext 48, i32 640) #8, !dbg !1144
  %31 = icmp eq %struct.pbuf* %30, null, !dbg !1146
  br i1 %31, label %32, label %35, !dbg !1148

; <label>:32:                                     ; preds = %21
  %33 = load i16, i16* getelementptr inbounds (%struct.stats_, %struct.stats_* @lwip_stats, i64 0, i32 10, i32 6), align 2, !dbg !1149, !tbaa !1151
  %34 = add i16 %33, 1, !dbg !1149
  store i16 %34, i16* getelementptr inbounds (%struct.stats_, %struct.stats_* @lwip_stats, i64 0, i32 10, i32 6), align 2, !dbg !1149, !tbaa !1151
  br label %124, !dbg !1152

; <label>:35:                                     ; preds = %21
  %36 = getelementptr inbounds %struct.pbuf, %struct.pbuf* %23, i64 0, i32 3, !dbg !1153
  %37 = load i16, i16* %36, align 2, !dbg !1153, !tbaa !574
  %38 = icmp ugt i16 %37, 39, !dbg !1153
  br i1 %38, label %40, label %39, !dbg !1156

; <label>:39:                                     ; preds = %35
  tail call void (i8*, ...) @uk_pr_crit(i8* getelementptr inbounds ([32 x i8], [32 x i8]* @.str.11, i64 0, i64 0)) #7, !dbg !1157
  tail call void (i8*, ...) @uk_pr_crit(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.1, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0)) #7, !dbg !1160
  tail call void @ukplat_terminate(i32 3) #9, !dbg !1160
  unreachable, !dbg !1160

; <label>:40:                                     ; preds = %35
  %41 = getelementptr inbounds %struct.pbuf, %struct.pbuf* %30, i64 0, i32 1, !dbg !1164
  %42 = load i8*, i8** %41, align 8, !dbg !1164, !tbaa !404
  %43 = tail call i8* @memcpy(i8* %42, i8* %10, i64 40) #8, !dbg !1164
  %44 = load i8*, i8** %41, align 8, !dbg !1165, !tbaa !404
  %45 = getelementptr inbounds i8, i8* %44, i64 40, !dbg !1167
  %46 = getelementptr inbounds %struct.pbuf, %struct.pbuf* %23, i64 0, i32 1, !dbg !1169
  %47 = load i8*, i8** %46, align 8, !dbg !1169, !tbaa !404
  %48 = zext i16 %22 to i64, !dbg !1170
  %49 = getelementptr inbounds i8, i8* %47, i64 %48, !dbg !1170
  store i8* %49, i8** %46, align 8, !dbg !1171, !tbaa !404
  %50 = load i16, i16* %36, align 2, !dbg !1172, !tbaa !574
  %51 = sub i16 %50, %22, !dbg !1173
  store i16 %51, i16* %36, align 2, !dbg !1174, !tbaa !574
  %52 = getelementptr inbounds %struct.pbuf, %struct.pbuf* %23, i64 0, i32 2, !dbg !1175
  %53 = load i16, i16* %52, align 8, !dbg !1175, !tbaa !1129
  %54 = sub i16 %53, %22, !dbg !1176
  store i16 %54, i16* %52, align 8, !dbg !1177, !tbaa !1129
  %55 = icmp eq i16 %29, 0, !dbg !1179
  br i1 %55, label %93, label %56, !dbg !1179

; <label>:56:                                     ; preds = %40, %87
  %57 = phi i16 [ %92, %87 ], [ %51, %40 ], !dbg !1180
  %58 = phi %struct.pbuf* [ %90, %87 ], [ %23, %40 ]
  %59 = phi i16 [ %88, %87 ], [ %29, %40 ]
  %60 = icmp ult i16 %59, %57, !dbg !1181
  %61 = select i1 %60, i16 %59, i16 %57, !dbg !1182
  %62 = icmp eq i16 %61, 0, !dbg !1183
  br i1 %62, label %87, label %63, !dbg !1185, !llvm.loop !1186

; <label>:63:                                     ; preds = %56
  %64 = tail call i8* @memp_malloc(i32 5) #8, !dbg !1188
  %65 = icmp eq i8* %64, null, !dbg !1195
  br i1 %65, label %66, label %70, !dbg !1197

; <label>:66:                                     ; preds = %63
  %67 = tail call zeroext i8 @pbuf_free(%struct.pbuf* nonnull %30) #8, !dbg !1198
  %68 = load i16, i16* getelementptr inbounds (%struct.stats_, %struct.stats_* @lwip_stats, i64 0, i32 10, i32 6), align 2, !dbg !1200, !tbaa !1151
  %69 = add i16 %68, 1, !dbg !1200
  store i16 %69, i16* getelementptr inbounds (%struct.stats_, %struct.stats_* @lwip_stats, i64 0, i32 10, i32 6), align 2, !dbg !1200, !tbaa !1151
  br label %124, !dbg !1201

; <label>:70:                                     ; preds = %63
  %71 = bitcast i8* %64 to %struct.pbuf_custom*, !dbg !1202
  %72 = getelementptr inbounds %struct.pbuf, %struct.pbuf* %58, i64 0, i32 1, !dbg !1203
  %73 = load i8*, i8** %72, align 8, !dbg !1203, !tbaa !404
  %74 = tail call %struct.pbuf* @pbuf_alloced_custom(i32 0, i16 zeroext %61, i32 65, %struct.pbuf_custom* nonnull %71, i8* %73, i16 zeroext %61) #8, !dbg !1204
  %75 = icmp eq %struct.pbuf* %74, null, !dbg !1206
  br i1 %75, label %76, label %80, !dbg !1208

; <label>:76:                                     ; preds = %70
  tail call void @memp_free(i32 5, i8* nonnull %64) #8, !dbg !1217
  %77 = tail call zeroext i8 @pbuf_free(%struct.pbuf* nonnull %30) #8, !dbg !1218
  %78 = load i16, i16* getelementptr inbounds (%struct.stats_, %struct.stats_* @lwip_stats, i64 0, i32 10, i32 6), align 2, !dbg !1219, !tbaa !1151
  %79 = add i16 %78, 1, !dbg !1219
  store i16 %79, i16* getelementptr inbounds (%struct.stats_, %struct.stats_* @lwip_stats, i64 0, i32 10, i32 6), align 2, !dbg !1219, !tbaa !1151
  br label %124, !dbg !1220

; <label>:80:                                     ; preds = %70
  tail call void @pbuf_ref(%struct.pbuf* nonnull %58) #8, !dbg !1221
  %81 = getelementptr inbounds i8, i8* %64, i64 32, !dbg !1222
  %82 = bitcast i8* %81 to %struct.pbuf**, !dbg !1222
  store %struct.pbuf* %58, %struct.pbuf** %82, align 8, !dbg !1223, !tbaa !1224
  %83 = getelementptr inbounds i8, i8* %64, i64 24, !dbg !1227
  %84 = bitcast i8* %83 to void (%struct.pbuf*)**, !dbg !1227
  store void (%struct.pbuf*)* @ip6_frag_free_pbuf_custom, void (%struct.pbuf*)** %84, align 8, !dbg !1228, !tbaa !1229
  tail call void @pbuf_cat(%struct.pbuf* nonnull %30, %struct.pbuf* nonnull %74) #8, !dbg !1230
  %85 = sub i16 %59, %61, !dbg !1231
  %86 = icmp eq i16 %85, 0, !dbg !1232
  br i1 %86, label %93, label %87, !dbg !1234

; <label>:87:                                     ; preds = %80, %56
  %88 = phi i16 [ %59, %56 ], [ %85, %80 ]
  %89 = getelementptr inbounds %struct.pbuf, %struct.pbuf* %58, i64 0, i32 0, !dbg !1235
  %90 = load %struct.pbuf*, %struct.pbuf** %89, align 8, !dbg !1235, !tbaa !1237
  %91 = getelementptr inbounds %struct.pbuf, %struct.pbuf* %90, i64 0, i32 3
  %92 = load i16, i16* %91, align 2, !dbg !1180, !tbaa !574
  br label %56, !dbg !1179

; <label>:93:                                     ; preds = %80, %40
  %94 = phi i16 [ %25, %40 ], [ %61, %80 ], !dbg !1238
  %95 = phi %struct.pbuf* [ %23, %40 ], [ %58, %80 ]
  %96 = load i8, i8* %19, align 1, !dbg !1239, !tbaa !1027
  store i8 %96, i8* %45, align 1, !dbg !1240, !tbaa !767
  %97 = getelementptr inbounds i8, i8* %44, i64 41, !dbg !1241
  store i8 0, i8* %97, align 1, !dbg !1242, !tbaa !1243
  %98 = and i32 %24, 65535, !dbg !1244
  %99 = and i32 %24, 65528, !dbg !1245
  %100 = zext i1 %27 to i32, !dbg !1246
  %101 = or i32 %99, %100, !dbg !1247
  %102 = trunc i32 %101 to i16, !dbg !1248
  %103 = tail call zeroext i16 @lwip_htons(i16 zeroext %102) #8, !dbg !1249
  %104 = getelementptr inbounds i8, i8* %44, i64 42, !dbg !1250
  %105 = bitcast i8* %104 to i16*, !dbg !1250
  store i16 %103, i16* %105, align 1, !dbg !1251, !tbaa !588
  %106 = load i32, i32* @ip6_frag.identification, align 4, !dbg !1252, !tbaa !437
  %107 = tail call i32 @lwip_htonl(i32 %106) #8, !dbg !1253
  %108 = getelementptr inbounds i8, i8* %44, i64 44, !dbg !1254
  %109 = bitcast i8* %108 to i32*, !dbg !1254
  store i32 %107, i32* %109, align 1, !dbg !1255, !tbaa !642
  %110 = getelementptr inbounds i8, i8* %44, i64 6, !dbg !1256
  store i8 44, i8* %110, align 1, !dbg !1256, !tbaa !1027
  %111 = zext i16 %29 to i32, !dbg !1257
  %112 = add i16 %29, 8, !dbg !1257
  %113 = tail call zeroext i16 @lwip_htons(i16 zeroext %112) #8, !dbg !1257
  %114 = getelementptr inbounds i8, i8* %44, i64 4, !dbg !1257
  %115 = bitcast i8* %114 to i16*, !dbg !1257
  store i16 %113, i16* %115, align 1, !dbg !1257, !tbaa !595
  %116 = load i16, i16* getelementptr inbounds (%struct.stats_, %struct.stats_* @lwip_stats, i64 0, i32 10, i32 0), align 2, !dbg !1258, !tbaa !1259
  %117 = add i16 %116, 1, !dbg !1258
  store i16 %117, i16* getelementptr inbounds (%struct.stats_, %struct.stats_* @lwip_stats, i64 0, i32 10, i32 0), align 2, !dbg !1258, !tbaa !1259
  %118 = load i8 (%struct.netif*, %struct.pbuf*, %struct.ip6_addr*)*, i8 (%struct.netif*, %struct.pbuf*, %struct.ip6_addr*)** %20, align 8, !dbg !1260, !tbaa !1261
  %119 = tail call signext i8 %118(%struct.netif* %1, %struct.pbuf* nonnull %30, %struct.ip6_addr* %2) #8, !dbg !1263
  %120 = tail call zeroext i8 @pbuf_free(%struct.pbuf* nonnull %30) #8, !dbg !1264
  %121 = sub i16 %26, %29, !dbg !1265
  %122 = add nuw nsw i32 %98, %111, !dbg !1266
  %123 = icmp eq i16 %121, 0, !dbg !1140
  br i1 %123, label %124, label %21, !dbg !1140, !llvm.loop !1267

; <label>:124:                                    ; preds = %93, %15, %76, %66, %32
  %125 = phi i8 [ -1, %32 ], [ -1, %66 ], [ -1, %76 ], [ 0, %15 ], [ 0, %93 ], !dbg !1269
  ret i8 %125, !dbg !1270
}
...
; Function Attrs: noredzone nounwind
define internal void @ip6_frag_free_pbuf_custom(%struct.pbuf*) #0 !dbg !1271 {
  %2 = icmp eq %struct.pbuf* %0, null, !dbg !1277
  br i1 %2, label %3, label %4, !dbg !1280

; <label>:3:                                      ; preds = %1
  tail call void (i8*, ...) @uk_pr_crit(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.17, i64 0, i64 0)) #7, !dbg !1281
  tail call void (i8*, ...) @uk_pr_crit(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.1, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i64 0, i64 0)) #7, !dbg !1284
  tail call void @ukplat_terminate(i32 3) #9, !dbg !1284
  unreachable, !dbg !1284

; <label>:4:                                      ; preds = %1
  %5 = getelementptr inbounds %struct.pbuf, %struct.pbuf* %0, i64 1, i32 1, !dbg !1288
  %6 = bitcast i8** %5 to %struct.pbuf**, !dbg !1288
  %7 = load %struct.pbuf*, %struct.pbuf** %6, align 8, !dbg !1288, !tbaa !1224
  %8 = icmp eq %struct.pbuf* %7, null, !dbg !1290
  br i1 %8, label %11, label %9, !dbg !1291

; <label>:9:                                      ; preds = %4
  %10 = tail call zeroext i8 @pbuf_free(%struct.pbuf* nonnull %7) #8, !dbg !1292
  br label %11, !dbg !1294

; <label>:11:                                     ; preds = %9, %4
  %12 = bitcast %struct.pbuf* %0 to i8*, !dbg !1297
  tail call void @memp_free(i32 5, i8* %12) #8, !dbg !1298
  ret void, !dbg !1299
}
...
!723 = !DILocation(line: 338, column: 37, scope: !668)
!724 = !DILocation(line: 338, column: 13, scope: !668)
!725 = !DILocation(line: 339, column: 15, scope: !726)
!726 = distinct !DILexicalBlock(scope: !668, file: !3, line: 339, column: 11)
!727 = !DILocation(line: 339, column: 11, scope: !668)
!728 = !DILocation(line: 341, column: 25, scope: !729)
!729 = distinct !DILexicalBlock(scope: !730, file: !3, line: 341, column: 9)
!730 = distinct !DILexicalBlock(scope: !726, file: !3, line: 339, column: 24)
!731 = !DILocation(line: 341, column: 14, scope: !729)
!732 = !DILocation(line: 0, scope: !733)
!733 = distinct !DILexicalBlock(scope: !729, file: !3, line: 341, column: 9)
!734 = !DILocation(line: 341, column: 50, scope: !733)
!735 = !DILocation(line: 341, column: 9, scope: !729)
!736 = !DILocation(line: 342, column: 25, scope: !737)
!737 = distinct !DILexicalBlock(scope: !738, file: !3, line: 342, column: 15)
!738 = distinct !DILexicalBlock(scope: !733, file: !3, line: 341, column: 86)
!739 = !DILocation(line: 342, column: 30, scope: !737)
!740 = !DILocation(line: 342, column: 15, scope: !738)
!741 = distinct !{!741, !735, !742}
!742 = !DILocation(line: 345, column: 9, scope: !729)
!743 = !DILocation(line: 0, scope: !638)
!744 = !DILocation(line: 0, scope: !661)
!745 = !DILocation(line: 354, column: 5, scope: !661)
!746 = !DILocation(line: 355, column: 10, scope: !661)
!747 = !DILocation(line: 355, column: 16, scope: !661)
!748 = !DILocation(line: 358, column: 17, scope: !661)
!749 = !DILocation(line: 358, column: 15, scope: !661)
!750 = !DILocation(line: 359, column: 20, scope: !661)
!751 = !DILocation(line: 365, column: 26, scope: !661)
!752 = !DILocation(line: 365, column: 10, scope: !661)
!753 = !DILocation(line: 365, column: 16, scope: !661)
!754 = !DILocation(line: 367, column: 5, scope: !661)
!755 = !DILocation(line: 368, column: 5, scope: !661)
!756 = !DILocation(line: 377, column: 21, scope: !661)
!757 = !{!353, !353, i64 0}
!758 = !DILocation(line: 377, column: 10, scope: !661)
!759 = !DILocation(line: 377, column: 19, scope: !661)
!760 = !DILocation(line: 378, column: 22, scope: !661)
!761 = !DILocation(line: 378, column: 10, scope: !661)
!762 = !DILocation(line: 378, column: 20, scope: !661)
!763 = !DILocation(line: 381, column: 37, scope: !661)
!764 = !DILocation(line: 381, column: 10, scope: !661)
!765 = !DILocation(line: 381, column: 25, scope: !661)
!766 = !DILocation(line: 384, column: 28, scope: !661)
!767 = !{!589, !353, i64 0}
!768 = !DILocation(line: 384, column: 10, scope: !661)
!769 = !DILocation(line: 384, column: 16, scope: !661)
!770 = !{!362, !353, i64 78}
!771 = !DILocation(line: 385, column: 3, scope: !661)
!772 = !DILocation(line: 388, column: 8, scope: !773)
!773 = distinct !DILexicalBlock(scope: !520, file: !3, line: 388, column: 7)
!774 = !DILocation(line: 388, column: 30, scope: !773)
!775 = !DILocation(line: 388, column: 28, scope: !773)
!776 = !DILocation(line: 388, column: 36, scope: !773)
!777 = !DILocation(line: 388, column: 7, scope: !520)
!778 = !DILocation(line: 236, column: 56, scope: !670, inlinedAt: !779)
!779 = distinct !DILocation(line: 390, column: 5, scope: !780)
!780 = distinct !DILexicalBlock(scope: !773, file: !3, line: 388, column: 58)
!781 = !DILocation(line: 236, column: 65, scope: !670, inlinedAt: !779)
!782 = !DILocation(line: 243, column: 18, scope: !681, inlinedAt: !779)
!783 = !DILocation(line: 242, column: 3, scope: !670, inlinedAt: !779)
!784 = !DILocation(line: 238, column: 29, scope: !670, inlinedAt: !779)
!785 = !DILocation(line: 238, column: 25, scope: !670, inlinedAt: !779)
!786 = !DILocation(line: 244, column: 14, scope: !681, inlinedAt: !779)
!787 = !DILocation(line: 244, column: 5, scope: !681, inlinedAt: !779)
!788 = !DILocation(line: 245, column: 13, scope: !688, inlinedAt: !779)
!789 = !DILocation(line: 245, column: 11, scope: !689, inlinedAt: !779)
!790 = !DILocation(line: 246, column: 16, scope: !692, inlinedAt: !779)
!791 = !DILocation(line: 246, column: 33, scope: !692, inlinedAt: !779)
!792 = !DILocation(line: 246, column: 22, scope: !692, inlinedAt: !779)
!793 = !DILocation(line: 246, column: 13, scope: !693, inlinedAt: !779)
!794 = !DILocation(line: 0, scope: !681, inlinedAt: !779)
!795 = !DILocation(line: 251, column: 14, scope: !689, inlinedAt: !779)
!796 = !DILocation(line: 0, scope: !703, inlinedAt: !779)
!797 = !DILocation(line: 253, column: 16, scope: !705, inlinedAt: !779)
!798 = !DILocation(line: 253, column: 9, scope: !681, inlinedAt: !779)
!799 = !DILocation(line: 391, column: 10, scope: !800)
!800 = distinct !DILexicalBlock(scope: !780, file: !3, line: 391, column: 9)
!801 = !DILocation(line: 391, column: 30, scope: !800)
!802 = !DILocation(line: 257, column: 16, scope: !708, inlinedAt: !779)
!803 = !DILocation(line: 257, column: 9, scope: !681, inlinedAt: !779)
!804 = !DILocation(line: 258, column: 7, scope: !711, inlinedAt: !779)
!805 = !DILocation(line: 260, column: 76, scope: !670, inlinedAt: !779)
!806 = !DILocation(line: 260, column: 14, scope: !670, inlinedAt: !779)
!807 = !DILocation(line: 259, column: 5, scope: !711, inlinedAt: !779)
!808 = !DILocation(line: 260, column: 34, scope: !670, inlinedAt: !779)
!809 = !DILocation(line: 260, column: 50, scope: !670, inlinedAt: !779)
!810 = !DILocation(line: 260, column: 91, scope: !670, inlinedAt: !779)
!811 = !DILocation(line: 260, column: 72, scope: !670, inlinedAt: !779)
!812 = !DILocation(line: 260, column: 3, scope: !681, inlinedAt: !779)
!813 = !DILocation(line: 391, column: 38, scope: !800)
!814 = !DILocation(line: 391, column: 9, scope: !780)
!815 = !DILocation(line: 0, scope: !816)
!816 = distinct !DILexicalBlock(scope: !817, file: !3, line: 393, column: 7)
!817 = distinct !DILexicalBlock(scope: !818, file: !3, line: 393, column: 7)
!818 = distinct !DILexicalBlock(scope: !800, file: !3, line: 391, column: 61)
!819 = !DILocation(line: 393, column: 48, scope: !816)
!820 = !DILocation(line: 393, column: 7, scope: !817)
!821 = !DILocation(line: 394, column: 23, scope: !822)
!822 = distinct !DILexicalBlock(scope: !823, file: !3, line: 394, column: 13)
!823 = distinct !DILexicalBlock(scope: !816, file: !3, line: 393, column: 84)
!824 = !DILocation(line: 394, column: 28, scope: !822)
!825 = !DILocation(line: 394, column: 13, scope: !823)
!826 = distinct !{!826, !820, !827}
!827 = !DILocation(line: 397, column: 7, scope: !817)
!828 = !DILocation(line: 0, scope: !729)
!829 = !DILocation(line: 413, column: 19, scope: !544)
!830 = !DILocation(line: 413, column: 10, scope: !544)
!831 = !DILocation(line: 415, column: 5, scope: !832)
!832 = distinct !DILexicalBlock(scope: !833, file: !3, line: 415, column: 5)
!833 = distinct !DILexicalBlock(scope: !544, file: !3, line: 415, column: 5)
!834 = !DILocation(line: 415, column: 5, scope: !833)
!835 = !DILocation(line: 415, column: 5, scope: !836)
!836 = distinct !DILexicalBlock(scope: !837, file: !3, line: 415, column: 5)
!837 = distinct !DILexicalBlock(scope: !832, file: !3, line: 415, column: 5)
!838 = !DILocation(line: 415, column: 5, scope: !839)
!839 = distinct !DILexicalBlock(scope: !840, file: !3, line: 415, column: 5)
!840 = distinct !DILexicalBlock(scope: !841, file: !3, line: 415, column: 5)
!841 = distinct !DILexicalBlock(scope: !836, file: !3, line: 415, column: 5)
!842 = !DILocation(line: 426, column: 40, scope: !520)
!843 = !DILocation(line: 275, column: 28, scope: !520)
!844 = !DILocation(line: 281, column: 20, scope: !520)
!845 = !DILocation(line: 428, column: 23, scope: !520)
!846 = !DILocation(line: 277, column: 29, scope: !520)
!847 = !DILocation(line: 433, column: 17, scope: !848)
!848 = distinct !DILexicalBlock(scope: !520, file: !3, line: 433, column: 3)
!849 = !DILocation(line: 281, column: 16, scope: !520)
!850 = !DILocation(line: 0, scope: !851)
!851 = distinct !DILexicalBlock(scope: !852, file: !3, line: 433, column: 32)
!852 = distinct !DILexicalBlock(scope: !848, file: !3, line: 433, column: 3)
!853 = !DILocation(line: 433, column: 22, scope: !852)
!854 = !DILocation(line: 433, column: 3, scope: !848)
!855 = !DILocation(line: 434, column: 45, scope: !851)
!856 = !DILocation(line: 275, column: 35, scope: !520)
!857 = !DILocation(line: 435, column: 27, scope: !858)
!858 = distinct !DILexicalBlock(scope: !851, file: !3, line: 435, column: 9)
!859 = !DILocation(line: 435, column: 15, scope: !858)
!860 = !DILocation(line: 435, column: 9, scope: !851)
!861 = !DILocation(line: 437, column: 15, scope: !862)
!862 = distinct !DILexicalBlock(scope: !863, file: !3, line: 437, column: 11)
!863 = distinct !DILexicalBlock(scope: !858, file: !3, line: 435, column: 34)
!864 = !DILocation(line: 437, column: 11, scope: !863)
!865 = !DILocation(line: 442, column: 21, scope: !866)
!866 = distinct !DILexicalBlock(scope: !863, file: !3, line: 442, column: 11)
!867 = !DILocation(line: 442, column: 11, scope: !863)
!868 = !DILocation(line: 443, column: 32, scope: !869)
!869 = distinct !DILexicalBlock(scope: !870, file: !3, line: 443, column: 13)
!870 = distinct !DILexicalBlock(scope: !866, file: !3, line: 442, column: 30)
!871 = !{!409, !365, i64 10}
!872 = !DILocation(line: 443, column: 19, scope: !869)
!873 = !DILocation(line: 443, column: 13, scope: !870)
!874 = !DILocation(line: 454, column: 20, scope: !875)
!875 = distinct !DILexicalBlock(scope: !876, file: !3, line: 452, column: 30)
!876 = distinct !DILexicalBlock(scope: !863, file: !3, line: 452, column: 11)
!877 = !DILocation(line: 454, column: 30, scope: !875)
!878 = !DILocation(line: 455, column: 7, scope: !875)
!879 = !DILocation(line: 457, column: 16, scope: !880)
!880 = distinct !DILexicalBlock(scope: !876, file: !3, line: 455, column: 14)
!881 = !DILocation(line: 460, column: 22, scope: !882)
!882 = distinct !DILexicalBlock(scope: !858, file: !3, line: 460, column: 16)
!883 = !DILocation(line: 460, column: 16, scope: !858)
!884 = !DILocation(line: 464, column: 34, scope: !885)
!885 = distinct !DILexicalBlock(scope: !882, file: !3, line: 464, column: 16)
!886 = !DILocation(line: 464, column: 22, scope: !885)
!887 = !DILocation(line: 464, column: 16, scope: !882)
!888 = !DILocation(line: 471, column: 21, scope: !889)
!889 = distinct !DILexicalBlock(scope: !890, file: !3, line: 471, column: 11)
!890 = distinct !DILexicalBlock(scope: !885, file: !3, line: 469, column: 12)
!891 = !DILocation(line: 471, column: 11, scope: !890)
!892 = !DILocation(line: 472, column: 24, scope: !893)
!893 = distinct !DILexicalBlock(scope: !894, file: !3, line: 472, column: 13)
!894 = distinct !DILexicalBlock(scope: !889, file: !3, line: 471, column: 30)
!895 = !DILocation(line: 472, column: 28, scope: !893)
!896 = !DILocation(line: 472, column: 13, scope: !894)
!897 = !DILocation(line: 0, scope: !520)
!898 = !DILocation(line: 479, column: 19, scope: !851)
!899 = distinct !{!899, !854, !900}
!900 = !DILocation(line: 481, column: 3, scope: !848)
!901 = !DILocation(line: 489, column: 7, scope: !902)
!902 = distinct !DILexicalBlock(scope: !903, file: !3, line: 489, column: 7)
!903 = distinct !DILexicalBlock(scope: !904, file: !3, line: 489, column: 7)
!904 = distinct !DILexicalBlock(scope: !905, file: !3, line: 485, column: 28)
!905 = distinct !DILexicalBlock(scope: !906, file: !3, line: 485, column: 9)
!906 = distinct !DILexicalBlock(scope: !907, file: !3, line: 484, column: 18)
!907 = distinct !DILexicalBlock(scope: !520, file: !3, line: 484, column: 7)
!908 = !DILocation(line: 489, column: 7, scope: !903)
!909 = !DILocation(line: 489, column: 7, scope: !910)
!910 = distinct !DILexicalBlock(scope: !911, file: !3, line: 489, column: 7)
!911 = distinct !DILexicalBlock(scope: !902, file: !3, line: 489, column: 7)
!912 = !DILocation(line: 489, column: 7, scope: !913)
!913 = distinct !DILexicalBlock(scope: !914, file: !3, line: 489, column: 7)
!914 = distinct !DILexicalBlock(scope: !915, file: !3, line: 489, column: 7)
!915 = distinct !DILexicalBlock(scope: !910, file: !3, line: 489, column: 7)
!916 = !DILocation(line: 491, column: 18, scope: !904)
!917 = !DILocation(line: 491, column: 28, scope: !904)
!918 = !DILocation(line: 492, column: 26, scope: !919)
!919 = distinct !DILexicalBlock(scope: !904, file: !3, line: 492, column: 11)
!920 = !DILocation(line: 492, column: 11, scope: !904)
!921 = !DILocation(line: 501, column: 14, scope: !922)
!922 = distinct !DILexicalBlock(scope: !905, file: !3, line: 495, column: 12)
!923 = !DILocation(line: 507, column: 33, scope: !520)
!924 = !DILocation(line: 507, column: 53, scope: !520)
!925 = !DILocation(line: 507, column: 23, scope: !520)
!926 = !DILocation(line: 510, column: 13, scope: !927)
!927 = distinct !DILexicalBlock(scope: !520, file: !3, line: 510, column: 7)
!928 = !DILocation(line: 510, column: 7, scope: !520)
!929 = !DILocation(line: 512, column: 26, scope: !930)
!930 = distinct !DILexicalBlock(scope: !927, file: !3, line: 510, column: 19)
!931 = !DILocation(line: 512, column: 10, scope: !930)
!932 = !DILocation(line: 512, column: 16, scope: !930)
!933 = !DILocation(line: 515, column: 5, scope: !930)
!934 = !DILocation(line: 519, column: 3, scope: !930)
!935 = !DILocation(line: 521, column: 9, scope: !520)
!936 = !DILocation(line: 521, column: 19, scope: !520)
!937 = !DILocation(line: 522, column: 9, scope: !520)
!938 = !DILocation(line: 522, column: 15, scope: !520)
!939 = !DILocation(line: 523, column: 9, scope: !520)
!940 = !DILocation(line: 523, column: 13, scope: !520)
!941 = !DILocation(line: 526, column: 15, scope: !942)
!942 = distinct !DILexicalBlock(scope: !520, file: !3, line: 526, column: 7)
!943 = !DILocation(line: 526, column: 37, scope: !942)
!944 = !DILocation(line: 526, column: 7, scope: !520)
!945 = !DILocation(line: 535, column: 12, scope: !946)
!946 = distinct !DILexicalBlock(scope: !520, file: !3, line: 535, column: 7)
!947 = !{!362, !365, i64 76}
!948 = !DILocation(line: 527, column: 23, scope: !949)
!949 = distinct !DILexicalBlock(scope: !942, file: !3, line: 526, column: 43)
!950 = !DILocation(line: 528, column: 3, scope: !949)
!951 = !DILocation(line: 531, column: 45, scope: !520)
!952 = !DILocation(line: 531, column: 48, scope: !520)
!953 = !DILocation(line: 532, column: 17, scope: !954)
!954 = distinct !DILexicalBlock(scope: !520, file: !3, line: 532, column: 7)
!955 = !DILocation(line: 532, column: 23, scope: !954)
!956 = !DILocation(line: 532, column: 7, scope: !520)
!957 = !DILocation(line: 535, column: 25, scope: !946)
!958 = !DILocation(line: 535, column: 7, scope: !520)
!959 = !DILocation(line: 542, column: 13, scope: !520)
!960 = !DILocation(line: 542, column: 22, scope: !520)
!961 = !DILocation(line: 542, column: 3, scope: !520)
!962 = !DILocation(line: 543, column: 41, scope: !963)
!963 = distinct !DILexicalBlock(scope: !520, file: !3, line: 542, column: 32)
!964 = !DILocation(line: 544, column: 33, scope: !965)
!965 = distinct !DILexicalBlock(scope: !963, file: !3, line: 544, column: 9)
!966 = !DILocation(line: 544, column: 24, scope: !965)
!967 = !DILocation(line: 544, column: 9, scope: !963)
!968 = !DILocation(line: 549, column: 15, scope: !963)
!969 = !DILocation(line: 0, scope: !963)
!970 = distinct !{!970, !961, !971}
!971 = !DILocation(line: 550, column: 3, scope: !520)
!972 = !DILocation(line: 544, column: 20, scope: !965)
!973 = !DILocation(line: 552, column: 7, scope: !548)
!974 = !DILocation(line: 552, column: 7, scope: !520)
!975 = !DILocation(line: 558, column: 17, scope: !547)
!976 = !DILocation(line: 558, column: 5, scope: !547)
!977 = !DILocation(line: 559, column: 25, scope: !554)
!978 = !DILocation(line: 560, column: 21, scope: !553)
!979 = !DILocation(line: 560, column: 11, scope: !554)
!980 = !DILocation(line: 562, column: 57, scope: !552)
!981 = !DILocation(line: 565, column: 9, scope: !552)
!982 = !DILocation(line: 569, column: 25, scope: !550)
!983 = !DILocation(line: 569, column: 16, scope: !550)
!984 = !DILocation(line: 571, column: 11, scope: !985)
!985 = distinct !DILexicalBlock(scope: !986, file: !3, line: 571, column: 11)
!986 = distinct !DILexicalBlock(scope: !550, file: !3, line: 571, column: 11)
!987 = !DILocation(line: 571, column: 11, scope: !986)
!988 = !DILocation(line: 571, column: 11, scope: !989)
!989 = distinct !DILexicalBlock(scope: !990, file: !3, line: 571, column: 11)
!990 = distinct !DILexicalBlock(scope: !985, file: !3, line: 571, column: 11)
!991 = !DILocation(line: 571, column: 11, scope: !992)
!992 = distinct !DILexicalBlock(scope: !993, file: !3, line: 571, column: 11)
!993 = distinct !DILexicalBlock(scope: !994, file: !3, line: 571, column: 11)
!994 = distinct !DILexicalBlock(scope: !989, file: !3, line: 571, column: 11)
!995 = !DILocation(line: 574, column: 23, scope: !552)
!996 = !DILocation(line: 574, column: 9, scope: !552)
!997 = distinct !{!997, !976, !998}
!998 = !DILocation(line: 581, column: 5, scope: !547)
!999 = !DILocation(line: 584, column: 14, scope: !547)
!1000 = !DILocation(line: 592, column: 7, scope: !556)
!1001 = !DILocation(line: 594, column: 16, scope: !556)
!1002 = !DILocation(line: 588, column: 12, scope: !556)
!1003 = !DILocation(line: 596, column: 7, scope: !1004)
!1004 = distinct !DILexicalBlock(scope: !1005, file: !3, line: 596, column: 7)
!1005 = distinct !DILexicalBlock(scope: !556, file: !3, line: 596, column: 7)
!1006 = !DILocation(line: 596, column: 7, scope: !1005)
!1007 = !DILocation(line: 596, column: 7, scope: !1008)
!1008 = distinct !DILexicalBlock(scope: !1009, file: !3, line: 596, column: 7)
!1009 = distinct !DILexicalBlock(scope: !1004, file: !3, line: 596, column: 7)
!1010 = !DILocation(line: 596, column: 7, scope: !1011)
!1011 = distinct !DILexicalBlock(scope: !1012, file: !3, line: 596, column: 7)
!1012 = distinct !DILexicalBlock(scope: !1013, file: !3, line: 596, column: 7)
!1013 = distinct !DILexicalBlock(scope: !1008, file: !3, line: 596, column: 7)
!1014 = !DILocation(line: 609, column: 5, scope: !547)
!1015 = !DILocation(line: 613, column: 47, scope: !547)
!1016 = !DILocation(line: 613, column: 53, scope: !547)
!1017 = !DILocation(line: 554, column: 21, scope: !547)
!1018 = !DILocation(line: 617, column: 38, scope: !547)
!1019 = !DILocation(line: 617, column: 64, scope: !547)
!1020 = !DILocation(line: 617, column: 72, scope: !547)
!1021 = !DILocation(line: 617, column: 25, scope: !547)
!1022 = !DILocation(line: 617, column: 23, scope: !547)
!1023 = !DILocation(line: 621, column: 24, scope: !547)
!1024 = !DILocation(line: 621, column: 16, scope: !547)
!1025 = !DILocation(line: 621, column: 22, scope: !547)
!1026 = !DILocation(line: 627, column: 9, scope: !560)
!1027 = !{!596, !353, i64 6}
!1028 = !DILocation(line: 627, column: 31, scope: !560)
!1029 = !DILocation(line: 627, column: 9, scope: !547)
!1030 = !DILocation(line: 630, column: 37, scope: !559)
!1031 = !DILocation(line: 630, column: 13, scope: !559)
!1032 = !DILocation(line: 631, column: 14, scope: !559)
!1033 = !DILocation(line: 631, column: 19, scope: !559)
!1034 = !DILocation(line: 631, column: 7, scope: !559)
!1035 = !DILocation(line: 632, column: 25, scope: !1036)
!1036 = distinct !DILexicalBlock(scope: !559, file: !3, line: 631, column: 42)
!1037 = !DILocation(line: 632, column: 18, scope: !1036)
!1038 = !DILocation(line: 632, column: 13, scope: !1036)
!1039 = distinct !{!1039, !1034, !1040}
!1040 = !DILocation(line: 633, column: 7, scope: !559)
!1041 = !DILocation(line: 0, scope: !1042)
!1042 = distinct !DILexicalBlock(scope: !560, file: !3, line: 627, column: 54)
!1043 = !DILocation(line: 638, column: 9, scope: !1044)
!1044 = distinct !DILexicalBlock(scope: !547, file: !3, line: 638, column: 9)
!1045 = !DILocation(line: 638, column: 24, scope: !1044)
!1046 = !DILocation(line: 638, column: 9, scope: !547)
!1047 = !DILocation(line: 640, column: 29, scope: !1048)
!1048 = distinct !DILexicalBlock(scope: !1044, file: !3, line: 638, column: 32)
!1049 = !DILocation(line: 640, column: 22, scope: !1048)
!1050 = !DILocation(line: 641, column: 5, scope: !1048)
!1051 = !DILocation(line: 643, column: 7, scope: !1052)
!1052 = distinct !DILexicalBlock(scope: !1053, file: !3, line: 643, column: 7)
!1053 = distinct !DILexicalBlock(scope: !1054, file: !3, line: 643, column: 7)
!1054 = distinct !DILexicalBlock(scope: !1044, file: !3, line: 641, column: 12)
!1055 = !DILocation(line: 643, column: 7, scope: !1053)
!1056 = !DILocation(line: 643, column: 7, scope: !1057)
!1057 = distinct !DILexicalBlock(scope: !1058, file: !3, line: 643, column: 7)
!1058 = distinct !DILexicalBlock(scope: !1052, file: !3, line: 643, column: 7)
!1059 = !DILocation(line: 643, column: 7, scope: !1060)
!1060 = distinct !DILexicalBlock(scope: !1061, file: !3, line: 643, column: 7)
!1061 = distinct !DILexicalBlock(scope: !1062, file: !3, line: 643, column: 7)
!1062 = distinct !DILexicalBlock(scope: !1057, file: !3, line: 643, column: 7)
!1063 = !DILocation(line: 644, column: 29, scope: !1054)
!1064 = !DILocation(line: 644, column: 22, scope: !1054)
!1065 = !DILocation(line: 646, column: 35, scope: !547)
!1066 = !DILocation(line: 646, column: 5, scope: !547)
!1067 = !DILocation(line: 649, column: 12, scope: !547)
!1068 = !DILocation(line: 650, column: 5, scope: !1069)
!1069 = distinct !DILexicalBlock(scope: !1070, file: !3, line: 650, column: 5)
!1070 = distinct !DILexicalBlock(scope: !547, file: !3, line: 650, column: 5)
!1071 = !DILocation(line: 650, column: 5, scope: !1070)
!1072 = !DILocation(line: 650, column: 5, scope: !1073)
!1073 = distinct !DILexicalBlock(scope: !1074, file: !3, line: 650, column: 5)
!1074 = distinct !DILexicalBlock(scope: !1069, file: !3, line: 650, column: 5)
!1075 = !DILocation(line: 650, column: 5, scope: !1076)
!1076 = distinct !DILexicalBlock(scope: !1077, file: !3, line: 650, column: 5)
!1077 = distinct !DILexicalBlock(scope: !1078, file: !3, line: 650, column: 5)
!1078 = distinct !DILexicalBlock(scope: !1073, file: !3, line: 650, column: 5)
!1079 = !DILocation(line: 651, column: 55, scope: !547)
!1080 = !DILocation(line: 651, column: 25, scope: !547)
!1081 = !DILocation(line: 654, column: 48, scope: !1082)
!1082 = distinct !DILexicalBlock(scope: !547, file: !3, line: 654, column: 9)
!1083 = !DILocation(line: 654, column: 56, scope: !1082)
!1084 = !DILocation(line: 654, column: 30, scope: !1082)
!1085 = !DILocation(line: 654, column: 9, scope: !1082)
!1086 = !DILocation(line: 654, column: 9, scope: !547)
!1087 = !DILocation(line: 655, column: 7, scope: !1088)
!1088 = distinct !DILexicalBlock(scope: !1089, file: !3, line: 655, column: 7)
!1089 = distinct !DILexicalBlock(scope: !1090, file: !3, line: 655, column: 7)
...
!1092 = distinct !DILexicalBlock(scope: !1082, file: !3, line: 654, column: 78)
!1093 = !DILocation(line: 655, column: 7, scope: !1094)
!1094 = distinct !DILexicalBlock(scope: !1095, file: !3, line: 655, column: 7)
!1095 = distinct !DILexicalBlock(scope: !1096, file: !3, line: 655, column: 7)
!1096 = distinct !DILexicalBlock(scope: !1088, file: !3, line: 655, column: 7)
!1097 = !DILocation(line: 0, scope: !1098)
!1098 = distinct !DILexicalBlock(scope: !626, file: !3, line: 304, column: 22)
!1099 = !DILocation(line: 667, column: 3, scope: !520)
!1100 = !{!566, !365, i64 240}
!1101 = !DILocation(line: 668, column: 3, scope: !520)
!1102 = !DILocation(line: 669, column: 3, scope: !520)
!1103 = !DILocation(line: 670, column: 1, scope: !520)
!1104 = !DILocation(line: 194, column: 43, scope: !313)
!1105 = !DILocation(line: 196, column: 2, scope: !313)
!1106 = !DILocation(line: 196, column: 10, scope: !313)
!1107 = !DILocation(line: 197, column: 2, scope: !313)
!1108 = !DILocation(line: 198, column: 2, scope: !1109)
!1109 = distinct !DILexicalBlock(scope: !1110, file: !314, line: 198, column: 2)
!1110 = distinct !DILexicalBlock(scope: !313, file: !314, line: 198, column: 2)
!1111 = !DILocation(line: 199, column: 2, scope: !313)
!1112 = !DILocation(line: 200, column: 1, scope: !313)
!1113 = !DILocation(line: 720, column: 23, scope: !185)
!1114 = !DILocation(line: 720, column: 40, scope: !185)
!1115 = !DILocation(line: 720, column: 65, scope: !185)
!1116 = !DILocation(line: 728, column: 9, scope: !185)
!1117 = !DILocation(line: 733, column: 21, scope: !185)
!1118 = !DILocation(line: 733, column: 15, scope: !185)
!1119 = !DILocation(line: 734, column: 64, scope: !185)
!1120 = !DILocation(line: 734, column: 15, scope: !185)
!1121 = !DILocation(line: 735, column: 9, scope: !185)
!1122 = !DILocation(line: 737, column: 9, scope: !185)
!1123 = !DILocation(line: 739, column: 17, scope: !185)
!1124 = !DILocation(line: 741, column: 42, scope: !185)
!1125 = !DILocation(line: 722, column: 19, scope: !185)
!1126 = !DILocation(line: 744, column: 3, scope: !1127)
!1127 = distinct !DILexicalBlock(scope: !1128, file: !3, line: 744, column: 3)
!1128 = distinct !DILexicalBlock(scope: !185, file: !3, line: 744, column: 3)
!1129 = !{!405, !365, i64 16}
!1130 = !DILocation(line: 744, column: 3, scope: !1128)
!1131 = !DILocation(line: 744, column: 3, scope: !1132)
!1132 = distinct !DILexicalBlock(scope: !1133, file: !3, line: 744, column: 3)
!1133 = distinct !DILexicalBlock(scope: !1127, file: !3, line: 744, column: 3)
!1134 = !DILocation(line: 744, column: 3, scope: !1135)
!1135 = distinct !DILexicalBlock(scope: !1136, file: !3, line: 744, column: 3)
!1136 = distinct !DILexicalBlock(scope: !1137, file: !3, line: 744, column: 3)
!1137 = distinct !DILexicalBlock(scope: !1132, file: !3, line: 744, column: 3)
!1138 = !DILocation(line: 745, column: 29, scope: !185)
!1139 = !DILocation(line: 732, column: 9, scope: !185)
!1140 = !DILocation(line: 747, column: 3, scope: !185)
!1141 = !DILocation(line: 748, column: 18, scope: !308)
!1142 = !DILocation(line: 751, column: 11, scope: !308)
!1143 = !DILocation(line: 732, column: 15, scope: !185)
!1144 = !DILocation(line: 778, column: 14, scope: !308)
!1145 = !DILocation(line: 725, column: 16, scope: !185)
!1146 = !DILocation(line: 779, column: 16, scope: !1147)
!1147 = distinct !DILexicalBlock(scope: !308, file: !3, line: 779, column: 9)
!1148 = !DILocation(line: 779, column: 9, scope: !308)
!1149 = !DILocation(line: 780, column: 7, scope: !1150)
!1150 = distinct !DILexicalBlock(scope: !1147, file: !3, line: 779, column: 25)
!1151 = !{!566, !365, i64 246}
!1152 = !DILocation(line: 781, column: 7, scope: !1150)
!1153 = !DILocation(line: 783, column: 5, scope: !1154)
!1154 = distinct !DILexicalBlock(scope: !1155, file: !3, line: 783, column: 5)
!1155 = distinct !DILexicalBlock(scope: !308, file: !3, line: 783, column: 5)
!1156 = !DILocation(line: 783, column: 5, scope: !1155)
!1157 = !DILocation(line: 783, column: 5, scope: !1158)
!1158 = distinct !DILexicalBlock(scope: !1159, file: !3, line: 783, column: 5)
!1159 = distinct !DILexicalBlock(scope: !1154, file: !3, line: 783, column: 5)
!1160 = !DILocation(line: 783, column: 5, scope: !1161)
!1161 = distinct !DILexicalBlock(scope: !1162, file: !3, line: 783, column: 5)
!1162 = distinct !DILexicalBlock(scope: !1163, file: !3, line: 783, column: 5)
!1163 = distinct !DILexicalBlock(scope: !1158, file: !3, line: 783, column: 5)
!1164 = !DILocation(line: 785, column: 5, scope: !308)
!1165 = !DILocation(line: 786, column: 40, scope: !308)
!1166 = !DILocation(line: 723, column: 19, scope: !185)
!1167 = !DILocation(line: 787, column: 63, scope: !308)
!1168 = !DILocation(line: 724, column: 24, scope: !185)
!1169 = !DILocation(line: 790, column: 29, scope: !308)
!1170 = !DILocation(line: 790, column: 37, scope: !308)
!1171 = !DILocation(line: 790, column: 16, scope: !308)
!1172 = !DILocation(line: 791, column: 25, scope: !308)
!1173 = !DILocation(line: 791, column: 29, scope: !308)
!1174 = !DILocation(line: 791, column: 12, scope: !308)
!1175 = !DILocation(line: 792, column: 29, scope: !308)
!1176 = !DILocation(line: 792, column: 37, scope: !308)
!1177 = !DILocation(line: 792, column: 16, scope: !308)
!1178 = !DILocation(line: 729, column: 9, scope: !185)
!1179 = !DILocation(line: 795, column: 5, scope: !308)
!1180 = !DILocation(line: 797, column: 39, scope: !307)
!1181 = !DILocation(line: 797, column: 34, scope: !307)
!1182 = !DILocation(line: 797, column: 20, scope: !307)
!1183 = !DILocation(line: 799, column: 12, scope: !1184)
!1184 = distinct !DILexicalBlock(scope: !307, file: !3, line: 799, column: 11)
!1185 = !DILocation(line: 799, column: 11, scope: !307)
!1186 = distinct !{!1186, !1179, !1187}
!1187 = !DILocation(line: 829, column: 5, scope: !308)
!1188 = !DILocation(line: 681, column: 35, scope: !1189, inlinedAt: !1193)
!1189 = distinct !DISubprogram(name: "ip6_frag_alloc_pbuf_custom_ref", scope: !3, file: !3, line: 679, type: !1190, isLocal: true, isDefinition: true, scopeLine: 680, flags: DIFlagPrototyped, isOptimized: true, unit: !2, retainedNodes: !1192)
!1190 = !DISubroutineType(types: !1191)
!1191 = !{!169}
!1192 = !{}
!1193 = distinct !DILocation(line: 803, column: 13, scope: !307)
!1194 = !DILocation(line: 796, column: 31, scope: !307)
!1195 = !DILocation(line: 804, column: 15, scope: !1196)
!1196 = distinct !DILexicalBlock(scope: !307, file: !3, line: 804, column: 11)
!1197 = !DILocation(line: 804, column: 11, scope: !307)
!1198 = !DILocation(line: 805, column: 9, scope: !1199)
!1199 = distinct !DILexicalBlock(scope: !1196, file: !3, line: 804, column: 24)
!1200 = !DILocation(line: 806, column: 9, scope: !1199)
!1201 = !DILocation(line: 807, column: 9, scope: !1199)
!1202 = !DILocation(line: 810, column: 75, scope: !307)
!1203 = !DILocation(line: 810, column: 82, scope: !307)
!1204 = !DILocation(line: 810, column: 17, scope: !307)
!1205 = !DILocation(line: 727, column: 16, scope: !185)
!1206 = !DILocation(line: 811, column: 19, scope: !1207)
!1207 = distinct !DILexicalBlock(scope: !307, file: !3, line: 811, column: 11)
!1208 = !DILocation(line: 811, column: 11, scope: !307)
!1209 = !DILocalVariable(name: "p", arg: 1, scope: !1210, file: !3, line: 686, type: !169)
!1210 = distinct !DISubprogram(name: "ip6_frag_free_pbuf_custom_ref", scope: !3, file: !3, line: 686, type: !1211, isLocal: true, isDefinition: true, scopeLine: 687, flags: DIFlagPrototyped, isOptimized: true, unit: !2, retainedNodes: !1213)
!1211 = !DISubroutineType(types: !1212)
!1212 = !{null, !169}
!1213 = !{!1209}
!1214 = !DILocation(line: 686, column: 55, scope: !1210, inlinedAt: !1215)
!1215 = distinct !DILocation(line: 812, column: 9, scope: !1216)
!1216 = distinct !DILexicalBlock(scope: !1207, file: !3, line: 811, column: 28)
!1217 = !DILocation(line: 689, column: 3, scope: !1210, inlinedAt: !1215)
!1218 = !DILocation(line: 813, column: 9, scope: !1216)
!1219 = !DILocation(line: 814, column: 9, scope: !1216)
!1220 = !DILocation(line: 815, column: 9, scope: !1216)
!1221 = !DILocation(line: 817, column: 7, scope: !307)
!1222 = !DILocation(line: 818, column: 12, scope: !307)
!1223 = !DILocation(line: 818, column: 21, scope: !307)
!1224 = !{!1225, !352, i64 32}
!1225 = !{!"pbuf_custom_ref", !1226, i64 0, !352, i64 32}
!1226 = !{!"pbuf_custom", !405, i64 0, !352, i64 24}
!1227 = !DILocation(line: 819, column: 15, scope: !307)
!1228 = !DILocation(line: 819, column: 36, scope: !307)
!1229 = !{!1225, !352, i64 24}
!1230 = !DILocation(line: 824, column: 7, scope: !307)
!1231 = !DILocation(line: 825, column: 43, scope: !307)
!1232 = !DILocation(line: 826, column: 11, scope: !1233)
!1233 = distinct !DILexicalBlock(scope: !307, file: !3, line: 826, column: 11)
!1234 = !DILocation(line: 826, column: 11, scope: !307)
!1235 = !DILocation(line: 0, scope: !1236)
!1236 = distinct !DILexicalBlock(scope: !1184, file: !3, line: 799, column: 24)
!1237 = !{!405, !352, i64 0}
!1238 = !DILocation(line: 0, scope: !307)
!1239 = !DILocation(line: 834, column: 41, scope: !308)
!1240 = !DILocation(line: 834, column: 22, scope: !308)
!1241 = !DILocation(line: 835, column: 15, scope: !308)
!1242 = !DILocation(line: 835, column: 24, scope: !308)
!1243 = !{!589, !353, i64 1}
!1244 = !DILocation(line: 836, column: 54, scope: !308)
!1245 = !DILocation(line: 836, column: 70, scope: !308)
!1246 = !DILocation(line: 836, column: 97, scope: !308)
!1247 = !DILocation(line: 836, column: 94, scope: !308)
!1248 = !DILocation(line: 836, column: 45, scope: !308)
!1249 = !DILocation(line: 836, column: 34, scope: !308)
!1250 = !DILocation(line: 836, column: 15, scope: !308)
!1251 = !DILocation(line: 836, column: 32, scope: !308)
!1252 = !DILocation(line: 837, column: 44, scope: !308)
!1253 = !DILocation(line: 837, column: 33, scope: !308)
!1254 = !DILocation(line: 837, column: 15, scope: !308)
!1255 = !DILocation(line: 837, column: 31, scope: !308)
!1256 = !DILocation(line: 839, column: 5, scope: !308)
!1257 = !DILocation(line: 840, column: 5, scope: !308)
!1258 = !DILocation(line: 845, column: 5, scope: !308)
!1259 = !{!566, !365, i64 234}
!1260 = !DILocation(line: 846, column: 12, scope: !308)
!1261 = !{!1262, !352, i64 208}
!1262 = !{!"netif", !352, i64 0, !594, i64 8, !594, i64 32, !594, i64 56, !353, i64 80, !353, i64 152, !353, i64 156, !353, i64 168, !352, i64 184, !352, i64 192, !352, i64 200, !352, i64 208, !352, i64 216, !352, i64 224, !352, i64 232, !353, i64 240, !365, i64 248, !365, i64 250, !365, i64 252, !353, i64 254, !353, i64 260, !353, i64 261, !353, i64 262, !353, i64 264, !353, i64 265, !353, i64 266, !352, i64 272}
!1263 = !DILocation(line: 846, column: 5, scope: !308)
!1264 = !DILocation(line: 855, column: 5, scope: !308)
!1265 = !DILocation(line: 856, column: 25, scope: !308)
!1266 = !DILocation(line: 857, column: 47, scope: !308)
!1267 = distinct !{!1267, !1140, !1268}
!1268 = !DILocation(line: 858, column: 3, scope: !185)
!1269 = !DILocation(line: 0, scope: !185)
!1270 = !DILocation(line: 860, column: 1, scope: !185)
!1271 = distinct !DISubprogram(name: "ip6_frag_free_pbuf_custom", scope: !3, file: !3, line: 695, type: !179, isLocal: true, isDefinition: true, scopeLine: 696, flags: DIFlagPrototyped, isOptimized: true, unit: !2, retainedNodes: !1272)
!1272 = !{!1273, !1274}
!1273 = !DILocalVariable(name: "p", arg: 1, scope: !1271, file: !3, line: 695, type: !129)
!1274 = !DILocalVariable(name: "pcr", scope: !1271, file: !3, line: 697, type: !169)
!1275 = !DILocation(line: 695, column: 40, scope: !1271)
!1276 = !DILocation(line: 697, column: 27, scope: !1271)
!1277 = !DILocation(line: 698, column: 3, scope: !1278)
!1278 = distinct !DILexicalBlock(scope: !1279, file: !3, line: 698, column: 3)
!1279 = distinct !DILexicalBlock(scope: !1271, file: !3, line: 698, column: 3)
!1280 = !DILocation(line: 698, column: 3, scope: !1279)
!1281 = !DILocation(line: 698, column: 3, scope: !1282)
!1282 = distinct !DILexicalBlock(scope: !1283, file: !3, line: 698, column: 3)
!1283 = distinct !DILexicalBlock(scope: !1278, file: !3, line: 698, column: 3)
!1284 = !DILocation(line: 698, column: 3, scope: !1285)
!1285 = distinct !DILexicalBlock(scope: !1286, file: !3, line: 698, column: 3)
...
!1288 = !DILocation(line: 700, column: 12, scope: !1289)
!1289 = distinct !DILexicalBlock(scope: !1271, file: !3, line: 700, column: 7)
!1290 = !DILocation(line: 700, column: 21, scope: !1289)
!1291 = !DILocation(line: 700, column: 7, scope: !1271)
!1292 = !DILocation(line: 701, column: 5, scope: !1293)
!1293 = distinct !DILexicalBlock(scope: !1289, file: !3, line: 700, column: 30)
!1294 = !DILocation(line: 702, column: 3, scope: !1293)
!1295 = !DILocation(line: 686, column: 55, scope: !1210, inlinedAt: !1296)
!1296 = distinct !DILocation(line: 703, column: 3, scope: !1271)
!1297 = !DILocation(line: 689, column: 29, scope: !1210, inlinedAt: !1296)
!1298 = !DILocation(line: 689, column: 3, scope: !1210, inlinedAt: !1296)
!1299 = !DILocation(line: 704, column: 1, scope: !1271)
