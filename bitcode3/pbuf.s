...
.LBB10_11:
	...
	movq	%rcx, %rsi
	popq	%rbp
	jmp	pbuf_remove_header      # TAILCALL
.LBB10_5:
	movq	8(%rdi), %rdx
	subq	%rcx, %rdx
	leaq	24(%rdi), %rcx
...
# %bb.10:                               #   in Loop: Header=BB30_9 Depth=2
	...
	testq	%r10, %r10
	jne	.LBB30_9
.LBB30_7:                               #   in Loop: Header=BB30_6 Depth=1
	xorl	%r9d, %r9d
	jmp	.LBB30_13
	.p2align	4, 0x90
...
# %bb.5:                                # %.preheader3
	...
	movq	%rdi, %r15
	.p2align	4, 0x90
.LBB31_6:                               #   Parent Loop BB31_4 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	movzwl	18(%r15), %ebx
	cmpw	%bx, %r11w
	jb	.LBB31_9
...
# %bb.16:                               #   in Loop: Header=BB31_15 Depth=3
	...
	testq	%rbp, %rbp
	jne	.LBB31_15
.LBB31_13:                              #   in Loop: Header=BB31_12 Depth=2
	xorl	%ebx, %ebx
	cmpb	(%rsi,%r12), %bl
	je	.LBB31_20
	jmp	.LBB31_3
...
# %bb.19:                               #   in Loop: Header=BB32_18 Depth=3
	...
	testq	%rcx, %rcx
	jne	.LBB32_18
.LBB32_16:                              #   in Loop: Header=BB32_15 Depth=2
	xorl	%ecx, %ecx
	cmpb	(%r14,%rsi), %cl
	je	.LBB32_23
	jmp	.LBB32_6
...
.LBB32_21:                              #   in Loop: Header=BB32_15 Depth=2
	...
	cmpb	(%r14,%rsi), %cl
	jne	.LBB32_6
.LBB32_23:                              #   in Loop: Header=BB32_15 Depth=2
	addq	$1, %rsi
	cmpq	%r12, %rsi
	jb	.LBB32_15
.LBB32_24:
