...
define dso_local %struct.__locale_t* @_uselocale_r(%struct._reent* nocapture, %struct.__locale_t*) local_unnamed_addr #0 !dbg !288 {
  ...
  %5 = icmp eq %struct.__locale_t* %4, null, !dbg !315
  %6 = select i1 %5, %struct.__locale_t* inttoptr (i64 -1 to %struct.__locale_t*), %struct.__locale_t* %4, !dbg !317
  %7 = ptrtoint %struct.__locale_t* %1 to i64, !dbg !318
...
; <label>:9:                                      ; preds = %2, %8
  ...
  store %struct.__locale_t* %10, %struct.__locale_t** %3, align 8, !dbg !322, !tbaa !305
  br label %11, !dbg !323

; <label>:11:                                     ; preds = %9, %2
  ret %struct.__locale_t* %6, !dbg !323
}

; Function Attrs: noredzone nounwind
define dso_local %struct.__locale_t* @uselocale(%struct.__locale_t*) local_unnamed_addr #0 !dbg !324 {
  %2 = tail call %struct._reent* @__getreent() #3, !dbg !332
  %3 = getelementptr inbounds %struct._reent, %struct._reent* %2, i64 0, i32 7, !dbg !338
  %4 = load %struct.__locale_t*, %struct.__locale_t** %3, align 8, !dbg !338, !tbaa !305
  %5 = icmp eq %struct.__locale_t* %4, null, !dbg !340
  %6 = select i1 %5, %struct.__locale_t* inttoptr (i64 -1 to %struct.__locale_t*), %struct.__locale_t* %4, !dbg !341
  %7 = ptrtoint %struct.__locale_t* %0 to i64, !dbg !342
  switch i64 %7, label %8 [
    i64 -1, label %9
    i64 0, label %11
  ], !dbg !342
...
; <label>:9:                                      ; preds = %1, %8
  ...
  store %struct.__locale_t* %10, %struct.__locale_t** %3, align 8, !dbg !344, !tbaa !305
  br label %11, !dbg !345

; <label>:11:                                     ; preds = %9, %1
  ret %struct.__locale_t* %6, !dbg !345
}
...
!314 = !DILocation(line: 61, column: 22, scope: !288)
!315 = !DILocation(line: 64, column: 8, scope: !316)
!316 = distinct !DILexicalBlock(scope: !288, file: !1, line: 64, column: 7)
!317 = !DILocation(line: 64, column: 7, scope: !288)
!318 = !DILocation(line: 66, column: 7, scope: !288)
!319 = !DILocation(line: 69, column: 5, scope: !320)
!320 = distinct !DILexicalBlock(scope: !321, file: !1, line: 68, column: 12)
!321 = distinct !DILexicalBlock(scope: !288, file: !1, line: 66, column: 7)
!322 = !DILocation(line: 0, scope: !321)
!323 = !DILocation(line: 70, column: 3, scope: !288)
!324 = distinct !DISubprogram(name: "uselocale", scope: !1, file: !1, line: 75, type: !325, isLocal: false, isDefinition: true, scopeLine: 76, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !329)
!325 = !DISubroutineType(types: !326)
!326 = !{!327, !4}
!327 = !DIDerivedType(tag: DW_TAG_typedef, name: "locale_t", file: !328, line: 10, baseType: !4)
...
!329 = !{!330}
!330 = !DILocalVariable(name: "newloc", arg: 1, scope: !324, file: !1, line: 75, type: !4)
!331 = !DILocation(line: 75, column: 31, scope: !324)
!332 = !DILocation(line: 77, column: 24, scope: !324)
!333 = !DILocation(line: 59, column: 30, scope: !288, inlinedAt: !334)
!334 = distinct !DILocation(line: 77, column: 10, scope: !324)
!335 = !DILocation(line: 59, column: 52, scope: !288, inlinedAt: !334)
!336 = !DILocation(line: 218, column: 32, scope: !298, inlinedAt: !337)
!337 = distinct !DILocation(line: 63, column: 20, scope: !288, inlinedAt: !334)
!338 = !DILocation(line: 220, column: 13, scope: !298, inlinedAt: !337)
!339 = !DILocation(line: 61, column: 22, scope: !288, inlinedAt: !334)
!340 = !DILocation(line: 64, column: 8, scope: !316, inlinedAt: !334)
!341 = !DILocation(line: 64, column: 7, scope: !288, inlinedAt: !334)
!342 = !DILocation(line: 66, column: 7, scope: !288, inlinedAt: !334)
!343 = !DILocation(line: 69, column: 5, scope: !320, inlinedAt: !334)
!344 = !DILocation(line: 0, scope: !324)
!345 = !DILocation(line: 77, column: 3, scope: !324)
