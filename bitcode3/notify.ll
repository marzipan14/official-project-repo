...
define dso_local i8* @keyspaceEventsFlagsToString(i32) local_unnamed_addr #3 !dbg !48 {
  %2 = tail call i8* @sdsempty() #5, !dbg !57
  %3 = and i32 %0, 2044, !dbg !59
  %4 = icmp eq i32 %3, 2044, !dbg !61
  br i1 %4, label %5, label %7, !dbg !62

; <label>:5:                                      ; preds = %1
  %6 = tail call i8* @sdscatlen(i8* %2, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0), i64 1) #5, !dbg !63
  br label %60, !dbg !65
...
; <label>:10:                                     ; preds = %7
  %11 = tail call i8* @sdscatlen(i8* %2, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i64 0, i64 0), i64 1) #5, !dbg !70
  br label %12, !dbg !71
...
; <label>:16:                                     ; preds = %12
  %17 = tail call i8* @sdscatlen(i8* %13, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i64 0, i64 0), i64 1) #5, !dbg !76
  br label %18, !dbg !77
...
; <label>:22:                                     ; preds = %18
  %23 = tail call i8* @sdscatlen(i8* %19, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3, i64 0, i64 0), i64 1) #5, !dbg !82
  br label %24, !dbg !83
...
; <label>:28:                                     ; preds = %24
  %29 = tail call i8* @sdscatlen(i8* %25, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.4, i64 0, i64 0), i64 1) #5, !dbg !88
  br label %30, !dbg !89
...
; <label>:34:                                     ; preds = %30
  %35 = tail call i8* @sdscatlen(i8* %31, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.5, i64 0, i64 0), i64 1) #5, !dbg !94
  br label %36, !dbg !95
...
; <label>:40:                                     ; preds = %36
  %41 = tail call i8* @sdscatlen(i8* %37, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.6, i64 0, i64 0), i64 1) #5, !dbg !100
  br label %42, !dbg !101
...
; <label>:46:                                     ; preds = %42
  %47 = tail call i8* @sdscatlen(i8* %43, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.7, i64 0, i64 0), i64 1) #5, !dbg !106
  br label %48, !dbg !107
...
; <label>:52:                                     ; preds = %48
  %53 = tail call i8* @sdscatlen(i8* %49, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.8, i64 0, i64 0), i64 1) #5, !dbg !112
  br label %54, !dbg !113
...
; <label>:58:                                     ; preds = %54
  %59 = tail call i8* @sdscatlen(i8* %55, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.9, i64 0, i64 0), i64 1) #5, !dbg !118
  br label %60, !dbg !119
...
; <label>:64:                                     ; preds = %60
  %65 = tail call i8* @sdscatlen(i8* %61, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.10, i64 0, i64 0), i64 1) #5, !dbg !124
  br label %66, !dbg !125
...
; <label>:70:                                     ; preds = %66
  %71 = tail call i8* @sdscatlen(i8* %67, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.11, i64 0, i64 0), i64 1) #5, !dbg !130
  br label %72, !dbg !131
...
; Function Attrs: noredzone nounwind
define dso_local void @notifyKeyspaceEvent(i32, i8*, %struct.redisObject*, i32) local_unnamed_addr #3 !dbg !134 {
  %5 = alloca [24 x i8], align 16
  %6 = getelementptr inbounds [24 x i8], [24 x i8]* %5, i64 0, i64 0, !dbg !167
  call void @llvm.lifetime.start.p0i8(i64 24, i8* nonnull %6) #6, !dbg !167
  tail call void @moduleNotifyKeyspaceEvent(i32 %0, i8* %1, %struct.redisObject* %2, i32 %3) #5, !dbg !169
...
; <label>:10:                                     ; preds = %4
  %11 = tail call i64 @strlen(i8* %1) #5, !dbg !184
  %12 = tail call %struct.redisObject* @createStringObject(i8* %1, i64 %11) #5, !dbg !185
...
; <label>:16:                                     ; preds = %10
  %17 = tail call i8* @sdsnewlen(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.12, i64 0, i64 0), i64 11) #5, !dbg !191
  %18 = sext i32 %3 to i64, !dbg !194
  %19 = call i32 @ll2string(i8* nonnull %6, i64 24, i64 %18) #5, !dbg !195
  %20 = sext i32 %19 to i64, !dbg !196
  %21 = call i8* @sdscatlen(i8* %17, i8* nonnull %6, i64 %20) #5, !dbg !197
  %22 = call i8* @sdscatlen(i8* %21, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.13, i64 0, i64 0), i64 3) #5, !dbg !198
  ...
  %25 = call i8* @sdscatsds(i8* %22, i8* %24) #5, !dbg !202
  %26 = call %struct.redisObject* @createObject(i32 0, i8* %25) #5, !dbg !203
  %27 = call i32 @pubsubPublishMessage(%struct.redisObject* %26, %struct.redisObject* %12) #5, !dbg !205
  call void @decrRefCount(%struct.redisObject* %26) #5, !dbg !206
...
; <label>:34:                                     ; preds = %29
  %35 = call i8* @sdsnewlen(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.14, i64 0, i64 0), i64 11) #5, !dbg !213
  %36 = icmp eq i32 %31, -1, !dbg !215
  br i1 %36, label %37, label %40, !dbg !217

; <label>:37:                                     ; preds = %34
  %38 = sext i32 %3 to i64, !dbg !218
  %39 = call i32 @ll2string(i8* nonnull %6, i64 24, i64 %38) #5, !dbg !219
  br label %40, !dbg !220

; <label>:40:                                     ; preds = %37, %34
  %41 = phi i32 [ %39, %37 ], [ %31, %34 ], !dbg !221
  %42 = sext i32 %41 to i64, !dbg !222
  %43 = call i8* @sdscatlen(i8* %35, i8* nonnull %6, i64 %42) #5, !dbg !223
  %44 = call i8* @sdscatlen(i8* %43, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.13, i64 0, i64 0), i64 3) #5, !dbg !224
  ...
  %47 = call i8* @sdscatsds(i8* %44, i8* %46) #5, !dbg !226
  %48 = call %struct.redisObject* @createObject(i32 0, i8* %47) #5, !dbg !227
  %49 = call i32 @pubsubPublishMessage(%struct.redisObject* %48, %struct.redisObject* %2) #5, !dbg !228
  call void @decrRefCount(%struct.redisObject* %48) #5, !dbg !229
  br label %50, !dbg !230

; <label>:50:                                     ; preds = %29, %40
  call void @decrRefCount(%struct.redisObject* %12) #5, !dbg !231
  br label %51, !dbg !232

; <label>:51:                                     ; preds = %4, %50
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %6) #6, !dbg !232
  ret void, !dbg !232
}

; Function Attrs: noredzone
declare dso_local void @moduleNotifyKeyspaceEvent(i32, i8*, %struct.redisObject*, i32) local_unnamed_addr #4

; Function Attrs: noredzone
declare dso_local %struct.redisObject* @createStringObject(i8*, i64) local_unnamed_addr #4
...
; Function Attrs: noredzone
declare dso_local i32 @pubsubPublishMessage(%struct.redisObject*, %struct.redisObject*) local_unnamed_addr #4
