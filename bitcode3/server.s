...
# %bb.0:
	movq	8(%rsi), %rsi
	movq	8(%rdx), %rdx
	jmp	dictSdsKeyCompare       # TAILCALL
.Lfunc_end19:
...
.LBB22_3:
	shrq	$3, %rsi
                                        # kill: def $esi killed $esi killed $rsi
	jmp	dictGenCaseHashFunction # TAILCALL
.LBB22_1:
	xorl	%esi, %esi
                                        # kill: def $esi killed $esi killed $rsi
	jmp	dictGenCaseHashFunction # TAILCALL
...
# %bb.0:
	...
	je	.LBB28_1
# %bb.2:
	jmp	dictDisableResize       # TAILCALL
.LBB28_1:
	jmp	dictEnableResize        # TAILCALL
.Lfunc_end28:
...
# %bb.21:                               #   in Loop: Header=BB36_20 Depth=1
	...
	cmpq	$-1, 80(%rdi)
	jne	.LBB36_24
# %bb.22:                               #   in Loop: Header=BB36_20 Depth=1
	addl	$1, %edx
	movl	%edx, %eax
	xorl	%edx, %edx
	divl	%esi
...
.LBB36_24:
	...
	popq	%r15
	popq	%rbp
	jmp	dictRehashMilliseconds  # TAILCALL
.Lfunc_end36:
...
.LBB58_5:
	...
	popq	%r15
	popq	%rbp
	jmp	replicationFeedSlaves   # TAILCALL
.Lfunc_end58:
...
# %bb.33:
	...
	jmp	.LBB64_34
	.p2align	4, 0x90
.LBB64_40:                              #   in Loop: Header=BB64_34 Depth=1
	addq	$1, %r12
	movslq	server+2232(%rip), %rax
	addq	$32, %rbx
	cmpq	%rax, %r12
	jge	.LBB64_41
.LBB64_34:                              # =>This Inner Loop Header: Depth=1
	movq	server+2224(%rip), %rax
	movl	-8(%rax,%rbx), %ecx
	movl	%ecx, %edx
	andl	$-2, %edx
	testb	$4, %r8b
...
.LBB72_7:
	...
	jne	.LBB72_11
.LBB72_8:
	movq	ClientsPeakMemInput(%rip), %r14
	movq	ClientsPeakMemInput+8(%rip), %rax
	cmpq	%r14, %rax
	cmovaq	%rax, %r14
	movq	ClientsPeakMemOutput(%rip), %rbx
...
.LBB86_10:
	...
	popq	%r14
	popq	%rbp
	jmp	redisSupervisedSystemd  # TAILCALL
.LBB86_5:
	xorl	%ebx, %ebx
	movl	$.L.str.458, %esi
	movl	$3, %edi
