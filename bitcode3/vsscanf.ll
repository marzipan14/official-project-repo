...
define dso_local i32 @_vsscanf_r(%struct._reent*, i8* noalias, i8* noalias, %struct.__va_list_tag*) local_unnamed_addr #0 !dbg !34 {
  ...
  %6 = bitcast %struct.__sFILE* %5 to i8*, !dbg !306
  call void @llvm.lifetime.start.p0i8(i64 176, i8* nonnull %6) #5, !dbg !306
  %7 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %5, i64 0, i32 3, !dbg !307
  store i16 516, i16* %7, align 8, !dbg !308, !tbaa !265
  %8 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %5, i64 0, i32 0, !dbg !309
  store i8* %1, i8** %8, align 8, !dbg !310, !tbaa !277
  %9 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %5, i64 0, i32 5, i32 0, !dbg !311
  store i8* %1, i8** %9, align 8, !dbg !312, !tbaa !280
  %10 = tail call i64 @strlen(i8* %1) #4, !dbg !313
  %11 = trunc i64 %10 to i32, !dbg !313
  %12 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %5, i64 0, i32 1, !dbg !314
  store i32 %11, i32* %12, align 8, !dbg !315, !tbaa !285
  %13 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %5, i64 0, i32 5, i32 1, !dbg !316
  store i32 %11, i32* %13, align 8, !dbg !317, !tbaa !288
  %14 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %5, i64 0, i32 8, !dbg !318
  store i64 (%struct._reent*, i8*, i8*, i32)* @__seofread, i64 (%struct._reent*, i8*, i8*, i32)** %14, align 8, !dbg !319, !tbaa !291
  %15 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %5, i64 0, i32 12, i32 0, !dbg !320
  store i8* null, i8** %15, align 8, !dbg !321, !tbaa !294
  %16 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %5, i64 0, i32 17, i32 0, !dbg !322
  store i8* null, i8** %16, align 8, !dbg !323, !tbaa !297
  %17 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %5, i64 0, i32 4, !dbg !324
  store i16 -1, i16* %17, align 2, !dbg !325, !tbaa !300
  %18 = call i32 @__ssvfscanf_r(%struct._reent* %0, %struct.__sFILE* nonnull %5, i8* %2, %struct.__va_list_tag* %3) #4, !dbg !327
...
!304 = !DILocation(line: 43, column: 3, scope: !10)
!305 = !DILocation(line: 55, column: 1, scope: !34)
!306 = !DILocation(line: 61, column: 3, scope: !34)
!307 = !DILocation(line: 63, column: 5, scope: !34)
!308 = !DILocation(line: 63, column: 12, scope: !34)
!309 = !DILocation(line: 64, column: 19, scope: !34)
!310 = !DILocation(line: 64, column: 22, scope: !34)
!311 = !DILocation(line: 64, column: 9, scope: !34)
!312 = !DILocation(line: 64, column: 15, scope: !34)
!313 = !DILocation(line: 65, column: 24, scope: !34)
!314 = !DILocation(line: 65, column: 19, scope: !34)
!315 = !DILocation(line: 65, column: 22, scope: !34)
!316 = !DILocation(line: 65, column: 9, scope: !34)
!317 = !DILocation(line: 65, column: 15, scope: !34)
!318 = !DILocation(line: 66, column: 5, scope: !34)
!319 = !DILocation(line: 66, column: 11, scope: !34)
!320 = !DILocation(line: 67, column: 9, scope: !34)
!321 = !DILocation(line: 67, column: 15, scope: !34)
!322 = !DILocation(line: 68, column: 9, scope: !34)
!323 = !DILocation(line: 68, column: 15, scope: !34)
!324 = !DILocation(line: 69, column: 5, scope: !34)
!325 = !DILocation(line: 69, column: 11, scope: !34)
!326 = !DILocation(line: 61, column: 8, scope: !34)
!327 = !DILocation(line: 70, column: 10, scope: !34)
!328 = !DILocation(line: 71, column: 1, scope: !34)
!329 = !DILocation(line: 70, column: 3, scope: !34)
