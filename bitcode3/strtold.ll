...
define dso_local x86_fp80 @_strtold_r(%struct._reent*, i8* noalias, i8** noalias) local_unnamed_addr #0 !dbg !34 {
  ...
  %8 = select i1 %7, %struct.__locale_t* @__global_locale, %struct.__locale_t* %6, !dbg !325
  %9 = tail call double @_strtod_l(%struct._reent* %0, i8* %1, i8** %2, %struct.__locale_t* %8) #5, !dbg !337
  %10 = fpext double %9 to x86_fp80, !dbg !337
  ret x86_fp80 %10, !dbg !338
}
...
; Function Attrs: noredzone nounwind
define dso_local x86_fp80 @strtold_l(i8* noalias, i8** noalias, %struct.__locale_t*) local_unnamed_addr #0 !dbg !339 {
  %4 = tail call %struct._reent* @__getreent() #5, !dbg !351
  %5 = tail call double @_strtod_l(%struct._reent* %4, i8* %0, i8** %1, %struct.__locale_t* %2) #5, !dbg !352
  %6 = fpext double %5 to x86_fp80, !dbg !352
  ret x86_fp80 %6, !dbg !353
}
...
; Function Attrs: noredzone nounwind
define dso_local x86_fp80 @strtold(i8* noalias, i8** noalias) local_unnamed_addr #0 !dbg !354 {
  %3 = tail call %struct._reent* @__getreent() #5, !dbg !362
  %4 = tail call %struct._reent* @__getreent() #5, !dbg !363
  %5 = getelementptr inbounds %struct._reent, %struct._reent* %4, i64 0, i32 7, !dbg !365
  %6 = load %struct.__locale_t*, %struct.__locale_t** %5, align 8, !dbg !365, !tbaa !331
  %7 = icmp eq %struct.__locale_t* %6, null, !dbg !363
  %8 = select i1 %7, %struct.__locale_t* @__global_locale, %struct.__locale_t* %6, !dbg !363
  %9 = tail call double @_strtod_l(%struct._reent* %3, i8* %0, i8** %1, %struct.__locale_t* %8) #5, !dbg !366
  %10 = fpext double %9 to x86_fp80, !dbg !366
  ret x86_fp80 %10, !dbg !367
}
...
!337 = !DILocation(line: 67, column: 10, scope: !34)
!338 = !DILocation(line: 67, column: 3, scope: !34)
!339 = distinct !DISubprogram(name: "strtold_l", scope: !3, file: !3, line: 77, type: !340, isLocal: false, isDefinition: true, scopeLine: 78, flags: DIFlagPrototyped, isOptimized: true, unit: !2, retainedNodes: !344)
!340 = !DISubroutineType(types: !341)
!341 = !{!37, !315, !316, !342}
!342 = !DIDerivedType(tag: DW_TAG_typedef, name: "locale_t", file: !343, line: 10, baseType: !132)
!343 = !DIFile(filename: "/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/include/xlocale.h", directory: "/root/.unikraft/apps/redis/build")
!344 = !{!345, !346, !347}
!345 = !DILocalVariable(name: "s00", arg: 1, scope: !339, file: !3, line: 77, type: !315)
!346 = !DILocalVariable(name: "se", arg: 2, scope: !339, file: !3, line: 77, type: !316)
!347 = !DILocalVariable(name: "loc", arg: 3, scope: !339, file: !3, line: 77, type: !342)
!348 = !DILocation(line: 77, column: 35, scope: !339)
!349 = !DILocation(line: 77, column: 58, scope: !339)
!350 = !DILocation(line: 77, column: 71, scope: !339)
!351 = !DILocation(line: 81, column: 21, scope: !339)
!352 = !DILocation(line: 81, column: 10, scope: !339)
!353 = !DILocation(line: 81, column: 3, scope: !339)
!354 = distinct !DISubprogram(name: "strtold", scope: !3, file: !3, line: 91, type: !355, isLocal: false, isDefinition: true, scopeLine: 92, flags: DIFlagPrototyped, isOptimized: true, unit: !2, retainedNodes: !357)
!355 = !DISubroutineType(types: !356)
!356 = !{!37, !315, !316}
!357 = !{!358, !359}
!358 = !DILocalVariable(name: "s00", arg: 1, scope: !354, file: !3, line: 91, type: !315)
!359 = !DILocalVariable(name: "se", arg: 2, scope: !354, file: !3, line: 91, type: !316)
!360 = !DILocation(line: 91, column: 33, scope: !354)
!361 = !DILocation(line: 91, column: 56, scope: !354)
!362 = !DILocation(line: 95, column: 21, scope: !354)
!363 = !DILocation(line: 230, column: 10, scope: !326, inlinedAt: !364)
!364 = distinct !DILocation(line: 95, column: 38, scope: !354)
!365 = !DILocation(line: 230, column: 18, scope: !326, inlinedAt: !364)
!366 = !DILocation(line: 95, column: 10, scope: !354)
!367 = !DILocation(line: 95, column: 3, scope: !354)
