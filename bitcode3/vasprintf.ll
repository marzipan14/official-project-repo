...
define dso_local i32 @_vasprintf_r(%struct._reent*, i8** nocapture, i8*, %struct.__va_list_tag*) local_unnamed_addr #0 !dbg !33 {
  ...
  %6 = bitcast %struct.__sFILE* %5 to i8*, !dbg !304
  call void @llvm.lifetime.start.p0i8(i64 176, i8* nonnull %6) #5, !dbg !304
  %7 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %5, i64 0, i32 3, !dbg !305
  store i16 648, i16* %7, align 8, !dbg !306, !tbaa !262
  %8 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %5, i64 0, i32 0, !dbg !307
  store i8* null, i8** %8, align 8, !dbg !308, !tbaa !274
  %9 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %5, i64 0, i32 5, i32 0, !dbg !309
  store i8* null, i8** %9, align 8, !dbg !310, !tbaa !277
  %10 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %5, i64 0, i32 2, !dbg !311
  store i32 0, i32* %10, align 4, !dbg !312, !tbaa !280
  %11 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %5, i64 0, i32 5, i32 1, !dbg !313
  store i32 0, i32* %11, align 8, !dbg !314, !tbaa !283
  %12 = getelementptr inbounds %struct.__sFILE, %struct.__sFILE* %5, i64 0, i32 4, !dbg !315
  store i16 -1, i16* %12, align 2, !dbg !316, !tbaa !286
  %13 = call i32 @_svfprintf_r(%struct._reent* %0, %struct.__sFILE* nonnull %5, i8* %2, %struct.__va_list_tag* %3) #4, !dbg !318
  %14 = icmp sgt i32 %13, -1, !dbg !320
  br i1 %14, label %15, label %20, !dbg !321

; <label>:15:                                     ; preds = %4
  %16 = load i8*, i8** %8, align 8, !dbg !322, !tbaa !274
  store i8 0, i8* %16, align 1, !dbg !323, !tbaa !296
  %17 = bitcast i8** %9 to i64*, !dbg !324
  %18 = load i64, i64* %17, align 8, !dbg !324, !tbaa !277
  %19 = bitcast i8** %1 to i64*, !dbg !325
  store i64 %18, i64* %19, align 8, !dbg !325, !tbaa !299
  br label %20, !dbg !326

; <label>:20:                                     ; preds = %15, %4
  call void @llvm.lifetime.end.p0i8(i64 176, i8* nonnull %6) #5, !dbg !327
  ret i32 %13, !dbg !328
}
...
!302 = !DILocation(line: 39, column: 3, scope: !10)
!303 = !DILocation(line: 51, column: 1, scope: !33)
!304 = !DILocation(line: 58, column: 3, scope: !33)
!305 = !DILocation(line: 60, column: 5, scope: !33)
!306 = !DILocation(line: 60, column: 12, scope: !33)
!307 = !DILocation(line: 61, column: 19, scope: !33)
!308 = !DILocation(line: 61, column: 22, scope: !33)
!309 = !DILocation(line: 61, column: 9, scope: !33)
!310 = !DILocation(line: 61, column: 15, scope: !33)
!311 = !DILocation(line: 62, column: 19, scope: !33)
!312 = !DILocation(line: 62, column: 22, scope: !33)
!313 = !DILocation(line: 62, column: 9, scope: !33)
!314 = !DILocation(line: 62, column: 15, scope: !33)
!315 = !DILocation(line: 63, column: 5, scope: !33)
!316 = !DILocation(line: 63, column: 11, scope: !33)
!317 = !DILocation(line: 58, column: 8, scope: !33)
!318 = !DILocation(line: 64, column: 9, scope: !33)
!319 = !DILocation(line: 57, column: 7, scope: !33)
!320 = !DILocation(line: 65, column: 11, scope: !291)
!321 = !DILocation(line: 65, column: 7, scope: !33)
!322 = !DILocation(line: 67, column: 10, scope: !294)
!323 = !DILocation(line: 67, column: 13, scope: !294)
!324 = !DILocation(line: 68, column: 30, scope: !294)
!325 = !DILocation(line: 68, column: 13, scope: !294)
!326 = !DILocation(line: 69, column: 5, scope: !294)
!327 = !DILocation(line: 71, column: 1, scope: !33)
!328 = !DILocation(line: 70, column: 3, scope: !33)
