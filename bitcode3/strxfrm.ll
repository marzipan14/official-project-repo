...
define dso_local i64 @strxfrm(i8* noalias nocapture, i8* noalias nocapture readonly, i64) local_unnamed_addr #0 !dbg !7 {
  ...
  br i1 %4, label %5, label %10, !dbg !29
...
; <label>:18:                                     ; preds = %10
  ...
  %22 = icmp eq i64 %15, 0, !dbg !28
  br i1 %22, label %5, label %10, !dbg !29, !llvm.loop !46
...
!28 = !DILocation(line: 63, column: 14, scope: !7)
!29 = !DILocation(line: 63, column: 3, scope: !7)
