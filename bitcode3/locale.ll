...
; <label>:5:                                      ; preds = %3
  %6 = tail call i32 @strcmp(i8* nonnull %2, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.2, i64 0, i64 0)) #4, !dbg !303
  %7 = icmp eq i32 %6, 0, !dbg !303
  br i1 %7, label %14, label %8, !dbg !306

; <label>:8:                                      ; preds = %5
  %9 = tail call i32 @strcmp(i8* nonnull %2, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3, i64 0, i64 0)) #4, !dbg !307
  %10 = icmp eq i32 %9, 0, !dbg !307
  br i1 %10, label %14, label %11, !dbg !308

; <label>:11:                                     ; preds = %8
  %12 = tail call i32 @strcmp(i8* nonnull %2, i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str.1, i64 0, i64 0)) #4, !dbg !309
...
define dso_local i32 @__locale_mb_cur_max() local_unnamed_addr #1 !dbg !314 {
  %1 = tail call %struct._reent* @__getreent() #4, !dbg !317
  ...
  %5 = select i1 %4, %struct.__locale_t* bitcast ({ [7 x [32 x i8]], i32 (%struct._reent*, i8*, i32, %struct._mbstate_t*)*, i32 (%struct._reent*, i32*, i8*, i64, %struct._mbstate_t*)*, i32, i8*, %struct.lconv, [2 x i8], [32 x i8], [32 x i8] }* @__global_locale to %struct.__locale_t*), %struct.__locale_t* %3, !dbg !317
  %6 = getelementptr inbounds %struct.__locale_t, %struct.__locale_t* %5, i64 0, i32 6, i64 0, !dbg !332
  %7 = load i8, i8* %6, align 8, !dbg !332, !tbaa !333
  %8 = sext i8 %7 to i32, !dbg !332
  ret i32 %8, !dbg !334
}

; Function Attrs: noredzone nounwind readonly
define dso_local i8* @__locale_ctype_ptr_l(%struct.__locale_t* nocapture readonly) local_unnamed_addr #2 !dbg !335 {
  %2 = getelementptr inbounds %struct.__locale_t, %struct.__locale_t* %0, i64 0, i32 4, !dbg !341
  %3 = load i8*, i8** %2, align 8, !dbg !341, !tbaa !342
  ret i8* %3, !dbg !345
}

; Function Attrs: noredzone nounwind
define dso_local i8* @__locale_ctype_ptr() local_unnamed_addr #1 !dbg !346 {
  %1 = tail call %struct._reent* @__getreent() #4, !dbg !349
  %2 = getelementptr inbounds %struct._reent, %struct._reent* %1, i64 0, i32 7, !dbg !351
  %3 = load %struct.__locale_t*, %struct.__locale_t** %2, align 8, !dbg !351, !tbaa !323
  %4 = icmp eq %struct.__locale_t* %3, null, !dbg !349
  %5 = select i1 %4, %struct.__locale_t* bitcast ({ [7 x [32 x i8]], i32 (%struct._reent*, i8*, i32, %struct._mbstate_t*)*, i32 (%struct._reent*, i32*, i8*, i64, %struct._mbstate_t*)*, i32, i8*, %struct.lconv, [2 x i8], [32 x i8], [32 x i8] }* @__global_locale to %struct.__locale_t*), %struct.__locale_t* %3, !dbg !349
  %6 = getelementptr inbounds %struct.__locale_t, %struct.__locale_t* %5, i64 0, i32 4, !dbg !352
  %7 = load i8*, i8** %6, align 8, !dbg !352, !tbaa !342
  ret i8* %7, !dbg !353
}

; Function Attrs: noredzone nounwind
define dso_local i8* @setlocale(i32, i8*) local_unnamed_addr #1 !dbg !354 {
  %3 = tail call %struct._reent* @__getreent() #4, !dbg !361
  %4 = icmp eq i8* %1, null, !dbg !364
  br i1 %4, label %14, label %5, !dbg !365

; <label>:5:                                      ; preds = %2
  %6 = tail call i32 @strcmp(i8* nonnull %1, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.2, i64 0, i64 0)) #4, !dbg !366
  %7 = icmp eq i32 %6, 0, !dbg !366
  br i1 %7, label %14, label %8, !dbg !367

; <label>:8:                                      ; preds = %5
  %9 = tail call i32 @strcmp(i8* nonnull %1, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3, i64 0, i64 0)) #4, !dbg !368
  %10 = icmp eq i32 %9, 0, !dbg !368
  br i1 %10, label %14, label %11, !dbg !369

; <label>:11:                                     ; preds = %8
  %12 = tail call i32 @strcmp(i8* nonnull %1, i8* getelementptr inbounds ([1 x i8], [1 x i8]* @.str.1, i64 0, i64 0)) #4, !dbg !370
  %13 = icmp eq i32 %12, 0, !dbg !370
  br i1 %13, label %14, label %15, !dbg !371

; <label>:14:                                     ; preds = %11, %8, %5, %2
  br label %15, !dbg !372

; <label>:15:                                     ; preds = %11, %14
  %16 = phi i8* [ getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3, i64 0, i64 0), %14 ], [ null, %11 ], !dbg !373
  ret i8* %16, !dbg !374
}
...
!332 = !DILocation(line: 990, column: 10, scope: !314)
!333 = !{!326, !326, i64 0}
!334 = !DILocation(line: 990, column: 3, scope: !314)
!335 = distinct !DISubprogram(name: "__locale_ctype_ptr_l", scope: !3, file: !3, line: 995, type: !336, isLocal: false, isDefinition: true, scopeLine: 996, flags: DIFlagPrototyped, isOptimized: true, unit: !2, retainedNodes: !338)
!336 = !DISubroutineType(types: !337)
!337 = !{!60, !117}
!338 = !{!339}
!339 = !DILocalVariable(name: "locale", arg: 1, scope: !335, file: !3, line: 995, type: !117)
!340 = !DILocation(line: 995, column: 42, scope: !335)
!341 = !DILocation(line: 997, column: 18, scope: !335)
!342 = !{!343, !328, i64 248}
!343 = !{!"__locale_t", !326, i64 0, !328, i64 224, !328, i64 232, !325, i64 240, !328, i64 248, !344, i64 256, !326, i64 352, !326, i64 354, !326, i64 386}
!344 = !{!"lconv", !328, i64 0, !328, i64 8, !328, i64 16, !328, i64 24, !328, i64 32, !328, i64 40, !328, i64 48, !328, i64 56, !328, i64 64, !328, i64 72, !326, i64 80, !326, i64 81, !326, i64 82, !326, i64 83, !326, i64 84, !326, i64 85, !326, i64 86, !326, i64 87, !326, i64 88, !326, i64 89, !326, i64 90, !326, i64 91, !326, i64 92, !326, i64 93}
!345 = !DILocation(line: 997, column: 3, scope: !335)
!346 = distinct !DISubprogram(name: "__locale_ctype_ptr", scope: !3, file: !3, line: 1001, type: !347, isLocal: false, isDefinition: true, scopeLine: 1002, flags: DIFlagPrototyped, isOptimized: true, unit: !2, retainedNodes: !4)
!347 = !DISubroutineType(types: !348)
!348 = !{!60}
!349 = !DILocation(line: 230, column: 10, scope: !318, inlinedAt: !350)
!350 = distinct !DILocation(line: 1003, column: 10, scope: !346)
!351 = !DILocation(line: 230, column: 18, scope: !318, inlinedAt: !350)
!352 = !DILocation(line: 1003, column: 35, scope: !346)
!353 = !DILocation(line: 1003, column: 3, scope: !346)
!354 = distinct !DISubprogram(name: "setlocale", scope: !3, file: !3, line: 1009, type: !355, isLocal: false, isDefinition: true, scopeLine: 1012, flags: DIFlagPrototyped, isOptimized: true, unit: !2, retainedNodes: !357)
!355 = !DISubroutineType(types: !356)
!356 = !{!55, !21, !60}
!357 = !{!358, !359}
!358 = !DILocalVariable(name: "category", arg: 1, scope: !354, file: !3, line: 1009, type: !21)
!359 = !DILocalVariable(name: "locale", arg: 2, scope: !354, file: !3, line: 1009, type: !60)
!360 = !DILocation(line: 1009, column: 1, scope: !354)
!361 = !DILocation(line: 1013, column: 24, scope: !354)
!362 = !DILocation(line: 308, column: 1, scope: !292, inlinedAt: !363)
!363 = distinct !DILocation(line: 1013, column: 10, scope: !354)
!364 = !DILocation(line: 314, column: 7, scope: !301, inlinedAt: !363)
!365 = !DILocation(line: 314, column: 7, scope: !292, inlinedAt: !363)
!366 = !DILocation(line: 316, column: 11, scope: !304, inlinedAt: !363)
!367 = !DILocation(line: 316, column: 36, scope: !304, inlinedAt: !363)
!368 = !DILocation(line: 316, column: 39, scope: !304, inlinedAt: !363)
!369 = !DILocation(line: 317, column: 4, scope: !304, inlinedAt: !363)
!370 = !DILocation(line: 317, column: 7, scope: !304, inlinedAt: !363)
!371 = !DILocation(line: 316, column: 11, scope: !305, inlinedAt: !363)
!372 = !DILocation(line: 320, column: 3, scope: !292, inlinedAt: !363)
!373 = !DILocation(line: 0, scope: !292, inlinedAt: !363)
!374 = !DILocation(line: 1013, column: 3, scope: !354)
