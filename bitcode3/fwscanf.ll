; ModuleID = '/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/stdio/fwscanf.c'
source_filename = "/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/stdio/fwscanf.c"
...
define dso_local i32 @fwscanf(%struct.__sFILE* noalias, i32* noalias, ...) local_unnamed_addr #0 !dbg !7 {
  %3 = alloca [1 x %struct.__va_list_tag], align 16
  %4 = bitcast [1 x %struct.__va_list_tag]* %3 to i8*, !dbg !256
  call void @llvm.lifetime.start.p0i8(i64 24, i8* nonnull %4) #3, !dbg !256
  %5 = getelementptr inbounds [1 x %struct.__va_list_tag], [1 x %struct.__va_list_tag]* %3, i64 0, i64 0, !dbg !258
  call void @llvm.va_start(i8* nonnull %4), !dbg !258
  %6 = call %struct._reent* @__getreent() #5, !dbg !259
  %7 = call i32 @_vfwscanf_r(%struct._reent* %6, %struct.__sFILE* %0, i32* %1, %struct.__va_list_tag* nonnull %5) #5, !dbg !260
  call void @llvm.va_end(i8* nonnull %4), !dbg !262
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %4) #3, !dbg !263
  ret i32 %7, !dbg !264
}
...
declare dso_local i32 @_vfwscanf_r(%struct._reent*, %struct.__sFILE*, i32*, %struct.__va_list_tag*) local_unnamed_addr #4
...
; Function Attrs: noredzone nounwind
define dso_local i32 @_fwscanf_r(%struct._reent*, %struct.__sFILE*, i32*, ...) local_unnamed_addr #0 !dbg !265 {
  %4 = alloca [1 x %struct.__va_list_tag], align 16
  %5 = bitcast [1 x %struct.__va_list_tag]* %4 to i8*, !dbg !277
  call void @llvm.lifetime.start.p0i8(i64 24, i8* nonnull %5) #3, !dbg !277
  %6 = getelementptr inbounds [1 x %struct.__va_list_tag], [1 x %struct.__va_list_tag]* %4, i64 0, i64 0, !dbg !279
  call void @llvm.va_start(i8* nonnull %5), !dbg !279
  %7 = call i32 @_vfwscanf_r(%struct._reent* %0, %struct.__sFILE* %1, i32* %2, %struct.__va_list_tag* nonnull %6) #5, !dbg !280
  call void @llvm.va_end(i8* nonnull %5), !dbg !282
  call void @llvm.lifetime.end.p0i8(i64 24, i8* nonnull %5) #3, !dbg !283
  ret i32 %7, !dbg !284
}
...
!1 = !DIFile(filename: "/root/.unikraft/apps/redis/build/libnewlibc/origin/newlib-2.5.0.20170922/newlib/libc/stdio/fwscanf.c", directory: "/root/.unikraft/apps/redis/build")
!2 = !{}
!3 = !{i32 2, !"Dwarf Version", i32 4}
!4 = !{i32 2, !"Debug Info Version", i32 3}
!5 = !{i32 1, !"wchar_size", i32 4}
!6 = !{!"clang version 7.0.1-8+deb10u2 (tags/RELEASE_701/final)"}
!7 = distinct !DISubprogram(name: "fwscanf", scope: !1, file: !1, line: 29, type: !8, isLocal: false, isDefinition: true, scopeLine: 30, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !238)
...
!237 = !DIDerivedType(tag: DW_TAG_typedef, name: "wchar_t", file: !134, line: 83, baseType: !10)
!238 = !{!239, !240, !241, !242}
!239 = !DILocalVariable(name: "fp", arg: 1, scope: !7, file: !1, line: 29, type: !11)
!240 = !DILocalVariable(name: "fmt", arg: 2, scope: !7, file: !1, line: 29, type: !234)
!241 = !DILocalVariable(name: "ret", scope: !7, file: !1, line: 31, type: !10)
!242 = !DILocalVariable(name: "ap", scope: !7, file: !1, line: 32, type: !243)
!243 = !DIDerivedType(tag: DW_TAG_typedef, name: "va_list", file: !14, line: 46, baseType: !244)
...
!246 = !DIDerivedType(tag: DW_TAG_typedef, name: "__builtin_va_list", file: !1, line: 32, baseType: !247)
!247 = !DICompositeType(tag: DW_TAG_array_type, baseType: !248, size: 192, elements: !78)
!248 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "__va_list_tag", file: !1, line: 32, size: 192, elements: !249)
!249 = !{!250, !251, !252, !253}
!250 = !DIDerivedType(tag: DW_TAG_member, name: "gp_offset", scope: !248, file: !1, line: 32, baseType: !77, size: 32)
!251 = !DIDerivedType(tag: DW_TAG_member, name: "fp_offset", scope: !248, file: !1, line: 32, baseType: !77, size: 32, offset: 32)
!252 = !DIDerivedType(tag: DW_TAG_member, name: "overflow_arg_area", scope: !248, file: !1, line: 32, baseType: !34, size: 64, offset: 64)
!253 = !DIDerivedType(tag: DW_TAG_member, name: "reg_save_area", scope: !248, file: !1, line: 32, baseType: !34, size: 64, offset: 128)
!254 = !DILocation(line: 29, column: 27, scope: !7)
!255 = !DILocation(line: 29, column: 58, scope: !7)
!256 = !DILocation(line: 32, column: 3, scope: !7)
!257 = !DILocation(line: 32, column: 11, scope: !7)
!258 = !DILocation(line: 34, column: 3, scope: !7)
!259 = !DILocation(line: 35, column: 22, scope: !7)
!260 = !DILocation(line: 35, column: 9, scope: !7)
!261 = !DILocation(line: 31, column: 7, scope: !7)
!262 = !DILocation(line: 36, column: 3, scope: !7)
!263 = !DILocation(line: 38, column: 1, scope: !7)
!264 = !DILocation(line: 37, column: 3, scope: !7)
!265 = distinct !DISubprogram(name: "_fwscanf_r", scope: !1, file: !1, line: 43, type: !266, isLocal: false, isDefinition: true, scopeLine: 44, flags: DIFlagPrototyped, isOptimized: true, unit: !0, retainedNodes: !268)
!266 = !DISubroutineType(types: !267)
!267 = !{!10, !42, !12, !235, null}
!268 = !{!269, !270, !271, !272, !273}
!269 = !DILocalVariable(name: "ptr", arg: 1, scope: !265, file: !1, line: 43, type: !42)
!270 = !DILocalVariable(name: "fp", arg: 2, scope: !265, file: !1, line: 43, type: !12)
!271 = !DILocalVariable(name: "fmt", arg: 3, scope: !265, file: !1, line: 43, type: !235)
!272 = !DILocalVariable(name: "ret", scope: !265, file: !1, line: 45, type: !10)
!273 = !DILocalVariable(name: "ap", scope: !265, file: !1, line: 46, type: !243)
!274 = !DILocation(line: 43, column: 28, scope: !265)
!275 = !DILocation(line: 43, column: 39, scope: !265)
!276 = !DILocation(line: 43, column: 59, scope: !265)
!277 = !DILocation(line: 46, column: 3, scope: !265)
!278 = !DILocation(line: 46, column: 11, scope: !265)
!279 = !DILocation(line: 48, column: 3, scope: !265)
!280 = !DILocation(line: 49, column: 9, scope: !265)
!281 = !DILocation(line: 45, column: 7, scope: !265)
!282 = !DILocation(line: 50, column: 3, scope: !265)
!283 = !DILocation(line: 52, column: 1, scope: !265)
!284 = !DILocation(line: 51, column: 3, scope: !265)
