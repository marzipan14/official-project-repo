...
define dso_local i32 @getservbyport_r(i32, i8* nocapture readnone, %struct.servent* nocapture readnone, i8* nocapture readnone, i64, %struct.servent** nocapture readnone) local_unnamed_addr #1 !dbg !39 {
  %7 = tail call i32* @__errno() #4, !dbg !61
