...
.LBB1_12:
	...
	popq	%r15
	popq	%rbp
	jmp	redisProtocolToLuaType_MultiBulk # TAILCALL
.LBB1_8:
	leaq	1(%rbx), %r15
	movq	%r15, %rdi
	movl	$13, %esi
...
# %bb.14:                               #   in Loop: Header=BB12_10 Depth=1
	movq	luaRedisGenericCommand.cached_objects(,%rbx,8), %rcx
	testq	%rcx, %rcx
	je	.LBB12_8
# %bb.15:                               #   in Loop: Header=BB12_10 Depth=1
	movq	-56(%rbp), %rdx
	cmpq	%rdx, luaRedisGenericCommand.cached_objects_len(,%rbx,8)
	jb	.LBB12_8
# %bb.16:                               #   in Loop: Header=BB12_10 Depth=1
	movq	8(%rcx), %r15
	movq	luaRedisGenericCommand.argv(%rip), %rsi
	movq	%rcx, (%rsi,%rbx,8)
	movq	$0, luaRedisGenericCommand.cached_objects(,%rbx,8)
	addq	$1, %rdx
	movq	%r15, %rdi
	movq	%rax, %rsi
	callq	memcpy
...
# %bb.121:                              # %.preheader
	...
	jmp	.LBB12_124
	.p2align	4, 0x90
.LBB12_122:                             #   in Loop: Header=BB12_124 Depth=1
	movq	%r14, %rdi
	callq	decrRefCount
.LBB12_123:                             #   in Loop: Header=BB12_124 Depth=1
	movq	-64(%rbp), %r15         # 8-byte Reload
	addq	$1, %rbx
	movslq	64(%r12), %rax
	movq	72(%r12), %rdi
...
# %bb.125:                              #   in Loop: Header=BB12_124 Depth=1
	cmpl	$1, 4(%r14)
	jne	.LBB12_122
# %bb.126:                              #   in Loop: Header=BB12_124 Depth=1
	movzbl	(%r14), %eax
	shrb	$4, %al
	orb	$8, %al
	cmpb	$8, %al
...
# %bb.128:                              #   in Loop: Header=BB12_124 Depth=1
	movzbl	%al, %eax
	jmpq	*.LJTI12_1(,%rax,8)
.LBB12_129:                             #   in Loop: Header=BB12_124 Depth=1
	movzbl	-3(%r15), %eax
	cmpq	$64, %rax
	jbe	.LBB12_133
	jmp	.LBB12_122
.LBB12_130:                             #   in Loop: Header=BB12_124 Depth=1
	...
	ja	.LBB12_122
	jmp	.LBB12_133
.LBB12_131:                             #   in Loop: Header=BB12_124 Depth=1
	movl	-9(%r15), %eax
	cmpq	$64, %rax
	ja	.LBB12_122
	jmp	.LBB12_133
.LBB12_132:                             #   in Loop: Header=BB12_124 Depth=1
	...
	cmpq	$64, %rax
	ja	.LBB12_122
.LBB12_133:                             #   in Loop: Header=BB12_124 Depth=1
	movq	luaRedisGenericCommand.cached_objects(,%rbx,8), %rdi
	testq	%rdi, %rdi
	je	.LBB12_135
# %bb.134:                              #   in Loop: Header=BB12_124 Depth=1
	callq	decrRefCount
.LBB12_135:                             #   in Loop: Header=BB12_124 Depth=1
	...
	cmpb	$4, %cl
	ja	.LBB12_138
# %bb.136:                              #   in Loop: Header=BB12_124 Depth=1
	movl	%eax, %ecx
	andl	$7, %ecx
	jmpq	*.LJTI12_2(,%rcx,8)
.LBB12_137:                             #   in Loop: Header=BB12_124 Depth=1
	shrq	$3, %rax
...
.LBB12_138:                             #   in Loop: Header=BB12_124 Depth=1
	...
	movq	%rax, luaRedisGenericCommand.cached_objects_len(,%rbx,8)
	jmp	.LBB12_123
.LBB12_139:                             #   in Loop: Header=BB12_124 Depth=1
	movzbl	-2(%r15), %eax
	movq	%rax, luaRedisGenericCommand.cached_objects_len(,%rbx,8)
	jmp	.LBB12_123
.LBB12_140:                             #   in Loop: Header=BB12_124 Depth=1
	...
	movq	%rax, luaRedisGenericCommand.cached_objects_len(,%rbx,8)
	jmp	.LBB12_123
.LBB12_141:                             #   in Loop: Header=BB12_124 Depth=1
	movl	-5(%r15), %eax
	movq	%rax, luaRedisGenericCommand.cached_objects_len(,%rbx,8)
	jmp	.LBB12_123
.LBB12_142:                             #   in Loop: Header=BB12_124 Depth=1
	movq	-9(%r15), %rax
	movq	%rax, luaRedisGenericCommand.cached_objects_len(,%rbx,8)
	jmp	.LBB12_123
.LBB12_143:
...
# %bb.0:
	movl	$1, %esi
	jmp	luaRedisGenericCommand  # TAILCALL
.Lfunc_end14:
...
# %bb.0:
	xorl	%ecx, %ecx
	jmp	ldbCatStackValueRec     # TAILCALL
.Lfunc_end23:
...
.LBB40_22:                              # =>This Inner Loop Header: Depth=1
	...
	je	.LBB40_23
# %bb.21:                               #   in Loop: Header=BB40_22 Depth=1
	addq	$1, %rcx
	cmpq	%rax, %rcx
	jl	.LBB40_22
	jmp	.LBB40_24
...
# %bb.3:
	...
	popq	%rbx
	popq	%rbp
	jmp	evalGenericCommand      # TAILCALL
.LBB41_1:
	movq	%rbx, %rdi
...
# %bb.23:
	...
	popq	%r15
	popq	%rbp
	jmp	forceCommandPropagation # TAILCALL
.LBB44_18:
	movq	server+3008(%rip), %rax
	testq	%rax, %rax
	je	.LBB44_19
...
.LBB44_42:                              # =>This Inner Loop Header: Depth=1
	...
	testq	%rsi, %rsi
	je	.LBB44_43
# %bb.41:                               #   in Loop: Header=BB44_42 Depth=1
	movq	%rbx, %rdi
	callq	listDelNode
	jmp	.LBB44_42
.LBB44_43:
...
.LBB44_47:                              # =>This Inner Loop Header: Depth=1
	...
	testq	%rsi, %rsi
	je	.LBB44_48
# %bb.46:                               #   in Loop: Header=BB44_47 Depth=1
	movq	%rbx, %rdi
	callq	listDelNode
	jmp	.LBB44_47
.LBB44_48:
...
.LBB57_5:                               # =>This Inner Loop Header: Depth=1
	cmpl	%edi, ldb+40(,%rdx,4)
	je	.LBB57_8
# %bb.4:                                #   in Loop: Header=BB57_5 Depth=1
	addq	$1, %rdx
	cmpq	%rcx, %rdx
	jl	.LBB57_5
# %bb.6:
...
# %bb.17:                               #   in Loop: Header=BB59_14 Depth=1
	...
	cmpl	$1023, %ecx             # imm = 0x3FF
	ja	.LBB59_21
# %bb.18:                               #   in Loop: Header=BB59_14 Depth=1
	addq	$2, %rbx
	movslq	%eax, %r14
	movq	%rbx, %rdi
	movq	%r14, %rsi
	...
	cmpb	$13, (%rbx,%r14)
	jne	.LBB59_20
# %bb.19:                               #   in Loop: Header=BB59_14 Depth=1
	addq	%r14, %rbx
	leaq	1(%r13), %rax
	cmpb	$10, 1(%rbx)
	movq	%rbx, %r14
...
# %bb.1:
	...
	jmp	.LBB61_2
	.p2align	4, 0x90
.LBB61_15:                              #   in Loop: Header=BB61_2 Depth=1
...
.LBB61_12:                              #   in Loop: Header=BB61_2 Depth=1
	...
	movq	%rax, %rsi
	callq	listAddNodeTail
.LBB61_13:                              #   in Loop: Header=BB61_2 Depth=1
	movslq	ldb+320(%rip), %rax
	cmpq	%rax, %rbx
	leaq	1(%rbx), %rbx
	jge	.LBB61_14
...
# %bb.8:                                #   in Loop: Header=BB61_2 Depth=1
	xorl	%ecx, %ecx
	.p2align	4, 0x90
.LBB61_10:                              #   Parent Loop BB61_2 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	movl	ldb+40(,%rcx,4), %edx
	cmpq	%rdx, %rbx
	je	.LBB61_11
# %bb.9:                                #   in Loop: Header=BB61_10 Depth=2
	addq	$1, %rcx
	cmpq	%rax, %rcx
	jl	.LBB61_10
	jmp	.LBB61_15
...
.LBB64_8:
	...
	popq	%r15
	popq	%rbp
	jmp	ldbRedisProtocolToHuman_MultiBulk # TAILCALL
.LBB64_9:
	leaq	1(%rbx), %r15
	movq	%r15, %rdi
	movl	$13, %esi
...
# %bb.7:                                # %.preheader
	...
	jmp	.LBB71_8
	.p2align	4, 0x90
.LBB71_47:                              #   in Loop: Header=BB71_8 Depth=1
	cmpl	%ebx, ldb+324(%rip)
	sete	%al
	movl	$.L.str.149, %ecx
	movl	$.L.str.147, %r15d
...
.LBB71_14:                              #   Parent Loop BB71_8 Depth=1
	...
	cmpl	%ebx, ldb+40(,%rcx,4)
	je	.LBB71_15
# %bb.13:                               #   in Loop: Header=BB71_14 Depth=2
	addq	$1, %rcx
	cmpq	%rax, %rcx
	jl	.LBB71_14
	jmp	.LBB71_47
...
.LBB71_35:                              #   Parent Loop BB71_3 Depth=1
	...
	cmpl	%edi, ldb+40(,%rcx,4)
	je	.LBB71_36
# %bb.34:                               #   in Loop: Header=BB71_35 Depth=2
	addq	$1, %rcx
	cmpq	%rax, %rcx
	jl	.LBB71_35
...
# %bb.1:
	...
	jmp	.LBB74_2
	.p2align	4, 0x90
.LBB74_15:                              #   in Loop: Header=BB74_2 Depth=1
	cmpl	%ebx, ldb+324(%rip)
	sete	%al
	movl	$.L.str.149, %ecx
	movl	$.L.str.147, %r15d
...
# %bb.7:                                #   in Loop: Header=BB74_2 Depth=1
	xorl	%ecx, %ecx
	.p2align	4, 0x90
.LBB74_9:                               #   Parent Loop BB74_2 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	cmpl	%ebx, ldb+40(,%rcx,4)
	je	.LBB74_10
# %bb.8:                                #   in Loop: Header=BB74_9 Depth=2
	addq	$1, %rcx
	cmpq	%rax, %rcx
	jl	.LBB74_9
	jmp	.LBB74_15
...
# %bb.43:                               #   in Loop: Header=BB76_1 Depth=1
	...
	testl	%eax, %eax
	je	.LBB76_44
# %bb.50:                               #   in Loop: Header=BB76_1 Depth=1
	movl	$.L.str.249, %esi
	movq	%r13, %rdi
	callq	strcasecmp
	testl	%eax, %eax
...
# %bb.51:                               #   in Loop: Header=BB76_1 Depth=1
	...
	testl	%eax, %eax
	je	.LBB76_52
# %bb.53:                               #   in Loop: Header=BB76_1 Depth=1
	movl	$.L.str.251, %edi
	jmp	.LBB76_54
	.p2align	4, 0x90
.LBB76_8:                               #   in Loop: Header=BB76_1 Depth=1
	...
	callq	listAddNodeTail
	movl	$.L.str.226, %edi
.LBB76_54:                              #   in Loop: Header=BB76_1 Depth=1
	callq	sdsnew
	movq	ldb+16(%rip), %rdi
	movq	%rax, %rsi
	callq	listAddNodeTail
...
.LBB76_29:                              #   in Loop: Header=BB76_1 Depth=1
	...
	callq	ldbEval
	.p2align	4, 0x90
.LBB76_55:                              #   in Loop: Header=BB76_1 Depth=1
	callq	ldbSendLogs
...
# %bb.46:                               #   in Loop: Header=BB76_1 Depth=1
	movl	$5, %esi
	jmp	.LBB76_48
.LBB76_52:                              #   in Loop: Header=BB76_1 Depth=1
	movl	$1, %edi
...
.LBB76_47:                              #   in Loop: Header=BB76_1 Depth=1
	...
	callq	atoi
	movl	%eax, %esi
.LBB76_48:                              #   in Loop: Header=BB76_1 Depth=1
	movl	%r13d, %edi
	callq	ldbList
	jmp	.LBB76_55
.LBB76_3:
